          ...
          if ($cliptunump->numrows > 0) {
            ...
            // valores das unica e parcelado
              ...
              $lReciboGerado = false;
                    ...
                    fputs($clabre_arquivo->arquivo,(string) db_contador("BARRASUNICA".$k00_percdes,"CODIGO DE BARRAS",$contador,101));
                }  
								if (pg_num_rows($resultfin) > 0) {
...
function db_contador($apelido, $expressao, $contador, $valor) {
  ...
  $contador+=$valor;
  return str_pad(trim((string) $apelido),30) . " - " . str_pad((string) $expressao,80) . " - " . str_pad((string) $valor,4,"0",STR_PAD_LEFT) . " - " . str_pad($contadorant,4,"0",STR_PAD_LEFT) . " - " . str_pad($contador,4,"0",STR_PAD_LEFT) . "{$sQuebraLinha}";
}
