...
for ($i = 0;$i < pg_num_rows($result);$i++) {
  ...
  $cgc = $sCnpjPrefeitura;
   ...
   $result_licita = $clempautitem->sql_record($clempautitem->sql_query_lic(null,null,"distinct l20_edital, l20_numero, l20_anousu, l20_objeto, l03_descr",null,"e55_autori = $e61_autori "));
