...
db_query("select fc_startsession();") or die("$sScriptName: Erro ao iniciar sess�o no banco de dados");
// criar usuario

db_query("begin") or die("$sScriptName: Erro ao iniciar transa��o");
...
if (pg_numrows($resultprocura) == 0) {
  ...
  $sql = "insert into db_usuarios (id_usuario , nome , login , senha , usuarioativo , email , usuext)
		       values     (1,'DBSeller Inform�tica Ltda','dbseller','" . Encriptacao::encriptaSenha('') . "','1','dbseller#dbseller.com.br',0)";
   //                    values     (nextval('db_usuarios_id_usuario_seq'),'DBSeller Inform�tica Ltda','dbseller','','t','dbseller#dbseller.com.br',0)";
...
$sql = " insert into db_sysregrasacesso values (0,'2000-01-01','00:00','2999-01-01','24:00',1,current_date,'implanta��o')";
$res = db_query($sql) or die("$sScriptName: $sql");
...
db_query("commit") or die("$sScriptName: Erro ao finalizar transa��o");

die("ATEN��O!! feche todas janelas e acesse novamente o sistema...")
