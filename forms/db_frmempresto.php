...
$clrotulo->label("o200_sequencial");
$clrotulo->label("o200_descricao");
?>

<form name="form1" method="post" action="" onsubmit="return js_validarAlteracaoRecurso()">
    <fieldset>
        <legend>Manutenção de Restos a Pagar</legend>
        <table border="0">
            <tr>
                ...
                <td>
                    ...
                    if (!empty($e91_recurso)) {
                        $recursooriginal = $e91_recurso;
                    }
                    db_input('e91_anousu', 4, $Ie91_anousu, true, 'text', $db_opcao, "");
                    db_input('recursooriginal', 4, $Ie91_anousu, true, 'hidden', $db_opcao, "");
                    ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td nowrap title="<?= @$Te91_recurso ?>">
                    <?php
                    db_ancora(@$Le91_recurso, "js_pesquisaRecurso(true);", $db_opcao);
                    ?>
                </td>
                <td>
                    <?php
                    db_input('e91_recurso', 4, $Ie91_recurso, true, 'hidden', $db_opcao);
                    db_input("o15_recurso", 10, null, false, "text", $db_opcao, "onchange='js_pesquisaRecurso(false);'");
            ...
            <tr>
                ...
                <td>
                    <?php
                    db_input('o200_sequencial', 10, $Io200_sequencial, true, 'hidden', 3);
                    db_input('o200_descricao', 70, $Io200_descricao, true, 'text', 3, '');
                    ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <?php
                    db_input('e91_codtipo', 15, $Ie91_codtipo, true, 'text', $db_opcao,
                        " onchange='js_pesquisae91_codtipo(false);'");
...
<script>
    ...
    function js_validarAlteracaoRecurso() {

        var recursoOriginal = document.getElementById('recursooriginal').value;
        if (recursoOriginal != '' && document.getElementById('e91_recurso').value != recursoOriginal) {
            var mensagem = "Atenção: a alteração do recurso neste empenho, poderá ocasionar divergências nos saldos da ";
            mensagem += "Matriz de Saldo Contábil e nos Contas Correntes deste recurso.";
    ...
    const pesquisaRecurso = (parametroAdicional) => {
        var sUrl = 'func_fonterecursocomplemento.php?funcao_js=parent.js_preencheRecurso|db_codigo|o15_recurso|o15_descr|o200_descricao|db_complemento';
    ...
    function js_preencheRecurso(id, recurso, descricao, complemento, idComplemento) {

        $('e91_recurso').value = id;
        $('o15_recurso').value = recurso;
        $('o15_descr').value = descricao;
        $('o200_descricao').value = complemento;
        $('o200_sequencial').value = idComplemento;
