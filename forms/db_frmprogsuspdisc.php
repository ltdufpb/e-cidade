...
<table border="0">
 <tr>
  ...
  <td>
   <?php db_input('ed119_i_codigo',10,$Ied119_i_codigo,true,'text',3,"")?>
  </td>
 </tr>
 <tr>
  <td nowrap title="<?=@$Ted119_i_progmatricula?>">
   <?php db_ancora(@$Led119_i_progmatricula,"js_pesquisaed119_i_progmatricula(true);",$db_opcao1);?>
  </td>
  <td>
   <?php db_input('ed119_i_progmatricula',10,$Ied119_i_progmatricula,true,'hidden',3,"")?>
 ...
 <tr>
  ...
  <td>
   <?php db_inputdata('ed119_d_data',@$ed119_d_data_dia,@$ed119_d_data_mes,@$ed119_d_data_ano,true,'text',$db_opcao," onchange=\"js_data();\"","","","parent.js_data();","js_data();")?>
  </td>
 </tr>
 <tr>
  ...
  <td>
   <?php db_textarea('ed119_t_obs',2,70,$Ied119_t_obs,true,'text',$db_opcao,"")?>
  </td>
 </tr>
</table>
</center>
