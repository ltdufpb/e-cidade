...
<fieldset>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                $result = $clretencaotipocalc->sql_record($clretencaotipocalc->sql_query("", "*",
                    ""));
                db_selectrecord("e21_retencaotipocalc", $result, true, $db_opcao, '', '', '', '',
        ...
        <tr>
            ...
            <td>
                <?php
                db_input('e21_receita', 10, $Ie21_receita, true, 'text', $db_opcao,
        ...
        <tr id='codigoirrf'>
            ...
            <td>
                ...
                db_input('e30_codigo', 10, $Ie30_codigo, true, 'text', $db_opcao,
        ...
        <tr>
            ...
            <td>
                <?php
                db_input('e48_cgm', 10, $Ie48_cgm, true, 'text', $db_opcao,
        ...
        <tr id="trReceitaEnteRecebedor" style="display: none">
            ...
            <td>
                <?php
                db_input('e21_receitaenterecebedor', 10, $Ie21_receitaenterecebedor, true, 'text', $db_opcao,
