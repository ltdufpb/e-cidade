        ...
        <table class="form-container">
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                    <?php
                    db_input('c60_estrut', 12, $Ic60_estrut, true, 'text', $db_opcao, "onchange='js_pesquisa_c60_estrut();'")
                    ?>
                    <?php
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                    <?php
                    db_input('c60_estrut_depreciacao', 12, $Ic60_estrut, true, 'text', $db_opcao, "onchange='js_pesquisa_c60_estrut_depreciacao();'")
                    ?>
                    <?php
            ...
            <tr>
                <td nowrap title="<?= @$T64_valorresidual ?>">
                    <?= $Lt64_valorresidual; ?>
                </td>
                <td>
                    <?php
...
<script>
    ...
    function js_pesquisa_c60_estrut() {
        ...
        if (document.form1.c60_estrut.value != '') {
            js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_conplano', 'func_conplano.php?chave_c60_estrut=' + $F('c60_estrut') + '&funcao_js=parent.js_mostraconplano1|c60_codcon|c60_descr|c60_estrut', 'Pesquisa', false);
        } else {
    ...
    function js_pesquisat86_conplano(mostra) {
        ...
        if (mostra == true) {
            js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_conplano', 'func_conplano.php?funcao_js=parent.js_mostraconplano1|c60_codcon|c60_descr|c60_estrut' + "&contasAtivo=true", 'Pesquisa', true);
        } else {
    ...
    function js_pesquisa_c60_estrut_depreciacao() {
        ...
        if (document.form1.c60_estrut_depreciacao.value != '') {
            js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_conplano', 'func_conplano.php?chave_c60_estrut=' + $F('c60_estrut_depreciacao') + '&funcao_js=parent.js_mostraconplanodepreciacao1|c60_codcon|c60_descr|c60_estrut', 'Pesquisa', false);
        } else {
    ...
    function js_pesquisat86_conplanodepreciacao(mostra) {
        ...
        if (mostra == true) {
            js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_conplano', 'func_conplano.php?funcao_js=parent.js_mostraconplanodepreciacao1|c60_codcon|c60_descr|c60_estrut' + '&contasDepreciacao=true', 'Pesquisa', true);
        } else {
