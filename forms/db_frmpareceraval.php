 ...
 <table border="0" width="100%" cellspacing="0" cellpading="0">
  <tr>
   <td colspan="4" align="center">
    <br>
    <?php db_textarea('ed72_t_parecer',5,120,@$Ied72_t_parecer,true,'text',$db_opcao,@$encerrado=="S"?"readonly onclick=\"alert('Aluno possui avaliações encerradas para esta disciplina!')\"":"")?>
    <br><br>
    <?php 
