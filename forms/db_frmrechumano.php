...
function js_pesquisaed20_i_codigo(mostra) {
  ...
  js_OpenJanelaIframe('','db_iframe_rhpessoal','func_rhpessoaleducacao.php?funcao_js=parent.js_mostrarhpessoal1|'+
		              'rh01_regist|z01_nomecomple','Pesquisa de Funcionários na Prefeitura',true);
}
...
function js_pesquisaz01_numcgm(mostra) {
  ...
  js_OpenJanelaIframe('','func_nome','func_cgmrechumano.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nomecomple',
