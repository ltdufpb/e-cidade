       ...
       <table border="0" cellspacing="1" cellpadding="0" width="100%">
        ...
        <tr>
            <td>
             ...
             <td>
                <?php db_input('ed47_v_nomesocial',70,$Ied47_v_nomesocial,true,'text',$db_opcao," onKeyUp=\"js_ValidaCamposEdu(this,1,'$GLOBALS[Sed47_v_nomesocial]','f','t',event);\""); ?>
            </td>
        </tr>
        <tr>
         <td>
         ...
         <td>
          <?php db_inputdata('ed47_d_nasc',@$ed47_d_nasc_dia,@$ed47_d_nasc_mes,@$ed47_d_nasc_ano,true,'text',$db_opcao, "onchange='validaIdade();'", '', '', '','', '', "validaIdade()");?>
          <b> Idade: </b>
   ...
   <fieldset style="height:240px"><legend><b>Endereço Residencial / Contato do Aluno</b></legend>
    <table border="0" cellspacing="1" cellpadding="0" width="100%">
     <tr>
      ...
      <td> 
        <?php db_input('ed47_v_cep',12,3,true,'text',$db_opcao,"onChange='js_verificacep(this);'","","",15,10);?>
      </td>
     </tr>
     <tr>
     <tr>
     ...
     <tr>
      ...
      <td>
       <?php db_input('ed47_v_email',30,$Ied47_v_email,true,'text',$db_opcao," onKeyUp=\"js_ValidaCamposEdu(this,4,'$GLOBALS[Sed47_v_email]','f','t',event);\"");?>
      </td>
     </tr>
    </table>
   </fielset>
