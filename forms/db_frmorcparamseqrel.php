...
function espaco($estrutural=""){
    $espaco ="";
    if(substr((string) $estrutural,1,14)     == '00000000000000'){	$espaco="";    }elseif(substr((string) $estrutural,2,13)== '0000000000000'){   	$espaco="&nbsp;&nbsp;";    }elseif(substr((string) $estrutural,3,12)== '000000000000'){   	$espaco="&nbsp;&nbsp;&nbsp;&nbsp;";    }elseif(substr((string) $estrutural,4,11) == '00000000000'){	$espaco="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";    }elseif(substr((string) $estrutural,5,10) == '0000000000'){    	$espaco="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";    }elseif(substr((string) $estrutural,7,8)  == '00000000'){    	$espaco="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";    }elseif(substr((string) $estrutural,9,6)  == '000000'){    	$espaco="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";    }elseif(substr((string) $estrutural,11,4) == '0000'){ 	$espaco="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";    }elseif(substr((string) $estrutural,12,3) == '000'){	$espaco="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";    }elseif(substr((string) $estrutural,13,2) == '00'){ 	$espaco="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";    }
    return $espaco;
}
