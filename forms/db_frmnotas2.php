...
<table width="600" border="1" cellpadding="0" cellspacing="0">
  ...
  ?>
  <tr>
   <td align="center"><?php db_input('ed09_i_codigo',5,$ed09_i_codigo,true,'text',3,"")?></td>
   <td>&nbsp;<?=$z01_nome?></td>
   <td align="center"><?php db_input('ed11_f_media',5,$Ied11_f_media,true,'text',$db_opcao," onchange='digita(this,$ed13_f_valor);'")?></td>
  </tr>
  <?php 
  }
  ?>
