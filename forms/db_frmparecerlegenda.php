...
<table border="0">
 <tr>
  ...
  <td>
   <?php db_input('ed91_i_codigo',20,$Ied91_i_codigo,true,'text',3,"")?>
  </td>
 </tr>
 <tr>
  ...
  <td>
   <?php db_input('ed91_c_descr',20,$Ied91_c_descr,true,'text',$db_opcao,"")?>
  </td>
 </tr>
 <tr>
  ...
  <td>
   <?php db_input('ed91_sigla',20,$Ied91_c_descr,true,'text',$db_opcao,"")?>
  </td>
 </tr>
</table>
