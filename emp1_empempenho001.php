    ...
    <td height="430" align="left" valign="top" bgcolor="#CCCCCC"> 
     <?php 
       ...
       if (isset($chavepesquisa)){       	
         ...
         $clcriaabas->src = ["empempenho"=>"{$sFonte}?chavepesquisa=".$chavepesquisa."&lanc_emp=".@$lanc_emp,"empempitem"=>"","empempdot"=>"","empprazos"=>""];
       }else {
         // $clcriaabas->src = array("empempenho"=>"emp1_empempenho004.php?lanc_emp=".@$lanc_emp,"empempitem"=>"","empempdot"=>"","empprazos"=>"","empempret"=>"");
         $clcriaabas->src = ["empempenho"=>"{$sFonte}?lanc_emp=".@$lanc_emp,"empempitem"=>"","empempdot"=>"","empprazos"=>""];
       }	 
