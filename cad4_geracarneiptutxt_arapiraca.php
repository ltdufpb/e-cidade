        ...
        if (pg_num_rows($resultfin) > 0) {
          ...
          if ($cliptunump->numrows > 0) {
            ...
            if ($gerar == "dados") {
              ...
              fputs($clabre_arquivo->arquivo, str_pad(addslashes((string) $z01_compl), 20));
	    ...
	    if( $oRegraEmissao->isCobranca() ){
	      ...
	      if ( $k03_numpreunica == '' && $k00_dtvenc == '' && $utotal == '' ){
	    	...
	    	if ($gerar == "dados") {
	    	  ...
	    	  fputs($clabre_arquivo->arquivo,(string) $numpre);
	    	}
	      ...
	      if ($gerar == "dados") {
	      	fputs($clabre_arquivo->arquivo,(string) $k03_numpreunica);
	      }
...
//            $sqlcalc .= "         j21_quant,                                                                       ";
            ...
            if ($gerar == "dados") {
              ...
              $rsVerifica = pg_fetch_result(db_query($sSqlVerifica),0,0);             	                     
...
//                }
            ...
            if ($gerar == "dados") {
                ...
                if (!empty($k03_numpreunica_semdesconto)) {
                  fputs($clabre_arquivo->arquivo,str_pad((string) @$k03_numpreunica_semdesconto,8,'0',STR_PAD_LEFT));
                }else{
                  fputs($clabre_arquivo->arquivo,str_pad('',8,' ',STR_PAD_LEFT));
                }
            } else {
                fputs($clabre_arquivo->arquivo, (string) db_contador("NPUNICASEMDESC","NUMPRE UNICA SEM DESCONTO", $contador, 8));
            }
            ...
            if ($gerar == "dados"  && isset($k03_numpreunica_semdesconto) && $k03_numpreunica_semdesconto != "") {
                ...
                fputs($clabre_arquivo->arquivo, (string) db_contador("LDUNICASEMDESC","LINHA DIGITAL UNICA SEM DESCONTO", $contador, 101));
            }
