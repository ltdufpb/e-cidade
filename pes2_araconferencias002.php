...
$xxnum = $result1 === false || $result1 === null ? 0 : pg_num_rows($result1);
...
$xxnum = $result2 === false || $result2 === null ? 0 : pg_num_rows($result2);
...
$xxnum = $result3 === false || $result3 === null ? 0 : pg_num_rows($result3);
...
$xxnum = $result4 === false || $result4 === null ? 0 : pg_num_rows($result4);
...
$xxnum = $result7 === false || $result7 === null ? 0 : pg_num_rows($result7);
...
$xxnum = $result5 === false || $result5 === null ? 0 : pg_num_rows($result5);
...
$xxnum = $result6 === false || $result6 === null ? 0 : pg_num_rows($result6);
...
$xxnum = $result8 === false || $result8 === null ? 0 : pg_num_rows($result8);
...
$xxnum = $result9 === false || $result9 === null ? 0 : pg_num_rows($result9);
