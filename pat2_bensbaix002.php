...
$sSelect .= " bens.t52_ident::numeric,                                                    ";
$sSelect .= " bens.t52_ident as placa_original,                                           ";
...
for ($iRow = 0; $iRow < $iNumRows; $iRow++) {
  ...
  if (!empty($oBemDepreciacao)) {
    ...
    $nValorDepreciacao = $oBemDepreciacao->getValorAtual();
  }
  ...
  $oPdf->cell(15, $iHeightLinha, $oBem->placa_original,"T",0,"C",0);
