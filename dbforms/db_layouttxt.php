...
/*      echo "<pre>";
    ...
    function formatarCampo($tipoFormat, $valor, $tamanho, $mascara)
    {
        ...
        switch ($tipoFormat) {
            case 1: // Para String
                $valor = db_formatar(substr(strtoupper((string) db_translate($valor)), 0, $tamanho), "s", " ", $tamanho, $this->_alinhaCampo, 0);
                break;
            case 2: // Para Inteiro
            ...
            case 3: // Para Decimal
                ...
                break;
            case 4: // Para Data
                $arr_data ['Y'] = str_pad((string) db_subdata($valor, 'a'), 4, '0');
                $arr_data ['y'] = str_pad(substr((string) db_subdata($valor, 'a'), - 2), 2, '0');
                $arr_data ['m'] = str_pad((string) db_subdata($valor, 'm'), 2, '0');
                $arr_data ['d'] = str_pad((string) db_subdata($valor, 'd'), 2, '0');
            ...
            case 16:
                ...
                break;
            default:
                $valor = db_formatar(substr((string) db_translate($valor), 0, $tamanho), "s", "0", $tamanho, $this->_alinhaCampo, 0);
