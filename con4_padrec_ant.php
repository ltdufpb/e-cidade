                ...
                if ($anousu > 2007) {
                    ...
                    if (pg_numrows($res_orcreceita) != 0) {
                        ...
                        if ($oRecurso->getComplementoRecursoVinculado()->isTribunal()) {
                            $complementoFonteRecurso = $oRecurso->getComplementoRecursoVinculado()->getCodigo();
                        }

                    }
                    /**
                     * o complemento foi encontrado na query da cl_receita_saldo_mes_complemento
                     * agora vem no campo da query complemento_lancamento
                     */
                    $complementoFonteRecurso = $complemento_lancamento;
