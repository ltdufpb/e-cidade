      ...
      <form name="form1" method="post" action="" >
        ...
        <tr>
          <td width="50%">
            <b>CPF:</b>
            <?php
            db_input("ed285_i_cpf", 20, $Ied285_i_cpf, true, "text", 4, "onFocus=\"nextfield='pesquisar2'\"", "chave_cpf");
            ?>
          </td>
          <td width="50%">
            <b>Código INEP:</b>
            <?php
            db_input("ed285_i_idinep", 20, $Ied285_i_idinep, true, "text", 4, "onFocus=\"nextfield='pesquisar2'\"", "chave_idinep");
            ?>
          </td>
        </tr>
        <tr>
