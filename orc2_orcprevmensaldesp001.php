...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
    <?php 
    $clcriaabas->identifica = ["g1"=>"Relatorio","filtro"=>"Filtro"];
    $clcriaabas->title      = ["g1"=>"Relatorio","filtro"=>"Filtros"];
    $clcriaabas->src        = ["g1"=>"orc2_orcprevmensaldesp011.php","filtro"=>"func_selorcdotacao_aba.php"];
