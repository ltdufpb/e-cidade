         ...
         if ($iLinhasDocente == 0) {
           ...
           for ($b = 0; $b < $iLinhasDocente; $b++) {
             ...
             if ($lErroDocente == false) {
               ...
               $write_linha .= "|".trim($oDadosDocente->rh01_nasc)."|".trim($oDadosDocente->rh01_sexo)."|".trim((string) $oDadosRecHumano->ed20_i_raca);
...
////           }
           ...
           if ($lErroAluno == false) {
             ...
             $write_linha .= "|".trim((string) $oDadosAluno->ed47_i_censoufident)."|".trim($oDadosAluno->ed47_d_identdtexp)."|".$iModeloCertidao;
             ...
             $write_linha .= "|".trim($oDadosAluno->ed47_c_certidaodata)."|".trim((string) $oDadosAluno->ed47_i_censoufcert);
