...
class RelatorioGradeAproveitamento extends PDFGradeAproveitamento {
   ...
   */
  public function __construct($oPdf, Matricula $oMatricula, $iLimiteLinha) {

    $this->lMargin = $oPdf instanceof Pdf ? $oPdf->GetLeftMargin() : $oPdf->lMargin;
    $this->oPdf                 = $oPdf;
  ...
  public function montarGrade() {
    ...
    foreach ($this->oGradeAproveitamento->getGradeAproveitamento() as $oDisciplina) {
      ...
      $this->oPdf->SetX( $this->lMargin  + $this->iTamanhoDisciplina );
