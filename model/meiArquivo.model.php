...
class MeiArquivo {
  ...
  function validaEventoMEI( $sCodEvento='', $iCnpj='' ){
    ...
    if ( $sCodEvento == '101' || $sCodEvento == '209' ) {
      ...
      $oDadosRua       = db_utils::fieldsMemory($rsConsultaRuas, 0);
      ...
      foreach ( $aPropriedadesEmpresa as $sCampoEmpresa => $sValorEmpresa ) {
        ...
        switch ($sCampoEmpresa) {
          case 'iCodRua':
            ...
            $sValorEmpresa = $this->aDadosMEI[$iCnpj]['aEventos'][$sCodEvento]['oEmpresa']->iCodRua;
            break;
          case 'iCodBairro':
            $oRotulo->label("j13_codi");
            $sValorEmpresa = $this->aDadosMEI[$iCnpj]['aEventos'][$sCodEvento]['oEmpresa']->iCodBairro;
            break;
      ...
      if ( isset($oDadosEvento['oEvento']->dtData) ) {
        ...
        $oDaoSocios               = db_utils::getDao('socios');
          ...
          try {
            ...
            $oDaoCgmTipoEmpresa->z03_sequencial  = null;
            $oDaoCgmTipoEmpresa->z03_numcgm      = $iCodCgmEmpresa;
            $oDaoCgmTipoEmpresa->z03_tipoempresa = 52;
            $oDaoCgmTipoEmpresa->incluir();
        ...
        if (!isset($iCodCgmEmpresa)) {
          ...
          if ((empty($iCodRua) || empty($iCodBairro)) &&
             ...
             $sWhereRuasBairro = "    j14_nome  = '{$oDadosEmpresa->q107_logradouro}'
                                  and j13_descr = '{$oDadosEmpresa->q107_bairro}';";
          ...
          if ( trim((string) $iCodRua) != '' ) {
            ...
            if ( $oDaoIssRuas->erro_status == 0 ) {
              ...
              $oDaoCgmTipoEmpresa->z03_sequencial  = null;
              $oDaoCgmTipoEmpresa->z03_numcgm      = $iCodCgmResponsavel;
        ...
        if ($sCodEvento == '101') {
           ...
           if (!empty($sListaAtivCalculo) && $iRowsAtiv > 0) {
              $sSqlCalculo    = "SELECT fc_issqn($iCodInscricao::int,
