...
try {
    ...
    switch ($oParam->exec) {
        ...
        case 'excluirAtividade':
            ...
            $oRetorno->sMessage = urlencode((string) _M(EDU4_RECHUMANOATIVIDADERPC . "atividade_excluida_sucesso"));
...
//            }
            ...
            $oRetorno->sMessage = urlencode((string) _M(EDU4_RECHUMANOATIVIDADERPC . "atividade_salva_sucesso"));
