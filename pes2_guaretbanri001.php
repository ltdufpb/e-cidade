...
//          echo "<br><br><br>". ($clmovrel->sql_query_gerfsal(null," * ",""," r54_anomes = '".$r54_anousu.$r54_mesusu."' and trim(r54_codrel) = '".$r54_codrel."' and r54_regist <> 0 limit 1 ",$r54_anousu,$r54_mesusu,$r55_rubr01));
          $result_testa_folha = $clmovrel->sql_record($clmovrel->sql_query_gerfsal(null," * ",""," r54_anomes = '".$r54_anousu.$r54_mesusu."' and trim(r54_codrel) = '".trim((string) $r54_codrel)."' and r54_regist <> 0 limit 1 ",$r54_anousu,$r54_mesusu,$r55_rubr01));
	  if($clmovrel->numrows == 0){
	    ...
	    break;
          ...
          $result_testa_folha = $clmovrel->sql_record($clmovrel->sql_query_gerfsal(null," * ",""," r54_anomes = '".$r54_anousu.$r54_mesusu."' and trim(r54_codrel) = '".trim((string) $r54_codrel)."' and r54_regist = ".$matriculaselect,$r54_anousu,$r54_mesusu,$r55_rubr01));
