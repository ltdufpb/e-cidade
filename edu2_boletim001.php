                        ...
                        <table border="0" align="left">
                            <tr>
                                <td>
                                    ...
                                    <select name="grupo"
                                        ...
                                        while ($row = pg_fetch_array($sql_result)) {
                                            ...
                                            ?>
                                            <option
                                                value="<?= $cod_curso; ?>" <?= isset($calendario) && $cod_curso == $calendario ? "selected" : "" ?>><?= $desc_curso; ?></option>
                                            <?php
                                        }
                                ...
                                <td valign='bottom'>
                                    <input type="checkbox"
                                           name="inativos"
                                           value="" <?= isset($inativos) && $inativos == "yes" ? "checked" : "" ?> >
                                    Somente alunos inativos
                                    <input type="button" name="procurar" value="Procurar"
                                           onclick="js_procurar(document.form1.grupo.value,document.form1.subgrupo.value)"
                                           disabled>
                                </td>
                            </tr>
                        </table>
                ...
                if (isset($turma)) {
                    ...
                    <tr>
                        ...
                        <td align="center">
                           ...
                           background:#cccccc;font-size:12px;font-weight:bold;width:30px;height:15px;padding:0px;"
                                               disabled>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            ...
                            <select name="modelo" id="modelo" style="font-size:9px;">
                                ...
                                <option value="4">MODELO 4 - 3 por página</option>
                            </select>
                            <input type="checkbox" id='assinaturaregente' name="assinaturaregente" value="" checked> <b>Imprimir
                                assinatura do professor conselheiro</b><br>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">
                            <b>Layout:</b><br>
                            <input type="checkbox" name="grade" value="" checked> <b>Mostrar grade com aproveitamento do
                                aluno</b><br>
                            <input type="checkbox" name="padrao" value="" checked onclick="js_padrao();"> <b>Mostrar
                                pareceres padronizados</b>
                            <span id="optpadrao">
                  <select name="padraotipo" style="font-size:9px;height:16px;">
                    <option value="C">Concatenar pareceres lado a lado</option>
                    <option value="L">Listar pareceres um abaixo do outro</option>
                            ...
                            if ($tem_nivel == true) {
                                ...
                                ?>
                                <input type="checkbox" name="niveis" value="" checked> <b>Mostrar descrição dos
                                    níveis</b><br>
                                <?php
                            } else {
                                ?>
                ...
                ?>
                    <tr>
                        <td valign="top" colspan="3">
                            ...
                            <br>
                            <?php
                            db_textarea('obs', 2, 110, 0, true, 'text', 1, "", "", "", 350);
                            ?>
                            <br>
                        </td>
                    </tr>
                            ...
                            if (trim((string) $ed37_c_tipo) != "PARECER") {
                                ...
                                <fieldset style="align:left">
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                MODELO 4 -> Retrato (Três boletins por página)
                                            </td>
                                        </tr>
                                    </table>
                                </fieldset>
...
<script>
    ...
    function js_pesquisa(turma) {
        ...
        if (document.form1.modelo.value == 1) {
            ...
            sUrlBoletim = 'edu2_boletimmediaponderada.php';
        }else {
