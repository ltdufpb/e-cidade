...
<table valign="top" marginwidth="0" width="790" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td height="430" align="left" valign="top" bgcolor="#CCCCCC"> 
	 ...
	 $clcriaabas->src = ["pcforne"=>"com1_pcforne006.php"];
	 $clcriaabas->disabled   = ["pcfornecon"=>"true","pcfornemov"=>"true","subgrupo"=>"true","pcfornereprlegal"=>"true", "pcforneidentificacaocredor"=>"true"]; 
