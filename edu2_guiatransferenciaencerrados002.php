...
try {
    ...
    foreach ($aMatriculas as $oMatricula) {
        ...
        $termoResultadoFinal = DBEducacaoTermo::getTermoEncerramento(
            $oMatricula->getEtapaDeOrigem()->getEnsino()->getCodigo(),
            $resultadoFinal,
            $oMatricula->getTurma()->getCalendario()->getAnoExecucao()
        );
