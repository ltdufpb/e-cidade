    ...
    <fieldset>
      ...
      <table width="35%" border="0" align="center" cellspacing="3" class="form-container">
        <tr>
          ...
          <td><?php  db_input("ar28_sequencial",10,$Iar28_sequencial,true,"text",4,"","chave_ar28_sequencial"); ?></td>
        </tr>
        <tr>
          <td><label><?=$Lar28_sequencial?></label></td>
          <td><?php  db_input("ar28_sequencial",10,$Iar28_sequencial,true,"text",4,"","chave_ar28_sequencial");?></td>
    ...
    <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_parametroscobrancaregistrada.hide();">
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_ar28_sequencial)){
          $repassa = ["chave_ar28_sequencial"=>$chave_ar28_sequencial,"chave_ar28_sequencial"=>$chave_ar28_sequencial];
        }
