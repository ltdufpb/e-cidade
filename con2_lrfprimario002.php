...
$m_rec     = [];
$m_rec_ant = [];  // vetor de receitas de exercicio anterior devido as deducoes mudarem de 497(2007) p/ 917(2008)
for($x=1;$x<=21;$x++){
...
// Deducoes do exercicio anterior
      if (db_conplano_grupo($anousu_ant,substr((string) $elemento,0,3)."%",9001) == true){
