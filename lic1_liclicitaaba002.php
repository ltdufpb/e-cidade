...
<html>
  ...
  <body class="body-default abas">
    <?php
      ...
      $clcriaabas->src        = [ "liclicita" => "lic1_liclicita002.php", "infocomplementar" => "lic1_liclicitainfocomplementar001.php", "liclicitem"=>"lic1_liclicitemalt001.php","liclicitemlote"=>"lic1_liclicitemlote001.php"];
