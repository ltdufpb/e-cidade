...
switch($oParam->exec) {
    ...
    case 'getAlunosDeProgressao':
        ...
        foreach ($aAlunosDeProgressao as $oAlunoProgressao) {
            ...
            $oDadosAlunoProgressao->sNomeAluno      = urlencode((string) $oAlunoProgressao->getAluno()->getNome());
            $oDadosAlunoProgressao->iOrdemAluno     = $iOrdemAluno;
            $oDadosAlunoProgressao->sDisciplina     = urlencode((string) $oAlunoProgressao->getDisciplina()->getAbreviatura());
            $oDadosAlunoProgressao->sEncerrado      = urlencode($sEncerrado);
            $oDadosAlunoProgressao->lEncerrado      = $oVinculoRegencia->isEncerrado();
            $oDadosAlunoProgressao->sResultadoFinal = urlencode((string) $oAlunoProgressao->getResultadoFinal()->getResultado());
