...
$result = $cldb_versao->sql_record($cldb_versao->sql_query(null, "db30_codversao,db30_codrelease",
    "db30_codver desc limit 1"));
...
<html>
  ...
  <?php
    $oSkin = new SkinService();
  require_once modification($oSkin->getPathFile('inicio.php'));
  ?>
</html>