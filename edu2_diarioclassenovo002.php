...
try {
     ...
     */
    $oRelatorio->setNomeRegente($oGet->regente);
    ...
    if (isset($oGet->turnoOriginal) && $oGet->turnoOriginal === 'false') {
        $oRelatorio->filtrarAlunosMatriculadosTurnoReferencia($oGet->turnoSelecionado);
    }
