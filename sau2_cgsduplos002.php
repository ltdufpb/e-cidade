...
for($i = 0; $i < $numrows_cgs_und; $i ++) {
	...
	for($iii = 0; $iii < $numrows_dadoscgs_und; $iii ++) {
		...
		$pdf->cell ( 50, $alt, substr ( (string) $z01_v_nome, 0, 31 ), 1, 0, "L", 0 );
		$pdf->cell ( 25, $alt, $z01_v_cgccpf, 1, 0, "R", 0 );
		$pdf->cell ( 60, $alt, substr ( (string) $z01_v_ender, 0, 35 ) . ", " . $z01_i_numero, 1, 0, "L", 0 );
		$pdf->cell ( 15, $alt, $z01_v_cep1 . "-" . $z01_v_cep2, 1, 0, "C", 0 );
		$pdf->cell ( 25, $alt, $z01_v_compl, 1, 0, "L", 0 );
		$pdf->cell ( 25, $alt, $z01_v_cxpostal, 1, 0, "R", 0 );
		$pdf->cell ( 30, $alt, substr ( (string) $z01_v_bairro, 0, 19 ), 1, 0, "L", 0 );
		$pdf->cell ( 30, $alt, substr ( (string) $z01_v_munic, 0, 16 ) . "/" . $z01_v_uf, 1, 1, "L", 0 );
		$total ++;
	}
