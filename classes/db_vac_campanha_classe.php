...
class cl_vac_campanha { 
   ...
   public $vc11_i_codigo = 0; 
   public $vc11_c_nome = null; 
   public $vc11_c_descr = null; 
   public $vc11_d_inicio_dia = null; 
   public $vc11_d_inicio_mes = null; 
   public $vc11_d_inicio_ano = null; 
   public $vc11_d_inicio = null; 
   public $vc11_d_fim_dia = null; 
   public $vc11_d_fim_mes = null; 
   public $vc11_d_fim_ano = null; 
   public $vc11_d_fim = null; 
   ...
   function incluir ($vc11_i_codigo){ 
     ...
     if($vc11_i_codigo == "" || $vc11_i_codigo == null ){
       ...
       $this->vc11_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from vac_campanha_vc11_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $vc11_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2965,16844,'','".AddSlashes(pg_fetch_result($resaco,0,'vc11_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2965,16845,'','".AddSlashes(pg_fetch_result($resaco,0,'vc11_c_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2965,16846,'','".AddSlashes(pg_fetch_result($resaco,0,'vc11_c_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2965,16847,'','".AddSlashes(pg_fetch_result($resaco,0,'vc11_d_inicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2965,16848,'','".AddSlashes(pg_fetch_result($resaco,0,'vc11_d_fim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($vc11_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->vc11_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc11_i_codigo"])){ 
       $sql  .= $virgula." vc11_i_codigo = $this->vc11_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->vc11_i_codigo) == null ){ 
     ...
     if(trim((string) $this->vc11_c_nome)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc11_c_nome"])){ 
       $sql  .= $virgula." vc11_c_nome = '$this->vc11_c_nome' ";
       $virgula = ",";
       if(trim((string) $this->vc11_c_nome) == null ){ 
         $this->erro_sql = " Campo Nome nao Informado.";
         $this->erro_campo = "vc11_c_nome";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc11_c_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc11_c_descr"])){ 
       $sql  .= $virgula." vc11_c_descr = '$this->vc11_c_descr' ";
       $virgula = ",";
       if(trim((string) $this->vc11_c_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "vc11_c_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc11_d_inicio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc11_d_inicio_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["vc11_d_inicio_dia"] !="") ){ 
       $sql  .= $virgula." vc11_d_inicio = '$this->vc11_d_inicio' ";
       $virgula = ",";
       if(trim((string) $this->vc11_d_inicio) == null ){ 
         $this->erro_sql = " Campo Data inicio nao Informado.";
         $this->erro_campo = "vc11_d_inicio_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc11_d_fim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc11_d_fim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["vc11_d_fim_dia"] !="") ){ 
       $sql  .= $virgula." vc11_d_fim = '$this->vc11_d_fim' ";
       $virgula = ",";
       if(trim((string) $this->vc11_d_fim) == null ){ 
         $this->erro_sql = " Campo Data fim nao Informado.";
         $this->erro_campo = "vc11_d_fim_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc11_i_codigo"]) || $this->vc11_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2965,16844,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc11_i_codigo'))."','$this->vc11_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc11_c_nome"]) || $this->vc11_c_nome != "")
           $resac = db_query("insert into db_acount values($acount,2965,16845,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc11_c_nome'))."','$this->vc11_c_nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc11_c_descr"]) || $this->vc11_c_descr != "")
           $resac = db_query("insert into db_acount values($acount,2965,16846,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc11_c_descr'))."','$this->vc11_c_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc11_d_inicio"]) || $this->vc11_d_inicio != "")
           $resac = db_query("insert into db_acount values($acount,2965,16847,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc11_d_inicio'))."','$this->vc11_d_inicio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc11_d_fim"]) || $this->vc11_d_fim != "")
           $resac = db_query("insert into db_acount values($acount,2965,16848,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc11_d_fim'))."','$this->vc11_d_fim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($vc11_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2965,16844,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc11_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2965,16845,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc11_c_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2965,16846,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc11_c_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2965,16847,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc11_d_inicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2965,16848,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc11_d_fim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
