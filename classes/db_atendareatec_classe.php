...
class cl_atendareatec { 
   ...
   public $at27_sequencial = 0; 
   public $at27_atendcadarea = 0; 
   public $at27_usuarios = 0; 
   ...
   function incluir ($at27_sequencial){ 
     ...
     if($at27_sequencial == "" || $at27_sequencial == null ){
       ...
       $this->at27_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from atendareatec_at27_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at27_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1679,9788,'','".AddSlashes(pg_fetch_result($resaco,0,'at27_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1679,9789,'','".AddSlashes(pg_fetch_result($resaco,0,'at27_atendcadarea'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1679,9790,'','".AddSlashes(pg_fetch_result($resaco,0,'at27_usuarios'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at27_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at27_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at27_sequencial"])){ 
       $sql  .= $virgula." at27_sequencial = $this->at27_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at27_sequencial) == null ){ 
     ...
     if(trim((string) $this->at27_atendcadarea)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at27_atendcadarea"])){ 
       $sql  .= $virgula." at27_atendcadarea = $this->at27_atendcadarea ";
       $virgula = ",";
       if(trim((string) $this->at27_atendcadarea) == null ){ 
         $this->erro_sql = " Campo Código da área nao Informado.";
         $this->erro_campo = "at27_atendcadarea";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at27_usuarios)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at27_usuarios"])){ 
       $sql  .= $virgula." at27_usuarios = $this->at27_usuarios ";
       $virgula = ",";
       if(trim((string) $this->at27_usuarios) == null ){ 
         $this->erro_sql = " Campo Código do usuário nao Informado.";
         $this->erro_campo = "at27_usuarios";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at27_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1679,9788,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at27_sequencial'))."','$this->at27_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at27_atendcadarea"]))
           $resac = db_query("insert into db_acount values($acount,1679,9789,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at27_atendcadarea'))."','$this->at27_atendcadarea',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at27_usuarios"]))
           $resac = db_query("insert into db_acount values($acount,1679,9790,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at27_usuarios'))."','$this->at27_usuarios',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at27_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1679,9788,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at27_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1679,9789,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at27_atendcadarea'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1679,9790,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at27_usuarios'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
