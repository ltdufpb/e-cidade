...
class cl_contacorrenteregravinculo { 
   ...
   public $c27_sequencial = 0; 
   public $c27_contacorrente = 0; 
   public $c27_estrutural = null; 
   ...
   function incluir ($c27_sequencial){ 
     ...
     if($c27_sequencial == "" || $c27_sequencial == null ){
       ...
       $this->c27_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from contacorrenteregravinculo_c27_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $c27_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3493,19662,'','".AddSlashes(pg_fetch_result($resaco,0,'c27_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3493,19663,'','".AddSlashes(pg_fetch_result($resaco,0,'c27_contacorrente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3493,19664,'','".AddSlashes(pg_fetch_result($resaco,0,'c27_estrutural'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($c27_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->c27_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c27_sequencial"])){ 
       $sql  .= $virgula." c27_sequencial = $this->c27_sequencial ";
       $virgula = ",";
       if(trim((string) $this->c27_sequencial) == null ){ 
     ...
     if(trim((string) $this->c27_contacorrente)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c27_contacorrente"])){ 
       $sql  .= $virgula." c27_contacorrente = $this->c27_contacorrente ";
       $virgula = ",";
       if(trim((string) $this->c27_contacorrente) == null ){ 
         $this->erro_sql = " Campo Conta corrente nao Informado.";
         $this->erro_campo = "c27_contacorrente";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c27_estrutural)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c27_estrutural"])){ 
       $sql  .= $virgula." c27_estrutural = '$this->c27_estrutural' ";
       $virgula = ",";
       if(trim((string) $this->c27_estrutural) == null ){ 
         $this->erro_sql = " Campo Estrutural para vinculo nao Informado.";
         $this->erro_campo = "c27_estrutural";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c27_sequencial"]) || $this->c27_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3493,19662,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c27_sequencial'))."','$this->c27_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c27_contacorrente"]) || $this->c27_contacorrente != "")
           $resac = db_query("insert into db_acount values($acount,3493,19663,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c27_contacorrente'))."','$this->c27_contacorrente',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c27_estrutural"]) || $this->c27_estrutural != "")
           $resac = db_query("insert into db_acount values($acount,3493,19664,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c27_estrutural'))."','$this->c27_estrutural',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($c27_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3493,19662,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c27_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3493,19663,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c27_contacorrente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3493,19664,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c27_estrutural'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
