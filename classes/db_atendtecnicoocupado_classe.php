...
class cl_atendtecnicoocupado { 
   ...
   public $at72_id = 0; 
   public $at72_id_usuario = 0; 
   public $at72_codtipo = 0; 
   public $at72_data_dia = null; 
   public $at72_data_mes = null; 
   public $at72_data_ano = null; 
   public $at72_data = null; 
   public $at72_hora = null; 
   public $at72_codatend = 0; 
   public $at72_tarefa = 0; 
   ...
   function incluir ($at72_id){ 
     ...
     if($at72_id == "" || $at72_id == null ){
       ...
       $this->at72_id = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from atendtecnicoocupado_at72_id_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at72_id)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1901,11030,'','".AddSlashes(pg_fetch_result($resaco,0,'at72_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1901,11031,'','".AddSlashes(pg_fetch_result($resaco,0,'at72_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1901,11032,'','".AddSlashes(pg_fetch_result($resaco,0,'at72_codtipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1901,11033,'','".AddSlashes(pg_fetch_result($resaco,0,'at72_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1901,11034,'','".AddSlashes(pg_fetch_result($resaco,0,'at72_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1901,11035,'','".AddSlashes(pg_fetch_result($resaco,0,'at72_codatend'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1901,11036,'','".AddSlashes(pg_fetch_result($resaco,0,'at72_tarefa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at72_id=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at72_id)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at72_id"])){ 
       $sql  .= $virgula." at72_id = $this->at72_id ";
       $virgula = ",";
       if(trim((string) $this->at72_id) == null ){ 
     ...
     if(trim((string) $this->at72_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at72_id_usuario"])){ 
       $sql  .= $virgula." at72_id_usuario = $this->at72_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->at72_id_usuario) == null ){ 
         $this->erro_sql = " Campo Cod. Usuário nao Informado.";
         $this->erro_campo = "at72_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at72_codtipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at72_codtipo"])){ 
       $sql  .= $virgula." at72_codtipo = $this->at72_codtipo ";
       $virgula = ",";
       if(trim((string) $this->at72_codtipo) == null ){ 
         $this->erro_sql = " Campo Código do tipo de Auseência nao Informado.";
         $this->erro_campo = "at72_codtipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at72_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at72_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["at72_data_dia"] !="") ){ 
       $sql  .= $virgula." at72_data = '$this->at72_data' ";
       $virgula = ",";
       if(trim((string) $this->at72_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "at72_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at72_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at72_hora"])){ 
       $sql  .= $virgula." at72_hora = '$this->at72_hora' ";
       $virgula = ",";
       if(trim((string) $this->at72_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "at72_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at72_codatend)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at72_codatend"])){ 
       $sql  .= $virgula." at72_codatend = $this->at72_codatend ";
       $virgula = ",";
       if(trim((string) $this->at72_codatend) == null ){ 
         $this->erro_sql = " Campo Atendimento nao Informado.";
         $this->erro_campo = "at72_codatend";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at72_tarefa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at72_tarefa"])){ 
       $sql  .= $virgula." at72_tarefa = $this->at72_tarefa ";
       $virgula = ",";
       if(trim((string) $this->at72_tarefa) == null ){ 
         $this->erro_sql = " Campo Codigo da Tarefa nao Informado.";
         $this->erro_campo = "at72_tarefa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at72_id"]))
           $resac = db_query("insert into db_acount values($acount,1901,11030,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at72_id'))."','$this->at72_id',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at72_id_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1901,11031,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at72_id_usuario'))."','$this->at72_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at72_codtipo"]))
           $resac = db_query("insert into db_acount values($acount,1901,11032,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at72_codtipo'))."','$this->at72_codtipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at72_data"]))
           $resac = db_query("insert into db_acount values($acount,1901,11033,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at72_data'))."','$this->at72_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at72_hora"]))
           $resac = db_query("insert into db_acount values($acount,1901,11034,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at72_hora'))."','$this->at72_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at72_codatend"]))
           $resac = db_query("insert into db_acount values($acount,1901,11035,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at72_codatend'))."','$this->at72_codatend',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at72_tarefa"]))
           $resac = db_query("insert into db_acount values($acount,1901,11036,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at72_tarefa'))."','$this->at72_tarefa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at72_id=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1901,11030,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at72_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1901,11031,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at72_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1901,11032,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at72_codtipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1901,11033,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at72_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1901,11034,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at72_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1901,11035,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at72_codatend'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1901,11036,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at72_tarefa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
