...
class cl_aidofautenticidade { 
   ...
   public $y01_sequencial = 0; 
   public $y01_aidof = 0; 
   public $y01_codautenticidade = null; 
   ...
   function incluir ($y01_sequencial){ 
     ...
     if($y01_sequencial == "" || $y01_sequencial == null ){
       ...
       $this->y01_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from aidofautenticidade_y01_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $y01_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1654,9614,'','".AddSlashes(pg_fetch_result($resaco,0,'y01_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1654,9613,'','".AddSlashes(pg_fetch_result($resaco,0,'y01_aidof'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1654,9612,'','".AddSlashes(pg_fetch_result($resaco,0,'y01_codautenticidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y01_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y01_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y01_sequencial"])){ 
       $sql  .= $virgula." y01_sequencial = $this->y01_sequencial ";
       $virgula = ",";
       if(trim((string) $this->y01_sequencial) == null ){ 
     ...
     if(trim((string) $this->y01_aidof)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y01_aidof"])){ 
       $sql  .= $virgula." y01_aidof = $this->y01_aidof ";
       $virgula = ",";
       if(trim((string) $this->y01_aidof) == null ){ 
         $this->erro_sql = " Campo Código da aidof nao Informado.";
         $this->erro_campo = "y01_aidof";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y01_codautenticidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y01_codautenticidade"])){ 
       $sql  .= $virgula." y01_codautenticidade = '$this->y01_codautenticidade' ";
       $virgula = ",";
       if(trim((string) $this->y01_codautenticidade) == null ){ 
         $this->erro_sql = " Campo Código de autenticidade nao Informado.";
         $this->erro_campo = "y01_codautenticidade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y01_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1654,9614,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y01_sequencial'))."','$this->y01_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y01_aidof"]))
           $resac = db_query("insert into db_acount values($acount,1654,9613,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y01_aidof'))."','$this->y01_aidof',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y01_codautenticidade"]))
           $resac = db_query("insert into db_acount values($acount,1654,9612,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y01_codautenticidade'))."','$this->y01_codautenticidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y01_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1654,9614,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y01_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1654,9613,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y01_aidof'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1654,9612,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y01_codautenticidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
