...
class cl_pctipocertifcom { 
   ...
   public $pc77_codigo = 0; 
   public $pc77_pctipocertif = 0; 
   public $pc77_liccomissao = 0; 
   ...
   function incluir ($pc77_codigo){ 
     ...
     if($pc77_codigo == "" || $pc77_codigo == null ){
       ...
       $this->pc77_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from pctipocertifcom_pc77_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $pc77_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1587,9238,'','".AddSlashes(pg_fetch_result($resaco,0,'pc77_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1587,9239,'','".AddSlashes(pg_fetch_result($resaco,0,'pc77_pctipocertif'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1587,9240,'','".AddSlashes(pg_fetch_result($resaco,0,'pc77_liccomissao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc77_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc77_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc77_codigo"])){ 
       $sql  .= $virgula." pc77_codigo = $this->pc77_codigo ";
       $virgula = ",";
       if(trim((string) $this->pc77_codigo) == null ){ 
     ...
     if(trim((string) $this->pc77_pctipocertif)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc77_pctipocertif"])){ 
       $sql  .= $virgula." pc77_pctipocertif = $this->pc77_pctipocertif ";
       $virgula = ",";
       if(trim((string) $this->pc77_pctipocertif) == null ){ 
         $this->erro_sql = " Campo Cod. Tipo Certificado nao Informado.";
         $this->erro_campo = "pc77_pctipocertif";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc77_liccomissao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc77_liccomissao"])){ 
       $sql  .= $virgula." pc77_liccomissao = $this->pc77_liccomissao ";
       $virgula = ",";
       if(trim((string) $this->pc77_liccomissao) == null ){ 
         $this->erro_sql = " Campo Código Comissão nao Informado.";
         $this->erro_campo = "pc77_liccomissao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc77_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1587,9238,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc77_codigo'))."','$this->pc77_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc77_pctipocertif"]))
           $resac = db_query("insert into db_acount values($acount,1587,9239,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc77_pctipocertif'))."','$this->pc77_pctipocertif',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc77_liccomissao"]))
           $resac = db_query("insert into db_acount values($acount,1587,9240,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc77_liccomissao'))."','$this->pc77_liccomissao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc77_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1587,9238,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc77_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1587,9239,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc77_pctipocertif'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1587,9240,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc77_liccomissao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
