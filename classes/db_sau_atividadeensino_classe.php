...
class cl_sau_atividadeensino { 
   ...
   public $sd38_i_cod_ativid = 0; 
   public $sd38_v_descricao = null; 
   ...
   function incluir ($sd38_i_cod_ativid){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1955,11406,'','".AddSlashes(pg_fetch_result($resaco,0,'sd38_i_cod_ativid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1955,11407,'','".AddSlashes(pg_fetch_result($resaco,0,'sd38_v_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd38_i_cod_ativid=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd38_i_cod_ativid)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd38_i_cod_ativid"])){ 
       $sql  .= $virgula." sd38_i_cod_ativid = $this->sd38_i_cod_ativid ";
       $virgula = ",";
       if(trim((string) $this->sd38_i_cod_ativid) == null ){ 
     ...
     if(trim((string) $this->sd38_v_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd38_v_descricao"])){ 
       $sql  .= $virgula." sd38_v_descricao = '$this->sd38_v_descricao' ";
       $virgula = ",";
       if(trim((string) $this->sd38_v_descricao) == null ){ 
         $this->erro_sql = " Campo Descricao nao Informado.";
         $this->erro_campo = "sd38_v_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd38_i_cod_ativid"]))
           $resac = db_query("insert into db_acount values($acount,1955,11406,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd38_i_cod_ativid'))."','$this->sd38_i_cod_ativid',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd38_v_descricao"]))
           $resac = db_query("insert into db_acount values($acount,1955,11407,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd38_v_descricao'))."','$this->sd38_v_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd38_i_cod_ativid=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1955,11406,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd38_i_cod_ativid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1955,11407,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd38_v_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
