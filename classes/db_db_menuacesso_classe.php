...
class cl_db_menuacesso { 
   ...
   public $db06_m_codigo = 0; 
   public $db06_idtipo = 0; 
   ...
   function incluir ($db06_m_codigo,$db06_idtipo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,521,3602,'','".AddSlashes(pg_fetch_result($resaco,0,'db06_m_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,521,3603,'','".AddSlashes(pg_fetch_result($resaco,0,'db06_idtipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db06_m_codigo=null,$db06_idtipo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db06_m_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db06_m_codigo"])){ 
        if(trim((string) $this->db06_m_codigo)=="" && isset($GLOBALS["HTTP_POST_VARS"]["db06_m_codigo"])){ 
           $this->db06_m_codigo = "0" ; 
        } 
       $sql  .= $virgula." db06_m_codigo = $this->db06_m_codigo ";
       $virgula = ",";
       if(trim((string) $this->db06_m_codigo) == null ){ 
     ...
     if(trim((string) $this->db06_idtipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db06_idtipo"])){ 
        if(trim((string) $this->db06_idtipo)=="" && isset($GLOBALS["HTTP_POST_VARS"]["db06_idtipo"])){ 
           $this->db06_idtipo = "0" ; 
        } 
       $sql  .= $virgula." db06_idtipo = $this->db06_idtipo ";
       $virgula = ",";
       if(trim((string) $this->db06_idtipo) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db06_m_codigo"]))
           $resac = db_query("insert into db_acount values($acount,521,3602,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db06_m_codigo'))."','$this->db06_m_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db06_idtipo"]))
           $resac = db_query("insert into db_acount values($acount,521,3603,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db06_idtipo'))."','$this->db06_idtipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db06_m_codigo=null,$db06_idtipo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,521,3602,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db06_m_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,521,3603,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db06_idtipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
