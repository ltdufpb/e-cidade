...
class cl_pcorcamdescla {
   ...
   public $pc32_orcamitem = 0;
   public $pc32_orcamforne = 0;
   public $pc32_motivo = null;
   ...
   function incluir ($pc32_orcamitem,$pc32_orcamforne){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1326,7910,'','".AddSlashes(pg_fetch_result($resaco,0,'pc32_orcamitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1326,7911,'','".AddSlashes(pg_fetch_result($resaco,0,'pc32_orcamforne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1326,7912,'','".AddSlashes(pg_fetch_result($resaco,0,'pc32_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($pc32_orcamitem=null,$pc32_orcamforne=null) {
     ...
     $virgula = "";
     if(trim((string) $this->pc32_orcamitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc32_orcamitem"])){
       $sql  .= $virgula." pc32_orcamitem = $this->pc32_orcamitem ";
       $virgula = ",";
       if(trim((string) $this->pc32_orcamitem) == null ){
     ...
     if(trim((string) $this->pc32_orcamforne)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc32_orcamforne"])){
       $sql  .= $virgula." pc32_orcamforne = $this->pc32_orcamforne ";
       $virgula = ",";
       if(trim((string) $this->pc32_orcamforne) == null ){
     ...
     if(trim((string) $this->pc32_motivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc32_motivo"])){
       $sql  .= $virgula." pc32_motivo = '$this->pc32_motivo' ";
       $virgula = ",";
       if(trim((string) $this->pc32_motivo) == null ){
         $this->erro_sql = " Campo Motivo da desclassificação nao Informado.";
         $this->erro_campo = "pc32_motivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc32_orcamitem"]))
           $resac = db_query("insert into db_acount values($acount,1326,7910,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc32_orcamitem'))."','$this->pc32_orcamitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc32_orcamforne"]))
           $resac = db_query("insert into db_acount values($acount,1326,7911,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc32_orcamforne'))."','$this->pc32_orcamforne',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc32_motivo"]))
           $resac = db_query("insert into db_acount values($acount,1326,7912,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc32_motivo'))."','$this->pc32_motivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($pc32_orcamitem=null,$pc32_orcamforne=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1326,7910,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc32_orcamitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1326,7911,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc32_orcamforne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1326,7912,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc32_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
