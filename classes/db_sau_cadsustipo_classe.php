...
class cl_sau_cadsustipo { 
   ...
   public $s138_i_codigo = 0; 
   public $s138_b_tipo = 'f'; 
   public $s138_c_descr = null; 
   ...
   function incluir ($s138_i_codigo){ 
     ...
     if($s138_i_codigo == "" || $s138_i_codigo == null ){
       ...
       $this->s138_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from sau_cadsustipo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $s138_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2584,14702,'','".AddSlashes(pg_fetch_result($resaco,0,'s138_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2584,14704,'','".AddSlashes(pg_fetch_result($resaco,0,'s138_b_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2584,14703,'','".AddSlashes(pg_fetch_result($resaco,0,'s138_c_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($s138_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->s138_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s138_i_codigo"])){ 
       $sql  .= $virgula." s138_i_codigo = $this->s138_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->s138_i_codigo) == null ){ 
     ...
     if(trim((string) $this->s138_b_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s138_b_tipo"])){ 
       $sql  .= $virgula." s138_b_tipo = '$this->s138_b_tipo' ";
       $virgula = ",";
       if(trim((string) $this->s138_b_tipo) == null ){ 
         $this->erro_sql = " Campo estado nao Informado.";
         $this->erro_campo = "s138_b_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s138_c_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s138_c_descr"])){ 
       $sql  .= $virgula." s138_c_descr = '$this->s138_c_descr' ";
       $virgula = ",";
       if(trim((string) $this->s138_c_descr) == null ){ 
         $this->erro_sql = " Campo descrição nao Informado.";
         $this->erro_campo = "s138_c_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s138_i_codigo"]) || $this->s138_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2584,14702,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s138_i_codigo'))."','$this->s138_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s138_b_tipo"]) || $this->s138_b_tipo != "")
           $resac = db_query("insert into db_acount values($acount,2584,14704,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s138_b_tipo'))."','$this->s138_b_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s138_c_descr"]) || $this->s138_c_descr != "")
           $resac = db_query("insert into db_acount values($acount,2584,14703,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s138_c_descr'))."','$this->s138_c_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($s138_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2584,14702,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s138_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2584,14704,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s138_b_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2584,14703,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s138_c_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
