...
class cl_retencaotiporeccgm { 
   ...
   public $e48_sequencial = 0; 
   public $e48_retencaotiporec = 0; 
   public $e48_cgm = 0; 
   ...
   function incluir ($e48_sequencial){ 
     ...
     if($e48_sequencial == "" || $e48_sequencial == null ){
       ...
       $this->e48_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from retencaotiporeccgm_e48_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $e48_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2546,14439,'','".AddSlashes(pg_fetch_result($resaco,0,'e48_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2546,14441,'','".AddSlashes(pg_fetch_result($resaco,0,'e48_retencaotiporec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2546,14440,'','".AddSlashes(pg_fetch_result($resaco,0,'e48_cgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e48_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e48_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e48_sequencial"])){ 
       $sql  .= $virgula." e48_sequencial = $this->e48_sequencial ";
       $virgula = ",";
       if(trim((string) $this->e48_sequencial) == null ){ 
     ...
     if(trim((string) $this->e48_retencaotiporec)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e48_retencaotiporec"])){ 
       $sql  .= $virgula." e48_retencaotiporec = $this->e48_retencaotiporec ";
       $virgula = ",";
       if(trim((string) $this->e48_retencaotiporec) == null ){ 
         $this->erro_sql = " Campo Retenção nao Informado.";
         $this->erro_campo = "e48_retencaotiporec";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e48_cgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e48_cgm"])){ 
       $sql  .= $virgula." e48_cgm = $this->e48_cgm ";
       $virgula = ",";
       if(trim((string) $this->e48_cgm) == null ){ 
         $this->erro_sql = " Campo CGM nao Informado.";
         $this->erro_campo = "e48_cgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e48_sequencial"]) || $this->e48_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2546,14439,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e48_sequencial'))."','$this->e48_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e48_retencaotiporec"]) || $this->e48_retencaotiporec != "")
           $resac = db_query("insert into db_acount values($acount,2546,14441,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e48_retencaotiporec'))."','$this->e48_retencaotiporec',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e48_cgm"]) || $this->e48_cgm != "")
           $resac = db_query("insert into db_acount values($acount,2546,14440,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e48_cgm'))."','$this->e48_cgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e48_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2546,14439,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e48_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2546,14441,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e48_retencaotiporec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2546,14440,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e48_cgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
