...
class cl_historico {
   ...
   public $ed61_i_codigo = 0;
   public $ed61_i_escola = 0;
   public $ed61_i_aluno = 0;
   public $ed61_i_curso = 0;
   public $ed61_t_obs = null;
   public $ed61_i_anoconc = 0;
   public $ed61_i_periodoconc = 0;
   ...
   function incluir ($ed61_i_codigo){
     ...
     if($ed61_i_codigo == "" || $ed61_i_codigo == null ){
       ...
       $this->ed61_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from historico_ed61_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed61_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010129,1008744,'','".AddSlashes(pg_fetch_result($resaco,0,'ed61_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010129,1008745,'','".AddSlashes(pg_fetch_result($resaco,0,'ed61_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010129,1008746,'','".AddSlashes(pg_fetch_result($resaco,0,'ed61_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010129,1008747,'','".AddSlashes(pg_fetch_result($resaco,0,'ed61_i_curso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010129,1008748,'','".AddSlashes(pg_fetch_result($resaco,0,'ed61_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010129,1008749,'','".AddSlashes(pg_fetch_result($resaco,0,'ed61_i_anoconc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010129,1008750,'','".AddSlashes(pg_fetch_result($resaco,0,'ed61_i_periodoconc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($ed61_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->ed61_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed61_i_codigo"])){
       $sql  .= $virgula." ed61_i_codigo = $this->ed61_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed61_i_codigo) == null ){
     ...
     if(trim((string) $this->ed61_i_escola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed61_i_escola"])){
       $sql  .= $virgula." ed61_i_escola = $this->ed61_i_escola ";
       $virgula = ",";
       if(trim((string) $this->ed61_i_escola) == null ){
         $this->erro_sql = " Campo Escola nao Informado.";
         $this->erro_campo = "ed61_i_escola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed61_i_aluno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed61_i_aluno"])){
       $sql  .= $virgula." ed61_i_aluno = $this->ed61_i_aluno ";
       $virgula = ",";
       if(trim((string) $this->ed61_i_aluno) == null ){
         $this->erro_sql = " Campo Aluno nao Informado.";
         $this->erro_campo = "ed61_i_aluno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed61_i_curso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed61_i_curso"])){
       $sql  .= $virgula." ed61_i_curso = $this->ed61_i_curso ";
       $virgula = ",";
       if(trim((string) $this->ed61_i_curso) == null ){
         $this->erro_sql = " Campo Curso nao Informado.";
         $this->erro_campo = "ed61_i_curso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed61_t_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed61_t_obs"])){
       $sql  .= $virgula." ed61_t_obs = '$this->ed61_t_obs' ";
       $virgula = ",";
     }
     if(trim((string) $this->ed61_i_anoconc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed61_i_anoconc"])){
        if(trim((string) $this->ed61_i_anoconc)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed61_i_anoconc"])){
           $this->ed61_i_anoconc = "null" ;
        }
     ...
     if(trim((string) $this->ed61_i_periodoconc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed61_i_periodoconc"])){
        if(trim((string) $this->ed61_i_periodoconc)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed61_i_periodoconc"])){
           $this->ed61_i_periodoconc = "null" ;
        }
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed61_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010129,1008744,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed61_i_codigo'))."','$this->ed61_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed61_i_escola"]))
           $resac = db_query("insert into db_acount values($acount,1010129,1008745,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed61_i_escola'))."','$this->ed61_i_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed61_i_aluno"]))
           $resac = db_query("insert into db_acount values($acount,1010129,1008746,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed61_i_aluno'))."','$this->ed61_i_aluno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed61_i_curso"]))
           $resac = db_query("insert into db_acount values($acount,1010129,1008747,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed61_i_curso'))."','$this->ed61_i_curso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed61_t_obs"]))
           $resac = db_query("insert into db_acount values($acount,1010129,1008748,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed61_t_obs'))."','$this->ed61_t_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed61_i_anoconc"]))
           $resac = db_query("insert into db_acount values($acount,1010129,1008749,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed61_i_anoconc'))."','$this->ed61_i_anoconc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed61_i_periodoconc"]))
           $resac = db_query("insert into db_acount values($acount,1010129,1008750,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed61_i_periodoconc'))."','$this->ed61_i_periodoconc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($ed61_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010129,1008744,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed61_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010129,1008745,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed61_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010129,1008746,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed61_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010129,1008747,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed61_i_curso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010129,1008748,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed61_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010129,1008749,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed61_i_anoconc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010129,1008750,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed61_i_periodoconc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
