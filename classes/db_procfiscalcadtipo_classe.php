...
class cl_procfiscalcadtipo { 
   ...
   function incluir ($y33_sequencial){ 
     ...
     if($y33_sequencial == "" || $y33_sequencial == null ){
       ...
       $this->y33_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from procfiscalcadtipo_y33_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $y33_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2081,12022,'','".AddSlashes(pg_fetch_result($resaco,0,'y33_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2081,12023,'','".AddSlashes(pg_fetch_result($resaco,0,'y33_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2081,12024,'','".AddSlashes(pg_fetch_result($resaco,0,'y33_validade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y33_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y33_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y33_sequencial"])){ 
       $sql  .= $virgula." y33_sequencial = $this->y33_sequencial ";
       $virgula = ",";
       if(trim((string) $this->y33_sequencial) == null ){ 
     ...
     if(trim((string) $this->y33_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y33_descricao"])){ 
       $sql  .= $virgula." y33_descricao = '$this->y33_descricao' ";
       $virgula = ",";
       if(trim((string) $this->y33_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "y33_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y33_validade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y33_validade_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["y33_validade_dia"] !="") ){ 
       $sql  .= $virgula." y33_validade = '$this->y33_validade' ";
       $virgula = ",";
       if(trim((string) $this->y33_validade) == null ){ 
         $this->erro_sql = " Campo Valido nao Informado.";
         $this->erro_campo = "y33_validade_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y33_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2081,12022,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y33_sequencial'))."','$this->y33_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y33_descricao"]))
           $resac = db_query("insert into db_acount values($acount,2081,12023,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y33_descricao'))."','$this->y33_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y33_validade"]))
           $resac = db_query("insert into db_acount values($acount,2081,12024,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y33_validade'))."','$this->y33_validade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y33_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2081,12022,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y33_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2081,12023,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y33_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2081,12024,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y33_validade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
