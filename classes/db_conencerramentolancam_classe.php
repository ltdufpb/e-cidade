...
class cl_conencerramentolancam {
   ...
   public $c44_sequencial = 0;
   public $c44_encerramento = 0;
   public $c44_conlancam = 0;
   ...
   function incluir ($c44_sequencial){
     ...
     if($c44_sequencial == "" || $c44_sequencial == null ){
       ...
       $this->c44_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from conencerramentolancam_c44_sequncial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $c44_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1856,10776,'','".AddSlashes(pg_fetch_result($resaco,0,'c44_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1856,10777,'','".AddSlashes(pg_fetch_result($resaco,0,'c44_encerramento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1856,10778,'','".AddSlashes(pg_fetch_result($resaco,0,'c44_conlancam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($c44_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->c44_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c44_sequencial"])){
       $sql  .= $virgula." c44_sequencial = $this->c44_sequencial ";
       $virgula = ",";
       if(trim((string) $this->c44_sequencial) == null ){
     ...
     if(trim((string) $this->c44_encerramento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c44_encerramento"])){
       $sql  .= $virgula." c44_encerramento = $this->c44_encerramento ";
       $virgula = ",";
       if(trim((string) $this->c44_encerramento) == null ){
         $this->erro_sql = " Campo Código do  Encerramento nao Informado.";
         $this->erro_campo = "c44_encerramento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c44_conlancam)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c44_conlancam"])){
       $sql  .= $virgula." c44_conlancam = $this->c44_conlancam ";
       $virgula = ",";
       if(trim((string) $this->c44_conlancam) == null ){
         $this->erro_sql = " Campo Código do Lançamento nao Informado.";
         $this->erro_campo = "c44_conlancam";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c44_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1856,10776,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c44_sequencial'))."','$this->c44_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c44_encerramento"]))
           $resac = db_query("insert into db_acount values($acount,1856,10777,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c44_encerramento'))."','$this->c44_encerramento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c44_conlancam"]))
           $resac = db_query("insert into db_acount values($acount,1856,10778,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c44_conlancam'))."','$this->c44_conlancam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($c44_sequencial=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1856,10776,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c44_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1856,10777,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c44_encerramento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1856,10778,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c44_conlancam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
