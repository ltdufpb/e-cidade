...
class cl_matestoqueinimeiari { 
   ...
   public $m49_codigo = 0; 
   public $m49_codatendrequiitem = 0; 
   public $m49_codmatestoqueinimei = 0; 
   ...
   function incluir ($m49_codigo){ 
     ...
     if($m49_codigo == "" || $m49_codigo == null ){
       ...
       $this->m49_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from matestoqueinimeiari_m49_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $m49_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1150,6954,'','".AddSlashes(pg_fetch_result($resaco,0,'m49_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1150,6955,'','".AddSlashes(pg_fetch_result($resaco,0,'m49_codatendrequiitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1150,6956,'','".AddSlashes(pg_fetch_result($resaco,0,'m49_codmatestoqueinimei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($m49_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->m49_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m49_codigo"])){ 
       $sql  .= $virgula." m49_codigo = $this->m49_codigo ";
       $virgula = ",";
       if(trim((string) $this->m49_codigo) == null ){ 
     ...
     if(trim((string) $this->m49_codatendrequiitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m49_codatendrequiitem"])){ 
       $sql  .= $virgula." m49_codatendrequiitem = $this->m49_codatendrequiitem ";
       $virgula = ",";
       if(trim((string) $this->m49_codatendrequiitem) == null ){ 
         $this->erro_sql = " Campo Código item do atendimento nao Informado.";
         $this->erro_campo = "m49_codatendrequiitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m49_codmatestoqueinimei)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m49_codmatestoqueinimei"])){ 
       $sql  .= $virgula." m49_codmatestoqueinimei = $this->m49_codmatestoqueinimei ";
       $virgula = ",";
       if(trim((string) $this->m49_codmatestoqueinimei) == null ){ 
         $this->erro_sql = " Campo Código matestoqueinimei nao Informado.";
         $this->erro_campo = "m49_codmatestoqueinimei";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["m49_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1150,6954,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m49_codigo'))."','$this->m49_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m49_codatendrequiitem"]))
           $resac = db_query("insert into db_acount values($acount,1150,6955,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m49_codatendrequiitem'))."','$this->m49_codatendrequiitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m49_codmatestoqueinimei"]))
           $resac = db_query("insert into db_acount values($acount,1150,6956,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m49_codmatestoqueinimei'))."','$this->m49_codmatestoqueinimei',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($m49_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1150,6954,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m49_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1150,6955,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m49_codatendrequiitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1150,6956,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m49_codmatestoqueinimei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
