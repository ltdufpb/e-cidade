...
class cl_solicitemveic { 
   ...
   public $pc14_sequencial = 0; 
   public $pc14_solicitem = 0; 
   public $pc14_veiculos = 0; 
   ...
   function incluir ($pc14_sequencial){ 
     ...
     if($pc14_sequencial == "" || $pc14_sequencial == null ){
       ...
       $this->pc14_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from solicitemveic_pc14_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $pc14_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1973,11470,'','".AddSlashes(pg_fetch_result($resaco,0,'pc14_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1973,11471,'','".AddSlashes(pg_fetch_result($resaco,0,'pc14_solicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1973,11472,'','".AddSlashes(pg_fetch_result($resaco,0,'pc14_veiculos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc14_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc14_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc14_sequencial"])){ 
       $sql  .= $virgula." pc14_sequencial = $this->pc14_sequencial ";
       $virgula = ",";
       if(trim((string) $this->pc14_sequencial) == null ){ 
     ...
     if(trim((string) $this->pc14_solicitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc14_solicitem"])){ 
       $sql  .= $virgula." pc14_solicitem = $this->pc14_solicitem ";
       $virgula = ",";
       if(trim((string) $this->pc14_solicitem) == null ){ 
         $this->erro_sql = " Campo Codigo nao Informado.";
         $this->erro_campo = "pc14_solicitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc14_veiculos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc14_veiculos"])){ 
       $sql  .= $virgula." pc14_veiculos = $this->pc14_veiculos ";
       $virgula = ",";
       if(trim((string) $this->pc14_veiculos) == null ){ 
         $this->erro_sql = " Campo Veiculos nao Informado.";
         $this->erro_campo = "pc14_veiculos";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc14_sequencial"]) || $this->pc14_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,1973,11470,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc14_sequencial'))."','$this->pc14_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc14_solicitem"]) || $this->pc14_solicitem != "")
           $resac = db_query("insert into db_acount values($acount,1973,11471,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc14_solicitem'))."','$this->pc14_solicitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc14_veiculos"]) || $this->pc14_veiculos != "")
           $resac = db_query("insert into db_acount values($acount,1973,11472,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc14_veiculos'))."','$this->pc14_veiculos',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc14_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1973,11470,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc14_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1973,11471,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc14_solicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1973,11472,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc14_veiculos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
