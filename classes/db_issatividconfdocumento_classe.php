...
class cl_issatividconfdocumento { 
   ...
   public $q119_sequencial = 0; 
   public $q119_ativid = 0; 
   public $q119_caddocumento = 0; 
   ...
   function incluir ($q119_sequencial) { 
     ...
     if($q119_sequencial == "" || $q119_sequencial == null ){
       ...
       $this->q119_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from issatividconfdocumento_q119_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q119_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3241,18320,'','".AddSlashes(pg_fetch_result($resaco,0,'q119_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3241,18322,'','".AddSlashes(pg_fetch_result($resaco,0,'q119_ativid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3241,18321,'','".AddSlashes(pg_fetch_result($resaco,0,'q119_caddocumento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q119_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q119_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q119_sequencial"])){ 
       $sql  .= $virgula." q119_sequencial = $this->q119_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q119_sequencial) == null ){ 
     ...
     if(trim((string) $this->q119_ativid)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q119_ativid"])){ 
       $sql  .= $virgula." q119_ativid = $this->q119_ativid ";
       $virgula = ",";
       if(trim((string) $this->q119_ativid) == null ){ 
         $this->erro_sql = " Campo Código da Atividade nao Informado.";
         $this->erro_campo = "q119_ativid";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q119_caddocumento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q119_caddocumento"])){ 
       $sql  .= $virgula." q119_caddocumento = $this->q119_caddocumento ";
       $virgula = ",";
       if(trim((string) $this->q119_caddocumento) == null ){ 
         $this->erro_sql = " Campo Código do Documento nao Informado.";
         $this->erro_campo = "q119_caddocumento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q119_sequencial"]) || $this->q119_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3241,18320,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q119_sequencial'))."','$this->q119_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q119_ativid"]) || $this->q119_ativid != "")
           $resac = db_query("insert into db_acount values($acount,3241,18322,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q119_ativid'))."','$this->q119_ativid',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q119_caddocumento"]) || $this->q119_caddocumento != "")
           $resac = db_query("insert into db_acount values($acount,3241,18321,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q119_caddocumento'))."','$this->q119_caddocumento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q119_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3241,18320,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q119_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3241,18322,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q119_ativid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3241,18321,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q119_caddocumento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
