...
class cl_orctiporecconveniosolicita { 
   ...
   public $o78_sequencial = 0; 
   public $o78_solicita = 0; 
   public $o78_pactoplano = 0; 
   ...
   function incluir ($o78_sequencial){ 
     ...
     if($o78_sequencial == "" || $o78_sequencial == null ){
       ...
       $this->o78_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from orctiporecconveniosolicita_o78_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $o78_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2440,13884,'','".AddSlashes(pg_fetch_result($resaco,0,'o78_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2440,13885,'','".AddSlashes(pg_fetch_result($resaco,0,'o78_solicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2440,13887,'','".AddSlashes(pg_fetch_result($resaco,0,'o78_pactoplano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o78_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o78_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o78_sequencial"])){ 
       $sql  .= $virgula." o78_sequencial = $this->o78_sequencial ";
       $virgula = ",";
       if(trim((string) $this->o78_sequencial) == null ){ 
     ...
     if(trim((string) $this->o78_solicita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o78_solicita"])){ 
       $sql  .= $virgula." o78_solicita = $this->o78_solicita ";
       $virgula = ",";
       if(trim((string) $this->o78_solicita) == null ){ 
         $this->erro_sql = " Campo Solicitação nao Informado.";
         $this->erro_campo = "o78_solicita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o78_pactoplano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o78_pactoplano"])){ 
       $sql  .= $virgula." o78_pactoplano = $this->o78_pactoplano ";
       $virgula = ",";
       if(trim((string) $this->o78_pactoplano) == null ){ 
         $this->erro_sql = " Campo Código Plano nao Informado.";
         $this->erro_campo = "o78_pactoplano";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o78_sequencial"]) || $this->o78_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2440,13884,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o78_sequencial'))."','$this->o78_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o78_solicita"]) || $this->o78_solicita != "")
           $resac = db_query("insert into db_acount values($acount,2440,13885,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o78_solicita'))."','$this->o78_solicita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o78_pactoplano"]) || $this->o78_pactoplano != "")
           $resac = db_query("insert into db_acount values($acount,2440,13887,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o78_pactoplano'))."','$this->o78_pactoplano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o78_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2440,13884,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o78_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2440,13885,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o78_solicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2440,13887,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o78_pactoplano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
