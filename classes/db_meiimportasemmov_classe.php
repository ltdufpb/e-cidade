...
class cl_meiimportasemmov { 
   ...
   public $q114_meiimporta = 0; 
   public $q114_motivo = null; 
   ...
   function incluir ($q114_sequencial){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2923,16632,'','".AddSlashes(pg_fetch_result($resaco,0,'q114_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2923,16633,'','".AddSlashes(pg_fetch_result($resaco,0,'q114_meiimporta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2923,16634,'','".AddSlashes(pg_fetch_result($resaco,0,'q114_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q114_sequencial=null) { 
     ...
     if(trim((string) $this->q114_meiimporta)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q114_meiimporta"])){ 
       $sql  .= $virgula." q114_meiimporta = $this->q114_meiimporta ";
       $virgula = ",";
       if(trim((string) $this->q114_meiimporta) == null ){ 
         $this->erro_sql = " Campo Código de Importação do MEI nao Informado.";
         $this->erro_campo = "q114_meiimporta";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q114_motivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q114_motivo"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q114_sequencial"]) || $this->q114_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2923,16632,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q114_sequencial'))."','$this->q114_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q114_meiimporta"]) || $this->q114_meiimporta != "")
           $resac = db_query("insert into db_acount values($acount,2923,16633,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q114_meiimporta'))."','$this->q114_meiimporta',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q114_motivo"]) || $this->q114_motivo != "")
           $resac = db_query("insert into db_acount values($acount,2923,16634,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q114_motivo'))."','$this->q114_motivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q114_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2923,16632,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q114_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2923,16633,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q114_meiimporta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2923,16634,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q114_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
