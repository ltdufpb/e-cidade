...
class cl_aguacalcval { 
   ...
   public $x23_codcalc = 0; 
   public $x23_codconsumotipo = 0; 
   public $x23_valor = 0; 
   ...
   function incluir ($x23_codcalc,$x23_codconsumotipo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1444,8499,'','".AddSlashes(pg_fetch_result($resaco,0,'x23_codcalc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1444,8500,'','".AddSlashes(pg_fetch_result($resaco,0,'x23_codconsumotipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1444,8501,'','".AddSlashes(pg_fetch_result($resaco,0,'x23_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($x23_codcalc=null,$x23_codconsumotipo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->x23_codcalc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x23_codcalc"])){ 
       $sql  .= $virgula." x23_codcalc = $this->x23_codcalc ";
       $virgula = ",";
       if(trim((string) $this->x23_codcalc) == null ){ 
     ...
     if(trim((string) $this->x23_codconsumotipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x23_codconsumotipo"])){ 
       $sql  .= $virgula." x23_codconsumotipo = $this->x23_codconsumotipo ";
       $virgula = ",";
       if(trim((string) $this->x23_codconsumotipo) == null ){ 
         $this->erro_sql = " Campo Codigo nao Informado.";
     ...
     if(trim((string) $this->x23_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x23_valor"])){ 
       $sql  .= $virgula." x23_valor = $this->x23_valor ";
       $virgula = ",";
       if(trim((string) $this->x23_valor) == null ){ 
         $this->erro_sql = " Campo Valor nao Informado.";
         $this->erro_campo = "x23_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x23_codcalc"]))
           $resac = db_query("insert into db_acount values($acount,1444,8499,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x23_codcalc'))."','$this->x23_codcalc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x23_codconsumotipo"]))
           $resac = db_query("insert into db_acount values($acount,1444,8500,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x23_codconsumotipo'))."','$this->x23_codconsumotipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x23_valor"]))
           $resac = db_query("insert into db_acount values($acount,1444,8501,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x23_valor'))."','$this->x23_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($x23_codcalc=null,$x23_codconsumotipo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1444,8499,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x23_codcalc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1444,8500,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x23_codconsumotipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1444,8501,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x23_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
