...
class cl_rhresponsavelregist { 
   ...
   public $rh108_sequencial = 0; 
   public $rh108_regist = 0; 
   public $rh108_rhresponsavel = 0; 
   public $rh108_status = 'f'; 
   ...
   function incluir ($rh108_sequencial){ 
     ...
     if($rh108_sequencial == "" || $rh108_sequencial == null ){
       ...
       $this->rh108_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhresponsavelregist_rh108_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh108_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3201,18094,'','".AddSlashes(pg_fetch_result($resaco,0,'rh108_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3201,18095,'','".AddSlashes(pg_fetch_result($resaco,0,'rh108_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3201,18096,'','".AddSlashes(pg_fetch_result($resaco,0,'rh108_rhresponsavel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3201,18097,'','".AddSlashes(pg_fetch_result($resaco,0,'rh108_status'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh108_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh108_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh108_sequencial"])){ 
       $sql  .= $virgula." rh108_sequencial = $this->rh108_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh108_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh108_regist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh108_regist"])){ 
       $sql  .= $virgula." rh108_regist = $this->rh108_regist ";
       $virgula = ",";
       if(trim((string) $this->rh108_regist) == null ){ 
         $this->erro_sql = " Campo Matricula nao Informado.";
         $this->erro_campo = "rh108_regist";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh108_rhresponsavel)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh108_rhresponsavel"])){ 
       $sql  .= $virgula." rh108_rhresponsavel = $this->rh108_rhresponsavel ";
       $virgula = ",";
       if(trim((string) $this->rh108_rhresponsavel) == null ){ 
         $this->erro_sql = " Campo Responsável nao Informado.";
         $this->erro_campo = "rh108_rhresponsavel";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh108_status)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh108_status"])){ 
       $sql  .= $virgula." rh108_status = '$this->rh108_status' ";
       $virgula = ",";
       if(trim((string) $this->rh108_status) == null ){ 
         $this->erro_sql = " Campo Status nao Informado.";
         $this->erro_campo = "rh108_status";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh108_sequencial"]) || $this->rh108_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3201,18094,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh108_sequencial'))."','$this->rh108_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh108_regist"]) || $this->rh108_regist != "")
           $resac = db_query("insert into db_acount values($acount,3201,18095,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh108_regist'))."','$this->rh108_regist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh108_rhresponsavel"]) || $this->rh108_rhresponsavel != "")
           $resac = db_query("insert into db_acount values($acount,3201,18096,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh108_rhresponsavel'))."','$this->rh108_rhresponsavel',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh108_status"]) || $this->rh108_status != "")
           $resac = db_query("insert into db_acount values($acount,3201,18097,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh108_status'))."','$this->rh108_status',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh108_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3201,18094,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh108_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3201,18095,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh108_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3201,18096,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh108_rhresponsavel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3201,18097,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh108_status'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
