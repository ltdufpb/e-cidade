...
class cl_modcarne { 
   ...
   public $k05_sequencial = 0; 
   public $k05_codigo = 0; 
   public $k05_tipo = 0; 
   public $k05_modcarne = 0; 
   ...
   function incluir ($k05_sequencial){ 
     ...
     if($k05_sequencial == "" || $k05_sequencial == null ){
       ...
       $this->k05_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from modcarne_k05_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k05_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1465,8614,'','".AddSlashes(pg_fetch_result($resaco,0,'k05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1465,8612,'','".AddSlashes(pg_fetch_result($resaco,0,'k05_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1465,8611,'','".AddSlashes(pg_fetch_result($resaco,0,'k05_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1465,8613,'','".AddSlashes(pg_fetch_result($resaco,0,'k05_modcarne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k05_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k05_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k05_sequencial"])){ 
       $sql  .= $virgula." k05_sequencial = $this->k05_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k05_sequencial) == null ){ 
     ...
     if(trim((string) $this->k05_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k05_codigo"])){ 
       $sql  .= $virgula." k05_codigo = $this->k05_codigo ";
       $virgula = ",";
       if(trim((string) $this->k05_codigo) == null ){ 
         $this->erro_sql = " Campo codigo da instituicao nao Informado.";
         $this->erro_campo = "k05_codigo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k05_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k05_tipo"])){ 
       $sql  .= $virgula." k05_tipo = $this->k05_tipo ";
       $virgula = ",";
       if(trim((string) $this->k05_tipo) == null ){ 
         $this->erro_sql = " Campo tipo de debito nao Informado.";
         $this->erro_campo = "k05_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k05_modcarne)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k05_modcarne"])){ 
       $sql  .= $virgula." k05_modcarne = $this->k05_modcarne ";
       $virgula = ",";
       if(trim((string) $this->k05_modcarne) == null ){ 
         $this->erro_sql = " Campo Modelo do carne nao Informado.";
         $this->erro_campo = "k05_modcarne";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k05_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1465,8614,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k05_sequencial'))."','$this->k05_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k05_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1465,8612,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k05_codigo'))."','$this->k05_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k05_tipo"]))
           $resac = db_query("insert into db_acount values($acount,1465,8611,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k05_tipo'))."','$this->k05_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k05_modcarne"]))
           $resac = db_query("insert into db_acount values($acount,1465,8613,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k05_modcarne'))."','$this->k05_modcarne',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k05_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1465,8614,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1465,8612,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k05_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1465,8611,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k05_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1465,8613,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k05_modcarne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
