...
class cl_infracaotransito { 
   ...
   public $i05_sequencial = 0; 
   public $i05_codigo = null; 
   public $i05_nivel = 0; 
   public $i05_descricao = null; 
   ...
   function incluir ($i05_sequencial){ 
     ...
     if($i05_sequencial == "" || $i05_sequencial == null ){
       ...
       $this->i05_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from infracaotransito_i05_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $i05_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,1010224,1009422,'','".AddSlashes(pg_fetch_result($resaco,0,'i05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010224,1009425,'','".AddSlashes(pg_fetch_result($resaco,0,'i05_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010224,1009423,'','".AddSlashes(pg_fetch_result($resaco,0,'i05_nivel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010224,1009424,'','".AddSlashes(pg_fetch_result($resaco,0,'i05_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($i05_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->i05_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["i05_sequencial"])){ 
       $sql  .= $virgula." i05_sequencial = $this->i05_sequencial ";
       $virgula = ",";
       if(trim((string) $this->i05_sequencial) == null ){ 
     ...
     if(trim((string) $this->i05_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["i05_codigo"])){ 
       $sql  .= $virgula." i05_codigo = '$this->i05_codigo' ";
       $virgula = ",";
       if(trim((string) $this->i05_codigo) == null ){ 
         $this->erro_sql = " Campo Código da Infração não informado.";
         $this->erro_campo = "i05_codigo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->i05_nivel)!="" || isset($GLOBALS["HTTP_POST_VARS"]["i05_nivel"])){ 
       $sql  .= $virgula." i05_nivel = $this->i05_nivel ";
       $virgula = ",";
       if(trim((string) $this->i05_nivel) == null ){ 
         $this->erro_sql = " Campo Código do Nível não informado.";
         $this->erro_campo = "i05_nivel";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->i05_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["i05_descricao"])){ 
       $sql  .= $virgula." i05_descricao = '$this->i05_descricao' ";
       $virgula = ",";
       if(trim((string) $this->i05_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição não informado.";
         $this->erro_campo = "i05_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["i05_sequencial"]) || $this->i05_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,1010224,1009422,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'i05_sequencial'))."','$this->i05_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["i05_codigo"]) || $this->i05_codigo != "")
             $resac = db_query("insert into db_acount values($acount,1010224,1009425,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'i05_codigo'))."','$this->i05_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["i05_nivel"]) || $this->i05_nivel != "")
             $resac = db_query("insert into db_acount values($acount,1010224,1009423,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'i05_nivel'))."','$this->i05_nivel',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["i05_descricao"]) || $this->i05_descricao != "")
             $resac = db_query("insert into db_acount values($acount,1010224,1009424,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'i05_descricao'))."','$this->i05_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,1010224,1009422,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'i05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010224,1009425,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'i05_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010224,1009423,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'i05_nivel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010224,1009424,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'i05_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
