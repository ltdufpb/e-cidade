...
class cl_matestoqueitemunid { 
   ...
   public $m75_codmatestoqueitem = 0; 
   public $m75_codmatunid = 0; 
   public $m75_quant = 0; 
   public $m75_quantmult = 0; 
   ...
   function incluir ($m75_codmatestoqueitem){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1152,6960,'','".AddSlashes(pg_fetch_result($resaco,0,'m75_codmatestoqueitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1152,6961,'','".AddSlashes(pg_fetch_result($resaco,0,'m75_codmatunid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1152,6962,'','".AddSlashes(pg_fetch_result($resaco,0,'m75_quant'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1152,6963,'','".AddSlashes(pg_fetch_result($resaco,0,'m75_quantmult'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($m75_codmatestoqueitem=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->m75_codmatestoqueitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m75_codmatestoqueitem"])){ 
       $sql  .= $virgula." m75_codmatestoqueitem = $this->m75_codmatestoqueitem ";
       $virgula = ",";
       if(trim((string) $this->m75_codmatestoqueitem) == null ){ 
     ...
     if(trim((string) $this->m75_codmatunid)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m75_codmatunid"])){ 
       $sql  .= $virgula." m75_codmatunid = $this->m75_codmatunid ";
       $virgula = ",";
       if(trim((string) $this->m75_codmatunid) == null ){ 
         $this->erro_sql = " Campo Código da Unidade nao Informado.";
         $this->erro_campo = "m75_codmatunid";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m75_quant)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m75_quant"])){ 
       $sql  .= $virgula." m75_quant = $this->m75_quant ";
       $virgula = ",";
       if(trim((string) $this->m75_quant) == null ){ 
         $this->erro_sql = " Campo Quantidade nao Informado.";
         $this->erro_campo = "m75_quant";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m75_quantmult)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m75_quantmult"])){ 
       $sql  .= $virgula." m75_quantmult = $this->m75_quantmult ";
       $virgula = ",";
       if(trim((string) $this->m75_quantmult) == null ){ 
         $this->erro_sql = " Campo Quant. Multiplicadora nao Informado.";
         $this->erro_campo = "m75_quantmult";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["m75_codmatestoqueitem"]))
           $resac = db_query("insert into db_acount values($acount,1152,6960,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m75_codmatestoqueitem'))."','$this->m75_codmatestoqueitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m75_codmatunid"]))
           $resac = db_query("insert into db_acount values($acount,1152,6961,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m75_codmatunid'))."','$this->m75_codmatunid',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m75_quant"]))
           $resac = db_query("insert into db_acount values($acount,1152,6962,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m75_quant'))."','$this->m75_quant',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m75_quantmult"]))
           $resac = db_query("insert into db_acount values($acount,1152,6963,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m75_quantmult'))."','$this->m75_quantmult',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($m75_codmatestoqueitem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1152,6960,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m75_codmatestoqueitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1152,6961,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m75_codmatunid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1152,6962,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m75_quant'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1152,6963,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m75_quantmult'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
