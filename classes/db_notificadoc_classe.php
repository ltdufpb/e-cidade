...
class cl_notificadoc { 
   ...
   public $k100_sequencial = 0; 
   public $k100_db_documento = 0; 
   public $k100_notifica = 0; 
   ...
   function incluir ($k100_sequencial){ 
     ...
     if($k100_sequencial == "" || $k100_sequencial == null ){
       ...
       $this->k100_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from notificadoc_k100_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k100_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2098,12097,'','".AddSlashes(pg_fetch_result($resaco,0,'k100_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2098,12098,'','".AddSlashes(pg_fetch_result($resaco,0,'k100_db_documento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2098,12099,'','".AddSlashes(pg_fetch_result($resaco,0,'k100_notifica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k100_sequencial=null,$k100_notifica=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k100_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k100_sequencial"])){ 
       $sql  .= $virgula." k100_sequencial = $this->k100_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k100_sequencial) == null ){ 
     ...
     if(trim((string) $this->k100_db_documento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k100_db_documento"])){ 
       $sql  .= $virgula." k100_db_documento = $this->k100_db_documento ";
       $virgula = ",";
       if(trim((string) $this->k100_db_documento) == null ){ 
         $this->erro_sql = " Campo Documento nao Informado.";
         $this->erro_campo = "k100_db_documento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k100_notifica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k100_notifica"])){ 
       $sql  .= $virgula." k100_notifica = $this->k100_notifica ";
       $virgula = ",";
       if(trim((string) $this->k100_notifica) == null ){ 
         $this->erro_sql = " Campo Notificação nao Informado.";
         $this->erro_campo = "k100_notifica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k100_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2098,12097,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k100_sequencial'))."','$this->k100_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k100_db_documento"]))
           $resac = db_query("insert into db_acount values($acount,2098,12098,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k100_db_documento'))."','$this->k100_db_documento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k100_notifica"]))
           $resac = db_query("insert into db_acount values($acount,2098,12099,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k100_notifica'))."','$this->k100_notifica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k100_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2098,12097,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k100_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2098,12098,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k100_db_documento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2098,12099,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k100_notifica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
