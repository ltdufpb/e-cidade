...
class cl_db_usupermemp { 
   ...
   public $db21_codperm = 0; 
   public $db21_id_usuario = 0; 
   ...
   function incluir ($db21_codperm,$db21_id_usuario){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,884,5578,'','".AddSlashes(pg_fetch_result($resaco,0,'db21_codperm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,884,5579,'','".AddSlashes(pg_fetch_result($resaco,0,'db21_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db21_codperm=null,$db21_id_usuario=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db21_codperm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db21_codperm"])){ 
       $sql  .= $virgula." db21_codperm = $this->db21_codperm ";
       $virgula = ",";
       if(trim((string) $this->db21_codperm) == null ){ 
     ...
     if(trim((string) $this->db21_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db21_id_usuario"])){ 
       $sql  .= $virgula." db21_id_usuario = $this->db21_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->db21_id_usuario) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db21_codperm"]))
           $resac = db_query("insert into db_acount values($acount,884,5578,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db21_codperm'))."','$this->db21_codperm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db21_id_usuario"]))
           $resac = db_query("insert into db_acount values($acount,884,5579,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db21_id_usuario'))."','$this->db21_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db21_codperm=null,$db21_id_usuario=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,884,5578,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db21_codperm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,884,5579,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db21_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
