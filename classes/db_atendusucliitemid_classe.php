...
class cl_atendusucliitemid { 
   ...
   public $at83_seq = 0; 
   public $at83_usucliitem = 0; 
   public $at83_id_usuario = 0; 
   ...
   function incluir ($at83_seq){ 
     ...
     if($at83_seq == "" || $at83_seq == null ){
       ...
       $this->at83_seq = pg_fetch_result($result,0,0); 
     }else{
       $result = @db_query("select last_value from atendusucliitemid_at83_seq_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at83_seq)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1575,9202,'','".AddSlashes(pg_fetch_result($resaco,0,'at83_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1575,9203,'','".AddSlashes(pg_fetch_result($resaco,0,'at83_usucliitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1575,9204,'','".AddSlashes(pg_fetch_result($resaco,0,'at83_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at83_seq=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at83_seq)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at83_seq"])){ 
       $sql  .= $virgula." at83_seq = $this->at83_seq ";
       $virgula = ",";
       if(trim((string) $this->at83_seq) == null ){ 
     ...
     if(trim((string) $this->at83_usucliitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at83_usucliitem"])){ 
       $sql  .= $virgula." at83_usucliitem = $this->at83_usucliitem ";
       $virgula = ",";
       if(trim((string) $this->at83_usucliitem) == null ){ 
         $this->erro_sql = " Campo Sequencial da tarefa nao Informado.";
         $this->erro_campo = "at83_usucliitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at83_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at83_id_usuario"])){ 
       $sql  .= $virgula." at83_id_usuario = $this->at83_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->at83_id_usuario) == null ){ 
         $this->erro_sql = " Campo Cod. Usuário nao Informado.";
         $this->erro_campo = "at83_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at83_seq"]))
           $resac = db_query("insert into db_acount values($acount,1575,9202,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at83_seq'))."','$this->at83_seq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at83_usucliitem"]))
           $resac = db_query("insert into db_acount values($acount,1575,9203,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at83_usucliitem'))."','$this->at83_usucliitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at83_id_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1575,9204,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at83_id_usuario'))."','$this->at83_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at83_seq=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1575,9202,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at83_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1575,9203,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at83_usucliitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1575,9204,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at83_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
