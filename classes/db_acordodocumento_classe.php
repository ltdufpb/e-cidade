...
class cl_acordodocumento {
   ...
   public $ac40_sequencial = 0;
   public $ac40_acordo = 0;
   public $ac40_descricao = null;
   public $ac40_nomearquivo = null;
   public $ac40_arquivo = 0;
   ...
   function incluir ($ac40_sequencial){
     ...
     if($ac40_sequencial == "" || $ac40_sequencial == null ){
       ...
       $this->ac40_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from acordodocumento_ac40_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac40_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3267,18488,'','".AddSlashes(pg_fetch_result($resaco,0,'ac40_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3267,18489,'','".AddSlashes(pg_fetch_result($resaco,0,'ac40_acordo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3267,18491,'','".AddSlashes(pg_fetch_result($resaco,0,'ac40_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3267,18492,'','".AddSlashes(pg_fetch_result($resaco,0,'ac40_nomearquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3267,18490,'','".AddSlashes(pg_fetch_result($resaco,0,'ac40_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($ac40_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->ac40_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac40_sequencial"])){
       $sql  .= $virgula." ac40_sequencial = $this->ac40_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac40_sequencial) == null ){
     ...
     if(trim((string) $this->ac40_acordo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac40_acordo"])){
       $sql  .= $virgula." ac40_acordo = $this->ac40_acordo ";
       $virgula = ",";
       if(trim((string) $this->ac40_acordo) == null ){
         $this->erro_sql = " Campo Acordo nao Informado.";
         $this->erro_campo = "ac40_acordo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac40_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac40_descricao"])){
       $sql  .= $virgula." ac40_descricao = '$this->ac40_descricao' ";
       $virgula = ",";
       if(trim((string) $this->ac40_descricao) == null ){
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "ac40_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac40_nomearquivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac40_nomearquivo"])){
       $sql  .= $virgula." ac40_nomearquivo = '$this->ac40_nomearquivo' ";
       $virgula = ",";
     }
     if(trim((string) $this->ac40_arquivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac40_arquivo"])){
       $sql  .= $virgula." ac40_arquivo = $this->ac40_arquivo ";
       $virgula = ",";
       if(trim((string) $this->ac40_arquivo) == null ){
         $this->erro_sql = " Campo Arquivos nao Informado.";
         $this->erro_campo = "ac40_arquivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac40_sequencial"]) || $this->ac40_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3267,18488,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac40_sequencial'))."','$this->ac40_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac40_acordo"]) || $this->ac40_acordo != "")
           $resac = db_query("insert into db_acount values($acount,3267,18489,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac40_acordo'))."','$this->ac40_acordo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac40_descricao"]) || $this->ac40_descricao != "")
           $resac = db_query("insert into db_acount values($acount,3267,18491,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac40_descricao'))."','$this->ac40_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac40_nomearquivo"]) || $this->ac40_nomearquivo != "")
           $resac = db_query("insert into db_acount values($acount,3267,18492,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac40_nomearquivo'))."','$this->ac40_nomearquivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac40_arquivo"]) || $this->ac40_arquivo != "")
           $resac = db_query("insert into db_acount values($acount,3267,18490,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac40_arquivo'))."','$this->ac40_arquivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($ac40_sequencial=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3267,18488,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac40_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3267,18489,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac40_acordo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3267,18491,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac40_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3267,18492,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac40_nomearquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3267,18490,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac40_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
