...
class cl_turno { 
   ...
   public $ed15_c_nome = null; 
   public $ed15_i_sequencia = 0; 
   ...
   function incluir ($ed15_i_codigo){ 
     ...
     if($ed15_i_codigo == "" || $ed15_i_codigo == null ){
       ...
       $this->ed15_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = @db_query("select last_value from turno_ed15_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed15_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010038,1008234,'','".AddSlashes(pg_fetch_result($resaco,0,'ed15_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010038,11207,'','".AddSlashes(pg_fetch_result($resaco,0,'ed15_c_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010038,1008236,'','".AddSlashes(pg_fetch_result($resaco,0,'ed15_i_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed15_i_codigo=null) { 
     ...
     if(trim((string) $this->ed15_c_nome)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed15_c_nome"])){ 
       $sql  .= $virgula." ed15_c_nome = '$this->ed15_c_nome' ";
       $virgula = ",";
       if(trim((string) $this->ed15_c_nome) == null ){ 
         $this->erro_sql = " Campo Nome nao Informado.";
         $this->erro_campo = "ed15_c_nome";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed15_i_sequencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed15_i_sequencia"])){ 
        if(trim((string) $this->ed15_i_sequencia)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed15_i_sequencia"])){ 
           $this->ed15_i_sequencia = "0" ; 
        } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed15_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010038,1008234,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed15_i_codigo'))."','$this->ed15_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed15_c_nome"]))
           $resac = db_query("insert into db_acount values($acount,1010038,11207,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed15_c_nome'))."','$this->ed15_c_nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed15_i_sequencia"]))
           $resac = db_query("insert into db_acount values($acount,1010038,1008236,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed15_i_sequencia'))."','$this->ed15_i_sequencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed15_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010038,1008234,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed15_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010038,11207,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed15_c_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010038,1008236,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed15_i_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
