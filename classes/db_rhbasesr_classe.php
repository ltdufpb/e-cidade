...
class cl_rhbasesr { 
   ...
   public $rh33_base = null; 
   public $rh33_rubric = null; 
   ...
   function incluir ($rh33_base,$rh33_rubric){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1188,7162,'','".AddSlashes(pg_fetch_result($resaco,0,'rh33_base'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1188,7163,'','".AddSlashes(pg_fetch_result($resaco,0,'rh33_rubric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh33_base=null,$rh33_rubric=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh33_base)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh33_base"])){ 
       $sql  .= $virgula." rh33_base = '$this->rh33_base' ";
       $virgula = ",";
       if(trim((string) $this->rh33_base) == null ){ 
     ...
     if(trim((string) $this->rh33_rubric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh33_rubric"])){ 
       $sql  .= $virgula." rh33_rubric = '$this->rh33_rubric' ";
       $virgula = ",";
       if(trim((string) $this->rh33_rubric) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh33_base"]))
           $resac = db_query("insert into db_acount values($acount,1188,7162,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh33_base'))."','$this->rh33_base',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh33_rubric"]))
           $resac = db_query("insert into db_acount values($acount,1188,7163,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh33_rubric'))."','$this->rh33_rubric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh33_base=null,$rh33_rubric=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1188,7162,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh33_base'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1188,7163,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh33_rubric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
