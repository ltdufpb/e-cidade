...
class cl_baseato { 
   ...
   public $ed278_i_codigo = 0; 
   public $ed278_i_escolabase = 0; 
   public $ed278_i_atolegal = 0; 
   ...
   function incluir ($ed278_i_codigo){ 
     ...
     if($ed278_i_codigo == "" || $ed278_i_codigo == null ){
       ...
       $this->ed278_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from baseato_codigo");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed278_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2613,14843,'','".AddSlashes(pg_fetch_result($resaco,0,'ed278_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2613,14844,'','".AddSlashes(pg_fetch_result($resaco,0,'ed278_i_escolabase'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2613,14845,'','".AddSlashes(pg_fetch_result($resaco,0,'ed278_i_atolegal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed278_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed278_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed278_i_codigo"])){ 
       $sql  .= $virgula." ed278_i_codigo = $this->ed278_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed278_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed278_i_escolabase)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed278_i_escolabase"])){ 
       $sql  .= $virgula." ed278_i_escolabase = $this->ed278_i_escolabase ";
       $virgula = ",";
       if(trim((string) $this->ed278_i_escolabase) == null ){ 
         $this->erro_sql = " Campo Escola Base nao Informado.";
         $this->erro_campo = "ed278_i_escolabase";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed278_i_atolegal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed278_i_atolegal"])){ 
       $sql  .= $virgula." ed278_i_atolegal = $this->ed278_i_atolegal ";
       $virgula = ",";
       if(trim((string) $this->ed278_i_atolegal) == null ){ 
         $this->erro_sql = " Campo Ato Legal nao Informado.";
         $this->erro_campo = "ed278_i_atolegal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed278_i_codigo"]) || $this->ed278_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2613,14843,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed278_i_codigo'))."','$this->ed278_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed278_i_escolabase"]) || $this->ed278_i_escolabase != "")
           $resac = db_query("insert into db_acount values($acount,2613,14844,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed278_i_escolabase'))."','$this->ed278_i_escolabase',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed278_i_atolegal"]) || $this->ed278_i_atolegal != "")
           $resac = db_query("insert into db_acount values($acount,2613,14845,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed278_i_atolegal'))."','$this->ed278_i_atolegal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed278_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2613,14843,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed278_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2613,14844,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed278_i_escolabase'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2613,14845,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed278_i_atolegal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
