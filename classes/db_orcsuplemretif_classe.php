...
class cl_orcsuplemretif { 
   ...
   public $o48_seq = 0; 
   public $o48_projeto = 0; 
   public $o48_retificado = 0; 
   public $o48_texto = null; 
   public $o48_id_usuario = 0; 
   public $o48_data_dia = null; 
   public $o48_data_mes = null; 
   public $o48_data_ano = null; 
   public $o48_data = null; 
   ...
   function incluir ($o48_seq){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1319,7875,'','".AddSlashes(pg_fetch_result($resaco,0,'o48_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1319,7876,'','".AddSlashes(pg_fetch_result($resaco,0,'o48_projeto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1319,7877,'','".AddSlashes(pg_fetch_result($resaco,0,'o48_retificado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1319,7880,'','".AddSlashes(pg_fetch_result($resaco,0,'o48_texto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1319,7878,'','".AddSlashes(pg_fetch_result($resaco,0,'o48_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1319,7879,'','".AddSlashes(pg_fetch_result($resaco,0,'o48_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o48_seq=null) { 
     ...
     if(trim((string) $this->o48_projeto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o48_projeto"])){ 
       $sql  .= $virgula." o48_projeto = $this->o48_projeto ";
       $virgula = ",";
       if(trim((string) $this->o48_projeto) == null ){ 
         $this->erro_sql = " Campo codigo do projeto retificador nao Informado.";
         $this->erro_campo = "o48_projeto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o48_retificado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o48_retificado"])){ 
       $sql  .= $virgula." o48_retificado = $this->o48_retificado ";
       $virgula = ",";
       if(trim((string) $this->o48_retificado) == null ){ 
         $this->erro_sql = " Campo projeto retificado nao Informado.";
         $this->erro_campo = "o48_retificado";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o48_texto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o48_texto"])){ 
       $sql  .= $virgula." o48_texto = '$this->o48_texto' ";
       $virgula = ",";
       if(trim((string) $this->o48_texto) == null ){ 
         $this->erro_sql = " Campo texto informativo nao Informado.";
         $this->erro_campo = "o48_texto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o48_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o48_id_usuario"])){ 
       $sql  .= $virgula." o48_id_usuario = $this->o48_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->o48_id_usuario) == null ){ 
         $this->erro_sql = " Campo Usuario nao Informado.";
         $this->erro_campo = "o48_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o48_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o48_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["o48_data_dia"] !="") ){ 
       $sql  .= $virgula." o48_data = '$this->o48_data' ";
       $virgula = ",";
       if(trim((string) $this->o48_data) == null ){ 
         $this->erro_sql = " Campo Data do Processamento nao Informado.";
         $this->erro_campo = "o48_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_seq"]))
           $resac = db_query("insert into db_acount values($acount,1319,7875,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o48_seq'))."','$this->o48_seq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_projeto"]))
           $resac = db_query("insert into db_acount values($acount,1319,7876,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o48_projeto'))."','$this->o48_projeto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_retificado"]))
           $resac = db_query("insert into db_acount values($acount,1319,7877,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o48_retificado'))."','$this->o48_retificado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_texto"]))
           $resac = db_query("insert into db_acount values($acount,1319,7880,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o48_texto'))."','$this->o48_texto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_id_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1319,7878,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o48_id_usuario'))."','$this->o48_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_data"]))
           $resac = db_query("insert into db_acount values($acount,1319,7879,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o48_data'))."','$this->o48_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o48_seq=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1319,7875,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o48_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1319,7876,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o48_projeto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1319,7877,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o48_retificado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1319,7880,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o48_texto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1319,7878,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o48_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1319,7879,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o48_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
