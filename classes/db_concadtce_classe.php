...
class cl_concadtce { 
   ...
   public $c10_sequencial = 0; 
   public $c10_nome = null; 
   public $c10_sigla = null; 
   public $c10_db_uf = 0; 
   ...
   function incluir ($c10_sequencial){ 
     ...
     if($c10_sequencial == "" || $c10_sequencial == null ){
       ...
       $this->c10_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from concadtce_c10_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $c10_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2061,11930,'','".AddSlashes(pg_fetch_result($resaco,0,'c10_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2061,11932,'','".AddSlashes(pg_fetch_result($resaco,0,'c10_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2061,11933,'','".AddSlashes(pg_fetch_result($resaco,0,'c10_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2061,11931,'','".AddSlashes(pg_fetch_result($resaco,0,'c10_db_uf'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($c10_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->c10_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c10_sequencial"])){ 
       $sql  .= $virgula." c10_sequencial = $this->c10_sequencial ";
       $virgula = ",";
       if(trim((string) $this->c10_sequencial) == null ){ 
     ...
     if(trim((string) $this->c10_nome)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c10_nome"])){ 
       $sql  .= $virgula." c10_nome = '$this->c10_nome' ";
       $virgula = ",";
       if(trim((string) $this->c10_nome) == null ){ 
         $this->erro_sql = " Campo Nome nao Informado.";
         $this->erro_campo = "c10_nome";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c10_sigla)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c10_sigla"])){ 
       $sql  .= $virgula." c10_sigla = '$this->c10_sigla' ";
       $virgula = ",";
       if(trim((string) $this->c10_sigla) == null ){ 
         $this->erro_sql = " Campo Sigla nao Informado.";
         $this->erro_campo = "c10_sigla";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c10_db_uf)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c10_db_uf"])){ 
       $sql  .= $virgula." c10_db_uf = $this->c10_db_uf ";
       $virgula = ",";
       if(trim((string) $this->c10_db_uf) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
         $this->erro_campo = "c10_db_uf";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c10_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2061,11930,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c10_sequencial'))."','$this->c10_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c10_nome"]))
           $resac = db_query("insert into db_acount values($acount,2061,11932,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c10_nome'))."','$this->c10_nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c10_sigla"]))
           $resac = db_query("insert into db_acount values($acount,2061,11933,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c10_sigla'))."','$this->c10_sigla',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c10_db_uf"]))
           $resac = db_query("insert into db_acount values($acount,2061,11931,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c10_db_uf'))."','$this->c10_db_uf',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($c10_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2061,11930,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c10_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2061,11932,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c10_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2061,11933,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c10_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2061,11931,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c10_db_uf'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
