...
class cl_mer_consumoescola { 
   ...
   public $me38_i_codigo        = 0; 
   public $me38_i_cardapioescola        = 0; 
   public $me38_i_tipocardapio        = 0; 
   public $me38_i_ordem        = 0; 
   ...
   function incluir ($me38_i_codigo){ 
     ...
     if($me38_i_codigo == "" || $me38_i_codigo == null ){
       ...
       $this->me38_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mer_consumoescola_me38_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $me38_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3074,17371,'','".AddSlashes(pg_fetch_result($resaco,0,'me38_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3074,17372,'','".AddSlashes(pg_fetch_result($resaco,0,'me38_i_cardapioescola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3074,17373,'','".AddSlashes(pg_fetch_result($resaco,0,'me38_i_tipocardapio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3074,17374,'','".AddSlashes(pg_fetch_result($resaco,0,'me38_i_ordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me38_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->me38_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me38_i_codigo"])){ 
       $sql  .= $virgula." me38_i_codigo = $this->me38_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->me38_i_codigo) == null ){ 
     ...
     if(trim((string) $this->me38_i_cardapioescola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me38_i_cardapioescola"])){ 
       $sql  .= $virgula." me38_i_cardapioescola = $this->me38_i_cardapioescola ";
       $virgula = ",";
       if(trim((string) $this->me38_i_cardapioescola) == null ){ 
         $this->erro_sql = " Campo Cardápio Escola nao Informado.";
         $this->erro_campo = "me38_i_cardapioescola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me38_i_tipocardapio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me38_i_tipocardapio"])){ 
       $sql  .= $virgula." me38_i_tipocardapio = $this->me38_i_tipocardapio ";
       $virgula = ",";
       if(trim((string) $this->me38_i_tipocardapio) == null ){ 
         $this->erro_sql = " Campo Tipo Cardápio nao Informado.";
         $this->erro_campo = "me38_i_tipocardapio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me38_i_ordem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me38_i_ordem"])){ 
       $sql  .= $virgula." me38_i_ordem = $this->me38_i_ordem ";
       $virgula = ",";
       if(trim((string) $this->me38_i_ordem) == null ){ 
         $this->erro_sql = " Campo Ordem nao Informado.";
         $this->erro_campo = "me38_i_ordem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me38_i_codigo"]) || $this->me38_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3074,17371,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me38_i_codigo'))."','$this->me38_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me38_i_cardapioescola"]) || $this->me38_i_cardapioescola != "")
           $resac = db_query("insert into db_acount values($acount,3074,17372,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me38_i_cardapioescola'))."','$this->me38_i_cardapioescola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me38_i_tipocardapio"]) || $this->me38_i_tipocardapio != "")
           $resac = db_query("insert into db_acount values($acount,3074,17373,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me38_i_tipocardapio'))."','$this->me38_i_tipocardapio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me38_i_ordem"]) || $this->me38_i_ordem != "")
           $resac = db_query("insert into db_acount values($acount,3074,17374,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me38_i_ordem'))."','$this->me38_i_ordem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me38_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3074,17371,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me38_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3074,17372,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me38_i_cardapioescola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3074,17373,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me38_i_tipocardapio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3074,17374,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me38_i_ordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
