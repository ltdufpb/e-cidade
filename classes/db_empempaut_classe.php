...
class cl_empempaut {
  ...
  function alterar ($e61_numemp=null) {
    ...
    $virgula = "";
    if(trim((string) $this->e61_numemp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e61_numemp"])){
      $sql  .= $virgula." e61_numemp = $this->e61_numemp ";
      $virgula = ",";
      if(trim((string) $this->e61_numemp) == null ){
    ...
    if(trim((string) $this->e61_autori)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e61_autori"])){
      $sql  .= $virgula." e61_autori = $this->e61_autori ";
      $virgula = ",";
      if(trim((string) $this->e61_autori) == null ){
        $this->erro_sql = " Campo Autorização nao Informado.";
        $this->erro_campo = "e61_autori";
        $this->erro_banco = "";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
