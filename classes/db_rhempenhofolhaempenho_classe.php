...
class cl_rhempenhofolhaempenho { 
   ...
   function incluir ($rh76_sequencial){ 
     ...
     if($rh76_sequencial == "" || $rh76_sequencial == null ){
       ...
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh76_sequencial)){
   ...
   function alterar ($rh76_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh76_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh76_sequencial"])){ 
       $sql  .= $virgula." rh76_sequencial = $this->rh76_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh76_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh76_rhempenhofolha)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh76_rhempenhofolha"])){ 
       $sql  .= $virgula." rh76_rhempenhofolha = $this->rh76_rhempenhofolha ";
       $virgula = ",";
       if(trim((string) $this->rh76_rhempenhofolha) == null ){ 
         $this->erro_sql = " Campo Empenho da Folha nao Informado.";
         $this->erro_campo = "rh76_rhempenhofolha";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh76_numemp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh76_numemp"])){ 
       $sql  .= $virgula." rh76_numemp = $this->rh76_numemp ";
       $virgula = ",";
       if(trim((string) $this->rh76_numemp) == null ){ 
         $this->erro_sql = " Campo Número do Empenho nao Informado.";
         $this->erro_campo = "rh76_numemp";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
