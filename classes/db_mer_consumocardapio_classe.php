...
class cl_mer_consumocardapio { 
   ...
   function incluir ($me37_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3073,17369,'','".AddSlashes(pg_fetch_result($resaco,0,'me37_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3073,17370,'','".AddSlashes(pg_fetch_result($resaco,0,'me37_i_tipocardapio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me37_i_codigo=null) { 
     ...
     if(trim((string) $this->me37_i_tipocardapio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me37_i_tipocardapio"])){ 
       $sql  .= $virgula." me37_i_tipocardapio = $this->me37_i_tipocardapio ";
       $virgula = ",";
       if(trim((string) $this->me37_i_tipocardapio) == null ){ 
         $this->erro_sql = " Campo Tipo Cardápio nao Informado.";
         $this->erro_campo = "me37_i_tipocardapio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me37_i_codigo"]) || $this->me37_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3073,17369,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me37_i_codigo'))."','$this->me37_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me37_i_tipocardapio"]) || $this->me37_i_tipocardapio != "")
           $resac = db_query("insert into db_acount values($acount,3073,17370,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me37_i_tipocardapio'))."','$this->me37_i_tipocardapio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me37_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3073,17369,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me37_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3073,17370,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me37_i_tipocardapio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
