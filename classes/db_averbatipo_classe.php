...
class cl_averbatipo { 
   ...
   public $j93_codigo = 0; 
   public $j93_descr = null; 
   public $j93_regra = 0; 
   public $j93_datalimite_dia = null; 
   public $j93_datalimite_mes = null; 
   public $j93_datalimite_ano = null; 
   public $j93_datalimite = null; 
   public $j93_averbagrupo = 0; 
   ...
   function incluir ($j93_codigo){ 
     ...
     if($j93_codigo == "" || $j93_codigo == null ){
       ...
       $this->j93_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from averbatipo_j93_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $j93_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1665,9677,'','".AddSlashes(pg_fetch_result($resaco,0,'j93_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1665,9678,'','".AddSlashes(pg_fetch_result($resaco,0,'j93_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1665,9679,'','".AddSlashes(pg_fetch_result($resaco,0,'j93_regra'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1665,11690,'','".AddSlashes(pg_fetch_result($resaco,0,'j93_datalimite'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1665,11737,'','".AddSlashes(pg_fetch_result($resaco,0,'j93_averbagrupo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j93_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j93_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j93_codigo"])){ 
       $sql  .= $virgula." j93_codigo = $this->j93_codigo ";
       $virgula = ",";
       if(trim((string) $this->j93_codigo) == null ){ 
     ...
     if(trim((string) $this->j93_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j93_descr"])){ 
       $sql  .= $virgula." j93_descr = '$this->j93_descr' ";
       $virgula = ",";
       if(trim((string) $this->j93_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "j93_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j93_regra)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j93_regra"])){ 
       $sql  .= $virgula." j93_regra = $this->j93_regra ";
       $virgula = ",";
       if(trim((string) $this->j93_regra) == null ){ 
         $this->erro_sql = " Campo Regra nao Informado.";
         $this->erro_campo = "j93_regra";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j93_datalimite)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j93_datalimite_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["j93_datalimite_dia"] !="") ){ 
     ...
     if(trim((string) $this->j93_averbagrupo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j93_averbagrupo"])){ 
       $sql  .= $virgula." j93_averbagrupo = $this->j93_averbagrupo ";
       $virgula = ",";
       if(trim((string) $this->j93_averbagrupo) == null ){ 
         $this->erro_sql = " Campo Grupo nao Informado.";
         $this->erro_campo = "j93_averbagrupo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j93_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1665,9677,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j93_codigo'))."','$this->j93_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j93_descr"]))
           $resac = db_query("insert into db_acount values($acount,1665,9678,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j93_descr'))."','$this->j93_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j93_regra"]))
           $resac = db_query("insert into db_acount values($acount,1665,9679,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j93_regra'))."','$this->j93_regra',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j93_datalimite"]))
           $resac = db_query("insert into db_acount values($acount,1665,11690,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j93_datalimite'))."','$this->j93_datalimite',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j93_averbagrupo"]))
           $resac = db_query("insert into db_acount values($acount,1665,11737,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j93_averbagrupo'))."','$this->j93_averbagrupo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j93_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1665,9677,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j93_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1665,9678,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j93_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1665,9679,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j93_regra'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1665,11690,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j93_datalimite'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1665,11737,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j93_averbagrupo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
