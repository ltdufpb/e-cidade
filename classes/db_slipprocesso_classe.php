...
class cl_slipprocesso { 
   ...
   public $k145_sequencial = 0; 
   public $k145_slip = 0; 
   public $k145_numeroprocesso = null; 
   ...
   function incluir ($k145_sequencial){ 
     ...
     if($k145_sequencial == "" || $k145_sequencial == null ){
       ...
       $this->k145_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from slipprocesso_k145_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k145_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3714,20624,'','".AddSlashes(pg_fetch_result($resaco,0,'k145_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3714,20625,'','".AddSlashes(pg_fetch_result($resaco,0,'k145_slip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3714,20626,'','".AddSlashes(pg_fetch_result($resaco,0,'k145_numeroprocesso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($k145_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k145_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k145_sequencial"])){ 
       $sql  .= $virgula." k145_sequencial = $this->k145_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k145_sequencial) == null ){ 
     ...
     if(trim((string) $this->k145_slip)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k145_slip"])){ 
       $sql  .= $virgula." k145_slip = $this->k145_slip ";
       $virgula = ",";
       if(trim((string) $this->k145_slip) == null ){ 
         $this->erro_sql = " Campo slip não informado.";
         $this->erro_campo = "k145_slip";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k145_numeroprocesso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k145_numeroprocesso"])){ 
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["k145_sequencial"]) || $this->k145_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3714,20624,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k145_sequencial'))."','$this->k145_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["k145_slip"]) || $this->k145_slip != "")
             $resac = db_query("insert into db_acount values($acount,3714,20625,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k145_slip'))."','$this->k145_slip',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["k145_numeroprocesso"]) || $this->k145_numeroprocesso != "")
             $resac = db_query("insert into db_acount values($acount,3714,20626,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k145_numeroprocesso'))."','$this->k145_numeroprocesso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3714,20624,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k145_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3714,20625,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k145_slip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3714,20626,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k145_numeroprocesso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
