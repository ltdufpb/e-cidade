...
class cl_pcfornecertifrenovacao { 
   ...
   public $pc35_sequencial = 0; 
   public $pc35_pcfornecertiforiginal = 0; 
   public $pc35_fornecertffilho = 0; 
   public $pc35_datarenovacao_dia = null; 
   public $pc35_datarenovacao_mes = null; 
   public $pc35_datarenovacao_ano = null; 
   public $pc35_datarenovacao = null; 
   ...
   function incluir ($pc35_sequencial){ 
     ...
     if($pc35_sequencial == "" || $pc35_sequencial == null ){
       ...
       $this->pc35_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from pcfonecertifrenovacao_pc35_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $pc35_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2907,16558,'','".AddSlashes(pg_fetch_result($resaco,0,'pc35_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2907,16559,'','".AddSlashes(pg_fetch_result($resaco,0,'pc35_pcfornecertiforiginal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2907,16561,'','".AddSlashes(pg_fetch_result($resaco,0,'pc35_fornecertffilho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2907,16562,'','".AddSlashes(pg_fetch_result($resaco,0,'pc35_datarenovacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc35_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc35_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc35_sequencial"])){ 
       $sql  .= $virgula." pc35_sequencial = $this->pc35_sequencial ";
       $virgula = ",";
       if(trim((string) $this->pc35_sequencial) == null ){ 
     ...
     if(trim((string) $this->pc35_pcfornecertiforiginal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc35_pcfornecertiforiginal"])){ 
       $sql  .= $virgula." pc35_pcfornecertiforiginal = $this->pc35_pcfornecertiforiginal ";
       $virgula = ",";
       if(trim((string) $this->pc35_pcfornecertiforiginal) == null ){ 
         $this->erro_sql = " Campo Certificado Original nao Informado.";
         $this->erro_campo = "pc35_pcfornecertiforiginal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc35_fornecertffilho)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc35_fornecertffilho"])){ 
        if(trim((string) $this->pc35_fornecertffilho)=="" && isset($GLOBALS["HTTP_POST_VARS"]["pc35_fornecertffilho"])){ 
           $this->pc35_fornecertffilho = "0" ; 
        } 
     ...
     if(trim((string) $this->pc35_datarenovacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc35_datarenovacao_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["pc35_datarenovacao_dia"] !="") ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc35_sequencial"]) || $this->pc35_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2907,16558,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc35_sequencial'))."','$this->pc35_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc35_pcfornecertiforiginal"]) || $this->pc35_pcfornecertiforiginal != "")
           $resac = db_query("insert into db_acount values($acount,2907,16559,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc35_pcfornecertiforiginal'))."','$this->pc35_pcfornecertiforiginal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc35_fornecertffilho"]) || $this->pc35_fornecertffilho != "")
           $resac = db_query("insert into db_acount values($acount,2907,16561,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc35_fornecertffilho'))."','$this->pc35_fornecertffilho',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc35_datarenovacao"]) || $this->pc35_datarenovacao != "")
           $resac = db_query("insert into db_acount values($acount,2907,16562,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc35_datarenovacao'))."','$this->pc35_datarenovacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc35_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2907,16558,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc35_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2907,16559,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc35_pcfornecertiforiginal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2907,16561,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc35_fornecertffilho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2907,16562,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc35_datarenovacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
