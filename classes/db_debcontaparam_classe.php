...
class cl_debcontaparam { 
   ...
   public $d62_instituicao = 0; 
   public $d62_banco = 0; 
   public $d62_convenio = null; 
   public $d62_ultimonsa = 0; 
   public $d62_mascara = null; 
   ...
   function incluir ($d62_instituicao,$d62_banco){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1329,7936,'','".AddSlashes(pg_fetch_result($resaco,0,'d62_instituicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1329,7937,'','".AddSlashes(pg_fetch_result($resaco,0,'d62_banco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1329,7938,'','".AddSlashes(pg_fetch_result($resaco,0,'d62_convenio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1329,7939,'','".AddSlashes(pg_fetch_result($resaco,0,'d62_ultimonsa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1329,7940,'','".AddSlashes(pg_fetch_result($resaco,0,'d62_mascara'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($d62_instituicao=null,$d62_banco=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->d62_instituicao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d62_instituicao"])){ 
       $sql  .= $virgula." d62_instituicao = $this->d62_instituicao ";
       $virgula = ",";
       if(trim((string) $this->d62_instituicao) == null ){ 
     ...
     if(trim((string) $this->d62_banco)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d62_banco"])){ 
       $sql  .= $virgula." d62_banco = $this->d62_banco ";
       $virgula = ",";
       if(trim((string) $this->d62_banco) == null ){ 
     ...
     if(trim((string) $this->d62_convenio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d62_convenio"])){ 
       $sql  .= $virgula." d62_convenio = '$this->d62_convenio' ";
       $virgula = ",";
       if(trim((string) $this->d62_convenio) == null ){ 
         $this->erro_sql = " Campo Convenio nao Informado.";
         $this->erro_campo = "d62_convenio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->d62_ultimonsa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d62_ultimonsa"])){ 
       $sql  .= $virgula." d62_ultimonsa = $this->d62_ultimonsa ";
       $virgula = ",";
       if(trim((string) $this->d62_ultimonsa) == null ){ 
         $this->erro_sql = " Campo Ultimo NSA nao Informado.";
         $this->erro_campo = "d62_ultimonsa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->d62_mascara)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d62_mascara"])){ 
       $sql  .= $virgula." d62_mascara = '$this->d62_mascara' ";
       $virgula = ",";
       if(trim((string) $this->d62_mascara) == null ){ 
         $this->erro_sql = " Campo Mascara nao Informado.";
         $this->erro_campo = "d62_mascara";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["d62_instituicao"]))
           $resac = db_query("insert into db_acount values($acount,1329,7936,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d62_instituicao'))."','$this->d62_instituicao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d62_banco"]))
           $resac = db_query("insert into db_acount values($acount,1329,7937,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d62_banco'))."','$this->d62_banco',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d62_convenio"]))
           $resac = db_query("insert into db_acount values($acount,1329,7938,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d62_convenio'))."','$this->d62_convenio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d62_ultimonsa"]))
           $resac = db_query("insert into db_acount values($acount,1329,7939,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d62_ultimonsa'))."','$this->d62_ultimonsa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d62_mascara"]))
           $resac = db_query("insert into db_acount values($acount,1329,7940,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d62_mascara'))."','$this->d62_mascara',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($d62_instituicao=null,$d62_banco=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1329,7936,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d62_instituicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1329,7937,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d62_banco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1329,7938,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d62_convenio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1329,7939,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d62_ultimonsa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1329,7940,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d62_mascara'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
