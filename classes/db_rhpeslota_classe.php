...
class cl_rhpeslota { 
   ...
   public $rh10_anousu = 0; 
   public $rh10_mesusu = 0; 
   public $rh10_regist = 0; 
   public $rh10_lotac = 0; 
   public $rh10_percrateio = 0; 
   ...
   function incluir ($rh10_anousu,$rh10_mesusu,$rh10_regist,$rh10_lotac){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,973,6060,'','".AddSlashes(pg_fetch_result($resaco,0,'rh10_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,973,6061,'','".AddSlashes(pg_fetch_result($resaco,0,'rh10_mesusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,973,6057,'','".AddSlashes(pg_fetch_result($resaco,0,'rh10_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,973,6058,'','".AddSlashes(pg_fetch_result($resaco,0,'rh10_lotac'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,973,6059,'','".AddSlashes(pg_fetch_result($resaco,0,'rh10_percrateio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh10_anousu=null,$rh10_mesusu=null,$rh10_regist=null,$rh10_lotac=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh10_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh10_anousu"])){ 
       $sql  .= $virgula." rh10_anousu = $this->rh10_anousu ";
       $virgula = ",";
       if(trim((string) $this->rh10_anousu) == null ){ 
     ...
     if(trim((string) $this->rh10_mesusu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh10_mesusu"])){ 
       $sql  .= $virgula." rh10_mesusu = $this->rh10_mesusu ";
       $virgula = ",";
       if(trim((string) $this->rh10_mesusu) == null ){ 
     ...
     if(trim((string) $this->rh10_regist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh10_regist"])){ 
       $sql  .= $virgula." rh10_regist = $this->rh10_regist ";
       $virgula = ",";
       if(trim((string) $this->rh10_regist) == null ){ 
     ...
     if(trim((string) $this->rh10_lotac)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh10_lotac"])){ 
       $sql  .= $virgula." rh10_lotac = $this->rh10_lotac ";
       $virgula = ",";
       if(trim((string) $this->rh10_lotac) == null ){ 
     ...
     if(trim((string) $this->rh10_percrateio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh10_percrateio"])){ 
       $sql  .= $virgula." rh10_percrateio = $this->rh10_percrateio ";
       $virgula = ",";
       if(trim((string) $this->rh10_percrateio) == null ){ 
         $this->erro_sql = " Campo Percentual de Reteio nao Informado.";
         $this->erro_campo = "rh10_percrateio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh10_anousu"]))
           $resac = db_query("insert into db_acount values($acount,973,6060,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh10_anousu'))."','$this->rh10_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh10_mesusu"]))
           $resac = db_query("insert into db_acount values($acount,973,6061,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh10_mesusu'))."','$this->rh10_mesusu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh10_regist"]))
           $resac = db_query("insert into db_acount values($acount,973,6057,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh10_regist'))."','$this->rh10_regist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh10_lotac"]))
           $resac = db_query("insert into db_acount values($acount,973,6058,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh10_lotac'))."','$this->rh10_lotac',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh10_percrateio"]))
           $resac = db_query("insert into db_acount values($acount,973,6059,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh10_percrateio'))."','$this->rh10_percrateio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh10_anousu=null,$rh10_mesusu=null,$rh10_regist=null,$rh10_lotac=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,973,6060,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh10_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,973,6061,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh10_mesusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,973,6057,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh10_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,973,6058,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh10_lotac'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,973,6059,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh10_percrateio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
