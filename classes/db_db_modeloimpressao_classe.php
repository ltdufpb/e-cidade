...
class cl_db_modeloimpressao { 
   ...
   public $db66_sequencial = 0; 
   public $db66_db_tipomodeloimpressao = 0; 
   public $db66_db_impressora = 0; 
   public $db66_descricao = null; 
   ...
   function incluir ($db66_sequencial){ 
     ...
     if($db66_sequencial == "" || $db66_sequencial == null ){
       ...
       $this->db66_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_modeloimpressao_db66_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db66_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2407,13751,'','".AddSlashes(pg_fetch_result($resaco,0,'db66_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2407,13752,'','".AddSlashes(pg_fetch_result($resaco,0,'db66_db_tipomodeloimpressao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2407,13753,'','".AddSlashes(pg_fetch_result($resaco,0,'db66_db_impressora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2407,13754,'','".AddSlashes(pg_fetch_result($resaco,0,'db66_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db66_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db66_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db66_sequencial"])){ 
       $sql  .= $virgula." db66_sequencial = $this->db66_sequencial ";
       $virgula = ",";
       if(trim((string) $this->db66_sequencial) == null ){ 
     ...
     if(trim((string) $this->db66_db_tipomodeloimpressao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db66_db_tipomodeloimpressao"])){ 
       $sql  .= $virgula." db66_db_tipomodeloimpressao = $this->db66_db_tipomodeloimpressao ";
       $virgula = ",";
       if(trim((string) $this->db66_db_tipomodeloimpressao) == null ){ 
         $this->erro_sql = " Campo Código do Modelo de Impressão nao Informado.";
         $this->erro_campo = "db66_db_tipomodeloimpressao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db66_db_impressora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db66_db_impressora"])){ 
       $sql  .= $virgula." db66_db_impressora = $this->db66_db_impressora ";
       $virgula = ",";
       if(trim((string) $this->db66_db_impressora) == null ){ 
         $this->erro_sql = " Campo Código da Impressora nao Informado.";
         $this->erro_campo = "db66_db_impressora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db66_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db66_descricao"])){ 
       $sql  .= $virgula." db66_descricao = '$this->db66_descricao' ";
       $virgula = ",";
       if(trim((string) $this->db66_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição do Modelo de Impressão nao Informado.";
         $this->erro_campo = "db66_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db66_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2407,13751,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db66_sequencial'))."','$this->db66_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db66_db_tipomodeloimpressao"]))
           $resac = db_query("insert into db_acount values($acount,2407,13752,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db66_db_tipomodeloimpressao'))."','$this->db66_db_tipomodeloimpressao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db66_db_impressora"]))
           $resac = db_query("insert into db_acount values($acount,2407,13753,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db66_db_impressora'))."','$this->db66_db_impressora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db66_descricao"]))
           $resac = db_query("insert into db_acount values($acount,2407,13754,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db66_descricao'))."','$this->db66_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db66_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2407,13751,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db66_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2407,13752,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db66_db_tipomodeloimpressao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2407,13753,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db66_db_impressora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2407,13754,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db66_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
