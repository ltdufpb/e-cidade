...
class cl_matestoqueitemfabric { 
   ...
   function incluir ($m78_sequencial){ 
     ...
     if($m78_sequencial == "" || $m78_sequencial == null ){
       ...
       $this->m78_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from matestoqueitemfabric_m78_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $m78_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2079,12015,'','".AddSlashes(pg_fetch_result($resaco,0,'m78_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2079,12016,'','".AddSlashes(pg_fetch_result($resaco,0,'m78_matestoqueitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2079,12017,'','".AddSlashes(pg_fetch_result($resaco,0,'m78_matfabricante'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($m78_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->m78_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m78_sequencial"])){ 
       $sql  .= $virgula." m78_sequencial = $this->m78_sequencial ";
       $virgula = ",";
       if(trim((string) $this->m78_sequencial) == null ){ 
     ...
     if(trim((string) $this->m78_matestoqueitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m78_matestoqueitem"])){ 
       $sql  .= $virgula." m78_matestoqueitem = $this->m78_matestoqueitem ";
       $virgula = ",";
       if(trim((string) $this->m78_matestoqueitem) == null ){ 
         $this->erro_sql = " Campo Item do Estoque nao Informado.";
         $this->erro_campo = "m78_matestoqueitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m78_matfabricante)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m78_matfabricante"])){ 
       $sql  .= $virgula." m78_matfabricante = $this->m78_matfabricante ";
       $virgula = ",";
       if(trim((string) $this->m78_matfabricante) == null ){ 
         $this->erro_sql = " Campo Fabricante nao Informado.";
         $this->erro_campo = "m78_matfabricante";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["m78_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2079,12015,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m78_sequencial'))."','$this->m78_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m78_matestoqueitem"]))
           $resac = db_query("insert into db_acount values($acount,2079,12016,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m78_matestoqueitem'))."','$this->m78_matestoqueitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m78_matfabricante"]))
           $resac = db_query("insert into db_acount values($acount,2079,12017,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m78_matfabricante'))."','$this->m78_matfabricante',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($m78_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2079,12015,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m78_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2079,12016,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m78_matestoqueitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2079,12017,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m78_matfabricante'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
