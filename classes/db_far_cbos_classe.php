...
class cl_far_cbos { 
   ...
   public $fa53_i_codigo = 0; 
   public $fa53_c_estrutural = null; 
   public $fa53_c_descr = null; 
   ...
   function incluir ($fa53_i_codigo){ 
     ...
     if($fa53_i_codigo == "" || $fa53_i_codigo == null ){
       ...
       $this->fa53_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_cbos_fa53_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa53_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3055,17266,'','".AddSlashes(pg_fetch_result($resaco,0,'fa53_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3055,17267,'','".AddSlashes(pg_fetch_result($resaco,0,'fa53_c_estrutural'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3055,17268,'','".AddSlashes(pg_fetch_result($resaco,0,'fa53_c_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa53_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa53_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa53_i_codigo"])){ 
       $sql  .= $virgula." fa53_i_codigo = $this->fa53_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa53_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa53_c_estrutural)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa53_c_estrutural"])){ 
       $sql  .= $virgula." fa53_c_estrutural = '$this->fa53_c_estrutural' ";
       $virgula = ",";
       if(trim((string) $this->fa53_c_estrutural) == null ){ 
         $this->erro_sql = " Campo CBOS nao Informado.";
         $this->erro_campo = "fa53_c_estrutural";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa53_c_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa53_c_descr"])){ 
       $sql  .= $virgula." fa53_c_descr = '$this->fa53_c_descr' ";
       $virgula = ",";
       if(trim((string) $this->fa53_c_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "fa53_c_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa53_i_codigo"]) || $this->fa53_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3055,17266,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa53_i_codigo'))."','$this->fa53_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa53_c_estrutural"]) || $this->fa53_c_estrutural != "")
           $resac = db_query("insert into db_acount values($acount,3055,17267,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa53_c_estrutural'))."','$this->fa53_c_estrutural',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa53_c_descr"]) || $this->fa53_c_descr != "")
           $resac = db_query("insert into db_acount values($acount,3055,17268,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa53_c_descr'))."','$this->fa53_c_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa53_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3055,17266,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa53_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3055,17267,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa53_c_estrutural'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3055,17268,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa53_c_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
