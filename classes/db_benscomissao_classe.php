...
class cl_benscomissao { 
   ...
   public $t60_codcom = 0; 
   public $t60_dataini_dia = null; 
   public $t60_dataini_mes = null; 
   public $t60_dataini_ano = null; 
   public $t60_dataini = null; 
   public $t60_datafim_dia = null; 
   public $t60_datafim_mes = null; 
   public $t60_datafim_ano = null; 
   public $t60_datafim = null; 
   public $t60_id_usuario = 0; 
   public $t60_instit = 0; 
   ...
   function incluir ($t60_codcom){ 
     ...
     if($t60_codcom == "" || $t60_codcom == null ){
       ...
       $this->t60_codcom = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from benscomissao_t60_codcom_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $t60_codcom)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,920,5795,'','".AddSlashes(pg_fetch_result($resaco,0,'t60_codcom'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,920,5796,'','".AddSlashes(pg_fetch_result($resaco,0,'t60_dataini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,920,5797,'','".AddSlashes(pg_fetch_result($resaco,0,'t60_datafim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,920,5798,'','".AddSlashes(pg_fetch_result($resaco,0,'t60_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,920,9804,'','".AddSlashes(pg_fetch_result($resaco,0,'t60_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($t60_codcom=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->t60_codcom)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t60_codcom"])){ 
       $sql  .= $virgula." t60_codcom = $this->t60_codcom ";
       $virgula = ",";
       if(trim((string) $this->t60_codcom) == null ){ 
     ...
     if(trim((string) $this->t60_dataini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t60_dataini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["t60_dataini_dia"] !="") ){ 
       $sql  .= $virgula." t60_dataini = '$this->t60_dataini' ";
       $virgula = ",";
       if(trim((string) $this->t60_dataini) == null ){ 
         $this->erro_sql = " Campo Data de início nao Informado.";
         $this->erro_campo = "t60_dataini_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->t60_datafim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t60_datafim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["t60_datafim_dia"] !="") ){ 
       $sql  .= $virgula." t60_datafim = '$this->t60_datafim' ";
       $virgula = ",";
       if(trim((string) $this->t60_datafim) == null ){ 
         $this->erro_sql = " Campo Data final nao Informado.";
         $this->erro_campo = "t60_datafim_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->t60_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t60_id_usuario"])){ 
       $sql  .= $virgula." t60_id_usuario = $this->t60_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->t60_id_usuario) == null ){ 
         $this->erro_sql = " Campo Cod. Usuário nao Informado.";
         $this->erro_campo = "t60_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->t60_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t60_instit"])){ 
       $sql  .= $virgula." t60_instit = $this->t60_instit ";
       $virgula = ",";
       if(trim((string) $this->t60_instit) == null ){ 
         $this->erro_sql = " Campo Instituição nao Informado.";
         $this->erro_campo = "t60_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["t60_codcom"]))
           $resac = db_query("insert into db_acount values($acount,920,5795,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t60_codcom'))."','$this->t60_codcom',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t60_dataini"]))
           $resac = db_query("insert into db_acount values($acount,920,5796,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t60_dataini'))."','$this->t60_dataini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t60_datafim"]))
           $resac = db_query("insert into db_acount values($acount,920,5797,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t60_datafim'))."','$this->t60_datafim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t60_id_usuario"]))
           $resac = db_query("insert into db_acount values($acount,920,5798,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t60_id_usuario'))."','$this->t60_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t60_instit"]))
           $resac = db_query("insert into db_acount values($acount,920,9804,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t60_instit'))."','$this->t60_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($t60_codcom=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,920,5795,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t60_codcom'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,920,5796,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t60_dataini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,920,5797,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t60_datafim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,920,5798,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t60_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,920,9804,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t60_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
