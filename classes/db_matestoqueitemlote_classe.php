...
class cl_matestoqueitemlote { 
   ...
   function incluir ($m77_sequencial){ 
     ...
     if($m77_sequencial == "" || $m77_sequencial == null ){
       ...
       $this->m77_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from matestoqueitemlote_m77_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $m77_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2072,11980,'','".AddSlashes(pg_fetch_result($resaco,0,'m77_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2072,11981,'','".AddSlashes(pg_fetch_result($resaco,0,'m77_lote'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2072,11982,'','".AddSlashes(pg_fetch_result($resaco,0,'m77_dtvalidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2072,11983,'','".AddSlashes(pg_fetch_result($resaco,0,'m77_matestoqueitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($m77_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->m77_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m77_sequencial"])){ 
       $sql  .= $virgula." m77_sequencial = $this->m77_sequencial ";
       $virgula = ",";
       if(trim((string) $this->m77_sequencial) == null ){ 
     ...
     if(trim((string) $this->m77_lote)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m77_lote"])){ 
       $sql  .= $virgula." m77_lote = '$this->m77_lote' ";
       $virgula = ",";
       if(trim((string) $this->m77_lote) == null ){ 
         $this->erro_sql = " Campo Lote do Material nao Informado.";
         $this->erro_campo = "m77_lote";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m77_dtvalidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m77_dtvalidade_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["m77_dtvalidade_dia"] !="") ){ 
       $sql  .= $virgula." m77_dtvalidade = '$this->m77_dtvalidade' ";
       $virgula = ",";
       if(trim((string) $this->m77_dtvalidade) == null ){ 
         $this->erro_sql = " Campo Data de Validade nao Informado.";
         $this->erro_campo = "m77_dtvalidade_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m77_matestoqueitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m77_matestoqueitem"])){ 
       $sql  .= $virgula." m77_matestoqueitem = $this->m77_matestoqueitem ";
       $virgula = ",";
       if(trim((string) $this->m77_matestoqueitem) == null ){ 
         $this->erro_sql = " Campo Código do Item nao Informado.";
         $this->erro_campo = "m77_matestoqueitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["m77_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2072,11980,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m77_sequencial'))."','$this->m77_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m77_lote"]))
           $resac = db_query("insert into db_acount values($acount,2072,11981,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m77_lote'))."','$this->m77_lote',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m77_dtvalidade"]))
           $resac = db_query("insert into db_acount values($acount,2072,11982,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m77_dtvalidade'))."','$this->m77_dtvalidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m77_matestoqueitem"]))
           $resac = db_query("insert into db_acount values($acount,2072,11983,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m77_matestoqueitem'))."','$this->m77_matestoqueitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($m77_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2072,11980,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m77_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2072,11981,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m77_lote'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2072,11982,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m77_dtvalidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2072,11983,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m77_matestoqueitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
