...
class cl_iptubasepredio { 
   ...
   public $j109_sequencial = 0; 
   public $j109_predio = 0; 
   public $j109_matric = 0; 
   ...
   function incluir ($j109_sequencial){ 
     ...
     if($j109_sequencial == "" || $j109_sequencial == null ){
       ...
       $this->j109_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from iptubasepredio_j109_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $j109_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2536,14384,'','".AddSlashes(pg_fetch_result($resaco,0,'j109_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2536,14385,'','".AddSlashes(pg_fetch_result($resaco,0,'j109_predio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2536,14386,'','".AddSlashes(pg_fetch_result($resaco,0,'j109_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j109_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j109_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j109_sequencial"])){ 
       $sql  .= $virgula." j109_sequencial = $this->j109_sequencial ";
       $virgula = ",";
       if(trim((string) $this->j109_sequencial) == null ){ 
     ...
     if(trim((string) $this->j109_predio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j109_predio"])){ 
       $sql  .= $virgula." j109_predio = $this->j109_predio ";
       $virgula = ",";
       if(trim((string) $this->j109_predio) == null ){ 
         $this->erro_sql = " Campo Prédio nao Informado.";
         $this->erro_campo = "j109_predio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j109_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j109_matric"])){ 
       $sql  .= $virgula." j109_matric = $this->j109_matric ";
       $virgula = ",";
       if(trim((string) $this->j109_matric) == null ){ 
         $this->erro_sql = " Campo Cód. IPTU Base nao Informado.";
         $this->erro_campo = "j109_matric";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j109_sequencial"]) || $this->j109_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2536,14384,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j109_sequencial'))."','$this->j109_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j109_predio"]) || $this->j109_predio != "")
           $resac = db_query("insert into db_acount values($acount,2536,14385,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j109_predio'))."','$this->j109_predio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j109_matric"]) || $this->j109_matric != "")
           $resac = db_query("insert into db_acount values($acount,2536,14386,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j109_matric'))."','$this->j109_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j109_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2536,14384,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j109_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2536,14385,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j109_predio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2536,14386,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j109_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
