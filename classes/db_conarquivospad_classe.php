...
class cl_conarquivospad { 
   ...
   function incluir ($c54_codarq){ 
     ...
     if($c54_codarq == "" || $c54_codarq == null ){
       ...
       $this->c54_codarq = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from conarquivospad_c54_codarq_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $c54_codarq)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1118,6821,'','".AddSlashes(pg_fetch_result($resaco,0,'c54_codarq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1118,6822,'','".AddSlashes(pg_fetch_result($resaco,0,'c54_nomearq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1118,6823,'','".AddSlashes(pg_fetch_result($resaco,0,'c54_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1118,7828,'','".AddSlashes(pg_fetch_result($resaco,0,'c54_codtrib'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1118,7829,'','".AddSlashes(pg_fetch_result($resaco,0,'c54_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($c54_codarq=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->c54_codarq)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c54_codarq"])){ 
       $sql  .= $virgula." c54_codarq = $this->c54_codarq ";
       $virgula = ",";
       if(trim((string) $this->c54_codarq) == null ){ 
     ...
     if(trim((string) $this->c54_nomearq)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c54_nomearq"])){ 
       $sql  .= $virgula." c54_nomearq = '$this->c54_nomearq' ";
       $virgula = ",";
       if(trim((string) $this->c54_nomearq) == null ){ 
         $this->erro_sql = " Campo Nome do Arquivo nao Informado.";
         $this->erro_campo = "c54_nomearq";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c54_arquivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c54_arquivo"])){ 
       $sql  .= $virgula." c54_arquivo = '$this->c54_arquivo' ";
       $virgula = ",";
       if(trim((string) $this->c54_arquivo) == null ){ 
         $this->erro_sql = " Campo Arquivo nao Informado.";
         $this->erro_campo = "c54_arquivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c54_codtrib)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c54_codtrib"])){ 
       $sql  .= $virgula." c54_codtrib = $this->c54_codtrib ";
       $virgula = ",";
       if(trim((string) $this->c54_codtrib) == null ){ 
         $this->erro_sql = " Campo codigo tribunal nao Informado.";
         $this->erro_campo = "c54_codtrib";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c54_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c54_anousu"])){ 
       $sql  .= $virgula." c54_anousu = $this->c54_anousu ";
       $virgula = ",";
       if(trim((string) $this->c54_anousu) == null ){ 
         $this->erro_sql = " Campo exercício nao Informado.";
         $this->erro_campo = "c54_anousu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c54_codarq"]) || $this->c54_codarq != "")
           $resac = db_query("insert into db_acount values($acount,1118,6821,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c54_codarq'))."','$this->c54_codarq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c54_nomearq"]) || $this->c54_nomearq != "")
           $resac = db_query("insert into db_acount values($acount,1118,6822,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c54_nomearq'))."','$this->c54_nomearq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c54_arquivo"]) || $this->c54_arquivo != "")
           $resac = db_query("insert into db_acount values($acount,1118,6823,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c54_arquivo'))."','$this->c54_arquivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c54_codtrib"]) || $this->c54_codtrib != "")
           $resac = db_query("insert into db_acount values($acount,1118,7828,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c54_codtrib'))."','$this->c54_codtrib',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c54_anousu"]) || $this->c54_anousu != "")
           $resac = db_query("insert into db_acount values($acount,1118,7829,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c54_anousu'))."','$this->c54_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($c54_codarq=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1118,6821,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c54_codarq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1118,6822,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c54_nomearq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1118,6823,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c54_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1118,7828,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c54_codtrib'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1118,7829,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c54_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
