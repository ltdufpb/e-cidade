...
class cl_cgs_und
{
   ...
   // cria propriedade com as variaveis do arquivo
    public $campos = "
                 ...
                 z01_c_bolsafamilia = char(1) = Auxílio Brasil
    ...
    public function atualizacampos($exclusao = false)
    {
     if($exclusao==false){
       ...
       $this->z01_nome_social = ($this->z01_nome_social == ""?@$GLOBALS["HTTP_POST_VARS"]["z01_nome_social"]:$this->z01_nome_social);
     }else{
       $this->z01_i_cgsund = ($this->z01_i_cgsund == ""?@$GLOBALS["HTTP_POST_VARS"]["z01_i_cgsund"]:$this->z01_i_cgsund);
     }
   }
    ...
    public function alterar($z01_i_cgsund=null)
    {
     ...
     if($this->z01_v_cgccpf !== null || isset($GLOBALS["HTTP_POST_VARS"]["z01_v_cgccpf"])) {
