...
class cl_acordoposicaoaditamento { 
   ...
   public $ac35_sequencial = 0; 
   public $ac35_valor = 0; 
   public $ac35_acordoposicao = 0; 
   ...
   function incluir ($ac35_sequencial){ 
     ...
     if($ac35_sequencial == "" || $ac35_sequencial == null ){
       ...
       $this->ac35_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordoposicaoaditamento_ac35_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac35_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3041,17200,'','".AddSlashes(pg_fetch_result($resaco,0,'ac35_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3041,17201,'','".AddSlashes(pg_fetch_result($resaco,0,'ac35_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3041,17202,'','".AddSlashes(pg_fetch_result($resaco,0,'ac35_acordoposicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac35_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac35_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac35_sequencial"])){ 
       $sql  .= $virgula." ac35_sequencial = $this->ac35_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac35_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac35_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac35_valor"])){ 
        if(trim((string) $this->ac35_valor)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ac35_valor"])){ 
           $this->ac35_valor = "0" ; 
        } 
     ...
     if(trim((string) $this->ac35_acordoposicao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac35_acordoposicao"])){ 
       $sql  .= $virgula." ac35_acordoposicao = $this->ac35_acordoposicao ";
       $virgula = ",";
       if(trim((string) $this->ac35_acordoposicao) == null ){ 
         $this->erro_sql = " Campo Código da posicao nao Informado.";
         $this->erro_campo = "ac35_acordoposicao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac35_sequencial"]) || $this->ac35_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3041,17200,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac35_sequencial'))."','$this->ac35_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac35_valor"]) || $this->ac35_valor != "")
           $resac = db_query("insert into db_acount values($acount,3041,17201,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac35_valor'))."','$this->ac35_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac35_acordoposicao"]) || $this->ac35_acordoposicao != "")
           $resac = db_query("insert into db_acount values($acount,3041,17202,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac35_acordoposicao'))."','$this->ac35_acordoposicao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac35_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3041,17200,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac35_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3041,17201,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac35_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3041,17202,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac35_acordoposicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
