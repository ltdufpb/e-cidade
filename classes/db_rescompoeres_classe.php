...
class cl_rescompoeres { 
   ...
   public $ed68_i_codigo = 0; 
   public $ed68_i_procresultado = 0; 
   public $ed68_i_procresultcomp = 0; 
   public $ed68_i_peso = 0; 
   public $ed68_c_minimoaprov = null; 
   ...
   function incluir ($ed68_i_codigo){ 
     ...
     if($ed68_i_codigo == "" || $ed68_i_codigo == null ){
       ...
       $this->ed68_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rescompoeres_ed68_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed68_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010081,1008475,'','".AddSlashes(pg_fetch_result($resaco,0,'ed68_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010081,1008476,'','".AddSlashes(pg_fetch_result($resaco,0,'ed68_i_procresultado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010081,1008477,'','".AddSlashes(pg_fetch_result($resaco,0,'ed68_i_procresultcomp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010081,1008478,'','".AddSlashes(pg_fetch_result($resaco,0,'ed68_i_peso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010081,1008479,'','".AddSlashes(pg_fetch_result($resaco,0,'ed68_c_minimoaprov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed68_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed68_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed68_i_codigo"])){ 
       $sql  .= $virgula." ed68_i_codigo = $this->ed68_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed68_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed68_i_procresultado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed68_i_procresultado"])){ 
       $sql  .= $virgula." ed68_i_procresultado = $this->ed68_i_procresultado ";
       $virgula = ",";
       if(trim((string) $this->ed68_i_procresultado) == null ){ 
         $this->erro_sql = " Campo Resultado nao Informado.";
         $this->erro_campo = "ed68_i_procresultado";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed68_i_procresultcomp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed68_i_procresultcomp"])){ 
       $sql  .= $virgula." ed68_i_procresultcomp = $this->ed68_i_procresultcomp ";
       $virgula = ",";
       if(trim((string) $this->ed68_i_procresultcomp) == null ){ 
         $this->erro_sql = " Campo Resultado Componente nao Informado.";
         $this->erro_campo = "ed68_i_procresultcomp";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed68_i_peso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed68_i_peso"])){ 
       $sql  .= $virgula." ed68_i_peso = $this->ed68_i_peso ";
       $virgula = ",";
       if(trim((string) $this->ed68_i_peso) == null ){ 
         $this->erro_sql = " Campo Peso nao Informado.";
         $this->erro_campo = "ed68_i_peso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed68_c_minimoaprov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed68_c_minimoaprov"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed68_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010081,1008475,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed68_i_codigo'))."','$this->ed68_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed68_i_procresultado"]))
           $resac = db_query("insert into db_acount values($acount,1010081,1008476,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed68_i_procresultado'))."','$this->ed68_i_procresultado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed68_i_procresultcomp"]))
           $resac = db_query("insert into db_acount values($acount,1010081,1008477,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed68_i_procresultcomp'))."','$this->ed68_i_procresultcomp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed68_i_peso"]))
           $resac = db_query("insert into db_acount values($acount,1010081,1008478,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed68_i_peso'))."','$this->ed68_i_peso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed68_c_minimoaprov"]))
           $resac = db_query("insert into db_acount values($acount,1010081,1008479,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed68_c_minimoaprov'))."','$this->ed68_c_minimoaprov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed68_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010081,1008475,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed68_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010081,1008476,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed68_i_procresultado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010081,1008477,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed68_i_procresultcomp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010081,1008478,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed68_i_peso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010081,1008479,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed68_c_minimoaprov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
