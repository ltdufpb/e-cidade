...
class cl_far_prescricaomed { 
   ...
   public $fa31_i_codigo = 0; 
   public $fa31_i_medanvisa = 0; 
   public $fa31_i_prescricao = 0; 
   ...
   function incluir ($fa31_i_codigo){ 
     ...
     if($fa31_i_codigo == "" || $fa31_i_codigo == null ){
       ...
       $this->fa31_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_prescricaomed_fa31_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa31_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2524,14349,'','".AddSlashes(pg_fetch_result($resaco,0,'fa31_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2524,14350,'','".AddSlashes(pg_fetch_result($resaco,0,'fa31_i_medanvisa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2524,14351,'','".AddSlashes(pg_fetch_result($resaco,0,'fa31_i_prescricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa31_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa31_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa31_i_codigo"])){ 
       $sql  .= $virgula." fa31_i_codigo = $this->fa31_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa31_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa31_i_medanvisa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa31_i_medanvisa"])){ 
       $sql  .= $virgula." fa31_i_medanvisa = $this->fa31_i_medanvisa ";
       $virgula = ",";
       if(trim((string) $this->fa31_i_medanvisa) == null ){ 
         $this->erro_sql = " Campo Medanvisa nao Informado.";
         $this->erro_campo = "fa31_i_medanvisa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa31_i_prescricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa31_i_prescricao"])){ 
       $sql  .= $virgula." fa31_i_prescricao = $this->fa31_i_prescricao ";
       $virgula = ",";
       if(trim((string) $this->fa31_i_prescricao) == null ){ 
         $this->erro_sql = " Campo prescricao medica nao Informado.";
         $this->erro_campo = "fa31_i_prescricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa31_i_codigo"]) || $this->fa31_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2524,14349,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa31_i_codigo'))."','$this->fa31_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa31_i_medanvisa"]) || $this->fa31_i_medanvisa != "")
           $resac = db_query("insert into db_acount values($acount,2524,14350,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa31_i_medanvisa'))."','$this->fa31_i_medanvisa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa31_i_prescricao"]) || $this->fa31_i_prescricao != "")
           $resac = db_query("insert into db_acount values($acount,2524,14351,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa31_i_prescricao'))."','$this->fa31_i_prescricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa31_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2524,14349,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa31_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2524,14350,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa31_i_medanvisa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2524,14351,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa31_i_prescricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
