...
class cl_rhestagioavaliacao { 
   ...
   public $h56_sequencial = 0; 
   public $h56_rhestagiocomissao = 0; 
   public $h56_rhestagioagenda = 0; 
   public $h56_data_dia = null; 
   public $h56_data_mes = null; 
   public $h56_data_ano = null; 
   public $h56_data = null; 
   public $h56_avaliador = 0; 
   ...
   function incluir ($h56_sequencial){ 
     ...
     if($h56_sequencial == "" || $h56_sequencial == null ){
       ...
       $this->h56_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhestagioavaliacao_h56_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h56_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1878,10888,'','".AddSlashes(pg_fetch_result($resaco,0,'h56_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1878,10889,'','".AddSlashes(pg_fetch_result($resaco,0,'h56_rhestagiocomissao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1878,10890,'','".AddSlashes(pg_fetch_result($resaco,0,'h56_rhestagioagenda'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1878,10891,'','".AddSlashes(pg_fetch_result($resaco,0,'h56_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1878,10892,'','".AddSlashes(pg_fetch_result($resaco,0,'h56_avaliador'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h56_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h56_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h56_sequencial"])){ 
       $sql  .= $virgula." h56_sequencial = $this->h56_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h56_sequencial) == null ){ 
     ...
     if(trim((string) $this->h56_rhestagiocomissao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h56_rhestagiocomissao"])){ 
       $sql  .= $virgula." h56_rhestagiocomissao = $this->h56_rhestagiocomissao ";
       $virgula = ",";
       if(trim((string) $this->h56_rhestagiocomissao) == null ){ 
         $this->erro_sql = " Campo Cód. Comissão nao Informado.";
         $this->erro_campo = "h56_rhestagiocomissao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h56_rhestagioagenda)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h56_rhestagioagenda"])){ 
       $sql  .= $virgula." h56_rhestagioagenda = $this->h56_rhestagioagenda ";
       $virgula = ",";
       if(trim((string) $this->h56_rhestagioagenda) == null ){ 
         $this->erro_sql = " Campo Cód. Agenda nao Informado.";
         $this->erro_campo = "h56_rhestagioagenda";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h56_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h56_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["h56_data_dia"] !="") ){ 
       $sql  .= $virgula." h56_data = '$this->h56_data' ";
       $virgula = ",";
       if(trim((string) $this->h56_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "h56_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h56_avaliador)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h56_avaliador"])){ 
       $sql  .= $virgula." h56_avaliador = $this->h56_avaliador ";
       $virgula = ",";
       if(trim((string) $this->h56_avaliador) == null ){ 
         $this->erro_sql = " Campo Avaliador nao Informado.";
         $this->erro_campo = "h56_avaliador";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h56_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1878,10888,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h56_sequencial'))."','$this->h56_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h56_rhestagiocomissao"]))
           $resac = db_query("insert into db_acount values($acount,1878,10889,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h56_rhestagiocomissao'))."','$this->h56_rhestagiocomissao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h56_rhestagioagenda"]))
           $resac = db_query("insert into db_acount values($acount,1878,10890,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h56_rhestagioagenda'))."','$this->h56_rhestagioagenda',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h56_data"]))
           $resac = db_query("insert into db_acount values($acount,1878,10891,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h56_data'))."','$this->h56_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h56_avaliador"]))
           $resac = db_query("insert into db_acount values($acount,1878,10892,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h56_avaliador'))."','$this->h56_avaliador',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h56_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1878,10888,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h56_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1878,10889,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h56_rhestagiocomissao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1878,10890,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h56_rhestagioagenda'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1878,10891,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h56_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1878,10892,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h56_avaliador'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
