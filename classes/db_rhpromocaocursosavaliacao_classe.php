...
class cl_rhpromocaocursosavaliacao { 
   ...
   public $h75_sequencial = 0; 
   public $h75_rhpromocaocurso = 0; 
   public $h75_rhavaliacao = 0; 
   ...
   function incluir ($h75_sequencial){ 
     ...
     if($h75_sequencial == "" || $h75_sequencial == null ){
       ...
       $this->h75_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhpromocaocursosavaliacao_h75_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h75_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3318,18724,'','".AddSlashes(pg_fetch_result($resaco,0,'h75_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3318,18725,'','".AddSlashes(pg_fetch_result($resaco,0,'h75_rhpromocaocurso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3318,18726,'','".AddSlashes(pg_fetch_result($resaco,0,'h75_rhavaliacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h75_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h75_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h75_sequencial"])){ 
       $sql  .= $virgula." h75_sequencial = $this->h75_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h75_sequencial) == null ){ 
     ...
     if(trim((string) $this->h75_rhpromocaocurso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h75_rhpromocaocurso"])){ 
       $sql  .= $virgula." h75_rhpromocaocurso = $this->h75_rhpromocaocurso ";
       $virgula = ",";
       if(trim((string) $this->h75_rhpromocaocurso) == null ){ 
         $this->erro_sql = " Campo Curso da promoção nao Informado.";
         $this->erro_campo = "h75_rhpromocaocurso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h75_rhavaliacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h75_rhavaliacao"])){ 
       $sql  .= $virgula." h75_rhavaliacao = $this->h75_rhavaliacao ";
       $virgula = ",";
       if(trim((string) $this->h75_rhavaliacao) == null ){ 
         $this->erro_sql = " Campo Avaliação nao Informado.";
         $this->erro_campo = "h75_rhavaliacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h75_sequencial"]) || $this->h75_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3318,18724,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h75_sequencial'))."','$this->h75_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h75_rhpromocaocurso"]) || $this->h75_rhpromocaocurso != "")
           $resac = db_query("insert into db_acount values($acount,3318,18725,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h75_rhpromocaocurso'))."','$this->h75_rhpromocaocurso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h75_rhavaliacao"]) || $this->h75_rhavaliacao != "")
           $resac = db_query("insert into db_acount values($acount,3318,18726,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h75_rhavaliacao'))."','$this->h75_rhavaliacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h75_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3318,18724,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h75_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3318,18725,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h75_rhpromocaocurso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3318,18726,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h75_rhavaliacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
