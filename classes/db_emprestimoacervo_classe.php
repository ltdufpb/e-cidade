...
class cl_emprestimoacervo {
   ...
   public $bi19_codigo = 0;
   public $bi19_emprestimo = 0;
   public $bi19_exemplar = 0;
   ...
   function incluir ($bi19_codigo){
     ...
     if($bi19_codigo == "" || $bi19_codigo == null ){
       ...
       $this->bi19_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from emprestimoacervo_bi19_codigo_se");
       if(($result != false) && (pg_fetch_result($result,0,0) < $bi19_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1008024,1008141,'','".AddSlashes(pg_fetch_result($resaco,0,'bi19_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1008024,1008144,'','".AddSlashes(pg_fetch_result($resaco,0,'bi19_emprestimo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1008024,1008145,'','".AddSlashes(pg_fetch_result($resaco,0,'bi19_exemplar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($bi19_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->bi19_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["bi19_codigo"])){
       $sql  .= $virgula." bi19_codigo = $this->bi19_codigo ";
       $virgula = ",";
       if(trim((string) $this->bi19_codigo) == null ){
     ...
     if(trim((string) $this->bi19_emprestimo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["bi19_emprestimo"])){
       $sql  .= $virgula." bi19_emprestimo = $this->bi19_emprestimo ";
       $virgula = ",";
       if(trim((string) $this->bi19_emprestimo) == null ){
         $this->erro_sql = " Campo Empréstimo nao Informado.";
         $this->erro_campo = "bi19_emprestimo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->bi19_exemplar)!="" || isset($GLOBALS["HTTP_POST_VARS"]["bi19_exemplar"])){
       $sql  .= $virgula." bi19_exemplar = $this->bi19_exemplar ";
       $virgula = ",";
       if(trim((string) $this->bi19_exemplar) == null ){
         $this->erro_sql = " Campo Exemplar nao Informado.";
         $this->erro_campo = "bi19_exemplar";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["bi19_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1008024,1008141,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'bi19_codigo'))."','$this->bi19_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["bi19_emprestimo"]))
           $resac = db_query("insert into db_acount values($acount,1008024,1008144,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'bi19_emprestimo'))."','$this->bi19_emprestimo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["bi19_exemplar"]))
           $resac = db_query("insert into db_acount values($acount,1008024,1008145,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'bi19_exemplar'))."','$this->bi19_exemplar',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($bi19_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1008024,1008141,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'bi19_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1008024,1008144,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'bi19_emprestimo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1008024,1008145,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'bi19_exemplar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
