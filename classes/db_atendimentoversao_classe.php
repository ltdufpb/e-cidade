...
class cl_atendimentoversao { 
   ...
   public $at67_sequencial = 0; 
   public $at67_codatend = 0; 
   public $at67_codver = 0; 
   ...
   function incluir ($at67_sequencial){ 
     ...
     if($at67_sequencial == "" || $at67_sequencial == null ){
       ...
       $this->at67_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from atendimentoversao_at67_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at67_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1746,10141,'','".AddSlashes(pg_fetch_result($resaco,0,'at67_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1746,10142,'','".AddSlashes(pg_fetch_result($resaco,0,'at67_codatend'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1746,10143,'','".AddSlashes(pg_fetch_result($resaco,0,'at67_codver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at67_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at67_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at67_sequencial"])){ 
       $sql  .= $virgula." at67_sequencial = $this->at67_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at67_sequencial) == null ){ 
     ...
     if(trim((string) $this->at67_codatend)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at67_codatend"])){ 
       $sql  .= $virgula." at67_codatend = $this->at67_codatend ";
       $virgula = ",";
       if(trim((string) $this->at67_codatend) == null ){ 
         $this->erro_sql = " Campo Atendimento nao Informado.";
         $this->erro_campo = "at67_codatend";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at67_codver)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at67_codver"])){ 
       $sql  .= $virgula." at67_codver = $this->at67_codver ";
       $virgula = ",";
       if(trim((string) $this->at67_codver) == null ){ 
         $this->erro_sql = " Campo Código da Versão nao Informado.";
         $this->erro_campo = "at67_codver";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at67_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1746,10141,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at67_sequencial'))."','$this->at67_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at67_codatend"]))
           $resac = db_query("insert into db_acount values($acount,1746,10142,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at67_codatend'))."','$this->at67_codatend',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at67_codver"]))
           $resac = db_query("insert into db_acount values($acount,1746,10143,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at67_codver'))."','$this->at67_codver',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at67_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1746,10141,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at67_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1746,10142,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at67_codatend'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1746,10143,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at67_codver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
