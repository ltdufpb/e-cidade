...
class cl_censodistrito { 
   ...
   public function incluir ($ed262_i_codigo){ 
     ...
     if($ed262_i_codigo == "" || $ed262_i_codigo == null ){
       ...
       $this->ed262_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from censodistrito_ed262_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed262_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2340,13353,'','".AddSlashes(pg_fetch_result($resaco,0,'ed262_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2340,13354,'','".AddSlashes(pg_fetch_result($resaco,0,'ed262_i_censomunic'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2340,13355,'','".AddSlashes(pg_fetch_result($resaco,0,'ed262_i_coddistrito'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2340,13356,'','".AddSlashes(pg_fetch_result($resaco,0,'ed262_c_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   public function alterar ($ed262_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed262_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed262_i_codigo"])){ 
       $sql  .= $virgula." ed262_i_codigo = $this->ed262_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed262_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed262_i_censomunic)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed262_i_censomunic"])){ 
       $sql  .= $virgula." ed262_i_censomunic = $this->ed262_i_censomunic ";
       $virgula = ",";
       if(trim((string) $this->ed262_i_censomunic) == null ){ 
         $this->erro_sql = " Campo Município nao Informado.";
         $this->erro_campo = "ed262_i_censomunic";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed262_i_coddistrito)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed262_i_coddistrito"])){ 
       $sql  .= $virgula." ed262_i_coddistrito = $this->ed262_i_coddistrito ";
       $virgula = ",";
       if(trim((string) $this->ed262_i_coddistrito) == null ){ 
         $this->erro_sql = " Campo Código Censo nao Informado.";
         $this->erro_campo = "ed262_i_coddistrito";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed262_c_nome)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed262_c_nome"])){ 
       $sql  .= $virgula." ed262_c_nome = '$this->ed262_c_nome' ";
       $virgula = ",";
       if(trim((string) $this->ed262_c_nome) == null ){ 
         $this->erro_sql = " Campo Nome nao Informado.";
         $this->erro_campo = "ed262_c_nome";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed262_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2340,13353,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed262_i_codigo'))."','$this->ed262_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed262_i_censomunic"]))
           $resac = db_query("insert into db_acount values($acount,2340,13354,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed262_i_censomunic'))."','$this->ed262_i_censomunic',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed262_i_coddistrito"]))
           $resac = db_query("insert into db_acount values($acount,2340,13355,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed262_i_coddistrito'))."','$this->ed262_i_coddistrito',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed262_c_nome"]))
           $resac = db_query("insert into db_acount values($acount,2340,13356,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed262_c_nome'))."','$this->ed262_c_nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   public function excluir ($ed262_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2340,13353,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed262_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2340,13354,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed262_i_censomunic'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2340,13355,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed262_i_coddistrito'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2340,13356,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed262_c_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
