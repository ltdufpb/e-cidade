...
class cl_far_requisitanteoutro { 
   ...
   public $fa39_i_codigo = 0; 
   public $fa39_i_requisitante = 0; 
   public $fa39_c_nome = null; 
   public $fa39_c_ender = null; 
   public $fa39_i_numero = 0; 
   public $fa39_i_ident = 0; 
   ...
   function incluir ($fa39_i_codigo){ 
     ...
     if($fa39_i_codigo == "" || $fa39_i_codigo == null ){
       ...
       $this->fa39_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_requisitanteoutro_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa39_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2617,14864,'','".AddSlashes(pg_fetch_result($resaco,0,'fa39_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2617,14865,'','".AddSlashes(pg_fetch_result($resaco,0,'fa39_i_requisitante'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2617,14866,'','".AddSlashes(pg_fetch_result($resaco,0,'fa39_c_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2617,14867,'','".AddSlashes(pg_fetch_result($resaco,0,'fa39_c_ender'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2617,14868,'','".AddSlashes(pg_fetch_result($resaco,0,'fa39_i_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2617,14869,'','".AddSlashes(pg_fetch_result($resaco,0,'fa39_i_ident'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa39_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa39_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa39_i_codigo"])){ 
       $sql  .= $virgula." fa39_i_codigo = $this->fa39_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa39_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa39_i_requisitante)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa39_i_requisitante"])){ 
       $sql  .= $virgula." fa39_i_requisitante = $this->fa39_i_requisitante ";
       $virgula = ",";
       if(trim((string) $this->fa39_i_requisitante) == null ){ 
         $this->erro_sql = " Campo requisitante nao Informado.";
         $this->erro_campo = "fa39_i_requisitante";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa39_c_nome)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa39_c_nome"])){ 
       $sql  .= $virgula." fa39_c_nome = '$this->fa39_c_nome' ";
       $virgula = ",";
       if(trim((string) $this->fa39_c_nome) == null ){ 
         $this->erro_sql = " Campo Nome nao Informado.";
         $this->erro_campo = "fa39_c_nome";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa39_c_ender)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa39_c_ender"])){ 
       $sql  .= $virgula." fa39_c_ender = '$this->fa39_c_ender' ";
       $virgula = ",";
       if(trim((string) $this->fa39_c_ender) == null ){ 
         $this->erro_sql = " Campo Endereço nao Informado.";
         $this->erro_campo = "fa39_c_ender";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa39_i_numero)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa39_i_numero"])){ 
       $sql  .= $virgula." fa39_i_numero = $this->fa39_i_numero ";
       $virgula = ",";
       if(trim((string) $this->fa39_i_numero) == null ){ 
         $this->erro_sql = " Campo Numero nao Informado.";
         $this->erro_campo = "fa39_i_numero";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa39_i_ident)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa39_i_ident"])){ 
       $sql  .= $virgula." fa39_i_ident = $this->fa39_i_ident ";
       $virgula = ",";
       if(trim((string) $this->fa39_i_ident) == null ){ 
         $this->erro_sql = " Campo Identidade nao Informado.";
         $this->erro_campo = "fa39_i_ident";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa39_i_codigo"]) || $this->fa39_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2617,14864,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa39_i_codigo'))."','$this->fa39_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa39_i_requisitante"]) || $this->fa39_i_requisitante != "")
           $resac = db_query("insert into db_acount values($acount,2617,14865,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa39_i_requisitante'))."','$this->fa39_i_requisitante',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa39_c_nome"]) || $this->fa39_c_nome != "")
           $resac = db_query("insert into db_acount values($acount,2617,14866,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa39_c_nome'))."','$this->fa39_c_nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa39_c_ender"]) || $this->fa39_c_ender != "")
           $resac = db_query("insert into db_acount values($acount,2617,14867,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa39_c_ender'))."','$this->fa39_c_ender',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa39_i_numero"]) || $this->fa39_i_numero != "")
           $resac = db_query("insert into db_acount values($acount,2617,14868,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa39_i_numero'))."','$this->fa39_i_numero',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa39_i_ident"]) || $this->fa39_i_ident != "")
           $resac = db_query("insert into db_acount values($acount,2617,14869,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa39_i_ident'))."','$this->fa39_i_ident',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa39_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2617,14864,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa39_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2617,14865,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa39_i_requisitante'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2617,14866,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa39_c_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2617,14867,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa39_c_ender'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2617,14868,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa39_i_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2617,14869,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa39_i_ident'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
