...
class cl_liclicitaedital { 
   ...
   public $l27_sequencial = 0; 
   public $l27_arquivo = 0; 
   public $l27_arqnome = null; 
   public $l27_liclicita = 0; 
   ...
   function incluir ($l27_sequencial){ 
     ...
     if($l27_sequencial == "" || $l27_sequencial == null ){
       ...
       $this->l27_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from liclicitaedital_l27_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $l27_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1617,9410,'','".AddSlashes(pg_fetch_result($resaco,0,'l27_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1617,9411,'','".AddSlashes(pg_fetch_result($resaco,0,'l27_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1617,9429,'','".AddSlashes(pg_fetch_result($resaco,0,'l27_arqnome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1617,9413,'','".AddSlashes(pg_fetch_result($resaco,0,'l27_liclicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($l27_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->l27_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l27_sequencial"])){ 
       $sql  .= $virgula." l27_sequencial = $this->l27_sequencial ";
       $virgula = ",";
       if(trim((string) $this->l27_sequencial) == null ){ 
     ...
     if(trim((string) $this->l27_arquivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l27_arquivo"])){ 
       $sql  .= $virgula." l27_arquivo = $this->l27_arquivo ";
       $virgula = ",";
       if(trim((string) $this->l27_arquivo) == null ){ 
         $this->erro_sql = " Campo Arquivo nao Informado.";
         $this->erro_campo = "l27_arquivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l27_arqnome)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l27_arqnome"])){ 
       $sql  .= $virgula." l27_arqnome = '$this->l27_arqnome' ";
       $virgula = ",";
       if(trim((string) $this->l27_arqnome) == null ){ 
         $this->erro_sql = " Campo Nome do arquivo nao Informado.";
         $this->erro_campo = "l27_arqnome";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l27_liclicita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l27_liclicita"])){ 
       $sql  .= $virgula." l27_liclicita = $this->l27_liclicita ";
       $virgula = ",";
       if(trim((string) $this->l27_liclicita) == null ){ 
         $this->erro_sql = " Campo codigo nao Informado.";
         $this->erro_campo = "l27_liclicita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["l27_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1617,9410,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l27_sequencial'))."','$this->l27_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l27_arquivo"]))
           $resac = db_query("insert into db_acount values($acount,1617,9411,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l27_arquivo'))."','$this->l27_arquivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l27_arqnome"]))
           $resac = db_query("insert into db_acount values($acount,1617,9429,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l27_arqnome'))."','$this->l27_arqnome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l27_liclicita"]))
           $resac = db_query("insert into db_acount values($acount,1617,9413,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l27_liclicita'))."','$this->l27_liclicita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($l27_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1617,9410,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l27_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1617,9411,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l27_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1617,9429,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l27_arqnome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1617,9413,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l27_liclicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
