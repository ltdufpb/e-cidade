...
class cl_empanuladoitem { 
   ...
   public $e37_sequencial = 0; 
   public $e37_empempitem = 0; 
   public $e37_empanulado = 0; 
   public $e37_vlranu = 0; 
   public $e37_qtd = 0; 
   ...
   function incluir ($e37_sequencial){ 
     ...
     if($e37_sequencial == "" || $e37_sequencial == null ){
       ...
       $this->e37_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from empanuladoitem_e37_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $e37_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1885,10918,'','".AddSlashes(pg_fetch_result($resaco,0,'e37_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1885,10919,'','".AddSlashes(pg_fetch_result($resaco,0,'e37_empempitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1885,10920,'','".AddSlashes(pg_fetch_result($resaco,0,'e37_empanulado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1885,10921,'','".AddSlashes(pg_fetch_result($resaco,0,'e37_vlranu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1885,10922,'','".AddSlashes(pg_fetch_result($resaco,0,'e37_qtd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e37_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e37_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e37_sequencial"])){ 
       $sql  .= $virgula." e37_sequencial = $this->e37_sequencial ";
       $virgula = ",";
       if(trim((string) $this->e37_sequencial) == null ){ 
     ...
     if(trim((string) $this->e37_empempitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e37_empempitem"])){ 
       $sql  .= $virgula." e37_empempitem = $this->e37_empempitem ";
       $virgula = ",";
       if(trim((string) $this->e37_empempitem) == null ){ 
         $this->erro_sql = " Campo Códido do Item nao Informado.";
         $this->erro_campo = "e37_empempitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e37_empanulado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e37_empanulado"])){ 
       $sql  .= $virgula." e37_empanulado = $this->e37_empanulado ";
       $virgula = ",";
       if(trim((string) $this->e37_empanulado) == null ){ 
         $this->erro_sql = " Campo Código da Anulaçao nao Informado.";
         $this->erro_campo = "e37_empanulado";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e37_vlranu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e37_vlranu"])){ 
       $sql  .= $virgula." e37_vlranu = $this->e37_vlranu ";
       $virgula = ",";
       if(trim((string) $this->e37_vlranu) == null ){ 
         $this->erro_sql = " Campo Valor Anulado nao Informado.";
         $this->erro_campo = "e37_vlranu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e37_qtd)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e37_qtd"])){ 
        if(trim((string) $this->e37_qtd)=="" && isset($GLOBALS["HTTP_POST_VARS"]["e37_qtd"])){ 
           $this->e37_qtd = "0" ; 
        } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e37_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1885,10918,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e37_sequencial'))."','$this->e37_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e37_empempitem"]))
           $resac = db_query("insert into db_acount values($acount,1885,10919,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e37_empempitem'))."','$this->e37_empempitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e37_empanulado"]))
           $resac = db_query("insert into db_acount values($acount,1885,10920,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e37_empanulado'))."','$this->e37_empanulado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e37_vlranu"]))
           $resac = db_query("insert into db_acount values($acount,1885,10921,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e37_vlranu'))."','$this->e37_vlranu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e37_qtd"]))
           $resac = db_query("insert into db_acount values($acount,1885,10922,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e37_qtd'))."','$this->e37_qtd',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e37_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1885,10918,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e37_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1885,10919,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e37_empempitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1885,10920,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e37_empanulado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1885,10921,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e37_vlranu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1885,10922,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e37_qtd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
