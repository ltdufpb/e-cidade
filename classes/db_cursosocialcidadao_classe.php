...
class cl_cursosocialcidadao { 
   ...
   public $as22_sequencial = 0; 
   public $as22_cursosocial = 0; 
   public $as22_cidadao = 0; 
   public $as22_cidadao_seq = 0; 
   public $as22_observacao = null; 
   ...
   function incluir ($as22_sequencial){ 
     ...
     if($as22_sequencial == "" || $as22_sequencial == null ){
       ...
       $this->as22_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cursocialcidadao_as22_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $as22_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3581,19976,'','".AddSlashes(pg_fetch_result($resaco,0,'as22_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3581,19977,'','".AddSlashes(pg_fetch_result($resaco,0,'as22_cursosocial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3581,19978,'','".AddSlashes(pg_fetch_result($resaco,0,'as22_cidadao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3581,19979,'','".AddSlashes(pg_fetch_result($resaco,0,'as22_cidadao_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3581,19980,'','".AddSlashes(pg_fetch_result($resaco,0,'as22_observacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($as22_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->as22_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as22_sequencial"])){ 
       $sql  .= $virgula." as22_sequencial = $this->as22_sequencial ";
       $virgula = ",";
       if(trim((string) $this->as22_sequencial) == null ){ 
     ...
     if(trim((string) $this->as22_cursosocial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as22_cursosocial"])){ 
       $sql  .= $virgula." as22_cursosocial = $this->as22_cursosocial ";
       $virgula = ",";
       if(trim((string) $this->as22_cursosocial) == null ){ 
         $this->erro_sql = " Campo Curso nao Informado.";
         $this->erro_campo = "as22_cursosocial";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->as22_cidadao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as22_cidadao"])){ 
       $sql  .= $virgula." as22_cidadao = $this->as22_cidadao ";
       $virgula = ",";
       if(trim((string) $this->as22_cidadao) == null ){ 
         $this->erro_sql = " Campo Cidadão nao Informado.";
         $this->erro_campo = "as22_cidadao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->as22_cidadao_seq)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as22_cidadao_seq"])){ 
       $sql  .= $virgula." as22_cidadao_seq = $this->as22_cidadao_seq ";
       $virgula = ",";
       if(trim((string) $this->as22_cidadao_seq) == null ){ 
         $this->erro_sql = " Campo Cidadão seq nao Informado.";
         $this->erro_campo = "as22_cidadao_seq";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->as22_observacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as22_observacao"])){ 
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["as22_sequencial"]) || $this->as22_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3581,19976,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as22_sequencial'))."','$this->as22_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["as22_cursosocial"]) || $this->as22_cursosocial != "")
             $resac = db_query("insert into db_acount values($acount,3581,19977,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as22_cursosocial'))."','$this->as22_cursosocial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["as22_cidadao"]) || $this->as22_cidadao != "")
             $resac = db_query("insert into db_acount values($acount,3581,19978,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as22_cidadao'))."','$this->as22_cidadao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["as22_cidadao_seq"]) || $this->as22_cidadao_seq != "")
             $resac = db_query("insert into db_acount values($acount,3581,19979,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as22_cidadao_seq'))."','$this->as22_cidadao_seq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["as22_observacao"]) || $this->as22_observacao != "")
             $resac = db_query("insert into db_acount values($acount,3581,19980,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as22_observacao'))."','$this->as22_observacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3581,19976,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as22_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3581,19977,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as22_cursosocial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3581,19978,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as22_cidadao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3581,19979,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as22_cidadao_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3581,19980,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as22_observacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
