...
class cl_procgrupoatend { 
   ...
   public $sd17_i_codigo = 0; 
   public $sd17_i_procedimento = 0; 
   public $sd17_i_grupoatend = 0; 
   ...
   function incluir ($sd17_i_codigo){ 
     ...
     if($sd17_i_codigo == "" || $sd17_i_codigo == null ){
       ...
       $this->sd17_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from procgrupoatend_sd17_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $sd17_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,100023,1008729,'','".AddSlashes(pg_fetch_result($resaco,0,'sd17_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,100023,100120,'','".AddSlashes(pg_fetch_result($resaco,0,'sd17_i_procedimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,100023,100121,'','".AddSlashes(pg_fetch_result($resaco,0,'sd17_i_grupoatend'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd17_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd17_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd17_i_codigo"])){ 
       $sql  .= $virgula." sd17_i_codigo = $this->sd17_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->sd17_i_codigo) == null ){ 
     ...
     if(trim((string) $this->sd17_i_procedimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd17_i_procedimento"])){ 
       $sql  .= $virgula." sd17_i_procedimento = $this->sd17_i_procedimento ";
       $virgula = ",";
       if(trim((string) $this->sd17_i_procedimento) == null ){ 
         $this->erro_sql = " Campo Procedimento nao Informado.";
         $this->erro_campo = "sd17_i_procedimento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd17_i_grupoatend)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd17_i_grupoatend"])){ 
       $sql  .= $virgula." sd17_i_grupoatend = $this->sd17_i_grupoatend ";
       $virgula = ",";
       if(trim((string) $this->sd17_i_grupoatend) == null ){ 
         $this->erro_sql = " Campo Grupo de Atendimento nao Informado.";
         $this->erro_campo = "sd17_i_grupoatend";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd17_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,100023,1008729,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd17_i_codigo'))."','$this->sd17_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd17_i_procedimento"]))
           $resac = db_query("insert into db_acount values($acount,100023,100120,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd17_i_procedimento'))."','$this->sd17_i_procedimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd17_i_grupoatend"]))
           $resac = db_query("insert into db_acount values($acount,100023,100121,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd17_i_grupoatend'))."','$this->sd17_i_grupoatend',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd17_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,100023,1008729,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd17_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,100023,100120,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd17_i_procedimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,100023,100121,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd17_i_grupoatend'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
