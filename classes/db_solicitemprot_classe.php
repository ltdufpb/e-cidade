...
class cl_solicitemprot { 
   ...
   public $pc49_solicitem = 0; 
   public $pc49_protprocesso = 0; 
   ...
   function incluir ($pc49_solicitem){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1311,7832,'','".AddSlashes(pg_fetch_result($resaco,0,'pc49_solicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1311,7833,'','".AddSlashes(pg_fetch_result($resaco,0,'pc49_protprocesso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc49_solicitem=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc49_solicitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc49_solicitem"])){ 
       $sql  .= $virgula." pc49_solicitem = $this->pc49_solicitem ";
       $virgula = ",";
       if(trim((string) $this->pc49_solicitem) == null ){ 
     ...
     if(trim((string) $this->pc49_protprocesso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc49_protprocesso"])){ 
       $sql  .= $virgula." pc49_protprocesso = $this->pc49_protprocesso ";
       $virgula = ",";
       if(trim((string) $this->pc49_protprocesso) == null ){ 
         $this->erro_sql = " Campo Código do processo nao Informado.";
         $this->erro_campo = "pc49_protprocesso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc49_solicitem"]))
           $resac = db_query("insert into db_acount values($acount,1311,7832,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc49_solicitem'))."','$this->pc49_solicitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc49_protprocesso"]))
           $resac = db_query("insert into db_acount values($acount,1311,7833,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc49_protprocesso'))."','$this->pc49_protprocesso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc49_solicitem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1311,7832,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc49_solicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1311,7833,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc49_protprocesso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
