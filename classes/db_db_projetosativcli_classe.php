...
class cl_db_projetosativcli { 
   ...
   public $at64_sequencial = 0; 
   public $at64_codproj = 0; 
   public $at64_codativ = 0; 
   public $at64_dtini_dia = null; 
   public $at64_dtini_mes = null; 
   public $at64_dtini_ano = null; 
   public $at64_dtini = null; 
   public $at64_dtfim_dia = null; 
   public $at64_dtfim_mes = null; 
   public $at64_dtfim_ano = null; 
   public $at64_dtfim = null; 
   public $at64_situacao = 0; 
   public $at64_descricao = null; 
   ...
   function incluir ($at64_sequencial){ 
     ...
     if($at64_sequencial == "" || $at64_sequencial == null ){
       ...
       $this->at64_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_projetosclientes_at64_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at64_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1414,8358,'','".AddSlashes(pg_fetch_result($resaco,0,'at64_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1414,8359,'','".AddSlashes(pg_fetch_result($resaco,0,'at64_codproj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1414,8360,'','".AddSlashes(pg_fetch_result($resaco,0,'at64_codativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1414,9740,'','".AddSlashes(pg_fetch_result($resaco,0,'at64_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1414,9741,'','".AddSlashes(pg_fetch_result($resaco,0,'at64_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1414,8352,'','".AddSlashes(pg_fetch_result($resaco,0,'at64_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1414,11855,'','".AddSlashes(pg_fetch_result($resaco,0,'at64_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at64_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at64_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at64_sequencial"])){ 
       $sql  .= $virgula." at64_sequencial = $this->at64_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at64_sequencial) == null ){ 
     ...
     if(trim((string) $this->at64_codproj)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at64_codproj"])){ 
       $sql  .= $virgula." at64_codproj = $this->at64_codproj ";
       $virgula = ",";
       if(trim((string) $this->at64_codproj) == null ){ 
         $this->erro_sql = " Campo Codigo do projeto nao Informado.";
         $this->erro_campo = "at64_codproj";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at64_codativ)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at64_codativ"])){ 
       $sql  .= $virgula." at64_codativ = $this->at64_codativ ";
       $virgula = ",";
       if(trim((string) $this->at64_codativ) == null ){ 
         $this->erro_sql = " Campo Código Atividade nao Informado.";
         $this->erro_campo = "at64_codativ";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at64_dtini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at64_dtini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["at64_dtini_dia"] !="") ){ 
       $sql  .= $virgula." at64_dtini = '$this->at64_dtini' ";
       $virgula = ",";
       if(trim((string) $this->at64_dtini) == null ){ 
         $this->erro_sql = " Campo Data Inicio nao Informado.";
         $this->erro_campo = "at64_dtini_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at64_dtfim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at64_dtfim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["at64_dtfim_dia"] !="") ){ 
       $sql  .= $virgula." at64_dtfim = '$this->at64_dtfim' ";
       $virgula = ",";
       if(trim((string) $this->at64_dtfim) == null ){ 
         $this->erro_sql = " Campo Data Final nao Informado.";
         $this->erro_campo = "at64_dtfim_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at64_situacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at64_situacao"])){ 
       $sql  .= $virgula." at64_situacao = $this->at64_situacao ";
       $virgula = ",";
       if(trim((string) $this->at64_situacao) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
         $this->erro_campo = "at64_situacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at64_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at64_descricao"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at64_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1414,8358,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at64_sequencial'))."','$this->at64_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at64_codproj"]))
           $resac = db_query("insert into db_acount values($acount,1414,8359,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at64_codproj'))."','$this->at64_codproj',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at64_codativ"]))
           $resac = db_query("insert into db_acount values($acount,1414,8360,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at64_codativ'))."','$this->at64_codativ',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at64_dtini"]))
           $resac = db_query("insert into db_acount values($acount,1414,9740,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at64_dtini'))."','$this->at64_dtini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at64_dtfim"]))
           $resac = db_query("insert into db_acount values($acount,1414,9741,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at64_dtfim'))."','$this->at64_dtfim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at64_situacao"]))
           $resac = db_query("insert into db_acount values($acount,1414,8352,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at64_situacao'))."','$this->at64_situacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at64_descricao"]))
           $resac = db_query("insert into db_acount values($acount,1414,11855,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at64_descricao'))."','$this->at64_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at64_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1414,8358,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at64_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1414,8359,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at64_codproj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1414,8360,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at64_codativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1414,9740,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at64_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1414,9741,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at64_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1414,8352,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at64_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1414,11855,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at64_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
