...
class cl_rhfopag { 
   ...
   public $rh66_regist = 0; 
   public $rh66_pis = null; 
   public $rh66_valor = 0; 
   public $rh66_proces = 0; 
   public $rh66_instit = 0; 
   ...
   function incluir ($rh66_regist,$rh66_instit){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1750,10177,'','".AddSlashes(pg_fetch_result($resaco,0,'rh66_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1750,10174,'','".AddSlashes(pg_fetch_result($resaco,0,'rh66_pis'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1750,10175,'','".AddSlashes(pg_fetch_result($resaco,0,'rh66_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1750,10176,'','".AddSlashes(pg_fetch_result($resaco,0,'rh66_proces'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1750,10179,'','".AddSlashes(pg_fetch_result($resaco,0,'rh66_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh66_regist=null,$rh66_instit=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh66_regist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh66_regist"])){ 
       $sql  .= $virgula." rh66_regist = $this->rh66_regist ";
       $virgula = ",";
       if(trim((string) $this->rh66_regist) == null ){ 
     ...
     if(trim((string) $this->rh66_pis)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh66_pis"])){ 
       $sql  .= $virgula." rh66_pis = '$this->rh66_pis' ";
       $virgula = ",";
       if(trim((string) $this->rh66_pis) == null ){ 
         $this->erro_sql = " Campo Nro PIS nao Informado.";
         $this->erro_campo = "rh66_pis";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh66_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh66_valor"])){ 
       $sql  .= $virgula." rh66_valor = $this->rh66_valor ";
       $virgula = ",";
       if(trim((string) $this->rh66_valor) == null ){ 
         $this->erro_sql = " Campo Valor nao Informado.";
         $this->erro_campo = "rh66_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh66_proces)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh66_proces"])){ 
       $sql  .= $virgula." rh66_proces = $this->rh66_proces ";
       $virgula = ",";
       if(trim((string) $this->rh66_proces) == null ){ 
         $this->erro_sql = " Campo Processado nao Informado.";
         $this->erro_campo = "rh66_proces";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh66_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh66_instit"])){ 
       $sql  .= $virgula." rh66_instit = $this->rh66_instit ";
       $virgula = ",";
       if(trim((string) $this->rh66_instit) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh66_regist"]))
           $resac = db_query("insert into db_acount values($acount,1750,10177,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh66_regist'))."','$this->rh66_regist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh66_pis"]))
           $resac = db_query("insert into db_acount values($acount,1750,10174,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh66_pis'))."','$this->rh66_pis',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh66_valor"]))
           $resac = db_query("insert into db_acount values($acount,1750,10175,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh66_valor'))."','$this->rh66_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh66_proces"]))
           $resac = db_query("insert into db_acount values($acount,1750,10176,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh66_proces'))."','$this->rh66_proces',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh66_instit"]))
           $resac = db_query("insert into db_acount values($acount,1750,10179,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh66_instit'))."','$this->rh66_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh66_regist=null,$rh66_instit=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1750,10177,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh66_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1750,10174,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh66_pis'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1750,10175,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh66_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1750,10176,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh66_proces'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1750,10179,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh66_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
