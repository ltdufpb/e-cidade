...
class cl_tarefalogitem { 
   ...
   public $at66_sequencial = 0; 
   public $at66_codmov = 0; 
   public $at66_id_item = 0; 
   ...
   function incluir ($at66_sequencial){ 
     ...
     if($at66_sequencial == "" || $at66_sequencial == null ){
       ...
       $this->at66_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tarefalogitem_at66_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at66_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1724,10037,'','".AddSlashes(pg_fetch_result($resaco,0,'at66_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1724,10038,'','".AddSlashes(pg_fetch_result($resaco,0,'at66_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1724,10039,'','".AddSlashes(pg_fetch_result($resaco,0,'at66_id_item'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at66_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at66_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at66_sequencial"])){ 
       $sql  .= $virgula." at66_sequencial = $this->at66_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at66_sequencial) == null ){ 
     ...
     if(trim((string) $this->at66_codmov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at66_codmov"])){ 
       $sql  .= $virgula." at66_codmov = $this->at66_codmov ";
       $virgula = ",";
       if(trim((string) $this->at66_codmov) == null ){ 
         $this->erro_sql = " Campo Mov. Tarefa nao Informado.";
         $this->erro_campo = "at66_codmov";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at66_id_item)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at66_id_item"])){ 
       $sql  .= $virgula." at66_id_item = $this->at66_id_item ";
       $virgula = ",";
       if(trim((string) $this->at66_id_item) == null ){ 
         $this->erro_sql = " Campo Código do ítem nao Informado.";
         $this->erro_campo = "at66_id_item";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at66_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1724,10037,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at66_sequencial'))."','$this->at66_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at66_codmov"]))
           $resac = db_query("insert into db_acount values($acount,1724,10038,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at66_codmov'))."','$this->at66_codmov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at66_id_item"]))
           $resac = db_query("insert into db_acount values($acount,1724,10039,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at66_id_item'))."','$this->at66_id_item',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at66_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1724,10037,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at66_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1724,10038,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at66_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1724,10039,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at66_id_item'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
