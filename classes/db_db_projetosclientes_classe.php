...
class cl_db_projetosclientes { 
   ...
   public $at64_projeto = 0; 
   public $at64_cliente = 0; 
   ...
   function incluir ($at64_sequencial){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1414,8359,'','".AddSlashes(pg_fetch_result($resaco,0,'at64_projeto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1414,8360,'','".AddSlashes(pg_fetch_result($resaco,0,'at64_cliente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at64_sequencial=null) { 
     ...
     if(trim((string) $this->at64_projeto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at64_projeto"])){ 
       $sql  .= $virgula." at64_projeto = $this->at64_projeto ";
       $virgula = ",";
       if(trim((string) $this->at64_projeto) == null ){ 
         $this->erro_sql = " Campo Codigo do projeto nao Informado.";
         $this->erro_campo = "at64_projeto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at64_cliente)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at64_cliente"])){ 
       $sql  .= $virgula." at64_cliente = $this->at64_cliente ";
       $virgula = ",";
       if(trim((string) $this->at64_cliente) == null ){ 
         $this->erro_sql = " Campo Código do cliente nao Informado.";
         $this->erro_campo = "at64_cliente";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at64_projeto"]))
           $resac = db_query("insert into db_acount values($acount,1414,8359,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at64_projeto'))."','$this->at64_projeto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at64_cliente"]))
           $resac = db_query("insert into db_acount values($acount,1414,8360,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at64_cliente'))."','$this->at64_cliente',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at64_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1414,8359,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at64_projeto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1414,8360,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at64_cliente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
