...
class cl_matestoquerec { 
   ...
   public $m84_matestoqueinitrans = 0; 
   public $m84_matestoqueinirec = 0; 
   ...
   function incluir ($m84_matestoqueinitrans){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1143,6935,'','".AddSlashes(pg_fetch_result($resaco,0,'m84_matestoqueinitrans'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1143,6936,'','".AddSlashes(pg_fetch_result($resaco,0,'m84_matestoqueinirec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($m84_matestoqueinitrans=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->m84_matestoqueinitrans)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m84_matestoqueinitrans"])){ 
       $sql  .= $virgula." m84_matestoqueinitrans = $this->m84_matestoqueinitrans ";
       $virgula = ",";
       if(trim((string) $this->m84_matestoqueinitrans) == null ){ 
         $this->erro_sql = " Campo Lançamento nao Informado.";
     ...
     if(trim((string) $this->m84_matestoqueinirec)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m84_matestoqueinirec"])){ 
       $sql  .= $virgula." m84_matestoqueinirec = $this->m84_matestoqueinirec ";
       $virgula = ",";
       if(trim((string) $this->m84_matestoqueinirec) == null ){ 
         $this->erro_sql = " Campo Lançamento nao Informado.";
         $this->erro_campo = "m84_matestoqueinirec";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["m84_matestoqueinitrans"]))
           $resac = db_query("insert into db_acount values($acount,1143,6935,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m84_matestoqueinitrans'))."','$this->m84_matestoqueinitrans',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m84_matestoqueinirec"]))
           $resac = db_query("insert into db_acount values($acount,1143,6936,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m84_matestoqueinirec'))."','$this->m84_matestoqueinirec',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($m84_matestoqueinitrans=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1143,6935,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m84_matestoqueinitrans'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1143,6936,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m84_matestoqueinirec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
