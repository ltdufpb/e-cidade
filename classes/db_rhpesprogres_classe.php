...
class cl_rhpesprogres { 
   ...
   public $rh07_seqpes = 0; 
   public $rh07_data_dia = null; 
   public $rh07_data_mes = null; 
   public $rh07_data_ano = null; 
   public $rh07_data = null; 
   ...
   function incluir ($rh07_seqpes){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1163,7052,'','".AddSlashes(pg_fetch_result($resaco,0,'rh07_seqpes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1163,7053,'','".AddSlashes(pg_fetch_result($resaco,0,'rh07_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh07_seqpes=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh07_seqpes)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh07_seqpes"])){ 
       $sql  .= $virgula." rh07_seqpes = $this->rh07_seqpes ";
       $virgula = ",";
       if(trim((string) $this->rh07_seqpes) == null ){ 
     ...
     if(trim((string) $this->rh07_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh07_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["rh07_data_dia"] !="") ){ 
       $sql  .= $virgula." rh07_data = '$this->rh07_data' ";
       $virgula = ",";
       if(trim((string) $this->rh07_data) == null ){ 
         $this->erro_sql = " Campo Data Para Progressão nao Informado.";
         $this->erro_campo = "rh07_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh07_seqpes"]))
           $resac = db_query("insert into db_acount values($acount,1163,7052,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh07_seqpes'))."','$this->rh07_seqpes',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh07_data"]))
           $resac = db_query("insert into db_acount values($acount,1163,7053,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh07_data'))."','$this->rh07_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh07_seqpes=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1163,7052,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh07_seqpes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1163,7053,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh07_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
