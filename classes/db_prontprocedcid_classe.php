...
class cl_prontprocedcid { 
   ...
   public $s135_i_codigo = 0; 
   public $s135_i_prontproced = 0; 
   public $s135_i_cid = 0; 
   ...
   function incluir ($s135_i_codigo){ 
     ...
     if($s135_i_codigo == "" || $s135_i_codigo == null ){
       ...
       $this->s135_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from prontprocedcid_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $s135_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2564,14574,'','".AddSlashes(pg_fetch_result($resaco,0,'s135_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2564,14575,'','".AddSlashes(pg_fetch_result($resaco,0,'s135_i_prontproced'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2564,14576,'','".AddSlashes(pg_fetch_result($resaco,0,'s135_i_cid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($s135_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->s135_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s135_i_codigo"])){ 
       $sql  .= $virgula." s135_i_codigo = $this->s135_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->s135_i_codigo) == null ){ 
     ...
     if(trim((string) $this->s135_i_prontproced)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s135_i_prontproced"])){ 
       $sql  .= $virgula." s135_i_prontproced = $this->s135_i_prontproced ";
       $virgula = ",";
       if(trim((string) $this->s135_i_prontproced) == null ){ 
         $this->erro_sql = " Campo Procedimento Prontuário nao Informado.";
         $this->erro_campo = "s135_i_prontproced";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s135_i_cid)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s135_i_cid"])){ 
       $sql  .= $virgula." s135_i_cid = $this->s135_i_cid ";
       $virgula = ",";
       if(trim((string) $this->s135_i_cid) == null ){ 
         $this->erro_sql = " Campo CID nao Informado.";
         $this->erro_campo = "s135_i_cid";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s135_i_codigo"]) || $this->s135_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2564,14574,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s135_i_codigo'))."','$this->s135_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s135_i_prontproced"]) || $this->s135_i_prontproced != "")
           $resac = db_query("insert into db_acount values($acount,2564,14575,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s135_i_prontproced'))."','$this->s135_i_prontproced',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s135_i_cid"]) || $this->s135_i_cid != "")
           $resac = db_query("insert into db_acount values($acount,2564,14576,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s135_i_cid'))."','$this->s135_i_cid',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($s135_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2564,14574,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s135_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2564,14575,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s135_i_prontproced'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2564,14576,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s135_i_cid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
