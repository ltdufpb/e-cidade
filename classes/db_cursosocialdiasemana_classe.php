...
class cl_cursosocialdiasemana { 
   ...
   public $as20_sequencial = 0; 
   public $as20_cursosocial = 0; 
   public $as20_diasemana = 0; 
   ...
   function incluir ($as20_sequencial){ 
     ...
     if($as20_sequencial == "" || $as20_sequencial == null ){
       ...
       $this->as20_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cursosocialdiasemana_as20_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $as20_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3579,19970,'','".AddSlashes(pg_fetch_result($resaco,0,'as20_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3579,19972,'','".AddSlashes(pg_fetch_result($resaco,0,'as20_cursosocial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3579,19971,'','".AddSlashes(pg_fetch_result($resaco,0,'as20_diasemana'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($as20_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->as20_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as20_sequencial"])){ 
       $sql  .= $virgula." as20_sequencial = $this->as20_sequencial ";
       $virgula = ",";
       if(trim((string) $this->as20_sequencial) == null ){ 
     ...
     if(trim((string) $this->as20_cursosocial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as20_cursosocial"])){ 
       $sql  .= $virgula." as20_cursosocial = $this->as20_cursosocial ";
       $virgula = ",";
       if(trim((string) $this->as20_cursosocial) == null ){ 
         $this->erro_sql = " Campo Curso Social nao Informado.";
         $this->erro_campo = "as20_cursosocial";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->as20_diasemana)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as20_diasemana"])){ 
       $sql  .= $virgula." as20_diasemana = $this->as20_diasemana ";
       $virgula = ",";
       if(trim((string) $this->as20_diasemana) == null ){ 
         $this->erro_sql = " Campo Dia da Semana nao Informado.";
         $this->erro_campo = "as20_diasemana";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["as20_sequencial"]) || $this->as20_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3579,19970,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as20_sequencial'))."','$this->as20_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["as20_cursosocial"]) || $this->as20_cursosocial != "")
             $resac = db_query("insert into db_acount values($acount,3579,19972,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as20_cursosocial'))."','$this->as20_cursosocial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["as20_diasemana"]) || $this->as20_diasemana != "")
             $resac = db_query("insert into db_acount values($acount,3579,19971,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as20_diasemana'))."','$this->as20_diasemana',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3579,19970,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as20_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3579,19972,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as20_cursosocial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3579,19971,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as20_diasemana'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
