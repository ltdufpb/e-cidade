...
class cl_notiemissao { 
   ...
   public $k136_sequencial = 0; 
   public $k136_notificatipogeracao = 0; 
   public $k136_recibo = 'f'; 
   public $k136_data_dia = null; 
   public $k136_data_mes = null; 
   public $k136_data_ano = null; 
   public $k136_data = null; 
   public $k136_usuario = 0; 
   ...
   function incluir ($k136_sequencial){ 
     ...
     if($k136_sequencial == "" || $k136_sequencial == null ){
       ...
       $this->k136_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from notiemissao_k136_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k136_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3282,18545,'','".AddSlashes(pg_fetch_result($resaco,0,'k136_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3282,18548,'','".AddSlashes(pg_fetch_result($resaco,0,'k136_notificatipogeracao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3282,18551,'','".AddSlashes(pg_fetch_result($resaco,0,'k136_recibo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3282,18549,'','".AddSlashes(pg_fetch_result($resaco,0,'k136_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3282,18550,'','".AddSlashes(pg_fetch_result($resaco,0,'k136_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k136_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k136_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k136_sequencial"])){ 
       $sql  .= $virgula." k136_sequencial = $this->k136_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k136_sequencial) == null ){ 
     ...
     if(trim((string) $this->k136_notificatipogeracao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k136_notificatipogeracao"])){ 
       $sql  .= $virgula." k136_notificatipogeracao = $this->k136_notificatipogeracao ";
       $virgula = ",";
       if(trim((string) $this->k136_notificatipogeracao) == null ){ 
         $this->erro_sql = " Campo Tipos de Geração de Notificação nao Informado.";
         $this->erro_campo = "k136_notificatipogeracao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k136_recibo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k136_recibo"])){ 
       $sql  .= $virgula." k136_recibo = '$this->k136_recibo' ";
       $virgula = ",";
       if(trim((string) $this->k136_recibo) == null ){ 
         $this->erro_sql = " Campo Recibo nao Informado.";
         $this->erro_campo = "k136_recibo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k136_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k136_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["k136_data_dia"] !="") ){ 
       $sql  .= $virgula." k136_data = '$this->k136_data' ";
       $virgula = ",";
       if(trim((string) $this->k136_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "k136_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k136_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k136_usuario"])){ 
       $sql  .= $virgula." k136_usuario = $this->k136_usuario ";
       $virgula = ",";
       if(trim((string) $this->k136_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "k136_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k136_sequencial"]) || $this->k136_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3282,18545,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k136_sequencial'))."','$this->k136_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k136_notificatipogeracao"]) || $this->k136_notificatipogeracao != "")
           $resac = db_query("insert into db_acount values($acount,3282,18548,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k136_notificatipogeracao'))."','$this->k136_notificatipogeracao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k136_recibo"]) || $this->k136_recibo != "")
           $resac = db_query("insert into db_acount values($acount,3282,18551,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k136_recibo'))."','$this->k136_recibo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k136_data"]) || $this->k136_data != "")
           $resac = db_query("insert into db_acount values($acount,3282,18549,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k136_data'))."','$this->k136_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k136_usuario"]) || $this->k136_usuario != "")
           $resac = db_query("insert into db_acount values($acount,3282,18550,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k136_usuario'))."','$this->k136_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k136_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3282,18545,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k136_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3282,18548,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k136_notificatipogeracao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3282,18551,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k136_recibo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3282,18549,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k136_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3282,18550,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k136_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
