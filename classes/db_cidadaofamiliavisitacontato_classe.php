...
class cl_cidadaofamiliavisitacontato { 
   ...
   public $as10_sequencial = 0; 
   public $as10_cidadaofamiliavisita = 0; 
   public $as10_profissionalcontato = 0; 
   public $as10_data_dia = null; 
   public $as10_data_mes = null; 
   public $as10_data_ano = null; 
   public $as10_data = null; 
   ...
   function incluir ($as10_sequencial){ 
     ...
     if($as10_sequencial == "" || $as10_sequencial == null ){
       ...
       $this->as10_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cidadaofamiliavisitacontato_as10_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $as10_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3491,19640,'','".AddSlashes(pg_fetch_result($resaco,0,'as10_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3491,19641,'','".AddSlashes(pg_fetch_result($resaco,0,'as10_cidadaofamiliavisita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3491,19642,'','".AddSlashes(pg_fetch_result($resaco,0,'as10_profissionalcontato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3491,19643,'','".AddSlashes(pg_fetch_result($resaco,0,'as10_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($as10_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->as10_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as10_sequencial"])){ 
       $sql  .= $virgula." as10_sequencial = $this->as10_sequencial ";
       $virgula = ",";
       if(trim((string) $this->as10_sequencial) == null ){ 
     ...
     if(trim((string) $this->as10_cidadaofamiliavisita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as10_cidadaofamiliavisita"])){ 
       $sql  .= $virgula." as10_cidadaofamiliavisita = $this->as10_cidadaofamiliavisita ";
       $virgula = ",";
       if(trim((string) $this->as10_cidadaofamiliavisita) == null ){ 
         $this->erro_sql = " Campo Código Cidadao Família Visita nao Informado.";
         $this->erro_campo = "as10_cidadaofamiliavisita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->as10_profissionalcontato)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as10_profissionalcontato"])){ 
       $sql  .= $virgula." as10_profissionalcontato = $this->as10_profissionalcontato ";
       $virgula = ",";
       if(trim((string) $this->as10_profissionalcontato) == null ){ 
         $this->erro_sql = " Campo Código Profissional nao Informado.";
         $this->erro_campo = "as10_profissionalcontato";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->as10_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as10_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["as10_data_dia"] !="") ){ 
       $sql  .= $virgula." as10_data = '$this->as10_data' ";
       $virgula = ",";
       if(trim((string) $this->as10_data) == null ){ 
         $this->erro_sql = " Campo Data do Contato nao Informado.";
         $this->erro_campo = "as10_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["as10_sequencial"]) || $this->as10_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3491,19640,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as10_sequencial'))."','$this->as10_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["as10_cidadaofamiliavisita"]) || $this->as10_cidadaofamiliavisita != "")
           $resac = db_query("insert into db_acount values($acount,3491,19641,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as10_cidadaofamiliavisita'))."','$this->as10_cidadaofamiliavisita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["as10_profissionalcontato"]) || $this->as10_profissionalcontato != "")
           $resac = db_query("insert into db_acount values($acount,3491,19642,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as10_profissionalcontato'))."','$this->as10_profissionalcontato',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["as10_data"]) || $this->as10_data != "")
           $resac = db_query("insert into db_acount values($acount,3491,19643,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as10_data'))."','$this->as10_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($as10_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3491,19640,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as10_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3491,19641,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as10_cidadaofamiliavisita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3491,19642,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as10_profissionalcontato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3491,19643,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as10_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
