...
class cl_far_laboratoriomed { 
   ...
   public $fa32_i_codigo = 0; 
   public $fa32_i_medanvisa = 0; 
   public $fa32_i_laboratorio = 0; 
   ...
   function incluir ($fa32_i_codigo){ 
     ...
     if($fa32_i_codigo == "" || $fa32_i_codigo == null ){
       ...
       $this->fa32_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_laboratoriomed_fa32_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa32_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2525,14352,'','".AddSlashes(pg_fetch_result($resaco,0,'fa32_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2525,14353,'','".AddSlashes(pg_fetch_result($resaco,0,'fa32_i_medanvisa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2525,14354,'','".AddSlashes(pg_fetch_result($resaco,0,'fa32_i_laboratorio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa32_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa32_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa32_i_codigo"])){ 
       $sql  .= $virgula." fa32_i_codigo = $this->fa32_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa32_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa32_i_medanvisa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa32_i_medanvisa"])){ 
       $sql  .= $virgula." fa32_i_medanvisa = $this->fa32_i_medanvisa ";
       $virgula = ",";
       if(trim((string) $this->fa32_i_medanvisa) == null ){ 
         $this->erro_sql = " Campo Medanvisa nao Informado.";
         $this->erro_campo = "fa32_i_medanvisa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa32_i_laboratorio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa32_i_laboratorio"])){ 
       $sql  .= $virgula." fa32_i_laboratorio = $this->fa32_i_laboratorio ";
       $virgula = ",";
       if(trim((string) $this->fa32_i_laboratorio) == null ){ 
         $this->erro_sql = " Campo Laboratorio nao Informado.";
         $this->erro_campo = "fa32_i_laboratorio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa32_i_codigo"]) || $this->fa32_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2525,14352,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa32_i_codigo'))."','$this->fa32_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa32_i_medanvisa"]) || $this->fa32_i_medanvisa != "")
           $resac = db_query("insert into db_acount values($acount,2525,14353,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa32_i_medanvisa'))."','$this->fa32_i_medanvisa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa32_i_laboratorio"]) || $this->fa32_i_laboratorio != "")
           $resac = db_query("insert into db_acount values($acount,2525,14354,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa32_i_laboratorio'))."','$this->fa32_i_laboratorio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa32_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2525,14352,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa32_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2525,14353,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa32_i_medanvisa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2525,14354,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa32_i_laboratorio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
