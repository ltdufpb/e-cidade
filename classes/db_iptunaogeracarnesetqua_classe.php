...
class cl_iptunaogeracarnesetqua { 
   ...
   public $j67_sequencial = 0; 
   public $j67_naogeracarne = 0; 
   public $j67_setor = null; 
   public $j67_quadra = null; 
   ...
   function incluir ($j67_sequencial){ 
     ...
     if($j67_sequencial == "" || $j67_sequencial == null ){
       ...
       $this->j67_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from iptunaogeracarnesetqua_j67_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $j67_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1385,8220,'','".AddSlashes(pg_fetch_result($resaco,0,'j67_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1385,8221,'','".AddSlashes(pg_fetch_result($resaco,0,'j67_naogeracarne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1385,8222,'','".AddSlashes(pg_fetch_result($resaco,0,'j67_setor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1385,8223,'','".AddSlashes(pg_fetch_result($resaco,0,'j67_quadra'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j67_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j67_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j67_sequencial"])){ 
       $sql  .= $virgula." j67_sequencial = $this->j67_sequencial ";
       $virgula = ",";
       if(trim((string) $this->j67_sequencial) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
     ...
     if(trim((string) $this->j67_naogeracarne)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j67_naogeracarne"])){ 
       $sql  .= $virgula." j67_naogeracarne = $this->j67_naogeracarne ";
       $virgula = ",";
       if(trim((string) $this->j67_naogeracarne) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
         $this->erro_campo = "j67_naogeracarne";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j67_setor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j67_setor"])){ 
       $sql  .= $virgula." j67_setor = '$this->j67_setor' ";
       $virgula = ",";
       if(trim((string) $this->j67_setor) == null ){ 
         $this->erro_sql = " Campo Cód. Setor nao Informado.";
         $this->erro_campo = "j67_setor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j67_quadra)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j67_quadra"])){ 
       $sql  .= $virgula." j67_quadra = '$this->j67_quadra' ";
       $virgula = ",";
       if(trim((string) $this->j67_quadra) == null ){ 
         $this->erro_sql = " Campo Quadra nao Informado.";
         $this->erro_campo = "j67_quadra";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j67_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1385,8220,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j67_sequencial'))."','$this->j67_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j67_naogeracarne"]))
           $resac = db_query("insert into db_acount values($acount,1385,8221,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j67_naogeracarne'))."','$this->j67_naogeracarne',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j67_setor"]))
           $resac = db_query("insert into db_acount values($acount,1385,8222,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j67_setor'))."','$this->j67_setor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j67_quadra"]))
           $resac = db_query("insert into db_acount values($acount,1385,8223,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j67_quadra'))."','$this->j67_quadra',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j67_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1385,8220,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j67_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1385,8221,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j67_naogeracarne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1385,8222,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j67_setor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1385,8223,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j67_quadra'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
