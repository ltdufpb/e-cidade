...
class cl_cursoturno {
   ...
   public $ed85_i_codigo = 0;
   public $ed85_i_escola = 0;
   public $ed85_i_curso = 0;
   public $ed85_i_turno = 0;
   ...
   function incluir ($ed85_i_codigo){
     ...
     if($ed85_i_codigo == "" || $ed85_i_codigo == null ){
       ...
       $this->ed85_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from cursoturno_ed85_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed85_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010102,1008572,'','".AddSlashes(pg_fetch_result($resaco,0,'ed85_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010102,1008575,'','".AddSlashes(pg_fetch_result($resaco,0,'ed85_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010102,1008573,'','".AddSlashes(pg_fetch_result($resaco,0,'ed85_i_curso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010102,1008574,'','".AddSlashes(pg_fetch_result($resaco,0,'ed85_i_turno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($ed85_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->ed85_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed85_i_codigo"])){
       $sql  .= $virgula." ed85_i_codigo = $this->ed85_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed85_i_codigo) == null ){
     ...
     if(trim((string) $this->ed85_i_escola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed85_i_escola"])){
       $sql  .= $virgula." ed85_i_escola = $this->ed85_i_escola ";
       $virgula = ",";
       if(trim((string) $this->ed85_i_escola) == null ){
         $this->erro_sql = " Campo Escola nao Informado.";
         $this->erro_campo = "ed85_i_escola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed85_i_curso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed85_i_curso"])){
       $sql  .= $virgula." ed85_i_curso = $this->ed85_i_curso ";
       $virgula = ",";
       if(trim((string) $this->ed85_i_curso) == null ){
         $this->erro_sql = " Campo Curso nao Informado.";
         $this->erro_campo = "ed85_i_curso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed85_i_turno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed85_i_turno"])){
       $sql  .= $virgula." ed85_i_turno = $this->ed85_i_turno ";
       $virgula = ",";
       if(trim((string) $this->ed85_i_turno) == null ){
         $this->erro_sql = " Campo Turno nao Informado.";
         $this->erro_campo = "ed85_i_turno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed85_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010102,1008572,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed85_i_codigo'))."','$this->ed85_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed85_i_escola"]))
           $resac = db_query("insert into db_acount values($acount,1010102,1008575,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed85_i_escola'))."','$this->ed85_i_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed85_i_curso"]))
           $resac = db_query("insert into db_acount values($acount,1010102,1008573,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed85_i_curso'))."','$this->ed85_i_curso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed85_i_turno"]))
           $resac = db_query("insert into db_acount values($acount,1010102,1008574,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed85_i_turno'))."','$this->ed85_i_turno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($ed85_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010102,1008572,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed85_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010102,1008575,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed85_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010102,1008573,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed85_i_curso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010102,1008574,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed85_i_turno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
