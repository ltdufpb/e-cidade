...
class cl_autoultandam { 
   ...
   function incluir ($y16_codauto,$y16_codandam){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,735,5148,'','".AddSlashes(pg_fetch_result($resaco,0,'y16_codauto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,735,5149,'','".AddSlashes(pg_fetch_result($resaco,0,'y16_codandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y16_codauto=null,$y16_codandam=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y16_codauto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y16_codauto"])){ 
       $sql  .= $virgula." y16_codauto = $this->y16_codauto ";
       $virgula = ",";
       if(trim((string) $this->y16_codauto) == null ){ 
     ...
     if(trim((string) $this->y16_codandam)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y16_codandam"])){ 
       $sql  .= $virgula." y16_codandam = $this->y16_codandam ";
       $virgula = ",";
       if(trim((string) $this->y16_codandam) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y16_codauto"]))
           $resac = db_query("insert into db_acount values($acount,735,5148,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y16_codauto'))."','$this->y16_codauto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y16_codandam"]))
           $resac = db_query("insert into db_acount values($acount,735,5149,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y16_codandam'))."','$this->y16_codandam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y16_codauto=null,$y16_codandam=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,735,5148,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y16_codauto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,735,5149,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y16_codandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
