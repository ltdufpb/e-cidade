...
class cl_conlancamord { 
   ...
   public $c80_codlan = 0; 
   public $c80_codord = 0; 
   public $c80_data_dia = null; 
   public $c80_data_mes = null; 
   public $c80_data_ano = null; 
   public $c80_data = null; 
   ...
   function incluir ($c80_codlan){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,809,5446,'','".AddSlashes(pg_fetch_result($resaco,0,'c80_codlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,809,5442,'','".AddSlashes(pg_fetch_result($resaco,0,'c80_codord'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,809,5903,'','".AddSlashes(pg_fetch_result($resaco,0,'c80_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($c80_codlan=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->c80_codlan)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c80_codlan"])){ 
       $sql  .= $virgula." c80_codlan = $this->c80_codlan ";
       $virgula = ",";
       if(trim((string) $this->c80_codlan) == null ){ 
     ...
     if(trim((string) $this->c80_codord)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c80_codord"])){ 
       $sql  .= $virgula." c80_codord = $this->c80_codord ";
       $virgula = ",";
       if(trim((string) $this->c80_codord) == null ){ 
         $this->erro_sql = " Campo Ordem nao Informado.";
         $this->erro_campo = "c80_codord";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c80_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c80_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["c80_data_dia"] !="") ){ 
       $sql  .= $virgula." c80_data = '$this->c80_data' ";
       $virgula = ",";
       if(trim((string) $this->c80_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "c80_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c80_codlan"]))
           $resac = db_query("insert into db_acount values($acount,809,5446,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c80_codlan'))."','$this->c80_codlan',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c80_codord"]))
           $resac = db_query("insert into db_acount values($acount,809,5442,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c80_codord'))."','$this->c80_codord',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c80_data"]))
           $resac = db_query("insert into db_acount values($acount,809,5903,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c80_data'))."','$this->c80_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($c80_codlan=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,809,5446,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c80_codlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,809,5442,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c80_codord'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,809,5903,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c80_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
