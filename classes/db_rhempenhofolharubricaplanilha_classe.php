...
class cl_rhempenhofolharubricaplanilha { 
   ...
   public $rh111_sequencial = 0; 
   public $rh111_rhempenhofolharubrica = 0; 
   public $rh111_placaixarec = 0; 
   ...
   function incluir ($rh111_sequencial){ 
     ...
     if($rh111_sequencial == "" || $rh111_sequencial == null ){
       ...
       $this->rh111_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhempenhofolharubricaplanilha_rh111_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh111_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3408,19184,'','".AddSlashes(pg_fetch_result($resaco,0,'rh111_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3408,19185,'','".AddSlashes(pg_fetch_result($resaco,0,'rh111_rhempenhofolharubrica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3408,19186,'','".AddSlashes(pg_fetch_result($resaco,0,'rh111_placaixarec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh111_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh111_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh111_sequencial"])){ 
       $sql  .= $virgula." rh111_sequencial = $this->rh111_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh111_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh111_rhempenhofolharubrica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh111_rhempenhofolharubrica"])){ 
       $sql  .= $virgula." rh111_rhempenhofolharubrica = $this->rh111_rhempenhofolharubrica ";
       $virgula = ",";
       if(trim((string) $this->rh111_rhempenhofolharubrica) == null ){ 
         $this->erro_sql = " Campo rhempenhofolharubrica nao Informado.";
         $this->erro_campo = "rh111_rhempenhofolharubrica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh111_placaixarec)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh111_placaixarec"])){ 
       $sql  .= $virgula." rh111_placaixarec = $this->rh111_placaixarec ";
       $virgula = ",";
       if(trim((string) $this->rh111_placaixarec) == null ){ 
         $this->erro_sql = " Campo placaixarec nao Informado.";
         $this->erro_campo = "rh111_placaixarec";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh111_sequencial"]) || $this->rh111_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3408,19184,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh111_sequencial'))."','$this->rh111_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh111_rhempenhofolharubrica"]) || $this->rh111_rhempenhofolharubrica != "")
           $resac = db_query("insert into db_acount values($acount,3408,19185,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh111_rhempenhofolharubrica'))."','$this->rh111_rhempenhofolharubrica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh111_placaixarec"]) || $this->rh111_placaixarec != "")
           $resac = db_query("insert into db_acount values($acount,3408,19186,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh111_placaixarec'))."','$this->rh111_placaixarec',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh111_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3408,19184,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh111_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3408,19185,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh111_rhempenhofolharubrica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3408,19186,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh111_placaixarec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
