...
class cl_laboratorios { 
   ...
   public $ed16_c_computador = null; 
   public $ed16_c_ativo = null; 
   public $ed16_t_descr = null; 
   ...
   function incluir ($ed16_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acount values($acount,1006008,1006034,'','".AddSlashes(pg_fetch_result($resaco,0,'ed16_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1006008,1006035,'','".AddSlashes(pg_fetch_result($resaco,0,'ed16_c_computador'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1006008,1006128,'','".AddSlashes(pg_fetch_result($resaco,0,'ed16_c_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1006008,1006129,'','".AddSlashes(pg_fetch_result($resaco,0,'ed16_t_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed16_i_codigo=null) { 
     ...
     if(trim((string) $this->ed16_c_computador)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed16_c_computador"])){ 
       $sql  .= $virgula." ed16_c_computador = '$this->ed16_c_computador' ";
       $virgula = ",";
       if(trim((string) $this->ed16_c_computador) == null ){ 
         $this->erro_sql = " Campo Computador nao Informado.";
         $this->erro_campo = "ed16_c_computador";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed16_c_ativo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed16_c_ativo"])){ 
       $sql  .= $virgula." ed16_c_ativo = '$this->ed16_c_ativo' ";
       $virgula = ",";
       if(trim((string) $this->ed16_c_ativo) == null ){ 
         $this->erro_sql = " Campo Ativo nao Informado.";
         $this->erro_campo = "ed16_c_ativo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed16_t_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed16_t_descr"])){ 
       $sql  .= $virgula." ed16_t_descr = '$this->ed16_t_descr' ";
       $virgula = ",";
       if(trim((string) $this->ed16_t_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "ed16_t_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed16_i_codigo"]))
           $resac = pg_query("insert into db_acount values($acount,1006008,1006034,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed16_i_codigo'))."','$this->ed16_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed16_c_computador"]))
           $resac = pg_query("insert into db_acount values($acount,1006008,1006035,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed16_c_computador'))."','$this->ed16_c_computador',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed16_c_ativo"]))
           $resac = pg_query("insert into db_acount values($acount,1006008,1006128,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed16_c_ativo'))."','$this->ed16_c_ativo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed16_t_descr"]))
           $resac = pg_query("insert into db_acount values($acount,1006008,1006129,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed16_t_descr'))."','$this->ed16_t_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($ed16_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = pg_query("insert into db_acount values($acount,1006008,1006034,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed16_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1006008,1006035,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed16_c_computador'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1006008,1006128,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed16_c_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1006008,1006129,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed16_t_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
