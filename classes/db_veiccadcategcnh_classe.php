...
class cl_veiccadcategcnh { 
   ...
   public $ve30_codigo = 0; 
   public $ve30_descr = null; 
   ...
   function incluir ($ve30_codigo){ 
     ...
     if($ve30_codigo == "" || $ve30_codigo == null ){
       ...
       $this->ve30_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veiccadcategcnh_ve30_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve30_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1583,9236,'','".AddSlashes(pg_fetch_result($resaco,0,'ve30_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1583,9237,'','".AddSlashes(pg_fetch_result($resaco,0,'ve30_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve30_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve30_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve30_codigo"])){ 
       $sql  .= $virgula." ve30_codigo = $this->ve30_codigo ";
       $virgula = ",";
       if(trim((string) $this->ve30_codigo) == null ){ 
     ...
     if(trim((string) $this->ve30_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve30_descr"])){ 
       $sql  .= $virgula." ve30_descr = '$this->ve30_descr' ";
       $virgula = ",";
       if(trim((string) $this->ve30_descr) == null ){ 
         $this->erro_sql = " Campo Descrição Categoria CNH nao Informado.";
         $this->erro_campo = "ve30_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve30_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1583,9236,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve30_codigo'))."','$this->ve30_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve30_descr"]))
           $resac = db_query("insert into db_acount values($acount,1583,9237,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve30_descr'))."','$this->ve30_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve30_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1583,9236,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve30_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1583,9237,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve30_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
