...
class cl_avaliacaoquestionariointerno { 
   ...
   public $db170_sequencial = 0; 
   public $db170_avaliacao = 0; 
   public $db170_transmitido = 'f'; 
   public $db170_ativo = 'f'; 
   public $db170_codigo = 0; 
   ...
   function incluir ($db170_sequencial){ 
     ...
     if($db170_sequencial == "" || $db170_sequencial == null ){
       ...
       $this->db170_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from avaliacaoquestionariointerno_db170_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db170_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3964,22024,'','".AddSlashes(pg_fetch_result($resaco,0,'db170_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3964,22025,'','".AddSlashes(pg_fetch_result($resaco,0,'db170_avaliacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3964,22023,'','".AddSlashes(pg_fetch_result($resaco,0,'db170_transmitido'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3964,22022,'','".AddSlashes(pg_fetch_result($resaco,0,'db170_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3964,22045,'','".AddSlashes(pg_fetch_result($resaco,0,'db170_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($db170_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db170_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db170_sequencial"])){ 
       $sql  .= $virgula." db170_sequencial = $this->db170_sequencial ";
       $virgula = ",";
       if(trim((string) $this->db170_sequencial) == null ){ 
     ...
     if(trim((string) $this->db170_avaliacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db170_avaliacao"])){ 
       $sql  .= $virgula." db170_avaliacao = $this->db170_avaliacao ";
       $virgula = ",";
       if(trim((string) $this->db170_avaliacao) == null ){ 
         $this->erro_sql = " Campo Código da Avaliação não informado.";
         $this->erro_campo = "db170_avaliacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db170_transmitido)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db170_transmitido"])){ 
       $sql  .= $virgula." db170_transmitido = '$this->db170_transmitido' ";
       $virgula = ",";
     }
     if(trim((string) $this->db170_ativo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db170_ativo"])){ 
       $sql  .= $virgula." db170_ativo = '$this->db170_ativo' ";
       $virgula = ",";
     }
     if(trim((string) $this->db170_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db170_codigo"])){ 
        if(trim((string) $this->db170_codigo)=="" && isset($GLOBALS["HTTP_POST_VARS"]["db170_codigo"])){ 
           $this->db170_codigo = "0" ; 
        } 
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["db170_sequencial"]) || $this->db170_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3964,22024,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db170_sequencial'))."','$this->db170_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["db170_avaliacao"]) || $this->db170_avaliacao != "")
             $resac = db_query("insert into db_acount values($acount,3964,22025,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db170_avaliacao'))."','$this->db170_avaliacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["db170_transmitido"]) || $this->db170_transmitido != "")
             $resac = db_query("insert into db_acount values($acount,3964,22023,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db170_transmitido'))."','$this->db170_transmitido',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["db170_ativo"]) || $this->db170_ativo != "")
             $resac = db_query("insert into db_acount values($acount,3964,22022,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db170_ativo'))."','$this->db170_ativo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["db170_codigo"]) || $this->db170_codigo != "")
             $resac = db_query("insert into db_acount values($acount,3964,22045,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db170_codigo'))."','$this->db170_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3964,22024,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db170_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3964,22025,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db170_avaliacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3964,22023,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db170_transmitido'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3964,22022,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db170_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3964,22045,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db170_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
