...
class cl_atinota { 
   ...
   function incluir ($q14_ativ,$q14_nota){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,121,659,'','".AddSlashes(pg_fetch_result($resaco,0,'q14_ativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,121,660,'','".AddSlashes(pg_fetch_result($resaco,0,'q14_nota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q14_ativ=null,$q14_nota=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q14_ativ)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q14_ativ"])){ 
       $sql  .= $virgula." q14_ativ = $this->q14_ativ ";
       $virgula = ",";
       if(trim((string) $this->q14_ativ) == null ){ 
     ...
     if(trim((string) $this->q14_nota)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q14_nota"])){ 
       $sql  .= $virgula." q14_nota = $this->q14_nota ";
       $virgula = ",";
       if(trim((string) $this->q14_nota) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q14_ativ"]))
           $resac = db_query("insert into db_acount values($acount,121,659,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q14_ativ'))."','$this->q14_ativ',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q14_nota"]))
           $resac = db_query("insert into db_acount values($acount,121,660,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q14_nota'))."','$this->q14_nota',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q14_ativ=null,$q14_nota=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,121,659,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q14_ativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,121,660,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q14_nota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
