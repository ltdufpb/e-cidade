...
class cl_rhiperegist { 
   ...
   public $rh62_sequencia = 0; 
   public $rh62_regist = 0; 
   ...
   function incluir ($rh62_sequencia){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1642,9574,'','".AddSlashes(pg_fetch_result($resaco,0,'rh62_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1642,9576,'','".AddSlashes(pg_fetch_result($resaco,0,'rh62_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh62_sequencia=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh62_sequencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh62_sequencia"])){ 
       $sql  .= $virgula." rh62_sequencia = $this->rh62_sequencia ";
       $virgula = ",";
       if(trim((string) $this->rh62_sequencia) == null ){ 
     ...
     if(trim((string) $this->rh62_regist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh62_regist"])){ 
       $sql  .= $virgula." rh62_regist = $this->rh62_regist ";
       $virgula = ",";
       if(trim((string) $this->rh62_regist) == null ){ 
         $this->erro_sql = " Campo Matrícula do Servidor nao Informado.";
         $this->erro_campo = "rh62_regist";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh62_sequencia"]))
           $resac = db_query("insert into db_acount values($acount,1642,9574,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh62_sequencia'))."','$this->rh62_sequencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh62_regist"]))
           $resac = db_query("insert into db_acount values($acount,1642,9576,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh62_regist'))."','$this->rh62_regist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh62_sequencia=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1642,9574,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh62_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1642,9576,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh62_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
