...
class cl_prescricaoanula { 
   ...
   public $k120_sequencial = 0; 
   public $k120_id_usuario = 0; 
   public $k120_instit = 0; 
   public $k120_obs = null; 
   public $k120_data_dia = null; 
   public $k120_data_mes = null; 
   public $k120_data_ano = null; 
   public $k120_data = null; 
   public $k120_hora = null; 
   ...
   function incluir ($k120_sequencial){ 
     ...
     if($k120_sequencial == "" || $k120_sequencial == null ){
       ...
       $this->k120_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from prescricaoanula_k120_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k120_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3113,17624,'','".AddSlashes(pg_fetch_result($resaco,0,'k120_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3113,17625,'','".AddSlashes(pg_fetch_result($resaco,0,'k120_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3113,17626,'','".AddSlashes(pg_fetch_result($resaco,0,'k120_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3113,17627,'','".AddSlashes(pg_fetch_result($resaco,0,'k120_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3113,17628,'','".AddSlashes(pg_fetch_result($resaco,0,'k120_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3113,17629,'','".AddSlashes(pg_fetch_result($resaco,0,'k120_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k120_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k120_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k120_sequencial"])){ 
       $sql  .= $virgula." k120_sequencial = $this->k120_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k120_sequencial) == null ){ 
     ...
     if(trim((string) $this->k120_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k120_id_usuario"])){ 
       $sql  .= $virgula." k120_id_usuario = $this->k120_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->k120_id_usuario) == null ){ 
         $this->erro_sql = " Campo Id Usuário nao Informado.";
         $this->erro_campo = "k120_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k120_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k120_instit"])){ 
       $sql  .= $virgula." k120_instit = $this->k120_instit ";
       $virgula = ",";
       if(trim((string) $this->k120_instit) == null ){ 
         $this->erro_sql = " Campo Instituição nao Informado.";
         $this->erro_campo = "k120_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k120_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k120_obs"])){ 
       $sql  .= $virgula." k120_obs = '$this->k120_obs' ";
       $virgula = ",";
       if(trim((string) $this->k120_obs) == null ){ 
         $this->erro_sql = " Campo Observação nao Informado.";
         $this->erro_campo = "k120_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k120_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k120_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["k120_data_dia"] !="") ){ 
       $sql  .= $virgula." k120_data = '$this->k120_data' ";
       $virgula = ",";
       if(trim((string) $this->k120_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "k120_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k120_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k120_hora"])){ 
       $sql  .= $virgula." k120_hora = '$this->k120_hora' ";
       $virgula = ",";
       if(trim((string) $this->k120_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "k120_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k120_sequencial"]) || $this->k120_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3113,17624,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k120_sequencial'))."','$this->k120_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k120_id_usuario"]) || $this->k120_id_usuario != "")
           $resac = db_query("insert into db_acount values($acount,3113,17625,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k120_id_usuario'))."','$this->k120_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k120_instit"]) || $this->k120_instit != "")
           $resac = db_query("insert into db_acount values($acount,3113,17626,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k120_instit'))."','$this->k120_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k120_obs"]) || $this->k120_obs != "")
           $resac = db_query("insert into db_acount values($acount,3113,17627,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k120_obs'))."','$this->k120_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k120_data"]) || $this->k120_data != "")
           $resac = db_query("insert into db_acount values($acount,3113,17628,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k120_data'))."','$this->k120_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k120_hora"]) || $this->k120_hora != "")
           $resac = db_query("insert into db_acount values($acount,3113,17629,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k120_hora'))."','$this->k120_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k120_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3113,17624,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k120_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3113,17625,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k120_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3113,17626,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k120_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3113,17627,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k120_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3113,17628,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k120_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3113,17629,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k120_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
