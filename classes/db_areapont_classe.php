...
class cl_areapont { 
   ...
   public $q28_sequencia = 0; 
   public $q28_quantini = 0; 
   public $q28_quantfim = 0; 
   public $q28_pontuacao = 0; 
   ...
   function incluir ($q28_sequencia){ 
     ...
     if($q28_sequencia == "" || $q28_sequencia == null ){
       ...
       $this->q28_sequencia = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from areapont_q28_sequencia_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q28_sequencia)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1493,8750,'','".AddSlashes(pg_fetch_result($resaco,0,'q28_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1493,8751,'','".AddSlashes(pg_fetch_result($resaco,0,'q28_quantini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1493,8752,'','".AddSlashes(pg_fetch_result($resaco,0,'q28_quantfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1493,8753,'','".AddSlashes(pg_fetch_result($resaco,0,'q28_pontuacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q28_sequencia=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q28_sequencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q28_sequencia"])){ 
       $sql  .= $virgula." q28_sequencia = $this->q28_sequencia ";
       $virgula = ",";
       if(trim((string) $this->q28_sequencia) == null ){ 
     ...
     if(trim((string) $this->q28_quantini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q28_quantini"])){ 
       $sql  .= $virgula." q28_quantini = $this->q28_quantini ";
       $virgula = ",";
       if(trim((string) $this->q28_quantini) == null ){ 
         $this->erro_sql = " Campo Quantidade final nao Informado.";
         $this->erro_campo = "q28_quantini";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q28_quantfim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q28_quantfim"])){ 
       $sql  .= $virgula." q28_quantfim = $this->q28_quantfim ";
       $virgula = ",";
       if(trim((string) $this->q28_quantfim) == null ){ 
         $this->erro_sql = " Campo Quantidade final nao Informado.";
         $this->erro_campo = "q28_quantfim";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q28_pontuacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q28_pontuacao"])){ 
       $sql  .= $virgula." q28_pontuacao = $this->q28_pontuacao ";
       $virgula = ",";
       if(trim((string) $this->q28_pontuacao) == null ){ 
         $this->erro_sql = " Campo Pontuação nao Informado.";
         $this->erro_campo = "q28_pontuacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q28_sequencia"]) || $this->q28_sequencia != "")
           $resac = db_query("insert into db_acount values($acount,1493,8750,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q28_sequencia'))."','$this->q28_sequencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q28_quantini"]) || $this->q28_quantini != "")
           $resac = db_query("insert into db_acount values($acount,1493,8751,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q28_quantini'))."','$this->q28_quantini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q28_quantfim"]) || $this->q28_quantfim != "")
           $resac = db_query("insert into db_acount values($acount,1493,8752,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q28_quantfim'))."','$this->q28_quantfim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q28_pontuacao"]) || $this->q28_pontuacao != "")
           $resac = db_query("insert into db_acount values($acount,1493,8753,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q28_pontuacao'))."','$this->q28_pontuacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q28_sequencia=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1493,8750,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q28_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1493,8751,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q28_quantini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1493,8752,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q28_quantfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1493,8753,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q28_pontuacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
  ...
  function sql_query_valida_qtde($q28_sequencia = null, $q28_quantini = null, $q28_quantfim = null) {
