...
class cl_orcprojetoorcprojetolei { 
   ...
   public $o139_sequencial = 0; 
   public $o139_orcprojetolei = 0; 
   public $o139_orcprojeto = 0; 
   ...
   function incluir ($o139_sequencial){ 
     ...
     if($o139_sequencial == "" || $o139_sequencial == null ){
       ...
       $this->o139_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from orcprojetoorcprojetolei_o139_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $o139_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3124,17687,'','".AddSlashes(pg_fetch_result($resaco,0,'o139_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3124,17688,'','".AddSlashes(pg_fetch_result($resaco,0,'o139_orcprojetolei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3124,17689,'','".AddSlashes(pg_fetch_result($resaco,0,'o139_orcprojeto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o139_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o139_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o139_sequencial"])){ 
       $sql  .= $virgula." o139_sequencial = $this->o139_sequencial ";
       $virgula = ",";
       if(trim((string) $this->o139_sequencial) == null ){ 
     ...
     if(trim((string) $this->o139_orcprojetolei)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o139_orcprojetolei"])){ 
       $sql  .= $virgula." o139_orcprojetolei = $this->o139_orcprojetolei ";
       $virgula = ",";
       if(trim((string) $this->o139_orcprojetolei) == null ){ 
         $this->erro_sql = " Campo Código do Projeto de lei nao Informado.";
         $this->erro_campo = "o139_orcprojetolei";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o139_orcprojeto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o139_orcprojeto"])){ 
       $sql  .= $virgula." o139_orcprojeto = $this->o139_orcprojeto ";
       $virgula = ",";
       if(trim((string) $this->o139_orcprojeto) == null ){ 
         $this->erro_sql = " Campo Código do Decreto nao Informado.";
         $this->erro_campo = "o139_orcprojeto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o139_sequencial"]) || $this->o139_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3124,17687,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o139_sequencial'))."','$this->o139_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o139_orcprojetolei"]) || $this->o139_orcprojetolei != "")
           $resac = db_query("insert into db_acount values($acount,3124,17688,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o139_orcprojetolei'))."','$this->o139_orcprojetolei',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o139_orcprojeto"]) || $this->o139_orcprojeto != "")
           $resac = db_query("insert into db_acount values($acount,3124,17689,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o139_orcprojeto'))."','$this->o139_orcprojeto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o139_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3124,17687,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o139_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3124,17688,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o139_orcprojetolei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3124,17689,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o139_orcprojeto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
