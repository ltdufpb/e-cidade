...
class cl_retencaocorgrupocorrente { 
   ...
   public $e47_sequencial = 0; 
   public $e47_corgrupocorrente = 0; 
   public $e47_retencaoreceita = 0; 
   ...
   function incluir ($e47_sequencial){ 
     ...
     if($e47_sequencial == "" || $e47_sequencial == null ){
       ...
       $this->e47_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from retencaocorgrupocorrente_e47_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $e47_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2173,12455,'','".AddSlashes(pg_fetch_result($resaco,0,'e47_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2173,12456,'','".AddSlashes(pg_fetch_result($resaco,0,'e47_corgrupocorrente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2173,12457,'','".AddSlashes(pg_fetch_result($resaco,0,'e47_retencaoreceita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e47_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e47_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e47_sequencial"])){ 
       $sql  .= $virgula." e47_sequencial = $this->e47_sequencial ";
       $virgula = ",";
       if(trim((string) $this->e47_sequencial) == null ){ 
     ...
     if(trim((string) $this->e47_corgrupocorrente)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e47_corgrupocorrente"])){ 
       $sql  .= $virgula." e47_corgrupocorrente = $this->e47_corgrupocorrente ";
       $virgula = ",";
       if(trim((string) $this->e47_corgrupocorrente) == null ){ 
         $this->erro_sql = " Campo Código do grupo nao Informado.";
         $this->erro_campo = "e47_corgrupocorrente";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e47_retencaoreceita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e47_retencaoreceita"])){ 
       $sql  .= $virgula." e47_retencaoreceita = $this->e47_retencaoreceita ";
       $virgula = ",";
       if(trim((string) $this->e47_retencaoreceita) == null ){ 
         $this->erro_sql = " Campo Código da Retencao nao Informado.";
         $this->erro_campo = "e47_retencaoreceita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e47_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2173,12455,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e47_sequencial'))."','$this->e47_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e47_corgrupocorrente"]))
           $resac = db_query("insert into db_acount values($acount,2173,12456,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e47_corgrupocorrente'))."','$this->e47_corgrupocorrente',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e47_retencaoreceita"]))
           $resac = db_query("insert into db_acount values($acount,2173,12457,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e47_retencaoreceita'))."','$this->e47_retencaoreceita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e47_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2173,12455,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e47_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2173,12456,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e47_corgrupocorrente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2173,12457,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e47_retencaoreceita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
