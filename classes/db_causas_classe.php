...
class cl_causas { 
   ...
   public $tr02_id = 0; 
   public $tr02_sigla = null; 
   public $tr02_descr = null; 
   ...
   function incluir ($tr02_id){ 
     ...
     if($tr02_id == "" || $tr02_id == null ){
       ...
       $this->tr02_id = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from causas_tr02_id_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $tr02_id)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,871,5605,'','".AddSlashes(pg_fetch_result($resaco,0,'tr02_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,871,5606,'','".AddSlashes(pg_fetch_result($resaco,0,'tr02_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,871,5604,'','".AddSlashes(pg_fetch_result($resaco,0,'tr02_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($tr02_id=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->tr02_id)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tr02_id"])){ 
       $sql  .= $virgula." tr02_id = $this->tr02_id ";
       $virgula = ",";
       if(trim((string) $this->tr02_id) == null ){ 
     ...
     if(trim((string) $this->tr02_sigla)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tr02_sigla"])){ 
       $sql  .= $virgula." tr02_sigla = '$this->tr02_sigla' ";
       $virgula = ",";
       if(trim((string) $this->tr02_sigla) == null ){ 
         $this->erro_sql = " Campo Sigla da Causa nao Informado.";
         $this->erro_campo = "tr02_sigla";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tr02_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tr02_descr"])){ 
       $sql  .= $virgula." tr02_descr = '$this->tr02_descr' ";
       $virgula = ",";
       if(trim((string) $this->tr02_descr) == null ){ 
         $this->erro_sql = " Campo Descrição da Causa nao Informado.";
         $this->erro_campo = "tr02_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["tr02_id"]))
           $resac = db_query("insert into db_acount values($acount,871,5605,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tr02_id'))."','$this->tr02_id',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tr02_sigla"]))
           $resac = db_query("insert into db_acount values($acount,871,5606,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tr02_sigla'))."','$this->tr02_sigla',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tr02_descr"]))
           $resac = db_query("insert into db_acount values($acount,871,5604,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tr02_descr'))."','$this->tr02_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($tr02_id=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,871,5605,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tr02_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,871,5606,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tr02_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,871,5604,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tr02_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
