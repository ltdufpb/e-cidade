...
class cl_empagegera { 
   ...
   public $e87_codgera = 0; 
   public $e87_descgera = null; 
   public $e87_data_dia = null; 
   public $e87_data_mes = null; 
   public $e87_data_ano = null; 
   public $e87_data = null; 
   public $e87_hora = null; 
   public $e87_dataproc_dia = null; 
   public $e87_dataproc_mes = null; 
   public $e87_dataproc_ano = null; 
   public $e87_dataproc = null; 
   ...
   function incluir ($e87_codgera){ 
     ...
     if($e87_codgera == "" || $e87_codgera == null ){
       ...
       $this->e87_codgera = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from empagegera_e87_codgera_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $e87_codgera)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1002,6194,'','".AddSlashes(pg_fetch_result($resaco,0,'e87_codgera'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1002,6195,'','".AddSlashes(pg_fetch_result($resaco,0,'e87_descgera'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1002,6196,'','".AddSlashes(pg_fetch_result($resaco,0,'e87_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1002,6197,'','".AddSlashes(pg_fetch_result($resaco,0,'e87_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1002,7235,'','".AddSlashes(pg_fetch_result($resaco,0,'e87_dataproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e87_codgera=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e87_codgera)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e87_codgera"])){ 
       $sql  .= $virgula." e87_codgera = $this->e87_codgera ";
       $virgula = ",";
       if(trim((string) $this->e87_codgera) == null ){ 
     ...
     if(trim((string) $this->e87_descgera)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e87_descgera"])){ 
       $sql  .= $virgula." e87_descgera = '$this->e87_descgera' ";
       $virgula = ",";
       if(trim((string) $this->e87_descgera) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "e87_descgera";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e87_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e87_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["e87_data_dia"] !="") ){ 
       $sql  .= $virgula." e87_data = '$this->e87_data' ";
       $virgula = ",";
       if(trim((string) $this->e87_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "e87_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e87_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e87_hora"])){ 
       $sql  .= $virgula." e87_hora = '$this->e87_hora' ";
       $virgula = ",";
       if(trim((string) $this->e87_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "e87_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e87_dataproc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e87_dataproc_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["e87_dataproc_dia"] !="") ){ 
       $sql  .= $virgula." e87_dataproc = '$this->e87_dataproc' ";
       $virgula = ",";
       if(trim((string) $this->e87_dataproc) == null ){ 
         $this->erro_sql = " Campo Autoriza pgto. nao Informado.";
         $this->erro_campo = "e87_dataproc_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e87_codgera"]))
           $resac = db_query("insert into db_acount values($acount,1002,6194,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e87_codgera'))."','$this->e87_codgera',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e87_descgera"]))
           $resac = db_query("insert into db_acount values($acount,1002,6195,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e87_descgera'))."','$this->e87_descgera',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e87_data"]))
           $resac = db_query("insert into db_acount values($acount,1002,6196,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e87_data'))."','$this->e87_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e87_hora"]))
           $resac = db_query("insert into db_acount values($acount,1002,6197,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e87_hora'))."','$this->e87_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e87_dataproc"]))
           $resac = db_query("insert into db_acount values($acount,1002,7235,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e87_dataproc'))."','$this->e87_dataproc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e87_codgera=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1002,6194,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e87_codgera'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1002,6195,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e87_descgera'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1002,6196,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e87_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1002,6197,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e87_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1002,7235,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e87_dataproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
