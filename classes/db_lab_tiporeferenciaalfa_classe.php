...
class cl_lab_tiporeferenciaalfa { 
   ...
   function incluir ($la29_i_codigo){ 
     ...
     if($la29_i_codigo == "" || $la29_i_codigo == null ){
       ...
       $this->la29_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from lab_tiporeferenciaalfa_la29_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $la29_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2902,16500,'','".AddSlashes(pg_fetch_result($resaco,0,'la29_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2902,16501,'','".AddSlashes(pg_fetch_result($resaco,0,'la29_i_valorref'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2902,16502,'','".AddSlashes(pg_fetch_result($resaco,0,'la29_i_fixo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($la29_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->la29_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la29_i_codigo"])){ 
       $sql  .= $virgula." la29_i_codigo = $this->la29_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->la29_i_codigo) == null ){ 
     ...
     if(trim((string) $this->la29_i_valorref)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la29_i_valorref"])){ 
       $sql  .= $virgula." la29_i_valorref = $this->la29_i_valorref ";
       $virgula = ",";
       if(trim((string) $this->la29_i_valorref) == null ){ 
         $this->erro_sql = " Campo Valor Referencial nao Informado.";
         $this->erro_campo = "la29_i_valorref";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->la29_i_fixo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la29_i_fixo"])){ 
        if(trim((string) $this->la29_i_fixo)=="" && isset($GLOBALS["HTTP_POST_VARS"]["la29_i_fixo"])){ 
           $this->la29_i_fixo = "0" ; 
        } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["la29_i_codigo"]) || $this->la29_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2902,16500,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la29_i_codigo'))."','$this->la29_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la29_i_valorref"]) || $this->la29_i_valorref != "")
           $resac = db_query("insert into db_acount values($acount,2902,16501,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la29_i_valorref'))."','$this->la29_i_valorref',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la29_i_fixo"]) || $this->la29_i_fixo != "")
           $resac = db_query("insert into db_acount values($acount,2902,16502,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la29_i_fixo'))."','$this->la29_i_fixo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($la29_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2902,16500,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la29_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2902,16501,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la29_i_valorref'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2902,16502,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la29_i_fixo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
