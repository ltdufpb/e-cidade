...
class cl_db_versaousu { 
   ...
   public $db32_codusu = 0; 
   public $db32_codver = 0; 
   public $db32_id_item = 0; 
   public $db32_obs = null; 
   public $db32_obsdb = null; 
   public $db32_data_dia = null; 
   public $db32_data_mes = null; 
   public $db32_data_ano = null; 
   public $db32_data = null; 
   ...
   function incluir ($db32_codusu){ 
     ...
     if($db32_codusu == "" || $db32_codusu == null ){
       ...
       $this->db32_codusu = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_versaousu_db32_codusu_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db32_codusu)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,940,5878,'','".AddSlashes(pg_fetch_result($resaco,0,'db32_codusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,940,5874,'','".AddSlashes(pg_fetch_result($resaco,0,'db32_codver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,940,5875,'','".AddSlashes(pg_fetch_result($resaco,0,'db32_id_item'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,940,5876,'','".AddSlashes(pg_fetch_result($resaco,0,'db32_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,940,7403,'','".AddSlashes(pg_fetch_result($resaco,0,'db32_obsdb'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,940,5877,'','".AddSlashes(pg_fetch_result($resaco,0,'db32_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db32_codusu=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db32_codusu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db32_codusu"])){ 
       $sql  .= $virgula." db32_codusu = $this->db32_codusu ";
       $virgula = ",";
       if(trim((string) $this->db32_codusu) == null ){ 
     ...
     if(trim((string) $this->db32_codver)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db32_codver"])){ 
       $sql  .= $virgula." db32_codver = $this->db32_codver ";
       $virgula = ",";
       if(trim((string) $this->db32_codver) == null ){ 
         $this->erro_sql = " Campo Código da Versão nao Informado.";
         $this->erro_campo = "db32_codver";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db32_id_item)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db32_id_item"])){ 
       $sql  .= $virgula." db32_id_item = $this->db32_id_item ";
       $virgula = ",";
       if(trim((string) $this->db32_id_item) == null ){ 
         $this->erro_sql = " Campo Item de Menu nao Informado.";
         $this->erro_campo = "db32_id_item";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db32_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db32_obs"])){ 
       $sql  .= $virgula." db32_obs = '$this->db32_obs' ";
       $virgula = ",";
       if(trim((string) $this->db32_obs) == null ){ 
         $this->erro_sql = " Campo Observações para o usuário nao Informado.";
         $this->erro_campo = "db32_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db32_obsdb)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db32_obsdb"])){ 
       $sql  .= $virgula." db32_obsdb = '$this->db32_obsdb' ";
       $virgula = ",";
       if(trim((string) $this->db32_obsdb) == null ){ 
         $this->erro_sql = " Campo Observação DBSeller nao Informado.";
         $this->erro_campo = "db32_obsdb";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db32_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db32_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["db32_data_dia"] !="") ){ 
       $sql  .= $virgula." db32_data = '$this->db32_data' ";
       $virgula = ",";
       if(trim((string) $this->db32_data) == null ){ 
         $this->erro_sql = " Campo Data da inclusão nao Informado.";
         $this->erro_campo = "db32_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db32_codusu"]))
           $resac = db_query("insert into db_acount values($acount,940,5878,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db32_codusu'))."','$this->db32_codusu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db32_codver"]))
           $resac = db_query("insert into db_acount values($acount,940,5874,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db32_codver'))."','$this->db32_codver',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db32_id_item"]))
           $resac = db_query("insert into db_acount values($acount,940,5875,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db32_id_item'))."','$this->db32_id_item',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db32_obs"]))
           $resac = db_query("insert into db_acount values($acount,940,5876,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db32_obs'))."','$this->db32_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db32_obsdb"]))
           $resac = db_query("insert into db_acount values($acount,940,7403,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db32_obsdb'))."','$this->db32_obsdb',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db32_data"]))
           $resac = db_query("insert into db_acount values($acount,940,5877,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db32_data'))."','$this->db32_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db32_codusu=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,940,5878,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db32_codusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,940,5874,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db32_codver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,940,5875,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db32_id_item'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,940,5876,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db32_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,940,7403,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db32_obsdb'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,940,5877,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db32_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
