...
class cl_habitcandidatointeresse { 
   ...
   public $ht20_sequencial = 0; 
   public $ht20_habitcandidato = 0; 
   public $ht20_habitgrupoprograma = 0; 
   public $ht20_ativo = 'f'; 
   ...
   function incluir ($ht20_sequencial){ 
     ...
     if($ht20_sequencial == "" || $ht20_sequencial == null ){
       ...
       $this->ht20_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from habitcandidatointeresse_ht20_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ht20_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3008,17033,'','".AddSlashes(pg_fetch_result($resaco,0,'ht20_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3008,17034,'','".AddSlashes(pg_fetch_result($resaco,0,'ht20_habitcandidato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3008,17035,'','".AddSlashes(pg_fetch_result($resaco,0,'ht20_habitgrupoprograma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3008,17036,'','".AddSlashes(pg_fetch_result($resaco,0,'ht20_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ht20_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ht20_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht20_sequencial"])){ 
       $sql  .= $virgula." ht20_sequencial = $this->ht20_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ht20_sequencial) == null ){ 
     ...
     if(trim((string) $this->ht20_habitcandidato)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht20_habitcandidato"])){ 
       $sql  .= $virgula." ht20_habitcandidato = $this->ht20_habitcandidato ";
       $virgula = ",";
       if(trim((string) $this->ht20_habitcandidato) == null ){ 
         $this->erro_sql = " Campo Candidato nao Informado.";
         $this->erro_campo = "ht20_habitcandidato";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ht20_habitgrupoprograma)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht20_habitgrupoprograma"])){ 
       $sql  .= $virgula." ht20_habitgrupoprograma = $this->ht20_habitgrupoprograma ";
       $virgula = ",";
       if(trim((string) $this->ht20_habitgrupoprograma) == null ){ 
         $this->erro_sql = " Campo Grupo Programa nao Informado.";
         $this->erro_campo = "ht20_habitgrupoprograma";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ht20_ativo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht20_ativo"])){ 
       $sql  .= $virgula." ht20_ativo = '$this->ht20_ativo' ";
       $virgula = ",";
       if(trim((string) $this->ht20_ativo) == null ){ 
         $this->erro_sql = " Campo Ativo nao Informado.";
         $this->erro_campo = "ht20_ativo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht20_sequencial"]) || $this->ht20_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3008,17033,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht20_sequencial'))."','$this->ht20_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht20_habitcandidato"]) || $this->ht20_habitcandidato != "")
           $resac = db_query("insert into db_acount values($acount,3008,17034,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht20_habitcandidato'))."','$this->ht20_habitcandidato',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht20_habitgrupoprograma"]) || $this->ht20_habitgrupoprograma != "")
           $resac = db_query("insert into db_acount values($acount,3008,17035,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht20_habitgrupoprograma'))."','$this->ht20_habitgrupoprograma',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht20_ativo"]) || $this->ht20_ativo != "")
           $resac = db_query("insert into db_acount values($acount,3008,17036,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht20_ativo'))."','$this->ht20_ativo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ht20_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3008,17033,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht20_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3008,17034,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht20_habitcandidato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3008,17035,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht20_habitgrupoprograma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3008,17036,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht20_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
