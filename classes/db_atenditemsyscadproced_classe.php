...
class cl_atenditemsyscadproced { 
   ...
   public $at29_sequencial = 0; 
   public $at29_atenditem = 0; 
   public $at29_syscadproced = 0; 
   ...
   function incluir ($at29_sequencial){ 
     ...
     if($at29_sequencial == "" || $at29_sequencial == null ){
       ...
       $this->at29_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from atenditemsyscadproced_at29_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at29_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1683,9806,'','".AddSlashes(pg_fetch_result($resaco,0,'at29_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1683,9807,'','".AddSlashes(pg_fetch_result($resaco,0,'at29_atenditem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1683,9808,'','".AddSlashes(pg_fetch_result($resaco,0,'at29_syscadproced'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at29_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at29_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at29_sequencial"])){ 
       $sql  .= $virgula." at29_sequencial = $this->at29_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at29_sequencial) == null ){ 
     ...
     if(trim((string) $this->at29_atenditem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at29_atenditem"])){ 
       $sql  .= $virgula." at29_atenditem = $this->at29_atenditem ";
       $virgula = ",";
       if(trim((string) $this->at29_atenditem) == null ){ 
         $this->erro_sql = " Campo Código do item de atendimento nao Informado.";
         $this->erro_campo = "at29_atenditem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at29_syscadproced)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at29_syscadproced"])){ 
       $sql  .= $virgula." at29_syscadproced = $this->at29_syscadproced ";
       $virgula = ",";
       if(trim((string) $this->at29_syscadproced) == null ){ 
         $this->erro_sql = " Campo Código do procedimento nao Informado.";
         $this->erro_campo = "at29_syscadproced";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at29_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1683,9806,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at29_sequencial'))."','$this->at29_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at29_atenditem"]))
           $resac = db_query("insert into db_acount values($acount,1683,9807,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at29_atenditem'))."','$this->at29_atenditem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at29_syscadproced"]))
           $resac = db_query("insert into db_acount values($acount,1683,9808,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at29_syscadproced'))."','$this->at29_syscadproced',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at29_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1683,9806,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at29_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1683,9807,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at29_atenditem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1683,9808,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at29_syscadproced'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
