...
class cl_far_origemreceitaretirada { 
   ...
   public $fa41_i_codigo = 0; 
   public $fa41_i_retirada = 0; 
   public $fa41_i_origemreceita = 0; 
   ...
   function incluir ($fa41_i_codigo){ 
     ...
     if($fa41_i_codigo == "" || $fa41_i_codigo == null ){
       ...
       $this->fa41_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_origemreceitaretirada_fa41_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa41_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2951,16757,'','".AddSlashes(pg_fetch_result($resaco,0,'fa41_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2951,16758,'','".AddSlashes(pg_fetch_result($resaco,0,'fa41_i_retirada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2951,16759,'','".AddSlashes(pg_fetch_result($resaco,0,'fa41_i_origemreceita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa41_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa41_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa41_i_codigo"])){ 
       $sql  .= $virgula." fa41_i_codigo = $this->fa41_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa41_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa41_i_retirada)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa41_i_retirada"])){ 
       $sql  .= $virgula." fa41_i_retirada = $this->fa41_i_retirada ";
       $virgula = ",";
       if(trim((string) $this->fa41_i_retirada) == null ){ 
         $this->erro_sql = " Campo Retirada nao Informado.";
         $this->erro_campo = "fa41_i_retirada";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa41_i_origemreceita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa41_i_origemreceita"])){ 
       $sql  .= $virgula." fa41_i_origemreceita = $this->fa41_i_origemreceita ";
       $virgula = ",";
       if(trim((string) $this->fa41_i_origemreceita) == null ){ 
         $this->erro_sql = " Campo Origem nao Informado.";
         $this->erro_campo = "fa41_i_origemreceita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa41_i_codigo"]) || $this->fa41_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2951,16757,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa41_i_codigo'))."','$this->fa41_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa41_i_retirada"]) || $this->fa41_i_retirada != "")
           $resac = db_query("insert into db_acount values($acount,2951,16758,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa41_i_retirada'))."','$this->fa41_i_retirada',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa41_i_origemreceita"]) || $this->fa41_i_origemreceita != "")
           $resac = db_query("insert into db_acount values($acount,2951,16759,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa41_i_origemreceita'))."','$this->fa41_i_origemreceita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa41_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2951,16757,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa41_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2951,16758,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa41_i_retirada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2951,16759,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa41_i_origemreceita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
