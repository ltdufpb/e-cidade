...
class cl_bib_parametros { 
   ...
   public $bi26_codigo = 0; 
   public $bi26_biblioteca = 0; 
   public $bi26_leitorbarra = null; 
   public $bi26_impressora = 0; 
   ...
   function incluir ($bi26_codigo){ 
     ...
     if($bi26_codigo == "" || $bi26_codigo == null ){
       ...
       $this->bi26_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from bib_parametros_bi26_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $bi26_codigo)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,2138,12285,'','".AddSlashes(pg_fetch_result($resaco,0,'bi26_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2138,12286,'','".AddSlashes(pg_fetch_result($resaco,0,'bi26_biblioteca'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2138,12287,'','".AddSlashes(pg_fetch_result($resaco,0,'bi26_leitorbarra'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2138,21910,'','".AddSlashes(pg_fetch_result($resaco,0,'bi26_impressora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($bi26_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->bi26_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["bi26_codigo"])){ 
       $sql  .= $virgula." bi26_codigo = $this->bi26_codigo ";
       $virgula = ",";
       if(trim((string) $this->bi26_codigo) == null ){ 
     ...
     if(trim((string) $this->bi26_biblioteca)!="" || isset($GLOBALS["HTTP_POST_VARS"]["bi26_biblioteca"])){ 
       $sql  .= $virgula." bi26_biblioteca = $this->bi26_biblioteca ";
       $virgula = ",";
       if(trim((string) $this->bi26_biblioteca) == null ){ 
         $this->erro_sql = " Campo Biblioteca não informado.";
         $this->erro_campo = "bi26_biblioteca";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->bi26_leitorbarra)!="" || isset($GLOBALS["HTTP_POST_VARS"]["bi26_leitorbarra"])){ 
       $sql  .= $virgula." bi26_leitorbarra = '$this->bi26_leitorbarra' ";
       $virgula = ",";
       if(trim((string) $this->bi26_leitorbarra) == null ){ 
         $this->erro_sql = " Campo Usar Leitor de Código de Barras não informado.";
         $this->erro_campo = "bi26_leitorbarra";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->bi26_impressora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["bi26_impressora"])){ 
        if(trim((string) $this->bi26_impressora)=="" && isset($GLOBALS["HTTP_POST_VARS"]["bi26_impressora"])){ 
           $this->bi26_impressora = "1" ; 
        } 
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["bi26_codigo"]) || $this->bi26_codigo != "")
             $resac = db_query("insert into db_acount values($acount,2138,12285,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'bi26_codigo'))."','$this->bi26_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["bi26_biblioteca"]) || $this->bi26_biblioteca != "")
             $resac = db_query("insert into db_acount values($acount,2138,12286,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'bi26_biblioteca'))."','$this->bi26_biblioteca',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["bi26_leitorbarra"]) || $this->bi26_leitorbarra != "")
             $resac = db_query("insert into db_acount values($acount,2138,12287,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'bi26_leitorbarra'))."','$this->bi26_leitorbarra',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["bi26_impressora"]) || $this->bi26_impressora != "")
             $resac = db_query("insert into db_acount values($acount,2138,21910,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'bi26_impressora'))."','$this->bi26_impressora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,2138,12285,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'bi26_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,2138,12286,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'bi26_biblioteca'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,2138,12287,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'bi26_leitorbarra'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,2138,21910,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'bi26_impressora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
