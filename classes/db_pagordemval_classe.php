...
class cl_pagordemval { 
   ...
   function incluir ($e51_codord,$e51_codlan){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,909,5735,'','".AddSlashes(pg_fetch_result($resaco,0,'e51_codord'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,909,5750,'','".AddSlashes(pg_fetch_result($resaco,0,'e51_codlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e51_codord=null,$e51_codlan=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e51_codord)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e51_codord"])){ 
       $sql  .= $virgula." e51_codord = $this->e51_codord ";
       $virgula = ",";
       if(trim((string) $this->e51_codord) == null ){ 
     ...
     if(trim((string) $this->e51_codlan)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e51_codlan"])){ 
       $sql  .= $virgula." e51_codlan = $this->e51_codlan ";
       $virgula = ",";
       if(trim((string) $this->e51_codlan) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e51_codord"]))
           $resac = db_query("insert into db_acount values($acount,909,5735,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e51_codord'))."','$this->e51_codord',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e51_codlan"]))
           $resac = db_query("insert into db_acount values($acount,909,5750,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e51_codlan'))."','$this->e51_codlan',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e51_codord=null,$e51_codlan=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,909,5735,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e51_codord'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,909,5750,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e51_codlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
