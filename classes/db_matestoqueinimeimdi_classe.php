...
class cl_matestoqueinimeimdi { 
   ...
   public $m50_codigo = 0; 
   public $m50_codmatestoquedevitem = 0; 
   public $m50_codmatestoqueinimei = 0; 
   ...
   function incluir ($m50_codigo){ 
     ...
     if($m50_codigo == "" || $m50_codigo == null ){
       ...
       $this->m50_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from matestoqueinimeimdi_m50_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $m50_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1151,6957,'','".AddSlashes(pg_fetch_result($resaco,0,'m50_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1151,6958,'','".AddSlashes(pg_fetch_result($resaco,0,'m50_codmatestoquedevitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1151,6959,'','".AddSlashes(pg_fetch_result($resaco,0,'m50_codmatestoqueinimei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($m50_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->m50_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m50_codigo"])){ 
       $sql  .= $virgula." m50_codigo = $this->m50_codigo ";
       $virgula = ",";
       if(trim((string) $this->m50_codigo) == null ){ 
     ...
     if(trim((string) $this->m50_codmatestoquedevitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m50_codmatestoquedevitem"])){ 
       $sql  .= $virgula." m50_codmatestoquedevitem = $this->m50_codmatestoquedevitem ";
       $virgula = ",";
       if(trim((string) $this->m50_codmatestoquedevitem) == null ){ 
         $this->erro_sql = " Campo Código item da devolução nao Informado.";
         $this->erro_campo = "m50_codmatestoquedevitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m50_codmatestoqueinimei)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m50_codmatestoqueinimei"])){ 
       $sql  .= $virgula." m50_codmatestoqueinimei = $this->m50_codmatestoqueinimei ";
       $virgula = ",";
       if(trim((string) $this->m50_codmatestoqueinimei) == null ){ 
         $this->erro_sql = " Campo Código matestoqueinimei nao Informado.";
         $this->erro_campo = "m50_codmatestoqueinimei";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["m50_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1151,6957,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m50_codigo'))."','$this->m50_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m50_codmatestoquedevitem"]))
           $resac = db_query("insert into db_acount values($acount,1151,6958,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m50_codmatestoquedevitem'))."','$this->m50_codmatestoquedevitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m50_codmatestoqueinimei"]))
           $resac = db_query("insert into db_acount values($acount,1151,6959,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m50_codmatestoqueinimei'))."','$this->m50_codmatestoqueinimei',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($m50_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1151,6957,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m50_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1151,6958,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m50_codmatestoquedevitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1151,6959,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m50_codmatestoqueinimei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
