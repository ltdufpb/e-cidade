...
class cl_declaracaoquitacaomatric { 
   ...
   public $ar33_sequencial = 0; 
   public $ar33_matric = 0; 
   public $ar33_declaracaoquitacao = 0; 
   ...
   function incluir ($ar33_sequencial){ 
     ...
     if($ar33_sequencial == "" || $ar33_sequencial == null ){
       ...
       $this->ar33_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from declaracaoquitacaomatric_ar33_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ar33_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3035,17170,'','".AddSlashes(pg_fetch_result($resaco,0,'ar33_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3035,17171,'','".AddSlashes(pg_fetch_result($resaco,0,'ar33_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3035,17172,'','".AddSlashes(pg_fetch_result($resaco,0,'ar33_declaracaoquitacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ar33_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ar33_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar33_sequencial"])){ 
       $sql  .= $virgula." ar33_sequencial = $this->ar33_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ar33_sequencial) == null ){ 
     ...
     if(trim((string) $this->ar33_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar33_matric"])){ 
       $sql  .= $virgula." ar33_matric = $this->ar33_matric ";
       $virgula = ",";
       if(trim((string) $this->ar33_matric) == null ){ 
         $this->erro_sql = " Campo Matrícula do Imóvel nao Informado.";
         $this->erro_campo = "ar33_matric";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ar33_declaracaoquitacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar33_declaracaoquitacao"])){ 
       $sql  .= $virgula." ar33_declaracaoquitacao = $this->ar33_declaracaoquitacao ";
       $virgula = ",";
       if(trim((string) $this->ar33_declaracaoquitacao) == null ){ 
         $this->erro_sql = " Campo Código Declaração nao Informado.";
         $this->erro_campo = "ar33_declaracaoquitacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar33_sequencial"]) || $this->ar33_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3035,17170,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar33_sequencial'))."','$this->ar33_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar33_matric"]) || $this->ar33_matric != "")
           $resac = db_query("insert into db_acount values($acount,3035,17171,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar33_matric'))."','$this->ar33_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar33_declaracaoquitacao"]) || $this->ar33_declaracaoquitacao != "")
           $resac = db_query("insert into db_acount values($acount,3035,17172,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar33_declaracaoquitacao'))."','$this->ar33_declaracaoquitacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ar33_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3035,17170,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar33_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3035,17171,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar33_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3035,17172,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar33_declaracaoquitacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
