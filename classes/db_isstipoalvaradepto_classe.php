...
class cl_isstipoalvaradepto { 
   ...
   public $q99_sequencial = 0; 
   public $q99_depto = 0; 
   public $q99_isstipoalvara = 0; 
   ...
   function incluir ($q99_sequencial){ 
     ...
     if($q99_sequencial == "" || $q99_sequencial == null ){
       ...
       $this->q99_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from isstipoalvaradepto_q99_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q99_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3239,18317,'','".AddSlashes(pg_fetch_result($resaco,0,'q99_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3239,18314,'','".AddSlashes(pg_fetch_result($resaco,0,'q99_depto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3239,18315,'','".AddSlashes(pg_fetch_result($resaco,0,'q99_isstipoalvara'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q99_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q99_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q99_sequencial"])){ 
       $sql  .= $virgula." q99_sequencial = $this->q99_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q99_sequencial) == null ){ 
     ...
     if(trim((string) $this->q99_depto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q99_depto"])){ 
       $sql  .= $virgula." q99_depto = $this->q99_depto ";
       $virgula = ",";
       if(trim((string) $this->q99_depto) == null ){ 
         $this->erro_sql = " Campo Departamento nao Informado.";
         $this->erro_campo = "q99_depto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q99_isstipoalvara)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q99_isstipoalvara"])){ 
       $sql  .= $virgula." q99_isstipoalvara = $this->q99_isstipoalvara ";
       $virgula = ",";
       if(trim((string) $this->q99_isstipoalvara) == null ){ 
         $this->erro_sql = " Campo Tipo de Alvará nao Informado.";
         $this->erro_campo = "q99_isstipoalvara";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q99_sequencial"]) || $this->q99_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3239,18317,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q99_sequencial'))."','$this->q99_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q99_depto"]) || $this->q99_depto != "")
           $resac = db_query("insert into db_acount values($acount,3239,18314,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q99_depto'))."','$this->q99_depto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q99_isstipoalvara"]) || $this->q99_isstipoalvara != "")
           $resac = db_query("insert into db_acount values($acount,3239,18315,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q99_isstipoalvara'))."','$this->q99_isstipoalvara',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q99_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3239,18317,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q99_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3239,18314,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q99_depto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3239,18315,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q99_isstipoalvara'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
