...
class cl_bensimoveis { 
   ...
   function incluir ($t54_codbem,$t54_idbql){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,916,5781,'','".AddSlashes(pg_fetch_result($resaco,0,'t54_codbem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,916,5782,'','".AddSlashes(pg_fetch_result($resaco,0,'t54_idbql'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,916,5783,'','".AddSlashes(pg_fetch_result($resaco,0,'t54_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($t54_codbem=null,$t54_idbql=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->t54_codbem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t54_codbem"])){ 
       $sql  .= $virgula." t54_codbem = $this->t54_codbem ";
       $virgula = ",";
       if(trim((string) $this->t54_codbem) == null ){ 
     ...
     if(trim((string) $this->t54_idbql)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t54_idbql"])){ 
       $sql  .= $virgula." t54_idbql = $this->t54_idbql ";
       $virgula = ",";
       if(trim((string) $this->t54_idbql) == null ){ 
     ...
     if(trim((string) $this->t54_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t54_obs"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["t54_codbem"]))
           $resac = db_query("insert into db_acount values($acount,916,5781,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t54_codbem'))."','$this->t54_codbem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t54_idbql"]))
           $resac = db_query("insert into db_acount values($acount,916,5782,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t54_idbql'))."','$this->t54_idbql',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t54_obs"]))
           $resac = db_query("insert into db_acount values($acount,916,5783,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t54_obs'))."','$this->t54_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($t54_codbem=null,$t54_idbql=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,916,5781,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t54_codbem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,916,5782,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t54_idbql'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,916,5783,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t54_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
