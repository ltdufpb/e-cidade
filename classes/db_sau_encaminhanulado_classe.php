...
class cl_sau_encaminhanulado {
   ...
   public $s149_i_codigo = 0;
   public $s149_i_encaminhamento = 0;
   public $s149_d_data_dia = null;
   public $s149_d_data_mes = null;
   public $s149_d_data_ano = null;
   public $s149_d_data = null;
   public $s149_c_hora = null;
   public $s149_i_login = 0;
   public $s149_t_obs = null;
   ...
   function incluir ($s149_i_codigo){
     ...
     if($s149_i_codigo == "" || $s149_i_codigo == null ){
       ...
       $this->s149_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from sau_encaminhanulado_s149_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $s149_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2727,15541,'','".AddSlashes(pg_fetch_result($resaco,0,'s149_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2727,15542,'','".AddSlashes(pg_fetch_result($resaco,0,'s149_i_encaminhamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2727,15543,'','".AddSlashes(pg_fetch_result($resaco,0,'s149_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2727,15544,'','".AddSlashes(pg_fetch_result($resaco,0,'s149_c_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2727,15545,'','".AddSlashes(pg_fetch_result($resaco,0,'s149_i_login'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2727,15546,'','".AddSlashes(pg_fetch_result($resaco,0,'s149_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($s149_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->s149_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s149_i_codigo"])){
       $sql  .= $virgula." s149_i_codigo = $this->s149_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->s149_i_codigo) == null ){
     ...
     if(trim((string) $this->s149_i_encaminhamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s149_i_encaminhamento"])){
       $sql  .= $virgula." s149_i_encaminhamento = $this->s149_i_encaminhamento ";
       $virgula = ",";
       if(trim((string) $this->s149_i_encaminhamento) == null ){
         $this->erro_sql = " Campo Encaminhamento nao Informado.";
         $this->erro_campo = "s149_i_encaminhamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s149_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s149_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["s149_d_data_dia"] !="") ){
       $sql  .= $virgula." s149_d_data = '$this->s149_d_data' ";
       $virgula = ",";
       if(trim((string) $this->s149_d_data) == null ){
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "s149_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s149_c_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s149_c_hora"])){
       $sql  .= $virgula." s149_c_hora = '$this->s149_c_hora' ";
       $virgula = ",";
       if(trim((string) $this->s149_c_hora) == null ){
         $this->erro_sql = " Campo Horário nao Informado.";
         $this->erro_campo = "s149_c_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s149_i_login)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s149_i_login"])){
       $sql  .= $virgula." s149_i_login = $this->s149_i_login ";
       $virgula = ",";
       if(trim((string) $this->s149_i_login) == null ){
         $this->erro_sql = " Campo Login nao Informado.";
         $this->erro_campo = "s149_i_login";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s149_t_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s149_t_obs"])){
       $sql  .= $virgula." s149_t_obs = '$this->s149_t_obs' ";
       $virgula = ",";
       if(trim((string) $this->s149_t_obs) == null ){
         $this->erro_sql = " Campo Obs. nao Informado.";
         $this->erro_campo = "s149_t_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s149_i_codigo"]) || $this->s149_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2727,15541,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s149_i_codigo'))."','$this->s149_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s149_i_encaminhamento"]) || $this->s149_i_encaminhamento != "")
           $resac = db_query("insert into db_acount values($acount,2727,15542,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s149_i_encaminhamento'))."','$this->s149_i_encaminhamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s149_d_data"]) || $this->s149_d_data != "")
           $resac = db_query("insert into db_acount values($acount,2727,15543,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s149_d_data'))."','$this->s149_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s149_c_hora"]) || $this->s149_c_hora != "")
           $resac = db_query("insert into db_acount values($acount,2727,15544,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s149_c_hora'))."','$this->s149_c_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s149_i_login"]) || $this->s149_i_login != "")
           $resac = db_query("insert into db_acount values($acount,2727,15545,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s149_i_login'))."','$this->s149_i_login',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s149_t_obs"]) || $this->s149_t_obs != "")
           $resac = db_query("insert into db_acount values($acount,2727,15546,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s149_t_obs'))."','$this->s149_t_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($s149_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2727,15541,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s149_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2727,15542,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s149_i_encaminhamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2727,15543,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s149_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2727,15544,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s149_c_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2727,15545,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s149_i_login'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2727,15546,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s149_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
