...
class cl_regrapontorhrubricas { 
   ...
   public $rh124_sequencial = 0; 
   public $rh124_regraponto = 0; 
   public $rh124_rubrica = null; 
   public $rh124_instit = 0; 
   ...
   function incluir ($rh124_sequencial){ 
     ...
     if($rh124_sequencial == "" || $rh124_sequencial == null ){
       ...
       $this->rh124_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from regrapontorhrubricas_rh124_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh124_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3612,20124,'','".AddSlashes(pg_fetch_result($resaco,0,'rh124_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3612,20125,'','".AddSlashes(pg_fetch_result($resaco,0,'rh124_regraponto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3612,20126,'','".AddSlashes(pg_fetch_result($resaco,0,'rh124_rubrica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3612,20127,'','".AddSlashes(pg_fetch_result($resaco,0,'rh124_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($rh124_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh124_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh124_sequencial"])){ 
       $sql  .= $virgula." rh124_sequencial = $this->rh124_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh124_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh124_regraponto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh124_regraponto"])){ 
       $sql  .= $virgula." rh124_regraponto = $this->rh124_regraponto ";
       $virgula = ",";
       if(trim((string) $this->rh124_regraponto) == null ){ 
         $this->erro_sql = " Campo Cod. Regra nao Informado.";
         $this->erro_campo = "rh124_regraponto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh124_rubrica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh124_rubrica"])){ 
       $sql  .= $virgula." rh124_rubrica = '$this->rh124_rubrica' ";
       $virgula = ",";
       if(trim((string) $this->rh124_rubrica) == null ){ 
         $this->erro_sql = " Campo Cod. Rubrica nao Informado.";
         $this->erro_campo = "rh124_rubrica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh124_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh124_instit"])){ 
       $sql  .= $virgula." rh124_instit = $this->rh124_instit ";
       $virgula = ",";
       if(trim((string) $this->rh124_instit) == null ){ 
         $this->erro_sql = " Campo Cod. Instituicao nao Informado.";
         $this->erro_campo = "rh124_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["rh124_sequencial"]) || $this->rh124_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3612,20124,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh124_sequencial'))."','$this->rh124_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["rh124_regraponto"]) || $this->rh124_regraponto != "")
             $resac = db_query("insert into db_acount values($acount,3612,20125,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh124_regraponto'))."','$this->rh124_regraponto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["rh124_rubrica"]) || $this->rh124_rubrica != "")
             $resac = db_query("insert into db_acount values($acount,3612,20126,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh124_rubrica'))."','$this->rh124_rubrica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["rh124_instit"]) || $this->rh124_instit != "")
             $resac = db_query("insert into db_acount values($acount,3612,20127,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh124_instit'))."','$this->rh124_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3612,20124,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh124_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3612,20125,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh124_regraponto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3612,20126,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh124_rubrica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3612,20127,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh124_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
