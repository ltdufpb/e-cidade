...
class cl_meiimportameireg { 
   ...
   public $q111_sequencial = 0; 
   public $q111_meiimportamei = 0; 
   public $q111_meievento = 0; 
   public $q111_meiimportameiregatividade = 0; 
   public $q111_meiimportameiregempresa = 0; 
   public $q111_meiimportameiregcontador = 0; 
   public $q111_meiimportameiregresponsavel = 0; 
   public $q111_data_dia = null; 
   public $q111_data_mes = null; 
   public $q111_data_ano = null; 
   public $q111_data = null; 
   ...
   function incluir ($q111_sequencial){ 
     ...
     if($q111_sequencial == "" || $q111_sequencial == null ){
       ...
       $this->q111_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from meiimportameireg_q111_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q111_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2915,16595,'','".AddSlashes(pg_fetch_result($resaco,0,'q111_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2915,16608,'','".AddSlashes(pg_fetch_result($resaco,0,'q111_meiimportamei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2915,16596,'','".AddSlashes(pg_fetch_result($resaco,0,'q111_meievento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2915,16599,'','".AddSlashes(pg_fetch_result($resaco,0,'q111_meiimportameiregatividade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2915,16600,'','".AddSlashes(pg_fetch_result($resaco,0,'q111_meiimportameiregempresa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2915,16601,'','".AddSlashes(pg_fetch_result($resaco,0,'q111_meiimportameiregcontador'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2915,16602,'','".AddSlashes(pg_fetch_result($resaco,0,'q111_meiimportameiregresponsavel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2915,16603,'','".AddSlashes(pg_fetch_result($resaco,0,'q111_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q111_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q111_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q111_sequencial"])){ 
       $sql  .= $virgula." q111_sequencial = $this->q111_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q111_sequencial) == null ){ 
     ...
     if(trim((string) $this->q111_meiimportamei)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportamei"])){ 
       $sql  .= $virgula." q111_meiimportamei = $this->q111_meiimportamei ";
       $virgula = ",";
       if(trim((string) $this->q111_meiimportamei) == null ){ 
         $this->erro_sql = " Campo Importação do MEI nao Informado.";
         $this->erro_campo = "q111_meiimportamei";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q111_meievento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q111_meievento"])){ 
       $sql  .= $virgula." q111_meievento = $this->q111_meievento ";
       $virgula = ",";
       if(trim((string) $this->q111_meievento) == null ){ 
         $this->erro_sql = " Campo Eventos do MEI nao Informado.";
         $this->erro_campo = "q111_meievento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q111_meiimportameiregatividade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportameiregatividade"])){ 
        if(trim((string) $this->q111_meiimportameiregatividade)=="" && isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportameiregatividade"])){ 
           $this->q111_meiimportameiregatividade = "null" ; 
        } 
     ...
     if(trim((string) $this->q111_meiimportameiregempresa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportameiregempresa"])){ 
        if(trim((string) $this->q111_meiimportameiregempresa)=="" && isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportameiregempresa"])){ 
           $this->q111_meiimportameiregempresa = "null" ; 
        } 
     ...
     if(trim((string) $this->q111_meiimportameiregcontador)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportameiregcontador"])){ 
        if(trim((string) $this->q111_meiimportameiregcontador)=="" && isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportameiregcontador"])){ 
           $this->q111_meiimportameiregcontador = "null" ; 
        } 
     ...
     if(trim((string) $this->q111_meiimportameiregresponsavel)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportameiregresponsavel"])){ 
        if(trim((string) $this->q111_meiimportameiregresponsavel)=="" && isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportameiregresponsavel"])){ 
           $this->q111_meiimportameiregresponsavel = "null" ; 
        } 
     ...
     if(trim((string) $this->q111_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q111_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["q111_data_dia"] !="") ){ 
       $sql  .= $virgula." q111_data = '$this->q111_data' ";
       $virgula = ",";
       if(trim((string) $this->q111_data) == null ){ 
         $this->erro_sql = " Campo Data Evento nao Informado.";
         $this->erro_campo = "q111_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q111_sequencial"]) || $this->q111_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2915,16595,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q111_sequencial'))."','$this->q111_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportamei"]) || $this->q111_meiimportamei != "")
           $resac = db_query("insert into db_acount values($acount,2915,16608,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q111_meiimportamei'))."','$this->q111_meiimportamei',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q111_meievento"]) || $this->q111_meievento != "")
           $resac = db_query("insert into db_acount values($acount,2915,16596,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q111_meievento'))."','$this->q111_meievento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportameiregatividade"]) || $this->q111_meiimportameiregatividade != "")
           $resac = db_query("insert into db_acount values($acount,2915,16599,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q111_meiimportameiregatividade'))."','$this->q111_meiimportameiregatividade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportameiregempresa"]) || $this->q111_meiimportameiregempresa != "")
           $resac = db_query("insert into db_acount values($acount,2915,16600,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q111_meiimportameiregempresa'))."','$this->q111_meiimportameiregempresa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportameiregcontador"]) || $this->q111_meiimportameiregcontador != "")
           $resac = db_query("insert into db_acount values($acount,2915,16601,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q111_meiimportameiregcontador'))."','$this->q111_meiimportameiregcontador',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportameiregresponsavel"]) || $this->q111_meiimportameiregresponsavel != "")
           $resac = db_query("insert into db_acount values($acount,2915,16602,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q111_meiimportameiregresponsavel'))."','$this->q111_meiimportameiregresponsavel',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q111_data"]) || $this->q111_data != "")
           $resac = db_query("insert into db_acount values($acount,2915,16603,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q111_data'))."','$this->q111_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q111_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2915,16595,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q111_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2915,16608,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q111_meiimportamei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2915,16596,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q111_meievento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2915,16599,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q111_meiimportameiregatividade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2915,16600,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q111_meiimportameiregempresa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2915,16601,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q111_meiimportameiregcontador'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2915,16602,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q111_meiimportameiregresponsavel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2915,16603,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q111_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
