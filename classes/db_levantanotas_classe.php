...
class cl_levantanotas { 
   ...
   function incluir ($y79_codigo){ 
     ...
     if($y79_codigo == "" || $y79_codigo == null ){
       ...
       $this->y79_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from levantanotas_y79_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $y79_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1074,6534,'','".AddSlashes(pg_fetch_result($resaco,0,'y79_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1074,6530,'','".AddSlashes(pg_fetch_result($resaco,0,'y79_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1074,6536,'','".AddSlashes(pg_fetch_result($resaco,0,'y79_ordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1074,6531,'','".AddSlashes(pg_fetch_result($resaco,0,'y79_documento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1074,6533,'','".AddSlashes(pg_fetch_result($resaco,0,'y79_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1074,6532,'','".AddSlashes(pg_fetch_result($resaco,0,'y79_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y79_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y79_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y79_codigo"])){ 
       $sql  .= $virgula." y79_codigo = $this->y79_codigo ";
       $virgula = ",";
       if(trim((string) $this->y79_codigo) == null ){ 
     ...
     if(trim((string) $this->y79_sequencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y79_sequencia"])){ 
       $sql  .= $virgula." y79_sequencia = $this->y79_sequencia ";
       $virgula = ",";
       if(trim((string) $this->y79_sequencia) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
         $this->erro_campo = "y79_sequencia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y79_ordem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y79_ordem"])){ 
       $sql  .= $virgula." y79_ordem = $this->y79_ordem ";
       $virgula = ",";
       if(trim((string) $this->y79_ordem) == null ){ 
         $this->erro_sql = " Campo Ordem nao Informado.";
         $this->erro_campo = "y79_ordem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y79_documento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y79_documento"])){ 
       $sql  .= $virgula." y79_documento = '$this->y79_documento' ";
       $virgula = ",";
       if(trim((string) $this->y79_documento) == null ){ 
         $this->erro_sql = " Campo Documento nao Informado.";
         $this->erro_campo = "y79_documento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y79_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y79_valor"])){ 
       $sql  .= $virgula." y79_valor = $this->y79_valor ";
       $virgula = ",";
       if(trim((string) $this->y79_valor) == null ){ 
         $this->erro_sql = " Campo Valor nao Informado.";
         $this->erro_campo = "y79_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y79_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y79_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["y79_data_dia"] !="") ){ 
       $sql  .= $virgula." y79_data = '$this->y79_data' ";
       $virgula = ",";
       if(trim((string) $this->y79_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "y79_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y79_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1074,6534,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y79_codigo'))."','$this->y79_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y79_sequencia"]))
           $resac = db_query("insert into db_acount values($acount,1074,6530,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y79_sequencia'))."','$this->y79_sequencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y79_ordem"]))
           $resac = db_query("insert into db_acount values($acount,1074,6536,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y79_ordem'))."','$this->y79_ordem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y79_documento"]))
           $resac = db_query("insert into db_acount values($acount,1074,6531,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y79_documento'))."','$this->y79_documento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y79_valor"]))
           $resac = db_query("insert into db_acount values($acount,1074,6533,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y79_valor'))."','$this->y79_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y79_data"]))
           $resac = db_query("insert into db_acount values($acount,1074,6532,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y79_data'))."','$this->y79_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y79_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1074,6534,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y79_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1074,6530,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y79_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1074,6536,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y79_ordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1074,6531,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y79_documento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1074,6533,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y79_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1074,6532,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y79_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
