...
class cl_turmaacprof { 
   ...
   public $ed222_i_turmaac = 0; 
   public $ed222_i_rechumano = 0; 
   ...
   function incluir ($ed222_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2634,14985,'','".AddSlashes(pg_fetch_result($resaco,0,'ed222_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2634,14986,'','".AddSlashes(pg_fetch_result($resaco,0,'ed222_i_turmaac'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2634,14987,'','".AddSlashes(pg_fetch_result($resaco,0,'ed222_i_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed222_i_codigo=null) { 
     ...
     if(trim((string) $this->ed222_i_turmaac)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed222_i_turmaac"])){ 
       $sql  .= $virgula." ed222_i_turmaac = $this->ed222_i_turmaac ";
       $virgula = ",";
       if(trim((string) $this->ed222_i_turmaac) == null ){ 
         $this->erro_sql = " Campo Turma nao Informado.";
         $this->erro_campo = "ed222_i_turmaac";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed222_i_rechumano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed222_i_rechumano"])){ 
       $sql  .= $virgula." ed222_i_rechumano = $this->ed222_i_rechumano ";
       $virgula = ",";
       if(trim((string) $this->ed222_i_rechumano) == null ){ 
         $this->erro_sql = " Campo Profissional/Monitor nao Informado.";
         $this->erro_campo = "ed222_i_rechumano";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed222_i_codigo"]) || $this->ed222_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2634,14985,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed222_i_codigo'))."','$this->ed222_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed222_i_turmaac"]) || $this->ed222_i_turmaac != "")
           $resac = db_query("insert into db_acount values($acount,2634,14986,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed222_i_turmaac'))."','$this->ed222_i_turmaac',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed222_i_rechumano"]) || $this->ed222_i_rechumano != "")
           $resac = db_query("insert into db_acount values($acount,2634,14987,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed222_i_rechumano'))."','$this->ed222_i_rechumano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed222_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2634,14985,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed222_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2634,14986,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed222_i_turmaac'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2634,14987,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed222_i_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
