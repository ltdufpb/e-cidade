...
class cl_veiccadmodelo { 
   ...
   public $ve22_codigo = 0; 
   public $ve22_descr = null; 
   ...
   function incluir ($ve22_codigo){ 
     ...
     if($ve22_codigo == "" || $ve22_codigo == null ){
       ...
       $this->ve22_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veiccadmodelo_ve22_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve22_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1578,9219,'','".AddSlashes(pg_fetch_result($resaco,0,'ve22_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1578,9220,'','".AddSlashes(pg_fetch_result($resaco,0,'ve22_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve22_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve22_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve22_codigo"])){ 
       $sql  .= $virgula." ve22_codigo = $this->ve22_codigo ";
       $virgula = ",";
       if(trim((string) $this->ve22_codigo) == null ){ 
     ...
     if(trim((string) $this->ve22_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve22_descr"])){ 
       $sql  .= $virgula." ve22_descr = '$this->ve22_descr' ";
       $virgula = ",";
       if(trim((string) $this->ve22_descr) == null ){ 
         $this->erro_sql = " Campo Descrição do Modelo nao Informado.";
         $this->erro_campo = "ve22_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve22_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1578,9219,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve22_codigo'))."','$this->ve22_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve22_descr"]))
           $resac = db_query("insert into db_acount values($acount,1578,9220,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve22_descr'))."','$this->ve22_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve22_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1578,9219,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve22_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1578,9220,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve22_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
