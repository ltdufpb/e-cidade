...
class cl_telefonerechumano { 
   ...
   public $ed30_i_rechumano = 0; 
   public $ed30_i_tipotelefone = 0; 
   public $ed30_i_numero = 0; 
   public $ed30_i_ramal = 0; 
   public $ed30_t_obs = null; 
   ...
   function incluir ($ed30_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010088,1008514,'','".AddSlashes(pg_fetch_result($resaco,0,'ed30_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010088,1008515,'','".AddSlashes(pg_fetch_result($resaco,0,'ed30_i_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010088,1008516,'','".AddSlashes(pg_fetch_result($resaco,0,'ed30_i_tipotelefone'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010088,1008517,'','".AddSlashes(pg_fetch_result($resaco,0,'ed30_i_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010088,1008518,'','".AddSlashes(pg_fetch_result($resaco,0,'ed30_i_ramal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010088,1008519,'','".AddSlashes(pg_fetch_result($resaco,0,'ed30_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed30_i_codigo=null) { 
     ...
     if(trim((string) $this->ed30_i_rechumano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed30_i_rechumano"])){ 
       $sql  .= $virgula." ed30_i_rechumano = $this->ed30_i_rechumano ";
       $virgula = ",";
       if(trim((string) $this->ed30_i_rechumano) == null ){ 
         $this->erro_sql = " Campo Matrícula nao Informado.";
         $this->erro_campo = "ed30_i_rechumano";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed30_i_tipotelefone)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed30_i_tipotelefone"])){ 
       $sql  .= $virgula." ed30_i_tipotelefone = $this->ed30_i_tipotelefone ";
       $virgula = ",";
       if(trim((string) $this->ed30_i_tipotelefone) == null ){ 
         $this->erro_sql = " Campo Tipo Telefone nao Informado.";
         $this->erro_campo = "ed30_i_tipotelefone";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed30_i_numero)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed30_i_numero"])){ 
       $sql  .= $virgula." ed30_i_numero = $this->ed30_i_numero ";
       $virgula = ",";
       if(trim((string) $this->ed30_i_numero) == null ){ 
         $this->erro_sql = " Campo Número nao Informado.";
         $this->erro_campo = "ed30_i_numero";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed30_i_ramal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed30_i_ramal"])){ 
       $sql  .= $virgula." ed30_i_ramal = $this->ed30_i_ramal ";
       $virgula = ",";
       if(trim((string) $this->ed30_i_ramal) == null ){ 
         $this->erro_sql = " Campo DDD nao Informado.";
         $this->erro_campo = "ed30_i_ramal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed30_t_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed30_t_obs"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed30_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010088,1008514,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed30_i_codigo'))."','$this->ed30_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed30_i_rechumano"]))
           $resac = db_query("insert into db_acount values($acount,1010088,1008515,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed30_i_rechumano'))."','$this->ed30_i_rechumano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed30_i_tipotelefone"]))
           $resac = db_query("insert into db_acount values($acount,1010088,1008516,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed30_i_tipotelefone'))."','$this->ed30_i_tipotelefone',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed30_i_numero"]))
           $resac = db_query("insert into db_acount values($acount,1010088,1008517,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed30_i_numero'))."','$this->ed30_i_numero',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed30_i_ramal"]))
           $resac = db_query("insert into db_acount values($acount,1010088,1008518,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed30_i_ramal'))."','$this->ed30_i_ramal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed30_t_obs"]))
           $resac = db_query("insert into db_acount values($acount,1010088,1008519,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed30_t_obs'))."','$this->ed30_t_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed30_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010088,1008514,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed30_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010088,1008515,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed30_i_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010088,1008516,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed30_i_tipotelefone'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010088,1008517,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed30_i_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010088,1008518,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed30_i_ramal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010088,1008519,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed30_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
