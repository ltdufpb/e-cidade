...
class cl_acordoitemaditamento { 
   ...
   public $ac21_sequencial = 0; 
   public $ac21_acordoitem = 0; 
   public $ac21_quantidade = 0; 
   public $ac21_valor = 0; 
   public $ac21_tipo = 0; 
   ...
   function incluir ($ac21_sequencial){ 
     ...
     if($ac21_sequencial == "" || $ac21_sequencial == null ){
       ...
       $this->ac21_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordoitemaditamento_ac21_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac21_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2838,16178,'','".AddSlashes(pg_fetch_result($resaco,0,'ac21_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2838,16179,'','".AddSlashes(pg_fetch_result($resaco,0,'ac21_acordoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2838,16180,'','".AddSlashes(pg_fetch_result($resaco,0,'ac21_quantidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2838,16181,'','".AddSlashes(pg_fetch_result($resaco,0,'ac21_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2838,16182,'','".AddSlashes(pg_fetch_result($resaco,0,'ac21_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac21_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac21_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac21_sequencial"])){ 
       $sql  .= $virgula." ac21_sequencial = $this->ac21_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac21_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac21_acordoitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac21_acordoitem"])){ 
       $sql  .= $virgula." ac21_acordoitem = $this->ac21_acordoitem ";
       $virgula = ",";
       if(trim((string) $this->ac21_acordoitem) == null ){ 
         $this->erro_sql = " Campo Acordo Item nao Informado.";
         $this->erro_campo = "ac21_acordoitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac21_quantidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac21_quantidade"])){ 
       $sql  .= $virgula." ac21_quantidade = $this->ac21_quantidade ";
       $virgula = ",";
       if(trim((string) $this->ac21_quantidade) == null ){ 
         $this->erro_sql = " Campo Quantidade nao Informado.";
         $this->erro_campo = "ac21_quantidade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac21_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac21_valor"])){ 
       $sql  .= $virgula." ac21_valor = $this->ac21_valor ";
       $virgula = ",";
       if(trim((string) $this->ac21_valor) == null ){ 
         $this->erro_sql = " Campo Valor nao Informado.";
         $this->erro_campo = "ac21_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac21_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac21_tipo"])){ 
       $sql  .= $virgula." ac21_tipo = $this->ac21_tipo ";
       $virgula = ",";
       if(trim((string) $this->ac21_tipo) == null ){ 
         $this->erro_sql = " Campo Tipo nao Informado.";
         $this->erro_campo = "ac21_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac21_sequencial"]) || $this->ac21_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2838,16178,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac21_sequencial'))."','$this->ac21_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac21_acordoitem"]) || $this->ac21_acordoitem != "")
           $resac = db_query("insert into db_acount values($acount,2838,16179,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac21_acordoitem'))."','$this->ac21_acordoitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac21_quantidade"]) || $this->ac21_quantidade != "")
           $resac = db_query("insert into db_acount values($acount,2838,16180,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac21_quantidade'))."','$this->ac21_quantidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac21_valor"]) || $this->ac21_valor != "")
           $resac = db_query("insert into db_acount values($acount,2838,16181,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac21_valor'))."','$this->ac21_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac21_tipo"]) || $this->ac21_tipo != "")
           $resac = db_query("insert into db_acount values($acount,2838,16182,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac21_tipo'))."','$this->ac21_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac21_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2838,16178,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac21_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2838,16179,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac21_acordoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2838,16180,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac21_quantidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2838,16181,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac21_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2838,16182,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac21_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
