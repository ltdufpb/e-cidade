...
class cl_orcimpactorecmovmes { 
   ...
   function incluir ($o97_sequen,$o97_mes){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1106,6776,'','".AddSlashes(pg_fetch_result($resaco,0,'o97_sequen'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1106,6777,'','".AddSlashes(pg_fetch_result($resaco,0,'o97_mes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1106,6778,'','".AddSlashes(pg_fetch_result($resaco,0,'o97_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o97_sequen=null,$o97_mes=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o97_sequen)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o97_sequen"])){ 
       $sql  .= $virgula." o97_sequen = $this->o97_sequen ";
       $virgula = ",";
       if(trim((string) $this->o97_sequen) == null ){ 
     ...
     if(trim((string) $this->o97_mes)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o97_mes"])){ 
       $sql  .= $virgula." o97_mes = $this->o97_mes ";
       $virgula = ",";
       if(trim((string) $this->o97_mes) == null ){ 
     ...
     if(trim((string) $this->o97_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o97_valor"])){ 
       $sql  .= $virgula." o97_valor = $this->o97_valor ";
       $virgula = ",";
       if(trim((string) $this->o97_valor) == null ){ 
         $this->erro_sql = " Campo Valor nao Informado.";
         $this->erro_campo = "o97_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o97_sequen"]))
           $resac = db_query("insert into db_acount values($acount,1106,6776,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o97_sequen'))."','$this->o97_sequen',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o97_mes"]))
           $resac = db_query("insert into db_acount values($acount,1106,6777,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o97_mes'))."','$this->o97_mes',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o97_valor"]))
           $resac = db_query("insert into db_acount values($acount,1106,6778,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o97_valor'))."','$this->o97_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o97_sequen=null,$o97_mes=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1106,6776,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o97_sequen'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1106,6777,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o97_mes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1106,6778,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o97_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
