...
class cl_itbidbpref { 
   ...
   public $it23_sequencial = 0; 
   public $it23_itbi = 0; 
   public $it23_data_dia = null; 
   public $it23_data_mes = null; 
   public $it23_data_ano = null; 
   public $it23_data = null; 
   public $it23_hora = null; 
   public $it23_ip = null; 
   ...
   function incluir ($it23_sequencial){ 
     ...
     if($it23_sequencial == "" || $it23_sequencial == null ){
       ...
       $this->it23_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from itbidbpref_it23_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $it23_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1656,9625,'','".AddSlashes(pg_fetch_result($resaco,0,'it23_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1656,9629,'','".AddSlashes(pg_fetch_result($resaco,0,'it23_itbi'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1656,9626,'','".AddSlashes(pg_fetch_result($resaco,0,'it23_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1656,9627,'','".AddSlashes(pg_fetch_result($resaco,0,'it23_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1656,9628,'','".AddSlashes(pg_fetch_result($resaco,0,'it23_ip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($it23_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->it23_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it23_sequencial"])){ 
       $sql  .= $virgula." it23_sequencial = $this->it23_sequencial ";
       $virgula = ",";
       if(trim((string) $this->it23_sequencial) == null ){ 
     ...
     if(trim((string) $this->it23_itbi)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it23_itbi"])){ 
       $sql  .= $virgula." it23_itbi = $this->it23_itbi ";
       $virgula = ",";
       if(trim((string) $this->it23_itbi) == null ){ 
         $this->erro_sql = " Campo codigo da ITBI nao Informado.";
         $this->erro_campo = "it23_itbi";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->it23_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it23_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["it23_data_dia"] !="") ){ 
       $sql  .= $virgula." it23_data = '$this->it23_data' ";
       $virgula = ",";
       if(trim((string) $this->it23_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "it23_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->it23_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it23_hora"])){ 
       $sql  .= $virgula." it23_hora = '$this->it23_hora' ";
       $virgula = ",";
       if(trim((string) $this->it23_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "it23_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->it23_ip)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it23_ip"])){ 
       $sql  .= $virgula." it23_ip = '$this->it23_ip' ";
       $virgula = ",";
       if(trim((string) $this->it23_ip) == null ){ 
         $this->erro_sql = " Campo IP nao Informado.";
         $this->erro_campo = "it23_ip";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["it23_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1656,9625,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'it23_sequencial'))."','$this->it23_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it23_itbi"]))
           $resac = db_query("insert into db_acount values($acount,1656,9629,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'it23_itbi'))."','$this->it23_itbi',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it23_data"]))
           $resac = db_query("insert into db_acount values($acount,1656,9626,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'it23_data'))."','$this->it23_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it23_hora"]))
           $resac = db_query("insert into db_acount values($acount,1656,9627,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'it23_hora'))."','$this->it23_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it23_ip"]))
           $resac = db_query("insert into db_acount values($acount,1656,9628,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'it23_ip'))."','$this->it23_ip',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($it23_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1656,9625,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'it23_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1656,9629,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'it23_itbi'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1656,9626,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'it23_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1656,9627,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'it23_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1656,9628,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'it23_ip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
