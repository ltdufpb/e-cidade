...
class cl_rechumanoescola {
   ...
   function incluir ($ed75_i_codigo){
     ...
     if($ed75_i_codigo == "" || $ed75_i_codigo == null ){
       ...
       $this->ed75_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from rechumanoescola_ed75_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed75_i_codigo)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,1010094,1008536,'','".AddSlashes(pg_fetch_result($resaco,0,'ed75_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010094,1008537,'','".AddSlashes(pg_fetch_result($resaco,0,'ed75_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010094,1008538,'','".AddSlashes(pg_fetch_result($resaco,0,'ed75_i_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010094,1008564,'','".AddSlashes(pg_fetch_result($resaco,0,'ed75_d_ingresso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010094,17612,'','".AddSlashes(pg_fetch_result($resaco,0,'ed75_c_simultaneo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010094,19748,'','".AddSlashes(pg_fetch_result($resaco,0,'ed75_i_saidaescola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   public function alterar ($ed75_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->ed75_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed75_i_codigo"])){
       $sql  .= $virgula." ed75_i_codigo = $this->ed75_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed75_i_codigo) == null ){
     ...
     if(trim((string) $this->ed75_i_escola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed75_i_escola"])){
       $sql  .= $virgula." ed75_i_escola = $this->ed75_i_escola ";
       $virgula = ",";
       if(trim((string) $this->ed75_i_escola) == null ){
         $this->erro_sql = " Campo Escola não informado.";
         $this->erro_campo = "ed75_i_escola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed75_i_rechumano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed75_i_rechumano"])){
       $sql  .= $virgula." ed75_i_rechumano = $this->ed75_i_rechumano ";
       $virgula = ",";
       if(trim((string) $this->ed75_i_rechumano) == null ){
         $this->erro_sql = " Campo Matrícula não informado.";
         $this->erro_campo = "ed75_i_rechumano";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed75_d_ingresso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed75_d_ingresso_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed75_d_ingresso_dia"] !="") ){
       $sql  .= $virgula." ed75_d_ingresso = '$this->ed75_d_ingresso' ";
       $virgula = ",";
       if(trim((string) $this->ed75_d_ingresso) == null ){
         $this->erro_sql = " Campo Data de Ingresso não informado.";
         $this->erro_campo = "ed75_d_ingresso_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed75_c_simultaneo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed75_c_simultaneo"])){
       $sql  .= $virgula." ed75_c_simultaneo = '$this->ed75_c_simultaneo' ";
       $virgula = ",";
       if(trim((string) $this->ed75_c_simultaneo) == null ){
         $this->erro_sql = " Campo Atende simultaneamente mais de uma turma não informado.";
         $this->erro_campo = "ed75_c_simultaneo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed75_i_saidaescola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed75_i_saidaescola_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed75_i_saidaescola_dia"] !="") ){
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed75_i_codigo"]) || $this->ed75_i_codigo != "")
             $resac = db_query("insert into db_acount values($acount,1010094,1008536,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed75_i_codigo'))."','$this->ed75_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed75_i_escola"]) || $this->ed75_i_escola != "")
             $resac = db_query("insert into db_acount values($acount,1010094,1008537,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed75_i_escola'))."','$this->ed75_i_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed75_i_rechumano"]) || $this->ed75_i_rechumano != "")
             $resac = db_query("insert into db_acount values($acount,1010094,1008538,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed75_i_rechumano'))."','$this->ed75_i_rechumano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed75_d_ingresso"]) || $this->ed75_d_ingresso != "")
             $resac = db_query("insert into db_acount values($acount,1010094,1008564,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed75_d_ingresso'))."','$this->ed75_d_ingresso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed75_c_simultaneo"]) || $this->ed75_c_simultaneo != "")
             $resac = db_query("insert into db_acount values($acount,1010094,17612,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed75_c_simultaneo'))."','$this->ed75_c_simultaneo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed75_i_saidaescola"]) || $this->ed75_i_saidaescola != "")
             $resac = db_query("insert into db_acount values($acount,1010094,19748,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed75_i_saidaescola'))."','$this->ed75_i_saidaescola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,1010094,1008536,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed75_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010094,1008537,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed75_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010094,1008538,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed75_i_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010094,1008564,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed75_d_ingresso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010094,17612,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed75_c_simultaneo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010094,19748,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed75_i_saidaescola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
