...
class cl_conlancamacordo {
   ...
   function incluir ($c87_codlan){
     ...
     if($this->c87_sequencial == "0" || $this->c87_sequencial == null ){
       ...
       $this->c87_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from conlancamacordo_c87_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $c87_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3576,19955,'','".AddSlashes(pg_fetch_result($resaco,0,'c87_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3576,19956,'','".AddSlashes(pg_fetch_result($resaco,0,'c87_codlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3576,19957,'','".AddSlashes(pg_fetch_result($resaco,0,'c87_acordo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   function alterar ($c87_codlan=null) {
     ...
     $virgula = "";
     if(trim((string) $this->c87_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c87_sequencial"])){
        if(trim((string) $this->c87_sequencial)=="" && isset($GLOBALS["HTTP_POST_VARS"]["c87_sequencial"])){
           $this->c87_sequencial = "0" ;
        }
     ...
     if(trim((string) $this->c87_codlan)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c87_codlan"])){
       $sql  .= $virgula." c87_codlan = $this->c87_codlan ";
       $virgula = ",";
       if(trim((string) $this->c87_codlan) == null ){
     ...
     if(trim((string) $this->c87_acordo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c87_acordo"])){
       $sql  .= $virgula." c87_acordo = $this->c87_acordo ";
       $virgula = ",";
       if(trim((string) $this->c87_acordo) == null ){
         $this->erro_sql = " Campo Sequencial do Acordo nao Informado.";
         $this->erro_campo = "c87_acordo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["c87_sequencial"]) || $this->c87_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3576,19955,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c87_sequencial'))."','$this->c87_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["c87_codlan"]) || $this->c87_codlan != "")
             $resac = db_query("insert into db_acount values($acount,3576,19956,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c87_codlan'))."','$this->c87_codlan',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["c87_acordo"]) || $this->c87_acordo != "")
             $resac = db_query("insert into db_acount values($acount,3576,19957,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c87_acordo'))."','$this->c87_acordo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3576,19955,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c87_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3576,19956,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c87_codlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3576,19957,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c87_acordo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
