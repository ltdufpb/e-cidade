...
class cl_cflicitatemplateminuta { 
   ...
   public $l41_sequencial = 0; 
   public $l41_cflicita = 0; 
   public $l41_db_documentotemplate = 0; 
   ...
   function incluir ($l41_sequencial){ 
     ...
     if($l41_sequencial == "" || $l41_sequencial == null ){
       ...
       $this->l41_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cflicitatemplateminuta_l41_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $l41_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3058,17276,'','".AddSlashes(pg_fetch_result($resaco,0,'l41_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3058,17277,'','".AddSlashes(pg_fetch_result($resaco,0,'l41_cflicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3058,17278,'','".AddSlashes(pg_fetch_result($resaco,0,'l41_db_documentotemplate'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($l41_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->l41_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l41_sequencial"])){ 
       $sql  .= $virgula." l41_sequencial = $this->l41_sequencial ";
       $virgula = ",";
       if(trim((string) $this->l41_sequencial) == null ){ 
     ...
     if(trim((string) $this->l41_cflicita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l41_cflicita"])){ 
       $sql  .= $virgula." l41_cflicita = $this->l41_cflicita ";
       $virgula = ",";
       if(trim((string) $this->l41_cflicita) == null ){ 
         $this->erro_sql = " Campo Código Licitação nao Informado.";
         $this->erro_campo = "l41_cflicita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l41_db_documentotemplate)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l41_db_documentotemplate"])){ 
       $sql  .= $virgula." l41_db_documentotemplate = $this->l41_db_documentotemplate ";
       $virgula = ",";
       if(trim((string) $this->l41_db_documentotemplate) == null ){ 
         $this->erro_sql = " Campo Documento Template nao Informado.";
         $this->erro_campo = "l41_db_documentotemplate";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["l41_sequencial"]) || $this->l41_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3058,17276,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l41_sequencial'))."','$this->l41_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l41_cflicita"]) || $this->l41_cflicita != "")
           $resac = db_query("insert into db_acount values($acount,3058,17277,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l41_cflicita'))."','$this->l41_cflicita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l41_db_documentotemplate"]) || $this->l41_db_documentotemplate != "")
           $resac = db_query("insert into db_acount values($acount,3058,17278,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l41_db_documentotemplate'))."','$this->l41_db_documentotemplate',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($l41_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3058,17276,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l41_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3058,17277,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l41_cflicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3058,17278,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l41_db_documentotemplate'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
