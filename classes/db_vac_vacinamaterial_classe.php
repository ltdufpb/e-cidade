...
class cl_vac_vacinamaterial { 
   ...
   public $vc29_i_dose = 0; 
   public $vc29_i_codigo = 0; 
   public $vc29_i_vacina = 0; 
   public $vc29_i_material = 0; 
   ...
   function incluir ($vc29_i_codigo){ 
     ...
     if($vc29_i_codigo == "" || $vc29_i_codigo == null ){
       ...
       $this->vc29_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from vac_vacinamaterial_vc29_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $vc29_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3170,17936,'','".AddSlashes(pg_fetch_result($resaco,0,'vc29_i_dose'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3170,17933,'','".AddSlashes(pg_fetch_result($resaco,0,'vc29_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3170,17934,'','".AddSlashes(pg_fetch_result($resaco,0,'vc29_i_vacina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3170,17935,'','".AddSlashes(pg_fetch_result($resaco,0,'vc29_i_material'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($vc29_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->vc29_i_dose)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc29_i_dose"])){ 
       $sql  .= $virgula." vc29_i_dose = $this->vc29_i_dose ";
       $virgula = ",";
       if(trim((string) $this->vc29_i_dose) == null ){ 
         $this->erro_sql = " Campo Dose nao Informado.";
         $this->erro_campo = "vc29_i_dose";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc29_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc29_i_codigo"])){ 
       $sql  .= $virgula." vc29_i_codigo = $this->vc29_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->vc29_i_codigo) == null ){ 
     ...
     if(trim((string) $this->vc29_i_vacina)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc29_i_vacina"])){ 
       $sql  .= $virgula." vc29_i_vacina = $this->vc29_i_vacina ";
       $virgula = ",";
       if(trim((string) $this->vc29_i_vacina) == null ){ 
         $this->erro_sql = " Campo Vacina nao Informado.";
         $this->erro_campo = "vc29_i_vacina";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc29_i_material)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc29_i_material"])){ 
       $sql  .= $virgula." vc29_i_material = $this->vc29_i_material ";
       $virgula = ",";
       if(trim((string) $this->vc29_i_material) == null ){ 
         $this->erro_sql = " Campo Material nao Informado.";
         $this->erro_campo = "vc29_i_material";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc29_i_dose"]) || $this->vc29_i_dose != "")
           $resac = db_query("insert into db_acount values($acount,3170,17936,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc29_i_dose'))."','$this->vc29_i_dose',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc29_i_codigo"]) || $this->vc29_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3170,17933,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc29_i_codigo'))."','$this->vc29_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc29_i_vacina"]) || $this->vc29_i_vacina != "")
           $resac = db_query("insert into db_acount values($acount,3170,17934,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc29_i_vacina'))."','$this->vc29_i_vacina',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc29_i_material"]) || $this->vc29_i_material != "")
           $resac = db_query("insert into db_acount values($acount,3170,17935,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc29_i_material'))."','$this->vc29_i_material',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($vc29_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3170,17936,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc29_i_dose'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3170,17933,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc29_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3170,17934,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc29_i_vacina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3170,17935,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc29_i_material'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
