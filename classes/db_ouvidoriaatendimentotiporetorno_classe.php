...
class cl_ouvidoriaatendimentotiporetorno { 
   ...
   public $ov17_sequencial = 0; 
   public $ov17_tiporetorno = 0; 
   public $ov17_ouvidoriaatendimento = 0; 
   ...
   function incluir ($ov17_sequencial){ 
     ...
     if($ov17_sequencial == "" || $ov17_sequencial == null ){
       ...
       $this->ov17_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from ouvidoriaatendimentotiporetorno_ov17_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ov17_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2615,14853,'','".AddSlashes(pg_fetch_result($resaco,0,'ov17_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2615,14854,'','".AddSlashes(pg_fetch_result($resaco,0,'ov17_tiporetorno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2615,14855,'','".AddSlashes(pg_fetch_result($resaco,0,'ov17_ouvidoriaatendimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ov17_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ov17_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov17_sequencial"])){ 
       $sql  .= $virgula." ov17_sequencial = $this->ov17_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ov17_sequencial) == null ){ 
     ...
     if(trim((string) $this->ov17_tiporetorno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov17_tiporetorno"])){ 
       $sql  .= $virgula." ov17_tiporetorno = $this->ov17_tiporetorno ";
       $virgula = ",";
       if(trim((string) $this->ov17_tiporetorno) == null ){ 
         $this->erro_sql = " Campo Tipo de Retorno nao Informado.";
         $this->erro_campo = "ov17_tiporetorno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ov17_ouvidoriaatendimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov17_ouvidoriaatendimento"])){ 
       $sql  .= $virgula." ov17_ouvidoriaatendimento = $this->ov17_ouvidoriaatendimento ";
       $virgula = ",";
       if(trim((string) $this->ov17_ouvidoriaatendimento) == null ){ 
         $this->erro_sql = " Campo Atendimento nao Informado.";
         $this->erro_campo = "ov17_ouvidoriaatendimento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov17_sequencial"]) || $this->ov17_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2615,14853,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov17_sequencial'))."','$this->ov17_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov17_tiporetorno"]) || $this->ov17_tiporetorno != "")
           $resac = db_query("insert into db_acount values($acount,2615,14854,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov17_tiporetorno'))."','$this->ov17_tiporetorno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov17_ouvidoriaatendimento"]) || $this->ov17_ouvidoriaatendimento != "")
           $resac = db_query("insert into db_acount values($acount,2615,14855,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov17_ouvidoriaatendimento'))."','$this->ov17_ouvidoriaatendimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ov17_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2615,14853,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov17_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2615,14854,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov17_tiporetorno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2615,14855,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov17_ouvidoriaatendimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
