...
class cl_avaliacaoclassificacao { 
   ...
   public $ed335_sequencial = 0; 
   public $ed335_trocaserie = 0; 
   public $ed335_disciplina = 0; 
   public $ed335_avaliacao = null; 
   ...
   function incluir ($ed335_sequencial){ 
     ...
     if($ed335_sequencial == "" || $ed335_sequencial == null ){
       ...
       $this->ed335_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from avaliacaoclassificacao_ed335_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed335_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3658,20363,'','".AddSlashes(pg_fetch_result($resaco,0,'ed335_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3658,20364,'','".AddSlashes(pg_fetch_result($resaco,0,'ed335_trocaserie'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3658,20365,'','".AddSlashes(pg_fetch_result($resaco,0,'ed335_disciplina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3658,20366,'','".AddSlashes(pg_fetch_result($resaco,0,'ed335_avaliacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($ed335_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed335_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed335_sequencial"])){ 
       $sql  .= $virgula." ed335_sequencial = $this->ed335_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed335_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed335_trocaserie)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed335_trocaserie"])){ 
       $sql  .= $virgula." ed335_trocaserie = $this->ed335_trocaserie ";
       $virgula = ",";
       if(trim((string) $this->ed335_trocaserie) == null ){ 
         $this->erro_sql = " Campo Código não informado.";
         $this->erro_campo = "ed335_trocaserie";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed335_disciplina)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed335_disciplina"])){ 
       $sql  .= $virgula." ed335_disciplina = $this->ed335_disciplina ";
       $virgula = ",";
       if(trim((string) $this->ed335_disciplina) == null ){ 
         $this->erro_sql = " Campo Código não informado.";
         $this->erro_campo = "ed335_disciplina";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed335_avaliacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed335_avaliacao"])){ 
       $sql  .= $virgula." ed335_avaliacao = '$this->ed335_avaliacao' ";
       $virgula = ",";
       if(trim((string) $this->ed335_avaliacao) == null ){ 
         $this->erro_sql = " Campo Avaliação não informado.";
         $this->erro_campo = "ed335_avaliacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["ed335_sequencial"]) || $this->ed335_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3658,20363,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed335_sequencial'))."','$this->ed335_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ed335_trocaserie"]) || $this->ed335_trocaserie != "")
             $resac = db_query("insert into db_acount values($acount,3658,20364,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed335_trocaserie'))."','$this->ed335_trocaserie',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ed335_disciplina"]) || $this->ed335_disciplina != "")
             $resac = db_query("insert into db_acount values($acount,3658,20365,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed335_disciplina'))."','$this->ed335_disciplina',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ed335_avaliacao"]) || $this->ed335_avaliacao != "")
             $resac = db_query("insert into db_acount values($acount,3658,20366,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed335_avaliacao'))."','$this->ed335_avaliacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3658,20363,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed335_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3658,20364,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed335_trocaserie'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3658,20365,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed335_disciplina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3658,20366,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed335_avaliacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
