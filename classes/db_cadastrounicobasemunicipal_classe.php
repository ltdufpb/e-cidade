...
class cl_cadastrounicobasemunicipal { 
   ...
   public $as09_sequencial = 0; 
   public $as09_tiporegistro = 0; 
   public $as09_chaveregistro = null; 
   public $as09_conteudolinha = null; 
   ...
   function incluir ($as09_sequencial){ 
     ...
     if($as09_sequencial == "" || $as09_sequencial == null ){
       ...
       $this->as09_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cadastrounicobasemunicipal_as09_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $as09_sequencial)){
     ...
     if (!isset($_SESSION["DB_usaAccount"])) {
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3405,19166,'','".AddSlashes(pg_fetch_result($resaco,0,'as09_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3405,19167,'','".AddSlashes(pg_fetch_result($resaco,0,'as09_tiporegistro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3405,19168,'','".AddSlashes(pg_fetch_result($resaco,0,'as09_chaveregistro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3405,19169,'','".AddSlashes(pg_fetch_result($resaco,0,'as09_conteudolinha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($as09_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->as09_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as09_sequencial"])){ 
       $sql  .= $virgula." as09_sequencial = $this->as09_sequencial ";
       $virgula = ",";
       if(trim((string) $this->as09_sequencial) == null ){ 
     ...
     if(trim((string) $this->as09_tiporegistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as09_tiporegistro"])){ 
       $sql  .= $virgula." as09_tiporegistro = $this->as09_tiporegistro ";
       $virgula = ",";
       if(trim((string) $this->as09_tiporegistro) == null ){ 
         $this->erro_sql = " Campo Tipo de Registro nao Informado.";
         $this->erro_campo = "as09_tiporegistro";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->as09_chaveregistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as09_chaveregistro"])){ 
       $sql  .= $virgula." as09_chaveregistro = '$this->as09_chaveregistro' ";
       $virgula = ",";
       if(trim((string) $this->as09_chaveregistro) == null ){ 
         $this->erro_sql = " Campo Chave de Registro nao Informado.";
         $this->erro_campo = "as09_chaveregistro";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->as09_conteudolinha)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as09_conteudolinha"])){ 
       $sql  .= $virgula." as09_conteudolinha = '$this->as09_conteudolinha' ";
       $virgula = ",";
       if(trim((string) $this->as09_conteudolinha) == null ){ 
         $this->erro_sql = " Campo Conteúdo da Linha nao Informado.";
         $this->erro_campo = "as09_conteudolinha";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["as09_sequencial"]) || $this->as09_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3405,19166,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as09_sequencial'))."','$this->as09_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["as09_tiporegistro"]) || $this->as09_tiporegistro != "")
             $resac = db_query("insert into db_acount values($acount,3405,19167,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as09_tiporegistro'))."','$this->as09_tiporegistro',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["as09_chaveregistro"]) || $this->as09_chaveregistro != "")
             $resac = db_query("insert into db_acount values($acount,3405,19168,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as09_chaveregistro'))."','$this->as09_chaveregistro',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["as09_conteudolinha"]) || $this->as09_conteudolinha != "")
             $resac = db_query("insert into db_acount values($acount,3405,19169,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as09_conteudolinha'))."','$this->as09_conteudolinha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($_SESSION["DB_usaAccount"])) {
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
           ...
           $resac = db_query("insert into db_acount values($acount,3405,19166,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as09_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,3405,19167,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as09_tiporegistro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,3405,19168,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as09_chaveregistro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,3405,19169,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as09_conteudolinha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
