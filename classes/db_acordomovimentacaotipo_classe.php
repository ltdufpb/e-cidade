...
class cl_acordomovimentacaotipo { 
   ...
   public $ac09_sequencial = 0; 
   public $ac09_descricao = null; 
   public $ac09_acordosituacao = 0; 
   ...
   function incluir ($ac09_sequencial){ 
     ...
     if($ac09_sequencial == "" || $ac09_sequencial == null ){
       ...
       $this->ac09_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordomovimentacaotipo_ac09_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac09_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2823,16097,'','".AddSlashes(pg_fetch_result($resaco,0,'ac09_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2823,16098,'','".AddSlashes(pg_fetch_result($resaco,0,'ac09_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2823,16594,'','".AddSlashes(pg_fetch_result($resaco,0,'ac09_acordosituacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac09_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac09_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac09_sequencial"])){ 
       $sql  .= $virgula." ac09_sequencial = $this->ac09_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac09_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac09_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac09_descricao"])){ 
       $sql  .= $virgula." ac09_descricao = '$this->ac09_descricao' ";
       $virgula = ",";
       if(trim((string) $this->ac09_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "ac09_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac09_acordosituacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac09_acordosituacao"])){ 
        if(trim((string) $this->ac09_acordosituacao)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ac09_acordosituacao"])){ 
           $this->ac09_acordosituacao = "0" ; 
        } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac09_sequencial"]) || $this->ac09_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2823,16097,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac09_sequencial'))."','$this->ac09_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac09_descricao"]) || $this->ac09_descricao != "")
           $resac = db_query("insert into db_acount values($acount,2823,16098,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac09_descricao'))."','$this->ac09_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac09_acordosituacao"]) || $this->ac09_acordosituacao != "")
           $resac = db_query("insert into db_acount values($acount,2823,16594,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac09_acordosituacao'))."','$this->ac09_acordosituacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac09_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2823,16097,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac09_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2823,16098,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac09_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2823,16594,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac09_acordosituacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
