...
class cl_rhpromocaofechamentoassentamento { 
   ...
   public $h78_sequencial = 0; 
   public $h78_rhpromocaofechamento = 0; 
   public $h78_rhassentamento = 0; 
   ...
   function incluir ($h78_sequencial){ 
     ...
     if($h78_sequencial == "" || $h78_sequencial == null ){
       ...
       $this->h78_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhpromocaofechamentoassentamento_h78_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h78_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3321,18734,'','".AddSlashes(pg_fetch_result($resaco,0,'h78_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3321,18735,'','".AddSlashes(pg_fetch_result($resaco,0,'h78_rhpromocaofechamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3321,18736,'','".AddSlashes(pg_fetch_result($resaco,0,'h78_rhassentamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h78_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h78_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h78_sequencial"])){ 
       $sql  .= $virgula." h78_sequencial = $this->h78_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h78_sequencial) == null ){ 
     ...
     if(trim((string) $this->h78_rhpromocaofechamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h78_rhpromocaofechamento"])){ 
       $sql  .= $virgula." h78_rhpromocaofechamento = $this->h78_rhpromocaofechamento ";
       $virgula = ",";
       if(trim((string) $this->h78_rhpromocaofechamento) == null ){ 
         $this->erro_sql = " Campo Fechamento da promoção nao Informado.";
         $this->erro_campo = "h78_rhpromocaofechamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h78_rhassentamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h78_rhassentamento"])){ 
       $sql  .= $virgula." h78_rhassentamento = $this->h78_rhassentamento ";
       $virgula = ",";
       if(trim((string) $this->h78_rhassentamento) == null ){ 
         $this->erro_sql = " Campo Assentamento nao Informado.";
         $this->erro_campo = "h78_rhassentamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h78_sequencial"]) || $this->h78_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3321,18734,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h78_sequencial'))."','$this->h78_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h78_rhpromocaofechamento"]) || $this->h78_rhpromocaofechamento != "")
           $resac = db_query("insert into db_acount values($acount,3321,18735,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h78_rhpromocaofechamento'))."','$this->h78_rhpromocaofechamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h78_rhassentamento"]) || $this->h78_rhassentamento != "")
           $resac = db_query("insert into db_acount values($acount,3321,18736,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h78_rhassentamento'))."','$this->h78_rhassentamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h78_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3321,18734,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h78_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3321,18735,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h78_rhpromocaofechamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3321,18736,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h78_rhassentamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
