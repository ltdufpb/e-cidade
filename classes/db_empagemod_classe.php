...
class cl_empagemod { 
   ...
   public $e84_codmod = 0; 
   public $e84_descr = null; 
   public $e84_layout = 0; 
   public $e84_sequencia = 0; 
   ...
   function incluir ($e84_codmod){ 
     ...
     if($e84_codmod == "" || $e84_codmod == null ){
       ...
       $this->e84_codmod = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from empagemod_e84_codmod_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $e84_codmod)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,998,6183,'','".AddSlashes(pg_fetch_result($resaco,0,'e84_codmod'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,998,6184,'','".AddSlashes(pg_fetch_result($resaco,0,'e84_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,998,6185,'','".AddSlashes(pg_fetch_result($resaco,0,'e84_layout'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,998,6251,'','".AddSlashes(pg_fetch_result($resaco,0,'e84_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e84_codmod=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e84_codmod)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e84_codmod"])){ 
       $sql  .= $virgula." e84_codmod = $this->e84_codmod ";
       $virgula = ",";
       if(trim((string) $this->e84_codmod) == null ){ 
     ...
     if(trim((string) $this->e84_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e84_descr"])){ 
       $sql  .= $virgula." e84_descr = '$this->e84_descr' ";
       $virgula = ",";
       if(trim((string) $this->e84_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "e84_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e84_layout)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e84_layout"])){ 
       $sql  .= $virgula." e84_layout = $this->e84_layout ";
       $virgula = ",";
       if(trim((string) $this->e84_layout) == null ){ 
         $this->erro_sql = " Campo Layout nao Informado.";
         $this->erro_campo = "e84_layout";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e84_sequencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e84_sequencia"])){ 
       $sql  .= $virgula." e84_sequencia = $this->e84_sequencia ";
       $virgula = ",";
       if(trim((string) $this->e84_sequencia) == null ){ 
         $this->erro_sql = " Campo Sequência nao Informado.";
         $this->erro_campo = "e84_sequencia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e84_codmod"]))
           $resac = db_query("insert into db_acount values($acount,998,6183,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e84_codmod'))."','$this->e84_codmod',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e84_descr"]))
           $resac = db_query("insert into db_acount values($acount,998,6184,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e84_descr'))."','$this->e84_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e84_layout"]))
           $resac = db_query("insert into db_acount values($acount,998,6185,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e84_layout'))."','$this->e84_layout',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e84_sequencia"]))
           $resac = db_query("insert into db_acount values($acount,998,6251,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e84_sequencia'))."','$this->e84_sequencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e84_codmod=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,998,6183,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e84_codmod'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,998,6184,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e84_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,998,6185,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e84_layout'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,998,6251,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e84_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
