...
class cl_serieregimemat { 
   ...
   public $ed223_i_serie = 0; 
   public $ed223_i_regimemat = 0; 
   public $ed223_i_regimematdiv = 0; 
   public $ed223_i_ordenacao = 0; 
   ...
   function incluir ($ed223_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2637,15002,'','".AddSlashes(pg_fetch_result($resaco,0,'ed223_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2637,15003,'','".AddSlashes(pg_fetch_result($resaco,0,'ed223_i_serie'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2637,15004,'','".AddSlashes(pg_fetch_result($resaco,0,'ed223_i_regimemat'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2637,15005,'','".AddSlashes(pg_fetch_result($resaco,0,'ed223_i_regimematdiv'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2637,15006,'','".AddSlashes(pg_fetch_result($resaco,0,'ed223_i_ordenacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed223_i_codigo=null) { 
     ...
     if(trim((string) $this->ed223_i_serie)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed223_i_serie"])){ 
       $sql  .= $virgula." ed223_i_serie = $this->ed223_i_serie ";
       $virgula = ",";
       if(trim((string) $this->ed223_i_serie) == null ){ 
         $this->erro_sql = " Campo Etapa nao Informado.";
         $this->erro_campo = "ed223_i_serie";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed223_i_regimemat)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed223_i_regimemat"])){ 
       $sql  .= $virgula." ed223_i_regimemat = $this->ed223_i_regimemat ";
       $virgula = ",";
       if(trim((string) $this->ed223_i_regimemat) == null ){ 
         $this->erro_sql = " Campo Regime de Matrícula nao Informado.";
         $this->erro_campo = "ed223_i_regimemat";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed223_i_regimematdiv)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed223_i_regimematdiv"])){ 
        if(trim((string) $this->ed223_i_regimematdiv)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed223_i_regimematdiv"])){ 
           $this->ed223_i_regimematdiv = "null" ;
        } 
     ...
     if(trim((string) $this->ed223_i_ordenacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed223_i_ordenacao"])){ 
       $sql  .= $virgula." ed223_i_ordenacao = $this->ed223_i_ordenacao ";
       $virgula = ",";
       if(trim((string) $this->ed223_i_ordenacao) == null ){ 
         $this->erro_sql = " Campo Ordenação nao Informado.";
         $this->erro_campo = "ed223_i_ordenacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed223_i_codigo"]) || $this->ed223_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2637,15002,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed223_i_codigo'))."','$this->ed223_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed223_i_serie"]) || $this->ed223_i_serie != "")
           $resac = db_query("insert into db_acount values($acount,2637,15003,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed223_i_serie'))."','$this->ed223_i_serie',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed223_i_regimemat"]) || $this->ed223_i_regimemat != "")
           $resac = db_query("insert into db_acount values($acount,2637,15004,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed223_i_regimemat'))."','$this->ed223_i_regimemat',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed223_i_regimematdiv"]) || $this->ed223_i_regimematdiv != "")
           $resac = db_query("insert into db_acount values($acount,2637,15005,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed223_i_regimematdiv'))."','$this->ed223_i_regimematdiv',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed223_i_ordenacao"]) || $this->ed223_i_ordenacao != "")
           $resac = db_query("insert into db_acount values($acount,2637,15006,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed223_i_ordenacao'))."','$this->ed223_i_ordenacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed223_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2637,15002,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed223_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2637,15003,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed223_i_serie'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2637,15004,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed223_i_regimemat'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2637,15005,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed223_i_regimematdiv'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2637,15006,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed223_i_ordenacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
