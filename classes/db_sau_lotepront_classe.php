...
class cl_sau_lotepront {
   ...
   public $sd59_i_codigo = 0;
   public $sd59_i_lote = 0;
   public $sd59_i_prontuario = 0;
   ...
   function incluir ($sd59_i_codigo){
     ...
     if($sd59_i_codigo == "" || $sd59_i_codigo == null ){
       ...
       $this->sd59_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from sau_lotepront_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $sd59_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2146,12306,'','".AddSlashes(pg_fetch_result($resaco,0,'sd59_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2146,12307,'','".AddSlashes(pg_fetch_result($resaco,0,'sd59_i_lote'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2146,12308,'','".AddSlashes(pg_fetch_result($resaco,0,'sd59_i_prontuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($sd59_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->sd59_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd59_i_codigo"])){
        if(trim((string) $this->sd59_i_codigo)=="" && isset($GLOBALS["HTTP_POST_VARS"]["sd59_i_codigo"])){
     ...
     if(trim((string) $this->sd59_i_lote)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd59_i_lote"])){
       $sql  .= $virgula." sd59_i_lote = $this->sd59_i_lote ";
       $virgula = ",";
       if(trim((string) $this->sd59_i_lote) == null ){
         $this->erro_sql = " Campo Lote nao Informado.";
         $this->erro_campo = "sd59_i_lote";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd59_i_prontuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd59_i_prontuario"])){
       $sql  .= $virgula." sd59_i_prontuario = $this->sd59_i_prontuario ";
       $virgula = ",";
       if(trim((string) $this->sd59_i_prontuario) == null ){
         $this->erro_sql = " Campo FAA nao Informado.";
         $this->erro_campo = "sd59_i_prontuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd59_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2146,12306,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd59_i_codigo'))."','$this->sd59_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd59_i_lote"]))
           $resac = db_query("insert into db_acount values($acount,2146,12307,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd59_i_lote'))."','$this->sd59_i_lote',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd59_i_prontuario"]))
           $resac = db_query("insert into db_acount values($acount,2146,12308,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd59_i_prontuario'))."','$this->sd59_i_prontuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($sd59_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2146,12306,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd59_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2146,12307,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd59_i_lote'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2146,12308,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd59_i_prontuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
