...
class cl_histbemdiv { 
   ...
   public $t32_codigo = 0; 
   public $t32_histbem = 0; 
   public $t32_divisao = 0; 
   ...
   function incluir ($t32_codigo){ 
     ...
     if($t32_codigo == "" || $t32_codigo == null ){
       ...
       $this->t32_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from histbemdiv_t32_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $t32_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1530,8941,'','".AddSlashes(pg_fetch_result($resaco,0,'t32_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1530,8942,'','".AddSlashes(pg_fetch_result($resaco,0,'t32_histbem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1530,8943,'','".AddSlashes(pg_fetch_result($resaco,0,'t32_divisao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($t32_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->t32_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t32_codigo"])){ 
       $sql  .= $virgula." t32_codigo = $this->t32_codigo ";
       $virgula = ",";
       if(trim((string) $this->t32_codigo) == null ){ 
     ...
     if(trim((string) $this->t32_histbem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t32_histbem"])){ 
       $sql  .= $virgula." t32_histbem = $this->t32_histbem ";
       $virgula = ",";
       if(trim((string) $this->t32_histbem) == null ){ 
         $this->erro_sql = " Campo Sequencial do lançamento de histórico nao Informado.";
         $this->erro_campo = "t32_histbem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->t32_divisao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t32_divisao"])){ 
       $sql  .= $virgula." t32_divisao = $this->t32_divisao ";
       $virgula = ",";
       if(trim((string) $this->t32_divisao) == null ){ 
         $this->erro_sql = " Campo Código da divisão nao Informado.";
         $this->erro_campo = "t32_divisao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["t32_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1530,8941,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t32_codigo'))."','$this->t32_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t32_histbem"]))
           $resac = db_query("insert into db_acount values($acount,1530,8942,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t32_histbem'))."','$this->t32_histbem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t32_divisao"]))
           $resac = db_query("insert into db_acount values($acount,1530,8943,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t32_divisao'))."','$this->t32_divisao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($t32_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1530,8941,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t32_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1530,8942,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t32_histbem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1530,8943,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t32_divisao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
