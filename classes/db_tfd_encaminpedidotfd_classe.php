...
class cl_tfd_encaminpedidotfd { 
   ...
   public $tf30_i_codigo = 0; 
   public $tf30_i_encaminhamento = 0; 
   public $tf30_i_pedidotfd = 0; 
   ...
   function incluir ($tf30_i_codigo){ 
     ...
     if($tf30_i_codigo == "" || $tf30_i_codigo == null ){
       ...
       $this->tf30_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tfd_encaminpedidotfd_tf30_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $tf30_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2886,16462,'','".AddSlashes(pg_fetch_result($resaco,0,'tf30_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2886,16464,'','".AddSlashes(pg_fetch_result($resaco,0,'tf30_i_encaminhamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2886,16463,'','".AddSlashes(pg_fetch_result($resaco,0,'tf30_i_pedidotfd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($tf30_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->tf30_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf30_i_codigo"])){ 
       $sql  .= $virgula." tf30_i_codigo = $this->tf30_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->tf30_i_codigo) == null ){ 
     ...
     if(trim((string) $this->tf30_i_encaminhamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf30_i_encaminhamento"])){ 
       $sql  .= $virgula." tf30_i_encaminhamento = $this->tf30_i_encaminhamento ";
       $virgula = ",";
       if(trim((string) $this->tf30_i_encaminhamento) == null ){ 
         $this->erro_sql = " Campo Encaminhamento nao Informado.";
         $this->erro_campo = "tf30_i_encaminhamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tf30_i_pedidotfd)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf30_i_pedidotfd"])){ 
       $sql  .= $virgula." tf30_i_pedidotfd = $this->tf30_i_pedidotfd ";
       $virgula = ",";
       if(trim((string) $this->tf30_i_pedidotfd) == null ){ 
         $this->erro_sql = " Campo Pedido nao Informado.";
         $this->erro_campo = "tf30_i_pedidotfd";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf30_i_codigo"]) || $this->tf30_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2886,16462,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf30_i_codigo'))."','$this->tf30_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf30_i_encaminhamento"]) || $this->tf30_i_encaminhamento != "")
           $resac = db_query("insert into db_acount values($acount,2886,16464,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf30_i_encaminhamento'))."','$this->tf30_i_encaminhamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf30_i_pedidotfd"]) || $this->tf30_i_pedidotfd != "")
           $resac = db_query("insert into db_acount values($acount,2886,16463,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf30_i_pedidotfd'))."','$this->tf30_i_pedidotfd',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($tf30_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2886,16462,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf30_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2886,16464,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf30_i_encaminhamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2886,16463,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf30_i_pedidotfd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
