...
class cl_aguacondominiomat { 
   ...
   function incluir ($x40_codcondominio,$x40_matric){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1434,8439,'','".AddSlashes(pg_fetch_result($resaco,0,'x40_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1434,8442,'','".AddSlashes(pg_fetch_result($resaco,0,'x40_codcondominio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($x40_codcondominio=null,$x40_matric=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->x40_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x40_matric"])){ 
       $sql  .= $virgula." x40_matric = $this->x40_matric ";
       $virgula = ",";
       if(trim((string) $this->x40_matric) == null ){ 
     ...
     if(trim((string) $this->x40_codcondominio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x40_codcondominio"])){ 
       $sql  .= $virgula." x40_codcondominio = $this->x40_codcondominio ";
       $virgula = ",";
       if(trim((string) $this->x40_codcondominio) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x40_matric"]))
           $resac = db_query("insert into db_acount values($acount,1434,8439,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x40_matric'))."','$this->x40_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x40_codcondominio"]))
           $resac = db_query("insert into db_acount values($acount,1434,8442,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x40_codcondominio'))."','$this->x40_codcondominio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($x40_codcondominio=null,$x40_matric=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1434,8439,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x40_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1434,8442,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x40_codcondominio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
