...
class cl_db_versaocpd { 
   ...
   public $db33_codcpd = 0; 
   public $db33_codver = 0; 
   public $db33_obs = null; 
   public $db33_obscpd = null; 
   public $db33_data_dia = null; 
   public $db33_data_mes = null; 
   public $db33_data_ano = null; 
   public $db33_data = null; 
   ...
   function incluir ($db33_codcpd){ 
     ...
     if($db33_codcpd == "" || $db33_codcpd == null ){
       ...
       $this->db33_codcpd = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_versaocpd_db33_codcpd_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db33_codcpd)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,941,5880,'','".AddSlashes(pg_fetch_result($resaco,0,'db33_codcpd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,941,5879,'','".AddSlashes(pg_fetch_result($resaco,0,'db33_codver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,941,5881,'','".AddSlashes(pg_fetch_result($resaco,0,'db33_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,941,5882,'','".AddSlashes(pg_fetch_result($resaco,0,'db33_obscpd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,941,5883,'','".AddSlashes(pg_fetch_result($resaco,0,'db33_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db33_codcpd=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db33_codcpd)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db33_codcpd"])){ 
       $sql  .= $virgula." db33_codcpd = $this->db33_codcpd ";
       $virgula = ",";
       if(trim((string) $this->db33_codcpd) == null ){ 
     ...
     if(trim((string) $this->db33_codver)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db33_codver"])){ 
       $sql  .= $virgula." db33_codver = $this->db33_codver ";
       $virgula = ",";
       if(trim((string) $this->db33_codver) == null ){ 
         $this->erro_sql = " Campo Código da Versão nao Informado.";
         $this->erro_campo = "db33_codver";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db33_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db33_obs"])){ 
       $sql  .= $virgula." db33_obs = '$this->db33_obs' ";
       $virgula = ",";
       if(trim((string) $this->db33_obs) == null ){ 
         $this->erro_sql = " Campo Observações da Release nao Informado.";
         $this->erro_campo = "db33_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db33_obscpd)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db33_obscpd"])){ 
       $sql  .= $virgula." db33_obscpd = '$this->db33_obscpd' ";
       $virgula = ",";
       if(trim((string) $this->db33_obscpd) == null ){ 
         $this->erro_sql = " Campo Observações para o CPD nao Informado.";
         $this->erro_campo = "db33_obscpd";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db33_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db33_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["db33_data_dia"] !="") ){ 
       $sql  .= $virgula." db33_data = '$this->db33_data' ";
       $virgula = ",";
       if(trim((string) $this->db33_data) == null ){ 
         $this->erro_sql = " Campo Data da Inclusão nao Informado.";
         $this->erro_campo = "db33_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db33_codcpd"]))
           $resac = db_query("insert into db_acount values($acount,941,5880,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db33_codcpd'))."','$this->db33_codcpd',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db33_codver"]))
           $resac = db_query("insert into db_acount values($acount,941,5879,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db33_codver'))."','$this->db33_codver',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db33_obs"]))
           $resac = db_query("insert into db_acount values($acount,941,5881,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db33_obs'))."','$this->db33_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db33_obscpd"]))
           $resac = db_query("insert into db_acount values($acount,941,5882,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db33_obscpd'))."','$this->db33_obscpd',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db33_data"]))
           $resac = db_query("insert into db_acount values($acount,941,5883,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db33_data'))."','$this->db33_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db33_codcpd=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,941,5880,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db33_codcpd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,941,5879,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db33_codver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,941,5881,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db33_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,941,5882,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db33_obscpd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,941,5883,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db33_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
