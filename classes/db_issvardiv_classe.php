...
class cl_issvardiv { 
   ...
   function incluir ($q19_coddiv,$q19_issvar){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1075,6539,'','".AddSlashes(pg_fetch_result($resaco,0,'q19_coddiv'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1075,6540,'','".AddSlashes(pg_fetch_result($resaco,0,'q19_issvar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q19_coddiv=null,$q19_issvar=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q19_coddiv)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q19_coddiv"])){ 
       $sql  .= $virgula." q19_coddiv = $this->q19_coddiv ";
       $virgula = ",";
       if(trim((string) $this->q19_coddiv) == null ){ 
     ...
     if(trim((string) $this->q19_issvar)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q19_issvar"])){ 
       $sql  .= $virgula." q19_issvar = $this->q19_issvar ";
       $virgula = ",";
       if(trim((string) $this->q19_issvar) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q19_coddiv"]))
           $resac = db_query("insert into db_acount values($acount,1075,6539,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q19_coddiv'))."','$this->q19_coddiv',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q19_issvar"]))
           $resac = db_query("insert into db_acount values($acount,1075,6540,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q19_issvar'))."','$this->q19_issvar',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q19_coddiv=null,$q19_issvar=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1075,6539,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q19_coddiv'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1075,6540,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q19_issvar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
