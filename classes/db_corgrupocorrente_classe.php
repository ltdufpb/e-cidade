...
class cl_corgrupocorrente {
   ...
   public $k105_sequencial = 0;
   public $k105_corgrupo = 0;
   public $k105_data_dia = null;
   public $k105_data_mes = null;
   public $k105_data_ano = null;
   public $k105_data = null;
   public $k105_autent = 0;
   public $k105_id = 0;
   ...
   function incluir ($k105_sequencial){
     ...
     if($k105_sequencial == "" || $k105_sequencial == null ){
       ...
       $this->k105_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from corgrupocorrente_k105_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k105_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2171,12447,'','".AddSlashes(pg_fetch_result($resaco,0,'k105_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2171,12448,'','".AddSlashes(pg_fetch_result($resaco,0,'k105_corgrupo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2171,12449,'','".AddSlashes(pg_fetch_result($resaco,0,'k105_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2171,12450,'','".AddSlashes(pg_fetch_result($resaco,0,'k105_autent'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2171,12451,'','".AddSlashes(pg_fetch_result($resaco,0,'k105_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($k105_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->k105_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k105_sequencial"])){
       $sql  .= $virgula." k105_sequencial = $this->k105_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k105_sequencial) == null ){
     ...
     if(trim((string) $this->k105_corgrupo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k105_corgrupo"])){
       $sql  .= $virgula." k105_corgrupo = $this->k105_corgrupo ";
       $virgula = ",";
       if(trim((string) $this->k105_corgrupo) == null ){
         $this->erro_sql = " Campo Código do Grupo nao Informado.";
         $this->erro_campo = "k105_corgrupo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k105_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k105_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["k105_data_dia"] !="") ){
       $sql  .= $virgula." k105_data = '$this->k105_data' ";
       $virgula = ",";
       if(trim((string) $this->k105_data) == null ){
         $this->erro_sql = " Campo data da Autenticação nao Informado.";
         $this->erro_campo = "k105_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k105_autent)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k105_autent"])){
       $sql  .= $virgula." k105_autent = $this->k105_autent ";
       $virgula = ",";
       if(trim((string) $this->k105_autent) == null ){
         $this->erro_sql = " Campo Sequencia da Autenticação nao Informado.";
         $this->erro_campo = "k105_autent";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k105_id)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k105_id"])){
       $sql  .= $virgula." k105_id = $this->k105_id ";
       $virgula = ",";
       if(trim((string) $this->k105_id) == null ){
         $this->erro_sql = " Campo Código do caixa nao Informado.";
         $this->erro_campo = "k105_id";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k105_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2171,12447,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k105_sequencial'))."','$this->k105_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k105_corgrupo"]))
           $resac = db_query("insert into db_acount values($acount,2171,12448,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k105_corgrupo'))."','$this->k105_corgrupo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k105_data"]))
           $resac = db_query("insert into db_acount values($acount,2171,12449,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k105_data'))."','$this->k105_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k105_autent"]))
           $resac = db_query("insert into db_acount values($acount,2171,12450,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k105_autent'))."','$this->k105_autent',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k105_id"]))
           $resac = db_query("insert into db_acount values($acount,2171,12451,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k105_id'))."','$this->k105_id',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($k105_sequencial=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2171,12447,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k105_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2171,12448,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k105_corgrupo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2171,12449,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k105_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2171,12450,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k105_autent'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2171,12451,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k105_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
