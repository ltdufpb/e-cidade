...
class cl_tabrecarretipo { 
   ...
   public $k79_sequencial = 0; 
   public $k79_arretipo = 0; 
   public $k79_receit = 0; 
   ...
   function incluir ($k79_sequencial){ 
     ...
     if($k79_sequencial == "" || $k79_sequencial == null ){
       ...
       $this->k79_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tabrecarretipo_k79_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k79_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2068,11957,'','".AddSlashes(pg_fetch_result($resaco,0,'k79_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2068,11958,'','".AddSlashes(pg_fetch_result($resaco,0,'k79_arretipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2068,11959,'','".AddSlashes(pg_fetch_result($resaco,0,'k79_receit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k79_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k79_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k79_sequencial"])){ 
       $sql  .= $virgula." k79_sequencial = $this->k79_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k79_sequencial) == null ){ 
     ...
     if(trim((string) $this->k79_arretipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k79_arretipo"])){ 
       $sql  .= $virgula." k79_arretipo = $this->k79_arretipo ";
       $virgula = ",";
       if(trim((string) $this->k79_arretipo) == null ){ 
         $this->erro_sql = " Campo Código Tipo nao Informado.";
         $this->erro_campo = "k79_arretipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k79_receit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k79_receit"])){ 
       $sql  .= $virgula." k79_receit = $this->k79_receit ";
       $virgula = ",";
       if(trim((string) $this->k79_receit) == null ){ 
         $this->erro_sql = " Campo Receita nao Informado.";
         $this->erro_campo = "k79_receit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k79_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2068,11957,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k79_sequencial'))."','$this->k79_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k79_arretipo"]))
           $resac = db_query("insert into db_acount values($acount,2068,11958,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k79_arretipo'))."','$this->k79_arretipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k79_receit"]))
           $resac = db_query("insert into db_acount values($acount,2068,11959,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k79_receit'))."','$this->k79_receit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k79_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2068,11957,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k79_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2068,11958,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k79_arretipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2068,11959,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k79_receit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
