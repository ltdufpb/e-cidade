...
class cl_iptubaixa { 
   ...
   public $j02_matric = 0; 
   public $j02_dtbaixa_dia = null; 
   public $j02_dtbaixa_mes = null; 
   public $j02_dtbaixa_ano = null; 
   public $j02_dtbaixa = null; 
   public $j02_motivo = null; 
   public $j02_usuario = 0; 
   public $j02_data_dia = null; 
   public $j02_data_mes = null; 
   public $j02_data_ano = null; 
   public $j02_data = null; 
   public $j02_hora = null; 
   ...
   function incluir ($j02_matric){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1693,9868,'','".AddSlashes(pg_fetch_result($resaco,0,'j02_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1693,9870,'','".AddSlashes(pg_fetch_result($resaco,0,'j02_dtbaixa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1693,9869,'','".AddSlashes(pg_fetch_result($resaco,0,'j02_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1693,9871,'','".AddSlashes(pg_fetch_result($resaco,0,'j02_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1693,9872,'','".AddSlashes(pg_fetch_result($resaco,0,'j02_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1693,9873,'','".AddSlashes(pg_fetch_result($resaco,0,'j02_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j02_matric=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j02_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j02_matric"])){ 
       $sql  .= $virgula." j02_matric = $this->j02_matric ";
       $virgula = ",";
       if(trim((string) $this->j02_matric) == null ){ 
     ...
     if(trim((string) $this->j02_dtbaixa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j02_dtbaixa_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["j02_dtbaixa_dia"] !="") ){ 
       $sql  .= $virgula." j02_dtbaixa = '$this->j02_dtbaixa' ";
       $virgula = ",";
       if(trim((string) $this->j02_dtbaixa) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "j02_dtbaixa_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j02_motivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j02_motivo"])){ 
       $sql  .= $virgula." j02_motivo = '$this->j02_motivo' ";
       $virgula = ",";
       if(trim((string) $this->j02_motivo) == null ){ 
         $this->erro_sql = " Campo Motivo da baixa nao Informado.";
         $this->erro_campo = "j02_motivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j02_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j02_usuario"])){ 
       $sql  .= $virgula." j02_usuario = $this->j02_usuario ";
       $virgula = ",";
       if(trim((string) $this->j02_usuario) == null ){ 
         $this->erro_sql = " Campo Cod. Usuário nao Informado.";
         $this->erro_campo = "j02_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j02_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j02_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["j02_data_dia"] !="") ){ 
       $sql  .= $virgula." j02_data = '$this->j02_data' ";
       $virgula = ",";
       if(trim((string) $this->j02_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "j02_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j02_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j02_hora"])){ 
       $sql  .= $virgula." j02_hora = '$this->j02_hora' ";
       $virgula = ",";
       if(trim((string) $this->j02_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "j02_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j02_matric"]))
           $resac = db_query("insert into db_acount values($acount,1693,9868,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j02_matric'))."','$this->j02_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j02_dtbaixa"]))
           $resac = db_query("insert into db_acount values($acount,1693,9870,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j02_dtbaixa'))."','$this->j02_dtbaixa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j02_motivo"]))
           $resac = db_query("insert into db_acount values($acount,1693,9869,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j02_motivo'))."','$this->j02_motivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j02_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1693,9871,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j02_usuario'))."','$this->j02_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j02_data"]))
           $resac = db_query("insert into db_acount values($acount,1693,9872,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j02_data'))."','$this->j02_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j02_hora"]))
           $resac = db_query("insert into db_acount values($acount,1693,9873,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j02_hora'))."','$this->j02_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j02_matric=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1693,9868,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j02_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1693,9870,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j02_dtbaixa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1693,9869,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j02_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1693,9871,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j02_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1693,9872,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j02_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1693,9873,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j02_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
