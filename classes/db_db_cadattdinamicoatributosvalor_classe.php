...
class cl_db_cadattdinamicoatributosvalor {
   ...
   public $db110_sequencial = 0;
   public $db110_db_cadattdinamicoatributos = 0;
   public $db110_cadattdinamicovalorgrupo = 0;
   public $db110_valor = null;
   ...
   function incluir ($db110_sequencial){
     ...
     if($db110_sequencial == "" || $db110_sequencial == null ){
       ...
       $this->db110_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from db_cadattdinamicoatributosvalor_db110_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db110_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3161,17880,'','".AddSlashes(pg_fetch_result($resaco,0,'db110_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3161,17881,'','".AddSlashes(pg_fetch_result($resaco,0,'db110_db_cadattdinamicoatributos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3161,17905,'','".AddSlashes(pg_fetch_result($resaco,0,'db110_cadattdinamicovalorgrupo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3161,17882,'','".AddSlashes(pg_fetch_result($resaco,0,'db110_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   public function alterar ($db110_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->db110_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db110_sequencial"])){
       $sql  .= $virgula." db110_sequencial = $this->db110_sequencial ";
       $virgula = ",";
       if(trim((string) $this->db110_sequencial) == null ){
     ...
     if(trim((string) $this->db110_db_cadattdinamicoatributos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db110_db_cadattdinamicoatributos"])){
       $sql  .= $virgula." db110_db_cadattdinamicoatributos = $this->db110_db_cadattdinamicoatributos ";
       $virgula = ",";
       if(trim((string) $this->db110_db_cadattdinamicoatributos) == null ){
         $this->erro_sql = " Campo Código Atributo Dinâmico não informado.";
         $this->erro_campo = "db110_db_cadattdinamicoatributos";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db110_cadattdinamicovalorgrupo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db110_cadattdinamicovalorgrupo"])){
       $sql  .= $virgula." db110_cadattdinamicovalorgrupo = $this->db110_cadattdinamicovalorgrupo ";
       $virgula = ",";
       if(trim((string) $this->db110_cadattdinamicovalorgrupo) == null ){
         $this->erro_sql = " Campo Grupo de Valores de um Atributo não informado.";
         $this->erro_campo = "db110_cadattdinamicovalorgrupo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db110_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db110_valor"])){
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["db110_sequencial"]) || $this->db110_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3161,17880,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db110_sequencial'))."','$this->db110_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["db110_db_cadattdinamicoatributos"]) || $this->db110_db_cadattdinamicoatributos != "")
             $resac = db_query("insert into db_acount values($acount,3161,17881,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db110_db_cadattdinamicoatributos'))."','$this->db110_db_cadattdinamicoatributos',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["db110_cadattdinamicovalorgrupo"]) || $this->db110_cadattdinamicovalorgrupo != "")
             $resac = db_query("insert into db_acount values($acount,3161,17905,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db110_cadattdinamicovalorgrupo'))."','$this->db110_cadattdinamicovalorgrupo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["db110_valor"]) || $this->db110_valor != "")
             $resac = db_query("insert into db_acount values($acount,3161,17882,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db110_valor'))."','$this->db110_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3161,17880,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db110_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3161,17881,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db110_db_cadattdinamicoatributos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3161,17905,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db110_cadattdinamicovalorgrupo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3161,17882,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db110_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
