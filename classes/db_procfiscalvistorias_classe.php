...
class cl_procfiscalvistorias { 
   ...
   function incluir ($y109_sequencial){ 
     ...
     if($y109_sequencial == "" || $y109_sequencial == null ){
       ...
       $this->y109_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from procfiscalvistorias_y109_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $y109_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2082,12029,'','".AddSlashes(pg_fetch_result($resaco,0,'y109_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2082,12031,'','".AddSlashes(pg_fetch_result($resaco,0,'y109_procfiscal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2082,12030,'','".AddSlashes(pg_fetch_result($resaco,0,'y109_codvist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y109_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y109_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y109_sequencial"])){ 
       $sql  .= $virgula." y109_sequencial = $this->y109_sequencial ";
       $virgula = ",";
       if(trim((string) $this->y109_sequencial) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
     ...
     if(trim((string) $this->y109_procfiscal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y109_procfiscal"])){ 
       $sql  .= $virgula." y109_procfiscal = $this->y109_procfiscal ";
       $virgula = ",";
       if(trim((string) $this->y109_procfiscal) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
         $this->erro_campo = "y109_procfiscal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y109_codvist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y109_codvist"])){ 
       $sql  .= $virgula." y109_codvist = $this->y109_codvist ";
       $virgula = ",";
       if(trim((string) $this->y109_codvist) == null ){ 
         $this->erro_sql = " Campo Código da vistoria nao Informado.";
         $this->erro_campo = "y109_codvist";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y109_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2082,12029,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y109_sequencial'))."','$this->y109_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y109_procfiscal"]))
           $resac = db_query("insert into db_acount values($acount,2082,12031,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y109_procfiscal'))."','$this->y109_procfiscal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y109_codvist"]))
           $resac = db_query("insert into db_acount values($acount,2082,12030,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y109_codvist'))."','$this->y109_codvist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y109_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2082,12029,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y109_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2082,12031,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y109_procfiscal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2082,12030,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y109_codvist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
