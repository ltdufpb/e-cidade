...
class cl_diverimportareg { 
   ...
   public $dv12_sequencial = 0; 
   public $dv12_diversos = 0; 
   public $dv12_diverimporta = 0; 
   ...
   function incluir ($dv12_sequencial){ 
     ...
     if($dv12_sequencial == "" || $dv12_sequencial == null ){
       ...
       $this->dv12_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from diverimportareg_dv12_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $dv12_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3294,18610,'','".AddSlashes(pg_fetch_result($resaco,0,'dv12_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3294,18612,'','".AddSlashes(pg_fetch_result($resaco,0,'dv12_diversos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3294,18611,'','".AddSlashes(pg_fetch_result($resaco,0,'dv12_diverimporta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($dv12_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->dv12_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv12_sequencial"])){ 
       $sql  .= $virgula." dv12_sequencial = $this->dv12_sequencial ";
       $virgula = ",";
       if(trim((string) $this->dv12_sequencial) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
     ...
     if(trim((string) $this->dv12_diversos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv12_diversos"])){ 
       $sql  .= $virgula." dv12_diversos = $this->dv12_diversos ";
       $virgula = ",";
       if(trim((string) $this->dv12_diversos) == null ){ 
         $this->erro_sql = " Campo Código do diversos nao Informado.";
         $this->erro_campo = "dv12_diversos";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->dv12_diverimporta)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv12_diverimporta"])){ 
       $sql  .= $virgula." dv12_diverimporta = $this->dv12_diverimporta ";
       $virgula = ",";
       if(trim((string) $this->dv12_diverimporta) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
         $this->erro_campo = "dv12_diverimporta";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv12_sequencial"]) || $this->dv12_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3294,18610,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv12_sequencial'))."','$this->dv12_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv12_diversos"]) || $this->dv12_diversos != "")
           $resac = db_query("insert into db_acount values($acount,3294,18612,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv12_diversos'))."','$this->dv12_diversos',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv12_diverimporta"]) || $this->dv12_diverimporta != "")
           $resac = db_query("insert into db_acount values($acount,3294,18611,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv12_diverimporta'))."','$this->dv12_diverimporta',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($dv12_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3294,18610,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv12_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3294,18612,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv12_diversos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3294,18611,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv12_diverimporta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
