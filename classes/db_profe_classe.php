...
class cl_profe { 
   ...
   public $h18_regist = 0; 
   public $h18_local = null; 
   public $h18_dtini_dia = null; 
   public $h18_dtini_mes = null; 
   public $h18_dtini_ano = null; 
   public $h18_dtini = null; 
   public $h18_dtfim_dia = null; 
   public $h18_dtfim_mes = null; 
   public $h18_dtfim_ano = null; 
   public $h18_dtfim = null; 
   public $h18_descat = null; 
   ...
   function alterar ( $oid=null ) { 
     ...
     $virgula = "";
     if(trim((string) $this->h18_regist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h18_regist"])){ 
       $sql  .= $virgula." h18_regist = $this->h18_regist ";
       $virgula = ",";
       if(trim((string) $this->h18_regist) == null ){ 
         $this->erro_sql = " Campo Codigo do Funcionario nao Informado.";
         $this->erro_campo = "h18_regist";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h18_local)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h18_local"])){ 
       $sql  .= $virgula." h18_local = '$this->h18_local' ";
       $virgula = ",";
       if(trim((string) $this->h18_local) == null ){ 
         $this->erro_sql = " Campo Local de Trabalho nao Informado.";
         $this->erro_campo = "h18_local";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h18_dtini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h18_dtini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["h18_dtini_dia"] !="") ){ 
       $sql  .= $virgula." h18_dtini = '$this->h18_dtini' ";
       $virgula = ",";
       if(trim((string) $this->h18_dtini) == null ){ 
         $this->erro_sql = " Campo Data inicio nao Informado.";
         $this->erro_campo = "h18_dtini_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h18_dtfim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h18_dtfim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["h18_dtfim_dia"] !="") ){ 
       $sql  .= $virgula." h18_dtfim = '$this->h18_dtfim' ";
       $virgula = ",";
       if(trim((string) $this->h18_dtfim) == null ){ 
         $this->erro_sql = " Campo Data fim nao Informado.";
         $this->erro_campo = "h18_dtfim_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h18_descat)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h18_descat"])){ 
       $sql  .= $virgula." h18_descat = '$this->h18_descat' ";
       $virgula = ",";
       if(trim((string) $this->h18_descat) == null ){ 
         $this->erro_sql = " Campo Descrição da Atividade nao Informado.";
         $this->erro_campo = "h18_descat";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
