...
class cl_bensmodeloetiquetapadrao { 
   ...
   public $t72_sequencial = 0; 
   public $t72_descr = null; 
   public $t72_strxml = null; 
   ...
   function incluir ($t72_sequencial){ 
     ...
     if($t72_sequencial == "" || $t72_sequencial == null ){
       ...
       $this->t72_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from bensmodeloetiquetapadrao_t72_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $t72_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2730,15562,'','".AddSlashes(pg_fetch_result($resaco,0,'t72_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2730,15563,'','".AddSlashes(pg_fetch_result($resaco,0,'t72_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2730,15564,'','".AddSlashes(pg_fetch_result($resaco,0,'t72_strxml'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($t72_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->t72_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t72_sequencial"])){ 
       $sql  .= $virgula." t72_sequencial = $this->t72_sequencial ";
       $virgula = ",";
       if(trim((string) $this->t72_sequencial) == null ){ 
     ...
     if(trim((string) $this->t72_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t72_descr"])){ 
       $sql  .= $virgula." t72_descr = '$this->t72_descr' ";
       $virgula = ",";
       if(trim((string) $this->t72_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "t72_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->t72_strxml)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t72_strxml"])){ 
       $sql  .= $virgula." t72_strxml = '$this->t72_strxml' ";
       $virgula = ",";
       if(trim((string) $this->t72_strxml) == null ){ 
         $this->erro_sql = " Campo XML nao Informado.";
         $this->erro_campo = "t72_strxml";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["t72_sequencial"]) || $this->t72_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2730,15562,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t72_sequencial'))."','$this->t72_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t72_descr"]) || $this->t72_descr != "")
           $resac = db_query("insert into db_acount values($acount,2730,15563,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t72_descr'))."','$this->t72_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t72_strxml"]) || $this->t72_strxml != "")
           $resac = db_query("insert into db_acount values($acount,2730,15564,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t72_strxml'))."','$this->t72_strxml',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($t72_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2730,15562,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t72_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2730,15563,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t72_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2730,15564,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t72_strxml'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
