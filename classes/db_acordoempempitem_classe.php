...
class cl_acordoempempitem { 
   ...
   public $ac44_sequencial = 0; 
   public $ac44_empempitem = 0; 
   public $ac44_acordoitem = 0; 
   ...
   function incluir ($ac44_sequencial){ 
     ...
     if($ac44_sequencial == "" || $ac44_sequencial == null ){
       ...
       $this->ac44_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordoempempitem_ac44_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac44_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3534,19713,'','".AddSlashes(pg_fetch_result($resaco,0,'ac44_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3534,19715,'','".AddSlashes(pg_fetch_result($resaco,0,'ac44_empempitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3534,19714,'','".AddSlashes(pg_fetch_result($resaco,0,'ac44_acordoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac44_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac44_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac44_sequencial"])){ 
       $sql  .= $virgula." ac44_sequencial = $this->ac44_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac44_sequencial) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
     ...
     if(trim((string) $this->ac44_empempitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac44_empempitem"])){ 
       $sql  .= $virgula." ac44_empempitem = $this->ac44_empempitem ";
       $virgula = ",";
       if(trim((string) $this->ac44_empempitem) == null ){ 
         $this->erro_sql = " Campo Código Sequencial nao Informado.";
         $this->erro_campo = "ac44_empempitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac44_acordoitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac44_acordoitem"])){ 
       $sql  .= $virgula." ac44_acordoitem = $this->ac44_acordoitem ";
       $virgula = ",";
       if(trim((string) $this->ac44_acordoitem) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
         $this->erro_campo = "ac44_acordoitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac44_sequencial"]) || $this->ac44_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3534,19713,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac44_sequencial'))."','$this->ac44_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac44_empempitem"]) || $this->ac44_empempitem != "")
           $resac = db_query("insert into db_acount values($acount,3534,19715,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac44_empempitem'))."','$this->ac44_empempitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac44_acordoitem"]) || $this->ac44_acordoitem != "")
           $resac = db_query("insert into db_acount values($acount,3534,19714,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac44_acordoitem'))."','$this->ac44_acordoitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac44_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3534,19713,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac44_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3534,19715,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac44_empempitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3534,19714,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac44_acordoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
