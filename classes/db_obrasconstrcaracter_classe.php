...
class cl_obrasconstrcaracter { 
   ...
   public $ob34_sequencial = 0; 
   public $ob34_obrasconstr = 0; 
   public $ob34_caracter = 0; 
   ...
   function incluir ($ob34_sequencial){ 
     ...
     if($ob34_sequencial == "" || $ob34_sequencial == null ){
       ...
       $this->ob34_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from obrasconstrcaracter_ob34_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ob34_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3303,18657,'','".AddSlashes(pg_fetch_result($resaco,0,'ob34_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3303,18658,'','".AddSlashes(pg_fetch_result($resaco,0,'ob34_obrasconstr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3303,18659,'','".AddSlashes(pg_fetch_result($resaco,0,'ob34_caracter'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ob34_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ob34_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ob34_sequencial"])){ 
       $sql  .= $virgula." ob34_sequencial = $this->ob34_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ob34_sequencial) == null ){ 
     ...
     if(trim((string) $this->ob34_obrasconstr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ob34_obrasconstr"])){ 
       $sql  .= $virgula." ob34_obrasconstr = $this->ob34_obrasconstr ";
       $virgula = ",";
       if(trim((string) $this->ob34_obrasconstr) == null ){ 
         $this->erro_sql = " Campo Código da construção nao Informado.";
         $this->erro_campo = "ob34_obrasconstr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ob34_caracter)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ob34_caracter"])){ 
       $sql  .= $virgula." ob34_caracter = $this->ob34_caracter ";
       $virgula = ",";
       if(trim((string) $this->ob34_caracter) == null ){ 
         $this->erro_sql = " Campo Caracteristica nao Informado.";
         $this->erro_campo = "ob34_caracter";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ob34_sequencial"]) || $this->ob34_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3303,18657,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ob34_sequencial'))."','$this->ob34_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ob34_obrasconstr"]) || $this->ob34_obrasconstr != "")
           $resac = db_query("insert into db_acount values($acount,3303,18658,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ob34_obrasconstr'))."','$this->ob34_obrasconstr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ob34_caracter"]) || $this->ob34_caracter != "")
           $resac = db_query("insert into db_acount values($acount,3303,18659,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ob34_caracter'))."','$this->ob34_caracter',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ob34_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3303,18657,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ob34_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3303,18658,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ob34_obrasconstr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3303,18659,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ob34_caracter'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
