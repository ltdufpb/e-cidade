...
class cl_meicgm { 
   ...
   public $q115_sequencial = 0; 
   public $q115_meisitucao = 0; 
   public $q115_numcgm = 0; 
   ...
   function incluir ($q115_sequencial){ 
     ...
     if($q115_sequencial == "" || $q115_sequencial == null ){
       ...
       $this->q115_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from meicgm_q115_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q115_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2927,16646,'','".AddSlashes(pg_fetch_result($resaco,0,'q115_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2927,16647,'','".AddSlashes(pg_fetch_result($resaco,0,'q115_meisitucao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2927,16648,'','".AddSlashes(pg_fetch_result($resaco,0,'q115_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q115_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q115_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q115_sequencial"])){ 
       $sql  .= $virgula." q115_sequencial = $this->q115_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q115_sequencial) == null ){ 
     ...
     if(trim((string) $this->q115_meisitucao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q115_meisitucao"])){ 
       $sql  .= $virgula." q115_meisitucao = $this->q115_meisitucao ";
       $virgula = ",";
       if(trim((string) $this->q115_meisitucao) == null ){ 
         $this->erro_sql = " Campo Situação nao Informado.";
         $this->erro_campo = "q115_meisitucao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q115_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q115_numcgm"])){ 
       $sql  .= $virgula." q115_numcgm = $this->q115_numcgm ";
       $virgula = ",";
       if(trim((string) $this->q115_numcgm) == null ){ 
         $this->erro_sql = " Campo CGM nao Informado.";
         $this->erro_campo = "q115_numcgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q115_sequencial"]) || $this->q115_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2927,16646,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q115_sequencial'))."','$this->q115_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q115_meisitucao"]) || $this->q115_meisitucao != "")
           $resac = db_query("insert into db_acount values($acount,2927,16647,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q115_meisitucao'))."','$this->q115_meisitucao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q115_numcgm"]) || $this->q115_numcgm != "")
           $resac = db_query("insert into db_acount values($acount,2927,16648,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q115_numcgm'))."','$this->q115_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q115_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2927,16646,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q115_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2927,16647,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q115_meisitucao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2927,16648,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q115_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
