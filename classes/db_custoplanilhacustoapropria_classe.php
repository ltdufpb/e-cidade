...
class cl_custoplanilhacustoapropria { 
   ...
   public $cc18_sequencial = 0; 
   public $cc18_custoapropria = 0; 
   public $cc18_custoplanilhaapuracao = 0; 
   ...
   function incluir ($cc18_sequencial){ 
     ...
     if($cc18_sequencial == "" || $cc18_sequencial == null ){
       ...
       $this->cc18_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from custoplanilhacustoapropria_cc18_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $cc18_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2663,15132,'','".AddSlashes(pg_fetch_result($resaco,0,'cc18_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2663,15133,'','".AddSlashes(pg_fetch_result($resaco,0,'cc18_custoapropria'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2663,15134,'','".AddSlashes(pg_fetch_result($resaco,0,'cc18_custoplanilhaapuracao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($cc18_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->cc18_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc18_sequencial"])){ 
       $sql  .= $virgula." cc18_sequencial = $this->cc18_sequencial ";
       $virgula = ",";
       if(trim((string) $this->cc18_sequencial) == null ){ 
     ...
     if(trim((string) $this->cc18_custoapropria)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc18_custoapropria"])){ 
       $sql  .= $virgula." cc18_custoapropria = $this->cc18_custoapropria ";
       $virgula = ",";
       if(trim((string) $this->cc18_custoapropria) == null ){ 
         $this->erro_sql = " Campo Custo a Propria nao Informado.";
         $this->erro_campo = "cc18_custoapropria";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cc18_custoplanilhaapuracao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc18_custoplanilhaapuracao"])){ 
       $sql  .= $virgula." cc18_custoplanilhaapuracao = $this->cc18_custoplanilhaapuracao ";
       $virgula = ",";
       if(trim((string) $this->cc18_custoplanilhaapuracao) == null ){ 
         $this->erro_sql = " Campo Custo Planilha Apuração nao Informado.";
         $this->erro_campo = "cc18_custoplanilhaapuracao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc18_sequencial"]) || $this->cc18_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2663,15132,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc18_sequencial'))."','$this->cc18_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc18_custoapropria"]) || $this->cc18_custoapropria != "")
           $resac = db_query("insert into db_acount values($acount,2663,15133,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc18_custoapropria'))."','$this->cc18_custoapropria',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc18_custoplanilhaapuracao"]) || $this->cc18_custoplanilhaapuracao != "")
           $resac = db_query("insert into db_acount values($acount,2663,15134,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc18_custoplanilhaapuracao'))."','$this->cc18_custoplanilhaapuracao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($cc18_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2663,15132,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc18_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2663,15133,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc18_custoapropria'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2663,15134,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc18_custoplanilhaapuracao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
