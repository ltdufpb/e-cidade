...
class cl_restos {
   ...
   function incluir ($cm12_i_codigo){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1000013,1000097,'','".AddSlashes(pg_fetch_result($resaco,0,'cm12_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1000013,1000098,'','".AddSlashes(pg_fetch_result($resaco,0,'cm12_i_ossoariopart'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1000013,1000092,'','".AddSlashes(pg_fetch_result($resaco,0,'cm12_i_sepultamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1000013,1000101,'','".AddSlashes(pg_fetch_result($resaco,0,'cm12_d_entrada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm12_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1000013,1000097,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm12_i_codigo'))."','$this->cm12_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm12_i_ossoariopart"]))
           $resac = db_query("insert into db_acount values($acount,1000013,1000098,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm12_i_ossoariopart'))."','$this->cm12_i_ossoariopart',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm12_i_sepultamento"]))
           $resac = db_query("insert into db_acount values($acount,1000013,1000092,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm12_i_sepultamento'))."','$this->cm12_i_sepultamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm12_d_entrada"]))
           $resac = db_query("insert into db_acount values($acount,1000013,1000101,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm12_d_entrada'))."','$this->cm12_d_entrada',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){
   ...
   function excluir ($cm12_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1000013,1000097,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm12_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1000013,1000098,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm12_i_ossoariopart'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1000013,1000092,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm12_i_sepultamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1000013,1000101,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm12_d_entrada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
