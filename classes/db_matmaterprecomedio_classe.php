...
class cl_matmaterprecomedio { 
   ...
   public $m85_sequencial = 0; 
   public $m85_matmater = 0; 
   public $m85_instit = 0; 
   public $m85_precomedio = 0; 
   public $m85_hora = null; 
   public $m85_data_dia = null; 
   public $m85_data_mes = null; 
   public $m85_data_ano = null; 
   public $m85_data = null; 
   ...
   function incluir ($m85_sequencial){ 
     ...
     if($m85_sequencial == "" || $m85_sequencial == null ){
       ...
       $this->m85_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from matmaterprecomedio_m85_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $m85_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3169,17928,'','".AddSlashes(pg_fetch_result($resaco,0,'m85_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3169,17929,'','".AddSlashes(pg_fetch_result($resaco,0,'m85_matmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3169,17931,'','".AddSlashes(pg_fetch_result($resaco,0,'m85_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3169,17932,'','".AddSlashes(pg_fetch_result($resaco,0,'m85_precomedio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3169,17937,'','".AddSlashes(pg_fetch_result($resaco,0,'m85_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3169,17938,'','".AddSlashes(pg_fetch_result($resaco,0,'m85_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($m85_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->m85_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m85_sequencial"])){ 
       $sql  .= $virgula." m85_sequencial = $this->m85_sequencial ";
       $virgula = ",";
       if(trim((string) $this->m85_sequencial) == null ){ 
     ...
     if(trim((string) $this->m85_matmater)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m85_matmater"])){ 
       $sql  .= $virgula." m85_matmater = $this->m85_matmater ";
       $virgula = ",";
       if(trim((string) $this->m85_matmater) == null ){ 
         $this->erro_sql = " Campo Código do Material nao Informado.";
         $this->erro_campo = "m85_matmater";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m85_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m85_instit"])){ 
       $sql  .= $virgula." m85_instit = $this->m85_instit ";
       $virgula = ",";
       if(trim((string) $this->m85_instit) == null ){ 
         $this->erro_sql = " Campo Instit nao Informado.";
         $this->erro_campo = "m85_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m85_precomedio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m85_precomedio"])){ 
       $sql  .= $virgula." m85_precomedio = $this->m85_precomedio ";
       $virgula = ",";
       if(trim((string) $this->m85_precomedio) == null ){ 
         $this->erro_sql = " Campo Último Preço Médio nao Informado.";
         $this->erro_campo = "m85_precomedio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m85_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m85_hora"])){ 
       $sql  .= $virgula." m85_hora = '$this->m85_hora' ";
       $virgula = ",";
       if(trim((string) $this->m85_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "m85_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m85_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m85_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["m85_data_dia"] !="") ){ 
       $sql  .= $virgula." m85_data = '$this->m85_data' ";
       $virgula = ",";
       if(trim((string) $this->m85_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "m85_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["m85_sequencial"]) || $this->m85_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3169,17928,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m85_sequencial'))."','$this->m85_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m85_matmater"]) || $this->m85_matmater != "")
           $resac = db_query("insert into db_acount values($acount,3169,17929,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m85_matmater'))."','$this->m85_matmater',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m85_instit"]) || $this->m85_instit != "")
           $resac = db_query("insert into db_acount values($acount,3169,17931,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m85_instit'))."','$this->m85_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m85_precomedio"]) || $this->m85_precomedio != "")
           $resac = db_query("insert into db_acount values($acount,3169,17932,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m85_precomedio'))."','$this->m85_precomedio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m85_hora"]) || $this->m85_hora != "")
           $resac = db_query("insert into db_acount values($acount,3169,17937,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m85_hora'))."','$this->m85_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m85_data"]) || $this->m85_data != "")
           $resac = db_query("insert into db_acount values($acount,3169,17938,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m85_data'))."','$this->m85_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($m85_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3169,17928,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m85_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3169,17929,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m85_matmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3169,17931,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m85_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3169,17932,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m85_precomedio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3169,17937,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m85_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3169,17938,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m85_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
