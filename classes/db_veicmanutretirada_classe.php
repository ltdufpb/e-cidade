...
class cl_veicmanutretirada { 
   ...
   public $ve65_codigo = 0; 
   public $ve65_veicmanut = 0; 
   public $ve65_veicretirada = 0; 
   ...
   function incluir ($ve65_codigo){ 
     ...
     if($ve65_codigo == "" || $ve65_codigo == null ){
       ...
       $this->ve65_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veicmanutretirada_ve65_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve65_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1606,9346,'','".AddSlashes(pg_fetch_result($resaco,0,'ve65_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1606,9347,'','".AddSlashes(pg_fetch_result($resaco,0,'ve65_veicmanut'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1606,9348,'','".AddSlashes(pg_fetch_result($resaco,0,'ve65_veicretirada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve65_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve65_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve65_codigo"])){ 
       $sql  .= $virgula." ve65_codigo = $this->ve65_codigo ";
       $virgula = ",";
       if(trim((string) $this->ve65_codigo) == null ){ 
     ...
     if(trim((string) $this->ve65_veicmanut)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve65_veicmanut"])){ 
       $sql  .= $virgula." ve65_veicmanut = $this->ve65_veicmanut ";
       $virgula = ",";
       if(trim((string) $this->ve65_veicmanut) == null ){ 
         $this->erro_sql = " Campo Manutenção nao Informado.";
         $this->erro_campo = "ve65_veicmanut";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve65_veicretirada)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve65_veicretirada"])){ 
       $sql  .= $virgula." ve65_veicretirada = $this->ve65_veicretirada ";
       $virgula = ",";
       if(trim((string) $this->ve65_veicretirada) == null ){ 
         $this->erro_sql = " Campo Retirada nao Informado.";
         $this->erro_campo = "ve65_veicretirada";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve65_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1606,9346,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve65_codigo'))."','$this->ve65_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve65_veicmanut"]))
           $resac = db_query("insert into db_acount values($acount,1606,9347,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve65_veicmanut'))."','$this->ve65_veicmanut',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve65_veicretirada"]))
           $resac = db_query("insert into db_acount values($acount,1606,9348,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve65_veicretirada'))."','$this->ve65_veicretirada',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve65_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1606,9346,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve65_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1606,9347,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve65_veicmanut'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1606,9348,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve65_veicretirada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
