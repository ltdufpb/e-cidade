...
class cl_debcontaarquivoregret { 
   ...
   public $d76_sequencial = 0; 
   public $d76_debcontatiporet = 0; 
   public $d76_debcontaarqreg = 0; 
   ...
   function incluir ($d76_sequencial){ 
     ...
     if($d76_sequencial == "" || $d76_sequencial == null ){
       ...
       $this->d76_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from debcontaarquivoregret_d76_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $d76_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1343,8207,'','".AddSlashes(pg_fetch_result($resaco,0,'d76_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1343,8208,'','".AddSlashes(pg_fetch_result($resaco,0,'d76_debcontatiporet'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1343,8209,'','".AddSlashes(pg_fetch_result($resaco,0,'d76_debcontaarqreg'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($d76_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->d76_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d76_sequencial"])){ 
       $sql  .= $virgula." d76_sequencial = $this->d76_sequencial ";
       $virgula = ",";
       if(trim((string) $this->d76_sequencial) == null ){ 
     ...
     if(trim((string) $this->d76_debcontatiporet)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d76_debcontatiporet"])){ 
       $sql  .= $virgula." d76_debcontatiporet = $this->d76_debcontatiporet ";
       $virgula = ",";
       if(trim((string) $this->d76_debcontatiporet) == null ){ 
         $this->erro_sql = " Campo Código do tipo de retorno nao Informado.";
         $this->erro_campo = "d76_debcontatiporet";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->d76_debcontaarqreg)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d76_debcontaarqreg"])){ 
       $sql  .= $virgula." d76_debcontaarqreg = $this->d76_debcontaarqreg ";
       $virgula = ",";
       if(trim((string) $this->d76_debcontaarqreg) == null ){ 
         $this->erro_sql = " Campo Codigo sequencial nao Informado.";
         $this->erro_campo = "d76_debcontaarqreg";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["d76_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1343,8207,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d76_sequencial'))."','$this->d76_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d76_debcontatiporet"]))
           $resac = db_query("insert into db_acount values($acount,1343,8208,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d76_debcontatiporet'))."','$this->d76_debcontatiporet',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d76_debcontaarqreg"]))
           $resac = db_query("insert into db_acount values($acount,1343,8209,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d76_debcontaarqreg'))."','$this->d76_debcontaarqreg',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($d76_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1343,8207,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d76_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1343,8208,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d76_debcontatiporet'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1343,8209,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d76_debcontaarqreg'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
