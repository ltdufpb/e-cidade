...
class cl_condataconf { 
   ...
   public $c99_anousu = 0; 
   public $c99_instit = 0; 
   public $c99_data_dia = null; 
   public $c99_data_mes = null; 
   public $c99_data_ano = null; 
   public $c99_data = null; 
   public $c99_usuario = 0; 
   ...
   function incluir ($c99_anousu,$c99_instit){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1350,8009,'','".AddSlashes(pg_fetch_result($resaco,0,'c99_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1350,8010,'','".AddSlashes(pg_fetch_result($resaco,0,'c99_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1350,8011,'','".AddSlashes(pg_fetch_result($resaco,0,'c99_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1350,8874,'','".AddSlashes(pg_fetch_result($resaco,0,'c99_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($c99_anousu=null,$c99_instit=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->c99_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c99_anousu"])){ 
       $sql  .= $virgula." c99_anousu = $this->c99_anousu ";
       $virgula = ",";
       if(trim((string) $this->c99_anousu) == null ){ 
     ...
     if(trim((string) $this->c99_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c99_instit"])){ 
       $sql  .= $virgula." c99_instit = $this->c99_instit ";
       $virgula = ",";
       if(trim((string) $this->c99_instit) == null ){ 
     ...
     if(trim((string) $this->c99_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c99_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["c99_data_dia"] !="") ){ 
     ...
     if(trim((string) $this->c99_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c99_usuario"])){ 
       $sql  .= $virgula." c99_usuario = $this->c99_usuario ";
       $virgula = ",";
       if(trim((string) $this->c99_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "c99_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c99_anousu"]))
           $resac = db_query("insert into db_acount values($acount,1350,8009,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c99_anousu'))."','$this->c99_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c99_instit"]))
           $resac = db_query("insert into db_acount values($acount,1350,8010,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c99_instit'))."','$this->c99_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c99_data"]))
           $resac = db_query("insert into db_acount values($acount,1350,8011,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c99_data'))."','$this->c99_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c99_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1350,8874,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c99_usuario'))."','$this->c99_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($c99_anousu=null,$c99_instit=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1350,8009,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c99_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1350,8010,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c99_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1350,8011,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c99_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1350,8874,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c99_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
