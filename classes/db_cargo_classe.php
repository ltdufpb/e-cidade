...
class cl_cargo { 
   ...
   function incluir ($r65_anousu,$r65_mesusu,$r65_cargo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,604,4562,'','".AddSlashes(pg_fetch_result($resaco,0,'r65_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,604,4563,'','".AddSlashes(pg_fetch_result($resaco,0,'r65_mesusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,604,4564,'','".AddSlashes(pg_fetch_result($resaco,0,'r65_cargo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,604,4565,'','".AddSlashes(pg_fetch_result($resaco,0,'r65_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($r65_anousu=null,$r65_mesusu=null,$r65_cargo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->r65_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r65_anousu"])){ 
       $sql  .= $virgula." r65_anousu = $this->r65_anousu ";
       $virgula = ",";
       if(trim((string) $this->r65_anousu) == null ){ 
     ...
     if(trim((string) $this->r65_mesusu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r65_mesusu"])){ 
       $sql  .= $virgula." r65_mesusu = $this->r65_mesusu ";
       $virgula = ",";
       if(trim((string) $this->r65_mesusu) == null ){ 
     ...
     if(trim((string) $this->r65_cargo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r65_cargo"])){ 
       $sql  .= $virgula." r65_cargo = $this->r65_cargo ";
       $virgula = ",";
       if(trim((string) $this->r65_cargo) == null ){ 
     ...
     if(trim((string) $this->r65_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r65_descr"])){ 
       $sql  .= $virgula." r65_descr = '$this->r65_descr' ";
       $virgula = ",";
       if(trim((string) $this->r65_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "r65_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["r65_anousu"]))
           $resac = db_query("insert into db_acount values($acount,604,4562,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r65_anousu'))."','$this->r65_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r65_mesusu"]))
           $resac = db_query("insert into db_acount values($acount,604,4563,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r65_mesusu'))."','$this->r65_mesusu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r65_cargo"]))
           $resac = db_query("insert into db_acount values($acount,604,4564,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r65_cargo'))."','$this->r65_cargo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r65_descr"]))
           $resac = db_query("insert into db_acount values($acount,604,4565,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r65_descr'))."','$this->r65_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($r65_anousu=null,$r65_mesusu=null,$r65_cargo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,604,4562,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r65_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,604,4563,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r65_mesusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,604,4564,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r65_cargo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,604,4565,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r65_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
