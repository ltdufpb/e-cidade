...
class cl_prescricaoanulareg { 
   ...
   public $k121_sequencial = 0; 
   public $k121_arreprescr = 0; 
   public $k121_prescricaoanula = 0; 
   ...
   function incluir ($k121_sequencial){ 
     ...
     if($k121_sequencial == "" || $k121_sequencial == null ){
       ...
       $this->k121_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from prescricaoanulareg_k121_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k121_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3114,17630,'','".AddSlashes(pg_fetch_result($resaco,0,'k121_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3114,17631,'','".AddSlashes(pg_fetch_result($resaco,0,'k121_arreprescr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3114,17632,'','".AddSlashes(pg_fetch_result($resaco,0,'k121_prescricaoanula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k121_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k121_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k121_sequencial"])){ 
       $sql  .= $virgula." k121_sequencial = $this->k121_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k121_sequencial) == null ){ 
     ...
     if(trim((string) $this->k121_arreprescr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k121_arreprescr"])){ 
       $sql  .= $virgula." k121_arreprescr = $this->k121_arreprescr ";
       $virgula = ",";
       if(trim((string) $this->k121_arreprescr) == null ){ 
         $this->erro_sql = " Campo Arreprescr nao Informado.";
         $this->erro_campo = "k121_arreprescr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k121_prescricaoanula)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k121_prescricaoanula"])){ 
       $sql  .= $virgula." k121_prescricaoanula = $this->k121_prescricaoanula ";
       $virgula = ",";
       if(trim((string) $this->k121_prescricaoanula) == null ){ 
         $this->erro_sql = " Campo Prescrição Anula nao Informado.";
         $this->erro_campo = "k121_prescricaoanula";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k121_sequencial"]) || $this->k121_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3114,17630,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k121_sequencial'))."','$this->k121_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k121_arreprescr"]) || $this->k121_arreprescr != "")
           $resac = db_query("insert into db_acount values($acount,3114,17631,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k121_arreprescr'))."','$this->k121_arreprescr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k121_prescricaoanula"]) || $this->k121_prescricaoanula != "")
           $resac = db_query("insert into db_acount values($acount,3114,17632,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k121_prescricaoanula'))."','$this->k121_prescricaoanula',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k121_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3114,17630,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k121_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3114,17631,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k121_arreprescr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3114,17632,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k121_prescricaoanula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
