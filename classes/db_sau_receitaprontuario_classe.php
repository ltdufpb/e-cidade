...
class cl_sau_receitaprontuario { 
   ...
   public $s162_i_codigo = 0; 
   public $s162_i_receita = 0; 
   public $s162_i_prontuario = 0; 
   ...
   function incluir ($s162_i_codigo){ 
     ...
     if($s162_i_codigo == "" || $s162_i_codigo == null ){
       ...
       $this->s162_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from sau_receitaprontuario_s162_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $s162_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3134,17751,'','".AddSlashes(pg_fetch_result($resaco,0,'s162_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3134,17752,'','".AddSlashes(pg_fetch_result($resaco,0,'s162_i_receita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3134,17753,'','".AddSlashes(pg_fetch_result($resaco,0,'s162_i_prontuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($s162_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->s162_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s162_i_codigo"])){ 
       $sql  .= $virgula." s162_i_codigo = $this->s162_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->s162_i_codigo) == null ){ 
     ...
     if(trim((string) $this->s162_i_receita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s162_i_receita"])){ 
       $sql  .= $virgula." s162_i_receita = $this->s162_i_receita ";
       $virgula = ",";
       if(trim((string) $this->s162_i_receita) == null ){ 
         $this->erro_sql = " Campo Receita nao Informado.";
         $this->erro_campo = "s162_i_receita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s162_i_prontuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s162_i_prontuario"])){ 
       $sql  .= $virgula." s162_i_prontuario = $this->s162_i_prontuario ";
       $virgula = ",";
       if(trim((string) $this->s162_i_prontuario) == null ){ 
         $this->erro_sql = " Campo Prontuário nao Informado.";
         $this->erro_campo = "s162_i_prontuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s162_i_codigo"]) || $this->s162_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3134,17751,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s162_i_codigo'))."','$this->s162_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s162_i_receita"]) || $this->s162_i_receita != "")
           $resac = db_query("insert into db_acount values($acount,3134,17752,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s162_i_receita'))."','$this->s162_i_receita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s162_i_prontuario"]) || $this->s162_i_prontuario != "")
           $resac = db_query("insert into db_acount values($acount,3134,17753,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s162_i_prontuario'))."','$this->s162_i_prontuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($s162_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3134,17751,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s162_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3134,17752,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s162_i_receita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3134,17753,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s162_i_prontuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
