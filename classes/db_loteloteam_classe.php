...
class cl_loteloteam { 
   ...
   function incluir ($j34_idbql,$j34_loteam){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,21,79,'','".AddSlashes(pg_fetch_result($resaco,0,'j34_idbql'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,21,86,'','".AddSlashes(pg_fetch_result($resaco,0,'j34_loteam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j34_idbql"]))
           $resac = db_query("insert into db_acount values($acount,21,79,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j34_idbql'))."','$this->j34_idbql',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j34_loteam"]))
           $resac = db_query("insert into db_acount values($acount,21,86,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j34_loteam'))."','$this->j34_loteam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j34_idbql=null,$j34_loteam=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,21,79,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j34_idbql'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,21,86,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j34_loteam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
