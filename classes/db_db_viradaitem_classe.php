...
class cl_db_viradaitem { 
   ...
   public $c31_sequencial = 0; 
   public $c31_db_virada = 0; 
   public $c31_db_viradacaditem = 0; 
   public $c31_situacao = 0; 
   ...
   function incluir ($c31_sequencial){ 
     ...
     if($c31_sequencial == "" || $c31_sequencial == null ){
       ...
       $this->c31_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_viradaitem_c31_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $c31_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1858,10797,'','".AddSlashes(pg_fetch_result($resaco,0,'c31_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1858,10798,'','".AddSlashes(pg_fetch_result($resaco,0,'c31_db_virada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1858,10799,'','".AddSlashes(pg_fetch_result($resaco,0,'c31_db_viradacaditem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1858,10800,'','".AddSlashes(pg_fetch_result($resaco,0,'c31_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($c31_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->c31_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c31_sequencial"])){ 
       $sql  .= $virgula." c31_sequencial = $this->c31_sequencial ";
       $virgula = ",";
       if(trim((string) $this->c31_sequencial) == null ){ 
     ...
     if(trim((string) $this->c31_db_virada)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c31_db_virada"])){ 
       $sql  .= $virgula." c31_db_virada = $this->c31_db_virada ";
       $virgula = ",";
       if(trim((string) $this->c31_db_virada) == null ){ 
         $this->erro_sql = " Campo Código da virada nao Informado.";
         $this->erro_campo = "c31_db_virada";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c31_db_viradacaditem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c31_db_viradacaditem"])){ 
       $sql  .= $virgula." c31_db_viradacaditem = $this->c31_db_viradacaditem ";
       $virgula = ",";
       if(trim((string) $this->c31_db_viradacaditem) == null ){ 
         $this->erro_sql = " Campo Cadastro item nao Informado.";
         $this->erro_campo = "c31_db_viradacaditem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c31_situacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c31_situacao"])){ 
       $sql  .= $virgula." c31_situacao = $this->c31_situacao ";
       $virgula = ",";
       if(trim((string) $this->c31_situacao) == null ){ 
         $this->erro_sql = " Campo Situação nao Informado.";
         $this->erro_campo = "c31_situacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c31_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1858,10797,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c31_sequencial'))."','$this->c31_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c31_db_virada"]))
           $resac = db_query("insert into db_acount values($acount,1858,10798,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c31_db_virada'))."','$this->c31_db_virada',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c31_db_viradacaditem"]))
           $resac = db_query("insert into db_acount values($acount,1858,10799,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c31_db_viradacaditem'))."','$this->c31_db_viradacaditem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c31_situacao"]))
           $resac = db_query("insert into db_acount values($acount,1858,10800,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c31_situacao'))."','$this->c31_situacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($c31_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1858,10797,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c31_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1858,10798,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c31_db_virada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1858,10799,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c31_db_viradacaditem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1858,10800,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c31_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
