...
class cl_parametroprogressaoparcialetapa { 
   ...
   public $ed113_sequencial = 0; 
   public $ed113_parametroprogressaoparcial = 0; 
   public $ed113_serie = 0; 
   ...
   function incluir ($ed113_sequencial){ 
     ...
     if($ed113_sequencial == "" || $ed113_sequencial == null ){
       ...
       $this->ed113_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from parametroprogressaoparcialetapa_ed113_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed113_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3471,19533,'','".AddSlashes(pg_fetch_result($resaco,0,'ed113_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3471,19534,'','".AddSlashes(pg_fetch_result($resaco,0,'ed113_parametroprogressaoparcial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3471,19535,'','".AddSlashes(pg_fetch_result($resaco,0,'ed113_serie'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed113_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed113_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed113_sequencial"])){ 
       $sql  .= $virgula." ed113_sequencial = $this->ed113_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed113_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed113_parametroprogressaoparcial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed113_parametroprogressaoparcial"])){ 
       $sql  .= $virgula." ed113_parametroprogressaoparcial = $this->ed113_parametroprogressaoparcial ";
       $virgula = ",";
       if(trim((string) $this->ed113_parametroprogressaoparcial) == null ){ 
         $this->erro_sql = " Campo Parâmetros da progressão parcial nao Informado.";
         $this->erro_campo = "ed113_parametroprogressaoparcial";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed113_serie)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed113_serie"])){ 
       $sql  .= $virgula." ed113_serie = $this->ed113_serie ";
       $virgula = ",";
       if(trim((string) $this->ed113_serie) == null ){ 
         $this->erro_sql = " Campo Série nao Informado.";
         $this->erro_campo = "ed113_serie";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed113_sequencial"]) || $this->ed113_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3471,19533,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed113_sequencial'))."','$this->ed113_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed113_parametroprogressaoparcial"]) || $this->ed113_parametroprogressaoparcial != "")
           $resac = db_query("insert into db_acount values($acount,3471,19534,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed113_parametroprogressaoparcial'))."','$this->ed113_parametroprogressaoparcial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed113_serie"]) || $this->ed113_serie != "")
           $resac = db_query("insert into db_acount values($acount,3471,19535,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed113_serie'))."','$this->ed113_serie',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed113_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3471,19533,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed113_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3471,19534,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed113_parametroprogressaoparcial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3471,19535,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed113_serie'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
