...
class cl_ouvidoriaatendimentodoc { 
   ...
   public $ov19_sequencial = 0; 
   public $ov19_procdoc = 0; 
   public $ov19_ouvidoriaatendimento = 0; 
   public $ov19_entregue = 'f'; 
   ...
   function incluir ($ov19_sequencial){ 
     ...
     if($ov19_sequencial == "" || $ov19_sequencial == null ){
       ...
       $this->ov19_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from ouvidoriaatendimentodoc_ov19_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ov19_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2608,14819,'','".AddSlashes(pg_fetch_result($resaco,0,'ov19_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2608,14820,'','".AddSlashes(pg_fetch_result($resaco,0,'ov19_procdoc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2608,14821,'','".AddSlashes(pg_fetch_result($resaco,0,'ov19_ouvidoriaatendimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2608,14822,'','".AddSlashes(pg_fetch_result($resaco,0,'ov19_entregue'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ov19_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ov19_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov19_sequencial"])){ 
       $sql  .= $virgula." ov19_sequencial = $this->ov19_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ov19_sequencial) == null ){ 
     ...
     if(trim((string) $this->ov19_procdoc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov19_procdoc"])){ 
       $sql  .= $virgula." ov19_procdoc = $this->ov19_procdoc ";
       $virgula = ",";
       if(trim((string) $this->ov19_procdoc) == null ){ 
         $this->erro_sql = " Campo Documento do Processo nao Informado.";
         $this->erro_campo = "ov19_procdoc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ov19_ouvidoriaatendimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov19_ouvidoriaatendimento"])){ 
       $sql  .= $virgula." ov19_ouvidoriaatendimento = $this->ov19_ouvidoriaatendimento ";
       $virgula = ",";
       if(trim((string) $this->ov19_ouvidoriaatendimento) == null ){ 
         $this->erro_sql = " Campo Atendimento nao Informado.";
         $this->erro_campo = "ov19_ouvidoriaatendimento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ov19_entregue)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov19_entregue"])){ 
       $sql  .= $virgula." ov19_entregue = '$this->ov19_entregue' ";
       $virgula = ",";
       if(trim((string) $this->ov19_entregue) == null ){ 
         $this->erro_sql = " Campo Entregue nao Informado.";
         $this->erro_campo = "ov19_entregue";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov19_sequencial"]) || $this->ov19_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2608,14819,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov19_sequencial'))."','$this->ov19_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov19_procdoc"]) || $this->ov19_procdoc != "")
           $resac = db_query("insert into db_acount values($acount,2608,14820,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov19_procdoc'))."','$this->ov19_procdoc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov19_ouvidoriaatendimento"]) || $this->ov19_ouvidoriaatendimento != "")
           $resac = db_query("insert into db_acount values($acount,2608,14821,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov19_ouvidoriaatendimento'))."','$this->ov19_ouvidoriaatendimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov19_entregue"]) || $this->ov19_entregue != "")
           $resac = db_query("insert into db_acount values($acount,2608,14822,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov19_entregue'))."','$this->ov19_entregue',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ov19_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2608,14819,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov19_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2608,14820,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov19_procdoc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2608,14821,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov19_ouvidoriaatendimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2608,14822,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov19_entregue'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
