...
class cl_solandamand { 
   ...
   public $pc42_solandam = 0; 
   public $pc42_codandam = 0; 
   ...
   function incluir ($pc42_solandam){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1347,7999,'','".AddSlashes(pg_fetch_result($resaco,0,'pc42_solandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1347,7997,'','".AddSlashes(pg_fetch_result($resaco,0,'pc42_codandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc42_solandam=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc42_solandam)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc42_solandam"])){ 
       $sql  .= $virgula." pc42_solandam = $this->pc42_solandam ";
       $virgula = ",";
       if(trim((string) $this->pc42_solandam) == null ){ 
     ...
     if(trim((string) $this->pc42_codandam)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc42_codandam"])){ 
       $sql  .= $virgula." pc42_codandam = $this->pc42_codandam ";
       $virgula = ",";
       if(trim((string) $this->pc42_codandam) == null ){ 
         $this->erro_sql = " Campo Código Andamento do Proc. nao Informado.";
         $this->erro_campo = "pc42_codandam";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc42_solandam"]))
           $resac = db_query("insert into db_acount values($acount,1347,7999,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc42_solandam'))."','$this->pc42_solandam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc42_codandam"]))
           $resac = db_query("insert into db_acount values($acount,1347,7997,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc42_codandam'))."','$this->pc42_codandam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc42_solandam=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1347,7999,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc42_solandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1347,7997,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc42_codandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
