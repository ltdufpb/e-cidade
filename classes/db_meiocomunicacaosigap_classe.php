...
class cl_meiocomunicacaosigap {
   ...
   public $c49_sequencial = 0; 
   public $c49_codigocomunicacao = null; 
   public $c49_descricao = null; 
   public $c49_uf = null; 
   ...
   function incluir ($c49_sequencial){ 
     ...
     if($c49_sequencial == "" || $c49_sequencial == null ){
       ...
       $this->c49_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from meiocomunicacaosigap_c49_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $c49_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3151,17849,'','".AddSlashes(pg_fetch_result($resaco,0,'c49_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3151,17850,'','".AddSlashes(pg_fetch_result($resaco,0,'c49_codigocomunicacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3151,17851,'','".AddSlashes(pg_fetch_result($resaco,0,'c49_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3151,17852,'','".AddSlashes(pg_fetch_result($resaco,0,'c49_uf'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($c49_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->c49_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c49_sequencial"])){ 
       $sql  .= $virgula." c49_sequencial = $this->c49_sequencial ";
       $virgula = ",";
       if(trim((string) $this->c49_sequencial) == null ){ 
     ...
     if(trim((string) $this->c49_codigocomunicacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c49_codigocomunicacao"])){ 
       $sql  .= $virgula." c49_codigocomunicacao = '$this->c49_codigocomunicacao' ";
       $virgula = ",";
       if(trim((string) $this->c49_codigocomunicacao) == null ){ 
         $this->erro_sql = " Campo Código Comunicação nao Informado.";
         $this->erro_campo = "c49_codigocomunicacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c49_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c49_descricao"])){ 
       $sql  .= $virgula." c49_descricao = '$this->c49_descricao' ";
       $virgula = ",";
       if(trim((string) $this->c49_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "c49_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c49_uf)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c49_uf"])){ 
       $sql  .= $virgula." c49_uf = '$this->c49_uf' ";
       $virgula = ",";
       if(trim((string) $this->c49_uf) == null ){ 
         $this->erro_sql = " Campo UF nao Informado.";
         $this->erro_campo = "c49_uf";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c49_sequencial"]) || $this->c49_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3151,17849,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c49_sequencial'))."','$this->c49_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c49_codigocomunicacao"]) || $this->c49_codigocomunicacao != "")
           $resac = db_query("insert into db_acount values($acount,3151,17850,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c49_codigocomunicacao'))."','$this->c49_codigocomunicacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c49_descricao"]) || $this->c49_descricao != "")
           $resac = db_query("insert into db_acount values($acount,3151,17851,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c49_descricao'))."','$this->c49_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c49_uf"]) || $this->c49_uf != "")
           $resac = db_query("insert into db_acount values($acount,3151,17852,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c49_uf'))."','$this->c49_uf',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($c49_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3151,17849,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c49_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3151,17850,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c49_codigocomunicacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3151,17851,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c49_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3151,17852,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c49_uf'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
