...
class cl_licencaempreendimento {
   ...
   public $am13_sequencial = 0;
   public $am13_parecertecnico = 0;
   public $am13_arquivo = 0;
   ...
   function incluir ($am13_sequencial=null){
     ...
     if($am13_sequencial == "" || $am13_sequencial == null ){
       ...
       $this->am13_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from licencaempreendimento_am13_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $am13_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3754,20863,'','".AddSlashes(pg_fetch_result($resaco,0,'am13_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3754,20864,'','".AddSlashes(pg_fetch_result($resaco,0,'am13_parecertecnico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3754,20865,'','".AddSlashes(pg_fetch_result($resaco,0,'am13_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   public function alterar ($am13_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->am13_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["am13_sequencial"])){
       $sql  .= $virgula." am13_sequencial = $this->am13_sequencial ";
       $virgula = ",";
       if(trim((string) $this->am13_sequencial) == null ){
     ...
     if(trim((string) $this->am13_parecertecnico)!="" || isset($GLOBALS["HTTP_POST_VARS"]["am13_parecertecnico"])){
       $sql  .= $virgula." am13_parecertecnico = $this->am13_parecertecnico ";
       $virgula = ",";
       if(trim((string) $this->am13_parecertecnico) == null ){
         $this->erro_sql = " Campo Parecer Técnico não informado.";
         $this->erro_campo = "am13_parecertecnico";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->am13_arquivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["am13_arquivo"])){
       $sql  .= $virgula." am13_arquivo = $this->am13_arquivo ";
       $virgula = ",";
       if(trim((string) $this->am13_arquivo) == null ){
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["am13_sequencial"]) || $this->am13_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3754,20863,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'am13_sequencial'))."','$this->am13_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["am13_parecertecnico"]) || $this->am13_parecertecnico != "")
             $resac = db_query("insert into db_acount values($acount,3754,20864,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'am13_parecertecnico'))."','$this->am13_parecertecnico',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["am13_arquivo"]) || $this->am13_arquivo != "")
             $resac = db_query("insert into db_acount values($acount,3754,20865,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'am13_arquivo'))."','$this->am13_arquivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3754,20863,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'am13_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3754,20864,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'am13_parecertecnico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3754,20865,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'am13_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
