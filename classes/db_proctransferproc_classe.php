...
class cl_proctransferproc {
   ...
   public $p63_codtran = 0;
   public $p63_codproc = 0;
   ...
   function incluir ($p63_codtran,$p63_codproc){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,409,2480,'','".AddSlashes(pg_fetch_result($resaco,0,'p63_codtran'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,409,2481,'','".AddSlashes(pg_fetch_result($resaco,0,'p63_codproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($p63_codtran=null,$p63_codproc=null) {
     ...
     $virgula = "";
     if(trim((string) $this->p63_codtran)!="" || isset($GLOBALS["HTTP_POST_VARS"]["p63_codtran"])){
       $sql  .= $virgula." p63_codtran = $this->p63_codtran ";
       $virgula = ",";
       if(trim((string) $this->p63_codtran) == null ){
     ...
     if(trim((string) $this->p63_codproc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["p63_codproc"])){
       $sql  .= $virgula." p63_codproc = $this->p63_codproc ";
       $virgula = ",";
       if(trim((string) $this->p63_codproc) == null ){
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["p63_codtran"]))
           $resac = db_query("insert into db_acount values($acount,409,2480,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'p63_codtran'))."','$this->p63_codtran',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p63_codproc"]))
           $resac = db_query("insert into db_acount values($acount,409,2481,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'p63_codproc'))."','$this->p63_codproc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($p63_codtran=null,$p63_codproc=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,409,2480,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'p63_codtran'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,409,2481,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'p63_codproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
