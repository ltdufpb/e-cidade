...
class cl_pcsugforn { 
   ...
   function incluir ($pc40_solic,$pc40_numcgm){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,343,2122,'','".AddSlashes(pg_fetch_result($resaco,0,'pc40_solic'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,343,2123,'','".AddSlashes(pg_fetch_result($resaco,0,'pc40_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc40_solic"]))
           $resac = db_query("insert into db_acount values($acount,343,2122,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc40_solic'))."','$this->pc40_solic',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc40_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,343,2123,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc40_numcgm'))."','$this->pc40_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc40_solic=null,$pc40_numcgm=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,343,2122,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc40_solic'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,343,2123,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc40_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
