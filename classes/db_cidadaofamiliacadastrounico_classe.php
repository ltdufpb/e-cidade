...
class cl_cidadaofamiliacadastrounico { 
   ...
   public $as15_sequencial = 0; 
   public $as15_cidadaofamilia = 0; 
   public $as15_codigofamiliarcadastrounico = null; 
   ...
   function incluir ($as15_sequencial){ 
     ...
     if($as15_sequencial == "" || $as15_sequencial == null ){
       ...
       $this->as15_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cidadaofamiliacadastrounico_as15_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $as15_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3573,19940,'','".AddSlashes(pg_fetch_result($resaco,0,'as15_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3573,19941,'','".AddSlashes(pg_fetch_result($resaco,0,'as15_cidadaofamilia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3573,19942,'','".AddSlashes(pg_fetch_result($resaco,0,'as15_codigofamiliarcadastrounico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($as15_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->as15_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as15_sequencial"])){ 
       $sql  .= $virgula." as15_sequencial = $this->as15_sequencial ";
       $virgula = ",";
       if(trim((string) $this->as15_sequencial) == null ){ 
     ...
     if(trim((string) $this->as15_cidadaofamilia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as15_cidadaofamilia"])){ 
       $sql  .= $virgula." as15_cidadaofamilia = $this->as15_cidadaofamilia ";
       $virgula = ",";
       if(trim((string) $this->as15_cidadaofamilia) == null ){ 
         $this->erro_sql = " Campo Família nao Informado.";
         $this->erro_campo = "as15_cidadaofamilia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->as15_codigofamiliarcadastrounico)!="" || isset($GLOBALS["HTTP_POST_VARS"]["as15_codigofamiliarcadastrounico"])){ 
       $sql  .= $virgula." as15_codigofamiliarcadastrounico = '$this->as15_codigofamiliarcadastrounico' ";
       $virgula = ",";
       if(trim((string) $this->as15_codigofamiliarcadastrounico) == null ){ 
         $this->erro_sql = " Campo Família no Cadastro Único nao Informado.";
         $this->erro_campo = "as15_codigofamiliarcadastrounico";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["as15_sequencial"]) || $this->as15_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3573,19940,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as15_sequencial'))."','$this->as15_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["as15_cidadaofamilia"]) || $this->as15_cidadaofamilia != "")
             $resac = db_query("insert into db_acount values($acount,3573,19941,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as15_cidadaofamilia'))."','$this->as15_cidadaofamilia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["as15_codigofamiliarcadastrounico"]) || $this->as15_codigofamiliarcadastrounico != "")
             $resac = db_query("insert into db_acount values($acount,3573,19942,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'as15_codigofamiliarcadastrounico'))."','$this->as15_codigofamiliarcadastrounico',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3573,19940,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as15_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3573,19941,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as15_cidadaofamilia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3573,19942,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'as15_codigofamiliarcadastrounico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
