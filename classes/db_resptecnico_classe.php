...
class cl_resptecnico { 
   ...
   function incluir ($y22_codsani,$y22_numcgm){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,739,5162,'','".AddSlashes(pg_fetch_result($resaco,0,'y22_codsani'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,739,5163,'','".AddSlashes(pg_fetch_result($resaco,0,'y22_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y22_codsani=null,$y22_numcgm=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y22_codsani)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y22_codsani"])){ 
       $sql  .= $virgula." y22_codsani = $this->y22_codsani ";
       $virgula = ",";
       if(trim((string) $this->y22_codsani) == null ){ 
     ...
     if(trim((string) $this->y22_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y22_numcgm"])){ 
       $sql  .= $virgula." y22_numcgm = $this->y22_numcgm ";
       $virgula = ",";
       if(trim((string) $this->y22_numcgm) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y22_codsani"]))
           $resac = db_query("insert into db_acount values($acount,739,5162,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y22_codsani'))."','$this->y22_codsani',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y22_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,739,5163,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y22_numcgm'))."','$this->y22_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y22_codsani=null,$y22_numcgm=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,739,5162,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y22_codsani'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,739,5163,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y22_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
