...
class cl_fiscalrec { 
   ...
   function incluir ($y42_codnoti,$y42_receit){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,695,4974,'','".AddSlashes(pg_fetch_result($resaco,0,'y42_codnoti'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,695,4975,'','".AddSlashes(pg_fetch_result($resaco,0,'y42_receit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,695,4976,'','".AddSlashes(pg_fetch_result($resaco,0,'y42_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,695,4977,'','".AddSlashes(pg_fetch_result($resaco,0,'y42_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y42_codnoti=null,$y42_receit=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y42_codnoti)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y42_codnoti"])){ 
       $sql  .= $virgula." y42_codnoti = $this->y42_codnoti ";
       $virgula = ",";
       if(trim((string) $this->y42_codnoti) == null ){ 
     ...
     if(trim((string) $this->y42_receit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y42_receit"])){ 
       $sql  .= $virgula." y42_receit = $this->y42_receit ";
       $virgula = ",";
       if(trim((string) $this->y42_receit) == null ){ 
     ...
     if(trim((string) $this->y42_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y42_descr"])){ 
       $sql  .= $virgula." y42_descr = '$this->y42_descr' ";
       $virgula = ",";
       if(trim((string) $this->y42_descr) == null ){ 
         $this->erro_sql = " Campo Descrição do lançamento da receita nao Informado.";
         $this->erro_campo = "y42_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y42_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y42_valor"])){ 
       $sql  .= $virgula." y42_valor = $this->y42_valor ";
       $virgula = ",";
       if(trim((string) $this->y42_valor) == null ){ 
         $this->erro_sql = " Campo Valor da Receita nao Informado.";
         $this->erro_campo = "y42_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y42_codnoti"]))
           $resac = db_query("insert into db_acount values($acount,695,4974,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y42_codnoti'))."','$this->y42_codnoti',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y42_receit"]))
           $resac = db_query("insert into db_acount values($acount,695,4975,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y42_receit'))."','$this->y42_receit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y42_descr"]))
           $resac = db_query("insert into db_acount values($acount,695,4976,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y42_descr'))."','$this->y42_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y42_valor"]))
           $resac = db_query("insert into db_acount values($acount,695,4977,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y42_valor'))."','$this->y42_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y42_codnoti=null,$y42_receit=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,695,4974,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y42_codnoti'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,695,4975,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y42_receit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,695,4976,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y42_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,695,4977,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y42_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
