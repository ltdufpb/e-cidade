...
class cl_rechumanonecessidade { 
   ...
   public $ed310_sequencial = 0; 
   public $ed310_rechumano = 0; 
   public $ed310_necessidade = 0; 
   ...
   function incluir ($ed310_sequencial){ 
     ...
     if($ed310_sequencial == "" || $ed310_sequencial == null ){
       ...
       $this->ed310_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rechumanonecessidade_ed310_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed310_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3361,18909,'','".AddSlashes(pg_fetch_result($resaco,0,'ed310_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3361,18910,'','".AddSlashes(pg_fetch_result($resaco,0,'ed310_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3361,18911,'','".AddSlashes(pg_fetch_result($resaco,0,'ed310_necessidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed310_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed310_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed310_sequencial"])){ 
       $sql  .= $virgula." ed310_sequencial = $this->ed310_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed310_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed310_rechumano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed310_rechumano"])){ 
       $sql  .= $virgula." ed310_rechumano = $this->ed310_rechumano ";
       $virgula = ",";
       if(trim((string) $this->ed310_rechumano) == null ){ 
         $this->erro_sql = " Campo Código do Recurso Humano nao Informado.";
         $this->erro_campo = "ed310_rechumano";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed310_necessidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed310_necessidade"])){ 
       $sql  .= $virgula." ed310_necessidade = $this->ed310_necessidade ";
       $virgula = ",";
       if(trim((string) $this->ed310_necessidade) == null ){ 
         $this->erro_sql = " Campo Código da Necessidade nao Informado.";
         $this->erro_campo = "ed310_necessidade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed310_sequencial"]) || $this->ed310_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3361,18909,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed310_sequencial'))."','$this->ed310_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed310_rechumano"]) || $this->ed310_rechumano != "")
           $resac = db_query("insert into db_acount values($acount,3361,18910,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed310_rechumano'))."','$this->ed310_rechumano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed310_necessidade"]) || $this->ed310_necessidade != "")
           $resac = db_query("insert into db_acount values($acount,3361,18911,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed310_necessidade'))."','$this->ed310_necessidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed310_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3361,18909,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed310_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3361,18910,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed310_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3361,18911,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed310_necessidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
