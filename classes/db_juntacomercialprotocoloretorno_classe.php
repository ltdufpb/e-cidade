...
class cl_juntacomercialprotocoloretorno { 
   ...
   public $q149_sequencial = 0; 
   public $q149_juntacomercialprotocolo = 0; 
   public $q149_xml = null; 
   ...
   function incluir ($q149_sequencial){ 
     ...
     if($q149_sequencial == "" || $q149_sequencial == null ){
       ...
       $this->q149_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from juntacomercialprotocoloretorno_q149_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q149_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,1010277,1009713,'','".AddSlashes(pg_fetch_result($resaco,0,'q149_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010277,1009714,'','".AddSlashes(pg_fetch_result($resaco,0,'q149_juntacomercialprotocolo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010277,1009715,'','".AddSlashes(pg_fetch_result($resaco,0,'q149_xml'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($q149_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q149_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q149_sequencial"])){ 
       $sql  .= $virgula." q149_sequencial = $this->q149_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q149_sequencial) == null ){ 
     ...
     if(trim((string) $this->q149_juntacomercialprotocolo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q149_juntacomercialprotocolo"])){ 
       $sql  .= $virgula." q149_juntacomercialprotocolo = $this->q149_juntacomercialprotocolo ";
       $virgula = ",";
       if(trim((string) $this->q149_juntacomercialprotocolo) == null ){ 
         $this->erro_sql = " Campo Protocolo não informado.";
         $this->erro_campo = "q149_juntacomercialprotocolo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q149_xml)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q149_xml"])){ 
       $sql  .= $virgula." q149_xml = '$this->q149_xml' ";
       $virgula = ",";
       if(trim((string) $this->q149_xml) == null ){ 
         $this->erro_sql = " Campo XML não informado.";
         $this->erro_campo = "q149_xml";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["q149_sequencial"]) || $this->q149_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,1010277,1009713,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q149_sequencial'))."','$this->q149_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["q149_juntacomercialprotocolo"]) || $this->q149_juntacomercialprotocolo != "")
             $resac = db_query("insert into db_acount values($acount,1010277,1009714,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q149_juntacomercialprotocolo'))."','$this->q149_juntacomercialprotocolo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["q149_xml"]) || $this->q149_xml != "")
             $resac = db_query("insert into db_acount values($acount,1010277,1009715,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q149_xml'))."','$this->q149_xml',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,1010277,1009713,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q149_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010277,1009714,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q149_juntacomercialprotocolo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010277,1009715,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q149_xml'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
