...
class cl_vac_fecharequi { 
   ...
   public $vc23_i_codigo = 0; 
   public $vc23_i_matrequi = 0; 
   public $vc23_i_fechamento = 0; 
   ...
   function incluir ($vc23_i_codigo){ 
     ...
     if($vc23_i_codigo == "" || $vc23_i_codigo == null ){
       ...
       $this->vc23_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from vac_fecharequi_vc23_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $vc23_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3100,17554,'','".AddSlashes(pg_fetch_result($resaco,0,'vc23_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3100,17555,'','".AddSlashes(pg_fetch_result($resaco,0,'vc23_i_matrequi'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3100,17556,'','".AddSlashes(pg_fetch_result($resaco,0,'vc23_i_fechamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($vc23_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->vc23_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc23_i_codigo"])){ 
       $sql  .= $virgula." vc23_i_codigo = $this->vc23_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->vc23_i_codigo) == null ){ 
     ...
     if(trim((string) $this->vc23_i_matrequi)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc23_i_matrequi"])){ 
       $sql  .= $virgula." vc23_i_matrequi = $this->vc23_i_matrequi ";
       $virgula = ",";
       if(trim((string) $this->vc23_i_matrequi) == null ){ 
         $this->erro_sql = " Campo Requisição nao Informado.";
         $this->erro_campo = "vc23_i_matrequi";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc23_i_fechamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc23_i_fechamento"])){ 
       $sql  .= $virgula." vc23_i_fechamento = $this->vc23_i_fechamento ";
       $virgula = ",";
       if(trim((string) $this->vc23_i_fechamento) == null ){ 
         $this->erro_sql = " Campo Fechamento nao Informado.";
         $this->erro_campo = "vc23_i_fechamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc23_i_codigo"]) || $this->vc23_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3100,17554,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc23_i_codigo'))."','$this->vc23_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc23_i_matrequi"]) || $this->vc23_i_matrequi != "")
           $resac = db_query("insert into db_acount values($acount,3100,17555,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc23_i_matrequi'))."','$this->vc23_i_matrequi',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc23_i_fechamento"]) || $this->vc23_i_fechamento != "")
           $resac = db_query("insert into db_acount values($acount,3100,17556,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc23_i_fechamento'))."','$this->vc23_i_fechamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($vc23_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3100,17554,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc23_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3100,17555,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc23_i_matrequi'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3100,17556,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc23_i_fechamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
