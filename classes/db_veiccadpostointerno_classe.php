...
class cl_veiccadpostointerno { 
   ...
   public $ve35_codigo = 0; 
   public $ve35_veiccadposto = 0; 
   public $ve35_depart = 0; 
   ...
   function incluir ($ve35_codigo){ 
     ...
     if($ve35_codigo == "" || $ve35_codigo == null ){
       ...
       $this->ve35_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veiccadpostointerno_ve35_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve35_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1602,9324,'','".AddSlashes(pg_fetch_result($resaco,0,'ve35_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1602,9325,'','".AddSlashes(pg_fetch_result($resaco,0,'ve35_veiccadposto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1602,9326,'','".AddSlashes(pg_fetch_result($resaco,0,'ve35_depart'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve35_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve35_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve35_codigo"])){ 
       $sql  .= $virgula." ve35_codigo = $this->ve35_codigo ";
       $virgula = ",";
       if(trim((string) $this->ve35_codigo) == null ){ 
     ...
     if(trim((string) $this->ve35_veiccadposto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve35_veiccadposto"])){ 
       $sql  .= $virgula." ve35_veiccadposto = $this->ve35_veiccadposto ";
       $virgula = ",";
       if(trim((string) $this->ve35_veiccadposto) == null ){ 
         $this->erro_sql = " Campo Posto nao Informado.";
         $this->erro_campo = "ve35_veiccadposto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve35_depart)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve35_depart"])){ 
       $sql  .= $virgula." ve35_depart = $this->ve35_depart ";
       $virgula = ",";
       if(trim((string) $this->ve35_depart) == null ){ 
         $this->erro_sql = " Campo Depart. nao Informado.";
         $this->erro_campo = "ve35_depart";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve35_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1602,9324,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve35_codigo'))."','$this->ve35_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve35_veiccadposto"]))
           $resac = db_query("insert into db_acount values($acount,1602,9325,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve35_veiccadposto'))."','$this->ve35_veiccadposto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve35_depart"]))
           $resac = db_query("insert into db_acount values($acount,1602,9326,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve35_depart'))."','$this->ve35_depart',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve35_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1602,9324,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve35_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1602,9325,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve35_veiccadposto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1602,9326,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve35_depart'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
