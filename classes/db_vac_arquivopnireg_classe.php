...
class cl_vac_arquivopnireg { 
   ...
   public $vc28_i_codigo = 0; 
   public $vc28_i_arquivopni = 0; 
   public $vc28_i_aplicalote = 0; 
   ...
   function incluir ($vc28_i_codigo){ 
     ...
     if($vc28_i_codigo == "" || $vc28_i_codigo == null ){
       ...
       $this->vc28_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from vac_arquivopnireg_vc28_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $vc28_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3108,17600,'','".AddSlashes(pg_fetch_result($resaco,0,'vc28_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3108,17601,'','".AddSlashes(pg_fetch_result($resaco,0,'vc28_i_arquivopni'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3108,17602,'','".AddSlashes(pg_fetch_result($resaco,0,'vc28_i_aplicalote'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($vc28_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->vc28_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc28_i_codigo"])){ 
       $sql  .= $virgula." vc28_i_codigo = $this->vc28_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->vc28_i_codigo) == null ){ 
     ...
     if(trim((string) $this->vc28_i_arquivopni)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc28_i_arquivopni"])){ 
       $sql  .= $virgula." vc28_i_arquivopni = $this->vc28_i_arquivopni ";
       $virgula = ",";
       if(trim((string) $this->vc28_i_arquivopni) == null ){ 
         $this->erro_sql = " Campo Arquivo PNI nao Informado.";
         $this->erro_campo = "vc28_i_arquivopni";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc28_i_aplicalote)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc28_i_aplicalote"])){ 
       $sql  .= $virgula." vc28_i_aplicalote = $this->vc28_i_aplicalote ";
       $virgula = ",";
       if(trim((string) $this->vc28_i_aplicalote) == null ){ 
         $this->erro_sql = " Campo Aplica Lote nao Informado.";
         $this->erro_campo = "vc28_i_aplicalote";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc28_i_codigo"]) || $this->vc28_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3108,17600,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc28_i_codigo'))."','$this->vc28_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc28_i_arquivopni"]) || $this->vc28_i_arquivopni != "")
           $resac = db_query("insert into db_acount values($acount,3108,17601,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc28_i_arquivopni'))."','$this->vc28_i_arquivopni',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc28_i_aplicalote"]) || $this->vc28_i_aplicalote != "")
           $resac = db_query("insert into db_acount values($acount,3108,17602,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc28_i_aplicalote'))."','$this->vc28_i_aplicalote',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($vc28_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3108,17600,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc28_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3108,17601,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc28_i_arquivopni'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3108,17602,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc28_i_aplicalote'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
