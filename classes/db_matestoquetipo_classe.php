...
class cl_matestoquetipo { 
   ...
   public $m81_codtipo = 0; 
   public $m81_descr = null; 
   public $m81_entrada = 'f'; 
   public $m81_tipo = 0; 
   ...
   function incluir ($m81_codtipo){ 
     ...
     if($m81_codtipo == "" || $m81_codtipo == null ){
       ...
       $this->m81_codtipo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from matestoquetipo_m81_codtipo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $m81_codtipo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1134,6897,'','".AddSlashes(pg_fetch_result($resaco,0,'m81_codtipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1134,6898,'','".AddSlashes(pg_fetch_result($resaco,0,'m81_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1134,7919,'','".AddSlashes(pg_fetch_result($resaco,0,'m81_entrada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1134,17927,'','".AddSlashes(pg_fetch_result($resaco,0,'m81_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($m81_codtipo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->m81_codtipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m81_codtipo"])){ 
       $sql  .= $virgula." m81_codtipo = $this->m81_codtipo ";
       $virgula = ",";
       if(trim((string) $this->m81_codtipo) == null ){ 
     ...
     if(trim((string) $this->m81_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m81_descr"])){ 
       $sql  .= $virgula." m81_descr = '$this->m81_descr' ";
       $virgula = ",";
       if(trim((string) $this->m81_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "m81_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m81_entrada)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m81_entrada"])){ 
       $sql  .= $virgula." m81_entrada = '$this->m81_entrada' ";
       $virgula = ",";
       if(trim((string) $this->m81_entrada) == null ){ 
         $this->erro_sql = " Campo Entrada de Materiais nao Informado.";
         $this->erro_campo = "m81_entrada";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m81_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m81_tipo"])){ 
       $sql  .= $virgula." m81_tipo = $this->m81_tipo ";
       $virgula = ",";
       if(trim((string) $this->m81_tipo) == null ){ 
         $this->erro_sql = " Campo Tipo da Movimentação nao Informado.";
         $this->erro_campo = "m81_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["m81_codtipo"]) || $this->m81_codtipo != "")
           $resac = db_query("insert into db_acount values($acount,1134,6897,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m81_codtipo'))."','$this->m81_codtipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m81_descr"]) || $this->m81_descr != "")
           $resac = db_query("insert into db_acount values($acount,1134,6898,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m81_descr'))."','$this->m81_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m81_entrada"]) || $this->m81_entrada != "")
           $resac = db_query("insert into db_acount values($acount,1134,7919,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m81_entrada'))."','$this->m81_entrada',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m81_tipo"]) || $this->m81_tipo != "")
           $resac = db_query("insert into db_acount values($acount,1134,17927,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m81_tipo'))."','$this->m81_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($m81_codtipo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1134,6897,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m81_codtipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1134,6898,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m81_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1134,7919,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m81_entrada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1134,17927,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m81_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
