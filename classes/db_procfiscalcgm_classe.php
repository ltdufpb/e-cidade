...
class cl_procfiscalcgm { 
   ...
   function incluir ($y101_sequencial){ 
     ...
     if($y101_sequencial == "" || $y101_sequencial == null ){
       ...
       $this->y101_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from procfiscalcgm_y101_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $y101_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2090,12057,'','".AddSlashes(pg_fetch_result($resaco,0,'y101_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2090,12058,'','".AddSlashes(pg_fetch_result($resaco,0,'y101_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2090,12059,'','".AddSlashes(pg_fetch_result($resaco,0,'y101_procfiscal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y101_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y101_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y101_sequencial"])){ 
       $sql  .= $virgula." y101_sequencial = $this->y101_sequencial ";
       $virgula = ",";
       if(trim((string) $this->y101_sequencial) == null ){ 
     ...
     if(trim((string) $this->y101_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y101_numcgm"])){ 
       $sql  .= $virgula." y101_numcgm = $this->y101_numcgm ";
       $virgula = ",";
       if(trim((string) $this->y101_numcgm) == null ){ 
         $this->erro_sql = " Campo Numcgm nao Informado.";
         $this->erro_campo = "y101_numcgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y101_procfiscal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y101_procfiscal"])){ 
       $sql  .= $virgula." y101_procfiscal = $this->y101_procfiscal ";
       $virgula = ",";
       if(trim((string) $this->y101_procfiscal) == null ){ 
         $this->erro_sql = " Campo Processo Fiscal nao Informado.";
         $this->erro_campo = "y101_procfiscal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y101_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2090,12057,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y101_sequencial'))."','$this->y101_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y101_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,2090,12058,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y101_numcgm'))."','$this->y101_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y101_procfiscal"]))
           $resac = db_query("insert into db_acount values($acount,2090,12059,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y101_procfiscal'))."','$this->y101_procfiscal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y101_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2090,12057,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y101_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2090,12058,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y101_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2090,12059,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y101_procfiscal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
