...
class cl_tipo_pista { 
   ...
   public $tr03_id = 0; 
   public $tr03_sigla = null; 
   public $tr03_descr = null; 
   ...
   function incluir ($tr03_id){ 
     ...
     if($tr03_id == "" || $tr03_id == null ){
       ...
       $this->tr03_id = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tipo_pista_tr03_id_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $tr03_id)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,881,5608,'','".AddSlashes(pg_fetch_result($resaco,0,'tr03_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,881,5609,'','".AddSlashes(pg_fetch_result($resaco,0,'tr03_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,881,5607,'','".AddSlashes(pg_fetch_result($resaco,0,'tr03_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($tr03_id=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->tr03_id)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tr03_id"])){ 
       $sql  .= $virgula." tr03_id = $this->tr03_id ";
       $virgula = ",";
       if(trim((string) $this->tr03_id) == null ){ 
     ...
     if(trim((string) $this->tr03_sigla)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tr03_sigla"])){ 
       $sql  .= $virgula." tr03_sigla = '$this->tr03_sigla' ";
       $virgula = ",";
       if(trim((string) $this->tr03_sigla) == null ){ 
         $this->erro_sql = " Campo Sigla da Pista nao Informado.";
         $this->erro_campo = "tr03_sigla";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tr03_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tr03_descr"])){ 
       $sql  .= $virgula." tr03_descr = '$this->tr03_descr' ";
       $virgula = ",";
       if(trim((string) $this->tr03_descr) == null ){ 
         $this->erro_sql = " Campo Descrição da Pista nao Informado.";
         $this->erro_campo = "tr03_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["tr03_id"]))
           $resac = db_query("insert into db_acount values($acount,881,5608,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tr03_id'))."','$this->tr03_id',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tr03_sigla"]))
           $resac = db_query("insert into db_acount values($acount,881,5609,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tr03_sigla'))."','$this->tr03_sigla',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tr03_descr"]))
           $resac = db_query("insert into db_acount values($acount,881,5607,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tr03_descr'))."','$this->tr03_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($tr03_id=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,881,5608,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tr03_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,881,5609,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tr03_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,881,5607,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tr03_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
