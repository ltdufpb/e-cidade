...
class cl_vac_aplicaanula { 
   ...
   public $vc18_i_codigo = 0; 
   public $vc18_i_aplica = 0; 
   public $vc18_i_usuario = 0; 
   public $vc18_c_hora = null; 
   public $vc18_d_data_dia = null; 
   public $vc18_d_data_mes = null; 
   public $vc18_d_data_ano = null; 
   public $vc18_d_data = null; 
   public $vc18_t_obs = null; 
   ...
   function incluir ($vc18_i_codigo){ 
     ...
     if($vc18_i_codigo == "" || $vc18_i_codigo == null ){
       ...
       $this->vc18_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from vac_aplicaanula_vc18_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $vc18_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2972,16891,'','".AddSlashes(pg_fetch_result($resaco,0,'vc18_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2972,16887,'','".AddSlashes(pg_fetch_result($resaco,0,'vc18_i_aplica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2972,16888,'','".AddSlashes(pg_fetch_result($resaco,0,'vc18_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2972,16890,'','".AddSlashes(pg_fetch_result($resaco,0,'vc18_c_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2972,16889,'','".AddSlashes(pg_fetch_result($resaco,0,'vc18_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2972,17137,'','".AddSlashes(pg_fetch_result($resaco,0,'vc18_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($vc18_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->vc18_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc18_i_codigo"])){ 
       $sql  .= $virgula." vc18_i_codigo = $this->vc18_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->vc18_i_codigo) == null ){ 
     ...
     if(trim((string) $this->vc18_i_aplica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc18_i_aplica"])){ 
       $sql  .= $virgula." vc18_i_aplica = $this->vc18_i_aplica ";
       $virgula = ",";
       if(trim((string) $this->vc18_i_aplica) == null ){ 
         $this->erro_sql = " Campo Aplicação nao Informado.";
         $this->erro_campo = "vc18_i_aplica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc18_i_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc18_i_usuario"])){ 
       $sql  .= $virgula." vc18_i_usuario = $this->vc18_i_usuario ";
       $virgula = ",";
       if(trim((string) $this->vc18_i_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "vc18_i_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc18_c_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc18_c_hora"])){ 
       $sql  .= $virgula." vc18_c_hora = '$this->vc18_c_hora' ";
       $virgula = ",";
       if(trim((string) $this->vc18_c_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "vc18_c_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc18_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc18_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["vc18_d_data_dia"] !="") ){ 
       $sql  .= $virgula." vc18_d_data = '$this->vc18_d_data' ";
       $virgula = ",";
       if(trim((string) $this->vc18_d_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "vc18_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc18_t_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc18_t_obs"])){ 
       $sql  .= $virgula." vc18_t_obs = '$this->vc18_t_obs' ";
       $virgula = ",";
       if(trim((string) $this->vc18_t_obs) == null ){ 
         $this->erro_sql = " Campo Observação nao Informado.";
         $this->erro_campo = "vc18_t_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc18_i_codigo"]) || $this->vc18_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2972,16891,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc18_i_codigo'))."','$this->vc18_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc18_i_aplica"]) || $this->vc18_i_aplica != "")
           $resac = db_query("insert into db_acount values($acount,2972,16887,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc18_i_aplica'))."','$this->vc18_i_aplica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc18_i_usuario"]) || $this->vc18_i_usuario != "")
           $resac = db_query("insert into db_acount values($acount,2972,16888,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc18_i_usuario'))."','$this->vc18_i_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc18_c_hora"]) || $this->vc18_c_hora != "")
           $resac = db_query("insert into db_acount values($acount,2972,16890,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc18_c_hora'))."','$this->vc18_c_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc18_d_data"]) || $this->vc18_d_data != "")
           $resac = db_query("insert into db_acount values($acount,2972,16889,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc18_d_data'))."','$this->vc18_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc18_t_obs"]) || $this->vc18_t_obs != "")
           $resac = db_query("insert into db_acount values($acount,2972,17137,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc18_t_obs'))."','$this->vc18_t_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($vc18_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2972,16891,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc18_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2972,16887,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc18_i_aplica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2972,16888,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc18_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2972,16890,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc18_c_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2972,16889,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc18_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2972,17137,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc18_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
