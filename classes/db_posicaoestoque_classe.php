...
class cl_posicaoestoque { 
   ...
   public $m06_sequencial = 0; 
   public $m06_posicaoestoqueprocessamento = 0; 
   public $m06_matestoque = 0; 
   public $m06_quantidade = 0; 
   public $m06_valor = 0; 
   public $m06_precomedio = 0; 
   ...
   function incluir ($m06_sequencial){ 
     ...
     if($m06_sequencial == "" || $m06_sequencial == null ){
       ...
       $this->m06_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from posicaoestoque_m06_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $m06_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3665,20392,'','".AddSlashes(pg_fetch_result($resaco,0,'m06_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3665,20400,'','".AddSlashes(pg_fetch_result($resaco,0,'m06_posicaoestoqueprocessamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3665,20393,'','".AddSlashes(pg_fetch_result($resaco,0,'m06_matestoque'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3665,20394,'','".AddSlashes(pg_fetch_result($resaco,0,'m06_quantidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3665,20395,'','".AddSlashes(pg_fetch_result($resaco,0,'m06_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3665,20396,'','".AddSlashes(pg_fetch_result($resaco,0,'m06_precomedio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($m06_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->m06_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m06_sequencial"])){ 
       $sql  .= $virgula." m06_sequencial = $this->m06_sequencial ";
       $virgula = ",";
       if(trim((string) $this->m06_sequencial) == null ){ 
     ...
     if(trim((string) $this->m06_posicaoestoqueprocessamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m06_posicaoestoqueprocessamento"])){ 
       $sql  .= $virgula." m06_posicaoestoqueprocessamento = $this->m06_posicaoestoqueprocessamento ";
       $virgula = ",";
       if(trim((string) $this->m06_posicaoestoqueprocessamento) == null ){ 
         $this->erro_sql = " Campo Código do Processamento não informado.";
         $this->erro_campo = "m06_posicaoestoqueprocessamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m06_matestoque)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m06_matestoque"])){ 
       $sql  .= $virgula." m06_matestoque = $this->m06_matestoque ";
       $virgula = ",";
       if(trim((string) $this->m06_matestoque) == null ){ 
         $this->erro_sql = " Campo Código do Estoque não informado.";
         $this->erro_campo = "m06_matestoque";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m06_quantidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m06_quantidade"])){ 
       $sql  .= $virgula." m06_quantidade = $this->m06_quantidade ";
       $virgula = ",";
       if(trim((string) $this->m06_quantidade) == null ){ 
         $this->erro_sql = " Campo Quantidade não informado.";
         $this->erro_campo = "m06_quantidade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m06_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m06_valor"])){ 
       $sql  .= $virgula." m06_valor = $this->m06_valor ";
       $virgula = ",";
       if(trim((string) $this->m06_valor) == null ){ 
         $this->erro_sql = " Campo Valor Total não informado.";
         $this->erro_campo = "m06_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m06_precomedio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m06_precomedio"])){ 
       $sql  .= $virgula." m06_precomedio = $this->m06_precomedio ";
       $virgula = ",";
       if(trim((string) $this->m06_precomedio) == null ){ 
         $this->erro_sql = " Campo Preço Médio não informado.";
         $this->erro_campo = "m06_precomedio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["m06_sequencial"]) || $this->m06_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3665,20392,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m06_sequencial'))."','$this->m06_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["m06_posicaoestoqueprocessamento"]) || $this->m06_posicaoestoqueprocessamento != "")
             $resac = db_query("insert into db_acount values($acount,3665,20400,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m06_posicaoestoqueprocessamento'))."','$this->m06_posicaoestoqueprocessamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["m06_matestoque"]) || $this->m06_matestoque != "")
             $resac = db_query("insert into db_acount values($acount,3665,20393,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m06_matestoque'))."','$this->m06_matestoque',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["m06_quantidade"]) || $this->m06_quantidade != "")
             $resac = db_query("insert into db_acount values($acount,3665,20394,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m06_quantidade'))."','$this->m06_quantidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["m06_valor"]) || $this->m06_valor != "")
             $resac = db_query("insert into db_acount values($acount,3665,20395,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m06_valor'))."','$this->m06_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["m06_precomedio"]) || $this->m06_precomedio != "")
             $resac = db_query("insert into db_acount values($acount,3665,20396,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m06_precomedio'))."','$this->m06_precomedio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3665,20392,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m06_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3665,20400,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m06_posicaoestoqueprocessamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3665,20393,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m06_matestoque'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3665,20394,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m06_quantidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3665,20395,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m06_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3665,20396,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m06_precomedio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
