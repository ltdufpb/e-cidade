...
class cl_tabativtipcalc { 
   ...
   function incluir ($q11_inscr,$q11_seq){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,68,298,'','".AddSlashes(pg_fetch_result($resaco,0,'q11_inscr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,68,299,'','".AddSlashes(pg_fetch_result($resaco,0,'q11_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,68,300,'','".AddSlashes(pg_fetch_result($resaco,0,'q11_tipcalc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q11_inscr=null,$q11_seq=null) { 
     ...
     if(trim((string) $this->q11_tipcalc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q11_tipcalc"])){ 
        if(trim((string) $this->q11_tipcalc)=="" && isset($GLOBALS["HTTP_POST_VARS"]["q11_tipcalc"])){ 
           $this->q11_tipcalc = "0" ; 
        } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q11_inscr"]))
           $resac = db_query("insert into db_acount values($acount,68,298,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q11_inscr'))."','$this->q11_inscr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q11_seq"]))
           $resac = db_query("insert into db_acount values($acount,68,299,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q11_seq'))."','$this->q11_seq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q11_tipcalc"]))
           $resac = db_query("insert into db_acount values($acount,68,300,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q11_tipcalc'))."','$this->q11_tipcalc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q11_inscr=null,$q11_seq=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,68,298,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q11_inscr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,68,299,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q11_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,68,300,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q11_tipcalc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
