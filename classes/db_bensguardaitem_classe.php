...
class cl_bensguardaitem { 
   ...
   public $t22_codigo = 0; 
   public $t22_bensguarda = 0; 
   public $t22_bem = 0; 
   public $t22_dtini_dia = null; 
   public $t22_dtini_mes = null; 
   public $t22_dtini_ano = null; 
   public $t22_dtini = null; 
   public $t22_dtfim_dia = null; 
   public $t22_dtfim_mes = null; 
   public $t22_dtfim_ano = null; 
   public $t22_dtfim = null; 
   public $t22_obs = null; 
   public $t22_usuario = 0; 
   ...
   function incluir ($t22_codigo){ 
     ...
     if($t22_codigo == "" || $t22_codigo == null ){
       ...
       $this->t22_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from bensguardaitem_t22_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $t22_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1534,8958,'','".AddSlashes(pg_fetch_result($resaco,0,'t22_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1534,8959,'','".AddSlashes(pg_fetch_result($resaco,0,'t22_bensguarda'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1534,8960,'','".AddSlashes(pg_fetch_result($resaco,0,'t22_bem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1534,8961,'','".AddSlashes(pg_fetch_result($resaco,0,'t22_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1534,8962,'','".AddSlashes(pg_fetch_result($resaco,0,'t22_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1534,8963,'','".AddSlashes(pg_fetch_result($resaco,0,'t22_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1534,8964,'','".AddSlashes(pg_fetch_result($resaco,0,'t22_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($t22_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->t22_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t22_codigo"])){ 
       $sql  .= $virgula." t22_codigo = $this->t22_codigo ";
       $virgula = ",";
       if(trim((string) $this->t22_codigo) == null ){ 
     ...
     if(trim((string) $this->t22_bensguarda)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t22_bensguarda"])){ 
       $sql  .= $virgula." t22_bensguarda = $this->t22_bensguarda ";
       $virgula = ",";
       if(trim((string) $this->t22_bensguarda) == null ){ 
         $this->erro_sql = " Campo Cod. Guarda nao Informado.";
         $this->erro_campo = "t22_bensguarda";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->t22_bem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t22_bem"])){ 
       $sql  .= $virgula." t22_bem = $this->t22_bem ";
       $virgula = ",";
       if(trim((string) $this->t22_bem) == null ){ 
         $this->erro_sql = " Campo Código do bem nao Informado.";
         $this->erro_campo = "t22_bem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->t22_dtini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t22_dtini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["t22_dtini_dia"] !="") ){ 
       $sql  .= $virgula." t22_dtini = '$this->t22_dtini' ";
       $virgula = ",";
       if(trim((string) $this->t22_dtini) == null ){ 
         $this->erro_sql = " Campo Data Início nao Informado.";
         $this->erro_campo = "t22_dtini_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->t22_dtfim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t22_dtfim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["t22_dtfim_dia"] !="") ){ 
     ...
     if(trim((string) $this->t22_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t22_obs"])){ 
       $sql  .= $virgula." t22_obs = '$this->t22_obs' ";
       $virgula = ",";
     }
     if(trim((string) $this->t22_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t22_usuario"])){ 
       $sql  .= $virgula." t22_usuario = $this->t22_usuario ";
       $virgula = ",";
       if(trim((string) $this->t22_usuario) == null ){ 
         $this->erro_sql = " Campo Cod. Usuário nao Informado.";
         $this->erro_campo = "t22_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["t22_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1534,8958,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t22_codigo'))."','$this->t22_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t22_bensguarda"]))
           $resac = db_query("insert into db_acount values($acount,1534,8959,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t22_bensguarda'))."','$this->t22_bensguarda',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t22_bem"]))
           $resac = db_query("insert into db_acount values($acount,1534,8960,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t22_bem'))."','$this->t22_bem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t22_dtini"]))
           $resac = db_query("insert into db_acount values($acount,1534,8961,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t22_dtini'))."','$this->t22_dtini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t22_dtfim"]))
           $resac = db_query("insert into db_acount values($acount,1534,8962,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t22_dtfim'))."','$this->t22_dtfim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t22_obs"]))
           $resac = db_query("insert into db_acount values($acount,1534,8963,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t22_obs'))."','$this->t22_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t22_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1534,8964,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t22_usuario'))."','$this->t22_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($t22_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1534,8958,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t22_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1534,8959,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t22_bensguarda'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1534,8960,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t22_bem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1534,8961,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t22_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1534,8962,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t22_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1534,8963,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t22_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1534,8964,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t22_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
