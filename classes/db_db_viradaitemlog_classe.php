...
class cl_db_viradaitemlog { 
   ...
   public $c35_sequencial = 0; 
   public $c35_codarq = 0; 
   public $c35_db_viradaitem = 0; 
   public $c35_data_dia = null; 
   public $c35_data_mes = null; 
   public $c35_data_ano = null; 
   public $c35_data = null; 
   public $c35_hora = null; 
   public $c35_log = null; 
   ...
   function incluir ($c35_sequencial){ 
     ...
     if($c35_sequencial == "" || $c35_sequencial == null ){
       ...
       $this->c35_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_viradaitemlog_c35_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $c35_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1864,10825,'','".AddSlashes(pg_fetch_result($resaco,0,'c35_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1864,10826,'','".AddSlashes(pg_fetch_result($resaco,0,'c35_codarq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1864,10827,'','".AddSlashes(pg_fetch_result($resaco,0,'c35_db_viradaitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1864,10828,'','".AddSlashes(pg_fetch_result($resaco,0,'c35_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1864,10829,'','".AddSlashes(pg_fetch_result($resaco,0,'c35_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1864,10830,'','".AddSlashes(pg_fetch_result($resaco,0,'c35_log'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($c35_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->c35_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c35_sequencial"])){ 
       $sql  .= $virgula." c35_sequencial = $this->c35_sequencial ";
       $virgula = ",";
       if(trim((string) $this->c35_sequencial) == null ){ 
     ...
     if(trim((string) $this->c35_codarq)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c35_codarq"])){ 
       $sql  .= $virgula." c35_codarq = $this->c35_codarq ";
       $virgula = ",";
       if(trim((string) $this->c35_codarq) == null ){ 
         $this->erro_sql = " Campo Código da tabela nao Informado.";
         $this->erro_campo = "c35_codarq";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c35_db_viradaitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c35_db_viradaitem"])){ 
       $sql  .= $virgula." c35_db_viradaitem = $this->c35_db_viradaitem ";
       $virgula = ",";
       if(trim((string) $this->c35_db_viradaitem) == null ){ 
         $this->erro_sql = " Campo Código da virada do item nao Informado.";
         $this->erro_campo = "c35_db_viradaitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c35_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c35_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["c35_data_dia"] !="") ){ 
       $sql  .= $virgula." c35_data = '$this->c35_data' ";
       $virgula = ",";
       if(trim((string) $this->c35_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "c35_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c35_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c35_hora"])){ 
       $sql  .= $virgula." c35_hora = '$this->c35_hora' ";
       $virgula = ",";
       if(trim((string) $this->c35_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "c35_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c35_log)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c35_log"])){ 
       $sql  .= $virgula." c35_log = '$this->c35_log' ";
       $virgula = ",";
       if(trim((string) $this->c35_log) == null ){ 
         $this->erro_sql = " Campo Log nao Informado.";
         $this->erro_campo = "c35_log";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c35_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1864,10825,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c35_sequencial'))."','$this->c35_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c35_codarq"]))
           $resac = db_query("insert into db_acount values($acount,1864,10826,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c35_codarq'))."','$this->c35_codarq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c35_db_viradaitem"]))
           $resac = db_query("insert into db_acount values($acount,1864,10827,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c35_db_viradaitem'))."','$this->c35_db_viradaitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c35_data"]))
           $resac = db_query("insert into db_acount values($acount,1864,10828,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c35_data'))."','$this->c35_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c35_hora"]))
           $resac = db_query("insert into db_acount values($acount,1864,10829,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c35_hora'))."','$this->c35_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c35_log"]))
           $resac = db_query("insert into db_acount values($acount,1864,10830,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c35_log'))."','$this->c35_log',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($c35_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1864,10825,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c35_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1864,10826,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c35_codarq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1864,10827,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c35_db_viradaitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1864,10828,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c35_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1864,10829,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c35_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1864,10830,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c35_log'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
