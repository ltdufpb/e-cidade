...
class cl_diversos { 
   ...
   function incluir ($dv05_coddiver){ 
     ...
     if($dv05_coddiver == "" || $dv05_coddiver == null ){
       ...
       $this->dv05_coddiver = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from diversos_dv05_coddiver_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $dv05_coddiver)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,372,3470,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_coddiver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,372,3471,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,372,3472,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_dtinsc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,372,3473,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_exerc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,372,3474,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,372,3478,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_vlrhis'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,372,3479,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_procdiver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,372,4760,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_numtot'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,372,4761,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_privenc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,372,3481,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_provenc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,372,4762,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_diaprox'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,372,3482,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_oper'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,372,3483,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,372,3480,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,372,10552,'','".AddSlashes(pg_fetch_result($resaco,0,'dv05_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($dv05_coddiver=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->dv05_coddiver)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_coddiver"])){ 
       $sql  .= $virgula." dv05_coddiver = $this->dv05_coddiver ";
       $virgula = ",";
       if(trim((string) $this->dv05_coddiver) == null ){ 
     ...
     if(trim((string) $this->dv05_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_numcgm"])){ 
       $sql  .= $virgula." dv05_numcgm = $this->dv05_numcgm ";
       $virgula = ",";
       if(trim((string) $this->dv05_numcgm) == null ){ 
         $this->erro_sql = " Campo Numcgm nao Informado.";
         $this->erro_campo = "dv05_numcgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->dv05_dtinsc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_dtinsc_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["dv05_dtinsc_dia"] !="") ){ 
       $sql  .= $virgula." dv05_dtinsc = '$this->dv05_dtinsc' ";
       $virgula = ",";
       if(trim((string) $this->dv05_dtinsc) == null ){ 
         $this->erro_sql = " Campo Data da Inscrição nao Informado.";
         $this->erro_campo = "dv05_dtinsc_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->dv05_exerc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_exerc"])){ 
       $sql  .= $virgula." dv05_exerc = $this->dv05_exerc ";
       $virgula = ",";
       if(trim((string) $this->dv05_exerc) == null ){ 
         $this->erro_sql = " Campo Ano de Origem nao Informado.";
         $this->erro_campo = "dv05_exerc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->dv05_numpre)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_numpre"])){ 
       $sql  .= $virgula." dv05_numpre = $this->dv05_numpre ";
       $virgula = ",";
       if(trim((string) $this->dv05_numpre) == null ){ 
         $this->erro_sql = " Campo Código de Arrecadação nao Informado.";
         $this->erro_campo = "dv05_numpre";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->dv05_vlrhis)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_vlrhis"])){ 
       $sql  .= $virgula." dv05_vlrhis = $this->dv05_vlrhis ";
       $virgula = ",";
       if(trim((string) $this->dv05_vlrhis) == null ){ 
         $this->erro_sql = " Campo Valor Histórico nao Informado.";
         $this->erro_campo = "dv05_vlrhis";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->dv05_procdiver)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_procdiver"])){ 
       $sql  .= $virgula." dv05_procdiver = $this->dv05_procdiver ";
       $virgula = ",";
       if(trim((string) $this->dv05_procdiver) == null ){ 
         $this->erro_sql = " Campo Procedência nao Informado.";
         $this->erro_campo = "dv05_procdiver";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->dv05_numtot)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_numtot"])){ 
       $sql  .= $virgula." dv05_numtot = $this->dv05_numtot ";
       $virgula = ",";
       if(trim((string) $this->dv05_numtot) == null ){ 
         $this->erro_sql = " Campo Numero de parcelas nao Informado.";
         $this->erro_campo = "dv05_numtot";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->dv05_privenc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_privenc_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["dv05_privenc_dia"] !="") ){ 
       $sql  .= $virgula." dv05_privenc = '$this->dv05_privenc' ";
       $virgula = ",";
       if(trim((string) $this->dv05_privenc) == null ){ 
         $this->erro_sql = " Campo Primeiro vencimento nao Informado.";
         $this->erro_campo = "dv05_privenc_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->dv05_provenc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_provenc_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["dv05_provenc_dia"] !="") ){ 
       $sql  .= $virgula." dv05_provenc = '$this->dv05_provenc' ";
       $virgula = ",";
       if(trim((string) $this->dv05_provenc) == null ){ 
         $this->erro_sql = " Campo Próximo vencimento nao Informado.";
         $this->erro_campo = "dv05_provenc_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->dv05_diaprox)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_diaprox"])){ 
       $sql  .= $virgula." dv05_diaprox = $this->dv05_diaprox ";
       $virgula = ",";
       if(trim((string) $this->dv05_diaprox) == null ){ 
         $this->erro_sql = " Campo Dia dos próximos vencimentos nao Informado.";
         $this->erro_campo = "dv05_diaprox";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->dv05_oper)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_oper_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["dv05_oper_dia"] !="") ){ 
       $sql  .= $virgula." dv05_oper = '$this->dv05_oper' ";
       $virgula = ",";
       if(trim((string) $this->dv05_oper) == null ){ 
         $this->erro_sql = " Campo Data da Operação nao Informado.";
         $this->erro_campo = "dv05_oper_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->dv05_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_valor"])){ 
       $sql  .= $virgula." dv05_valor = $this->dv05_valor ";
       $virgula = ",";
       if(trim((string) $this->dv05_valor) == null ){ 
         $this->erro_sql = " Campo Valor Corrigido nao Informado.";
         $this->erro_campo = "dv05_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->dv05_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_obs"])){ 
       $sql  .= $virgula." dv05_obs = '$this->dv05_obs' ";
       $virgula = ",";
     }
     if(trim((string) $this->dv05_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["dv05_instit"])){ 
       $sql  .= $virgula." dv05_instit = $this->dv05_instit ";
       $virgula = ",";
       if(trim((string) $this->dv05_instit) == null ){ 
         $this->erro_sql = " Campo Instituição nao Informado.";
         $this->erro_campo = "dv05_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_coddiver"]) || $this->dv05_coddiver != "")
           $resac = db_query("insert into db_acount values($acount,372,3470,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_coddiver'))."','$this->dv05_coddiver',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_numcgm"]) || $this->dv05_numcgm != "")
           $resac = db_query("insert into db_acount values($acount,372,3471,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_numcgm'))."','$this->dv05_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_dtinsc"]) || $this->dv05_dtinsc != "")
           $resac = db_query("insert into db_acount values($acount,372,3472,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_dtinsc'))."','$this->dv05_dtinsc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_exerc"]) || $this->dv05_exerc != "")
           $resac = db_query("insert into db_acount values($acount,372,3473,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_exerc'))."','$this->dv05_exerc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_numpre"]) || $this->dv05_numpre != "")
           $resac = db_query("insert into db_acount values($acount,372,3474,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_numpre'))."','$this->dv05_numpre',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_vlrhis"]) || $this->dv05_vlrhis != "")
           $resac = db_query("insert into db_acount values($acount,372,3478,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_vlrhis'))."','$this->dv05_vlrhis',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_procdiver"]) || $this->dv05_procdiver != "")
           $resac = db_query("insert into db_acount values($acount,372,3479,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_procdiver'))."','$this->dv05_procdiver',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_numtot"]) || $this->dv05_numtot != "")
           $resac = db_query("insert into db_acount values($acount,372,4760,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_numtot'))."','$this->dv05_numtot',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_privenc"]) || $this->dv05_privenc != "")
           $resac = db_query("insert into db_acount values($acount,372,4761,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_privenc'))."','$this->dv05_privenc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_provenc"]) || $this->dv05_provenc != "")
           $resac = db_query("insert into db_acount values($acount,372,3481,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_provenc'))."','$this->dv05_provenc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_diaprox"]) || $this->dv05_diaprox != "")
           $resac = db_query("insert into db_acount values($acount,372,4762,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_diaprox'))."','$this->dv05_diaprox',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_oper"]) || $this->dv05_oper != "")
           $resac = db_query("insert into db_acount values($acount,372,3482,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_oper'))."','$this->dv05_oper',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_valor"]) || $this->dv05_valor != "")
           $resac = db_query("insert into db_acount values($acount,372,3483,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_valor'))."','$this->dv05_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_obs"]) || $this->dv05_obs != "")
           $resac = db_query("insert into db_acount values($acount,372,3480,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_obs'))."','$this->dv05_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["dv05_instit"]) || $this->dv05_instit != "")
           $resac = db_query("insert into db_acount values($acount,372,10552,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'dv05_instit'))."','$this->dv05_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($dv05_coddiver=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,372,3470,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_coddiver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,372,3471,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,372,3472,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_dtinsc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,372,3473,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_exerc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,372,3474,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,372,3478,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_vlrhis'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,372,3479,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_procdiver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,372,4760,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_numtot'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,372,4761,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_privenc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,372,3481,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_provenc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,372,4762,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_diaprox'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,372,3482,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_oper'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,372,3483,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,372,3480,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,372,10552,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'dv05_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
