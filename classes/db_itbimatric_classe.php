...
class cl_itbimatric { 
   ...
   function alterar ($it06_guia=null,$it06_matric=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->it06_guia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it06_guia"])){ 
       $sql  .= $virgula." it06_guia = $this->it06_guia ";
       $virgula = ",";
       if(trim((string) $this->it06_guia) == null ){ 
     ...
     if(trim((string) $this->it06_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it06_matric"])){ 
       $sql  .= $virgula." it06_matric = $this->it06_matric ";
       $virgula = ",";
       if(trim((string) $this->it06_matric) == null ){ 
