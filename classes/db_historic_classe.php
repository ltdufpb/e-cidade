...
class cl_historic { 
   ...
   public $r25_anousu = 0; 
   public $r25_mesusu = 0; 
   public $r25_codigo = null; 
   public $r25_descr = null; 
   ...
   function incluir ($r25_anousu,$r25_mesusu,$r25_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,560,4005,'','".AddSlashes(pg_fetch_result($resaco,0,'r25_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,560,4006,'','".AddSlashes(pg_fetch_result($resaco,0,'r25_mesusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,560,4007,'','".AddSlashes(pg_fetch_result($resaco,0,'r25_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,560,4008,'','".AddSlashes(pg_fetch_result($resaco,0,'r25_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($r25_anousu=null,$r25_mesusu=null,$r25_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->r25_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r25_anousu"])){ 
       $sql  .= $virgula." r25_anousu = $this->r25_anousu ";
       $virgula = ",";
       if(trim((string) $this->r25_anousu) == null ){ 
     ...
     if(trim((string) $this->r25_mesusu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r25_mesusu"])){ 
       $sql  .= $virgula." r25_mesusu = $this->r25_mesusu ";
       $virgula = ",";
       if(trim((string) $this->r25_mesusu) == null ){ 
     ...
     if(trim((string) $this->r25_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r25_codigo"])){ 
       $sql  .= $virgula." r25_codigo = '$this->r25_codigo' ";
       $virgula = ",";
       if(trim((string) $this->r25_codigo) == null ){ 
     ...
     if(trim((string) $this->r25_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r25_descr"])){ 
       $sql  .= $virgula." r25_descr = '$this->r25_descr' ";
       $virgula = ",";
       if(trim((string) $this->r25_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "r25_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["r25_anousu"]))
           $resac = db_query("insert into db_acount values($acount,560,4005,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r25_anousu'))."','$this->r25_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r25_mesusu"]))
           $resac = db_query("insert into db_acount values($acount,560,4006,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r25_mesusu'))."','$this->r25_mesusu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r25_codigo"]))
           $resac = db_query("insert into db_acount values($acount,560,4007,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r25_codigo'))."','$this->r25_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r25_descr"]))
           $resac = db_query("insert into db_acount values($acount,560,4008,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r25_descr'))."','$this->r25_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($r25_anousu=null,$r25_mesusu=null,$r25_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,560,4005,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r25_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,560,4006,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r25_mesusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,560,4007,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r25_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,560,4008,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r25_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
