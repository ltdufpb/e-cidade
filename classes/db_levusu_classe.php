...
class cl_levusu { 
   ...
   function incluir ($y61_codlev,$y61_id_usuario){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,710,5020,'','".AddSlashes(pg_fetch_result($resaco,0,'y61_codlev'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,710,5021,'','".AddSlashes(pg_fetch_result($resaco,0,'y61_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,710,5022,'','".AddSlashes(pg_fetch_result($resaco,0,'y61_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y61_codlev=null,$y61_id_usuario=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y61_codlev)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y61_codlev"])){ 
       $sql  .= $virgula." y61_codlev = $this->y61_codlev ";
       $virgula = ",";
       if(trim((string) $this->y61_codlev) == null ){ 
     ...
     if(trim((string) $this->y61_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y61_id_usuario"])){ 
       $sql  .= $virgula." y61_id_usuario = $this->y61_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->y61_id_usuario) == null ){ 
     ...
     if(trim((string) $this->y61_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y61_obs"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y61_codlev"]))
           $resac = db_query("insert into db_acount values($acount,710,5020,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y61_codlev'))."','$this->y61_codlev',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y61_id_usuario"]))
           $resac = db_query("insert into db_acount values($acount,710,5021,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y61_id_usuario'))."','$this->y61_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y61_obs"]))
           $resac = db_query("insert into db_acount values($acount,710,5022,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y61_obs'))."','$this->y61_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y61_codlev=null,$y61_id_usuario=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,710,5020,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y61_codlev'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,710,5021,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y61_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,710,5022,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y61_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
