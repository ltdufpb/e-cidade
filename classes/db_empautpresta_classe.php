...
class cl_empautpresta {
   ...
   function alterar ( $oid=null ) {
     ...
     $virgula = "";
     if(trim((string) $this->e58_autori)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e58_autori"])){
       $sql  .= $virgula." e58_autori = $this->e58_autori ";
       $virgula = ",";
       if(trim((string) $this->e58_autori) == null ){
         $this->erro_sql = " Campo Autorização nao Informado.";
         $this->erro_campo = "e58_autori";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e58_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e58_tipo"])){
       $sql  .= $virgula." e58_tipo = $this->e58_tipo ";
       $virgula = ",";
       if(trim((string) $this->e58_tipo) == null ){
         $this->erro_sql = " Campo Tipo de Prestação de contas nao Informado.";
         $this->erro_campo = "e58_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
