...
class cl_inicialcert {
   ...
   public $v51_inicial = 0;
   public $v51_certidao = 0;
   ...
   function incluir ($v51_inicial,$v51_certidao){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,111,2567,'','".AddSlashes(pg_fetch_result($resaco,0,'v51_inicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,111,575,'','".AddSlashes(pg_fetch_result($resaco,0,'v51_certidao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($v51_inicial=null,$v51_certidao=null) {
     ...
     $virgula = "";
     if(trim((string) $this->v51_inicial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v51_inicial"])){
       $sql  .= $virgula." v51_inicial = $this->v51_inicial ";
       $virgula = ",";
       if(trim((string) $this->v51_inicial) == null ){
     ...
     if(trim((string) $this->v51_certidao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v51_certidao"])){
       $sql  .= $virgula." v51_certidao = $this->v51_certidao ";
       $virgula = ",";
       if(trim((string) $this->v51_certidao) == null ){
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v51_inicial"]))
           $resac = db_query("insert into db_acount values($acount,111,2567,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v51_inicial'))."','$this->v51_inicial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v51_certidao"]))
           $resac = db_query("insert into db_acount values($acount,111,575,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v51_certidao'))."','$this->v51_certidao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($v51_inicial=null,$v51_certidao=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,111,2567,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v51_inicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,111,575,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v51_certidao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
