...
class cl_veicpatri { 
   ...
   public $ve03_codigo = 0; 
   public $ve03_veiculo = 0; 
   public $ve03_bem = 0; 
   ...
   function incluir ($ve03_codigo){ 
     ...
     if($ve03_codigo == "" || $ve03_codigo == null ){
       ...
       $this->ve03_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veicpatri_ve03_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve03_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1592,9266,'','".AddSlashes(pg_fetch_result($resaco,0,'ve03_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1592,9267,'','".AddSlashes(pg_fetch_result($resaco,0,'ve03_veiculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1592,9268,'','".AddSlashes(pg_fetch_result($resaco,0,'ve03_bem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve03_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve03_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve03_codigo"])){ 
       $sql  .= $virgula." ve03_codigo = $this->ve03_codigo ";
       $virgula = ",";
       if(trim((string) $this->ve03_codigo) == null ){ 
     ...
     if(trim((string) $this->ve03_veiculo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve03_veiculo"])){ 
       $sql  .= $virgula." ve03_veiculo = $this->ve03_veiculo ";
       $virgula = ",";
       if(trim((string) $this->ve03_veiculo) == null ){ 
         $this->erro_sql = " Campo Veiculo nao Informado.";
         $this->erro_campo = "ve03_veiculo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve03_bem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve03_bem"])){ 
       $sql  .= $virgula." ve03_bem = $this->ve03_bem ";
       $virgula = ",";
       if(trim((string) $this->ve03_bem) == null ){ 
         $this->erro_sql = " Campo Bem nao Informado.";
         $this->erro_campo = "ve03_bem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve03_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1592,9266,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve03_codigo'))."','$this->ve03_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve03_veiculo"]))
           $resac = db_query("insert into db_acount values($acount,1592,9267,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve03_veiculo'))."','$this->ve03_veiculo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve03_bem"]))
           $resac = db_query("insert into db_acount values($acount,1592,9268,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve03_bem'))."','$this->ve03_bem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve03_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1592,9266,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve03_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1592,9267,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve03_veiculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1592,9268,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve03_bem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
