...
class cl_aguahidromarca { 
   ...
   public $x03_codmarca = 0; 
   public $x03_nomemarca = null; 
   public $x03_sigla = null; 
   ...
   function incluir ($x03_codmarca){ 
     ...
     if($x03_codmarca == "" || $x03_codmarca == null ){
       ...
       $this->x03_codmarca = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from aguahidro_x03_codmarca_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $x03_codmarca)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1420,8384,'','".AddSlashes(pg_fetch_result($resaco,0,'x03_codmarca'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1420,8385,'','".AddSlashes(pg_fetch_result($resaco,0,'x03_nomemarca'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1420,8574,'','".AddSlashes(pg_fetch_result($resaco,0,'x03_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($x03_codmarca=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->x03_codmarca)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x03_codmarca"])){ 
       $sql  .= $virgula." x03_codmarca = $this->x03_codmarca ";
       $virgula = ",";
       if(trim((string) $this->x03_codmarca) == null ){ 
     ...
     if(trim((string) $this->x03_nomemarca)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x03_nomemarca"])){ 
       $sql  .= $virgula." x03_nomemarca = '$this->x03_nomemarca' ";
       $virgula = ",";
       if(trim((string) $this->x03_nomemarca) == null ){ 
         $this->erro_sql = " Campo Marca nao Informado.";
         $this->erro_campo = "x03_nomemarca";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->x03_sigla)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x03_sigla"])){ 
       $sql  .= $virgula." x03_sigla = '$this->x03_sigla' ";
       $virgula = ",";
       if(trim((string) $this->x03_sigla) == null ){ 
         $this->erro_sql = " Campo Sigla nao Informado.";
         $this->erro_campo = "x03_sigla";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x03_codmarca"]))
           $resac = db_query("insert into db_acount values($acount,1420,8384,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x03_codmarca'))."','$this->x03_codmarca',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x03_nomemarca"]))
           $resac = db_query("insert into db_acount values($acount,1420,8385,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x03_nomemarca'))."','$this->x03_nomemarca',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x03_sigla"]))
           $resac = db_query("insert into db_acount values($acount,1420,8574,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x03_sigla'))."','$this->x03_sigla',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($x03_codmarca=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1420,8384,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x03_codmarca'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1420,8385,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x03_nomemarca'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1420,8574,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x03_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
