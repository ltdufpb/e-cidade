...
class cl_orcsuplemreceitappa { 
   ...
   public $o137_sequencial = 0; 
   public $o137_orcsuplem = 0; 
   public $o137_ppaestimativareceita = 0; 
   public $o137_valor = 0; 
   ...
   function incluir ($o137_sequencial){ 
     ...
     if($o137_sequencial == "" || $o137_sequencial == null ){
       ...
       $this->o137_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from orcsuplemreceitappa_o137_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $o137_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3122,17677,'','".AddSlashes(pg_fetch_result($resaco,0,'o137_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3122,17678,'','".AddSlashes(pg_fetch_result($resaco,0,'o137_orcsuplem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3122,17679,'','".AddSlashes(pg_fetch_result($resaco,0,'o137_ppaestimativareceita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3122,17680,'','".AddSlashes(pg_fetch_result($resaco,0,'o137_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o137_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o137_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o137_sequencial"])){ 
       $sql  .= $virgula." o137_sequencial = $this->o137_sequencial ";
       $virgula = ",";
       if(trim((string) $this->o137_sequencial) == null ){ 
     ...
     if(trim((string) $this->o137_orcsuplem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o137_orcsuplem"])){ 
       $sql  .= $virgula." o137_orcsuplem = $this->o137_orcsuplem ";
       $virgula = ",";
       if(trim((string) $this->o137_orcsuplem) == null ){ 
         $this->erro_sql = " Campo Suplementação nao Informado.";
         $this->erro_campo = "o137_orcsuplem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o137_ppaestimativareceita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o137_ppaestimativareceita"])){ 
       $sql  .= $virgula." o137_ppaestimativareceita = $this->o137_ppaestimativareceita ";
       $virgula = ",";
       if(trim((string) $this->o137_ppaestimativareceita) == null ){ 
         $this->erro_sql = " Campo Estimativa da Receita nao Informado.";
         $this->erro_campo = "o137_ppaestimativareceita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o137_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o137_valor"])){ 
       $sql  .= $virgula." o137_valor = $this->o137_valor ";
       $virgula = ",";
       if(trim((string) $this->o137_valor) == null ){ 
         $this->erro_sql = " Campo Valor nao Informado.";
         $this->erro_campo = "o137_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o137_sequencial"]) || $this->o137_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3122,17677,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o137_sequencial'))."','$this->o137_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o137_orcsuplem"]) || $this->o137_orcsuplem != "")
           $resac = db_query("insert into db_acount values($acount,3122,17678,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o137_orcsuplem'))."','$this->o137_orcsuplem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o137_ppaestimativareceita"]) || $this->o137_ppaestimativareceita != "")
           $resac = db_query("insert into db_acount values($acount,3122,17679,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o137_ppaestimativareceita'))."','$this->o137_ppaestimativareceita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o137_valor"]) || $this->o137_valor != "")
           $resac = db_query("insert into db_acount values($acount,3122,17680,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o137_valor'))."','$this->o137_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o137_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3122,17677,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o137_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3122,17678,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o137_orcsuplem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3122,17679,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o137_ppaestimativareceita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3122,17680,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o137_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
