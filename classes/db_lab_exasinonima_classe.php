...
class cl_lab_exasinonima { 
   ...
   public $la18_i_codigo = 0; 
   public $la18_i_sinonima = 0; 
   public $la18_i_exame = 0; 
   ...
   function incluir ($la18_i_codigo){ 
     ...
     if($la18_i_codigo == "" || $la18_i_codigo == null ){
       ...
       $this->la18_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from lab_exasinonima_la18_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $la18_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2768,15821,'','".AddSlashes(pg_fetch_result($resaco,0,'la18_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2768,15822,'','".AddSlashes(pg_fetch_result($resaco,0,'la18_i_sinonima'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2768,15823,'','".AddSlashes(pg_fetch_result($resaco,0,'la18_i_exame'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($la18_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->la18_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la18_i_codigo"])){ 
       $sql  .= $virgula." la18_i_codigo = $this->la18_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->la18_i_codigo) == null ){ 
     ...
     if(trim((string) $this->la18_i_sinonima)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la18_i_sinonima"])){ 
       $sql  .= $virgula." la18_i_sinonima = $this->la18_i_sinonima ";
       $virgula = ",";
       if(trim((string) $this->la18_i_sinonima) == null ){ 
         $this->erro_sql = " Campo Sinônima nao Informado.";
         $this->erro_campo = "la18_i_sinonima";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->la18_i_exame)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la18_i_exame"])){ 
       $sql  .= $virgula." la18_i_exame = $this->la18_i_exame ";
       $virgula = ",";
       if(trim((string) $this->la18_i_exame) == null ){ 
         $this->erro_sql = " Campo Exame nao Informado.";
         $this->erro_campo = "la18_i_exame";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["la18_i_codigo"]) || $this->la18_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2768,15821,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la18_i_codigo'))."','$this->la18_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la18_i_sinonima"]) || $this->la18_i_sinonima != "")
           $resac = db_query("insert into db_acount values($acount,2768,15822,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la18_i_sinonima'))."','$this->la18_i_sinonima',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la18_i_exame"]) || $this->la18_i_exame != "")
           $resac = db_query("insert into db_acount values($acount,2768,15823,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la18_i_exame'))."','$this->la18_i_exame',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($la18_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2768,15821,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la18_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2768,15822,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la18_i_sinonima'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2768,15823,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la18_i_exame'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
