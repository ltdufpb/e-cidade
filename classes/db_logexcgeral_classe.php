...
class cl_logexcgeral {
   ...
   public $ed256_i_codigo = 0;
   public $ed256_i_usuario = 0;
   public $ed256_i_escola = 0;
   public $ed256_d_data_dia = null;
   public $ed256_d_data_mes = null;
   public $ed256_d_data_ano = null;
   public $ed256_d_data = null;
   public $ed256_c_hora = null;
   public $ed256_c_evento = null;
   public $ed256_t_descr = null;
   ...
   function incluir ($ed256_i_codigo){
     ...
     if($ed256_i_codigo == "" || $ed256_i_codigo == null ){
       ...
       $this->ed256_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from logexcgeral_ed256_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed256_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2348,13423,'','".AddSlashes(pg_fetch_result($resaco,0,'ed256_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2348,13424,'','".AddSlashes(pg_fetch_result($resaco,0,'ed256_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2348,13428,'','".AddSlashes(pg_fetch_result($resaco,0,'ed256_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2348,13425,'','".AddSlashes(pg_fetch_result($resaco,0,'ed256_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2348,13426,'','".AddSlashes(pg_fetch_result($resaco,0,'ed256_c_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2348,13427,'','".AddSlashes(pg_fetch_result($resaco,0,'ed256_c_evento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2348,13429,'','".AddSlashes(pg_fetch_result($resaco,0,'ed256_t_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($ed256_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->ed256_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed256_i_codigo"])){
       $sql  .= $virgula." ed256_i_codigo = $this->ed256_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed256_i_codigo) == null ){
     ...
     if(trim((string) $this->ed256_i_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed256_i_usuario"])){
       $sql  .= $virgula." ed256_i_usuario = $this->ed256_i_usuario ";
       $virgula = ",";
       if(trim((string) $this->ed256_i_usuario) == null ){
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "ed256_i_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed256_i_escola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed256_i_escola"])){
       $sql  .= $virgula." ed256_i_escola = $this->ed256_i_escola ";
       $virgula = ",";
       if(trim((string) $this->ed256_i_escola) == null ){
         $this->erro_sql = " Campo Escola nao Informado.";
         $this->erro_campo = "ed256_i_escola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed256_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed256_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed256_d_data_dia"] !="") ){
       $sql  .= $virgula." ed256_d_data = '$this->ed256_d_data' ";
       $virgula = ",";
       if(trim((string) $this->ed256_d_data) == null ){
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "ed256_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed256_c_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed256_c_hora"])){
       $sql  .= $virgula." ed256_c_hora = '$this->ed256_c_hora' ";
       $virgula = ",";
       if(trim((string) $this->ed256_c_hora) == null ){
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "ed256_c_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed256_c_evento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed256_c_evento"])){
       $sql  .= $virgula." ed256_c_evento = '$this->ed256_c_evento' ";
       $virgula = ",";
       if(trim((string) $this->ed256_c_evento) == null ){
         $this->erro_sql = " Campo Evento nao Informado.";
         $this->erro_campo = "ed256_c_evento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed256_t_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed256_t_descr"])){
       $sql  .= $virgula." ed256_t_descr = '$this->ed256_t_descr' ";
       $virgula = ",";
       if(trim((string) $this->ed256_t_descr) == null ){
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "ed256_t_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed256_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2348,13423,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed256_i_codigo'))."','$this->ed256_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed256_i_usuario"]))
           $resac = db_query("insert into db_acount values($acount,2348,13424,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed256_i_usuario'))."','$this->ed256_i_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed256_i_escola"]))
           $resac = db_query("insert into db_acount values($acount,2348,13428,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed256_i_escola'))."','$this->ed256_i_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed256_d_data"]))
           $resac = db_query("insert into db_acount values($acount,2348,13425,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed256_d_data'))."','$this->ed256_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed256_c_hora"]))
           $resac = db_query("insert into db_acount values($acount,2348,13426,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed256_c_hora'))."','$this->ed256_c_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed256_c_evento"]))
           $resac = db_query("insert into db_acount values($acount,2348,13427,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed256_c_evento'))."','$this->ed256_c_evento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed256_t_descr"]))
           $resac = db_query("insert into db_acount values($acount,2348,13429,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed256_t_descr'))."','$this->ed256_t_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($ed256_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2348,13423,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed256_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2348,13424,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed256_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2348,13428,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed256_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2348,13425,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed256_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2348,13426,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed256_c_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2348,13427,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed256_c_evento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2348,13429,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed256_t_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
