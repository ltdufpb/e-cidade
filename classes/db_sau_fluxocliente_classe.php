...
class cl_sau_fluxocliente { 
   ...
   public $sd41_i_cod_cliente = 0; 
   public $sd41_v_descricao = null; 
   ...
   function incluir ($sd41_i_cod_cliente){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1958,11412,'','".AddSlashes(pg_fetch_result($resaco,0,'sd41_i_cod_cliente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1958,11413,'','".AddSlashes(pg_fetch_result($resaco,0,'sd41_v_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd41_i_cod_cliente=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd41_i_cod_cliente)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd41_i_cod_cliente"])){ 
       $sql  .= $virgula." sd41_i_cod_cliente = $this->sd41_i_cod_cliente ";
       $virgula = ",";
       if(trim((string) $this->sd41_i_cod_cliente) == null ){ 
     ...
     if(trim((string) $this->sd41_v_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd41_v_descricao"])){ 
       $sql  .= $virgula." sd41_v_descricao = '$this->sd41_v_descricao' ";
       $virgula = ",";
       if(trim((string) $this->sd41_v_descricao) == null ){ 
         $this->erro_sql = " Campo Descricao nao Informado.";
         $this->erro_campo = "sd41_v_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd41_i_cod_cliente"]))
           $resac = db_query("insert into db_acount values($acount,1958,11412,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd41_i_cod_cliente'))."','$this->sd41_i_cod_cliente',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd41_v_descricao"]))
           $resac = db_query("insert into db_acount values($acount,1958,11413,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd41_v_descricao'))."','$this->sd41_v_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd41_i_cod_cliente=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1958,11412,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd41_i_cod_cliente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1958,11413,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd41_v_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
