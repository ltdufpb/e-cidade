...
class cl_sau_agendaveiculocia { 
   ...
   function incluir ($s123_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2517,14309,'','".AddSlashes(pg_fetch_result($resaco,0,'s123_i_agendaveiculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function alterar ($s123_i_codigo=null) { 
     ...
     if(trim((string) $this->s123_i_agendaveiculo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s123_i_agendaveiculo"])){ 
       $sql  .= $virgula." s123_i_agendaveiculo = $this->s123_i_agendaveiculo ";
       $virgula = ",";
       if(trim((string) $this->s123_i_agendaveiculo) == null ){ 
         $this->erro_sql = " Campo Agenda Veículo nao Informado.";
         $this->erro_campo = "s123_i_agendaveiculo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s123_i_agendaveiculo"]) || $this->s123_i_agendaveiculo != "")
           $resac = db_query("insert into db_acount values($acount,2517,14309,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s123_i_agendaveiculo'))."','$this->s123_i_agendaveiculo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function excluir ($s123_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2517,14309,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s123_i_agendaveiculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
