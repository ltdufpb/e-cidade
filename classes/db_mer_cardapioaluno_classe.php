...
class cl_mer_cardapioaluno { 
   ...
   public $me11_i_codigo        = 0; 
   public $me11_i_cardapiodia        = 0; 
   public $me11_i_matricula        = 0; 
   public $me11_d_data_dia    = null; 
   public $me11_d_data_mes    = null; 
   public $me11_d_data_ano    = null; 
   public $me11_d_data        = null; 
   public $me11_i_usuario        = 0; 
   ...
   function incluir ($me11_i_codigo){ 
     ...
     if($me11_i_codigo == "" || $me11_i_codigo == null ){
       ...
       $this->me11_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mercardapioaluno_me11_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $me11_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2230,12747,'','".AddSlashes(pg_fetch_result($resaco,0,'me11_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2230,12748,'','".AddSlashes(pg_fetch_result($resaco,0,'me11_i_cardapiodia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2230,12749,'','".AddSlashes(pg_fetch_result($resaco,0,'me11_i_matricula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2230,13777,'','".AddSlashes(pg_fetch_result($resaco,0,'me11_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2230,14483,'','".AddSlashes(pg_fetch_result($resaco,0,'me11_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me11_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->me11_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me11_i_codigo"])){ 
       $sql  .= $virgula." me11_i_codigo = $this->me11_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->me11_i_codigo) == null ){ 
     ...
     if(trim((string) $this->me11_i_cardapiodia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me11_i_cardapiodia"])){ 
       $sql  .= $virgula." me11_i_cardapiodia = $this->me11_i_cardapiodia ";
       $virgula = ",";
       if(trim((string) $this->me11_i_cardapiodia) == null ){ 
         $this->erro_sql = " Campo Cardápio nao Informado.";
         $this->erro_campo = "me11_i_cardapiodia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me11_i_matricula)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me11_i_matricula"])){ 
       $sql  .= $virgula." me11_i_matricula = $this->me11_i_matricula ";
       $virgula = ",";
       if(trim((string) $this->me11_i_matricula) == null ){ 
         $this->erro_sql = " Campo Matricula nao Informado.";
         $this->erro_campo = "me11_i_matricula";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me11_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me11_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["me11_d_data_dia"] !="") ){ 
       $sql  .= $virgula." me11_d_data = '$this->me11_d_data' ";
       $virgula = ",";
       if(trim((string) $this->me11_d_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "me11_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me11_i_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me11_i_usuario"])){ 
       $sql  .= $virgula." me11_i_usuario = $this->me11_i_usuario ";
       $virgula = ",";
       if(trim((string) $this->me11_i_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "me11_i_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me11_i_codigo"]) || $this->me11_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2230,12747,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me11_i_codigo'))."','$this->me11_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me11_i_cardapiodia"]) || $this->me11_i_cardapiodia != "")
           $resac = db_query("insert into db_acount values($acount,2230,12748,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me11_i_cardapiodia'))."','$this->me11_i_cardapiodia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me11_i_matricula"]) || $this->me11_i_matricula != "")
           $resac = db_query("insert into db_acount values($acount,2230,12749,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me11_i_matricula'))."','$this->me11_i_matricula',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me11_d_data"]) || $this->me11_d_data != "")
           $resac = db_query("insert into db_acount values($acount,2230,13777,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me11_d_data'))."','$this->me11_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me11_i_usuario"]) || $this->me11_i_usuario != "")
           $resac = db_query("insert into db_acount values($acount,2230,14483,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me11_i_usuario'))."','$this->me11_i_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me11_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2230,12747,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me11_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2230,12748,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me11_i_cardapiodia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2230,12749,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me11_i_matricula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2230,13777,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me11_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2230,14483,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me11_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
