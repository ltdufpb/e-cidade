...
class cl_habitprogramalote { 
   ...
   public $ht05_sequencial = 0; 
   public $ht05_idbql = 0; 
   public $ht05_habitprograma = 0; 
   ...
   function incluir ($ht05_sequencial){ 
     ...
     if($ht05_sequencial == "" || $ht05_sequencial == null ){
       ...
       $this->ht05_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from habitprogramalote_ht05_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ht05_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2993,16968,'','".AddSlashes(pg_fetch_result($resaco,0,'ht05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2993,16969,'','".AddSlashes(pg_fetch_result($resaco,0,'ht05_idbql'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2993,16970,'','".AddSlashes(pg_fetch_result($resaco,0,'ht05_habitprograma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ht05_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ht05_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht05_sequencial"])){ 
       $sql  .= $virgula." ht05_sequencial = $this->ht05_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ht05_sequencial) == null ){ 
     ...
     if(trim((string) $this->ht05_idbql)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht05_idbql"])){ 
       $sql  .= $virgula." ht05_idbql = $this->ht05_idbql ";
       $virgula = ",";
       if(trim((string) $this->ht05_idbql) == null ){ 
         $this->erro_sql = " Campo Idbql nao Informado.";
         $this->erro_campo = "ht05_idbql";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ht05_habitprograma)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht05_habitprograma"])){ 
       $sql  .= $virgula." ht05_habitprograma = $this->ht05_habitprograma ";
       $virgula = ",";
       if(trim((string) $this->ht05_habitprograma) == null ){ 
         $this->erro_sql = " Campo Programa nao Informado.";
         $this->erro_campo = "ht05_habitprograma";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht05_sequencial"]) || $this->ht05_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2993,16968,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht05_sequencial'))."','$this->ht05_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht05_idbql"]) || $this->ht05_idbql != "")
           $resac = db_query("insert into db_acount values($acount,2993,16969,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht05_idbql'))."','$this->ht05_idbql',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht05_habitprograma"]) || $this->ht05_habitprograma != "")
           $resac = db_query("insert into db_acount values($acount,2993,16970,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht05_habitprograma'))."','$this->ht05_habitprograma',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ht05_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2993,16968,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2993,16969,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht05_idbql'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2993,16970,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht05_habitprograma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
