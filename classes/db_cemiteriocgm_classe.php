...
class cl_cemiteriocgm { 
   ...
   function incluir ($cm15_i_cemiterio){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1781,10293,'','".AddSlashes(pg_fetch_result($resaco,0,'cm15_i_cemiterio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1781,10294,'','".AddSlashes(pg_fetch_result($resaco,0,'cm15_i_cgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($cm15_i_cemiterio=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->cm15_i_cemiterio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm15_i_cemiterio"])){ 
       $sql  .= $virgula." cm15_i_cemiterio = $this->cm15_i_cemiterio ";
       $virgula = ",";
       if(trim((string) $this->cm15_i_cemiterio) == null ){ 
     ...
     if(trim((string) $this->cm15_i_cgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm15_i_cgm"])){ 
       $sql  .= $virgula." cm15_i_cgm = $this->cm15_i_cgm ";
       $virgula = ",";
       if(trim((string) $this->cm15_i_cgm) == null ){ 
         $this->erro_sql = " Campo Numcgm nao Informado.";
         $this->erro_campo = "cm15_i_cgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm15_i_cemiterio"]))
           $resac = db_query("insert into db_acount values($acount,1781,10293,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm15_i_cemiterio'))."','$this->cm15_i_cemiterio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm15_i_cgm"]))
           $resac = db_query("insert into db_acount values($acount,1781,10294,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm15_i_cgm'))."','$this->cm15_i_cgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($cm15_i_cemiterio=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1781,10293,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm15_i_cemiterio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1781,10294,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm15_i_cgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
