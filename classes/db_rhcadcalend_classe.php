...
class cl_rhcadcalend { 
   ...
   public $rh53_instit = 0; 
   public $rh53_calend = 0; 
   public $rh53_descr = null; 
   ...
   function incluir ($rh53_calend){ 
     ...
     if($rh53_calend == "" || $rh53_calend == null ){
       ...
       $this->rh53_calend = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhcadcalend_rh53_calend_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh53_calend)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1521,9902,'','".AddSlashes(pg_fetch_result($resaco,0,'rh53_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1521,8901,'','".AddSlashes(pg_fetch_result($resaco,0,'rh53_calend'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1521,8902,'','".AddSlashes(pg_fetch_result($resaco,0,'rh53_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh53_calend=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh53_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh53_instit"])){ 
       $sql  .= $virgula." rh53_instit = $this->rh53_instit ";
       $virgula = ",";
       if(trim((string) $this->rh53_instit) == null ){ 
         $this->erro_sql = " Campo Cod. Instituição nao Informado.";
         $this->erro_campo = "rh53_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh53_calend)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh53_calend"])){ 
       $sql  .= $virgula." rh53_calend = $this->rh53_calend ";
       $virgula = ",";
       if(trim((string) $this->rh53_calend) == null ){ 
     ...
     if(trim((string) $this->rh53_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh53_descr"])){ 
       $sql  .= $virgula." rh53_descr = '$this->rh53_descr' ";
       $virgula = ",";
       if(trim((string) $this->rh53_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "rh53_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh53_instit"]))
           $resac = db_query("insert into db_acount values($acount,1521,9902,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh53_instit'))."','$this->rh53_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh53_calend"]))
           $resac = db_query("insert into db_acount values($acount,1521,8901,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh53_calend'))."','$this->rh53_calend',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh53_descr"]))
           $resac = db_query("insert into db_acount values($acount,1521,8902,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh53_descr'))."','$this->rh53_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh53_calend=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1521,9902,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh53_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1521,8901,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh53_calend'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1521,8902,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh53_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
