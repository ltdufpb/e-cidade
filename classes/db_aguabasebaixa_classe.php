...
class cl_aguabasebaixa { 
   ...
   public $x08_matric = 0; 
   public $x08_data_dia = null; 
   public $x08_data_mes = null; 
   public $x08_data_ano = null; 
   public $x08_data = null; 
   public $x08_obs = null; 
   public $x08_usuario = 0; 
   ...
   function incluir ($x08_matric){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1451,8531,'','".AddSlashes(pg_fetch_result($resaco,0,'x08_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1451,8532,'','".AddSlashes(pg_fetch_result($resaco,0,'x08_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1451,8533,'','".AddSlashes(pg_fetch_result($resaco,0,'x08_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1451,8534,'','".AddSlashes(pg_fetch_result($resaco,0,'x08_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($x08_matric=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->x08_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x08_matric"])){ 
       $sql  .= $virgula." x08_matric = $this->x08_matric ";
       $virgula = ",";
       if(trim((string) $this->x08_matric) == null ){ 
     ...
     if(trim((string) $this->x08_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x08_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["x08_data_dia"] !="") ){ 
       $sql  .= $virgula." x08_data = '$this->x08_data' ";
       $virgula = ",";
       if(trim((string) $this->x08_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "x08_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->x08_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x08_obs"])){ 
       $sql  .= $virgula." x08_obs = '$this->x08_obs' ";
       $virgula = ",";
       if(trim((string) $this->x08_obs) == null ){ 
         $this->erro_sql = " Campo Observações nao Informado.";
         $this->erro_campo = "x08_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->x08_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x08_usuario"])){ 
       $sql  .= $virgula." x08_usuario = $this->x08_usuario ";
       $virgula = ",";
       if(trim((string) $this->x08_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "x08_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x08_matric"]))
           $resac = db_query("insert into db_acount values($acount,1451,8531,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x08_matric'))."','$this->x08_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x08_data"]))
           $resac = db_query("insert into db_acount values($acount,1451,8532,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x08_data'))."','$this->x08_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x08_obs"]))
           $resac = db_query("insert into db_acount values($acount,1451,8533,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x08_obs'))."','$this->x08_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x08_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1451,8534,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x08_usuario'))."','$this->x08_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($x08_matric=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1451,8531,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x08_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1451,8532,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x08_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1451,8533,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x08_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1451,8534,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x08_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
