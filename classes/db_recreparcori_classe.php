...
class cl_recreparcori { 
   ...
   public $k70_codigo = 0; 
   public $k70_recori = 0; 
   public $k70_vezesini = 0; 
   public $k70_vezesfim = 0; 
   ...
   function incluir ($k70_codigo){ 
     ...
     if($k70_codigo == "" || $k70_codigo == null ){
       ...
       $this->k70_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from recreparcori_k70_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k70_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1293,7773,'','".AddSlashes(pg_fetch_result($resaco,0,'k70_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1293,7771,'','".AddSlashes(pg_fetch_result($resaco,0,'k70_recori'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1293,9809,'','".AddSlashes(pg_fetch_result($resaco,0,'k70_vezesini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1293,9810,'','".AddSlashes(pg_fetch_result($resaco,0,'k70_vezesfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k70_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k70_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k70_codigo"])){ 
       $sql  .= $virgula." k70_codigo = $this->k70_codigo ";
       $virgula = ",";
       if(trim((string) $this->k70_codigo) == null ){ 
     ...
     if(trim((string) $this->k70_recori)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k70_recori"])){ 
       $sql  .= $virgula." k70_recori = $this->k70_recori ";
       $virgula = ",";
       if(trim((string) $this->k70_recori) == null ){ 
         $this->erro_sql = " Campo Receita original nao Informado.";
         $this->erro_campo = "k70_recori";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k70_vezesini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k70_vezesini"])){ 
       $sql  .= $virgula." k70_vezesini = $this->k70_vezesini ";
       $virgula = ",";
       if(trim((string) $this->k70_vezesini) == null ){ 
         $this->erro_sql = " Campo Vezes inicial nao Informado.";
         $this->erro_campo = "k70_vezesini";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k70_vezesfim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k70_vezesfim"])){ 
       $sql  .= $virgula." k70_vezesfim = $this->k70_vezesfim ";
       $virgula = ",";
       if(trim((string) $this->k70_vezesfim) == null ){ 
         $this->erro_sql = " Campo Vezes final nao Informado.";
         $this->erro_campo = "k70_vezesfim";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k70_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1293,7773,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k70_codigo'))."','$this->k70_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k70_recori"]))
           $resac = db_query("insert into db_acount values($acount,1293,7771,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k70_recori'))."','$this->k70_recori',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k70_vezesini"]))
           $resac = db_query("insert into db_acount values($acount,1293,9809,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k70_vezesini'))."','$this->k70_vezesini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k70_vezesfim"]))
           $resac = db_query("insert into db_acount values($acount,1293,9810,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k70_vezesfim'))."','$this->k70_vezesfim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k70_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1293,7773,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k70_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1293,7771,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k70_recori'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1293,9809,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k70_vezesini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1293,9810,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k70_vezesfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
