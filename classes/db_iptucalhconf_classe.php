...
class cl_iptucalhconf { 
   ...
   public $j89_sequencial = 0; 
   public $j89_codhis = 0; 
   public $j89_codhispai = 0; 
   ...
   function incluir ($j89_sequencial){ 
     ...
     if($j89_sequencial == "" || $j89_sequencial == null ){
       ...
       $this->j89_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from iptucalhconf_j89_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $j89_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1852,10761,'','".AddSlashes(pg_fetch_result($resaco,0,'j89_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1852,10760,'','".AddSlashes(pg_fetch_result($resaco,0,'j89_codhis'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1852,10762,'','".AddSlashes(pg_fetch_result($resaco,0,'j89_codhispai'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j89_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j89_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j89_sequencial"])){ 
       $sql  .= $virgula." j89_sequencial = $this->j89_sequencial ";
       $virgula = ",";
       if(trim((string) $this->j89_sequencial) == null ){ 
     ...
     if(trim((string) $this->j89_codhis)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j89_codhis"])){ 
       $sql  .= $virgula." j89_codhis = $this->j89_codhis ";
       $virgula = ",";
       if(trim((string) $this->j89_codhis) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
         $this->erro_campo = "j89_codhis";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j89_codhispai)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j89_codhispai"])){ 
       $sql  .= $virgula." j89_codhispai = $this->j89_codhispai ";
       $virgula = ",";
       if(trim((string) $this->j89_codhispai) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
         $this->erro_campo = "j89_codhispai";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j89_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1852,10761,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j89_sequencial'))."','$this->j89_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j89_codhis"]))
           $resac = db_query("insert into db_acount values($acount,1852,10760,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j89_codhis'))."','$this->j89_codhis',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j89_codhispai"]))
           $resac = db_query("insert into db_acount values($acount,1852,10762,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j89_codhispai'))."','$this->j89_codhispai',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j89_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1852,10761,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j89_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1852,10760,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j89_codhis'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1852,10762,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j89_codhispai'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
