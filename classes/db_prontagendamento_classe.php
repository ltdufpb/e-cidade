...
class cl_prontagendamento { 
   ...
   public $s102_i_codigo = 0; 
   public $s102_i_prontuario = 0; 
   public $s102_i_agendamento = 0; 
   ...
   function incluir ($s102_i_codigo){ 
     ...
     if($s102_i_codigo == "" || $s102_i_codigo == null ){
       ...
       $this->s102_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from prontagendametno_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $s102_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2213,12675,'','".AddSlashes(pg_fetch_result($resaco,0,'s102_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2213,12677,'','".AddSlashes(pg_fetch_result($resaco,0,'s102_i_prontuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2213,12676,'','".AddSlashes(pg_fetch_result($resaco,0,'s102_i_agendamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($s102_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->s102_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s102_i_codigo"])){ 
       $sql  .= $virgula." s102_i_codigo = $this->s102_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->s102_i_codigo) == null ){ 
     ...
     if(trim((string) $this->s102_i_prontuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s102_i_prontuario"])){ 
       $sql  .= $virgula." s102_i_prontuario = $this->s102_i_prontuario ";
       $virgula = ",";
       if(trim((string) $this->s102_i_prontuario) == null ){ 
         $this->erro_sql = " Campo Prontuario nao Informado.";
         $this->erro_campo = "s102_i_prontuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s102_i_agendamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s102_i_agendamento"])){ 
       $sql  .= $virgula." s102_i_agendamento = $this->s102_i_agendamento ";
       $virgula = ",";
       if(trim((string) $this->s102_i_agendamento) == null ){ 
         $this->erro_sql = " Campo Agendamento nao Informado.";
         $this->erro_campo = "s102_i_agendamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s102_i_codigo"]) || $this->s102_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2213,12675,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s102_i_codigo'))."','$this->s102_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s102_i_prontuario"]) || $this->s102_i_prontuario != "")
           $resac = db_query("insert into db_acount values($acount,2213,12677,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s102_i_prontuario'))."','$this->s102_i_prontuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s102_i_agendamento"]) || $this->s102_i_agendamento != "")
           $resac = db_query("insert into db_acount values($acount,2213,12676,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s102_i_agendamento'))."','$this->s102_i_agendamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($s102_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2213,12675,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s102_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2213,12677,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s102_i_prontuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2213,12676,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s102_i_agendamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
