...
class cl_alunocensotipotransporte { 
   ...
   public $ed311_sequencial = 0; 
   public $ed311_aluno = 0; 
   public $ed311_censotipotransporte = 0; 
   ...
   function incluir ($ed311_sequencial){ 
     ...
     if($ed311_sequencial == "" || $ed311_sequencial == null ){
       ...
       $this->ed311_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from alunocensotipotransporte_ed311_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed311_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3362,18912,'','".AddSlashes(pg_fetch_result($resaco,0,'ed311_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3362,18913,'','".AddSlashes(pg_fetch_result($resaco,0,'ed311_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3362,18914,'','".AddSlashes(pg_fetch_result($resaco,0,'ed311_censotipotransporte'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed311_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed311_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed311_sequencial"])){ 
       $sql  .= $virgula." ed311_sequencial = $this->ed311_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed311_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed311_aluno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed311_aluno"])){ 
       $sql  .= $virgula." ed311_aluno = $this->ed311_aluno ";
       $virgula = ",";
       if(trim((string) $this->ed311_aluno) == null ){ 
         $this->erro_sql = " Campo Código do Aluno nao Informado.";
         $this->erro_campo = "ed311_aluno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed311_censotipotransporte)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed311_censotipotransporte"])){ 
       $sql  .= $virgula." ed311_censotipotransporte = $this->ed311_censotipotransporte ";
       $virgula = ",";
       if(trim((string) $this->ed311_censotipotransporte) == null ){ 
         $this->erro_sql = " Campo Código do Tipo de Transporte nao Informado.";
         $this->erro_campo = "ed311_censotipotransporte";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed311_sequencial"]) || $this->ed311_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3362,18912,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed311_sequencial'))."','$this->ed311_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed311_aluno"]) || $this->ed311_aluno != "")
           $resac = db_query("insert into db_acount values($acount,3362,18913,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed311_aluno'))."','$this->ed311_aluno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed311_censotipotransporte"]) || $this->ed311_censotipotransporte != "")
           $resac = db_query("insert into db_acount values($acount,3362,18914,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed311_censotipotransporte'))."','$this->ed311_censotipotransporte',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed311_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3362,18912,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed311_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3362,18913,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed311_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3362,18914,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed311_censotipotransporte'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
