...
class cl_abatimentoprotprocesso { 
   ...
   public $k159_sequencial = 0; 
   public $k159_abatimento = 0; 
   public $k159_protprocesso = 0; 
   ...
   function incluir ($k159_sequencial){ 
     ...
     if($k159_sequencial == "" || $k159_sequencial == null ){
       ...
       $this->k159_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from abatimentoprotprocesso_k159_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k159_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3486,19618,'','".AddSlashes(pg_fetch_result($resaco,0,'k159_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3486,19615,'','".AddSlashes(pg_fetch_result($resaco,0,'k159_abatimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3486,19616,'','".AddSlashes(pg_fetch_result($resaco,0,'k159_protprocesso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k159_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k159_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k159_sequencial"])){ 
       $sql  .= $virgula." k159_sequencial = $this->k159_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k159_sequencial) == null ){ 
     ...
     if(trim((string) $this->k159_abatimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k159_abatimento"])){ 
       $sql  .= $virgula." k159_abatimento = $this->k159_abatimento ";
       $virgula = ",";
       if(trim((string) $this->k159_abatimento) == null ){ 
         $this->erro_sql = " Campo Sequencial da tabela abatimento nao Informado.";
         $this->erro_campo = "k159_abatimento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k159_protprocesso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k159_protprocesso"])){ 
       $sql  .= $virgula." k159_protprocesso = $this->k159_protprocesso ";
       $virgula = ",";
       if(trim((string) $this->k159_protprocesso) == null ){ 
         $this->erro_sql = " Campo Cód. Processo nao Informado.";
         $this->erro_campo = "k159_protprocesso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k159_sequencial"]) || $this->k159_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3486,19618,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k159_sequencial'))."','$this->k159_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k159_abatimento"]) || $this->k159_abatimento != "")
           $resac = db_query("insert into db_acount values($acount,3486,19615,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k159_abatimento'))."','$this->k159_abatimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k159_protprocesso"]) || $this->k159_protprocesso != "")
           $resac = db_query("insert into db_acount values($acount,3486,19616,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k159_protprocesso'))."','$this->k159_protprocesso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k159_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3486,19618,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k159_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3486,19615,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k159_abatimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3486,19616,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k159_protprocesso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
