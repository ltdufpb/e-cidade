...
class cl_contlot { 
   ...
   function incluir ($d05_contri,$d05_idbql){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,130,699,'','".AddSlashes(pg_fetch_result($resaco,0,'d05_contri'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,130,700,'','".AddSlashes(pg_fetch_result($resaco,0,'d05_idbql'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,130,701,'','".AddSlashes(pg_fetch_result($resaco,0,'d05_testad'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($d05_contri=null,$d05_idbql=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->d05_contri)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d05_contri"])){ 
        if(trim((string) $this->d05_contri)=="" && isset($GLOBALS["HTTP_POST_VARS"]["d05_contri"])){ 
           $this->d05_contri = "0" ; 
        } 
       $sql  .= $virgula." d05_contri = $this->d05_contri ";
       $virgula = ",";
       if(trim((string) $this->d05_contri) == null ){ 
     ...
     if(trim((string) $this->d05_idbql)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d05_idbql"])){ 
        if(trim((string) $this->d05_idbql)=="" && isset($GLOBALS["HTTP_POST_VARS"]["d05_idbql"])){ 
           $this->d05_idbql = "0" ; 
        } 
       $sql  .= $virgula." d05_idbql = $this->d05_idbql ";
       $virgula = ",";
       if(trim((string) $this->d05_idbql) == null ){ 
     ...
     if(trim((string) $this->d05_testad)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d05_testad"])){ 
        if(trim((string) $this->d05_testad)=="" && isset($GLOBALS["HTTP_POST_VARS"]["d05_testad"])){ 
           $this->d05_testad = "0" ; 
        } 
       $sql  .= $virgula." d05_testad = $this->d05_testad ";
       $virgula = ",";
       if(trim((string) $this->d05_testad) == null ){ 
         $this->erro_sql = " Campo Testada nao Informado.";
         $this->erro_campo = "d05_testad";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["d05_contri"]))
           $resac = db_query("insert into db_acount values($acount,130,699,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d05_contri'))."','$this->d05_contri',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d05_idbql"]))
           $resac = db_query("insert into db_acount values($acount,130,700,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d05_idbql'))."','$this->d05_idbql',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d05_testad"]))
           $resac = db_query("insert into db_acount values($acount,130,701,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d05_testad'))."','$this->d05_testad',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($d05_contri=null,$d05_idbql=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,130,699,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d05_contri'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,130,700,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d05_idbql'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,130,701,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d05_testad'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
