...
class cl_empprestaitemempagemov {
   ...
   public $e26_sequencial = 0;
   public $e26_empprestaitem = 0;
   public $e26_codmov = 0;
   ...
   function incluir ($e26_sequencial){
     ...
     if($e26_sequencial == "" || $e26_sequencial == null ){
       ...
       $this->e26_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from empprestaitemempagemov_e26_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $e26_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3638,20249,'','".AddSlashes(pg_fetch_result($resaco,0,'e26_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3638,20250,'','".AddSlashes(pg_fetch_result($resaco,0,'e26_empprestaitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3638,20251,'','".AddSlashes(pg_fetch_result($resaco,0,'e26_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   function alterar ($e26_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->e26_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e26_sequencial"])){
       $sql  .= $virgula." e26_sequencial = $this->e26_sequencial ";
       $virgula = ",";
       if(trim((string) $this->e26_sequencial) == null ){
     ...
     if(trim((string) $this->e26_empprestaitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e26_empprestaitem"])){
       $sql  .= $virgula." e26_empprestaitem = $this->e26_empprestaitem ";
       $virgula = ",";
       if(trim((string) $this->e26_empprestaitem) == null ){
         $this->erro_sql = " Campo emprestaitem não informado.";
         $this->erro_campo = "e26_empprestaitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e26_codmov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e26_codmov"])){
       $sql  .= $virgula." e26_codmov = $this->e26_codmov ";
       $virgula = ",";
       if(trim((string) $this->e26_codmov) == null ){
         $this->erro_sql = " Campo Código do Movimento não informado.";
         $this->erro_campo = "e26_codmov";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["e26_sequencial"]) || $this->e26_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3638,20249,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e26_sequencial'))."','$this->e26_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["e26_empprestaitem"]) || $this->e26_empprestaitem != "")
             $resac = db_query("insert into db_acount values($acount,3638,20250,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e26_empprestaitem'))."','$this->e26_empprestaitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["e26_codmov"]) || $this->e26_codmov != "")
             $resac = db_query("insert into db_acount values($acount,3638,20251,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e26_codmov'))."','$this->e26_codmov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3638,20249,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e26_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3638,20250,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e26_empprestaitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3638,20251,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e26_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
