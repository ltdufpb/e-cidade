...
class cl_atenditemmotivo { 
   ...
   public $at34_sequencial = 0; 
   public $at34_atenditem = 0; 
   public $at34_tarefacadmotivo = 0; 
   ...
   function incluir ($at34_sequencial){ 
     ...
     if($at34_sequencial == "" || $at34_sequencial == null ){
       ...
       $this->at34_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from atenditemmotivo_at34_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at34_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1688,9831,'','".AddSlashes(pg_fetch_result($resaco,0,'at34_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1688,9833,'','".AddSlashes(pg_fetch_result($resaco,0,'at34_atenditem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1688,9832,'','".AddSlashes(pg_fetch_result($resaco,0,'at34_tarefacadmotivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at34_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at34_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at34_sequencial"])){ 
       $sql  .= $virgula." at34_sequencial = $this->at34_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at34_sequencial) == null ){ 
     ...
     if(trim((string) $this->at34_atenditem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at34_atenditem"])){ 
       $sql  .= $virgula." at34_atenditem = $this->at34_atenditem ";
       $virgula = ",";
       if(trim((string) $this->at34_atenditem) == null ){ 
         $this->erro_sql = " Campo Item nao Informado.";
         $this->erro_campo = "at34_atenditem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at34_tarefacadmotivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at34_tarefacadmotivo"])){ 
       $sql  .= $virgula." at34_tarefacadmotivo = $this->at34_tarefacadmotivo ";
       $virgula = ",";
       if(trim((string) $this->at34_tarefacadmotivo) == null ){ 
         $this->erro_sql = " Campo Motivo nao Informado.";
         $this->erro_campo = "at34_tarefacadmotivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at34_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1688,9831,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at34_sequencial'))."','$this->at34_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at34_atenditem"]))
           $resac = db_query("insert into db_acount values($acount,1688,9833,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at34_atenditem'))."','$this->at34_atenditem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at34_tarefacadmotivo"]))
           $resac = db_query("insert into db_acount values($acount,1688,9832,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at34_tarefacadmotivo'))."','$this->at34_tarefacadmotivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at34_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1688,9831,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at34_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1688,9833,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at34_atenditem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1688,9832,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at34_tarefacadmotivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
