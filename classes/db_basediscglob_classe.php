...
class cl_basediscglob { 
   ...
   public $ed89_i_codigo = 0; 
   public $ed89_i_disciplina = 0; 
   public $ed89_i_qtdperiodos = 0; 
   ...
   function incluir ($ed89_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010066,1008389,'','".AddSlashes(pg_fetch_result($resaco,0,'ed89_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010066,1008390,'','".AddSlashes(pg_fetch_result($resaco,0,'ed89_i_disciplina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010066,1008391,'','".AddSlashes(pg_fetch_result($resaco,0,'ed89_i_qtdperiodos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed89_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed89_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed89_i_codigo"])){ 
       $sql  .= $virgula." ed89_i_codigo = $this->ed89_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed89_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed89_i_disciplina)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed89_i_disciplina"])){ 
       $sql  .= $virgula." ed89_i_disciplina = $this->ed89_i_disciplina ";
       $virgula = ",";
       if(trim((string) $this->ed89_i_disciplina) == null ){ 
         $this->erro_sql = " Campo Disciplina Global nao Informado.";
         $this->erro_campo = "ed89_i_disciplina";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed89_i_qtdperiodos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed89_i_qtdperiodos"])){ 
       $sql  .= $virgula." ed89_i_qtdperiodos = $this->ed89_i_qtdperiodos ";
       $virgula = ",";
       if(trim((string) $this->ed89_i_qtdperiodos) == null ){ 
         $this->erro_sql = " Campo Períodos nao Informado.";
         $this->erro_campo = "ed89_i_qtdperiodos";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed89_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010066,1008389,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed89_i_codigo'))."','$this->ed89_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed89_i_disciplina"]))
           $resac = db_query("insert into db_acount values($acount,1010066,1008390,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed89_i_disciplina'))."','$this->ed89_i_disciplina',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed89_i_qtdperiodos"]))
           $resac = db_query("insert into db_acount values($acount,1010066,1008391,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed89_i_qtdperiodos'))."','$this->ed89_i_qtdperiodos',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed89_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010066,1008389,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed89_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010066,1008390,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed89_i_disciplina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010066,1008391,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed89_i_qtdperiodos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
