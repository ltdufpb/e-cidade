...
class cl_valorpassagem { 
   ...
   public $ed230_i_codigo = 0; 
   public $ed230_i_linha = 0; 
   public $ed230_i_usuario = 0; 
   public $ed230_f_valor = 0; 
   public $ed230_d_datacad_dia = null; 
   public $ed230_d_datacad_mes = null; 
   public $ed230_d_datacad_ano = null; 
   public $ed230_d_datacad = null; 
   ...
   function incluir ($ed230_i_codigo){ 
     ...
     if($ed230_i_codigo == "" || $ed230_i_codigo == null ){
       ...
       $this->ed230_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from valorpassagem_ed230_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed230_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1950,11340,'','".AddSlashes(pg_fetch_result($resaco,0,'ed230_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1950,11341,'','".AddSlashes(pg_fetch_result($resaco,0,'ed230_i_linha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1950,11342,'','".AddSlashes(pg_fetch_result($resaco,0,'ed230_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1950,11343,'','".AddSlashes(pg_fetch_result($resaco,0,'ed230_f_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1950,11344,'','".AddSlashes(pg_fetch_result($resaco,0,'ed230_d_datacad'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed230_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed230_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed230_i_codigo"])){ 
       $sql  .= $virgula." ed230_i_codigo = $this->ed230_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed230_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed230_i_linha)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed230_i_linha"])){ 
       $sql  .= $virgula." ed230_i_linha = $this->ed230_i_linha ";
       $virgula = ",";
       if(trim((string) $this->ed230_i_linha) == null ){ 
         $this->erro_sql = " Campo Linha nao Informado.";
         $this->erro_campo = "ed230_i_linha";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed230_i_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed230_i_usuario"])){ 
       $sql  .= $virgula." ed230_i_usuario = $this->ed230_i_usuario ";
       $virgula = ",";
       if(trim((string) $this->ed230_i_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "ed230_i_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed230_f_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed230_f_valor"])){ 
       $sql  .= $virgula." ed230_f_valor = $this->ed230_f_valor ";
       $virgula = ",";
       if(trim((string) $this->ed230_f_valor) == null ){ 
         $this->erro_sql = " Campo Valor nao Informado.";
         $this->erro_campo = "ed230_f_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed230_d_datacad)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed230_d_datacad_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed230_d_datacad_dia"] !="") ){ 
       $sql  .= $virgula." ed230_d_datacad = '$this->ed230_d_datacad' ";
       $virgula = ",";
       if(trim((string) $this->ed230_d_datacad) == null ){ 
         $this->erro_sql = " Campo Data de Cadastro nao Informado.";
         $this->erro_campo = "ed230_d_datacad_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed230_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1950,11340,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed230_i_codigo'))."','$this->ed230_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed230_i_linha"]))
           $resac = db_query("insert into db_acount values($acount,1950,11341,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed230_i_linha'))."','$this->ed230_i_linha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed230_i_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1950,11342,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed230_i_usuario'))."','$this->ed230_i_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed230_f_valor"]))
           $resac = db_query("insert into db_acount values($acount,1950,11343,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed230_f_valor'))."','$this->ed230_f_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed230_d_datacad"]))
           $resac = db_query("insert into db_acount values($acount,1950,11344,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed230_d_datacad'))."','$this->ed230_d_datacad',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed230_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1950,11340,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed230_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1950,11341,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed230_i_linha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1950,11342,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed230_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1950,11343,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed230_f_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1950,11344,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed230_d_datacad'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
