...
class cl_tipoprocdepto {
   ...
   public $p41_sequencial = 0;
   public $p41_tipoproc = 0;
   public $p41_coddepto = 0;
   ...
   function incluir ($p41_sequencial){
     ...
     if($p41_sequencial == "" || $p41_sequencial == null ){
       ...
       $this->p41_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from tipoprocdepto_p41_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $p41_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2592,14726,'','".AddSlashes(pg_fetch_result($resaco,0,'p41_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2592,14727,'','".AddSlashes(pg_fetch_result($resaco,0,'p41_tipoproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2592,14728,'','".AddSlashes(pg_fetch_result($resaco,0,'p41_coddepto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($p41_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->p41_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["p41_sequencial"])){
       $sql  .= $virgula." p41_sequencial = $this->p41_sequencial ";
       $virgula = ",";
       if(trim((string) $this->p41_sequencial) == null ){
     ...
     if(trim((string) $this->p41_tipoproc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["p41_tipoproc"])){
       $sql  .= $virgula." p41_tipoproc = $this->p41_tipoproc ";
       $virgula = ",";
       if(trim((string) $this->p41_tipoproc) == null ){
         $this->erro_sql = " Campo Tipo de Processo nao Informado.";
         $this->erro_campo = "p41_tipoproc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->p41_coddepto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["p41_coddepto"])){
       $sql  .= $virgula." p41_coddepto = $this->p41_coddepto ";
       $virgula = ",";
       if(trim((string) $this->p41_coddepto) == null ){
         $this->erro_sql = " Campo Código do Departamento nao Informado.";
         $this->erro_campo = "p41_coddepto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["p41_sequencial"]) || $this->p41_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2592,14726,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'p41_sequencial'))."','$this->p41_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p41_tipoproc"]) || $this->p41_tipoproc != "")
           $resac = db_query("insert into db_acount values($acount,2592,14727,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'p41_tipoproc'))."','$this->p41_tipoproc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p41_coddepto"]) || $this->p41_coddepto != "")
           $resac = db_query("insert into db_acount values($acount,2592,14728,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'p41_coddepto'))."','$this->p41_coddepto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($p41_sequencial=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2592,14726,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'p41_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2592,14727,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'p41_tipoproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2592,14728,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'p41_coddepto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
