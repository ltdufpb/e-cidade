...
class cl_issnotaavulsaemissao { 
   ...
   public $q69_sequencial = 0; 
   public $q69_issnotaavulsa = 0; 
   public $q69_usuario = 0; 
   public $q69_data_dia = null; 
   public $q69_data_mes = null; 
   public $q69_data_ano = null; 
   public $q69_data = null; 
   public $q69_hora = null; 
   ...
   function incluir ($q69_sequencial){ 
     ...
     if($q69_sequencial == "" || $q69_sequencial == null ){
       ...
       $this->q69_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from issnotaavulsaemissao_q69_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q69_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1851,10755,'','".AddSlashes(pg_fetch_result($resaco,0,'q69_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1851,10756,'','".AddSlashes(pg_fetch_result($resaco,0,'q69_issnotaavulsa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1851,10757,'','".AddSlashes(pg_fetch_result($resaco,0,'q69_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1851,10758,'','".AddSlashes(pg_fetch_result($resaco,0,'q69_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1851,10759,'','".AddSlashes(pg_fetch_result($resaco,0,'q69_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q69_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q69_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q69_sequencial"])){ 
       $sql  .= $virgula." q69_sequencial = $this->q69_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q69_sequencial) == null ){ 
     ...
     if(trim((string) $this->q69_issnotaavulsa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q69_issnotaavulsa"])){ 
       $sql  .= $virgula." q69_issnotaavulsa = $this->q69_issnotaavulsa ";
       $virgula = ",";
       if(trim((string) $this->q69_issnotaavulsa) == null ){ 
         $this->erro_sql = " Campo Código da Nota nao Informado.";
         $this->erro_campo = "q69_issnotaavulsa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q69_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q69_usuario"])){ 
       $sql  .= $virgula." q69_usuario = $this->q69_usuario ";
       $virgula = ",";
       if(trim((string) $this->q69_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "q69_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q69_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q69_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["q69_data_dia"] !="") ){ 
       $sql  .= $virgula." q69_data = '$this->q69_data' ";
       $virgula = ",";
       if(trim((string) $this->q69_data) == null ){ 
         $this->erro_sql = " Campo Data da Emissão nao Informado.";
         $this->erro_campo = "q69_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q69_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q69_hora"])){ 
       $sql  .= $virgula." q69_hora = '$this->q69_hora' ";
       $virgula = ",";
       if(trim((string) $this->q69_hora) == null ){ 
         $this->erro_sql = " Campo Hora da Emissão nao Informado.";
         $this->erro_campo = "q69_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q69_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1851,10755,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q69_sequencial'))."','$this->q69_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q69_issnotaavulsa"]))
           $resac = db_query("insert into db_acount values($acount,1851,10756,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q69_issnotaavulsa'))."','$this->q69_issnotaavulsa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q69_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1851,10757,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q69_usuario'))."','$this->q69_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q69_data"]))
           $resac = db_query("insert into db_acount values($acount,1851,10758,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q69_data'))."','$this->q69_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q69_hora"]))
           $resac = db_query("insert into db_acount values($acount,1851,10759,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q69_hora'))."','$this->q69_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q69_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1851,10755,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q69_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1851,10756,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q69_issnotaavulsa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1851,10757,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q69_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1851,10758,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q69_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1851,10759,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q69_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
