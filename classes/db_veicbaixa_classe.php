...
class cl_veicbaixa { 
   ...
   public $ve04_codigo = 0; 
   public $ve04_veiculo = 0; 
   public $ve04_data_dia = null; 
   public $ve04_data_mes = null; 
   public $ve04_data_ano = null; 
   public $ve04_data = null; 
   public $ve04_hora = null; 
   public $ve04_usuario = 0; 
   public $ve04_motivo = null; 
   public $ve04_veiccadtipobaixa = 0; 
   ...
   function incluir ($ve04_codigo){ 
     ...
     if($ve04_codigo == "" || $ve04_codigo == null ){
       ...
       $this->ve04_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veicbaixa_ve04_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve04_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1594,9274,'','".AddSlashes(pg_fetch_result($resaco,0,'ve04_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1594,9279,'','".AddSlashes(pg_fetch_result($resaco,0,'ve04_veiculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1594,9275,'','".AddSlashes(pg_fetch_result($resaco,0,'ve04_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1594,9276,'','".AddSlashes(pg_fetch_result($resaco,0,'ve04_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1594,9277,'','".AddSlashes(pg_fetch_result($resaco,0,'ve04_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1594,9278,'','".AddSlashes(pg_fetch_result($resaco,0,'ve04_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1594,11087,'','".AddSlashes(pg_fetch_result($resaco,0,'ve04_veiccadtipobaixa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve04_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve04_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve04_codigo"])){ 
       $sql  .= $virgula." ve04_codigo = $this->ve04_codigo ";
       $virgula = ",";
       if(trim((string) $this->ve04_codigo) == null ){ 
     ...
     if(trim((string) $this->ve04_veiculo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve04_veiculo"])){ 
       $sql  .= $virgula." ve04_veiculo = $this->ve04_veiculo ";
       $virgula = ",";
       if(trim((string) $this->ve04_veiculo) == null ){ 
         $this->erro_sql = " Campo Veiculo nao Informado.";
         $this->erro_campo = "ve04_veiculo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve04_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve04_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ve04_data_dia"] !="") ){ 
       $sql  .= $virgula." ve04_data = '$this->ve04_data' ";
       $virgula = ",";
       if(trim((string) $this->ve04_data) == null ){ 
         $this->erro_sql = " Campo Data da Baixa nao Informado.";
         $this->erro_campo = "ve04_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve04_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve04_hora"])){ 
       $sql  .= $virgula." ve04_hora = '$this->ve04_hora' ";
       $virgula = ",";
       if(trim((string) $this->ve04_hora) == null ){ 
         $this->erro_sql = " Campo Hora da Baixa nao Informado.";
         $this->erro_campo = "ve04_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve04_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve04_usuario"])){ 
       $sql  .= $virgula." ve04_usuario = $this->ve04_usuario ";
       $virgula = ",";
       if(trim((string) $this->ve04_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "ve04_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve04_motivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve04_motivo"])){ 
       $sql  .= $virgula." ve04_motivo = '$this->ve04_motivo' ";
       $virgula = ",";
       if(trim((string) $this->ve04_motivo) == null ){ 
         $this->erro_sql = " Campo Motivo nao Informado.";
         $this->erro_campo = "ve04_motivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve04_veiccadtipobaixa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve04_veiccadtipobaixa"])){ 
       $sql  .= $virgula." ve04_veiccadtipobaixa = $this->ve04_veiccadtipobaixa ";
       $virgula = ",";
       if(trim((string) $this->ve04_veiccadtipobaixa) == null ){ 
         $this->erro_sql = " Campo Tipo de baixa nao Informado.";
         $this->erro_campo = "ve04_veiccadtipobaixa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve04_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1594,9274,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve04_codigo'))."','$this->ve04_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve04_veiculo"]))
           $resac = db_query("insert into db_acount values($acount,1594,9279,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve04_veiculo'))."','$this->ve04_veiculo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve04_data"]))
           $resac = db_query("insert into db_acount values($acount,1594,9275,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve04_data'))."','$this->ve04_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve04_hora"]))
           $resac = db_query("insert into db_acount values($acount,1594,9276,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve04_hora'))."','$this->ve04_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve04_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1594,9277,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve04_usuario'))."','$this->ve04_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve04_motivo"]))
           $resac = db_query("insert into db_acount values($acount,1594,9278,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve04_motivo'))."','$this->ve04_motivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve04_veiccadtipobaixa"]))
           $resac = db_query("insert into db_acount values($acount,1594,11087,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve04_veiccadtipobaixa'))."','$this->ve04_veiccadtipobaixa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve04_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1594,9274,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve04_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1594,9279,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve04_veiculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1594,9275,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve04_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1594,9276,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve04_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1594,9277,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve04_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1594,9278,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve04_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1594,11087,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve04_veiccadtipobaixa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
