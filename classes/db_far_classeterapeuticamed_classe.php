...
class cl_far_classeterapeuticamed { 
   ...
   public $fa36_i_codigo = 0; 
   public $fa36_i_medanvisa = 0; 
   public $fa36_i_classeterapeutica = 0; 
   ...
   function incluir ($fa36_i_codigo){ 
     ...
     if($fa36_i_codigo == "" || $fa36_i_codigo == null ){
       ...
       $this->fa36_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_classeterapeuticamed_fa36_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa36_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2529,14364,'','".AddSlashes(pg_fetch_result($resaco,0,'fa36_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2529,14365,'','".AddSlashes(pg_fetch_result($resaco,0,'fa36_i_medanvisa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2529,14366,'','".AddSlashes(pg_fetch_result($resaco,0,'fa36_i_classeterapeutica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa36_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa36_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa36_i_codigo"])){ 
       $sql  .= $virgula." fa36_i_codigo = $this->fa36_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa36_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa36_i_medanvisa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa36_i_medanvisa"])){ 
       $sql  .= $virgula." fa36_i_medanvisa = $this->fa36_i_medanvisa ";
       $virgula = ",";
       if(trim((string) $this->fa36_i_medanvisa) == null ){ 
         $this->erro_sql = " Campo Medanvisa nao Informado.";
         $this->erro_campo = "fa36_i_medanvisa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa36_i_classeterapeutica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa36_i_classeterapeutica"])){ 
       $sql  .= $virgula." fa36_i_classeterapeutica = $this->fa36_i_classeterapeutica ";
       $virgula = ",";
       if(trim((string) $this->fa36_i_classeterapeutica) == null ){ 
         $this->erro_sql = " Campo classeterapeutica nao Informado.";
         $this->erro_campo = "fa36_i_classeterapeutica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa36_i_codigo"]) || $this->fa36_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2529,14364,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa36_i_codigo'))."','$this->fa36_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa36_i_medanvisa"]) || $this->fa36_i_medanvisa != "")
           $resac = db_query("insert into db_acount values($acount,2529,14365,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa36_i_medanvisa'))."','$this->fa36_i_medanvisa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa36_i_classeterapeutica"]) || $this->fa36_i_classeterapeutica != "")
           $resac = db_query("insert into db_acount values($acount,2529,14366,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa36_i_classeterapeutica'))."','$this->fa36_i_classeterapeutica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa36_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2529,14364,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa36_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2529,14365,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa36_i_medanvisa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2529,14366,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa36_i_classeterapeutica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
