...
class cl_averbadecisaojudicial { 
   ...
   public $j101_sequencial = 0; 
   public $j101_averbacao = 0; 
   public $j101_processojudicial = null; 
   ...
   function incluir ($j101_sequencial){ 
     ...
     if($j101_sequencial == "" || $j101_sequencial == null ){
       ...
       $this->j101_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from averbadecisaojudicial_j101_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $j101_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2011,11680,'','".AddSlashes(pg_fetch_result($resaco,0,'j101_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2011,11681,'','".AddSlashes(pg_fetch_result($resaco,0,'j101_averbacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2011,11682,'','".AddSlashes(pg_fetch_result($resaco,0,'j101_processojudicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j101_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j101_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j101_sequencial"])){ 
       $sql  .= $virgula." j101_sequencial = $this->j101_sequencial ";
       $virgula = ",";
       if(trim((string) $this->j101_sequencial) == null ){ 
     ...
     if(trim((string) $this->j101_averbacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j101_averbacao"])){ 
       $sql  .= $virgula." j101_averbacao = $this->j101_averbacao ";
       $virgula = ",";
       if(trim((string) $this->j101_averbacao) == null ){ 
         $this->erro_sql = " Campo Averbação nao Informado.";
         $this->erro_campo = "j101_averbacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j101_processojudicial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j101_processojudicial"])){ 
       $sql  .= $virgula." j101_processojudicial = '$this->j101_processojudicial' ";
       $virgula = ",";
       if(trim((string) $this->j101_processojudicial) == null ){ 
         $this->erro_sql = " Campo Processo Judicial nao Informado.";
         $this->erro_campo = "j101_processojudicial";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j101_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2011,11680,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j101_sequencial'))."','$this->j101_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j101_averbacao"]))
           $resac = db_query("insert into db_acount values($acount,2011,11681,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j101_averbacao'))."','$this->j101_averbacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j101_processojudicial"]))
           $resac = db_query("insert into db_acount values($acount,2011,11682,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j101_processojudicial'))."','$this->j101_processojudicial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j101_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2011,11680,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j101_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2011,11681,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j101_averbacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2011,11682,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j101_processojudicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
