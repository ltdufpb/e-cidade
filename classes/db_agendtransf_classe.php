...
class cl_agendtransf { 
   ...
   public $sd31_i_codigo = 0; 
   public $sd31_d_dataorigem_dia = null; 
   public $sd31_d_dataorigem_mes = null; 
   public $sd31_d_dataorigem_ano = null; 
   public $sd31_d_dataorigem = null; 
   public $sd31_i_agendamento = 0; 
   public $sd31_i_usuario = 0; 
   public $sd31_i_undmedorigem = 0; 
   ...
   function incluir ($sd31_i_codigo){ 
     ...
     if($sd31_i_codigo == "" || $sd31_i_codigo == null ){
       ...
       $this->sd31_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from agendtransf_sd31_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $sd31_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010141,1008834,'','".AddSlashes(pg_fetch_result($resaco,0,'sd31_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010141,1008835,'','".AddSlashes(pg_fetch_result($resaco,0,'sd31_d_dataorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010141,1008836,'','".AddSlashes(pg_fetch_result($resaco,0,'sd31_i_agendamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010141,1008837,'','".AddSlashes(pg_fetch_result($resaco,0,'sd31_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010141,1008838,'','".AddSlashes(pg_fetch_result($resaco,0,'sd31_i_undmedorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd31_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd31_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd31_i_codigo"])){ 
       $sql  .= $virgula." sd31_i_codigo = $this->sd31_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->sd31_i_codigo) == null ){ 
     ...
     if(trim((string) $this->sd31_d_dataorigem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd31_d_dataorigem_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["sd31_d_dataorigem_dia"] !="") ){ 
       $sql  .= $virgula." sd31_d_dataorigem = '$this->sd31_d_dataorigem' ";
       $virgula = ",";
       if(trim((string) $this->sd31_d_dataorigem) == null ){ 
         $this->erro_sql = " Campo Origem nao Informado.";
         $this->erro_campo = "sd31_d_dataorigem_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd31_i_agendamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd31_i_agendamento"])){ 
       $sql  .= $virgula." sd31_i_agendamento = $this->sd31_i_agendamento ";
       $virgula = ",";
       if(trim((string) $this->sd31_i_agendamento) == null ){ 
         $this->erro_sql = " Campo Agendamento nao Informado.";
         $this->erro_campo = "sd31_i_agendamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd31_i_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd31_i_usuario"])){ 
       $sql  .= $virgula." sd31_i_usuario = $this->sd31_i_usuario ";
       $virgula = ",";
       if(trim((string) $this->sd31_i_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "sd31_i_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd31_i_undmedorigem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd31_i_undmedorigem"])){ 
       $sql  .= $virgula." sd31_i_undmedorigem = $this->sd31_i_undmedorigem ";
       $virgula = ",";
       if(trim((string) $this->sd31_i_undmedorigem) == null ){ 
         $this->erro_sql = " Campo Unidade / Médico nao Informado.";
         $this->erro_campo = "sd31_i_undmedorigem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd31_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010141,1008834,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd31_i_codigo'))."','$this->sd31_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd31_d_dataorigem"]))
           $resac = db_query("insert into db_acount values($acount,1010141,1008835,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd31_d_dataorigem'))."','$this->sd31_d_dataorigem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd31_i_agendamento"]))
           $resac = db_query("insert into db_acount values($acount,1010141,1008836,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd31_i_agendamento'))."','$this->sd31_i_agendamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd31_i_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1010141,1008837,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd31_i_usuario'))."','$this->sd31_i_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd31_i_undmedorigem"]))
           $resac = db_query("insert into db_acount values($acount,1010141,1008838,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd31_i_undmedorigem'))."','$this->sd31_i_undmedorigem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd31_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010141,1008834,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd31_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010141,1008835,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd31_d_dataorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010141,1008836,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd31_i_agendamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010141,1008837,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd31_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010141,1008838,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd31_i_undmedorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
