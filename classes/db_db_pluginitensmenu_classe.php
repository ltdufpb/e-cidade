...
class cl_db_pluginitensmenu { 
   ...
   public $db146_sequencial = 0; 
   public $db146_db_plugin = 0; 
   public $db146_db_itensmenu = 0; 
   public $db146_uid = null; 
   ...
   function incluir ($db146_sequencial){ 
     ...
     if($db146_sequencial == "" || $db146_sequencial == null ){
       ...
       $this->db146_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_pluginitensmenu_db146_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db146_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3673,20427,'','".AddSlashes(pg_fetch_result($resaco,0,'db146_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3673,20434,'','".AddSlashes(pg_fetch_result($resaco,0,'db146_db_plugin'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3673,20435,'','".AddSlashes(pg_fetch_result($resaco,0,'db146_db_itensmenu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3673,21696,'','".AddSlashes(pg_fetch_result($resaco,0,'db146_uid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($db146_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db146_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db146_sequencial"])){ 
       $sql  .= $virgula." db146_sequencial = $this->db146_sequencial ";
       $virgula = ",";
       if(trim((string) $this->db146_sequencial) == null ){ 
         $this->erro_sql = " Campo Código não informado.";
     ...
     if(trim((string) $this->db146_db_plugin)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db146_db_plugin"])){ 
       $sql  .= $virgula." db146_db_plugin = $this->db146_db_plugin ";
       $virgula = ",";
       if(trim((string) $this->db146_db_plugin) == null ){ 
         $this->erro_sql = " Campo Código não informado.";
         $this->erro_campo = "db146_db_plugin";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db146_db_itensmenu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db146_db_itensmenu"])){ 
       $sql  .= $virgula." db146_db_itensmenu = $this->db146_db_itensmenu ";
       $virgula = ",";
       if(trim((string) $this->db146_db_itensmenu) == null ){ 
         $this->erro_sql = " Campo Código do ítem não informado.";
         $this->erro_campo = "db146_db_itensmenu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db146_uid)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db146_uid"])){ 
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["db146_sequencial"]) || $this->db146_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3673,20427,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db146_sequencial'))."','$this->db146_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["db146_db_plugin"]) || $this->db146_db_plugin != "")
             $resac = db_query("insert into db_acount values($acount,3673,20434,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db146_db_plugin'))."','$this->db146_db_plugin',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["db146_db_itensmenu"]) || $this->db146_db_itensmenu != "")
             $resac = db_query("insert into db_acount values($acount,3673,20435,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db146_db_itensmenu'))."','$this->db146_db_itensmenu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["db146_uid"]) || $this->db146_uid != "")
             $resac = db_query("insert into db_acount values($acount,3673,21696,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db146_uid'))."','$this->db146_uid',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3673,20427,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db146_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3673,20434,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db146_db_plugin'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3673,20435,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db146_db_itensmenu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3673,21696,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db146_uid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
