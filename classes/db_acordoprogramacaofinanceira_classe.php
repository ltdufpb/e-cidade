...
class cl_acordoprogramacaofinanceira {
   ...
   function alterar ($ac34_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->ac34_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac34_sequencial"])){
       $sql  .= $virgula." ac34_sequencial = $this->ac34_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac34_sequencial) == null ){
     ...
     if(trim((string) $this->ac34_programacaofinanceira)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac34_programacaofinanceira"])){
       $sql  .= $virgula." ac34_programacaofinanceira = $this->ac34_programacaofinanceira ";
       $virgula = ",";
       if(trim((string) $this->ac34_programacaofinanceira) == null ){
         $this->erro_sql = " Campo Programação Financeira nao Informado.";
         $this->erro_campo = "ac34_programacaofinanceira";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac34_acordo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac34_acordo"])){
       $sql  .= $virgula." ac34_acordo = $this->ac34_acordo ";
       $virgula = ",";
       if(trim((string) $this->ac34_acordo) == null ){
         $this->erro_sql = " Campo Acordo nao Informado.";
         $this->erro_campo = "ac34_acordo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
