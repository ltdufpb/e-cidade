...
class cl_editalruaproj { 
   ...
   function incluir ($d11_contri,$d11_codproj){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,629,4727,'','".AddSlashes(pg_fetch_result($resaco,0,'d11_contri'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,629,4728,'','".AddSlashes(pg_fetch_result($resaco,0,'d11_codproj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($d11_contri=null,$d11_codproj=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->d11_contri)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d11_contri"])){ 
       $sql  .= $virgula." d11_contri = $this->d11_contri ";
       $virgula = ",";
       if(trim((string) $this->d11_contri) == null ){ 
     ...
     if(trim((string) $this->d11_codproj)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d11_codproj"])){ 
       $sql  .= $virgula." d11_codproj = $this->d11_codproj ";
       $virgula = ",";
       if(trim((string) $this->d11_codproj) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["d11_contri"]))
           $resac = db_query("insert into db_acount values($acount,629,4727,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d11_contri'))."','$this->d11_contri',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d11_codproj"]))
           $resac = db_query("insert into db_acount values($acount,629,4728,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d11_codproj'))."','$this->d11_codproj',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($d11_contri=null,$d11_codproj=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,629,4727,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d11_contri'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,629,4728,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d11_codproj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
