...
class cl_iptuconstr {
   ...
   public function incluir ($j39_matric,$j39_idcons){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,30,150,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,30,151,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_idcons'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,30,152,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_ano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,30,153,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_area'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,30,154,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_areap'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,30,155,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_dtlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,30,156,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,30,157,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,30,158,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_compl'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,30,2490,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_dtdemo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,30,18437,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_codprotdemo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,30,2491,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_idaument'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,30,2532,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_idprinc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,30,5085,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_pavim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,30,18543,'','".AddSlashes(pg_fetch_result($resaco,0,'j39_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   public function alterar ($j39_matric=null,$j39_idcons=null) {
     ...
     $virgula = "";
     if(trim((string) $this->j39_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j39_matric"])){
       $sql  .= $virgula." j39_matric = $this->j39_matric ";
       $virgula = ",";
       if(trim((string) $this->j39_matric) == null ){
     ...
     if(trim((string) $this->j39_idcons)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j39_idcons"])){
       $sql  .= $virgula." j39_idcons = $this->j39_idcons ";
       $virgula = ",";
       if(trim((string) $this->j39_idcons) == null ){
     ...
     if(trim((string) $this->j39_ano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j39_ano"])){
        if(trim((string) $this->j39_ano)=="" && isset($GLOBALS["HTTP_POST_VARS"]["j39_ano"])){
           $this->j39_ano = "0" ;
        }
     ...
     if(trim((string) $this->j39_area)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j39_area"])){
       $sql  .= $virgula." j39_area = $this->j39_area ";
       $virgula = ",";
       if(trim((string) $this->j39_area) == null ){
         $this->erro_sql = " Campo Área da Construção M2 nao Informado.";
         $this->erro_campo = "j39_area";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j39_areap)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j39_areap"])){
        if(trim((string) $this->j39_areap)=="" && isset($GLOBALS["HTTP_POST_VARS"]["j39_areap"])){
           $this->j39_areap = "0" ;
        }
     ...
     if(trim((string) $this->j39_dtlan)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j39_dtlan_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["j39_dtlan_dia"] !="") ){
       $sql  .= $virgula." j39_dtlan = '$this->j39_dtlan' ";
       $virgula = ",";
       if(trim((string) $this->j39_dtlan) == null ){
         $this->erro_sql = " Campo Data de Inclusão nao Informado.";
         $this->erro_campo = "j39_dtlan_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j39_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j39_codigo"])){
       $sql  .= $virgula." j39_codigo = $this->j39_codigo ";
       $virgula = ",";
       if(trim((string) $this->j39_codigo) == null ){
         $this->erro_sql = " Campo Logradouro nao Informado.";
         $this->erro_campo = "j39_codigo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j39_dtdemo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j39_dtdemo_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["j39_dtdemo_dia"] !="") ){
     ...
     if(trim((string) $this->j39_codprotdemo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j39_codprotdemo"])){
       $sql  .= $virgula." j39_codprotdemo = '$this->j39_codprotdemo' ";
       $virgula = ",";
     }
     if(trim((string) $this->j39_idaument)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j39_idaument"])){
        if(trim((string) $this->j39_idaument)=="" && isset($GLOBALS["HTTP_POST_VARS"]["j39_idaument"])){
           $this->j39_idaument = "0" ;
        }
     ...
     if(trim((string) $this->j39_idprinc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j39_idprinc"])){
       $sql  .= $virgula." j39_idprinc = '$this->j39_idprinc' ";
       $virgula = ",";
       if(trim((string) $this->j39_idprinc) == null ){
         $this->erro_sql = " Campo Construção Principal nao Informado.";
         $this->erro_campo = "j39_idprinc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j39_pavim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j39_pavim"])){
       $sql  .= $virgula." j39_pavim = $this->j39_pavim ";
       $virgula = ",";
       if(trim((string) $this->j39_pavim) == null ){
         $this->erro_sql = " Campo Pavimento nao Informado.";
         $this->erro_campo = "j39_pavim";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j39_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j39_obs"])){
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_matric"]) || $this->j39_matric != "")
           $resac = db_query("insert into db_acount values($acount,30,150,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_matric'))."','$this->j39_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_idcons"]) || $this->j39_idcons != "")
           $resac = db_query("insert into db_acount values($acount,30,151,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_idcons'))."','$this->j39_idcons',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_ano"]) || $this->j39_ano != "")
           $resac = db_query("insert into db_acount values($acount,30,152,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_ano'))."','$this->j39_ano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_area"]) || $this->j39_area != "")
           $resac = db_query("insert into db_acount values($acount,30,153,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_area'))."','$this->j39_area',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_areap"]) || $this->j39_areap != "")
           $resac = db_query("insert into db_acount values($acount,30,154,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_areap'))."','$this->j39_areap',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_dtlan"]) || $this->j39_dtlan != "")
           $resac = db_query("insert into db_acount values($acount,30,155,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_dtlan'))."','$this->j39_dtlan',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_codigo"]) || $this->j39_codigo != "")
           $resac = db_query("insert into db_acount values($acount,30,156,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_codigo'))."','$this->j39_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_numero"]) || $this->j39_numero != "")
           $resac = db_query("insert into db_acount values($acount,30,157,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_numero'))."','$this->j39_numero',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_compl"]) || $this->j39_compl != "")
           $resac = db_query("insert into db_acount values($acount,30,158,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_compl'))."','$this->j39_compl',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_dtdemo"]) || $this->j39_dtdemo != "")
           $resac = db_query("insert into db_acount values($acount,30,2490,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_dtdemo'))."','$this->j39_dtdemo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_codprotdemo"]) || $this->j39_codprotdemo != "")
           $resac = db_query("insert into db_acount values($acount,30,18437,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_codprotdemo'))."','$this->j39_codprotdemo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_idaument"]) || $this->j39_idaument != "")
           $resac = db_query("insert into db_acount values($acount,30,2491,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_idaument'))."','$this->j39_idaument',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_idprinc"]) || $this->j39_idprinc != "")
           $resac = db_query("insert into db_acount values($acount,30,2532,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_idprinc'))."','$this->j39_idprinc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_pavim"]) || $this->j39_pavim != "")
           $resac = db_query("insert into db_acount values($acount,30,5085,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_pavim'))."','$this->j39_pavim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j39_obs"]) || $this->j39_obs != "")
           $resac = db_query("insert into db_acount values($acount,30,18543,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j39_obs'))."','$this->j39_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   public function excluir ($j39_matric=null,$j39_idcons=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,30,150,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,30,151,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_idcons'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,30,152,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_ano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,30,153,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_area'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,30,154,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_areap'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,30,155,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_dtlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,30,156,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,30,157,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,30,158,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_compl'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,30,2490,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_dtdemo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,30,18437,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_codprotdemo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,30,2491,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_idaument'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,30,2532,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_idprinc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,30,5085,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_pavim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,30,18543,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j39_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
