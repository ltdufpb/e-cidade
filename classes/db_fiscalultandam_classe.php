...
class cl_fiscalultandam { 
   ...
   function incluir ($y19_codnoti,$y19_codandam){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,722,5071,'','".AddSlashes(pg_fetch_result($resaco,0,'y19_codnoti'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,722,5072,'','".AddSlashes(pg_fetch_result($resaco,0,'y19_codandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y19_codnoti=null,$y19_codandam=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y19_codnoti)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y19_codnoti"])){ 
       $sql  .= $virgula." y19_codnoti = $this->y19_codnoti ";
       $virgula = ",";
       if(trim((string) $this->y19_codnoti) == null ){ 
     ...
     if(trim((string) $this->y19_codandam)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y19_codandam"])){ 
       $sql  .= $virgula." y19_codandam = $this->y19_codandam ";
       $virgula = ",";
       if(trim((string) $this->y19_codandam) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y19_codnoti"]))
           $resac = db_query("insert into db_acount values($acount,722,5071,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y19_codnoti'))."','$this->y19_codnoti',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y19_codandam"]))
           $resac = db_query("insert into db_acount values($acount,722,5072,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y19_codandam'))."','$this->y19_codandam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y19_codnoti=null,$y19_codandam=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,722,5071,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y19_codnoti'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,722,5072,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y19_codandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
