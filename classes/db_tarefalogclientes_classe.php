...
class cl_tarefalogclientes { 
   ...
   public $at68_sequen = 0; 
   public $at68_codmov = 0; 
   public $at68_codcli = 0; 
   ...
   function incluir ($at68_sequen){ 
     ...
     if($at68_sequen == "" || $at68_sequen == null ){
       ...
       $this->at68_sequen = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tarefalogclientes_at68_sequen_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at68_sequen)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1824,10570,'','".AddSlashes(pg_fetch_result($resaco,0,'at68_sequen'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1824,10568,'','".AddSlashes(pg_fetch_result($resaco,0,'at68_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1824,10569,'','".AddSlashes(pg_fetch_result($resaco,0,'at68_codcli'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at68_sequen=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at68_sequen)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at68_sequen"])){ 
       $sql  .= $virgula." at68_sequen = $this->at68_sequen ";
       $virgula = ",";
       if(trim((string) $this->at68_sequen) == null ){ 
     ...
     if(trim((string) $this->at68_codmov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at68_codmov"])){ 
       $sql  .= $virgula." at68_codmov = $this->at68_codmov ";
       $virgula = ",";
       if(trim((string) $this->at68_codmov) == null ){ 
         $this->erro_sql = " Campo Codigo de Andamento nao Informado.";
         $this->erro_campo = "at68_codmov";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at68_codcli)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at68_codcli"])){ 
       $sql  .= $virgula." at68_codcli = $this->at68_codcli ";
       $virgula = ",";
       if(trim((string) $this->at68_codcli) == null ){ 
         $this->erro_sql = " Campo Código do cliente nao Informado.";
         $this->erro_campo = "at68_codcli";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at68_sequen"]))
           $resac = db_query("insert into db_acount values($acount,1824,10570,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at68_sequen'))."','$this->at68_sequen',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at68_codmov"]))
           $resac = db_query("insert into db_acount values($acount,1824,10568,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at68_codmov'))."','$this->at68_codmov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at68_codcli"]))
           $resac = db_query("insert into db_acount values($acount,1824,10569,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at68_codcli'))."','$this->at68_codcli',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at68_sequen=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1824,10570,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at68_sequen'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1824,10568,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at68_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1824,10569,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at68_codcli'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
