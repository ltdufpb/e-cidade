...
class cl_empempenhocontrato {
   ...
   function alterar ($e100_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->e100_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e100_sequencial"])){
       $sql  .= $virgula." e100_sequencial = $this->e100_sequencial ";
       $virgula = ",";
       if(trim((string) $this->e100_sequencial) == null ){
     ...
     if(trim((string) $this->e100_numemp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e100_numemp"])){
       $sql  .= $virgula." e100_numemp = $this->e100_numemp ";
       $virgula = ",";
       if(trim((string) $this->e100_numemp) == null ){
         $this->erro_sql = " Campo Código do Empenho nao Informado.";
         $this->erro_campo = "e100_numemp";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e100_acordo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e100_acordo"])){
       $sql  .= $virgula." e100_acordo = $this->e100_acordo ";
       $virgula = ",";
       if(trim((string) $this->e100_acordo) == null ){
         $this->erro_sql = " Campo Número do Contrato nao Informado.";
         $this->erro_campo = "e100_acordo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
