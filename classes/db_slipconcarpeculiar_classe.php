...
class cl_slipconcarpeculiar {
   ...
   public $k131_sequencial = 0;
   public $k131_slip = 0;
   public $k131_tipo = 0;
   public $k131_concarpeculiar = null;
   ...
   function incluir ($k131_sequencial){
     ...
     if($k131_sequencial == "" || $k131_sequencial == null ){
       ...
       $this->k131_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from slipconcarpeculiar_k131_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k131_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3209,18166,'','".AddSlashes(pg_fetch_result($resaco,0,'k131_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3209,18167,'','".AddSlashes(pg_fetch_result($resaco,0,'k131_slip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3209,18168,'','".AddSlashes(pg_fetch_result($resaco,0,'k131_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3209,18169,'','".AddSlashes(pg_fetch_result($resaco,0,'k131_concarpeculiar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($k131_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->k131_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k131_sequencial"])){
       $sql  .= $virgula." k131_sequencial = $this->k131_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k131_sequencial) == null ){
     ...
     if(trim((string) $this->k131_slip)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k131_slip"])){
       $sql  .= $virgula." k131_slip = $this->k131_slip ";
       $virgula = ",";
       if(trim((string) $this->k131_slip) == null ){
         $this->erro_sql = " Campo Código do Slip nao Informado.";
         $this->erro_campo = "k131_slip";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k131_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k131_tipo"])){
       $sql  .= $virgula." k131_tipo = $this->k131_tipo ";
       $virgula = ",";
       if(trim((string) $this->k131_tipo) == null ){
         $this->erro_sql = " Campo Tipo de Característica nao Informado.";
         $this->erro_campo = "k131_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k131_concarpeculiar)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k131_concarpeculiar"])){
       $sql  .= $virgula." k131_concarpeculiar = '$this->k131_concarpeculiar' ";
       $virgula = ",";
       if(trim((string) $this->k131_concarpeculiar) == null ){
         $this->erro_sql = " Campo C. Peculiar / C. Aplicação nao Informado.";
         $this->erro_campo = "k131_concarpeculiar";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k131_sequencial"]) || $this->k131_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3209,18166,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k131_sequencial'))."','$this->k131_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k131_slip"]) || $this->k131_slip != "")
           $resac = db_query("insert into db_acount values($acount,3209,18167,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k131_slip'))."','$this->k131_slip',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k131_tipo"]) || $this->k131_tipo != "")
           $resac = db_query("insert into db_acount values($acount,3209,18168,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k131_tipo'))."','$this->k131_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k131_concarpeculiar"]) || $this->k131_concarpeculiar != "")
           $resac = db_query("insert into db_acount values($acount,3209,18169,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k131_concarpeculiar'))."','$this->k131_concarpeculiar',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($k131_sequencial=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3209,18166,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k131_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3209,18167,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k131_slip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3209,18168,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k131_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3209,18169,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k131_concarpeculiar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
