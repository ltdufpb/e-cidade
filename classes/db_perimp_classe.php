...
class cl_perimp { 
   ...
   function incluir ($d51_usuario,$d51_impres){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,322,1948,'','".AddSlashes(pg_fetch_result($resaco,0,'d51_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,322,1949,'','".AddSlashes(pg_fetch_result($resaco,0,'d51_impres'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($d51_usuario=null,$d51_impres=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->d51_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d51_usuario"])){ 
       $sql  .= $virgula." d51_usuario = $this->d51_usuario ";
       $virgula = ",";
       if(trim((string) $this->d51_usuario) == null ){ 
     ...
     if(trim((string) $this->d51_impres)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d51_impres"])){ 
       $sql  .= $virgula." d51_impres = $this->d51_impres ";
       $virgula = ",";
       if(trim((string) $this->d51_impres) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["d51_usuario"]))
           $resac = db_query("insert into db_acount values($acount,322,1948,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d51_usuario'))."','$this->d51_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d51_impres"]))
           $resac = db_query("insert into db_acount values($acount,322,1949,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d51_impres'))."','$this->d51_impres',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($d51_usuario=null,$d51_impres=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,322,1948,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d51_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,322,1949,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d51_impres'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
