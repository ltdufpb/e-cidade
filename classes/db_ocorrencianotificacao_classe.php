...
class cl_ocorrencianotificacao { 
   ...
   public $ed105_sequencial = 0; 
   public $ed105_ocorrencia = 0; 
   public $ed105_mensagemnotificacao = 0; 
   ...
   function incluir ($ed105_sequencial){ 
     ...
     if($ed105_sequencial == "" || $ed105_sequencial == null ){
       ...
       $this->ed105_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from ocorrencianotificacao_ed105_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed105_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3422,19254,'','".AddSlashes(pg_fetch_result($resaco,0,'ed105_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3422,19255,'','".AddSlashes(pg_fetch_result($resaco,0,'ed105_ocorrencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3422,19268,'','".AddSlashes(pg_fetch_result($resaco,0,'ed105_mensagemnotificacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed105_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed105_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed105_sequencial"])){ 
       $sql  .= $virgula." ed105_sequencial = $this->ed105_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed105_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed105_ocorrencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed105_ocorrencia"])){ 
       $sql  .= $virgula." ed105_ocorrencia = $this->ed105_ocorrencia ";
       $virgula = ",";
       if(trim((string) $this->ed105_ocorrencia) == null ){ 
         $this->erro_sql = " Campo Ocorrência nao Informado.";
         $this->erro_campo = "ed105_ocorrencia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed105_mensagemnotificacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed105_mensagemnotificacao"])){ 
       $sql  .= $virgula." ed105_mensagemnotificacao = $this->ed105_mensagemnotificacao ";
       $virgula = ",";
       if(trim((string) $this->ed105_mensagemnotificacao) == null ){ 
         $this->erro_sql = " Campo Mensagem Notificação nao Informado.";
         $this->erro_campo = "ed105_mensagemnotificacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed105_sequencial"]) || $this->ed105_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3422,19254,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed105_sequencial'))."','$this->ed105_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed105_ocorrencia"]) || $this->ed105_ocorrencia != "")
           $resac = db_query("insert into db_acount values($acount,3422,19255,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed105_ocorrencia'))."','$this->ed105_ocorrencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed105_mensagemnotificacao"]) || $this->ed105_mensagemnotificacao != "")
           $resac = db_query("insert into db_acount values($acount,3422,19268,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed105_mensagemnotificacao'))."','$this->ed105_mensagemnotificacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed105_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3422,19254,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed105_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3422,19255,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed105_ocorrencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3422,19268,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed105_mensagemnotificacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
