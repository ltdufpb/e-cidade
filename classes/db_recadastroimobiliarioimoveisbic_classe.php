...
class cl_recadastroimobiliarioimoveisbic { 
   ...
   public $ie29_sequencial = 0; 
   public $ie29_arquivobic = 0; 
   public $ie29_iptubase = 0; 
   ...
   function incluir ($ie29_sequencial){ 
     ...
     if($ie29_sequencial == "" || $ie29_sequencial == null ){
       ...
       $this->ie29_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from recadastroimobiliarioimoveisbic_ie29_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ie29_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3468,19517,'','".AddSlashes(pg_fetch_result($resaco,0,'ie29_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3468,19519,'','".AddSlashes(pg_fetch_result($resaco,0,'ie29_arquivobic'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3468,19520,'','".AddSlashes(pg_fetch_result($resaco,0,'ie29_iptubase'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ie29_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ie29_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ie29_sequencial"])){ 
       $sql  .= $virgula." ie29_sequencial = $this->ie29_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ie29_sequencial) == null ){ 
     ...
     if(trim((string) $this->ie29_arquivobic)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ie29_arquivobic"])){ 
       $sql  .= $virgula." ie29_arquivobic = $this->ie29_arquivobic ";
       $virgula = ",";
       if(trim((string) $this->ie29_arquivobic) == null ){ 
         $this->erro_sql = " Campo Arquivo Bic nao Informado.";
         $this->erro_campo = "ie29_arquivobic";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ie29_iptubase)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ie29_iptubase"])){ 
       $sql  .= $virgula." ie29_iptubase = $this->ie29_iptubase ";
       $virgula = ",";
       if(trim((string) $this->ie29_iptubase) == null ){ 
         $this->erro_sql = " Campo Matrícula do Imóvel nao Informado.";
         $this->erro_campo = "ie29_iptubase";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ie29_sequencial"]) || $this->ie29_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3468,19517,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ie29_sequencial'))."','$this->ie29_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ie29_arquivobic"]) || $this->ie29_arquivobic != "")
           $resac = db_query("insert into db_acount values($acount,3468,19519,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ie29_arquivobic'))."','$this->ie29_arquivobic',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ie29_iptubase"]) || $this->ie29_iptubase != "")
           $resac = db_query("insert into db_acount values($acount,3468,19520,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ie29_iptubase'))."','$this->ie29_iptubase',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ie29_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3468,19517,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ie29_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3468,19519,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ie29_arquivobic'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3468,19520,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ie29_iptubase'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
