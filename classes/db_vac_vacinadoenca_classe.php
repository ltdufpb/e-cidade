...
class cl_vac_vacinadoenca { 
   ...
   public $vc10_i_codigo = 0; 
   public $vc10_i_vacina = 0; 
   public $vc10_i_cid = 0; 
   ...
   function incluir ($vc10_i_codigo){ 
     ...
     if($vc10_i_codigo == "" || $vc10_i_codigo == null ){
       ...
       $this->vc10_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from vac_vacinadoenca_vc10_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $vc10_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2964,16841,'','".AddSlashes(pg_fetch_result($resaco,0,'vc10_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2964,16842,'','".AddSlashes(pg_fetch_result($resaco,0,'vc10_i_vacina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2964,16843,'','".AddSlashes(pg_fetch_result($resaco,0,'vc10_i_cid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($vc10_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->vc10_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc10_i_codigo"])){ 
       $sql  .= $virgula." vc10_i_codigo = $this->vc10_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->vc10_i_codigo) == null ){ 
     ...
     if(trim((string) $this->vc10_i_vacina)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc10_i_vacina"])){ 
       $sql  .= $virgula." vc10_i_vacina = $this->vc10_i_vacina ";
       $virgula = ",";
       if(trim((string) $this->vc10_i_vacina) == null ){ 
         $this->erro_sql = " Campo Vacina nao Informado.";
         $this->erro_campo = "vc10_i_vacina";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc10_i_cid)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc10_i_cid"])){ 
       $sql  .= $virgula." vc10_i_cid = $this->vc10_i_cid ";
       $virgula = ",";
       if(trim((string) $this->vc10_i_cid) == null ){ 
         $this->erro_sql = " Campo CID nao Informado.";
         $this->erro_campo = "vc10_i_cid";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc10_i_codigo"]) || $this->vc10_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2964,16841,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc10_i_codigo'))."','$this->vc10_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc10_i_vacina"]) || $this->vc10_i_vacina != "")
           $resac = db_query("insert into db_acount values($acount,2964,16842,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc10_i_vacina'))."','$this->vc10_i_vacina',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc10_i_cid"]) || $this->vc10_i_cid != "")
           $resac = db_query("insert into db_acount values($acount,2964,16843,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc10_i_cid'))."','$this->vc10_i_cid',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($vc10_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2964,16841,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc10_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2964,16842,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc10_i_vacina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2964,16843,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc10_i_cid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
