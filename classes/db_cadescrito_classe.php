...
class cl_cadescrito { 
   ...
   public $q86_numcgm = 0; 
   public $q86_datalimite_dia = null; 
   public $q86_datalimite_mes = null; 
   public $q86_datalimite_ano = null; 
   public $q86_datalimite = null; 
   ...
   function incluir ($q86_numcgm){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,52,303,'','".AddSlashes(pg_fetch_result($resaco,0,'q86_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,52,18282,'','".AddSlashes(pg_fetch_result($resaco,0,'q86_datalimite'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q86_numcgm=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q86_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q86_numcgm"])){ 
       $sql  .= $virgula." q86_numcgm = $this->q86_numcgm ";
       $virgula = ",";
       if(trim((string) $this->q86_numcgm) == null ){ 
     ...
     if(trim((string) $this->q86_datalimite)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q86_datalimite_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["q86_datalimite_dia"] !="") ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q86_numcgm"]) || $this->q86_numcgm != "")
           $resac = db_query("insert into db_acount values($acount,52,303,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q86_numcgm'))."','$this->q86_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q86_datalimite"]) || $this->q86_datalimite != "")
           $resac = db_query("insert into db_acount values($acount,52,18282,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q86_datalimite'))."','$this->q86_datalimite',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q86_numcgm=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,52,303,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q86_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,52,18282,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q86_datalimite'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
