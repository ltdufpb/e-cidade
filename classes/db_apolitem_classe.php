...
class cl_apolitem { 
   ...
   function incluir ($t82_codapo,$t82_codbem){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,929,5820,'','".AddSlashes(pg_fetch_result($resaco,0,'t82_codapo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,929,5821,'','".AddSlashes(pg_fetch_result($resaco,0,'t82_codbem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($t82_codapo=null,$t82_codbem=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->t82_codapo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t82_codapo"])){ 
       $sql  .= $virgula." t82_codapo = $this->t82_codapo ";
       $virgula = ",";
       if(trim((string) $this->t82_codapo) == null ){ 
     ...
     if(trim((string) $this->t82_codbem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t82_codbem"])){ 
       $sql  .= $virgula." t82_codbem = $this->t82_codbem ";
       $virgula = ",";
       if(trim((string) $this->t82_codbem) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["t82_codapo"]))
           $resac = db_query("insert into db_acount values($acount,929,5820,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t82_codapo'))."','$this->t82_codapo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t82_codbem"]))
           $resac = db_query("insert into db_acount values($acount,929,5821,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t82_codbem'))."','$this->t82_codbem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($t82_codapo=null,$t82_codbem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,929,5820,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t82_codapo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,929,5821,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t82_codbem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
