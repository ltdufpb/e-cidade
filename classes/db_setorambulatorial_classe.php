...
class cl_setorambulatorial { 
   ...
   function incluir ($sd91_codigo){ 
     ...
     if($sd91_codigo == "" || $sd91_codigo == null ){
       ...
       $this->sd91_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from setorambulatorial_sd91_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $sd91_codigo)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3772,20939,'','".AddSlashes(pg_fetch_result($resaco,0,'sd91_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3772,20940,'','".AddSlashes(pg_fetch_result($resaco,0,'sd91_unidades'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3772,20941,'','".AddSlashes(pg_fetch_result($resaco,0,'sd91_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3772,20942,'','".AddSlashes(pg_fetch_result($resaco,0,'sd91_local'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($sd91_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd91_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd91_codigo"])){ 
       $sql  .= $virgula." sd91_codigo = $this->sd91_codigo ";
       $virgula = ",";
       if(trim((string) $this->sd91_codigo) == null ){ 
     ...
     if(trim((string) $this->sd91_unidades)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd91_unidades"])){ 
       $sql  .= $virgula." sd91_unidades = $this->sd91_unidades ";
       $virgula = ",";
       if(trim((string) $this->sd91_unidades) == null ){ 
         $this->erro_sql = " Campo Unidade não informado.";
         $this->erro_campo = "sd91_unidades";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd91_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd91_descricao"])){ 
       $sql  .= $virgula." sd91_descricao = '$this->sd91_descricao' ";
       $virgula = ",";
       if(trim((string) $this->sd91_descricao) == null ){ 
         $this->erro_sql = " Campo Setor não informado.";
         $this->erro_campo = "sd91_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd91_local)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd91_local"])){ 
       $sql  .= $virgula." sd91_local = $this->sd91_local ";
       $virgula = ",";
       if(trim((string) $this->sd91_local) == null ){ 
         $this->erro_sql = " Campo Local não informado.";
         $this->erro_campo = "sd91_local";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["sd91_codigo"]) || $this->sd91_codigo != "")
             $resac = db_query("insert into db_acount values($acount,3772,20939,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd91_codigo'))."','$this->sd91_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["sd91_unidades"]) || $this->sd91_unidades != "")
             $resac = db_query("insert into db_acount values($acount,3772,20940,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd91_unidades'))."','$this->sd91_unidades',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["sd91_descricao"]) || $this->sd91_descricao != "")
             $resac = db_query("insert into db_acount values($acount,3772,20941,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd91_descricao'))."','$this->sd91_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["sd91_local"]) || $this->sd91_local != "")
             $resac = db_query("insert into db_acount values($acount,3772,20942,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd91_local'))."','$this->sd91_local',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3772,20939,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd91_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3772,20940,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd91_unidades'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3772,20941,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd91_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3772,20942,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd91_local'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
