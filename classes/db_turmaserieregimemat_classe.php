...
class cl_turmaserieregimemat { 
   ...
   public $ed220_i_turma = 0;
   public $ed220_i_serieregimemat = 0; 
   public $ed220_c_historico = null;
   public $ed220_i_procedimento = 0;
   public $ed220_c_aprovauto = null;
   ...
   function incluir ($ed220_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2627,14962,'','".AddSlashes(pg_fetch_result($resaco,0,'ed220_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2627,14963,'','".AddSlashes(pg_fetch_result($resaco,0,'ed220_i_turma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2627,14964,'','".AddSlashes(pg_fetch_result($resaco,0,'ed220_i_serieregimemat'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2627,14965,'','".AddSlashes(pg_fetch_result($resaco,0,'ed220_c_historico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2627,17207,'','".AddSlashes(pg_fetch_result($resaco,0,'ed220_i_procedimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2627,17208,'','".AddSlashes(pg_fetch_result($resaco,0,'ed220_c_aprovauto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed220_i_codigo=null) { 
     ...
     if(trim((string) $this->ed220_i_turma)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed220_i_turma"])){ 
       $sql  .= $virgula." ed220_i_turma = $this->ed220_i_turma ";
       $virgula = ",";
       if(trim((string) $this->ed220_i_turma) == null ){ 
         $this->erro_sql = " Campo Turma nao Informado.";
         $this->erro_campo = "ed220_i_turma";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed220_i_serieregimemat)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed220_i_serieregimemat"])){ 
       $sql  .= $virgula." ed220_i_serieregimemat = $this->ed220_i_serieregimemat ";
       $virgula = ",";
       if(trim((string) $this->ed220_i_serieregimemat) == null ){ 
         $this->erro_sql = " Campo Etapa nao Informado.";
         $this->erro_campo = "ed220_i_serieregimemat";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed220_c_historico)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed220_c_historico"])){ 
       $sql  .= $virgula." ed220_c_historico = '$this->ed220_c_historico' ";
       $virgula = ",";
       if(trim((string) $this->ed220_c_historico) == null ){ 
         $this->erro_sql = " Campo Incluir no Histórico nao Informado.";
         $this->erro_campo = "ed220_c_historico";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed220_i_procedimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed220_i_procedimento"])){ 
       $sql  .= $virgula." ed220_i_procedimento = $this->ed220_i_procedimento ";
       $virgula = ",";
       if(trim((string) $this->ed220_i_procedimento) == null ){ 
         $this->erro_sql = " Campo Procedimento de Avaliação nao Informado.";
         $this->erro_campo = "ed220_i_procedimento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed220_c_aprovauto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed220_c_aprovauto"])){ 
       $sql  .= $virgula." ed220_c_aprovauto = '$this->ed220_c_aprovauto' ";
       $virgula = ",";
       if(trim((string) $this->ed220_c_aprovauto) == null ){ 
         $this->erro_sql = " Campo Aprovação Automática nao Informado.";
         $this->erro_campo = "ed220_c_aprovauto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed220_i_codigo"]) || $this->ed220_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2627,14962,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed220_i_codigo'))."','$this->ed220_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed220_i_turma"]) || $this->ed220_i_turma != "")
           $resac = db_query("insert into db_acount values($acount,2627,14963,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed220_i_turma'))."','$this->ed220_i_turma',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed220_i_serieregimemat"]) || $this->ed220_i_serieregimemat != "")
           $resac = db_query("insert into db_acount values($acount,2627,14964,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed220_i_serieregimemat'))."','$this->ed220_i_serieregimemat',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed220_c_historico"]) || $this->ed220_c_historico != "")
           $resac = db_query("insert into db_acount values($acount,2627,14965,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed220_c_historico'))."','$this->ed220_c_historico',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed220_i_procedimento"]) || $this->ed220_i_procedimento != "")
           $resac = db_query("insert into db_acount values($acount,2627,17207,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed220_i_procedimento'))."','$this->ed220_i_procedimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed220_c_aprovauto"]) || $this->ed220_c_aprovauto!= "")
           $resac = db_query("insert into db_acount values($acount,2627,17208,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed220_c_aprovauto'))."','$this->ed220_c_aprovauto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed220_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2627,14962,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed220_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2627,14963,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed220_i_turma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2627,14964,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed220_i_serieregimemat'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2627,14965,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed220_c_historico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2627,17207,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed220_i_procedimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2627,17208,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed220_c_aprovauto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
