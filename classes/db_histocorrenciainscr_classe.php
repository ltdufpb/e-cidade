...
class cl_histocorrenciainscr { 
   ...
   public $ar26_sequencial = 0; 
   public $ar26_inscr = 0; 
   public $ar26_histocorrencia = 0; 
   ...
   function incluir ($ar26_sequencial){ 
     ...
     if($ar26_sequencial == "" || $ar26_sequencial == null ){
       ...
       $this->ar26_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from histocorrenciainscr_ar26_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ar26_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2657,15106,'','".AddSlashes(pg_fetch_result($resaco,0,'ar26_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2657,15108,'','".AddSlashes(pg_fetch_result($resaco,0,'ar26_inscr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2657,15109,'','".AddSlashes(pg_fetch_result($resaco,0,'ar26_histocorrencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ar26_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ar26_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar26_sequencial"])){ 
       $sql  .= $virgula." ar26_sequencial = $this->ar26_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ar26_sequencial) == null ){ 
         $this->erro_sql = " Campo Código Histórico nao Informado.";
     ...
     if(trim((string) $this->ar26_inscr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar26_inscr"])){ 
       $sql  .= $virgula." ar26_inscr = $this->ar26_inscr ";
       $virgula = ",";
       if(trim((string) $this->ar26_inscr) == null ){ 
         $this->erro_sql = " Campo Inscrição Municipal nao Informado.";
         $this->erro_campo = "ar26_inscr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ar26_histocorrencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar26_histocorrencia"])){ 
       $sql  .= $virgula." ar26_histocorrencia = $this->ar26_histocorrencia ";
       $virgula = ",";
       if(trim((string) $this->ar26_histocorrencia) == null ){ 
         $this->erro_sql = " Campo Código Histórico nao Informado.";
         $this->erro_campo = "ar26_histocorrencia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar26_sequencial"]) || $this->ar26_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2657,15106,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar26_sequencial'))."','$this->ar26_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar26_inscr"]) || $this->ar26_inscr != "")
           $resac = db_query("insert into db_acount values($acount,2657,15108,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar26_inscr'))."','$this->ar26_inscr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar26_histocorrencia"]) || $this->ar26_histocorrencia != "")
           $resac = db_query("insert into db_acount values($acount,2657,15109,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar26_histocorrencia'))."','$this->ar26_histocorrencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ar26_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2657,15106,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar26_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2657,15108,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar26_inscr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2657,15109,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar26_histocorrencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
