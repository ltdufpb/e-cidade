...
class cl_procfiscalmatric { 
   ...
   function incluir ($y102_sequencial){ 
     ...
     if($y102_sequencial == "" || $y102_sequencial == null ){
       ...
       $this->y102_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from procfiscalmatric_y102_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $y102_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2091,12060,'','".AddSlashes(pg_fetch_result($resaco,0,'y102_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2091,12061,'','".AddSlashes(pg_fetch_result($resaco,0,'y102_procfiscal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2091,12062,'','".AddSlashes(pg_fetch_result($resaco,0,'y102_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y102_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y102_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y102_sequencial"])){ 
       $sql  .= $virgula." y102_sequencial = $this->y102_sequencial ";
       $virgula = ",";
       if(trim((string) $this->y102_sequencial) == null ){ 
     ...
     if(trim((string) $this->y102_procfiscal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y102_procfiscal"])){ 
       $sql  .= $virgula." y102_procfiscal = $this->y102_procfiscal ";
       $virgula = ",";
       if(trim((string) $this->y102_procfiscal) == null ){ 
         $this->erro_sql = " Campo Processo Fiscal nao Informado.";
         $this->erro_campo = "y102_procfiscal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y102_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y102_matric"])){ 
       $sql  .= $virgula." y102_matric = $this->y102_matric ";
       $virgula = ",";
       if(trim((string) $this->y102_matric) == null ){ 
         $this->erro_sql = " Campo Matrícula do Imóvel nao Informado.";
         $this->erro_campo = "y102_matric";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y102_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2091,12060,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y102_sequencial'))."','$this->y102_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y102_procfiscal"]))
           $resac = db_query("insert into db_acount values($acount,2091,12061,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y102_procfiscal'))."','$this->y102_procfiscal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y102_matric"]))
           $resac = db_query("insert into db_acount values($acount,2091,12062,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y102_matric'))."','$this->y102_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y102_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2091,12060,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y102_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2091,12061,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y102_procfiscal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2091,12062,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y102_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
