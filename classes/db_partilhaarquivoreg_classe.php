...
class cl_partilhaarquivoreg { 
   ...
   public $v79_sequencial = 0; 
   public $v79_partilhaarquivo = 0; 
   public $v79_processoforopartilhacusta = 0; 
   ...
   function incluir ($v79_sequencial){ 
     ...
     if($v79_sequencial == "" || $v79_sequencial == null ){
       ...
       $this->v79_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from partilhaarquivoreg_v79_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $v79_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3232,18258,'','".AddSlashes(pg_fetch_result($resaco,0,'v79_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3232,18270,'','".AddSlashes(pg_fetch_result($resaco,0,'v79_partilhaarquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3232,18271,'','".AddSlashes(pg_fetch_result($resaco,0,'v79_processoforopartilhacusta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($v79_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->v79_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v79_sequencial"])){ 
       $sql  .= $virgula." v79_sequencial = $this->v79_sequencial ";
       $virgula = ",";
       if(trim((string) $this->v79_sequencial) == null ){ 
     ...
     if(trim((string) $this->v79_partilhaarquivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v79_partilhaarquivo"])){ 
       $sql  .= $virgula." v79_partilhaarquivo = $this->v79_partilhaarquivo ";
       $virgula = ",";
       if(trim((string) $this->v79_partilhaarquivo) == null ){ 
         $this->erro_sql = " Campo Arquivo de Remessa nao Informado.";
         $this->erro_campo = "v79_partilhaarquivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->v79_processoforopartilhacusta)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v79_processoforopartilhacusta"])){ 
       $sql  .= $virgula." v79_processoforopartilhacusta = $this->v79_processoforopartilhacusta ";
       $virgula = ",";
       if(trim((string) $this->v79_processoforopartilhacusta) == null ){ 
         $this->erro_sql = " Campo Custa da partilha do processo nao Informado.";
         $this->erro_campo = "v79_processoforopartilhacusta";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v79_sequencial"]) || $this->v79_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3232,18258,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v79_sequencial'))."','$this->v79_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v79_partilhaarquivo"]) || $this->v79_partilhaarquivo != "")
           $resac = db_query("insert into db_acount values($acount,3232,18270,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v79_partilhaarquivo'))."','$this->v79_partilhaarquivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v79_processoforopartilhacusta"]) || $this->v79_processoforopartilhacusta != "")
           $resac = db_query("insert into db_acount values($acount,3232,18271,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v79_processoforopartilhacusta'))."','$this->v79_processoforopartilhacusta',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($v79_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3232,18258,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v79_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3232,18270,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v79_partilhaarquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3232,18271,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v79_processoforopartilhacusta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
