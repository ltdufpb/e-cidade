...
class cl_controleacessoalunoregistroinvalido { 
   ...
   public $ed304_sequencial = 0; 
   public $ed304_controleacessoalunoregistro = 0; 
   public $ed304_codigoinvalido = null; 
   ...
   function incluir ($ed304_sequencial){ 
     ...
     if($ed304_sequencial == "" || $ed304_sequencial == null ){
       ...
       $this->ed304_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from controleacessoalunoregistroinvalido_ed304_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed304_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3337,18820,'','".AddSlashes(pg_fetch_result($resaco,0,'ed304_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3337,18821,'','".AddSlashes(pg_fetch_result($resaco,0,'ed304_controleacessoalunoregistro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3337,18822,'','".AddSlashes(pg_fetch_result($resaco,0,'ed304_codigoinvalido'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed304_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed304_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed304_sequencial"])){ 
       $sql  .= $virgula." ed304_sequencial = $this->ed304_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed304_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed304_controleacessoalunoregistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed304_controleacessoalunoregistro"])){ 
       $sql  .= $virgula." ed304_controleacessoalunoregistro = $this->ed304_controleacessoalunoregistro ";
       $virgula = ",";
       if(trim((string) $this->ed304_controleacessoalunoregistro) == null ){ 
         $this->erro_sql = " Campo Código da Leitura nao Informado.";
         $this->erro_campo = "ed304_controleacessoalunoregistro";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed304_codigoinvalido)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed304_codigoinvalido"])){ 
       $sql  .= $virgula." ed304_codigoinvalido = '$this->ed304_codigoinvalido' ";
       $virgula = ",";
       if(trim((string) $this->ed304_codigoinvalido) == null ){ 
         $this->erro_sql = " Campo Código da Leitura Inválido nao Informado.";
         $this->erro_campo = "ed304_codigoinvalido";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed304_sequencial"]) || $this->ed304_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3337,18820,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed304_sequencial'))."','$this->ed304_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed304_controleacessoalunoregistro"]) || $this->ed304_controleacessoalunoregistro != "")
           $resac = db_query("insert into db_acount values($acount,3337,18821,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed304_controleacessoalunoregistro'))."','$this->ed304_controleacessoalunoregistro',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed304_codigoinvalido"]) || $this->ed304_codigoinvalido != "")
           $resac = db_query("insert into db_acount values($acount,3337,18822,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed304_codigoinvalido'))."','$this->ed304_codigoinvalido',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed304_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3337,18820,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed304_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3337,18821,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed304_controleacessoalunoregistro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3337,18822,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed304_codigoinvalido'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
