...
class cl_lab_valorreferencia { 
   ...
   public $la27_i_codigo = 0; 
   public $la27_i_unidade = 0; 
   public $la27_i_atributo = 0; 
   ...
   function incluir ($la27_i_codigo){ 
     ...
     if($la27_i_codigo == "" || $la27_i_codigo == null ){
       ...
       $this->la27_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from lab_valorreferencia_la27_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $la27_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2901,16498,'','".AddSlashes(pg_fetch_result($resaco,0,'la27_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2901,16499,'','".AddSlashes(pg_fetch_result($resaco,0,'la27_i_unidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2901,16560,'','".AddSlashes(pg_fetch_result($resaco,0,'la27_i_atributo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($la27_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->la27_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la27_i_codigo"])){ 
       $sql  .= $virgula." la27_i_codigo = $this->la27_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->la27_i_codigo) == null ){ 
     ...
     if(trim((string) $this->la27_i_unidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la27_i_unidade"])){ 
        if(trim((string) $this->la27_i_unidade)=="" && isset($GLOBALS["HTTP_POST_VARS"]["la27_i_unidade"])){ 
           $this->la27_i_unidade = "null" ; 
        } 
     ...
     if(trim((string) $this->la27_i_atributo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la27_i_atributo"])){ 
       $sql  .= $virgula." la27_i_atributo = $this->la27_i_atributo ";
       $virgula = ",";
       if(trim((string) $this->la27_i_atributo) == null ){ 
         $this->erro_sql = " Campo Atributo nao Informado.";
         $this->erro_campo = "la27_i_atributo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["la27_i_codigo"]) || $this->la27_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2901,16498,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la27_i_codigo'))."','$this->la27_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la27_i_unidade"]) || $this->la27_i_unidade != "")
           $resac = db_query("insert into db_acount values($acount,2901,16499,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la27_i_unidade'))."','$this->la27_i_unidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la27_i_atributo"]) || $this->la27_i_atributo != "")
           $resac = db_query("insert into db_acount values($acount,2901,16560,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la27_i_atributo'))."','$this->la27_i_atributo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($la27_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2901,16498,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la27_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2901,16499,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la27_i_unidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2901,16560,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la27_i_atributo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
