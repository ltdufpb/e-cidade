...
class cl_iptunaogeracarnecgm { 
   ...
   public $j68_sequencial = 0; 
   public $j68_naogeracarne = 0; 
   public $j68_numcgm = 0; 
   ...
   function incluir ($j68_sequencial){ 
     ...
     if($j68_sequencial == "" || $j68_sequencial == null ){
       ...
       $this->j68_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from iptunaogeracarnecgm_j68_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $j68_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1407,8330,'','".AddSlashes(pg_fetch_result($resaco,0,'j68_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1407,8331,'','".AddSlashes(pg_fetch_result($resaco,0,'j68_naogeracarne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1407,8333,'','".AddSlashes(pg_fetch_result($resaco,0,'j68_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j68_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j68_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j68_sequencial"])){ 
       $sql  .= $virgula." j68_sequencial = $this->j68_sequencial ";
       $virgula = ",";
       if(trim((string) $this->j68_sequencial) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
     ...
     if(trim((string) $this->j68_naogeracarne)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j68_naogeracarne"])){ 
       $sql  .= $virgula." j68_naogeracarne = $this->j68_naogeracarne ";
       $virgula = ",";
       if(trim((string) $this->j68_naogeracarne) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
         $this->erro_campo = "j68_naogeracarne";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j68_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j68_numcgm"])){ 
       $sql  .= $virgula." j68_numcgm = $this->j68_numcgm ";
       $virgula = ",";
       if(trim((string) $this->j68_numcgm) == null ){ 
         $this->erro_sql = " Campo Numcgm nao Informado.";
         $this->erro_campo = "j68_numcgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j68_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1407,8330,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j68_sequencial'))."','$this->j68_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j68_naogeracarne"]))
           $resac = db_query("insert into db_acount values($acount,1407,8331,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j68_naogeracarne'))."','$this->j68_naogeracarne',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j68_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,1407,8333,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j68_numcgm'))."','$this->j68_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j68_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1407,8330,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j68_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1407,8331,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j68_naogeracarne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1407,8333,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j68_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
