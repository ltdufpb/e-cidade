...
class cl_emppresta {
   ...
   public $e45_numemp = 0;
   public $e45_data_dia = null;
   public $e45_data_mes = null;
   public $e45_data_ano = null;
   public $e45_data = null;
   public $e45_obs = null;
   public $e45_tipo = 0;
   public $e45_acerta_dia = null;
   public $e45_acerta_mes = null;
   public $e45_acerta_ano = null;
   public $e45_acerta = null;
   public $e45_conferido_dia = null;
   public $e45_conferido_mes = null;
   public $e45_conferido_ano = null;
   public $e45_conferido     = null;
   public $e45_codmov        = null;
   public $e45_sequencial    = 0;
   public $e45_processoadministrativo = null;
   public $e45_datalimiteaplicacao_dia = null;
   public $e45_datalimiteaplicacao_mes = null;
   public $e45_datalimiteaplicacao_ano = null;
   public $e45_datalimiteaplicacao = null;
   ...
   function incluir ($e45_sequencial){
     ...
     if($e45_sequencial == "" || $e45_sequencial == null ){
       ...
       $this->e45_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from emppresta_e45_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $e45_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,1036,6340,'','".AddSlashes(pg_fetch_result($resaco,0,'e45_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1036,6341,'','".AddSlashes(pg_fetch_result($resaco,0,'e45_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1036,6342,'','".AddSlashes(pg_fetch_result($resaco,0,'e45_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1036,6343,'','".AddSlashes(pg_fetch_result($resaco,0,'e45_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1036,6344,'','".AddSlashes(pg_fetch_result($resaco,0,'e45_acerta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1036,6345,'','".AddSlashes(pg_fetch_result($resaco,0,'e45_conferido'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1036,20269,'','".AddSlashes(pg_fetch_result($resaco,0,'e45_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1036,20271,'','".AddSlashes(pg_fetch_result($resaco,0,'e45_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1036,20884,'','".AddSlashes(pg_fetch_result($resaco,0,'e45_processoadministrativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1036,20889,'','".AddSlashes(pg_fetch_result($resaco,0,'e45_datalimiteaplicacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   public function alterar ($e45_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->e45_numemp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e45_numemp"])){
       $sql  .= $virgula." e45_numemp = $this->e45_numemp ";
       $virgula = ",";
       if(trim((string) $this->e45_numemp) == null ){
         $this->erro_sql = " Campo Número do Empenho não informado.";
         $this->erro_campo = "e45_numemp";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e45_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e45_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["e45_data_dia"] !="") ){
       $sql  .= $virgula." e45_data = '$this->e45_data' ";
       $virgula = ",";
       if(trim((string) $this->e45_data) == null ){
         $this->erro_sql = " Campo Data não informado.";
         $this->erro_campo = "e45_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e45_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e45_obs"])){
       $sql  .= $virgula." e45_obs = '$this->e45_obs' ";
       $virgula = ",";
     }
     if(trim((string) $this->e45_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e45_tipo"])){
       $sql  .= $virgula." e45_tipo = $this->e45_tipo ";
       $virgula = ",";
       if(trim((string) $this->e45_tipo) == null ){
         $this->erro_sql = " Campo Tipo não informado.";
         $this->erro_campo = "e45_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e45_acerta)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e45_acerta_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["e45_acerta_dia"] !="") ){
     ...
     if(trim((string) $this->e45_conferido)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e45_conferido_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["e45_conferido_dia"] !="") ){
     ...
     if(trim((string) $this->e45_codmov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e45_codmov"])){
        if(trim((string) $this->e45_codmov)=="" && isset($GLOBALS["HTTP_POST_VARS"]["e45_codmov"])){
           $this->e45_codmov = "null" ;
        }
     ...
     if(trim((string) $this->e45_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e45_sequencial"])){
       $sql  .= $virgula." e45_sequencial = $this->e45_sequencial ";
       $virgula = ",";
       if(trim((string) $this->e45_sequencial) == null ){
     ...
     if(trim((string) $this->e45_processoadministrativo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e45_processoadministrativo"])){
       $sql  .= $virgula." e45_processoadministrativo = '$this->e45_processoadministrativo' ";
       $virgula = ",";
     }
     if(trim((string) $this->e45_datalimiteaplicacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e45_datalimiteaplicacao_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["e45_datalimiteaplicacao_dia"] !="") ){
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["e45_numemp"]) || $this->e45_numemp != "")
             $resac = db_query("insert into db_acount values($acount,1036,6340,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e45_numemp'))."','$this->e45_numemp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["e45_data"]) || $this->e45_data != "")
             $resac = db_query("insert into db_acount values($acount,1036,6341,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e45_data'))."','$this->e45_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["e45_obs"]) || $this->e45_obs != "")
             $resac = db_query("insert into db_acount values($acount,1036,6342,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e45_obs'))."','$this->e45_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["e45_tipo"]) || $this->e45_tipo != "")
             $resac = db_query("insert into db_acount values($acount,1036,6343,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e45_tipo'))."','$this->e45_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["e45_acerta"]) || $this->e45_acerta != "")
             $resac = db_query("insert into db_acount values($acount,1036,6344,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e45_acerta'))."','$this->e45_acerta',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["e45_conferido"]) || $this->e45_conferido != "")
             $resac = db_query("insert into db_acount values($acount,1036,6345,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e45_conferido'))."','$this->e45_conferido',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["e45_codmov"]) || $this->e45_codmov != "")
             $resac = db_query("insert into db_acount values($acount,1036,20269,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e45_codmov'))."','$this->e45_codmov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["e45_sequencial"]) || $this->e45_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,1036,20271,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e45_sequencial'))."','$this->e45_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["e45_processoadministrativo"]) || $this->e45_processoadministrativo != "")
             $resac = db_query("insert into db_acount values($acount,1036,20884,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e45_processoadministrativo'))."','$this->e45_processoadministrativo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["e45_datalimiteaplicacao"]) || $this->e45_datalimiteaplicacao != "")
             $resac = db_query("insert into db_acount values($acount,1036,20889,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e45_datalimiteaplicacao'))."','$this->e45_datalimiteaplicacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,1036,6340,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e45_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1036,6341,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e45_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1036,6342,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e45_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1036,6343,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e45_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1036,6344,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e45_acerta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1036,6345,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e45_conferido'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1036,20269,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e45_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1036,20271,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e45_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1036,20884,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e45_processoadministrativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1036,20889,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e45_datalimiteaplicacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
