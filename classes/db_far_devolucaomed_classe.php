...
class cl_far_devolucaomed { 
   ...
   public $fa23_i_codigo = 0; 
   public $fa23_i_quantidade = 0; 
   public $fa23_c_motivo = null; 
   public $fa23_i_devolucao = 0; 
   public $fa23_i_retiradaitens = 0; 
   public $fa23_i_cancelamento = 0; 
   ...
   function incluir ($fa23_i_codigo){ 
     ...
     if($fa23_i_codigo == "" || $fa23_i_codigo == null ){
       ...
       $this->fa23_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_devolucaomed_fa23_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa23_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2471,14037,'','".AddSlashes(pg_fetch_result($resaco,0,'fa23_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2471,14039,'','".AddSlashes(pg_fetch_result($resaco,0,'fa23_i_quantidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2471,14072,'','".AddSlashes(pg_fetch_result($resaco,0,'fa23_c_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2471,16234,'','".AddSlashes(pg_fetch_result($resaco,0,'fa23_i_devolucao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2471,17112,'','".AddSlashes(pg_fetch_result($resaco,0,'fa23_i_retiradaitens'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2471,17113,'','".AddSlashes(pg_fetch_result($resaco,0,'fa23_i_cancelamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa23_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa23_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa23_i_codigo"])){ 
       $sql  .= $virgula." fa23_i_codigo = $this->fa23_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa23_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa23_i_quantidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa23_i_quantidade"])){ 
       $sql  .= $virgula." fa23_i_quantidade = $this->fa23_i_quantidade ";
       $virgula = ",";
       if(trim((string) $this->fa23_i_quantidade) == null ){ 
         $this->erro_sql = " Campo Quantidade nao Informado.";
         $this->erro_campo = "fa23_i_quantidade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa23_c_motivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa23_c_motivo"])){ 
       $sql  .= $virgula." fa23_c_motivo = '$this->fa23_c_motivo' ";
       $virgula = ",";
       if(trim((string) $this->fa23_c_motivo) == null ){ 
         $this->erro_sql = " Campo Motivo nao Informado.";
         $this->erro_campo = "fa23_c_motivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa23_i_devolucao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa23_i_devolucao"])){ 
       $sql  .= $virgula." fa23_i_devolucao = $this->fa23_i_devolucao ";
       $virgula = ",";
       if(trim((string) $this->fa23_i_devolucao) == null ){ 
         $this->erro_sql = " Campo Devolucao nao Informado.";
         $this->erro_campo = "fa23_i_devolucao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa23_i_retiradaitens)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa23_i_retiradaitens"])){ 
       $sql  .= $virgula." fa23_i_retiradaitens = $this->fa23_i_retiradaitens ";
       $virgula = ",";
       if(trim((string) $this->fa23_i_retiradaitens) == null ){ 
         $this->erro_sql = " Campo Ítem da Retirada nao Informado.";
         $this->erro_campo = "fa23_i_retiradaitens";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa23_i_cancelamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa23_i_cancelamento"])){ 
       $sql  .= $virgula." fa23_i_cancelamento = $this->fa23_i_cancelamento ";
       $virgula = ",";
       if(trim((string) $this->fa23_i_cancelamento) == null ){ 
         $this->erro_sql = " Campo Cancelamento nao Informado.";
         $this->erro_campo = "fa23_i_cancelamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa23_i_codigo"]) || $this->fa23_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2471,14037,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa23_i_codigo'))."','$this->fa23_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa23_i_quantidade"]) || $this->fa23_i_quantidade != "")
           $resac = db_query("insert into db_acount values($acount,2471,14039,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa23_i_quantidade'))."','$this->fa23_i_quantidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa23_c_motivo"]) || $this->fa23_c_motivo != "")
           $resac = db_query("insert into db_acount values($acount,2471,14072,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa23_c_motivo'))."','$this->fa23_c_motivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa23_i_devolucao"]) || $this->fa23_i_devolucao != "")
           $resac = db_query("insert into db_acount values($acount,2471,16234,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa23_i_devolucao'))."','$this->fa23_i_devolucao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa23_i_retiradaitens"]) || $this->fa23_i_retiradaitens != "")
           $resac = db_query("insert into db_acount values($acount,2471,17112,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa23_i_retiradaitens'))."','$this->fa23_i_retiradaitens',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa23_i_cancelamento"]) || $this->fa23_i_cancelamento != "")
           $resac = db_query("insert into db_acount values($acount,2471,17113,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa23_i_cancelamento'))."','$this->fa23_i_cancelamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa23_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2471,14037,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa23_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2471,14039,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa23_i_quantidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2471,14072,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa23_c_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2471,16234,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa23_i_devolucao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2471,17112,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa23_i_retiradaitens'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2471,17113,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa23_i_cancelamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
