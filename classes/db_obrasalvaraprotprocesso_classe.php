...
class cl_obrasalvaraprotprocesso { 
   ...
   public $ob26_sequencial = 0; 
   public $ob26_obrasalvara = 0; 
   public $ob26_protprocesso = 0; 
   ...
   function incluir ($ob26_sequencial){ 
     ...
     if($ob26_sequencial == "" || $ob26_sequencial == null ){
       ...
       $this->ob26_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from obrasalvaraprotprocesso_ob26_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ob26_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3301,18645,'','".AddSlashes(pg_fetch_result($resaco,0,'ob26_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3301,18646,'','".AddSlashes(pg_fetch_result($resaco,0,'ob26_obrasalvara'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3301,18647,'','".AddSlashes(pg_fetch_result($resaco,0,'ob26_protprocesso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ob26_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ob26_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ob26_sequencial"])){ 
       $sql  .= $virgula." ob26_sequencial = $this->ob26_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ob26_sequencial) == null ){ 
     ...
     if(trim((string) $this->ob26_obrasalvara)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ob26_obrasalvara"])){ 
       $sql  .= $virgula." ob26_obrasalvara = $this->ob26_obrasalvara ";
       $virgula = ",";
       if(trim((string) $this->ob26_obrasalvara) == null ){ 
         $this->erro_sql = " Campo obrasalvara nao Informado.";
         $this->erro_campo = "ob26_obrasalvara";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ob26_protprocesso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ob26_protprocesso"])){ 
       $sql  .= $virgula." ob26_protprocesso = $this->ob26_protprocesso ";
       $virgula = ",";
       if(trim((string) $this->ob26_protprocesso) == null ){ 
         $this->erro_sql = " Campo Processo nao Informado.";
         $this->erro_campo = "ob26_protprocesso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ob26_sequencial"]) || $this->ob26_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3301,18645,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ob26_sequencial'))."','$this->ob26_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ob26_obrasalvara"]) || $this->ob26_obrasalvara != "")
           $resac = db_query("insert into db_acount values($acount,3301,18646,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ob26_obrasalvara'))."','$this->ob26_obrasalvara',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ob26_protprocesso"]) || $this->ob26_protprocesso != "")
           $resac = db_query("insert into db_acount values($acount,3301,18647,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ob26_protprocesso'))."','$this->ob26_protprocesso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ob26_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3301,18645,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ob26_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3301,18646,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ob26_obrasalvara'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3301,18647,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ob26_protprocesso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
