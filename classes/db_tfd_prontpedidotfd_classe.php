...
class cl_tfd_prontpedidotfd { 
   ...
   public $tf29_i_codigo = 0; 
   public $tf29_i_prontuario = 0; 
   public $tf29_i_pedidotfd = 0; 
   ...
   function incluir ($tf29_i_codigo){ 
     ...
     if($tf29_i_codigo == "" || $tf29_i_codigo == null ){
       ...
       $this->tf29_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tfd_prontpedidotfd_tf29_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $tf29_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2885,16459,'','".AddSlashes(pg_fetch_result($resaco,0,'tf29_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2885,16461,'','".AddSlashes(pg_fetch_result($resaco,0,'tf29_i_prontuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2885,16460,'','".AddSlashes(pg_fetch_result($resaco,0,'tf29_i_pedidotfd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($tf29_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->tf29_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf29_i_codigo"])){ 
       $sql  .= $virgula." tf29_i_codigo = $this->tf29_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->tf29_i_codigo) == null ){ 
     ...
     if(trim((string) $this->tf29_i_prontuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf29_i_prontuario"])){ 
       $sql  .= $virgula." tf29_i_prontuario = $this->tf29_i_prontuario ";
       $virgula = ",";
       if(trim((string) $this->tf29_i_prontuario) == null ){ 
         $this->erro_sql = " Campo Prontuário nao Informado.";
         $this->erro_campo = "tf29_i_prontuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tf29_i_pedidotfd)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf29_i_pedidotfd"])){ 
       $sql  .= $virgula." tf29_i_pedidotfd = $this->tf29_i_pedidotfd ";
       $virgula = ",";
       if(trim((string) $this->tf29_i_pedidotfd) == null ){ 
         $this->erro_sql = " Campo Pedido nao Informado.";
         $this->erro_campo = "tf29_i_pedidotfd";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf29_i_codigo"]) || $this->tf29_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2885,16459,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf29_i_codigo'))."','$this->tf29_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf29_i_prontuario"]) || $this->tf29_i_prontuario != "")
           $resac = db_query("insert into db_acount values($acount,2885,16461,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf29_i_prontuario'))."','$this->tf29_i_prontuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf29_i_pedidotfd"]) || $this->tf29_i_pedidotfd != "")
           $resac = db_query("insert into db_acount values($acount,2885,16460,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf29_i_pedidotfd'))."','$this->tf29_i_pedidotfd',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($tf29_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2885,16459,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf29_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2885,16461,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf29_i_prontuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2885,16460,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf29_i_pedidotfd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
