...
class cl_iptuconstrpontos { 
   ...
   function incluir ($j83_codigo){ 
     ...
     if($j83_codigo == "" || $j83_codigo == null ){
       ...
       $this->j83_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from iptuconstrpontos_j83_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $j83_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1672,9743,'','".AddSlashes(pg_fetch_result($resaco,0,'j83_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1672,9744,'','".AddSlashes(pg_fetch_result($resaco,0,'j83_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1672,9745,'','".AddSlashes(pg_fetch_result($resaco,0,'j83_idcons'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1672,9746,'','".AddSlashes(pg_fetch_result($resaco,0,'j83_pontos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j83_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j83_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j83_codigo"])){ 
       $sql  .= $virgula." j83_codigo = $this->j83_codigo ";
       $virgula = ",";
       if(trim((string) $this->j83_codigo) == null ){ 
     ...
     if(trim((string) $this->j83_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j83_matric"])){ 
       $sql  .= $virgula." j83_matric = $this->j83_matric ";
       $virgula = ",";
       if(trim((string) $this->j83_matric) == null ){ 
         $this->erro_sql = " Campo Matrícula do Imóvel nao Informado.";
         $this->erro_campo = "j83_matric";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j83_idcons)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j83_idcons"])){ 
       $sql  .= $virgula." j83_idcons = $this->j83_idcons ";
       $virgula = ",";
       if(trim((string) $this->j83_idcons) == null ){ 
         $this->erro_sql = " Campo Código da construcao nao Informado.";
         $this->erro_campo = "j83_idcons";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j83_pontos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j83_pontos"])){ 
       $sql  .= $virgula." j83_pontos = $this->j83_pontos ";
       $virgula = ",";
       if(trim((string) $this->j83_pontos) == null ){ 
         $this->erro_sql = " Campo Pontos nao Informado.";
         $this->erro_campo = "j83_pontos";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j83_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1672,9743,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j83_codigo'))."','$this->j83_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j83_matric"]))
           $resac = db_query("insert into db_acount values($acount,1672,9744,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j83_matric'))."','$this->j83_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j83_idcons"]))
           $resac = db_query("insert into db_acount values($acount,1672,9745,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j83_idcons'))."','$this->j83_idcons',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j83_pontos"]))
           $resac = db_query("insert into db_acount values($acount,1672,9746,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j83_pontos'))."','$this->j83_pontos',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j83_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1672,9743,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j83_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1672,9744,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j83_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1672,9745,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j83_idcons'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1672,9746,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j83_pontos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
