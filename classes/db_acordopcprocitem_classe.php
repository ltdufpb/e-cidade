...
class cl_acordopcprocitem { 
   ...
   public $ac23_sequencial = 0; 
   public $ac23_pcprocitem = 0; 
   public $ac23_acordoitem = 0; 
   public $ac23_quantidade = 0; 
   public $ac23_valor = 0; 
   ...
   function incluir ($ac23_sequencial){ 
     ...
     if($ac23_sequencial == "" || $ac23_sequencial == null ){
       ...
       $this->ac23_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordopcprocitem_ac23_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac23_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2842,16191,'','".AddSlashes(pg_fetch_result($resaco,0,'ac23_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2842,16192,'','".AddSlashes(pg_fetch_result($resaco,0,'ac23_pcprocitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2842,16193,'','".AddSlashes(pg_fetch_result($resaco,0,'ac23_acordoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2842,16663,'','".AddSlashes(pg_fetch_result($resaco,0,'ac23_quantidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2842,16664,'','".AddSlashes(pg_fetch_result($resaco,0,'ac23_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac23_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac23_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac23_sequencial"])){ 
       $sql  .= $virgula." ac23_sequencial = $this->ac23_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac23_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac23_pcprocitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac23_pcprocitem"])){ 
       $sql  .= $virgula." ac23_pcprocitem = $this->ac23_pcprocitem ";
       $virgula = ",";
       if(trim((string) $this->ac23_pcprocitem) == null ){ 
         $this->erro_sql = " Campo Item Processo de Compras nao Informado.";
         $this->erro_campo = "ac23_pcprocitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac23_acordoitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac23_acordoitem"])){ 
       $sql  .= $virgula." ac23_acordoitem = $this->ac23_acordoitem ";
       $virgula = ",";
       if(trim((string) $this->ac23_acordoitem) == null ){ 
         $this->erro_sql = " Campo Acordo Item nao Informado.";
         $this->erro_campo = "ac23_acordoitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac23_quantidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac23_quantidade"])){ 
        if(trim((string) $this->ac23_quantidade)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ac23_quantidade"])){ 
           $this->ac23_quantidade = "0" ; 
        } 
     ...
     if(trim((string) $this->ac23_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac23_valor"])){ 
        if(trim((string) $this->ac23_valor)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ac23_valor"])){ 
           $this->ac23_valor = "0" ; 
        } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac23_sequencial"]) || $this->ac23_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2842,16191,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac23_sequencial'))."','$this->ac23_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac23_pcprocitem"]) || $this->ac23_pcprocitem != "")
           $resac = db_query("insert into db_acount values($acount,2842,16192,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac23_pcprocitem'))."','$this->ac23_pcprocitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac23_acordoitem"]) || $this->ac23_acordoitem != "")
           $resac = db_query("insert into db_acount values($acount,2842,16193,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac23_acordoitem'))."','$this->ac23_acordoitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac23_quantidade"]) || $this->ac23_quantidade != "")
           $resac = db_query("insert into db_acount values($acount,2842,16663,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac23_quantidade'))."','$this->ac23_quantidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac23_valor"]) || $this->ac23_valor != "")
           $resac = db_query("insert into db_acount values($acount,2842,16664,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac23_valor'))."','$this->ac23_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac23_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2842,16191,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac23_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2842,16192,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac23_pcprocitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2842,16193,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac23_acordoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2842,16663,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac23_quantidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2842,16664,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac23_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
