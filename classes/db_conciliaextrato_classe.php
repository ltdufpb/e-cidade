...
class cl_conciliaextrato { 
   ...
   public $k87_sequencial = 0; 
   public $k87_conciliaitem = 0; 
   public $k87_extratolinha = 0; 
   public $k87_conciliaorigem = 0; 
   ...
   function incluir ($k87_sequencial){ 
     ...
     if($k87_sequencial == "" || $k87_sequencial == null ){
       ...
       $this->k87_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from conciliaextrato_k87_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k87_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1735,10091,'','".AddSlashes(pg_fetch_result($resaco,0,'k87_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1735,10092,'','".AddSlashes(pg_fetch_result($resaco,0,'k87_conciliaitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1735,10093,'','".AddSlashes(pg_fetch_result($resaco,0,'k87_extratolinha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1735,10153,'','".AddSlashes(pg_fetch_result($resaco,0,'k87_conciliaorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k87_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k87_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k87_sequencial"])){ 
       $sql  .= $virgula." k87_sequencial = $this->k87_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k87_sequencial) == null ){ 
     ...
     if(trim((string) $this->k87_conciliaitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k87_conciliaitem"])){ 
       $sql  .= $virgula." k87_conciliaitem = $this->k87_conciliaitem ";
       $virgula = ",";
       if(trim((string) $this->k87_conciliaitem) == null ){ 
         $this->erro_sql = " Campo Item da conciliação nao Informado.";
         $this->erro_campo = "k87_conciliaitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k87_extratolinha)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k87_extratolinha"])){ 
       $sql  .= $virgula." k87_extratolinha = $this->k87_extratolinha ";
       $virgula = ",";
       if(trim((string) $this->k87_extratolinha) == null ){ 
         $this->erro_sql = " Campo Linha do extrato nao Informado.";
         $this->erro_campo = "k87_extratolinha";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k87_conciliaorigem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k87_conciliaorigem"])){ 
       $sql  .= $virgula." k87_conciliaorigem = $this->k87_conciliaorigem ";
       $virgula = ",";
       if(trim((string) $this->k87_conciliaorigem) == null ){ 
         $this->erro_sql = " Campo Origem nao Informado.";
         $this->erro_campo = "k87_conciliaorigem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k87_sequencial"]) || $this->k87_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,1735,10091,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k87_sequencial'))."','$this->k87_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k87_conciliaitem"]) || $this->k87_conciliaitem != "")
           $resac = db_query("insert into db_acount values($acount,1735,10092,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k87_conciliaitem'))."','$this->k87_conciliaitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k87_extratolinha"]) || $this->k87_extratolinha != "")
           $resac = db_query("insert into db_acount values($acount,1735,10093,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k87_extratolinha'))."','$this->k87_extratolinha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k87_conciliaorigem"]) || $this->k87_conciliaorigem != "")
           $resac = db_query("insert into db_acount values($acount,1735,10153,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k87_conciliaorigem'))."','$this->k87_conciliaorigem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k87_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1735,10091,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k87_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1735,10092,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k87_conciliaitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1735,10093,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k87_extratolinha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1735,10153,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k87_conciliaorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
