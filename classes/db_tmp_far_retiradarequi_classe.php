...
class cl_far_retiradarequi { 
   ...
   function incluir ($fa07_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acount values($acount,2120,12206,'','".AddSlashes(pg_fetch_result($resaco,0,'fa07_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2120,12207,'','".AddSlashes(pg_fetch_result($resaco,0,'fa07_i_retirada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2120,12223,'','".AddSlashes(pg_fetch_result($resaco,0,'fa07_i_matrequi'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa07_i_codigo"]))
           $resac = pg_query("insert into db_acount values($acount,2120,12206,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa07_i_codigo'))."','$this->fa07_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa07_i_retirada"]))
           $resac = pg_query("insert into db_acount values($acount,2120,12207,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa07_i_retirada'))."','$this->fa07_i_retirada',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa07_i_matrequi"]))
           $resac = pg_query("insert into db_acount values($acount,2120,12223,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa07_i_matrequi'))."','$this->fa07_i_matrequi',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($fa07_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = pg_query("insert into db_acount values($acount,2120,12206,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa07_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2120,12207,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa07_i_retirada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2120,12223,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa07_i_matrequi'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
