...
class cl_meiimportalinhaatividademeievento { 
   ...
   function incluir ($q111_sequencial){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2850,16244,'','".AddSlashes(pg_fetch_result($resaco,0,'q111_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2850,16245,'','".AddSlashes(pg_fetch_result($resaco,0,'q111_meiimportalinhaatividade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2850,16246,'','".AddSlashes(pg_fetch_result($resaco,0,'q111_meievento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2850,16247,'','".AddSlashes(pg_fetch_result($resaco,0,'q111_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2850,16248,'','".AddSlashes(pg_fetch_result($resaco,0,'q111_processado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q111_sequencial=null) { 
     ...
     if(trim((string) $this->q111_meiimportalinhaatividade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportalinhaatividade"])){ 
       $sql  .= $virgula." q111_meiimportalinhaatividade = $this->q111_meiimportalinhaatividade ";
       $virgula = ",";
       if(trim((string) $this->q111_meiimportalinhaatividade) == null ){ 
         $this->erro_sql = " Campo Importação do MEI por Atividade nao Informado.";
         $this->erro_campo = "q111_meiimportalinhaatividade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q111_processado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q111_processado"])){ 
       $sql  .= $virgula." q111_processado = '$this->q111_processado' ";
       $virgula = ",";
       if(trim((string) $this->q111_processado) == null ){ 
         $this->erro_sql = " Campo Processado nao Informado.";
         $this->erro_campo = "q111_processado";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q111_sequencial"]) || $this->q111_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2850,16244,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q111_sequencial'))."','$this->q111_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q111_meiimportalinhaatividade"]) || $this->q111_meiimportalinhaatividade != "")
           $resac = db_query("insert into db_acount values($acount,2850,16245,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q111_meiimportalinhaatividade'))."','$this->q111_meiimportalinhaatividade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q111_meievento"]) || $this->q111_meievento != "")
           $resac = db_query("insert into db_acount values($acount,2850,16246,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q111_meievento'))."','$this->q111_meievento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q111_data"]) || $this->q111_data != "")
           $resac = db_query("insert into db_acount values($acount,2850,16247,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q111_data'))."','$this->q111_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q111_processado"]) || $this->q111_processado != "")
           $resac = db_query("insert into db_acount values($acount,2850,16248,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q111_processado'))."','$this->q111_processado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q111_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2850,16244,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q111_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2850,16245,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q111_meiimportalinhaatividade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2850,16246,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q111_meievento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2850,16247,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q111_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2850,16248,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q111_processado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
