...
class cl_mer_cardapioturma { 
   ...
   public $me39_i_codigo = 0; 
   public $me39_i_repeticao = 0; 
   public $me39_i_quantidade = 0; 
   public $me39_i_turma = 0; 
   public $me39_i_cardapiodia = 0; 
   ...
   function incluir ($me39_i_codigo){ 
     ...
     if($me39_i_codigo == "" || $me39_i_codigo == null ){
       ...
       $this->me39_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mer_cardapioturma_me39_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $me39_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3083,17438,'','".AddSlashes(pg_fetch_result($resaco,0,'me39_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3083,17440,'','".AddSlashes(pg_fetch_result($resaco,0,'me39_i_repeticao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3083,17439,'','".AddSlashes(pg_fetch_result($resaco,0,'me39_i_quantidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3083,17441,'','".AddSlashes(pg_fetch_result($resaco,0,'me39_i_turma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3083,17442,'','".AddSlashes(pg_fetch_result($resaco,0,'me39_i_cardapiodia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me39_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->me39_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me39_i_codigo"])){ 
       $sql  .= $virgula." me39_i_codigo = $this->me39_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->me39_i_codigo) == null ){ 
     ...
     if(trim((string) $this->me39_i_repeticao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me39_i_repeticao"])){ 
       $sql  .= $virgula." me39_i_repeticao = $this->me39_i_repeticao ";
       $virgula = ",";
       if(trim((string) $this->me39_i_repeticao) == null ){ 
         $this->erro_sql = " Campo Repetições nao Informado.";
         $this->erro_campo = "me39_i_repeticao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me39_i_quantidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me39_i_quantidade"])){ 
       $sql  .= $virgula." me39_i_quantidade = $this->me39_i_quantidade ";
       $virgula = ",";
       if(trim((string) $this->me39_i_quantidade) == null ){ 
         $this->erro_sql = " Campo Quantidade de Alunos nao Informado.";
         $this->erro_campo = "me39_i_quantidade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me39_i_turma)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me39_i_turma"])){ 
       $sql  .= $virgula." me39_i_turma = $this->me39_i_turma ";
       $virgula = ",";
       if(trim((string) $this->me39_i_turma) == null ){ 
         $this->erro_sql = " Campo Turma nao Informado.";
         $this->erro_campo = "me39_i_turma";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me39_i_cardapiodia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me39_i_cardapiodia"])){ 
       $sql  .= $virgula." me39_i_cardapiodia = $this->me39_i_cardapiodia ";
       $virgula = ",";
       if(trim((string) $this->me39_i_cardapiodia) == null ){ 
         $this->erro_sql = " Campo Cardapio dia nao Informado.";
         $this->erro_campo = "me39_i_cardapiodia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me39_i_codigo"]) || $this->me39_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3083,17438,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me39_i_codigo'))."','$this->me39_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me39_i_repeticao"]) || $this->me39_i_repeticao != "")
           $resac = db_query("insert into db_acount values($acount,3083,17440,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me39_i_repeticao'))."','$this->me39_i_repeticao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me39_i_quantidade"]) || $this->me39_i_quantidade != "")
           $resac = db_query("insert into db_acount values($acount,3083,17439,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me39_i_quantidade'))."','$this->me39_i_quantidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me39_i_turma"]) || $this->me39_i_turma != "")
           $resac = db_query("insert into db_acount values($acount,3083,17441,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me39_i_turma'))."','$this->me39_i_turma',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me39_i_cardapiodia"]) || $this->me39_i_cardapiodia != "")
           $resac = db_query("insert into db_acount values($acount,3083,17442,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me39_i_cardapiodia'))."','$this->me39_i_cardapiodia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me39_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3083,17438,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me39_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3083,17440,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me39_i_repeticao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3083,17439,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me39_i_quantidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3083,17441,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me39_i_turma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3083,17442,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me39_i_cardapiodia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
