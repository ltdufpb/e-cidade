...
class cl_portariatipodoccoletiva { 
   ...
   public $h38_sequencial = 0; 
   public $h38_portariatipo = 0; 
   public $h38_modportariacoletiva = 0; 
   ...
   function incluir ($h38_sequencial){ 
     ...
     if($h38_sequencial == "" || $h38_sequencial == null ){
       ...
       $this->h38_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from portariatipocoletiva_h38_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h38_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2123,12217,'','".AddSlashes(pg_fetch_result($resaco,0,'h38_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2123,12218,'','".AddSlashes(pg_fetch_result($resaco,0,'h38_portariatipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2123,12219,'','".AddSlashes(pg_fetch_result($resaco,0,'h38_modportariacoletiva'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h38_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h38_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h38_sequencial"])){ 
       $sql  .= $virgula." h38_sequencial = $this->h38_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h38_sequencial) == null ){ 
     ...
     if(trim((string) $this->h38_portariatipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h38_portariatipo"])){ 
       $sql  .= $virgula." h38_portariatipo = $this->h38_portariatipo ";
       $virgula = ",";
       if(trim((string) $this->h38_portariatipo) == null ){ 
         $this->erro_sql = " Campo Tipo nao Informado.";
         $this->erro_campo = "h38_portariatipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h38_modportariacoletiva)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h38_modportariacoletiva"])){ 
       $sql  .= $virgula." h38_modportariacoletiva = $this->h38_modportariacoletiva ";
       $virgula = ",";
       if(trim((string) $this->h38_modportariacoletiva) == null ){ 
         $this->erro_sql = " Campo Modelo Portaria Coletiva nao Informado.";
         $this->erro_campo = "h38_modportariacoletiva";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h38_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2123,12217,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h38_sequencial'))."','$this->h38_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h38_portariatipo"]))
           $resac = db_query("insert into db_acount values($acount,2123,12218,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h38_portariatipo'))."','$this->h38_portariatipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h38_modportariacoletiva"]))
           $resac = db_query("insert into db_acount values($acount,2123,12219,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h38_modportariacoletiva'))."','$this->h38_modportariacoletiva',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h38_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2123,12217,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h38_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2123,12218,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h38_portariatipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2123,12219,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h38_modportariacoletiva'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
