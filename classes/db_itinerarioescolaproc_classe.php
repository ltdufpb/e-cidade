...
class cl_itinerarioescolaproc { 
   ...
   public $ed222_i_codigo = 0; 
   public $ed222_i_itinerario = 0; 
   public $ed222_i_escolaproc = 0; 
   ...
   function incluir ($ed222_i_codigo){ 
     ...
     if($ed222_i_codigo == "" || $ed222_i_codigo == null ){
       ...
       $this->ed222_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from itinerarioescolaproc_ed222_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed222_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1928,11168,'','".AddSlashes(pg_fetch_result($resaco,0,'ed222_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1928,11169,'','".AddSlashes(pg_fetch_result($resaco,0,'ed222_i_itinerario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1928,11170,'','".AddSlashes(pg_fetch_result($resaco,0,'ed222_i_escolaproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed222_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed222_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed222_i_codigo"])){ 
       $sql  .= $virgula." ed222_i_codigo = $this->ed222_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed222_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed222_i_itinerario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed222_i_itinerario"])){ 
       $sql  .= $virgula." ed222_i_itinerario = $this->ed222_i_itinerario ";
       $virgula = ",";
       if(trim((string) $this->ed222_i_itinerario) == null ){ 
         $this->erro_sql = " Campo Itinerario nao Informado.";
         $this->erro_campo = "ed222_i_itinerario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed222_i_escolaproc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed222_i_escolaproc"])){ 
       $sql  .= $virgula." ed222_i_escolaproc = $this->ed222_i_escolaproc ";
       $virgula = ",";
       if(trim((string) $this->ed222_i_escolaproc) == null ){ 
         $this->erro_sql = " Campo Escola fora rede municipal nao Informado.";
         $this->erro_campo = "ed222_i_escolaproc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed222_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1928,11168,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed222_i_codigo'))."','$this->ed222_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed222_i_itinerario"]))
           $resac = db_query("insert into db_acount values($acount,1928,11169,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed222_i_itinerario'))."','$this->ed222_i_itinerario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed222_i_escolaproc"]))
           $resac = db_query("insert into db_acount values($acount,1928,11170,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed222_i_escolaproc'))."','$this->ed222_i_escolaproc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed222_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1928,11168,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed222_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1928,11169,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed222_i_itinerario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1928,11170,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed222_i_escolaproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
