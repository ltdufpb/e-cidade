...
class cl_termoanuproc { 
   ...
   public $v22_sequencial = 0; 
   public $v22_termoanu = 0; 
   public $v22_processo = 0; 
   ...
   function incluir ($v22_sequencial){ 
     ...
     if($v22_sequencial == "" || $v22_sequencial == null ){
       ...
       $this->v22_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from termoanuproc_v22_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $v22_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1699,9924,'','".AddSlashes(pg_fetch_result($resaco,0,'v22_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1699,9925,'','".AddSlashes(pg_fetch_result($resaco,0,'v22_termoanu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1699,9926,'','".AddSlashes(pg_fetch_result($resaco,0,'v22_processo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($v22_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->v22_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v22_sequencial"])){ 
       $sql  .= $virgula." v22_sequencial = $this->v22_sequencial ";
       $virgula = ",";
       if(trim((string) $this->v22_sequencial) == null ){ 
     ...
     if(trim((string) $this->v22_termoanu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v22_termoanu"])){ 
       $sql  .= $virgula." v22_termoanu = $this->v22_termoanu ";
       $virgula = ",";
       if(trim((string) $this->v22_termoanu) == null ){ 
         $this->erro_sql = " Campo Anulação nao Informado.";
         $this->erro_campo = "v22_termoanu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->v22_processo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v22_processo"])){ 
       $sql  .= $virgula." v22_processo = $this->v22_processo ";
       $virgula = ",";
       if(trim((string) $this->v22_processo) == null ){ 
         $this->erro_sql = " Campo Código do processo nao Informado.";
         $this->erro_campo = "v22_processo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v22_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1699,9924,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v22_sequencial'))."','$this->v22_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v22_termoanu"]))
           $resac = db_query("insert into db_acount values($acount,1699,9925,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v22_termoanu'))."','$this->v22_termoanu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v22_processo"]))
           $resac = db_query("insert into db_acount values($acount,1699,9926,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v22_processo'))."','$this->v22_processo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($v22_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1699,9924,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v22_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1699,9925,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v22_termoanu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1699,9926,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v22_processo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
