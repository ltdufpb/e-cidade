...
class cl_pcfornecertifdoc { 
   ...
   public $pc75_codigo = 0; 
   public $pc75_pcfornecertif = 0; 
   public $pc75_pcdoccertif = 0; 
   public $pc75_validade_dia = null; 
   public $pc75_validade_mes = null; 
   public $pc75_validade_ano = null; 
   public $pc75_validade = null; 
   public $pc75_obrigatorio = 'f'; 
   public $pc75_obs = null; 
   public $pc75_apresentado = 0; 
   public $pc75_dataemissao_dia = null; 
   public $pc75_dataemissao_mes = null; 
   public $pc75_dataemissao_ano = null; 
   public $pc75_dataemissao = null; 
   ...
   function incluir ($pc75_codigo){ 
     ...
     if($pc75_codigo == "" || $pc75_codigo == null ){
       ...
       $this->pc75_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from pcfornecertifdoc_pc75_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $pc75_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1306,7802,'','".AddSlashes(pg_fetch_result($resaco,0,'pc75_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1306,7803,'','".AddSlashes(pg_fetch_result($resaco,0,'pc75_pcfornecertif'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1306,7804,'','".AddSlashes(pg_fetch_result($resaco,0,'pc75_pcdoccertif'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1306,7805,'','".AddSlashes(pg_fetch_result($resaco,0,'pc75_validade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1306,7806,'','".AddSlashes(pg_fetch_result($resaco,0,'pc75_obrigatorio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1306,7807,'','".AddSlashes(pg_fetch_result($resaco,0,'pc75_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1306,16556,'','".AddSlashes(pg_fetch_result($resaco,0,'pc75_apresentado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1306,16557,'','".AddSlashes(pg_fetch_result($resaco,0,'pc75_dataemissao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc75_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc75_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc75_codigo"])){ 
       $sql  .= $virgula." pc75_codigo = $this->pc75_codigo ";
       $virgula = ",";
       if(trim((string) $this->pc75_codigo) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
     ...
     if(trim((string) $this->pc75_pcfornecertif)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc75_pcfornecertif"])){ 
       $sql  .= $virgula." pc75_pcfornecertif = $this->pc75_pcfornecertif ";
       $virgula = ",";
       if(trim((string) $this->pc75_pcfornecertif) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
         $this->erro_campo = "pc75_pcfornecertif";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc75_pcdoccertif)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc75_pcdoccertif"])){ 
       $sql  .= $virgula." pc75_pcdoccertif = $this->pc75_pcdoccertif ";
       $virgula = ",";
       if(trim((string) $this->pc75_pcdoccertif) == null ){ 
         $this->erro_sql = " Campo Cod. Documento nao Informado.";
         $this->erro_campo = "pc75_pcdoccertif";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc75_validade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc75_validade_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["pc75_validade_dia"] !="") ){ 
       $sql  .= $virgula." pc75_validade = '$this->pc75_validade' ";
       $virgula = ",";
     } else{ 
       if(isset($GLOBALS["HTTP_POST_VARS"]["pc75_validade_dia"]) || trim((string) $this->pc75_validade) == ""){ 
         $sql  .= $virgula." pc75_validade = null ";
         $virgula = ",";
       }
     }
     if(trim((string) $this->pc75_obrigatorio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc75_obrigatorio"])){ 
       $sql  .= $virgula." pc75_obrigatorio = '$this->pc75_obrigatorio' ";
       $virgula = ",";
       if(trim((string) $this->pc75_obrigatorio) == null ){ 
         $this->erro_sql = " Campo Obrigatório nao Informado.";
         $this->erro_campo = "pc75_obrigatorio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc75_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc75_obs"])){ 
       if(trim((string) $this->pc75_obs) == "null"){
       	$this->pc75_obs = '';
       }
     ...
     if(trim((string) $this->pc75_apresentado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc75_apresentado"])){ 
       $sql  .= $virgula." pc75_apresentado = $this->pc75_apresentado ";
       $virgula = ",";
       if(trim((string) $this->pc75_apresentado) == null ){ 
         $this->erro_sql = " Campo Apresentado nao Informado.";
         $this->erro_campo = "pc75_apresentado";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc75_dataemissao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc75_dataemissao_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["pc75_dataemissao_dia"] !="") ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc75_codigo"]) || $this->pc75_codigo != "")
           $resac = db_query("insert into db_acount values($acount,1306,7802,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc75_codigo'))."','$this->pc75_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc75_pcfornecertif"]) || $this->pc75_pcfornecertif != "")
           $resac = db_query("insert into db_acount values($acount,1306,7803,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc75_pcfornecertif'))."','$this->pc75_pcfornecertif',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc75_pcdoccertif"]) || $this->pc75_pcdoccertif != "")
           $resac = db_query("insert into db_acount values($acount,1306,7804,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc75_pcdoccertif'))."','$this->pc75_pcdoccertif',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc75_validade"]) || $this->pc75_validade != "")
           $resac = db_query("insert into db_acount values($acount,1306,7805,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc75_validade'))."','$this->pc75_validade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc75_obrigatorio"]) || $this->pc75_obrigatorio != "")
           $resac = db_query("insert into db_acount values($acount,1306,7806,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc75_obrigatorio'))."','$this->pc75_obrigatorio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc75_obs"]) || $this->pc75_obs != "")
           $resac = db_query("insert into db_acount values($acount,1306,7807,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc75_obs'))."','$this->pc75_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc75_apresentado"]) || $this->pc75_apresentado != "")
           $resac = db_query("insert into db_acount values($acount,1306,16556,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc75_apresentado'))."','$this->pc75_apresentado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc75_dataemissao"]) || $this->pc75_dataemissao != "")
           $resac = db_query("insert into db_acount values($acount,1306,16557,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc75_dataemissao'))."','$this->pc75_dataemissao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc75_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1306,7802,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc75_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1306,7803,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc75_pcfornecertif'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1306,7804,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc75_pcdoccertif'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1306,7805,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc75_validade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1306,7806,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc75_obrigatorio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1306,7807,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc75_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1306,16556,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc75_apresentado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1306,16557,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc75_dataemissao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
