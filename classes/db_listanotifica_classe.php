...
class cl_listanotifica { 
   ...
   function incluir ($k63_codigo,$k63_numpre,$k63_notifica){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,644,4788,'','".AddSlashes(pg_fetch_result($resaco,0,'k63_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,644,4789,'','".AddSlashes(pg_fetch_result($resaco,0,'k63_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,644,4787,'','".AddSlashes(pg_fetch_result($resaco,0,'k63_notifica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k63_codigo=null,$k63_numpre=null,$k63_notifica=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k63_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k63_codigo"])){ 
       $sql  .= $virgula." k63_codigo = $this->k63_codigo ";
       $virgula = ",";
       if(trim((string) $this->k63_codigo) == null ){ 
     ...
     if(trim((string) $this->k63_numpre)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k63_numpre"])){ 
       $sql  .= $virgula." k63_numpre = $this->k63_numpre ";
       $virgula = ",";
       if(trim((string) $this->k63_numpre) == null ){ 
     ...
     if(trim((string) $this->k63_notifica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k63_notifica"])){ 
       $sql  .= $virgula." k63_notifica = $this->k63_notifica ";
       $virgula = ",";
       if(trim((string) $this->k63_notifica) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k63_codigo"]))
           $resac = db_query("insert into db_acount values($acount,644,4788,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k63_codigo'))."','$this->k63_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k63_numpre"]))
           $resac = db_query("insert into db_acount values($acount,644,4789,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k63_numpre'))."','$this->k63_numpre',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k63_notifica"]))
           $resac = db_query("insert into db_acount values($acount,644,4787,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k63_notifica'))."','$this->k63_notifica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k63_codigo=null,$k63_numpre=null,$k63_notifica=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,644,4788,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k63_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,644,4789,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k63_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,644,4787,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k63_notifica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
