...
class cl_matanulitempedido { 
   ...
   public $m101_sequencial = 0; 
   public $m101_matanulitem = 0; 
   public $m101_matpedidoitem = 0; 
   ...
   function incluir ($m101_sequencial){ 
     ...
     if($m101_sequencial == "" || $m101_sequencial == null ){
       ...
       $this->m101_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from matanulitempedido_m101_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $m101_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2688,15251,'','".AddSlashes(pg_fetch_result($resaco,0,'m101_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2688,15252,'','".AddSlashes(pg_fetch_result($resaco,0,'m101_matanulitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2688,15253,'','".AddSlashes(pg_fetch_result($resaco,0,'m101_matpedidoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($m101_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->m101_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m101_sequencial"])){ 
       $sql  .= $virgula." m101_sequencial = $this->m101_sequencial ";
       $virgula = ",";
       if(trim((string) $this->m101_sequencial) == null ){ 
     ...
     if(trim((string) $this->m101_matanulitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m101_matanulitem"])){ 
       $sql  .= $virgula." m101_matanulitem = $this->m101_matanulitem ";
       $virgula = ",";
       if(trim((string) $this->m101_matanulitem) == null ){ 
         $this->erro_sql = " Campo Ítem nao Informado.";
         $this->erro_campo = "m101_matanulitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m101_matpedidoitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m101_matpedidoitem"])){ 
       $sql  .= $virgula." m101_matpedidoitem = $this->m101_matpedidoitem ";
       $virgula = ",";
       if(trim((string) $this->m101_matpedidoitem) == null ){ 
         $this->erro_sql = " Campo Pedido nao Informado.";
         $this->erro_campo = "m101_matpedidoitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["m101_sequencial"]) || $this->m101_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2688,15251,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m101_sequencial'))."','$this->m101_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m101_matanulitem"]) || $this->m101_matanulitem != "")
           $resac = db_query("insert into db_acount values($acount,2688,15252,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m101_matanulitem'))."','$this->m101_matanulitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m101_matpedidoitem"]) || $this->m101_matpedidoitem != "")
           $resac = db_query("insert into db_acount values($acount,2688,15253,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m101_matpedidoitem'))."','$this->m101_matpedidoitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($m101_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2688,15251,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m101_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2688,15252,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m101_matanulitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2688,15253,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m101_matpedidoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
