...
class cl_atendimento_top { 
   ...
   public $at14_sequencial = 0; 
   public $at14_codcli = 0; 
   public $at14_usuario = 0; 
   public $at14_qtd = 0; 
   ...
   function incluir ($at14_sequencial=null){ 
     ...
     if($at14_sequencial == "" || $at14_sequencial == null ){
       ...
       $this->at14_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from atendimento_top_at14_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at14_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1498,8772,'','".AddSlashes(pg_fetch_result($resaco,0,'at14_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1498,8773,'','".AddSlashes(pg_fetch_result($resaco,0,'at14_codcli'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1498,8774,'','".AddSlashes(pg_fetch_result($resaco,0,'at14_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1498,8775,'','".AddSlashes(pg_fetch_result($resaco,0,'at14_qtd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at14_sequencial=null,$dbwhere=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at14_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at14_sequencial"])){ 
       $sql  .= $virgula." at14_sequencial = $this->at14_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at14_sequencial) == null ){ 
     ...
     if(trim((string) $this->at14_codcli)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at14_codcli"])){ 
       $sql  .= $virgula." at14_codcli = $this->at14_codcli ";
       $virgula = ",";
       if(trim((string) $this->at14_codcli) == null ){ 
         $this->erro_sql = " Campo Cliente nao Informado.";
         $this->erro_campo = "at14_codcli";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at14_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at14_usuario"])){ 
       $sql  .= $virgula." at14_usuario = $this->at14_usuario ";
       $virgula = ",";
       if(trim((string) $this->at14_usuario) == null ){ 
         $this->erro_sql = " Campo Solicitante nao Informado.";
         $this->erro_campo = "at14_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at14_qtd)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at14_qtd"])){ 
       $sql  .= $virgula." at14_qtd = $this->at14_qtd ";
       $virgula = ",";
       if(trim((string) $this->at14_qtd) == null ){ 
         $this->erro_sql = " Campo Atendimentos nao Informado.";
         $this->erro_campo = "at14_qtd";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at14_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1498,8772,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at14_sequencial'))."','$this->at14_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at14_codcli"]))
           $resac = db_query("insert into db_acount values($acount,1498,8773,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at14_codcli'))."','$this->at14_codcli',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at14_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1498,8774,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at14_usuario'))."','$this->at14_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at14_qtd"]))
           $resac = db_query("insert into db_acount values($acount,1498,8775,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at14_qtd'))."','$this->at14_qtd',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at14_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1498,8772,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at14_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1498,8773,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at14_codcli'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1498,8774,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at14_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1498,8775,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at14_qtd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
