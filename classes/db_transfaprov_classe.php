...
class cl_transfaprov {
   ...
   function incluir ($ed251_i_codigo){
     ...
     if($ed251_i_codigo == "" || $ed251_i_codigo == null ){
       ...
       $this->ed251_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from transfaprov_ed251_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed251_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2125,12224,'','".AddSlashes(pg_fetch_result($resaco,0,'ed251_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2125,12225,'','".AddSlashes(pg_fetch_result($resaco,0,'ed251_i_diarioorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2125,12226,'','".AddSlashes(pg_fetch_result($resaco,0,'ed251_i_diariodestino'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($ed251_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->ed251_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed251_i_codigo"])){
       $sql  .= $virgula." ed251_i_codigo = $this->ed251_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed251_i_codigo) == null ){
     ...
     if(trim((string) $this->ed251_i_diarioorigem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed251_i_diarioorigem"])){
       $sql  .= $virgula." ed251_i_diarioorigem = $this->ed251_i_diarioorigem ";
       $virgula = ",";
       if(trim((string) $this->ed251_i_diarioorigem) == null ){
         $this->erro_sql = " Campo Avaliação de origem nao Informado.";
         $this->erro_campo = "ed251_i_diarioorigem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed251_i_diariodestino)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed251_i_diariodestino"])){
       $sql  .= $virgula." ed251_i_diariodestino = $this->ed251_i_diariodestino ";
       $virgula = ",";
       if(trim((string) $this->ed251_i_diariodestino) == null ){
         $this->erro_sql = " Campo Avaliação de destino nao Informado.";
         $this->erro_campo = "ed251_i_diariodestino";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed251_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2125,12224,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed251_i_codigo'))."','$this->ed251_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed251_i_diarioorigem"]))
           $resac = db_query("insert into db_acount values($acount,2125,12225,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed251_i_diarioorigem'))."','$this->ed251_i_diarioorigem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed251_i_diariodestino"]))
           $resac = db_query("insert into db_acount values($acount,2125,12226,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed251_i_diariodestino'))."','$this->ed251_i_diariodestino',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($ed251_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2125,12224,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed251_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2125,12225,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed251_i_diarioorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2125,12226,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed251_i_diariodestino'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
