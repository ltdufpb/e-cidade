...
class cl_db_versaocpdcliente { 
   ...
   public $db35_sequen = 0; 
   public $db35_codcpd = 0; 
   public $db35_codcli = 0; 
   ...
   function incluir ($db35_sequen){ 
     ...
     if($db35_sequen == "" || $db35_sequen == null ){
       ...
       $this->db35_sequen = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_versaocpdcliente_db35_sequen_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db35_sequen)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1837,10644,'','".AddSlashes(pg_fetch_result($resaco,0,'db35_sequen'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1837,10645,'','".AddSlashes(pg_fetch_result($resaco,0,'db35_codcpd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1837,10646,'','".AddSlashes(pg_fetch_result($resaco,0,'db35_codcli'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db35_sequen=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db35_sequen)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db35_sequen"])){ 
       $sql  .= $virgula." db35_sequen = $this->db35_sequen ";
       $virgula = ",";
       if(trim((string) $this->db35_sequen) == null ){ 
     ...
     if(trim((string) $this->db35_codcpd)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db35_codcpd"])){ 
       $sql  .= $virgula." db35_codcpd = $this->db35_codcpd ";
       $virgula = ",";
       if(trim((string) $this->db35_codcpd) == null ){ 
         $this->erro_sql = " Campo Código da Observação nao Informado.";
         $this->erro_campo = "db35_codcpd";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db35_codcli)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db35_codcli"])){ 
       $sql  .= $virgula." db35_codcli = $this->db35_codcli ";
       $virgula = ",";
       if(trim((string) $this->db35_codcli) == null ){ 
         $this->erro_sql = " Campo Código do cliente nao Informado.";
         $this->erro_campo = "db35_codcli";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db35_sequen"]))
           $resac = db_query("insert into db_acount values($acount,1837,10644,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db35_sequen'))."','$this->db35_sequen',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db35_codcpd"]))
           $resac = db_query("insert into db_acount values($acount,1837,10645,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db35_codcpd'))."','$this->db35_codcpd',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db35_codcli"]))
           $resac = db_query("insert into db_acount values($acount,1837,10646,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db35_codcli'))."','$this->db35_codcli',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db35_sequen=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1837,10644,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db35_sequen'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1837,10645,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db35_codcpd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1837,10646,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db35_codcli'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
