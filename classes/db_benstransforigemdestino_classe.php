...
class cl_benstransforigemdestino { 
   ...
   public $t34_sequencial = 0; 
   public $t34_transferencia = 0; 
   public $t34_bem = 0; 
   public $t34_divisaoorigem = null; 
   public $t34_divisaodestino = null; 
   public $t34_departamentodestino = 0; 
   public $t34_departamentoorigem = 0; 
   ...
   function incluir ($t34_sequencial){ 
     ...
     if($t34_sequencial == "" || $t34_sequencial == null ){
       ...
       $this->t34_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from benstransforigemdestino_t34_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $t34_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3432,19305,'','".AddSlashes(pg_fetch_result($resaco,0,'t34_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3432,19306,'','".AddSlashes(pg_fetch_result($resaco,0,'t34_transferencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3432,19307,'','".AddSlashes(pg_fetch_result($resaco,0,'t34_bem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3432,19308,'','".AddSlashes(pg_fetch_result($resaco,0,'t34_divisaoorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3432,19309,'','".AddSlashes(pg_fetch_result($resaco,0,'t34_divisaodestino'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3432,19399,'','".AddSlashes(pg_fetch_result($resaco,0,'t34_departamentodestino'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3432,19398,'','".AddSlashes(pg_fetch_result($resaco,0,'t34_departamentoorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($t34_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->t34_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t34_sequencial"])){ 
       $sql  .= $virgula." t34_sequencial = $this->t34_sequencial ";
       $virgula = ",";
       if(trim((string) $this->t34_sequencial) == null ){ 
     ...
     if(trim((string) $this->t34_transferencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t34_transferencia"])){ 
       $sql  .= $virgula." t34_transferencia = $this->t34_transferencia ";
       $virgula = ",";
       if(trim((string) $this->t34_transferencia) == null ){ 
         $this->erro_sql = " Campo sequencial da transferencia do bem nao Informado.";
         $this->erro_campo = "t34_transferencia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->t34_bem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t34_bem"])){ 
       $sql  .= $virgula." t34_bem = $this->t34_bem ";
       $virgula = ",";
       if(trim((string) $this->t34_bem) == null ){ 
         $this->erro_sql = " Campo sequencial do bem na transferencia nao Informado.";
         $this->erro_campo = "t34_bem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->t34_divisaoorigem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t34_divisaoorigem"])){ 
        if(trim((string) $this->t34_divisaoorigem)=="" && isset($GLOBALS["HTTP_POST_VARS"]["t34_divisaoorigem"])){ 
           $this->t34_divisaoorigem = "null" ; 
        } 
     ...
     if(trim((string) $this->t34_divisaodestino)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t34_divisaodestino"])){ 
        if(trim((string) $this->t34_divisaodestino)=="" && isset($GLOBALS["HTTP_POST_VARS"]["t34_divisaodestino"])){ 
           $this->t34_divisaodestino = "null" ; 
        } 
     ...
     if(trim((string) $this->t34_departamentodestino)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t34_departamentodestino"])){ 
       $sql  .= $virgula." t34_departamentodestino = $this->t34_departamentodestino ";
       $virgula = ",";
       if(trim((string) $this->t34_departamentodestino) == null ){ 
         $this->erro_sql = " Campo Departamento Atual nao Informado.";
         $this->erro_campo = "t34_departamentodestino";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->t34_departamentoorigem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t34_departamentoorigem"])){ 
       $sql  .= $virgula." t34_departamentoorigem = $this->t34_departamentoorigem ";
       $virgula = ",";
       if(trim((string) $this->t34_departamentoorigem) == null ){ 
         $this->erro_sql = " Campo Departamento Origem nao Informado.";
         $this->erro_campo = "t34_departamentoorigem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["t34_sequencial"]) || $this->t34_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3432,19305,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t34_sequencial'))."','$this->t34_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t34_transferencia"]) || $this->t34_transferencia != "")
           $resac = db_query("insert into db_acount values($acount,3432,19306,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t34_transferencia'))."','$this->t34_transferencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t34_bem"]) || $this->t34_bem != "")
           $resac = db_query("insert into db_acount values($acount,3432,19307,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t34_bem'))."','$this->t34_bem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t34_divisaoorigem"]) || $this->t34_divisaoorigem != "")
           $resac = db_query("insert into db_acount values($acount,3432,19308,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t34_divisaoorigem'))."','$this->t34_divisaoorigem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t34_divisaodestino"]) || $this->t34_divisaodestino != "")
           $resac = db_query("insert into db_acount values($acount,3432,19309,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t34_divisaodestino'))."','$this->t34_divisaodestino',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t34_departamentodestino"]) || $this->t34_departamentodestino != "")
           $resac = db_query("insert into db_acount values($acount,3432,19399,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t34_departamentodestino'))."','$this->t34_departamentodestino',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t34_departamentoorigem"]) || $this->t34_departamentoorigem != "")
           $resac = db_query("insert into db_acount values($acount,3432,19398,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t34_departamentoorigem'))."','$this->t34_departamentoorigem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($t34_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3432,19305,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t34_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3432,19306,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t34_transferencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3432,19307,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t34_bem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3432,19308,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t34_divisaoorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3432,19309,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t34_divisaodestino'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3432,19399,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t34_departamentodestino'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3432,19398,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t34_departamentoorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
