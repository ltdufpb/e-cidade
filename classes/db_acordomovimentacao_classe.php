...
class cl_acordomovimentacao { 
   ...
   public $ac10_sequencial = 0; 
   public $ac10_acordomovimentacaotipo = 0; 
   public $ac10_acordo = 0; 
   public $ac10_id_usuario = 0; 
   public $ac10_datamovimento_dia = null; 
   public $ac10_datamovimento_mes = null; 
   public $ac10_datamovimento_ano = null; 
   public $ac10_datamovimento = null; 
   public $ac10_hora = null; 
   public $ac10_obs = null; 
   ...
   function incluir ($ac10_sequencial){ 
     ...
     if($ac10_sequencial == "" || $ac10_sequencial == null ){
       ...
       $this->ac10_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordomovimentacao_ac10_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac10_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2832,16145,'','".AddSlashes(pg_fetch_result($resaco,0,'ac10_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2832,16146,'','".AddSlashes(pg_fetch_result($resaco,0,'ac10_acordomovimentacaotipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2832,16147,'','".AddSlashes(pg_fetch_result($resaco,0,'ac10_acordo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2832,16148,'','".AddSlashes(pg_fetch_result($resaco,0,'ac10_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2832,16149,'','".AddSlashes(pg_fetch_result($resaco,0,'ac10_datamovimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2832,16150,'','".AddSlashes(pg_fetch_result($resaco,0,'ac10_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2832,16151,'','".AddSlashes(pg_fetch_result($resaco,0,'ac10_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac10_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac10_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac10_sequencial"])){ 
       $sql  .= $virgula." ac10_sequencial = $this->ac10_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac10_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac10_acordomovimentacaotipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac10_acordomovimentacaotipo"])){ 
       $sql  .= $virgula." ac10_acordomovimentacaotipo = $this->ac10_acordomovimentacaotipo ";
       $virgula = ",";
       if(trim((string) $this->ac10_acordomovimentacaotipo) == null ){ 
         $this->erro_sql = " Campo Acordo Movimentação Tipo nao Informado.";
         $this->erro_campo = "ac10_acordomovimentacaotipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac10_acordo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac10_acordo"])){ 
       $sql  .= $virgula." ac10_acordo = $this->ac10_acordo ";
       $virgula = ",";
       if(trim((string) $this->ac10_acordo) == null ){ 
         $this->erro_sql = " Campo Acordo nao Informado.";
         $this->erro_campo = "ac10_acordo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac10_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac10_id_usuario"])){ 
       $sql  .= $virgula." ac10_id_usuario = $this->ac10_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->ac10_id_usuario) == null ){ 
         $this->erro_sql = " Campo Código Usúario nao Informado.";
         $this->erro_campo = "ac10_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac10_datamovimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac10_datamovimento_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ac10_datamovimento_dia"] !="") ){ 
       $sql  .= $virgula." ac10_datamovimento = '$this->ac10_datamovimento' ";
       $virgula = ",";
       if(trim((string) $this->ac10_datamovimento) == null ){ 
         $this->erro_sql = " Campo Data Movimentação nao Informado.";
         $this->erro_campo = "ac10_datamovimento_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac10_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac10_hora"])){ 
       $sql  .= $virgula." ac10_hora = '$this->ac10_hora' ";
       $virgula = ",";
       if(trim((string) $this->ac10_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "ac10_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac10_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac10_obs"])){ 
       $sql  .= $virgula." ac10_obs = '$this->ac10_obs' ";
       $virgula = ",";
       if(trim((string) $this->ac10_obs) == null ){ 
         $this->erro_sql = " Campo Observação nao Informado.";
         $this->erro_campo = "ac10_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac10_sequencial"]) || $this->ac10_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2832,16145,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac10_sequencial'))."','$this->ac10_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac10_acordomovimentacaotipo"]) || $this->ac10_acordomovimentacaotipo != "")
           $resac = db_query("insert into db_acount values($acount,2832,16146,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac10_acordomovimentacaotipo'))."','$this->ac10_acordomovimentacaotipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac10_acordo"]) || $this->ac10_acordo != "")
           $resac = db_query("insert into db_acount values($acount,2832,16147,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac10_acordo'))."','$this->ac10_acordo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac10_id_usuario"]) || $this->ac10_id_usuario != "")
           $resac = db_query("insert into db_acount values($acount,2832,16148,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac10_id_usuario'))."','$this->ac10_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac10_datamovimento"]) || $this->ac10_datamovimento != "")
           $resac = db_query("insert into db_acount values($acount,2832,16149,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac10_datamovimento'))."','$this->ac10_datamovimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac10_hora"]) || $this->ac10_hora != "")
           $resac = db_query("insert into db_acount values($acount,2832,16150,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac10_hora'))."','$this->ac10_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac10_obs"]) || $this->ac10_obs != "")
           $resac = db_query("insert into db_acount values($acount,2832,16151,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac10_obs'))."','$this->ac10_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac10_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2832,16145,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac10_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2832,16146,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac10_acordomovimentacaotipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2832,16147,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac10_acordo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2832,16148,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac10_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2832,16149,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac10_datamovimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2832,16150,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac10_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2832,16151,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac10_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
