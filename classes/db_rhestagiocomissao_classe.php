...
class cl_rhestagiocomissao { 
   ...
   public $h59_sequencial = 0; 
   public $h59_dtini_dia = null; 
   public $h59_dtini_mes = null; 
   public $h59_dtini_ano = null; 
   public $h59_dtini = null; 
   public $h59_dtfim_dia = null; 
   public $h59_dtfim_mes = null; 
   public $h59_dtfim_ano = null; 
   public $h59_dtfim = null; 
   public $h59_descr = null; 
   public $h59_instit = 0; 
   ...
   function incluir ($h59_sequencial){ 
     ...
     if($h59_sequencial == "" || $h59_sequencial == null ){
       ...
       $this->h59_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhestagiocomissao_h59_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h59_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1874,10874,'','".AddSlashes(pg_fetch_result($resaco,0,'h59_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1874,10875,'','".AddSlashes(pg_fetch_result($resaco,0,'h59_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1874,10876,'','".AddSlashes(pg_fetch_result($resaco,0,'h59_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1874,10934,'','".AddSlashes(pg_fetch_result($resaco,0,'h59_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1874,10948,'','".AddSlashes(pg_fetch_result($resaco,0,'h59_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h59_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h59_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h59_sequencial"])){ 
       $sql  .= $virgula." h59_sequencial = $this->h59_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h59_sequencial) == null ){ 
     ...
     if(trim((string) $this->h59_dtini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h59_dtini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["h59_dtini_dia"] !="") ){ 
       $sql  .= $virgula." h59_dtini = '$this->h59_dtini' ";
       $virgula = ",";
       if(trim((string) $this->h59_dtini) == null ){ 
         $this->erro_sql = " Campo Data inicial nao Informado.";
         $this->erro_campo = "h59_dtini_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h59_dtfim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h59_dtfim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["h59_dtfim_dia"] !="") ){ 
       $sql  .= $virgula." h59_dtfim = '$this->h59_dtfim' ";
       $virgula = ",";
       if(trim((string) $this->h59_dtfim) == null ){ 
         $this->erro_sql = " Campo Data final nao Informado.";
         $this->erro_campo = "h59_dtfim_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h59_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h59_descr"])){ 
       $sql  .= $virgula." h59_descr = '$this->h59_descr' ";
       $virgula = ",";
       if(trim((string) $this->h59_descr) == null ){ 
         $this->erro_sql = " Campo Descrição: nao Informado.";
         $this->erro_campo = "h59_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h59_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h59_instit"])){ 
       $sql  .= $virgula." h59_instit = $this->h59_instit ";
       $virgula = ",";
       if(trim((string) $this->h59_instit) == null ){ 
         $this->erro_sql = " Campo Instituição nao Informado.";
         $this->erro_campo = "h59_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h59_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1874,10874,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h59_sequencial'))."','$this->h59_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h59_dtini"]))
           $resac = db_query("insert into db_acount values($acount,1874,10875,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h59_dtini'))."','$this->h59_dtini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h59_dtfim"]))
           $resac = db_query("insert into db_acount values($acount,1874,10876,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h59_dtfim'))."','$this->h59_dtfim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h59_descr"]))
           $resac = db_query("insert into db_acount values($acount,1874,10934,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h59_descr'))."','$this->h59_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h59_instit"]))
           $resac = db_query("insert into db_acount values($acount,1874,10948,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h59_instit'))."','$this->h59_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h59_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1874,10874,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h59_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1874,10875,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h59_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1874,10876,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h59_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1874,10934,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h59_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1874,10948,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h59_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
