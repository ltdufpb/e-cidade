...
class cl_rhempenhofolhaexcecaoregra { 
   ...
   public $rh128_sequencial = 0; 
   public $rh128_descricao = null; 
   ...
   function incluir ($rh128_sequencial){ 
     ...
     if($rh128_sequencial == "" || $rh128_sequencial == null ){
       ...
       $this->rh128_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhempenhofolhaexcecaoregra_rh128_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh128_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3655,20341,'','".AddSlashes(pg_fetch_result($resaco,0,'rh128_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3655,20338,'','".AddSlashes(pg_fetch_result($resaco,0,'rh128_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($rh128_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh128_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh128_sequencial"])){ 
       $sql  .= $virgula." rh128_sequencial = $this->rh128_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh128_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh128_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh128_descricao"])){ 
       $sql  .= $virgula." rh128_descricao = '$this->rh128_descricao' ";
       $virgula = ",";
       if(trim((string) $this->rh128_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição não informado.";
         $this->erro_campo = "rh128_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["rh128_sequencial"]) || $this->rh128_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3655,20341,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh128_sequencial'))."','$this->rh128_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["rh128_descricao"]) || $this->rh128_descricao != "")
             $resac = db_query("insert into db_acount values($acount,3655,20338,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh128_descricao'))."','$this->rh128_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3655,20341,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh128_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3655,20338,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh128_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
