...
class cl_procespecialidades { 
   ...
   public $sd18_i_codigo = 0; 
   public $sd18_i_procedimento = 0; 
   public $sd18_i_especialidade = 0; 
   ...
   function incluir ($sd18_i_codigo){ 
     ...
     if($sd18_i_codigo == "" || $sd18_i_codigo == null ){
       ...
       $this->sd18_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from procespecialidades_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $sd18_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,100025,1008720,'','".AddSlashes(pg_fetch_result($resaco,0,'sd18_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,100025,100124,'','".AddSlashes(pg_fetch_result($resaco,0,'sd18_i_procedimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,100025,100125,'','".AddSlashes(pg_fetch_result($resaco,0,'sd18_i_especialidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd18_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd18_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd18_i_codigo"])){ 
       $sql  .= $virgula." sd18_i_codigo = $this->sd18_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->sd18_i_codigo) == null ){ 
     ...
     if(trim((string) $this->sd18_i_procedimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd18_i_procedimento"])){ 
       $sql  .= $virgula." sd18_i_procedimento = $this->sd18_i_procedimento ";
       $virgula = ",";
       if(trim((string) $this->sd18_i_procedimento) == null ){ 
         $this->erro_sql = " Campo Procedimento nao Informado.";
         $this->erro_campo = "sd18_i_procedimento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd18_i_especialidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd18_i_especialidade"])){ 
       $sql  .= $virgula." sd18_i_especialidade = $this->sd18_i_especialidade ";
       $virgula = ",";
       if(trim((string) $this->sd18_i_especialidade) == null ){ 
         $this->erro_sql = " Campo Especialidade nao Informado.";
         $this->erro_campo = "sd18_i_especialidade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd18_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,100025,1008720,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd18_i_codigo'))."','$this->sd18_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd18_i_procedimento"]))
           $resac = db_query("insert into db_acount values($acount,100025,100124,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd18_i_procedimento'))."','$this->sd18_i_procedimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd18_i_especialidade"]))
           $resac = db_query("insert into db_acount values($acount,100025,100125,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd18_i_especialidade'))."','$this->sd18_i_especialidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd18_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,100025,1008720,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd18_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,100025,100124,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd18_i_procedimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,100025,100125,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd18_i_especialidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
