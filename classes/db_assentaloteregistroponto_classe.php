...
class cl_assentaloteregistroponto { 
   ...
   public $rh160_sequencial = 0; 
   public $rh160_loteregistroponto = 0; 
   public $rh160_assentamento = 0; 
   ...
   public function alterar ($rh160_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh160_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh160_sequencial"])){ 
       $sql  .= $virgula." rh160_sequencial = $this->rh160_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh160_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh160_loteregistroponto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh160_loteregistroponto"])){ 
       $sql  .= $virgula." rh160_loteregistroponto = $this->rh160_loteregistroponto ";
       $virgula = ",";
       if(trim((string) $this->rh160_loteregistroponto) == null ){ 
         $this->erro_sql = " Campo Lote não informado.";
         $this->erro_campo = "rh160_loteregistroponto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh160_assentamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh160_assentamento"])){ 
       $sql  .= $virgula." rh160_assentamento = $this->rh160_assentamento ";
       $virgula = ",";
       if(trim((string) $this->rh160_assentamento) == null ){ 
         $this->erro_sql = " Campo Assentamento não informado.";
         $this->erro_campo = "rh160_assentamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
