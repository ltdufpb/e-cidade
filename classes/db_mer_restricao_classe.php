...
class cl_mer_restricao { 
   ...
   public $me24_i_codigo = 0; 
   public $me24_i_aluno = 0; 
   ...
   function incluir ($me24_i_codigo){ 
     ...
     if($me24_i_codigo == "" || $me24_i_codigo == null ){
       ...
       $this->me24_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mer_restricao_me24_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $me24_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2399,13726,'','".AddSlashes(pg_fetch_result($resaco,0,'me24_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2399,13727,'','".AddSlashes(pg_fetch_result($resaco,0,'me24_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me24_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->me24_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me24_i_codigo"])){ 
       $sql  .= $virgula." me24_i_codigo = $this->me24_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->me24_i_codigo) == null ){ 
     ...
     if(trim((string) $this->me24_i_aluno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me24_i_aluno"])){ 
       $sql  .= $virgula." me24_i_aluno = $this->me24_i_aluno ";
       $virgula = ",";
       if(trim((string) $this->me24_i_aluno) == null ){ 
         $this->erro_sql = " Campo Aluno nao Informado.";
         $this->erro_campo = "me24_i_aluno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me24_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2399,13726,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me24_i_codigo'))."','$this->me24_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me24_i_aluno"]))
           $resac = db_query("insert into db_acount values($acount,2399,13727,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me24_i_aluno'))."','$this->me24_i_aluno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me24_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2399,13726,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me24_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2399,13727,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me24_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
