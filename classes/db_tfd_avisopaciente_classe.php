...
class cl_tfd_avisopaciente { 
   ...
   public $tf21_i_codigo = 0; 
   public $tf21_i_pedidotfd = 0; 
   public $tf21_i_formaaviso = 0; 
   public $tf21_d_dataaviso_dia = null; 
   public $tf21_d_dataaviso_mes = null; 
   public $tf21_d_dataaviso_ano = null; 
   public $tf21_d_dataaviso = null; 
   public $tf21_c_horaaviso = null; 
   public $tf21_i_login = 0; 
   public $tf21_t_obs = null; 
   ...
   function incluir ($tf21_i_codigo){ 
     ...
     if($tf21_i_codigo == "" || $tf21_i_codigo == null ){
       ...
       $this->tf21_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tfd_avisopaciente_tf21_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $tf21_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2877,16425,'','".AddSlashes(pg_fetch_result($resaco,0,'tf21_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2877,16426,'','".AddSlashes(pg_fetch_result($resaco,0,'tf21_i_pedidotfd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2877,16427,'','".AddSlashes(pg_fetch_result($resaco,0,'tf21_i_formaaviso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2877,16428,'','".AddSlashes(pg_fetch_result($resaco,0,'tf21_d_dataaviso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2877,16429,'','".AddSlashes(pg_fetch_result($resaco,0,'tf21_c_horaaviso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2877,16431,'','".AddSlashes(pg_fetch_result($resaco,0,'tf21_i_login'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2877,16430,'','".AddSlashes(pg_fetch_result($resaco,0,'tf21_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($tf21_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->tf21_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf21_i_codigo"])){ 
       $sql  .= $virgula." tf21_i_codigo = $this->tf21_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->tf21_i_codigo) == null ){ 
     ...
     if(trim((string) $this->tf21_i_pedidotfd)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf21_i_pedidotfd"])){ 
       $sql  .= $virgula." tf21_i_pedidotfd = $this->tf21_i_pedidotfd ";
       $virgula = ",";
       if(trim((string) $this->tf21_i_pedidotfd) == null ){ 
         $this->erro_sql = " Campo Pedido nao Informado.";
         $this->erro_campo = "tf21_i_pedidotfd";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tf21_i_formaaviso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf21_i_formaaviso"])){ 
       $sql  .= $virgula." tf21_i_formaaviso = $this->tf21_i_formaaviso ";
       $virgula = ",";
       if(trim((string) $this->tf21_i_formaaviso) == null ){ 
         $this->erro_sql = " Campo Forma de Aviso nao Informado.";
         $this->erro_campo = "tf21_i_formaaviso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tf21_d_dataaviso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf21_d_dataaviso_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["tf21_d_dataaviso_dia"] !="") ){ 
       $sql  .= $virgula." tf21_d_dataaviso = '$this->tf21_d_dataaviso' ";
       $virgula = ",";
       if(trim((string) $this->tf21_d_dataaviso) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "tf21_d_dataaviso_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tf21_c_horaaviso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf21_c_horaaviso"])){ 
       $sql  .= $virgula." tf21_c_horaaviso = '$this->tf21_c_horaaviso' ";
       $virgula = ",";
       if(trim((string) $this->tf21_c_horaaviso) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "tf21_c_horaaviso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tf21_i_login)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf21_i_login"])){ 
       $sql  .= $virgula." tf21_i_login = $this->tf21_i_login ";
       $virgula = ",";
       if(trim((string) $this->tf21_i_login) == null ){ 
         $this->erro_sql = " Campo Login nao Informado.";
         $this->erro_campo = "tf21_i_login";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tf21_t_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf21_t_obs"])){ 
       $sql  .= $virgula." tf21_t_obs = '$this->tf21_t_obs' ";
       $virgula = ",";
       if(trim((string) $this->tf21_t_obs) == null ){ 
         $this->erro_sql = " Campo Avisado / Obs nao Informado.";
         $this->erro_campo = "tf21_t_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf21_i_codigo"]) || $this->tf21_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2877,16425,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf21_i_codigo'))."','$this->tf21_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf21_i_pedidotfd"]) || $this->tf21_i_pedidotfd != "")
           $resac = db_query("insert into db_acount values($acount,2877,16426,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf21_i_pedidotfd'))."','$this->tf21_i_pedidotfd',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf21_i_formaaviso"]) || $this->tf21_i_formaaviso != "")
           $resac = db_query("insert into db_acount values($acount,2877,16427,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf21_i_formaaviso'))."','$this->tf21_i_formaaviso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf21_d_dataaviso"]) || $this->tf21_d_dataaviso != "")
           $resac = db_query("insert into db_acount values($acount,2877,16428,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf21_d_dataaviso'))."','$this->tf21_d_dataaviso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf21_c_horaaviso"]) || $this->tf21_c_horaaviso != "")
           $resac = db_query("insert into db_acount values($acount,2877,16429,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf21_c_horaaviso'))."','$this->tf21_c_horaaviso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf21_i_login"]) || $this->tf21_i_login != "")
           $resac = db_query("insert into db_acount values($acount,2877,16431,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf21_i_login'))."','$this->tf21_i_login',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf21_t_obs"]) || $this->tf21_t_obs != "")
           $resac = db_query("insert into db_acount values($acount,2877,16430,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf21_t_obs'))."','$this->tf21_t_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($tf21_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2877,16425,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf21_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2877,16426,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf21_i_pedidotfd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2877,16427,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf21_i_formaaviso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2877,16428,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf21_d_dataaviso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2877,16429,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf21_c_horaaviso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2877,16431,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf21_i_login'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2877,16430,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf21_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
