...
class cl_cadenderbairro { 
   ...
   public $db73_sequencial = 0; 
   public $db73_cadendermunicipio = 0; 
   public $db73_descricao = null; 
   public $db73_sigla = null; 
   ...
   function incluir ($db73_sequencial){ 
     ...
     if($db73_sequencial == "" || $db73_sequencial == null ){
       ...
       $this->db73_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cadenderbairro_db73_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db73_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2782,15853,'','".AddSlashes(pg_fetch_result($resaco,0,'db73_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2782,15854,'','".AddSlashes(pg_fetch_result($resaco,0,'db73_cadendermunicipio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2782,15855,'','".AddSlashes(pg_fetch_result($resaco,0,'db73_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2782,15856,'','".AddSlashes(pg_fetch_result($resaco,0,'db73_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db73_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db73_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db73_sequencial"])){ 
       $sql  .= $virgula." db73_sequencial = $this->db73_sequencial ";
       $virgula = ",";
       if(trim((string) $this->db73_sequencial) == null ){ 
     ...
     if(trim((string) $this->db73_cadendermunicipio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db73_cadendermunicipio"])){ 
       $sql  .= $virgula." db73_cadendermunicipio = $this->db73_cadendermunicipio ";
       $virgula = ",";
       if(trim((string) $this->db73_cadendermunicipio) == null ){ 
         $this->erro_sql = " Campo Código do Município nao Informado.";
         $this->erro_campo = "db73_cadendermunicipio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db73_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db73_descricao"])){ 
       $sql  .= $virgula." db73_descricao = '$this->db73_descricao' ";
       $virgula = ",";
       if(trim((string) $this->db73_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição do Bairro nao Informado.";
         $this->erro_campo = "db73_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db73_sigla)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db73_sigla"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db73_sequencial"]) || $this->db73_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2782,15853,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db73_sequencial'))."','$this->db73_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db73_cadendermunicipio"]) || $this->db73_cadendermunicipio != "")
           $resac = db_query("insert into db_acount values($acount,2782,15854,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db73_cadendermunicipio'))."','$this->db73_cadendermunicipio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db73_descricao"]) || $this->db73_descricao != "")
           $resac = db_query("insert into db_acount values($acount,2782,15855,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db73_descricao'))."','$this->db73_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db73_sigla"]) || $this->db73_sigla != "")
           $resac = db_query("insert into db_acount values($acount,2782,15856,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db73_sigla'))."','$this->db73_sigla',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db73_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2782,15853,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db73_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2782,15854,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db73_cadendermunicipio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2782,15855,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db73_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2782,15856,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db73_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
