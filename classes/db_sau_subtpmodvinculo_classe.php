...
class cl_sau_subtpmodvinculo { 
   ...
   public $sd54_i_vinculacao = 0; 
   public $sd54_i_tpvinculo = 0; 
   public $sd54_i_tpsubvinculo = 0; 
   public $sd54_v_descricao = null; 
   ...
   function incluir ($sd54_i_vinculacao,$sd54_i_tpvinculo,$sd54_i_tpsubvinculo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1972,11465,'','".AddSlashes(pg_fetch_result($resaco,0,'sd54_i_vinculacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1972,11466,'','".AddSlashes(pg_fetch_result($resaco,0,'sd54_i_tpvinculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1972,11467,'','".AddSlashes(pg_fetch_result($resaco,0,'sd54_i_tpsubvinculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1972,11468,'','".AddSlashes(pg_fetch_result($resaco,0,'sd54_v_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd54_i_vinculacao=null,$sd54_i_tpvinculo=null,$sd54_i_tpsubvinculo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd54_i_vinculacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd54_i_vinculacao"])){ 
       $sql  .= $virgula." sd54_i_vinculacao = $this->sd54_i_vinculacao ";
       $virgula = ",";
       if(trim((string) $this->sd54_i_vinculacao) == null ){ 
     ...
     if(trim((string) $this->sd54_i_tpvinculo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd54_i_tpvinculo"])){ 
       $sql  .= $virgula." sd54_i_tpvinculo = $this->sd54_i_tpvinculo ";
       $virgula = ",";
       if(trim((string) $this->sd54_i_tpvinculo) == null ){ 
     ...
     if(trim((string) $this->sd54_i_tpsubvinculo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd54_i_tpsubvinculo"])){ 
       $sql  .= $virgula." sd54_i_tpsubvinculo = $this->sd54_i_tpsubvinculo ";
       $virgula = ",";
       if(trim((string) $this->sd54_i_tpsubvinculo) == null ){ 
     ...
     if(trim((string) $this->sd54_v_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd54_v_descricao"])){ 
       $sql  .= $virgula." sd54_v_descricao = '$this->sd54_v_descricao' ";
       $virgula = ",";
       if(trim((string) $this->sd54_v_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição Subvinculo nao Informado.";
         $this->erro_campo = "sd54_v_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd54_i_vinculacao"]))
           $resac = db_query("insert into db_acount values($acount,1972,11465,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd54_i_vinculacao'))."','$this->sd54_i_vinculacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd54_i_tpvinculo"]))
           $resac = db_query("insert into db_acount values($acount,1972,11466,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd54_i_tpvinculo'))."','$this->sd54_i_tpvinculo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd54_i_tpsubvinculo"]))
           $resac = db_query("insert into db_acount values($acount,1972,11467,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd54_i_tpsubvinculo'))."','$this->sd54_i_tpsubvinculo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd54_v_descricao"]))
           $resac = db_query("insert into db_acount values($acount,1972,11468,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd54_v_descricao'))."','$this->sd54_v_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd54_i_vinculacao=null,$sd54_i_tpvinculo=null,$sd54_i_tpsubvinculo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1972,11465,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd54_i_vinculacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1972,11466,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd54_i_tpvinculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1972,11467,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd54_i_tpsubvinculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1972,11468,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd54_v_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
