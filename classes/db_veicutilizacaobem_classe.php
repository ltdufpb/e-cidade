...
class cl_veicutilizacaobem { 
   ...
   public $ve16_sequencial = 0; 
   public $ve16_bens = 0; 
   public $ve16_veicutilizacao = 0; 
   ...
   function incluir ($ve16_sequencial){ 
     ...
     if($ve16_sequencial == "" || $ve16_sequencial == null ){
       ...
       $this->ve16_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veicutilizacaobem_ve16_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve16_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1920,11126,'','".AddSlashes(pg_fetch_result($resaco,0,'ve16_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1920,11127,'','".AddSlashes(pg_fetch_result($resaco,0,'ve16_bens'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1920,11128,'','".AddSlashes(pg_fetch_result($resaco,0,'ve16_veicutilizacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve16_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve16_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve16_sequencial"])){ 
       $sql  .= $virgula." ve16_sequencial = $this->ve16_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ve16_sequencial) == null ){ 
     ...
     if(trim((string) $this->ve16_bens)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve16_bens"])){ 
       $sql  .= $virgula." ve16_bens = $this->ve16_bens ";
       $virgula = ",";
       if(trim((string) $this->ve16_bens) == null ){ 
         $this->erro_sql = " Campo Cód. Bem nao Informado.";
         $this->erro_campo = "ve16_bens";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve16_veicutilizacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve16_veicutilizacao"])){ 
       $sql  .= $virgula." ve16_veicutilizacao = $this->ve16_veicutilizacao ";
       $virgula = ",";
       if(trim((string) $this->ve16_veicutilizacao) == null ){ 
         $this->erro_sql = " Campo Utilização nao Informado.";
         $this->erro_campo = "ve16_veicutilizacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve16_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1920,11126,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve16_sequencial'))."','$this->ve16_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve16_bens"]))
           $resac = db_query("insert into db_acount values($acount,1920,11127,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve16_bens'))."','$this->ve16_bens',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve16_veicutilizacao"]))
           $resac = db_query("insert into db_acount values($acount,1920,11128,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve16_veicutilizacao'))."','$this->ve16_veicutilizacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve16_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1920,11126,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve16_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1920,11127,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve16_bens'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1920,11128,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve16_veicutilizacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
