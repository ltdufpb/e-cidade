...
class cl_issarqsimplesregdisbanco { 
   ...
   public $q44_sequencial = 0; 
   public $q44_issarqsimplesreg = 0; 
   public $q44_disbanco = 0; 
   ...
   function incluir ($q44_sequencial){ 
     ...
     if($q44_sequencial == "" || $q44_sequencial == null ){
       ...
       $this->q44_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from issarqsimplesregdisbanco_q44_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q44_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1847,10713,'','".AddSlashes(pg_fetch_result($resaco,0,'q44_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1847,10714,'','".AddSlashes(pg_fetch_result($resaco,0,'q44_issarqsimplesreg'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1847,10715,'','".AddSlashes(pg_fetch_result($resaco,0,'q44_disbanco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q44_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q44_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q44_sequencial"])){ 
       $sql  .= $virgula." q44_sequencial = $this->q44_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q44_sequencial) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
     ...
     if(trim((string) $this->q44_issarqsimplesreg)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q44_issarqsimplesreg"])){ 
       $sql  .= $virgula." q44_issarqsimplesreg = $this->q44_issarqsimplesreg ";
       $virgula = ",";
       if(trim((string) $this->q44_issarqsimplesreg) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
         $this->erro_campo = "q44_issarqsimplesreg";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q44_disbanco)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q44_disbanco"])){ 
       $sql  .= $virgula." q44_disbanco = $this->q44_disbanco ";
       $virgula = ",";
       if(trim((string) $this->q44_disbanco) == null ){ 
         $this->erro_sql = " Campo Cód. Ret. nao Informado.";
         $this->erro_campo = "q44_disbanco";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q44_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1847,10713,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q44_sequencial'))."','$this->q44_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q44_issarqsimplesreg"]))
           $resac = db_query("insert into db_acount values($acount,1847,10714,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q44_issarqsimplesreg'))."','$this->q44_issarqsimplesreg',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q44_disbanco"]))
           $resac = db_query("insert into db_acount values($acount,1847,10715,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q44_disbanco'))."','$this->q44_disbanco',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q44_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1847,10713,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q44_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1847,10714,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q44_issarqsimplesreg'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1847,10715,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q44_disbanco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
