...
class cl_conlancamreconhecimentocontabil { 
   ...
   public $c113_sequencial = 0; 
   public $c113_reconhecimentocontabil = 0; 
   public $c113_codlan = 0; 
   ...
   function incluir ($c113_sequencial){ 
     ...
     if($c113_sequencial == "" || $c113_sequencial == null ){
       ...
       $this->c113_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from conlancamreconhecimentocontabil_c113_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $c113_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3628,20207,'','".AddSlashes(pg_fetch_result($resaco,0,'c113_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3628,20209,'','".AddSlashes(pg_fetch_result($resaco,0,'c113_reconhecimentocontabil'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3628,20208,'','".AddSlashes(pg_fetch_result($resaco,0,'c113_codlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($c113_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->c113_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c113_sequencial"])){ 
       $sql  .= $virgula." c113_sequencial = $this->c113_sequencial ";
       $virgula = ",";
       if(trim((string) $this->c113_sequencial) == null ){ 
     ...
     if(trim((string) $this->c113_reconhecimentocontabil)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c113_reconhecimentocontabil"])){ 
       $sql  .= $virgula." c113_reconhecimentocontabil = $this->c113_reconhecimentocontabil ";
       $virgula = ",";
       if(trim((string) $this->c113_reconhecimentocontabil) == null ){ 
         $this->erro_sql = " Campo Reconhecimento Contabil não informado.";
         $this->erro_campo = "c113_reconhecimentocontabil";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c113_codlan)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c113_codlan"])){ 
       $sql  .= $virgula." c113_codlan = $this->c113_codlan ";
       $virgula = ",";
       if(trim((string) $this->c113_codlan) == null ){ 
         $this->erro_sql = " Campo Código Lançamento não informado.";
         $this->erro_campo = "c113_codlan";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["c113_sequencial"]) || $this->c113_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3628,20207,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c113_sequencial'))."','$this->c113_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["c113_reconhecimentocontabil"]) || $this->c113_reconhecimentocontabil != "")
             $resac = db_query("insert into db_acount values($acount,3628,20209,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c113_reconhecimentocontabil'))."','$this->c113_reconhecimentocontabil',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["c113_codlan"]) || $this->c113_codlan != "")
             $resac = db_query("insert into db_acount values($acount,3628,20208,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c113_codlan'))."','$this->c113_codlan',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3628,20207,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c113_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3628,20209,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c113_reconhecimentocontabil'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3628,20208,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c113_codlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
