...
class cl_aguabasecar { 
   ...
   function incluir ($x30_matric,$x30_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1430,8427,'','".AddSlashes(pg_fetch_result($resaco,0,'x30_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1430,8428,'','".AddSlashes(pg_fetch_result($resaco,0,'x30_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($x30_matric=null,$x30_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->x30_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x30_codigo"])){ 
       $sql  .= $virgula." x30_codigo = $this->x30_codigo ";
       $virgula = ",";
       if(trim((string) $this->x30_codigo) == null ){ 
     ...
     if(trim((string) $this->x30_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x30_matric"])){ 
       $sql  .= $virgula." x30_matric = $this->x30_matric ";
       $virgula = ",";
       if(trim((string) $this->x30_matric) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x30_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1430,8427,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x30_codigo'))."','$this->x30_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x30_matric"]))
           $resac = db_query("insert into db_acount values($acount,1430,8428,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x30_matric'))."','$this->x30_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($x30_matric=null,$x30_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1430,8427,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x30_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1430,8428,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x30_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
