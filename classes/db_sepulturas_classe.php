...
class cl_sepulturas { 
   ...
   public $cm05_i_codigo = 0; 
   public $cm05_c_numero = null; 
   public $cm05_i_campa = 0; 
   public $cm05_i_lotecemit = 0; 
   ...
   function incluir ($cm05_i_codigo){ 
     ...
     if($cm05_i_codigo == "" || $cm05_i_codigo == null ){
       ...
       $this->cm05_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from sepulturas_cm05_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $cm05_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1802,10429,'','".AddSlashes(pg_fetch_result($resaco,0,'cm05_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1802,12079,'','".AddSlashes(pg_fetch_result($resaco,0,'cm05_c_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1802,10430,'','".AddSlashes(pg_fetch_result($resaco,0,'cm05_i_campa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1802,10431,'','".AddSlashes(pg_fetch_result($resaco,0,'cm05_i_lotecemit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($cm05_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->cm05_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm05_i_codigo"])){ 
       $sql  .= $virgula." cm05_i_codigo = $this->cm05_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->cm05_i_codigo) == null ){ 
     ...
     if(trim((string) $this->cm05_c_numero)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm05_c_numero"])){ 
       $sql  .= $virgula." cm05_c_numero = '$this->cm05_c_numero' ";
       $virgula = ",";
       if(trim((string) $this->cm05_c_numero) == null ){ 
         $this->erro_sql = " Campo Numero nao Informado.";
         $this->erro_campo = "cm05_c_numero";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cm05_i_campa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm05_i_campa"])){ 
       $sql  .= $virgula." cm05_i_campa = $this->cm05_i_campa ";
       $virgula = ",";
       if(trim((string) $this->cm05_i_campa) == null ){ 
         $this->erro_sql = " Campo Identificação da Campa nao Informado.";
         $this->erro_campo = "cm05_i_campa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cm05_i_lotecemit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm05_i_lotecemit"])){ 
       $sql  .= $virgula." cm05_i_lotecemit = $this->cm05_i_lotecemit ";
       $virgula = ",";
       if(trim((string) $this->cm05_i_lotecemit) == null ){ 
         $this->erro_sql = " Campo Lote Cemiterio nao Informado.";
         $this->erro_campo = "cm05_i_lotecemit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm05_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1802,10429,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm05_i_codigo'))."','$this->cm05_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm05_c_numero"]))
           $resac = db_query("insert into db_acount values($acount,1802,12079,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm05_c_numero'))."','$this->cm05_c_numero',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm05_i_campa"]))
           $resac = db_query("insert into db_acount values($acount,1802,10430,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm05_i_campa'))."','$this->cm05_i_campa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm05_i_lotecemit"]))
           $resac = db_query("insert into db_acount values($acount,1802,10431,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm05_i_lotecemit'))."','$this->cm05_i_lotecemit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($cm05_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1802,10429,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm05_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1802,12079,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm05_c_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1802,10430,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm05_i_campa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1802,10431,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm05_i_lotecemit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
