...
class cl_rhpesjustica { 
   ...
   public $rh61_codigo = 0; 
   public $rh61_regist = 0; 
   public $rh61_dataini_dia = null; 
   public $rh61_dataini_mes = null; 
   public $rh61_dataini_ano = null; 
   public $rh61_dataini = null; 
   public $rh61_datafim_dia = null; 
   public $rh61_datafim_mes = null; 
   public $rh61_datafim_ano = null; 
   public $rh61_datafim = null; 
   public $rh61_obs = null; 
   ...
   function incluir ($rh61_codigo){ 
     ...
     if($rh61_codigo == "" || $rh61_codigo == null ){
       ...
       $this->rh61_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhpesjustica_rh61_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh61_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1571,9180,'','".AddSlashes(pg_fetch_result($resaco,0,'rh61_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1571,9181,'','".AddSlashes(pg_fetch_result($resaco,0,'rh61_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1571,9182,'','".AddSlashes(pg_fetch_result($resaco,0,'rh61_dataini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1571,9183,'','".AddSlashes(pg_fetch_result($resaco,0,'rh61_datafim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1571,9184,'','".AddSlashes(pg_fetch_result($resaco,0,'rh61_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh61_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh61_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh61_codigo"])){ 
       $sql  .= $virgula." rh61_codigo = $this->rh61_codigo ";
       $virgula = ",";
       if(trim((string) $this->rh61_codigo) == null ){ 
     ...
     if(trim((string) $this->rh61_regist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh61_regist"])){ 
       $sql  .= $virgula." rh61_regist = $this->rh61_regist ";
       $virgula = ",";
       if(trim((string) $this->rh61_regist) == null ){ 
         $this->erro_sql = " Campo Matrícula do Servidor nao Informado.";
         $this->erro_campo = "rh61_regist";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh61_dataini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh61_dataini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["rh61_dataini_dia"] !="") ){ 
       $sql  .= $virgula." rh61_dataini = '$this->rh61_dataini' ";
       $virgula = ",";
       if(trim((string) $this->rh61_dataini) == null ){ 
         $this->erro_sql = " Campo Data inicial nao Informado.";
         $this->erro_campo = "rh61_dataini_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh61_datafim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh61_datafim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["rh61_datafim_dia"] !="") ){ 
       $sql  .= $virgula." rh61_datafim = '$this->rh61_datafim' ";
       $virgula = ",";
       if(trim((string) $this->rh61_datafim) == null ){ 
         $this->erro_sql = " Campo Data final nao Informado.";
         $this->erro_campo = "rh61_datafim_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh61_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh61_obs"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh61_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1571,9180,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh61_codigo'))."','$this->rh61_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh61_regist"]))
           $resac = db_query("insert into db_acount values($acount,1571,9181,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh61_regist'))."','$this->rh61_regist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh61_dataini"]))
           $resac = db_query("insert into db_acount values($acount,1571,9182,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh61_dataini'))."','$this->rh61_dataini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh61_datafim"]))
           $resac = db_query("insert into db_acount values($acount,1571,9183,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh61_datafim'))."','$this->rh61_datafim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh61_obs"]))
           $resac = db_query("insert into db_acount values($acount,1571,9184,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh61_obs'))."','$this->rh61_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh61_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1571,9180,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh61_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1571,9181,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh61_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1571,9182,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh61_dataini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1571,9183,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh61_datafim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1571,9184,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh61_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
