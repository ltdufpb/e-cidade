...
class cl_iptupadraoconstrpontos { 
   ...
   public $j118_sequencial = 0; 
   public $j118_iptupadraoconstr = 0; 
   public $j118_caracter = 0; 
   public $j118_pontosini = 0; 
   public $j118_pontosfim = 0; 
   public $j118_fatorreajuste = 0; 
   public $j118_anousu = 0; 
   ...
   function incluir ($j118_sequencial){ 
     ...
     if($j118_sequencial == "" || $j118_sequencial == null ){
       ...
       $this->j118_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from iptupadraoconstrpontos_j118_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $j118_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2673,15175,'','".AddSlashes(pg_fetch_result($resaco,0,'j118_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2673,15176,'','".AddSlashes(pg_fetch_result($resaco,0,'j118_iptupadraoconstr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2673,15177,'','".AddSlashes(pg_fetch_result($resaco,0,'j118_caracter'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2673,15178,'','".AddSlashes(pg_fetch_result($resaco,0,'j118_pontosini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2673,15179,'','".AddSlashes(pg_fetch_result($resaco,0,'j118_pontosfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2673,15180,'','".AddSlashes(pg_fetch_result($resaco,0,'j118_fatorreajuste'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2673,15181,'','".AddSlashes(pg_fetch_result($resaco,0,'j118_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j118_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j118_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j118_sequencial"])){ 
       $sql  .= $virgula." j118_sequencial = $this->j118_sequencial ";
       $virgula = ",";
       if(trim((string) $this->j118_sequencial) == null ){ 
     ...
     if(trim((string) $this->j118_iptupadraoconstr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j118_iptupadraoconstr"])){ 
       $sql  .= $virgula." j118_iptupadraoconstr = $this->j118_iptupadraoconstr ";
       $virgula = ",";
       if(trim((string) $this->j118_iptupadraoconstr) == null ){ 
         $this->erro_sql = " Campo Iptu Padrão Construção nao Informado.";
         $this->erro_campo = "j118_iptupadraoconstr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j118_caracter)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j118_caracter"])){ 
       $sql  .= $virgula." j118_caracter = $this->j118_caracter ";
       $virgula = ",";
       if(trim((string) $this->j118_caracter) == null ){ 
         $this->erro_sql = " Campo Caracter nao Informado.";
         $this->erro_campo = "j118_caracter";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j118_pontosini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j118_pontosini"])){ 
       $sql  .= $virgula." j118_pontosini = $this->j118_pontosini ";
       $virgula = ",";
       if(trim((string) $this->j118_pontosini) == null ){ 
         $this->erro_sql = " Campo Ponto Inicial nao Informado.";
         $this->erro_campo = "j118_pontosini";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j118_pontosfim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j118_pontosfim"])){ 
       $sql  .= $virgula." j118_pontosfim = $this->j118_pontosfim ";
       $virgula = ",";
       if(trim((string) $this->j118_pontosfim) == null ){ 
         $this->erro_sql = " Campo Ponto Final nao Informado.";
         $this->erro_campo = "j118_pontosfim";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j118_fatorreajuste)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j118_fatorreajuste"])){ 
       $sql  .= $virgula." j118_fatorreajuste = $this->j118_fatorreajuste ";
       $virgula = ",";
       if(trim((string) $this->j118_fatorreajuste) == null ){ 
         $this->erro_sql = " Campo Fator Reajuste nao Informado.";
         $this->erro_campo = "j118_fatorreajuste";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j118_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j118_anousu"])){ 
       $sql  .= $virgula." j118_anousu = $this->j118_anousu ";
       $virgula = ",";
       if(trim((string) $this->j118_anousu) == null ){ 
         $this->erro_sql = " Campo Ano nao Informado.";
         $this->erro_campo = "j118_anousu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j118_sequencial"]) || $this->j118_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2673,15175,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j118_sequencial'))."','$this->j118_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j118_iptupadraoconstr"]) || $this->j118_iptupadraoconstr != "")
           $resac = db_query("insert into db_acount values($acount,2673,15176,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j118_iptupadraoconstr'))."','$this->j118_iptupadraoconstr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j118_caracter"]) || $this->j118_caracter != "")
           $resac = db_query("insert into db_acount values($acount,2673,15177,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j118_caracter'))."','$this->j118_caracter',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j118_pontosini"]) || $this->j118_pontosini != "")
           $resac = db_query("insert into db_acount values($acount,2673,15178,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j118_pontosini'))."','$this->j118_pontosini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j118_pontosfim"]) || $this->j118_pontosfim != "")
           $resac = db_query("insert into db_acount values($acount,2673,15179,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j118_pontosfim'))."','$this->j118_pontosfim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j118_fatorreajuste"]) || $this->j118_fatorreajuste != "")
           $resac = db_query("insert into db_acount values($acount,2673,15180,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j118_fatorreajuste'))."','$this->j118_fatorreajuste',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j118_anousu"]) || $this->j118_anousu != "")
           $resac = db_query("insert into db_acount values($acount,2673,15181,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j118_anousu'))."','$this->j118_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j118_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2673,15175,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j118_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2673,15176,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j118_iptupadraoconstr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2673,15177,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j118_caracter'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2673,15178,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j118_pontosini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2673,15179,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j118_pontosfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2673,15180,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j118_fatorreajuste'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2673,15181,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j118_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
