...
class cl_situacao { 
   ...
   function incluir ($v52_codsit){ 
     ...
     if($v52_codsit == "" || $v52_codsit == null ){
       ...
       $this->v52_codsit = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from situacao_v52_codsit_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $v52_codsit)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,313,1884,'','".AddSlashes(pg_fetch_result($resaco,0,'v52_codsit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,313,1885,'','".AddSlashes(pg_fetch_result($resaco,0,'v52_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,313,14052,'','".AddSlashes(pg_fetch_result($resaco,0,'v52_tpsit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($v52_codsit=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->v52_codsit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v52_codsit"])){ 
       $sql  .= $virgula." v52_codsit = $this->v52_codsit ";
       $virgula = ",";
       if(trim((string) $this->v52_codsit) == null ){ 
     ...
     if(trim((string) $this->v52_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v52_descr"])){ 
       $sql  .= $virgula." v52_descr = '$this->v52_descr' ";
       $virgula = ",";
       if(trim((string) $this->v52_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "v52_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->v52_tpsit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v52_tpsit"])){ 
       $sql  .= $virgula." v52_tpsit = $this->v52_tpsit ";
       $virgula = ",";
       if(trim((string) $this->v52_tpsit) == null ){ 
         $this->erro_sql = " Campo Tipo da Situação nao Informado.";
         $this->erro_campo = "v52_tpsit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v52_codsit"]) || $this->v52_codsit != "")
           $resac = db_query("insert into db_acount values($acount,313,1884,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v52_codsit'))."','$this->v52_codsit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v52_descr"]) || $this->v52_descr != "")
           $resac = db_query("insert into db_acount values($acount,313,1885,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v52_descr'))."','$this->v52_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v52_tpsit"]) || $this->v52_tpsit != "")
           $resac = db_query("insert into db_acount values($acount,313,14052,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v52_tpsit'))."','$this->v52_tpsit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($v52_codsit=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,313,1884,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v52_codsit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,313,1885,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v52_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,313,14052,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v52_tpsit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
