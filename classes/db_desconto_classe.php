...
class cl_desconto { 
   ...
   public $r27_anousu = 0; 
   public $r27_mesusu = 0; 
   public $r27_codigo = null; 
   public $r27_descr = null; 
   public $r27_valor = 0; 
   ...
   function incluir ($r27_anousu,$r27_mesusu,$r27_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,545,3880,'','".AddSlashes(pg_fetch_result($resaco,0,'r27_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,545,3881,'','".AddSlashes(pg_fetch_result($resaco,0,'r27_mesusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,545,3882,'','".AddSlashes(pg_fetch_result($resaco,0,'r27_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,545,3883,'','".AddSlashes(pg_fetch_result($resaco,0,'r27_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,545,3884,'','".AddSlashes(pg_fetch_result($resaco,0,'r27_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($r27_anousu=null,$r27_mesusu=null,$r27_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->r27_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r27_anousu"])){ 
       $sql  .= $virgula." r27_anousu = $this->r27_anousu ";
       $virgula = ",";
       if(trim((string) $this->r27_anousu) == null ){ 
     ...
     if(trim((string) $this->r27_mesusu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r27_mesusu"])){ 
       $sql  .= $virgula." r27_mesusu = $this->r27_mesusu ";
       $virgula = ",";
       if(trim((string) $this->r27_mesusu) == null ){ 
     ...
     if(trim((string) $this->r27_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r27_codigo"])){ 
       $sql  .= $virgula." r27_codigo = '$this->r27_codigo' ";
       $virgula = ",";
       if(trim((string) $this->r27_codigo) == null ){ 
     ...
     if(trim((string) $this->r27_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r27_descr"])){ 
       $sql  .= $virgula." r27_descr = '$this->r27_descr' ";
       $virgula = ",";
       if(trim((string) $this->r27_descr) == null ){ 
         $this->erro_sql = " Campo Descrição do Desconto nao Informado.";
         $this->erro_campo = "r27_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->r27_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r27_valor"])){ 
       $sql  .= $virgula." r27_valor = $this->r27_valor ";
       $virgula = ",";
       if(trim((string) $this->r27_valor) == null ){ 
         $this->erro_sql = " Campo Valor do Desconto nao Informado.";
         $this->erro_campo = "r27_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["r27_anousu"]))
           $resac = db_query("insert into db_acount values($acount,545,3880,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r27_anousu'))."','$this->r27_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r27_mesusu"]))
           $resac = db_query("insert into db_acount values($acount,545,3881,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r27_mesusu'))."','$this->r27_mesusu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r27_codigo"]))
           $resac = db_query("insert into db_acount values($acount,545,3882,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r27_codigo'))."','$this->r27_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r27_descr"]))
           $resac = db_query("insert into db_acount values($acount,545,3883,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r27_descr'))."','$this->r27_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r27_valor"]))
           $resac = db_query("insert into db_acount values($acount,545,3884,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r27_valor'))."','$this->r27_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($r27_anousu=null,$r27_mesusu=null,$r27_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,545,3880,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r27_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,545,3881,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r27_mesusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,545,3882,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r27_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,545,3883,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r27_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,545,3884,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r27_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
