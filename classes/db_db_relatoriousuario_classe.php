...
class cl_db_relatoriousuario { 
   ...
   function incluir ($db09_sequencial){ 
     ...
     if($db09_sequencial == "" || $db09_sequencial == null ){
       ...
       $this->db09_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_relatoriousuario_db09_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db09_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2132,12265,'','".AddSlashes(pg_fetch_result($resaco,0,'db09_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2132,12276,'','".AddSlashes(pg_fetch_result($resaco,0,'db09_db_relatorio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2132,12278,'','".AddSlashes(pg_fetch_result($resaco,0,'db09_db_usuarios'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db09_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db09_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db09_sequencial"])){ 
       $sql  .= $virgula." db09_sequencial = $this->db09_sequencial ";
       $virgula = ",";
       if(trim((string) $this->db09_sequencial) == null ){ 
     ...
     if(trim((string) $this->db09_db_relatorio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db09_db_relatorio"])){ 
       $sql  .= $virgula." db09_db_relatorio = $this->db09_db_relatorio ";
       $virgula = ",";
       if(trim((string) $this->db09_db_relatorio) == null ){ 
         $this->erro_sql = " Campo Relatório usuário nao Informado.";
         $this->erro_campo = "db09_db_relatorio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db09_db_usuarios)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db09_db_usuarios"])){ 
       $sql  .= $virgula." db09_db_usuarios = $this->db09_db_usuarios ";
       $virgula = ",";
       if(trim((string) $this->db09_db_usuarios) == null ){ 
         $this->erro_sql = " Campo ID do usuário nao Informado.";
         $this->erro_campo = "db09_db_usuarios";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db09_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2132,12265,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db09_sequencial'))."','$this->db09_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db09_db_relatorio"]))
           $resac = db_query("insert into db_acount values($acount,2132,12276,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db09_db_relatorio'))."','$this->db09_db_relatorio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db09_db_usuarios"]))
           $resac = db_query("insert into db_acount values($acount,2132,12278,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db09_db_usuarios'))."','$this->db09_db_usuarios',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db09_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2132,12265,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db09_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2132,12276,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db09_db_relatorio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2132,12278,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db09_db_usuarios'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
