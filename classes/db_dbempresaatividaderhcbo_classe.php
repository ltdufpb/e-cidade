...
class cl_dbempresaatividaderhcbo { 
   ...
   public $q59_sequencial = 0; 
   public $q59_dbempresaatividade = 0; 
   public $q59_rhcbo = 0; 
   ...
   function incluir ($q59_sequencial){ 
     ...
     if($q59_sequencial == "" || $q59_sequencial == null ){
       ...
       $this->q59_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from dbempresaatividaderhcbo_q59_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q59_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1762,10224,'','".AddSlashes(pg_fetch_result($resaco,0,'q59_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1762,10225,'','".AddSlashes(pg_fetch_result($resaco,0,'q59_dbempresaatividade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1762,10226,'','".AddSlashes(pg_fetch_result($resaco,0,'q59_rhcbo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q59_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q59_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q59_sequencial"])){ 
       $sql  .= $virgula." q59_sequencial = $this->q59_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q59_sequencial) == null ){ 
     ...
     if(trim((string) $this->q59_dbempresaatividade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q59_dbempresaatividade"])){ 
       $sql  .= $virgula." q59_dbempresaatividade = $this->q59_dbempresaatividade ";
       $virgula = ",";
       if(trim((string) $this->q59_dbempresaatividade) == null ){ 
         $this->erro_sql = " Campo Código atividade empresa nao Informado.";
         $this->erro_campo = "q59_dbempresaatividade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q59_rhcbo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q59_rhcbo"])){ 
       $sql  .= $virgula." q59_rhcbo = $this->q59_rhcbo ";
       $virgula = ",";
       if(trim((string) $this->q59_rhcbo) == null ){ 
         $this->erro_sql = " Campo Código CBO nao Informado.";
         $this->erro_campo = "q59_rhcbo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q59_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1762,10224,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q59_sequencial'))."','$this->q59_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q59_dbempresaatividade"]))
           $resac = db_query("insert into db_acount values($acount,1762,10225,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q59_dbempresaatividade'))."','$this->q59_dbempresaatividade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q59_rhcbo"]))
           $resac = db_query("insert into db_acount values($acount,1762,10226,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q59_rhcbo'))."','$this->q59_rhcbo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q59_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1762,10224,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q59_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1762,10225,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q59_dbempresaatividade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1762,10226,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q59_rhcbo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
