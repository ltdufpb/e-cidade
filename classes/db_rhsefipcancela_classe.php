...
class cl_rhsefipcancela { 
   ...
   public $rh91_sequencial = 0; 
   public $rh91_rhsefip = 0; 
   public $rh91_id_usuario = 0; 
   public $rh91_data_dia = null; 
   public $rh91_data_mes = null; 
   public $rh91_data_ano = null; 
   public $rh91_data = null; 
   public $rh91_hora = null; 
   public $rh91_obs = null; 
   ...
   function incluir ($rh91_sequencial){ 
     ...
     if($rh91_sequencial == "" || $rh91_sequencial == null ){
       ...
       $this->rh91_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhsefipcancela_rh91_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh91_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3099,17548,'','".AddSlashes(pg_fetch_result($resaco,0,'rh91_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3099,17549,'','".AddSlashes(pg_fetch_result($resaco,0,'rh91_rhsefip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3099,17550,'','".AddSlashes(pg_fetch_result($resaco,0,'rh91_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3099,17551,'','".AddSlashes(pg_fetch_result($resaco,0,'rh91_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3099,17552,'','".AddSlashes(pg_fetch_result($resaco,0,'rh91_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3099,17553,'','".AddSlashes(pg_fetch_result($resaco,0,'rh91_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh91_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh91_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh91_sequencial"])){ 
       $sql  .= $virgula." rh91_sequencial = $this->rh91_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh91_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh91_rhsefip)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh91_rhsefip"])){ 
       $sql  .= $virgula." rh91_rhsefip = $this->rh91_rhsefip ";
       $virgula = ",";
       if(trim((string) $this->rh91_rhsefip) == null ){ 
         $this->erro_sql = " Campo Geração da SEFIP nao Informado.";
         $this->erro_campo = "rh91_rhsefip";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh91_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh91_id_usuario"])){ 
       $sql  .= $virgula." rh91_id_usuario = $this->rh91_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->rh91_id_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "rh91_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh91_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh91_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["rh91_data_dia"] !="") ){ 
       $sql  .= $virgula." rh91_data = '$this->rh91_data' ";
       $virgula = ",";
       if(trim((string) $this->rh91_data) == null ){ 
         $this->erro_sql = " Campo Data Cancelamento nao Informado.";
         $this->erro_campo = "rh91_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh91_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh91_hora"])){ 
       $sql  .= $virgula." rh91_hora = '$this->rh91_hora' ";
       $virgula = ",";
       if(trim((string) $this->rh91_hora) == null ){ 
         $this->erro_sql = " Campo Hora Cancelamento nao Informado.";
         $this->erro_campo = "rh91_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh91_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh91_obs"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh91_sequencial"]) || $this->rh91_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3099,17548,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh91_sequencial'))."','$this->rh91_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh91_rhsefip"]) || $this->rh91_rhsefip != "")
           $resac = db_query("insert into db_acount values($acount,3099,17549,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh91_rhsefip'))."','$this->rh91_rhsefip',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh91_id_usuario"]) || $this->rh91_id_usuario != "")
           $resac = db_query("insert into db_acount values($acount,3099,17550,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh91_id_usuario'))."','$this->rh91_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh91_data"]) || $this->rh91_data != "")
           $resac = db_query("insert into db_acount values($acount,3099,17551,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh91_data'))."','$this->rh91_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh91_hora"]) || $this->rh91_hora != "")
           $resac = db_query("insert into db_acount values($acount,3099,17552,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh91_hora'))."','$this->rh91_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh91_obs"]) || $this->rh91_obs != "")
           $resac = db_query("insert into db_acount values($acount,3099,17553,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh91_obs'))."','$this->rh91_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh91_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3099,17548,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh91_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3099,17549,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh91_rhsefip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3099,17550,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh91_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3099,17551,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh91_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3099,17552,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh91_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3099,17553,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh91_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
