...
class cl_mer_modpreparo { 
   ...
   public $me05_i_codigo        = 0; 
   public $me05_f_porcao        = 0; 
   public $me05_c_natureza        = null; 
   public $me05_t_obs        = null; 
   public $me05_i_cardapio        = 0; 
   public $me05_i_alimento        = 0; 
   ...
   function incluir ($me05_i_codigo){ 
     ...
     if($me05_i_codigo == "" || $me05_i_codigo == null ){
       ...
       $this->me05_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mermodpreparo_me05_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $me05_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2237,12770,'','".AddSlashes(pg_fetch_result($resaco,0,'me05_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2237,12771,'','".AddSlashes(pg_fetch_result($resaco,0,'me05_f_porcao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2237,12772,'','".AddSlashes(pg_fetch_result($resaco,0,'me05_c_natureza'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2237,12774,'','".AddSlashes(pg_fetch_result($resaco,0,'me05_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2237,12775,'','".AddSlashes(pg_fetch_result($resaco,0,'me05_i_cardapio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2237,17408,'','".AddSlashes(pg_fetch_result($resaco,0,'me05_i_alimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me05_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->me05_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me05_i_codigo"])){ 
       $sql  .= $virgula." me05_i_codigo = $this->me05_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->me05_i_codigo) == null ){ 
     ...
     if(trim((string) $this->me05_f_porcao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me05_f_porcao"])){ 
       $sql  .= $virgula." me05_f_porcao = $this->me05_f_porcao ";
       $virgula = ",";
       if(trim((string) $this->me05_f_porcao) == null ){ 
         $this->erro_sql = " Campo Porção nao Informado.";
         $this->erro_campo = "me05_f_porcao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me05_c_natureza)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me05_c_natureza"])){ 
       $sql  .= $virgula." me05_c_natureza = '$this->me05_c_natureza' ";
       $virgula = ",";
       if(trim((string) $this->me05_c_natureza) == null ){ 
         $this->erro_sql = " Campo Natureza nao Informado.";
         $this->erro_campo = "me05_c_natureza";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me05_t_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me05_t_obs"])){ 
       $sql  .= $virgula." me05_t_obs = '$this->me05_t_obs' ";
       $virgula = ",";
       if(trim((string) $this->me05_t_obs) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "me05_t_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me05_i_cardapio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me05_i_cardapio"])){ 
       $sql  .= $virgula." me05_i_cardapio = $this->me05_i_cardapio ";
       $virgula = ",";
       if(trim((string) $this->me05_i_cardapio) == null ){ 
         $this->erro_sql = " Campo Refeição nao Informado.";
         $this->erro_campo = "me05_i_cardapio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me05_i_alimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me05_i_alimento"])){ 
       $sql  .= $virgula." me05_i_alimento = $this->me05_i_alimento ";
       $virgula = ",";
       if(trim((string) $this->me05_i_alimento) == null ){ 
         $this->erro_sql = " Campo Alimento nao Informado.";
         $this->erro_campo = "me05_i_alimento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me05_i_codigo"]) || $this->me05_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2237,12770,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me05_i_codigo'))."','$this->me05_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me05_f_porcao"]) || $this->me05_f_porcao != "")
           $resac = db_query("insert into db_acount values($acount,2237,12771,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me05_f_porcao'))."','$this->me05_f_porcao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me05_c_natureza"]) || $this->me05_c_natureza != "")
           $resac = db_query("insert into db_acount values($acount,2237,12772,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me05_c_natureza'))."','$this->me05_c_natureza',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me05_t_obs"]) || $this->me05_t_obs != "")
           $resac = db_query("insert into db_acount values($acount,2237,12774,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me05_t_obs'))."','$this->me05_t_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me05_i_cardapio"]) || $this->me05_i_cardapio != "")
           $resac = db_query("insert into db_acount values($acount,2237,12775,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me05_i_cardapio'))."','$this->me05_i_cardapio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me05_i_alimento"]) || $this->me05_i_alimento != "")
           $resac = db_query("insert into db_acount values($acount,2237,17408,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me05_i_alimento'))."','$this->me05_i_alimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me05_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2237,12770,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me05_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2237,12771,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me05_f_porcao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2237,12772,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me05_c_natureza'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2237,12774,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me05_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2237,12775,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me05_i_cardapio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2237,17408,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me05_i_alimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
