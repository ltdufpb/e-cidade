...
class cl_atojustificativa { 
   ...
   function incluir ($ed07_i_codigo){ 
     ...
     if($ed07_i_codigo == "" || $ed07_i_codigo == null ){
       ...
       $this->ed07_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from atojustificativa_ed07_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed07_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010035,1008226,'','".AddSlashes(pg_fetch_result($resaco,0,'ed07_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010035,1008227,'','".AddSlashes(pg_fetch_result($resaco,0,'ed07_i_ato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010035,1008228,'','".AddSlashes(pg_fetch_result($resaco,0,'ed07_i_justificativa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed07_i_codigo=null) { 
     ...
     if(trim((string) $this->ed07_i_ato)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed07_i_ato"])){ 
       $sql  .= $virgula." ed07_i_ato = $this->ed07_i_ato ";
       $virgula = ",";
       if(trim((string) $this->ed07_i_ato) == null ){ 
         $this->erro_sql = " Campo Ato Legal nao Informado.";
         $this->erro_campo = "ed07_i_ato";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed07_i_justificativa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed07_i_justificativa"])){ 
       $sql  .= $virgula." ed07_i_justificativa = $this->ed07_i_justificativa ";
       $virgula = ",";
       if(trim((string) $this->ed07_i_justificativa) == null ){ 
         $this->erro_sql = " Campo Justificativa nao Informado.";
         $this->erro_campo = "ed07_i_justificativa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed07_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010035,1008226,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed07_i_codigo'))."','$this->ed07_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed07_i_ato"]))
           $resac = db_query("insert into db_acount values($acount,1010035,1008227,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed07_i_ato'))."','$this->ed07_i_ato',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed07_i_justificativa"]))
           $resac = db_query("insert into db_acount values($acount,1010035,1008228,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed07_i_justificativa'))."','$this->ed07_i_justificativa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed07_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010035,1008226,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed07_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010035,1008227,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed07_i_ato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010035,1008228,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed07_i_justificativa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
