...
class cl_slipoperacaotipovinculo { 
   ...
   public $k153_slip = 0; 
   public $k153_slipoperacaotipo = 0; 
   ...
   function incluir ($k153_slip){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3417,19237,'','".AddSlashes(pg_fetch_result($resaco,0,'k153_slip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3417,19238,'','".AddSlashes(pg_fetch_result($resaco,0,'k153_slipoperacaotipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k153_slip=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k153_slip)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k153_slip"])){ 
       $sql  .= $virgula." k153_slip = $this->k153_slip ";
       $virgula = ",";
       if(trim((string) $this->k153_slip) == null ){ 
     ...
     if(trim((string) $this->k153_slipoperacaotipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k153_slipoperacaotipo"])){ 
       $sql  .= $virgula." k153_slipoperacaotipo = $this->k153_slipoperacaotipo ";
       $virgula = ",";
       if(trim((string) $this->k153_slipoperacaotipo) == null ){ 
         $this->erro_sql = " Campo Tipo de Operação nao Informado.";
         $this->erro_campo = "k153_slipoperacaotipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k153_slip"]) || $this->k153_slip != "")
           $resac = db_query("insert into db_acount values($acount,3417,19237,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k153_slip'))."','$this->k153_slip',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k153_slipoperacaotipo"]) || $this->k153_slipoperacaotipo != "")
           $resac = db_query("insert into db_acount values($acount,3417,19238,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k153_slipoperacaotipo'))."','$this->k153_slipoperacaotipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k153_slip=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3417,19237,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k153_slip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3417,19238,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k153_slipoperacaotipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
