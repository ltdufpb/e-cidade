...
class cl_benscedente { 
   ...
   public $t09_sequencial = 0; 
   public $t09_benscadcedente = 0; 
   public $t09_bem = 0; 
   ...
   function incluir ($t09_sequencial){ 
     ...
     if($t09_sequencial == "" || $t09_sequencial == null ){
       ...
       $this->t09_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from benscedente_t09_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $t09_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2497,14195,'','".AddSlashes(pg_fetch_result($resaco,0,'t09_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2497,14196,'','".AddSlashes(pg_fetch_result($resaco,0,'t09_benscadcedente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2497,14197,'','".AddSlashes(pg_fetch_result($resaco,0,'t09_bem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($t09_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->t09_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t09_sequencial"])){ 
       $sql  .= $virgula." t09_sequencial = $this->t09_sequencial ";
       $virgula = ",";
       if(trim((string) $this->t09_sequencial) == null ){ 
     ...
     if(trim((string) $this->t09_benscadcedente)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t09_benscadcedente"])){ 
       $sql  .= $virgula." t09_benscadcedente = $this->t09_benscadcedente ";
       $virgula = ",";
       if(trim((string) $this->t09_benscadcedente) == null ){ 
         $this->erro_sql = " Campo Código Cedente nao Informado.";
         $this->erro_campo = "t09_benscadcedente";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->t09_bem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t09_bem"])){ 
       $sql  .= $virgula." t09_bem = $this->t09_bem ";
       $virgula = ",";
       if(trim((string) $this->t09_bem) == null ){ 
         $this->erro_sql = " Campo Código do Bem nao Informado.";
         $this->erro_campo = "t09_bem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["t09_sequencial"]) || $this->t09_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2497,14195,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t09_sequencial'))."','$this->t09_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t09_benscadcedente"]) || $this->t09_benscadcedente != "")
           $resac = db_query("insert into db_acount values($acount,2497,14196,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t09_benscadcedente'))."','$this->t09_benscadcedente',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t09_bem"]) || $this->t09_bem != "")
           $resac = db_query("insert into db_acount values($acount,2497,14197,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t09_bem'))."','$this->t09_bem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($t09_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2497,14195,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t09_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2497,14196,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t09_benscadcedente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2497,14197,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t09_bem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
