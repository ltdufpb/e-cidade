...
class cl_orcimpactotiporec { 
   ...
   function incluir ($o93_codseqimp,$o93_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1092,6650,'','".AddSlashes(pg_fetch_result($resaco,0,'o93_codseqimp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1092,6651,'','".AddSlashes(pg_fetch_result($resaco,0,'o93_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o93_codseqimp=null,$o93_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o93_codseqimp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o93_codseqimp"])){ 
       $sql  .= $virgula." o93_codseqimp = $this->o93_codseqimp ";
       $virgula = ",";
       if(trim((string) $this->o93_codseqimp) == null ){ 
     ...
     if(trim((string) $this->o93_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o93_codigo"])){ 
       $sql  .= $virgula." o93_codigo = $this->o93_codigo ";
       $virgula = ",";
       if(trim((string) $this->o93_codigo) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o93_codseqimp"]))
           $resac = db_query("insert into db_acount values($acount,1092,6650,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o93_codseqimp'))."','$this->o93_codseqimp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o93_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1092,6651,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o93_codigo'))."','$this->o93_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o93_codseqimp=null,$o93_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1092,6650,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o93_codseqimp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1092,6651,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o93_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
