...
class cl_sau_vinculosus { 
   ...
   public $sd50_i_codigo = 0; 
   public $sd50_i_unidade = 0; 
   public $sd50_v_banco = null; 
   public $sd50_v_agencia = null; 
   public $sd50_v_cc = null; 
   public $sd50_v_contratosus = null; 
   public $sd50_d_publicacao_dia = null; 
   public $sd50_d_publicacao_mes = null; 
   public $sd50_d_publicacao_ano = null; 
   public $sd50_d_publicacao = null; 
   public $sd50_v_contratosus2 = null; 
   public $sd50_d_publicacao2_dia = null; 
   public $sd50_d_publicacao2_mes = null; 
   public $sd50_d_publicacao2_ano = null; 
   public $sd50_d_publicacao2 = null; 
   ...
   function incluir ($sd50_i_codigo){ 
     ...
     if($sd50_i_codigo == "" || $sd50_i_codigo == null ){
       ...
       $this->sd50_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from sau_vinculosus_sd50_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $sd50_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1967,11436,'','".AddSlashes(pg_fetch_result($resaco,0,'sd50_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1967,11437,'','".AddSlashes(pg_fetch_result($resaco,0,'sd50_i_unidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1967,11438,'','".AddSlashes(pg_fetch_result($resaco,0,'sd50_v_banco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1967,11439,'','".AddSlashes(pg_fetch_result($resaco,0,'sd50_v_agencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1967,11440,'','".AddSlashes(pg_fetch_result($resaco,0,'sd50_v_cc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1967,11441,'','".AddSlashes(pg_fetch_result($resaco,0,'sd50_v_contratosus'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1967,11442,'','".AddSlashes(pg_fetch_result($resaco,0,'sd50_d_publicacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1967,11443,'','".AddSlashes(pg_fetch_result($resaco,0,'sd50_v_contratosus2'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1967,11444,'','".AddSlashes(pg_fetch_result($resaco,0,'sd50_d_publicacao2'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd50_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd50_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd50_i_codigo"])){ 
       $sql  .= $virgula." sd50_i_codigo = $this->sd50_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->sd50_i_codigo) == null ){ 
     ...
     if(trim((string) $this->sd50_i_unidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd50_i_unidade"])){ 
       $sql  .= $virgula." sd50_i_unidade = $this->sd50_i_unidade ";
       $virgula = ",";
       if(trim((string) $this->sd50_i_unidade) == null ){ 
         $this->erro_sql = " Campo Unidade nao Informado.";
         $this->erro_campo = "sd50_i_unidade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd50_v_banco)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd50_v_banco"])){ 
       $sql  .= $virgula." sd50_v_banco = '$this->sd50_v_banco' ";
       $virgula = ",";
     }
     if(trim((string) $this->sd50_v_agencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd50_v_agencia"])){ 
       $sql  .= $virgula." sd50_v_agencia = '$this->sd50_v_agencia' ";
       $virgula = ",";
     }
     if(trim((string) $this->sd50_v_cc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd50_v_cc"])){ 
       $sql  .= $virgula." sd50_v_cc = '$this->sd50_v_cc' ";
       $virgula = ",";
     }
     if(trim((string) $this->sd50_v_contratosus)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd50_v_contratosus"])){ 
       $sql  .= $virgula." sd50_v_contratosus = '$this->sd50_v_contratosus' ";
       $virgula = ",";
     }
     if(trim((string) $this->sd50_d_publicacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd50_d_publicacao_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["sd50_d_publicacao_dia"] !="") ){ 
     ...
     if(trim((string) $this->sd50_v_contratosus2)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd50_v_contratosus2"])){ 
       $sql  .= $virgula." sd50_v_contratosus2 = '$this->sd50_v_contratosus2' ";
       $virgula = ",";
     }
     if(trim((string) $this->sd50_d_publicacao2)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd50_d_publicacao2_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["sd50_d_publicacao2_dia"] !="") ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd50_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1967,11436,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd50_i_codigo'))."','$this->sd50_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd50_i_unidade"]))
           $resac = db_query("insert into db_acount values($acount,1967,11437,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd50_i_unidade'))."','$this->sd50_i_unidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd50_v_banco"]))
           $resac = db_query("insert into db_acount values($acount,1967,11438,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd50_v_banco'))."','$this->sd50_v_banco',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd50_v_agencia"]))
           $resac = db_query("insert into db_acount values($acount,1967,11439,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd50_v_agencia'))."','$this->sd50_v_agencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd50_v_cc"]))
           $resac = db_query("insert into db_acount values($acount,1967,11440,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd50_v_cc'))."','$this->sd50_v_cc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd50_v_contratosus"]))
           $resac = db_query("insert into db_acount values($acount,1967,11441,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd50_v_contratosus'))."','$this->sd50_v_contratosus',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd50_d_publicacao"]))
           $resac = db_query("insert into db_acount values($acount,1967,11442,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd50_d_publicacao'))."','$this->sd50_d_publicacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd50_v_contratosus2"]))
           $resac = db_query("insert into db_acount values($acount,1967,11443,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd50_v_contratosus2'))."','$this->sd50_v_contratosus2',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd50_d_publicacao2"]))
           $resac = db_query("insert into db_acount values($acount,1967,11444,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd50_d_publicacao2'))."','$this->sd50_d_publicacao2',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd50_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1967,11436,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd50_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1967,11437,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd50_i_unidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1967,11438,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd50_v_banco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1967,11439,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd50_v_agencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1967,11440,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd50_v_cc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1967,11441,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd50_v_contratosus'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1967,11442,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd50_d_publicacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1967,11443,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd50_v_contratosus2'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1967,11444,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd50_d_publicacao2'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
