...
class cl_progressaoparcialalunoresultadofinal { 
   ...
   public $ed121_sequencial = 0; 
   public $ed121_progressaoparcialalunomatricula = 0; 
   public $ed121_nota = null; 
   public $ed121_faltas = 0; 
   public $ed121_resultadofinal = null; 
   ...
   function incluir ($ed121_sequencial){ 
     ...
     if($ed121_sequencial == "" || $ed121_sequencial == null ){
       ...
       $this->ed121_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from progressaoparcialalunoresultadofinal_ed121_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed121_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3483,19601,'','".AddSlashes(pg_fetch_result($resaco,0,'ed121_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3483,19602,'','".AddSlashes(pg_fetch_result($resaco,0,'ed121_progressaoparcialalunomatricula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3483,19603,'','".AddSlashes(pg_fetch_result($resaco,0,'ed121_nota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3483,19604,'','".AddSlashes(pg_fetch_result($resaco,0,'ed121_faltas'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3483,19605,'','".AddSlashes(pg_fetch_result($resaco,0,'ed121_resultadofinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed121_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed121_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed121_sequencial"])){ 
       $sql  .= $virgula." ed121_sequencial = $this->ed121_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed121_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed121_progressaoparcialalunomatricula)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed121_progressaoparcialalunomatricula"])){ 
       $sql  .= $virgula." ed121_progressaoparcialalunomatricula = $this->ed121_progressaoparcialalunomatricula ";
       $virgula = ",";
       if(trim((string) $this->ed121_progressaoparcialalunomatricula) == null ){ 
         $this->erro_sql = " Campo Matricula Progressão Parcial nao Informado.";
         $this->erro_campo = "ed121_progressaoparcialalunomatricula";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed121_nota)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed121_nota"])){ 
       $sql  .= $virgula." ed121_nota = '$this->ed121_nota' ";
       $virgula = ",";
     }
     if(trim((string) $this->ed121_faltas)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed121_faltas"])){ 
        if(trim((string) $this->ed121_faltas)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed121_faltas"])){ 
           $this->ed121_faltas = "0" ; 
        } 
     ...
     if(trim((string) $this->ed121_resultadofinal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed121_resultadofinal"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed121_sequencial"]) || $this->ed121_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3483,19601,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed121_sequencial'))."','$this->ed121_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed121_progressaoparcialalunomatricula"]) || $this->ed121_progressaoparcialalunomatricula != "")
           $resac = db_query("insert into db_acount values($acount,3483,19602,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed121_progressaoparcialalunomatricula'))."','$this->ed121_progressaoparcialalunomatricula',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed121_nota"]) || $this->ed121_nota != "")
           $resac = db_query("insert into db_acount values($acount,3483,19603,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed121_nota'))."','$this->ed121_nota',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed121_faltas"]) || $this->ed121_faltas != "")
           $resac = db_query("insert into db_acount values($acount,3483,19604,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed121_faltas'))."','$this->ed121_faltas',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed121_resultadofinal"]) || $this->ed121_resultadofinal != "")
           $resac = db_query("insert into db_acount values($acount,3483,19605,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed121_resultadofinal'))."','$this->ed121_resultadofinal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed121_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3483,19601,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed121_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3483,19602,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed121_progressaoparcialalunomatricula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3483,19603,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed121_nota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3483,19604,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed121_faltas'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3483,19605,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed121_resultadofinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
