...
class cl_pccontrdep { 
   ...
   function incluir ($p74_codcontr){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,985,6122,'','".AddSlashes(pg_fetch_result($resaco,0,'p74_codcontr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,985,6123,'','".AddSlashes(pg_fetch_result($resaco,0,'p74_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,985,6124,'','".AddSlashes(pg_fetch_result($resaco,0,'p74_perc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($p74_codcontr=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->p74_codcontr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["p74_codcontr"])){ 
       $sql  .= $virgula." p74_codcontr = $this->p74_codcontr ";
       $virgula = ",";
       if(trim((string) $this->p74_codcontr) == null ){ 
     ...
     if(trim((string) $this->p74_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["p74_valor"])){ 
       $sql  .= $virgula." p74_valor = $this->p74_valor ";
       $virgula = ",";
       if(trim((string) $this->p74_valor) == null ){ 
         $this->erro_sql = " Campo Valor aditivo nao Informado.";
         $this->erro_campo = "p74_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->p74_perc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["p74_perc"])){ 
       $sql  .= $virgula." p74_perc = $this->p74_perc ";
       $virgula = ",";
       if(trim((string) $this->p74_perc) == null ){ 
         $this->erro_sql = " Campo Percentual aditivo nao Informado.";
         $this->erro_campo = "p74_perc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["p74_codcontr"]))
           $resac = db_query("insert into db_acount values($acount,985,6122,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'p74_codcontr'))."','$this->p74_codcontr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p74_valor"]))
           $resac = db_query("insert into db_acount values($acount,985,6123,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'p74_valor'))."','$this->p74_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p74_perc"]))
           $resac = db_query("insert into db_acount values($acount,985,6124,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'p74_perc'))."','$this->p74_perc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($p74_codcontr=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,985,6122,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'p74_codcontr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,985,6123,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'p74_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,985,6124,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'p74_perc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
