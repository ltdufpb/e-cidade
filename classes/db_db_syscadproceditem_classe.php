...
class cl_db_syscadproceditem { 
   ...
   function incluir ($seqproitem){ 
     ...
     if($seqproitem == "" || $seqproitem == null ){
       ...
       $this->seqproitem = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_syscadproceditem_seqproitem_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $seqproitem)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1640,9566,'','".AddSlashes(pg_fetch_result($resaco,0,'seqproitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1640,8992,'','".AddSlashes(pg_fetch_result($resaco,0,'codproced'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1640,821,'','".AddSlashes(pg_fetch_result($resaco,0,'id_item'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($seqproitem=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->seqproitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["seqproitem"])){ 
       $sql  .= $virgula." seqproitem = $this->seqproitem ";
       $virgula = ",";
       if(trim((string) $this->seqproitem) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["seqproitem"]))
           $resac = db_query("insert into db_acount values($acount,1640,9566,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'seqproitem'))."','$this->seqproitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["codproced"]))
           $resac = db_query("insert into db_acount values($acount,1640,8992,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'codproced'))."','$this->codproced',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["id_item"]))
           $resac = db_query("insert into db_acount values($acount,1640,821,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'id_item'))."','$this->id_item',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($seqproitem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1640,9566,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'seqproitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1640,8992,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'codproced'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1640,821,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'id_item'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
