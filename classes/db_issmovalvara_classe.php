...
class cl_issmovalvara { 
   ...
   function incluir ($q120_sequencial){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3242,18334,'','".AddSlashes(pg_fetch_result($resaco,0,'q120_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3242,18335,'','".AddSlashes(pg_fetch_result($resaco,0,'q120_issalvara'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3242,18336,'','".AddSlashes(pg_fetch_result($resaco,0,'q120_isstipomovalvara'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3242,18337,'','".AddSlashes(pg_fetch_result($resaco,0,'q120_dtmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3242,18338,'','".AddSlashes(pg_fetch_result($resaco,0,'q120_validadealvara'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3242,18339,'','".AddSlashes(pg_fetch_result($resaco,0,'q120_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3242,18340,'','".AddSlashes(pg_fetch_result($resaco,0,'q120_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q120_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q120_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q120_sequencial"])){ 
       $sql  .= $virgula." q120_sequencial = $this->q120_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q120_sequencial) == null ){ 
     ...
     if(trim((string) $this->q120_issalvara)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q120_issalvara"])){ 
       $sql  .= $virgula." q120_issalvara = $this->q120_issalvara ";
       $virgula = ",";
       if(trim((string) $this->q120_issalvara) == null ){ 
         $this->erro_sql = " Campo Código do Alvará nao Informado.";
         $this->erro_campo = "q120_issalvara";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q120_isstipomovalvara)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q120_isstipomovalvara"])){ 
       $sql  .= $virgula." q120_isstipomovalvara = $this->q120_isstipomovalvara ";
       $virgula = ",";
       if(trim((string) $this->q120_isstipomovalvara) == null ){ 
         $this->erro_sql = " Campo Tipo de Movimentação do Alvará nao Informado.";
         $this->erro_campo = "q120_isstipomovalvara";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q120_dtmov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q120_dtmov_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["q120_dtmov_dia"] !="") ){ 
       $sql  .= $virgula." q120_dtmov = '$this->q120_dtmov' ";
       $virgula = ",";
       if(trim((string) $this->q120_dtmov) == null ){ 
         $this->erro_sql = " Campo Data da Movimentação nao Informado.";
         $this->erro_campo = "q120_dtmov_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q120_validadealvara)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q120_validadealvara"])){ 
        if(trim((string) $this->q120_validadealvara)=="" && isset($GLOBALS["HTTP_POST_VARS"]["q120_validadealvara"])){ 
           $this->q120_validadealvara = "0" ; 
        } 
     ...
     if(trim((string) $this->q120_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q120_usuario"])){ 
       $sql  .= $virgula." q120_usuario = $this->q120_usuario ";
       $virgula = ",";
       if(trim((string) $this->q120_usuario) == null ){ 
         $this->erro_sql = " Campo Usuario nao Informado.";
         $this->erro_campo = "q120_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q120_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q120_obs"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q120_sequencial"]) || $this->q120_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3242,18334,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q120_sequencial'))."','$this->q120_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q120_issalvara"]) || $this->q120_issalvara != "")
           $resac = db_query("insert into db_acount values($acount,3242,18335,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q120_issalvara'))."','$this->q120_issalvara',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q120_isstipomovalvara"]) || $this->q120_isstipomovalvara != "")
           $resac = db_query("insert into db_acount values($acount,3242,18336,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q120_isstipomovalvara'))."','$this->q120_isstipomovalvara',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q120_dtmov"]) || $this->q120_dtmov != "")
           $resac = db_query("insert into db_acount values($acount,3242,18337,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q120_dtmov'))."','$this->q120_dtmov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q120_validadealvara"]) || $this->q120_validadealvara != "")
           $resac = db_query("insert into db_acount values($acount,3242,18338,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q120_validadealvara'))."','$this->q120_validadealvara',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q120_usuario"]) || $this->q120_usuario != "")
           $resac = db_query("insert into db_acount values($acount,3242,18339,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q120_usuario'))."','$this->q120_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q120_obs"]) || $this->q120_obs != "")
           $resac = db_query("insert into db_acount values($acount,3242,18340,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q120_obs'))."','$this->q120_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q120_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3242,18334,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q120_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3242,18335,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q120_issalvara'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3242,18336,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q120_isstipomovalvara'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3242,18337,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q120_dtmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3242,18338,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q120_validadealvara'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3242,18339,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q120_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3242,18340,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q120_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
 ...
 /** Retorna uma String com todos os alvaras que podem ser transformados
   ...
   * @return String
   */
  function sql_AlvaraLiberado($q123_sequencial=null,$iInscr = null, $campos="*", $dbwhere="") {
