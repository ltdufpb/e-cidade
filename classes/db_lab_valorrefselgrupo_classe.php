...
class cl_lab_valorrefselgrupo { 
   ...
   public $la51_i_codigo = 0; 
   public $la51_i_valorrefsel = 0; 
   public $la51_i_referencia = 0; 
   ...
   function incluir ($la51_i_codigo){ 
     ...
     if($la51_i_codigo == "" || $la51_i_codigo == null ){
       ...
       $this->la51_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from lab_valorrefselgrupo_la51_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $la51_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2916,16604,'','".AddSlashes(pg_fetch_result($resaco,0,'la51_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2916,16605,'','".AddSlashes(pg_fetch_result($resaco,0,'la51_i_valorrefsel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2916,16606,'','".AddSlashes(pg_fetch_result($resaco,0,'la51_i_referencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($la51_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->la51_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la51_i_codigo"])){ 
       $sql  .= $virgula." la51_i_codigo = $this->la51_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->la51_i_codigo) == null ){ 
     ...
     if(trim((string) $this->la51_i_valorrefsel)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la51_i_valorrefsel"])){ 
       $sql  .= $virgula." la51_i_valorrefsel = $this->la51_i_valorrefsel ";
       $virgula = ",";
       if(trim((string) $this->la51_i_valorrefsel) == null ){ 
         $this->erro_sql = " Campo Valor Referencial Selecionável nao Informado.";
         $this->erro_campo = "la51_i_valorrefsel";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->la51_i_referencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la51_i_referencia"])){ 
       $sql  .= $virgula." la51_i_referencia = $this->la51_i_referencia ";
       $virgula = ",";
       if(trim((string) $this->la51_i_referencia) == null ){ 
         $this->erro_sql = " Campo Referência nao Informado.";
         $this->erro_campo = "la51_i_referencia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["la51_i_codigo"]) || $this->la51_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2916,16604,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la51_i_codigo'))."','$this->la51_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la51_i_valorrefsel"]) || $this->la51_i_valorrefsel != "")
           $resac = db_query("insert into db_acount values($acount,2916,16605,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la51_i_valorrefsel'))."','$this->la51_i_valorrefsel',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la51_i_referencia"]) || $this->la51_i_referencia != "")
           $resac = db_query("insert into db_acount values($acount,2916,16606,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la51_i_referencia'))."','$this->la51_i_referencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($la51_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2916,16604,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la51_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2916,16605,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la51_i_valorrefsel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2916,16606,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la51_i_referencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
