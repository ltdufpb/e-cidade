...
class cl_orcparamrecurso { 
   ...
   function incluir ($o44_anousu,$o44_codparrel,$o44_sequencia,$o44_codrec){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1416,5713,'','".AddSlashes(pg_fetch_result($resaco,0,'o44_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1416,6582,'','".AddSlashes(pg_fetch_result($resaco,0,'o44_codparrel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1416,5709,'','".AddSlashes(pg_fetch_result($resaco,0,'o44_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1416,8367,'','".AddSlashes(pg_fetch_result($resaco,0,'o44_codrec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1416,6783,'','".AddSlashes(pg_fetch_result($resaco,0,'o44_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o44_anousu=null,$o44_codparrel=null,$o44_sequencia=null,$o44_codrec=null) { 
     ...
     if(trim((string) $this->o44_codrec)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o44_codrec"])){ 
       $sql  .= $virgula." o44_codrec = $this->o44_codrec ";
       $virgula = ",";
       if(trim((string) $this->o44_codrec) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o44_anousu"]))
           $resac = db_query("insert into db_acount values($acount,1416,5713,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o44_anousu'))."','$this->o44_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o44_codparrel"]))
           $resac = db_query("insert into db_acount values($acount,1416,6582,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o44_codparrel'))."','$this->o44_codparrel',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o44_sequencia"]))
           $resac = db_query("insert into db_acount values($acount,1416,5709,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o44_sequencia'))."','$this->o44_sequencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o44_codrec"]))
           $resac = db_query("insert into db_acount values($acount,1416,8367,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o44_codrec'))."','$this->o44_codrec',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o44_instit"]))
           $resac = db_query("insert into db_acount values($acount,1416,6783,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o44_instit'))."','$this->o44_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o44_anousu=null,$o44_codparrel=null,$o44_sequencia=null,$o44_codrec=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1416,5713,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o44_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1416,6582,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o44_codparrel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1416,5709,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o44_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1416,8367,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o44_codrec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1416,6783,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o44_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
