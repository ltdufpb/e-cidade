...
class cl_saltesextra {
   ...
   function incluir ($k109_sequencial){
     ...
     if($k109_sequencial == "" || $k109_sequencial == null ){
       ...
       $this->k109_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from saltesextra_k109_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k109_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2209,12654,'','".AddSlashes(pg_fetch_result($resaco,0,'k109_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2209,12655,'','".AddSlashes(pg_fetch_result($resaco,0,'k109_saltes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2209,12656,'','".AddSlashes(pg_fetch_result($resaco,0,'k109_contaextra'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($k109_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->k109_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k109_sequencial"])){
       $sql  .= $virgula." k109_sequencial = $this->k109_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k109_sequencial) == null ){
     ...
     if(trim((string) $this->k109_saltes)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k109_saltes"])){
       $sql  .= $virgula." k109_saltes = $this->k109_saltes ";
       $virgula = ",";
       if(trim((string) $this->k109_saltes) == null ){
         $this->erro_sql = " Campo Código da conta Tesouraria nao Informado.";
         $this->erro_campo = "k109_saltes";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k109_contaextra)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k109_contaextra"])){
       $sql  .= $virgula." k109_contaextra = $this->k109_contaextra ";
       $virgula = ",";
       if(trim((string) $this->k109_contaextra) == null ){
         $this->erro_sql = " Campo Conta Extra Orçamentaria nao Informado.";
         $this->erro_campo = "k109_contaextra";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k109_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2209,12654,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k109_sequencial'))."','$this->k109_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k109_saltes"]))
           $resac = db_query("insert into db_acount values($acount,2209,12655,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k109_saltes'))."','$this->k109_saltes',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k109_contaextra"]))
           $resac = db_query("insert into db_acount values($acount,2209,12656,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k109_contaextra'))."','$this->k109_contaextra',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($k109_sequencial=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2209,12654,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k109_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2209,12655,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k109_saltes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2209,12656,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k109_contaextra'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
