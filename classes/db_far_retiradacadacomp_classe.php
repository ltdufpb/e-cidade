...
class cl_far_retiradacadacomp { 
   ...
   public $fa55_i_codigo = 0; 
   public $fa55_i_cadacomp = 0; 
   public $fa55_i_retirada = 0; 
   ...
   function incluir ($fa55_i_codigo){ 
     ...
     if($fa55_i_codigo == "" || $fa55_i_codigo == null ){
       ...
       $this->fa55_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_retiradacadacomp_fa55_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa55_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3057,17272,'','".AddSlashes(pg_fetch_result($resaco,0,'fa55_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3057,17273,'','".AddSlashes(pg_fetch_result($resaco,0,'fa55_i_cadacomp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3057,17274,'','".AddSlashes(pg_fetch_result($resaco,0,'fa55_i_retirada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa55_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa55_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa55_i_codigo"])){ 
       $sql  .= $virgula." fa55_i_codigo = $this->fa55_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa55_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa55_i_cadacomp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa55_i_cadacomp"])){ 
       $sql  .= $virgula." fa55_i_cadacomp = $this->fa55_i_cadacomp ";
       $virgula = ",";
       if(trim((string) $this->fa55_i_cadacomp) == null ){ 
         $this->erro_sql = " Campo Cadastro / Acompanhamento nao Informado.";
         $this->erro_campo = "fa55_i_cadacomp";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa55_i_retirada)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa55_i_retirada"])){ 
       $sql  .= $virgula." fa55_i_retirada = $this->fa55_i_retirada ";
       $virgula = ",";
       if(trim((string) $this->fa55_i_retirada) == null ){ 
         $this->erro_sql = " Campo Retirada nao Informado.";
         $this->erro_campo = "fa55_i_retirada";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa55_i_codigo"]) || $this->fa55_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3057,17272,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa55_i_codigo'))."','$this->fa55_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa55_i_cadacomp"]) || $this->fa55_i_cadacomp != "")
           $resac = db_query("insert into db_acount values($acount,3057,17273,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa55_i_cadacomp'))."','$this->fa55_i_cadacomp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa55_i_retirada"]) || $this->fa55_i_retirada != "")
           $resac = db_query("insert into db_acount values($acount,3057,17274,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa55_i_retirada'))."','$this->fa55_i_retirada',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa55_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3057,17272,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa55_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3057,17273,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa55_i_cadacomp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3057,17274,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa55_i_retirada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
