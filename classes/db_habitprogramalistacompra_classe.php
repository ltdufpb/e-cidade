...
class cl_habitprogramalistacompra { 
   ...
   public $ht17_sequencial = 0; 
   public $ht17_habitprograma = 0; 
   public $ht17_descricao = null; 
   public $ht17_datalimite_dia = null; 
   public $ht17_datalimite_mes = null; 
   public $ht17_datalimite_ano = null; 
   public $ht17_datalimite = null; 
   public $ht17_formaavaliacao = 0; 
   ...
   function incluir ($ht17_sequencial){ 
     ...
     if($ht17_sequencial == "" || $ht17_sequencial == null ){
       ...
       $this->ht17_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from habitprogramalistacompra_ht17_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ht17_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3005,17020,'','".AddSlashes(pg_fetch_result($resaco,0,'ht17_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3005,17021,'','".AddSlashes(pg_fetch_result($resaco,0,'ht17_habitprograma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3005,17022,'','".AddSlashes(pg_fetch_result($resaco,0,'ht17_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3005,17024,'','".AddSlashes(pg_fetch_result($resaco,0,'ht17_datalimite'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3005,17073,'','".AddSlashes(pg_fetch_result($resaco,0,'ht17_formaavaliacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ht17_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ht17_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht17_sequencial"])){ 
       $sql  .= $virgula." ht17_sequencial = $this->ht17_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ht17_sequencial) == null ){ 
     ...
     if(trim((string) $this->ht17_habitprograma)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht17_habitprograma"])){ 
       $sql  .= $virgula." ht17_habitprograma = $this->ht17_habitprograma ";
       $virgula = ",";
       if(trim((string) $this->ht17_habitprograma) == null ){ 
         $this->erro_sql = " Campo Programa nao Informado.";
         $this->erro_campo = "ht17_habitprograma";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ht17_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht17_descricao"])){ 
       $sql  .= $virgula." ht17_descricao = '$this->ht17_descricao' ";
       $virgula = ",";
       if(trim((string) $this->ht17_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "ht17_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ht17_datalimite)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht17_datalimite_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ht17_datalimite_dia"] !="") ){ 
     ...
     if(trim((string) $this->ht17_formaavaliacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht17_formaavaliacao"])){ 
       $sql  .= $virgula." ht17_formaavaliacao = $this->ht17_formaavaliacao ";
       $virgula = ",";
       if(trim((string) $this->ht17_formaavaliacao) == null ){ 
         $this->erro_sql = " Campo Forma de Avaliação nao Informado.";
         $this->erro_campo = "ht17_formaavaliacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht17_sequencial"]) || $this->ht17_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3005,17020,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht17_sequencial'))."','$this->ht17_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht17_habitprograma"]) || $this->ht17_habitprograma != "")
           $resac = db_query("insert into db_acount values($acount,3005,17021,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht17_habitprograma'))."','$this->ht17_habitprograma',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht17_descricao"]) || $this->ht17_descricao != "")
           $resac = db_query("insert into db_acount values($acount,3005,17022,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht17_descricao'))."','$this->ht17_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht17_datalimite"]) || $this->ht17_datalimite != "")
           $resac = db_query("insert into db_acount values($acount,3005,17024,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht17_datalimite'))."','$this->ht17_datalimite',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht17_formaavaliacao"]) || $this->ht17_formaavaliacao != "")
           $resac = db_query("insert into db_acount values($acount,3005,17073,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht17_formaavaliacao'))."','$this->ht17_formaavaliacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ht17_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3005,17020,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht17_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3005,17021,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht17_habitprograma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3005,17022,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht17_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3005,17024,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht17_datalimite'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3005,17073,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht17_formaavaliacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
