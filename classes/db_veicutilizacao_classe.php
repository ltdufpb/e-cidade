...
class cl_veicutilizacao { 
   ...
   public $ve15_sequencial = 0; 
   public $ve15_veiccadutilizacao = 0; 
   public $ve15_veiculos = 0; 
   ...
   function incluir ($ve15_sequencial){ 
     ...
     if($ve15_sequencial == "" || $ve15_sequencial == null ){
       ...
       $this->ve15_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veicutilizacao_ve15_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve15_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1918,11120,'','".AddSlashes(pg_fetch_result($resaco,0,'ve15_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1918,11121,'','".AddSlashes(pg_fetch_result($resaco,0,'ve15_veiccadutilizacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1918,11122,'','".AddSlashes(pg_fetch_result($resaco,0,'ve15_veiculos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve15_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve15_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve15_sequencial"])){ 
       $sql  .= $virgula." ve15_sequencial = $this->ve15_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ve15_sequencial) == null ){ 
     ...
     if(trim((string) $this->ve15_veiccadutilizacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve15_veiccadutilizacao"])){ 
       $sql  .= $virgula." ve15_veiccadutilizacao = $this->ve15_veiccadutilizacao ";
       $virgula = ",";
       if(trim((string) $this->ve15_veiccadutilizacao) == null ){ 
         $this->erro_sql = " Campo Utilização nao Informado.";
         $this->erro_campo = "ve15_veiccadutilizacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve15_veiculos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve15_veiculos"])){ 
       $sql  .= $virgula." ve15_veiculos = $this->ve15_veiculos ";
       $virgula = ",";
       if(trim((string) $this->ve15_veiculos) == null ){ 
         $this->erro_sql = " Campo Veiculo nao Informado.";
         $this->erro_campo = "ve15_veiculos";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve15_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1918,11120,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve15_sequencial'))."','$this->ve15_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve15_veiccadutilizacao"]))
           $resac = db_query("insert into db_acount values($acount,1918,11121,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve15_veiccadutilizacao'))."','$this->ve15_veiccadutilizacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve15_veiculos"]))
           $resac = db_query("insert into db_acount values($acount,1918,11122,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve15_veiculos'))."','$this->ve15_veiculos',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve15_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1918,11120,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve15_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1918,11121,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve15_veiccadutilizacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1918,11122,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve15_veiculos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
