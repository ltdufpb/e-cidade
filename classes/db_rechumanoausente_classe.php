...
class cl_rechumanoausente {
   ...
   public $ed348_sequencial = 0;
   public $ed348_rechumano = 0;
   public $ed348_tipoausencia = 0;
   public $ed348_usuario = 0;
   public $ed348_inicio_dia = null;
   public $ed348_inicio_mes = null;
   public $ed348_inicio_ano = null;
   public $ed348_inicio = null;
   public $ed348_final_dia = null;
   public $ed348_final_mes = null;
   public $ed348_final_ano = null;
   public $ed348_final = null;
   public $ed348_observacao = null;
   public $ed348_escola = 0;
   ...
   function incluir ($ed348_sequencial){
     ...
     if($ed348_sequencial == "" || $ed348_sequencial == null ){
       ...
       $this->ed348_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from rechumanoausente_ed348_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed348_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3884,21619,'','".AddSlashes(pg_fetch_result($resaco,0,'ed348_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3884,21620,'','".AddSlashes(pg_fetch_result($resaco,0,'ed348_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3884,21621,'','".AddSlashes(pg_fetch_result($resaco,0,'ed348_tipoausencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3884,21622,'','".AddSlashes(pg_fetch_result($resaco,0,'ed348_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3884,21623,'','".AddSlashes(pg_fetch_result($resaco,0,'ed348_inicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3884,21624,'','".AddSlashes(pg_fetch_result($resaco,0,'ed348_final'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3884,21625,'','".AddSlashes(pg_fetch_result($resaco,0,'ed348_observacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3884,21626,'','".AddSlashes(pg_fetch_result($resaco,0,'ed348_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   public function alterar ($ed348_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->ed348_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed348_sequencial"])){
       $sql  .= $virgula." ed348_sequencial = $this->ed348_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed348_sequencial) == null ){
     ...
     if(trim((string) $this->ed348_rechumano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed348_rechumano"])){
       $sql  .= $virgula." ed348_rechumano = $this->ed348_rechumano ";
       $virgula = ",";
       if(trim((string) $this->ed348_rechumano) == null ){
         $this->erro_sql = " Campo Recursos Humanos não informado.";
         $this->erro_campo = "ed348_rechumano";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed348_tipoausencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed348_tipoausencia"])){
       $sql  .= $virgula." ed348_tipoausencia = $this->ed348_tipoausencia ";
       $virgula = ",";
       if(trim((string) $this->ed348_tipoausencia) == null ){
         $this->erro_sql = " Campo Tipo de Ausência não informado.";
         $this->erro_campo = "ed348_tipoausencia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed348_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed348_usuario"])){
       $sql  .= $virgula." ed348_usuario = $this->ed348_usuario ";
       $virgula = ",";
       if(trim((string) $this->ed348_usuario) == null ){
         $this->erro_sql = " Campo Usuário não informado.";
         $this->erro_campo = "ed348_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed348_inicio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed348_inicio_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed348_inicio_dia"] !="") ){
       $sql  .= $virgula." ed348_inicio = '$this->ed348_inicio' ";
       $virgula = ",";
       if(trim((string) $this->ed348_inicio) == null ){
         $this->erro_sql = " Campo Data de Início não informado.";
         $this->erro_campo = "ed348_inicio_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if ( trim((string) $this->ed348_final) != ""  ) {
     ...
     if(trim((string) $this->ed348_observacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed348_observacao"])){
       $sql  .= $virgula." ed348_observacao = '$this->ed348_observacao' ";
       $virgula = ",";
     }
     if(trim((string) $this->ed348_escola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed348_escola"])){
       $sql  .= $virgula." ed348_escola = $this->ed348_escola ";
       $virgula = ",";
       if(trim((string) $this->ed348_escola) == null ){
         $this->erro_sql = " Campo Escola não informado.";
         $this->erro_campo = "ed348_escola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed348_sequencial"]) || $this->ed348_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3884,21619,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed348_sequencial'))."','$this->ed348_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed348_rechumano"]) || $this->ed348_rechumano != "")
             $resac = db_query("insert into db_acount values($acount,3884,21620,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed348_rechumano'))."','$this->ed348_rechumano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed348_tipoausencia"]) || $this->ed348_tipoausencia != "")
             $resac = db_query("insert into db_acount values($acount,3884,21621,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed348_tipoausencia'))."','$this->ed348_tipoausencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed348_usuario"]) || $this->ed348_usuario != "")
             $resac = db_query("insert into db_acount values($acount,3884,21622,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed348_usuario'))."','$this->ed348_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed348_inicio"]) || $this->ed348_inicio != "")
             $resac = db_query("insert into db_acount values($acount,3884,21623,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed348_inicio'))."','$this->ed348_inicio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed348_final"]) || $this->ed348_final != "")
             $resac = db_query("insert into db_acount values($acount,3884,21624,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed348_final'))."','$this->ed348_final',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed348_observacao"]) || $this->ed348_observacao != "")
             $resac = db_query("insert into db_acount values($acount,3884,21625,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed348_observacao'))."','$this->ed348_observacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed348_escola"]) || $this->ed348_escola != "")
             $resac = db_query("insert into db_acount values($acount,3884,21626,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed348_escola'))."','$this->ed348_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3884,21619,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed348_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3884,21620,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed348_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3884,21621,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed348_tipoausencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3884,21622,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed348_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3884,21623,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed348_inicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3884,21624,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed348_final'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3884,21625,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed348_observacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3884,21626,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed348_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
