...
class cl_orcsuplem {
   ...
   public $o46_codsup = 0;
   public $o46_tiposup = 0;
   public $o46_codlei = 0;
   public $o46_instit = 0;
   public $o46_data_dia = null;
   public $o46_data_mes = null;
   public $o46_data_ano = null;
   public $o46_data = null;
   public $o46_obs = null;
   ...
   function incluir ($o46_codsup){
     ...
     if($o46_codsup == "" || $o46_codsup == null ){
       ...
       $this->o46_codsup = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from orcsuplem_o46_codsup_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $o46_codsup)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,786,5328,'','".AddSlashes(pg_fetch_result($resaco,0,'o46_codsup'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,786,5329,'','".AddSlashes(pg_fetch_result($resaco,0,'o46_tiposup'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,786,5330,'','".AddSlashes(pg_fetch_result($resaco,0,'o46_codlei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,786,5331,'','".AddSlashes(pg_fetch_result($resaco,0,'o46_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,786,5332,'','".AddSlashes(pg_fetch_result($resaco,0,'o46_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,786,5333,'','".AddSlashes(pg_fetch_result($resaco,0,'o46_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($o46_codsup=null) {
     ...
     $virgula = "";
     if(trim((string) $this->o46_codsup)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o46_codsup"])){
       $sql  .= $virgula." o46_codsup = $this->o46_codsup ";
       $virgula = ",";
       if(trim((string) $this->o46_codsup) == null ){
     ...
     if(trim((string) $this->o46_tiposup)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o46_tiposup"])){
       $sql  .= $virgula." o46_tiposup = $this->o46_tiposup ";
       $virgula = ",";
       if(trim((string) $this->o46_tiposup) == null ){
         $this->erro_sql = " Campo Código nao Informado.";
         $this->erro_campo = "o46_tiposup";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o46_codlei)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o46_codlei"])){
       $sql  .= $virgula." o46_codlei = $this->o46_codlei ";
       $virgula = ",";
       if(trim((string) $this->o46_codlei) == null ){
         $this->erro_sql = " Campo Projeto de Lei nao Informado.";
         $this->erro_campo = "o46_codlei";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o46_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o46_instit"])){
       $sql  .= $virgula." o46_instit = $this->o46_instit ";
       $virgula = ",";
       if(trim((string) $this->o46_instit) == null ){
         $this->erro_sql = " Campo instituição nao Informado.";
         $this->erro_campo = "o46_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o46_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o46_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["o46_data_dia"] !="") ){
       $sql  .= $virgula." o46_data = '$this->o46_data' ";
       $virgula = ",";
       if(trim((string) $this->o46_data) == null ){
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "o46_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o46_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o46_obs"])){
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o46_codsup"]))
           $resac = db_query("insert into db_acount values($acount,786,5328,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o46_codsup'))."','$this->o46_codsup',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o46_tiposup"]))
           $resac = db_query("insert into db_acount values($acount,786,5329,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o46_tiposup'))."','$this->o46_tiposup',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o46_codlei"]))
           $resac = db_query("insert into db_acount values($acount,786,5330,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o46_codlei'))."','$this->o46_codlei',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o46_instit"]))
           $resac = db_query("insert into db_acount values($acount,786,5331,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o46_instit'))."','$this->o46_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o46_data"]))
           $resac = db_query("insert into db_acount values($acount,786,5332,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o46_data'))."','$this->o46_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o46_obs"]))
           $resac = db_query("insert into db_acount values($acount,786,5333,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o46_obs'))."','$this->o46_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($o46_codsup=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,786,5328,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o46_codsup'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,786,5329,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o46_tiposup'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,786,5330,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o46_codlei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,786,5331,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o46_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,786,5332,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o46_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,786,5333,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o46_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
