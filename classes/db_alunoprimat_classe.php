...
class cl_alunoprimat { 
   ...
   public $ed76_i_codigo = 0; 
   public $ed76_i_aluno = 0; 
   public $ed76_i_escola = 0; 
   public $ed76_d_data_dia = null; 
   public $ed76_d_data_mes = null; 
   public $ed76_d_data_ano = null; 
   public $ed76_d_data = null; 
   public $ed76_c_tipo = null; 
   ...
   function incluir ($ed76_i_codigo){ 
     ...
     if($ed76_i_codigo == "" || $ed76_i_codigo == null ){
       ...
       $this->ed76_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from alunoprimat_ed76_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed76_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010069,1008408,'','".AddSlashes(pg_fetch_result($resaco,0,'ed76_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010069,1008410,'','".AddSlashes(pg_fetch_result($resaco,0,'ed76_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010069,1008409,'','".AddSlashes(pg_fetch_result($resaco,0,'ed76_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010069,1008411,'','".AddSlashes(pg_fetch_result($resaco,0,'ed76_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010069,11719,'','".AddSlashes(pg_fetch_result($resaco,0,'ed76_c_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed76_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed76_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed76_i_codigo"])){ 
       $sql  .= $virgula." ed76_i_codigo = $this->ed76_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed76_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed76_i_aluno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed76_i_aluno"])){ 
       $sql  .= $virgula." ed76_i_aluno = $this->ed76_i_aluno ";
       $virgula = ",";
       if(trim((string) $this->ed76_i_aluno) == null ){ 
         $this->erro_sql = " Campo Aluno nao Informado.";
         $this->erro_campo = "ed76_i_aluno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed76_i_escola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed76_i_escola"])){ 
        if(trim((string) $this->ed76_i_escola)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed76_i_escola"])){ 
     ...
     if(trim((string) $this->ed76_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed76_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed76_d_data_dia"] !="") ){ 
     ...
     if(trim((string) $this->ed76_c_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed76_c_tipo"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed76_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010069,1008408,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed76_i_codigo'))."','$this->ed76_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed76_i_aluno"]))
           $resac = db_query("insert into db_acount values($acount,1010069,1008410,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed76_i_aluno'))."','$this->ed76_i_aluno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed76_i_escola"]))
           $resac = db_query("insert into db_acount values($acount,1010069,1008409,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed76_i_escola'))."','$this->ed76_i_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed76_d_data"]))
           $resac = db_query("insert into db_acount values($acount,1010069,1008411,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed76_d_data'))."','$this->ed76_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed76_c_tipo"]))
           $resac = db_query("insert into db_acount values($acount,1010069,11719,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed76_c_tipo'))."','$this->ed76_c_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed76_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010069,1008408,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed76_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010069,1008410,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed76_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010069,1008409,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed76_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010069,1008411,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed76_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010069,11719,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed76_c_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
