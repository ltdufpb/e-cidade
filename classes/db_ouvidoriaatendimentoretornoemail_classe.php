...
class cl_ouvidoriaatendimentoretornoemail { 
   ...
   public $ov13_sequencial = 0; 
   public $ov13_ouvidoriaantendimento = 0; 
   public $ov13_email = null; 
   ...
   function incluir ($ov13_sequencial){ 
     ...
     if($ov13_sequencial == "" || $ov13_sequencial == null ){
       ...
       $this->ov13_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from ouvidoriaatendimentoretornoemail_ov13_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ov13_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2603,14791,'','".AddSlashes(pg_fetch_result($resaco,0,'ov13_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2603,14792,'','".AddSlashes(pg_fetch_result($resaco,0,'ov13_ouvidoriaantendimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2603,14793,'','".AddSlashes(pg_fetch_result($resaco,0,'ov13_email'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ov13_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ov13_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov13_sequencial"])){ 
       $sql  .= $virgula." ov13_sequencial = $this->ov13_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ov13_sequencial) == null ){ 
     ...
     if(trim((string) $this->ov13_ouvidoriaantendimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov13_ouvidoriaantendimento"])){ 
       $sql  .= $virgula." ov13_ouvidoriaantendimento = $this->ov13_ouvidoriaantendimento ";
       $virgula = ",";
       if(trim((string) $this->ov13_ouvidoriaantendimento) == null ){ 
         $this->erro_sql = " Campo Atendimento nao Informado.";
         $this->erro_campo = "ov13_ouvidoriaantendimento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ov13_email)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov13_email"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov13_sequencial"]) || $this->ov13_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2603,14791,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov13_sequencial'))."','$this->ov13_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov13_ouvidoriaantendimento"]) || $this->ov13_ouvidoriaantendimento != "")
           $resac = db_query("insert into db_acount values($acount,2603,14792,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov13_ouvidoriaantendimento'))."','$this->ov13_ouvidoriaantendimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov13_email"]) || $this->ov13_email != "")
           $resac = db_query("insert into db_acount values($acount,2603,14793,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov13_email'))."','$this->ov13_email',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ov13_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2603,14791,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov13_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2603,14792,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov13_ouvidoriaantendimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2603,14793,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov13_email'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
