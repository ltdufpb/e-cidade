...
class cl_disbancodiver { 
   ...
   public $k44_sequencial = 0; 
   public $k44_idret = 0; 
   public $k44_coddiver = 0; 
   ...
   function incluir ($k44_sequencial){ 
     ...
     if($k44_sequencial == "" || $k44_sequencial == null ){
       ...
       $this->k44_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from disbancodiver_k44_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k44_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1896,11002,'','".AddSlashes(pg_fetch_result($resaco,0,'k44_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1896,11003,'','".AddSlashes(pg_fetch_result($resaco,0,'k44_idret'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1896,11004,'','".AddSlashes(pg_fetch_result($resaco,0,'k44_coddiver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k44_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k44_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k44_sequencial"])){ 
       $sql  .= $virgula." k44_sequencial = $this->k44_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k44_sequencial) == null ){ 
     ...
     if(trim((string) $this->k44_idret)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k44_idret"])){ 
       $sql  .= $virgula." k44_idret = $this->k44_idret ";
       $virgula = ",";
       if(trim((string) $this->k44_idret) == null ){ 
         $this->erro_sql = " Campo Codigo da disbanco nao Informado.";
         $this->erro_campo = "k44_idret";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k44_coddiver)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k44_coddiver"])){ 
       $sql  .= $virgula." k44_coddiver = $this->k44_coddiver ";
       $virgula = ",";
       if(trim((string) $this->k44_coddiver) == null ){ 
         $this->erro_sql = " Campo Codigo diversos nao Informado.";
         $this->erro_campo = "k44_coddiver";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k44_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1896,11002,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k44_sequencial'))."','$this->k44_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k44_idret"]))
           $resac = db_query("insert into db_acount values($acount,1896,11003,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k44_idret'))."','$this->k44_idret',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k44_coddiver"]))
           $resac = db_query("insert into db_acount values($acount,1896,11004,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k44_coddiver'))."','$this->k44_coddiver',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k44_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1896,11002,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k44_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1896,11003,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k44_idret'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1896,11004,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k44_coddiver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
