...
class cl_veicmotoristascentral { 
   ...
   public $ve41_sequencial = 0; 
   public $ve41_veicmotoristas = 0; 
   public $ve41_veiccadcentral = 0; 
   public $ve41_dtini_dia = null; 
   public $ve41_dtini_mes = null; 
   public $ve41_dtini_ano = null; 
   public $ve41_dtini = null; 
   public $ve41_dtfim_dia = null; 
   public $ve41_dtfim_mes = null; 
   public $ve41_dtfim_ano = null; 
   public $ve41_dtfim = null; 
   ...
   function incluir ($ve41_sequencial){ 
     ...
     if($ve41_sequencial == "" || $ve41_sequencial == null ){
       ...
       $this->ve41_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veicmotoristascentral_ve41_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve41_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1939,11276,'','".AddSlashes(pg_fetch_result($resaco,0,'ve41_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1939,11277,'','".AddSlashes(pg_fetch_result($resaco,0,'ve41_veicmotoristas'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1939,11278,'','".AddSlashes(pg_fetch_result($resaco,0,'ve41_veiccadcentral'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1939,11286,'','".AddSlashes(pg_fetch_result($resaco,0,'ve41_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1939,11287,'','".AddSlashes(pg_fetch_result($resaco,0,'ve41_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve41_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve41_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve41_sequencial"])){ 
       $sql  .= $virgula." ve41_sequencial = $this->ve41_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ve41_sequencial) == null ){ 
     ...
     if(trim((string) $this->ve41_veicmotoristas)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve41_veicmotoristas"])){ 
       $sql  .= $virgula." ve41_veicmotoristas = $this->ve41_veicmotoristas ";
       $virgula = ",";
       if(trim((string) $this->ve41_veicmotoristas) == null ){ 
         $this->erro_sql = " Campo Motorista nao Informado.";
         $this->erro_campo = "ve41_veicmotoristas";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve41_veiccadcentral)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve41_veiccadcentral"])){ 
       $sql  .= $virgula." ve41_veiccadcentral = $this->ve41_veiccadcentral ";
       $virgula = ",";
       if(trim((string) $this->ve41_veiccadcentral) == null ){ 
         $this->erro_sql = " Campo Central nao Informado.";
         $this->erro_campo = "ve41_veiccadcentral";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve41_dtini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve41_dtini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ve41_dtini_dia"] !="") ){ 
       $sql  .= $virgula." ve41_dtini = '$this->ve41_dtini' ";
       $virgula = ",";
       if(trim((string) $this->ve41_dtini) == null ){ 
         $this->erro_sql = " Campo Inicial nao Informado.";
         $this->erro_campo = "ve41_dtini_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve41_dtfim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve41_dtfim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ve41_dtfim_dia"] !="") ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve41_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1939,11276,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve41_sequencial'))."','$this->ve41_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve41_veicmotoristas"]))
           $resac = db_query("insert into db_acount values($acount,1939,11277,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve41_veicmotoristas'))."','$this->ve41_veicmotoristas',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve41_veiccadcentral"]))
           $resac = db_query("insert into db_acount values($acount,1939,11278,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve41_veiccadcentral'))."','$this->ve41_veiccadcentral',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve41_dtini"]))
           $resac = db_query("insert into db_acount values($acount,1939,11286,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve41_dtini'))."','$this->ve41_dtini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve41_dtfim"]))
           $resac = db_query("insert into db_acount values($acount,1939,11287,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve41_dtfim'))."','$this->ve41_dtfim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve41_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1939,11276,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve41_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1939,11277,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve41_veicmotoristas'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1939,11278,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve41_veiccadcentral'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1939,11286,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve41_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1939,11287,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve41_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
