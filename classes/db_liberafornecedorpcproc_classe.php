...
class cl_liberafornecedorpcproc { 
   ...
   public $pc84_sequencial = 0; 
   public $pc84_liberafornecedor = 0; 
   public $pc84_pcproc = 0; 
   ...
   function incluir ($pc84_sequencial){ 
     ...
     if($pc84_sequencial == "" || $pc84_sequencial == null ){
       ...
       $this->pc84_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from liberafornecedorpcproc_pc84_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $pc84_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2726,15532,'','".AddSlashes(pg_fetch_result($resaco,0,'pc84_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2726,15533,'','".AddSlashes(pg_fetch_result($resaco,0,'pc84_liberafornecedor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2726,15534,'','".AddSlashes(pg_fetch_result($resaco,0,'pc84_pcproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc84_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc84_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc84_sequencial"])){ 
       $sql  .= $virgula." pc84_sequencial = $this->pc84_sequencial ";
       $virgula = ",";
       if(trim((string) $this->pc84_sequencial) == null ){ 
     ...
     if(trim((string) $this->pc84_liberafornecedor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc84_liberafornecedor"])){ 
       $sql  .= $virgula." pc84_liberafornecedor = $this->pc84_liberafornecedor ";
       $virgula = ",";
       if(trim((string) $this->pc84_liberafornecedor) == null ){ 
         $this->erro_sql = " Campo Fornecedor nao Informado.";
         $this->erro_campo = "pc84_liberafornecedor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc84_pcproc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc84_pcproc"])){ 
       $sql  .= $virgula." pc84_pcproc = $this->pc84_pcproc ";
       $virgula = ",";
       if(trim((string) $this->pc84_pcproc) == null ){ 
         $this->erro_sql = " Campo Processo Compra nao Informado.";
         $this->erro_campo = "pc84_pcproc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc84_sequencial"]) || $this->pc84_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2726,15532,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc84_sequencial'))."','$this->pc84_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc84_liberafornecedor"]) || $this->pc84_liberafornecedor != "")
           $resac = db_query("insert into db_acount values($acount,2726,15533,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc84_liberafornecedor'))."','$this->pc84_liberafornecedor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc84_pcproc"]) || $this->pc84_pcproc != "")
           $resac = db_query("insert into db_acount values($acount,2726,15534,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc84_pcproc'))."','$this->pc84_pcproc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc84_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2726,15532,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc84_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2726,15533,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc84_liberafornecedor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2726,15534,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc84_pcproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
