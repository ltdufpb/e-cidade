...
class cl_modcarneexcessao { 
   ...
   public $k36_sequencial = 0; 
   public $k36_modcarnepadrao = 0; 
   public $k36_ip = null; 
   ...
   function incluir ($k36_sequencial){ 
     ...
     if($k36_sequencial == "" || $k36_sequencial == null ){
       ...
       $this->k36_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from modcarneexcessao_k36_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k36_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1518,8896,'','".AddSlashes(pg_fetch_result($resaco,0,'k36_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1518,8894,'','".AddSlashes(pg_fetch_result($resaco,0,'k36_modcarnepadrao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1518,8895,'','".AddSlashes(pg_fetch_result($resaco,0,'k36_ip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k36_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k36_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k36_sequencial"])){ 
       $sql  .= $virgula." k36_sequencial = $this->k36_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k36_sequencial) == null ){ 
     ...
     if(trim((string) $this->k36_modcarnepadrao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k36_modcarnepadrao"])){ 
       $sql  .= $virgula." k36_modcarnepadrao = $this->k36_modcarnepadrao ";
       $virgula = ",";
       if(trim((string) $this->k36_modcarnepadrao) == null ){ 
         $this->erro_sql = " Campo Codigo do modelo padrão do tipo de debito nao Informado.";
         $this->erro_campo = "k36_modcarnepadrao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k36_ip)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k36_ip"])){ 
       $sql  .= $virgula." k36_ip = '$this->k36_ip' ";
       $virgula = ",";
       if(trim((string) $this->k36_ip) == null ){ 
         $this->erro_sql = " Campo IP nao Informado.";
         $this->erro_campo = "k36_ip";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k36_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1518,8896,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k36_sequencial'))."','$this->k36_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k36_modcarnepadrao"]))
           $resac = db_query("insert into db_acount values($acount,1518,8894,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k36_modcarnepadrao'))."','$this->k36_modcarnepadrao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k36_ip"]))
           $resac = db_query("insert into db_acount values($acount,1518,8895,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k36_ip'))."','$this->k36_ip',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k36_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1518,8896,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k36_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1518,8894,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k36_modcarnepadrao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1518,8895,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k36_ip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
