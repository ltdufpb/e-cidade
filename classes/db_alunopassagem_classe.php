...
class cl_alunopassagem { 
   ...
   public $ed215_i_codigo = 0; 
   public $ed215_i_aluno = 0; 
   public $ed215_i_linha = 0; 
   public $ed215_i_usuario = 0; 
   public $ed215_i_ano = 0; 
   public $ed215_d_datacad_dia = null; 
   public $ed215_d_datacad_mes = null; 
   public $ed215_d_datacad_ano = null; 
   public $ed215_d_datacad = null; 
   ...
   function incluir ($ed215_i_codigo){ 
     ...
     if($ed215_i_codigo == "" || $ed215_i_codigo == null ){
       ...
       $this->ed215_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from alunopassagem_ed215_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed215_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1930,11174,'','".AddSlashes(pg_fetch_result($resaco,0,'ed215_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1930,11180,'','".AddSlashes(pg_fetch_result($resaco,0,'ed215_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1930,11347,'','".AddSlashes(pg_fetch_result($resaco,0,'ed215_i_linha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1930,11179,'','".AddSlashes(pg_fetch_result($resaco,0,'ed215_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1930,11348,'','".AddSlashes(pg_fetch_result($resaco,0,'ed215_i_ano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1930,11178,'','".AddSlashes(pg_fetch_result($resaco,0,'ed215_d_datacad'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed215_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed215_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_codigo"])){ 
       $sql  .= $virgula." ed215_i_codigo = $this->ed215_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed215_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed215_i_aluno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_aluno"])){ 
       $sql  .= $virgula." ed215_i_aluno = $this->ed215_i_aluno ";
       $virgula = ",";
       if(trim((string) $this->ed215_i_aluno) == null ){ 
         $this->erro_sql = " Campo Aluno nao Informado.";
         $this->erro_campo = "ed215_i_aluno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed215_i_linha)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_linha"])){ 
       $sql  .= $virgula." ed215_i_linha = $this->ed215_i_linha ";
       $virgula = ",";
       if(trim((string) $this->ed215_i_linha) == null ){ 
         $this->erro_sql = " Campo Código linha nao Informado.";
         $this->erro_campo = "ed215_i_linha";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed215_i_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_usuario"])){ 
       $sql  .= $virgula." ed215_i_usuario = $this->ed215_i_usuario ";
       $virgula = ",";
       if(trim((string) $this->ed215_i_usuario) == null ){ 
         $this->erro_sql = " Campo Usuario nao Informado.";
         $this->erro_campo = "ed215_i_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed215_i_ano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_ano"])){ 
       $sql  .= $virgula." ed215_i_ano = $this->ed215_i_ano ";
       $virgula = ",";
       if(trim((string) $this->ed215_i_ano) == null ){ 
         $this->erro_sql = " Campo Código ano nao Informado.";
         $this->erro_campo = "ed215_i_ano";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed215_d_datacad)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed215_d_datacad_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed215_d_datacad_dia"] !="") ){ 
       $sql  .= $virgula." ed215_d_datacad = '$this->ed215_d_datacad' ";
       $virgula = ",";
       if(trim((string) $this->ed215_d_datacad) == null ){ 
         $this->erro_sql = " Campo Data cadastro nao Informado.";
         $this->erro_campo = "ed215_d_datacad_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1930,11174,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed215_i_codigo'))."','$this->ed215_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_aluno"]))
           $resac = db_query("insert into db_acount values($acount,1930,11180,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed215_i_aluno'))."','$this->ed215_i_aluno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_linha"]))
           $resac = db_query("insert into db_acount values($acount,1930,11347,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed215_i_linha'))."','$this->ed215_i_linha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1930,11179,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed215_i_usuario'))."','$this->ed215_i_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_ano"]))
           $resac = db_query("insert into db_acount values($acount,1930,11348,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed215_i_ano'))."','$this->ed215_i_ano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed215_d_datacad"]))
           $resac = db_query("insert into db_acount values($acount,1930,11178,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed215_d_datacad'))."','$this->ed215_d_datacad',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed215_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1930,11174,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed215_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1930,11180,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed215_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1930,11347,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed215_i_linha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1930,11179,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed215_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1930,11348,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed215_i_ano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1930,11178,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed215_d_datacad'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
