...
class cl_rhpescargo { 
   ...
   public $rh20_seqpes = 0; 
   public $rh20_cargo = 0; 
   public $rh20_instit = 0; 
   ...
   function incluir ($rh20_seqpes){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1172,7090,'','".AddSlashes(pg_fetch_result($resaco,0,'rh20_seqpes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1172,7091,'','".AddSlashes(pg_fetch_result($resaco,0,'rh20_cargo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1172,9916,'','".AddSlashes(pg_fetch_result($resaco,0,'rh20_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh20_seqpes=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh20_seqpes)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh20_seqpes"])){ 
       $sql  .= $virgula." rh20_seqpes = $this->rh20_seqpes ";
       $virgula = ",";
       if(trim((string) $this->rh20_seqpes) == null ){ 
     ...
     if(trim((string) $this->rh20_cargo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh20_cargo"])){ 
       $sql  .= $virgula." rh20_cargo = $this->rh20_cargo ";
       $virgula = ",";
       if(trim((string) $this->rh20_cargo) == null ){ 
         $this->erro_sql = " Campo Função nao Informado.";
         $this->erro_campo = "rh20_cargo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh20_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh20_instit"])){ 
       $sql  .= $virgula." rh20_instit = $this->rh20_instit ";
       $virgula = ",";
       if(trim((string) $this->rh20_instit) == null ){ 
         $this->erro_sql = " Campo Cod. Instituição nao Informado.";
         $this->erro_campo = "rh20_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh20_seqpes"]))
           $resac = db_query("insert into db_acount values($acount,1172,7090,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh20_seqpes'))."','$this->rh20_seqpes',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh20_cargo"]))
           $resac = db_query("insert into db_acount values($acount,1172,7091,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh20_cargo'))."','$this->rh20_cargo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh20_instit"]))
           $resac = db_query("insert into db_acount values($acount,1172,9916,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh20_instit'))."','$this->rh20_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh20_seqpes=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1172,7090,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh20_seqpes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1172,7091,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh20_cargo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1172,9916,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh20_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
   ...
   function sql_query_retorno ( $rh20_seqpes=null,$campos="*",$ordem=null,$dbwhere="",$anonovo = null,$mesnovo = null){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
