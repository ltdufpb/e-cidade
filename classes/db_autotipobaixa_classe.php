...
class cl_autotipobaixa { 
   ...
   function incluir ($y86_codautotipo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1113,6804,'','".AddSlashes(pg_fetch_result($resaco,0,'y86_codautotipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1113,6805,'','".AddSlashes(pg_fetch_result($resaco,0,'y86_codbaixaproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y86_codautotipo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y86_codautotipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y86_codautotipo"])){ 
       $sql  .= $virgula." y86_codautotipo = $this->y86_codautotipo ";
       $virgula = ",";
       if(trim((string) $this->y86_codautotipo) == null ){ 
     ...
     if(trim((string) $this->y86_codbaixaproc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y86_codbaixaproc"])){ 
       $sql  .= $virgula." y86_codbaixaproc = $this->y86_codbaixaproc ";
       $virgula = ",";
       if(trim((string) $this->y86_codbaixaproc) == null ){ 
         $this->erro_sql = " Campo Codigo da Baixa da Procedência do auto nao Informado.";
         $this->erro_campo = "y86_codbaixaproc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y86_codautotipo"]))
           $resac = db_query("insert into db_acount values($acount,1113,6804,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y86_codautotipo'))."','$this->y86_codautotipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y86_codbaixaproc"]))
           $resac = db_query("insert into db_acount values($acount,1113,6805,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y86_codbaixaproc'))."','$this->y86_codbaixaproc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y86_codautotipo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1113,6804,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y86_codautotipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1113,6805,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y86_codbaixaproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
