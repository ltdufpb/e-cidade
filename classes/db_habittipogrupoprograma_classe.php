...
class cl_habittipogrupoprograma { 
   ...
   public $ht02_sequencial = 0; 
   public $ht02_descricao = null; 
   public $ht02_obs = null; 
   public $ht02_datainicial_dia = null; 
   public $ht02_datainicial_mes = null; 
   public $ht02_datainicial_ano = null; 
   public $ht02_datainicial = null; 
   public $ht02_datafinal_dia = null; 
   public $ht02_datafinal_mes = null; 
   public $ht02_datafinal_ano = null; 
   public $ht02_datafinal = null; 
   ...
   function incluir ($ht02_sequencial){ 
     ...
     if($ht02_sequencial == "" || $ht02_sequencial == null ){
       ...
       $this->ht02_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from habittipogrupoprograma_ht02_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ht02_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2990,16951,'','".AddSlashes(pg_fetch_result($resaco,0,'ht02_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2990,16952,'','".AddSlashes(pg_fetch_result($resaco,0,'ht02_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2990,16953,'','".AddSlashes(pg_fetch_result($resaco,0,'ht02_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2990,16954,'','".AddSlashes(pg_fetch_result($resaco,0,'ht02_datainicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2990,16955,'','".AddSlashes(pg_fetch_result($resaco,0,'ht02_datafinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ht02_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ht02_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht02_sequencial"])){ 
       $sql  .= $virgula." ht02_sequencial = $this->ht02_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ht02_sequencial) == null ){ 
     ...
     if(trim((string) $this->ht02_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht02_descricao"])){ 
       $sql  .= $virgula." ht02_descricao = '$this->ht02_descricao' ";
       $virgula = ",";
       if(trim((string) $this->ht02_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "ht02_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ht02_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht02_obs"])){ 
       $sql  .= $virgula." ht02_obs = '$this->ht02_obs' ";
       $virgula = ",";
     }
     if(trim((string) $this->ht02_datainicial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht02_datainicial_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ht02_datainicial_dia"] !="") ){ 
     ...
     if(trim((string) $this->ht02_datafinal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht02_datafinal_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ht02_datafinal_dia"] !="") ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht02_sequencial"]) || $this->ht02_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2990,16951,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht02_sequencial'))."','$this->ht02_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht02_descricao"]) || $this->ht02_descricao != "")
           $resac = db_query("insert into db_acount values($acount,2990,16952,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht02_descricao'))."','$this->ht02_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht02_obs"]) || $this->ht02_obs != "")
           $resac = db_query("insert into db_acount values($acount,2990,16953,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht02_obs'))."','$this->ht02_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht02_datainicial"]) || $this->ht02_datainicial != "")
           $resac = db_query("insert into db_acount values($acount,2990,16954,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht02_datainicial'))."','$this->ht02_datainicial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht02_datafinal"]) || $this->ht02_datafinal != "")
           $resac = db_query("insert into db_acount values($acount,2990,16955,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht02_datafinal'))."','$this->ht02_datafinal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ht02_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2990,16951,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht02_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2990,16952,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht02_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2990,16953,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht02_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2990,16954,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht02_datainicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2990,16955,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht02_datafinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
