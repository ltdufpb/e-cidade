...
class cl_db_logsacessakey { 
   ...
   function incluir ($codsequen,$codcam){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,721,5063,'','".AddSlashes(pg_fetch_result($resaco,0,'codsequen'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,721,752,'','".AddSlashes(pg_fetch_result($resaco,0,'codcam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,721,5064,'','".AddSlashes(pg_fetch_result($resaco,0,'conteudocam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($codsequen=null,$codcam=null) { 
     ...
     if(trim((string) $this->conteudocam)!="" || isset($GLOBALS["HTTP_POST_VARS"]["conteudocam"])){ 
       $sql  .= $virgula." conteudocam = $this->conteudocam ";
       $virgula = ",";
       if(trim((string) $this->conteudocam) == null ){ 
         $this->erro_sql = " Campo Conteúdo do Campo nao Informado.";
         $this->erro_campo = "conteudocam";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["codsequen"]))
           $resac = db_query("insert into db_acount values($acount,721,5063,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'codsequen'))."','$this->codsequen',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["codcam"]))
           $resac = db_query("insert into db_acount values($acount,721,752,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'codcam'))."','$this->codcam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["conteudocam"]))
           $resac = db_query("insert into db_acount values($acount,721,5064,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'conteudocam'))."','$this->conteudocam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($codsequen=null,$codcam=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,721,5063,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'codsequen'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,721,752,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'codcam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,721,5064,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'conteudocam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
