...
class cl_db_versao { 
   ...
   var $campos = "
                 db30_codver = int4 = C�digo da Vers�o 
                 db30_codversao = int4 = N�mero da Release 
                 db30_codrelease = int4 = N�mero da Sub-Release 
                 db30_data = date = Data da Vers�o/Release 
                 db30_obs = text = Observa��o da Vers�o/Release 
                 ";
   ...
   function incluir ($db30_codver){ 
     ...
     if($this->db30_codversao == null ){ 
       $this->erro_sql = " Campo N�mero da Release nao Informado.";
     ...
     if($this->db30_codrelease == null ){ 
       $this->erro_sql = " Campo N�mero da Sub-Release nao Informado.";
     ...
     if($this->db30_data == null ){ 
       $this->erro_sql = " Campo Data da Vers�o/Release nao Informado.";
     ...
     if($this->db30_obs == null ){ 
       $this->erro_sql = " Campo Observa��o da Vers�o/Release nao Informado.";
     ...
     if($db30_codver == "" || $db30_codver == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $db30_codver)){
         $this->erro_sql = " Campo db30_codver maior que �ltimo n�mero da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Vers�o Atual ($this->db30_codver) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Vers�o Atual j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Vers�o Atual ($this->db30_codver) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($db30_codver=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Vers�o Atual nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->db30_codver;
       $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Vers�o Atual nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->db30_codver;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($db30_codver=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Vers�o Atual nao Exclu�do. Exclus�o Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Vers�o Atual nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$db30_codver;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
