...
class cl_db_versao { 
   ...
   public $db30_codver = 0; 
   public $db30_codversao = 0; 
   public $db30_codrelease = 0; 
   public $db30_data_dia = null; 
   public $db30_data_mes = null; 
   public $db30_data_ano = null; 
   public $db30_data = null; 
   public $db30_obs = null; 
   ...
   function incluir ($db30_codver){ 
     ...
     if($db30_codver == "" || $db30_codver == null ){
       ...
       $this->db30_codver = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_versao_db30_codver_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db30_codver)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,939,5867,'','".AddSlashes(pg_fetch_result($resaco,0,'db30_codver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,939,5868,'','".AddSlashes(pg_fetch_result($resaco,0,'db30_codversao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,939,5869,'','".AddSlashes(pg_fetch_result($resaco,0,'db30_codrelease'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,939,5870,'','".AddSlashes(pg_fetch_result($resaco,0,'db30_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,939,5871,'','".AddSlashes(pg_fetch_result($resaco,0,'db30_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db30_codver=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db30_codver)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db30_codver"])){ 
       $sql  .= $virgula." db30_codver = $this->db30_codver ";
       $virgula = ",";
       if(trim((string) $this->db30_codver) == null ){ 
     ...
     if(trim((string) $this->db30_codversao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db30_codversao"])){ 
       $sql  .= $virgula." db30_codversao = $this->db30_codversao ";
       $virgula = ",";
       if(trim((string) $this->db30_codversao) == null ){ 
         $this->erro_sql = " Campo Número da Release nao Informado.";
         $this->erro_campo = "db30_codversao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db30_codrelease)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db30_codrelease"])){ 
       $sql  .= $virgula." db30_codrelease = $this->db30_codrelease ";
       $virgula = ",";
       if(trim((string) $this->db30_codrelease) == null ){ 
         $this->erro_sql = " Campo Número da Sub-Release nao Informado.";
         $this->erro_campo = "db30_codrelease";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db30_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db30_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["db30_data_dia"] !="") ){ 
       $sql  .= $virgula." db30_data = '$this->db30_data' ";
       $virgula = ",";
       if(trim((string) $this->db30_data) == null ){ 
         $this->erro_sql = " Campo Data da Versão/Release nao Informado.";
         $this->erro_campo = "db30_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db30_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db30_obs"])){ 
       $sql  .= $virgula." db30_obs = '$this->db30_obs' ";
       $virgula = ",";
       if(trim((string) $this->db30_obs) == null ){ 
         $this->erro_sql = " Campo Observação da Versão/Release nao Informado.";
         $this->erro_campo = "db30_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db30_codver"]))
           $resac = db_query("insert into db_acount values($acount,939,5867,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db30_codver'))."','$this->db30_codver',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db30_codversao"]))
           $resac = db_query("insert into db_acount values($acount,939,5868,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db30_codversao'))."','$this->db30_codversao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db30_codrelease"]))
           $resac = db_query("insert into db_acount values($acount,939,5869,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db30_codrelease'))."','$this->db30_codrelease',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db30_data"]))
           $resac = db_query("insert into db_acount values($acount,939,5870,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db30_data'))."','$this->db30_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db30_obs"]))
           $resac = db_query("insert into db_acount values($acount,939,5871,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db30_obs'))."','$this->db30_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db30_codver=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,939,5867,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db30_codver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,939,5868,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db30_codversao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,939,5869,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db30_codrelease'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,939,5870,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db30_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,939,5871,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db30_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
