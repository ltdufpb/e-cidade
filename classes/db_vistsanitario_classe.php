...
class cl_vistsanitario { 
   ...
   function incluir ($y74_codvist){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,673,4913,'','".AddSlashes(pg_fetch_result($resaco,0,'y74_codvist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,673,4914,'','".AddSlashes(pg_fetch_result($resaco,0,'y74_codsani'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y74_codvist=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y74_codvist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y74_codvist"])){ 
       $sql  .= $virgula." y74_codvist = $this->y74_codvist ";
       $virgula = ",";
       if(trim((string) $this->y74_codvist) == null ){ 
     ...
     if(trim((string) $this->y74_codsani)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y74_codsani"])){ 
       $sql  .= $virgula." y74_codsani = $this->y74_codsani ";
       $virgula = ",";
       if(trim((string) $this->y74_codsani) == null ){ 
         $this->erro_sql = " Campo Código do Alvará sanitário nao Informado.";
         $this->erro_campo = "y74_codsani";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y74_codvist"]))
           $resac = db_query("insert into db_acount values($acount,673,4913,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y74_codvist'))."','$this->y74_codvist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y74_codsani"]))
           $resac = db_query("insert into db_acount values($acount,673,4914,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y74_codsani'))."','$this->y74_codsani',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y74_codvist=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,673,4913,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y74_codvist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,673,4914,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y74_codsani'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
