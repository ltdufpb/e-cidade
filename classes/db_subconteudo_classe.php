...
class cl_subconteudo { 
   ...
   public $ed239_i_codigo = 0; 
   public $ed239_c_descr = null; 
   public $ed239_i_conteudo = 0; 
   ...
   function incluir ($ed239_i_codigo){ 
     ...
     if($ed239_i_codigo == "" || $ed239_i_codigo == null ){
       ...
       $this->ed239_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from subconteudo_ed239_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed239_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2034,11775,'','".AddSlashes(pg_fetch_result($resaco,0,'ed239_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2034,11776,'','".AddSlashes(pg_fetch_result($resaco,0,'ed239_c_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2034,11791,'','".AddSlashes(pg_fetch_result($resaco,0,'ed239_i_conteudo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed239_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed239_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed239_i_codigo"])){ 
       $sql  .= $virgula." ed239_i_codigo = $this->ed239_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed239_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed239_c_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed239_c_descr"])){ 
       $sql  .= $virgula." ed239_c_descr = '$this->ed239_c_descr' ";
       $virgula = ",";
       if(trim((string) $this->ed239_c_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "ed239_c_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed239_i_conteudo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed239_i_conteudo"])){ 
       $sql  .= $virgula." ed239_i_conteudo = $this->ed239_i_conteudo ";
       $virgula = ",";
       if(trim((string) $this->ed239_i_conteudo) == null ){ 
         $this->erro_sql = " Campo Conteúdo nao Informado.";
         $this->erro_campo = "ed239_i_conteudo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed239_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2034,11775,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed239_i_codigo'))."','$this->ed239_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed239_c_descr"]))
           $resac = db_query("insert into db_acount values($acount,2034,11776,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed239_c_descr'))."','$this->ed239_c_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed239_i_conteudo"]))
           $resac = db_query("insert into db_acount values($acount,2034,11791,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed239_i_conteudo'))."','$this->ed239_i_conteudo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed239_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2034,11775,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed239_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2034,11776,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed239_c_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2034,11791,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed239_i_conteudo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
