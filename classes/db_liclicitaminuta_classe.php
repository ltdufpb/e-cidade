...
class cl_liclicitaminuta { 
   ...
   public $l43_sequencial = 0; 
   public $l43_arquivo = 0; 
   public $l43_arqnome = null; 
   public $l43_liclicita = 0; 
   ...
   function incluir ($l43_sequencial){ 
     ...
     if($l43_sequencial == "" || $l43_sequencial == null ){
       ...
       $this->l43_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from liclicitaminuta_l43_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $l43_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3062,17289,'','".AddSlashes(pg_fetch_result($resaco,0,'l43_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3062,17291,'','".AddSlashes(pg_fetch_result($resaco,0,'l43_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3062,17293,'','".AddSlashes(pg_fetch_result($resaco,0,'l43_arqnome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3062,17294,'','".AddSlashes(pg_fetch_result($resaco,0,'l43_liclicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($l43_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->l43_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l43_sequencial"])){ 
       $sql  .= $virgula." l43_sequencial = $this->l43_sequencial ";
       $virgula = ",";
       if(trim((string) $this->l43_sequencial) == null ){ 
     ...
     if(trim((string) $this->l43_arquivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l43_arquivo"])){ 
       $sql  .= $virgula." l43_arquivo = $this->l43_arquivo ";
       $virgula = ",";
       if(trim((string) $this->l43_arquivo) == null ){ 
         $this->erro_sql = " Campo Arquivo nao Informado.";
         $this->erro_campo = "l43_arquivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l43_arqnome)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l43_arqnome"])){ 
       $sql  .= $virgula." l43_arqnome = '$this->l43_arqnome' ";
       $virgula = ",";
       if(trim((string) $this->l43_arqnome) == null ){ 
         $this->erro_sql = " Campo Nome do Arquivo nao Informado.";
         $this->erro_campo = "l43_arqnome";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l43_liclicita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l43_liclicita"])){ 
       $sql  .= $virgula." l43_liclicita = $this->l43_liclicita ";
       $virgula = ",";
       if(trim((string) $this->l43_liclicita) == null ){ 
         $this->erro_sql = " Campo Licitação nao Informado.";
         $this->erro_campo = "l43_liclicita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["l43_sequencial"]) || $this->l43_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3062,17289,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l43_sequencial'))."','$this->l43_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l43_arquivo"]) || $this->l43_arquivo != "")
           $resac = db_query("insert into db_acount values($acount,3062,17291,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l43_arquivo'))."','$this->l43_arquivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l43_arqnome"]) || $this->l43_arqnome != "")
           $resac = db_query("insert into db_acount values($acount,3062,17293,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l43_arqnome'))."','$this->l43_arqnome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l43_liclicita"]) || $this->l43_liclicita != "")
           $resac = db_query("insert into db_acount values($acount,3062,17294,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l43_liclicita'))."','$this->l43_liclicita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($l43_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3062,17289,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l43_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3062,17291,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l43_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3062,17293,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l43_arqnome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3062,17294,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l43_liclicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
