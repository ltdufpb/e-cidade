...
class cl_agrupamentorubricarubrica { 
   ...
   public $rh114_sequencial = 0; 
   public $rh114_agrupamentorubrica = 0; 
   public $rh114_rubrica = null; 
   public $rh114_instituicao = 0; 
   ...
   function incluir ($rh114_sequencial){ 
     ...
     if($rh114_sequencial == "" || $rh114_sequencial == null ){
       ...
       $this->rh114_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from agrupamentorubricarubrica_rh114_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh114_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3479,19563,'','".AddSlashes(pg_fetch_result($resaco,0,'rh114_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3479,19565,'','".AddSlashes(pg_fetch_result($resaco,0,'rh114_agrupamentorubrica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3479,19566,'','".AddSlashes(pg_fetch_result($resaco,0,'rh114_rubrica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3479,19567,'','".AddSlashes(pg_fetch_result($resaco,0,'rh114_instituicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh114_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh114_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh114_sequencial"])){ 
       $sql  .= $virgula." rh114_sequencial = $this->rh114_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh114_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh114_agrupamentorubrica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh114_agrupamentorubrica"])){ 
       $sql  .= $virgula." rh114_agrupamentorubrica = $this->rh114_agrupamentorubrica ";
       $virgula = ",";
       if(trim((string) $this->rh114_agrupamentorubrica) == null ){ 
         $this->erro_sql = " Campo Agrupamento Rubrica nao Informado.";
         $this->erro_campo = "rh114_agrupamentorubrica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh114_rubrica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh114_rubrica"])){ 
       $sql  .= $virgula." rh114_rubrica = '$this->rh114_rubrica' ";
       $virgula = ",";
       if(trim((string) $this->rh114_rubrica) == null ){ 
         $this->erro_sql = " Campo Rubrica nao Informado.";
         $this->erro_campo = "rh114_rubrica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh114_instituicao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh114_instituicao"])){ 
       $sql  .= $virgula." rh114_instituicao = $this->rh114_instituicao ";
       $virgula = ",";
       if(trim((string) $this->rh114_instituicao) == null ){ 
         $this->erro_sql = " Campo Instituição nao Informado.";
         $this->erro_campo = "rh114_instituicao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh114_sequencial"]) || $this->rh114_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3479,19563,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh114_sequencial'))."','$this->rh114_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh114_agrupamentorubrica"]) || $this->rh114_agrupamentorubrica != "")
           $resac = db_query("insert into db_acount values($acount,3479,19565,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh114_agrupamentorubrica'))."','$this->rh114_agrupamentorubrica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh114_rubrica"]) || $this->rh114_rubrica != "")
           $resac = db_query("insert into db_acount values($acount,3479,19566,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh114_rubrica'))."','$this->rh114_rubrica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh114_instituicao"]) || $this->rh114_instituicao != "")
           $resac = db_query("insert into db_acount values($acount,3479,19567,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh114_instituicao'))."','$this->rh114_instituicao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh114_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3479,19563,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh114_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3479,19565,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh114_agrupamentorubrica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3479,19566,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh114_rubrica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3479,19567,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh114_instituicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
