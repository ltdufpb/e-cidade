...
class cl_custoplanoanalitica { 
   ...
   public $cc04_sequencial = 0; 
   public $cc04_coddepto = 0; 
   public $cc04_custoplano = 0; 
   ...
   function incluir ($cc04_sequencial){ 
     ...
     if($cc04_sequencial == "" || $cc04_sequencial == null ){
       ...
       $this->cc04_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from custoplanoanalitica_cc04_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $cc04_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2194,12572,'','".AddSlashes(pg_fetch_result($resaco,0,'cc04_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2194,13288,'','".AddSlashes(pg_fetch_result($resaco,0,'cc04_coddepto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2194,12573,'','".AddSlashes(pg_fetch_result($resaco,0,'cc04_custoplano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($cc04_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->cc04_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc04_sequencial"])){ 
       $sql  .= $virgula." cc04_sequencial = $this->cc04_sequencial ";
       $virgula = ",";
       if(trim((string) $this->cc04_sequencial) == null ){ 
     ...
     if(trim((string) $this->cc04_coddepto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc04_coddepto"])){ 
       $sql  .= $virgula." cc04_coddepto = $this->cc04_coddepto ";
       $virgula = ",";
       if(trim((string) $this->cc04_coddepto) == null ){ 
         $this->erro_sql = " Campo Depart. nao Informado.";
         $this->erro_campo = "cc04_coddepto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cc04_custoplano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc04_custoplano"])){ 
       $sql  .= $virgula." cc04_custoplano = $this->cc04_custoplano ";
       $virgula = ",";
       if(trim((string) $this->cc04_custoplano) == null ){
         $this->erro_sql = " Campo Custo Plano nao Informado.";
         $this->erro_campo = "cc04_custoplano";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc04_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2194,12572,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc04_sequencial'))."','$this->cc04_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc04_coddepto"]))
           $resac = db_query("insert into db_acount values($acount,2194,13288,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc04_coddepto'))."','$this->cc04_coddepto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc04_custoplano"]))
           $resac = db_query("insert into db_acount values($acount,2194,12573,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc04_custoplano'))."','$this->cc04_custoplano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($cc04_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2194,12572,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc04_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2194,13288,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc04_coddepto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2194,12573,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc04_custoplano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
