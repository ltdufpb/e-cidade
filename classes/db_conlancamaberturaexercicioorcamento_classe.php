...
class cl_conlancamaberturaexercicioorcamento {
   ...
   public $c105_sequencial = 0;
   public $c105_codlan = 0;
   public $c105_aberturaexercicioorcamento = 0;
   ...
   function incluir ($c105_sequencial){
     ...
     if($c105_sequencial == "" || $c105_sequencial == null ){
       ...
       $this->c105_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from conlancamaberturaexercicioorcamento_c105_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $c105_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3465,19497,'','".AddSlashes(pg_fetch_result($resaco,0,'c105_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3465,19498,'','".AddSlashes(pg_fetch_result($resaco,0,'c105_codlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3465,19499,'','".AddSlashes(pg_fetch_result($resaco,0,'c105_aberturaexercicioorcamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($c105_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->c105_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c105_sequencial"])){
       $sql  .= $virgula." c105_sequencial = $this->c105_sequencial ";
       $virgula = ",";
       if(trim((string) $this->c105_sequencial) == null ){
         $this->erro_sql = " Campo Sequencial nao Informado.";
     ...
     if(trim((string) $this->c105_codlan)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c105_codlan"])){
       $sql  .= $virgula." c105_codlan = $this->c105_codlan ";
       $virgula = ",";
       if(trim((string) $this->c105_codlan) == null ){
         $this->erro_sql = " Campo Código Lançamento nao Informado.";
         $this->erro_campo = "c105_codlan";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c105_aberturaexercicioorcamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c105_aberturaexercicioorcamento"])){
       $sql  .= $virgula." c105_aberturaexercicioorcamento = $this->c105_aberturaexercicioorcamento ";
       $virgula = ",";
       if(trim((string) $this->c105_aberturaexercicioorcamento) == null ){
         $this->erro_sql = " Campo Sequencial nao Informado.";
         $this->erro_campo = "c105_aberturaexercicioorcamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c105_sequencial"]) || $this->c105_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3465,19497,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c105_sequencial'))."','$this->c105_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c105_codlan"]) || $this->c105_codlan != "")
           $resac = db_query("insert into db_acount values($acount,3465,19498,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c105_codlan'))."','$this->c105_codlan',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c105_aberturaexercicioorcamento"]) || $this->c105_aberturaexercicioorcamento != "")
           $resac = db_query("insert into db_acount values($acount,3465,19499,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c105_aberturaexercicioorcamento'))."','$this->c105_aberturaexercicioorcamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($c105_sequencial=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3465,19497,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c105_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3465,19498,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c105_codlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3465,19499,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c105_aberturaexercicioorcamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
