...
class cl_acordoacordogarantia { 
   ...
   public $ac12_sequencial = 0; 
   public $ac12_acordo = 0; 
   public $ac12_acordogarantia = 0; 
   public $ac12_texto = null; 
   ...
   function incluir ($ac12_sequencial){ 
     ...
     if($ac12_sequencial == "" || $ac12_sequencial == null ){
       ...
       $this->ac12_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordoacordogarantia_ac12_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac12_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2827,16112,'','".AddSlashes(pg_fetch_result($resaco,0,'ac12_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2827,16113,'','".AddSlashes(pg_fetch_result($resaco,0,'ac12_acordo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2827,16114,'','".AddSlashes(pg_fetch_result($resaco,0,'ac12_acordogarantia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2827,16115,'','".AddSlashes(pg_fetch_result($resaco,0,'ac12_texto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac12_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac12_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac12_sequencial"])){ 
       $sql  .= $virgula." ac12_sequencial = $this->ac12_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac12_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac12_acordo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac12_acordo"])){ 
       $sql  .= $virgula." ac12_acordo = $this->ac12_acordo ";
       $virgula = ",";
       if(trim((string) $this->ac12_acordo) == null ){ 
         $this->erro_sql = " Campo Acordo nao Informado.";
         $this->erro_campo = "ac12_acordo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac12_acordogarantia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac12_acordogarantia"])){ 
       $sql  .= $virgula." ac12_acordogarantia = $this->ac12_acordogarantia ";
       $virgula = ",";
       if(trim((string) $this->ac12_acordogarantia) == null ){ 
         $this->erro_sql = " Campo Acordo Garantia nao Informado.";
         $this->erro_campo = "ac12_acordogarantia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac12_texto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac12_texto"])){ 
       $sql  .= $virgula." ac12_texto = '$this->ac12_texto' ";
       $virgula = ",";
       if(trim((string) $this->ac12_texto) == null ){ 
         $this->erro_sql = " Campo Texto nao Informado.";
         $this->erro_campo = "ac12_texto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac12_sequencial"]) || $this->ac12_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2827,16112,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac12_sequencial'))."','$this->ac12_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac12_acordo"]) || $this->ac12_acordo != "")
           $resac = db_query("insert into db_acount values($acount,2827,16113,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac12_acordo'))."','$this->ac12_acordo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac12_acordogarantia"]) || $this->ac12_acordogarantia != "")
           $resac = db_query("insert into db_acount values($acount,2827,16114,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac12_acordogarantia'))."','$this->ac12_acordogarantia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac12_texto"]) || $this->ac12_texto != "")
           $resac = db_query("insert into db_acount values($acount,2827,16115,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac12_texto'))."','$this->ac12_texto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac12_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2827,16112,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac12_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2827,16113,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac12_acordo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2827,16114,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac12_acordogarantia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2827,16115,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac12_texto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
