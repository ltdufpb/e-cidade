...
class cl_vistoriaandam { 
   ...
   function incluir ($y68_codvist,$y68_codandam){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,677,4923,'','".AddSlashes(pg_fetch_result($resaco,0,'y68_codvist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,677,4932,'','".AddSlashes(pg_fetch_result($resaco,0,'y68_codandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y68_codvist=null,$y68_codandam=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y68_codvist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y68_codvist"])){ 
       $sql  .= $virgula." y68_codvist = $this->y68_codvist ";
       $virgula = ",";
       if(trim((string) $this->y68_codvist) == null ){ 
     ...
     if(trim((string) $this->y68_codandam)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y68_codandam"])){ 
       $sql  .= $virgula." y68_codandam = $this->y68_codandam ";
       $virgula = ",";
       if(trim((string) $this->y68_codandam) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y68_codvist"]))
           $resac = db_query("insert into db_acount values($acount,677,4923,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y68_codvist'))."','$this->y68_codvist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y68_codandam"]))
           $resac = db_query("insert into db_acount values($acount,677,4932,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y68_codandam'))."','$this->y68_codandam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y68_codvist=null,$y68_codandam=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,677,4923,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y68_codvist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,677,4932,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y68_codandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
