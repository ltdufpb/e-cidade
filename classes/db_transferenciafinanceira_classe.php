...
class cl_transferenciafinanceira { 
   ...
   public $k150_sequencial = 0; 
   public $k150_slip = 0; 
   public $k150_instituicao = 0; 
   ...
   function incluir ($k150_sequencial){ 
     ...
     if($k150_sequencial == "" || $k150_sequencial == null ){
       ...
       $this->k150_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from transferenciafinanceira_k150_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k150_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3414,19226,'','".AddSlashes(pg_fetch_result($resaco,0,'k150_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3414,19227,'','".AddSlashes(pg_fetch_result($resaco,0,'k150_slip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3414,19228,'','".AddSlashes(pg_fetch_result($resaco,0,'k150_instituicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k150_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k150_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k150_sequencial"])){ 
       $sql  .= $virgula." k150_sequencial = $this->k150_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k150_sequencial) == null ){ 
     ...
     if(trim((string) $this->k150_slip)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k150_slip"])){ 
       $sql  .= $virgula." k150_slip = $this->k150_slip ";
       $virgula = ",";
       if(trim((string) $this->k150_slip) == null ){ 
         $this->erro_sql = " Campo Código Slip nao Informado.";
         $this->erro_campo = "k150_slip";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k150_instituicao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k150_instituicao"])){ 
       $sql  .= $virgula." k150_instituicao = $this->k150_instituicao ";
       $virgula = ",";
       if(trim((string) $this->k150_instituicao) == null ){ 
         $this->erro_sql = " Campo Código da Instituição nao Informado.";
         $this->erro_campo = "k150_instituicao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k150_sequencial"]) || $this->k150_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3414,19226,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k150_sequencial'))."','$this->k150_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k150_slip"]) || $this->k150_slip != "")
           $resac = db_query("insert into db_acount values($acount,3414,19227,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k150_slip'))."','$this->k150_slip',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k150_instituicao"]) || $this->k150_instituicao != "")
           $resac = db_query("insert into db_acount values($acount,3414,19228,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k150_instituicao'))."','$this->k150_instituicao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k150_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3414,19226,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k150_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3414,19227,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k150_slip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3414,19228,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k150_instituicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
