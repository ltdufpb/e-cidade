...
class cl_iptutabelasconfigcampocorrecao { 
   ...
   public $j123_sequencial = 0; 
   public $j123_codcam = 0; 
   public $j123_iptutabelasconfig = 0; 
   ...
   function incluir ($j123_sequencial){ 
     ...
     if($j123_sequencial == "" || $j123_sequencial == null ){
       ...
       $this->j123_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from iptutabelasconfigcampocorrecao_j123_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $j123_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3079,17398,'','".AddSlashes(pg_fetch_result($resaco,0,'j123_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3079,17399,'','".AddSlashes(pg_fetch_result($resaco,0,'j123_codcam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3079,17400,'','".AddSlashes(pg_fetch_result($resaco,0,'j123_iptutabelasconfig'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j123_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j123_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j123_sequencial"])){ 
       $sql  .= $virgula." j123_sequencial = $this->j123_sequencial ";
       $virgula = ",";
       if(trim((string) $this->j123_sequencial) == null ){ 
     ...
     if(trim((string) $this->j123_codcam)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j123_codcam"])){ 
       $sql  .= $virgula." j123_codcam = $this->j123_codcam ";
       $virgula = ",";
       if(trim((string) $this->j123_codcam) == null ){ 
         $this->erro_sql = " Campo Código do Campo nao Informado.";
         $this->erro_campo = "j123_codcam";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j123_iptutabelasconfig)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j123_iptutabelasconfig"])){ 
       $sql  .= $virgula." j123_iptutabelasconfig = $this->j123_iptutabelasconfig ";
       $virgula = ",";
       if(trim((string) $this->j123_iptutabelasconfig) == null ){ 
         $this->erro_sql = " Campo Código da Tabela de Configuração nao Informado.";
         $this->erro_campo = "j123_iptutabelasconfig";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j123_sequencial"]) || $this->j123_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3079,17398,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j123_sequencial'))."','$this->j123_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j123_codcam"]) || $this->j123_codcam != "")
           $resac = db_query("insert into db_acount values($acount,3079,17399,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j123_codcam'))."','$this->j123_codcam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j123_iptutabelasconfig"]) || $this->j123_iptutabelasconfig != "")
           $resac = db_query("insert into db_acount values($acount,3079,17400,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j123_iptutabelasconfig'))."','$this->j123_iptutabelasconfig',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j123_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3079,17398,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j123_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3079,17399,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j123_codcam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3079,17400,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j123_iptutabelasconfig'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
