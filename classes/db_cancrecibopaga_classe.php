...
class cl_cancrecibopaga { 
   ...
   public $k134_sequencial = 0; 
   public $k134_numnov = 0; 
   public $k134_motivo = null; 
   public $k134_usuario = 0; 
   public $k134_data_dia = null; 
   public $k134_data_mes = null; 
   public $k134_data_ano = null; 
   public $k134_data = null; 
   ...
   function incluir ($k134_sequencial){ 
     ...
     if($k134_sequencial == "" || $k134_sequencial == null ){
       ...
       $this->k134_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cancrecibopaga_k134_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k134_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3254,18380,'','".AddSlashes(pg_fetch_result($resaco,0,'k134_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3254,18381,'','".AddSlashes(pg_fetch_result($resaco,0,'k134_numnov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3254,18382,'','".AddSlashes(pg_fetch_result($resaco,0,'k134_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3254,18383,'','".AddSlashes(pg_fetch_result($resaco,0,'k134_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3254,18384,'','".AddSlashes(pg_fetch_result($resaco,0,'k134_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k134_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k134_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k134_sequencial"])){ 
       $sql  .= $virgula." k134_sequencial = $this->k134_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k134_sequencial) == null ){ 
     ...
     if(trim((string) $this->k134_numnov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k134_numnov"])){ 
       $sql  .= $virgula." k134_numnov = $this->k134_numnov ";
       $virgula = ",";
       if(trim((string) $this->k134_numnov) == null ){ 
         $this->erro_sql = " Campo Numnov nao Informado.";
         $this->erro_campo = "k134_numnov";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k134_motivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k134_motivo"])){ 
       $sql  .= $virgula." k134_motivo = '$this->k134_motivo' ";
       $virgula = ",";
       if(trim((string) $this->k134_motivo) == null ){ 
         $this->erro_sql = " Campo Motivo nao Informado.";
         $this->erro_campo = "k134_motivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k134_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k134_usuario"])){ 
       $sql  .= $virgula." k134_usuario = $this->k134_usuario ";
       $virgula = ",";
       if(trim((string) $this->k134_usuario) == null ){ 
         $this->erro_sql = " Campo Usuario nao Informado.";
         $this->erro_campo = "k134_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k134_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k134_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["k134_data_dia"] !="") ){ 
       $sql  .= $virgula." k134_data = '$this->k134_data' ";
       $virgula = ",";
       if(trim((string) $this->k134_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "k134_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k134_sequencial"]) || $this->k134_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3254,18380,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k134_sequencial'))."','$this->k134_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k134_numnov"]) || $this->k134_numnov != "")
           $resac = db_query("insert into db_acount values($acount,3254,18381,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k134_numnov'))."','$this->k134_numnov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k134_motivo"]) || $this->k134_motivo != "")
           $resac = db_query("insert into db_acount values($acount,3254,18382,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k134_motivo'))."','$this->k134_motivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k134_usuario"]) || $this->k134_usuario != "")
           $resac = db_query("insert into db_acount values($acount,3254,18383,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k134_usuario'))."','$this->k134_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k134_data"]) || $this->k134_data != "")
           $resac = db_query("insert into db_acount values($acount,3254,18384,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k134_data'))."','$this->k134_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k134_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3254,18380,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k134_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3254,18381,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k134_numnov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3254,18382,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k134_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3254,18383,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k134_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3254,18384,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k134_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
