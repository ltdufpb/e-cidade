...
class cl_gestorgrupoindicador { 
   ...
   public $g03_sequencial = 0; 
   public $g03_descricao = null; 
   public $g03_datalimite_dia = null; 
   public $g03_datalimite_mes = null; 
   public $g03_datalimite_ano = null; 
   public $g03_datalimite = null; 
   public $g03_projeto = null; 
   ...
   function incluir ($g03_sequencial){ 
     ...
     if($g03_sequencial == "" || $g03_sequencial == null ){
       ...
       $this->g03_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from gestorgrupoindicador_g03_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $g03_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2816,16048,'','".AddSlashes(pg_fetch_result($resaco,0,'g03_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2816,16049,'','".AddSlashes(pg_fetch_result($resaco,0,'g03_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2816,16050,'','".AddSlashes(pg_fetch_result($resaco,0,'g03_datalimite'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2816,18466,'','".AddSlashes(pg_fetch_result($resaco,0,'g03_projeto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($g03_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->g03_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["g03_sequencial"])){ 
       $sql  .= $virgula." g03_sequencial = $this->g03_sequencial ";
       $virgula = ",";
       if(trim((string) $this->g03_sequencial) == null ){ 
     ...
     if(trim((string) $this->g03_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["g03_descricao"])){ 
       $sql  .= $virgula." g03_descricao = '$this->g03_descricao' ";
       $virgula = ",";
       if(trim((string) $this->g03_descricao) == null ){ 
         $this->erro_sql = " Campo Descricao do Grupo nao Informado.";
         $this->erro_campo = "g03_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->g03_datalimite)!="" || isset($GLOBALS["HTTP_POST_VARS"]["g03_datalimite_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["g03_datalimite_dia"] !="") ){ 
     ...
     if(trim((string) $this->g03_projeto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["g03_projeto"])){ 
       $sql  .= $virgula." g03_projeto = '$this->g03_projeto' ";
       $virgula = ",";
       if(trim((string) $this->g03_projeto) == null ){ 
         $this->erro_sql = " Campo Projeto nao Informado.";
         $this->erro_campo = "g03_projeto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["g03_sequencial"]) || $this->g03_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2816,16048,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'g03_sequencial'))."','$this->g03_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["g03_descricao"]) || $this->g03_descricao != "")
           $resac = db_query("insert into db_acount values($acount,2816,16049,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'g03_descricao'))."','$this->g03_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["g03_datalimite"]) || $this->g03_datalimite != "")
           $resac = db_query("insert into db_acount values($acount,2816,16050,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'g03_datalimite'))."','$this->g03_datalimite',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["g03_projeto"]) || $this->g03_projeto != "")
           $resac = db_query("insert into db_acount values($acount,2816,18466,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'g03_projeto'))."','$this->g03_projeto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($g03_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2816,16048,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'g03_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2816,16049,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'g03_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2816,16050,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'g03_datalimite'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2816,18466,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'g03_projeto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
