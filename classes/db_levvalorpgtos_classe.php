...
class cl_levvalorpgtos { 
   ...
   function incluir ($y68_sequencia,$y68_seq){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,726,5099,'','".AddSlashes(pg_fetch_result($resaco,0,'y68_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,726,5100,'','".AddSlashes(pg_fetch_result($resaco,0,'y68_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,726,5101,'','".AddSlashes(pg_fetch_result($resaco,0,'y68_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,726,5102,'','".AddSlashes(pg_fetch_result($resaco,0,'y68_pgto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y68_sequencia=null,$y68_seq=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y68_sequencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y68_sequencia"])){ 
       $sql  .= $virgula." y68_sequencia = $this->y68_sequencia ";
       $virgula = ",";
       if(trim((string) $this->y68_sequencia) == null ){ 
     ...
     if(trim((string) $this->y68_seq)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y68_seq"])){ 
       $sql  .= $virgula." y68_seq = $this->y68_seq ";
       $virgula = ",";
       if(trim((string) $this->y68_seq) == null ){ 
     ...
     if(trim((string) $this->y68_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y68_valor"])){ 
       $sql  .= $virgula." y68_valor = $this->y68_valor ";
       $virgula = ",";
       if(trim((string) $this->y68_valor) == null ){ 
         $this->erro_sql = " Campo Valor nao Informado.";
         $this->erro_campo = "y68_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y68_pgto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y68_pgto_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["y68_pgto_dia"] !="") ){ 
       $sql  .= $virgula." y68_pgto = '$this->y68_pgto' ";
       $virgula = ",";
       if(trim((string) $this->y68_pgto) == null ){ 
         $this->erro_sql = " Campo Pagamento nao Informado.";
         $this->erro_campo = "y68_pgto_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y68_sequencia"]))
           $resac = db_query("insert into db_acount values($acount,726,5099,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y68_sequencia'))."','$this->y68_sequencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y68_seq"]))
           $resac = db_query("insert into db_acount values($acount,726,5100,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y68_seq'))."','$this->y68_seq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y68_valor"]))
           $resac = db_query("insert into db_acount values($acount,726,5101,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y68_valor'))."','$this->y68_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y68_pgto"]))
           $resac = db_query("insert into db_acount values($acount,726,5102,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y68_pgto'))."','$this->y68_pgto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y68_sequencia=null,$y68_seq=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,726,5099,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y68_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,726,5100,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y68_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,726,5101,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y68_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,726,5102,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y68_pgto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
