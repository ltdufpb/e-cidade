...
class cl_progsuspdisc { 
   ...
   public $ed119_i_codigo = 0; 
   public $ed119_i_progmatricula = 0; 
   public $ed119_i_usuario = 0; 
   public $ed119_d_data_dia = null; 
   public $ed119_d_data_mes = null; 
   public $ed119_d_data_ano = null; 
   public $ed119_d_data = null; 
   public $ed119_t_obs = null; 
   ...
   function incluir ($ed119_i_codigo){ 
     ...
     if($ed119_i_codigo == "" || $ed119_i_codigo == null ){
       ...
       $this->ed119_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from progsuspdisc_ed119_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed119_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010175,1009123,'','".AddSlashes(pg_fetch_result($resaco,0,'ed119_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010175,1009124,'','".AddSlashes(pg_fetch_result($resaco,0,'ed119_i_progmatricula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010175,1009125,'','".AddSlashes(pg_fetch_result($resaco,0,'ed119_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010175,1009126,'','".AddSlashes(pg_fetch_result($resaco,0,'ed119_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010175,1009127,'','".AddSlashes(pg_fetch_result($resaco,0,'ed119_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed119_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed119_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed119_i_codigo"])){ 
       $sql  .= $virgula." ed119_i_codigo = $this->ed119_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed119_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed119_i_progmatricula)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed119_i_progmatricula"])){ 
       $sql  .= $virgula." ed119_i_progmatricula = $this->ed119_i_progmatricula ";
       $virgula = ",";
       if(trim((string) $this->ed119_i_progmatricula) == null ){ 
         $this->erro_sql = " Campo Matrícula nao Informado.";
         $this->erro_campo = "ed119_i_progmatricula";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed119_i_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed119_i_usuario"])){ 
       $sql  .= $virgula." ed119_i_usuario = $this->ed119_i_usuario ";
       $virgula = ",";
       if(trim((string) $this->ed119_i_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "ed119_i_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed119_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed119_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed119_d_data_dia"] !="") ){ 
       $sql  .= $virgula." ed119_d_data = '$this->ed119_d_data' ";
       $virgula = ",";
       if(trim((string) $this->ed119_d_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "ed119_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed119_t_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed119_t_obs"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed119_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010175,1009123,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed119_i_codigo'))."','$this->ed119_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed119_i_progmatricula"]))
           $resac = db_query("insert into db_acount values($acount,1010175,1009124,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed119_i_progmatricula'))."','$this->ed119_i_progmatricula',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed119_i_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1010175,1009125,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed119_i_usuario'))."','$this->ed119_i_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed119_d_data"]))
           $resac = db_query("insert into db_acount values($acount,1010175,1009126,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed119_d_data'))."','$this->ed119_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed119_t_obs"]))
           $resac = db_query("insert into db_acount values($acount,1010175,1009127,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed119_t_obs'))."','$this->ed119_t_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed119_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010175,1009123,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed119_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010175,1009124,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed119_i_progmatricula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010175,1009125,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed119_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010175,1009126,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed119_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010175,1009127,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed119_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
