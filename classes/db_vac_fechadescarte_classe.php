...
class cl_vac_fechadescarte { 
   ...
   public $vc22_i_codigo = 0; 
   public $vc22_i_fechamento = 0; 
   public $vc22_i_descarte = 0; 
   ...
   function incluir ($vc22_i_codigo){ 
     ...
     if($vc22_i_codigo == "" || $vc22_i_codigo == null ){
       ...
       $this->vc22_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from vac_fechadescarte_vc22_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $vc22_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3095,17517,'','".AddSlashes(pg_fetch_result($resaco,0,'vc22_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3095,17518,'','".AddSlashes(pg_fetch_result($resaco,0,'vc22_i_fechamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3095,17519,'','".AddSlashes(pg_fetch_result($resaco,0,'vc22_i_descarte'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($vc22_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->vc22_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc22_i_codigo"])){ 
       $sql  .= $virgula." vc22_i_codigo = $this->vc22_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->vc22_i_codigo) == null ){ 
     ...
     if(trim((string) $this->vc22_i_fechamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc22_i_fechamento"])){ 
       $sql  .= $virgula." vc22_i_fechamento = $this->vc22_i_fechamento ";
       $virgula = ",";
       if(trim((string) $this->vc22_i_fechamento) == null ){ 
         $this->erro_sql = " Campo Fechamento nao Informado.";
         $this->erro_campo = "vc22_i_fechamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc22_i_descarte)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc22_i_descarte"])){ 
       $sql  .= $virgula." vc22_i_descarte = $this->vc22_i_descarte ";
       $virgula = ",";
       if(trim((string) $this->vc22_i_descarte) == null ){ 
         $this->erro_sql = " Campo Descarte nao Informado.";
         $this->erro_campo = "vc22_i_descarte";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc22_i_codigo"]) || $this->vc22_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3095,17517,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc22_i_codigo'))."','$this->vc22_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc22_i_fechamento"]) || $this->vc22_i_fechamento != "")
           $resac = db_query("insert into db_acount values($acount,3095,17518,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc22_i_fechamento'))."','$this->vc22_i_fechamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc22_i_descarte"]) || $this->vc22_i_descarte != "")
           $resac = db_query("insert into db_acount values($acount,3095,17519,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc22_i_descarte'))."','$this->vc22_i_descarte',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($vc22_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3095,17517,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc22_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3095,17518,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc22_i_fechamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3095,17519,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc22_i_descarte'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
