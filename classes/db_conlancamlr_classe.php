...
class cl_conlancamlr { 
   ...
   function incluir ($c81_sequen,$c81_seqtranslr){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,967,6032,'','".AddSlashes(pg_fetch_result($resaco,0,'c81_sequen'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,967,6033,'','".AddSlashes(pg_fetch_result($resaco,0,'c81_seqtranslr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($c81_sequen=null,$c81_seqtranslr=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->c81_sequen)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c81_sequen"])){ 
       $sql  .= $virgula." c81_sequen = $this->c81_sequen ";
       $virgula = ",";
       if(trim((string) $this->c81_sequen) == null ){ 
     ...
     if(trim((string) $this->c81_seqtranslr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c81_seqtranslr"])){ 
       $sql  .= $virgula." c81_seqtranslr = $this->c81_seqtranslr ";
       $virgula = ",";
       if(trim((string) $this->c81_seqtranslr) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c81_sequen"]))
           $resac = db_query("insert into db_acount values($acount,967,6032,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c81_sequen'))."','$this->c81_sequen',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c81_seqtranslr"]))
           $resac = db_query("insert into db_acount values($acount,967,6033,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c81_seqtranslr'))."','$this->c81_seqtranslr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($c81_sequen=null,$c81_seqtranslr=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,967,6032,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c81_sequen'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,967,6033,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c81_seqtranslr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
