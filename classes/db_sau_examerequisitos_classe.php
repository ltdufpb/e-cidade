...
class cl_sau_examerequisitos { 
   ...
   public $s109_i_codigo = 0; 
   public $s109_i_exame = 0; 
   public $s109_i_requisito = 0; 
   ...
   function incluir ($s109_i_codigo){ 
     ...
     if($s109_i_codigo == "" || $s109_i_codigo == null ){
       ...
       $this->s109_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from sau_examereguisito_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $s109_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2377,13550,'','".AddSlashes(pg_fetch_result($resaco,0,'s109_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2377,13551,'','".AddSlashes(pg_fetch_result($resaco,0,'s109_i_exame'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2377,13552,'','".AddSlashes(pg_fetch_result($resaco,0,'s109_i_requisito'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($s109_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->s109_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s109_i_codigo"])){ 
       $sql  .= $virgula." s109_i_codigo = $this->s109_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->s109_i_codigo) == null ){ 
     ...
     if(trim((string) $this->s109_i_exame)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s109_i_exame"])){ 
       $sql  .= $virgula." s109_i_exame = $this->s109_i_exame ";
       $virgula = ",";
       if(trim((string) $this->s109_i_exame) == null ){ 
         $this->erro_sql = " Campo Exame nao Informado.";
         $this->erro_campo = "s109_i_exame";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s109_i_requisito)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s109_i_requisito"])){ 
       $sql  .= $virgula." s109_i_requisito = $this->s109_i_requisito ";
       $virgula = ",";
       if(trim((string) $this->s109_i_requisito) == null ){ 
         $this->erro_sql = " Campo Requisito nao Informado.";
         $this->erro_campo = "s109_i_requisito";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s109_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2377,13550,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s109_i_codigo'))."','$this->s109_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s109_i_exame"]))
           $resac = db_query("insert into db_acount values($acount,2377,13551,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s109_i_exame'))."','$this->s109_i_exame',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s109_i_requisito"]))
           $resac = db_query("insert into db_acount values($acount,2377,13552,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s109_i_requisito'))."','$this->s109_i_requisito',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($s109_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2377,13550,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s109_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2377,13551,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s109_i_exame'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2377,13552,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s109_i_requisito'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
