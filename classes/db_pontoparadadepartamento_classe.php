...
class cl_pontoparadadepartamento { 
   ...
   public $tre05_sequencial = 0; 
   public $tre05_pontoparada = 0; 
   public $tre05_db_depart = 0; 
   ...
   function incluir ($tre05_sequencial){ 
     ...
     if($tre05_sequencial == "" || $tre05_sequencial == null ){
       ...
       $this->tre05_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from pontoparadadepartamento_tre05_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $tre05_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3602,20090,'','".AddSlashes(pg_fetch_result($resaco,0,'tre05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3602,20091,'','".AddSlashes(pg_fetch_result($resaco,0,'tre05_pontoparada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3602,20092,'','".AddSlashes(pg_fetch_result($resaco,0,'tre05_db_depart'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($tre05_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->tre05_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tre05_sequencial"])){ 
       $sql  .= $virgula." tre05_sequencial = $this->tre05_sequencial ";
       $virgula = ",";
       if(trim((string) $this->tre05_sequencial) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
     ...
     if(trim((string) $this->tre05_pontoparada)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tre05_pontoparada"])){ 
       $sql  .= $virgula." tre05_pontoparada = $this->tre05_pontoparada ";
       $virgula = ",";
       if(trim((string) $this->tre05_pontoparada) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
         $this->erro_campo = "tre05_pontoparada";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tre05_db_depart)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tre05_db_depart"])){ 
       $sql  .= $virgula." tre05_db_depart = $this->tre05_db_depart ";
       $virgula = ",";
       if(trim((string) $this->tre05_db_depart) == null ){ 
         $this->erro_sql = " Campo Depart. nao Informado.";
         $this->erro_campo = "tre05_db_depart";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["tre05_sequencial"]) || $this->tre05_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3602,20090,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tre05_sequencial'))."','$this->tre05_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["tre05_pontoparada"]) || $this->tre05_pontoparada != "")
             $resac = db_query("insert into db_acount values($acount,3602,20091,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tre05_pontoparada'))."','$this->tre05_pontoparada',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["tre05_db_depart"]) || $this->tre05_db_depart != "")
             $resac = db_query("insert into db_acount values($acount,3602,20092,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tre05_db_depart'))."','$this->tre05_db_depart',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3602,20090,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tre05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3602,20091,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tre05_pontoparada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3602,20092,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tre05_db_depart'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
