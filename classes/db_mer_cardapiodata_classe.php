...
class cl_mer_cardapiodata { 
   ...
   public $me13_i_codigo = 0; 
   public $me13_d_data_dia = null; 
   public $me13_d_data_mes = null; 
   public $me13_d_data_ano = null; 
   public $me13_d_data = null; 
   public $me13_i_cardapiodiaescola = 0; 
   ...
   function incluir ($me13_i_codigo){ 
     ...
     if($me13_i_codigo == "" || $me13_i_codigo == null ){
       ...
       $this->me13_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mercardapiodata_me13_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $me13_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2231,12750,'','".AddSlashes(pg_fetch_result($resaco,0,'me13_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2231,12751,'','".AddSlashes(pg_fetch_result($resaco,0,'me13_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2231,14157,'','".AddSlashes(pg_fetch_result($resaco,0,'me13_i_cardapiodiaescola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me13_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->me13_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me13_i_codigo"])){ 
       $sql  .= $virgula." me13_i_codigo = $this->me13_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->me13_i_codigo) == null ){ 
     ...
     if(trim((string) $this->me13_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me13_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["me13_d_data_dia"] !="") ){ 
       $sql  .= $virgula." me13_d_data = '$this->me13_d_data' ";
       $virgula = ",";
       if(trim((string) $this->me13_d_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "me13_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me13_i_cardapiodiaescola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me13_i_cardapiodiaescola"])){ 
       $sql  .= $virgula." me13_i_cardapiodiaescola = $this->me13_i_cardapiodiaescola ";
       $virgula = ",";
       if(trim((string) $this->me13_i_cardapiodiaescola) == null ){ 
         $this->erro_sql = " Campo Cardapio/Dia nao Informado.";
         $this->erro_campo = "me13_i_cardapiodiaescola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me13_i_codigo"]) || $this->me13_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2231,12750,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me13_i_codigo'))."','$this->me13_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me13_d_data"]) || $this->me13_d_data != "")
           $resac = db_query("insert into db_acount values($acount,2231,12751,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me13_d_data'))."','$this->me13_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me13_i_cardapiodiaescola"]) || $this->me13_i_cardapiodiaescola != "")
           $resac = db_query("insert into db_acount values($acount,2231,14157,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me13_i_cardapiodiaescola'))."','$this->me13_i_cardapiodiaescola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me13_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2231,12750,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me13_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2231,12751,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me13_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2231,14157,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me13_i_cardapiodiaescola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
