...
class cl_matrequiitemcriteriocustorateio { 
   ...
   public $cc13_sequencial = 0; 
   public $cc13_matrequiitem = 0; 
   public $cc13_custocriteriorateio = 0; 
   ...
   function incluir ($cc13_sequencial){ 
     ...
     if($cc13_sequencial == "" || $cc13_sequencial == null ){
       ...
       $this->cc13_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from matrequiitemcriteriocustorateio_cc13_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $cc13_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2359,13479,'','".AddSlashes(pg_fetch_result($resaco,0,'cc13_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2359,13480,'','".AddSlashes(pg_fetch_result($resaco,0,'cc13_matrequiitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2359,13481,'','".AddSlashes(pg_fetch_result($resaco,0,'cc13_custocriteriorateio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($cc13_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->cc13_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc13_sequencial"])){ 
       $sql  .= $virgula." cc13_sequencial = $this->cc13_sequencial ";
       $virgula = ",";
       if(trim((string) $this->cc13_sequencial) == null ){ 
     ...
     if(trim((string) $this->cc13_matrequiitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc13_matrequiitem"])){ 
       $sql  .= $virgula." cc13_matrequiitem = $this->cc13_matrequiitem ";
       $virgula = ",";
       if(trim((string) $this->cc13_matrequiitem) == null ){ 
         $this->erro_sql = " Campo Código do Material nao Informado.";
         $this->erro_campo = "cc13_matrequiitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cc13_custocriteriorateio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc13_custocriteriorateio"])){ 
       $sql  .= $virgula." cc13_custocriteriorateio = $this->cc13_custocriteriorateio ";
       $virgula = ",";
       if(trim((string) $this->cc13_custocriteriorateio) == null ){ 
         $this->erro_sql = " Campo Código do Critério nao Informado.";
         $this->erro_campo = "cc13_custocriteriorateio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc13_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2359,13479,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc13_sequencial'))."','$this->cc13_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc13_matrequiitem"]))
           $resac = db_query("insert into db_acount values($acount,2359,13480,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc13_matrequiitem'))."','$this->cc13_matrequiitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc13_custocriteriorateio"]))
           $resac = db_query("insert into db_acount values($acount,2359,13481,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc13_custocriteriorateio'))."','$this->cc13_custocriteriorateio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($cc13_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2359,13479,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc13_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2359,13480,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc13_matrequiitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2359,13481,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc13_custocriteriorateio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
