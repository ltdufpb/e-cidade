...
class cl_cgsfatorderisco { 
   ...
   public $s106_i_codigo = 0; 
   public $s106_i_cgs = 0; 
   public $s106_i_fatorderisco = 0; 
   ...
   function incluir ($s106_i_codigo){ 
     ...
     if($s106_i_codigo == "" || $s106_i_codigo == null ){
       ...
       $this->s106_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cgsfatorderisco_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $s106_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2369,13537,'','".AddSlashes(pg_fetch_result($resaco,0,'s106_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2369,13538,'','".AddSlashes(pg_fetch_result($resaco,0,'s106_i_cgs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2369,13539,'','".AddSlashes(pg_fetch_result($resaco,0,'s106_i_fatorderisco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($s106_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->s106_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s106_i_codigo"])){ 
       $sql  .= $virgula." s106_i_codigo = $this->s106_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->s106_i_codigo) == null ){ 
     ...
     if(trim((string) $this->s106_i_cgs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s106_i_cgs"])){ 
       $sql  .= $virgula." s106_i_cgs = $this->s106_i_cgs ";
       $virgula = ",";
       if(trim((string) $this->s106_i_cgs) == null ){ 
         $this->erro_sql = " Campo Prontuário nao Informado.";
         $this->erro_campo = "s106_i_cgs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s106_i_fatorderisco)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s106_i_fatorderisco"])){ 
       $sql  .= $virgula." s106_i_fatorderisco = $this->s106_i_fatorderisco ";
       $virgula = ",";
       if(trim((string) $this->s106_i_fatorderisco) == null ){ 
         $this->erro_sql = " Campo Fator de Risco nao Informado.";
         $this->erro_campo = "s106_i_fatorderisco";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s106_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2369,13537,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s106_i_codigo'))."','$this->s106_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s106_i_cgs"]))
           $resac = db_query("insert into db_acount values($acount,2369,13538,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s106_i_cgs'))."','$this->s106_i_cgs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s106_i_fatorderisco"]))
           $resac = db_query("insert into db_acount values($acount,2369,13539,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s106_i_fatorderisco'))."','$this->s106_i_fatorderisco',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($s106_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2369,13537,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s106_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2369,13538,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s106_i_cgs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2369,13539,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s106_i_fatorderisco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
