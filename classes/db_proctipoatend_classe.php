...
class cl_proctipoatend { 
   ...
   function incluir ($sd20_i_codigo){ 
     ...
     if($sd20_i_codigo == "" || $sd20_i_codigo == null ){
       ...
       $this->sd20_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from proctipoatend_sd20_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $sd20_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,100022,1008731,'','".AddSlashes(pg_fetch_result($resaco,0,'sd20_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,100022,100118,'','".AddSlashes(pg_fetch_result($resaco,0,'sd20_i_procedimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,100022,100119,'','".AddSlashes(pg_fetch_result($resaco,0,'sd20_i_tipoatend'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd20_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd20_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd20_i_codigo"])){ 
       $sql  .= $virgula." sd20_i_codigo = $this->sd20_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->sd20_i_codigo) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd20_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,100022,1008731,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd20_i_codigo'))."','$this->sd20_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd20_i_procedimento"]))
           $resac = db_query("insert into db_acount values($acount,100022,100118,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd20_i_procedimento'))."','$this->sd20_i_procedimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd20_i_tipoatend"]))
           $resac = db_query("insert into db_acount values($acount,100022,100119,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd20_i_tipoatend'))."','$this->sd20_i_tipoatend',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd20_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,100022,1008731,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd20_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,100022,100118,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd20_i_procedimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,100022,100119,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd20_i_tipoatend'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
