...
class cl_rechumanorelacao { 
   ...
   public $ed03_i_codigo = 0; 
   public $ed03_i_rechumanoativ = 0; 
   public $ed03_i_relacaotrabalho = 0; 
   ...
   function incluir ($ed03_i_codigo){ 
     ...
     if($ed03_i_codigo == "" || $ed03_i_codigo == null ){
       ...
       $this->ed03_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rechumanorelacao_ed03_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed03_i_codigo)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,1010098,1008555,'','".AddSlashes(pg_fetch_result($resaco,0,'ed03_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010098,1008556,'','".AddSlashes(pg_fetch_result($resaco,0,'ed03_i_rechumanoativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010098,1008557,'','".AddSlashes(pg_fetch_result($resaco,0,'ed03_i_relacaotrabalho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($ed03_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed03_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed03_i_codigo"])){ 
       $sql  .= $virgula." ed03_i_codigo = $this->ed03_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed03_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed03_i_rechumanoativ)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed03_i_rechumanoativ"])){ 
       $sql  .= $virgula." ed03_i_rechumanoativ = $this->ed03_i_rechumanoativ ";
       $virgula = ",";
       if(trim((string) $this->ed03_i_rechumanoativ) == null ){ 
         $this->erro_sql = " Campo Atividade não informado.";
         $this->erro_campo = "ed03_i_rechumanoativ";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed03_i_relacaotrabalho)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed03_i_relacaotrabalho"])){ 
       $sql  .= $virgula." ed03_i_relacaotrabalho = $this->ed03_i_relacaotrabalho ";
       $virgula = ",";
       if(trim((string) $this->ed03_i_relacaotrabalho) == null ){ 
         $this->erro_sql = " Campo Relação de Trabalho não informado.";
         $this->erro_campo = "ed03_i_relacaotrabalho";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed03_i_codigo"]) || $this->ed03_i_codigo != "")
             $resac = db_query("insert into db_acount values($acount,1010098,1008555,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed03_i_codigo'))."','$this->ed03_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed03_i_rechumanoativ"]) || $this->ed03_i_rechumanoativ != "")
             $resac = db_query("insert into db_acount values($acount,1010098,1008556,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed03_i_rechumanoativ'))."','$this->ed03_i_rechumanoativ',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed03_i_relacaotrabalho"]) || $this->ed03_i_relacaotrabalho != "")
             $resac = db_query("insert into db_acount values($acount,1010098,1008557,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed03_i_relacaotrabalho'))."','$this->ed03_i_relacaotrabalho',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,1010098,1008555,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed03_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010098,1008556,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed03_i_rechumanoativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010098,1008557,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed03_i_relacaotrabalho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
