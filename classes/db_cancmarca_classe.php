...
class cl_cancmarca { 
   ...
   public $ma03_i_codigo = 0; 
   public $ma03_i_marca = 0; 
   public $ma03_i_codproc = 0; 
   public $ma03_d_data_dia = null; 
   public $ma03_d_data_mes = null; 
   public $ma03_d_data_ano = null; 
   public $ma03_d_data = null; 
   public $ma03_t_obs = null; 
   public $ma03_c_tipo = null; 
   ...
   function incluir ($ma03_i_codigo){ 
     ...
     if($ma03_i_codigo == "" || $ma03_i_codigo == null ){
       ...
       $this->ma03_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cancmarca_ma03_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ma03_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1817,10526,'','".AddSlashes(pg_fetch_result($resaco,0,'ma03_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1817,10527,'','".AddSlashes(pg_fetch_result($resaco,0,'ma03_i_marca'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1817,10528,'','".AddSlashes(pg_fetch_result($resaco,0,'ma03_i_codproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1817,10529,'','".AddSlashes(pg_fetch_result($resaco,0,'ma03_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1817,10530,'','".AddSlashes(pg_fetch_result($resaco,0,'ma03_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1817,10531,'','".AddSlashes(pg_fetch_result($resaco,0,'ma03_c_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ma03_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ma03_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ma03_i_codigo"])){ 
       $sql  .= $virgula." ma03_i_codigo = $this->ma03_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ma03_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ma03_i_marca)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ma03_i_marca"])){ 
       $sql  .= $virgula." ma03_i_marca = $this->ma03_i_marca ";
       $virgula = ",";
       if(trim((string) $this->ma03_i_marca) == null ){ 
         $this->erro_sql = " Campo Código da Marca nao Informado.";
         $this->erro_campo = "ma03_i_marca";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ma03_i_codproc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ma03_i_codproc"])){ 
       $sql  .= $virgula." ma03_i_codproc = $this->ma03_i_codproc ";
       $virgula = ",";
       if(trim((string) $this->ma03_i_codproc) == null ){ 
         $this->erro_sql = " Campo Código do processo nao Informado.";
         $this->erro_campo = "ma03_i_codproc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ma03_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ma03_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ma03_d_data_dia"] !="") ){ 
       $sql  .= $virgula." ma03_d_data = '$this->ma03_d_data' ";
       $virgula = ",";
       if(trim((string) $this->ma03_d_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "ma03_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ma03_t_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ma03_t_obs"])){ 
       $sql  .= $virgula." ma03_t_obs = '$this->ma03_t_obs' ";
       $virgula = ",";
       if(trim((string) $this->ma03_t_obs) == null ){ 
         $this->erro_sql = " Campo Observações nao Informado.";
         $this->erro_campo = "ma03_t_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ma03_c_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ma03_c_tipo"])){ 
       $sql  .= $virgula." ma03_c_tipo = '$this->ma03_c_tipo' ";
       $virgula = ",";
       if(trim((string) $this->ma03_c_tipo) == null ){ 
         $this->erro_sql = " Campo Tipos nao Informado.";
         $this->erro_campo = "ma03_c_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ma03_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1817,10526,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ma03_i_codigo'))."','$this->ma03_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ma03_i_marca"]))
           $resac = db_query("insert into db_acount values($acount,1817,10527,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ma03_i_marca'))."','$this->ma03_i_marca',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ma03_i_codproc"]))
           $resac = db_query("insert into db_acount values($acount,1817,10528,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ma03_i_codproc'))."','$this->ma03_i_codproc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ma03_d_data"]))
           $resac = db_query("insert into db_acount values($acount,1817,10529,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ma03_d_data'))."','$this->ma03_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ma03_t_obs"]))
           $resac = db_query("insert into db_acount values($acount,1817,10530,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ma03_t_obs'))."','$this->ma03_t_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ma03_c_tipo"]))
           $resac = db_query("insert into db_acount values($acount,1817,10531,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ma03_c_tipo'))."','$this->ma03_c_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ma03_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1817,10526,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ma03_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1817,10527,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ma03_i_marca'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1817,10528,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ma03_i_codproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1817,10529,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ma03_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1817,10530,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ma03_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1817,10531,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ma03_c_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
