...
class cl_sau_triagemprocsf { 
   ...
   public $s147_i_codigo = 0; 
   public $s147_i_triagem = 0; 
   public $s147_i_procsf = 0; 
   ...
   function incluir ($s147_i_codigo){ 
     ...
     if($s147_i_codigo == "" || $s147_i_codigo == null ){
       ...
       $this->s147_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from sau_triagemprocsf_s147_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $s147_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2722,15512,'','".AddSlashes(pg_fetch_result($resaco,0,'s147_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2722,15514,'','".AddSlashes(pg_fetch_result($resaco,0,'s147_i_triagem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2722,15513,'','".AddSlashes(pg_fetch_result($resaco,0,'s147_i_procsf'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($s147_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->s147_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s147_i_codigo"])){ 
       $sql  .= $virgula." s147_i_codigo = $this->s147_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->s147_i_codigo) == null ){ 
     ...
     if(trim((string) $this->s147_i_triagem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s147_i_triagem"])){ 
       $sql  .= $virgula." s147_i_triagem = $this->s147_i_triagem ";
       $virgula = ",";
       if(trim((string) $this->s147_i_triagem) == null ){ 
         $this->erro_sql = " Campo triagem nao Informado.";
         $this->erro_campo = "s147_i_triagem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s147_i_procsf)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s147_i_procsf"])){ 
       $sql  .= $virgula." s147_i_procsf = $this->s147_i_procsf ";
       $virgula = ",";
       if(trim((string) $this->s147_i_procsf) == null ){ 
         $this->erro_sql = " Campo procedimento sem fatua nao Informado.";
         $this->erro_campo = "s147_i_procsf";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s147_i_codigo"]) || $this->s147_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2722,15512,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s147_i_codigo'))."','$this->s147_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s147_i_triagem"]) || $this->s147_i_triagem != "")
           $resac = db_query("insert into db_acount values($acount,2722,15514,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s147_i_triagem'))."','$this->s147_i_triagem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s147_i_procsf"]) || $this->s147_i_procsf != "")
           $resac = db_query("insert into db_acount values($acount,2722,15513,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s147_i_procsf'))."','$this->s147_i_procsf',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($s147_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2722,15512,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s147_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2722,15514,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s147_i_triagem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2722,15513,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s147_i_procsf'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
