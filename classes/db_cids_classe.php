...
class cl_cids { 
   ...
   public $sd22_c_codigo = null; 
   public $sd22_v_descr = null; 
   public $sd22_d_validade_dia = null; 
   public $sd22_d_validade_mes = null; 
   public $sd22_d_validade_ano = null; 
   public $sd22_d_validade = null; 
   public $sd22_c_restrsexo = null; 
   ...
   function incluir ($sd22_c_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,100009,100028,'','".AddSlashes(pg_fetch_result($resaco,0,'sd22_c_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,100009,100029,'','".AddSlashes(pg_fetch_result($resaco,0,'sd22_v_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,100009,100030,'','".AddSlashes(pg_fetch_result($resaco,0,'sd22_d_validade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,100009,1008810,'','".AddSlashes(pg_fetch_result($resaco,0,'sd22_c_restrsexo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd22_c_codigo=null) { 
     ...
     $sql = " update cids set ";
     $virgula = "";
     if(trim((string) $this->sd22_c_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd22_c_codigo"])){ 
       $sql  .= $virgula." sd22_c_codigo = '$this->sd22_c_codigo' ";
       $virgula = ",";
       if(trim((string) $this->sd22_c_codigo) == null ){ 
     ...
     if(trim((string) $this->sd22_v_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd22_v_descr"])){ 
       $sql  .= $virgula." sd22_v_descr = '$this->sd22_v_descr' ";
       $virgula = ",";
       if(trim((string) $this->sd22_v_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "sd22_v_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd22_d_validade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd22_d_validade_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["sd22_d_validade_dia"] !="") ){ 
     ...
     if(trim((string) $this->sd22_c_restrsexo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd22_c_restrsexo"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd22_c_codigo"]))
           $resac = db_query("insert into db_acount values($acount,100009,100028,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd22_c_codigo'))."','$this->sd22_c_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd22_v_descr"]))
           $resac = db_query("insert into db_acount values($acount,100009,100029,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd22_v_descr'))."','$this->sd22_v_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd22_d_validade"]))
           $resac = db_query("insert into db_acount values($acount,100009,100030,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd22_d_validade'))."','$this->sd22_d_validade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd22_c_restrsexo"]))
           $resac = db_query("insert into db_acount values($acount,100009,1008810,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd22_c_restrsexo'))."','$this->sd22_c_restrsexo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd22_c_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,100009,100028,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd22_c_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,100009,100029,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd22_v_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,100009,100030,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd22_d_validade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,100009,1008810,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd22_c_restrsexo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
