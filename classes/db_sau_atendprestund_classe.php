...
class cl_sau_atendprestund { 
   ...
   public $sd48_i_codigo = 0; 
   public $sd48_i_unidade = 0; 
   public $sd48_i_atendprestado = 0; 
   public $sd48_i_convenio = 0; 
   ...
   function incluir ($sd48_i_codigo){ 
     ...
     if($sd48_i_codigo == "" || $sd48_i_codigo == null ){
       ...
       $this->sd48_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from sau_atendprestund_sd48_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $sd48_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1965,11430,'','".AddSlashes(pg_fetch_result($resaco,0,'sd48_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1965,11431,'','".AddSlashes(pg_fetch_result($resaco,0,'sd48_i_unidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1965,11432,'','".AddSlashes(pg_fetch_result($resaco,0,'sd48_i_atendprestado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1965,11433,'','".AddSlashes(pg_fetch_result($resaco,0,'sd48_i_convenio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd48_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd48_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd48_i_codigo"])){ 
       $sql  .= $virgula." sd48_i_codigo = $this->sd48_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->sd48_i_codigo) == null ){ 
     ...
     if(trim((string) $this->sd48_i_unidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd48_i_unidade"])){ 
       $sql  .= $virgula." sd48_i_unidade = $this->sd48_i_unidade ";
       $virgula = ",";
       if(trim((string) $this->sd48_i_unidade) == null ){ 
         $this->erro_sql = " Campo Unidade nao Informado.";
         $this->erro_campo = "sd48_i_unidade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd48_i_atendprestado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd48_i_atendprestado"])){ 
       $sql  .= $virgula." sd48_i_atendprestado = $this->sd48_i_atendprestado ";
       $virgula = ",";
       if(trim((string) $this->sd48_i_atendprestado) == null ){ 
         $this->erro_sql = " Campo Atendimetno Prestado nao Informado.";
         $this->erro_campo = "sd48_i_atendprestado";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd48_i_convenio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd48_i_convenio"])){ 
       $sql  .= $virgula." sd48_i_convenio = $this->sd48_i_convenio ";
       $virgula = ",";
       if(trim((string) $this->sd48_i_convenio) == null ){ 
         $this->erro_sql = " Campo Convênio nao Informado.";
         $this->erro_campo = "sd48_i_convenio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd48_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1965,11430,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd48_i_codigo'))."','$this->sd48_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd48_i_unidade"]))
           $resac = db_query("insert into db_acount values($acount,1965,11431,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd48_i_unidade'))."','$this->sd48_i_unidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd48_i_atendprestado"]))
           $resac = db_query("insert into db_acount values($acount,1965,11432,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd48_i_atendprestado'))."','$this->sd48_i_atendprestado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd48_i_convenio"]))
           $resac = db_query("insert into db_acount values($acount,1965,11433,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd48_i_convenio'))."','$this->sd48_i_convenio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd48_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1965,11430,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd48_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1965,11431,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd48_i_unidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1965,11432,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd48_i_atendprestado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1965,11433,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd48_i_convenio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
