...
class cl_cfautentdocasschq { 
   ...
   public $k39_sequencial = 0; 
   public $k39_cfautent = 0; 
   public $k39_documento = 0; 
   ...
   function incluir ($k39_sequencial){ 
     ...
     if($k39_sequencial == "" || $k39_sequencial == null ){
       ...
       $this->k39_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cfautentdocasschq_k39_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k39_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1867,10842,'','".AddSlashes(pg_fetch_result($resaco,0,'k39_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1867,10843,'','".AddSlashes(pg_fetch_result($resaco,0,'k39_cfautent'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1867,10844,'','".AddSlashes(pg_fetch_result($resaco,0,'k39_documento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k39_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k39_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k39_sequencial"])){ 
       $sql  .= $virgula." k39_sequencial = $this->k39_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k39_sequencial) == null ){ 
     ...
     if(trim((string) $this->k39_cfautent)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k39_cfautent"])){ 
       $sql  .= $virgula." k39_cfautent = $this->k39_cfautent ";
       $virgula = ",";
       if(trim((string) $this->k39_cfautent) == null ){ 
         $this->erro_sql = " Campo Codigo autenticadora nao Informado.";
         $this->erro_campo = "k39_cfautent";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k39_documento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k39_documento"])){ 
       $sql  .= $virgula." k39_documento = $this->k39_documento ";
       $virgula = ",";
       if(trim((string) $this->k39_documento) == null ){ 
         $this->erro_sql = " Campo Codigo do documento nao Informado.";
         $this->erro_campo = "k39_documento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k39_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1867,10842,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k39_sequencial'))."','$this->k39_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k39_cfautent"]))
           $resac = db_query("insert into db_acount values($acount,1867,10843,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k39_cfautent'))."','$this->k39_cfautent',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k39_documento"]))
           $resac = db_query("insert into db_acount values($acount,1867,10844,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k39_documento'))."','$this->k39_documento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k39_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1867,10842,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k39_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1867,10843,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k39_cfautent'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1867,10844,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k39_documento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
