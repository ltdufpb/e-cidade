...
class cl_certbaixanumero { 
   ...
   function incluir ($q79_sequencial){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2180,12483,'','".AddSlashes(pg_fetch_result($resaco,0,'q79_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2180,12484,'','".AddSlashes(pg_fetch_result($resaco,0,'q79_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2180,12485,'','".AddSlashes(pg_fetch_result($resaco,0,'q79_ultcodcertbaixa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q79_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q79_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q79_sequencial"])){ 
       $sql  .= $virgula." q79_sequencial = $this->q79_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q79_sequencial) == null ){ 
     ...
     if(trim((string) $this->q79_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q79_anousu"])){ 
       $sql  .= $virgula." q79_anousu = $this->q79_anousu ";
       $virgula = ",";
       if(trim((string) $this->q79_anousu) == null ){ 
         $this->erro_sql = " Campo Ano nao Informado.";
         $this->erro_campo = "q79_anousu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q79_ultcodcertbaixa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q79_ultcodcertbaixa"])){ 
       $sql  .= $virgula." q79_ultcodcertbaixa = $this->q79_ultcodcertbaixa ";
       $virgula = ",";
       if(trim((string) $this->q79_ultcodcertbaixa) == null ){ 
         $this->erro_sql = " Campo Numeração nao Informado.";
         $this->erro_campo = "q79_ultcodcertbaixa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q79_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2180,12483,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q79_sequencial'))."','$this->q79_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q79_anousu"]))
           $resac = db_query("insert into db_acount values($acount,2180,12484,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q79_anousu'))."','$this->q79_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q79_ultcodcertbaixa"]))
           $resac = db_query("insert into db_acount values($acount,2180,12485,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q79_ultcodcertbaixa'))."','$this->q79_ultcodcertbaixa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q79_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2180,12483,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q79_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2180,12484,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q79_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2180,12485,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q79_ultcodcertbaixa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
