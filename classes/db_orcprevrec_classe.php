...
class cl_orcprevrec { 
   ...
   function incluir ($o34_codigo){ 
     ...
     if($o34_codigo == "" || $o34_codigo == null ){
       ...
       $this->o34_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from orcprevrec_o34_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $o34_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1473,8674,'','".AddSlashes(pg_fetch_result($resaco,0,'o34_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1473,8648,'','".AddSlashes(pg_fetch_result($resaco,0,'o34_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1473,8649,'','".AddSlashes(pg_fetch_result($resaco,0,'o34_codrec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1473,8650,'','".AddSlashes(pg_fetch_result($resaco,0,'o34_mes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1473,8651,'','".AddSlashes(pg_fetch_result($resaco,0,'o34_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o34_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o34_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o34_codigo"])){ 
       $sql  .= $virgula." o34_codigo = $this->o34_codigo ";
       $virgula = ",";
       if(trim((string) $this->o34_codigo) == null ){ 
     ...
     if(trim((string) $this->o34_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o34_anousu"])){ 
       $sql  .= $virgula." o34_anousu = $this->o34_anousu ";
       $virgula = ",";
       if(trim((string) $this->o34_anousu) == null ){ 
         $this->erro_sql = " Campo Exercicio nao Informado.";
         $this->erro_campo = "o34_anousu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o34_codrec)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o34_codrec"])){ 
       $sql  .= $virgula." o34_codrec = $this->o34_codrec ";
       $virgula = ",";
       if(trim((string) $this->o34_codrec) == null ){ 
         $this->erro_sql = " Campo Código Reduzido nao Informado.";
         $this->erro_campo = "o34_codrec";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o34_mes)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o34_mes"])){ 
       $sql  .= $virgula." o34_mes = $this->o34_mes ";
       $virgula = ",";
       if(trim((string) $this->o34_mes) == null ){ 
         $this->erro_sql = " Campo Mes nao Informado.";
         $this->erro_campo = "o34_mes";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o34_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o34_valor"])){ 
       $sql  .= $virgula." o34_valor = $this->o34_valor ";
       $virgula = ",";
       if(trim((string) $this->o34_valor) == null ){ 
         $this->erro_sql = " Campo Valor nao Informado.";
         $this->erro_campo = "o34_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o34_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1473,8674,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o34_codigo'))."','$this->o34_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o34_anousu"]))
           $resac = db_query("insert into db_acount values($acount,1473,8648,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o34_anousu'))."','$this->o34_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o34_codrec"]))
           $resac = db_query("insert into db_acount values($acount,1473,8649,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o34_codrec'))."','$this->o34_codrec',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o34_mes"]))
           $resac = db_query("insert into db_acount values($acount,1473,8650,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o34_mes'))."','$this->o34_mes',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o34_valor"]))
           $resac = db_query("insert into db_acount values($acount,1473,8651,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o34_valor'))."','$this->o34_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o34_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1473,8674,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o34_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1473,8648,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o34_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1473,8649,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o34_codrec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1473,8650,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o34_mes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1473,8651,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o34_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
