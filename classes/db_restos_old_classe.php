...
class cl_restos_old {
   ...
   public $cm12_i_codigo = 0;
   public $cm12_i_ossoariopart = 0;
   public $cm12_i_resto = 0;
   public $cm12_i_sepultamento = 0;
   public $cm12_d_entrada_dia = null;
   public $cm12_d_entrada_mes = null;
   public $cm12_d_entrada_ano = null;
   public $cm12_d_entrada = null;
   ...
   function incluir ($cm12_i_codigo){
     ...
     if($cm12_i_codigo == "" || $cm12_i_codigo == null ){
       ...
       $this->cm12_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from restos_old_cm12_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $cm12_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1800,10415,'','".AddSlashes(pg_fetch_result($resaco,0,'cm12_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1800,10416,'','".AddSlashes(pg_fetch_result($resaco,0,'cm12_i_ossoariopart'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1800,10417,'','".AddSlashes(pg_fetch_result($resaco,0,'cm12_i_resto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1800,10418,'','".AddSlashes(pg_fetch_result($resaco,0,'cm12_i_sepultamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1800,10419,'','".AddSlashes(pg_fetch_result($resaco,0,'cm12_d_entrada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($cm12_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->cm12_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm12_i_codigo"])){
       $sql  .= $virgula." cm12_i_codigo = $this->cm12_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->cm12_i_codigo) == null ){
     ...
     if(trim((string) $this->cm12_i_ossoariopart)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm12_i_ossoariopart"])){
       $sql  .= $virgula." cm12_i_ossoariopart = $this->cm12_i_ossoariopart ";
       $virgula = ",";
       if(trim((string) $this->cm12_i_ossoariopart) == null ){
         $this->erro_sql = " Campo Ossário nao Informado.";
         $this->erro_campo = "cm12_i_ossoariopart";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cm12_i_resto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm12_i_resto"])){
       $sql  .= $virgula." cm12_i_resto = $this->cm12_i_resto ";
       $virgula = ",";
       if(trim((string) $this->cm12_i_resto) == null ){
         $this->erro_sql = " Campo Numero nao Informado.";
         $this->erro_campo = "cm12_i_resto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cm12_i_sepultamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm12_i_sepultamento"])){
       $sql  .= $virgula." cm12_i_sepultamento = $this->cm12_i_sepultamento ";
       $virgula = ",";
       if(trim((string) $this->cm12_i_sepultamento) == null ){
         $this->erro_sql = " Campo Sepultamento nao Informado.";
         $this->erro_campo = "cm12_i_sepultamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cm12_d_entrada)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm12_d_entrada_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["cm12_d_entrada_dia"] !="") ){
       $sql  .= $virgula." cm12_d_entrada = '$this->cm12_d_entrada' ";
       $virgula = ",";
       if(trim((string) $this->cm12_d_entrada) == null ){
         $this->erro_sql = " Campo Entrada nao Informado.";
         $this->erro_campo = "cm12_d_entrada_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm12_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1800,10415,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm12_i_codigo'))."','$this->cm12_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm12_i_ossoariopart"]))
           $resac = db_query("insert into db_acount values($acount,1800,10416,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm12_i_ossoariopart'))."','$this->cm12_i_ossoariopart',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm12_i_resto"]))
           $resac = db_query("insert into db_acount values($acount,1800,10417,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm12_i_resto'))."','$this->cm12_i_resto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm12_i_sepultamento"]))
           $resac = db_query("insert into db_acount values($acount,1800,10418,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm12_i_sepultamento'))."','$this->cm12_i_sepultamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm12_d_entrada"]))
           $resac = db_query("insert into db_acount values($acount,1800,10419,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cm12_d_entrada'))."','$this->cm12_d_entrada',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($cm12_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1800,10415,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm12_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1800,10416,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm12_i_ossoariopart'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1800,10417,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm12_i_resto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1800,10418,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm12_i_sepultamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1800,10419,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cm12_d_entrada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
