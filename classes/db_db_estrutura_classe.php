...
class cl_db_estrutura { 
   ...
   public $db77_codestrut = 0; 
   public $db77_estrut = null; 
   public $db77_descr = null; 
   public $db77_permitesintetico = 'f'; 
   ...
   function incluir ($db77_codestrut){ 
     ...
     if($db77_codestrut == "" || $db77_codestrut == null ){
       ...
       $this->db77_codestrut = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhestrutura_r77_codestrut_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db77_codestrut)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,898,5691,'','".AddSlashes(pg_fetch_result($resaco,0,'db77_codestrut'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,898,5692,'','".AddSlashes(pg_fetch_result($resaco,0,'db77_estrut'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,898,5693,'','".AddSlashes(pg_fetch_result($resaco,0,'db77_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,898,17958,'','".AddSlashes(pg_fetch_result($resaco,0,'db77_permitesintetico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db77_codestrut=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db77_codestrut)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db77_codestrut"])){ 
       $sql  .= $virgula." db77_codestrut = $this->db77_codestrut ";
       $virgula = ",";
       if(trim((string) $this->db77_codestrut) == null ){ 
     ...
     if(trim((string) $this->db77_estrut)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db77_estrut"])){ 
       $sql  .= $virgula." db77_estrut = '$this->db77_estrut' ";
       $virgula = ",";
       if(trim((string) $this->db77_estrut) == null ){ 
         $this->erro_sql = " Campo Estrutural nao Informado.";
         $this->erro_campo = "db77_estrut";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db77_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db77_descr"])){ 
       $sql  .= $virgula." db77_descr = '$this->db77_descr' ";
       $virgula = ",";
       if(trim((string) $this->db77_descr) == null ){ 
         $this->erro_sql = " Campo Decrição nao Informado.";
         $this->erro_campo = "db77_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db77_permitesintetico)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db77_permitesintetico"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db77_codestrut"]) || $this->db77_codestrut != "")
           $resac = db_query("insert into db_acount values($acount,898,5691,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db77_codestrut'))."','$this->db77_codestrut',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db77_estrut"]) || $this->db77_estrut != "")
           $resac = db_query("insert into db_acount values($acount,898,5692,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db77_estrut'))."','$this->db77_estrut',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db77_descr"]) || $this->db77_descr != "")
           $resac = db_query("insert into db_acount values($acount,898,5693,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db77_descr'))."','$this->db77_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db77_permitesintetico"]) || $this->db77_permitesintetico != "")
           $resac = db_query("insert into db_acount values($acount,898,17958,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db77_permitesintetico'))."','$this->db77_permitesintetico',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db77_codestrut=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,898,5691,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db77_codestrut'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,898,5692,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db77_estrut'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,898,5693,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db77_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,898,17958,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db77_permitesintetico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
