...
class cl_econsigmotivo { 
   ...
   public $rh147_sequencial = 0; 
   public $rh147_motivo = null; 
   ...
   function incluir ($rh147_sequencial){ 
     ...
     if($rh147_sequencial == "" || $rh147_sequencial == null ){
       ...
       $this->rh147_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from econsigmotivo_rh147_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh147_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3755,20869,'','".AddSlashes(pg_fetch_result($resaco,0,'rh147_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3755,20870,'','".AddSlashes(pg_fetch_result($resaco,0,'rh147_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($rh147_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh147_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh147_sequencial"])){ 
       $sql  .= $virgula." rh147_sequencial = $this->rh147_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh147_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh147_motivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh147_motivo"])){ 
       $sql  .= $virgula." rh147_motivo = '$this->rh147_motivo' ";
       $virgula = ",";
       if(trim((string) $this->rh147_motivo) == null ){ 
         $this->erro_sql = " Campo Motivo não informado.";
         $this->erro_campo = "rh147_motivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["rh147_sequencial"]) || $this->rh147_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3755,20869,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh147_sequencial'))."','$this->rh147_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["rh147_motivo"]) || $this->rh147_motivo != "")
             $resac = db_query("insert into db_acount values($acount,3755,20870,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh147_motivo'))."','$this->rh147_motivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3755,20869,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh147_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3755,20870,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh147_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
