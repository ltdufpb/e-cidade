...
class cl_pactovalormovempempitem { 
   ...
   public $o105_sequencial = 0; 
   public $o105_empempitem = 0; 
   public $o105_pactovalormov = 0; 
   ...
   function incluir ($o105_sequencial){ 
     ...
     if($o105_sequencial == "" || $o105_sequencial == null ){
       ...
       $this->o105_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from pactovalormovempempitem_o105_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $o105_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2445,13916,'','".AddSlashes(pg_fetch_result($resaco,0,'o105_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2445,13918,'','".AddSlashes(pg_fetch_result($resaco,0,'o105_empempitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2445,13921,'','".AddSlashes(pg_fetch_result($resaco,0,'o105_pactovalormov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o105_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o105_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o105_sequencial"])){ 
       $sql  .= $virgula." o105_sequencial = $this->o105_sequencial ";
       $virgula = ",";
       if(trim((string) $this->o105_sequencial) == null ){ 
     ...
     if(trim((string) $this->o105_empempitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o105_empempitem"])){ 
       $sql  .= $virgula." o105_empempitem = $this->o105_empempitem ";
       $virgula = ",";
       if(trim((string) $this->o105_empempitem) == null ){ 
         $this->erro_sql = " Campo Item do Empenho nao Informado.";
         $this->erro_campo = "o105_empempitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o105_pactovalormov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o105_pactovalormov"])){ 
       $sql  .= $virgula." o105_pactovalormov = $this->o105_pactovalormov ";
       $virgula = ",";
       if(trim((string) $this->o105_pactovalormov) == null ){ 
         $this->erro_sql = " Campo Item nao Informado.";
         $this->erro_campo = "o105_pactovalormov";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o105_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2445,13916,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o105_sequencial'))."','$this->o105_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o105_empempitem"]))
           $resac = db_query("insert into db_acount values($acount,2445,13918,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o105_empempitem'))."','$this->o105_empempitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o105_pactovalormov"]))
           $resac = db_query("insert into db_acount values($acount,2445,13921,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o105_pactovalormov'))."','$this->o105_pactovalormov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o105_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2445,13916,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o105_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2445,13918,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o105_empempitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2445,13921,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o105_pactovalormov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
