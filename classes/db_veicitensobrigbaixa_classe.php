...
class cl_veicitensobrigbaixa { 
   ...
   public $ve10_sequencial = 0; 
   public $ve10_veiccaditensobrigtipobaixa = 0; 
   public $ve10_veicitensobrig = 0; 
   public $ve10_data_dia = null; 
   public $ve10_data_mes = null; 
   public $ve10_data_ano = null; 
   public $ve10_data = null; 
   public $ve10_hora = null; 
   public $ve10_motivo = null; 
   ...
   function incluir ($ve10_sequencial){ 
     ...
     if($ve10_sequencial == "" || $ve10_sequencial == null ){
       ...
       $this->ve10_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veicitensobrigbaixa_ve10_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve10_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1913,11098,'','".AddSlashes(pg_fetch_result($resaco,0,'ve10_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1913,11099,'','".AddSlashes(pg_fetch_result($resaco,0,'ve10_veiccaditensobrigtipobaixa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1913,11100,'','".AddSlashes(pg_fetch_result($resaco,0,'ve10_veicitensobrig'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1913,11101,'','".AddSlashes(pg_fetch_result($resaco,0,'ve10_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1913,11102,'','".AddSlashes(pg_fetch_result($resaco,0,'ve10_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1913,11103,'','".AddSlashes(pg_fetch_result($resaco,0,'ve10_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve10_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve10_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve10_sequencial"])){ 
       $sql  .= $virgula." ve10_sequencial = $this->ve10_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ve10_sequencial) == null ){ 
     ...
     if(trim((string) $this->ve10_veiccaditensobrigtipobaixa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve10_veiccaditensobrigtipobaixa"])){ 
       $sql  .= $virgula." ve10_veiccaditensobrigtipobaixa = $this->ve10_veiccaditensobrigtipobaixa ";
       $virgula = ",";
       if(trim((string) $this->ve10_veiccaditensobrigtipobaixa) == null ){ 
         $this->erro_sql = " Campo Tipo de baixa nao Informado.";
         $this->erro_campo = "ve10_veiccaditensobrigtipobaixa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve10_veicitensobrig)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve10_veicitensobrig"])){ 
       $sql  .= $virgula." ve10_veicitensobrig = $this->ve10_veicitensobrig ";
       $virgula = ",";
       if(trim((string) $this->ve10_veicitensobrig) == null ){ 
         $this->erro_sql = " Campo Item nao Informado.";
         $this->erro_campo = "ve10_veicitensobrig";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve10_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve10_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ve10_data_dia"] !="") ){ 
       $sql  .= $virgula." ve10_data = '$this->ve10_data' ";
       $virgula = ",";
       if(trim((string) $this->ve10_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "ve10_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve10_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve10_hora"])){ 
       $sql  .= $virgula." ve10_hora = '$this->ve10_hora' ";
       $virgula = ",";
       if(trim((string) $this->ve10_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "ve10_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve10_motivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve10_motivo"])){ 
       $sql  .= $virgula." ve10_motivo = '$this->ve10_motivo' ";
       $virgula = ",";
       if(trim((string) $this->ve10_motivo) == null ){ 
         $this->erro_sql = " Campo Motivo nao Informado.";
         $this->erro_campo = "ve10_motivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve10_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1913,11098,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve10_sequencial'))."','$this->ve10_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve10_veiccaditensobrigtipobaixa"]))
           $resac = db_query("insert into db_acount values($acount,1913,11099,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve10_veiccaditensobrigtipobaixa'))."','$this->ve10_veiccaditensobrigtipobaixa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve10_veicitensobrig"]))
           $resac = db_query("insert into db_acount values($acount,1913,11100,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve10_veicitensobrig'))."','$this->ve10_veicitensobrig',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve10_data"]))
           $resac = db_query("insert into db_acount values($acount,1913,11101,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve10_data'))."','$this->ve10_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve10_hora"]))
           $resac = db_query("insert into db_acount values($acount,1913,11102,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve10_hora'))."','$this->ve10_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve10_motivo"]))
           $resac = db_query("insert into db_acount values($acount,1913,11103,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve10_motivo'))."','$this->ve10_motivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve10_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1913,11098,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve10_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1913,11099,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve10_veiccaditensobrigtipobaixa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1913,11100,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve10_veicitensobrig'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1913,11101,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve10_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1913,11102,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve10_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1913,11103,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve10_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
