...
class cl_grupotaxa { 
   ...
   public $ar37_sequencial = 0; 
   public $ar37_grupotaxatipo = 0; 
   public $ar37_descricao = null; 
   ...
   function incluir ($ar37_sequencial){ 
     ...
     if($ar37_sequencial == "" || $ar37_sequencial == null ){
       ...
       $this->ar37_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from grupotaxa_ar37_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ar37_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3222,18222,'','".AddSlashes(pg_fetch_result($resaco,0,'ar37_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3222,18223,'','".AddSlashes(pg_fetch_result($resaco,0,'ar37_grupotaxatipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3222,18224,'','".AddSlashes(pg_fetch_result($resaco,0,'ar37_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ar37_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ar37_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar37_sequencial"])){ 
       $sql  .= $virgula." ar37_sequencial = $this->ar37_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ar37_sequencial) == null ){ 
     ...
     if(trim((string) $this->ar37_grupotaxatipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar37_grupotaxatipo"])){ 
       $sql  .= $virgula." ar37_grupotaxatipo = $this->ar37_grupotaxatipo ";
       $virgula = ",";
       if(trim((string) $this->ar37_grupotaxatipo) == null ){ 
         $this->erro_sql = " Campo Grupo da Taxa nao Informado.";
         $this->erro_campo = "ar37_grupotaxatipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ar37_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar37_descricao"])){ 
       $sql  .= $virgula." ar37_descricao = '$this->ar37_descricao' ";
       $virgula = ",";
       if(trim((string) $this->ar37_descricao) == null ){ 
         $this->erro_sql = " Campo Descricao nao Informado.";
         $this->erro_campo = "ar37_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar37_sequencial"]) || $this->ar37_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3222,18222,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar37_sequencial'))."','$this->ar37_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar37_grupotaxatipo"]) || $this->ar37_grupotaxatipo != "")
           $resac = db_query("insert into db_acount values($acount,3222,18223,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar37_grupotaxatipo'))."','$this->ar37_grupotaxatipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar37_descricao"]) || $this->ar37_descricao != "")
           $resac = db_query("insert into db_acount values($acount,3222,18224,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar37_descricao'))."','$this->ar37_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ar37_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3222,18222,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar37_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3222,18223,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar37_grupotaxatipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3222,18224,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar37_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
