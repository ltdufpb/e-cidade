...
class cl_mensageriaacordodb_usuario { 
   ...
   public $ac52_sequencial = 0; 
   public $ac52_db_usuarios = 0; 
   public $ac52_dias = 0; 
   ...
   function incluir ($ac52_sequencial){ 
     ...
     if($ac52_sequencial == "" || $ac52_sequencial == null ){
       ...
       $this->ac52_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mensageriaacordodb_usuario_ac52_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac52_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3702,20577,'','".AddSlashes(pg_fetch_result($resaco,0,'ac52_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3702,20579,'','".AddSlashes(pg_fetch_result($resaco,0,'ac52_db_usuarios'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3702,20580,'','".AddSlashes(pg_fetch_result($resaco,0,'ac52_dias'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($ac52_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac52_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac52_sequencial"])){ 
       $sql  .= $virgula." ac52_sequencial = $this->ac52_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac52_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac52_db_usuarios)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac52_db_usuarios"])){ 
       $sql  .= $virgula." ac52_db_usuarios = $this->ac52_db_usuarios ";
       $virgula = ",";
       if(trim((string) $this->ac52_db_usuarios) == null ){ 
         $this->erro_sql = " Campo db_usuarios não informado.";
         $this->erro_campo = "ac52_db_usuarios";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac52_dias)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac52_dias"])){ 
       $sql  .= $virgula." ac52_dias = $this->ac52_dias ";
       $virgula = ",";
       if(trim((string) $this->ac52_dias) == null ){ 
         $this->erro_sql = " Campo Dias não informado.";
         $this->erro_campo = "ac52_dias";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["ac52_sequencial"]) || $this->ac52_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3702,20577,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac52_sequencial'))."','$this->ac52_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ac52_db_usuarios"]) || $this->ac52_db_usuarios != "")
             $resac = db_query("insert into db_acount values($acount,3702,20579,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac52_db_usuarios'))."','$this->ac52_db_usuarios',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ac52_dias"]) || $this->ac52_dias != "")
             $resac = db_query("insert into db_acount values($acount,3702,20580,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac52_dias'))."','$this->ac52_dias',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3702,20577,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac52_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3702,20579,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac52_db_usuarios'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3702,20580,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac52_dias'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
