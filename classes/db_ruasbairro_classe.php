...
class cl_ruasbairro { 
   ...
   function incluir ($j16_codigo){ 
     ...
     if($j16_codigo == "" || $j16_codigo == null ){
       ...
       $this->j16_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from ruasbairro_j16_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $j16_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1371,8121,'','".AddSlashes(pg_fetch_result($resaco,0,'j16_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1371,8122,'','".AddSlashes(pg_fetch_result($resaco,0,'j16_lograd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1371,8123,'','".AddSlashes(pg_fetch_result($resaco,0,'j16_bairro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j16_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j16_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j16_codigo"])){ 
       $sql  .= $virgula." j16_codigo = $this->j16_codigo ";
       $virgula = ",";
       if(trim((string) $this->j16_codigo) == null ){ 
     ...
     if(trim((string) $this->j16_lograd)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j16_lograd"])){ 
       $sql  .= $virgula." j16_lograd = $this->j16_lograd ";
       $virgula = ",";
       if(trim((string) $this->j16_lograd) == null ){ 
         $this->erro_sql = " Campo Cód. Logradouro nao Informado.";
         $this->erro_campo = "j16_lograd";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j16_bairro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j16_bairro"])){ 
       $sql  .= $virgula." j16_bairro = $this->j16_bairro ";
       $virgula = ",";
       if(trim((string) $this->j16_bairro) == null ){ 
         $this->erro_sql = " Campo Cód. do Bairro nao Informado.";
         $this->erro_campo = "j16_bairro";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j16_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1371,8121,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j16_codigo'))."','$this->j16_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j16_lograd"]))
           $resac = db_query("insert into db_acount values($acount,1371,8122,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j16_lograd'))."','$this->j16_lograd',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j16_bairro"]))
           $resac = db_query("insert into db_acount values($acount,1371,8123,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j16_bairro'))."','$this->j16_bairro',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j16_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1371,8121,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j16_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1371,8122,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j16_lograd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1371,8123,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j16_bairro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
