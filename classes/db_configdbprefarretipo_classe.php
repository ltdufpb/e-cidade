...
class cl_configdbprefarretipo { 
   ...
   public $w17_sequencial = 0; 
   public $w17_arretipo = 0; 
   public $w17_instit = 0; 
   public $w17_dtini_dia = null; 
   public $w17_dtini_mes = null; 
   public $w17_dtini_ano = null; 
   public $w17_dtini = null; 
   public $w17_dtfim_dia = null; 
   public $w17_dtfim_mes = null; 
   public $w17_dtfim_ano = null; 
   public $w17_dtfim = null; 
   ...
   function incluir ($w17_sequencial){ 
     ...
     if($w17_sequencial == "" || $w17_sequencial == null ){
       ...
       $this->w17_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from configdbprefarretipo_w17_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $w17_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2570,14619,'','".AddSlashes(pg_fetch_result($resaco,0,'w17_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2570,14620,'','".AddSlashes(pg_fetch_result($resaco,0,'w17_arretipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2570,14621,'','".AddSlashes(pg_fetch_result($resaco,0,'w17_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2570,14622,'','".AddSlashes(pg_fetch_result($resaco,0,'w17_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2570,14623,'','".AddSlashes(pg_fetch_result($resaco,0,'w17_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($w17_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->w17_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["w17_sequencial"])){ 
       $sql  .= $virgula." w17_sequencial = $this->w17_sequencial ";
       $virgula = ",";
       if(trim((string) $this->w17_sequencial) == null ){ 
     ...
     if(trim((string) $this->w17_arretipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["w17_arretipo"])){ 
       $sql  .= $virgula." w17_arretipo = $this->w17_arretipo ";
       $virgula = ",";
       if(trim((string) $this->w17_arretipo) == null ){ 
         $this->erro_sql = " Campo Tipo de Débito nao Informado.";
         $this->erro_campo = "w17_arretipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->w17_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["w17_instit"])){ 
       $sql  .= $virgula." w17_instit = $this->w17_instit ";
       $virgula = ",";
       if(trim((string) $this->w17_instit) == null ){ 
         $this->erro_sql = " Campo Intituíção nao Informado.";
         $this->erro_campo = "w17_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->w17_dtini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["w17_dtini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["w17_dtini_dia"] !="") ){ 
       $sql  .= $virgula." w17_dtini = '$this->w17_dtini' ";
       $virgula = ",";
       if(trim((string) $this->w17_dtini) == null ){ 
         $this->erro_sql = " Campo Vencimento Inicial nao Informado.";
         $this->erro_campo = "w17_dtini_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->w17_dtfim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["w17_dtfim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["w17_dtfim_dia"] !="") ){ 
       $sql  .= $virgula." w17_dtfim = '$this->w17_dtfim' ";
       $virgula = ",";
       if(trim((string) $this->w17_dtfim) == null ){ 
         $this->erro_sql = " Campo Vencimento Final nao Informado.";
         $this->erro_campo = "w17_dtfim_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["w17_sequencial"]) || $this->w17_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2570,14619,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'w17_sequencial'))."','$this->w17_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w17_arretipo"]) || $this->w17_arretipo != "")
           $resac = db_query("insert into db_acount values($acount,2570,14620,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'w17_arretipo'))."','$this->w17_arretipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w17_instit"]) || $this->w17_instit != "")
           $resac = db_query("insert into db_acount values($acount,2570,14621,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'w17_instit'))."','$this->w17_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w17_dtini"]) || $this->w17_dtini != "")
           $resac = db_query("insert into db_acount values($acount,2570,14622,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'w17_dtini'))."','$this->w17_dtini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w17_dtfim"]) || $this->w17_dtfim != "")
           $resac = db_query("insert into db_acount values($acount,2570,14623,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'w17_dtfim'))."','$this->w17_dtfim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($w17_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2570,14619,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'w17_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2570,14620,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'w17_arretipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2570,14621,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'w17_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2570,14622,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'w17_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2570,14623,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'w17_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
