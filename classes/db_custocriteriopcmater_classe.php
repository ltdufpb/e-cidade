...
class cl_custocriteriopcmater { 
   ...
   public $cc10_sequencial = 0; 
   public $cc10_pcmater = 0; 
   public $cc10_custocriteriorateio = 0; 
   ...
   function incluir ($cc10_sequencial){ 
     ...
     if($cc10_sequencial == "" || $cc10_sequencial == null ){
       ...
       $this->cc10_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from custocriteriopcmater_cc10_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $cc10_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2347,13416,'','".AddSlashes(pg_fetch_result($resaco,0,'cc10_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2347,13417,'','".AddSlashes(pg_fetch_result($resaco,0,'cc10_pcmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2347,13418,'','".AddSlashes(pg_fetch_result($resaco,0,'cc10_custocriteriorateio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($cc10_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->cc10_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc10_sequencial"])){ 
       $sql  .= $virgula." cc10_sequencial = $this->cc10_sequencial ";
       $virgula = ",";
       if(trim((string) $this->cc10_sequencial) == null ){ 
     ...
     if(trim((string) $this->cc10_pcmater)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc10_pcmater"])){ 
       $sql  .= $virgula." cc10_pcmater = $this->cc10_pcmater ";
       $virgula = ",";
       if(trim((string) $this->cc10_pcmater) == null ){ 
         $this->erro_sql = " Campo Código do Material nao Informado.";
         $this->erro_campo = "cc10_pcmater";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cc10_custocriteriorateio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc10_custocriteriorateio"])){ 
       $sql  .= $virgula." cc10_custocriteriorateio = $this->cc10_custocriteriorateio ";
       $virgula = ",";
       if(trim((string) $this->cc10_custocriteriorateio) == null ){ 
         $this->erro_sql = " Campo Criterio de Rateio nao Informado.";
         $this->erro_campo = "cc10_custocriteriorateio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc10_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2347,13416,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc10_sequencial'))."','$this->cc10_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc10_pcmater"]))
           $resac = db_query("insert into db_acount values($acount,2347,13417,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc10_pcmater'))."','$this->cc10_pcmater',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc10_custocriteriorateio"]))
           $resac = db_query("insert into db_acount values($acount,2347,13418,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc10_custocriteriorateio'))."','$this->cc10_custocriteriorateio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($cc10_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2347,13416,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc10_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2347,13417,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc10_pcmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2347,13418,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc10_custocriteriorateio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
