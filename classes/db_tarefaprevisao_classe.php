...
class cl_tarefaprevisao { 
   ...
   public $at81_sequencial = 0; 
   public $at81_tarefa = 0; 
   public $at81_usuario = 0; 
   public $at81_dtlanc_dia = null; 
   public $at81_dtlanc_mes = null; 
   public $at81_dtlanc_ano = null; 
   public $at81_dtlanc = null; 
   ...
   function incluir ($at81_sequencial){ 
     ...
     if($at81_sequencial == "" || $at81_sequencial == null ){
       ...
       $this->at81_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tarefaprevisao_at81_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at81_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2635,14989,'','".AddSlashes(pg_fetch_result($resaco,0,'at81_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2635,14990,'','".AddSlashes(pg_fetch_result($resaco,0,'at81_tarefa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2635,14991,'','".AddSlashes(pg_fetch_result($resaco,0,'at81_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2635,14992,'','".AddSlashes(pg_fetch_result($resaco,0,'at81_dtlanc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2635,14993,'','".AddSlashes(pg_fetch_result($resaco,0,'at81_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2635,15267,'','".AddSlashes(pg_fetch_result($resaco,0,'at81_ordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at81_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at81_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at81_sequencial"])){ 
       $sql  .= $virgula." at81_sequencial = $this->at81_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at81_sequencial) == null ){ 
     ...
     if(trim((string) $this->at81_tarefa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at81_tarefa"])){ 
       $sql  .= $virgula." at81_tarefa = $this->at81_tarefa ";
       $virgula = ",";
       if(trim((string) $this->at81_tarefa) == null ){ 
         $this->erro_sql = " Campo Codigo da Tarefa nao Informado.";
         $this->erro_campo = "at81_tarefa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at81_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at81_usuario"])){ 
       $sql  .= $virgula." at81_usuario = $this->at81_usuario ";
       $virgula = ",";
       if(trim((string) $this->at81_usuario) == null ){ 
         $this->erro_sql = " Campo Cod. Usuário nao Informado.";
         $this->erro_campo = "at81_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at81_dtlanc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at81_dtlanc_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["at81_dtlanc_dia"] !="") ){ 
       $sql  .= $virgula." at81_dtlanc = '$this->at81_dtlanc' ";
       $virgula = ",";
       if(trim((string) $this->at81_dtlanc) == null ){ 
         $this->erro_sql = " Campo Data de Lançamento nao Informado.";
         $this->erro_campo = "at81_dtlanc_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at81_ordem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at81_ordem"])){ 
       $sql  .= $virgula." at81_ordem = $this->at81_ordem ";
       $virgula = ",";
       if(trim((string) $this->at81_ordem) == null ){ 
         $this->erro_sql = " Campo Ordem de Execução nao Informado.";
         $this->erro_campo = "at81_ordem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at81_sequencial"]) || $this->at81_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2635,14989,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at81_sequencial'))."','$this->at81_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at81_tarefa"]) || $this->at81_tarefa != "")
           $resac = db_query("insert into db_acount values($acount,2635,14990,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at81_tarefa'))."','$this->at81_tarefa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at81_usuario"]) || $this->at81_usuario != "")
           $resac = db_query("insert into db_acount values($acount,2635,14991,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at81_usuario'))."','$this->at81_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at81_dtlanc"]) || $this->at81_dtlanc != "")
           $resac = db_query("insert into db_acount values($acount,2635,14992,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at81_dtlanc'))."','$this->at81_dtlanc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at81_hora"]) || $this->at81_hora != "")
           $resac = db_query("insert into db_acount values($acount,2635,14993,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at81_hora'))."','$this->at81_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at81_ordem"]) || $this->at81_ordem != "")
           $resac = db_query("insert into db_acount values($acount,2635,15267,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at81_ordem'))."','$this->at81_ordem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at81_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2635,14989,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at81_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2635,14990,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at81_tarefa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2635,14991,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at81_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2635,14992,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at81_dtlanc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2635,14993,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at81_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2635,15267,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at81_ordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
