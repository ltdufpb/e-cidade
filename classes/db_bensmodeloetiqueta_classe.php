...
class cl_bensmodeloetiqueta { 
   ...
   public $t71_sequencial = 0; 
   public $t71_descr = null; 
   public $t71_strxml = null; 
   ...
   function incluir ($t71_sequencial){ 
     ...
     if($t71_sequencial == "" || $t71_sequencial == null ){
       ...
       $this->t71_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from bensmodeloetiqueta_t71_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $t71_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2729,15557,'','".AddSlashes(pg_fetch_result($resaco,0,'t71_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2729,15558,'','".AddSlashes(pg_fetch_result($resaco,0,'t71_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2729,15559,'','".AddSlashes(pg_fetch_result($resaco,0,'t71_strxml'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($t71_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->t71_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t71_sequencial"])){ 
       $sql  .= $virgula." t71_sequencial = $this->t71_sequencial ";
       $virgula = ",";
       if(trim((string) $this->t71_sequencial) == null ){ 
     ...
     if(trim((string) $this->t71_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t71_descr"])){ 
       $sql  .= $virgula." t71_descr = '$this->t71_descr' ";
       $virgula = ",";
       if(trim((string) $this->t71_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "t71_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->t71_strxml)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t71_strxml"])){ 
       $sql  .= $virgula." t71_strxml = '$this->t71_strxml' ";
       $virgula = ",";
       if(trim((string) $this->t71_strxml) == null ){ 
         $this->erro_sql = " Campo XML nao Informado.";
         $this->erro_campo = "t71_strxml";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["t71_sequencial"]) || $this->t71_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2729,15557,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t71_sequencial'))."','$this->t71_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t71_descr"]) || $this->t71_descr != "")
           $resac = db_query("insert into db_acount values($acount,2729,15558,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t71_descr'))."','$this->t71_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t71_strxml"]) || $this->t71_strxml != "")
           $resac = db_query("insert into db_acount values($acount,2729,15559,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t71_strxml'))."','$this->t71_strxml',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     //echo "\n\n".($sql)."\n\n";
     $result = db_query($sql);
   ...
   function excluir ($t71_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2729,15557,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t71_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2729,15558,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t71_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2729,15559,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t71_strxml'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
