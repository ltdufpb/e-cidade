...
class cl_veicmanutoficina { 
   ...
   public $ve66_codigo = 0; 
   public $ve66_veicmanut = 0; 
   public $ve66_veiccadoficinas = 0; 
   ...
   function incluir ($ve66_codigo){ 
     ...
     if($ve66_codigo == "" || $ve66_codigo == null ){
       ...
       $this->ve66_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veicmanutoficina_ve66_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve66_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1607,9349,'','".AddSlashes(pg_fetch_result($resaco,0,'ve66_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1607,9350,'','".AddSlashes(pg_fetch_result($resaco,0,'ve66_veicmanut'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1607,9351,'','".AddSlashes(pg_fetch_result($resaco,0,'ve66_veiccadoficinas'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve66_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve66_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve66_codigo"])){ 
       $sql  .= $virgula." ve66_codigo = $this->ve66_codigo ";
       $virgula = ",";
       if(trim((string) $this->ve66_codigo) == null ){ 
     ...
     if(trim((string) $this->ve66_veicmanut)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve66_veicmanut"])){ 
       $sql  .= $virgula." ve66_veicmanut = $this->ve66_veicmanut ";
       $virgula = ",";
       if(trim((string) $this->ve66_veicmanut) == null ){ 
         $this->erro_sql = " Campo Manutenção nao Informado.";
         $this->erro_campo = "ve66_veicmanut";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve66_veiccadoficinas)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve66_veiccadoficinas"])){ 
       $sql  .= $virgula." ve66_veiccadoficinas = $this->ve66_veiccadoficinas ";
       $virgula = ",";
       if(trim((string) $this->ve66_veiccadoficinas) == null ){ 
         $this->erro_sql = " Campo Oficina nao Informado.";
         $this->erro_campo = "ve66_veiccadoficinas";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve66_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1607,9349,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve66_codigo'))."','$this->ve66_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve66_veicmanut"]))
           $resac = db_query("insert into db_acount values($acount,1607,9350,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve66_veicmanut'))."','$this->ve66_veicmanut',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve66_veiccadoficinas"]))
           $resac = db_query("insert into db_acount values($acount,1607,9351,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve66_veiccadoficinas'))."','$this->ve66_veiccadoficinas',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve66_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1607,9349,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve66_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1607,9350,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve66_veicmanut'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1607,9351,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve66_veiccadoficinas'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
