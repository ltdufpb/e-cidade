   ...
   // cria propriedade com as variaveis do arquivo 
    ...
    public function incluir($fa58_codigo)
    {
     ...
     if($fa58_codigo == "" || $fa58_codigo == null ){
       ...
       $this->fa58_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from medicamentos_fa58_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa58_codigo)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3836,21286,'','".AddSlashes(pg_fetch_result($resaco,0,'fa58_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3836,21287,'','".AddSlashes(pg_fetch_result($resaco,0,'fa58_catmat'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3836,21288,'','".AddSlashes(pg_fetch_result($resaco,0,'fa58_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
    ...
    public function alterar($fa58_codigo=null)
    {
     ...
     $virgula = "";
     if(trim((string) $this->fa58_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa58_codigo"])){ 
       $sql  .= $virgula." fa58_codigo = $this->fa58_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa58_codigo) == null ){ 
     ...
     if(trim((string) $this->fa58_catmat)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa58_catmat"])){ 
       $sql  .= $virgula." fa58_catmat = '$this->fa58_catmat' ";
       $virgula = ",";
       if(trim((string) $this->fa58_catmat) == null ){ 
         $this->erro_sql = " Campo CATMAT não informado.";
         $this->erro_campo = "fa58_catmat";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa58_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa58_descricao"])){ 
       $sql  .= $virgula." fa58_descricao = '$this->fa58_descricao' ";
       $virgula = ",";
       if(trim((string) $this->fa58_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição não informado.";
         $this->erro_campo = "fa58_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["fa58_codigo"]) || $this->fa58_codigo != "")
             $resac = db_query("insert into db_acount values($acount,3836,21286,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa58_codigo'))."','$this->fa58_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["fa58_catmat"]) || $this->fa58_catmat != "")
             $resac = db_query("insert into db_acount values($acount,3836,21287,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa58_catmat'))."','$this->fa58_catmat',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["fa58_descricao"]) || $this->fa58_descricao != "")
             $resac = db_query("insert into db_acount values($acount,3836,21288,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa58_descricao'))."','$this->fa58_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3836,21286,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa58_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3836,21287,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa58_catmat'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3836,21288,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa58_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
