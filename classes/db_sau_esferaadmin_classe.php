...
class cl_sau_esferaadmin { 
   ...
   public $sd37_i_cod_esfadm = 0; 
   public $sd37_v_descricao = null; 
   ...
   function incluir ($sd37_i_cod_esfadm){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1954,11404,'','".AddSlashes(pg_fetch_result($resaco,0,'sd37_i_cod_esfadm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1954,11405,'','".AddSlashes(pg_fetch_result($resaco,0,'sd37_v_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd37_i_cod_esfadm=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd37_i_cod_esfadm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd37_i_cod_esfadm"])){ 
       $sql  .= $virgula." sd37_i_cod_esfadm = $this->sd37_i_cod_esfadm ";
       $virgula = ",";
       if(trim((string) $this->sd37_i_cod_esfadm) == null ){ 
     ...
     if(trim((string) $this->sd37_v_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd37_v_descricao"])){ 
       $sql  .= $virgula." sd37_v_descricao = '$this->sd37_v_descricao' ";
       $virgula = ",";
       if(trim((string) $this->sd37_v_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "sd37_v_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd37_i_cod_esfadm"]))
           $resac = db_query("insert into db_acount values($acount,1954,11404,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd37_i_cod_esfadm'))."','$this->sd37_i_cod_esfadm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd37_v_descricao"]))
           $resac = db_query("insert into db_acount values($acount,1954,11405,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd37_v_descricao'))."','$this->sd37_v_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd37_i_cod_esfadm=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1954,11404,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd37_i_cod_esfadm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1954,11405,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd37_v_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
