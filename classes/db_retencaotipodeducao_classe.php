...
class cl_retencaotipodeducao { 
   ...
   public $e24_sequencial = 0; 
   public $e24_pcmater = 0; 
   public $e24_aliquota = 0; 
   public $e24_descricao = null; 
   ...
   function incluir ($e24_sequencial){ 
     ...
     if($e24_sequencial == "" || $e24_sequencial == null ){
       ...
       $this->e24_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from retencaotipodeducao_e24_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $e24_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2114,12169,'','".AddSlashes(pg_fetch_result($resaco,0,'e24_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2114,12170,'','".AddSlashes(pg_fetch_result($resaco,0,'e24_pcmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2114,12171,'','".AddSlashes(pg_fetch_result($resaco,0,'e24_aliquota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2114,12172,'','".AddSlashes(pg_fetch_result($resaco,0,'e24_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e24_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e24_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e24_sequencial"])){ 
       $sql  .= $virgula." e24_sequencial = $this->e24_sequencial ";
       $virgula = ",";
       if(trim((string) $this->e24_sequencial) == null ){ 
     ...
     if(trim((string) $this->e24_pcmater)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e24_pcmater"])){ 
       $sql  .= $virgula." e24_pcmater = $this->e24_pcmater ";
       $virgula = ",";
       if(trim((string) $this->e24_pcmater) == null ){ 
         $this->erro_sql = " Campo Código do Material nao Informado.";
         $this->erro_campo = "e24_pcmater";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e24_aliquota)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e24_aliquota"])){ 
       $sql  .= $virgula." e24_aliquota = $this->e24_aliquota ";
       $virgula = ",";
       if(trim((string) $this->e24_aliquota) == null ){ 
         $this->erro_sql = " Campo Aliquota nao Informado.";
         $this->erro_campo = "e24_aliquota";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e24_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e24_descricao"])){ 
       $sql  .= $virgula." e24_descricao = '$this->e24_descricao' ";
       $virgula = ",";
       if(trim((string) $this->e24_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição da Dedução nao Informado.";
         $this->erro_campo = "e24_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e24_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2114,12169,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e24_sequencial'))."','$this->e24_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e24_pcmater"]))
           $resac = db_query("insert into db_acount values($acount,2114,12170,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e24_pcmater'))."','$this->e24_pcmater',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e24_aliquota"]))
           $resac = db_query("insert into db_acount values($acount,2114,12171,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e24_aliquota'))."','$this->e24_aliquota',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e24_descricao"]))
           $resac = db_query("insert into db_acount values($acount,2114,12172,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e24_descricao'))."','$this->e24_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e24_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2114,12169,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e24_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2114,12170,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e24_pcmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2114,12171,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e24_aliquota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2114,12172,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e24_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
