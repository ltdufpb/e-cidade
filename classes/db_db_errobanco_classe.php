...
class cl_db_errobanco { 
   ...
   public $e78_codban = null; 
   public $e78_errobanco = 0; 
   ...
   function incluir ($e78_codban,$e78_errobanco){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1211,7293,'','".AddSlashes(pg_fetch_result($resaco,0,'e78_codban'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1211,7292,'','".AddSlashes(pg_fetch_result($resaco,0,'e78_errobanco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e78_codban=null,$e78_errobanco=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e78_codban)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e78_codban"])){ 
       $sql  .= $virgula." e78_codban = '$this->e78_codban' ";
       $virgula = ",";
       if(trim((string) $this->e78_codban) == null ){ 
     ...
     if(trim((string) $this->e78_errobanco)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e78_errobanco"])){ 
       $sql  .= $virgula." e78_errobanco = $this->e78_errobanco ";
       $virgula = ",";
       if(trim((string) $this->e78_errobanco) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e78_codban"]))
           $resac = db_query("insert into db_acount values($acount,1211,7293,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e78_codban'))."','$this->e78_codban',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e78_errobanco"]))
           $resac = db_query("insert into db_acount values($acount,1211,7292,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e78_errobanco'))."','$this->e78_errobanco',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e78_codban=null,$e78_errobanco=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1211,7293,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e78_codban'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1211,7292,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e78_errobanco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
