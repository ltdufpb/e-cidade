...
class cl_efetividaderh { 
   ...
   public $ed98_i_codigo = 0; 
   public $ed98_i_escola = 0; 
   public $ed98_i_mes = 0; 
   public $ed98_i_ano = 0; 
   public $ed98_c_tipo = null; 
   public $ed98_d_dataini_dia = null; 
   public $ed98_d_dataini_mes = null; 
   public $ed98_d_dataini_ano = null; 
   public $ed98_d_dataini = null; 
   public $ed98_d_datafim_dia = null; 
   public $ed98_d_datafim_mes = null; 
   public $ed98_d_datafim_ano = null; 
   public $ed98_d_datafim = null; 
   public $ed98_c_tipocomp = null; 
   ...
   function incluir ($ed98_i_codigo){ 
     ...
     if($ed98_i_codigo == "" || $ed98_i_codigo == null ){
       ...
       $this->ed98_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from efetividaderh_ed98_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed98_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010156,1009003,'','".AddSlashes(pg_fetch_result($resaco,0,'ed98_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010156,1009004,'','".AddSlashes(pg_fetch_result($resaco,0,'ed98_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010156,1009001,'','".AddSlashes(pg_fetch_result($resaco,0,'ed98_i_mes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010156,1009002,'','".AddSlashes(pg_fetch_result($resaco,0,'ed98_i_ano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010156,1009005,'','".AddSlashes(pg_fetch_result($resaco,0,'ed98_c_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010156,14557,'','".AddSlashes(pg_fetch_result($resaco,0,'ed98_d_dataini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010156,14558,'','".AddSlashes(pg_fetch_result($resaco,0,'ed98_d_datafim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010156,14559,'','".AddSlashes(pg_fetch_result($resaco,0,'ed98_c_tipocomp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed98_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed98_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed98_i_codigo"])){ 
       $sql  .= $virgula." ed98_i_codigo = $this->ed98_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed98_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed98_i_escola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed98_i_escola"])){ 
       $sql  .= $virgula." ed98_i_escola = $this->ed98_i_escola ";
       $virgula = ",";
       if(trim((string) $this->ed98_i_escola) == null ){ 
         $this->erro_sql = " Campo Escola nao Informado.";
         $this->erro_campo = "ed98_i_escola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed98_i_mes)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed98_i_mes"])){ 
        if(trim((string) $this->ed98_i_mes)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed98_i_mes"])){ 
           $this->ed98_i_mes = "null" ;
        } 
     ...
     if(trim((string) $this->ed98_i_ano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed98_i_ano"])){ 
        if(trim((string) $this->ed98_i_ano)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed98_i_ano"])){ 
           $this->ed98_i_ano = "null" ;
        } 
     ...
     if(trim((string) $this->ed98_c_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed98_c_tipo"])){ 
       $sql  .= $virgula." ed98_c_tipo = '$this->ed98_c_tipo' ";
       $virgula = ",";
       if(trim((string) $this->ed98_c_tipo) == null ){ 
         $this->erro_sql = " Campo Efetividade de nao Informado.";
         $this->erro_campo = "ed98_c_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed98_d_dataini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed98_d_dataini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed98_d_dataini_dia"] !="") ){ 
       $sql  .= $virgula." ed98_d_dataini = '$this->ed98_d_dataini' ";
       $virgula = ",";
       if(trim((string) $this->ed98_d_dataini) == null ){ 
         $this->erro_sql = " Campo Data Inicial nao Informado.";
         $this->erro_campo = "ed98_d_dataini_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed98_d_datafim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed98_d_datafim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed98_d_datafim_dia"] !="") ){ 
       $sql  .= $virgula." ed98_d_datafim = '$this->ed98_d_datafim' ";
       $virgula = ",";
       if(trim((string) $this->ed98_d_datafim) == null ){ 
         $this->erro_sql = " Campo Data Final nao Informado.";
         $this->erro_campo = "ed98_d_datafim_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed98_c_tipocomp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed98_c_tipocomp"])){ 
       $sql  .= $virgula." ed98_c_tipocomp = '$this->ed98_c_tipocomp' ";
       $virgula = ",";
       if(trim((string) $this->ed98_c_tipocomp) == null ){ 
         $this->erro_sql = " Campo Tipo de Competência nao Informado.";
         $this->erro_campo = "ed98_c_tipocomp";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed98_i_codigo"]) || $this->ed98_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,1010156,1009003,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed98_i_codigo'))."','$this->ed98_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed98_i_escola"]) || $this->ed98_i_escola != "")
           $resac = db_query("insert into db_acount values($acount,1010156,1009004,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed98_i_escola'))."','$this->ed98_i_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed98_i_mes"]) || $this->ed98_i_mes != "")
           $resac = db_query("insert into db_acount values($acount,1010156,1009001,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed98_i_mes'))."','$this->ed98_i_mes',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed98_i_ano"]) || $this->ed98_i_ano != "")
           $resac = db_query("insert into db_acount values($acount,1010156,1009002,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed98_i_ano'))."','$this->ed98_i_ano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed98_c_tipo"]) || $this->ed98_c_tipo != "")
           $resac = db_query("insert into db_acount values($acount,1010156,1009005,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed98_c_tipo'))."','$this->ed98_c_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed98_d_dataini"]) || $this->ed98_d_dataini != "")
           $resac = db_query("insert into db_acount values($acount,1010156,14557,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed98_d_dataini'))."','$this->ed98_d_dataini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed98_d_datafim"]) || $this->ed98_d_datafim != "")
           $resac = db_query("insert into db_acount values($acount,1010156,14558,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed98_d_datafim'))."','$this->ed98_d_datafim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed98_c_tipocomp"]) || $this->ed98_c_tipocomp != "")
           $resac = db_query("insert into db_acount values($acount,1010156,14559,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed98_c_tipocomp'))."','$this->ed98_c_tipocomp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed98_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010156,1009003,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed98_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010156,1009004,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed98_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010156,1009001,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed98_i_mes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010156,1009002,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed98_i_ano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010156,1009005,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed98_c_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010156,14557,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed98_d_dataini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010156,14558,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed98_d_datafim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010156,14559,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed98_c_tipocomp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
