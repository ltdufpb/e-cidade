...
class cl_pactovalormovsolicitem { 
   ...
   public $o101_sequencial = 0; 
   public $o101_solicitem = 0; 
   public $o101_pactovalormov = 0; 
   ...
   function incluir ($o101_sequencial){ 
     ...
     if($o101_sequencial == "" || $o101_sequencial == null ){
       ...
       $this->o101_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from pactovalormovsolicitem_o101_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $o101_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2444,13907,'','".AddSlashes(pg_fetch_result($resaco,0,'o101_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2444,13910,'','".AddSlashes(pg_fetch_result($resaco,0,'o101_solicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2444,13913,'','".AddSlashes(pg_fetch_result($resaco,0,'o101_pactovalormov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o101_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o101_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o101_sequencial"])){ 
       $sql  .= $virgula." o101_sequencial = $this->o101_sequencial ";
       $virgula = ",";
       if(trim((string) $this->o101_sequencial) == null ){ 
     ...
     if(trim((string) $this->o101_solicitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o101_solicitem"])){ 
       $sql  .= $virgula." o101_solicitem = $this->o101_solicitem ";
       $virgula = ",";
       if(trim((string) $this->o101_solicitem) == null ){ 
         $this->erro_sql = " Campo Item Solicitação nao Informado.";
         $this->erro_campo = "o101_solicitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o101_pactovalormov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o101_pactovalormov"])){ 
       $sql  .= $virgula." o101_pactovalormov = $this->o101_pactovalormov ";
       $virgula = ",";
       if(trim((string) $this->o101_pactovalormov) == null ){ 
         $this->erro_sql = " Campo Movimentação do Item nao Informado.";
         $this->erro_campo = "o101_pactovalormov";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o101_sequencial"]) || $this->o101_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2444,13907,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o101_sequencial'))."','$this->o101_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o101_solicitem"]) || $this->o101_solicitem != "")
           $resac = db_query("insert into db_acount values($acount,2444,13910,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o101_solicitem'))."','$this->o101_solicitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o101_pactovalormov"]) || $this->o101_pactovalormov != "")
           $resac = db_query("insert into db_acount values($acount,2444,13913,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o101_pactovalormov'))."','$this->o101_pactovalormov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o101_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2444,13907,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o101_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2444,13910,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o101_solicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2444,13913,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o101_pactovalormov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
