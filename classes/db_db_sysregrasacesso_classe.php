...
class cl_db_sysregrasacesso { 
   ...
   public $db46_idacesso = 0; 
   public $db46_dtinicio_dia = null; 
   public $db46_dtinicio_mes = null; 
   public $db46_dtinicio_ano = null; 
   public $db46_dtinicio = null; 
   public $db46_horaini = null; 
   public $db46_datafinal_dia = null; 
   public $db46_datafinal_mes = null; 
   public $db46_datafinal_ano = null; 
   public $db46_datafinal = null; 
   public $db46_horafinal = null; 
   public $db46_id_usuario = 0; 
   public $db46_datacadastd_dia = null; 
   public $db46_datacadastd_mes = null; 
   public $db46_datacadastd_ano = null; 
   public $db46_datacadastd = null; 
   public $db46_observ = null; 
   ...
   function incluir ($db46_idacesso){ 
     ...
     if($db46_idacesso == "" || $db46_idacesso == null ){
       ...
       $this->db46_idacesso = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_sysregrasacesso_db46_idacesso_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db46_idacesso)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1772,10260,'','".AddSlashes(pg_fetch_result($resaco,0,'db46_idacesso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1772,10261,'','".AddSlashes(pg_fetch_result($resaco,0,'db46_dtinicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1772,10262,'','".AddSlashes(pg_fetch_result($resaco,0,'db46_horaini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1772,10263,'','".AddSlashes(pg_fetch_result($resaco,0,'db46_datafinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1772,10264,'','".AddSlashes(pg_fetch_result($resaco,0,'db46_horafinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1772,10265,'','".AddSlashes(pg_fetch_result($resaco,0,'db46_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1772,10266,'','".AddSlashes(pg_fetch_result($resaco,0,'db46_datacadastd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1772,10267,'','".AddSlashes(pg_fetch_result($resaco,0,'db46_observ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db46_idacesso=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db46_idacesso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db46_idacesso"])){ 
       $sql  .= $virgula." db46_idacesso = $this->db46_idacesso ";
       $virgula = ",";
       if(trim((string) $this->db46_idacesso) == null ){ 
     ...
     if(trim((string) $this->db46_dtinicio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db46_dtinicio_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["db46_dtinicio_dia"] !="") ){ 
       $sql  .= $virgula." db46_dtinicio = '$this->db46_dtinicio' ";
       $virgula = ",";
       if(trim((string) $this->db46_dtinicio) == null ){ 
         $this->erro_sql = " Campo Data Início nao Informado.";
         $this->erro_campo = "db46_dtinicio_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db46_horaini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db46_horaini"])){ 
       $sql  .= $virgula." db46_horaini = '$this->db46_horaini' ";
       $virgula = ",";
       if(trim((string) $this->db46_horaini) == null ){ 
         $this->erro_sql = " Campo Hora Início nao Informado.";
         $this->erro_campo = "db46_horaini";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db46_datafinal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db46_datafinal_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["db46_datafinal_dia"] !="") ){ 
       $sql  .= $virgula." db46_datafinal = '$this->db46_datafinal' ";
       $virgula = ",";
       if(trim((string) $this->db46_datafinal) == null ){ 
         $this->erro_sql = " Campo Data Final nao Informado.";
         $this->erro_campo = "db46_datafinal_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db46_horafinal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db46_horafinal"])){ 
       $sql  .= $virgula." db46_horafinal = '$this->db46_horafinal' ";
       $virgula = ",";
       if(trim((string) $this->db46_horafinal) == null ){ 
         $this->erro_sql = " Campo Hora Final nao Informado.";
         $this->erro_campo = "db46_horafinal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db46_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db46_id_usuario"])){ 
       $sql  .= $virgula." db46_id_usuario = $this->db46_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->db46_id_usuario) == null ){ 
         $this->erro_sql = " Campo Cod. Usuário nao Informado.";
         $this->erro_campo = "db46_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db46_datacadastd)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db46_datacadastd_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["db46_datacadastd_dia"] !="") ){ 
       $sql  .= $virgula." db46_datacadastd = '$this->db46_datacadastd' ";
       $virgula = ",";
       if(trim((string) $this->db46_datacadastd) == null ){ 
         $this->erro_sql = " Campo Data Cadastro nao Informado.";
         $this->erro_campo = "db46_datacadastd_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db46_observ)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db46_observ"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db46_idacesso"]))
           $resac = db_query("insert into db_acount values($acount,1772,10260,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db46_idacesso'))."','$this->db46_idacesso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db46_dtinicio"]))
           $resac = db_query("insert into db_acount values($acount,1772,10261,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db46_dtinicio'))."','$this->db46_dtinicio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db46_horaini"]))
           $resac = db_query("insert into db_acount values($acount,1772,10262,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db46_horaini'))."','$this->db46_horaini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db46_datafinal"]))
           $resac = db_query("insert into db_acount values($acount,1772,10263,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db46_datafinal'))."','$this->db46_datafinal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db46_horafinal"]))
           $resac = db_query("insert into db_acount values($acount,1772,10264,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db46_horafinal'))."','$this->db46_horafinal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db46_id_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1772,10265,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db46_id_usuario'))."','$this->db46_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db46_datacadastd"]))
           $resac = db_query("insert into db_acount values($acount,1772,10266,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db46_datacadastd'))."','$this->db46_datacadastd',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db46_observ"]))
           $resac = db_query("insert into db_acount values($acount,1772,10267,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db46_observ'))."','$this->db46_observ',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db46_idacesso=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1772,10260,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db46_idacesso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1772,10261,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db46_dtinicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1772,10262,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db46_horaini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1772,10263,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db46_datafinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1772,10264,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db46_horafinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1772,10265,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db46_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1772,10266,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db46_datacadastd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1772,10267,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db46_observ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
