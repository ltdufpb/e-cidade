...
class cl_autorizacaocirculacaoveiculo { 
   ...
   public $ve13_sequencial = 0; 
   public $ve13_instituicao = 0; 
   public $ve13_veiculo = 0; 
   public $ve13_motorista = 0; 
   public $ve13_datainicial_dia = null; 
   public $ve13_datainicial_mes = null; 
   public $ve13_datainicial_ano = null; 
   public $ve13_datainicial = null; 
   public $ve13_datafinal_dia = null; 
   public $ve13_datafinal_mes = null; 
   public $ve13_datafinal_ano = null; 
   public $ve13_datafinal = null; 
   public $ve13_dataemissao_dia = null; 
   public $ve13_dataemissao_mes = null; 
   public $ve13_dataemissao_ano = null; 
   public $ve13_dataemissao = null; 
   public $ve13_observacao = null;
   public $ve13_departamento = 0; 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->ve13_observacao ??= @$GLOBALS["HTTP_POST_VARS"]["ve13_observacao"];
   ...
   function incluir ($ve13_sequencial = null){
     ...
     if($ve13_sequencial == "" || $ve13_sequencial == null ){
       ...
       $this->ve13_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from autorizacaocirculacaoveiculo_ve13_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve13_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3845,21365,'','".AddSlashes(pg_fetch_result($resaco,0,'ve13_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3845,21366,'','".AddSlashes(pg_fetch_result($resaco,0,'ve13_instituicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3845,21367,'','".AddSlashes(pg_fetch_result($resaco,0,'ve13_veiculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3845,21368,'','".AddSlashes(pg_fetch_result($resaco,0,'ve13_motorista'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3845,21369,'','".AddSlashes(pg_fetch_result($resaco,0,'ve13_datainicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3845,21370,'','".AddSlashes(pg_fetch_result($resaco,0,'ve13_datafinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3845,21371,'','".AddSlashes(pg_fetch_result($resaco,0,'ve13_dataemissao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3845,21372,'','".AddSlashes(pg_fetch_result($resaco,0,'ve13_observacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3845,21377,'','".AddSlashes(pg_fetch_result($resaco,0,'ve13_departamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($ve13_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve13_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve13_sequencial"])){ 
       $sql  .= $virgula." ve13_sequencial = $this->ve13_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ve13_sequencial) == null ){ 
     ...
     if(trim((string) $this->ve13_instituicao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve13_instituicao"])){ 
       $sql  .= $virgula." ve13_instituicao = $this->ve13_instituicao ";
       $virgula = ",";
       if(trim((string) $this->ve13_instituicao) == null ){ 
         $this->erro_sql = " Campo Instituição não informado.";
         $this->erro_campo = "ve13_instituicao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve13_veiculo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve13_veiculo"])){ 
       $sql  .= $virgula." ve13_veiculo = $this->ve13_veiculo ";
       $virgula = ",";
       if(trim((string) $this->ve13_veiculo) == null ){ 
         $this->erro_sql = " Campo Veículo não informado.";
         $this->erro_campo = "ve13_veiculo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve13_motorista)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve13_motorista"])){ 
       $sql  .= $virgula." ve13_motorista = $this->ve13_motorista ";
       $virgula = ",";
       if(trim((string) $this->ve13_motorista) == null ){ 
         $this->erro_sql = " Campo Motorista não informado.";
         $this->erro_campo = "ve13_motorista";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve13_datainicial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve13_datainicial_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ve13_datainicial_dia"] !="") ){ 
       $sql  .= $virgula." ve13_datainicial = '$this->ve13_datainicial' ";
       $virgula = ",";
       if(trim((string) $this->ve13_datainicial) == null ){ 
         $this->erro_sql = " Campo Data Inicial não informado.";
         $this->erro_campo = "ve13_datainicial_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve13_datafinal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve13_datafinal_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ve13_datafinal_dia"] !="") ){ 
       $sql  .= $virgula." ve13_datafinal = '$this->ve13_datafinal' ";
       $virgula = ",";
       if(trim((string) $this->ve13_datafinal) == null ){ 
         $this->erro_sql = " Campo Data Final não informado.";
         $this->erro_campo = "ve13_datafinal_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve13_dataemissao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve13_dataemissao_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ve13_dataemissao_dia"] !="") ){ 
       $sql  .= $virgula." ve13_dataemissao = '$this->ve13_dataemissao' ";
       $virgula = ",";
       if(trim((string) $this->ve13_dataemissao) == null ){ 
         $this->erro_sql = " Campo Data de Emissão não informado.";
         $this->erro_campo = "ve13_dataemissao_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve13_observacao) !== null || isset($GLOBALS["HTTP_POST_VARS"]["ve13_observacao"])){
       $sql  .= $virgula." ve13_observacao = '$this->ve13_observacao' ";
       $virgula = ",";
     }
     if(trim((string) $this->ve13_departamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve13_departamento"])){
       $sql  .= $virgula." ve13_departamento = $this->ve13_departamento ";
       $virgula = ",";
       if(trim((string) $this->ve13_departamento) == null ){ 
         $this->erro_sql = " Campo Departamento não informado.";
         $this->erro_campo = "ve13_departamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["ve13_sequencial"]) || $this->ve13_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3845,21365,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve13_sequencial'))."','$this->ve13_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ve13_instituicao"]) || $this->ve13_instituicao != "")
             $resac = db_query("insert into db_acount values($acount,3845,21366,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve13_instituicao'))."','$this->ve13_instituicao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ve13_veiculo"]) || $this->ve13_veiculo != "")
             $resac = db_query("insert into db_acount values($acount,3845,21367,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve13_veiculo'))."','$this->ve13_veiculo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ve13_motorista"]) || $this->ve13_motorista != "")
             $resac = db_query("insert into db_acount values($acount,3845,21368,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve13_motorista'))."','$this->ve13_motorista',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ve13_datainicial"]) || $this->ve13_datainicial != "")
             $resac = db_query("insert into db_acount values($acount,3845,21369,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve13_datainicial'))."','$this->ve13_datainicial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ve13_datafinal"]) || $this->ve13_datafinal != "")
             $resac = db_query("insert into db_acount values($acount,3845,21370,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve13_datafinal'))."','$this->ve13_datafinal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ve13_dataemissao"]) || $this->ve13_dataemissao != "")
             $resac = db_query("insert into db_acount values($acount,3845,21371,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve13_dataemissao'))."','$this->ve13_dataemissao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ve13_observacao"]) || $this->ve13_observacao !== null)
             $resac = db_query("insert into db_acount values($acount,3845,21372,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve13_observacao'))."','$this->ve13_observacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ve13_departamento"]) || $this->ve13_departamento != "")
             $resac = db_query("insert into db_acount values($acount,3845,21377,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve13_departamento'))."','$this->ve13_departamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3845,21365,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve13_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3845,21366,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve13_instituicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3845,21367,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve13_veiculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3845,21368,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve13_motorista'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3845,21369,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve13_datainicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3845,21370,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve13_datafinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3845,21371,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve13_dataemissao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3845,21372,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve13_observacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3845,21377,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve13_departamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
