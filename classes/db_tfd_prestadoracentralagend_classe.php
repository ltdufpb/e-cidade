...
class cl_tfd_prestadoracentralagend { 
   ...
   public $tf10_i_codigo = 0; 
   public $tf10_i_prestadora = 0; 
   public $tf10_i_centralagend = 0; 
   public $tf10_d_validadeini_dia = null; 
   public $tf10_d_validadeini_mes = null; 
   public $tf10_d_validadeini_ano = null; 
   public $tf10_d_validadeini = null; 
   public $tf10_d_validadefim_dia = null; 
   public $tf10_d_validadefim_mes = null; 
   public $tf10_d_validadefim_ano = null; 
   public $tf10_d_validadefim = null; 
   ...
   function incluir ($tf10_i_codigo){ 
     ...
     if($tf10_i_codigo == "" || $tf10_i_codigo == null ){
       ...
       $this->tf10_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tfd_prestadoracentralagend_tf10_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $tf10_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2866,16366,'','".AddSlashes(pg_fetch_result($resaco,0,'tf10_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2866,16367,'','".AddSlashes(pg_fetch_result($resaco,0,'tf10_i_prestadora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2866,16368,'','".AddSlashes(pg_fetch_result($resaco,0,'tf10_i_centralagend'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2866,16369,'','".AddSlashes(pg_fetch_result($resaco,0,'tf10_d_validadeini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2866,16370,'','".AddSlashes(pg_fetch_result($resaco,0,'tf10_d_validadefim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($tf10_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->tf10_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf10_i_codigo"])){ 
       $sql  .= $virgula." tf10_i_codigo = $this->tf10_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->tf10_i_codigo) == null ){ 
     ...
     if(trim((string) $this->tf10_i_prestadora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf10_i_prestadora"])){ 
       $sql  .= $virgula." tf10_i_prestadora = $this->tf10_i_prestadora ";
       $virgula = ",";
       if(trim((string) $this->tf10_i_prestadora) == null ){ 
         $this->erro_sql = " Campo Prestadora nao Informado.";
         $this->erro_campo = "tf10_i_prestadora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tf10_i_centralagend)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf10_i_centralagend"])){ 
       $sql  .= $virgula." tf10_i_centralagend = $this->tf10_i_centralagend ";
       $virgula = ",";
       if(trim((string) $this->tf10_i_centralagend) == null ){ 
         $this->erro_sql = " Campo Central de Agendamento nao Informado.";
         $this->erro_campo = "tf10_i_centralagend";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tf10_d_validadeini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf10_d_validadeini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["tf10_d_validadeini_dia"] !="") ){ 
       $sql  .= $virgula." tf10_d_validadeini = '$this->tf10_d_validadeini' ";
       $virgula = ",";
       if(trim((string) $this->tf10_d_validadeini) == null ){ 
         $this->erro_sql = " Campo Início nao Informado.";
         $this->erro_campo = "tf10_d_validadeini_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tf10_d_validadefim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf10_d_validadefim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["tf10_d_validadefim_dia"] !="") ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf10_i_codigo"]) || $this->tf10_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2866,16366,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf10_i_codigo'))."','$this->tf10_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf10_i_prestadora"]) || $this->tf10_i_prestadora != "")
           $resac = db_query("insert into db_acount values($acount,2866,16367,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf10_i_prestadora'))."','$this->tf10_i_prestadora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf10_i_centralagend"]) || $this->tf10_i_centralagend != "")
           $resac = db_query("insert into db_acount values($acount,2866,16368,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf10_i_centralagend'))."','$this->tf10_i_centralagend',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf10_d_validadeini"]) || $this->tf10_d_validadeini != "")
           $resac = db_query("insert into db_acount values($acount,2866,16369,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf10_d_validadeini'))."','$this->tf10_d_validadeini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf10_d_validadefim"]) || $this->tf10_d_validadefim != "")
           $resac = db_query("insert into db_acount values($acount,2866,16370,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf10_d_validadefim'))."','$this->tf10_d_validadefim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($tf10_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2866,16366,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf10_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2866,16367,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf10_i_prestadora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2866,16368,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf10_i_centralagend'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2866,16369,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf10_d_validadeini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2866,16370,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf10_d_validadefim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
