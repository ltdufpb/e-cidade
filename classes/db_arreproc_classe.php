...
class cl_arreproc { 
   ...
   function incluir ($k80_numpre,$k80_codproc){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,991,6146,'','".AddSlashes(pg_fetch_result($resaco,0,'k80_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,991,6144,'','".AddSlashes(pg_fetch_result($resaco,0,'k80_codproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k80_numpre=null,$k80_codproc=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k80_numpre)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k80_numpre"])){ 
       $sql  .= $virgula." k80_numpre = $this->k80_numpre ";
       $virgula = ",";
       if(trim((string) $this->k80_numpre) == null ){ 
     ...
     if(trim((string) $this->k80_codproc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k80_codproc"])){ 
       $sql  .= $virgula." k80_codproc = $this->k80_codproc ";
       $virgula = ",";
       if(trim((string) $this->k80_codproc) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k80_numpre"]))
           $resac = db_query("insert into db_acount values($acount,991,6146,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k80_numpre'))."','$this->k80_numpre',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k80_codproc"]))
           $resac = db_query("insert into db_acount values($acount,991,6144,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k80_codproc'))."','$this->k80_codproc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k80_numpre=null,$k80_codproc=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,991,6146,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k80_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,991,6144,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k80_codproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
