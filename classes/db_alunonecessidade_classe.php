...
class cl_alunonecessidade {
   ...
   function incluir ($ed214_i_codigo){
     ...
     if($ed214_i_codigo == "" || $ed214_i_codigo == null ){
       ...
       $this->ed214_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from alunonecessidade_ed214_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed214_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1907,11072,'','".AddSlashes(pg_fetch_result($resaco,0,'ed214_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1907,11073,'','".AddSlashes(pg_fetch_result($resaco,0,'ed214_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1907,11074,'','".AddSlashes(pg_fetch_result($resaco,0,'ed214_i_necessidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1907,11075,'','".AddSlashes(pg_fetch_result($resaco,0,'ed214_c_principal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1907,11299,'','".AddSlashes(pg_fetch_result($resaco,0,'ed214_i_apoio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1907,11300,'','".AddSlashes(pg_fetch_result($resaco,0,'ed214_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1907,11301,'','".AddSlashes(pg_fetch_result($resaco,0,'ed214_i_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1907,11302,'','".AddSlashes(pg_fetch_result($resaco,0,'ed214_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($ed214_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->ed214_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed214_i_codigo"])){
       $sql  .= $virgula." ed214_i_codigo = $this->ed214_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed214_i_codigo) == null ){
     ...
     if(trim((string) $this->ed214_i_aluno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed214_i_aluno"])){
       $sql  .= $virgula." ed214_i_aluno = $this->ed214_i_aluno ";
       $virgula = ",";
       if(trim((string) $this->ed214_i_aluno) == null ){
         $this->erro_sql = " Campo Aluno nao Informado.";
         $this->erro_campo = "ed214_i_aluno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed214_i_necessidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed214_i_necessidade"])){
       $sql  .= $virgula." ed214_i_necessidade = $this->ed214_i_necessidade ";
       $virgula = ",";
       if(trim((string) $this->ed214_i_necessidade) == null ){
         $this->erro_sql = " Campo Necessidade nao Informado.";
         $this->erro_campo = "ed214_i_necessidade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed214_c_principal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed214_c_principal"])){
       $sql  .= $virgula." ed214_c_principal = '$this->ed214_c_principal' ";
       $virgula = ",";
       if(trim((string) $this->ed214_c_principal) == null ){
         $this->erro_sql = " Campo Necessidade Maior nao Informado.";
         $this->erro_campo = "ed214_c_principal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed214_i_apoio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed214_i_apoio"])){
       $sql  .= $virgula." ed214_i_apoio = $this->ed214_i_apoio ";
       $virgula = ",";
       if(trim((string) $this->ed214_i_apoio) == null ){
         $this->erro_sql = " Campo Apoio Pedagógico nao Informado.";
         $this->erro_campo = "ed214_i_apoio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed214_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed214_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed214_d_data_dia"] !="") ){
       $sql  .= $virgula." ed214_d_data = '$this->ed214_d_data' ";
       $virgula = ",";
       if(trim((string) $this->ed214_d_data) == null ){
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "ed214_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed214_i_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed214_i_tipo"])){
       $sql  .= $virgula." ed214_i_tipo = $this->ed214_i_tipo ";
       $virgula = ",";
       if(trim((string) $this->ed214_i_tipo) == null ){
         $this->erro_sql = " Campo Tipo de Diagnóstico nao Informado.";
         $this->erro_campo = "ed214_i_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed214_i_escola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed214_i_escola"])){
        if(trim((string) $this->ed214_i_escola)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed214_i_escola"])){
           $this->ed214_i_escola = "null" ;
        }
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed214_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1907,11072,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed214_i_codigo'))."','$this->ed214_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed214_i_aluno"]))
           $resac = db_query("insert into db_acount values($acount,1907,11073,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed214_i_aluno'))."','$this->ed214_i_aluno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed214_i_necessidade"]))
           $resac = db_query("insert into db_acount values($acount,1907,11074,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed214_i_necessidade'))."','$this->ed214_i_necessidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed214_c_principal"]))
           $resac = db_query("insert into db_acount values($acount,1907,11075,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed214_c_principal'))."','$this->ed214_c_principal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed214_i_apoio"]))
           $resac = db_query("insert into db_acount values($acount,1907,11299,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed214_i_apoio'))."','$this->ed214_i_apoio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed214_d_data"]))
           $resac = db_query("insert into db_acount values($acount,1907,11300,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed214_d_data'))."','$this->ed214_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed214_i_tipo"]))
           $resac = db_query("insert into db_acount values($acount,1907,11301,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed214_i_tipo'))."','$this->ed214_i_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed214_i_escola"]))
           $resac = db_query("insert into db_acount values($acount,1907,11302,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed214_i_escola'))."','$this->ed214_i_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($ed214_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1907,11072,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed214_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1907,11073,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed214_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1907,11074,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed214_i_necessidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1907,11075,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed214_c_principal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1907,11299,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed214_i_apoio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1907,11300,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed214_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1907,11301,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed214_i_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1907,11302,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed214_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
