...
class cl_far_listamodelo { 
   ...
   public $fa17_i_codigo = 0; 
   public $fa17_i_modelolivro = 0; 
   public $fa17_i_listacontrolado = 0; 
   ...
   function incluir ($fa17_i_codigo){ 
     ...
     if($fa17_i_codigo == "" || $fa17_i_codigo == null ){
       ...
       $this->fa17_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_listamodelo_fa17_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa17_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2465,14025,'','".AddSlashes(pg_fetch_result($resaco,0,'fa17_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2465,14026,'','".AddSlashes(pg_fetch_result($resaco,0,'fa17_i_modelolivro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2465,14027,'','".AddSlashes(pg_fetch_result($resaco,0,'fa17_i_listacontrolado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa17_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa17_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa17_i_codigo"])){ 
       $sql  .= $virgula." fa17_i_codigo = $this->fa17_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa17_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa17_i_modelolivro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa17_i_modelolivro"])){ 
       $sql  .= $virgula." fa17_i_modelolivro = $this->fa17_i_modelolivro ";
       $virgula = ",";
       if(trim((string) $this->fa17_i_modelolivro) == null ){ 
         $this->erro_sql = " Campo Modelo Livro nao Informado.";
         $this->erro_campo = "fa17_i_modelolivro";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa17_i_listacontrolado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa17_i_listacontrolado"])){ 
       $sql  .= $virgula." fa17_i_listacontrolado = $this->fa17_i_listacontrolado ";
       $virgula = ",";
       if(trim((string) $this->fa17_i_listacontrolado) == null ){ 
         $this->erro_sql = " Campo Medicamento Controlado nao Informado.";
         $this->erro_campo = "fa17_i_listacontrolado";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa17_i_codigo"]) || $this->fa17_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2465,14025,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa17_i_codigo'))."','$this->fa17_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa17_i_modelolivro"]) || $this->fa17_i_modelolivro != "")
           $resac = db_query("insert into db_acount values($acount,2465,14026,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa17_i_modelolivro'))."','$this->fa17_i_modelolivro',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa17_i_listacontrolado"]) || $this->fa17_i_listacontrolado != "")
           $resac = db_query("insert into db_acount values($acount,2465,14027,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa17_i_listacontrolado'))."','$this->fa17_i_listacontrolado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa17_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2465,14025,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa17_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2465,14026,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa17_i_modelolivro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2465,14027,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa17_i_listacontrolado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
