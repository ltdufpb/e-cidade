...
class cl_ppaestimativa { 
   ...
   public $o05_sequencial = 0; 
   public $o05_ppaversao = 0; 
   public $o05_anoreferencia = 0; 
   public $o05_base = 'f'; 
   public $o05_valor = 0; 
   ...
   function incluir ($o05_sequencial){ 
     ...
     if($o05_sequencial == "" || $o05_sequencial == null ){
       ...
       $this->o05_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from ppaestimativa_o05_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $o05_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2382,13597,'','".AddSlashes(pg_fetch_result($resaco,0,'o05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2382,13598,'','".AddSlashes(pg_fetch_result($resaco,0,'o05_ppaversao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2382,13609,'','".AddSlashes(pg_fetch_result($resaco,0,'o05_anoreferencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2382,13610,'','".AddSlashes(pg_fetch_result($resaco,0,'o05_base'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2382,13611,'','".AddSlashes(pg_fetch_result($resaco,0,'o05_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o05_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o05_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o05_sequencial"])){ 
       $sql  .= $virgula." o05_sequencial = $this->o05_sequencial ";
       $virgula = ",";
       if(trim((string) $this->o05_sequencial) == null ){ 
     ...
     if(trim((string) $this->o05_ppaversao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o05_ppaversao"])){ 
       $sql  .= $virgula." o05_ppaversao = $this->o05_ppaversao ";
       $virgula = ",";
       if(trim((string) $this->o05_ppaversao) == null ){ 
         $this->erro_sql = " Campo Versão do PPA nao Informado.";
         $this->erro_campo = "o05_ppaversao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o05_anoreferencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o05_anoreferencia"])){ 
       $sql  .= $virgula." o05_anoreferencia = $this->o05_anoreferencia ";
       $virgula = ",";
       if(trim((string) $this->o05_anoreferencia) == null ){ 
         $this->erro_sql = " Campo Ano de Referência nao Informado.";
         $this->erro_campo = "o05_anoreferencia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o05_base)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o05_base"])){ 
       $sql  .= $virgula." o05_base = '$this->o05_base' ";
       $virgula = ",";
       if(trim((string) $this->o05_base) == null ){ 
         $this->erro_sql = " Campo Base para  Cálculo nao Informado.";
         $this->erro_campo = "o05_base";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o05_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o05_valor"])){ 
       $sql  .= $virgula." o05_valor = $this->o05_valor ";
       $virgula = ",";
       if(trim((string) $this->o05_valor) == null ){ 
         $this->erro_sql = " Campo Valor Estimado nao Informado.";
         $this->erro_campo = "o05_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o05_sequencial"]) || $this->o05_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2382,13597,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o05_sequencial'))."','$this->o05_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o05_ppaversao"]) || $this->o05_ppaversao != "")
           $resac = db_query("insert into db_acount values($acount,2382,13598,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o05_ppaversao'))."','$this->o05_ppaversao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o05_anoreferencia"]) || $this->o05_anoreferencia != "")
           $resac = db_query("insert into db_acount values($acount,2382,13609,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o05_anoreferencia'))."','$this->o05_anoreferencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o05_base"]) || $this->o05_base != "")
           $resac = db_query("insert into db_acount values($acount,2382,13610,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o05_base'))."','$this->o05_base',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o05_valor"]) || $this->o05_valor != "")
           $resac = db_query("insert into db_acount values($acount,2382,13611,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o05_valor'))."','$this->o05_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o05_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2382,13597,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2382,13598,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o05_ppaversao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2382,13609,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o05_anoreferencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2382,13610,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o05_base'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2382,13611,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o05_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
