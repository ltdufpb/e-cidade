...
class cl_alunomatcenso { 
   ...
   public $ed280_i_codigo = 0; 
   public $ed280_i_aluno = 0; 
   public $ed280_i_turmacenso = 0; 
   public $ed280_i_ano = 0; 
   public $ed280_i_matcenso = 0; 
   ...
   function incluir ($ed280_i_codigo){ 
     ...
     if($ed280_i_codigo == "" || $ed280_i_codigo == null ){
       ...
       $this->ed280_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from alunomatcenso_ed280_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed280_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2731,15571,'','".AddSlashes(pg_fetch_result($resaco,0,'ed280_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2731,15572,'','".AddSlashes(pg_fetch_result($resaco,0,'ed280_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2731,15573,'','".AddSlashes(pg_fetch_result($resaco,0,'ed280_i_turmacenso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2731,15574,'','".AddSlashes(pg_fetch_result($resaco,0,'ed280_i_ano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2731,15575,'','".AddSlashes(pg_fetch_result($resaco,0,'ed280_i_matcenso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed280_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed280_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed280_i_codigo"])){ 
       $sql  .= $virgula." ed280_i_codigo = $this->ed280_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed280_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed280_i_aluno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed280_i_aluno"])){ 
       $sql  .= $virgula." ed280_i_aluno = $this->ed280_i_aluno ";
       $virgula = ",";
       if(trim((string) $this->ed280_i_aluno) == null ){ 
         $this->erro_sql = " Campo Aluno nao Informado.";
         $this->erro_campo = "ed280_i_aluno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed280_i_turmacenso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed280_i_turmacenso"])){ 
        if(trim((string) $this->ed280_i_turmacenso)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed280_i_turmacenso"])){ 
           $this->ed280_i_turmacenso = "0" ; 
        } 
     ...
     if(trim((string) $this->ed280_i_ano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed280_i_ano"])){ 
        if(trim((string) $this->ed280_i_ano)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed280_i_ano"])){ 
           $this->ed280_i_ano = "0" ; 
        } 
     ...
     if(trim((string) $this->ed280_i_matcenso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed280_i_matcenso"])){ 
        if(trim((string) $this->ed280_i_matcenso)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed280_i_matcenso"])){ 
           $this->ed280_i_matcenso = "0" ; 
        } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed280_i_codigo"]) || $this->ed280_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2731,15571,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed280_i_codigo'))."','$this->ed280_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed280_i_aluno"]) || $this->ed280_i_aluno != "")
           $resac = db_query("insert into db_acount values($acount,2731,15572,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed280_i_aluno'))."','$this->ed280_i_aluno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed280_i_turmacenso"]) || $this->ed280_i_turmacenso != "")
           $resac = db_query("insert into db_acount values($acount,2731,15573,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed280_i_turmacenso'))."','$this->ed280_i_turmacenso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed280_i_ano"]) || $this->ed280_i_ano != "")
           $resac = db_query("insert into db_acount values($acount,2731,15574,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed280_i_ano'))."','$this->ed280_i_ano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed280_i_matcenso"]) || $this->ed280_i_matcenso != "")
           $resac = db_query("insert into db_acount values($acount,2731,15575,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed280_i_matcenso'))."','$this->ed280_i_matcenso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed280_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2731,15571,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed280_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2731,15572,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed280_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2731,15573,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed280_i_turmacenso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2731,15574,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed280_i_ano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2731,15575,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed280_i_matcenso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
