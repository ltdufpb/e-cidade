...
class cl_arresusp { 
   ...
   function incluir ($k00_sequencial){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2220,11816,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,12707,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_suspensao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,361,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,362,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_numpar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,372,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,373,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_dtoper'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,374,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_receit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,375,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_hist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,376,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,377,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_dtvenc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,378,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_numtot'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,379,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_numdig'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,380,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,381,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_tipojm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,10020,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_vlrcor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,10021,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_vlrjur'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,10022,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_vlrmul'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2220,10025,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_vlrdes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k00_sequencial=null) { 
     ...
     if(trim((string) $this->k00_suspensao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k00_suspensao"])){ 
       $sql  .= $virgula." k00_suspensao = $this->k00_suspensao ";
       $virgula = ",";
       if(trim((string) $this->k00_suspensao) == null ){ 
         $this->erro_sql = " Campo Suspensão nao Informado.";
         $this->erro_campo = "k00_suspensao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k00_tipojm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k00_tipojm"])){ 
       $sql  .= $virgula." k00_tipojm = $this->k00_tipojm ";
       $virgula = ",";
       if(trim((string) $this->k00_tipojm) == null ){ 
         $this->erro_sql = " Campo tipo de juro e multa nao Informado.";
         $this->erro_campo = "k00_tipojm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k00_vlrcor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k00_vlrcor"])){ 
       $sql  .= $virgula." k00_vlrcor = $this->k00_vlrcor ";
       $virgula = ",";
       if(trim((string) $this->k00_vlrcor) == null ){ 
         $this->erro_sql = " Campo Valor Corrigido nao Informado.";
         $this->erro_campo = "k00_vlrcor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k00_vlrjur)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k00_vlrjur"])){ 
       $sql  .= $virgula." k00_vlrjur = $this->k00_vlrjur ";
       $virgula = ",";
       if(trim((string) $this->k00_vlrjur) == null ){ 
         $this->erro_sql = " Campo Valor Juros nao Informado.";
         $this->erro_campo = "k00_vlrjur";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k00_vlrmul)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k00_vlrmul"])){ 
       $sql  .= $virgula." k00_vlrmul = $this->k00_vlrmul ";
       $virgula = ",";
       if(trim((string) $this->k00_vlrmul) == null ){ 
         $this->erro_sql = " Campo Valor Multa nao Informado.";
         $this->erro_campo = "k00_vlrmul";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k00_vlrdes)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k00_vlrdes"])){ 
       $sql  .= $virgula." k00_vlrdes = $this->k00_vlrdes ";
       $virgula = ",";
       if(trim((string) $this->k00_vlrdes) == null ){ 
         $this->erro_sql = " Campo Valor do desconto nao Informado.";
         $this->erro_campo = "k00_vlrdes";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2220,11816,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_sequencial'))."','$this->k00_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_suspensao"]))
           $resac = db_query("insert into db_acount values($acount,2220,12707,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_suspensao'))."','$this->k00_suspensao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_numpre"]))
           $resac = db_query("insert into db_acount values($acount,2220,361,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_numpre'))."','$this->k00_numpre',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_numpar"]))
           $resac = db_query("insert into db_acount values($acount,2220,362,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_numpar'))."','$this->k00_numpar',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,2220,372,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_numcgm'))."','$this->k00_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_dtoper"]))
           $resac = db_query("insert into db_acount values($acount,2220,373,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_dtoper'))."','$this->k00_dtoper',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_receit"]))
           $resac = db_query("insert into db_acount values($acount,2220,374,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_receit'))."','$this->k00_receit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_hist"]))
           $resac = db_query("insert into db_acount values($acount,2220,375,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_hist'))."','$this->k00_hist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_valor"]))
           $resac = db_query("insert into db_acount values($acount,2220,376,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_valor'))."','$this->k00_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_dtvenc"]))
           $resac = db_query("insert into db_acount values($acount,2220,377,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_dtvenc'))."','$this->k00_dtvenc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_numtot"]))
           $resac = db_query("insert into db_acount values($acount,2220,378,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_numtot'))."','$this->k00_numtot',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_numdig"]))
           $resac = db_query("insert into db_acount values($acount,2220,379,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_numdig'))."','$this->k00_numdig',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_tipo"]))
           $resac = db_query("insert into db_acount values($acount,2220,380,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_tipo'))."','$this->k00_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_tipojm"]))
           $resac = db_query("insert into db_acount values($acount,2220,381,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_tipojm'))."','$this->k00_tipojm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_vlrcor"]))
           $resac = db_query("insert into db_acount values($acount,2220,10020,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_vlrcor'))."','$this->k00_vlrcor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_vlrjur"]))
           $resac = db_query("insert into db_acount values($acount,2220,10021,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_vlrjur'))."','$this->k00_vlrjur',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_vlrmul"]))
           $resac = db_query("insert into db_acount values($acount,2220,10022,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_vlrmul'))."','$this->k00_vlrmul',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_vlrdes"]))
           $resac = db_query("insert into db_acount values($acount,2220,10025,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_vlrdes'))."','$this->k00_vlrdes',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k00_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2220,11816,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,12707,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_suspensao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,361,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,362,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_numpar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,372,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,373,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_dtoper'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,374,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_receit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,375,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_hist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,376,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,377,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_dtvenc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,378,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_numtot'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,379,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_numdig'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,380,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,381,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_tipojm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,10020,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_vlrcor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,10021,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_vlrjur'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,10022,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_vlrmul'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2220,10025,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_vlrdes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
