...
class cl_pcmaterele {
   ...
   public $pc07_codmater = 0;
   public $pc07_codele = 0;
   ...
   function incluir ($pc07_codmater,$pc07_codele){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,993,6162,'','".AddSlashes(pg_fetch_result($resaco,0,'pc07_codmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,993,6163,'','".AddSlashes(pg_fetch_result($resaco,0,'pc07_codele'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($pc07_codmater=null,$pc07_codele=null) {
     ...
     $virgula = "";
     if(trim((string) $this->pc07_codmater)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc07_codmater"])){
       $sql  .= $virgula." pc07_codmater = $this->pc07_codmater ";
       $virgula = ",";
       if(trim((string) $this->pc07_codmater) == null ){
     ...
     if(trim((string) $this->pc07_codele)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc07_codele"])){
       $sql  .= $virgula." pc07_codele = $this->pc07_codele ";
       $virgula = ",";
       if(trim((string) $this->pc07_codele) == null ){
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc07_codmater"]))
           $resac = db_query("insert into db_acount values($acount,993,6162,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc07_codmater'))."','$this->pc07_codmater',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc07_codele"]))
           $resac = db_query("insert into db_acount values($acount,993,6163,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc07_codele'))."','$this->pc07_codele',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($pc07_codmater=null,$pc07_codele=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,993,6162,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc07_codmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,993,6163,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc07_codele'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
...
//die($sql);
   ...
   function sql_query_funcauteledescr ( $pc07_codmater=null,$pc07_codele=null,$campos="*",$ordem=null,$dbwhere="", $sWhereElemento = null){
     ...
     $where_sql = preg_split("#\\##m",(string) $dbwhere);
     $where1 = $where_sql[0];
     $where2 = $where_sql[1];
