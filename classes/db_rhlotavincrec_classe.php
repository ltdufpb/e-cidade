...
class cl_rhlotavincrec { 
   ...
   public $rh43_codlotavinc = 0; 
   public $rh43_codelenov = 0; 
   public $rh43_recurso = 0; 
   ...
   function incluir ($rh43_codlotavinc,$rh43_codelenov){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1229,7366,'','".AddSlashes(pg_fetch_result($resaco,0,'rh43_codlotavinc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1229,7367,'','".AddSlashes(pg_fetch_result($resaco,0,'rh43_codelenov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1229,7368,'','".AddSlashes(pg_fetch_result($resaco,0,'rh43_recurso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh43_codlotavinc=null,$rh43_codelenov=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh43_codlotavinc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh43_codlotavinc"])){ 
       $sql  .= $virgula." rh43_codlotavinc = $this->rh43_codlotavinc ";
       $virgula = ",";
       if(trim((string) $this->rh43_codlotavinc) == null ){ 
     ...
     if(trim((string) $this->rh43_codelenov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh43_codelenov"])){ 
       $sql  .= $virgula." rh43_codelenov = $this->rh43_codelenov ";
       $virgula = ",";
       if(trim((string) $this->rh43_codelenov) == null ){ 
     ...
     if(trim((string) $this->rh43_recurso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh43_recurso"])){ 
       $sql  .= $virgula." rh43_recurso = $this->rh43_recurso ";
       $virgula = ",";
       if(trim((string) $this->rh43_recurso) == null ){ 
         $this->erro_sql = " Campo Recurso nao Informado.";
         $this->erro_campo = "rh43_recurso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh43_codlotavinc"]))
           $resac = db_query("insert into db_acount values($acount,1229,7366,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh43_codlotavinc'))."','$this->rh43_codlotavinc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh43_codelenov"]))
           $resac = db_query("insert into db_acount values($acount,1229,7367,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh43_codelenov'))."','$this->rh43_codelenov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh43_recurso"]))
           $resac = db_query("insert into db_acount values($acount,1229,7368,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh43_recurso'))."','$this->rh43_recurso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh43_codlotavinc=null,$rh43_codelenov=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1229,7366,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh43_codlotavinc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1229,7367,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh43_codelenov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1229,7368,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh43_recurso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
