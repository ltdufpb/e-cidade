...
class cl_abatimentotransferencia { 
   ...
   public $k158_sequencial = 0; 
   public $k158_abatimentoutilizacao = 0; 
   public $k158_abatimentoorigem = 0; 
   public $k158_abatimentodestino = 0; 
   ...
   function incluir ($k158_sequencial){ 
     ...
     if($k158_sequencial == "" || $k158_sequencial == null ){
       ...
       $this->k158_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from abatimentotransferencia_k158_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k158_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3485,19617,'','".AddSlashes(pg_fetch_result($resaco,0,'k158_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3485,19612,'','".AddSlashes(pg_fetch_result($resaco,0,'k158_abatimentoutilizacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3485,19613,'','".AddSlashes(pg_fetch_result($resaco,0,'k158_abatimentoorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3485,19614,'','".AddSlashes(pg_fetch_result($resaco,0,'k158_abatimentodestino'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k158_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k158_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k158_sequencial"])){ 
       $sql  .= $virgula." k158_sequencial = $this->k158_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k158_sequencial) == null ){ 
     ...
     if(trim((string) $this->k158_abatimentoutilizacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k158_abatimentoutilizacao"])){ 
       $sql  .= $virgula." k158_abatimentoutilizacao = $this->k158_abatimentoutilizacao ";
       $virgula = ",";
       if(trim((string) $this->k158_abatimentoutilizacao) == null ){ 
         $this->erro_sql = " Campo Código abatimento utilização nao Informado.";
         $this->erro_campo = "k158_abatimentoutilizacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k158_abatimentoorigem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k158_abatimentoorigem"])){ 
       $sql  .= $virgula." k158_abatimentoorigem = $this->k158_abatimentoorigem ";
       $virgula = ",";
       if(trim((string) $this->k158_abatimentoorigem) == null ){ 
         $this->erro_sql = " Campo Sequencial da tabela abatimento nao Informado.";
         $this->erro_campo = "k158_abatimentoorigem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k158_abatimentodestino)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k158_abatimentodestino"])){ 
       $sql  .= $virgula." k158_abatimentodestino = $this->k158_abatimentodestino ";
       $virgula = ",";
       if(trim((string) $this->k158_abatimentodestino) == null ){ 
         $this->erro_sql = " Campo Sequencial da tabela abatimento nao Informado.";
         $this->erro_campo = "k158_abatimentodestino";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k158_sequencial"]) || $this->k158_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3485,19617,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k158_sequencial'))."','$this->k158_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k158_abatimentoutilizacao"]) || $this->k158_abatimentoutilizacao != "")
           $resac = db_query("insert into db_acount values($acount,3485,19612,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k158_abatimentoutilizacao'))."','$this->k158_abatimentoutilizacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k158_abatimentoorigem"]) || $this->k158_abatimentoorigem != "")
           $resac = db_query("insert into db_acount values($acount,3485,19613,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k158_abatimentoorigem'))."','$this->k158_abatimentoorigem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k158_abatimentodestino"]) || $this->k158_abatimentodestino != "")
           $resac = db_query("insert into db_acount values($acount,3485,19614,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k158_abatimentodestino'))."','$this->k158_abatimentodestino',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k158_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3485,19617,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k158_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3485,19612,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k158_abatimentoutilizacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3485,19613,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k158_abatimentoorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3485,19614,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k158_abatimentodestino'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
