...
class cl_liclicitaata { 
   ...
   public $l39_sequencial = 0; 
   public $l39_arquivo = 0; 
   public $l39_arqnome = null; 
   public $l39_liclicita = 0; 
   public $l39_posicaoinicial = 'f'; 
   ...
   function incluir ($l39_sequencial){ 
     ...
     if($l39_sequencial == "" || $l39_sequencial == null ){
       ...
       $this->l39_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from liclicitaata_l39_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $l39_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2742,15634,'','".AddSlashes(pg_fetch_result($resaco,0,'l39_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2742,15635,'','".AddSlashes(pg_fetch_result($resaco,0,'l39_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2742,15636,'','".AddSlashes(pg_fetch_result($resaco,0,'l39_arqnome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2742,15637,'','".AddSlashes(pg_fetch_result($resaco,0,'l39_liclicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2742,17713,'','".AddSlashes(pg_fetch_result($resaco,0,'l39_posicaoinicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($l39_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->l39_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l39_sequencial"])){ 
       $sql  .= $virgula." l39_sequencial = $this->l39_sequencial ";
       $virgula = ",";
       if(trim((string) $this->l39_sequencial) == null ){ 
     ...
     if(trim((string) $this->l39_arquivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l39_arquivo"])){ 
       $sql  .= $virgula." l39_arquivo = $this->l39_arquivo ";
       $virgula = ",";
       if(trim((string) $this->l39_arquivo) == null ){ 
         $this->erro_sql = " Campo Arquivo nao Informado.";
         $this->erro_campo = "l39_arquivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l39_arqnome)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l39_arqnome"])){ 
       $sql  .= $virgula." l39_arqnome = '$this->l39_arqnome' ";
       $virgula = ",";
       if(trim((string) $this->l39_arqnome) == null ){ 
         $this->erro_sql = " Campo Nome Arquivo nao Informado.";
         $this->erro_campo = "l39_arqnome";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l39_liclicita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l39_liclicita"])){ 
       $sql  .= $virgula." l39_liclicita = $this->l39_liclicita ";
       $virgula = ",";
       if(trim((string) $this->l39_liclicita) == null ){ 
         $this->erro_sql = " Campo Licitação nao Informado.";
         $this->erro_campo = "l39_liclicita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l39_posicaoinicial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l39_posicaoinicial"])){ 
       $sql  .= $virgula." l39_posicaoinicial = '$this->l39_posicaoinicial' ";
       $virgula = ",";
       if(trim((string) $this->l39_posicaoinicial) == null ){ 
         $this->erro_sql = " Campo Posição Inicial do Registro nao Informado.";
         $this->erro_campo = "l39_posicaoinicial";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["l39_sequencial"]) || $this->l39_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2742,15634,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l39_sequencial'))."','$this->l39_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l39_arquivo"]) || $this->l39_arquivo != "")
           $resac = db_query("insert into db_acount values($acount,2742,15635,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l39_arquivo'))."','$this->l39_arquivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l39_arqnome"]) || $this->l39_arqnome != "")
           $resac = db_query("insert into db_acount values($acount,2742,15636,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l39_arqnome'))."','$this->l39_arqnome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l39_liclicita"]) || $this->l39_liclicita != "")
           $resac = db_query("insert into db_acount values($acount,2742,15637,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l39_liclicita'))."','$this->l39_liclicita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l39_posicaoinicial"]) || $this->l39_posicaoinicial != "")
           $resac = db_query("insert into db_acount values($acount,2742,17713,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l39_posicaoinicial'))."','$this->l39_posicaoinicial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($l39_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2742,15634,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l39_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2742,15635,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l39_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2742,15636,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l39_arqnome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2742,15637,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l39_liclicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2742,17713,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l39_posicaoinicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
