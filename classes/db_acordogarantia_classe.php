...
class cl_acordogarantia { 
   ...
   public $ac11_sequencial = 0; 
   public $ac11_descricao = null; 
   public $ac11_obs = null; 
   public $ac11_textopadrao = null; 
   public $ac11_validade_dia = null; 
   public $ac11_validade_mes = null; 
   public $ac11_validade_ano = null; 
   public $ac11_validade = null; 
   ...
   function incluir ($ac11_sequencial){ 
     ...
     if($ac11_sequencial == "" || $ac11_sequencial == null ){
       ...
       $this->ac11_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordogarantia_ac11_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac11_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2829,16131,'','".AddSlashes(pg_fetch_result($resaco,0,'ac11_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2829,16132,'','".AddSlashes(pg_fetch_result($resaco,0,'ac11_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2829,16133,'','".AddSlashes(pg_fetch_result($resaco,0,'ac11_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2829,16134,'','".AddSlashes(pg_fetch_result($resaco,0,'ac11_textopadrao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2829,16135,'','".AddSlashes(pg_fetch_result($resaco,0,'ac11_validade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac11_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac11_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac11_sequencial"])){ 
       $sql  .= $virgula." ac11_sequencial = $this->ac11_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac11_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac11_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac11_descricao"])){ 
       $sql  .= $virgula." ac11_descricao = '$this->ac11_descricao' ";
       $virgula = ",";
       if(trim((string) $this->ac11_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "ac11_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac11_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac11_obs"])){ 
       $sql  .= $virgula." ac11_obs = '$this->ac11_obs' ";
       $virgula = ",";
       if(trim((string) $this->ac11_obs) == null ){ 
         $this->erro_sql = " Campo Observação nao Informado.";
         $this->erro_campo = "ac11_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac11_textopadrao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac11_textopadrao"])){ 
       $sql  .= $virgula." ac11_textopadrao = '$this->ac11_textopadrao' ";
       $virgula = ",";
       if(trim((string) $this->ac11_textopadrao) == null ){ 
         $this->erro_sql = " Campo Texto Padrão nao Informado.";
         $this->erro_campo = "ac11_textopadrao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac11_validade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac11_validade_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ac11_validade_dia"] !="") ){ 
       $sql  .= $virgula." ac11_validade = '$this->ac11_validade' ";
       $virgula = ",";
       if(trim((string) $this->ac11_validade) == null ){ 
         $this->erro_sql = " Campo Data de Validade nao Informado.";
         $this->erro_campo = "ac11_validade_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac11_sequencial"]) || $this->ac11_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2829,16131,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac11_sequencial'))."','$this->ac11_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac11_descricao"]) || $this->ac11_descricao != "")
           $resac = db_query("insert into db_acount values($acount,2829,16132,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac11_descricao'))."','$this->ac11_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac11_obs"]) || $this->ac11_obs != "")
           $resac = db_query("insert into db_acount values($acount,2829,16133,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac11_obs'))."','$this->ac11_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac11_textopadrao"]) || $this->ac11_textopadrao != "")
           $resac = db_query("insert into db_acount values($acount,2829,16134,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac11_textopadrao'))."','$this->ac11_textopadrao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac11_validade"]) || $this->ac11_validade != "")
           $resac = db_query("insert into db_acount values($acount,2829,16135,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac11_validade'))."','$this->ac11_validade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac11_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2829,16131,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac11_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2829,16132,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac11_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2829,16133,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac11_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2829,16134,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac11_textopadrao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2829,16135,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac11_validade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
