...
class cl_atenditemlanc { 
   ...
   public $at07_atenditem = 0; 
   public $at07_usuariolanc = 0; 
   public $at07_datalanc_dia = null; 
   public $at07_datalanc_mes = null; 
   public $at07_datalanc_ano = null; 
   public $at07_datalanc = null; 
   public $at07_horalanc = null; 
   ...
   function incluir ($at07_atenditem){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1403,8308,'','".AddSlashes(pg_fetch_result($resaco,0,'at07_atenditem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1403,8309,'','".AddSlashes(pg_fetch_result($resaco,0,'at07_usuariolanc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1403,8310,'','".AddSlashes(pg_fetch_result($resaco,0,'at07_datalanc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1403,8311,'','".AddSlashes(pg_fetch_result($resaco,0,'at07_horalanc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at07_atenditem=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at07_atenditem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at07_atenditem"])){ 
       $sql  .= $virgula." at07_atenditem = $this->at07_atenditem ";
       $virgula = ",";
       if(trim((string) $this->at07_atenditem) == null ){ 
     ...
     if(trim((string) $this->at07_usuariolanc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at07_usuariolanc"])){ 
       $sql  .= $virgula." at07_usuariolanc = $this->at07_usuariolanc ";
       $virgula = ",";
       if(trim((string) $this->at07_usuariolanc) == null ){ 
         $this->erro_sql = " Campo Cod. Usuário nao Informado.";
         $this->erro_campo = "at07_usuariolanc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at07_datalanc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at07_datalanc_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["at07_datalanc_dia"] !="") ){ 
       $sql  .= $virgula." at07_datalanc = '$this->at07_datalanc' ";
       $virgula = ",";
       if(trim((string) $this->at07_datalanc) == null ){ 
         $this->erro_sql = " Campo Data de lancamento nao Informado.";
         $this->erro_campo = "at07_datalanc_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at07_horalanc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at07_horalanc"])){ 
       $sql  .= $virgula." at07_horalanc = '$this->at07_horalanc' ";
       $virgula = ",";
       if(trim((string) $this->at07_horalanc) == null ){ 
         $this->erro_sql = " Campo Hora do lancamento nao Informado.";
         $this->erro_campo = "at07_horalanc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at07_atenditem"]))
           $resac = db_query("insert into db_acount values($acount,1403,8308,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at07_atenditem'))."','$this->at07_atenditem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at07_usuariolanc"]))
           $resac = db_query("insert into db_acount values($acount,1403,8309,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at07_usuariolanc'))."','$this->at07_usuariolanc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at07_datalanc"]))
           $resac = db_query("insert into db_acount values($acount,1403,8310,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at07_datalanc'))."','$this->at07_datalanc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at07_horalanc"]))
           $resac = db_query("insert into db_acount values($acount,1403,8311,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at07_horalanc'))."','$this->at07_horalanc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at07_atenditem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1403,8308,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at07_atenditem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1403,8309,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at07_usuariolanc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1403,8310,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at07_datalanc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1403,8311,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at07_horalanc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
