...
class cl_autotipo { 
   ...
   function incluir ($y59_codigo){ 
     ...
     if($y59_codigo == "" || $y59_codigo == null ){
       ...
       $this->y59_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from autotipo_y59_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $y59_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,700,6797,'','".AddSlashes(pg_fetch_result($resaco,0,'y59_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,700,4993,'','".AddSlashes(pg_fetch_result($resaco,0,'y59_codauto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,700,4994,'','".AddSlashes(pg_fetch_result($resaco,0,'y59_codtipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,700,6628,'','".AddSlashes(pg_fetch_result($resaco,0,'y59_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,700,6660,'','".AddSlashes(pg_fetch_result($resaco,0,'y59_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,700,6661,'','".AddSlashes(pg_fetch_result($resaco,0,'y59_fator'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y59_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y59_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y59_codigo"])){ 
       $sql  .= $virgula." y59_codigo = $this->y59_codigo ";
       $virgula = ",";
       if(trim((string) $this->y59_codigo) == null ){ 
     ...
     if(trim((string) $this->y59_codauto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y59_codauto"])){ 
       $sql  .= $virgula." y59_codauto = $this->y59_codauto ";
       $virgula = ",";
       if(trim((string) $this->y59_codauto) == null ){ 
         $this->erro_sql = " Campo Código do Auto de Infração nao Informado.";
         $this->erro_campo = "y59_codauto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y59_codtipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y59_codtipo"])){ 
       $sql  .= $virgula." y59_codtipo = $this->y59_codtipo ";
       $virgula = ",";
       if(trim((string) $this->y59_codtipo) == null ){ 
         $this->erro_sql = " Campo Código da Procedência nao Informado.";
         $this->erro_campo = "y59_codtipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y59_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y59_valor"])){ 
       $sql  .= $virgula." y59_valor = $this->y59_valor ";
       $virgula = ",";
       if(trim((string) $this->y59_valor) == null ){ 
         $this->erro_sql = " Campo Valor nao Informado.";
         $this->erro_campo = "y59_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y59_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y59_tipo"])){ 
       $sql  .= $virgula." y59_tipo = $this->y59_tipo ";
       $virgula = ",";
       if(trim((string) $this->y59_tipo) == null ){ 
         $this->erro_sql = " Campo Tipo de Correção nao Informado.";
         $this->erro_campo = "y59_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y59_fator)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y59_fator"])){ 
       $sql  .= $virgula." y59_fator = $this->y59_fator ";
       $virgula = ",";
       if(trim((string) $this->y59_fator) == null ){ 
         $this->erro_sql = " Campo Fator nao Informado.";
         $this->erro_campo = "y59_fator";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y59_codigo"]))
           $resac = db_query("insert into db_acount values($acount,700,6797,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y59_codigo'))."','$this->y59_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y59_codauto"]))
           $resac = db_query("insert into db_acount values($acount,700,4993,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y59_codauto'))."','$this->y59_codauto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y59_codtipo"]))
           $resac = db_query("insert into db_acount values($acount,700,4994,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y59_codtipo'))."','$this->y59_codtipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y59_valor"]))
           $resac = db_query("insert into db_acount values($acount,700,6628,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y59_valor'))."','$this->y59_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y59_tipo"]))
           $resac = db_query("insert into db_acount values($acount,700,6660,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y59_tipo'))."','$this->y59_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y59_fator"]))
           $resac = db_query("insert into db_acount values($acount,700,6661,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y59_fator'))."','$this->y59_fator',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y59_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,700,6797,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y59_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,700,4993,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y59_codauto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,700,4994,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y59_codtipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,700,6628,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y59_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,700,6660,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y59_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,700,6661,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y59_fator'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
