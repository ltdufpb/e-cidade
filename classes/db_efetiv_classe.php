...
class cl_efetiv { 
   ...
   function incluir ($r57_anousu,$r57_mesusu,$r57_codrel,$r57_regist,$r57_instit){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,546,9914,'','".AddSlashes(pg_fetch_result($resaco,0,'r57_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,546,3885,'','".AddSlashes(pg_fetch_result($resaco,0,'r57_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,546,3886,'','".AddSlashes(pg_fetch_result($resaco,0,'r57_mesusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,546,3887,'','".AddSlashes(pg_fetch_result($resaco,0,'r57_codrel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,546,3888,'','".AddSlashes(pg_fetch_result($resaco,0,'r57_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($r57_anousu=null,$r57_mesusu=null,$r57_codrel=null,$r57_regist=null,$r57_instit=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->r57_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r57_instit"])){ 
       $sql  .= $virgula." r57_instit = $this->r57_instit ";
       $virgula = ",";
       if(trim((string) $this->r57_instit) == null ){ 
     ...
     if(trim((string) $this->r57_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r57_anousu"])){ 
       $sql  .= $virgula." r57_anousu = $this->r57_anousu ";
       $virgula = ",";
       if(trim((string) $this->r57_anousu) == null ){ 
     ...
     if(trim((string) $this->r57_mesusu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r57_mesusu"])){ 
       $sql  .= $virgula." r57_mesusu = $this->r57_mesusu ";
       $virgula = ",";
       if(trim((string) $this->r57_mesusu) == null ){ 
     ...
     if(trim((string) $this->r57_codrel)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r57_codrel"])){ 
       $sql  .= $virgula." r57_codrel = '$this->r57_codrel' ";
       $virgula = ",";
       if(trim((string) $this->r57_codrel) == null ){ 
     ...
     if(trim((string) $this->r57_regist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r57_regist"])){ 
       $sql  .= $virgula." r57_regist = $this->r57_regist ";
       $virgula = ",";
       if(trim((string) $this->r57_regist) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["r57_instit"]))
           $resac = db_query("insert into db_acount values($acount,546,9914,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r57_instit'))."','$this->r57_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r57_anousu"]))
           $resac = db_query("insert into db_acount values($acount,546,3885,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r57_anousu'))."','$this->r57_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r57_mesusu"]))
           $resac = db_query("insert into db_acount values($acount,546,3886,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r57_mesusu'))."','$this->r57_mesusu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r57_codrel"]))
           $resac = db_query("insert into db_acount values($acount,546,3887,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r57_codrel'))."','$this->r57_codrel',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r57_regist"]))
           $resac = db_query("insert into db_acount values($acount,546,3888,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r57_regist'))."','$this->r57_regist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($r57_anousu=null,$r57_mesusu=null,$r57_codrel=null,$r57_regist=null,$r57_instit=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       ...
       $resaco = $this->sql_record($this->sql_query_file(null,null,null,null,null,"*",null));
     }
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,546,9914,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r57_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,546,3885,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r57_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,546,3886,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r57_mesusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,546,3887,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r57_codrel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,546,3888,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r57_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
