...
class cl_issnotaavulsatomadorcgm { 
   ...
   public $q61_sequencial = 0; 
   public $q61_issnotaavulsatomador = 0; 
   public $q61_numcgm = 0; 
   ...
   function incluir ($q61_sequencial){ 
     ...
     if($q61_sequencial == "" || $q61_sequencial == null ){
       ...
       $this->q61_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from issnotaavulsatomadorcgm_q61_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q61_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1829,10597,'','".AddSlashes(pg_fetch_result($resaco,0,'q61_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1829,10598,'','".AddSlashes(pg_fetch_result($resaco,0,'q61_issnotaavulsatomador'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1829,10599,'','".AddSlashes(pg_fetch_result($resaco,0,'q61_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q61_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q61_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q61_sequencial"])){ 
       $sql  .= $virgula." q61_sequencial = $this->q61_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q61_sequencial) == null ){ 
     ...
     if(trim((string) $this->q61_issnotaavulsatomador)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q61_issnotaavulsatomador"])){ 
       $sql  .= $virgula." q61_issnotaavulsatomador = $this->q61_issnotaavulsatomador ";
       $virgula = ",";
       if(trim((string) $this->q61_issnotaavulsatomador) == null ){ 
         $this->erro_sql = " Campo Código do Tomador nao Informado.";
         $this->erro_campo = "q61_issnotaavulsatomador";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q61_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q61_numcgm"])){ 
       $sql  .= $virgula." q61_numcgm = $this->q61_numcgm ";
       $virgula = ",";
       if(trim((string) $this->q61_numcgm) == null ){ 
         $this->erro_sql = " Campo Número do CGM nao Informado.";
         $this->erro_campo = "q61_numcgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q61_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1829,10597,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q61_sequencial'))."','$this->q61_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q61_issnotaavulsatomador"]))
           $resac = db_query("insert into db_acount values($acount,1829,10598,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q61_issnotaavulsatomador'))."','$this->q61_issnotaavulsatomador',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q61_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,1829,10599,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q61_numcgm'))."','$this->q61_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q61_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1829,10597,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q61_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1829,10598,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q61_issnotaavulsatomador'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1829,10599,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q61_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
