...
class cl_mer_itemunisaida { 
   ...
   public $me20_i_codigo = 0; 
   public $me20_i_unidade = 0; 
   public $me20_i_item = 0; 
   ...
   function incluir ($me20_i_codigo){ 
     ...
     if($me20_i_codigo == "" || $me20_i_codigo == null ){
       ...
       $this->me20_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mertemunisaida_me20_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $me20_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2242,12798,'','".AddSlashes(pg_fetch_result($resaco,0,'me20_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2242,12799,'','".AddSlashes(pg_fetch_result($resaco,0,'me20_i_unidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2242,12800,'','".AddSlashes(pg_fetch_result($resaco,0,'me20_i_item'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me20_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->me20_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me20_i_codigo"])){ 
       $sql  .= $virgula." me20_i_codigo = $this->me20_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->me20_i_codigo) == null ){ 
     ...
     if(trim((string) $this->me20_i_unidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me20_i_unidade"])){ 
       $sql  .= $virgula." me20_i_unidade = $this->me20_i_unidade ";
       $virgula = ",";
       if(trim((string) $this->me20_i_unidade) == null ){ 
         $this->erro_sql = " Campo Unidade Saída nao Informado.";
         $this->erro_campo = "me20_i_unidade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me20_i_item)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me20_i_item"])){ 
       $sql  .= $virgula." me20_i_item = $this->me20_i_item ";
       $virgula = ",";
       if(trim((string) $this->me20_i_item) == null ){ 
         $this->erro_sql = " Campo Produto nao Informado.";
         $this->erro_campo = "me20_i_item";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me20_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2242,12798,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me20_i_codigo'))."','$this->me20_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me20_i_unidade"]))
           $resac = db_query("insert into db_acount values($acount,2242,12799,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me20_i_unidade'))."','$this->me20_i_unidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me20_i_item"]))
           $resac = db_query("insert into db_acount values($acount,2242,12800,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me20_i_item'))."','$this->me20_i_item',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me20_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2242,12798,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me20_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2242,12799,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me20_i_unidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2242,12800,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me20_i_item'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
