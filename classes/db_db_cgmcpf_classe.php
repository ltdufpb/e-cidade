...
class cl_db_cgmcpf {
   ...
   function incluir ($z01_numcgm){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,136,216,'','".AddSlashes(pg_fetch_result($resaco,0,'z01_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,136,731,'','".AddSlashes(pg_fetch_result($resaco,0,'z01_cpf'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($z01_numcgm=null) {
     ...
     if(trim((string) $this->z01_cpf)!="" || isset($GLOBALS["HTTP_POST_VARS"]["z01_cpf"])){
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["z01_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,136,216,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'z01_numcgm'))."','$this->z01_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["z01_cpf"]))
           $resac = db_query("insert into db_acount values($acount,136,731,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'z01_cpf'))."','$this->z01_cpf',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($z01_numcgm=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,136,216,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'z01_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,136,731,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'z01_cpf'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
