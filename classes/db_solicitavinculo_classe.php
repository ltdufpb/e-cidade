...
class cl_solicitavinculo {
   ...
   public $pc53_sequencial = 0;
   public $pc53_solicitapai = 0;
   public $pc53_solicitafilho = 0;
   ...
   function incluir ($pc53_sequencial){
     ...
     if($pc53_sequencial == "" || $pc53_sequencial == null ){
       ...
       $this->pc53_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from solicitavinculo_pc53_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $pc53_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2677,15199,'','".AddSlashes(pg_fetch_result($resaco,0,'pc53_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2677,15200,'','".AddSlashes(pg_fetch_result($resaco,0,'pc53_solicitapai'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2677,15201,'','".AddSlashes(pg_fetch_result($resaco,0,'pc53_solicitafilho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($pc53_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->pc53_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc53_sequencial"])){
       $sql  .= $virgula." pc53_sequencial = $this->pc53_sequencial ";
       $virgula = ",";
       if(trim((string) $this->pc53_sequencial) == null ){
     ...
     if(trim((string) $this->pc53_solicitapai)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc53_solicitapai"])){
       $sql  .= $virgula." pc53_solicitapai = $this->pc53_solicitapai ";
       $virgula = ",";
       if(trim((string) $this->pc53_solicitapai) == null ){
         $this->erro_sql = " Campo Código da solicitação principal nao Informado.";
         $this->erro_campo = "pc53_solicitapai";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc53_solicitafilho)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc53_solicitafilho"])){
       $sql  .= $virgula." pc53_solicitafilho = $this->pc53_solicitafilho ";
       $virgula = ",";
       if(trim((string) $this->pc53_solicitafilho) == null ){
         $this->erro_sql = " Campo Código da solicitação vinculada nao Informado.";
         $this->erro_campo = "pc53_solicitafilho";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc53_sequencial"]) || $this->pc53_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2677,15199,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc53_sequencial'))."','$this->pc53_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc53_solicitapai"]) || $this->pc53_solicitapai != "")
           $resac = db_query("insert into db_acount values($acount,2677,15200,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc53_solicitapai'))."','$this->pc53_solicitapai',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc53_solicitafilho"]) || $this->pc53_solicitafilho != "")
           $resac = db_query("insert into db_acount values($acount,2677,15201,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc53_solicitafilho'))."','$this->pc53_solicitafilho',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($pc53_sequencial=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2677,15199,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc53_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2677,15200,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc53_solicitapai'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2677,15201,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc53_solicitafilho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
