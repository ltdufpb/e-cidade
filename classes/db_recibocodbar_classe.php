...
class cl_recibocodbar {
   ...
   public $k00_numpre = 0;
   public $k00_codbar = null;
   public $k00_linhadigitavel = null;
   public $k00_nossonumero = null;
   ...
   function incluir ($k00_numpre){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,1575,361,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1575,9206,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_codbar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1575,9207,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_linhadigitavel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1575,22164,'','".AddSlashes(pg_fetch_result($resaco,0,'k00_nossonumero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   public function alterar ($k00_numpre=null) {
     ...
     if(trim((string) $this->k00_codbar)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k00_codbar"])){
       $sql  .= $virgula." k00_codbar = '$this->k00_codbar' ";
       $virgula = ",";
       if(trim((string) $this->k00_codbar) == null ){
         $this->erro_sql = " Campo Código de Barras não informado.";
         $this->erro_campo = "k00_codbar";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k00_linhadigitavel)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k00_linhadigitavel"])){
       $sql  .= $virgula." k00_linhadigitavel = '$this->k00_linhadigitavel' ";
       $virgula = ",";
       if(trim((string) $this->k00_linhadigitavel) == null ){
         $this->erro_sql = " Campo Linha Digitável não informado.";
         $this->erro_campo = "k00_linhadigitavel";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k00_nossonumero)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k00_nossonumero"])){
       $sql  .= $virgula." k00_nossonumero = '$this->k00_nossonumero' ";
       $virgula = ",";
       if(trim((string) $this->k00_nossonumero) == null ){
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["k00_numpre"]) || $this->k00_numpre != "")
             $resac = db_query("insert into db_acount values($acount,1575,361,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_numpre'))."','$this->k00_numpre',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["k00_codbar"]) || $this->k00_codbar != "")
             $resac = db_query("insert into db_acount values($acount,1575,9206,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_codbar'))."','$this->k00_codbar',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["k00_linhadigitavel"]) || $this->k00_linhadigitavel != "")
             $resac = db_query("insert into db_acount values($acount,1575,9207,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_linhadigitavel'))."','$this->k00_linhadigitavel',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["k00_nossonumero"]) || $this->k00_nossonumero != "")
             $resac = db_query("insert into db_acount values($acount,1575,22164,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k00_nossonumero'))."','$this->k00_nossonumero',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,1575,361,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1575,9206,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_codbar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1575,9207,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_linhadigitavel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1575,22164,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k00_nossonumero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
