...
class cl_agualeiturista { 
   ...
   public $x16_dtini_dia = null; 
   public $x16_dtini_mes = null; 
   public $x16_dtini_ano = null; 
   public $x16_dtini = null; 
   public $x16_dtfim_dia = null; 
   public $x16_dtfim_mes = null; 
   public $x16_dtfim_ano = null; 
   public $x16_dtfim = null; 
   public $x16_numcgm = 0; 
   public $x16_senha = null; 
   ...
   function incluir ($x16_numcgm){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1438,8466,'','".AddSlashes(pg_fetch_result($resaco,0,'x16_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1438,8467,'','".AddSlashes(pg_fetch_result($resaco,0,'x16_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1438,8468,'','".AddSlashes(pg_fetch_result($resaco,0,'x16_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1438,15303,'','".AddSlashes(pg_fetch_result($resaco,0,'x16_senha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($x16_numcgm=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->x16_dtini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x16_dtini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["x16_dtini_dia"] !="") ){ 
       $sql  .= $virgula." x16_dtini = '$this->x16_dtini' ";
       $virgula = ",";
       if(trim((string) $this->x16_dtini) == null ){ 
         $this->erro_sql = " Campo Data Inicio nao Informado.";
         $this->erro_campo = "x16_dtini_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->x16_dtfim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x16_dtfim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["x16_dtfim_dia"] !="") ){ 
     ...
     if(trim((string) $this->x16_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x16_numcgm"])){ 
       $sql  .= $virgula." x16_numcgm = $this->x16_numcgm ";
       $virgula = ",";
       if(trim((string) $this->x16_numcgm) == null ){ 
     ...
     if(trim((string) $this->x16_senha)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x16_senha"])){ 
       $sql  .= $virgula." x16_senha = '$this->x16_senha' ";
       $virgula = ",";
       if(trim((string) $this->x16_senha) == null ){ 
         $this->erro_sql = " Campo Senha nao Informado.";
         $this->erro_campo = "x16_senha";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x16_dtini"]) || $this->x16_dtini != "")
           $resac = db_query("insert into db_acount values($acount,1438,8466,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x16_dtini'))."','$this->x16_dtini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x16_dtfim"]) || $this->x16_dtfim != "")
           $resac = db_query("insert into db_acount values($acount,1438,8467,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x16_dtfim'))."','$this->x16_dtfim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x16_numcgm"]) || $this->x16_numcgm != "")
           $resac = db_query("insert into db_acount values($acount,1438,8468,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x16_numcgm'))."','$this->x16_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x16_senha"]) || $this->x16_senha != "")
           $resac = db_query("insert into db_acount values($acount,1438,15303,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x16_senha'))."','$this->x16_senha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($x16_numcgm=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1438,8466,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x16_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1438,8467,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x16_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1438,8468,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x16_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1438,15303,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x16_senha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
