...
class cl_agendaproced { 
   ...
   public $s125_i_codigo = 0; 
   public $s125_i_agendamento = 0; 
   public $s125_i_procedimento = 0; 
   ...
   function incluir ($s125_i_codigo){ 
     ...
     if($s125_i_codigo == "" || $s125_i_codigo == null ){
       ...
       $this->s125_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from agendaproc_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $s125_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2556,14507,'','".AddSlashes(pg_fetch_result($resaco,0,'s125_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2556,14508,'','".AddSlashes(pg_fetch_result($resaco,0,'s125_i_agendamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2556,14509,'','".AddSlashes(pg_fetch_result($resaco,0,'s125_i_procedimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($s125_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->s125_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s125_i_codigo"])){ 
       $sql  .= $virgula." s125_i_codigo = $this->s125_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->s125_i_codigo) == null ){ 
     ...
     if(trim((string) $this->s125_i_agendamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s125_i_agendamento"])){ 
       $sql  .= $virgula." s125_i_agendamento = $this->s125_i_agendamento ";
       $virgula = ",";
       if(trim((string) $this->s125_i_agendamento) == null ){ 
         $this->erro_sql = " Campo Agendamento nao Informado.";
         $this->erro_campo = "s125_i_agendamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s125_i_procedimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s125_i_procedimento"])){ 
       $sql  .= $virgula." s125_i_procedimento = $this->s125_i_procedimento ";
       $virgula = ",";
       if(trim((string) $this->s125_i_procedimento) == null ){ 
         $this->erro_sql = " Campo Procedimento nao Informado.";
         $this->erro_campo = "s125_i_procedimento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s125_i_codigo"]) || $this->s125_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2556,14507,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s125_i_codigo'))."','$this->s125_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s125_i_agendamento"]) || $this->s125_i_agendamento != "")
           $resac = db_query("insert into db_acount values($acount,2556,14508,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s125_i_agendamento'))."','$this->s125_i_agendamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s125_i_procedimento"]) || $this->s125_i_procedimento != "")
           $resac = db_query("insert into db_acount values($acount,2556,14509,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s125_i_procedimento'))."','$this->s125_i_procedimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($s125_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2556,14507,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s125_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2556,14508,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s125_i_agendamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2556,14509,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s125_i_procedimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
