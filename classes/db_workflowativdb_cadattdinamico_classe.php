...
class cl_workflowativdb_cadattdinamico { 
   ...
   public $db117_sequencial = 0; 
   public $db117_db_cadattdinamico = 0; 
   public $db117_workflowativ = 0; 
   ...
   function incluir ($db117_sequencial){ 
     ...
     if($db117_sequencial == "" || $db117_sequencial == null ){
       ...
       $this->db117_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from workflowativdb_cadattdinamico_db117_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db117_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3160,17895,'','".AddSlashes(pg_fetch_result($resaco,0,'db117_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3160,17896,'','".AddSlashes(pg_fetch_result($resaco,0,'db117_db_cadattdinamico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3160,17897,'','".AddSlashes(pg_fetch_result($resaco,0,'db117_workflowativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db117_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db117_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db117_sequencial"])){ 
       $sql  .= $virgula." db117_sequencial = $this->db117_sequencial ";
       $virgula = ",";
       if(trim((string) $this->db117_sequencial) == null ){ 
     ...
     if(trim((string) $this->db117_db_cadattdinamico)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db117_db_cadattdinamico"])){ 
       $sql  .= $virgula." db117_db_cadattdinamico = $this->db117_db_cadattdinamico ";
       $virgula = ",";
       if(trim((string) $this->db117_db_cadattdinamico) == null ){ 
         $this->erro_sql = " Campo Código Atributo Dinâmico nao Informado.";
         $this->erro_campo = "db117_db_cadattdinamico";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db117_workflowativ)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db117_workflowativ"])){ 
       $sql  .= $virgula." db117_workflowativ = $this->db117_workflowativ ";
       $virgula = ",";
       if(trim((string) $this->db117_workflowativ) == null ){ 
         $this->erro_sql = " Campo Código Work Flow Atividade nao Informado.";
         $this->erro_campo = "db117_workflowativ";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db117_sequencial"]) || $this->db117_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3160,17895,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db117_sequencial'))."','$this->db117_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db117_db_cadattdinamico"]) || $this->db117_db_cadattdinamico != "")
           $resac = db_query("insert into db_acount values($acount,3160,17896,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db117_db_cadattdinamico'))."','$this->db117_db_cadattdinamico',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db117_workflowativ"]) || $this->db117_workflowativ != "")
           $resac = db_query("insert into db_acount values($acount,3160,17897,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db117_workflowativ'))."','$this->db117_workflowativ',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db117_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3160,17895,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db117_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3160,17896,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db117_db_cadattdinamico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3160,17897,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db117_workflowativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
