...
class cl_mensageriaacordoprocessados { 
   ...
   public $ac53_sequencial = 0; 
   public $ac53_mensageriaacordodb_usuarios = 0; 
   public $ac53_acordo = 0; 
   ...
   function incluir ($ac53_sequencial){ 
     ...
     if($ac53_sequencial == "" || $ac53_sequencial == null ){
       ...
       $this->ac53_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mensageriaacordoprocessados_ac53_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac53_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3705,20589,'','".AddSlashes(pg_fetch_result($resaco,0,'ac53_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3705,20590,'','".AddSlashes(pg_fetch_result($resaco,0,'ac53_mensageriaacordodb_usuarios'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3705,20591,'','".AddSlashes(pg_fetch_result($resaco,0,'ac53_acordo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($ac53_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac53_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac53_sequencial"])){ 
       $sql  .= $virgula." ac53_sequencial = $this->ac53_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac53_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac53_mensageriaacordodb_usuarios)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac53_mensageriaacordodb_usuarios"])){ 
       $sql  .= $virgula." ac53_mensageriaacordodb_usuarios = $this->ac53_mensageriaacordodb_usuarios ";
       $virgula = ",";
       if(trim((string) $this->ac53_mensageriaacordodb_usuarios) == null ){ 
         $this->erro_sql = " Campo Usuário não informado.";
         $this->erro_campo = "ac53_mensageriaacordodb_usuarios";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac53_acordo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac53_acordo"])){ 
       $sql  .= $virgula." ac53_acordo = $this->ac53_acordo ";
       $virgula = ",";
       if(trim((string) $this->ac53_acordo) == null ){ 
         $this->erro_sql = " Campo Acordo não informado.";
         $this->erro_campo = "ac53_acordo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["ac53_sequencial"]) || $this->ac53_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3705,20589,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac53_sequencial'))."','$this->ac53_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ac53_mensageriaacordodb_usuarios"]) || $this->ac53_mensageriaacordodb_usuarios != "")
             $resac = db_query("insert into db_acount values($acount,3705,20590,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac53_mensageriaacordodb_usuarios'))."','$this->ac53_mensageriaacordodb_usuarios',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ac53_acordo"]) || $this->ac53_acordo != "")
             $resac = db_query("insert into db_acount values($acount,3705,20591,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac53_acordo'))."','$this->ac53_acordo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3705,20589,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac53_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3705,20590,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac53_mensageriaacordodb_usuarios'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3705,20591,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac53_acordo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
