...
class cl_histocorrenciamatric { 
   ...
   public $ar25_sequencial = 0; 
   public $ar25_matric = 0; 
   public $ar25_histocorrencia = 0; 
   ...
   function incluir ($ar25_sequencial){ 
     ...
     if($ar25_sequencial == "" || $ar25_sequencial == null ){
       ...
       $this->ar25_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from histocorrenciamatric_ar25_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ar25_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2656,15103,'','".AddSlashes(pg_fetch_result($resaco,0,'ar25_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2656,15104,'','".AddSlashes(pg_fetch_result($resaco,0,'ar25_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2656,15105,'','".AddSlashes(pg_fetch_result($resaco,0,'ar25_histocorrencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ar25_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ar25_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar25_sequencial"])){ 
       $sql  .= $virgula." ar25_sequencial = $this->ar25_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ar25_sequencial) == null ){ 
         $this->erro_sql = " Campo Código Histórico nao Informado.";
     ...
     if(trim((string) $this->ar25_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar25_matric"])){ 
       $sql  .= $virgula." ar25_matric = $this->ar25_matric ";
       $virgula = ",";
       if(trim((string) $this->ar25_matric) == null ){ 
         $this->erro_sql = " Campo Matrícula do Imóvel nao Informado.";
         $this->erro_campo = "ar25_matric";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ar25_histocorrencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar25_histocorrencia"])){ 
       $sql  .= $virgula." ar25_histocorrencia = $this->ar25_histocorrencia ";
       $virgula = ",";
       if(trim((string) $this->ar25_histocorrencia) == null ){ 
         $this->erro_sql = " Campo Código Histórico nao Informado.";
         $this->erro_campo = "ar25_histocorrencia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar25_sequencial"]) || $this->ar25_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2656,15103,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar25_sequencial'))."','$this->ar25_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar25_matric"]) || $this->ar25_matric != "")
           $resac = db_query("insert into db_acount values($acount,2656,15104,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar25_matric'))."','$this->ar25_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar25_histocorrencia"]) || $this->ar25_histocorrencia != "")
           $resac = db_query("insert into db_acount values($acount,2656,15105,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar25_histocorrencia'))."','$this->ar25_histocorrencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ar25_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2656,15103,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar25_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2656,15104,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar25_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2656,15105,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar25_histocorrencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
