...
class cl_issarquivoretencaoregistroissvar {
   ...
   public $q146_sequencial = 0;
   public $q146_issvar = 0;
   public $q146_issarquivoretencaoregistro = 0;
   ...
   function incluir ($q146_sequencial){
     ...
     if($q146_sequencial == "" || $q146_sequencial == null ){
       ...
       $this->q146_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from issarquivoretencaoregistroissvar_q146_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q146_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3806,21137,'','".AddSlashes(pg_fetch_result($resaco,0,'q146_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3806,21138,'','".AddSlashes(pg_fetch_result($resaco,0,'q146_issvar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3806,21139,'','".AddSlashes(pg_fetch_result($resaco,0,'q146_issarquivoretencaoregistro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   public function alterar ($q146_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->q146_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q146_sequencial"])){
       $sql  .= $virgula." q146_sequencial = $this->q146_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q146_sequencial) == null ){
     ...
     if(trim((string) $this->q146_issvar)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q146_issvar"])){
       $sql  .= $virgula." q146_issvar = $this->q146_issvar ";
       $virgula = ",";
       if(trim((string) $this->q146_issvar) == null ){
         $this->erro_sql = " Campo IssVar não informado.";
         $this->erro_campo = "q146_issvar";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q146_issarquivoretencaoregistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q146_issarquivoretencaoregistro"])){
       $sql  .= $virgula." q146_issarquivoretencaoregistro = $this->q146_issarquivoretencaoregistro ";
       $virgula = ",";
       if(trim((string) $this->q146_issarquivoretencaoregistro) == null ){
         $this->erro_sql = " Campo Código Registro Retencão não informado.";
         $this->erro_campo = "q146_issarquivoretencaoregistro";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["q146_sequencial"]) || $this->q146_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3806,21137,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q146_sequencial'))."','$this->q146_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["q146_issvar"]) || $this->q146_issvar != "")
             $resac = db_query("insert into db_acount values($acount,3806,21138,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q146_issvar'))."','$this->q146_issvar',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["q146_issarquivoretencaoregistro"]) || $this->q146_issarquivoretencaoregistro != "")
             $resac = db_query("insert into db_acount values($acount,3806,21139,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q146_issarquivoretencaoregistro'))."','$this->q146_issarquivoretencaoregistro',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3806,21137,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q146_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3806,21138,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q146_issvar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3806,21139,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q146_issarquivoretencaoregistro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
