...
class cl_unidadeservicos { 
   ...
   public $s126_i_codigo = 0; 
   public $s126_i_unidade = 0; 
   public $s126_i_servico = 0; 
   public $s126_d_ativado_dia = null; 
   public $s126_d_ativado_mes = null; 
   public $s126_d_ativado_ano = null; 
   public $s126_d_ativado = null; 
   public $s126_d_desativado_dia = null; 
   public $s126_d_desativado_mes = null; 
   public $s126_d_desativado_ano = null; 
   public $s126_d_desativado = null; 
   ...
   function incluir ($s126_i_codigo){ 
     ...
     if($s126_i_codigo == "" || $s126_i_codigo == null ){
       ...
       $this->s126_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from unidadeservicos_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $s126_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2674,15185,'','".AddSlashes(pg_fetch_result($resaco,0,'s126_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2674,15189,'','".AddSlashes(pg_fetch_result($resaco,0,'s126_i_unidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2674,15186,'','".AddSlashes(pg_fetch_result($resaco,0,'s126_i_servico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2674,15187,'','".AddSlashes(pg_fetch_result($resaco,0,'s126_d_ativado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2674,15188,'','".AddSlashes(pg_fetch_result($resaco,0,'s126_d_desativado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($s126_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->s126_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s126_i_codigo"])){ 
       $sql  .= $virgula." s126_i_codigo = $this->s126_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->s126_i_codigo) == null ){ 
     ...
     if(trim((string) $this->s126_i_unidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s126_i_unidade"])){ 
       $sql  .= $virgula." s126_i_unidade = $this->s126_i_unidade ";
       $virgula = ",";
       if(trim((string) $this->s126_i_unidade) == null ){ 
         $this->erro_sql = " Campo Unidade nao Informado.";
         $this->erro_campo = "s126_i_unidade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s126_i_servico)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s126_i_servico"])){ 
       $sql  .= $virgula." s126_i_servico = $this->s126_i_servico ";
       $virgula = ",";
       if(trim((string) $this->s126_i_servico) == null ){ 
         $this->erro_sql = " Campo Serviço nao Informado.";
         $this->erro_campo = "s126_i_servico";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s126_d_ativado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s126_d_ativado_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["s126_d_ativado_dia"] !="") ){ 
     ...
     if(trim((string) $this->s126_d_desativado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s126_d_desativado_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["s126_d_desativado_dia"] !="") ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s126_i_codigo"]) || $this->s126_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2674,15185,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s126_i_codigo'))."','$this->s126_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s126_i_unidade"]) || $this->s126_i_unidade != "")
           $resac = db_query("insert into db_acount values($acount,2674,15189,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s126_i_unidade'))."','$this->s126_i_unidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s126_i_servico"]) || $this->s126_i_servico != "")
           $resac = db_query("insert into db_acount values($acount,2674,15186,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s126_i_servico'))."','$this->s126_i_servico',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s126_d_ativado"]) || $this->s126_d_ativado != "")
           $resac = db_query("insert into db_acount values($acount,2674,15187,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s126_d_ativado'))."','$this->s126_d_ativado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s126_d_desativado"]) || $this->s126_d_desativado != "")
           $resac = db_query("insert into db_acount values($acount,2674,15188,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s126_d_desativado'))."','$this->s126_d_desativado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($s126_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2674,15185,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s126_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2674,15189,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s126_i_unidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2674,15186,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s126_i_servico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2674,15187,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s126_d_ativado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2674,15188,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s126_d_desativado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
