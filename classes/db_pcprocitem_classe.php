...
class cl_pcprocitem {
   ...
   public $pc81_codprocitem = 0;
   public $pc81_codproc = 0;
   public $pc81_solicitem = 0;
   ...
   function incluir ($pc81_codprocitem){
     ...
     if($pc81_codprocitem == "" || $pc81_codprocitem == null ){
       ...
       $this->pc81_codprocitem = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from pcprocitem_pc81_codprocitem_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $pc81_codprocitem)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1043,6385,'','".AddSlashes(pg_fetch_result($resaco,0,'pc81_codprocitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1043,6386,'','".AddSlashes(pg_fetch_result($resaco,0,'pc81_codproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1043,6387,'','".AddSlashes(pg_fetch_result($resaco,0,'pc81_solicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($pc81_codprocitem=null) {
     ...
     $virgula = "";
     if(trim((string) $this->pc81_codprocitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc81_codprocitem"])){
       $sql  .= $virgula." pc81_codprocitem = $this->pc81_codprocitem ";
       $virgula = ",";
       if(trim((string) $this->pc81_codprocitem) == null ){
     ...
     if(trim((string) $this->pc81_codproc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc81_codproc"])){
       $sql  .= $virgula." pc81_codproc = $this->pc81_codproc ";
       $virgula = ",";
       if(trim((string) $this->pc81_codproc) == null ){
     ...
     if(trim((string) $this->pc81_solicitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc81_solicitem"])){
       $sql  .= $virgula." pc81_solicitem = $this->pc81_solicitem ";
       $virgula = ",";
       if(trim((string) $this->pc81_solicitem) == null ){
         $this->erro_sql = " Campo Código do registro nao Informado.";
         $this->erro_campo = "pc81_solicitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc81_codprocitem"]))
           $resac = db_query("insert into db_acount values($acount,1043,6385,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc81_codprocitem'))."','$this->pc81_codprocitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc81_codproc"]))
           $resac = db_query("insert into db_acount values($acount,1043,6386,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc81_codproc'))."','$this->pc81_codproc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc81_solicitem"]))
           $resac = db_query("insert into db_acount values($acount,1043,6387,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc81_solicitem'))."','$this->pc81_solicitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($pc81_codprocitem=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1043,6385,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc81_codprocitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1043,6386,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc81_codproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1043,6387,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc81_solicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
