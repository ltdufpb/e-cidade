...
class cl_botipgrausat { 
   ...
   public $bo02__codgrausat = 0; 
   public $bo02_descr = null; 
   ...
   function incluir ($bo02__codgrausat){ 
     ...
     if($bo02__codgrausat == "" || $bo02__codgrausat == null ){
       ...
       $this->bo02__codgrausat = pg_fetch_result($result,0,0); 
     }else{
       $result = @db_query("select last_value from bograusat_codgrausat_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $bo02__codgrausat)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,10001,10005,'','".AddSlashes(pg_fetch_result($resaco,0,'bo02__codgrausat'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,10001,10006,'','".AddSlashes(pg_fetch_result($resaco,0,'bo02_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($bo02__codgrausat=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->bo02__codgrausat)!="" || isset($GLOBALS["HTTP_POST_VARS"]["bo02__codgrausat"])){ 
       $sql  .= $virgula." bo02__codgrausat = $this->bo02__codgrausat ";
       $virgula = ",";
       if(trim((string) $this->bo02__codgrausat) == null ){ 
     ...
     if(trim((string) $this->bo02_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["bo02_descr"])){ 
       $sql  .= $virgula." bo02_descr = '$this->bo02_descr' ";
       $virgula = ",";
       if(trim((string) $this->bo02_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "bo02_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["bo02__codgrausat"]))
           $resac = db_query("insert into db_acount values($acount,10001,10005,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'bo02__codgrausat'))."','$this->bo02__codgrausat',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["bo02_descr"]))
           $resac = db_query("insert into db_acount values($acount,10001,10006,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'bo02_descr'))."','$this->bo02_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($bo02__codgrausat=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,10001,10005,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'bo02__codgrausat'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,10001,10006,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'bo02_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
