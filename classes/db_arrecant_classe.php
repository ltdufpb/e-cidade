...
$sql .= "oid = '$oid'";     $result = db_query($sql);
   ...
   function excluir_arrecant($numpre,$numpar=0,$receit=0,$excluir_arrecad=true){
    ...
    for ($a=0; $a< $numrows; $a++) {
        ...
        $k00_numpre = pg_fetch_result($result,$a,"k00_numpre");
        $k00_numpar = pg_fetch_result($result,$a,"k00_numpar");
        $k00_numcgm = pg_fetch_result($result,$a,"k00_numcgm");
        $k00_dtoper = pg_fetch_result($result,$a,"k00_dtoper");
        $k00_receit = pg_fetch_result($result,$a,"k00_receit");
        $k00_hist   = pg_fetch_result($result,$a,"k00_hist");
        $k00_valor  = pg_fetch_result($result,$a,"k00_valor");
        $k00_dtvenc = pg_fetch_result($result,$a,"k00_dtvenc");
        $k00_numtot = pg_fetch_result($result,$a,"k00_numtot");
        $k00_numdig = pg_fetch_result($result,$a,"k00_numdig");
        $k00_tipo   = pg_fetch_result($result,$a,"k00_tipo");
        $k00_tipojm = pg_fetch_result($result,$a,"k00_tipojm");
