...
class cl_issgruposervicoativid { 
   ...
   public $q127_sequencial = 0; 
   public $q127_issgruposerviso = 0; 
   public $q127_ativid = 0; 
   ...
   function incluir ($q127_sequencial){ 
     ...
     if($q127_sequencial == "" || $q127_sequencial == null ){
       ...
       $this->q127_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from issgruposervicoativid_q127_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q127_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3249,18357,'','".AddSlashes(pg_fetch_result($resaco,0,'q127_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3249,18358,'','".AddSlashes(pg_fetch_result($resaco,0,'q127_issgruposerviso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3249,18359,'','".AddSlashes(pg_fetch_result($resaco,0,'q127_ativid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q127_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q127_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q127_sequencial"])){ 
       $sql  .= $virgula." q127_sequencial = $this->q127_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q127_sequencial) == null ){ 
     ...
     if(trim((string) $this->q127_issgruposerviso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q127_issgruposerviso"])){ 
       $sql  .= $virgula." q127_issgruposerviso = $this->q127_issgruposerviso ";
       $virgula = ",";
       if(trim((string) $this->q127_issgruposerviso) == null ){ 
         $this->erro_sql = " Campo Código de Serviço nao Informado.";
         $this->erro_campo = "q127_issgruposerviso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q127_ativid)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q127_ativid"])){ 
       $sql  .= $virgula." q127_ativid = $this->q127_ativid ";
       $virgula = ",";
       if(trim((string) $this->q127_ativid) == null ){ 
         $this->erro_sql = " Campo Código da Atividade nao Informado.";
         $this->erro_campo = "q127_ativid";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q127_sequencial"]) || $this->q127_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3249,18357,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q127_sequencial'))."','$this->q127_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q127_issgruposerviso"]) || $this->q127_issgruposerviso != "")
           $resac = db_query("insert into db_acount values($acount,3249,18358,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q127_issgruposerviso'))."','$this->q127_issgruposerviso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q127_ativid"]) || $this->q127_ativid != "")
           $resac = db_query("insert into db_acount values($acount,3249,18359,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q127_ativid'))."','$this->q127_ativid',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q127_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3249,18357,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q127_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3249,18358,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q127_issgruposerviso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3249,18359,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q127_ativid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
