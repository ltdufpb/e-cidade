...
class cl_motorist { 
   ...
   public $u03_habili = 0; 
   public $u03_categ = null; 
   public $u03_vencim_dia = null; 
   public $u03_vencim_mes = null; 
   public $u03_vencim_ano = null; 
   public $u03_vencim = null; 
   public $u03_numcgm = 0; 
   ...
   function alterar ( $oid=null ) { 
     ...
     $virgula = "";
     if(trim((string) $this->u03_habili)!="" || isset($GLOBALS["HTTP_POST_VARS"]["u03_habili"])){ 
       $sql  .= $virgula." u03_habili = $this->u03_habili ";
       $virgula = ",";
       if(trim((string) $this->u03_habili) == null ){ 
         $this->erro_sql = " Campo Numero da CNH nao Informado.";
         $this->erro_campo = "u03_habili";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->u03_categ)!="" || isset($GLOBALS["HTTP_POST_VARS"]["u03_categ"])){ 
       $sql  .= $virgula." u03_categ = '$this->u03_categ' ";
       $virgula = ",";
       if(trim((string) $this->u03_categ) == null ){ 
         $this->erro_sql = " Campo Categoria da CNH nao Informado.";
         $this->erro_campo = "u03_categ";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->u03_vencim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["u03_vencim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["u03_vencim_dia"] !="") ){ 
       $sql  .= $virgula." u03_vencim = '$this->u03_vencim' ";
       $virgula = ",";
       if(trim((string) $this->u03_vencim) == null ){ 
         $this->erro_sql = " Campo Data de Vencimento da CNH nao Informado.";
         $this->erro_campo = "u03_vencim_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->u03_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["u03_numcgm"])){ 
       $sql  .= $virgula." u03_numcgm = $this->u03_numcgm ";
       $virgula = ",";
       if(trim((string) $this->u03_numcgm) == null ){ 
         $this->erro_sql = " Campo Numero CGM nao Informado.";
         $this->erro_campo = "u03_numcgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
