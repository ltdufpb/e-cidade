...
class cl_far_requisitantecgs { 
   ...
   public $fa38_i_codigo = 0; 
   public $fa38_i_requisitante = 0; 
   public $fa38_i_cgs = 0; 
   ...
   function incluir ($fa38_i_codigo){ 
     ...
     if($fa38_i_codigo == "" || $fa38_i_codigo == null ){
       ...
       $this->fa38_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_requisitantecgs_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa38_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2616,14861,'','".AddSlashes(pg_fetch_result($resaco,0,'fa38_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2616,14862,'','".AddSlashes(pg_fetch_result($resaco,0,'fa38_i_requisitante'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2616,14863,'','".AddSlashes(pg_fetch_result($resaco,0,'fa38_i_cgs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa38_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa38_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa38_i_codigo"])){ 
       $sql  .= $virgula." fa38_i_codigo = $this->fa38_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa38_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa38_i_requisitante)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa38_i_requisitante"])){ 
       $sql  .= $virgula." fa38_i_requisitante = $this->fa38_i_requisitante ";
       $virgula = ",";
       if(trim((string) $this->fa38_i_requisitante) == null ){ 
         $this->erro_sql = " Campo Requisitante nao Informado.";
         $this->erro_campo = "fa38_i_requisitante";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa38_i_cgs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa38_i_cgs"])){ 
       $sql  .= $virgula." fa38_i_cgs = $this->fa38_i_cgs ";
       $virgula = ",";
       if(trim((string) $this->fa38_i_cgs) == null ){ 
         $this->erro_sql = " Campo CGS nao Informado.";
         $this->erro_campo = "fa38_i_cgs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa38_i_codigo"]) || $this->fa38_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2616,14861,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa38_i_codigo'))."','$this->fa38_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa38_i_requisitante"]) || $this->fa38_i_requisitante != "")
           $resac = db_query("insert into db_acount values($acount,2616,14862,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa38_i_requisitante'))."','$this->fa38_i_requisitante',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa38_i_cgs"]) || $this->fa38_i_cgs != "")
           $resac = db_query("insert into db_acount values($acount,2616,14863,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa38_i_cgs'))."','$this->fa38_i_cgs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa38_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2616,14861,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa38_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2616,14862,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa38_i_requisitante'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2616,14863,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa38_i_cgs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
