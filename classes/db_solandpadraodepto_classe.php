...
class cl_solandpadraodepto { 
   ...
   function incluir ($pc48_solandpadrao){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1315,7846,'','".AddSlashes(pg_fetch_result($resaco,0,'pc48_solandpadrao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1315,7847,'','".AddSlashes(pg_fetch_result($resaco,0,'pc48_depto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc48_solandpadrao=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc48_solandpadrao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc48_solandpadrao"])){ 
       $sql  .= $virgula." pc48_solandpadrao = $this->pc48_solandpadrao ";
       $virgula = ",";
       if(trim((string) $this->pc48_solandpadrao) == null ){ 
     ...
     if(trim((string) $this->pc48_depto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc48_depto"])){ 
       $sql  .= $virgula." pc48_depto = $this->pc48_depto ";
       $virgula = ",";
       if(trim((string) $this->pc48_depto) == null ){ 
         $this->erro_sql = " Campo Depart. nao Informado.";
         $this->erro_campo = "pc48_depto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc48_solandpadrao"]))
           $resac = db_query("insert into db_acount values($acount,1315,7846,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc48_solandpadrao'))."','$this->pc48_solandpadrao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc48_depto"]))
           $resac = db_query("insert into db_acount values($acount,1315,7847,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc48_depto'))."','$this->pc48_depto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc48_solandpadrao=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1315,7846,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc48_solandpadrao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1315,7847,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc48_depto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
