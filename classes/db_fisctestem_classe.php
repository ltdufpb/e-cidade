...
class cl_fisctestem { 
   ...
   function incluir ($y23_codnoti,$y23_numcgm){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,740,5164,'','".AddSlashes(pg_fetch_result($resaco,0,'y23_codnoti'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,740,5165,'','".AddSlashes(pg_fetch_result($resaco,0,'y23_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y23_codnoti=null,$y23_numcgm=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y23_codnoti)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y23_codnoti"])){ 
       $sql  .= $virgula." y23_codnoti = $this->y23_codnoti ";
       $virgula = ",";
       if(trim((string) $this->y23_codnoti) == null ){ 
     ...
     if(trim((string) $this->y23_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y23_numcgm"])){ 
       $sql  .= $virgula." y23_numcgm = $this->y23_numcgm ";
       $virgula = ",";
       if(trim((string) $this->y23_numcgm) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y23_codnoti"]))
           $resac = db_query("insert into db_acount values($acount,740,5164,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y23_codnoti'))."','$this->y23_codnoti',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y23_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,740,5165,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y23_numcgm'))."','$this->y23_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y23_codnoti=null,$y23_numcgm=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,740,5164,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y23_codnoti'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,740,5165,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y23_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
