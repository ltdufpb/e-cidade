...
class cl_classificacaorisco { 
   ...
   public $sd78_codigo = 0; 
   public $sd78_descricao = null; 
   public $sd78_peso = 0; 
   public $sd78_labelcor = null; 
   public $sd78_cor = null; 
   ...
   function incluir ($sd78_codigo){ 
     ...
     if($sd78_codigo == "" || $sd78_codigo == null ){
       ...
       $this->sd78_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from classificacaorisco_sd78_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $sd78_codigo)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3763,20914,'','".AddSlashes(pg_fetch_result($resaco,0,'sd78_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3763,20915,'','".AddSlashes(pg_fetch_result($resaco,0,'sd78_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3763,20917,'','".AddSlashes(pg_fetch_result($resaco,0,'sd78_peso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3763,20916,'','".AddSlashes(pg_fetch_result($resaco,0,'sd78_labelcor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3763,20918,'','".AddSlashes(pg_fetch_result($resaco,0,'sd78_cor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($sd78_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd78_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd78_codigo"])){ 
       $sql  .= $virgula." sd78_codigo = $this->sd78_codigo ";
       $virgula = ",";
       if(trim((string) $this->sd78_codigo) == null ){ 
     ...
     if(trim((string) $this->sd78_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd78_descricao"])){ 
       $sql  .= $virgula." sd78_descricao = '$this->sd78_descricao' ";
       $virgula = ",";
       if(trim((string) $this->sd78_descricao) == null ){ 
         $this->erro_sql = " Campo Decrição não informado.";
         $this->erro_campo = "sd78_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd78_peso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd78_peso"])){ 
       $sql  .= $virgula." sd78_peso = $this->sd78_peso ";
       $virgula = ",";
       if(trim((string) $this->sd78_peso) == null ){ 
         $this->erro_sql = " Campo Peso não informado.";
         $this->erro_campo = "sd78_peso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd78_labelcor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd78_labelcor"])){ 
       $sql  .= $virgula." sd78_labelcor = '$this->sd78_labelcor' ";
       $virgula = ",";
       if(trim((string) $this->sd78_labelcor) == null ){ 
         $this->erro_sql = " Campo Descrição da cor não informado.";
         $this->erro_campo = "sd78_labelcor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd78_cor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd78_cor"])){ 
       $sql  .= $virgula." sd78_cor = '$this->sd78_cor' ";
       $virgula = ",";
       if(trim((string) $this->sd78_cor) == null ){ 
         $this->erro_sql = " Campo Cor não informado.";
         $this->erro_campo = "sd78_cor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["sd78_codigo"]) || $this->sd78_codigo != "")
             $resac = db_query("insert into db_acount values($acount,3763,20914,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd78_codigo'))."','$this->sd78_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["sd78_descricao"]) || $this->sd78_descricao != "")
             $resac = db_query("insert into db_acount values($acount,3763,20915,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd78_descricao'))."','$this->sd78_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["sd78_peso"]) || $this->sd78_peso != "")
             $resac = db_query("insert into db_acount values($acount,3763,20917,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd78_peso'))."','$this->sd78_peso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["sd78_labelcor"]) || $this->sd78_labelcor != "")
             $resac = db_query("insert into db_acount values($acount,3763,20916,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd78_labelcor'))."','$this->sd78_labelcor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["sd78_cor"]) || $this->sd78_cor != "")
             $resac = db_query("insert into db_acount values($acount,3763,20918,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd78_cor'))."','$this->sd78_cor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3763,20914,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd78_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3763,20915,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd78_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3763,20917,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd78_peso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3763,20916,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd78_labelcor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3763,20918,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd78_cor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
