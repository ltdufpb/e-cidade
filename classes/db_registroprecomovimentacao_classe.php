...
class cl_registroprecomovimentacao { 
   ...
   public $pc58_sequencial = 0; 
   public $pc58_tipo = 0; 
   public $pc58_usuario = 0; 
   public $pc58_data_dia = null; 
   public $pc58_data_mes = null; 
   public $pc58_data_ano = null; 
   public $pc58_data = null; 
   public $pc58_situacao = 0; 
   public $pc58_solicita = 0; 
   ...
   function incluir ($pc58_sequencial){ 
     ...
     if($pc58_sequencial == "" || $pc58_sequencial == null ){
       ...
       $this->pc58_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from registroprecomovimentacao_pc58_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $pc58_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2695,15291,'','".AddSlashes(pg_fetch_result($resaco,0,'pc58_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2695,15292,'','".AddSlashes(pg_fetch_result($resaco,0,'pc58_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2695,15294,'','".AddSlashes(pg_fetch_result($resaco,0,'pc58_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2695,15295,'','".AddSlashes(pg_fetch_result($resaco,0,'pc58_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2695,15296,'','".AddSlashes(pg_fetch_result($resaco,0,'pc58_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2695,18204,'','".AddSlashes(pg_fetch_result($resaco,0,'pc58_solicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc58_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc58_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc58_sequencial"])){ 
       $sql  .= $virgula." pc58_sequencial = $this->pc58_sequencial ";
       $virgula = ",";
       if(trim((string) $this->pc58_sequencial) == null ){ 
     ...
     if(trim((string) $this->pc58_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc58_tipo"])){ 
       $sql  .= $virgula." pc58_tipo = $this->pc58_tipo ";
       $virgula = ",";
       if(trim((string) $this->pc58_tipo) == null ){ 
         $this->erro_sql = " Campo Código do Tipo nao Informado.";
         $this->erro_campo = "pc58_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc58_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc58_usuario"])){ 
       $sql  .= $virgula." pc58_usuario = $this->pc58_usuario ";
       $virgula = ",";
       if(trim((string) $this->pc58_usuario) == null ){ 
         $this->erro_sql = " Campo Código do Usuário nao Informado.";
         $this->erro_campo = "pc58_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc58_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc58_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["pc58_data_dia"] !="") ){ 
       $sql  .= $virgula." pc58_data = '$this->pc58_data' ";
       $virgula = ",";
       if(trim((string) $this->pc58_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "pc58_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc58_situacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc58_situacao"])){ 
       $sql  .= $virgula." pc58_situacao = $this->pc58_situacao ";
       $virgula = ",";
       if(trim((string) $this->pc58_situacao) == null ){ 
         $this->erro_sql = " Campo Código da Situação nao Informado.";
         $this->erro_campo = "pc58_situacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc58_solicita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc58_solicita"])){ 
       $sql  .= $virgula." pc58_solicita = $this->pc58_solicita ";
       $virgula = ",";
       if(trim((string) $this->pc58_solicita) == null ){ 
         $this->erro_sql = " Campo Código da Compilação nao Informado.";
         $this->erro_campo = "pc58_solicita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc58_sequencial"]) || $this->pc58_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2695,15291,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc58_sequencial'))."','$this->pc58_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc58_tipo"]) || $this->pc58_tipo != "")
           $resac = db_query("insert into db_acount values($acount,2695,15292,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc58_tipo'))."','$this->pc58_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc58_usuario"]) || $this->pc58_usuario != "")
           $resac = db_query("insert into db_acount values($acount,2695,15294,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc58_usuario'))."','$this->pc58_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc58_data"]) || $this->pc58_data != "")
           $resac = db_query("insert into db_acount values($acount,2695,15295,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc58_data'))."','$this->pc58_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc58_situacao"]) || $this->pc58_situacao != "")
           $resac = db_query("insert into db_acount values($acount,2695,15296,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc58_situacao'))."','$this->pc58_situacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc58_solicita"]) || $this->pc58_solicita != "")
           $resac = db_query("insert into db_acount values($acount,2695,18204,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc58_solicita'))."','$this->pc58_solicita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc58_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2695,15291,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc58_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2695,15292,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc58_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2695,15294,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc58_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2695,15295,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc58_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2695,15296,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc58_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2695,18204,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc58_solicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
