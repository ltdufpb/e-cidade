...
class cl_solicitapendencia { 
   ...
   public $pc91_sequencial = 0; 
   public $pc91_solicita = 0; 
   public $pc91_usuario = 0; 
   public $pc91_pendencia = null; 
   public $pc91_datainclusao_dia = null; 
   public $pc91_datainclusao_mes = null; 
   public $pc91_datainclusao_ano = null; 
   public $pc91_datainclusao = null; 
   ...
   function incluir ($pc91_sequencial){ 
     ...
     if($pc91_sequencial == "" || $pc91_sequencial == null ){
       ...
       $this->pc91_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from solicitapendencia_pc91_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $pc91_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3338,18823,'','".AddSlashes(pg_fetch_result($resaco,0,'pc91_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3338,18824,'','".AddSlashes(pg_fetch_result($resaco,0,'pc91_solicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3338,18825,'','".AddSlashes(pg_fetch_result($resaco,0,'pc91_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3338,18826,'','".AddSlashes(pg_fetch_result($resaco,0,'pc91_pendencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3338,18827,'','".AddSlashes(pg_fetch_result($resaco,0,'pc91_datainclusao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc91_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc91_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc91_sequencial"])){ 
       $sql  .= $virgula." pc91_sequencial = $this->pc91_sequencial ";
       $virgula = ",";
       if(trim((string) $this->pc91_sequencial) == null ){ 
     ...
     if(trim((string) $this->pc91_solicita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc91_solicita"])){ 
       $sql  .= $virgula." pc91_solicita = $this->pc91_solicita ";
       $virgula = ",";
       if(trim((string) $this->pc91_solicita) == null ){ 
         $this->erro_sql = " Campo Solicitação nao Informado.";
         $this->erro_campo = "pc91_solicita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc91_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc91_usuario"])){ 
       $sql  .= $virgula." pc91_usuario = $this->pc91_usuario ";
       $virgula = ",";
       if(trim((string) $this->pc91_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "pc91_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc91_pendencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc91_pendencia"])){ 
       $sql  .= $virgula." pc91_pendencia = '$this->pc91_pendencia' ";
       $virgula = ",";
       if(trim((string) $this->pc91_pendencia) == null ){ 
         $this->erro_sql = " Campo Pendencia nao Informado.";
         $this->erro_campo = "pc91_pendencia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc91_datainclusao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc91_datainclusao_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["pc91_datainclusao_dia"] !="") ){ 
       $sql  .= $virgula." pc91_datainclusao = '$this->pc91_datainclusao' ";
       $virgula = ",";
       if(trim((string) $this->pc91_datainclusao) == null ){ 
         $this->erro_sql = " Campo Data Inclusao nao Informado.";
         $this->erro_campo = "pc91_datainclusao_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc91_sequencial"]) || $this->pc91_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3338,18823,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc91_sequencial'))."','$this->pc91_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc91_solicita"]) || $this->pc91_solicita != "")
           $resac = db_query("insert into db_acount values($acount,3338,18824,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc91_solicita'))."','$this->pc91_solicita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc91_usuario"]) || $this->pc91_usuario != "")
           $resac = db_query("insert into db_acount values($acount,3338,18825,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc91_usuario'))."','$this->pc91_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc91_pendencia"]) || $this->pc91_pendencia != "")
           $resac = db_query("insert into db_acount values($acount,3338,18826,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc91_pendencia'))."','$this->pc91_pendencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc91_datainclusao"]) || $this->pc91_datainclusao != "")
           $resac = db_query("insert into db_acount values($acount,3338,18827,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc91_datainclusao'))."','$this->pc91_datainclusao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc91_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3338,18823,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc91_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3338,18824,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc91_solicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3338,18825,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc91_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3338,18826,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc91_pendencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3338,18827,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc91_datainclusao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
