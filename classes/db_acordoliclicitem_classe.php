...
class cl_acordoliclicitem { 
   ...
   public $ac24_sequencial = 0; 
   public $ac24_acordoitem = 0; 
   public $ac24_liclicitem = 0; 
   public $ac24_quantidade = 0; 
   public $ac24_valor = 0; 
   ...
   function incluir ($ac24_sequencial){ 
     ...
     if($ac24_sequencial == "" || $ac24_sequencial == null ){
       ...
       $this->ac24_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordoliclicitem_ac24_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac24_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2841,16188,'','".AddSlashes(pg_fetch_result($resaco,0,'ac24_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2841,16189,'','".AddSlashes(pg_fetch_result($resaco,0,'ac24_acordoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2841,16190,'','".AddSlashes(pg_fetch_result($resaco,0,'ac24_liclicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2841,16661,'','".AddSlashes(pg_fetch_result($resaco,0,'ac24_quantidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2841,16662,'','".AddSlashes(pg_fetch_result($resaco,0,'ac24_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac24_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac24_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac24_sequencial"])){ 
       $sql  .= $virgula." ac24_sequencial = $this->ac24_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac24_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac24_acordoitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac24_acordoitem"])){ 
       $sql  .= $virgula." ac24_acordoitem = $this->ac24_acordoitem ";
       $virgula = ",";
       if(trim((string) $this->ac24_acordoitem) == null ){ 
         $this->erro_sql = " Campo Acordo Item nao Informado.";
         $this->erro_campo = "ac24_acordoitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac24_liclicitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac24_liclicitem"])){ 
       $sql  .= $virgula." ac24_liclicitem = $this->ac24_liclicitem ";
       $virgula = ",";
       if(trim((string) $this->ac24_liclicitem) == null ){ 
         $this->erro_sql = " Campo Código Licitação nao Informado.";
         $this->erro_campo = "ac24_liclicitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac24_quantidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac24_quantidade"])){ 
        if(trim((string) $this->ac24_quantidade)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ac24_quantidade"])){ 
           $this->ac24_quantidade = "0" ; 
        } 
     ...
     if(trim((string) $this->ac24_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac24_valor"])){ 
        if(trim((string) $this->ac24_valor)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ac24_valor"])){ 
           $this->ac24_valor = "0" ; 
        } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac24_sequencial"]) || $this->ac24_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2841,16188,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac24_sequencial'))."','$this->ac24_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac24_acordoitem"]) || $this->ac24_acordoitem != "")
           $resac = db_query("insert into db_acount values($acount,2841,16189,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac24_acordoitem'))."','$this->ac24_acordoitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac24_liclicitem"]) || $this->ac24_liclicitem != "")
           $resac = db_query("insert into db_acount values($acount,2841,16190,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac24_liclicitem'))."','$this->ac24_liclicitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac24_quantidade"]) || $this->ac24_quantidade != "")
           $resac = db_query("insert into db_acount values($acount,2841,16661,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac24_quantidade'))."','$this->ac24_quantidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac24_valor"]) || $this->ac24_valor != "")
           $resac = db_query("insert into db_acount values($acount,2841,16662,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac24_valor'))."','$this->ac24_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac24_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2841,16188,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac24_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2841,16189,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac24_acordoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2841,16190,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac24_liclicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2841,16661,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac24_quantidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2841,16662,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac24_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
