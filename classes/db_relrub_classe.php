...
class cl_relrub { 
   ...
   public $rh45_instit = 0; 
   public $rh45_codigo = 0; 
   public $rh45_descr = null; 
   public $rh45_selecao = 0; 
   public $rh45_form = null; 
   ...
   function incluir ($rh45_codigo,$rh45_instit){ 
     ...
     if($rh45_codigo == "" || $rh45_codigo == null ){
       ...
       $this->rh45_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from relrub_rh45_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh45_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1351,9899,'','".AddSlashes(pg_fetch_result($resaco,0,'rh45_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1351,8014,'','".AddSlashes(pg_fetch_result($resaco,0,'rh45_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1351,8015,'','".AddSlashes(pg_fetch_result($resaco,0,'rh45_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1351,8016,'','".AddSlashes(pg_fetch_result($resaco,0,'rh45_selecao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1351,8017,'','".AddSlashes(pg_fetch_result($resaco,0,'rh45_form'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh45_codigo=null,$rh45_instit=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh45_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh45_instit"])){ 
       $sql  .= $virgula." rh45_instit = $this->rh45_instit ";
       $virgula = ",";
       if(trim((string) $this->rh45_instit) == null ){ 
     ...
     if(trim((string) $this->rh45_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh45_codigo"])){ 
       $sql  .= $virgula." rh45_codigo = $this->rh45_codigo ";
       $virgula = ",";
       if(trim((string) $this->rh45_codigo) == null ){ 
     ...
     if(trim((string) $this->rh45_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh45_descr"])){ 
       $sql  .= $virgula." rh45_descr = '$this->rh45_descr' ";
       $virgula = ",";
       if(trim((string) $this->rh45_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "rh45_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh45_selecao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh45_selecao"])){ 
        if(trim((string) $this->rh45_selecao)=="" && isset($GLOBALS["HTTP_POST_VARS"]["rh45_selecao"])){ 
           $this->rh45_selecao = "0" ; 
        } 
     ...
     if(trim((string) $this->rh45_form)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh45_form"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh45_instit"]))
           $resac = db_query("insert into db_acount values($acount,1351,9899,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh45_instit'))."','$this->rh45_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh45_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1351,8014,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh45_codigo'))."','$this->rh45_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh45_descr"]))
           $resac = db_query("insert into db_acount values($acount,1351,8015,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh45_descr'))."','$this->rh45_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh45_selecao"]))
           $resac = db_query("insert into db_acount values($acount,1351,8016,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh45_selecao'))."','$this->rh45_selecao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh45_form"]))
           $resac = db_query("insert into db_acount values($acount,1351,8017,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh45_form'))."','$this->rh45_form',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh45_codigo=null,$rh45_instit=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1351,9899,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh45_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1351,8014,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh45_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1351,8015,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh45_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1351,8016,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh45_selecao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1351,8017,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh45_form'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
