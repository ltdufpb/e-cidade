...
class cl_atoescola { 
   ...
   public $ed19_i_codigo = 0; 
   public $ed19_i_ato = 0; 
   public $ed19_i_escola = 0; 
   ...
   public function incluir ($ed19_i_codigo){ 
     ...
     if($ed19_i_codigo == "" || $ed19_i_codigo == null ){
       ...
       $this->ed19_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from atoescola_ed19_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed19_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010034,1008223,'','".AddSlashes(pg_fetch_result($resaco,0,'ed19_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010034,1008224,'','".AddSlashes(pg_fetch_result($resaco,0,'ed19_i_ato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010034,1008225,'','".AddSlashes(pg_fetch_result($resaco,0,'ed19_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   public function alterar ($ed19_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed19_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed19_i_codigo"])){ 
       $sql  .= $virgula." ed19_i_codigo = $this->ed19_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed19_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed19_i_ato)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed19_i_ato"])){ 
       $sql  .= $virgula." ed19_i_ato = $this->ed19_i_ato ";
       $virgula = ",";
       if(trim((string) $this->ed19_i_ato) == null ){ 
         $this->erro_sql = " Campo Ato Legal nao Informado.";
         $this->erro_campo = "ed19_i_ato";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed19_i_escola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed19_i_escola"])){ 
       $sql  .= $virgula." ed19_i_escola = $this->ed19_i_escola ";
       $virgula = ",";
       if(trim((string) $this->ed19_i_escola) == null ){ 
         $this->erro_sql = " Campo Escola nao Informado.";
         $this->erro_campo = "ed19_i_escola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed19_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010034,1008223,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed19_i_codigo'))."','$this->ed19_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed19_i_ato"]))
           $resac = db_query("insert into db_acount values($acount,1010034,1008224,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed19_i_ato'))."','$this->ed19_i_ato',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed19_i_escola"]))
           $resac = db_query("insert into db_acount values($acount,1010034,1008225,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed19_i_escola'))."','$this->ed19_i_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   public function excluir ($ed19_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010034,1008223,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed19_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010034,1008224,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed19_i_ato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010034,1008225,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed19_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
