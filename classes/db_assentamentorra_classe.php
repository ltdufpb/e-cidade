...
class cl_assentamentorra { 
   ...
   public $h83_assenta = 0; 
   public $h83_valor = 0; 
   public $h83_meses = 0; 
   public $h83_encargos = 0; 
   ...
   function incluir ($h83_assenta){ 
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3890,21655,'','".AddSlashes(pg_fetch_result($resaco,0,'h83_assenta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3890,21656,'','".AddSlashes(pg_fetch_result($resaco,0,'h83_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3890,21657,'','".AddSlashes(pg_fetch_result($resaco,0,'h83_meses'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3890,21665,'','".AddSlashes(pg_fetch_result($resaco,0,'h83_encargos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($h83_assenta=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h83_assenta)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h83_assenta"])){ 
       $sql  .= $virgula." h83_assenta = $this->h83_assenta ";
       $virgula = ",";
       if(trim((string) $this->h83_assenta) == null ){ 
     ...
     if(trim((string) $this->h83_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h83_valor"])){ 
       $sql  .= $virgula." h83_valor = $this->h83_valor ";
       $virgula = ",";
       if(trim((string) $this->h83_valor) == null ){ 
         $this->erro_sql = " Campo Valor não informado.";
         $this->erro_campo = "h83_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h83_meses)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h83_meses"])){ 
       $sql  .= $virgula." h83_meses = $this->h83_meses ";
       $virgula = ",";
       if(trim((string) $this->h83_meses) == null ){ 
         $this->erro_sql = " Campo Quantidade de Meses não informado.";
         $this->erro_campo = "h83_meses";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h83_encargos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h83_encargos"])){ 
       $sql  .= $virgula." h83_encargos = $this->h83_encargos ";
       $virgula = ",";
       if(trim((string) $this->h83_encargos) == null ){ 
         $this->erro_sql = " Campo Valor dos Encargos não informado.";
         $this->erro_campo = "h83_encargos";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["h83_assenta"]) || $this->h83_assenta != "")
             $resac = db_query("insert into db_acount values($acount,3890,21655,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h83_assenta'))."','$this->h83_assenta',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["h83_valor"]) || $this->h83_valor != "")
             $resac = db_query("insert into db_acount values($acount,3890,21656,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h83_valor'))."','$this->h83_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["h83_meses"]) || $this->h83_meses != "")
             $resac = db_query("insert into db_acount values($acount,3890,21657,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h83_meses'))."','$this->h83_meses',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["h83_encargos"]) || $this->h83_encargos != "")
             $resac = db_query("insert into db_acount values($acount,3890,21665,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h83_encargos'))."','$this->h83_encargos',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3890,21655,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h83_assenta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3890,21656,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h83_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3890,21657,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h83_meses'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3890,21665,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h83_encargos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
