...
class cl_vac_devfechaaplica { 
   ...
   public $vc24_i_codigo = 0; 
   public $vc24_i_fechaaplica = 0; 
   public $vc24_i_devolucao = 0; 
   ...
   function incluir ($vc24_i_codigo){ 
     ...
     if($vc24_i_codigo == "" || $vc24_i_codigo == null ){
       ...
       $this->vc24_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from vac_devfechaaplica_vc24_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $vc24_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3104,17574,'','".AddSlashes(pg_fetch_result($resaco,0,'vc24_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3104,17575,'','".AddSlashes(pg_fetch_result($resaco,0,'vc24_i_fechaaplica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3104,17576,'','".AddSlashes(pg_fetch_result($resaco,0,'vc24_i_devolucao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($vc24_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->vc24_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc24_i_codigo"])){ 
       $sql  .= $virgula." vc24_i_codigo = $this->vc24_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->vc24_i_codigo) == null ){ 
     ...
     if(trim((string) $this->vc24_i_fechaaplica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc24_i_fechaaplica"])){ 
       $sql  .= $virgula." vc24_i_fechaaplica = $this->vc24_i_fechaaplica ";
       $virgula = ",";
       if(trim((string) $this->vc24_i_fechaaplica) == null ){ 
         $this->erro_sql = " Campo fechamento aplicação nao Informado.";
         $this->erro_campo = "vc24_i_fechaaplica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc24_i_devolucao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc24_i_devolucao"])){ 
       $sql  .= $virgula." vc24_i_devolucao = $this->vc24_i_devolucao ";
       $virgula = ",";
       if(trim((string) $this->vc24_i_devolucao) == null ){ 
         $this->erro_sql = " Campo Devolução nao Informado.";
         $this->erro_campo = "vc24_i_devolucao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc24_i_codigo"]) || $this->vc24_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3104,17574,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc24_i_codigo'))."','$this->vc24_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc24_i_fechaaplica"]) || $this->vc24_i_fechaaplica != "")
           $resac = db_query("insert into db_acount values($acount,3104,17575,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc24_i_fechaaplica'))."','$this->vc24_i_fechaaplica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc24_i_devolucao"]) || $this->vc24_i_devolucao != "")
           $resac = db_query("insert into db_acount values($acount,3104,17576,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc24_i_devolucao'))."','$this->vc24_i_devolucao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($vc24_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3104,17574,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc24_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3104,17575,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc24_i_fechaaplica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3104,17576,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc24_i_devolucao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
