...
class cl_veicabastretirada { 
   ...
   public $ve73_codigo = 0; 
   public $ve73_veicabast = 0; 
   public $ve73_veicretirada = 0; 
   ...
   function incluir ($ve73_codigo){ 
     ...
     if($ve73_codigo == "" || $ve73_codigo == null ){
       ...
       $this->ve73_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veicabastretirada_ve73_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve73_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1613,9384,'','".AddSlashes(pg_fetch_result($resaco,0,'ve73_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1613,9385,'','".AddSlashes(pg_fetch_result($resaco,0,'ve73_veicabast'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1613,9386,'','".AddSlashes(pg_fetch_result($resaco,0,'ve73_veicretirada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve73_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve73_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve73_codigo"])){ 
       $sql  .= $virgula." ve73_codigo = $this->ve73_codigo ";
       $virgula = ",";
       if(trim((string) $this->ve73_codigo) == null ){ 
     ...
     if(trim((string) $this->ve73_veicabast)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve73_veicabast"])){ 
       $sql  .= $virgula." ve73_veicabast = $this->ve73_veicabast ";
       $virgula = ",";
       if(trim((string) $this->ve73_veicabast) == null ){ 
         $this->erro_sql = " Campo Abastecimento nao Informado.";
         $this->erro_campo = "ve73_veicabast";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve73_veicretirada)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve73_veicretirada"])){ 
       $sql  .= $virgula." ve73_veicretirada = $this->ve73_veicretirada ";
       $virgula = ",";
       if(trim((string) $this->ve73_veicretirada) == null ){ 
         $this->erro_sql = " Campo Retirada nao Informado.";
         $this->erro_campo = "ve73_veicretirada";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve73_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1613,9384,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve73_codigo'))."','$this->ve73_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve73_veicabast"]))
           $resac = db_query("insert into db_acount values($acount,1613,9385,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve73_veicabast'))."','$this->ve73_veicabast',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve73_veicretirada"]))
           $resac = db_query("insert into db_acount values($acount,1613,9386,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve73_veicretirada'))."','$this->ve73_veicretirada',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve73_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1613,9384,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve73_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1613,9385,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve73_veicabast'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1613,9386,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve73_veicretirada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
