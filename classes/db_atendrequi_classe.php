...
class cl_atendrequi {
   ...
   public $m42_codigo = 0;
   public $m42_data_dia = null;
   public $m42_data_mes = null;
   public $m42_data_ano = null;
   public $m42_data = null;
   public $m42_hora = null;
   public $m42_login = 0;
   public $m42_depto = 0;
   ...
   function incluir ($m42_codigo){
     ...
     if($m42_codigo == "" || $m42_codigo == null ){
       ...
       $this->m42_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from atendrequi_m42_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $m42_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1130,6876,'','".AddSlashes(pg_fetch_result($resaco,0,'m42_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1130,6877,'','".AddSlashes(pg_fetch_result($resaco,0,'m42_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1130,6878,'','".AddSlashes(pg_fetch_result($resaco,0,'m42_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1130,6879,'','".AddSlashes(pg_fetch_result($resaco,0,'m42_login'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1130,6880,'','".AddSlashes(pg_fetch_result($resaco,0,'m42_depto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($m42_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->m42_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m42_codigo"])){
       $sql  .= $virgula." m42_codigo = $this->m42_codigo ";
       $virgula = ",";
       if(trim((string) $this->m42_codigo) == null ){
     ...
     if(trim((string) $this->m42_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m42_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["m42_data_dia"] !="") ){
       $sql  .= $virgula." m42_data = '$this->m42_data' ";
       $virgula = ",";
       if(trim((string) $this->m42_data) == null ){
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "m42_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m42_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m42_hora"])){
       $sql  .= $virgula." m42_hora = '$this->m42_hora' ";
       $virgula = ",";
       if(trim((string) $this->m42_hora) == null ){
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "m42_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m42_login)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m42_login"])){
       $sql  .= $virgula." m42_login = $this->m42_login ";
       $virgula = ",";
       if(trim((string) $this->m42_login) == null ){
         $this->erro_sql = " Campo Cod. Usuário nao Informado.";
         $this->erro_campo = "m42_login";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m42_depto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m42_depto"])){
       $sql  .= $virgula." m42_depto = $this->m42_depto ";
       $virgula = ",";
       if(trim((string) $this->m42_depto) == null ){
         $this->erro_sql = " Campo Depart. nao Informado.";
         $this->erro_campo = "m42_depto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["m42_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1130,6876,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m42_codigo'))."','$this->m42_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m42_data"]))
           $resac = db_query("insert into db_acount values($acount,1130,6877,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m42_data'))."','$this->m42_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m42_hora"]))
           $resac = db_query("insert into db_acount values($acount,1130,6878,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m42_hora'))."','$this->m42_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m42_login"]))
           $resac = db_query("insert into db_acount values($acount,1130,6879,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m42_login'))."','$this->m42_login',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m42_depto"]))
           $resac = db_query("insert into db_acount values($acount,1130,6880,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m42_depto'))."','$this->m42_depto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($m42_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1130,6876,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m42_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1130,6877,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m42_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1130,6878,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m42_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1130,6879,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m42_login'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1130,6880,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m42_depto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
