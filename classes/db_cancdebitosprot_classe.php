...
class cl_cancdebitosprot { 
   ...
   public $k25_cancdebitos = 0; 
   public $k25_codproc = 0; 
   ...
   function incluir ($k25_cancdebitos){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1292,7764,'','".AddSlashes(pg_fetch_result($resaco,0,'k25_cancdebitos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1292,7765,'','".AddSlashes(pg_fetch_result($resaco,0,'k25_codproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k25_cancdebitos=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k25_cancdebitos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k25_cancdebitos"])){ 
       $sql  .= $virgula." k25_cancdebitos = $this->k25_cancdebitos ";
       $virgula = ",";
       if(trim((string) $this->k25_cancdebitos) == null ){ 
     ...
     if(trim((string) $this->k25_codproc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k25_codproc"])){ 
       $sql  .= $virgula." k25_codproc = $this->k25_codproc ";
       $virgula = ",";
       if(trim((string) $this->k25_codproc) == null ){ 
         $this->erro_sql = " Campo Código do processo nao Informado.";
         $this->erro_campo = "k25_codproc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k25_cancdebitos"]))
           $resac = db_query("insert into db_acount values($acount,1292,7764,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k25_cancdebitos'))."','$this->k25_cancdebitos',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k25_codproc"]))
           $resac = db_query("insert into db_acount values($acount,1292,7765,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k25_codproc'))."','$this->k25_codproc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k25_cancdebitos=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1292,7764,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k25_cancdebitos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1292,7765,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k25_codproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
