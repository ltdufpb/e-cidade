...
class cl_veicabastposto { 
   ...
   public $ve71_codigo = 0; 
   public $ve71_veicabast = 0; 
   public $ve71_veiccadposto = 0; 
   public $ve71_nota = null; 
   ...
   function incluir ($ve71_codigo){ 
     ...
     if($ve71_codigo == "" || $ve71_codigo == null ){
       ...
       $this->ve71_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veicabastposto_ve71_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve71_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1611,9377,'','".AddSlashes(pg_fetch_result($resaco,0,'ve71_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1611,9378,'','".AddSlashes(pg_fetch_result($resaco,0,'ve71_veicabast'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1611,9379,'','".AddSlashes(pg_fetch_result($resaco,0,'ve71_veiccadposto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1611,9380,'','".AddSlashes(pg_fetch_result($resaco,0,'ve71_nota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve71_codigo=null,$dbwhere=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve71_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve71_codigo"])){ 
       $sql  .= $virgula." ve71_codigo = $this->ve71_codigo ";
       $virgula = ",";
       if(trim((string) $this->ve71_codigo) == null ){ 
     ...
     if(trim((string) $this->ve71_veicabast)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve71_veicabast"])){ 
       $sql  .= $virgula." ve71_veicabast = $this->ve71_veicabast ";
       $virgula = ",";
       if(trim((string) $this->ve71_veicabast) == null ){ 
         $this->erro_sql = " Campo Abastecimento nao Informado.";
         $this->erro_campo = "ve71_veicabast";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve71_veiccadposto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve71_veiccadposto"])){ 
       $sql  .= $virgula." ve71_veiccadposto = $this->ve71_veiccadposto ";
       $virgula = ",";
       if(trim((string) $this->ve71_veiccadposto) == null ){ 
         $this->erro_sql = " Campo Posto nao Informado.";
         $this->erro_campo = "ve71_veiccadposto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve71_nota)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve71_nota"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve71_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1611,9377,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve71_codigo'))."','$this->ve71_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve71_veicabast"]))
           $resac = db_query("insert into db_acount values($acount,1611,9378,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve71_veicabast'))."','$this->ve71_veicabast',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve71_veiccadposto"]))
           $resac = db_query("insert into db_acount values($acount,1611,9379,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve71_veiccadposto'))."','$this->ve71_veiccadposto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve71_nota"]))
           $resac = db_query("insert into db_acount values($acount,1611,9380,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve71_nota'))."','$this->ve71_nota',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve71_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1611,9377,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve71_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1611,9378,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve71_veicabast'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1611,9379,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve71_veiccadposto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1611,9380,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve71_nota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
