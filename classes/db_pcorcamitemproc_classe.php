...
class cl_pcorcamitemproc {
    ...
    public $pc31_orcamitem = 0;
    public $pc31_pcprocitem = 0;
    ...
    function incluir ($pc31_orcamitem,$pc31_pcprocitem){
        ...
        if(($resaco!=false)||($this->numrows!=0)){
            ...
            $resac = db_query("insert into db_acount values($acount,1044,6444,'','".AddSlashes(pg_fetch_result($resaco,0,'pc31_orcamitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
            $resac = db_query("insert into db_acount values($acount,1044,6445,'','".AddSlashes(pg_fetch_result($resaco,0,'pc31_pcprocitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        }
        return true;
    }
    ...
    function alterar ($pc31_orcamitem=null,$pc31_pcprocitem=null) {
        ...
        $virgula = "";
        if(trim((string) $this->pc31_orcamitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc31_orcamitem"])){
            $sql  .= $virgula." pc31_orcamitem = $this->pc31_orcamitem ";
            $virgula = ",";
            if(trim((string) $this->pc31_orcamitem) == null ){
        ...
        if(trim((string) $this->pc31_pcprocitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc31_pcprocitem"])){
            $sql  .= $virgula." pc31_pcprocitem = $this->pc31_pcprocitem ";
            $virgula = ",";
            if(trim((string) $this->pc31_pcprocitem) == null ){
        ...
        if($this->numrows>0){
            for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
                ...
                if(isset($GLOBALS["HTTP_POST_VARS"]["pc31_orcamitem"]))
                    $resac = db_query("insert into db_acount values($acount,1044,6444,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc31_orcamitem'))."','$this->pc31_orcamitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                if(isset($GLOBALS["HTTP_POST_VARS"]["pc31_pcprocitem"]))
                    $resac = db_query("insert into db_acount values($acount,1044,6445,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc31_pcprocitem'))."','$this->pc31_pcprocitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
            }
        }
        $result = db_query($sql);
        if($result==false){
    ...
    function excluir ($pc31_orcamitem=null,$pc31_pcprocitem=null,$dbwhere=null) {
        ...
        if(($resaco!=false)||($this->numrows!=0)){
            for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
                ...
                $resac = db_query("insert into db_acount values($acount,1044,6444,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc31_orcamitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1044,6445,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc31_pcprocitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
            }
        }
