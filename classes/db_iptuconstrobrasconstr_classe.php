...
class cl_iptuconstrobrasconstr { 
   ...
   public $j132_sequencial = 0; 
   public $j132_matric = 0; 
   public $j132_idconstr = 0; 
   public $j132_obrasconstr = 0; 
   ...
   function incluir ($j132_sequencial){ 
     ...
     if($j132_sequencial == "" || $j132_sequencial == null ){
       ...
       $this->j132_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from iptuconstrobrasconstr_j132_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $j132_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3302,18656,'','".AddSlashes(pg_fetch_result($resaco,0,'j132_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3302,18653,'','".AddSlashes(pg_fetch_result($resaco,0,'j132_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3302,18654,'','".AddSlashes(pg_fetch_result($resaco,0,'j132_idconstr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3302,18655,'','".AddSlashes(pg_fetch_result($resaco,0,'j132_obrasconstr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j132_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j132_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j132_sequencial"])){ 
       $sql  .= $virgula." j132_sequencial = $this->j132_sequencial ";
       $virgula = ",";
       if(trim((string) $this->j132_sequencial) == null ){ 
     ...
     if(trim((string) $this->j132_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j132_matric"])){ 
       $sql  .= $virgula." j132_matric = $this->j132_matric ";
       $virgula = ",";
       if(trim((string) $this->j132_matric) == null ){ 
         $this->erro_sql = " Campo Matric nao Informado.";
         $this->erro_campo = "j132_matric";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j132_idconstr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j132_idconstr"])){ 
       $sql  .= $virgula." j132_idconstr = $this->j132_idconstr ";
       $virgula = ",";
       if(trim((string) $this->j132_idconstr) == null ){ 
         $this->erro_sql = " Campo idconstr nao Informado.";
         $this->erro_campo = "j132_idconstr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j132_obrasconstr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j132_obrasconstr"])){ 
       $sql  .= $virgula." j132_obrasconstr = $this->j132_obrasconstr ";
       $virgula = ",";
       if(trim((string) $this->j132_obrasconstr) == null ){ 
         $this->erro_sql = " Campo obrasconstr nao Informado.";
         $this->erro_campo = "j132_obrasconstr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j132_sequencial"]) || $this->j132_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3302,18656,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j132_sequencial'))."','$this->j132_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j132_matric"]) || $this->j132_matric != "")
           $resac = db_query("insert into db_acount values($acount,3302,18653,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j132_matric'))."','$this->j132_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j132_idconstr"]) || $this->j132_idconstr != "")
           $resac = db_query("insert into db_acount values($acount,3302,18654,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j132_idconstr'))."','$this->j132_idconstr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j132_obrasconstr"]) || $this->j132_obrasconstr != "")
           $resac = db_query("insert into db_acount values($acount,3302,18655,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j132_obrasconstr'))."','$this->j132_obrasconstr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j132_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3302,18656,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j132_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3302,18653,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j132_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3302,18654,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j132_idconstr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3302,18655,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j132_obrasconstr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
