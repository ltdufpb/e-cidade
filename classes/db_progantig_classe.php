...
class cl_progantig { 
   ...
   public $ed113_i_codigo = 0; 
   public $ed113_i_progmatricula = 0; 
   public $ed113_i_usuario = 0; 
   public $ed113_d_data_dia = null; 
   public $ed113_d_data_mes = null; 
   public $ed113_d_data_ano = null; 
   public $ed113_d_data = null; 
   public $ed113_f_pontuacao = 0; 
   public $ed113_i_ano = 0; 
   ...
   function incluir ($ed113_i_codigo){ 
     ...
     if($ed113_i_codigo == "" || $ed113_i_codigo == null ){
       ...
       $this->ed113_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from progantig_ed113_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed113_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010174,1009117,'','".AddSlashes(pg_fetch_result($resaco,0,'ed113_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010174,1009118,'','".AddSlashes(pg_fetch_result($resaco,0,'ed113_i_progmatricula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010174,1009122,'','".AddSlashes(pg_fetch_result($resaco,0,'ed113_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010174,1009119,'','".AddSlashes(pg_fetch_result($resaco,0,'ed113_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010174,1009120,'','".AddSlashes(pg_fetch_result($resaco,0,'ed113_f_pontuacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010174,1009121,'','".AddSlashes(pg_fetch_result($resaco,0,'ed113_i_ano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed113_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed113_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed113_i_codigo"])){ 
       $sql  .= $virgula." ed113_i_codigo = $this->ed113_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed113_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed113_i_progmatricula)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed113_i_progmatricula"])){ 
       $sql  .= $virgula." ed113_i_progmatricula = $this->ed113_i_progmatricula ";
       $virgula = ",";
       if(trim((string) $this->ed113_i_progmatricula) == null ){ 
         $this->erro_sql = " Campo Matrícula nao Informado.";
         $this->erro_campo = "ed113_i_progmatricula";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed113_i_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed113_i_usuario"])){ 
       $sql  .= $virgula." ed113_i_usuario = $this->ed113_i_usuario ";
       $virgula = ",";
       if(trim((string) $this->ed113_i_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "ed113_i_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed113_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed113_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed113_d_data_dia"] !="") ){ 
       $sql  .= $virgula." ed113_d_data = '$this->ed113_d_data' ";
       $virgula = ",";
       if(trim((string) $this->ed113_d_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "ed113_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed113_f_pontuacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed113_f_pontuacao"])){ 
       $sql  .= $virgula." ed113_f_pontuacao = $this->ed113_f_pontuacao ";
       $virgula = ",";
       if(trim((string) $this->ed113_f_pontuacao) == null ){ 
         $this->erro_sql = " Campo Pontuação nao Informado.";
         $this->erro_campo = "ed113_f_pontuacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed113_i_ano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed113_i_ano"])){ 
       $sql  .= $virgula." ed113_i_ano = $this->ed113_i_ano ";
       $virgula = ",";
       if(trim((string) $this->ed113_i_ano) == null ){ 
         $this->erro_sql = " Campo Ano Referente nao Informado.";
         $this->erro_campo = "ed113_i_ano";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed113_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010174,1009117,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed113_i_codigo'))."','$this->ed113_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed113_i_progmatricula"]))
           $resac = db_query("insert into db_acount values($acount,1010174,1009118,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed113_i_progmatricula'))."','$this->ed113_i_progmatricula',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed113_i_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1010174,1009122,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed113_i_usuario'))."','$this->ed113_i_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed113_d_data"]))
           $resac = db_query("insert into db_acount values($acount,1010174,1009119,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed113_d_data'))."','$this->ed113_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed113_f_pontuacao"]))
           $resac = db_query("insert into db_acount values($acount,1010174,1009120,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed113_f_pontuacao'))."','$this->ed113_f_pontuacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed113_i_ano"]))
           $resac = db_query("insert into db_acount values($acount,1010174,1009121,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed113_i_ano'))."','$this->ed113_i_ano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed113_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010174,1009117,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed113_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010174,1009118,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed113_i_progmatricula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010174,1009122,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed113_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010174,1009119,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed113_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010174,1009120,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed113_f_pontuacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010174,1009121,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed113_i_ano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
