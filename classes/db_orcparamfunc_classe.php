...
class cl_orcparamfunc { 
   ...
   public $o45_sequencia = 0; 
   public $o45_codparrel = 0; 
   public $o45_anousu = 0; 
   public $o45_func = 0; 
   public $o45_instit = 0; 
   ...
   function incluir ($o45_sequencia,$o45_anousu,$o45_codparrel,$o45_func){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1770,10249,'','".AddSlashes(pg_fetch_result($resaco,0,'o45_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1770,10248,'','".AddSlashes(pg_fetch_result($resaco,0,'o45_codparrel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1770,10247,'','".AddSlashes(pg_fetch_result($resaco,0,'o45_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1770,10250,'','".AddSlashes(pg_fetch_result($resaco,0,'o45_func'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1770,10251,'','".AddSlashes(pg_fetch_result($resaco,0,'o45_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o45_sequencia=null,$o45_anousu=null,$o45_codparrel=null,$o45_func=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o45_sequencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o45_sequencia"])){ 
       $sql  .= $virgula." o45_sequencia = $this->o45_sequencia ";
       $virgula = ",";
       if(trim((string) $this->o45_sequencia) == null ){ 
     ...
     if(trim((string) $this->o45_codparrel)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o45_codparrel"])){ 
       $sql  .= $virgula." o45_codparrel = $this->o45_codparrel ";
       $virgula = ",";
       if(trim((string) $this->o45_codparrel) == null ){ 
     ...
     if(trim((string) $this->o45_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o45_anousu"])){ 
       $sql  .= $virgula." o45_anousu = $this->o45_anousu ";
       $virgula = ",";
       if(trim((string) $this->o45_anousu) == null ){ 
     ...
     if(trim((string) $this->o45_func)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o45_func"])){ 
       $sql  .= $virgula." o45_func = $this->o45_func ";
       $virgula = ",";
       if(trim((string) $this->o45_func) == null ){ 
     ...
     if(trim((string) $this->o45_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o45_instit"])){ 
       $sql  .= $virgula." o45_instit = $this->o45_instit ";
       $virgula = ",";
       if(trim((string) $this->o45_instit) == null ){ 
         $this->erro_sql = " Campo Instituição nao Informado.";
         $this->erro_campo = "o45_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o45_sequencia"]))
           $resac = db_query("insert into db_acount values($acount,1770,10249,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o45_sequencia'))."','$this->o45_sequencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o45_codparrel"]))
           $resac = db_query("insert into db_acount values($acount,1770,10248,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o45_codparrel'))."','$this->o45_codparrel',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o45_anousu"]))
           $resac = db_query("insert into db_acount values($acount,1770,10247,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o45_anousu'))."','$this->o45_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o45_func"]))
           $resac = db_query("insert into db_acount values($acount,1770,10250,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o45_func'))."','$this->o45_func',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o45_instit"]))
           $resac = db_query("insert into db_acount values($acount,1770,10251,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o45_instit'))."','$this->o45_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o45_sequencia=null,$o45_anousu=null,$o45_codparrel=null,$o45_func=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1770,10249,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o45_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1770,10248,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o45_codparrel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1770,10247,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o45_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1770,10250,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o45_func'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1770,10251,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o45_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
