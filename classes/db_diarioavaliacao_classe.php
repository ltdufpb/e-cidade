...
class cl_diarioavaliacao {
   ...
   public $ed72_i_codigo = 0;
   public $ed72_i_diario = 0;
   public $ed72_i_procavaliacao = 0;
   public $ed72_i_numfaltas = 0;
   public $ed72_i_valornota = "";
   public $ed72_c_valorconceito = null;
   public $ed72_t_parecer = null;
   public $ed72_c_aprovmin = null;
   public $ed72_c_amparo = null;
   public $ed72_t_obs = null;
   public $ed72_i_escola = 0;
   public $ed72_c_tipo = null;
   public $ed72_c_convertido = null;
   ...
   function incluir ($ed72_i_codigo){
     ...
     if($ed72_i_codigo == "" || $ed72_i_codigo == null ){
       ...
       $this->ed72_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from diarioavaliacao_ed72_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed72_i_codigo)){
     ...
     if (isset($lSessaoDesativarAccount) && $lSessaoDesativarAccount === false) {
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,1010119,1008663,'','".AddSlashes(pg_fetch_result($resaco,0,'ed72_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010119,1008664,'','".AddSlashes(pg_fetch_result($resaco,0,'ed72_i_diario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010119,1008665,'','".AddSlashes(pg_fetch_result($resaco,0,'ed72_i_procavaliacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010119,1008666,'','".AddSlashes(pg_fetch_result($resaco,0,'ed72_i_numfaltas'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010119,1008667,'','".AddSlashes(pg_fetch_result($resaco,0,'ed72_i_valornota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010119,1008668,'','".AddSlashes(pg_fetch_result($resaco,0,'ed72_c_valorconceito'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010119,1008669,'','".AddSlashes(pg_fetch_result($resaco,0,'ed72_t_parecer'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010119,1008670,'','".AddSlashes(pg_fetch_result($resaco,0,'ed72_c_aprovmin'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010119,1008671,'','".AddSlashes(pg_fetch_result($resaco,0,'ed72_c_amparo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010119,1009243,'','".AddSlashes(pg_fetch_result($resaco,0,'ed72_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010119,12153,'','".AddSlashes(pg_fetch_result($resaco,0,'ed72_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010119,12154,'','".AddSlashes(pg_fetch_result($resaco,0,'ed72_c_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     }
     return true;
   }
   ...
   function alterar ($ed72_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->ed72_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed72_i_codigo"])){
       $sql  .= $virgula." ed72_i_codigo = $this->ed72_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed72_i_codigo) == null ){
     ...
     if(trim((string) $this->ed72_i_diario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed72_i_diario"])){
       $sql  .= $virgula." ed72_i_diario = $this->ed72_i_diario ";
       $virgula = ",";
       if(trim((string) $this->ed72_i_diario) == null ){
         $this->erro_sql = " Campo Diário de Classe nao Informado.";
         $this->erro_campo = "ed72_i_diario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed72_i_procavaliacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed72_i_procavaliacao"])){
       $sql  .= $virgula." ed72_i_procavaliacao = $this->ed72_i_procavaliacao ";
       $virgula = ",";
       if(trim((string) $this->ed72_i_procavaliacao) == null ){
         $this->erro_sql = " Campo Período de Avaliação nao Informado.";
         $this->erro_campo = "ed72_i_procavaliacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed72_i_numfaltas)==null){
      $this->ed72_i_numfaltas = "null" ;
     }
     $sql  .= $virgula." ed72_i_numfaltas = $this->ed72_i_numfaltas ";
     $virgula = ",";

     if(trim((string) $this->ed72_i_valornota)==null){
        $this->ed72_i_valornota = "null" ;
     }
     $sql  .= $virgula." ed72_i_valornota = $this->ed72_i_valornota ";
     $virgula = ",";

     if(trim((string) $this->ed72_c_valorconceito)==null){
        $this->ed72_c_valorconceito = "" ;
     }
     $sql  .= $virgula." ed72_c_valorconceito = '$this->ed72_c_valorconceito' ";
     $virgula = ",";

     if (trim((string) $this->ed72_t_parecer) == null) {
       $this->ed72_t_parecer = '';
     }
     $sql     .= $virgula." ed72_t_parecer = '$this->ed72_t_parecer' ";
     $virgula  = ",";
     if(trim((string) $this->ed72_c_aprovmin)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed72_c_aprovmin"])){
       $sql  .= $virgula." ed72_c_aprovmin = '$this->ed72_c_aprovmin' ";
       $virgula = ",";
       if(trim((string) $this->ed72_c_aprovmin) == null ){
         $this->erro_sql = " Campo Aproveitamento Mínimo nao Informado.";
         $this->erro_campo = "ed72_c_aprovmin";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed72_c_amparo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed72_c_amparo"])){
       $sql  .= $virgula." ed72_c_amparo = '$this->ed72_c_amparo' ";
       $virgula = ",";
       if(trim((string) $this->ed72_c_amparo) == null ){
         $this->erro_sql = " Campo Amparo nao Informado.";
         $this->erro_campo = "ed72_c_amparo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed72_i_escola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed72_i_escola"])){
       $sql  .= $virgula." ed72_i_escola = $this->ed72_i_escola ";
       $virgula = ",";
       if(trim((string) $this->ed72_i_escola) == null ){
         $this->erro_sql = " Campo Escola de Origem do Aproveitamento nao Informado.";
         $this->erro_campo = "ed72_i_escola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed72_c_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed72_c_tipo"])){
       $sql  .= $virgula." ed72_c_tipo = '$this->ed72_c_tipo' ";
       $virgula = ",";
       if(trim((string) $this->ed72_c_tipo) == null ){
         $this->erro_sql = " Campo Tipo de Escola nao Informado.";
         $this->erro_campo = "ed72_c_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed72_c_convertido)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed72_c_convertido"])){
       $sql  .= $virgula." ed72_c_convertido = '$this->ed72_c_convertido' ";
       $virgula = ",";
       if(trim((string) $this->ed72_c_convertido) == null ){
         $this->erro_sql = " Campo Nota Convertida nao Informado.";
         $this->erro_campo = "ed72_c_convertido";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if( trim( (string) $this->ed72_t_obs ) == null ) {
       $this->ed72_t_obs = "" ;
     }
       ...
       if (isset($lSessaoDesativarAccount) && $lSessaoDesativarAccount === false) {
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           $resac = db_query("insert into db_acountkey values($acount,1008663,'$this->ed72_i_codigo','A')");
             $resac = db_query("insert into db_acount values($acount,1010119,1008663,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed72_i_codigo'))."','$this->ed72_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
             $resac = db_query("insert into db_acount values($acount,1010119,1008664,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed72_i_diario'))."','$this->ed72_i_diario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
             $resac = db_query("insert into db_acount values($acount,1010119,1008665,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed72_i_procavaliacao'))."','$this->ed72_i_procavaliacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
             $resac = db_query("insert into db_acount values($acount,1010119,1008666,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed72_i_numfaltas'))."','$this->ed72_i_numfaltas',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
             $resac = db_query("insert into db_acount values($acount,1010119,1008667,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed72_i_valornota'))."','$this->ed72_i_valornota',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
             $resac = db_query("insert into db_acount values($acount,1010119,1008668,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed72_c_valorconceito'))."','$this->ed72_c_valorconceito',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
             $resac = db_query("insert into db_acount values($acount,1010119,1008669,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed72_t_parecer'))."','$this->ed72_t_parecer',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
             $resac = db_query("insert into db_acount values($acount,1010119,1008670,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed72_c_aprovmin'))."','$this->ed72_c_aprovmin',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
             $resac = db_query("insert into db_acount values($acount,1010119,1008671,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed72_c_amparo'))."','$this->ed72_c_amparo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
             $resac = db_query("insert into db_acount values($acount,1010119,1009243,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed72_t_obs'))."','$this->ed72_t_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
             $resac = db_query("insert into db_acount values($acount,1010119,12153,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed72_i_escola'))."','$this->ed72_i_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
             $resac = db_query("insert into db_acount values($acount,1010119,12154,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed72_c_tipo'))."','$this->ed72_c_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     ...
     if (isset($lSessaoDesativarAccount) && $lSessaoDesativarAccount === false) {
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
           ...
           $resac = db_query("insert into db_acount values($acount,1010119,1008663,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed72_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,1010119,1008664,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed72_i_diario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,1010119,1008665,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed72_i_procavaliacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,1010119,1008666,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed72_i_numfaltas'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,1010119,1008667,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed72_i_valornota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,1010119,1008668,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed72_c_valorconceito'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,1010119,1008669,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed72_t_parecer'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,1010119,1008670,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed72_c_aprovmin'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,1010119,1008671,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed72_c_amparo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,1010119,1009243,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed72_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,1010119,12153,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed72_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,1010119,12154,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed72_c_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
