...
class cl_db_arquivos { 
   ...
   public $codfilho = 0; 
   public $arqfilho = null; 
   public $descfilho = null; 
   ...
   function incluir ($codfilho){ 
     ...
     if($codfilho == "" || $codfilho == null ){
       ...
       $this->codfilho = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_arquivos_codfilho_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $codfilho)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,657,4861,'','".AddSlashes(pg_fetch_result($resaco,0,'codfilho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,657,4862,'','".AddSlashes(pg_fetch_result($resaco,0,'arqfilho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,657,4863,'','".AddSlashes(pg_fetch_result($resaco,0,'descfilho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,657,5048,'','".AddSlashes(pg_fetch_result($resaco,0,'id_versao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($codfilho=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->codfilho)!="" || isset($GLOBALS["HTTP_POST_VARS"]["codfilho"])){ 
       $sql  .= $virgula." codfilho = $this->codfilho ";
       $virgula = ",";
       if(trim((string) $this->codfilho) == null ){ 
     ...
     if(trim((string) $this->arqfilho)!="" || isset($GLOBALS["HTTP_POST_VARS"]["arqfilho"])){ 
       $sql  .= $virgula." arqfilho = '$this->arqfilho' ";
       $virgula = ",";
       if(trim((string) $this->arqfilho) == null ){ 
         $this->erro_sql = " Campo Arquivo nao Informado.";
         $this->erro_campo = "arqfilho";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->descfilho)!="" || isset($GLOBALS["HTTP_POST_VARS"]["descfilho"])){ 
       $sql  .= $virgula." descfilho = '$this->descfilho' ";
       $virgula = ",";
       if(trim((string) $this->descfilho) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "descfilho";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->id_versao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["id_versao"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["codfilho"]))
           $resac = db_query("insert into db_acount values($acount,657,4861,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'codfilho'))."','$this->codfilho',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["arqfilho"]))
           $resac = db_query("insert into db_acount values($acount,657,4862,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'arqfilho'))."','$this->arqfilho',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["descfilho"]))
           $resac = db_query("insert into db_acount values($acount,657,4863,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'descfilho'))."','$this->descfilho',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["id_versao"]))
           $resac = db_query("insert into db_acount values($acount,657,5048,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'id_versao'))."','$this->id_versao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($codfilho=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,657,4861,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'codfilho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,657,4862,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'arqfilho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,657,4863,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'descfilho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,657,5048,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'id_versao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
