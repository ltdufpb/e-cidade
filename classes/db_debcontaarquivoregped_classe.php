...
class cl_debcontaarquivoregped { 
   ...
   public $d80_sequencial = 0; 
   public $d80_arquivoreg = 0; 
   public $d80_pedido = 0; 
   ...
   function incluir ($d80_sequencial){ 
     ...
     if($d80_sequencial == "" || $d80_sequencial == null ){
       ...
       $this->d80_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from debcontaarquivoregped_d80_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $d80_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1393,8267,'','".AddSlashes(pg_fetch_result($resaco,0,'d80_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1393,8268,'','".AddSlashes(pg_fetch_result($resaco,0,'d80_arquivoreg'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1393,8269,'','".AddSlashes(pg_fetch_result($resaco,0,'d80_pedido'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($d80_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->d80_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d80_sequencial"])){ 
       $sql  .= $virgula." d80_sequencial = $this->d80_sequencial ";
       $virgula = ",";
       if(trim((string) $this->d80_sequencial) == null ){ 
     ...
     if(trim((string) $this->d80_arquivoreg)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d80_arquivoreg"])){ 
       $sql  .= $virgula." d80_arquivoreg = $this->d80_arquivoreg ";
       $virgula = ",";
       if(trim((string) $this->d80_arquivoreg) == null ){ 
         $this->erro_sql = " Campo Codigo sequencial nao Informado.";
         $this->erro_campo = "d80_arquivoreg";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->d80_pedido)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d80_pedido"])){ 
       $sql  .= $virgula." d80_pedido = $this->d80_pedido ";
       $virgula = ",";
       if(trim((string) $this->d80_pedido) == null ){ 
         $this->erro_sql = " Campo Codigo sequencial nao Informado.";
         $this->erro_campo = "d80_pedido";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["d80_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1393,8267,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d80_sequencial'))."','$this->d80_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d80_arquivoreg"]))
           $resac = db_query("insert into db_acount values($acount,1393,8268,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d80_arquivoreg'))."','$this->d80_arquivoreg',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d80_pedido"]))
           $resac = db_query("insert into db_acount values($acount,1393,8269,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d80_pedido'))."','$this->d80_pedido',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($d80_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1393,8267,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d80_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1393,8268,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d80_arquivoreg'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1393,8269,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d80_pedido'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
