...
class cl_aguaconstrcar { 
   ...
   function incluir ($x12_codigo,$x12_codconstr){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1429,8425,'','".AddSlashes(pg_fetch_result($resaco,0,'x12_codconstr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1429,8426,'','".AddSlashes(pg_fetch_result($resaco,0,'x12_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($x12_codigo=null,$x12_codconstr=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->x12_codconstr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x12_codconstr"])){ 
       $sql  .= $virgula." x12_codconstr = $this->x12_codconstr ";
       $virgula = ",";
       if(trim((string) $this->x12_codconstr) == null ){ 
     ...
     if(trim((string) $this->x12_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x12_codigo"])){ 
       $sql  .= $virgula." x12_codigo = $this->x12_codigo ";
       $virgula = ",";
       if(trim((string) $this->x12_codigo) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x12_codconstr"]))
           $resac = db_query("insert into db_acount values($acount,1429,8425,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x12_codconstr'))."','$this->x12_codconstr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x12_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1429,8426,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x12_codigo'))."','$this->x12_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($x12_codigo=null,$x12_codconstr=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1429,8425,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x12_codconstr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1429,8426,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x12_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
