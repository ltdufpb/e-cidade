...
class cl_clasativ { 
   ...
   function incluir ($q82_ativ,$q82_classe){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,56,306,'','".AddSlashes(pg_fetch_result($resaco,0,'q82_ativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,56,307,'','".AddSlashes(pg_fetch_result($resaco,0,'q82_classe'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q82_ativ=null,$q82_classe=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q82_ativ)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q82_ativ"])){ 
       $sql  .= $virgula." q82_ativ = $this->q82_ativ ";
       $virgula = ",";
       if(trim((string) $this->q82_ativ) == null ){ 
     ...
     if(trim((string) $this->q82_classe)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q82_classe"])){ 
       $sql  .= $virgula." q82_classe = $this->q82_classe ";
       $virgula = ",";
       if(trim((string) $this->q82_classe) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q82_ativ"]))
           $resac = db_query("insert into db_acount values($acount,56,306,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q82_ativ'))."','$this->q82_ativ',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q82_classe"]))
           $resac = db_query("insert into db_acount values($acount,56,307,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q82_classe'))."','$this->q82_classe',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q82_ativ=null,$q82_classe=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,56,306,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q82_ativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,56,307,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q82_classe'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
