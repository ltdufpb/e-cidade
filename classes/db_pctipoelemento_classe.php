...
class cl_pctipoelemento { 
   ...
   public $pc06_codtipo = 0; 
   public $pc06_codele = 0; 
   ...
   function incluir ($pc06_codtipo,$pc06_codele){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,867,5498,'','".AddSlashes(pg_fetch_result($resaco,0,'pc06_codtipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,867,5499,'','".AddSlashes(pg_fetch_result($resaco,0,'pc06_codele'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc06_codtipo=null,$pc06_codele=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc06_codtipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc06_codtipo"])){ 
       $sql  .= $virgula." pc06_codtipo = $this->pc06_codtipo ";
       $virgula = ",";
       if(trim((string) $this->pc06_codtipo) == null ){ 
     ...
     if(trim((string) $this->pc06_codele)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc06_codele"])){ 
       $sql  .= $virgula." pc06_codele = $this->pc06_codele ";
       $virgula = ",";
       if(trim((string) $this->pc06_codele) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc06_codtipo"]))
           $resac = db_query("insert into db_acount values($acount,867,5498,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc06_codtipo'))."','$this->pc06_codtipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc06_codele"]))
           $resac = db_query("insert into db_acount values($acount,867,5499,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc06_codele'))."','$this->pc06_codele',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc06_codtipo=null,$pc06_codele=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,867,5498,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc06_codtipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,867,5499,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc06_codele'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
