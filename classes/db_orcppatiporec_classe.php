...
class cl_orcppatiporec { 
   ...
   function incluir ($o26_codseqppa,$o26_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1068,6491,'','".AddSlashes(pg_fetch_result($resaco,0,'o26_codseqppa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1068,6492,'','".AddSlashes(pg_fetch_result($resaco,0,'o26_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o26_codseqppa=null,$o26_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o26_codseqppa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o26_codseqppa"])){ 
       $sql  .= $virgula." o26_codseqppa = $this->o26_codseqppa ";
       $virgula = ",";
       if(trim((string) $this->o26_codseqppa) == null ){ 
     ...
     if(trim((string) $this->o26_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o26_codigo"])){ 
       $sql  .= $virgula." o26_codigo = $this->o26_codigo ";
       $virgula = ",";
       if(trim((string) $this->o26_codigo) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o26_codseqppa"]))
           $resac = db_query("insert into db_acount values($acount,1068,6491,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o26_codseqppa'))."','$this->o26_codseqppa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o26_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1068,6492,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o26_codigo'))."','$this->o26_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o26_codseqppa=null,$o26_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1068,6491,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o26_codseqppa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1068,6492,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o26_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
