...
class cl_meiprocessaregmeicgm { 
   ...
   public $q118_sequencial = 0; 
   public $q118_meicgm = 0; 
   public $q118_meiprocessareg = 0; 
   ...
   function incluir ($q118_sequencial){ 
     ...
     if($q118_sequencial == "" || $q118_sequencial == null ){
       ...
       $this->q118_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from meiprocessaregmeicgm_q118_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q118_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2947,16649,'','".AddSlashes(pg_fetch_result($resaco,0,'q118_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2947,16650,'','".AddSlashes(pg_fetch_result($resaco,0,'q118_meicgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2947,16651,'','".AddSlashes(pg_fetch_result($resaco,0,'q118_meiprocessareg'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q118_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q118_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q118_sequencial"])){ 
       $sql  .= $virgula." q118_sequencial = $this->q118_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q118_sequencial) == null ){ 
     ...
     if(trim((string) $this->q118_meicgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q118_meicgm"])){ 
       $sql  .= $virgula." q118_meicgm = $this->q118_meicgm ";
       $virgula = ",";
       if(trim((string) $this->q118_meicgm) == null ){ 
         $this->erro_sql = " Campo MEI nao Informado.";
         $this->erro_campo = "q118_meicgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q118_meiprocessareg)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q118_meiprocessareg"])){ 
       $sql  .= $virgula." q118_meiprocessareg = $this->q118_meiprocessareg ";
       $virgula = ",";
       if(trim((string) $this->q118_meiprocessareg) == null ){ 
         $this->erro_sql = " Campo Registro de Processamento do MEI nao Informado.";
         $this->erro_campo = "q118_meiprocessareg";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q118_sequencial"]) || $this->q118_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2947,16649,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q118_sequencial'))."','$this->q118_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q118_meicgm"]) || $this->q118_meicgm != "")
           $resac = db_query("insert into db_acount values($acount,2947,16650,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q118_meicgm'))."','$this->q118_meicgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q118_meiprocessareg"]) || $this->q118_meiprocessareg != "")
           $resac = db_query("insert into db_acount values($acount,2947,16651,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q118_meiprocessareg'))."','$this->q118_meiprocessareg',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q118_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2947,16649,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q118_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2947,16650,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q118_meicgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2947,16651,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q118_meiprocessareg'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
