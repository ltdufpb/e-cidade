...
class cl_cadenderestado { 
   ...
   public $db71_sequencial = 0; 
   public $db71_cadenderpais = 0; 
   public $db71_sigla = null; 
   public $db71_descricao = null; 
   ...
   function incluir ($db71_sequencial){ 
     ...
     if($db71_sequencial == "" || $db71_sequencial == null ){
       ...
       $this->db71_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cadenderestado_db71_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db71_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2780,15843,'','".AddSlashes(pg_fetch_result($resaco,0,'db71_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2780,15844,'','".AddSlashes(pg_fetch_result($resaco,0,'db71_cadenderpais'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2780,15845,'','".AddSlashes(pg_fetch_result($resaco,0,'db71_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2780,15846,'','".AddSlashes(pg_fetch_result($resaco,0,'db71_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db71_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db71_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db71_sequencial"])){ 
       $sql  .= $virgula." db71_sequencial = $this->db71_sequencial ";
       $virgula = ",";
       if(trim((string) $this->db71_sequencial) == null ){ 
     ...
     if(trim((string) $this->db71_cadenderpais)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db71_cadenderpais"])){ 
       $sql  .= $virgula." db71_cadenderpais = $this->db71_cadenderpais ";
       $virgula = ",";
       if(trim((string) $this->db71_cadenderpais) == null ){ 
         $this->erro_sql = " Campo Código do País nao Informado.";
         $this->erro_campo = "db71_cadenderpais";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db71_sigla)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db71_sigla"])){ 
       $sql  .= $virgula." db71_sigla = '$this->db71_sigla' ";
       $virgula = ",";
       if(trim((string) $this->db71_sigla) == null ){ 
         $this->erro_sql = " Campo Sigla do Estado nao Informado.";
         $this->erro_campo = "db71_sigla";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db71_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db71_descricao"])){ 
       $sql  .= $virgula." db71_descricao = '$this->db71_descricao' ";
       $virgula = ",";
       if(trim((string) $this->db71_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição do Estado nao Informado.";
         $this->erro_campo = "db71_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db71_sequencial"]) || $this->db71_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2780,15843,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db71_sequencial'))."','$this->db71_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db71_cadenderpais"]) || $this->db71_cadenderpais != "")
           $resac = db_query("insert into db_acount values($acount,2780,15844,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db71_cadenderpais'))."','$this->db71_cadenderpais',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db71_sigla"]) || $this->db71_sigla != "")
           $resac = db_query("insert into db_acount values($acount,2780,15845,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db71_sigla'))."','$this->db71_sigla',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db71_descricao"]) || $this->db71_descricao != "")
           $resac = db_query("insert into db_acount values($acount,2780,15846,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db71_descricao'))."','$this->db71_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db71_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2780,15843,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db71_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2780,15844,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db71_cadenderpais'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2780,15845,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db71_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2780,15846,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db71_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
