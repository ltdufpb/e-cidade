...
class cl_progconvfaltas { 
   ...
   public $ed128_i_codigo = 0; 
   public $ed128_i_progconvres = 0; 
   public $ed128_c_abonada = null; 
   public $ed128_t_obs = null; 
   public $ed128_d_data_dia = null; 
   public $ed128_d_data_mes = null; 
   public $ed128_d_data_ano = null; 
   public $ed128_d_data = null; 
   public $ed128_c_numfono = null; 
   ...
   function incluir ($ed128_i_codigo){ 
     ...
     if($ed128_i_codigo == "" || $ed128_i_codigo == null ){
       ...
       $this->ed128_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from progconvfaltas_ed128_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed128_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010188,1009207,'','".AddSlashes(pg_fetch_result($resaco,0,'ed128_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010188,1009208,'','".AddSlashes(pg_fetch_result($resaco,0,'ed128_i_progconvres'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010188,1009212,'','".AddSlashes(pg_fetch_result($resaco,0,'ed128_c_abonada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010188,1009209,'','".AddSlashes(pg_fetch_result($resaco,0,'ed128_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010188,1009210,'','".AddSlashes(pg_fetch_result($resaco,0,'ed128_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010188,1009211,'','".AddSlashes(pg_fetch_result($resaco,0,'ed128_c_numfono'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed128_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed128_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed128_i_codigo"])){ 
       $sql  .= $virgula." ed128_i_codigo = $this->ed128_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed128_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed128_i_progconvres)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed128_i_progconvres"])){ 
       $sql  .= $virgula." ed128_i_progconvres = $this->ed128_i_progconvres ";
       $virgula = ",";
       if(trim((string) $this->ed128_i_progconvres) == null ){ 
         $this->erro_sql = " Campo Convocação nao Informado.";
         $this->erro_campo = "ed128_i_progconvres";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed128_c_abonada)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed128_c_abonada"])){ 
       $sql  .= $virgula." ed128_c_abonada = '$this->ed128_c_abonada' ";
       $virgula = ",";
       if(trim((string) $this->ed128_c_abonada) == null ){ 
         $this->erro_sql = " Campo Falta Abonada nao Informado.";
         $this->erro_campo = "ed128_c_abonada";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed128_t_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed128_t_obs"])){ 
       $sql  .= $virgula." ed128_t_obs = '$this->ed128_t_obs' ";
       $virgula = ",";
     }
     if(trim((string) $this->ed128_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed128_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed128_d_data_dia"] !="") ){ 
     ...
     if(trim((string) $this->ed128_c_numfono)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed128_c_numfono"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed128_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010188,1009207,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed128_i_codigo'))."','$this->ed128_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed128_i_progconvres"]))
           $resac = db_query("insert into db_acount values($acount,1010188,1009208,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed128_i_progconvres'))."','$this->ed128_i_progconvres',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed128_c_abonada"]))
           $resac = db_query("insert into db_acount values($acount,1010188,1009212,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed128_c_abonada'))."','$this->ed128_c_abonada',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed128_t_obs"]))
           $resac = db_query("insert into db_acount values($acount,1010188,1009209,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed128_t_obs'))."','$this->ed128_t_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed128_d_data"]))
           $resac = db_query("insert into db_acount values($acount,1010188,1009210,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed128_d_data'))."','$this->ed128_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed128_c_numfono"]))
           $resac = db_query("insert into db_acount values($acount,1010188,1009211,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed128_c_numfono'))."','$this->ed128_c_numfono',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed128_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010188,1009207,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed128_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010188,1009208,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed128_i_progconvres'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010188,1009212,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed128_c_abonada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010188,1009209,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed128_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010188,1009210,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed128_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010188,1009211,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed128_c_numfono'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
