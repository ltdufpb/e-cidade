...
class cl_prontcid {
   ...
   public $sd55_i_codigo = 0;
   public $sd55_i_prontuario = 0;
   public $sd55_i_cid = 0;
   public $sd55_b_principal = 'f';
   ...
   function incluir ($sd55_i_codigo){
     ...
     if($sd55_i_codigo == "" || $sd55_i_codigo == null ){
       ...
       $this->sd55_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from prontcid_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $sd55_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2118,12197,'','".AddSlashes(pg_fetch_result($resaco,0,'sd55_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2118,12198,'','".AddSlashes(pg_fetch_result($resaco,0,'sd55_i_prontuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2118,12199,'','".AddSlashes(pg_fetch_result($resaco,0,'sd55_i_cid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2118,12216,'','".AddSlashes(pg_fetch_result($resaco,0,'sd55_b_principal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($sd55_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->sd55_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd55_i_codigo"])){
       $sql  .= $virgula." sd55_i_codigo = $this->sd55_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->sd55_i_codigo) == null ){
     ...
     if(trim((string) $this->sd55_i_prontuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd55_i_prontuario"])){
       $sql  .= $virgula." sd55_i_prontuario = $this->sd55_i_prontuario ";
       $virgula = ",";
       if(trim((string) $this->sd55_i_prontuario) == null ){
         $this->erro_sql = " Campo Prontuário nao Informado.";
         $this->erro_campo = "sd55_i_prontuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd55_i_cid)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd55_i_cid"])){
       $sql  .= $virgula." sd55_i_cid = $this->sd55_i_cid ";
       $virgula = ",";
       if(trim((string) $this->sd55_i_cid) == null ){
         $this->erro_sql = " Campo CID nao Informado.";
         $this->erro_campo = "sd55_i_cid";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd55_b_principal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd55_b_principal"])){
       $sql  .= $virgula." sd55_b_principal = '$this->sd55_b_principal' ";
       $virgula = ",";
       if(trim((string) $this->sd55_b_principal) == null ){
         $this->erro_sql = " Campo CID Principal nao Informado.";
         $this->erro_campo = "sd55_b_principal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd55_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2118,12197,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd55_i_codigo'))."','$this->sd55_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd55_i_prontuario"]))
           $resac = db_query("insert into db_acount values($acount,2118,12198,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd55_i_prontuario'))."','$this->sd55_i_prontuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd55_i_cid"]))
           $resac = db_query("insert into db_acount values($acount,2118,12199,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd55_i_cid'))."','$this->sd55_i_cid',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd55_b_principal"]))
           $resac = db_query("insert into db_acount values($acount,2118,12216,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd55_b_principal'))."','$this->sd55_b_principal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($sd55_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2118,12197,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd55_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2118,12198,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd55_i_prontuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2118,12199,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd55_i_cid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2118,12216,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd55_b_principal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
