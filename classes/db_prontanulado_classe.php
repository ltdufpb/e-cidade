...
class cl_prontanulado { 
   ...
   public $sd57_i_codigo = 0; 
   public $sd57_i_prontuario = 0; 
   public $sd57_d_data_dia = null; 
   public $sd57_d_data_mes = null; 
   public $sd57_d_data_ano = null; 
   public $sd57_d_data = null; 
   public $sd57_c_hora = null; 
   public $sd57_i_login = 0; 
   public $sd57_t_obs = null; 
   ...
   function incluir ($sd57_i_codigo){ 
     ...
     if($sd57_i_codigo == "" || $sd57_i_codigo == null ){
       ...
       $this->sd57_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from prontanulado_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $sd57_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2128,12240,'','".AddSlashes(pg_fetch_result($resaco,0,'sd57_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2128,12241,'','".AddSlashes(pg_fetch_result($resaco,0,'sd57_i_prontuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2128,12242,'','".AddSlashes(pg_fetch_result($resaco,0,'sd57_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2128,12243,'','".AddSlashes(pg_fetch_result($resaco,0,'sd57_c_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2128,12244,'','".AddSlashes(pg_fetch_result($resaco,0,'sd57_i_login'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2128,12245,'','".AddSlashes(pg_fetch_result($resaco,0,'sd57_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd57_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd57_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd57_i_codigo"])){ 
       $sql  .= $virgula." sd57_i_codigo = $this->sd57_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->sd57_i_codigo) == null ){ 
     ...
     if(trim((string) $this->sd57_i_prontuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd57_i_prontuario"])){ 
       $sql  .= $virgula." sd57_i_prontuario = $this->sd57_i_prontuario ";
       $virgula = ",";
       if(trim((string) $this->sd57_i_prontuario) == null ){ 
         $this->erro_sql = " Campo Prontuário nao Informado.";
         $this->erro_campo = "sd57_i_prontuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd57_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd57_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["sd57_d_data_dia"] !="") ){ 
       $sql  .= $virgula." sd57_d_data = '$this->sd57_d_data' ";
       $virgula = ",";
       if(trim((string) $this->sd57_d_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "sd57_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd57_c_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd57_c_hora"])){ 
       $sql  .= $virgula." sd57_c_hora = '$this->sd57_c_hora' ";
       $virgula = ",";
       if(trim((string) $this->sd57_c_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "sd57_c_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd57_i_login)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd57_i_login"])){ 
       $sql  .= $virgula." sd57_i_login = $this->sd57_i_login ";
       $virgula = ",";
       if(trim((string) $this->sd57_i_login) == null ){ 
         $this->erro_sql = " Campo Login nao Informado.";
         $this->erro_campo = "sd57_i_login";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd57_t_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd57_t_obs"])){ 
       $sql  .= $virgula." sd57_t_obs = '$this->sd57_t_obs' ";
       $virgula = ",";
       if(trim((string) $this->sd57_t_obs) == null ){ 
         $this->erro_sql = " Campo Observação nao Informado.";
         $this->erro_campo = "sd57_t_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd57_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2128,12240,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd57_i_codigo'))."','$this->sd57_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd57_i_prontuario"]))
           $resac = db_query("insert into db_acount values($acount,2128,12241,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd57_i_prontuario'))."','$this->sd57_i_prontuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd57_d_data"]))
           $resac = db_query("insert into db_acount values($acount,2128,12242,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd57_d_data'))."','$this->sd57_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd57_c_hora"]))
           $resac = db_query("insert into db_acount values($acount,2128,12243,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd57_c_hora'))."','$this->sd57_c_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd57_i_login"]))
           $resac = db_query("insert into db_acount values($acount,2128,12244,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd57_i_login'))."','$this->sd57_i_login',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd57_t_obs"]))
           $resac = db_query("insert into db_acount values($acount,2128,12245,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd57_t_obs'))."','$this->sd57_t_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd57_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2128,12240,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd57_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2128,12241,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd57_i_prontuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2128,12242,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd57_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2128,12243,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd57_c_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2128,12244,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd57_i_login'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2128,12245,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd57_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
