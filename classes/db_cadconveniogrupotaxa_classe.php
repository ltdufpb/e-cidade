...
class cl_cadconveniogrupotaxa { 
   ...
   public $ar39_sequencial = 0; 
   public $ar39_cadconvenio = 0; 
   public $ar39_grupotaxa = 0; 
   ...
   function incluir ($ar39_sequencial){ 
     ...
     if($ar39_sequencial == "" || $ar39_sequencial == null ){
       ...
       $this->ar39_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cadconveniogrupotaxa_ar39_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ar39_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3224,18227,'','".AddSlashes(pg_fetch_result($resaco,0,'ar39_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3224,18228,'','".AddSlashes(pg_fetch_result($resaco,0,'ar39_cadconvenio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3224,18229,'','".AddSlashes(pg_fetch_result($resaco,0,'ar39_grupotaxa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ar39_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ar39_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar39_sequencial"])){ 
       $sql  .= $virgula." ar39_sequencial = $this->ar39_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ar39_sequencial) == null ){ 
     ...
     if(trim((string) $this->ar39_cadconvenio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar39_cadconvenio"])){ 
       $sql  .= $virgula." ar39_cadconvenio = $this->ar39_cadconvenio ";
       $virgula = ",";
       if(trim((string) $this->ar39_cadconvenio) == null ){ 
         $this->erro_sql = " Campo Convenio nao Informado.";
         $this->erro_campo = "ar39_cadconvenio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ar39_grupotaxa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar39_grupotaxa"])){ 
       $sql  .= $virgula." ar39_grupotaxa = $this->ar39_grupotaxa ";
       $virgula = ",";
       if(trim((string) $this->ar39_grupotaxa) == null ){ 
         $this->erro_sql = " Campo Grupo Taxa nao Informado.";
         $this->erro_campo = "ar39_grupotaxa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar39_sequencial"]) || $this->ar39_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3224,18227,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar39_sequencial'))."','$this->ar39_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar39_cadconvenio"]) || $this->ar39_cadconvenio != "")
           $resac = db_query("insert into db_acount values($acount,3224,18228,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar39_cadconvenio'))."','$this->ar39_cadconvenio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar39_grupotaxa"]) || $this->ar39_grupotaxa != "")
           $resac = db_query("insert into db_acount values($acount,3224,18229,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar39_grupotaxa'))."','$this->ar39_grupotaxa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ar39_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3224,18227,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar39_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3224,18228,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar39_cadconvenio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3224,18229,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar39_grupotaxa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
