...
class cl_issplanitinscr { 
   ...
   public $q31_sequencial = 0; 
   public $q31_issplanit = 0; 
   public $q31_inscr = 0; 
   ...
   function incluir ($q31_sequencial){ 
     ...
     if($q31_sequencial == "" || $q31_sequencial == null ){
       ...
       $this->q31_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from issplanitinscr_q31_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q31_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1573,9196,'','".AddSlashes(pg_fetch_result($resaco,0,'q31_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1573,9197,'','".AddSlashes(pg_fetch_result($resaco,0,'q31_issplanit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1573,9198,'','".AddSlashes(pg_fetch_result($resaco,0,'q31_inscr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q31_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q31_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q31_sequencial"])){ 
       $sql  .= $virgula." q31_sequencial = $this->q31_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q31_sequencial) == null ){ 
     ...
     if(trim((string) $this->q31_issplanit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q31_issplanit"])){ 
       $sql  .= $virgula." q31_issplanit = $this->q31_issplanit ";
       $virgula = ",";
       if(trim((string) $this->q31_issplanit) == null ){ 
         $this->erro_sql = " Campo q31_issplanit nao Informado.";
         $this->erro_campo = "q31_issplanit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q31_inscr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q31_inscr"])){ 
       $sql  .= $virgula." q31_inscr = $this->q31_inscr ";
       $virgula = ",";
       if(trim((string) $this->q31_inscr) == null ){ 
         $this->erro_sql = " Campo q31_inscr nao Informado.";
         $this->erro_campo = "q31_inscr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q31_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1573,9196,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q31_sequencial'))."','$this->q31_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q31_issplanit"]))
           $resac = db_query("insert into db_acount values($acount,1573,9197,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q31_issplanit'))."','$this->q31_issplanit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q31_inscr"]))
           $resac = db_query("insert into db_acount values($acount,1573,9198,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q31_inscr'))."','$this->q31_inscr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q31_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1573,9196,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q31_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1573,9197,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q31_issplanit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1573,9198,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q31_inscr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
