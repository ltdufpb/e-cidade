...
class cl_custoplanilhamatordemitem { 
   ...
   public $cc20_sequencial = 0; 
   public $cc20_custoplanilhaapuracao = 0; 
   public $cc20_matordemitemcustocriterio = 0; 
   ...
   function incluir ($cc20_sequencial){ 
     ...
     if($cc20_sequencial == "" || $cc20_sequencial == null ){
       ...
       $this->cc20_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from custoplanilhamatordemitem_cc20_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $cc20_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2665,15139,'','".AddSlashes(pg_fetch_result($resaco,0,'cc20_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2665,15140,'','".AddSlashes(pg_fetch_result($resaco,0,'cc20_custoplanilhaapuracao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2665,15141,'','".AddSlashes(pg_fetch_result($resaco,0,'cc20_matordemitemcustocriterio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($cc20_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->cc20_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc20_sequencial"])){ 
       $sql  .= $virgula." cc20_sequencial = $this->cc20_sequencial ";
       $virgula = ",";
       if(trim((string) $this->cc20_sequencial) == null ){ 
     ...
     if(trim((string) $this->cc20_custoplanilhaapuracao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc20_custoplanilhaapuracao"])){ 
       $sql  .= $virgula." cc20_custoplanilhaapuracao = $this->cc20_custoplanilhaapuracao ";
       $virgula = ",";
       if(trim((string) $this->cc20_custoplanilhaapuracao) == null ){ 
         $this->erro_sql = " Campo Custo Planilha Apuração nao Informado.";
         $this->erro_campo = "cc20_custoplanilhaapuracao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cc20_matordemitemcustocriterio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc20_matordemitemcustocriterio"])){ 
       $sql  .= $virgula." cc20_matordemitemcustocriterio = $this->cc20_matordemitemcustocriterio ";
       $virgula = ",";
       if(trim((string) $this->cc20_matordemitemcustocriterio) == null ){ 
         $this->erro_sql = " Campo Mat. Ordem item Custo Criterio nao Informado.";
         $this->erro_campo = "cc20_matordemitemcustocriterio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc20_sequencial"]) || $this->cc20_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2665,15139,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc20_sequencial'))."','$this->cc20_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc20_custoplanilhaapuracao"]) || $this->cc20_custoplanilhaapuracao != "")
           $resac = db_query("insert into db_acount values($acount,2665,15140,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc20_custoplanilhaapuracao'))."','$this->cc20_custoplanilhaapuracao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc20_matordemitemcustocriterio"]) || $this->cc20_matordemitemcustocriterio != "")
           $resac = db_query("insert into db_acount values($acount,2665,15141,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc20_matordemitemcustocriterio'))."','$this->cc20_matordemitemcustocriterio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($cc20_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2665,15139,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc20_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2665,15140,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc20_custoplanilhaapuracao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2665,15141,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc20_matordemitemcustocriterio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
