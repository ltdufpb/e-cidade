...
class cl_rharquivossiprev { 
   ...
   public $rh94_sequencial = 0; 
   public $rh94_descricao = null; 
   public $rh94_nomeclasse = null; 
   ...
   function incluir ($rh94_sequencial){ 
     ...
     if($rh94_sequencial == "" || $rh94_sequencial == null ){
       ...
       $this->rh94_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rharquivossiprev_rh94_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh94_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3135,17755,'','".AddSlashes(pg_fetch_result($resaco,0,'rh94_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3135,17756,'','".AddSlashes(pg_fetch_result($resaco,0,'rh94_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3135,17757,'','".AddSlashes(pg_fetch_result($resaco,0,'rh94_nomeclasse'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh94_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh94_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh94_sequencial"])){ 
       $sql  .= $virgula." rh94_sequencial = $this->rh94_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh94_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh94_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh94_descricao"])){ 
       $sql  .= $virgula." rh94_descricao = '$this->rh94_descricao' ";
       $virgula = ",";
       if(trim((string) $this->rh94_descricao) == null ){ 
         $this->erro_sql = " Campo Nome do Arquivo nao Informado.";
         $this->erro_campo = "rh94_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh94_nomeclasse)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh94_nomeclasse"])){ 
       $sql  .= $virgula." rh94_nomeclasse = '$this->rh94_nomeclasse' ";
       $virgula = ",";
       if(trim((string) $this->rh94_nomeclasse) == null ){ 
         $this->erro_sql = " Campo Nome da classe a ser utitilizada nao Informado.";
         $this->erro_campo = "rh94_nomeclasse";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh94_sequencial"]) || $this->rh94_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3135,17755,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh94_sequencial'))."','$this->rh94_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh94_descricao"]) || $this->rh94_descricao != "")
           $resac = db_query("insert into db_acount values($acount,3135,17756,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh94_descricao'))."','$this->rh94_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh94_nomeclasse"]) || $this->rh94_nomeclasse != "")
           $resac = db_query("insert into db_acount values($acount,3135,17757,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh94_nomeclasse'))."','$this->rh94_nomeclasse',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh94_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3135,17755,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh94_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3135,17756,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh94_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3135,17757,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh94_nomeclasse'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
