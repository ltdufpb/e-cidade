...
class cl_rhestagioavaliacaoobs { 
   ...
   public $h61_sequencial = 0; 
   public $h61_rhestagioavaliacao = 0; 
   public $h61_tipo = 0; 
   public $h61_observacoes = null; 
   public $h61_recomendacoes = null; 
   ...
   function incluir ($h61_sequencial){ 
     ...
     if($h61_sequencial == "" || $h61_sequencial == null ){
       ...
       $this->h61_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhestagioavaliacaoobs_h61_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h61_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1880,10896,'','".AddSlashes(pg_fetch_result($resaco,0,'h61_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1880,10897,'','".AddSlashes(pg_fetch_result($resaco,0,'h61_rhestagioavaliacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1880,10898,'','".AddSlashes(pg_fetch_result($resaco,0,'h61_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1880,10899,'','".AddSlashes(pg_fetch_result($resaco,0,'h61_observacoes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1880,10900,'','".AddSlashes(pg_fetch_result($resaco,0,'h61_recomendacoes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h61_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h61_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h61_sequencial"])){ 
       $sql  .= $virgula." h61_sequencial = $this->h61_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h61_sequencial) == null ){ 
     ...
     if(trim((string) $this->h61_rhestagioavaliacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h61_rhestagioavaliacao"])){ 
       $sql  .= $virgula." h61_rhestagioavaliacao = $this->h61_rhestagioavaliacao ";
       $virgula = ",";
       if(trim((string) $this->h61_rhestagioavaliacao) == null ){ 
         $this->erro_sql = " Campo Cód. Avaliação nao Informado.";
         $this->erro_campo = "h61_rhestagioavaliacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h61_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h61_tipo"])){ 
       $sql  .= $virgula." h61_tipo = $this->h61_tipo ";
       $virgula = ",";
       if(trim((string) $this->h61_tipo) == null ){ 
         $this->erro_sql = " Campo Tipo nao Informado.";
         $this->erro_campo = "h61_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h61_observacoes)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h61_observacoes"])){ 
       $sql  .= $virgula." h61_observacoes = '$this->h61_observacoes' ";
       $virgula = ",";
     }
     if(trim((string) $this->h61_recomendacoes)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h61_recomendacoes"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h61_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1880,10896,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h61_sequencial'))."','$this->h61_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h61_rhestagioavaliacao"]))
           $resac = db_query("insert into db_acount values($acount,1880,10897,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h61_rhestagioavaliacao'))."','$this->h61_rhestagioavaliacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h61_tipo"]))
           $resac = db_query("insert into db_acount values($acount,1880,10898,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h61_tipo'))."','$this->h61_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h61_observacoes"]))
           $resac = db_query("insert into db_acount values($acount,1880,10899,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h61_observacoes'))."','$this->h61_observacoes',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h61_recomendacoes"]))
           $resac = db_query("insert into db_acount values($acount,1880,10900,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h61_recomendacoes'))."','$this->h61_recomendacoes',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h61_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1880,10896,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h61_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1880,10897,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h61_rhestagioavaliacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1880,10898,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h61_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1880,10899,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h61_observacoes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1880,10900,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h61_recomendacoes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
