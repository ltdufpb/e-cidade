...
class cl_acordomovimentacaocancela { 
   ...
   public $ac25_sequencial = 0; 
   public $ac25_acordomovimentacao = 0; 
   public $ac25_acordomovimentacaocancela = 0; 
   ...
   function incluir ($ac25_sequencial){ 
     ...
     if($ac25_sequencial == "" || $ac25_sequencial == null ){
       ...
       $this->ac25_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordomovimentacaocancela_ac25_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac25_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2914,16591,'','".AddSlashes(pg_fetch_result($resaco,0,'ac25_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2914,16592,'','".AddSlashes(pg_fetch_result($resaco,0,'ac25_acordomovimentacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2914,16593,'','".AddSlashes(pg_fetch_result($resaco,0,'ac25_acordomovimentacaocancela'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac25_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac25_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac25_sequencial"])){ 
       $sql  .= $virgula." ac25_sequencial = $this->ac25_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac25_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac25_acordomovimentacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac25_acordomovimentacao"])){ 
       $sql  .= $virgula." ac25_acordomovimentacao = $this->ac25_acordomovimentacao ";
       $virgula = ",";
       if(trim((string) $this->ac25_acordomovimentacao) == null ){ 
         $this->erro_sql = " Campo Movimento nao Informado.";
         $this->erro_campo = "ac25_acordomovimentacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac25_acordomovimentacaocancela)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac25_acordomovimentacaocancela"])){ 
       $sql  .= $virgula." ac25_acordomovimentacaocancela = $this->ac25_acordomovimentacaocancela ";
       $virgula = ",";
       if(trim((string) $this->ac25_acordomovimentacaocancela) == null ){ 
         $this->erro_sql = " Campo Movimento Cancelado nao Informado.";
         $this->erro_campo = "ac25_acordomovimentacaocancela";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac25_sequencial"]) || $this->ac25_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2914,16591,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac25_sequencial'))."','$this->ac25_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac25_acordomovimentacao"]) || $this->ac25_acordomovimentacao != "")
           $resac = db_query("insert into db_acount values($acount,2914,16592,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac25_acordomovimentacao'))."','$this->ac25_acordomovimentacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac25_acordomovimentacaocancela"]) || $this->ac25_acordomovimentacaocancela != "")
           $resac = db_query("insert into db_acount values($acount,2914,16593,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac25_acordomovimentacaocancela'))."','$this->ac25_acordomovimentacaocancela',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac25_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2914,16591,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac25_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2914,16592,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac25_acordomovimentacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2914,16593,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac25_acordomovimentacaocancela'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
