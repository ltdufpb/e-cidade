...
class cl_tarefaprojeto { 
   ...
   public $at41_tarefa = 0; 
   public $at41_projeto = 0; 
   ...
   function incluir ($at41_tarefa,$at41_projeto){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1366,8099,'','".AddSlashes(pg_fetch_result($resaco,0,'at41_tarefa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1366,8100,'','".AddSlashes(pg_fetch_result($resaco,0,'at41_projeto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at41_tarefa=null,$at41_projeto=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at41_tarefa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at41_tarefa"])){ 
       $sql  .= $virgula." at41_tarefa = $this->at41_tarefa ";
       $virgula = ",";
       if(trim((string) $this->at41_tarefa) == null ){ 
     ...
     if(trim((string) $this->at41_projeto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at41_projeto"])){ 
       $sql  .= $virgula." at41_projeto = $this->at41_projeto ";
       $virgula = ",";
       if(trim((string) $this->at41_projeto) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at41_tarefa"]))
           $resac = db_query("insert into db_acount values($acount,1366,8099,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at41_tarefa'))."','$this->at41_tarefa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at41_projeto"]))
           $resac = db_query("insert into db_acount values($acount,1366,8100,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at41_projeto'))."','$this->at41_projeto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at41_tarefa=null,$at41_projeto=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1366,8099,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at41_tarefa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1366,8100,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at41_projeto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
