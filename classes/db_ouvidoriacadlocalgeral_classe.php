...
class cl_ouvidoriacadlocalgeral { 
   ...
   public $ov28_sequencial = 0; 
   public $ov28_ouvidoriacadlocal = 0; 
   public $ov28_descricao = null; 
   ...
   function incluir ($ov28_sequencial){ 
     ...
     if($ov28_sequencial == "" || $ov28_sequencial == null ){
       ...
       $this->ov28_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from ouvidoriacadlocalgeral_ov28_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ov28_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2633,14978,'','".AddSlashes(pg_fetch_result($resaco,0,'ov28_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2633,14979,'','".AddSlashes(pg_fetch_result($resaco,0,'ov28_ouvidoriacadlocal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2633,14980,'','".AddSlashes(pg_fetch_result($resaco,0,'ov28_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ov28_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ov28_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov28_sequencial"])){ 
       $sql  .= $virgula." ov28_sequencial = $this->ov28_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ov28_sequencial) == null ){ 
     ...
     if(trim((string) $this->ov28_ouvidoriacadlocal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov28_ouvidoriacadlocal"])){ 
       $sql  .= $virgula." ov28_ouvidoriacadlocal = $this->ov28_ouvidoriacadlocal ";
       $virgula = ",";
       if(trim((string) $this->ov28_ouvidoriacadlocal) == null ){ 
         $this->erro_sql = " Campo Local nao Informado.";
         $this->erro_campo = "ov28_ouvidoriacadlocal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ov28_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov28_descricao"])){ 
       $sql  .= $virgula." ov28_descricao = '$this->ov28_descricao' ";
       $virgula = ",";
       if(trim((string) $this->ov28_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "ov28_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov28_sequencial"]) || $this->ov28_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2633,14978,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov28_sequencial'))."','$this->ov28_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov28_ouvidoriacadlocal"]) || $this->ov28_ouvidoriacadlocal != "")
           $resac = db_query("insert into db_acount values($acount,2633,14979,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov28_ouvidoriacadlocal'))."','$this->ov28_ouvidoriacadlocal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov28_descricao"]) || $this->ov28_descricao != "")
           $resac = db_query("insert into db_acount values($acount,2633,14980,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov28_descricao'))."','$this->ov28_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ov28_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2633,14978,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov28_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2633,14979,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov28_ouvidoriacadlocal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2633,14980,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov28_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
