...
class cl_diretores { 
   ...
   public $ed15_i_codigo = 0; 
   public $ed15_i_escolas = 0; 
   public $ed15_c_categoria = null; 
   public $ed15_d_inicio_dia = null; 
   public $ed15_d_inicio_mes = null; 
   public $ed15_d_inicio_ano = null; 
   public $ed15_d_inicio = null; 
   public $ed15_d_termino_dia = null; 
   public $ed15_d_termino_mes = null; 
   public $ed15_d_termino_ano = null; 
   public $ed15_d_termino = null; 
   ...
   function incluir ($ed15_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1006002,1006018,'','".AddSlashes(pg_fetch_result($resaco,0,'ed15_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1006002,1006058,'','".AddSlashes(pg_fetch_result($resaco,0,'ed15_i_escolas'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1006002,1006019,'','".AddSlashes(pg_fetch_result($resaco,0,'ed15_c_categoria'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1006002,1006020,'','".AddSlashes(pg_fetch_result($resaco,0,'ed15_d_inicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1006002,1006021,'','".AddSlashes(pg_fetch_result($resaco,0,'ed15_d_termino'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed15_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed15_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed15_i_codigo"])){ 
       $sql  .= $virgula." ed15_i_codigo = $this->ed15_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed15_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed15_i_escolas)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed15_i_escolas"])){ 
       $sql  .= $virgula." ed15_i_escolas = $this->ed15_i_escolas ";
       $virgula = ",";
       if(trim((string) $this->ed15_i_escolas) == null ){ 
         $this->erro_sql = " Campo CGM da Escola nao Informado.";
         $this->erro_campo = "ed15_i_escolas";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed15_c_categoria)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed15_c_categoria"])){ 
       $sql  .= $virgula." ed15_c_categoria = '$this->ed15_c_categoria' ";
       $virgula = ",";
       if(trim((string) $this->ed15_c_categoria) == null ){ 
         $this->erro_sql = " Campo Categoria nao Informado.";
         $this->erro_campo = "ed15_c_categoria";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed15_d_inicio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed15_d_inicio_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed15_d_inicio_dia"] !="") ){ 
       $sql  .= $virgula." ed15_d_inicio = '$this->ed15_d_inicio' ";
       $virgula = ",";
       if(trim((string) $this->ed15_d_inicio) == null ){ 
         $this->erro_sql = " Campo Início nao Informado.";
         $this->erro_campo = "ed15_d_inicio_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed15_d_termino)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed15_d_termino_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed15_d_termino_dia"] !="") ){ 
       $sql  .= $virgula." ed15_d_termino = '$this->ed15_d_termino' ";
       $virgula = ",";
       if(trim((string) $this->ed15_d_termino) == null ){ 
         $this->erro_sql = " Campo Término nao Informado.";
         $this->erro_campo = "ed15_d_termino_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed15_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1006002,1006018,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed15_i_codigo'))."','$this->ed15_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed15_i_escolas"]))
           $resac = db_query("insert into db_acount values($acount,1006002,1006058,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed15_i_escolas'))."','$this->ed15_i_escolas',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed15_c_categoria"]))
           $resac = db_query("insert into db_acount values($acount,1006002,1006019,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed15_c_categoria'))."','$this->ed15_c_categoria',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed15_d_inicio"]))
           $resac = db_query("insert into db_acount values($acount,1006002,1006020,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed15_d_inicio'))."','$this->ed15_d_inicio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed15_d_termino"]))
           $resac = db_query("insert into db_acount values($acount,1006002,1006021,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed15_d_termino'))."','$this->ed15_d_termino',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed15_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1006002,1006018,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed15_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1006002,1006058,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed15_i_escolas'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1006002,1006019,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed15_c_categoria'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1006002,1006020,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed15_d_inicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1006002,1006021,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed15_d_termino'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
