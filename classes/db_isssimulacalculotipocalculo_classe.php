...
class cl_isssimulacalculotipocalculo { 
   ...
   public $q132_sequencial = 0; 
   public $q132_isssimulacalculo = 0; 
   public $q132_tipcalc = 0; 
   public $q132_parcela = 0; 
   public $q132_vencimento_dia = null; 
   public $q132_vencimento_mes = null; 
   public $q132_vencimento_ano = null; 
   public $q132_vencimento = null; 
   public $q132_valor = 0; 
   ...
   function incluir ($q132_sequencial){ 
     ...
     if($q132_sequencial == "" || $q132_sequencial == null ){
       ...
       $this->q132_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from isssimulacalculotipocalculo_q132_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q132_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3332,18789,'','".AddSlashes(pg_fetch_result($resaco,0,'q132_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3332,18790,'','".AddSlashes(pg_fetch_result($resaco,0,'q132_isssimulacalculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3332,18791,'','".AddSlashes(pg_fetch_result($resaco,0,'q132_tipcalc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3332,18792,'','".AddSlashes(pg_fetch_result($resaco,0,'q132_parcela'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3332,18793,'','".AddSlashes(pg_fetch_result($resaco,0,'q132_vencimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3332,18794,'','".AddSlashes(pg_fetch_result($resaco,0,'q132_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q132_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q132_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q132_sequencial"])){ 
       $sql  .= $virgula." q132_sequencial = $this->q132_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q132_sequencial) == null ){ 
     ...
     if(trim((string) $this->q132_isssimulacalculo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q132_isssimulacalculo"])){ 
       $sql  .= $virgula." q132_isssimulacalculo = $this->q132_isssimulacalculo ";
       $virgula = ",";
       if(trim((string) $this->q132_isssimulacalculo) == null ){ 
         $this->erro_sql = " Campo Simulação nao Informado.";
         $this->erro_campo = "q132_isssimulacalculo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q132_tipcalc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q132_tipcalc"])){ 
       $sql  .= $virgula." q132_tipcalc = $this->q132_tipcalc ";
       $virgula = ",";
       if(trim((string) $this->q132_tipcalc) == null ){ 
         $this->erro_sql = " Campo Tipo de Calculo nao Informado.";
         $this->erro_campo = "q132_tipcalc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q132_parcela)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q132_parcela"])){ 
       $sql  .= $virgula." q132_parcela = $this->q132_parcela ";
       $virgula = ",";
       if(trim((string) $this->q132_parcela) == null ){ 
         $this->erro_sql = " Campo Parcela nao Informado.";
         $this->erro_campo = "q132_parcela";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q132_vencimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q132_vencimento_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["q132_vencimento_dia"] !="") ){ 
       $sql  .= $virgula." q132_vencimento = '$this->q132_vencimento' ";
       $virgula = ",";
       if(trim((string) $this->q132_vencimento) == null ){ 
         $this->erro_sql = " Campo Vencimento nao Informado.";
         $this->erro_campo = "q132_vencimento_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q132_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q132_valor"])){ 
       $sql  .= $virgula." q132_valor = $this->q132_valor ";
       $virgula = ",";
       if(trim((string) $this->q132_valor) == null ){ 
         $this->erro_sql = " Campo Valor nao Informado.";
         $this->erro_campo = "q132_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q132_sequencial"]) || $this->q132_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3332,18789,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q132_sequencial'))."','$this->q132_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q132_isssimulacalculo"]) || $this->q132_isssimulacalculo != "")
           $resac = db_query("insert into db_acount values($acount,3332,18790,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q132_isssimulacalculo'))."','$this->q132_isssimulacalculo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q132_tipcalc"]) || $this->q132_tipcalc != "")
           $resac = db_query("insert into db_acount values($acount,3332,18791,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q132_tipcalc'))."','$this->q132_tipcalc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q132_parcela"]) || $this->q132_parcela != "")
           $resac = db_query("insert into db_acount values($acount,3332,18792,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q132_parcela'))."','$this->q132_parcela',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q132_vencimento"]) || $this->q132_vencimento != "")
           $resac = db_query("insert into db_acount values($acount,3332,18793,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q132_vencimento'))."','$this->q132_vencimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q132_valor"]) || $this->q132_valor != "")
           $resac = db_query("insert into db_acount values($acount,3332,18794,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q132_valor'))."','$this->q132_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q132_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3332,18789,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q132_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3332,18790,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q132_isssimulacalculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3332,18791,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q132_tipcalc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3332,18792,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q132_parcela'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3332,18793,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q132_vencimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3332,18794,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q132_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
