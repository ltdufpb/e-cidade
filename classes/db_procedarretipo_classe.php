...
class cl_procedarretipo { 
   ...
   public $v06_sequencial = 0; 
   public $v06_proced = 0; 
   public $v06_arretipo = 0; 
   ...
   function incluir ($v06_sequencial){ 
     ...
     if($v06_sequencial == "" || $v06_sequencial == null ){
       ...
       $this->v06_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from procedarretipo_v06_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $v06_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2021,11734,'','".AddSlashes(pg_fetch_result($resaco,0,'v06_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2021,11735,'','".AddSlashes(pg_fetch_result($resaco,0,'v06_proced'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2021,11736,'','".AddSlashes(pg_fetch_result($resaco,0,'v06_arretipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($v06_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->v06_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v06_sequencial"])){ 
       $sql  .= $virgula." v06_sequencial = $this->v06_sequencial ";
       $virgula = ",";
       if(trim((string) $this->v06_sequencial) == null ){ 
     ...
     if(trim((string) $this->v06_proced)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v06_proced"])){ 
       $sql  .= $virgula." v06_proced = $this->v06_proced ";
       $virgula = ",";
       if(trim((string) $this->v06_proced) == null ){ 
         $this->erro_sql = " Campo Proced nao Informado.";
         $this->erro_campo = "v06_proced";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->v06_arretipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v06_arretipo"])){ 
       $sql  .= $virgula." v06_arretipo = $this->v06_arretipo ";
       $virgula = ",";
       if(trim((string) $this->v06_arretipo) == null ){ 
         $this->erro_sql = " Campo Arretipo nao Informado.";
         $this->erro_campo = "v06_arretipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v06_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2021,11734,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v06_sequencial'))."','$this->v06_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v06_proced"]))
           $resac = db_query("insert into db_acount values($acount,2021,11735,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v06_proced'))."','$this->v06_proced',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v06_arretipo"]))
           $resac = db_query("insert into db_acount values($acount,2021,11736,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v06_arretipo'))."','$this->v06_arretipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($v06_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2021,11734,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v06_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2021,11735,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v06_proced'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2021,11736,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v06_arretipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
