...
class cl_rechumanomovimentacao { 
   ...
   public $ed118_sequencial = 0; 
   public $ed118_escola = 0; 
   public $ed118_rechumano = 0; 
   public $ed118_usuario = 0; 
   public $ed118_data_dia = null; 
   public $ed118_data_mes = null; 
   public $ed118_data_ano = null; 
   public $ed118_data = null; 
   public $ed118_hora = null; 
   public $ed118_resumo = null; 
   ...
   function incluir ($ed118_sequencial){ 
     ...
     if($ed118_sequencial == "" || $ed118_sequencial == null ){
       ...
       $this->ed118_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rechumanomovimentacao_ed118_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed118_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3699,20560,'','".AddSlashes(pg_fetch_result($resaco,0,'ed118_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3699,20561,'','".AddSlashes(pg_fetch_result($resaco,0,'ed118_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3699,20562,'','".AddSlashes(pg_fetch_result($resaco,0,'ed118_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3699,20563,'','".AddSlashes(pg_fetch_result($resaco,0,'ed118_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3699,20564,'','".AddSlashes(pg_fetch_result($resaco,0,'ed118_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3699,20565,'','".AddSlashes(pg_fetch_result($resaco,0,'ed118_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3699,20566,'','".AddSlashes(pg_fetch_result($resaco,0,'ed118_resumo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($ed118_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed118_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed118_sequencial"])){ 
       $sql  .= $virgula." ed118_sequencial = $this->ed118_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed118_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed118_escola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed118_escola"])){ 
       $sql  .= $virgula." ed118_escola = $this->ed118_escola ";
       $virgula = ",";
       if(trim((string) $this->ed118_escola) == null ){ 
         $this->erro_sql = " Campo Escola não informado.";
         $this->erro_campo = "ed118_escola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed118_rechumano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed118_rechumano"])){ 
       $sql  .= $virgula." ed118_rechumano = $this->ed118_rechumano ";
       $virgula = ",";
       if(trim((string) $this->ed118_rechumano) == null ){ 
         $this->erro_sql = " Campo Rec. Humano não informado.";
         $this->erro_campo = "ed118_rechumano";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed118_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed118_usuario"])){ 
       $sql  .= $virgula." ed118_usuario = $this->ed118_usuario ";
       $virgula = ",";
       if(trim((string) $this->ed118_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário não informado.";
         $this->erro_campo = "ed118_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed118_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed118_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed118_data_dia"] !="") ){ 
       $sql  .= $virgula." ed118_data = '$this->ed118_data' ";
       $virgula = ",";
       if(trim((string) $this->ed118_data) == null ){ 
         $this->erro_sql = " Campo Data não informado.";
         $this->erro_campo = "ed118_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed118_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed118_hora"])){ 
       $sql  .= $virgula." ed118_hora = '$this->ed118_hora' ";
       $virgula = ",";
       if(trim((string) $this->ed118_hora) == null ){ 
         $this->erro_sql = " Campo Hora não informado.";
         $this->erro_campo = "ed118_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed118_resumo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed118_resumo"])){ 
       $sql  .= $virgula." ed118_resumo = '$this->ed118_resumo' ";
       $virgula = ",";
       if(trim((string) $this->ed118_resumo) == null ){ 
         $this->erro_sql = " Campo Resumo não informado.";
         $this->erro_campo = "ed118_resumo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["ed118_sequencial"]) || $this->ed118_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3699,20560,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed118_sequencial'))."','$this->ed118_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ed118_escola"]) || $this->ed118_escola != "")
             $resac = db_query("insert into db_acount values($acount,3699,20561,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed118_escola'))."','$this->ed118_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ed118_rechumano"]) || $this->ed118_rechumano != "")
             $resac = db_query("insert into db_acount values($acount,3699,20562,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed118_rechumano'))."','$this->ed118_rechumano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ed118_usuario"]) || $this->ed118_usuario != "")
             $resac = db_query("insert into db_acount values($acount,3699,20563,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed118_usuario'))."','$this->ed118_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ed118_data"]) || $this->ed118_data != "")
             $resac = db_query("insert into db_acount values($acount,3699,20564,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed118_data'))."','$this->ed118_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ed118_hora"]) || $this->ed118_hora != "")
             $resac = db_query("insert into db_acount values($acount,3699,20565,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed118_hora'))."','$this->ed118_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ed118_resumo"]) || $this->ed118_resumo != "")
             $resac = db_query("insert into db_acount values($acount,3699,20566,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed118_resumo'))."','$this->ed118_resumo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3699,20560,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed118_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3699,20561,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed118_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3699,20562,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed118_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3699,20563,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed118_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3699,20564,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed118_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3699,20565,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed118_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3699,20566,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed118_resumo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
