...
class cl_fornrequ { 
   ...
   public $l10_n_requ = null; 
   public $l10_n_forn = 0; 
   public $l10_p_empe = null; 
   public $l10_n_auto = null; 
   public $l10_2_auto = null; 
   ...
   function alterar ( $oid=null ) { 
     ...
     $virgula = "";
     if(trim((string) $this->l10_n_requ)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l10_n_requ"])){ 
       $sql  .= $virgula." l10_n_requ = '$this->l10_n_requ' ";
       $virgula = ",";
       if(trim((string) $this->l10_n_requ) == null ){ 
         $this->erro_sql = " Campo Numero da Requisicao nao Informado.";
         $this->erro_campo = "l10_n_requ";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l10_n_forn)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l10_n_forn"])){ 
       $sql  .= $virgula." l10_n_forn = $this->l10_n_forn ";
       $virgula = ",";
       if(trim((string) $this->l10_n_forn) == null ){ 
         $this->erro_sql = " Campo Numcgm do Fornecedor nao Informado.";
         $this->erro_campo = "l10_n_forn";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l10_p_empe)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l10_p_empe"])){ 
       $sql  .= $virgula." l10_p_empe = '$this->l10_p_empe' ";
       $virgula = ",";
       if(trim((string) $this->l10_p_empe) == null ){ 
         $this->erro_sql = " Campo Para Empenho (s/n) nao Informado.";
         $this->erro_campo = "l10_p_empe";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l10_n_auto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l10_n_auto"])){ 
       $sql  .= $virgula." l10_n_auto = '$this->l10_n_auto' ";
       $virgula = ",";
       if(trim((string) $this->l10_n_auto) == null ){ 
         $this->erro_sql = " Campo Numero Autorizacao nao Informado.";
         $this->erro_campo = "l10_n_auto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l10_2_auto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l10_2_auto"])){ 
       $sql  .= $virgula." l10_2_auto = '$this->l10_2_auto' ";
       $virgula = ",";
       if(trim((string) $this->l10_2_auto) == null ){ 
         $this->erro_sql = " Campo Numero Autorizacao nao Informado.";
         $this->erro_campo = "l10_2_auto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
