...
class cl_liclicitemlote {
   ...
   public $l04_codigo = 0;
   public $l04_liclicitem = 0;
   public $l04_descricao = null;
   ...
   function incluir ($l04_codigo){
     ...
     if($l04_codigo == "" || $l04_codigo == null ){
       ...
       $this->l04_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from liclicitemlote_l04_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $l04_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1719,10012,'','".AddSlashes(pg_fetch_result($resaco,0,'l04_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1719,10013,'','".AddSlashes(pg_fetch_result($resaco,0,'l04_liclicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1719,10014,'','".AddSlashes(pg_fetch_result($resaco,0,'l04_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($l04_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->l04_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l04_codigo"])){
       $sql  .= $virgula." l04_codigo = $this->l04_codigo ";
       $virgula = ",";
       if(trim((string) $this->l04_codigo) == null ){
     ...
     if(trim((string) $this->l04_liclicitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l04_liclicitem"])){
       $sql  .= $virgula." l04_liclicitem = $this->l04_liclicitem ";
       $virgula = ",";
       if(trim((string) $this->l04_liclicitem) == null ){
         $this->erro_sql = " Campo Item nao Informado.";
         $this->erro_campo = "l04_liclicitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l04_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l04_descricao"])){
       $sql  .= $virgula." l04_descricao = '$this->l04_descricao' ";
       $virgula = ",";
       if(trim((string) $this->l04_descricao) == null ){
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "l04_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["l04_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1719,10012,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l04_codigo'))."','$this->l04_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l04_liclicitem"]))
           $resac = db_query("insert into db_acount values($acount,1719,10013,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l04_liclicitem'))."','$this->l04_liclicitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l04_descricao"]))
           $resac = db_query("insert into db_acount values($acount,1719,10014,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l04_descricao'))."','$this->l04_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($l04_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1719,10012,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l04_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1719,10013,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l04_liclicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1719,10014,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l04_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
