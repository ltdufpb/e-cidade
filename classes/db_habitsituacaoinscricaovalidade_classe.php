...
class cl_habitsituacaoinscricaovalidade { 
   ...
   public $ht14_sequencial = 0; 
   public $ht14_habitsituacaoinscricao = 0; 
   public $ht14_datainicial_dia = null; 
   public $ht14_datainicial_mes = null; 
   public $ht14_datainicial_ano = null; 
   public $ht14_datainicial = null; 
   public $ht14_datafinal_dia = null; 
   public $ht14_datafinal_mes = null; 
   public $ht14_datafinal_ano = null; 
   public $ht14_datafinal = null; 
   ...
   function incluir ($ht14_sequencial){ 
     ...
     if($ht14_sequencial == "" || $ht14_sequencial == null ){
       ...
       $this->ht14_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from habitsituacaoinscricaovalidade_ht14_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ht14_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3002,16999,'','".AddSlashes(pg_fetch_result($resaco,0,'ht14_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3002,17000,'','".AddSlashes(pg_fetch_result($resaco,0,'ht14_habitsituacaoinscricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3002,17001,'','".AddSlashes(pg_fetch_result($resaco,0,'ht14_datainicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3002,17002,'','".AddSlashes(pg_fetch_result($resaco,0,'ht14_datafinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ht14_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ht14_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht14_sequencial"])){ 
       $sql  .= $virgula." ht14_sequencial = $this->ht14_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ht14_sequencial) == null ){ 
     ...
     if(trim((string) $this->ht14_habitsituacaoinscricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht14_habitsituacaoinscricao"])){ 
       $sql  .= $virgula." ht14_habitsituacaoinscricao = $this->ht14_habitsituacaoinscricao ";
       $virgula = ",";
       if(trim((string) $this->ht14_habitsituacaoinscricao) == null ){ 
         $this->erro_sql = " Campo Situação da Inscrição nao Informado.";
         $this->erro_campo = "ht14_habitsituacaoinscricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ht14_datainicial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht14_datainicial_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ht14_datainicial_dia"] !="") ){ 
     ...
     if(trim((string) $this->ht14_datafinal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ht14_datafinal_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ht14_datafinal_dia"] !="") ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht14_sequencial"]) || $this->ht14_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3002,16999,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht14_sequencial'))."','$this->ht14_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht14_habitsituacaoinscricao"]) || $this->ht14_habitsituacaoinscricao != "")
           $resac = db_query("insert into db_acount values($acount,3002,17000,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht14_habitsituacaoinscricao'))."','$this->ht14_habitsituacaoinscricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht14_datainicial"]) || $this->ht14_datainicial != "")
           $resac = db_query("insert into db_acount values($acount,3002,17001,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht14_datainicial'))."','$this->ht14_datainicial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ht14_datafinal"]) || $this->ht14_datafinal != "")
           $resac = db_query("insert into db_acount values($acount,3002,17002,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ht14_datafinal'))."','$this->ht14_datafinal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ht14_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3002,16999,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht14_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3002,17000,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht14_habitsituacaoinscricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3002,17001,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht14_datainicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3002,17002,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ht14_datafinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
