...
class cl_cornumpdesconto { 
   ...
   function incluir ($k12_id,$k12_data,$k12_autent,$k12_numpre,$k12_numpar,$k12_receit){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3499,1139,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3499,1140,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3499,1141,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_autent'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3499,1146,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3499,1147,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_numpar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3499,1148,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_numtot'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3499,1149,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_numdig'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3499,1150,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_receit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3499,1144,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3499,2022,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_numnov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3499,19817,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_receitaprincipal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k12_id=null,$k12_data=null,$k12_autent=null,$k12_numpre=null,$k12_numpar=null,$k12_receit=null) { 
     ...
     if(trim((string) $this->k12_numpre)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k12_numpre"])){ 
       $sql  .= $virgula." k12_numpre = $this->k12_numpre ";
       $virgula = ",";
       if(trim((string) $this->k12_numpre) == null ){ 
     ...
     if(trim((string) $this->k12_numpar)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k12_numpar"])){ 
       $sql  .= $virgula." k12_numpar = $this->k12_numpar ";
       $virgula = ",";
       if(trim((string) $this->k12_numpar) == null ){ 
     ...
     if(trim((string) $this->k12_numtot)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k12_numtot"])){ 
       $sql  .= $virgula." k12_numtot = $this->k12_numtot ";
       $virgula = ",";
       if(trim((string) $this->k12_numtot) == null ){ 
         $this->erro_sql = " Campo Numero Total nao Informado.";
         $this->erro_campo = "k12_numtot";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k12_numdig)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k12_numdig"])){ 
       $sql  .= $virgula." k12_numdig = $this->k12_numdig ";
       $virgula = ",";
       if(trim((string) $this->k12_numdig) == null ){ 
         $this->erro_sql = " Campo Digito nao Informado.";
         $this->erro_campo = "k12_numdig";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k12_receit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k12_receit"])){ 
       $sql  .= $virgula." k12_receit = $this->k12_receit ";
       $virgula = ",";
       if(trim((string) $this->k12_receit) == null ){ 
     ...
     if(trim((string) $this->k12_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k12_valor"])){ 
       $sql  .= $virgula." k12_valor = $this->k12_valor ";
       $virgula = ",";
       if(trim((string) $this->k12_valor) == null ){ 
         $this->erro_sql = " Campo Valor Autenticação nao Informado.";
         $this->erro_campo = "k12_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k12_numnov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k12_numnov"])){ 
        if(trim((string) $this->k12_numnov)=="" && isset($GLOBALS["HTTP_POST_VARS"]["k12_numnov"])){ 
           $this->k12_numnov = "0" ; 
        } 
     ...
     if(trim((string) $this->k12_receitaprincipal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k12_receitaprincipal"])){ 
       $sql  .= $virgula." k12_receitaprincipal = $this->k12_receitaprincipal ";
       $virgula = ",";
       if(trim((string) $this->k12_receitaprincipal) == null ){ 
         $this->erro_sql = " Campo Receita principal do desconto nao Informado.";
         $this->erro_campo = "k12_receitaprincipal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_id"]) || $this->k12_id != "")
           $resac = db_query("insert into db_acount values($acount,3499,1139,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_id'))."','$this->k12_id',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_data"]) || $this->k12_data != "")
           $resac = db_query("insert into db_acount values($acount,3499,1140,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_data'))."','$this->k12_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_autent"]) || $this->k12_autent != "")
           $resac = db_query("insert into db_acount values($acount,3499,1141,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_autent'))."','$this->k12_autent',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_numpre"]) || $this->k12_numpre != "")
           $resac = db_query("insert into db_acount values($acount,3499,1146,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_numpre'))."','$this->k12_numpre',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_numpar"]) || $this->k12_numpar != "")
           $resac = db_query("insert into db_acount values($acount,3499,1147,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_numpar'))."','$this->k12_numpar',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_numtot"]) || $this->k12_numtot != "")
           $resac = db_query("insert into db_acount values($acount,3499,1148,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_numtot'))."','$this->k12_numtot',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_numdig"]) || $this->k12_numdig != "")
           $resac = db_query("insert into db_acount values($acount,3499,1149,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_numdig'))."','$this->k12_numdig',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_receit"]) || $this->k12_receit != "")
           $resac = db_query("insert into db_acount values($acount,3499,1150,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_receit'))."','$this->k12_receit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_valor"]) || $this->k12_valor != "")
           $resac = db_query("insert into db_acount values($acount,3499,1144,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_valor'))."','$this->k12_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_numnov"]) || $this->k12_numnov != "")
           $resac = db_query("insert into db_acount values($acount,3499,2022,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_numnov'))."','$this->k12_numnov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_receitaprincipal"]) || $this->k12_receitaprincipal != "")
           $resac = db_query("insert into db_acount values($acount,3499,19817,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_receitaprincipal'))."','$this->k12_receitaprincipal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k12_id=null,$k12_data=null,$k12_autent=null,$k12_numpre=null,$k12_numpar=null,$k12_receit=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3499,1139,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3499,1140,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3499,1141,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_autent'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3499,1146,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3499,1147,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_numpar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3499,1148,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_numtot'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3499,1149,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_numdig'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3499,1150,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_receit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3499,1144,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3499,2022,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_numnov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3499,19817,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_receitaprincipal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
