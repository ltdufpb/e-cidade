...
class cl_parecer {
   ...
   public $ed92_i_codigo = 0;
   public $ed92_c_descr = null;
   public $ed92_i_escola = 0;
   public $ed92_i_sequencial = 0;
   ...
   function incluir ($ed92_i_codigo){
     ...
     if($ed92_i_codigo == "" || $ed92_i_codigo == null ){
       ...
       $this->ed92_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from parecer_ed92_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed92_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010124,1008695,'','".AddSlashes(pg_fetch_result($resaco,0,'ed92_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010124,1008696,'','".AddSlashes(pg_fetch_result($resaco,0,'ed92_c_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010124,1009217,'','".AddSlashes(pg_fetch_result($resaco,0,'ed92_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010124,11825,'','".AddSlashes(pg_fetch_result($resaco,0,'ed92_i_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($ed92_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->ed92_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed92_i_codigo"])){
       $sql  .= $virgula." ed92_i_codigo = $this->ed92_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed92_i_codigo) == null ){
     ...
     if(trim((string) $this->ed92_c_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed92_c_descr"])){
       $sql  .= $virgula." ed92_c_descr = '$this->ed92_c_descr' ";
       $virgula = ",";
       if(trim((string) $this->ed92_c_descr) == null ){
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "ed92_c_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed92_i_escola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed92_i_escola"])){
       $sql  .= $virgula." ed92_i_escola = $this->ed92_i_escola ";
       $virgula = ",";
       if(trim((string) $this->ed92_i_escola) == null ){
         $this->erro_sql = " Campo Escola nao Informado.";
         $this->erro_campo = "ed92_i_escola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed92_i_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed92_i_sequencial"])){
        if(trim((string) $this->ed92_i_sequencial)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed92_i_sequencial"])){
           $this->ed92_i_sequencial = "0" ;
        }
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed92_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010124,1008695,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed92_i_codigo'))."','$this->ed92_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed92_c_descr"]))
           $resac = db_query("insert into db_acount values($acount,1010124,1008696,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed92_c_descr'))."','$this->ed92_c_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed92_i_escola"]))
           $resac = db_query("insert into db_acount values($acount,1010124,1009217,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed92_i_escola'))."','$this->ed92_i_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed92_i_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1010124,11825,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed92_i_sequencial'))."','$this->ed92_i_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($ed92_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010124,1008695,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed92_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010124,1008696,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed92_c_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010124,1009217,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed92_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010124,11825,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed92_i_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
