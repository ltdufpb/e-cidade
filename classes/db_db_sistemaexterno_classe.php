...
class cl_db_sistemaexterno {
   ...
   public $db124_sequencial = 0;
   public $db124_descricao = null;
   ...
   function incluir ($db124_sequencial){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3291,18596,'','".AddSlashes(pg_fetch_result($resaco,0,'db124_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3291,18597,'','".AddSlashes(pg_fetch_result($resaco,0,'db124_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($db124_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->db124_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db124_sequencial"])){
       $sql  .= $virgula." db124_sequencial = $this->db124_sequencial ";
       $virgula = ",";
       if(trim((string) $this->db124_sequencial) == null ){
     ...
     if(trim((string) $this->db124_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db124_descricao"])){
       $sql  .= $virgula." db124_descricao = '$this->db124_descricao' ";
       $virgula = ",";
       if(trim((string) $this->db124_descricao) == null ){
         $this->erro_sql = " Campo Sistema Externo nao Informado.";
         $this->erro_campo = "db124_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db124_sequencial"]) || $this->db124_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3291,18596,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db124_sequencial'))."','$this->db124_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db124_descricao"]) || $this->db124_descricao != "")
           $resac = db_query("insert into db_acount values($acount,3291,18597,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db124_descricao'))."','$this->db124_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($db124_sequencial=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3291,18596,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db124_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3291,18597,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db124_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
