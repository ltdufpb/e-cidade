...
class cl_solicitatipo { 
   ...
   function incluir ($pc12_numero){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1034,6334,'','".AddSlashes(pg_fetch_result($resaco,0,'pc12_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1034,5543,'','".AddSlashes(pg_fetch_result($resaco,0,'pc12_vlrap'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1034,5547,'','".AddSlashes(pg_fetch_result($resaco,0,'pc12_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc12_numero=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc12_numero)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc12_numero"])){ 
       $sql  .= $virgula." pc12_numero = $this->pc12_numero ";
       $virgula = ",";
       if(trim((string) $this->pc12_numero) == null ){ 
     ...
     if(trim((string) $this->pc12_vlrap)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc12_vlrap"])){ 
        if(trim((string) $this->pc12_vlrap)=="" && isset($GLOBALS["HTTP_POST_VARS"]["pc12_vlrap"])){ 
           $this->pc12_vlrap = "0" ; 
        } 
     ...
     if(trim((string) $this->pc12_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc12_tipo"])){ 
       $sql  .= $virgula." pc12_tipo = $this->pc12_tipo ";
       $virgula = ",";
       if(trim((string) $this->pc12_tipo) == null ){ 
         $this->erro_sql = " Campo tipo nao Informado.";
         $this->erro_campo = "pc12_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc12_numero"]))
           $resac = db_query("insert into db_acount values($acount,1034,6334,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc12_numero'))."','$this->pc12_numero',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc12_vlrap"]))
           $resac = db_query("insert into db_acount values($acount,1034,5543,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc12_vlrap'))."','$this->pc12_vlrap',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc12_tipo"]))
           $resac = db_query("insert into db_acount values($acount,1034,5547,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc12_tipo'))."','$this->pc12_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc12_numero=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1034,6334,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc12_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1034,5543,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc12_vlrap'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1034,5547,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc12_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
