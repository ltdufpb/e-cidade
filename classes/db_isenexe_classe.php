...
class cl_isenexe { 
   ...
   function incluir ($j47_codigo,$j47_anousu){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,39,196,'','".AddSlashes(pg_fetch_result($resaco,0,'j47_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,39,197,'','".AddSlashes(pg_fetch_result($resaco,0,'j47_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j47_codigo=null,$j47_anousu=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j47_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j47_codigo"])){ 
       $sql  .= $virgula." j47_codigo = $this->j47_codigo ";
       $virgula = ",";
       if(trim((string) $this->j47_codigo) == null ){ 
     ...
     if(trim((string) $this->j47_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j47_anousu"])){ 
       $sql  .= $virgula." j47_anousu = $this->j47_anousu ";
       $virgula = ",";
       if(trim((string) $this->j47_anousu) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j47_codigo"]))
           $resac = db_query("insert into db_acount values($acount,39,196,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j47_codigo'))."','$this->j47_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j47_anousu"]))
           $resac = db_query("insert into db_acount values($acount,39,197,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j47_anousu'))."','$this->j47_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j47_codigo=null,$j47_anousu=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,39,196,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j47_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,39,197,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j47_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
