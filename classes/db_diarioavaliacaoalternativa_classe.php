...
class cl_diarioavaliacaoalternativa { 
   ...
   public $ed136_sequencial = 0; 
   public $ed136_diario = 0; 
   public $ed136_procavalalternativa = 0; 
   ...
   function incluir ($ed136_sequencial){ 
     ...
     if($ed136_sequencial == "" || $ed136_sequencial == null ){
       ...
       $this->ed136_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from diarioavaliacaoalternativa_ed136_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed136_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3881,21607,'','".AddSlashes(pg_fetch_result($resaco,0,'ed136_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3881,21608,'','".AddSlashes(pg_fetch_result($resaco,0,'ed136_diario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3881,21609,'','".AddSlashes(pg_fetch_result($resaco,0,'ed136_procavalalternativa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($ed136_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed136_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed136_sequencial"])){ 
       $sql  .= $virgula." ed136_sequencial = $this->ed136_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed136_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed136_diario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed136_diario"])){ 
       $sql  .= $virgula." ed136_diario = $this->ed136_diario ";
       $virgula = ",";
       if(trim((string) $this->ed136_diario) == null ){ 
         $this->erro_sql = " Campo Diário não informado.";
         $this->erro_campo = "ed136_diario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed136_procavalalternativa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed136_procavalalternativa"])){ 
       $sql  .= $virgula." ed136_procavalalternativa = $this->ed136_procavalalternativa ";
       $virgula = ",";
       if(trim((string) $this->ed136_procavalalternativa) == null ){ 
         $this->erro_sql = " Campo Avaliação Alternativa não informado.";
         $this->erro_campo = "ed136_procavalalternativa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed136_sequencial"]) || $this->ed136_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3881,21607,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed136_sequencial'))."','$this->ed136_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed136_diario"]) || $this->ed136_diario != "")
             $resac = db_query("insert into db_acount values($acount,3881,21608,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed136_diario'))."','$this->ed136_diario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed136_procavalalternativa"]) || $this->ed136_procavalalternativa != "")
             $resac = db_query("insert into db_acount values($acount,3881,21609,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed136_procavalalternativa'))."','$this->ed136_procavalalternativa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3881,21607,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed136_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3881,21608,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed136_diario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3881,21609,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed136_procavalalternativa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
