...
class cl_vtfdias { 
   ...
   public $r63_mesusu = 0; 
   public $r63_regist = 0; 
   public $r63_vale = null; 
   public $r63_difere = 'f'; 
   public $r63_dia_dia = null; 
   public $r63_dia_mes = null; 
   public $r63_dia_ano = null; 
   public $r63_dia = null; 
   public $r63_quant = 0; 
   public $r63_obrig = 'f'; 
   public $r63_quants = 0; 
   ...
   function incluir ($r63_anousu,$r63_mesusu,$r63_regist,$r63_vale,$r63_difere,$r63_dia){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,599,4523,'','".AddSlashes(pg_fetch_result($resaco,0,'r63_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,599,4524,'','".AddSlashes(pg_fetch_result($resaco,0,'r63_mesusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,599,4525,'','".AddSlashes(pg_fetch_result($resaco,0,'r63_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,599,4526,'','".AddSlashes(pg_fetch_result($resaco,0,'r63_vale'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,599,4527,'','".AddSlashes(pg_fetch_result($resaco,0,'r63_difere'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,599,4528,'','".AddSlashes(pg_fetch_result($resaco,0,'r63_dia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,599,4529,'','".AddSlashes(pg_fetch_result($resaco,0,'r63_quant'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,599,4530,'','".AddSlashes(pg_fetch_result($resaco,0,'r63_obrig'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,599,4531,'','".AddSlashes(pg_fetch_result($resaco,0,'r63_quants'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($r63_anousu=null,$r63_mesusu=null,$r63_regist=null,$r63_vale=null,$r63_difere=null,$r63_dia=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->r63_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r63_anousu"])){ 
       $sql  .= $virgula." r63_anousu = $this->r63_anousu ";
       $virgula = ",";
       if(trim((string) $this->r63_anousu) == null ){ 
     ...
     if(trim((string) $this->r63_mesusu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r63_mesusu"])){ 
       $sql  .= $virgula." r63_mesusu = $this->r63_mesusu ";
       $virgula = ",";
       if(trim((string) $this->r63_mesusu) == null ){ 
     ...
     if(trim((string) $this->r63_regist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r63_regist"])){ 
       $sql  .= $virgula." r63_regist = $this->r63_regist ";
       $virgula = ",";
       if(trim((string) $this->r63_regist) == null ){ 
     ...
     if(trim((string) $this->r63_vale)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r63_vale"])){ 
       $sql  .= $virgula." r63_vale = '$this->r63_vale' ";
       $virgula = ",";
       if(trim((string) $this->r63_vale) == null ){ 
     ...
     if(trim((string) $this->r63_difere)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r63_difere"])){ 
       $sql  .= $virgula." r63_difere = '$this->r63_difere' ";
       $virgula = ",";
       if(trim((string) $this->r63_difere) == null ){ 
     ...
     if(trim((string) $this->r63_dia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r63_dia_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["r63_dia_dia"] !="") ){ 
       $sql  .= $virgula." r63_dia = '$this->r63_dia' ";
       $virgula = ",";
       if(trim((string) $this->r63_dia) == null ){ 
     ...
     if(trim((string) $this->r63_quant)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r63_quant"])){ 
       $sql  .= $virgula." r63_quant = $this->r63_quant ";
       $virgula = ",";
       if(trim((string) $this->r63_quant) == null ){ 
         $this->erro_sql = " Campo Qtda de vales do dia nao Informado.";
         $this->erro_campo = "r63_quant";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->r63_obrig)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r63_obrig"])){ 
       $sql  .= $virgula." r63_obrig = '$this->r63_obrig' ";
       $virgula = ",";
       if(trim((string) $this->r63_obrig) == null ){ 
         $this->erro_sql = " Campo informa se e obrigatorio nao Informado.";
         $this->erro_campo = "r63_obrig";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->r63_quants)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r63_quants"])){ 
       $sql  .= $virgula." r63_quants = $this->r63_quants ";
       $virgula = ",";
       if(trim((string) $this->r63_quants) == null ){ 
         $this->erro_sql = " Campo qtd vales vinda da semana nao Informado.";
         $this->erro_campo = "r63_quants";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["r63_anousu"]))
           $resac = db_query("insert into db_acount values($acount,599,4523,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r63_anousu'))."','$this->r63_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r63_mesusu"]))
           $resac = db_query("insert into db_acount values($acount,599,4524,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r63_mesusu'))."','$this->r63_mesusu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r63_regist"]))
           $resac = db_query("insert into db_acount values($acount,599,4525,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r63_regist'))."','$this->r63_regist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r63_vale"]))
           $resac = db_query("insert into db_acount values($acount,599,4526,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r63_vale'))."','$this->r63_vale',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r63_difere"]))
           $resac = db_query("insert into db_acount values($acount,599,4527,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r63_difere'))."','$this->r63_difere',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r63_dia"]))
           $resac = db_query("insert into db_acount values($acount,599,4528,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r63_dia'))."','$this->r63_dia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r63_quant"]))
           $resac = db_query("insert into db_acount values($acount,599,4529,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r63_quant'))."','$this->r63_quant',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r63_obrig"]))
           $resac = db_query("insert into db_acount values($acount,599,4530,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r63_obrig'))."','$this->r63_obrig',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r63_quants"]))
           $resac = db_query("insert into db_acount values($acount,599,4531,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r63_quants'))."','$this->r63_quants',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($r63_anousu=null,$r63_mesusu=null,$r63_regist=null,$r63_vale=null,$r63_difere=null,$r63_dia=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,599,4523,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r63_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,599,4524,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r63_mesusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,599,4525,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r63_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,599,4526,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r63_vale'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,599,4527,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r63_difere'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,599,4528,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r63_dia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,599,4529,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r63_quant'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,599,4530,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r63_obrig'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,599,4531,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r63_quants'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
