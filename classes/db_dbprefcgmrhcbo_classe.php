...
class cl_dbprefcgmrhcbo { 
   ...
   function incluir ($z01_sequencial){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1757,10200,'','".AddSlashes(pg_fetch_result($resaco,0,'z01_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1757,10227,'','".AddSlashes(pg_fetch_result($resaco,0,'z01_dbprefcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1757,10201,'','".AddSlashes(pg_fetch_result($resaco,0,'z01_hrcbo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($z01_sequencial=null) { 
     ...
     if(trim((string) $this->z01_hrcbo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["z01_hrcbo"])){ 
       $sql  .= $virgula." z01_hrcbo = $this->z01_hrcbo ";
       $virgula = ",";
       if(trim((string) $this->z01_hrcbo) == null ){ 
         $this->erro_sql = " Campo Código CBO nao Informado.";
         $this->erro_campo = "z01_hrcbo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["z01_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1757,10200,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'z01_sequencial'))."','$this->z01_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["z01_dbprefcgm"]))
           $resac = db_query("insert into db_acount values($acount,1757,10227,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'z01_dbprefcgm'))."','$this->z01_dbprefcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["z01_hrcbo"]))
           $resac = db_query("insert into db_acount values($acount,1757,10201,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'z01_hrcbo'))."','$this->z01_hrcbo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($z01_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1757,10200,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'z01_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1757,10227,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'z01_dbprefcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1757,10201,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'z01_hrcbo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
