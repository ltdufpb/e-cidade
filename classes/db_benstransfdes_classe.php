...
class cl_benstransfdes { 
   ...
   public $t94_codtran = 0; 
   public $t94_depart = 0; 
   public $t94_divisao = 0; 
   ...
   function incluir ($t94_codtran,$t94_depart){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,931,5827,'','".AddSlashes(pg_fetch_result($resaco,0,'t94_codtran'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,931,5829,'','".AddSlashes(pg_fetch_result($resaco,0,'t94_depart'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,931,13774,'','".AddSlashes(pg_fetch_result($resaco,0,'t94_divisao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($t94_codtran=null,$t94_depart=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->t94_codtran)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t94_codtran"])){ 
       $sql  .= $virgula." t94_codtran = $this->t94_codtran ";
       $virgula = ",";
       if(trim((string) $this->t94_codtran) == null ){ 
     ...
     if(trim((string) $this->t94_depart)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t94_depart"])){ 
       $sql  .= $virgula." t94_depart = $this->t94_depart ";
       $virgula = ",";
       if(trim((string) $this->t94_depart) == null ){ 
     ...
     if(trim((string) $this->t94_divisao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t94_divisao"])){ 
        if(trim((string) $this->t94_divisao)=="" && isset($GLOBALS["HTTP_POST_VARS"]["t94_divisao"])){ 
           $this->t94_divisao = "0" ; 
        } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["t94_codtran"]))
           $resac = db_query("insert into db_acount values($acount,931,5827,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t94_codtran'))."','$this->t94_codtran',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t94_depart"]))
           $resac = db_query("insert into db_acount values($acount,931,5829,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t94_depart'))."','$this->t94_depart',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t94_divisao"]))
           $resac = db_query("insert into db_acount values($acount,931,13774,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t94_divisao'))."','$this->t94_divisao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($t94_codtran=null,$t94_depart=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,931,5827,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t94_codtran'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,931,5829,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t94_depart'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,931,13774,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t94_divisao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
