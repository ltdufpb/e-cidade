...
class cl_acordogarantiaacordotipo { 
   ...
   public $ac05_sequencial = 0; 
   public $ac05_acordotipo = 0; 
   public $ac05_acordogarantia = 0; 
   ...
   function incluir ($ac05_sequencial){ 
     ...
     if($ac05_sequencial == "" || $ac05_sequencial == null ){
       ...
       $this->ac05_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordogarantiaacordotipo_ac05_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac05_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2826,16108,'','".AddSlashes(pg_fetch_result($resaco,0,'ac05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2826,16109,'','".AddSlashes(pg_fetch_result($resaco,0,'ac05_acordotipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2826,16111,'','".AddSlashes(pg_fetch_result($resaco,0,'ac05_acordogarantia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac05_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac05_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac05_sequencial"])){ 
       $sql  .= $virgula." ac05_sequencial = $this->ac05_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac05_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac05_acordotipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac05_acordotipo"])){ 
       $sql  .= $virgula." ac05_acordotipo = $this->ac05_acordotipo ";
       $virgula = ",";
       if(trim((string) $this->ac05_acordotipo) == null ){ 
         $this->erro_sql = " Campo Acordo Tipo nao Informado.";
         $this->erro_campo = "ac05_acordotipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac05_acordogarantia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac05_acordogarantia"])){ 
       $sql  .= $virgula." ac05_acordogarantia = $this->ac05_acordogarantia ";
       $virgula = ",";
       if(trim((string) $this->ac05_acordogarantia) == null ){ 
         $this->erro_sql = " Campo Acordo Garantia nao Informado.";
         $this->erro_campo = "ac05_acordogarantia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac05_sequencial"]) || $this->ac05_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2826,16108,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac05_sequencial'))."','$this->ac05_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac05_acordotipo"]) || $this->ac05_acordotipo != "")
           $resac = db_query("insert into db_acount values($acount,2826,16109,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac05_acordotipo'))."','$this->ac05_acordotipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac05_acordogarantia"]) || $this->ac05_acordogarantia != "")
           $resac = db_query("insert into db_acount values($acount,2826,16111,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac05_acordogarantia'))."','$this->ac05_acordogarantia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac05_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2826,16108,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2826,16109,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac05_acordotipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2826,16111,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac05_acordogarantia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
