...
class cl_procrec { 
   ...
   function incluir ($p52_codigo,$p52_codrec){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,395,2432,'','".AddSlashes(pg_fetch_result($resaco,0,'p52_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,395,2433,'','".AddSlashes(pg_fetch_result($resaco,0,'p52_codrec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,395,2434,'','".AddSlashes(pg_fetch_result($resaco,0,'p52_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($p52_codigo=null,$p52_codrec=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->p52_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["p52_codigo"])){ 
       $sql  .= $virgula." p52_codigo = $this->p52_codigo ";
       $virgula = ",";
       if(trim((string) $this->p52_codigo) == null ){ 
     ...
     if(trim((string) $this->p52_codrec)!="" || isset($GLOBALS["HTTP_POST_VARS"]["p52_codrec"])){ 
       $sql  .= $virgula." p52_codrec = $this->p52_codrec ";
       $virgula = ",";
       if(trim((string) $this->p52_codrec) == null ){ 
     ...
     if(trim((string) $this->p52_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["p52_valor"])){ 
       $sql  .= $virgula." p52_valor = $this->p52_valor ";
       $virgula = ",";
       if(trim((string) $this->p52_valor) == null ){ 
         $this->erro_sql = " Campo Valor da Taxa nao Informado.";
         $this->erro_campo = "p52_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["p52_codigo"]))
           $resac = db_query("insert into db_acount values($acount,395,2432,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'p52_codigo'))."','$this->p52_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p52_codrec"]))
           $resac = db_query("insert into db_acount values($acount,395,2433,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'p52_codrec'))."','$this->p52_codrec',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p52_valor"]))
           $resac = db_query("insert into db_acount values($acount,395,2434,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'p52_valor'))."','$this->p52_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($p52_codigo=null,$p52_codrec=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,395,2432,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'p52_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,395,2433,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'p52_codrec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,395,2434,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'p52_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
