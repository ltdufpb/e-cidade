...
class cl_procavalalternativa { 
   ...
   public $ed281_i_codigo = 0; 
   public $ed281_i_procresultado = 0; 
   public $ed281_i_alternativa = 0; 
   ...
   function incluir ($ed281_i_codigo){ 
     ...
     if($ed281_i_codigo == "" || $ed281_i_codigo == null ){
       ...
       $this->ed281_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from procavalalternativa_ed281_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed281_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3023,17115,'','".AddSlashes(pg_fetch_result($resaco,0,'ed281_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3023,17116,'','".AddSlashes(pg_fetch_result($resaco,0,'ed281_i_procresultado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3023,17117,'','".AddSlashes(pg_fetch_result($resaco,0,'ed281_i_alternativa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed281_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed281_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed281_i_codigo"])){ 
       $sql  .= $virgula." ed281_i_codigo = $this->ed281_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed281_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed281_i_procresultado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed281_i_procresultado"])){ 
       $sql  .= $virgula." ed281_i_procresultado = $this->ed281_i_procresultado ";
       $virgula = ",";
       if(trim((string) $this->ed281_i_procresultado) == null ){ 
         $this->erro_sql = " Campo Resultado nao Informado.";
         $this->erro_campo = "ed281_i_procresultado";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed281_i_alternativa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed281_i_alternativa"])){ 
       $sql  .= $virgula." ed281_i_alternativa = $this->ed281_i_alternativa ";
       $virgula = ",";
       if(trim((string) $this->ed281_i_alternativa) == null ){ 
         $this->erro_sql = " Campo Avaliação Alternativa nao Informado.";
         $this->erro_campo = "ed281_i_alternativa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed281_i_codigo"]) || $this->ed281_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3023,17115,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed281_i_codigo'))."','$this->ed281_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed281_i_procresultado"]) || $this->ed281_i_procresultado != "")
           $resac = db_query("insert into db_acount values($acount,3023,17116,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed281_i_procresultado'))."','$this->ed281_i_procresultado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed281_i_alternativa"]) || $this->ed281_i_alternativa != "")
           $resac = db_query("insert into db_acount values($acount,3023,17117,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed281_i_alternativa'))."','$this->ed281_i_alternativa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed281_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3023,17115,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed281_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3023,17116,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed281_i_procresultado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3023,17117,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed281_i_alternativa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
