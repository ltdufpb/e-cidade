...
class cl_mer_nutricionista_ext { 
   ...
   function incluir ($me02_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2224,12716,'','".AddSlashes(pg_fetch_result($resaco,0,'me02_i_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function alterar ($me02_i_codigo=null) { 
     ...
     if(trim((string) $this->me02_i_rechumano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me02_i_rechumano"])){ 
       $sql  .= $virgula." me02_i_rechumano = $this->me02_i_rechumano ";
       $virgula = ",";
       if(trim((string) $this->me02_i_rechumano) == null ){ 
         $this->erro_sql = " Campo Rechumano nao Informado.";
         $this->erro_campo = "me02_i_rechumano";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me02_i_rechumano"]))
           $resac = db_query("insert into db_acount values($acount,2224,12716,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me02_i_rechumano'))."','$this->me02_i_rechumano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function excluir ($me02_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2224,12716,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me02_i_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
