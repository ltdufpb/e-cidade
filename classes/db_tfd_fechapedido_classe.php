...
class cl_tfd_fechapedido { 
   ...
   public $tf35_i_codigo = 0; 
   public $tf35_i_fechamento = 0; 
   public $tf35_i_procpedidotfd = 0; 
   ...
   function incluir ($tf35_i_codigo){ 
     ...
     if($tf35_i_codigo == "" || $tf35_i_codigo == null ){
       ...
       $this->tf35_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tfd_fechapedido_tf35_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $tf35_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3181,18000,'','".AddSlashes(pg_fetch_result($resaco,0,'tf35_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3181,18001,'','".AddSlashes(pg_fetch_result($resaco,0,'tf35_i_fechamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3181,18002,'','".AddSlashes(pg_fetch_result($resaco,0,'tf35_i_procpedidotfd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($tf35_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->tf35_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf35_i_codigo"])){ 
       $sql  .= $virgula." tf35_i_codigo = $this->tf35_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->tf35_i_codigo) == null ){ 
     ...
     if(trim((string) $this->tf35_i_fechamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf35_i_fechamento"])){ 
       $sql  .= $virgula." tf35_i_fechamento = $this->tf35_i_fechamento ";
       $virgula = ",";
       if(trim((string) $this->tf35_i_fechamento) == null ){ 
         $this->erro_sql = " Campo Fechamento nao Informado.";
         $this->erro_campo = "tf35_i_fechamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tf35_i_procpedidotfd)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf35_i_procpedidotfd"])){ 
       $sql  .= $virgula." tf35_i_procpedidotfd = $this->tf35_i_procpedidotfd ";
       $virgula = ",";
       if(trim((string) $this->tf35_i_procpedidotfd) == null ){ 
         $this->erro_sql = " Campo Procedimento nao Informado.";
         $this->erro_campo = "tf35_i_procpedidotfd";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf35_i_codigo"]) || $this->tf35_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3181,18000,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf35_i_codigo'))."','$this->tf35_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf35_i_fechamento"]) || $this->tf35_i_fechamento != "")
           $resac = db_query("insert into db_acount values($acount,3181,18001,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf35_i_fechamento'))."','$this->tf35_i_fechamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf35_i_procpedidotfd"]) || $this->tf35_i_procpedidotfd != "")
           $resac = db_query("insert into db_acount values($acount,3181,18002,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf35_i_procpedidotfd'))."','$this->tf35_i_procpedidotfd',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($tf35_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3181,18000,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf35_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3181,18001,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf35_i_fechamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3181,18002,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf35_i_procpedidotfd'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
