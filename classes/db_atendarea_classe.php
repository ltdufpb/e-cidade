...
class cl_atendarea { 
   ...
   public $at28_sequencial = 0; 
   public $at28_atendimento = 0; 
   public $at28_atendcadarea = 0; 
   ...
   function incluir ($at28_sequencial){ 
     ...
     if($at28_sequencial == "" || $at28_sequencial == null ){
       ...
       $this->at28_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from atendarea_at28_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at28_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1680,9791,'','".AddSlashes(pg_fetch_result($resaco,0,'at28_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1680,9792,'','".AddSlashes(pg_fetch_result($resaco,0,'at28_atendimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1680,9793,'','".AddSlashes(pg_fetch_result($resaco,0,'at28_atendcadarea'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at28_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at28_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at28_sequencial"])){ 
       $sql  .= $virgula." at28_sequencial = $this->at28_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at28_sequencial) == null ){ 
     ...
     if(trim((string) $this->at28_atendimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at28_atendimento"])){ 
       $sql  .= $virgula." at28_atendimento = $this->at28_atendimento ";
       $virgula = ",";
       if(trim((string) $this->at28_atendimento) == null ){ 
         $this->erro_sql = " Campo Código do atendimento nao Informado.";
         $this->erro_campo = "at28_atendimento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at28_atendcadarea)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at28_atendcadarea"])){ 
       $sql  .= $virgula." at28_atendcadarea = $this->at28_atendcadarea ";
       $virgula = ",";
       if(trim((string) $this->at28_atendcadarea) == null ){ 
         $this->erro_sql = " Campo Código da área nao Informado.";
         $this->erro_campo = "at28_atendcadarea";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at28_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1680,9791,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at28_sequencial'))."','$this->at28_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at28_atendimento"]))
           $resac = db_query("insert into db_acount values($acount,1680,9792,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at28_atendimento'))."','$this->at28_atendimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at28_atendcadarea"]))
           $resac = db_query("insert into db_acount values($acount,1680,9793,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at28_atendcadarea'))."','$this->at28_atendcadarea',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at28_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1680,9791,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at28_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1680,9792,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at28_atendimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1680,9793,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at28_atendcadarea'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
