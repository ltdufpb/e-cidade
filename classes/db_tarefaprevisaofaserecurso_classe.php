...
class cl_tarefaprevisaofaserecurso { 
   ...
   public $at83_sequencial = 0; 
   public $at83_tarefaprevisaofase = 0; 
   public $at83_usuario = 0; 
   ...
   function incluir ($at83_sequencial){ 
     ...
     if($at83_sequencial == "" || $at83_sequencial == null ){
       ...
       $this->at83_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tarefaprevisaofaserecurso_at83_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at83_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2644,15038,'','".AddSlashes(pg_fetch_result($resaco,0,'at83_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2644,15040,'','".AddSlashes(pg_fetch_result($resaco,0,'at83_tarefaprevisaofase'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2644,15039,'','".AddSlashes(pg_fetch_result($resaco,0,'at83_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at83_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at83_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at83_sequencial"])){ 
       $sql  .= $virgula." at83_sequencial = $this->at83_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at83_sequencial) == null ){ 
         $this->erro_sql = " Campo Codigo sequencial nao Informado.";
     ...
     if(trim((string) $this->at83_tarefaprevisaofase)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at83_tarefaprevisaofase"])){ 
       $sql  .= $virgula." at83_tarefaprevisaofase = $this->at83_tarefaprevisaofase ";
       $virgula = ",";
       if(trim((string) $this->at83_tarefaprevisaofase) == null ){ 
         $this->erro_sql = " Campo Codigo sequencial nao Informado.";
         $this->erro_campo = "at83_tarefaprevisaofase";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at83_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at83_usuario"])){ 
       $sql  .= $virgula." at83_usuario = $this->at83_usuario ";
       $virgula = ",";
       if(trim((string) $this->at83_usuario) == null ){ 
         $this->erro_sql = " Campo Cod. Usuário nao Informado.";
         $this->erro_campo = "at83_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at83_sequencial"]) || $this->at83_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2644,15038,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at83_sequencial'))."','$this->at83_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at83_tarefaprevisaofase"]) || $this->at83_tarefaprevisaofase != "")
           $resac = db_query("insert into db_acount values($acount,2644,15040,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at83_tarefaprevisaofase'))."','$this->at83_tarefaprevisaofase',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at83_usuario"]) || $this->at83_usuario != "")
           $resac = db_query("insert into db_acount values($acount,2644,15039,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at83_usuario'))."','$this->at83_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at83_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2644,15038,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at83_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2644,15040,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at83_tarefaprevisaofase'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2644,15039,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at83_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
