...
class cl_testpri { 
   ...
   function incluir ($j49_idbql,$j49_face){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,25,134,'','".AddSlashes(pg_fetch_result($resaco,0,'j49_idbql'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,25,135,'','".AddSlashes(pg_fetch_result($resaco,0,'j49_face'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,25,136,'','".AddSlashes(pg_fetch_result($resaco,0,'j49_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j49_idbql=null,$j49_face=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j49_idbql)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j49_idbql"])){ 
       $sql  .= $virgula." j49_idbql = $this->j49_idbql ";
       $virgula = ",";
       if(trim((string) $this->j49_idbql) == null ){ 
     ...
     if(trim((string) $this->j49_face)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j49_face"])){ 
       $sql  .= $virgula." j49_face = $this->j49_face ";
       $virgula = ",";
       if(trim((string) $this->j49_face) == null ){ 
     ...
     if(trim((string) $this->j49_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j49_codigo"])){ 
       $sql  .= $virgula." j49_codigo = $this->j49_codigo ";
       $virgula = ",";
       if(trim((string) $this->j49_codigo) == null ){ 
         $this->erro_sql = " Campo Rua nao Informado.";
         $this->erro_campo = "j49_codigo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j49_idbql"]))
           $resac = db_query("insert into db_acount values($acount,25,134,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j49_idbql'))."','$this->j49_idbql',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j49_face"]))
           $resac = db_query("insert into db_acount values($acount,25,135,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j49_face'))."','$this->j49_face',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j49_codigo"]))
           $resac = db_query("insert into db_acount values($acount,25,136,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j49_codigo'))."','$this->j49_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j49_idbql=null,$j49_face=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,25,134,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j49_idbql'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,25,135,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j49_face'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,25,136,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j49_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
