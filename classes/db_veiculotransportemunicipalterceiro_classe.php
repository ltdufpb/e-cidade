...
class cl_veiculotransportemunicipalterceiro { 
   ...
   function incluir ($tre03_sequencial){ 
     ...
     if($tre03_sequencial == "" || $tre03_sequencial == null ){
       ...
       $this->tre03_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veiculotransportemunicipalterceiro_tre03_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $tre03_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3600,20079,'','".AddSlashes(pg_fetch_result($resaco,0,'tre03_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3600,20080,'','".AddSlashes(pg_fetch_result($resaco,0,'tre03_cgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3600,20081,'','".AddSlashes(pg_fetch_result($resaco,0,'tre03_veiculotransportemunicipal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($tre03_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->tre03_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tre03_sequencial"])){ 
       $sql  .= $virgula." tre03_sequencial = $this->tre03_sequencial ";
       $virgula = ",";
       if(trim((string) $this->tre03_sequencial) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
     ...
     if(trim((string) $this->tre03_cgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tre03_cgm"])){ 
       $sql  .= $virgula." tre03_cgm = $this->tre03_cgm ";
       $virgula = ",";
       if(trim((string) $this->tre03_cgm) == null ){ 
         $this->erro_sql = " Campo Numcgm nao Informado.";
         $this->erro_campo = "tre03_cgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tre03_veiculotransportemunicipal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tre03_veiculotransportemunicipal"])){ 
       $sql  .= $virgula." tre03_veiculotransportemunicipal = $this->tre03_veiculotransportemunicipal ";
       $virgula = ",";
       if(trim((string) $this->tre03_veiculotransportemunicipal) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
         $this->erro_campo = "tre03_veiculotransportemunicipal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["tre03_sequencial"]) || $this->tre03_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3600,20079,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tre03_sequencial'))."','$this->tre03_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["tre03_cgm"]) || $this->tre03_cgm != "")
             $resac = db_query("insert into db_acount values($acount,3600,20080,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tre03_cgm'))."','$this->tre03_cgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["tre03_veiculotransportemunicipal"]) || $this->tre03_veiculotransportemunicipal != "")
             $resac = db_query("insert into db_acount values($acount,3600,20081,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tre03_veiculotransportemunicipal'))."','$this->tre03_veiculotransportemunicipal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3600,20079,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tre03_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3600,20080,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tre03_cgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3600,20081,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tre03_veiculotransportemunicipal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
