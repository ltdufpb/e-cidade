...
class cl_orcppaval { 
   ...
   public $o24_codseqppa = 0; 
   public $o24_codppa = 0; 
   public $o24_exercicio = 0; 
   public $o24_valor = 0; 
   public $o24_quantmed = 0; 
   public $o24_proces = 0; 
   ...
   function incluir ($o24_codseqppa){ 
     ...
     if($o24_codseqppa == "" || $o24_codseqppa == null ){
       ...
       $this->o24_codseqppa = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from orcppaval_o24_codseqppa_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $o24_codseqppa)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1066,6484,'','".AddSlashes(pg_fetch_result($resaco,0,'o24_codseqppa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1066,6485,'','".AddSlashes(pg_fetch_result($resaco,0,'o24_codppa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1066,6486,'','".AddSlashes(pg_fetch_result($resaco,0,'o24_exercicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1066,6487,'','".AddSlashes(pg_fetch_result($resaco,0,'o24_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1066,6488,'','".AddSlashes(pg_fetch_result($resaco,0,'o24_quantmed'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1066,6518,'','".AddSlashes(pg_fetch_result($resaco,0,'o24_proces'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o24_codseqppa=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o24_codseqppa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o24_codseqppa"])){ 
       $sql  .= $virgula." o24_codseqppa = $this->o24_codseqppa ";
       $virgula = ",";
       if(trim((string) $this->o24_codseqppa) == null ){ 
     ...
     if(trim((string) $this->o24_codppa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o24_codppa"])){ 
       $sql  .= $virgula." o24_codppa = $this->o24_codppa ";
       $virgula = ",";
       if(trim((string) $this->o24_codppa) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
         $this->erro_campo = "o24_codppa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o24_exercicio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o24_exercicio"])){ 
       $sql  .= $virgula." o24_exercicio = $this->o24_exercicio ";
       $virgula = ",";
       if(trim((string) $this->o24_exercicio) == null ){ 
         $this->erro_sql = " Campo Exercicío nao Informado.";
         $this->erro_campo = "o24_exercicio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o24_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o24_valor"])){ 
       $sql  .= $virgula." o24_valor = $this->o24_valor ";
       $virgula = ",";
       if(trim((string) $this->o24_valor) == null ){ 
         $this->erro_sql = " Campo Valor nao Informado.";
         $this->erro_campo = "o24_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o24_quantmed)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o24_quantmed"])){ 
        if(trim((string) $this->o24_quantmed)=="" && isset($GLOBALS["HTTP_POST_VARS"]["o24_quantmed"])){ 
           $this->o24_quantmed = "0" ; 
        } 
     ...
     if(trim((string) $this->o24_proces)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o24_proces"])){ 
       $sql  .= $virgula." o24_proces = $this->o24_proces ";
       $virgula = ",";
       if(trim((string) $this->o24_proces) == null ){ 
         $this->erro_sql = " Campo Processo nao Informado.";
         $this->erro_campo = "o24_proces";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o24_codseqppa"]))
           $resac = db_query("insert into db_acount values($acount,1066,6484,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o24_codseqppa'))."','$this->o24_codseqppa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o24_codppa"]))
           $resac = db_query("insert into db_acount values($acount,1066,6485,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o24_codppa'))."','$this->o24_codppa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o24_exercicio"]))
           $resac = db_query("insert into db_acount values($acount,1066,6486,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o24_exercicio'))."','$this->o24_exercicio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o24_valor"]))
           $resac = db_query("insert into db_acount values($acount,1066,6487,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o24_valor'))."','$this->o24_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o24_quantmed"]))
           $resac = db_query("insert into db_acount values($acount,1066,6488,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o24_quantmed'))."','$this->o24_quantmed',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o24_proces"]))
           $resac = db_query("insert into db_acount values($acount,1066,6518,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o24_proces'))."','$this->o24_proces',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o24_codseqppa=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1066,6484,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o24_codseqppa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1066,6485,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o24_codppa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1066,6486,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o24_exercicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1066,6487,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o24_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1066,6488,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o24_quantmed'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1066,6518,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o24_proces'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
