...
class cl_empagepag { 
   ...
   function incluir ($e85_codmov,$e85_codtipo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,999,6186,'','".AddSlashes(pg_fetch_result($resaco,0,'e85_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,999,6187,'','".AddSlashes(pg_fetch_result($resaco,0,'e85_codtipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e85_codmov=null,$e85_codtipo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e85_codmov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e85_codmov"])){ 
       $sql  .= $virgula." e85_codmov = $this->e85_codmov ";
       $virgula = ",";
       if(trim((string) $this->e85_codmov) == null ){ 
     ...
     if(trim((string) $this->e85_codtipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e85_codtipo"])){ 
       $sql  .= $virgula." e85_codtipo = $this->e85_codtipo ";
       $virgula = ",";
       if(trim((string) $this->e85_codtipo) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e85_codmov"]))
           $resac = db_query("insert into db_acount values($acount,999,6186,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e85_codmov'))."','$this->e85_codmov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e85_codtipo"]))
           $resac = db_query("insert into db_acount values($acount,999,6187,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e85_codtipo'))."','$this->e85_codtipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e85_codmov=null,$e85_codtipo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,999,6186,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e85_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,999,6187,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e85_codtipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
