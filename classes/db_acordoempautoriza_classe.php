...
class cl_acordoempautoriza { 
   ...
   public $ac45_sequencial = 0; 
   public $ac45_acordo = 0; 
   public $ac45_empautoriza = 0; 
   ...
   function incluir ($ac45_sequencial){ 
     ...
     if($ac45_sequencial == "" || $ac45_sequencial == null ){
       ...
       $this->ac45_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordoempautoriza_ac45_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac45_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3538,19742,'','".AddSlashes(pg_fetch_result($resaco,0,'ac45_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3538,19743,'','".AddSlashes(pg_fetch_result($resaco,0,'ac45_acordo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3538,19744,'','".AddSlashes(pg_fetch_result($resaco,0,'ac45_empautoriza'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac45_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac45_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac45_sequencial"])){ 
       $sql  .= $virgula." ac45_sequencial = $this->ac45_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac45_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac45_acordo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac45_acordo"])){ 
       $sql  .= $virgula." ac45_acordo = $this->ac45_acordo ";
       $virgula = ",";
       if(trim((string) $this->ac45_acordo) == null ){ 
         $this->erro_sql = " Campo Acordo da Autorização nao Informado.";
         $this->erro_campo = "ac45_acordo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac45_empautoriza)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac45_empautoriza"])){ 
       $sql  .= $virgula." ac45_empautoriza = $this->ac45_empautoriza ";
       $virgula = ",";
       if(trim((string) $this->ac45_empautoriza) == null ){ 
         $this->erro_sql = " Campo Autorização do Acordo nao Informado.";
         $this->erro_campo = "ac45_empautoriza";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac45_sequencial"]) || $this->ac45_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3538,19742,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac45_sequencial'))."','$this->ac45_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac45_acordo"]) || $this->ac45_acordo != "")
           $resac = db_query("insert into db_acount values($acount,3538,19743,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac45_acordo'))."','$this->ac45_acordo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac45_empautoriza"]) || $this->ac45_empautoriza != "")
           $resac = db_query("insert into db_acount values($acount,3538,19744,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac45_empautoriza'))."','$this->ac45_empautoriza',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac45_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3538,19742,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac45_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3538,19743,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac45_acordo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3538,19744,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac45_empautoriza'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
