...
class cl_issarquivoretencaoregistroissbase {
   ...
   public $q128_sequencial = 0;
   public $q128_inscr = 0;
   public $q128_issarquivoretencaoregistro = 0;
   ...
   function incluir ($q128_sequencial){
     ...
     if($q128_sequencial == "" || $q128_sequencial == null ){
       ...
       $this->q128_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from issarquivoretencaoregistroissbase_q128_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q128_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3800,21112,'','".AddSlashes(pg_fetch_result($resaco,0,'q128_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3800,21113,'','".AddSlashes(pg_fetch_result($resaco,0,'q128_inscr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3800,21115,'','".AddSlashes(pg_fetch_result($resaco,0,'q128_issarquivoretencaoregistro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   public function alterar ($q128_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->q128_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q128_sequencial"])){
       $sql  .= $virgula." q128_sequencial = $this->q128_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q128_sequencial) == null ){
     ...
     if(trim((string) $this->q128_inscr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q128_inscr"])){
       $sql  .= $virgula." q128_inscr = $this->q128_inscr ";
       $virgula = ",";
       if(trim((string) $this->q128_inscr) == null ){
         $this->erro_sql = " Campo Inscrição não informado.";
         $this->erro_campo = "q128_inscr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q128_issarquivoretencaoregistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q128_issarquivoretencaoregistro"])){
       $sql  .= $virgula." q128_issarquivoretencaoregistro = $this->q128_issarquivoretencaoregistro ";
       $virgula = ",";
       if(trim((string) $this->q128_issarquivoretencaoregistro) == null ){
         $this->erro_sql = " Campo Código Registro Retencão não informado.";
         $this->erro_campo = "q128_issarquivoretencaoregistro";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["q128_sequencial"]) || $this->q128_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3800,21112,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q128_sequencial'))."','$this->q128_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["q128_inscr"]) || $this->q128_inscr != "")
             $resac = db_query("insert into db_acount values($acount,3800,21113,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q128_inscr'))."','$this->q128_inscr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["q128_issarquivoretencaoregistro"]) || $this->q128_issarquivoretencaoregistro != "")
             $resac = db_query("insert into db_acount values($acount,3800,21115,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q128_issarquivoretencaoregistro'))."','$this->q128_issarquivoretencaoregistro',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3800,21112,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q128_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3800,21113,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q128_inscr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3800,21115,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q128_issarquivoretencaoregistro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
