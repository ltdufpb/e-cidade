...
class cl_declaracaoquitacaocarneagua { 
   ...
   public $ar41_sequencial = 0; 
   public $ar41_declaracaoquitacao = 0; 
   public $ar41_numpre = 0; 
   public $ar41_numpar = 0; 
   public $ar41_anoemissao = 0; 
   public $ar41_mesemissao = null; 
   ...
   function incluir ($ar41_sequencial){ 
     ...
     if($ar41_sequencial == "" || $ar41_sequencial == null ){
       ...
       $this->ar41_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from declaracaoquitacaocarneagua_ar41_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ar41_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3431,19292,'','".AddSlashes(pg_fetch_result($resaco,0,'ar41_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3431,19293,'','".AddSlashes(pg_fetch_result($resaco,0,'ar41_declaracaoquitacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3431,19297,'','".AddSlashes(pg_fetch_result($resaco,0,'ar41_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3431,19298,'','".AddSlashes(pg_fetch_result($resaco,0,'ar41_numpar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3431,19295,'','".AddSlashes(pg_fetch_result($resaco,0,'ar41_anoemissao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3431,19294,'','".AddSlashes(pg_fetch_result($resaco,0,'ar41_mesemissao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ar41_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ar41_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar41_sequencial"])){ 
       $sql  .= $virgula." ar41_sequencial = $this->ar41_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ar41_sequencial) == null ){ 
     ...
     if(trim((string) $this->ar41_declaracaoquitacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar41_declaracaoquitacao"])){ 
       $sql  .= $virgula." ar41_declaracaoquitacao = $this->ar41_declaracaoquitacao ";
       $virgula = ",";
       if(trim((string) $this->ar41_declaracaoquitacao) == null ){ 
         $this->erro_sql = " Campo Declaração quitação nao Informado.";
         $this->erro_campo = "ar41_declaracaoquitacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ar41_numpre)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar41_numpre"])){ 
       $sql  .= $virgula." ar41_numpre = $this->ar41_numpre ";
       $virgula = ",";
       if(trim((string) $this->ar41_numpre) == null ){ 
         $this->erro_sql = " Campo Numpre nao Informado.";
         $this->erro_campo = "ar41_numpre";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ar41_numpar)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar41_numpar"])){ 
       $sql  .= $virgula." ar41_numpar = $this->ar41_numpar ";
       $virgula = ",";
       if(trim((string) $this->ar41_numpar) == null ){ 
         $this->erro_sql = " Campo Parcela nao Informado.";
         $this->erro_campo = "ar41_numpar";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ar41_anoemissao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar41_anoemissao"])){ 
       $sql  .= $virgula." ar41_anoemissao = $this->ar41_anoemissao ";
       $virgula = ",";
       if(trim((string) $this->ar41_anoemissao) == null ){ 
         $this->erro_sql = " Campo Ano Emissão nao Informado.";
         $this->erro_campo = "ar41_anoemissao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ar41_mesemissao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ar41_mesemissao"])){ 
       $sql  .= $virgula." ar41_mesemissao = '$this->ar41_mesemissao' ";
       $virgula = ",";
       if(trim((string) $this->ar41_mesemissao) == null ){ 
         $this->erro_sql = " Campo Mês Emissão nao Informado.";
         $this->erro_campo = "ar41_mesemissao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar41_sequencial"]) || $this->ar41_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3431,19292,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar41_sequencial'))."','$this->ar41_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar41_declaracaoquitacao"]) || $this->ar41_declaracaoquitacao != "")
           $resac = db_query("insert into db_acount values($acount,3431,19293,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar41_declaracaoquitacao'))."','$this->ar41_declaracaoquitacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar41_numpre"]) || $this->ar41_numpre != "")
           $resac = db_query("insert into db_acount values($acount,3431,19297,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar41_numpre'))."','$this->ar41_numpre',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar41_numpar"]) || $this->ar41_numpar != "")
           $resac = db_query("insert into db_acount values($acount,3431,19298,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar41_numpar'))."','$this->ar41_numpar',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar41_anoemissao"]) || $this->ar41_anoemissao != "")
           $resac = db_query("insert into db_acount values($acount,3431,19295,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar41_anoemissao'))."','$this->ar41_anoemissao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ar41_mesemissao"]) || $this->ar41_mesemissao != "")
           $resac = db_query("insert into db_acount values($acount,3431,19294,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ar41_mesemissao'))."','$this->ar41_mesemissao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ar41_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3431,19292,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar41_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3431,19293,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar41_declaracaoquitacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3431,19297,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar41_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3431,19298,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar41_numpar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3431,19295,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar41_anoemissao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3431,19294,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ar41_mesemissao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
