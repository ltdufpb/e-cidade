...
class cl_processoforonumcgm { 
   ...
   public $v75_sequencial = 0; 
   public $v75_seqprocforo = 0; 
   public $v75_numcgm = 0; 
   ...
   function incluir ($v75_sequencial){ 
     ...
     if($v75_sequencial == "" || $v75_sequencial == null ){
       ...
       $this->v75_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from processoforonumcgm_v75_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $v75_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3140,17784,'','".AddSlashes(pg_fetch_result($resaco,0,'v75_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3140,17786,'','".AddSlashes(pg_fetch_result($resaco,0,'v75_seqprocforo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3140,17785,'','".AddSlashes(pg_fetch_result($resaco,0,'v75_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($v75_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->v75_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v75_sequencial"])){ 
       $sql  .= $virgula." v75_sequencial = $this->v75_sequencial ";
       $virgula = ",";
       if(trim((string) $this->v75_sequencial) == null ){ 
         $this->erro_sql = " Campo Código Sequencial nao Informado.";
     ...
     if(trim((string) $this->v75_seqprocforo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v75_seqprocforo"])){ 
       $sql  .= $virgula." v75_seqprocforo = $this->v75_seqprocforo ";
       $virgula = ",";
       if(trim((string) $this->v75_seqprocforo) == null ){ 
         $this->erro_sql = " Campo Código Sequencial nao Informado.";
         $this->erro_campo = "v75_seqprocforo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->v75_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v75_numcgm"])){ 
       $sql  .= $virgula." v75_numcgm = $this->v75_numcgm ";
       $virgula = ",";
       if(trim((string) $this->v75_numcgm) == null ){ 
         $this->erro_sql = " Campo Nome nao Informado.";
         $this->erro_campo = "v75_numcgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v75_sequencial"]) || $this->v75_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3140,17784,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v75_sequencial'))."','$this->v75_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v75_seqprocforo"]) || $this->v75_seqprocforo != "")
           $resac = db_query("insert into db_acount values($acount,3140,17786,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v75_seqprocforo'))."','$this->v75_seqprocforo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v75_numcgm"]) || $this->v75_numcgm != "")
           $resac = db_query("insert into db_acount values($acount,3140,17785,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v75_numcgm'))."','$this->v75_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($v75_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3140,17784,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v75_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3140,17786,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v75_seqprocforo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3140,17785,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v75_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
