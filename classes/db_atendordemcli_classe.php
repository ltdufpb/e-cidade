...
class cl_atendordemcli { 
   ...
   public $at85_seq = 0; 
   public $at85_respcli = 0; 
   public $at85_cliitem = 0; 
   public $at85_prioridade = 0; 
   ...
   function incluir ($at85_seq){ 
     ...
     if($at85_seq == "" || $at85_seq == null ){
       ...
       $this->at85_seq = pg_fetch_result($result,0,0); 
     }else{
       $result = @db_query("select last_value from atendordemcli_at85_seq_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at85_seq)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1577,9207,'','".AddSlashes(pg_fetch_result($resaco,0,'at85_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1577,9208,'','".AddSlashes(pg_fetch_result($resaco,0,'at85_respcli'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1577,9209,'','".AddSlashes(pg_fetch_result($resaco,0,'at85_cliitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1577,9210,'','".AddSlashes(pg_fetch_result($resaco,0,'at85_prioridade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at85_seq=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at85_seq)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at85_seq"])){ 
       $sql  .= $virgula." at85_seq = $this->at85_seq ";
       $virgula = ",";
       if(trim((string) $this->at85_seq) == null ){ 
     ...
     if(trim((string) $this->at85_respcli)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at85_respcli"])){ 
       $sql  .= $virgula." at85_respcli = $this->at85_respcli ";
       $virgula = ",";
       if(trim((string) $this->at85_respcli) == null ){ 
         $this->erro_sql = " Campo Código do responsável nao Informado.";
         $this->erro_campo = "at85_respcli";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at85_cliitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at85_cliitem"])){ 
       $sql  .= $virgula." at85_cliitem = $this->at85_cliitem ";
       $virgula = ",";
       if(trim((string) $this->at85_cliitem) == null ){ 
         $this->erro_sql = " Campo Sequencial da tarefa nao Informado.";
         $this->erro_campo = "at85_cliitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at85_prioridade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at85_prioridade"])){ 
       $sql  .= $virgula." at85_prioridade = $this->at85_prioridade ";
       $virgula = ",";
       if(trim((string) $this->at85_prioridade) == null ){ 
         $this->erro_sql = " Campo Prioridade nao Informado.";
         $this->erro_campo = "at85_prioridade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at85_seq"]))
           $resac = db_query("insert into db_acount values($acount,1577,9207,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at85_seq'))."','$this->at85_seq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at85_respcli"]))
           $resac = db_query("insert into db_acount values($acount,1577,9208,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at85_respcli'))."','$this->at85_respcli',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at85_cliitem"]))
           $resac = db_query("insert into db_acount values($acount,1577,9209,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at85_cliitem'))."','$this->at85_cliitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at85_prioridade"]))
           $resac = db_query("insert into db_acount values($acount,1577,9210,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at85_prioridade'))."','$this->at85_prioridade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at85_seq=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1577,9207,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at85_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1577,9208,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at85_respcli'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1577,9209,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at85_cliitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1577,9210,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at85_prioridade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
