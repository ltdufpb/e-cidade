...
class cl_serieidade { 
   ...
   public $ed259_i_codigo = 0; 
   public $ed259_i_serie = 0; 
   public $ed259_i_idadeini = 0; 
   public $ed259_i_idadefim = 0; 
   ...
   function incluir ($ed259_i_codigo){ 
     ...
     if($ed259_i_codigo == "" || $ed259_i_codigo == null ){
       ...
       $this->ed259_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from serieidade_ed259_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed259_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2210,12657,'','".AddSlashes(pg_fetch_result($resaco,0,'ed259_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2210,12659,'','".AddSlashes(pg_fetch_result($resaco,0,'ed259_i_serie'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2210,12660,'','".AddSlashes(pg_fetch_result($resaco,0,'ed259_i_idadeini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2210,12661,'','".AddSlashes(pg_fetch_result($resaco,0,'ed259_i_idadefim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed259_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed259_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed259_i_codigo"])){ 
       $sql  .= $virgula." ed259_i_codigo = $this->ed259_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed259_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed259_i_serie)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed259_i_serie"])){ 
       $sql  .= $virgula." ed259_i_serie = $this->ed259_i_serie ";
       $virgula = ",";
       if(trim((string) $this->ed259_i_serie) == null ){ 
         $this->erro_sql = " Campo Série nao Informado.";
         $this->erro_campo = "ed259_i_serie";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed259_i_idadeini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed259_i_idadeini"])){ 
       $sql  .= $virgula." ed259_i_idadeini = $this->ed259_i_idadeini ";
       $virgula = ",";
       if(trim((string) $this->ed259_i_idadeini) == null ){ 
         $this->erro_sql = " Campo Idade Inicial (em meses) nao Informado.";
         $this->erro_campo = "ed259_i_idadeini";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed259_i_idadefim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed259_i_idadefim"])){ 
       $sql  .= $virgula." ed259_i_idadefim = $this->ed259_i_idadefim ";
       $virgula = ",";
       if(trim((string) $this->ed259_i_idadefim) == null ){ 
         $this->erro_sql = " Campo Idade Final (em meses) nao Informado.";
         $this->erro_campo = "ed259_i_idadefim";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed259_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2210,12657,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed259_i_codigo'))."','$this->ed259_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed259_i_serie"]))
           $resac = db_query("insert into db_acount values($acount,2210,12659,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed259_i_serie'))."','$this->ed259_i_serie',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed259_i_idadeini"]))
           $resac = db_query("insert into db_acount values($acount,2210,12660,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed259_i_idadeini'))."','$this->ed259_i_idadeini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed259_i_idadefim"]))
           $resac = db_query("insert into db_acount values($acount,2210,12661,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed259_i_idadefim'))."','$this->ed259_i_idadefim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed259_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2210,12657,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed259_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2210,12659,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed259_i_serie'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2210,12660,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed259_i_idadeini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2210,12661,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed259_i_idadefim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
