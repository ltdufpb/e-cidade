...
class cl_rhtipoparticipacaocurso { 
   ...
   public $h67_sequencial = 0; 
   public $h67_descricao = null; 
   ...
   function incluir ($h67_descricao){ 
     ...
     if($h67_sequencial == "" || $h67_sequencial == null ){
       ...
       $this->h67_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhtipoparticipacaocurso_h67_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h67_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3310,18693,'','".AddSlashes(pg_fetch_result($resaco,0,'h67_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3310,18694,'','".AddSlashes(pg_fetch_result($resaco,0,'h67_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h67_descricao=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h67_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h67_sequencial"])){ 
       $sql  .= $virgula." h67_sequencial = $this->h67_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h67_sequencial) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
         $this->erro_campo = "h67_sequencial";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h67_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h67_descricao"])){ 
       $sql  .= $virgula." h67_descricao = '$this->h67_descricao' ";
       $virgula = ",";
       if(trim((string) $this->h67_descricao) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h67_sequencial"]) || $this->h67_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3310,18693,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h67_sequencial'))."','$this->h67_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h67_descricao"]) || $this->h67_descricao != "")
           $resac = db_query("insert into db_acount values($acount,3310,18694,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h67_descricao'))."','$this->h67_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h67_descricao=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3310,18693,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h67_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3310,18694,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h67_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
