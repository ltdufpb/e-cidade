...
class cl_rhfotos { 
   ...
   function incluir ($rh50_numcgm){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1489,8738,'','".AddSlashes(pg_fetch_result($resaco,0,'rh50_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1489,8739,'','".AddSlashes(pg_fetch_result($resaco,0,'rh50_oid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh50_numcgm=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh50_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh50_numcgm"])){ 
       $sql  .= $virgula." rh50_numcgm = $this->rh50_numcgm ";
       $virgula = ",";
       if(trim((string) $this->rh50_numcgm) == null ){ 
     ...
     if(trim((string) $this->rh50_oid)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh50_oid"])){ 
       $sql  .= $virgula." rh50_oid = $this->rh50_oid ";
       $virgula = ",";
       if(trim((string) $this->rh50_oid) == null ){ 
         $this->erro_sql = " Campo Local nao Informado.";
         $this->erro_campo = "rh50_oid";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh50_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,1489,8738,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh50_numcgm'))."','$this->rh50_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh50_oid"]))
           $resac = db_query("insert into db_acount values($acount,1489,8739,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh50_oid'))."','$this->rh50_oid',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh50_numcgm=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1489,8738,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh50_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1489,8739,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh50_oid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
