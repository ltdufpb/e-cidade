...
class cl_vac_devolucao { 
   ...
   public $vc26_i_codigo = 0; 
   public $vc26_i_fechamento = 0; 
   public $vc26_i_usuario = 0; 
   public $vc26_d_data_dia = null; 
   public $vc26_d_data_mes = null; 
   public $vc26_d_data_ano = null; 
   public $vc26_d_data = null; 
   ...
   function incluir ($vc26_i_codigo){ 
     ...
     if($vc26_i_codigo == "" || $vc26_i_codigo == null ){
       ...
       $this->vc26_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from vac_devolucao_vc26_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $vc26_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3103,17570,'','".AddSlashes(pg_fetch_result($resaco,0,'vc26_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3103,17571,'','".AddSlashes(pg_fetch_result($resaco,0,'vc26_i_fechamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3103,17573,'','".AddSlashes(pg_fetch_result($resaco,0,'vc26_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3103,17572,'','".AddSlashes(pg_fetch_result($resaco,0,'vc26_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($vc26_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->vc26_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc26_i_codigo"])){ 
       $sql  .= $virgula." vc26_i_codigo = $this->vc26_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->vc26_i_codigo) == null ){ 
     ...
     if(trim((string) $this->vc26_i_fechamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc26_i_fechamento"])){ 
       $sql  .= $virgula." vc26_i_fechamento = $this->vc26_i_fechamento ";
       $virgula = ",";
       if(trim((string) $this->vc26_i_fechamento) == null ){ 
         $this->erro_sql = " Campo Fechamento nao Informado.";
         $this->erro_campo = "vc26_i_fechamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc26_i_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc26_i_usuario"])){ 
       $sql  .= $virgula." vc26_i_usuario = $this->vc26_i_usuario ";
       $virgula = ",";
       if(trim((string) $this->vc26_i_usuario) == null ){ 
         $this->erro_sql = " Campo Usuario nao Informado.";
         $this->erro_campo = "vc26_i_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc26_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc26_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["vc26_d_data_dia"] !="") ){ 
       $sql  .= $virgula." vc26_d_data = '$this->vc26_d_data' ";
       $virgula = ",";
       if(trim((string) $this->vc26_d_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "vc26_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc26_i_codigo"]) || $this->vc26_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3103,17570,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc26_i_codigo'))."','$this->vc26_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc26_i_fechamento"]) || $this->vc26_i_fechamento != "")
           $resac = db_query("insert into db_acount values($acount,3103,17571,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc26_i_fechamento'))."','$this->vc26_i_fechamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc26_i_usuario"]) || $this->vc26_i_usuario != "")
           $resac = db_query("insert into db_acount values($acount,3103,17573,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc26_i_usuario'))."','$this->vc26_i_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc26_d_data"]) || $this->vc26_d_data != "")
           $resac = db_query("insert into db_acount values($acount,3103,17572,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc26_d_data'))."','$this->vc26_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($vc26_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3103,17570,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc26_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3103,17571,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc26_i_fechamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3103,17573,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc26_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3103,17572,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc26_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
