...
class cl_alunoaltconf {
   ...
   public $ed277_i_codigo = 0;
   public $ed277_i_alunoalt = 0;
   public $ed277_i_usuario = 0;
   public $ed277_i_data = 0;
   ...
   function incluir ($ed277_i_codigo){
     ...
     if($ed277_i_codigo == "" || $ed277_i_codigo == null ){
       ...
       $this->ed277_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from alunoaltconf_ed277_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed277_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2495,14189,'','".AddSlashes(pg_fetch_result($resaco,0,'ed277_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2495,14190,'','".AddSlashes(pg_fetch_result($resaco,0,'ed277_i_alunoalt'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2495,14191,'','".AddSlashes(pg_fetch_result($resaco,0,'ed277_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2495,14192,'','".AddSlashes(pg_fetch_result($resaco,0,'ed277_i_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($ed277_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->ed277_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed277_i_codigo"])){
       $sql  .= $virgula." ed277_i_codigo = $this->ed277_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed277_i_codigo) == null ){
     ...
     if(trim((string) $this->ed277_i_alunoalt)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed277_i_alunoalt"])){
       $sql  .= $virgula." ed277_i_alunoalt = $this->ed277_i_alunoalt ";
       $virgula = ",";
       if(trim((string) $this->ed277_i_alunoalt) == null ){
         $this->erro_sql = " Campo Aluno nao Informado.";
         $this->erro_campo = "ed277_i_alunoalt";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed277_i_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed277_i_usuario"])){
       $sql  .= $virgula." ed277_i_usuario = $this->ed277_i_usuario ";
       $virgula = ",";
       if(trim((string) $this->ed277_i_usuario) == null ){
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "ed277_i_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed277_i_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed277_i_data"])){
       $sql  .= $virgula." ed277_i_data = $this->ed277_i_data ";
       $virgula = ",";
       if(trim((string) $this->ed277_i_data) == null ){
         $this->erro_sql = " Campo Data/Hora nao Informado.";
         $this->erro_campo = "ed277_i_data";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed277_i_codigo"]) || $this->ed277_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2495,14189,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed277_i_codigo'))."','$this->ed277_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed277_i_alunoalt"]) || $this->ed277_i_alunoalt != "")
           $resac = db_query("insert into db_acount values($acount,2495,14190,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed277_i_alunoalt'))."','$this->ed277_i_alunoalt',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed277_i_usuario"]) || $this->ed277_i_usuario != "")
           $resac = db_query("insert into db_acount values($acount,2495,14191,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed277_i_usuario'))."','$this->ed277_i_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed277_i_data"]) || $this->ed277_i_data != "")
           $resac = db_query("insert into db_acount values($acount,2495,14192,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed277_i_data'))."','$this->ed277_i_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($ed277_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2495,14189,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed277_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2495,14190,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed277_i_alunoalt'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2495,14191,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed277_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2495,14192,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed277_i_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
