...
class cl_far_tiporeceitapadrao { 
   ...
   public $fa42_i_codigo = 0; 
   public $fa42_i_tiporeceita = 0; 
   public $fa42_i_departamento = 0; 
   ...
   function incluir ($fa42_i_codigo){ 
     ...
     if($fa42_i_codigo == "" || $fa42_i_codigo == null ){
       ...
       $this->fa42_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_tiporeceitapadrao_fa42_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa42_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2953,16771,'','".AddSlashes(pg_fetch_result($resaco,0,'fa42_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2953,16772,'','".AddSlashes(pg_fetch_result($resaco,0,'fa42_i_tiporeceita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2953,16773,'','".AddSlashes(pg_fetch_result($resaco,0,'fa42_i_departamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa42_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa42_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa42_i_codigo"])){ 
       $sql  .= $virgula." fa42_i_codigo = $this->fa42_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa42_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa42_i_tiporeceita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa42_i_tiporeceita"])){ 
       $sql  .= $virgula." fa42_i_tiporeceita = $this->fa42_i_tiporeceita ";
       $virgula = ",";
       if(trim((string) $this->fa42_i_tiporeceita) == null ){ 
         $this->erro_sql = " Campo Tipo de Receita nao Informado.";
         $this->erro_campo = "fa42_i_tiporeceita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa42_i_departamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa42_i_departamento"])){ 
       $sql  .= $virgula." fa42_i_departamento = $this->fa42_i_departamento ";
       $virgula = ",";
       if(trim((string) $this->fa42_i_departamento) == null ){ 
         $this->erro_sql = " Campo Departamento nao Informado.";
         $this->erro_campo = "fa42_i_departamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa42_i_codigo"]) || $this->fa42_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2953,16771,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa42_i_codigo'))."','$this->fa42_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa42_i_tiporeceita"]) || $this->fa42_i_tiporeceita != "")
           $resac = db_query("insert into db_acount values($acount,2953,16772,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa42_i_tiporeceita'))."','$this->fa42_i_tiporeceita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa42_i_departamento"]) || $this->fa42_i_departamento != "")
           $resac = db_query("insert into db_acount values($acount,2953,16773,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa42_i_departamento'))."','$this->fa42_i_departamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa42_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2953,16771,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa42_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2953,16772,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa42_i_tiporeceita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2953,16773,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa42_i_departamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
