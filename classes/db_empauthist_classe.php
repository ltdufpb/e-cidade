...
class cl_empauthist { 
   ...
   function incluir ($e57_autori){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,887,5588,'','".AddSlashes(pg_fetch_result($resaco,0,'e57_autori'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,887,5589,'','".AddSlashes(pg_fetch_result($resaco,0,'e57_codhist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e57_autori=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e57_autori)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e57_autori"])){ 
       $sql  .= $virgula." e57_autori = $this->e57_autori ";
       $virgula = ",";
       if(trim((string) $this->e57_autori) == null ){ 
     ...
     if(trim((string) $this->e57_codhist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e57_codhist"])){ 
       $sql  .= $virgula." e57_codhist = $this->e57_codhist ";
       $virgula = ",";
       if(trim((string) $this->e57_codhist) == null ){ 
         $this->erro_sql = " Campo Histórico nao Informado.";
         $this->erro_campo = "e57_codhist";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e57_autori"]))
           $resac = db_query("insert into db_acount values($acount,887,5588,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e57_autori'))."','$this->e57_autori',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e57_codhist"]))
           $resac = db_query("insert into db_acount values($acount,887,5589,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e57_codhist'))."','$this->e57_codhist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e57_autori=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,887,5588,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e57_autori'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,887,5589,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e57_codhist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
