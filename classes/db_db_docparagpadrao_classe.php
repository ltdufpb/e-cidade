...
class cl_db_docparagpadrao { 
   ...
   public $db62_coddoc = 0; 
   public $db62_codparag = 0; 
   public $db62_ordem = 0; 
   ...
   function incluir ($db62_coddoc,$db62_codparag){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1570,9167,'','".AddSlashes(pg_fetch_result($resaco,0,'db62_coddoc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1570,9168,'','".AddSlashes(pg_fetch_result($resaco,0,'db62_codparag'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1570,9169,'','".AddSlashes(pg_fetch_result($resaco,0,'db62_ordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db62_coddoc=null,$db62_codparag=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db62_coddoc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db62_coddoc"])){ 
       $sql  .= $virgula." db62_coddoc = $this->db62_coddoc ";
       $virgula = ",";
       if(trim((string) $this->db62_coddoc) == null ){ 
     ...
     if(trim((string) $this->db62_codparag)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db62_codparag"])){ 
       $sql  .= $virgula." db62_codparag = $this->db62_codparag ";
       $virgula = ",";
       if(trim((string) $this->db62_codparag) == null ){ 
     ...
     if(trim((string) $this->db62_ordem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db62_ordem"])){ 
       $sql  .= $virgula." db62_ordem = $this->db62_ordem ";
       $virgula = ",";
       if(trim((string) $this->db62_ordem) == null ){ 
         $this->erro_sql = " Campo Ordem do Parágrafo nao Informado.";
         $this->erro_campo = "db62_ordem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db62_coddoc"]))
           $resac = db_query("insert into db_acount values($acount,1570,9167,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db62_coddoc'))."','$this->db62_coddoc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db62_codparag"]))
           $resac = db_query("insert into db_acount values($acount,1570,9168,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db62_codparag'))."','$this->db62_codparag',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db62_ordem"]))
           $resac = db_query("insert into db_acount values($acount,1570,9169,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db62_ordem'))."','$this->db62_ordem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db62_coddoc=null,$db62_codparag=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1570,9167,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db62_coddoc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1570,9168,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db62_codparag'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1570,9169,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db62_ordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
