...
class cl_tfd_tipotratamentodoc { 
   ...
   public $tf06_i_codigo = 0; 
   public $tf06_i_tipotratamento = 0; 
   public $tf06_i_documento = 0; 
   public $tf06_i_obrigatorio = 0; 
   ...
   function incluir ($tf06_i_codigo){ 
     ...
     if($tf06_i_codigo == "" || $tf06_i_codigo == null ){
       ...
       $this->tf06_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tfd_tipotratamentodoc_tf06_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $tf06_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2862,16354,'','".AddSlashes(pg_fetch_result($resaco,0,'tf06_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2862,16356,'','".AddSlashes(pg_fetch_result($resaco,0,'tf06_i_tipotratamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2862,16355,'','".AddSlashes(pg_fetch_result($resaco,0,'tf06_i_documento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2862,16357,'','".AddSlashes(pg_fetch_result($resaco,0,'tf06_i_obrigatorio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($tf06_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->tf06_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf06_i_codigo"])){ 
       $sql  .= $virgula." tf06_i_codigo = $this->tf06_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->tf06_i_codigo) == null ){ 
     ...
     if(trim((string) $this->tf06_i_tipotratamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf06_i_tipotratamento"])){ 
       $sql  .= $virgula." tf06_i_tipotratamento = $this->tf06_i_tipotratamento ";
       $virgula = ",";
       if(trim((string) $this->tf06_i_tipotratamento) == null ){ 
         $this->erro_sql = " Campo Tipo de Tratamento nao Informado.";
         $this->erro_campo = "tf06_i_tipotratamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tf06_i_documento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf06_i_documento"])){ 
       $sql  .= $virgula." tf06_i_documento = $this->tf06_i_documento ";
       $virgula = ",";
       if(trim((string) $this->tf06_i_documento) == null ){ 
         $this->erro_sql = " Campo Documento nao Informado.";
         $this->erro_campo = "tf06_i_documento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->tf06_i_obrigatorio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["tf06_i_obrigatorio"])){ 
       $sql  .= $virgula." tf06_i_obrigatorio = $this->tf06_i_obrigatorio ";
       $virgula = ",";
       if(trim((string) $this->tf06_i_obrigatorio) == null ){ 
         $this->erro_sql = " Campo Obrigatório nao Informado.";
         $this->erro_campo = "tf06_i_obrigatorio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf06_i_codigo"]) || $this->tf06_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2862,16354,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf06_i_codigo'))."','$this->tf06_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf06_i_tipotratamento"]) || $this->tf06_i_tipotratamento != "")
           $resac = db_query("insert into db_acount values($acount,2862,16356,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf06_i_tipotratamento'))."','$this->tf06_i_tipotratamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf06_i_documento"]) || $this->tf06_i_documento != "")
           $resac = db_query("insert into db_acount values($acount,2862,16355,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf06_i_documento'))."','$this->tf06_i_documento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["tf06_i_obrigatorio"]) || $this->tf06_i_obrigatorio != "")
           $resac = db_query("insert into db_acount values($acount,2862,16357,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'tf06_i_obrigatorio'))."','$this->tf06_i_obrigatorio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($tf06_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2862,16354,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf06_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2862,16356,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf06_i_tipotratamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2862,16355,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf06_i_documento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2862,16357,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'tf06_i_obrigatorio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
