...
class cl_far_medreferenciamed { 
   ...
   public $fa34_i_codigo = 0; 
   public $fa34_i_medanvisa = 0; 
   public $fa34_i_medreferencia = 0; 
   ...
   function incluir ($fa34_i_codigo){ 
     ...
     if($fa34_i_codigo == "" || $fa34_i_codigo == null ){
       ...
       $this->fa34_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_medreferenciamed_fa34_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa34_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2527,14358,'','".AddSlashes(pg_fetch_result($resaco,0,'fa34_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2527,14359,'','".AddSlashes(pg_fetch_result($resaco,0,'fa34_i_medanvisa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2527,14360,'','".AddSlashes(pg_fetch_result($resaco,0,'fa34_i_medreferencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa34_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa34_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa34_i_codigo"])){ 
       $sql  .= $virgula." fa34_i_codigo = $this->fa34_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa34_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa34_i_medanvisa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa34_i_medanvisa"])){ 
       $sql  .= $virgula." fa34_i_medanvisa = $this->fa34_i_medanvisa ";
       $virgula = ",";
       if(trim((string) $this->fa34_i_medanvisa) == null ){ 
         $this->erro_sql = " Campo Medanvisa nao Informado.";
         $this->erro_campo = "fa34_i_medanvisa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa34_i_medreferencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa34_i_medreferencia"])){ 
       $sql  .= $virgula." fa34_i_medreferencia = $this->fa34_i_medreferencia ";
       $virgula = ",";
       if(trim((string) $this->fa34_i_medreferencia) == null ){ 
         $this->erro_sql = " Campo med referencia nao Informado.";
         $this->erro_campo = "fa34_i_medreferencia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa34_i_codigo"]) || $this->fa34_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2527,14358,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa34_i_codigo'))."','$this->fa34_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa34_i_medanvisa"]) || $this->fa34_i_medanvisa != "")
           $resac = db_query("insert into db_acount values($acount,2527,14359,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa34_i_medanvisa'))."','$this->fa34_i_medanvisa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa34_i_medreferencia"]) || $this->fa34_i_medreferencia != "")
           $resac = db_query("insert into db_acount values($acount,2527,14360,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa34_i_medreferencia'))."','$this->fa34_i_medreferencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa34_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2527,14358,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa34_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2527,14359,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa34_i_medanvisa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2527,14360,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa34_i_medreferencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
