...
class cl_corchequecgm { 
   ...
   function incluir ($k12_codcorcheque){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1690,9835,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_codcorcheque'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1690,9848,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k12_codcorcheque=null) { 
     ...
     if(trim((string) $this->k12_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k12_numcgm"])){ 
       $sql  .= $virgula." k12_numcgm = $this->k12_numcgm ";
       $virgula = ",";
       if(trim((string) $this->k12_numcgm) == null ){ 
         $this->erro_sql = " Campo Numcgm nao Informado.";
         $this->erro_campo = "k12_numcgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_codcorcheque"]))
           $resac = db_query("insert into db_acount values($acount,1690,9835,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_codcorcheque'))."','$this->k12_codcorcheque',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,1690,9848,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_numcgm'))."','$this->k12_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k12_codcorcheque=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1690,9835,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_codcorcheque'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1690,9848,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
