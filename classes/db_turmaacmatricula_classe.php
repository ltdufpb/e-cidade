...
class cl_turmaacmatricula {
	...
	public $ed269_i_codigo = 0;
	public $ed269_i_turmaac = 0;
	public $ed269_d_data_dia = null;
	public $ed269_d_data_mes = null;
	public $ed269_d_data_ano = null;
	public $ed269_d_data = null;
	public $ed269_aluno = 0;
	public $iTipoAtendimento = 0;
	public $iQuantidadeDeNecessidade = 0;
	public $iCodigoAluno = null;
	...
	function incluir ($ed269_i_codigo){
		...
		if($this->ed269_aluno != null ){
			...
			$iTipoAtendimento = pg_fetch_result($result,0,0);
			if($iTipoAtendimento == 5){
				...
				$iQuantidadeDeNecessidade = pg_fetch_result($result,0,0);
		...
		if($ed269_i_codigo == "" || $ed269_i_codigo == null ){
			...
			$this->ed269_i_codigo = pg_fetch_result($result,0,0);
		}else{
			$result = db_query("select last_value from turmaacmatricula_ed269_i_codigo_seq");
			if(($result != false) && (pg_fetch_result($result,0,0) < $ed269_i_codigo)){
		...
		if(($resaco!=false)||($this->numrows!=0)){
			...
			$resac = db_query("insert into db_acount values($acount,2417,13836,'','".AddSlashes(pg_fetch_result($resaco,0,'ed269_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			$resac = db_query("insert into db_acount values($acount,2417,13837,'','".AddSlashes(pg_fetch_result($resaco,0,'ed269_i_turmaac'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			$resac = db_query("insert into db_acount values($acount,2417,13839,'','".AddSlashes(pg_fetch_result($resaco,0,'ed269_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			$resac = db_query("insert into db_acount values($acount,2417,19741,'','".AddSlashes(pg_fetch_result($resaco,0,'ed269_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
		}
		return true;
	}
	...
	function alterar ($ed269_i_codigo=null) {
		...
		$virgula = "";
		if(trim((string) $this->ed269_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed269_i_codigo"])){
			$sql  .= $virgula." ed269_i_codigo = $this->ed269_i_codigo ";
			$virgula = ",";
			if(trim((string) $this->ed269_i_codigo) == null ){
		...
		if(trim((string) $this->ed269_i_turmaac)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed269_i_turmaac"])){
			$sql  .= $virgula." ed269_i_turmaac = $this->ed269_i_turmaac ";
			$virgula = ",";
			if(trim((string) $this->ed269_i_turmaac) == null ){
		...
		if(trim((string) $this->ed269_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed269_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed269_d_data_dia"] !="") ){
			$sql  .= $virgula." ed269_d_data = '$this->ed269_d_data' ";
			$virgula = ",";
			if(trim((string) $this->ed269_d_data) == null ){
				$this->erro_sql = " Campo Data de Inclusão não Informado.";
				$this->erro_campo = "ed269_d_data_dia";
				$this->erro_banco = "";
				$this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
		...
		if(trim((string) $this->ed269_aluno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed269_aluno"])){
			$sql  .= $virgula." ed269_aluno = $this->ed269_aluno ";
			$virgula = ",";
			if(trim((string) $this->ed269_aluno) == null ){
				$this->erro_sql = " Campo Código do Aluno não Informado.";
				$this->erro_campo = "ed269_aluno";
				$this->erro_banco = "";
				$this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
		...
		if($this->numrows>0){
			for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
				...
				if(isset($GLOBALS["HTTP_POST_VARS"]["ed269_i_codigo"]) || $this->ed269_i_codigo != "")
					$resac = db_query("insert into db_acount values($acount,2417,13836,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed269_i_codigo'))."','$this->ed269_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				if(isset($GLOBALS["HTTP_POST_VARS"]["ed269_i_turmaac"]) || $this->ed269_i_turmaac != "")
					$resac = db_query("insert into db_acount values($acount,2417,13837,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed269_i_turmaac'))."','$this->ed269_i_turmaac',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				if(isset($GLOBALS["HTTP_POST_VARS"]["ed269_d_data"]) || $this->ed269_d_data != "")
					$resac = db_query("insert into db_acount values($acount,2417,13839,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed269_d_data'))."','$this->ed269_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				if(isset($GLOBALS["HTTP_POST_VARS"]["ed269_aluno"]) || $this->ed269_aluno != "")
					$resac = db_query("insert into db_acount values($acount,2417,19741,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed269_aluno'))."','$this->ed269_aluno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			}
		}
		$result = db_query($sql);
		if($result==false){
	...
	function excluir ($ed269_i_codigo=null,$dbwhere=null) {
		...
		if(($resaco!=false)||($this->numrows!=0)){
			for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
				...
				$resac = db_query("insert into db_acount values($acount,2417,13836,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed269_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				$resac = db_query("insert into db_acount values($acount,2417,13837,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed269_i_turmaac'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				$resac = db_query("insert into db_acount values($acount,2417,13839,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed269_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				$resac = db_query("insert into db_acount values($acount,2417,19741,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed269_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			}
		}
