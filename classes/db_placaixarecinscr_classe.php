...
class cl_placaixarecinscr { 
   ...
   public $k76_sequencial = 0; 
   public $k76_placaixarec = 0; 
   public $k76_inscr = 0; 
   ...
   function incluir ($k76_sequencial){ 
     ...
     if($k76_sequencial == "" || $k76_sequencial == null ){
       ...
       $this->k76_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from placaixarecinscr_k76_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k76_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2044,11826,'','".AddSlashes(pg_fetch_result($resaco,0,'k76_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2044,11827,'','".AddSlashes(pg_fetch_result($resaco,0,'k76_placaixarec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2044,11828,'','".AddSlashes(pg_fetch_result($resaco,0,'k76_inscr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k76_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k76_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k76_sequencial"])){ 
       $sql  .= $virgula." k76_sequencial = $this->k76_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k76_sequencial) == null ){ 
     ...
     if(trim((string) $this->k76_placaixarec)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k76_placaixarec"])){ 
       $sql  .= $virgula." k76_placaixarec = $this->k76_placaixarec ";
       $virgula = ",";
       if(trim((string) $this->k76_placaixarec) == null ){ 
         $this->erro_sql = " Campo Receita da Planilha nao Informado.";
         $this->erro_campo = "k76_placaixarec";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k76_inscr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k76_inscr"])){ 
       $sql  .= $virgula." k76_inscr = $this->k76_inscr ";
       $virgula = ",";
       if(trim((string) $this->k76_inscr) == null ){ 
         $this->erro_sql = " Campo Inscrição Municipal nao Informado.";
         $this->erro_campo = "k76_inscr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k76_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2044,11826,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k76_sequencial'))."','$this->k76_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k76_placaixarec"]))
           $resac = db_query("insert into db_acount values($acount,2044,11827,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k76_placaixarec'))."','$this->k76_placaixarec',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k76_inscr"]))
           $resac = db_query("insert into db_acount values($acount,2044,11828,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k76_inscr'))."','$this->k76_inscr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k76_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2044,11826,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k76_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2044,11827,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k76_placaixarec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2044,11828,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k76_inscr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
