...
class cl_datadebitos { 
   ...
   public $k115_sequencial = 0; 
   public $k115_data_dia = null; 
   public $k115_data_mes = null; 
   public $k115_data_ano = null; 
   public $k115_data = null; 
   public $k115_instit = 0; 
   ...
   function incluir ($k115_sequencial){ 
     ...
     if($k115_sequencial == "" || $k115_sequencial == null ){
       ...
       $this->k115_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from datadebitos_k115_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k115_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2580,14666,'','".AddSlashes(pg_fetch_result($resaco,0,'k115_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2580,14667,'','".AddSlashes(pg_fetch_result($resaco,0,'k115_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2580,14668,'','".AddSlashes(pg_fetch_result($resaco,0,'k115_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k115_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k115_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k115_sequencial"])){ 
       $sql  .= $virgula." k115_sequencial = $this->k115_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k115_sequencial) == null ){ 
     ...
     if(trim((string) $this->k115_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k115_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["k115_data_dia"] !="") ){ 
       $sql  .= $virgula." k115_data = '$this->k115_data' ";
       $virgula = ",";
       if(trim((string) $this->k115_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "k115_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k115_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k115_instit"])){ 
       $sql  .= $virgula." k115_instit = $this->k115_instit ";
       $virgula = ",";
       if(trim((string) $this->k115_instit) == null ){ 
         $this->erro_sql = " Campo Instituição nao Informado.";
         $this->erro_campo = "k115_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k115_sequencial"]) || $this->k115_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2580,14666,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k115_sequencial'))."','$this->k115_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k115_data"]) || $this->k115_data != "")
           $resac = db_query("insert into db_acount values($acount,2580,14667,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k115_data'))."','$this->k115_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k115_instit"]) || $this->k115_instit != "")
           $resac = db_query("insert into db_acount values($acount,2580,14668,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k115_instit'))."','$this->k115_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k115_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2580,14666,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k115_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2580,14667,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k115_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2580,14668,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k115_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
