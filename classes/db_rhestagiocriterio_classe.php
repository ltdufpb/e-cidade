...
class cl_rhestagiocriterio { 
   ...
   public $h52_sequencial = 0; 
   public $h52_rhestagio = 0; 
   public $h52_descr = null; 
   public $h52_pontos = 0; 
   ...
   function incluir ($h52_sequencial){ 
     ...
     if($h52_sequencial == "" || $h52_sequencial == null ){
       ...
       $this->h52_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhestagiocriterio_h52_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h52_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1869,10857,'','".AddSlashes(pg_fetch_result($resaco,0,'h52_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1869,10858,'','".AddSlashes(pg_fetch_result($resaco,0,'h52_rhestagio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1869,10856,'','".AddSlashes(pg_fetch_result($resaco,0,'h52_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1869,10859,'','".AddSlashes(pg_fetch_result($resaco,0,'h52_pontos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h52_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h52_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h52_sequencial"])){ 
       $sql  .= $virgula." h52_sequencial = $this->h52_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h52_sequencial) == null ){ 
     ...
     if(trim((string) $this->h52_rhestagio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h52_rhestagio"])){ 
       $sql  .= $virgula." h52_rhestagio = $this->h52_rhestagio ";
       $virgula = ",";
       if(trim((string) $this->h52_rhestagio) == null ){ 
         $this->erro_sql = " Campo Cód. Estágio nao Informado.";
         $this->erro_campo = "h52_rhestagio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h52_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h52_descr"])){ 
       $sql  .= $virgula." h52_descr = '$this->h52_descr' ";
       $virgula = ",";
       if(trim((string) $this->h52_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "h52_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h52_pontos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h52_pontos"])){ 
       $sql  .= $virgula." h52_pontos = $this->h52_pontos ";
       $virgula = ",";
       if(trim((string) $this->h52_pontos) == null ){ 
         $this->erro_sql = " Campo Pontos nao Informado.";
         $this->erro_campo = "h52_pontos";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h52_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1869,10857,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h52_sequencial'))."','$this->h52_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h52_rhestagio"]))
           $resac = db_query("insert into db_acount values($acount,1869,10858,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h52_rhestagio'))."','$this->h52_rhestagio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h52_descr"]))
           $resac = db_query("insert into db_acount values($acount,1869,10856,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h52_descr'))."','$this->h52_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h52_pontos"]))
           $resac = db_query("insert into db_acount values($acount,1869,10859,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h52_pontos'))."','$this->h52_pontos',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h52_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1869,10857,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h52_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1869,10858,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h52_rhestagio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1869,10856,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h52_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1869,10859,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h52_pontos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
