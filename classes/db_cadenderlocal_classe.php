...
class cl_cadenderlocal { 
   ...
   public $db75_sequencial = 0; 
   public $db75_cadenderbairrocadenderrua = 0; 
   public $db75_numero = null; 
   ...
   function incluir ($db75_sequencial){ 
     ...
     if($db75_sequencial == "" || $db75_sequencial == null ){
       ...
       $this->db75_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cadenderlocal_db75_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db75_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2784,15865,'','".AddSlashes(pg_fetch_result($resaco,0,'db75_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2784,16580,'','".AddSlashes(pg_fetch_result($resaco,0,'db75_cadenderbairrocadenderrua'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2784,15868,'','".AddSlashes(pg_fetch_result($resaco,0,'db75_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db75_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db75_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db75_sequencial"])){ 
       $sql  .= $virgula." db75_sequencial = $this->db75_sequencial ";
       $virgula = ",";
       if(trim((string) $this->db75_sequencial) == null ){ 
     ...
     if(trim((string) $this->db75_cadenderbairrocadenderrua)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db75_cadenderbairrocadenderrua"])){ 
       $sql  .= $virgula." db75_cadenderbairrocadenderrua = $this->db75_cadenderbairrocadenderrua ";
       $virgula = ",";
       if(trim((string) $this->db75_cadenderbairrocadenderrua) == null ){ 
         $this->erro_sql = " Campo Codigo bairro rua nao Informado.";
         $this->erro_campo = "db75_cadenderbairrocadenderrua";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db75_numero)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db75_numero"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db75_sequencial"]) || $this->db75_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2784,15865,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db75_sequencial'))."','$this->db75_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db75_cadenderbairrocadenderrua"]) || $this->db75_cadenderbairrocadenderrua != "")
           $resac = db_query("insert into db_acount values($acount,2784,16580,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db75_cadenderbairrocadenderrua'))."','$this->db75_cadenderbairrocadenderrua',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db75_numero"]) || $this->db75_numero != "")
           $resac = db_query("insert into db_acount values($acount,2784,15868,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db75_numero'))."','$this->db75_numero',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db75_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2784,15865,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db75_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2784,16580,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db75_cadenderbairrocadenderrua'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2784,15868,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db75_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
