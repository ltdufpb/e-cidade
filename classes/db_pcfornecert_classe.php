...
class cl_pcfornecert { 
   ...
   public $pc61_numcgm = 0; 
   public $pc61_certif = 0; 
   public $pc61_vencim_dia = null; 
   public $pc61_vencim_mes = null; 
   public $pc61_vencim_ano = null; 
   public $pc61_vencim = null; 
   public $pc61_obs = null; 
   ...
   function incluir ($pc61_numcgm,$pc61_certif){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,961,5990,'','".AddSlashes(pg_fetch_result($resaco,0,'pc61_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,961,5994,'','".AddSlashes(pg_fetch_result($resaco,0,'pc61_certif'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,961,5995,'','".AddSlashes(pg_fetch_result($resaco,0,'pc61_vencim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,961,5996,'','".AddSlashes(pg_fetch_result($resaco,0,'pc61_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc61_numcgm=null,$pc61_certif=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc61_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc61_numcgm"])){ 
       $sql  .= $virgula." pc61_numcgm = $this->pc61_numcgm ";
       $virgula = ",";
       if(trim((string) $this->pc61_numcgm) == null ){ 
     ...
     if(trim((string) $this->pc61_certif)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc61_certif"])){ 
       $sql  .= $virgula." pc61_certif = $this->pc61_certif ";
       $virgula = ",";
       if(trim((string) $this->pc61_certif) == null ){ 
     ...
     if(trim((string) $this->pc61_vencim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc61_vencim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["pc61_vencim_dia"] !="") ){ 
       $sql  .= $virgula." pc61_vencim = '$this->pc61_vencim' ";
       $virgula = ",";
       if(trim((string) $this->pc61_vencim) == null ){ 
         $this->erro_sql = " Campo Vencimento nao Informado.";
         $this->erro_campo = "pc61_vencim_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc61_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc61_obs"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc61_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,961,5990,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc61_numcgm'))."','$this->pc61_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc61_certif"]))
           $resac = db_query("insert into db_acount values($acount,961,5994,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc61_certif'))."','$this->pc61_certif',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc61_vencim"]))
           $resac = db_query("insert into db_acount values($acount,961,5995,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc61_vencim'))."','$this->pc61_vencim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc61_obs"]))
           $resac = db_query("insert into db_acount values($acount,961,5996,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc61_obs'))."','$this->pc61_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc61_numcgm=null,$pc61_certif=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,961,5990,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc61_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,961,5994,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc61_certif'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,961,5995,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc61_vencim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,961,5996,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc61_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
