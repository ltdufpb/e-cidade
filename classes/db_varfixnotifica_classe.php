...
class cl_varfixnotifica { 
   ...
   public $q37_sequence = 0; 
   public $q37_varfix = 0; 
   public $q37_notifica = 0; 
   ...
   function incluir ($q37_sequence){ 
     ...
     if($q37_sequence == "" || $q37_sequence == null ){
       ...
       $this->q37_sequence = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from varfixnotifica_q37_sequence_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q37_sequence)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1615,9397,'','".AddSlashes(pg_fetch_result($resaco,0,'q37_sequence'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1615,9398,'','".AddSlashes(pg_fetch_result($resaco,0,'q37_varfix'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1615,9399,'','".AddSlashes(pg_fetch_result($resaco,0,'q37_notifica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q37_sequence=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q37_sequence)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q37_sequence"])){ 
       $sql  .= $virgula." q37_sequence = $this->q37_sequence ";
       $virgula = ",";
       if(trim((string) $this->q37_sequence) == null ){ 
     ...
     if(trim((string) $this->q37_varfix)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q37_varfix"])){ 
       $sql  .= $virgula." q37_varfix = $this->q37_varfix ";
       $virgula = ",";
       if(trim((string) $this->q37_varfix) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
         $this->erro_campo = "q37_varfix";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q37_notifica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q37_notifica"])){ 
       $sql  .= $virgula." q37_notifica = $this->q37_notifica ";
       $virgula = ",";
       if(trim((string) $this->q37_notifica) == null ){ 
         $this->erro_sql = " Campo Código da Notificação nao Informado.";
         $this->erro_campo = "q37_notifica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q37_sequence"]))
           $resac = db_query("insert into db_acount values($acount,1615,9397,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q37_sequence'))."','$this->q37_sequence',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q37_varfix"]))
           $resac = db_query("insert into db_acount values($acount,1615,9398,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q37_varfix'))."','$this->q37_varfix',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q37_notifica"]))
           $resac = db_query("insert into db_acount values($acount,1615,9399,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q37_notifica'))."','$this->q37_notifica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q37_sequence=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1615,9397,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q37_sequence'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1615,9398,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q37_varfix'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1615,9399,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q37_notifica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
