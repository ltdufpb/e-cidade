...
class cl_atenditemproced { 
   ...
   public $at24_sequencial = 0; 
   public $at24_atenditem = 0; 
   public $at24_proced = 0; 
   ...
   function incluir ($at24_sequencial){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1677,9783,'','".AddSlashes(pg_fetch_result($resaco,0,'at24_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1677,9785,'','".AddSlashes(pg_fetch_result($resaco,0,'at24_atenditem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1677,9784,'','".AddSlashes(pg_fetch_result($resaco,0,'at24_proced'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at24_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at24_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at24_sequencial"])){ 
       $sql  .= $virgula." at24_sequencial = $this->at24_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at24_sequencial) == null ){ 
     ...
     if(trim((string) $this->at24_atenditem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at24_atenditem"])){ 
       $sql  .= $virgula." at24_atenditem = $this->at24_atenditem ";
       $virgula = ",";
       if(trim((string) $this->at24_atenditem) == null ){ 
         $this->erro_sql = " Campo Atendimento nao Informado.";
         $this->erro_campo = "at24_atenditem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at24_proced)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at24_proced"])){ 
       $sql  .= $virgula." at24_proced = $this->at24_proced ";
       $virgula = ",";
       if(trim((string) $this->at24_proced) == null ){ 
         $this->erro_sql = " Campo Procedimento nao Informado.";
         $this->erro_campo = "at24_proced";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at24_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1677,9783,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at24_sequencial'))."','$this->at24_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at24_atenditem"]))
           $resac = db_query("insert into db_acount values($acount,1677,9785,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at24_atenditem'))."','$this->at24_atenditem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at24_proced"]))
           $resac = db_query("insert into db_acount values($acount,1677,9784,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at24_proced'))."','$this->at24_proced',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at24_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1677,9783,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at24_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1677,9785,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at24_atenditem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1677,9784,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at24_proced'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
