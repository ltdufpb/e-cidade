...
class cl_vac_doseperiodica { 
   ...
   public $vc14_i_codigo = 0; 
   public $vc14_i_vacinadose = 0; 
   public $vc14_i_faixadia = 0; 
   public $vc14_i_faixames = 0; 
   public $vc14_i_faixaano = 0; 
   ...
   function incluir ($vc14_i_codigo){ 
     ...
     if($vc14_i_codigo == "" || $vc14_i_codigo == null ){
       ...
       $this->vc14_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from vac_doseperiodica_vc14_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $vc14_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2968,16862,'','".AddSlashes(pg_fetch_result($resaco,0,'vc14_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2968,16863,'','".AddSlashes(pg_fetch_result($resaco,0,'vc14_i_vacinadose'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2968,16864,'','".AddSlashes(pg_fetch_result($resaco,0,'vc14_i_faixadia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2968,16865,'','".AddSlashes(pg_fetch_result($resaco,0,'vc14_i_faixames'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2968,16866,'','".AddSlashes(pg_fetch_result($resaco,0,'vc14_i_faixaano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($vc14_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->vc14_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc14_i_codigo"])){ 
       $sql  .= $virgula." vc14_i_codigo = $this->vc14_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->vc14_i_codigo) == null ){ 
     ...
     if(trim((string) $this->vc14_i_vacinadose)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc14_i_vacinadose"])){ 
       $sql  .= $virgula." vc14_i_vacinadose = $this->vc14_i_vacinadose ";
       $virgula = ",";
       if(trim((string) $this->vc14_i_vacinadose) == null ){ 
         $this->erro_sql = " Campo Vacina nao Informado.";
         $this->erro_campo = "vc14_i_vacinadose";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc14_i_faixadia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc14_i_faixadia"])){ 
       $sql  .= $virgula." vc14_i_faixadia = $this->vc14_i_faixadia ";
       $virgula = ",";
       if(trim((string) $this->vc14_i_faixadia) == null ){ 
         $this->erro_sql = " Campo Faixa dias nao Informado.";
         $this->erro_campo = "vc14_i_faixadia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc14_i_faixames)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc14_i_faixames"])){ 
       $sql  .= $virgula." vc14_i_faixames = $this->vc14_i_faixames ";
       $virgula = ",";
       if(trim((string) $this->vc14_i_faixames) == null ){ 
         $this->erro_sql = " Campo Faixa mes nao Informado.";
         $this->erro_campo = "vc14_i_faixames";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc14_i_faixaano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc14_i_faixaano"])){ 
       $sql  .= $virgula." vc14_i_faixaano = $this->vc14_i_faixaano ";
       $virgula = ",";
       if(trim((string) $this->vc14_i_faixaano) == null ){ 
         $this->erro_sql = " Campo Faixa ano nao Informado.";
         $this->erro_campo = "vc14_i_faixaano";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc14_i_codigo"]) || $this->vc14_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2968,16862,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc14_i_codigo'))."','$this->vc14_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc14_i_vacinadose"]) || $this->vc14_i_vacinadose != "")
           $resac = db_query("insert into db_acount values($acount,2968,16863,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc14_i_vacinadose'))."','$this->vc14_i_vacinadose',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc14_i_faixadia"]) || $this->vc14_i_faixadia != "")
           $resac = db_query("insert into db_acount values($acount,2968,16864,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc14_i_faixadia'))."','$this->vc14_i_faixadia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc14_i_faixames"]) || $this->vc14_i_faixames != "")
           $resac = db_query("insert into db_acount values($acount,2968,16865,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc14_i_faixames'))."','$this->vc14_i_faixames',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc14_i_faixaano"]) || $this->vc14_i_faixaano != "")
           $resac = db_query("insert into db_acount values($acount,2968,16866,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc14_i_faixaano'))."','$this->vc14_i_faixaano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($vc14_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2968,16862,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc14_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2968,16863,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc14_i_vacinadose'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2968,16864,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc14_i_faixadia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2968,16865,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc14_i_faixames'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2968,16866,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc14_i_faixaano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
