...
class cl_autoexec { 
   ...
   function incluir ($y15_codauto){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,734,5143,'','".AddSlashes(pg_fetch_result($resaco,0,'y15_codauto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,734,5144,'','".AddSlashes(pg_fetch_result($resaco,0,'y15_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,734,5145,'','".AddSlashes(pg_fetch_result($resaco,0,'y15_codi'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,734,5146,'','".AddSlashes(pg_fetch_result($resaco,0,'y15_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,734,5147,'','".AddSlashes(pg_fetch_result($resaco,0,'y15_compl'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y15_codauto=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y15_codauto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y15_codauto"])){ 
       $sql  .= $virgula." y15_codauto = $this->y15_codauto ";
       $virgula = ",";
       if(trim((string) $this->y15_codauto) == null ){ 
     ...
     if(trim((string) $this->y15_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y15_codigo"])){ 
       $sql  .= $virgula." y15_codigo = $this->y15_codigo ";
       $virgula = ",";
       if(trim((string) $this->y15_codigo) == null ){ 
         $this->erro_sql = " Campo cód. Rua/Avenida nao Informado.";
         $this->erro_campo = "y15_codigo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y15_codi)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y15_codi"])){ 
       $sql  .= $virgula." y15_codi = $this->y15_codi ";
       $virgula = ",";
       if(trim((string) $this->y15_codi) == null ){ 
         $this->erro_sql = " Campo Bairro nao Informado.";
         $this->erro_campo = "y15_codi";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y15_numero)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y15_numero"])){ 
       $sql  .= $virgula." y15_numero = $this->y15_numero ";
       $virgula = ",";
       if(trim((string) $this->y15_numero) == null ){ 
         $this->erro_sql = " Campo Número nao Informado.";
         $this->erro_campo = "y15_numero";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y15_compl)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y15_compl"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y15_codauto"]))
           $resac = db_query("insert into db_acount values($acount,734,5143,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y15_codauto'))."','$this->y15_codauto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y15_codigo"]))
           $resac = db_query("insert into db_acount values($acount,734,5144,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y15_codigo'))."','$this->y15_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y15_codi"]))
           $resac = db_query("insert into db_acount values($acount,734,5145,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y15_codi'))."','$this->y15_codi',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y15_numero"]))
           $resac = db_query("insert into db_acount values($acount,734,5146,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y15_numero'))."','$this->y15_numero',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y15_compl"]))
           $resac = db_query("insert into db_acount values($acount,734,5147,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y15_compl'))."','$this->y15_compl',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y15_codauto=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,734,5143,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y15_codauto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,734,5144,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y15_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,734,5145,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y15_codi'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,734,5146,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y15_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,734,5147,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y15_compl'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
