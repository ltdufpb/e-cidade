...
class cl_turmaacativnova {
   ...
   public $ed274_i_codigo = 0;
   public $ed274_i_turmaacativ = 0;
   public $ed274_c_nome = null;
   ...
   function incluir ($ed274_i_codigo){
     ...
     if($ed274_i_codigo == "" || $ed274_i_codigo == null ){
       ...
       $this->ed274_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from turmaacativnova_ed274_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed274_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2459,13995,'','".AddSlashes(pg_fetch_result($resaco,0,'ed274_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2459,13996,'','".AddSlashes(pg_fetch_result($resaco,0,'ed274_i_turmaacativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2459,13997,'','".AddSlashes(pg_fetch_result($resaco,0,'ed274_c_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($ed274_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->ed274_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed274_i_codigo"])){
       $sql  .= $virgula." ed274_i_codigo = $this->ed274_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed274_i_codigo) == null ){
     ...
     if(trim((string) $this->ed274_i_turmaacativ)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed274_i_turmaacativ"])){
       $sql  .= $virgula." ed274_i_turmaacativ = $this->ed274_i_turmaacativ ";
       $virgula = ",";
       if(trim((string) $this->ed274_i_turmaacativ) == null ){
         $this->erro_sql = " Campo Atividade da Turma nao Informado.";
         $this->erro_campo = "ed274_i_turmaacativ";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed274_c_nome)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed274_c_nome"])){
       $sql  .= $virgula." ed274_c_nome = '$this->ed274_c_nome' ";
       $virgula = ",";
       if(trim((string) $this->ed274_c_nome) == null ){
         $this->erro_sql = " Campo Nome da Outra Atividade nao Informado.";
         $this->erro_campo = "ed274_c_nome";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed274_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2459,13995,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed274_i_codigo'))."','$this->ed274_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed274_i_turmaacativ"]))
           $resac = db_query("insert into db_acount values($acount,2459,13996,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed274_i_turmaacativ'))."','$this->ed274_i_turmaacativ',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed274_c_nome"]))
           $resac = db_query("insert into db_acount values($acount,2459,13997,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed274_c_nome'))."','$this->ed274_c_nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($ed274_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2459,13995,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed274_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2459,13996,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed274_i_turmaacativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2459,13997,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed274_c_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
