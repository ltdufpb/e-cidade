...
class cl_cepbairros { 
   ...
   public $cp01_codlocalidade = 0; 
   public $cp01_bairro = null; 
   public $cp01_sigla = null; 
   public $cp01_codbairro = 0; 
   ...
   function incluir ($cp01_codbairro){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1192,7176,'','".AddSlashes(pg_fetch_result($resaco,0,'cp01_codlocalidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1192,7174,'','".AddSlashes(pg_fetch_result($resaco,0,'cp01_bairro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1192,7175,'','".AddSlashes(pg_fetch_result($resaco,0,'cp01_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1192,7173,'','".AddSlashes(pg_fetch_result($resaco,0,'cp01_codbairro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($cp01_codbairro=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->cp01_codlocalidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cp01_codlocalidade"])){ 
       $sql  .= $virgula." cp01_codlocalidade = $this->cp01_codlocalidade ";
       $virgula = ",";
       if(trim((string) $this->cp01_codlocalidade) == null ){ 
         $this->erro_sql = " Campo Codigo da Localidade nao Informado.";
         $this->erro_campo = "cp01_codlocalidade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cp01_bairro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cp01_bairro"])){ 
       $sql  .= $virgula." cp01_bairro = '$this->cp01_bairro' ";
       $virgula = ",";
       if(trim((string) $this->cp01_bairro) == null ){ 
         $this->erro_sql = " Campo Nome do bairro nao Informado.";
         $this->erro_campo = "cp01_bairro";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cp01_sigla)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cp01_sigla"])){ 
       $sql  .= $virgula." cp01_sigla = '$this->cp01_sigla' ";
       $virgula = ",";
       if(trim((string) $this->cp01_sigla) == null ){ 
         $this->erro_sql = " Campo Sigla nao Informado.";
         $this->erro_campo = "cp01_sigla";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cp01_codbairro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cp01_codbairro"])){ 
       $sql  .= $virgula." cp01_codbairro = $this->cp01_codbairro ";
       $virgula = ",";
       if(trim((string) $this->cp01_codbairro) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["cp01_codlocalidade"]))
           $resac = db_query("insert into db_acount values($acount,1192,7176,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cp01_codlocalidade'))."','$this->cp01_codlocalidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cp01_bairro"]))
           $resac = db_query("insert into db_acount values($acount,1192,7174,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cp01_bairro'))."','$this->cp01_bairro',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cp01_sigla"]))
           $resac = db_query("insert into db_acount values($acount,1192,7175,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cp01_sigla'))."','$this->cp01_sigla',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cp01_codbairro"]))
           $resac = db_query("insert into db_acount values($acount,1192,7173,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cp01_codbairro'))."','$this->cp01_codbairro',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($cp01_codbairro=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1192,7176,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cp01_codlocalidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1192,7174,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cp01_bairro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1192,7175,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cp01_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1192,7173,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cp01_codbairro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
