...
class cl_workflowativandpadrao { 
   ...
   public $db115_sequencial = 0; 
   public $db115_workflowativ = 0; 
   public $db115_codigo = 0; 
   public $db115_ordem = 0; 
   ...
   function incluir ($db115_sequencial){ 
     ...
     if($db115_sequencial == "" || $db115_sequencial == null ){
       ...
       $this->db115_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from workflowativandpadrao_db115_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db115_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3159,17891,'','".AddSlashes(pg_fetch_result($resaco,0,'db115_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3159,17892,'','".AddSlashes(pg_fetch_result($resaco,0,'db115_workflowativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3159,17894,'','".AddSlashes(pg_fetch_result($resaco,0,'db115_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3159,17893,'','".AddSlashes(pg_fetch_result($resaco,0,'db115_ordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db115_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db115_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db115_sequencial"])){ 
       $sql  .= $virgula." db115_sequencial = $this->db115_sequencial ";
       $virgula = ",";
       if(trim((string) $this->db115_sequencial) == null ){ 
     ...
     if(trim((string) $this->db115_workflowativ)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db115_workflowativ"])){ 
       $sql  .= $virgula." db115_workflowativ = $this->db115_workflowativ ";
       $virgula = ",";
       if(trim((string) $this->db115_workflowativ) == null ){ 
         $this->erro_sql = " Campo Código Work Flow Atividade nao Informado.";
         $this->erro_campo = "db115_workflowativ";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db115_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db115_codigo"])){ 
       $sql  .= $virgula." db115_codigo = $this->db115_codigo ";
       $virgula = ",";
       if(trim((string) $this->db115_codigo) == null ){ 
         $this->erro_sql = " Campo Código Andamento Padrão nao Informado.";
         $this->erro_campo = "db115_codigo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db115_ordem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db115_ordem"])){ 
       $sql  .= $virgula." db115_ordem = $this->db115_ordem ";
       $virgula = ",";
       if(trim((string) $this->db115_ordem) == null ){ 
         $this->erro_sql = " Campo Ordem Andamento Padrão nao Informado.";
         $this->erro_campo = "db115_ordem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db115_sequencial"]) || $this->db115_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3159,17891,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db115_sequencial'))."','$this->db115_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db115_workflowativ"]) || $this->db115_workflowativ != "")
           $resac = db_query("insert into db_acount values($acount,3159,17892,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db115_workflowativ'))."','$this->db115_workflowativ',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db115_codigo"]) || $this->db115_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3159,17894,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db115_codigo'))."','$this->db115_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db115_ordem"]) || $this->db115_ordem != "")
           $resac = db_query("insert into db_acount values($acount,3159,17893,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db115_ordem'))."','$this->db115_ordem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db115_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3159,17891,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db115_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3159,17892,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db115_workflowativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3159,17894,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db115_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3159,17893,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db115_ordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
