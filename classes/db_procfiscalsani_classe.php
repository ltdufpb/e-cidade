...
class cl_procfiscalsani { 
   ...
   function incluir ($y104_sequencial){ 
     ...
     if($y104_sequencial == "" || $y104_sequencial == null ){
       ...
       $this->y104_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from procfiscalsani_y104_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $y104_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2092,12063,'','".AddSlashes(pg_fetch_result($resaco,0,'y104_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2092,12064,'','".AddSlashes(pg_fetch_result($resaco,0,'y104_codsani'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2092,12065,'','".AddSlashes(pg_fetch_result($resaco,0,'y104_procfiscal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y104_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y104_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y104_sequencial"])){ 
       $sql  .= $virgula." y104_sequencial = $this->y104_sequencial ";
       $virgula = ",";
       if(trim((string) $this->y104_sequencial) == null ){ 
     ...
     if(trim((string) $this->y104_codsani)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y104_codsani"])){ 
       $sql  .= $virgula." y104_codsani = $this->y104_codsani ";
       $virgula = ",";
       if(trim((string) $this->y104_codsani) == null ){ 
         $this->erro_sql = " Campo Alvará Sanitário nao Informado.";
         $this->erro_campo = "y104_codsani";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y104_procfiscal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y104_procfiscal"])){ 
       $sql  .= $virgula." y104_procfiscal = $this->y104_procfiscal ";
       $virgula = ",";
       if(trim((string) $this->y104_procfiscal) == null ){ 
         $this->erro_sql = " Campo Processo Fiscal nao Informado.";
         $this->erro_campo = "y104_procfiscal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y104_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2092,12063,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y104_sequencial'))."','$this->y104_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y104_codsani"]))
           $resac = db_query("insert into db_acount values($acount,2092,12064,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y104_codsani'))."','$this->y104_codsani',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y104_procfiscal"]))
           $resac = db_query("insert into db_acount values($acount,2092,12065,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y104_procfiscal'))."','$this->y104_procfiscal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y104_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2092,12063,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y104_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2092,12064,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y104_codsani'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2092,12065,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y104_procfiscal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
