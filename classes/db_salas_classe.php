...
class cl_salas { 
   ...
   public $ed08_i_codigo = 0; 
   public $ed08_i_matricula = 0; 
   public $ed08_f_comportamento = 0; 
   public $ed08_f_nota = 0; 
   public $ed08_f_frequencia = 0; 
   ...
   function incluir ($ed08_i_codigo){ 
     ...
     if($ed08_i_codigo == "" || $ed08_i_codigo == null ){
       ...
       $this->ed08_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = @db_query("select last_value from salas_ed08_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed08_i_codigo)){
     ...
     if($ed08_i_matricula == "" || $ed08_i_matricula == null ){
       ...
       $this->ed08_i_matricula = pg_fetch_result($result,0,0); 
     }else{
       $result = @db_query("select last_value from salas_ed08_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed08_i_matricula)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1005008,1006202,'','".AddSlashes(pg_fetch_result($resaco,0,'ed08_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1005008,1005012,'','".AddSlashes(pg_fetch_result($resaco,0,'ed08_i_matricula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1005008,1005013,'','".AddSlashes(pg_fetch_result($resaco,0,'ed08_f_comportamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1005008,1005014,'','".AddSlashes(pg_fetch_result($resaco,0,'ed08_f_nota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1005008,1005015,'','".AddSlashes(pg_fetch_result($resaco,0,'ed08_f_frequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed08_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed08_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed08_i_codigo"])){ 
       $sql  .= $virgula." ed08_i_codigo = $this->ed08_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed08_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed08_i_matricula)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed08_i_matricula"])){ 
       $sql  .= $virgula." ed08_i_matricula = $this->ed08_i_matricula ";
       $virgula = ",";
       if(trim((string) $this->ed08_i_matricula) == null ){ 
         $this->erro_sql = " Campo Matrícula nao Informado.";
         $this->erro_campo = "ed08_i_matricula";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed08_f_comportamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed08_f_comportamento"])){ 
       $sql  .= $virgula." ed08_f_comportamento = $this->ed08_f_comportamento ";
       $virgula = ",";
       if(trim((string) $this->ed08_f_comportamento) == null ){ 
         $this->erro_sql = " Campo Comportamento nao Informado.";
         $this->erro_campo = "ed08_f_comportamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed08_f_nota)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed08_f_nota"])){ 
       $sql  .= $virgula." ed08_f_nota = $this->ed08_f_nota ";
       $virgula = ",";
       if(trim((string) $this->ed08_f_nota) == null ){ 
         $this->erro_sql = " Campo Nota nao Informado.";
         $this->erro_campo = "ed08_f_nota";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed08_f_frequencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed08_f_frequencia"])){ 
       $sql  .= $virgula." ed08_f_frequencia = $this->ed08_f_frequencia ";
       $virgula = ",";
       if(trim((string) $this->ed08_f_frequencia) == null ){ 
         $this->erro_sql = " Campo Frequência nao Informado.";
         $this->erro_campo = "ed08_f_frequencia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed08_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1005008,1006202,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed08_i_codigo'))."','$this->ed08_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed08_i_matricula"]))
           $resac = db_query("insert into db_acount values($acount,1005008,1005012,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed08_i_matricula'))."','$this->ed08_i_matricula',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed08_f_comportamento"]))
           $resac = db_query("insert into db_acount values($acount,1005008,1005013,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed08_f_comportamento'))."','$this->ed08_f_comportamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed08_f_nota"]))
           $resac = db_query("insert into db_acount values($acount,1005008,1005014,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed08_f_nota'))."','$this->ed08_f_nota',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed08_f_frequencia"]))
           $resac = db_query("insert into db_acount values($acount,1005008,1005015,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed08_f_frequencia'))."','$this->ed08_f_frequencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed08_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1005008,1006202,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed08_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1005008,1005012,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed08_i_matricula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1005008,1005013,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed08_f_comportamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1005008,1005014,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed08_f_nota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1005008,1005015,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed08_f_frequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
