...
class cl_corconf { 
   ...
   function incluir ($k12_id,$k12_data,$k12_autent){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1004,1139,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1004,1140,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1004,1141,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_autent'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1004,6209,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1004,15147,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k12_id=null,$k12_data=null,$k12_autent=null) { 
     ...
     if(trim((string) $this->k12_ativo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k12_ativo"])){ 
       $sql  .= $virgula." k12_ativo = '$this->k12_ativo' ";
       $virgula = ",";
       if(trim((string) $this->k12_ativo) == null ){ 
         $this->erro_sql = " Campo Ativo nao Informado.";
         $this->erro_campo = "k12_ativo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_id"]) || $this->k12_id != "")
           $resac = db_query("insert into db_acount values($acount,1004,1139,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_id'))."','$this->k12_id',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_data"]) || $this->k12_data != "")
           $resac = db_query("insert into db_acount values($acount,1004,1140,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_data'))."','$this->k12_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_autent"]) || $this->k12_autent != "")
           $resac = db_query("insert into db_acount values($acount,1004,1141,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_autent'))."','$this->k12_autent',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_codmov"]) || $this->k12_codmov != "")
           $resac = db_query("insert into db_acount values($acount,1004,6209,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_codmov'))."','$this->k12_codmov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_ativo"]) || $this->k12_ativo != "")
           $resac = db_query("insert into db_acount values($acount,1004,15147,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_ativo'))."','$this->k12_ativo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k12_id=null,$k12_data=null,$k12_autent=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1004,1139,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1004,1140,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1004,1141,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_autent'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1004,6209,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1004,15147,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
