...
class cl_pccflicitapar { 
   ...
   function incluir ($l25_codigo){ 
     ...
     if($l25_codigo == "" || $l25_codigo == null ){
       ...
       $this->l25_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from pccflicitapar_l25_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $l25_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1272,7766,'','".AddSlashes(pg_fetch_result($resaco,0,'l25_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1272,7667,'','".AddSlashes(pg_fetch_result($resaco,0,'l25_codcflicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1272,7668,'','".AddSlashes(pg_fetch_result($resaco,0,'l25_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1272,7669,'','".AddSlashes(pg_fetch_result($resaco,0,'l25_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($l25_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->l25_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l25_codigo"])){ 
       $sql  .= $virgula." l25_codigo = $this->l25_codigo ";
       $virgula = ",";
       if(trim((string) $this->l25_codigo) == null ){ 
     ...
     if(trim((string) $this->l25_codcflicita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l25_codcflicita"])){ 
       $sql  .= $virgula." l25_codcflicita = $this->l25_codcflicita ";
       $virgula = ",";
       if(trim((string) $this->l25_codcflicita) == null ){ 
         $this->erro_sql = " Campo Codigo Sequencial nao Informado.";
         $this->erro_campo = "l25_codcflicita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l25_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l25_anousu"])){ 
       $sql  .= $virgula." l25_anousu = $this->l25_anousu ";
       $virgula = ",";
       if(trim((string) $this->l25_anousu) == null ){ 
         $this->erro_sql = " Campo Ano nao Informado.";
         $this->erro_campo = "l25_anousu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->l25_numero)!="" || isset($GLOBALS["HTTP_POST_VARS"]["l25_numero"])){ 
       $sql  .= $virgula." l25_numero = $this->l25_numero ";
       $virgula = ",";
       if(trim((string) $this->l25_numero) == null ){ 
         $this->erro_sql = " Campo Numeração nao Informado.";
         $this->erro_campo = "l25_numero";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["l25_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1272,7766,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l25_codigo'))."','$this->l25_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l25_codcflicita"]))
           $resac = db_query("insert into db_acount values($acount,1272,7667,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l25_codcflicita'))."','$this->l25_codcflicita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l25_anousu"]))
           $resac = db_query("insert into db_acount values($acount,1272,7668,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l25_anousu'))."','$this->l25_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l25_numero"]))
           $resac = db_query("insert into db_acount values($acount,1272,7669,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'l25_numero'))."','$this->l25_numero',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($l25_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1272,7766,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l25_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1272,7667,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l25_codcflicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1272,7668,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l25_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1272,7669,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'l25_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
