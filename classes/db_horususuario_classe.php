...
class cl_horususuario { 
   ...
   public $fa66_sequencial = 0; 
   public $fa66_unidade = 0; 
   public $fa66_usuario = null; 
   public $fa66_senha = null; 
   ...
   function incluir ($fa66_sequencial){ 
     ...
     if($fa66_sequencial == "" || $fa66_sequencial == null ){
       ...
       $this->fa66_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from horususuario_fa66_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa66_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3946,21914,'','".AddSlashes(pg_fetch_result($resaco,0,'fa66_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3946,21915,'','".AddSlashes(pg_fetch_result($resaco,0,'fa66_unidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3946,21916,'','".AddSlashes(pg_fetch_result($resaco,0,'fa66_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3946,21917,'','".AddSlashes(pg_fetch_result($resaco,0,'fa66_senha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($fa66_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa66_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa66_sequencial"])){ 
       $sql  .= $virgula." fa66_sequencial = $this->fa66_sequencial ";
       $virgula = ",";
       if(trim((string) $this->fa66_sequencial) == null ){ 
     ...
     if(trim((string) $this->fa66_unidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa66_unidade"])){ 
       $sql  .= $virgula." fa66_unidade = $this->fa66_unidade ";
       $virgula = ",";
       if(trim((string) $this->fa66_unidade) == null ){ 
         $this->erro_sql = " Campo Unidade não informado.";
         $this->erro_campo = "fa66_unidade";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa66_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa66_usuario"])){ 
       $sql  .= $virgula." fa66_usuario = '$this->fa66_usuario' ";
       $virgula = ",";
       if(trim((string) $this->fa66_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário não informado.";
         $this->erro_campo = "fa66_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa66_senha)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa66_senha"])){ 
       $sql  .= $virgula." fa66_senha = '$this->fa66_senha' ";
       $virgula = ",";
       if(trim((string) $this->fa66_senha) == null ){ 
         $this->erro_sql = " Campo Senha não informado.";
         $this->erro_campo = "fa66_senha";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["fa66_sequencial"]) || $this->fa66_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3946,21914,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa66_sequencial'))."','$this->fa66_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["fa66_unidade"]) || $this->fa66_unidade != "")
             $resac = db_query("insert into db_acount values($acount,3946,21915,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa66_unidade'))."','$this->fa66_unidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["fa66_usuario"]) || $this->fa66_usuario != "")
             $resac = db_query("insert into db_acount values($acount,3946,21916,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa66_usuario'))."','$this->fa66_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["fa66_senha"]) || $this->fa66_senha != "")
             $resac = db_query("insert into db_acount values($acount,3946,21917,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa66_senha'))."','$this->fa66_senha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3946,21914,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa66_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3946,21915,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa66_unidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3946,21916,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa66_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3946,21917,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa66_senha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
