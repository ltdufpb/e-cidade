...
class cl_far_programa { 
   ...
   function incluir ($fa12_i_codigo){ 
     ...
     if($fa12_i_codigo == "" || $fa12_i_codigo == null ){
       ...
       $this->fa12_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_programa_fa12_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa12_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2177,12479,'','".AddSlashes(pg_fetch_result($resaco,0,'fa12_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2177,12480,'','".AddSlashes(pg_fetch_result($resaco,0,'fa12_c_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2177,12481,'','".AddSlashes(pg_fetch_result($resaco,0,'fa12_c_depadmin'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2177,15537,'','".AddSlashes(pg_fetch_result($resaco,0,'fa12_i_tipoacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa12_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa12_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa12_i_codigo"])){ 
       $sql  .= $virgula." fa12_i_codigo = $this->fa12_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa12_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa12_c_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa12_c_descricao"])){ 
       $sql  .= $virgula." fa12_c_descricao = '$this->fa12_c_descricao' ";
       $virgula = ",";
       if(trim((string) $this->fa12_c_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "fa12_c_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa12_c_depadmin)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa12_c_depadmin"])){ 
       $sql  .= $virgula." fa12_c_depadmin = '$this->fa12_c_depadmin' ";
       $virgula = ",";
       if(trim((string) $this->fa12_c_depadmin) == null ){ 
         $this->erro_sql = " Campo Dependência  Administrativa nao Informado.";
         $this->erro_campo = "fa12_c_depadmin";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa12_i_tipoacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa12_i_tipoacao"])){ 
       $sql  .= $virgula." fa12_i_tipoacao = $this->fa12_i_tipoacao ";
       $virgula = ",";
       if(trim((string) $this->fa12_i_tipoacao) == null ){ 
         $this->erro_sql = " Campo Tipo de Ação nao Informado.";
         $this->erro_campo = "fa12_i_tipoacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa12_i_codigo"]) || $this->fa12_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2177,12479,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa12_i_codigo'))."','$this->fa12_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa12_c_descricao"]) || $this->fa12_c_descricao != "")
           $resac = db_query("insert into db_acount values($acount,2177,12480,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa12_c_descricao'))."','$this->fa12_c_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa12_c_depadmin"]) || $this->fa12_c_depadmin != "")
           $resac = db_query("insert into db_acount values($acount,2177,12481,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa12_c_depadmin'))."','$this->fa12_c_depadmin',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa12_i_tipoacao"]) || $this->fa12_i_tipoacao != "")
           $resac = db_query("insert into db_acount values($acount,2177,15537,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa12_i_tipoacao'))."','$this->fa12_i_tipoacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa12_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2177,12479,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa12_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2177,12480,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa12_c_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2177,12481,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa12_c_depadmin'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2177,15537,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa12_i_tipoacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
