...
class cl_sau_turnoatend { 
   ...
   public $sd43_cod_turnat = 0; 
   public $sd43_v_descricao = null; 
   public $sd43_c_horainicial = null; 
   public $sd43_c_horafinal = null; 
   ...
   function incluir ($sd43_cod_turnat){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1960,11416,'','".AddSlashes(pg_fetch_result($resaco,0,'sd43_cod_turnat'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1960,11417,'','".AddSlashes(pg_fetch_result($resaco,0,'sd43_v_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1960,12506,'','".AddSlashes(pg_fetch_result($resaco,0,'sd43_c_horainicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1960,12507,'','".AddSlashes(pg_fetch_result($resaco,0,'sd43_c_horafinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd43_cod_turnat=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd43_cod_turnat)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd43_cod_turnat"])){ 
       $sql  .= $virgula." sd43_cod_turnat = $this->sd43_cod_turnat ";
       $virgula = ",";
       if(trim((string) $this->sd43_cod_turnat) == null ){ 
     ...
     if(trim((string) $this->sd43_v_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd43_v_descricao"])){ 
       $sql  .= $virgula." sd43_v_descricao = '$this->sd43_v_descricao' ";
       $virgula = ",";
       if(trim((string) $this->sd43_v_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "sd43_v_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd43_c_horainicial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd43_c_horainicial"])){ 
       $sql  .= $virgula." sd43_c_horainicial = '$this->sd43_c_horainicial' ";
       $virgula = ",";
       if(trim((string) $this->sd43_c_horainicial) == null ){ 
         $this->erro_sql = " Campo Hora Inicial nao Informado.";
         $this->erro_campo = "sd43_c_horainicial";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd43_c_horafinal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd43_c_horafinal"])){ 
       $sql  .= $virgula." sd43_c_horafinal = '$this->sd43_c_horafinal' ";
       $virgula = ",";
       if(trim((string) $this->sd43_c_horafinal) == null ){ 
         $this->erro_sql = " Campo Hora Final nao Informado.";
         $this->erro_campo = "sd43_c_horafinal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd43_cod_turnat"]))
           $resac = db_query("insert into db_acount values($acount,1960,11416,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd43_cod_turnat'))."','$this->sd43_cod_turnat',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd43_v_descricao"]))
           $resac = db_query("insert into db_acount values($acount,1960,11417,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd43_v_descricao'))."','$this->sd43_v_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd43_c_horainicial"]))
           $resac = db_query("insert into db_acount values($acount,1960,12506,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd43_c_horainicial'))."','$this->sd43_c_horainicial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd43_c_horafinal"]))
           $resac = db_query("insert into db_acount values($acount,1960,12507,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd43_c_horafinal'))."','$this->sd43_c_horafinal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd43_cod_turnat=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1960,11416,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd43_cod_turnat'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1960,11417,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd43_v_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1960,12506,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd43_c_horainicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1960,12507,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd43_c_horafinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
