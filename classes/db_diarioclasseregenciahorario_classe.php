...
class cl_diarioclasseregenciahorario { 
   ...
   public $ed302_sequencial = 0; 
   public $ed302_regenciahorario = 0; 
   public $ed302_diarioclasse = 0; 
   ...
   function incluir ($ed302_sequencial){ 
     ...
     if($ed302_sequencial == "" || $ed302_sequencial == null ){
       ...
       $this->ed302_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from diarioclasseregenciahorario_ed302_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed302_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3333,18797,'','".AddSlashes(pg_fetch_result($resaco,0,'ed302_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3333,18798,'','".AddSlashes(pg_fetch_result($resaco,0,'ed302_regenciahorario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3333,18799,'','".AddSlashes(pg_fetch_result($resaco,0,'ed302_diarioclasse'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed302_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed302_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed302_sequencial"])){ 
       $sql  .= $virgula." ed302_sequencial = $this->ed302_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed302_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed302_regenciahorario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed302_regenciahorario"])){ 
       $sql  .= $virgula." ed302_regenciahorario = $this->ed302_regenciahorario ";
       $virgula = ",";
       if(trim((string) $this->ed302_regenciahorario) == null ){ 
         $this->erro_sql = " Campo Codigo da Regencia nao Informado.";
         $this->erro_campo = "ed302_regenciahorario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed302_diarioclasse)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed302_diarioclasse"])){ 
       $sql  .= $virgula." ed302_diarioclasse = $this->ed302_diarioclasse ";
       $virgula = ",";
       if(trim((string) $this->ed302_diarioclasse) == null ){ 
         $this->erro_sql = " Campo Diario de classe nao Informado.";
         $this->erro_campo = "ed302_diarioclasse";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed302_sequencial"]) || $this->ed302_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3333,18797,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed302_sequencial'))."','$this->ed302_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed302_regenciahorario"]) || $this->ed302_regenciahorario != "")
           $resac = db_query("insert into db_acount values($acount,3333,18798,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed302_regenciahorario'))."','$this->ed302_regenciahorario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed302_diarioclasse"]) || $this->ed302_diarioclasse != "")
           $resac = db_query("insert into db_acount values($acount,3333,18799,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed302_diarioclasse'))."','$this->ed302_diarioclasse',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed302_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3333,18797,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed302_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3333,18798,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed302_regenciahorario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3333,18799,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed302_diarioclasse'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
