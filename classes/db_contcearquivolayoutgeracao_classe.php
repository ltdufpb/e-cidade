...
class cl_contcearquivolayoutgeracao { 
   ...
   public $c15_sequencial = 0; 
   public $c15_db_layouttxtgeracao = 0; 
   public $c15_contcearquivo = 0; 
   ...
   function incluir ($c15_sequencial){ 
     ...
     if($c15_sequencial == "" || $c15_sequencial == null ){
       ...
       $this->c15_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from contcearquivolayoutgeracao_c15_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $c15_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2064,11942,'','".AddSlashes(pg_fetch_result($resaco,0,'c15_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2064,11943,'','".AddSlashes(pg_fetch_result($resaco,0,'c15_db_layouttxtgeracao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2064,11944,'','".AddSlashes(pg_fetch_result($resaco,0,'c15_contcearquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($c15_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->c15_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c15_sequencial"])){ 
       $sql  .= $virgula." c15_sequencial = $this->c15_sequencial ";
       $virgula = ",";
       if(trim((string) $this->c15_sequencial) == null ){ 
         $this->erro_sql = " Campo Codigo sequencial nao Informado.";
     ...
     if(trim((string) $this->c15_db_layouttxtgeracao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c15_db_layouttxtgeracao"])){ 
       $sql  .= $virgula." c15_db_layouttxtgeracao = $this->c15_db_layouttxtgeracao ";
       $virgula = ",";
       if(trim((string) $this->c15_db_layouttxtgeracao) == null ){ 
         $this->erro_sql = " Campo Codigo da geração do arquivo nao Informado.";
         $this->erro_campo = "c15_db_layouttxtgeracao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c15_contcearquivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c15_contcearquivo"])){ 
       $sql  .= $virgula." c15_contcearquivo = $this->c15_contcearquivo ";
       $virgula = ",";
       if(trim((string) $this->c15_contcearquivo) == null ){ 
         $this->erro_sql = " Campo Codigo sequencial nao Informado.";
         $this->erro_campo = "c15_contcearquivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c15_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2064,11942,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c15_sequencial'))."','$this->c15_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c15_db_layouttxtgeracao"]))
           $resac = db_query("insert into db_acount values($acount,2064,11943,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c15_db_layouttxtgeracao'))."','$this->c15_db_layouttxtgeracao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c15_contcearquivo"]))
           $resac = db_query("insert into db_acount values($acount,2064,11944,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c15_contcearquivo'))."','$this->c15_contcearquivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($c15_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2064,11942,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c15_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2064,11943,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c15_db_layouttxtgeracao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2064,11944,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c15_contcearquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
