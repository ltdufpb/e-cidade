...
class cl_acordoitemperiodo { 
   ...
   public $ac41_sequencial = 0; 
   public $ac41_acordoitem = 0; 
   public $ac41_datainicial_dia = null; 
   public $ac41_datainicial_mes = null; 
   public $ac41_datainicial_ano = null; 
   public $ac41_datainicial = null; 
   public $ac41_datafinal_dia = null; 
   public $ac41_datafinal_mes = null; 
   public $ac41_datafinal_ano = null; 
   public $ac41_datafinal = null; 
   ...
   function incluir ($ac41_sequencial){ 
     ...
     if($ac41_sequencial == "" || $ac41_sequencial == null ){
       ...
       $this->ac41_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordoitemperiodo_ac41_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac41_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3296,18618,'','".AddSlashes(pg_fetch_result($resaco,0,'ac41_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3296,18619,'','".AddSlashes(pg_fetch_result($resaco,0,'ac41_acordoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3296,18620,'','".AddSlashes(pg_fetch_result($resaco,0,'ac41_datainicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3296,18621,'','".AddSlashes(pg_fetch_result($resaco,0,'ac41_datafinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac41_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac41_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac41_sequencial"])){ 
       $sql  .= $virgula." ac41_sequencial = $this->ac41_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac41_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac41_acordoitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac41_acordoitem"])){ 
       $sql  .= $virgula." ac41_acordoitem = $this->ac41_acordoitem ";
       $virgula = ",";
       if(trim((string) $this->ac41_acordoitem) == null ){ 
         $this->erro_sql = " Campo Acordo Item nao Informado.";
         $this->erro_campo = "ac41_acordoitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac41_datainicial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac41_datainicial_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ac41_datainicial_dia"] !="") ){ 
       $sql  .= $virgula." ac41_datainicial = '$this->ac41_datainicial' ";
       $virgula = ",";
       if(trim((string) $this->ac41_datainicial) == null ){ 
         $this->erro_sql = " Campo Data Inicial nao Informado.";
         $this->erro_campo = "ac41_datainicial_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac41_datafinal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac41_datafinal_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ac41_datafinal_dia"] !="") ){ 
       $sql  .= $virgula." ac41_datafinal = '$this->ac41_datafinal' ";
       $virgula = ",";
       if(trim((string) $this->ac41_datafinal) == null ){ 
         $this->erro_sql = " Campo Data Final nao Informado.";
         $this->erro_campo = "ac41_datafinal_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac41_sequencial"]) || $this->ac41_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3296,18618,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac41_sequencial'))."','$this->ac41_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac41_acordoitem"]) || $this->ac41_acordoitem != "")
           $resac = db_query("insert into db_acount values($acount,3296,18619,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac41_acordoitem'))."','$this->ac41_acordoitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac41_datainicial"]) || $this->ac41_datainicial != "")
           $resac = db_query("insert into db_acount values($acount,3296,18620,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac41_datainicial'))."','$this->ac41_datainicial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac41_datafinal"]) || $this->ac41_datafinal != "")
           $resac = db_query("insert into db_acount values($acount,3296,18621,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac41_datafinal'))."','$this->ac41_datafinal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac41_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3296,18618,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac41_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3296,18619,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac41_acordoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3296,18620,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac41_datainicial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3296,18621,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac41_datafinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
