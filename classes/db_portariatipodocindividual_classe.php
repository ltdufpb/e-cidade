...
class cl_portariatipodocindividual { 
   ...
   public $h37_sequencial = 0; 
   public $h37_portariatipo = 0; 
   public $h37_modportariaindividual = 0; 
   ...
   function incluir ($h37_sequencial){ 
     ...
     if($h37_sequencial == "" || $h37_sequencial == null ){
       ...
       $this->h37_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from portariatipodocindividual_h37_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h37_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2122,12212,'','".AddSlashes(pg_fetch_result($resaco,0,'h37_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2122,12213,'','".AddSlashes(pg_fetch_result($resaco,0,'h37_portariatipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2122,12214,'','".AddSlashes(pg_fetch_result($resaco,0,'h37_modportariaindividual'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h37_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h37_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h37_sequencial"])){ 
       $sql  .= $virgula." h37_sequencial = $this->h37_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h37_sequencial) == null ){ 
     ...
     if(trim((string) $this->h37_portariatipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h37_portariatipo"])){ 
       $sql  .= $virgula." h37_portariatipo = $this->h37_portariatipo ";
       $virgula = ",";
       if(trim((string) $this->h37_portariatipo) == null ){ 
         $this->erro_sql = " Campo Tipo nao Informado.";
         $this->erro_campo = "h37_portariatipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h37_modportariaindividual)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h37_modportariaindividual"])){ 
       $sql  .= $virgula." h37_modportariaindividual = $this->h37_modportariaindividual ";
       $virgula = ",";
       if(trim((string) $this->h37_modportariaindividual) == null ){ 
         $this->erro_sql = " Campo Modelo Portaria Individual nao Informado.";
         $this->erro_campo = "h37_modportariaindividual";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h37_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2122,12212,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h37_sequencial'))."','$this->h37_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h37_portariatipo"]))
           $resac = db_query("insert into db_acount values($acount,2122,12213,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h37_portariatipo'))."','$this->h37_portariatipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h37_modportariaindividual"]))
           $resac = db_query("insert into db_acount values($acount,2122,12214,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h37_modportariaindividual'))."','$this->h37_modportariaindividual',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h37_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2122,12212,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h37_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2122,12213,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h37_portariatipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2122,12214,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h37_modportariaindividual'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
