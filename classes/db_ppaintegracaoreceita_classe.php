...
class cl_ppaintegracaoreceita { 
   ...
   public $o122_sequencial = 0; 
   public $o122_ppaintegracao = 0; 
   public $o122_codrec = 0; 
   public $o122_anousu = 0; 
   public $o122_ppaestimativareceita = 0; 
   ...
   function incluir ($o122_sequencial){ 
     ...
     if($o122_sequencial == "" || $o122_sequencial == null ){
       ...
       $this->o122_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from ppaintegracaoreceita_o122_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $o122_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2558,14515,'','".AddSlashes(pg_fetch_result($resaco,0,'o122_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2558,14516,'','".AddSlashes(pg_fetch_result($resaco,0,'o122_ppaintegracao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2558,14517,'','".AddSlashes(pg_fetch_result($resaco,0,'o122_codrec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2558,14518,'','".AddSlashes(pg_fetch_result($resaco,0,'o122_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2558,14519,'','".AddSlashes(pg_fetch_result($resaco,0,'o122_ppaestimativareceita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o122_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o122_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o122_sequencial"])){ 
       $sql  .= $virgula." o122_sequencial = $this->o122_sequencial ";
       $virgula = ",";
       if(trim((string) $this->o122_sequencial) == null ){ 
     ...
     if(trim((string) $this->o122_ppaintegracao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o122_ppaintegracao"])){ 
       $sql  .= $virgula." o122_ppaintegracao = $this->o122_ppaintegracao ";
       $virgula = ",";
       if(trim((string) $this->o122_ppaintegracao) == null ){ 
         $this->erro_sql = " Campo Código da Integração nao Informado.";
         $this->erro_campo = "o122_ppaintegracao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o122_codrec)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o122_codrec"])){ 
       $sql  .= $virgula." o122_codrec = $this->o122_codrec ";
       $virgula = ",";
       if(trim((string) $this->o122_codrec) == null ){ 
         $this->erro_sql = " Campo Código da Receita nao Informado.";
         $this->erro_campo = "o122_codrec";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o122_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o122_anousu"])){ 
       $sql  .= $virgula." o122_anousu = $this->o122_anousu ";
       $virgula = ",";
       if(trim((string) $this->o122_anousu) == null ){ 
         $this->erro_sql = " Campo Ano da Receita nao Informado.";
         $this->erro_campo = "o122_anousu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o122_ppaestimativareceita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o122_ppaestimativareceita"])){ 
       $sql  .= $virgula." o122_ppaestimativareceita = $this->o122_ppaestimativareceita ";
       $virgula = ",";
       if(trim((string) $this->o122_ppaestimativareceita) == null ){ 
         $this->erro_sql = " Campo Código da Estimativa nao Informado.";
         $this->erro_campo = "o122_ppaestimativareceita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o122_sequencial"]) || $this->o122_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2558,14515,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o122_sequencial'))."','$this->o122_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o122_ppaintegracao"]) || $this->o122_ppaintegracao != "")
           $resac = db_query("insert into db_acount values($acount,2558,14516,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o122_ppaintegracao'))."','$this->o122_ppaintegracao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o122_codrec"]) || $this->o122_codrec != "")
           $resac = db_query("insert into db_acount values($acount,2558,14517,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o122_codrec'))."','$this->o122_codrec',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o122_anousu"]) || $this->o122_anousu != "")
           $resac = db_query("insert into db_acount values($acount,2558,14518,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o122_anousu'))."','$this->o122_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o122_ppaestimativareceita"]) || $this->o122_ppaestimativareceita != "")
           $resac = db_query("insert into db_acount values($acount,2558,14519,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o122_ppaestimativareceita'))."','$this->o122_ppaestimativareceita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o122_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2558,14515,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o122_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2558,14516,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o122_ppaintegracao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2558,14517,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o122_codrec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2558,14518,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o122_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2558,14519,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o122_ppaestimativareceita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
