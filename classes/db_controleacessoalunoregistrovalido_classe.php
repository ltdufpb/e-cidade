...
class cl_controleacessoalunoregistrovalido { 
   ...
   public $ed303_sequencial = 0; 
   public $ed303_controleacessoalunoregistro = 0; 
   public $ed303_aluno = 0; 
   ...
   function incluir ($ed303_sequencial){ 
     ...
     if($ed303_sequencial == "" || $ed303_sequencial == null ){
       ...
       $this->ed303_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from controleacessoalunoregistrovalido_ed303_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed303_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3336,18817,'','".AddSlashes(pg_fetch_result($resaco,0,'ed303_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3336,18819,'','".AddSlashes(pg_fetch_result($resaco,0,'ed303_controleacessoalunoregistro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3336,18818,'','".AddSlashes(pg_fetch_result($resaco,0,'ed303_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed303_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed303_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed303_sequencial"])){ 
       $sql  .= $virgula." ed303_sequencial = $this->ed303_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed303_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed303_controleacessoalunoregistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed303_controleacessoalunoregistro"])){ 
       $sql  .= $virgula." ed303_controleacessoalunoregistro = $this->ed303_controleacessoalunoregistro ";
       $virgula = ",";
       if(trim((string) $this->ed303_controleacessoalunoregistro) == null ){ 
         $this->erro_sql = " Campo Código da Leitura nao Informado.";
         $this->erro_campo = "ed303_controleacessoalunoregistro";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed303_aluno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed303_aluno"])){ 
       $sql  .= $virgula." ed303_aluno = $this->ed303_aluno ";
       $virgula = ",";
       if(trim((string) $this->ed303_aluno) == null ){ 
         $this->erro_sql = " Campo Código do aluno nao Informado.";
         $this->erro_campo = "ed303_aluno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed303_sequencial"]) || $this->ed303_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3336,18817,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed303_sequencial'))."','$this->ed303_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed303_controleacessoalunoregistro"]) || $this->ed303_controleacessoalunoregistro != "")
           $resac = db_query("insert into db_acount values($acount,3336,18819,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed303_controleacessoalunoregistro'))."','$this->ed303_controleacessoalunoregistro',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed303_aluno"]) || $this->ed303_aluno != "")
           $resac = db_query("insert into db_acount values($acount,3336,18818,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed303_aluno'))."','$this->ed303_aluno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed303_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3336,18817,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed303_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3336,18819,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed303_controleacessoalunoregistro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3336,18818,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed303_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
