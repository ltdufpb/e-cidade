...
class cl_modcarnepadraocadmodcarne { 
   ...
   public $m01_sequencial = 0; 
   public $m01_cadmodcarne = 0; 
   public $m01_modcarnepadrao = 0; 
   ...
   function incluir ($m01_sequencial){ 
     ...
     if($m01_sequencial == "" || $m01_sequencial == null ){
       ...
       $this->m01_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from modcarnepadraocadmodcarne_m01_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $m01_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2203,12616,'','".AddSlashes(pg_fetch_result($resaco,0,'m01_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2203,12617,'','".AddSlashes(pg_fetch_result($resaco,0,'m01_cadmodcarne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2203,12618,'','".AddSlashes(pg_fetch_result($resaco,0,'m01_modcarnepadrao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($m01_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->m01_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m01_sequencial"])){ 
       $sql  .= $virgula." m01_sequencial = $this->m01_sequencial ";
       $virgula = ",";
       if(trim((string) $this->m01_sequencial) == null ){ 
     ...
     if(trim((string) $this->m01_cadmodcarne)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m01_cadmodcarne"])){ 
       $sql  .= $virgula." m01_cadmodcarne = $this->m01_cadmodcarne ";
       $virgula = ",";
       if(trim((string) $this->m01_cadmodcarne) == null ){ 
         $this->erro_sql = " Campo Código do Modelo nao Informado.";
         $this->erro_campo = "m01_cadmodcarne";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m01_modcarnepadrao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m01_modcarnepadrao"])){ 
       $sql  .= $virgula." m01_modcarnepadrao = $this->m01_modcarnepadrao ";
       $virgula = ",";
       if(trim((string) $this->m01_modcarnepadrao) == null ){ 
         $this->erro_sql = " Campo Modelo Padrão nao Informado.";
         $this->erro_campo = "m01_modcarnepadrao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["m01_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2203,12616,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m01_sequencial'))."','$this->m01_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m01_cadmodcarne"]))
           $resac = db_query("insert into db_acount values($acount,2203,12617,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m01_cadmodcarne'))."','$this->m01_cadmodcarne',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m01_modcarnepadrao"]))
           $resac = db_query("insert into db_acount values($acount,2203,12618,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m01_modcarnepadrao'))."','$this->m01_modcarnepadrao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($m01_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2203,12616,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m01_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2203,12617,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m01_cadmodcarne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2203,12618,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m01_modcarnepadrao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
