...
class cl_veiccadpostoexterno { 
   ...
   public $ve34_codigo = 0; 
   public $ve34_veiccadposto = 0; 
   public $ve34_numcgm = 0; 
   ...
   function incluir ($ve34_codigo){ 
     ...
     if($ve34_codigo == "" || $ve34_codigo == null ){
       ...
       $this->ve34_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veiccadpostoexterno_ve34_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve34_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1601,9321,'','".AddSlashes(pg_fetch_result($resaco,0,'ve34_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1601,9322,'','".AddSlashes(pg_fetch_result($resaco,0,'ve34_veiccadposto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1601,9323,'','".AddSlashes(pg_fetch_result($resaco,0,'ve34_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve34_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve34_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve34_codigo"])){ 
       $sql  .= $virgula." ve34_codigo = $this->ve34_codigo ";
       $virgula = ",";
       if(trim((string) $this->ve34_codigo) == null ){ 
     ...
     if(trim((string) $this->ve34_veiccadposto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve34_veiccadposto"])){ 
       $sql  .= $virgula." ve34_veiccadposto = $this->ve34_veiccadposto ";
       $virgula = ",";
       if(trim((string) $this->ve34_veiccadposto) == null ){ 
         $this->erro_sql = " Campo Código do Posto nao Informado.";
         $this->erro_campo = "ve34_veiccadposto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve34_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve34_numcgm"])){ 
       $sql  .= $virgula." ve34_numcgm = $this->ve34_numcgm ";
       $virgula = ",";
       if(trim((string) $this->ve34_numcgm) == null ){ 
         $this->erro_sql = " Campo Numcgm nao Informado.";
         $this->erro_campo = "ve34_numcgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve34_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1601,9321,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve34_codigo'))."','$this->ve34_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve34_veiccadposto"]))
           $resac = db_query("insert into db_acount values($acount,1601,9322,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve34_veiccadposto'))."','$this->ve34_veiccadposto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve34_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,1601,9323,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve34_numcgm'))."','$this->ve34_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve34_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1601,9321,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve34_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1601,9322,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve34_veiccadposto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1601,9323,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve34_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
