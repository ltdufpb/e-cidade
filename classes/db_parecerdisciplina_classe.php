...
class cl_parecerdisciplina { 
   ...
   public $ed106_sequencial = 0; 
   public $ed106_parecer = 0; 
   public $ed106_disciplina = 0; 
   ...
   function incluir ($ed106_sequencial){ 
     ...
     if($ed106_sequencial == "" || $ed106_sequencial == null ){
       ...
       $this->ed106_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from parecerdisciplina_ed106_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed106_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3425,19270,'','".AddSlashes(pg_fetch_result($resaco,0,'ed106_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3425,19271,'','".AddSlashes(pg_fetch_result($resaco,0,'ed106_parecer'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3425,19272,'','".AddSlashes(pg_fetch_result($resaco,0,'ed106_disciplina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed106_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed106_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed106_sequencial"])){ 
       $sql  .= $virgula." ed106_sequencial = $this->ed106_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed106_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed106_parecer)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed106_parecer"])){ 
       $sql  .= $virgula." ed106_parecer = $this->ed106_parecer ";
       $virgula = ",";
       if(trim((string) $this->ed106_parecer) == null ){ 
         $this->erro_sql = " Campo Parecer nao Informado.";
         $this->erro_campo = "ed106_parecer";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed106_disciplina)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed106_disciplina"])){ 
       $sql  .= $virgula." ed106_disciplina = $this->ed106_disciplina ";
       $virgula = ",";
       if(trim((string) $this->ed106_disciplina) == null ){ 
         $this->erro_sql = " Campo Disciplina nao Informado.";
         $this->erro_campo = "ed106_disciplina";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed106_sequencial"]) || $this->ed106_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3425,19270,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed106_sequencial'))."','$this->ed106_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed106_parecer"]) || $this->ed106_parecer != "")
           $resac = db_query("insert into db_acount values($acount,3425,19271,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed106_parecer'))."','$this->ed106_parecer',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed106_disciplina"]) || $this->ed106_disciplina != "")
           $resac = db_query("insert into db_acount values($acount,3425,19272,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed106_disciplina'))."','$this->ed106_disciplina',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed106_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3425,19270,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed106_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3425,19271,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed106_parecer'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3425,19272,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed106_disciplina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
