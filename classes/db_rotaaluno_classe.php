...
class cl_rotaaluno { 
   ...
   public $ed219_d_dataacao_dia = null; 
   public $ed219_d_dataacao_mes = null; 
   public $ed219_d_dataacao_ano = null; 
   public $ed219_d_dataacao = null; 
   public $ed219_d_datafim_dia = null; 
   public $ed219_d_datafim_mes = null; 
   public $ed219_d_datafim_ano = null; 
   public $ed219_d_datafim = null; 
   public $ed219_d_datainicio_dia = null; 
   public $ed219_d_datainicio_mes = null; 
   public $ed219_d_datainicio_ano = null; 
   public $ed219_d_datainicio = null; 
   public $ed219_i_rota = 0; 
   public $ed219_i_aluno = 0; 
   public $ed219_i_usuario = 0; 
   ...
   function incluir ($ed219_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1927,11161,'','".AddSlashes(pg_fetch_result($resaco,0,'ed219_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1927,11162,'','".AddSlashes(pg_fetch_result($resaco,0,'ed219_d_dataacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1927,11163,'','".AddSlashes(pg_fetch_result($resaco,0,'ed219_d_datafim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1927,11164,'','".AddSlashes(pg_fetch_result($resaco,0,'ed219_d_datainicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1927,11165,'','".AddSlashes(pg_fetch_result($resaco,0,'ed219_i_rota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1927,11166,'','".AddSlashes(pg_fetch_result($resaco,0,'ed219_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1927,11167,'','".AddSlashes(pg_fetch_result($resaco,0,'ed219_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed219_i_codigo=null) { 
     ...
     if(trim((string) $this->ed219_d_dataacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed219_d_dataacao_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed219_d_dataacao_dia"] !="") ){ 
       $sql  .= $virgula." ed219_d_dataacao = '$this->ed219_d_dataacao' ";
       $virgula = ",";
       if(trim((string) $this->ed219_d_dataacao) == null ){ 
         $this->erro_sql = " Campo Data ação nao Informado.";
         $this->erro_campo = "ed219_d_dataacao_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed219_d_datafim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed219_d_datafim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed219_d_datafim_dia"] !="") ){ 
     ...
     if(trim((string) $this->ed219_d_datainicio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed219_d_datainicio_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed219_d_datainicio_dia"] !="") ){ 
       $sql  .= $virgula." ed219_d_datainicio = '$this->ed219_d_datainicio' ";
       $virgula = ",";
       if(trim((string) $this->ed219_d_datainicio) == null ){ 
         $this->erro_sql = " Campo Data Inicial nao Informado.";
         $this->erro_campo = "ed219_d_datainicio_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed219_i_rota)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed219_i_rota"])){ 
       $sql  .= $virgula." ed219_i_rota = $this->ed219_i_rota ";
       $virgula = ",";
       if(trim((string) $this->ed219_i_rota) == null ){ 
         $this->erro_sql = " Campo Rota nao Informado.";
         $this->erro_campo = "ed219_i_rota";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed219_i_aluno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed219_i_aluno"])){ 
       $sql  .= $virgula." ed219_i_aluno = $this->ed219_i_aluno ";
       $virgula = ",";
       if(trim((string) $this->ed219_i_aluno) == null ){ 
         $this->erro_sql = " Campo Aluno nao Informado.";
         $this->erro_campo = "ed219_i_aluno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed219_i_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed219_i_usuario"])){ 
       $sql  .= $virgula." ed219_i_usuario = $this->ed219_i_usuario ";
       $virgula = ",";
       if(trim((string) $this->ed219_i_usuario) == null ){ 
         $this->erro_sql = " Campo Usuario nao Informado.";
         $this->erro_campo = "ed219_i_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed219_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1927,11161,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed219_i_codigo'))."','$this->ed219_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed219_d_dataacao"]))
           $resac = db_query("insert into db_acount values($acount,1927,11162,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed219_d_dataacao'))."','$this->ed219_d_dataacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed219_d_datafim"]))
           $resac = db_query("insert into db_acount values($acount,1927,11163,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed219_d_datafim'))."','$this->ed219_d_datafim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed219_d_datainicio"]))
           $resac = db_query("insert into db_acount values($acount,1927,11164,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed219_d_datainicio'))."','$this->ed219_d_datainicio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed219_i_rota"]))
           $resac = db_query("insert into db_acount values($acount,1927,11165,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed219_i_rota'))."','$this->ed219_i_rota',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed219_i_aluno"]))
           $resac = db_query("insert into db_acount values($acount,1927,11166,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed219_i_aluno'))."','$this->ed219_i_aluno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed219_i_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1927,11167,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed219_i_usuario'))."','$this->ed219_i_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed219_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1927,11161,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed219_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1927,11162,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed219_d_dataacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1927,11163,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed219_d_datafim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1927,11164,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed219_d_datainicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1927,11165,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed219_i_rota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1927,11166,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed219_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1927,11167,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed219_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
