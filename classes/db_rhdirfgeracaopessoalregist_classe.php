...
class cl_rhdirfgeracaopessoalregist { 
   ...
   public $rh99_sequencial = 0; 
   public $rh99_rhdirfgeracaodadospessoalvalor = 0; 
   public $rh99_regist = 0; 
   ...
   function incluir ($rh99_sequencial){ 
     ...
     if($rh99_sequencial == "" || $rh99_sequencial == null ){
       ...
       $this->rh99_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhdirfgeracaopessoalregist_rh99_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh99_sequencial)){
     ...
     if (!isset($_SESSION["ignoreAccount"])) {
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3143,17806,'','".AddSlashes(pg_fetch_result($resaco,0,'rh99_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3143,17807,'','".AddSlashes(pg_fetch_result($resaco,0,'rh99_rhdirfgeracaodadospessoalvalor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3143,17808,'','".AddSlashes(pg_fetch_result($resaco,0,'rh99_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($rh99_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh99_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh99_sequencial"])){ 
       $sql  .= $virgula." rh99_sequencial = $this->rh99_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh99_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh99_rhdirfgeracaodadospessoalvalor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh99_rhdirfgeracaodadospessoalvalor"])){ 
       $sql  .= $virgula." rh99_rhdirfgeracaodadospessoalvalor = $this->rh99_rhdirfgeracaodadospessoalvalor ";
       $virgula = ",";
       if(trim((string) $this->rh99_rhdirfgeracaodadospessoalvalor) == null ){ 
         $this->erro_sql = " Campo Código do valor nao Informado.";
         $this->erro_campo = "rh99_rhdirfgeracaodadospessoalvalor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh99_regist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh99_regist"])){ 
       $sql  .= $virgula." rh99_regist = $this->rh99_regist ";
       $virgula = ",";
       if(trim((string) $this->rh99_regist) == null ){ 
         $this->erro_sql = " Campo Código da Matrícula nao Informado.";
         $this->erro_campo = "rh99_regist";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["rh99_sequencial"]) || $this->rh99_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3143,17806,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh99_sequencial'))."','$this->rh99_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["rh99_rhdirfgeracaodadospessoalvalor"]) || $this->rh99_rhdirfgeracaodadospessoalvalor != "")
             $resac = db_query("insert into db_acount values($acount,3143,17807,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh99_rhdirfgeracaodadospessoalvalor'))."','$this->rh99_rhdirfgeracaodadospessoalvalor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["rh99_regist"]) || $this->rh99_regist != "")
             $resac = db_query("insert into db_acount values($acount,3143,17808,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh99_regist'))."','$this->rh99_regist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($_SESSION["ignoreAccount"])) {
       ...
       if (($resaco!=false)||($this->numrows!=0)) {
         for ($iresaco=0;$iresaco < $this->numrows;$iresaco++) {
           ...
           $resac = db_query("insert into db_acount values($acount,3143,17806,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh99_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,3143,17807,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh99_rhdirfgeracaodadospessoalvalor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,3143,17808,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh99_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
