...
class cl_tiporeferenciacalculo { 
   ...
   public $la61_sequencial = 0; 
   public $la61_tiporeferencialnumerico = 0; 
   public $la61_atributobase = 0; 
   public $la61_tipocalculo = 0; 
   ...
   function incluir ($la61_sequencial){ 
     ...
     if($la61_sequencial == "" || $la61_sequencial == null ){
       ...
       $this->la61_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tiporeferenciacalculo_la61_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $la61_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3686,20492,'','".AddSlashes(pg_fetch_result($resaco,0,'la61_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3686,20493,'','".AddSlashes(pg_fetch_result($resaco,0,'la61_tiporeferencialnumerico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3686,20494,'','".AddSlashes(pg_fetch_result($resaco,0,'la61_atributobase'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3686,20495,'','".AddSlashes(pg_fetch_result($resaco,0,'la61_tipocalculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($la61_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->la61_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la61_sequencial"])){ 
       $sql  .= $virgula." la61_sequencial = $this->la61_sequencial ";
       $virgula = ",";
       if(trim((string) $this->la61_sequencial) == null ){ 
     ...
     if(trim((string) $this->la61_tiporeferencialnumerico)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la61_tiporeferencialnumerico"])){ 
       $sql  .= $virgula." la61_tiporeferencialnumerico = $this->la61_tiporeferencialnumerico ";
       $virgula = ",";
       if(trim((string) $this->la61_tiporeferencialnumerico) == null ){ 
         $this->erro_sql = " Campo Código da Referência não informado.";
         $this->erro_campo = "la61_tiporeferencialnumerico";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->la61_atributobase)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la61_atributobase"])){ 
       $sql  .= $virgula." la61_atributobase = $this->la61_atributobase ";
       $virgula = ",";
       if(trim((string) $this->la61_atributobase) == null ){ 
         $this->erro_sql = " Campo Atributo Referência não informado.";
         $this->erro_campo = "la61_atributobase";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->la61_tipocalculo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la61_tipocalculo"])){ 
       $sql  .= $virgula." la61_tipocalculo = $this->la61_tipocalculo ";
       $virgula = ",";
       if(trim((string) $this->la61_tipocalculo) == null ){ 
         $this->erro_sql = " Campo Tipo do Calculo não informado.";
         $this->erro_campo = "la61_tipocalculo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["la61_sequencial"]) || $this->la61_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3686,20492,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la61_sequencial'))."','$this->la61_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["la61_tiporeferencialnumerico"]) || $this->la61_tiporeferencialnumerico != "")
             $resac = db_query("insert into db_acount values($acount,3686,20493,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la61_tiporeferencialnumerico'))."','$this->la61_tiporeferencialnumerico',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["la61_atributobase"]) || $this->la61_atributobase != "")
             $resac = db_query("insert into db_acount values($acount,3686,20494,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la61_atributobase'))."','$this->la61_atributobase',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["la61_tipocalculo"]) || $this->la61_tipocalculo != "")
             $resac = db_query("insert into db_acount values($acount,3686,20495,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la61_tipocalculo'))."','$this->la61_tipocalculo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3686,20492,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la61_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3686,20493,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la61_tiporeferencialnumerico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3686,20494,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la61_atributobase'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3686,20495,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la61_tipocalculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
