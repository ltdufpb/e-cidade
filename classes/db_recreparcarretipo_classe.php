...
class cl_recreparcarretipo { 
   ...
   function incluir ($k72_sequencial){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3063,11743,'','".AddSlashes(pg_fetch_result($resaco,0,'k72_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3063,17298,'','".AddSlashes(pg_fetch_result($resaco,0,'k72_arretipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3063,17297,'','".AddSlashes(pg_fetch_result($resaco,0,'k72_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k72_sequencial=null) { 
     ...
     if(trim((string) $this->k72_arretipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k72_arretipo"])){ 
       $sql  .= $virgula." k72_arretipo = $this->k72_arretipo ";
       $virgula = ",";
       if(trim((string) $this->k72_arretipo) == null ){ 
         $this->erro_sql = " Campo Tipo de Débito nao Informado.";
         $this->erro_campo = "k72_arretipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k72_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k72_codigo"])){ 
       $sql  .= $virgula." k72_codigo = $this->k72_codigo ";
       $virgula = ",";
       if(trim((string) $this->k72_codigo) == null ){ 
         $this->erro_sql = " Campo Receita nao Informado.";
         $this->erro_campo = "k72_codigo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k72_sequencial"]) || $this->k72_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3063,11743,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k72_sequencial'))."','$this->k72_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k72_arretipo"]) || $this->k72_arretipo != "")
           $resac = db_query("insert into db_acount values($acount,3063,17298,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k72_arretipo'))."','$this->k72_arretipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k72_codigo"]) || $this->k72_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3063,17297,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k72_codigo'))."','$this->k72_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k72_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3063,11743,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k72_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3063,17298,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k72_arretipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3063,17297,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k72_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
