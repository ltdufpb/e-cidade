...
class cl_acordoparalisacaoperiodo { 
   ...
   public $ac49_sequencial = 0; 
   public $ac49_acordoparalisacao = 0; 
   public $ac49_acordoposicaoperiodo = 0; 
   public $ac49_tipoperiodo = 0; 
   ...
   function incluir ($ac49_sequencial){ 
     ...
     if($ac49_sequencial == "" || $ac49_sequencial == null ){
       ...
       $this->ac49_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordoparalisacaoperiodo_ac49_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac49_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3694,20525,'','".AddSlashes(pg_fetch_result($resaco,0,'ac49_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3694,20526,'','".AddSlashes(pg_fetch_result($resaco,0,'ac49_acordoparalisacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3694,20527,'','".AddSlashes(pg_fetch_result($resaco,0,'ac49_acordoposicaoperiodo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3694,20528,'','".AddSlashes(pg_fetch_result($resaco,0,'ac49_tipoperiodo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($ac49_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac49_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac49_sequencial"])){ 
       $sql  .= $virgula." ac49_sequencial = $this->ac49_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac49_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac49_acordoparalisacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac49_acordoparalisacao"])){ 
       $sql  .= $virgula." ac49_acordoparalisacao = $this->ac49_acordoparalisacao ";
       $virgula = ",";
       if(trim((string) $this->ac49_acordoparalisacao) == null ){ 
         $this->erro_sql = " Campo Sequencial da Paralisação não informado.";
         $this->erro_campo = "ac49_acordoparalisacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac49_acordoposicaoperiodo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac49_acordoposicaoperiodo"])){ 
       $sql  .= $virgula." ac49_acordoposicaoperiodo = $this->ac49_acordoposicaoperiodo ";
       $virgula = ",";
       if(trim((string) $this->ac49_acordoposicaoperiodo) == null ){ 
         $this->erro_sql = " Campo Codigo Sequencial não informado.";
         $this->erro_campo = "ac49_acordoposicaoperiodo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac49_tipoperiodo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac49_tipoperiodo"])){ 
       $sql  .= $virgula." ac49_tipoperiodo = $this->ac49_tipoperiodo ";
       $virgula = ",";
       if(trim((string) $this->ac49_tipoperiodo) == null ){ 
         $this->erro_sql = " Campo Tipo de Periodo não informado.";
         $this->erro_campo = "ac49_tipoperiodo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["ac49_sequencial"]) || $this->ac49_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3694,20525,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac49_sequencial'))."','$this->ac49_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ac49_acordoparalisacao"]) || $this->ac49_acordoparalisacao != "")
             $resac = db_query("insert into db_acount values($acount,3694,20526,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac49_acordoparalisacao'))."','$this->ac49_acordoparalisacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ac49_acordoposicaoperiodo"]) || $this->ac49_acordoposicaoperiodo != "")
             $resac = db_query("insert into db_acount values($acount,3694,20527,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac49_acordoposicaoperiodo'))."','$this->ac49_acordoposicaoperiodo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ac49_tipoperiodo"]) || $this->ac49_tipoperiodo != "")
             $resac = db_query("insert into db_acount values($acount,3694,20528,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac49_tipoperiodo'))."','$this->ac49_tipoperiodo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3694,20525,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac49_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3694,20526,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac49_acordoparalisacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3694,20527,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac49_acordoposicaoperiodo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3694,20528,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac49_tipoperiodo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
