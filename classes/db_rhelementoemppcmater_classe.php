...
class cl_rhelementoemppcmater { 
   ...
   public $rh36_sequencial = 0; 
   public $rh36_pcmater = 0; 
   public $rh36_rhelementoemp = 0; 
   ...
   function incluir ($rh36_sequencial){ 
     ...
     if($rh36_sequencial == "" || $rh36_sequencial == null ){
       ...
       $this->rh36_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhelementoemppcmater_rh36_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh36_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1849,10740,'','".AddSlashes(pg_fetch_result($resaco,0,'rh36_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1849,10741,'','".AddSlashes(pg_fetch_result($resaco,0,'rh36_pcmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1849,10742,'','".AddSlashes(pg_fetch_result($resaco,0,'rh36_rhelementoemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh36_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh36_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh36_sequencial"])){ 
       $sql  .= $virgula." rh36_sequencial = $this->rh36_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh36_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh36_pcmater)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh36_pcmater"])){ 
       $sql  .= $virgula." rh36_pcmater = $this->rh36_pcmater ";
       $virgula = ",";
       if(trim((string) $this->rh36_pcmater) == null ){ 
         $this->erro_sql = " Campo Cód. Material nao Informado.";
         $this->erro_campo = "rh36_pcmater";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh36_rhelementoemp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh36_rhelementoemp"])){ 
       $sql  .= $virgula." rh36_rhelementoemp = $this->rh36_rhelementoemp ";
       $virgula = ",";
       if(trim((string) $this->rh36_rhelementoemp) == null ){ 
         $this->erro_sql = " Campo Elementos utilizados na folha nao Informado.";
         $this->erro_campo = "rh36_rhelementoemp";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh36_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1849,10740,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh36_sequencial'))."','$this->rh36_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh36_pcmater"]))
           $resac = db_query("insert into db_acount values($acount,1849,10741,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh36_pcmater'))."','$this->rh36_pcmater',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh36_rhelementoemp"]))
           $resac = db_query("insert into db_acount values($acount,1849,10742,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh36_rhelementoemp'))."','$this->rh36_rhelementoemp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh36_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1849,10740,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh36_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1849,10741,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh36_pcmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1849,10742,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh36_rhelementoemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
