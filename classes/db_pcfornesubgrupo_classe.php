...
class cl_pcfornesubgrupo { 
   ...
   public $pc76_codigo = 0; 
   public $pc76_pcforne = 0; 
   public $pc76_pcsubgrupo = 0; 
   ...
   function incluir ($pc76_codigo){ 
     ...
     if($pc76_codigo == "" || $pc76_codigo == null ){
       ...
       $this->pc76_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from pcfornesubgrupo_pc76_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $pc76_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1307,7808,'','".AddSlashes(pg_fetch_result($resaco,0,'pc76_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1307,7809,'','".AddSlashes(pg_fetch_result($resaco,0,'pc76_pcforne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1307,7810,'','".AddSlashes(pg_fetch_result($resaco,0,'pc76_pcsubgrupo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc76_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc76_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc76_codigo"])){ 
       $sql  .= $virgula." pc76_codigo = $this->pc76_codigo ";
       $virgula = ",";
       if(trim((string) $this->pc76_codigo) == null ){ 
     ...
     if(trim((string) $this->pc76_pcforne)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc76_pcforne"])){ 
       $sql  .= $virgula." pc76_pcforne = $this->pc76_pcforne ";
       $virgula = ",";
       if(trim((string) $this->pc76_pcforne) == null ){ 
         $this->erro_sql = " Campo Fornecedor nao Informado.";
         $this->erro_campo = "pc76_pcforne";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc76_pcsubgrupo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc76_pcsubgrupo"])){ 
       $sql  .= $virgula." pc76_pcsubgrupo = $this->pc76_pcsubgrupo ";
       $virgula = ",";
       if(trim((string) $this->pc76_pcsubgrupo) == null ){ 
         $this->erro_sql = " Campo Código do Subgrupo nao Informado.";
         $this->erro_campo = "pc76_pcsubgrupo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc76_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1307,7808,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc76_codigo'))."','$this->pc76_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc76_pcforne"]))
           $resac = db_query("insert into db_acount values($acount,1307,7809,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc76_pcforne'))."','$this->pc76_pcforne',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc76_pcsubgrupo"]))
           $resac = db_query("insert into db_acount values($acount,1307,7810,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc76_pcsubgrupo'))."','$this->pc76_pcsubgrupo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc76_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1307,7808,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc76_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1307,7809,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc76_pcforne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1307,7810,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc76_pcsubgrupo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
