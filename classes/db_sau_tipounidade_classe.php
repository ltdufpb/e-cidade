...
class cl_sau_tipounidade { 
   ...
   public $sd42_i_tp_unid_id = 0; 
   public $sd42_v_descricao = null; 
   ...
   function incluir ($sd42_i_tp_unid_id){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1959,11414,'','".AddSlashes(pg_fetch_result($resaco,0,'sd42_i_tp_unid_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1959,11415,'','".AddSlashes(pg_fetch_result($resaco,0,'sd42_v_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd42_i_tp_unid_id=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd42_i_tp_unid_id)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd42_i_tp_unid_id"])){ 
       $sql  .= $virgula." sd42_i_tp_unid_id = $this->sd42_i_tp_unid_id ";
       $virgula = ",";
       if(trim((string) $this->sd42_i_tp_unid_id) == null ){ 
     ...
     if(trim((string) $this->sd42_v_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd42_v_descricao"])){ 
       $sql  .= $virgula." sd42_v_descricao = '$this->sd42_v_descricao' ";
       $virgula = ",";
       if(trim((string) $this->sd42_v_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "sd42_v_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd42_i_tp_unid_id"]))
           $resac = db_query("insert into db_acount values($acount,1959,11414,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd42_i_tp_unid_id'))."','$this->sd42_i_tp_unid_id',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd42_v_descricao"]))
           $resac = db_query("insert into db_acount values($acount,1959,11415,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd42_v_descricao'))."','$this->sd42_v_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd42_i_tp_unid_id=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1959,11414,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd42_i_tp_unid_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1959,11415,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd42_v_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
