...
class cl_fiscalvistorias { 
   ...
   function incluir ($y21_codnoti,$y21_codvist){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,738,5160,'','".AddSlashes(pg_fetch_result($resaco,0,'y21_codnoti'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,738,5161,'','".AddSlashes(pg_fetch_result($resaco,0,'y21_codvist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y21_codnoti=null,$y21_codvist=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y21_codnoti)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y21_codnoti"])){ 
       $sql  .= $virgula." y21_codnoti = $this->y21_codnoti ";
       $virgula = ",";
       if(trim((string) $this->y21_codnoti) == null ){ 
     ...
     if(trim((string) $this->y21_codvist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y21_codvist"])){ 
       $sql  .= $virgula." y21_codvist = $this->y21_codvist ";
       $virgula = ",";
       if(trim((string) $this->y21_codvist) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y21_codnoti"]))
           $resac = db_query("insert into db_acount values($acount,738,5160,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y21_codnoti'))."','$this->y21_codnoti',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y21_codvist"]))
           $resac = db_query("insert into db_acount values($acount,738,5161,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y21_codvist'))."','$this->y21_codvist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y21_codnoti=null,$y21_codvist=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,738,5160,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y21_codnoti'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,738,5161,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y21_codvist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
