...
class cl_rhestagioavaliacaoresposta { 
   ...
   public $h58_sequencial = 0; 
   public $h58_rhestagioquesitoresposta = 0; 
   public $h58_rhestagioavaliacao = 0; 
   ...
   function incluir ($h58_sequencial){ 
     ...
     if($h58_sequencial == "" || $h58_sequencial == null ){
       ...
       $this->h58_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhestagioavaliacaoresposta_h58_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h58_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1876,10881,'','".AddSlashes(pg_fetch_result($resaco,0,'h58_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1876,10882,'','".AddSlashes(pg_fetch_result($resaco,0,'h58_rhestagioquesitoresposta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1876,10883,'','".AddSlashes(pg_fetch_result($resaco,0,'h58_rhestagioavaliacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h58_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h58_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h58_sequencial"])){ 
       $sql  .= $virgula." h58_sequencial = $this->h58_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h58_sequencial) == null ){ 
     ...
     if(trim((string) $this->h58_rhestagioquesitoresposta)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h58_rhestagioquesitoresposta"])){ 
       $sql  .= $virgula." h58_rhestagioquesitoresposta = $this->h58_rhestagioquesitoresposta ";
       $virgula = ",";
       if(trim((string) $this->h58_rhestagioquesitoresposta) == null ){ 
         $this->erro_sql = " Campo Cód. Resposta nao Informado.";
         $this->erro_campo = "h58_rhestagioquesitoresposta";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h58_rhestagioavaliacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h58_rhestagioavaliacao"])){ 
       $sql  .= $virgula." h58_rhestagioavaliacao = $this->h58_rhestagioavaliacao ";
       $virgula = ",";
       if(trim((string) $this->h58_rhestagioavaliacao) == null ){ 
         $this->erro_sql = " Campo Cód. Avaliação nao Informado.";
         $this->erro_campo = "h58_rhestagioavaliacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h58_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1876,10881,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h58_sequencial'))."','$this->h58_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h58_rhestagioquesitoresposta"]))
           $resac = db_query("insert into db_acount values($acount,1876,10882,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h58_rhestagioquesitoresposta'))."','$this->h58_rhestagioquesitoresposta',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h58_rhestagioavaliacao"]))
           $resac = db_query("insert into db_acount values($acount,1876,10883,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h58_rhestagioavaliacao'))."','$this->h58_rhestagioavaliacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h58_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1876,10881,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h58_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1876,10882,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h58_rhestagioquesitoresposta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1876,10883,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h58_rhestagioavaliacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
