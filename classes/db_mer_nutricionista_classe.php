...
class cl_mer_nutricionista { 
   ...
   public $me02_i_codigo = 0; 
   public $me02_c_crn = null; 
   public $me02_c_nutriativo = null; 
   public $me02_i_cgm = 0; 
   ...
   function incluir ($me02_i_codigo){ 
     ...
     if($me02_i_codigo == "" || $me02_i_codigo == null ){
       ...
       $this->me02_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mernutricionista_me02_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $me02_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2224,12715,'','".AddSlashes(pg_fetch_result($resaco,0,'me02_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2224,13775,'','".AddSlashes(pg_fetch_result($resaco,0,'me02_c_crn'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2224,17071,'','".AddSlashes(pg_fetch_result($resaco,0,'me02_c_nutriativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2224,16763,'','".AddSlashes(pg_fetch_result($resaco,0,'me02_i_cgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me02_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->me02_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me02_i_codigo"])){ 
       $sql  .= $virgula." me02_i_codigo = $this->me02_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->me02_i_codigo) == null ){ 
     ...
     if(trim((string) $this->me02_c_crn)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me02_c_crn"])){ 
       $sql  .= $virgula." me02_c_crn = '$this->me02_c_crn' ";
       $virgula = ",";
       if(trim((string) $this->me02_c_crn) == null ){ 
         $this->erro_sql = " Campo N° CRN - Região nao Informado.";
         $this->erro_campo = "me02_c_crn";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me02_c_nutriativo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me02_c_nutriativo"])){ 
       $sql  .= $virgula." me02_c_nutriativo = '$this->me02_c_nutriativo' ";
       $virgula = ",";
       if(trim((string) $this->me02_c_nutriativo) == null ){ 
         $this->erro_sql = " Campo Nutricionista Ativo nao Informado.";
         $this->erro_campo = "me02_c_nutriativo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me02_i_cgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me02_i_cgm"])){ 
       $sql  .= $virgula." me02_i_cgm = $this->me02_i_cgm ";
       $virgula = ",";
       if(trim((string) $this->me02_i_cgm) == null ){ 
         $this->erro_sql = " Campo CGM nao Informado.";
         $this->erro_campo = "me02_i_cgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me02_i_codigo"]) || $this->me02_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2224,12715,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me02_i_codigo'))."','$this->me02_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me02_c_crn"]) || $this->me02_c_crn != "")
           $resac = db_query("insert into db_acount values($acount,2224,13775,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me02_c_crn'))."','$this->me02_c_crn',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me02_c_nutriativo"]) || $this->me02_c_nutriativo != "")
           $resac = db_query("insert into db_acount values($acount,2224,17071,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me02_c_nutriativo'))."','$this->me02_c_nutriativo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me02_i_cgm"]) || $this->me02_i_cgm != "")
           $resac = db_query("insert into db_acount values($acount,2224,16763,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me02_i_cgm'))."','$this->me02_i_cgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me02_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2224,12715,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me02_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2224,13775,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me02_c_crn'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2224,17071,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me02_c_nutriativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2224,16763,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me02_i_cgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
