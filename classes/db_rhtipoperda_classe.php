...
class cl_rhtipoperda { 
   ...
   public $h70_sequencial = 0; 
   public $h70_descricao = null; 
   public $h70_dias = 0; 
   ...
   function incluir ($h70_sequencial){ 
     ...
     if($h70_sequencial == "" || $h70_sequencial == null ){
       ...
       $this->h70_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhtipoperda_h70_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h70_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3313,18703,'','".AddSlashes(pg_fetch_result($resaco,0,'h70_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3313,18704,'','".AddSlashes(pg_fetch_result($resaco,0,'h70_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3313,18705,'','".AddSlashes(pg_fetch_result($resaco,0,'h70_dias'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h70_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h70_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h70_sequencial"])){ 
       $sql  .= $virgula." h70_sequencial = $this->h70_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h70_sequencial) == null ){ 
     ...
     if(trim((string) $this->h70_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h70_descricao"])){ 
       $sql  .= $virgula." h70_descricao = '$this->h70_descricao' ";
       $virgula = ",";
       if(trim((string) $this->h70_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "h70_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h70_dias)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h70_dias"])){ 
       $sql  .= $virgula." h70_dias = $this->h70_dias ";
       $virgula = ",";
       if(trim((string) $this->h70_dias) == null ){ 
         $this->erro_sql = " Campo Dias nao Informado.";
         $this->erro_campo = "h70_dias";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h70_sequencial"]) || $this->h70_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3313,18703,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h70_sequencial'))."','$this->h70_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h70_descricao"]) || $this->h70_descricao != "")
           $resac = db_query("insert into db_acount values($acount,3313,18704,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h70_descricao'))."','$this->h70_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h70_dias"]) || $this->h70_dias != "")
           $resac = db_query("insert into db_acount values($acount,3313,18705,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h70_dias'))."','$this->h70_dias',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h70_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3313,18703,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h70_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3313,18704,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h70_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3313,18705,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h70_dias'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
