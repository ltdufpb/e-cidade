...
class cl_fiscarquivos { 
   ...
   function incluir ($y26_codnoti,$y26_idparag){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,746,5187,'','".AddSlashes(pg_fetch_result($resaco,0,'y26_codnoti'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,746,5188,'','".AddSlashes(pg_fetch_result($resaco,0,'y26_idparag'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y26_codnoti=null,$y26_idparag=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y26_codnoti)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y26_codnoti"])){ 
       $sql  .= $virgula." y26_codnoti = $this->y26_codnoti ";
       $virgula = ",";
       if(trim((string) $this->y26_codnoti) == null ){ 
     ...
     if(trim((string) $this->y26_idparag)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y26_idparag"])){ 
       $sql  .= $virgula." y26_idparag = $this->y26_idparag ";
       $virgula = ",";
       if(trim((string) $this->y26_idparag) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y26_codnoti"]))
           $resac = db_query("insert into db_acount values($acount,746,5187,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y26_codnoti'))."','$this->y26_codnoti',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y26_idparag"]))
           $resac = db_query("insert into db_acount values($acount,746,5188,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y26_idparag'))."','$this->y26_idparag',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y26_codnoti=null,$y26_idparag=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,746,5187,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y26_codnoti'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,746,5188,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y26_idparag'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
