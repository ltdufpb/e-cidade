...
class cl_matestoqueitemlanc { 
   ...
   public $m95_codlanc = 0; 
   public $m95_id_usuario = 0; 
   public $m95_data_dia = null; 
   public $m95_data_mes = null; 
   public $m95_data_ano = null; 
   public $m95_data = null; 
   public $m95_verificado = 'f'; 
   ...
   function incluir ($m95_codlanc){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1660,9645,'','".AddSlashes(pg_fetch_result($resaco,0,'m95_codlanc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1660,9646,'','".AddSlashes(pg_fetch_result($resaco,0,'m95_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1660,9647,'','".AddSlashes(pg_fetch_result($resaco,0,'m95_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1660,9648,'','".AddSlashes(pg_fetch_result($resaco,0,'m95_verificado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($m95_codlanc=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->m95_codlanc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m95_codlanc"])){ 
       $sql  .= $virgula." m95_codlanc = $this->m95_codlanc ";
       $virgula = ",";
       if(trim((string) $this->m95_codlanc) == null ){ 
     ...
     if(trim((string) $this->m95_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m95_id_usuario"])){ 
       $sql  .= $virgula." m95_id_usuario = $this->m95_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->m95_id_usuario) == null ){ 
         $this->erro_sql = " Campo Cod. Usuário nao Informado.";
         $this->erro_campo = "m95_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m95_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m95_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["m95_data_dia"] !="") ){ 
       $sql  .= $virgula." m95_data = '$this->m95_data' ";
       $virgula = ",";
       if(trim((string) $this->m95_data) == null ){ 
         $this->erro_sql = " Campo Data de entrada nao Informado.";
         $this->erro_campo = "m95_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->m95_verificado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m95_verificado"])){ 
       $sql  .= $virgula." m95_verificado = '$this->m95_verificado' ";
       $virgula = ",";
       if(trim((string) $this->m95_verificado) == null ){ 
         $this->erro_sql = " Campo Verificado nao Informado.";
         $this->erro_campo = "m95_verificado";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["m95_codlanc"]))
           $resac = db_query("insert into db_acount values($acount,1660,9645,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m95_codlanc'))."','$this->m95_codlanc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m95_id_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1660,9646,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m95_id_usuario'))."','$this->m95_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m95_data"]))
           $resac = db_query("insert into db_acount values($acount,1660,9647,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m95_data'))."','$this->m95_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m95_verificado"]))
           $resac = db_query("insert into db_acount values($acount,1660,9648,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'m95_verificado'))."','$this->m95_verificado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($m95_codlanc=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1660,9645,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m95_codlanc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1660,9646,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m95_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1660,9647,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m95_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1660,9648,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'m95_verificado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
