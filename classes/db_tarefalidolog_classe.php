...
class cl_tarefalidolog { 
   ...
   public $at60_sequencial = 0; 
   public $at60_tarefalido = 0; 
   public $at60_tarefalog = 0; 
   ...
   function incluir ($at60_sequencial){ 
     ...
     if($at60_sequencial == "" || $at60_sequencial == null ){
       ...
       $this->at60_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tarefalidolog_at60_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at60_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1558,9093,'','".AddSlashes(pg_fetch_result($resaco,0,'at60_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1558,9094,'','".AddSlashes(pg_fetch_result($resaco,0,'at60_tarefalido'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1558,9096,'','".AddSlashes(pg_fetch_result($resaco,0,'at60_tarefalog'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at60_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at60_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at60_sequencial"])){ 
       $sql  .= $virgula." at60_sequencial = $this->at60_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at60_sequencial) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
     ...
     if(trim((string) $this->at60_tarefalido)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at60_tarefalido"])){ 
       $sql  .= $virgula." at60_tarefalido = $this->at60_tarefalido ";
       $virgula = ",";
       if(trim((string) $this->at60_tarefalido) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
         $this->erro_campo = "at60_tarefalido";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at60_tarefalog)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at60_tarefalog"])){ 
       $sql  .= $virgula." at60_tarefalog = $this->at60_tarefalog ";
       $virgula = ",";
       if(trim((string) $this->at60_tarefalog) == null ){ 
         $this->erro_sql = " Campo Codigo de Andamento nao Informado.";
         $this->erro_campo = "at60_tarefalog";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at60_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1558,9093,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at60_sequencial'))."','$this->at60_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at60_tarefalido"]))
           $resac = db_query("insert into db_acount values($acount,1558,9094,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at60_tarefalido'))."','$this->at60_tarefalido',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at60_tarefalog"]))
           $resac = db_query("insert into db_acount values($acount,1558,9096,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at60_tarefalog'))."','$this->at60_tarefalog',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at60_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1558,9093,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at60_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1558,9094,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at60_tarefalido'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1558,9096,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at60_tarefalog'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
