...
class cl_acordopenalidade { 
   ...
   public $ac13_sequencial = 0; 
   public $ac13_descricao = null; 
   public $ac13_obs = null; 
   public $ac13_textopadrao = null; 
   public $ac13_validade_dia = null; 
   public $ac13_validade_mes = null; 
   public $ac13_validade_ano = null; 
   public $ac13_validade = null; 
   ...
   function incluir ($ac13_sequencial){ 
     ...
     if($ac13_sequencial == "" || $ac13_sequencial == null ){
       ...
       $this->ac13_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordopenalidade_ac13_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac13_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2834,16156,'','".AddSlashes(pg_fetch_result($resaco,0,'ac13_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2834,16157,'','".AddSlashes(pg_fetch_result($resaco,0,'ac13_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2834,16158,'','".AddSlashes(pg_fetch_result($resaco,0,'ac13_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2834,16159,'','".AddSlashes(pg_fetch_result($resaco,0,'ac13_textopadrao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2834,16160,'','".AddSlashes(pg_fetch_result($resaco,0,'ac13_validade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac13_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac13_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac13_sequencial"])){ 
       $sql  .= $virgula." ac13_sequencial = $this->ac13_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac13_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac13_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac13_descricao"])){ 
       $sql  .= $virgula." ac13_descricao = '$this->ac13_descricao' ";
       $virgula = ",";
       if(trim((string) $this->ac13_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "ac13_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac13_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac13_obs"])){ 
       $sql  .= $virgula." ac13_obs = '$this->ac13_obs' ";
       $virgula = ",";
       if(trim((string) $this->ac13_obs) == null ){ 
         $this->erro_sql = " Campo Observação nao Informado.";
         $this->erro_campo = "ac13_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac13_textopadrao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac13_textopadrao"])){ 
       $sql  .= $virgula." ac13_textopadrao = '$this->ac13_textopadrao' ";
       $virgula = ",";
       if(trim((string) $this->ac13_textopadrao) == null ){ 
         $this->erro_sql = " Campo Texto Padrão nao Informado.";
         $this->erro_campo = "ac13_textopadrao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac13_validade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac13_validade_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ac13_validade_dia"] !="") ){ 
       $sql  .= $virgula." ac13_validade = '$this->ac13_validade' ";
       $virgula = ",";
       if(trim((string) $this->ac13_validade) == null ){ 
         $this->erro_sql = " Campo Validade nao Informado.";
         $this->erro_campo = "ac13_validade_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac13_sequencial"]) || $this->ac13_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2834,16156,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac13_sequencial'))."','$this->ac13_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac13_descricao"]) || $this->ac13_descricao != "")
           $resac = db_query("insert into db_acount values($acount,2834,16157,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac13_descricao'))."','$this->ac13_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac13_obs"]) || $this->ac13_obs != "")
           $resac = db_query("insert into db_acount values($acount,2834,16158,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac13_obs'))."','$this->ac13_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac13_textopadrao"]) || $this->ac13_textopadrao != "")
           $resac = db_query("insert into db_acount values($acount,2834,16159,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac13_textopadrao'))."','$this->ac13_textopadrao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac13_validade"]) || $this->ac13_validade != "")
           $resac = db_query("insert into db_acount values($acount,2834,16160,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac13_validade'))."','$this->ac13_validade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac13_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2834,16156,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac13_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2834,16157,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac13_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2834,16158,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac13_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2834,16159,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac13_textopadrao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2834,16160,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac13_validade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
