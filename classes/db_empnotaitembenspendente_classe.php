...
class cl_empnotaitembenspendente {
   ...
   public $e137_sequencial = 0;
   public $e137_empnotaitem = 0;
   public $e137_matestoqueitem = 0;
   ...
   function incluir ($e137_sequencial){
     ...
     if($e137_sequencial == "" || $e137_sequencial == null ){
       ...
       $this->e137_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from empnotaitembenspendente_e137_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $e137_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3350,18890,'','".AddSlashes(pg_fetch_result($resaco,0,'e137_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3350,18891,'','".AddSlashes(pg_fetch_result($resaco,0,'e137_empnotaitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3350,18892,'','".AddSlashes(pg_fetch_result($resaco,0,'e137_matestoqueitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($e137_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->e137_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e137_sequencial"])){
       $sql  .= $virgula." e137_sequencial = $this->e137_sequencial ";
       $virgula = ",";
       if(trim((string) $this->e137_sequencial) == null ){
     ...
     if(trim((string) $this->e137_empnotaitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e137_empnotaitem"])){
       $sql  .= $virgula." e137_empnotaitem = $this->e137_empnotaitem ";
       $virgula = ",";
       if(trim((string) $this->e137_empnotaitem) == null ){
         $this->erro_sql = " Campo empnotaitem nao Informado.";
         $this->erro_campo = "e137_empnotaitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e137_matestoqueitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e137_matestoqueitem"])){
       $sql  .= $virgula." e137_matestoqueitem = $this->e137_matestoqueitem ";
       $virgula = ",";
       if(trim((string) $this->e137_matestoqueitem) == null ){
         $this->erro_sql = " Campo Matestoqueitem nao Informado.";
         $this->erro_campo = "e137_matestoqueitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e137_sequencial"]) || $this->e137_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3350,18890,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e137_sequencial'))."','$this->e137_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e137_empnotaitem"]) || $this->e137_empnotaitem != "")
           $resac = db_query("insert into db_acount values($acount,3350,18891,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e137_empnotaitem'))."','$this->e137_empnotaitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e137_matestoqueitem"]) || $this->e137_matestoqueitem != "")
           $resac = db_query("insert into db_acount values($acount,3350,18892,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e137_matestoqueitem'))."','$this->e137_matestoqueitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($e137_sequencial=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3350,18890,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e137_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3350,18891,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e137_empnotaitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3350,18892,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e137_matestoqueitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
