...
class cl_aguacoletorexportadadosleitura { 
   ...
   public $x51_sequencial = 0; 
   public $x51_aguacoletorexportadados = 0; 
   public $x51_agualeitura = 0; 
   public $x51_diasultimaleitura = 0; 
   public $x51_mesesultimaleitura = 0; 
   public $x51_tipoleitura = 0; 
   public $x51_numcgm = 0; 
   ...
   function incluir ($x51_sequencial){ 
     ...
     if($x51_sequencial == "" || $x51_sequencial == null ){
       ...
       $this->x51_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from aguacoletorexportadadosleitura_x51_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $x51_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2705,15406,'','".AddSlashes(pg_fetch_result($resaco,0,'x51_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2705,15407,'','".AddSlashes(pg_fetch_result($resaco,0,'x51_aguacoletorexportadados'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2705,15408,'','".AddSlashes(pg_fetch_result($resaco,0,'x51_agualeitura'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2705,15409,'','".AddSlashes(pg_fetch_result($resaco,0,'x51_diasultimaleitura'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2705,15410,'','".AddSlashes(pg_fetch_result($resaco,0,'x51_mesesultimaleitura'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2705,15411,'','".AddSlashes(pg_fetch_result($resaco,0,'x51_tipoleitura'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2705,16565,'','".AddSlashes(pg_fetch_result($resaco,0,'x51_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($x51_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->x51_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x51_sequencial"])){ 
       $sql  .= $virgula." x51_sequencial = $this->x51_sequencial ";
       $virgula = ",";
       if(trim((string) $this->x51_sequencial) == null ){ 
     ...
     if(trim((string) $this->x51_aguacoletorexportadados)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x51_aguacoletorexportadados"])){ 
       $sql  .= $virgula." x51_aguacoletorexportadados = $this->x51_aguacoletorexportadados ";
       $virgula = ",";
       if(trim((string) $this->x51_aguacoletorexportadados) == null ){ 
         $this->erro_sql = " Campo Código Exportação Dados nao Informado.";
         $this->erro_campo = "x51_aguacoletorexportadados";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->x51_agualeitura)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x51_agualeitura"])){ 
       $sql  .= $virgula." x51_agualeitura = $this->x51_agualeitura ";
       $virgula = ",";
       if(trim((string) $this->x51_agualeitura) == null ){ 
         $this->erro_sql = " Campo Codigo nao Informado.";
         $this->erro_campo = "x51_agualeitura";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->x51_diasultimaleitura)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x51_diasultimaleitura"])){ 
       $sql  .= $virgula." x51_diasultimaleitura = $this->x51_diasultimaleitura ";
       $virgula = ",";
       if(trim((string) $this->x51_diasultimaleitura) == null ){ 
         $this->erro_sql = " Campo Dias Ultima Leitura nao Informado.";
         $this->erro_campo = "x51_diasultimaleitura";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->x51_mesesultimaleitura)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x51_mesesultimaleitura"])){ 
       $sql  .= $virgula." x51_mesesultimaleitura = $this->x51_mesesultimaleitura ";
       $virgula = ",";
       if(trim((string) $this->x51_mesesultimaleitura) == null ){ 
         $this->erro_sql = " Campo Mês Última Leitura nao Informado.";
         $this->erro_campo = "x51_mesesultimaleitura";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->x51_tipoleitura)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x51_tipoleitura"])){ 
       $sql  .= $virgula." x51_tipoleitura = $this->x51_tipoleitura ";
       $virgula = ",";
       if(trim((string) $this->x51_tipoleitura) == null ){ 
         $this->erro_sql = " Campo Tipo de Leitura nao Informado.";
         $this->erro_campo = "x51_tipoleitura";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->x51_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["x51_numcgm"])){ 
        if(trim((string) $this->x51_numcgm)=="" && isset($GLOBALS["HTTP_POST_VARS"]["x51_numcgm"])){ 
           $this->x51_numcgm = "0" ; 
        } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x51_sequencial"]) || $this->x51_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2705,15406,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x51_sequencial'))."','$this->x51_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x51_aguacoletorexportadados"]) || $this->x51_aguacoletorexportadados != "")
           $resac = db_query("insert into db_acount values($acount,2705,15407,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x51_aguacoletorexportadados'))."','$this->x51_aguacoletorexportadados',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x51_agualeitura"]) || $this->x51_agualeitura != "")
           $resac = db_query("insert into db_acount values($acount,2705,15408,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x51_agualeitura'))."','$this->x51_agualeitura',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x51_diasultimaleitura"]) || $this->x51_diasultimaleitura != "")
           $resac = db_query("insert into db_acount values($acount,2705,15409,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x51_diasultimaleitura'))."','$this->x51_diasultimaleitura',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x51_mesesultimaleitura"]) || $this->x51_mesesultimaleitura != "")
           $resac = db_query("insert into db_acount values($acount,2705,15410,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x51_mesesultimaleitura'))."','$this->x51_mesesultimaleitura',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x51_tipoleitura"]) || $this->x51_tipoleitura != "")
           $resac = db_query("insert into db_acount values($acount,2705,15411,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x51_tipoleitura'))."','$this->x51_tipoleitura',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["x51_numcgm"]) || $this->x51_numcgm != "")
           $resac = db_query("insert into db_acount values($acount,2705,16565,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'x51_numcgm'))."','$this->x51_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($x51_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2705,15406,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x51_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2705,15407,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x51_aguacoletorexportadados'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2705,15408,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x51_agualeitura'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2705,15409,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x51_diasultimaleitura'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2705,15410,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x51_mesesultimaleitura'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2705,15411,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x51_tipoleitura'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2705,16565,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'x51_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
