...
class cl_tarefausu { 
   ...
   public $at42_sequencial = 0; 
   public $at42_tarefa = 0; 
   public $at42_usuario = 0; 
   public $at42_perc = 0; 
   ...
   function incluir ($at42_sequencial){ 
     ...
     if($at42_sequencial == "" || $at42_sequencial == null ){
       ...
       $this->at42_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tarefausu_at42_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at42_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1367,8101,'','".AddSlashes(pg_fetch_result($resaco,0,'at42_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1367,8102,'','".AddSlashes(pg_fetch_result($resaco,0,'at42_tarefa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1367,8103,'','".AddSlashes(pg_fetch_result($resaco,0,'at42_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1367,8104,'','".AddSlashes(pg_fetch_result($resaco,0,'at42_perc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at42_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at42_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at42_sequencial"])){ 
       $sql  .= $virgula." at42_sequencial = $this->at42_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at42_sequencial) == null ){ 
     ...
     if(trim((string) $this->at42_tarefa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at42_tarefa"])){ 
       $sql  .= $virgula." at42_tarefa = $this->at42_tarefa ";
       $virgula = ",";
       if(trim((string) $this->at42_tarefa) == null ){ 
         $this->erro_sql = " Campo Codigo da Tarefa nao Informado.";
         $this->erro_campo = "at42_tarefa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at42_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at42_usuario"])){ 
       $sql  .= $virgula." at42_usuario = $this->at42_usuario ";
       $virgula = ",";
       if(trim((string) $this->at42_usuario) == null ){ 
         $this->erro_sql = " Campo Cod. Usuário nao Informado.";
         $this->erro_campo = "at42_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at42_perc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at42_perc"])){ 
       $sql  .= $virgula." at42_perc = $this->at42_perc ";
       $virgula = ",";
       if(trim((string) $this->at42_perc) == null ){ 
         $this->erro_sql = " Campo Percentual nao Informado.";
         $this->erro_campo = "at42_perc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at42_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1367,8101,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at42_sequencial'))."','$this->at42_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at42_tarefa"]))
           $resac = db_query("insert into db_acount values($acount,1367,8102,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at42_tarefa'))."','$this->at42_tarefa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at42_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1367,8103,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at42_usuario'))."','$this->at42_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at42_perc"]))
           $resac = db_query("insert into db_acount values($acount,1367,8104,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at42_perc'))."','$this->at42_perc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at42_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1367,8101,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at42_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1367,8102,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at42_tarefa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1367,8103,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at42_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1367,8104,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at42_perc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
