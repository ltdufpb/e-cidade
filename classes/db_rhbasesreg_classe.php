...
class cl_rhbasesreg { 
   ...
   public $rh54_seq = 0; 
   public $rh54_regist = 0; 
   public $rh54_base = null; 
   public $rh54_rubric = null; 
   ...
   function incluir ($rh54_seq){ 
     ...
     if($rh54_seq == "" || $rh54_seq == null ){
       ...
       $this->rh54_seq = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhbasesreg_rh54_seq_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh54_seq)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1544,9019,'','".AddSlashes(pg_fetch_result($resaco,0,'rh54_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1544,9020,'','".AddSlashes(pg_fetch_result($resaco,0,'rh54_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1544,9021,'','".AddSlashes(pg_fetch_result($resaco,0,'rh54_base'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1544,9022,'','".AddSlashes(pg_fetch_result($resaco,0,'rh54_rubric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh54_seq=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh54_seq)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh54_seq"])){ 
       $sql  .= $virgula." rh54_seq = $this->rh54_seq ";
       $virgula = ",";
       if(trim((string) $this->rh54_seq) == null ){ 
     ...
     if(trim((string) $this->rh54_regist)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh54_regist"])){ 
       $sql  .= $virgula." rh54_regist = $this->rh54_regist ";
       $virgula = ",";
       if(trim((string) $this->rh54_regist) == null ){ 
         $this->erro_sql = " Campo Matrícula nao Informado.";
         $this->erro_campo = "rh54_regist";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh54_base)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh54_base"])){ 
       $sql  .= $virgula." rh54_base = '$this->rh54_base' ";
       $virgula = ",";
       if(trim((string) $this->rh54_base) == null ){ 
         $this->erro_sql = " Campo Base nao Informado.";
         $this->erro_campo = "rh54_base";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh54_rubric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh54_rubric"])){ 
       $sql  .= $virgula." rh54_rubric = '$this->rh54_rubric' ";
       $virgula = ",";
       if(trim((string) $this->rh54_rubric) == null ){ 
         $this->erro_sql = " Campo Rubrica nao Informado.";
         $this->erro_campo = "rh54_rubric";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh54_seq"]))
           $resac = db_query("insert into db_acount values($acount,1544,9019,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh54_seq'))."','$this->rh54_seq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh54_regist"]))
           $resac = db_query("insert into db_acount values($acount,1544,9020,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh54_regist'))."','$this->rh54_regist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh54_base"]))
           $resac = db_query("insert into db_acount values($acount,1544,9021,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh54_base'))."','$this->rh54_base',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh54_rubric"]))
           $resac = db_query("insert into db_acount values($acount,1544,9022,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh54_rubric'))."','$this->rh54_rubric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh54_seq=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1544,9019,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh54_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1544,9020,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh54_regist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1544,9021,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh54_base'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1544,9022,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh54_rubric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
