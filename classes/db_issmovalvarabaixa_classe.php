...
class cl_issmovalvarabaixa { 
   ...
   function incluir ($q129_sequecial){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3252,18370,'','".AddSlashes(pg_fetch_result($resaco,0,'q129_sequecial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3252,18371,'','".AddSlashes(pg_fetch_result($resaco,0,'q129_issmovalvara'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3252,18372,'','".AddSlashes(pg_fetch_result($resaco,0,'q129_tipobaixa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q129_sequecial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q129_sequecial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q129_sequecial"])){ 
       $sql  .= $virgula." q129_sequecial = $this->q129_sequecial ";
       $virgula = ",";
       if(trim((string) $this->q129_sequecial) == null ){ 
     ...
     if(trim((string) $this->q129_issmovalvara)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q129_issmovalvara"])){ 
       $sql  .= $virgula." q129_issmovalvara = $this->q129_issmovalvara ";
       $virgula = ",";
       if(trim((string) $this->q129_issmovalvara) == null ){ 
         $this->erro_sql = " Campo Movimentação nao Informado.";
         $this->erro_campo = "q129_issmovalvara";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q129_tipobaixa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q129_tipobaixa"])){ 
       $sql  .= $virgula." q129_tipobaixa = $this->q129_tipobaixa ";
       $virgula = ",";
       if(trim((string) $this->q129_tipobaixa) == null ){ 
         $this->erro_sql = " Campo Tipo de Baixa nao Informado.";
         $this->erro_campo = "q129_tipobaixa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q129_sequecial"]) || $this->q129_sequecial != "")
           $resac = db_query("insert into db_acount values($acount,3252,18370,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q129_sequecial'))."','$this->q129_sequecial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q129_issmovalvara"]) || $this->q129_issmovalvara != "")
           $resac = db_query("insert into db_acount values($acount,3252,18371,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q129_issmovalvara'))."','$this->q129_issmovalvara',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q129_tipobaixa"]) || $this->q129_tipobaixa != "")
           $resac = db_query("insert into db_acount values($acount,3252,18372,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q129_tipobaixa'))."','$this->q129_tipobaixa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q129_sequecial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3252,18370,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q129_sequecial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3252,18371,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q129_issmovalvara'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3252,18372,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q129_tipobaixa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
