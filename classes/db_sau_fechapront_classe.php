...
class cl_sau_fechapront { 
   ...
   public $sd98_i_codigo = 0; 
   public $sd98_i_prontproced = 0; 
   public $sd98_i_fechamento = 0; 
   ...
   function incluir ($sd98_i_codigo){ 
     ...
     if($sd98_i_codigo == "" || $sd98_i_codigo == null ){
       ...
       $this->sd98_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from sau_fechapront_sd98_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $sd98_i_codigo)){
   ...
   function alterar ($sd98_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd98_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd98_i_codigo"])){ 
       $sql  .= $virgula." sd98_i_codigo = $this->sd98_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->sd98_i_codigo) == null ){ 
     ...
     if(trim((string) $this->sd98_i_prontproced)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd98_i_prontproced"])){ 
       $sql  .= $virgula." sd98_i_prontproced = $this->sd98_i_prontproced ";
       $virgula = ",";
       if(trim((string) $this->sd98_i_prontproced) == null ){ 
         $this->erro_sql = " Campo Prontproced nao Informado.";
         $this->erro_campo = "sd98_i_prontproced";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd98_i_fechamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd98_i_fechamento"])){ 
       $sql  .= $virgula." sd98_i_fechamento = $this->sd98_i_fechamento ";
       $virgula = ",";
       if(trim((string) $this->sd98_i_fechamento) == null ){ 
         $this->erro_sql = " Campo Fechamento nao Informado.";
         $this->erro_campo = "sd98_i_fechamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
