...
class cl_autoandam { 
   ...
   function incluir ($y58_codauto,$y58_codandam){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,708,5012,'','".AddSlashes(pg_fetch_result($resaco,0,'y58_codauto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,708,5013,'','".AddSlashes(pg_fetch_result($resaco,0,'y58_codandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y58_codauto=null,$y58_codandam=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y58_codauto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y58_codauto"])){ 
       $sql  .= $virgula." y58_codauto = $this->y58_codauto ";
       $virgula = ",";
       if(trim((string) $this->y58_codauto) == null ){ 
     ...
     if(trim((string) $this->y58_codandam)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y58_codandam"])){ 
       $sql  .= $virgula." y58_codandam = $this->y58_codandam ";
       $virgula = ",";
       if(trim((string) $this->y58_codandam) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y58_codauto"]))
           $resac = db_query("insert into db_acount values($acount,708,5012,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y58_codauto'))."','$this->y58_codauto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y58_codandam"]))
           $resac = db_query("insert into db_acount values($acount,708,5013,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y58_codandam'))."','$this->y58_codandam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y58_codauto=null,$y58_codandam=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,708,5012,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y58_codauto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,708,5013,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y58_codandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
