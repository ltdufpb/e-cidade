...
class cl_autosanitario { 
   ...
   function incluir ($y55_codauto){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,705,5003,'','".AddSlashes(pg_fetch_result($resaco,0,'y55_codauto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,705,5004,'','".AddSlashes(pg_fetch_result($resaco,0,'y55_codsani'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y55_codauto=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y55_codauto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y55_codauto"])){ 
       $sql  .= $virgula." y55_codauto = $this->y55_codauto ";
       $virgula = ",";
       if(trim((string) $this->y55_codauto) == null ){ 
     ...
     if(trim((string) $this->y55_codsani)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y55_codsani"])){ 
       $sql  .= $virgula." y55_codsani = $this->y55_codsani ";
       $virgula = ",";
       if(trim((string) $this->y55_codsani) == null ){ 
         $this->erro_sql = " Campo Código do Alvará sanitário nao Informado.";
         $this->erro_campo = "y55_codsani";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y55_codauto"]))
           $resac = db_query("insert into db_acount values($acount,705,5003,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y55_codauto'))."','$this->y55_codauto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y55_codsani"]))
           $resac = db_query("insert into db_acount values($acount,705,5004,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y55_codsani'))."','$this->y55_codsani',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y55_codauto=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,705,5003,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y55_codauto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,705,5004,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y55_codsani'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
