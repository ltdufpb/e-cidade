...
class cl_setorfiscalvalor { 
   ...
   function alterar ($j82_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j82_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j82_codigo"])){ 
       $sql  .= $virgula." j82_codigo = $this->j82_codigo ";
       $virgula = ",";
       if(trim((string) $this->j82_codigo) == null ){ 
     ...
     if(trim((string) $this->j82_setorfiscal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j82_setorfiscal"])){ 
       $sql  .= $virgula." j82_setorfiscal = $this->j82_setorfiscal ";
       $virgula = ",";
       if(trim((string) $this->j82_setorfiscal) == null ){ 
         $this->erro_sql = " Campo Codigo do setor fiscal nao Informado.";
         $this->erro_campo = "j82_setorfiscal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j82_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j82_anousu"])){ 
       $sql  .= $virgula." j82_anousu = $this->j82_anousu ";
       $virgula = ",";
       if(trim((string) $this->j82_anousu) == null ){ 
         $this->erro_sql = " Campo Ano nao Informado.";
         $this->erro_campo = "j82_anousu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j82_valorterreno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j82_valorterreno"])){ 
       $sql  .= $virgula." j82_valorterreno = $this->j82_valorterreno ";
       $virgula = ",";
       if(trim((string) $this->j82_valorterreno) == null ){ 
         $this->erro_sql = " Campo Valor m2 terreno nao Informado.";
         $this->erro_campo = "j82_valorterreno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
