...
class cl_mer_restricaointolerancia { 
   ...
   public $me34_i_codigo = 0; 
   public $me34_i_restricao = 0; 
   public $me34_i_intolerancia = 0; 
   ...
   function incluir ($me34_i_codigo){ 
     ...
     if($me34_i_codigo == "" || $me34_i_codigo == null ){
       ...
       $this->me34_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mer_restricaointolerancia_me34_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $me34_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3039,17191,'','".AddSlashes(pg_fetch_result($resaco,0,'me34_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3039,17192,'','".AddSlashes(pg_fetch_result($resaco,0,'me34_i_restricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3039,17193,'','".AddSlashes(pg_fetch_result($resaco,0,'me34_i_intolerancia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me34_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->me34_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me34_i_codigo"])){ 
       $sql  .= $virgula." me34_i_codigo = $this->me34_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->me34_i_codigo) == null ){ 
     ...
     if(trim((string) $this->me34_i_restricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me34_i_restricao"])){ 
       $sql  .= $virgula." me34_i_restricao = $this->me34_i_restricao ";
       $virgula = ",";
       if(trim((string) $this->me34_i_restricao) == null ){ 
         $this->erro_sql = " Campo Restrição nao Informado.";
         $this->erro_campo = "me34_i_restricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me34_i_intolerancia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me34_i_intolerancia"])){ 
       $sql  .= $virgula." me34_i_intolerancia = $this->me34_i_intolerancia ";
       $virgula = ",";
       if(trim((string) $this->me34_i_intolerancia) == null ){ 
         $this->erro_sql = " Campo Intolerância Alimentar nao Informado.";
         $this->erro_campo = "me34_i_intolerancia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me34_i_codigo"]) || $this->me34_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3039,17191,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me34_i_codigo'))."','$this->me34_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me34_i_restricao"]) || $this->me34_i_restricao != "")
           $resac = db_query("insert into db_acount values($acount,3039,17192,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me34_i_restricao'))."','$this->me34_i_restricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me34_i_intolerancia"]) || $this->me34_i_intolerancia != "")
           $resac = db_query("insert into db_acount values($acount,3039,17193,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me34_i_intolerancia'))."','$this->me34_i_intolerancia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me34_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3039,17191,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me34_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3039,17192,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me34_i_restricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3039,17193,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me34_i_intolerancia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
