...
class cl_autousu { 
   ...
   function incluir ($y56_codauto,$y56_id_usuario){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,706,5005,'','".AddSlashes(pg_fetch_result($resaco,0,'y56_codauto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,706,5006,'','".AddSlashes(pg_fetch_result($resaco,0,'y56_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,706,5007,'','".AddSlashes(pg_fetch_result($resaco,0,'y56_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y56_codauto=null,$y56_id_usuario=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y56_codauto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y56_codauto"])){ 
       $sql  .= $virgula." y56_codauto = $this->y56_codauto ";
       $virgula = ",";
       if(trim((string) $this->y56_codauto) == null ){ 
     ...
     if(trim((string) $this->y56_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y56_id_usuario"])){ 
       $sql  .= $virgula." y56_id_usuario = $this->y56_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->y56_id_usuario) == null ){ 
     ...
     if(trim((string) $this->y56_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y56_obs"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y56_codauto"]))
           $resac = db_query("insert into db_acount values($acount,706,5005,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y56_codauto'))."','$this->y56_codauto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y56_id_usuario"]))
           $resac = db_query("insert into db_acount values($acount,706,5006,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y56_id_usuario'))."','$this->y56_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y56_obs"]))
           $resac = db_query("insert into db_acount values($acount,706,5007,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y56_obs'))."','$this->y56_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y56_codauto=null,$y56_id_usuario=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,706,5005,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y56_codauto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,706,5006,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y56_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,706,5007,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y56_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
