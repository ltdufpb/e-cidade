...
class cl_custoplanoanaliticabens { 
   ...
   public $cc05_sequencial = 0; 
   public $cc05_bens = 0; 
   public $cc05_custoplanoanalitica = 0; 
   ...
   function incluir ($cc05_sequencial){ 
     ...
     if($cc05_sequencial == "" || $cc05_sequencial == null ){
       ...
       $this->cc05_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from custoplanoanaliticabens_cc05_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $cc05_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2195,12574,'','".AddSlashes(pg_fetch_result($resaco,0,'cc05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2195,12575,'','".AddSlashes(pg_fetch_result($resaco,0,'cc05_bens'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2195,12576,'','".AddSlashes(pg_fetch_result($resaco,0,'cc05_custoplanoanalitica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($cc05_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->cc05_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc05_sequencial"])){ 
       $sql  .= $virgula." cc05_sequencial = $this->cc05_sequencial ";
       $virgula = ",";
       if(trim((string) $this->cc05_sequencial) == null ){ 
     ...
     if(trim((string) $this->cc05_bens)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc05_bens"])){ 
       $sql  .= $virgula." cc05_bens = $this->cc05_bens ";
       $virgula = ",";
       if(trim((string) $this->cc05_bens) == null ){ 
         $this->erro_sql = " Campo Bens nao Informado.";
         $this->erro_campo = "cc05_bens";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cc05_custoplanoanalitica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc05_custoplanoanalitica"])){ 
       $sql  .= $virgula." cc05_custoplanoanalitica = $this->cc05_custoplanoanalitica ";
       $virgula = ",";
       if(trim((string) $this->cc05_custoplanoanalitica) == null ){ 
         $this->erro_sql = " Campo Custo plano analítico nao Informado.";
         $this->erro_campo = "cc05_custoplanoanalitica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc05_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2195,12574,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc05_sequencial'))."','$this->cc05_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc05_bens"]))
           $resac = db_query("insert into db_acount values($acount,2195,12575,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc05_bens'))."','$this->cc05_bens',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc05_custoplanoanalitica"]))
           $resac = db_query("insert into db_acount values($acount,2195,12576,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc05_custoplanoanalitica'))."','$this->cc05_custoplanoanalitica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($cc05_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2195,12574,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2195,12575,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc05_bens'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2195,12576,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc05_custoplanoanalitica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
