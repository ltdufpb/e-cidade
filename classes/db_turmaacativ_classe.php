...
class cl_turmaacativ { 
   ...
   public $ed267_i_codigo = 0; 
   public $ed267_i_turmaac = 0; 
   public $ed267_i_censoativcompl = 0; 
   ...
   function incluir ($ed267_i_codigo){ 
     ...
     if($ed267_i_codigo == "" || $ed267_i_codigo == null ){
       ...
       $this->ed267_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from turmaacativ_ed267_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed267_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2414,13791,'','".AddSlashes(pg_fetch_result($resaco,0,'ed267_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2414,13792,'','".AddSlashes(pg_fetch_result($resaco,0,'ed267_i_turmaac'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2414,13793,'','".AddSlashes(pg_fetch_result($resaco,0,'ed267_i_censoativcompl'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed267_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed267_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed267_i_codigo"])){ 
       $sql  .= $virgula." ed267_i_codigo = $this->ed267_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed267_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed267_i_turmaac)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed267_i_turmaac"])){ 
       $sql  .= $virgula." ed267_i_turmaac = $this->ed267_i_turmaac ";
       $virgula = ",";
       if(trim((string) $this->ed267_i_turmaac) == null ){ 
         $this->erro_sql = " Campo Turma nao Informado.";
         $this->erro_campo = "ed267_i_turmaac";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed267_i_censoativcompl)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed267_i_censoativcompl"])){ 
       $sql  .= $virgula." ed267_i_censoativcompl = $this->ed267_i_censoativcompl ";
       $virgula = ",";
       if(trim((string) $this->ed267_i_censoativcompl) == null ){ 
         $this->erro_sql = " Campo Atividade Complementar nao Informado.";
         $this->erro_campo = "ed267_i_censoativcompl";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed267_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2414,13791,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed267_i_codigo'))."','$this->ed267_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed267_i_turmaac"]))
           $resac = db_query("insert into db_acount values($acount,2414,13792,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed267_i_turmaac'))."','$this->ed267_i_turmaac',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed267_i_censoativcompl"]))
           $resac = db_query("insert into db_acount values($acount,2414,13793,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed267_i_censoativcompl'))."','$this->ed267_i_censoativcompl',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed267_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2414,13791,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed267_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2414,13792,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed267_i_turmaac'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2414,13793,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed267_i_censoativcompl'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
