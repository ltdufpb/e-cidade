...
class cl_transfescolarede {
   ...
   public $ed103_i_codigo = 0;
   public $ed103_i_matricula = 0;
   public $ed103_i_escolaorigem = 0;
   public $ed103_i_atestvaga = 0;
   public $ed103_i_usuario = 0;
   public $ed103_d_data_dia = null;
   public $ed103_d_data_mes = null;
   public $ed103_d_data_ano = null;
   public $ed103_d_data = null;
   public $ed103_t_obs = null;
   public $ed103_c_situacao = null;
   ...
   function incluir ($ed103_i_codigo){
     ...
     if($ed103_i_codigo == "" || $ed103_i_codigo == null ){
       ...
       $this->ed103_i_codigo = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from transfescolarede_ed103_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed103_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010162,1009045,'','".AddSlashes(pg_fetch_result($resaco,0,'ed103_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010162,1009060,'','".AddSlashes(pg_fetch_result($resaco,0,'ed103_i_matricula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010162,1009046,'','".AddSlashes(pg_fetch_result($resaco,0,'ed103_i_escolaorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010162,1009047,'','".AddSlashes(pg_fetch_result($resaco,0,'ed103_i_atestvaga'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010162,1009048,'','".AddSlashes(pg_fetch_result($resaco,0,'ed103_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010162,1009049,'','".AddSlashes(pg_fetch_result($resaco,0,'ed103_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010162,1009050,'','".AddSlashes(pg_fetch_result($resaco,0,'ed103_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010162,1009061,'','".AddSlashes(pg_fetch_result($resaco,0,'ed103_c_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($ed103_i_codigo=null) {
     ...
     $virgula = "";
     if(trim((string) $this->ed103_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed103_i_codigo"])){
       $sql  .= $virgula." ed103_i_codigo = $this->ed103_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed103_i_codigo) == null ){
     ...
     if(trim((string) $this->ed103_i_matricula)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed103_i_matricula"])){
       $sql  .= $virgula." ed103_i_matricula = $this->ed103_i_matricula ";
       $virgula = ",";
       if(trim((string) $this->ed103_i_matricula) == null ){
         $this->erro_sql = " Campo Matrícula nao Informado.";
         $this->erro_campo = "ed103_i_matricula";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed103_i_escolaorigem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed103_i_escolaorigem"])){
       $sql  .= $virgula." ed103_i_escolaorigem = $this->ed103_i_escolaorigem ";
       $virgula = ",";
       if(trim((string) $this->ed103_i_escolaorigem) == null ){
         $this->erro_sql = " Campo Escola Origem nao Informado.";
         $this->erro_campo = "ed103_i_escolaorigem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed103_i_atestvaga)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed103_i_atestvaga"])){
       $sql  .= $virgula." ed103_i_atestvaga = $this->ed103_i_atestvaga ";
       $virgula = ",";
       if(trim((string) $this->ed103_i_atestvaga) == null ){
         $this->erro_sql = " Campo Código Atestado nao Informado.";
         $this->erro_campo = "ed103_i_atestvaga";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed103_i_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed103_i_usuario"])){
       $sql  .= $virgula." ed103_i_usuario = $this->ed103_i_usuario ";
       $virgula = ",";
       if(trim((string) $this->ed103_i_usuario) == null ){
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "ed103_i_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed103_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed103_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed103_d_data_dia"] !="") ){
       $sql  .= $virgula." ed103_d_data = '$this->ed103_d_data' ";
       $virgula = ",";
       if(trim((string) $this->ed103_d_data) == null ){
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "ed103_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed103_t_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed103_t_obs"])){
       $sql  .= $virgula." ed103_t_obs = '$this->ed103_t_obs' ";
       $virgula = ",";
     }
     if(trim((string) $this->ed103_c_situacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed103_c_situacao"])){
       $sql  .= $virgula." ed103_c_situacao = '$this->ed103_c_situacao' ";
       $virgula = ",";
       if(trim((string) $this->ed103_c_situacao) == null ){
         $this->erro_sql = " Campo Situação nao Informado.";
         $this->erro_campo = "ed103_c_situacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed103_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010162,1009045,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed103_i_codigo'))."','$this->ed103_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed103_i_matricula"]))
           $resac = db_query("insert into db_acount values($acount,1010162,1009060,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed103_i_matricula'))."','$this->ed103_i_matricula',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed103_i_escolaorigem"]))
           $resac = db_query("insert into db_acount values($acount,1010162,1009046,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed103_i_escolaorigem'))."','$this->ed103_i_escolaorigem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed103_i_atestvaga"]))
           $resac = db_query("insert into db_acount values($acount,1010162,1009047,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed103_i_atestvaga'))."','$this->ed103_i_atestvaga',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed103_i_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1010162,1009048,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed103_i_usuario'))."','$this->ed103_i_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed103_d_data"]))
           $resac = db_query("insert into db_acount values($acount,1010162,1009049,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed103_d_data'))."','$this->ed103_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed103_t_obs"]))
           $resac = db_query("insert into db_acount values($acount,1010162,1009050,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed103_t_obs'))."','$this->ed103_t_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed103_c_situacao"]))
           $resac = db_query("insert into db_acount values($acount,1010162,1009061,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed103_c_situacao'))."','$this->ed103_c_situacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($ed103_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010162,1009045,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed103_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010162,1009060,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed103_i_matricula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010162,1009046,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed103_i_escolaorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010162,1009047,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed103_i_atestvaga'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010162,1009048,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed103_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010162,1009049,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed103_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010162,1009050,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed103_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010162,1009061,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed103_c_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
  ...
  function sql_query_transferido( $ed103_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
   ...
   function sql_query_tipotransferido( $ed103_i_codigo = null, $sCampos = "*", $sOrdem = null, $sWhere = "") {
     ...
     if ($sOrdem != null ){
        ...
        $sSql    .= " order by ";
        $sCampos  = preg_split("#\\##m",(string) $sOrdem);
        $sVirgula = "";
        for ($iCont = 0; $iCont < sizeof($sCampos); $iCont++) {
