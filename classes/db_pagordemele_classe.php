...
class cl_pagordemele { 
   ...
   function incluir ($e53_codord,$e53_codele){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,911,5751,'','".AddSlashes(pg_fetch_result($resaco,0,'e53_codord'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,911,5752,'','".AddSlashes(pg_fetch_result($resaco,0,'e53_codele'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,911,5440,'','".AddSlashes(pg_fetch_result($resaco,0,'e53_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,911,5736,'','".AddSlashes(pg_fetch_result($resaco,0,'e53_vlranu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,911,5737,'','".AddSlashes(pg_fetch_result($resaco,0,'e53_vlrpag'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e53_codord=null,$e53_codele=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e53_codord)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e53_codord"])){ 
       $sql  .= $virgula." e53_codord = $this->e53_codord ";
       $virgula = ",";
       if(trim((string) $this->e53_codord) == null ){ 
     ...
     if(trim((string) $this->e53_codele)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e53_codele"])){ 
       $sql  .= $virgula." e53_codele = $this->e53_codele ";
       $virgula = ",";
       if(trim((string) $this->e53_codele) == null ){ 
     ...
     if(trim((string) $this->e53_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e53_valor"])){ 
       $sql  .= $virgula." e53_valor = $this->e53_valor ";
       $virgula = ",";
       if(trim((string) $this->e53_valor) == null ){ 
         $this->erro_sql = " Campo Valor nao Informado.";
         $this->erro_campo = "e53_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e53_vlranu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e53_vlranu"])){ 
       $sql  .= $virgula." e53_vlranu = $this->e53_vlranu ";
       $virgula = ",";
       if(trim((string) $this->e53_vlranu) == null ){ 
         $this->erro_sql = " Campo Anulado nao Informado.";
         $this->erro_campo = "e53_vlranu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e53_vlrpag)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e53_vlrpag"])){ 
       $sql  .= $virgula." e53_vlrpag = $this->e53_vlrpag ";
       $virgula = ",";
       if(trim((string) $this->e53_vlrpag) == null ){ 
         $this->erro_sql = " Campo Pago nao Informado.";
         $this->erro_campo = "e53_vlrpag";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e53_codord"]))
           $resac = db_query("insert into db_acount values($acount,911,5751,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e53_codord'))."','$this->e53_codord',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e53_codele"]))
           $resac = db_query("insert into db_acount values($acount,911,5752,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e53_codele'))."','$this->e53_codele',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e53_valor"]))
           $resac = db_query("insert into db_acount values($acount,911,5440,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e53_valor'))."','$this->e53_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e53_vlranu"]))
           $resac = db_query("insert into db_acount values($acount,911,5736,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e53_vlranu'))."','$this->e53_vlranu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e53_vlrpag"]))
           $resac = db_query("insert into db_acount values($acount,911,5737,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e53_vlrpag'))."','$this->e53_vlrpag',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e53_codord=null,$e53_codele=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,911,5751,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e53_codord'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,911,5752,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e53_codele'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,911,5440,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e53_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,911,5736,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e53_vlranu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,911,5737,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e53_vlrpag'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
