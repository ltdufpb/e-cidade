...
class cl_regenciahorariohistorico { 
   ...
   public $ed323_sequencial = 0; 
   public $ed323_docente = 0; 
   public $ed323_substituto = 0; 
   public $ed323_regencia = 0; 
   public $ed323_periodo = 0; 
   public $ed323_diasemana = 0; 
   ...
   function incluir ($ed323_sequencial){ 
     ...
     if($ed323_sequencial == "" || $ed323_sequencial == null ){
       ...
       $this->ed323_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from regenciahorariohistorico_ed323_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed323_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3543,19768,'','".AddSlashes(pg_fetch_result($resaco,0,'ed323_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3543,19769,'','".AddSlashes(pg_fetch_result($resaco,0,'ed323_docente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3543,19770,'','".AddSlashes(pg_fetch_result($resaco,0,'ed323_substituto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3543,19771,'','".AddSlashes(pg_fetch_result($resaco,0,'ed323_regencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3543,19772,'','".AddSlashes(pg_fetch_result($resaco,0,'ed323_periodo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3543,19773,'','".AddSlashes(pg_fetch_result($resaco,0,'ed323_diasemana'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed323_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed323_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed323_sequencial"])){ 
       $sql  .= $virgula." ed323_sequencial = $this->ed323_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed323_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed323_docente)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed323_docente"])){ 
       $sql  .= $virgula." ed323_docente = $this->ed323_docente ";
       $virgula = ",";
       if(trim((string) $this->ed323_docente) == null ){ 
         $this->erro_sql = " Campo Docente nao Informado.";
         $this->erro_campo = "ed323_docente";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed323_substituto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed323_substituto"])){ 
       $sql  .= $virgula." ed323_substituto = $this->ed323_substituto ";
       $virgula = ",";
       if(trim((string) $this->ed323_substituto) == null ){ 
         $this->erro_sql = " Campo Substituto nao Informado.";
         $this->erro_campo = "ed323_substituto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed323_regencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed323_regencia"])){ 
       $sql  .= $virgula." ed323_regencia = $this->ed323_regencia ";
       $virgula = ",";
       if(trim((string) $this->ed323_regencia) == null ){ 
         $this->erro_sql = " Campo Regencia nao Informado.";
         $this->erro_campo = "ed323_regencia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed323_periodo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed323_periodo"])){ 
       $sql  .= $virgula." ed323_periodo = $this->ed323_periodo ";
       $virgula = ",";
       if(trim((string) $this->ed323_periodo) == null ){ 
         $this->erro_sql = " Campo Período nao Informado.";
         $this->erro_campo = "ed323_periodo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed323_diasemana)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed323_diasemana"])){ 
       $sql  .= $virgula." ed323_diasemana = $this->ed323_diasemana ";
       $virgula = ",";
       if(trim((string) $this->ed323_diasemana) == null ){ 
         $this->erro_sql = " Campo Dia da semana nao Informado.";
         $this->erro_campo = "ed323_diasemana";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed323_sequencial"]) || $this->ed323_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3543,19768,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed323_sequencial'))."','$this->ed323_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed323_docente"]) || $this->ed323_docente != "")
           $resac = db_query("insert into db_acount values($acount,3543,19769,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed323_docente'))."','$this->ed323_docente',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed323_substituto"]) || $this->ed323_substituto != "")
           $resac = db_query("insert into db_acount values($acount,3543,19770,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed323_substituto'))."','$this->ed323_substituto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed323_regencia"]) || $this->ed323_regencia != "")
           $resac = db_query("insert into db_acount values($acount,3543,19771,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed323_regencia'))."','$this->ed323_regencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed323_periodo"]) || $this->ed323_periodo != "")
           $resac = db_query("insert into db_acount values($acount,3543,19772,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed323_periodo'))."','$this->ed323_periodo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed323_diasemana"]) || $this->ed323_diasemana != "")
           $resac = db_query("insert into db_acount values($acount,3543,19773,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed323_diasemana'))."','$this->ed323_diasemana',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed323_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3543,19768,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed323_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3543,19769,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed323_docente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3543,19770,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed323_substituto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3543,19771,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed323_regencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3543,19772,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed323_periodo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3543,19773,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed323_diasemana'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
