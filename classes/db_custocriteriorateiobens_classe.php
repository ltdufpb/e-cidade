...
class cl_custocriteriorateiobens { 
   ...
   public $cc06_sequencial = 0; 
   public $cc06_custoplanoanaliticabens = 0; 
   public $cc06_custocriteriorateio = 0; 
   public $cc06_ativo = 'f'; 
   ...
   function incluir ($cc06_sequencial){ 
     ...
     if($cc06_sequencial == "" || $cc06_sequencial == null ){
       ...
       $this->cc06_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from custocriteriorateiobens_cc06_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $cc06_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2198,12589,'','".AddSlashes(pg_fetch_result($resaco,0,'cc06_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2198,12590,'','".AddSlashes(pg_fetch_result($resaco,0,'cc06_custoplanoanaliticabens'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2198,12592,'','".AddSlashes(pg_fetch_result($resaco,0,'cc06_custocriteriorateio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2198,12593,'','".AddSlashes(pg_fetch_result($resaco,0,'cc06_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($cc06_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->cc06_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc06_sequencial"])){ 
       $sql  .= $virgula." cc06_sequencial = $this->cc06_sequencial ";
       $virgula = ",";
       if(trim((string) $this->cc06_sequencial) == null ){ 
         $this->erro_sql = " Campo Sequêncial nao Informado.";
     ...
     if(trim((string) $this->cc06_custoplanoanaliticabens)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc06_custoplanoanaliticabens"])){ 
       $sql  .= $virgula." cc06_custoplanoanaliticabens = $this->cc06_custoplanoanaliticabens ";
       $virgula = ",";
       if(trim((string) $this->cc06_custoplanoanaliticabens) == null ){ 
         $this->erro_sql = " Campo Custo plano analítico dos bens nao Informado.";
         $this->erro_campo = "cc06_custoplanoanaliticabens";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cc06_custocriteriorateio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc06_custocriteriorateio"])){ 
       $sql  .= $virgula." cc06_custocriteriorateio = $this->cc06_custocriteriorateio ";
       $virgula = ",";
       if(trim((string) $this->cc06_custocriteriorateio) == null ){ 
         $this->erro_sql = " Campo Sequêncial nao Informado.";
         $this->erro_campo = "cc06_custocriteriorateio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cc06_ativo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc06_ativo"])){ 
       $sql  .= $virgula." cc06_ativo = '$this->cc06_ativo' ";
       $virgula = ",";
       if(trim((string) $this->cc06_ativo) == null ){ 
         $this->erro_sql = " Campo Ativo nao Informado.";
         $this->erro_campo = "cc06_ativo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc06_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2198,12589,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc06_sequencial'))."','$this->cc06_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc06_custoplanoanaliticabens"]))
           $resac = db_query("insert into db_acount values($acount,2198,12590,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc06_custoplanoanaliticabens'))."','$this->cc06_custoplanoanaliticabens',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc06_custocriteriorateio"]))
           $resac = db_query("insert into db_acount values($acount,2198,12592,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc06_custocriteriorateio'))."','$this->cc06_custocriteriorateio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc06_ativo"]))
           $resac = db_query("insert into db_acount values($acount,2198,12593,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc06_ativo'))."','$this->cc06_ativo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($cc06_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2198,12589,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc06_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2198,12590,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc06_custoplanoanaliticabens'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2198,12592,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc06_custocriteriorateio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2198,12593,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc06_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
