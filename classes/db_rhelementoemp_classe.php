...
class cl_rhelementoemp { 
   ...
   public $rh38_seq = 0; 
   public $rh38_codele = 0; 
   public $rh38_anousu = 0; 
   ...
   function incluir ($rh38_seq){ 
     ...
     if($rh38_seq == "" || $rh38_seq == null ){
       ...
       $this->rh38_seq = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhelementoemp_seq_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh38_seq)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1200,7239,'','".AddSlashes(pg_fetch_result($resaco,0,'rh38_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1200,7240,'','".AddSlashes(pg_fetch_result($resaco,0,'rh38_codele'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1200,10739,'','".AddSlashes(pg_fetch_result($resaco,0,'rh38_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh38_seq=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh38_seq)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh38_seq"])){ 
       $sql  .= $virgula." rh38_seq = $this->rh38_seq ";
       $virgula = ",";
       if(trim((string) $this->rh38_seq) == null ){ 
     ...
     if(trim((string) $this->rh38_codele)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh38_codele"])){ 
       $sql  .= $virgula." rh38_codele = $this->rh38_codele ";
       $virgula = ",";
       if(trim((string) $this->rh38_codele) == null ){ 
         $this->erro_sql = " Campo Código do Elemento nao Informado.";
         $this->erro_campo = "rh38_codele";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh38_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh38_anousu"])){ 
       $sql  .= $virgula." rh38_anousu = $this->rh38_anousu ";
       $virgula = ",";
       if(trim((string) $this->rh38_anousu) == null ){ 
         $this->erro_sql = " Campo Exercício nao Informado.";
         $this->erro_campo = "rh38_anousu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh38_seq"]))
           $resac = db_query("insert into db_acount values($acount,1200,7239,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh38_seq'))."','$this->rh38_seq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh38_codele"]))
           $resac = db_query("insert into db_acount values($acount,1200,7240,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh38_codele'))."','$this->rh38_codele',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh38_anousu"]))
           $resac = db_query("insert into db_acount values($acount,1200,10739,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh38_anousu'))."','$this->rh38_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh38_seq=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1200,7239,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh38_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1200,7240,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh38_codele'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1200,10739,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh38_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
