...
class cl_iptutaxamatric { 
   ...
   public $j09_iptutaxamatric = 0; 
   public $j09_iptucadtaxaexe = 0; 
   public $j09_matric = 0; 
   public $j09_valor = 0; 
   ...
   function incluir ($j09_iptutaxamatric){ 
     ...
     if($j09_iptutaxamatric == "" || $j09_iptutaxamatric == null ){
       ...
       $this->j09_iptutaxamatric = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from iptutaxamatric_j09_iptutaxamatric_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $j09_iptutaxamatric)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1630,9494,'','".AddSlashes(pg_fetch_result($resaco,0,'j09_iptutaxamatric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1630,11061,'','".AddSlashes(pg_fetch_result($resaco,0,'j09_iptucadtaxaexe'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1630,9495,'','".AddSlashes(pg_fetch_result($resaco,0,'j09_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1630,11025,'','".AddSlashes(pg_fetch_result($resaco,0,'j09_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j09_iptutaxamatric=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j09_iptutaxamatric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j09_iptutaxamatric"])){ 
       $sql  .= $virgula." j09_iptutaxamatric = $this->j09_iptutaxamatric ";
       $virgula = ",";
       if(trim((string) $this->j09_iptutaxamatric) == null ){ 
     ...
     if(trim((string) $this->j09_iptucadtaxaexe)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j09_iptucadtaxaexe"])){ 
       $sql  .= $virgula." j09_iptucadtaxaexe = $this->j09_iptucadtaxaexe ";
       $virgula = ",";
       if(trim((string) $this->j09_iptucadtaxaexe) == null ){ 
         $this->erro_sql = " Campo Taxa nao Informado.";
         $this->erro_campo = "j09_iptucadtaxaexe";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j09_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j09_matric"])){ 
       $sql  .= $virgula." j09_matric = $this->j09_matric ";
       $virgula = ",";
       if(trim((string) $this->j09_matric) == null ){ 
         $this->erro_sql = " Campo Matrícula do Imóvel nao Informado.";
         $this->erro_campo = "j09_matric";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j09_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j09_valor"])){ 
       $sql  .= $virgula." j09_valor = $this->j09_valor ";
       $virgula = ",";
       if(trim((string) $this->j09_valor) == null ){ 
         $this->erro_sql = " Campo Valor nao Informado.";
         $this->erro_campo = "j09_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j09_iptutaxamatric"]))
           $resac = db_query("insert into db_acount values($acount,1630,9494,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j09_iptutaxamatric'))."','$this->j09_iptutaxamatric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j09_iptucadtaxaexe"]))
           $resac = db_query("insert into db_acount values($acount,1630,11061,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j09_iptucadtaxaexe'))."','$this->j09_iptucadtaxaexe',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j09_matric"]))
           $resac = db_query("insert into db_acount values($acount,1630,9495,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j09_matric'))."','$this->j09_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j09_valor"]))
           $resac = db_query("insert into db_acount values($acount,1630,11025,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j09_valor'))."','$this->j09_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j09_iptutaxamatric=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1630,9494,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j09_iptutaxamatric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1630,11061,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j09_iptucadtaxaexe'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1630,9495,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j09_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1630,11025,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j09_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
