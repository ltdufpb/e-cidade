...
class cl_veiccadconveniocgm { 
   ...
   public $ve18_sequencial = 0; 
   public $ve18_numcgm = 0; 
   public $ve18_veiccadconvenio = 0; 
   ...
   function incluir ($ve18_sequencial){ 
     ...
     if($ve18_sequencial == "" || $ve18_sequencial == null ){
       ...
       $this->ve18_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veiccadconveniocgm_ve18_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve18_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1921,11129,'','".AddSlashes(pg_fetch_result($resaco,0,'ve18_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1921,11130,'','".AddSlashes(pg_fetch_result($resaco,0,'ve18_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1921,11131,'','".AddSlashes(pg_fetch_result($resaco,0,'ve18_veiccadconvenio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve18_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve18_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve18_sequencial"])){ 
       $sql  .= $virgula." ve18_sequencial = $this->ve18_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ve18_sequencial) == null ){ 
     ...
     if(trim((string) $this->ve18_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve18_numcgm"])){ 
       $sql  .= $virgula." ve18_numcgm = $this->ve18_numcgm ";
       $virgula = ",";
       if(trim((string) $this->ve18_numcgm) == null ){ 
         $this->erro_sql = " Campo Cgm nao Informado.";
         $this->erro_campo = "ve18_numcgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve18_veiccadconvenio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve18_veiccadconvenio"])){ 
       $sql  .= $virgula." ve18_veiccadconvenio = $this->ve18_veiccadconvenio ";
       $virgula = ",";
       if(trim((string) $this->ve18_veiccadconvenio) == null ){ 
         $this->erro_sql = " Campo Convênio nao Informado.";
         $this->erro_campo = "ve18_veiccadconvenio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve18_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1921,11129,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve18_sequencial'))."','$this->ve18_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve18_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,1921,11130,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve18_numcgm'))."','$this->ve18_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve18_veiccadconvenio"]))
           $resac = db_query("insert into db_acount values($acount,1921,11131,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve18_veiccadconvenio'))."','$this->ve18_veiccadconvenio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve18_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1921,11129,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve18_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1921,11130,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve18_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1921,11131,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve18_veiccadconvenio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
