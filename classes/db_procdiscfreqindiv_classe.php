...
class cl_procdiscfreqindiv { 
   ...
   public $ed45_i_codigo = 0; 
   public $ed45_i_procedimento = 0; 
   public $ed45_i_disciplina = 0; 
   ...
   function incluir ($ed45_i_codigo){ 
     ...
     if($ed45_i_codigo == "" || $ed45_i_codigo == null ){
       ...
       $this->ed45_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from procdiscfreqindiv_ed45_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed45_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010076,1008444,'','".AddSlashes(pg_fetch_result($resaco,0,'ed45_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010076,1008445,'','".AddSlashes(pg_fetch_result($resaco,0,'ed45_i_procedimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010076,1008446,'','".AddSlashes(pg_fetch_result($resaco,0,'ed45_i_disciplina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed45_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed45_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed45_i_codigo"])){ 
       $sql  .= $virgula." ed45_i_codigo = $this->ed45_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed45_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed45_i_procedimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed45_i_procedimento"])){ 
       $sql  .= $virgula." ed45_i_procedimento = $this->ed45_i_procedimento ";
       $virgula = ",";
       if(trim((string) $this->ed45_i_procedimento) == null ){ 
         $this->erro_sql = " Campo Procedimento de Avaliação nao Informado.";
         $this->erro_campo = "ed45_i_procedimento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed45_i_disciplina)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed45_i_disciplina"])){ 
       $sql  .= $virgula." ed45_i_disciplina = $this->ed45_i_disciplina ";
       $virgula = ",";
       if(trim((string) $this->ed45_i_disciplina) == null ){ 
         $this->erro_sql = " Campo Disciplina nao Informado.";
         $this->erro_campo = "ed45_i_disciplina";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed45_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010076,1008444,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed45_i_codigo'))."','$this->ed45_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed45_i_procedimento"]))
           $resac = db_query("insert into db_acount values($acount,1010076,1008445,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed45_i_procedimento'))."','$this->ed45_i_procedimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed45_i_disciplina"]))
           $resac = db_query("insert into db_acount values($acount,1010076,1008446,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed45_i_disciplina'))."','$this->ed45_i_disciplina',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed45_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010076,1008444,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed45_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010076,1008445,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed45_i_procedimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010076,1008446,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed45_i_disciplina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
