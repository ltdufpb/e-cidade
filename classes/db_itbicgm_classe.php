...
class cl_itbicgm { 
   ...
   function incluir ($it02_guia,$it02_numcgm){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,793,5399,'','".AddSlashes(pg_fetch_result($resaco,0,'it02_guia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,793,5377,'','".AddSlashes(pg_fetch_result($resaco,0,'it02_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($it02_guia=null,$it02_numcgm=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->it02_guia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it02_guia"])){ 
       $sql  .= $virgula." it02_guia = $this->it02_guia ";
       $virgula = ",";
       if(trim((string) $this->it02_guia) == null ){ 
     ...
     if(trim((string) $this->it02_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it02_numcgm"])){ 
       $sql  .= $virgula." it02_numcgm = $this->it02_numcgm ";
       $virgula = ",";
       if(trim((string) $this->it02_numcgm) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["it02_guia"]))
           $resac = db_query("insert into db_acount values($acount,793,5399,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'it02_guia'))."','$this->it02_guia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it02_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,793,5377,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'it02_numcgm'))."','$this->it02_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($it02_guia=null,$it02_numcgm=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,793,5399,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'it02_guia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,793,5377,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'it02_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
