...
class cl_empagemovforma { 
   ...
   function incluir ($e97_codmov){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1157,7017,'','".AddSlashes(pg_fetch_result($resaco,0,'e97_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1157,7018,'','".AddSlashes(pg_fetch_result($resaco,0,'e97_codforma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e97_codmov=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e97_codmov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e97_codmov"])){ 
       $sql  .= $virgula." e97_codmov = $this->e97_codmov ";
       $virgula = ",";
       if(trim((string) $this->e97_codmov) == null ){ 
     ...
     if(trim((string) $this->e97_codforma)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e97_codforma"])){ 
       $sql  .= $virgula." e97_codforma = $this->e97_codforma ";
       $virgula = ",";
       if(trim((string) $this->e97_codforma) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
         $this->erro_campo = "e97_codforma";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e97_codmov"]))
           $resac = db_query("insert into db_acount values($acount,1157,7017,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e97_codmov'))."','$this->e97_codmov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e97_codforma"]))
           $resac = db_query("insert into db_acount values($acount,1157,7018,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e97_codforma'))."','$this->e97_codforma',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e97_codmov=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1157,7017,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e97_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1157,7018,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e97_codforma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
