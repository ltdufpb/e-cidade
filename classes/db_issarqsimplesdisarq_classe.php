...
class cl_issarqsimplesdisarq { 
   ...
   public $q43_sequencial = 0; 
   public $q43_issarqsimples = 0; 
   public $q43_disarq = 0; 
   ...
   function incluir ($q43_sequencial){ 
     ...
     if($q43_sequencial == "" || $q43_sequencial == null ){
       ...
       $this->q43_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from issarqsimplesdisarq_q43_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q43_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1843,10690,'','".AddSlashes(pg_fetch_result($resaco,0,'q43_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1843,10691,'','".AddSlashes(pg_fetch_result($resaco,0,'q43_issarqsimples'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1843,10692,'','".AddSlashes(pg_fetch_result($resaco,0,'q43_disarq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q43_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q43_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q43_sequencial"])){ 
       $sql  .= $virgula." q43_sequencial = $this->q43_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q43_sequencial) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
     ...
     if(trim((string) $this->q43_issarqsimples)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q43_issarqsimples"])){ 
       $sql  .= $virgula." q43_issarqsimples = $this->q43_issarqsimples ";
       $virgula = ",";
       if(trim((string) $this->q43_issarqsimples) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
         $this->erro_campo = "q43_issarqsimples";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q43_disarq)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q43_disarq"])){ 
       $sql  .= $virgula." q43_disarq = $this->q43_disarq ";
       $virgula = ",";
       if(trim((string) $this->q43_disarq) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
         $this->erro_campo = "q43_disarq";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q43_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1843,10690,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q43_sequencial'))."','$this->q43_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q43_issarqsimples"]))
           $resac = db_query("insert into db_acount values($acount,1843,10691,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q43_issarqsimples'))."','$this->q43_issarqsimples',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q43_disarq"]))
           $resac = db_query("insert into db_acount values($acount,1843,10692,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q43_disarq'))."','$this->q43_disarq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q43_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1843,10690,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q43_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1843,10691,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q43_issarqsimples'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1843,10692,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q43_disarq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
