...
class cl_empord {
   ...
   function incluir ($e82_codmov,$e82_codord){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,996,6177,'','".AddSlashes(pg_fetch_result($resaco,0,'e82_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,996,6178,'','".AddSlashes(pg_fetch_result($resaco,0,'e82_codord'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($e82_codmov=null,$e82_codord=null) {
     ...
     $virgula = "";
     if(trim((string) $this->e82_codmov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e82_codmov"])){
       $sql  .= $virgula." e82_codmov = $this->e82_codmov ";
       $virgula = ",";
       if(trim((string) $this->e82_codmov) == null ){
     ...
     if(trim((string) $this->e82_codord)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e82_codord"])){
       $sql  .= $virgula." e82_codord = $this->e82_codord ";
       $virgula = ",";
       if(trim((string) $this->e82_codord) == null ){
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e82_codmov"]))
           $resac = db_query("insert into db_acount values($acount,996,6177,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e82_codmov'))."','$this->e82_codmov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e82_codord"]))
           $resac = db_query("insert into db_acount values($acount,996,6178,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e82_codord'))."','$this->e82_codord',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($e82_codmov=null,$e82_codord=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,996,6177,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e82_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,996,6178,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e82_codord'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
