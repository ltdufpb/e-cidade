...
class cl_censoorgreg { 
   ...
   public $ed263_i_codigo = 0; 
   public $ed263_i_censouf = 0; 
   public $ed263_i_codigocenso = null; 
   public $ed263_c_nome = null; 
   ...
   function incluir ($ed263_i_codigo){ 
     ...
     if($ed263_i_codigo == "" || $ed263_i_codigo == null ){
       ...
       $this->ed263_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from censoorgreg_ed263_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed263_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2341,13357,'','".AddSlashes(pg_fetch_result($resaco,0,'ed263_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2341,13358,'','".AddSlashes(pg_fetch_result($resaco,0,'ed263_i_censouf'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2341,13359,'','".AddSlashes(pg_fetch_result($resaco,0,'ed263_i_codigocenso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2341,13360,'','".AddSlashes(pg_fetch_result($resaco,0,'ed263_c_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed263_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed263_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed263_i_codigo"])){ 
       $sql  .= $virgula." ed263_i_codigo = $this->ed263_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed263_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed263_i_censouf)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed263_i_censouf"])){ 
       $sql  .= $virgula." ed263_i_censouf = $this->ed263_i_censouf ";
       $virgula = ",";
       if(trim((string) $this->ed263_i_censouf) == null ){ 
         $this->erro_sql = " Campo Estado nao Informado.";
         $this->erro_campo = "ed263_i_censouf";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed263_i_codigocenso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed263_i_codigocenso"])){ 
       $sql  .= $virgula." ed263_i_codigocenso = '$this->ed263_i_codigocenso' ";
       $virgula = ",";
       if(trim((string) $this->ed263_i_codigocenso) == null ){ 
         $this->erro_sql = " Campo Código Censo nao Informado.";
         $this->erro_campo = "ed263_i_codigocenso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed263_c_nome)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed263_c_nome"])){ 
       $sql  .= $virgula." ed263_c_nome = '$this->ed263_c_nome' ";
       $virgula = ",";
       if(trim((string) $this->ed263_c_nome) == null ){ 
         $this->erro_sql = " Campo Nome nao Informado.";
         $this->erro_campo = "ed263_c_nome";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed263_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2341,13357,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed263_i_codigo'))."','$this->ed263_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed263_i_censouf"]))
           $resac = db_query("insert into db_acount values($acount,2341,13358,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed263_i_censouf'))."','$this->ed263_i_censouf',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed263_i_codigocenso"]))
           $resac = db_query("insert into db_acount values($acount,2341,13359,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed263_i_codigocenso'))."','$this->ed263_i_codigocenso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed263_c_nome"]))
           $resac = db_query("insert into db_acount values($acount,2341,13360,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed263_c_nome'))."','$this->ed263_c_nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed263_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2341,13357,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed263_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2341,13358,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed263_i_censouf'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2341,13359,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed263_i_codigocenso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2341,13360,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed263_c_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
