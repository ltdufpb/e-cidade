...
class cl_tmp_far_retiradaitemlote { 
   ...
   public $fa09_i_codigo = 0; 
   public $fa09_i_retiradaitens = 0; 
   public $fa09_i_matestoqueitem = 0; 
   public $fa09_f_quant = 0; 
   ...
   function incluir ($fa09_i_codigo){ 
     ...
     if($fa09_i_codigo == "" || $fa09_i_codigo == null ){
       ...
       $this->fa09_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = @db_query("select last_value from faretiradaitemlote_fa09_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa09_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2131,12255,'','".AddSlashes(pg_fetch_result($resaco,0,'fa09_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2131,12256,'','".AddSlashes(pg_fetch_result($resaco,0,'fa09_i_retiradaitens'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2131,12260,'','".AddSlashes(pg_fetch_result($resaco,0,'fa09_i_matestoqueitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2131,12257,'','".AddSlashes(pg_fetch_result($resaco,0,'fa09_f_quant'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa09_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa09_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa09_i_codigo"])){ 
       $sql  .= $virgula." fa09_i_codigo = $this->fa09_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa09_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa09_i_retiradaitens)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa09_i_retiradaitens"])){ 
       $sql  .= $virgula." fa09_i_retiradaitens = $this->fa09_i_retiradaitens ";
       $virgula = ",";
       if(trim((string) $this->fa09_i_retiradaitens) == null ){ 
         $this->erro_sql = " Campo Retirada itens nao Informado.";
         $this->erro_campo = "fa09_i_retiradaitens";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa09_i_matestoqueitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa09_i_matestoqueitem"])){ 
       $sql  .= $virgula." fa09_i_matestoqueitem = $this->fa09_i_matestoqueitem ";
       $virgula = ",";
       if(trim((string) $this->fa09_i_matestoqueitem) == null ){ 
         $this->erro_sql = " Campo Matestoqueitem nao Informado.";
         $this->erro_campo = "fa09_i_matestoqueitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa09_f_quant)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa09_f_quant"])){ 
       $sql  .= $virgula." fa09_f_quant = $this->fa09_f_quant ";
       $virgula = ",";
       if(trim((string) $this->fa09_f_quant) == null ){ 
         $this->erro_sql = " Campo Quantidade nao Informado.";
         $this->erro_campo = "fa09_f_quant";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa09_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2131,12255,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa09_i_codigo'))."','$this->fa09_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa09_i_retiradaitens"]))
           $resac = db_query("insert into db_acount values($acount,2131,12256,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa09_i_retiradaitens'))."','$this->fa09_i_retiradaitens',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa09_i_matestoqueitem"]))
           $resac = db_query("insert into db_acount values($acount,2131,12260,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa09_i_matestoqueitem'))."','$this->fa09_i_matestoqueitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa09_f_quant"]))
           $resac = db_query("insert into db_acount values($acount,2131,12257,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa09_f_quant'))."','$this->fa09_f_quant',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa09_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2131,12255,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa09_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2131,12256,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa09_i_retiradaitens'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2131,12260,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa09_i_matestoqueitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2131,12257,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa09_f_quant'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
