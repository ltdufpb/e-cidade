...
class cl_isencaoproc { 
   ...
   public $v17_sequencial = 0; 
   public $v17_protprocesso = 0; 
   public $v17_isencao = 0; 
   ...
   function incluir ($v17_sequencial){ 
     ...
     if($v17_sequencial == "" || $v17_sequencial == null ){
       ...
       $this->v17_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from isencaoproc_v17_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $v17_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1710,9935,'','".AddSlashes(pg_fetch_result($resaco,0,'v17_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1710,9937,'','".AddSlashes(pg_fetch_result($resaco,0,'v17_protprocesso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1710,9936,'','".AddSlashes(pg_fetch_result($resaco,0,'v17_isencao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($v17_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->v17_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v17_sequencial"])){ 
       $sql  .= $virgula." v17_sequencial = $this->v17_sequencial ";
       $virgula = ",";
       if(trim((string) $this->v17_sequencial) == null ){ 
     ...
     if(trim((string) $this->v17_protprocesso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v17_protprocesso"])){ 
       $sql  .= $virgula." v17_protprocesso = $this->v17_protprocesso ";
       $virgula = ",";
       if(trim((string) $this->v17_protprocesso) == null ){ 
         $this->erro_sql = " Campo Código do processo nao Informado.";
         $this->erro_campo = "v17_protprocesso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->v17_isencao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v17_isencao"])){ 
       $sql  .= $virgula." v17_isencao = $this->v17_isencao ";
       $virgula = ",";
       if(trim((string) $this->v17_isencao) == null ){ 
         $this->erro_sql = " Campo Codigo da isenção nao Informado.";
         $this->erro_campo = "v17_isencao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v17_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1710,9935,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v17_sequencial'))."','$this->v17_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v17_protprocesso"]))
           $resac = db_query("insert into db_acount values($acount,1710,9937,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v17_protprocesso'))."','$this->v17_protprocesso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v17_isencao"]))
           $resac = db_query("insert into db_acount values($acount,1710,9936,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v17_isencao'))."','$this->v17_isencao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($v17_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1710,9935,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v17_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1710,9937,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v17_protprocesso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1710,9936,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v17_isencao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
