...
class cl_rechumanocgm { 
   ...
   public $ed285_i_codigo = 0; 
   public $ed285_i_rechumano = 0; 
   public $ed285_i_cgm = 0; 
   ...
   function incluir ($ed285_i_codigo){ 
     ...
     if($ed285_i_codigo == "" || $ed285_i_codigo == null ){
       ...
       $this->ed285_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rechumanocgm_ed285_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed285_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3061,17285,'','".AddSlashes(pg_fetch_result($resaco,0,'ed285_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3061,17286,'','".AddSlashes(pg_fetch_result($resaco,0,'ed285_i_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3061,17287,'','".AddSlashes(pg_fetch_result($resaco,0,'ed285_i_cgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed285_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed285_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed285_i_codigo"])){ 
       $sql  .= $virgula." ed285_i_codigo = $this->ed285_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed285_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed285_i_rechumano)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed285_i_rechumano"])){ 
       $sql  .= $virgula." ed285_i_rechumano = $this->ed285_i_rechumano ";
       $virgula = ",";
       if(trim((string) $this->ed285_i_rechumano) == null ){ 
         $this->erro_sql = " Campo Código Rechumano nao Informado.";
         $this->erro_campo = "ed285_i_rechumano";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed285_i_cgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed285_i_cgm"])){ 
       $sql  .= $virgula." ed285_i_cgm = $this->ed285_i_cgm ";
       $virgula = ",";
       if(trim((string) $this->ed285_i_cgm) == null ){ 
         $this->erro_sql = " Campo Código CGM nao Informado.";
         $this->erro_campo = "ed285_i_cgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed285_i_codigo"]) || $this->ed285_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3061,17285,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed285_i_codigo'))."','$this->ed285_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed285_i_rechumano"]) || $this->ed285_i_rechumano != "")
           $resac = db_query("insert into db_acount values($acount,3061,17286,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed285_i_rechumano'))."','$this->ed285_i_rechumano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed285_i_cgm"]) || $this->ed285_i_cgm != "")
           $resac = db_query("insert into db_acount values($acount,3061,17287,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed285_i_cgm'))."','$this->ed285_i_cgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed285_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3061,17285,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed285_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3061,17286,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed285_i_rechumano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3061,17287,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed285_i_cgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
