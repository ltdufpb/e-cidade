...
class cl_avaliacaogruporespostacgm {
   ...
   public $eso03_sequencial = 0;
   public $eso03_avaliacaogruporesposta = 0;
   public $eso03_cgm = 0;
   ...
   function incluir ($eso03_sequencial){
     ...
     if($eso03_sequencial == "" || $eso03_sequencial == null ){
       ...
       $this->eso03_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from avaliacaogruporespostacgm_eso03_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $eso03_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3943,21904,'','".AddSlashes(pg_fetch_result($resaco,0,'eso03_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3943,21905,'','".AddSlashes(pg_fetch_result($resaco,0,'eso03_avaliacaogruporesposta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3943,21906,'','".AddSlashes(pg_fetch_result($resaco,0,'eso03_cgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   public function alterar ($eso03_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->eso03_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["eso03_sequencial"])){
       $sql  .= $virgula." eso03_sequencial = $this->eso03_sequencial ";
       $virgula = ",";
       if(trim((string) $this->eso03_sequencial) == null ){
     ...
     if(trim((string) $this->eso03_avaliacaogruporesposta)!="" || isset($GLOBALS["HTTP_POST_VARS"]["eso03_avaliacaogruporesposta"])){
       $sql  .= $virgula." eso03_avaliacaogruporesposta = $this->eso03_avaliacaogruporesposta ";
       $virgula = ",";
       if(trim((string) $this->eso03_avaliacaogruporesposta) == null ){
         $this->erro_sql = " Campo Grupo Resposta não informado.";
         $this->erro_campo = "eso03_avaliacaogruporesposta";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->eso03_cgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["eso03_cgm"])){
       $sql  .= $virgula." eso03_cgm = $this->eso03_cgm ";
       $virgula = ",";
       if(trim((string) $this->eso03_cgm) == null ){
         $this->erro_sql = " Campo CGM não informado.";
         $this->erro_campo = "eso03_cgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["eso03_sequencial"]) || $this->eso03_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3943,21904,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'eso03_sequencial'))."','$this->eso03_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["eso03_avaliacaogruporesposta"]) || $this->eso03_avaliacaogruporesposta != "")
             $resac = db_query("insert into db_acount values($acount,3943,21905,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'eso03_avaliacaogruporesposta'))."','$this->eso03_avaliacaogruporesposta',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["eso03_cgm"]) || $this->eso03_cgm != "")
             $resac = db_query("insert into db_acount values($acount,3943,21906,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'eso03_cgm'))."','$this->eso03_cgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3943,21904,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'eso03_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3943,21905,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'eso03_avaliacaogruporesposta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3943,21906,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'eso03_cgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
