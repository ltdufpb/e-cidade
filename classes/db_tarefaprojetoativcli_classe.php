...
class cl_tarefaprojetoativcli { 
   ...
   public $at69_sequencial = 0; 
   public $at69_seqprojeto = 0; 
   public $at69_seqtarefa = 0; 
   ...
   function incluir ($at69_sequencial){ 
     ...
     if($at69_sequencial == "" || $at69_sequencial == null ){
       ...
       $this->at69_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tarefalogprojetoativcli_at69_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at69_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2048,11856,'','".AddSlashes(pg_fetch_result($resaco,0,'at69_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2048,11858,'','".AddSlashes(pg_fetch_result($resaco,0,'at69_seqprojeto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2048,11857,'','".AddSlashes(pg_fetch_result($resaco,0,'at69_seqtarefa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at69_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at69_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at69_sequencial"])){ 
       $sql  .= $virgula." at69_sequencial = $this->at69_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at69_sequencial) == null ){ 
     ...
     if(trim((string) $this->at69_seqprojeto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at69_seqprojeto"])){ 
       $sql  .= $virgula." at69_seqprojeto = $this->at69_seqprojeto ";
       $virgula = ",";
       if(trim((string) $this->at69_seqprojeto) == null ){ 
         $this->erro_sql = " Campo Atividade Projeto nao Informado.";
         $this->erro_campo = "at69_seqprojeto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at69_seqtarefa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at69_seqtarefa"])){ 
       $sql  .= $virgula." at69_seqtarefa = $this->at69_seqtarefa ";
       $virgula = ",";
       if(trim((string) $this->at69_seqtarefa) == null ){ 
         $this->erro_sql = " Campo Tarefa nao Informado.";
         $this->erro_campo = "at69_seqtarefa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at69_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2048,11856,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at69_sequencial'))."','$this->at69_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at69_seqprojeto"]))
           $resac = db_query("insert into db_acount values($acount,2048,11858,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at69_seqprojeto'))."','$this->at69_seqprojeto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at69_seqtarefa"]))
           $resac = db_query("insert into db_acount values($acount,2048,11857,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at69_seqtarefa'))."','$this->at69_seqtarefa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at69_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2048,11856,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at69_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2048,11858,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at69_seqprojeto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2048,11857,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at69_seqtarefa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
