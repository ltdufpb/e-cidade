...
class cl_censocaddisciplina { 
   ...
   public $ed294_sequencial = 0; 
   public $ed294_censodisciplina = 0; 
   public $ed294_caddisciplina = 0; 
   ...
   function incluir ($ed294_sequencial){ 
     ...
     if($ed294_sequencial == "" || $ed294_sequencial == null ){
       ...
       $this->ed294_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from censocaddisciplina_ed294_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed294_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3260,18431,'','".AddSlashes(pg_fetch_result($resaco,0,'ed294_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3260,18432,'','".AddSlashes(pg_fetch_result($resaco,0,'ed294_censodisciplina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3260,18433,'','".AddSlashes(pg_fetch_result($resaco,0,'ed294_caddisciplina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed294_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed294_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed294_sequencial"])){ 
       $sql  .= $virgula." ed294_sequencial = $this->ed294_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed294_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed294_censodisciplina)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed294_censodisciplina"])){ 
       $sql  .= $virgula." ed294_censodisciplina = $this->ed294_censodisciplina ";
       $virgula = ",";
       if(trim((string) $this->ed294_censodisciplina) == null ){ 
         $this->erro_sql = " Campo Código Censo nao Informado.";
         $this->erro_campo = "ed294_censodisciplina";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed294_caddisciplina)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed294_caddisciplina"])){ 
       $sql  .= $virgula." ed294_caddisciplina = $this->ed294_caddisciplina ";
       $virgula = ",";
       if(trim((string) $this->ed294_caddisciplina) == null ){ 
         $this->erro_sql = " Campo Disciplina nao Informado.";
         $this->erro_campo = "ed294_caddisciplina";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed294_sequencial"]) || $this->ed294_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3260,18431,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed294_sequencial'))."','$this->ed294_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed294_censodisciplina"]) || $this->ed294_censodisciplina != "")
           $resac = db_query("insert into db_acount values($acount,3260,18432,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed294_censodisciplina'))."','$this->ed294_censodisciplina',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed294_caddisciplina"]) || $this->ed294_caddisciplina != "")
           $resac = db_query("insert into db_acount values($acount,3260,18433,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed294_caddisciplina'))."','$this->ed294_caddisciplina',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed294_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3260,18431,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed294_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3260,18432,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed294_censodisciplina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3260,18433,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed294_caddisciplina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
