...
class cl_rhlota { 
   ...
   public $r70_codigo = 0; 
   public $r70_codestrut = 0; 
   public $r70_estrut = null; 
   public $r70_descr = null; 
   public $r70_analitica = 'f'; 
   public $r70_instit = 0; 
   public $r70_ativo = 'f'; 
   public $r70_numcgm = 0; 
   public $r70_concarpeculiar = null; 
   ...
   function incluir ($r70_codigo){ 
     ...
     if($r70_codigo == "" || $r70_codigo == null ){
       ...
       $this->r70_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhlota_r70_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $r70_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,894,5678,'','".AddSlashes(pg_fetch_result($resaco,0,'r70_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,894,5701,'','".AddSlashes(pg_fetch_result($resaco,0,'r70_codestrut'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,894,5680,'','".AddSlashes(pg_fetch_result($resaco,0,'r70_estrut'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,894,5681,'','".AddSlashes(pg_fetch_result($resaco,0,'r70_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,894,5704,'','".AddSlashes(pg_fetch_result($resaco,0,'r70_analitica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,894,7470,'','".AddSlashes(pg_fetch_result($resaco,0,'r70_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,894,11885,'','".AddSlashes(pg_fetch_result($resaco,0,'r70_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,894,12662,'','".AddSlashes(pg_fetch_result($resaco,0,'r70_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,894,15050,'','".AddSlashes(pg_fetch_result($resaco,0,'r70_concarpeculiar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($r70_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->r70_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r70_codigo"])){ 
       $sql  .= $virgula." r70_codigo = $this->r70_codigo ";
       $virgula = ",";
       if(trim((string) $this->r70_codigo) == null ){ 
     ...
     if(trim((string) $this->r70_codestrut)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r70_codestrut"])){ 
       $sql  .= $virgula." r70_codestrut = $this->r70_codestrut ";
       $virgula = ",";
       if(trim((string) $this->r70_codestrut) == null ){ 
         $this->erro_sql = " Campo Código da estrutura nao Informado.";
         $this->erro_campo = "r70_codestrut";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->r70_estrut)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r70_estrut"])){ 
       $sql  .= $virgula." r70_estrut = '$this->r70_estrut' ";
       $virgula = ",";
       if(trim((string) $this->r70_estrut) == null ){ 
         $this->erro_sql = " Campo Estrutural da Lotação nao Informado.";
         $this->erro_campo = "r70_estrut";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->r70_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r70_descr"])){ 
       $sql  .= $virgula." r70_descr = '$this->r70_descr' ";
       $virgula = ",";
       if(trim((string) $this->r70_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "r70_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->r70_analitica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r70_analitica"])){ 
       $sql  .= $virgula." r70_analitica = '$this->r70_analitica' ";
       $virgula = ",";
       if(trim((string) $this->r70_analitica) == null ){ 
         $this->erro_sql = " Campo Analitica nao Informado.";
         $this->erro_campo = "r70_analitica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->r70_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r70_instit"])){ 
       $sql  .= $virgula." r70_instit = $this->r70_instit ";
       $virgula = ",";
       if(trim((string) $this->r70_instit) == null ){ 
         $this->erro_sql = " Campo codigo da instituicao nao Informado.";
         $this->erro_campo = "r70_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->r70_ativo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r70_ativo"])){ 
       $sql  .= $virgula." r70_ativo = '$this->r70_ativo' ";
       $virgula = ",";
       if(trim((string) $this->r70_ativo) == null ){ 
         $this->erro_sql = " Campo Ativo nao Informado.";
         $this->erro_campo = "r70_ativo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->r70_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r70_numcgm"])){ 
       $sql  .= $virgula." r70_numcgm = $this->r70_numcgm ";
       $virgula = ",";
       if(trim((string) $this->r70_numcgm) == null ){ 
         $this->erro_sql = " Campo Numcgm nao Informado.";
         $this->erro_campo = "r70_numcgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->r70_concarpeculiar)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r70_concarpeculiar"])){ 
       $sql  .= $virgula." r70_concarpeculiar = '$this->r70_concarpeculiar' ";
       $virgula = ",";
       if(trim((string) $this->r70_concarpeculiar) == null ){ 
         $this->erro_sql = " Campo Caracteristica Peculiar nao Informado.";
         $this->erro_campo = "r70_concarpeculiar";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["r70_codigo"]) || $this->r70_codigo != "")
           $resac = db_query("insert into db_acount values($acount,894,5678,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r70_codigo'))."','$this->r70_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r70_codestrut"]) || $this->r70_codestrut != "")
           $resac = db_query("insert into db_acount values($acount,894,5701,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r70_codestrut'))."','$this->r70_codestrut',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r70_estrut"]) || $this->r70_estrut != "")
           $resac = db_query("insert into db_acount values($acount,894,5680,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r70_estrut'))."','$this->r70_estrut',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r70_descr"]) || $this->r70_descr != "")
           $resac = db_query("insert into db_acount values($acount,894,5681,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r70_descr'))."','$this->r70_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r70_analitica"]) || $this->r70_analitica != "")
           $resac = db_query("insert into db_acount values($acount,894,5704,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r70_analitica'))."','$this->r70_analitica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r70_instit"]) || $this->r70_instit != "")
           $resac = db_query("insert into db_acount values($acount,894,7470,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r70_instit'))."','$this->r70_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r70_ativo"]) || $this->r70_ativo != "")
           $resac = db_query("insert into db_acount values($acount,894,11885,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r70_ativo'))."','$this->r70_ativo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r70_numcgm"]) || $this->r70_numcgm != "")
           $resac = db_query("insert into db_acount values($acount,894,12662,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r70_numcgm'))."','$this->r70_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r70_concarpeculiar"]) || $this->r70_concarpeculiar != "")
           $resac = db_query("insert into db_acount values($acount,894,15050,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r70_concarpeculiar'))."','$this->r70_concarpeculiar',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($r70_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,894,5678,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r70_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,894,5701,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r70_codestrut'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,894,5680,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r70_estrut'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,894,5681,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r70_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,894,5704,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r70_analitica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,894,7470,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r70_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,894,11885,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r70_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,894,12662,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r70_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,894,15050,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r70_concarpeculiar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
