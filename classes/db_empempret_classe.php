...
class cl_empempret { 
   ...
   function incluir ($e67_numemp,$e67_seqretencao){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1659,9642,'','".AddSlashes(pg_fetch_result($resaco,0,'e67_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1659,9643,'','".AddSlashes(pg_fetch_result($resaco,0,'e67_seqretencao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e67_numemp=null,$e67_seqretencao=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e67_numemp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e67_numemp"])){ 
       $sql  .= $virgula." e67_numemp = $this->e67_numemp ";
       $virgula = ",";
       if(trim((string) $this->e67_numemp) == null ){ 
     ...
     if(trim((string) $this->e67_seqretencao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e67_seqretencao"])){ 
       $sql  .= $virgula." e67_seqretencao = $this->e67_seqretencao ";
       $virgula = ",";
       if(trim((string) $this->e67_seqretencao) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e67_numemp"]))
           $resac = db_query("insert into db_acount values($acount,1659,9642,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e67_numemp'))."','$this->e67_numemp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e67_seqretencao"]))
           $resac = db_query("insert into db_acount values($acount,1659,9643,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e67_seqretencao'))."','$this->e67_seqretencao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e67_numemp=null,$e67_seqretencao=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1659,9642,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e67_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1659,9643,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e67_seqretencao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
