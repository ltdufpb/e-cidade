...
class cl_termoprotprocesso {
   ...
   public $v27_sequencial = 0;
   public $v27_termo = 0;
   public $v27_protprocesso = 0;
   ...
   function incluir ($v27_sequencial){
     ...
     if($v27_sequencial == "" || $v27_sequencial == null ){
       ...
       $this->v27_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from termoprotprocesso_v27_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $v27_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2658,15110,'','".AddSlashes(pg_fetch_result($resaco,0,'v27_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2658,15111,'','".AddSlashes(pg_fetch_result($resaco,0,'v27_termo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2658,15112,'','".AddSlashes(pg_fetch_result($resaco,0,'v27_protprocesso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($v27_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->v27_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v27_sequencial"])){
       $sql  .= $virgula." v27_sequencial = $this->v27_sequencial ";
       $virgula = ",";
       if(trim((string) $this->v27_sequencial) == null ){
     ...
     if(trim((string) $this->v27_termo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v27_termo"])){
       $sql  .= $virgula." v27_termo = $this->v27_termo ";
       $virgula = ",";
       if(trim((string) $this->v27_termo) == null ){
         $this->erro_sql = " Campo Parcelamento nao Informado.";
         $this->erro_campo = "v27_termo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->v27_protprocesso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v27_protprocesso"])){
       $sql  .= $virgula." v27_protprocesso = $this->v27_protprocesso ";
       $virgula = ",";
       if(trim((string) $this->v27_protprocesso) == null ){
         $this->erro_sql = " Campo Código do Processo nao Informado.";
         $this->erro_campo = "v27_protprocesso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v27_sequencial"]) || $this->v27_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2658,15110,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v27_sequencial'))."','$this->v27_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v27_termo"]) || $this->v27_termo != "")
           $resac = db_query("insert into db_acount values($acount,2658,15111,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v27_termo'))."','$this->v27_termo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v27_protprocesso"]) || $this->v27_protprocesso != "")
           $resac = db_query("insert into db_acount values($acount,2658,15112,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v27_protprocesso'))."','$this->v27_protprocesso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($v27_sequencial=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2658,15110,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v27_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2658,15111,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v27_termo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2658,15112,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v27_protprocesso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
