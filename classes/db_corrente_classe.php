...
class cl_corrente {
   ...
   function incluir ($k12_id,$k12_data,$k12_autent){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,200,1139,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,200,1140,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,200,1141,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_autent'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,200,1142,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,200,1143,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_conta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,200,1144,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,200,1145,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_estorn'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,200,6316,'','".AddSlashes(pg_fetch_result($resaco,0,'k12_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($k12_id=null,$k12_data=null,$k12_autent=null) {
     ...
     if(trim((string) $this->k12_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k12_hora"])){
       $sql  .= $virgula." k12_hora = '$this->k12_hora' ";
       $virgula = ",";
       if(trim((string) $this->k12_hora) == null ){
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "k12_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k12_conta)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k12_conta"])){
       $sql  .= $virgula." k12_conta = $this->k12_conta ";
       $virgula = ",";
       if(trim((string) $this->k12_conta) == null ){
         $this->erro_sql = " Campo Código da Conta nao Informado.";
         $this->erro_campo = "k12_conta";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k12_estorn)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k12_estorn"])){
       $sql  .= $virgula." k12_estorn = '$this->k12_estorn' ";
       $virgula = ",";
       if(trim((string) $this->k12_estorn) == null ){
         $this->erro_sql = " Campo Estornado nao Informado.";
         $this->erro_campo = "k12_estorn";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k12_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k12_instit"])){
       $sql  .= $virgula." k12_instit = $this->k12_instit ";
       $virgula = ",";
       if(trim((string) $this->k12_instit) == null ){
         $this->erro_sql = " Campo Instituição nao Informado.";
         $this->erro_campo = "k12_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_id"]))
           $resac = db_query("insert into db_acount values($acount,200,1139,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_id'))."','$this->k12_id',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_data"]))
           $resac = db_query("insert into db_acount values($acount,200,1140,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_data'))."','$this->k12_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_autent"]))
           $resac = db_query("insert into db_acount values($acount,200,1141,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_autent'))."','$this->k12_autent',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_hora"]))
           $resac = db_query("insert into db_acount values($acount,200,1142,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_hora'))."','$this->k12_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_conta"]))
           $resac = db_query("insert into db_acount values($acount,200,1143,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_conta'))."','$this->k12_conta',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_valor"]))
           $resac = db_query("insert into db_acount values($acount,200,1144,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_valor'))."','$this->k12_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_estorn"]))
           $resac = db_query("insert into db_acount values($acount,200,1145,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_estorn'))."','$this->k12_estorn',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k12_instit"]))
           $resac = db_query("insert into db_acount values($acount,200,6316,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k12_instit'))."','$this->k12_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($k12_id=null,$k12_data=null,$k12_autent=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,200,1139,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,200,1140,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,200,1141,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_autent'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,200,1142,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,200,1143,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_conta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,200,1144,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,200,1145,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_estorn'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,200,6316,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k12_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
