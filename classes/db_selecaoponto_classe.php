...
class cl_selecaoponto { 
   ...
   public $r72_sequencial = 0; 
   public $r72_selecao = 0; 
   public $r72_instit = 0; 
   public $r72_descricao = null; 
   ...
   function incluir ($r72_sequencial){ 
     ...
     if($r72_sequencial == "" || $r72_sequencial == null ){
       ...
       $this->r72_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from selecaoponto_r72_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $r72_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2499,14210,'','".AddSlashes(pg_fetch_result($resaco,0,'r72_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2499,14211,'','".AddSlashes(pg_fetch_result($resaco,0,'r72_selecao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2499,14219,'','".AddSlashes(pg_fetch_result($resaco,0,'r72_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2499,14212,'','".AddSlashes(pg_fetch_result($resaco,0,'r72_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($r72_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->r72_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r72_sequencial"])){ 
       $sql  .= $virgula." r72_sequencial = $this->r72_sequencial ";
       $virgula = ",";
       if(trim((string) $this->r72_sequencial) == null ){ 
     ...
     if(trim((string) $this->r72_selecao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r72_selecao"])){ 
       $sql  .= $virgula." r72_selecao = $this->r72_selecao ";
       $virgula = ",";
       if(trim((string) $this->r72_selecao) == null ){ 
         $this->erro_sql = " Campo Seleção nao Informado.";
         $this->erro_campo = "r72_selecao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->r72_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r72_instit"])){ 
       $sql  .= $virgula." r72_instit = $this->r72_instit ";
       $virgula = ",";
       if(trim((string) $this->r72_instit) == null ){ 
         $this->erro_sql = " Campo Codigo da Instituição nao Informado.";
         $this->erro_campo = "r72_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->r72_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r72_descricao"])){ 
       $sql  .= $virgula." r72_descricao = '$this->r72_descricao' ";
       $virgula = ",";
       if(trim((string) $this->r72_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "r72_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["r72_sequencial"]) || $this->r72_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2499,14210,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r72_sequencial'))."','$this->r72_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r72_selecao"]) || $this->r72_selecao != "")
           $resac = db_query("insert into db_acount values($acount,2499,14211,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r72_selecao'))."','$this->r72_selecao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r72_instit"]) || $this->r72_instit != "")
           $resac = db_query("insert into db_acount values($acount,2499,14219,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r72_instit'))."','$this->r72_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["r72_descricao"]) || $this->r72_descricao != "")
           $resac = db_query("insert into db_acount values($acount,2499,14212,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'r72_descricao'))."','$this->r72_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($r72_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2499,14210,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r72_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2499,14211,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r72_selecao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2499,14219,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r72_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2499,14212,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'r72_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
