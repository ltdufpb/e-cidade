...
class cl_conlancamrec {
   ...
   public $c74_anousu = 0;
   public $c74_codrec = 0;
   public $c74_data_dia = null;
   public $c74_data_mes = null;
   public $c74_data_ano = null;
   public $c74_data = null;
   ...
   function incluir ($c74_codlan){
     ...
     if (isset($lSessaoDesativarAccount) && $lSessaoDesativarAccount === false) {
       ...
       if (($resaco!=false)||($this->numrows!=0)) {
         ...
         $resac = db_query("insert into db_acount values($acount,767,5204,'','".AddSlashes(pg_fetch_result($resaco,0,'c74_codlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,767,5205,'','".AddSlashes(pg_fetch_result($resaco,0,'c74_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,767,5206,'','".AddSlashes(pg_fetch_result($resaco,0,'c74_codrec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,767,5904,'','".AddSlashes(pg_fetch_result($resaco,0,'c74_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   function alterar ($c74_codlan=null) {
     ...
     $virgula = "";
     if(trim((string) $this->c74_codlan)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c74_codlan"])){
       $sql  .= $virgula." c74_codlan = $this->c74_codlan ";
       $virgula = ",";
       if(trim((string) $this->c74_codlan) == null ){
     ...
     if(trim((string) $this->c74_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c74_anousu"])){
       $sql  .= $virgula." c74_anousu = $this->c74_anousu ";
       $virgula = ",";
       if(trim((string) $this->c74_anousu) == null ){
         $this->erro_sql = " Campo Exercício nao Informado.";
         $this->erro_campo = "c74_anousu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c74_codrec)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c74_codrec"])){
       $sql  .= $virgula." c74_codrec = $this->c74_codrec ";
       $virgula = ",";
       if(trim((string) $this->c74_codrec) == null ){
         $this->erro_sql = " Campo Receita nao Informado.";
         $this->erro_campo = "c74_codrec";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c74_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c74_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["c74_data_dia"] !="") ){
       $sql  .= $virgula." c74_data = '$this->c74_data' ";
       $virgula = ",";
       if(trim((string) $this->c74_data) == null ){
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "c74_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["c74_codlan"]))
             $resac = db_query("insert into db_acount values($acount,767,5204,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c74_codlan'))."','$this->c74_codlan',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["c74_anousu"]))
             $resac = db_query("insert into db_acount values($acount,767,5205,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c74_anousu'))."','$this->c74_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["c74_codrec"]))
             $resac = db_query("insert into db_acount values($acount,767,5206,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c74_codrec'))."','$this->c74_codrec',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["c74_data"]))
             $resac = db_query("insert into db_acount values($acount,767,5904,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c74_data'))."','$this->c74_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (isset($lSessaoDesativarAccount) && $lSessaoDesativarAccount === false) {
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
           ...
           $resac = db_query("insert into db_acount values($acount,767,5204,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c74_codlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,767,5205,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c74_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,767,5206,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c74_codrec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,767,5904,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c74_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
