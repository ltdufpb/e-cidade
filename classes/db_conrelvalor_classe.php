...
class cl_conrelvalor { 
   ...
   public $c83_codigo = 0; 
   public $c83_instit = 0; 
   public $c83_informacao = null; 
   public $c83_anousu = 0; 
   public $c83_periodo = null; 
   ...
   function incluir ($c83_codigo,$c83_instit,$c83_periodo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1205,7264,'','".AddSlashes(pg_fetch_result($resaco,0,'c83_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1205,7414,'','".AddSlashes(pg_fetch_result($resaco,0,'c83_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1205,7268,'','".AddSlashes(pg_fetch_result($resaco,0,'c83_informacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1205,8640,'','".AddSlashes(pg_fetch_result($resaco,0,'c83_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1205,10723,'','".AddSlashes(pg_fetch_result($resaco,0,'c83_periodo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($c83_codigo=null,$c83_instit=null,$c83_periodo=null) { 
     ...
     if(trim((string) $this->c83_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c83_instit"])){ 
       $sql  .= $virgula." c83_instit = $this->c83_instit ";
       $virgula = ",";
       if(trim((string) $this->c83_instit) == null ){ 
     ...
     if(trim((string) $this->c83_informacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c83_informacao"])){ 
       $sql  .= $virgula." c83_informacao = '$this->c83_informacao' ";
       $virgula = ",";
       if(trim((string) $this->c83_informacao) == null ){ 
         $this->erro_sql = " Campo informação da variavel nao Informado.";
         $this->erro_campo = "c83_informacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c83_periodo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c83_periodo"])){ 
       $sql  .= $virgula." c83_periodo = '$this->c83_periodo' ";
       $virgula = ",";
       if(trim((string) $this->c83_periodo) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c83_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1205,7264,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c83_codigo'))."','$this->c83_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c83_instit"]))
           $resac = db_query("insert into db_acount values($acount,1205,7414,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c83_instit'))."','$this->c83_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c83_informacao"]))
           $resac = db_query("insert into db_acount values($acount,1205,7268,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c83_informacao'))."','$this->c83_informacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c83_anousu"]))
           $resac = db_query("insert into db_acount values($acount,1205,8640,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c83_anousu'))."','$this->c83_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c83_periodo"]))
           $resac = db_query("insert into db_acount values($acount,1205,10723,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c83_periodo'))."','$this->c83_periodo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($c83_codigo=null,$c83_instit=null,$c83_periodo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1205,7264,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c83_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1205,7414,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c83_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1205,7268,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c83_informacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1205,8640,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c83_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1205,10723,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c83_periodo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
