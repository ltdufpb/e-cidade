...
class cl_tipoassecontrolediasmes { 
   ...
   function incluir ($rh170_sequencial){ 
     ...
     if($rh170_sequencial == "" || $rh170_sequencial == null ){
       ...
       $this->rh170_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tipoassecontrolediasmes_rh170_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh170_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3882,21611,'','".AddSlashes(pg_fetch_result($resaco,0,'rh170_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3882,21612,'','".AddSlashes(pg_fetch_result($resaco,0,'rh170_tipoasse'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($rh170_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh170_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh170_sequencial"])){ 
       $sql  .= $virgula." rh170_sequencial = $this->rh170_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh170_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh170_tipoasse)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh170_tipoasse"])){ 
       $sql  .= $virgula." rh170_tipoasse = $this->rh170_tipoasse ";
       $virgula = ",";
       if(trim((string) $this->rh170_tipoasse) == null ){ 
         $this->erro_sql = " Campo Tipo do Assentamento não informado.";
         $this->erro_campo = "rh170_tipoasse";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["rh170_sequencial"]) || $this->rh170_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3882,21611,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh170_sequencial'))."','$this->rh170_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["rh170_tipoasse"]) || $this->rh170_tipoasse != "")
             $resac = db_query("insert into db_acount values($acount,3882,21612,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh170_tipoasse'))."','$this->rh170_tipoasse',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3882,21611,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh170_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3882,21612,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh170_tipoasse'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
