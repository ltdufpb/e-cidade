...
class cl_orcprojlan { 
   ...
   public $o51_codproj = 0; 
   public $o51_data_dia = null; 
   public $o51_data_mes = null; 
   public $o51_data_ano = null; 
   public $o51_data = null; 
   public $o51_id_usuario = 0; 
   ...
   function incluir ($o51_codproj){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1076,6541,'','".AddSlashes(pg_fetch_result($resaco,0,'o51_codproj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1076,6542,'','".AddSlashes(pg_fetch_result($resaco,0,'o51_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1076,6543,'','".AddSlashes(pg_fetch_result($resaco,0,'o51_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o51_codproj=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o51_codproj)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o51_codproj"])){ 
       $sql  .= $virgula." o51_codproj = $this->o51_codproj ";
       $virgula = ",";
       if(trim((string) $this->o51_codproj) == null ){ 
     ...
     if(trim((string) $this->o51_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o51_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["o51_data_dia"] !="") ){ 
       $sql  .= $virgula." o51_data = '$this->o51_data' ";
       $virgula = ",";
       if(trim((string) $this->o51_data) == null ){ 
         $this->erro_sql = " Campo data de processamento nao Informado.";
         $this->erro_campo = "o51_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o51_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o51_id_usuario"])){ 
       $sql  .= $virgula." o51_id_usuario = $this->o51_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->o51_id_usuario) == null ){ 
         $this->erro_sql = " Campo id do usuario nao Informado.";
         $this->erro_campo = "o51_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o51_codproj"]))
           $resac = db_query("insert into db_acount values($acount,1076,6541,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o51_codproj'))."','$this->o51_codproj',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o51_data"]))
           $resac = db_query("insert into db_acount values($acount,1076,6542,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o51_data'))."','$this->o51_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o51_id_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1076,6543,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o51_id_usuario'))."','$this->o51_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o51_codproj=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1076,6541,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o51_codproj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1076,6542,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o51_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1076,6543,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o51_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
