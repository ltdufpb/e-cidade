...
class cl_projmelhoriasmatric { 
   ...
   public $d41_codigo = 0; 
   public $d41_matric = 0; 
   public $d41_testada = 0; 
   public $d41_eixo = 0; 
   public $d41_obs = null; 
   public $d41_auto = 'f'; 
   public $d41_pgtopref = 'f'; 
   ...
   function incluir ($d41_codigo,$d41_matric){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,514,3577,'','".AddSlashes(pg_fetch_result($resaco,0,'d41_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,514,3578,'','".AddSlashes(pg_fetch_result($resaco,0,'d41_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,514,3579,'','".AddSlashes(pg_fetch_result($resaco,0,'d41_testada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,514,3580,'','".AddSlashes(pg_fetch_result($resaco,0,'d41_eixo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,514,3581,'','".AddSlashes(pg_fetch_result($resaco,0,'d41_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,514,3582,'','".AddSlashes(pg_fetch_result($resaco,0,'d41_auto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,514,4857,'','".AddSlashes(pg_fetch_result($resaco,0,'d41_pgtopref'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($d41_codigo=null,$d41_matric=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->d41_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d41_codigo"])){ 
       $sql  .= $virgula." d41_codigo = $this->d41_codigo ";
       $virgula = ",";
       if(trim((string) $this->d41_codigo) == null ){ 
     ...
     if(trim((string) $this->d41_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d41_matric"])){ 
       $sql  .= $virgula." d41_matric = $this->d41_matric ";
       $virgula = ",";
       if(trim((string) $this->d41_matric) == null ){ 
     ...
     if(trim((string) $this->d41_testada)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d41_testada"])){ 
       $sql  .= $virgula." d41_testada = $this->d41_testada ";
       $virgula = ",";
       if(trim((string) $this->d41_testada) == null ){ 
         $this->erro_sql = " Campo Testada Ml nao Informado.";
         $this->erro_campo = "d41_testada";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->d41_eixo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d41_eixo"])){ 
        if(trim((string) $this->d41_eixo)=="" && isset($GLOBALS["HTTP_POST_VARS"]["d41_eixo"])){ 
           $this->d41_eixo = "0" ; 
        } 
     ...
     if(trim((string) $this->d41_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d41_obs"])){ 
       $sql  .= $virgula." d41_obs = '$this->d41_obs' ";
       $virgula = ",";
     }
     if(trim((string) $this->d41_auto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d41_auto"])){ 
       $sql  .= $virgula." d41_auto = '$this->d41_auto' ";
       $virgula = ",";
       if(trim((string) $this->d41_auto) == null ){ 
         $this->erro_sql = " Campo Automático nao Informado.";
         $this->erro_campo = "d41_auto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->d41_pgtopref)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d41_pgtopref"])){ 
       $sql  .= $virgula." d41_pgtopref = '$this->d41_pgtopref' ";
       $virgula = ",";
       if(trim((string) $this->d41_pgtopref) == null ){ 
         $this->erro_sql = " Campo Pgto prefeitura nao Informado.";
         $this->erro_campo = "d41_pgtopref";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["d41_codigo"]))
           $resac = db_query("insert into db_acount values($acount,514,3577,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d41_codigo'))."','$this->d41_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d41_matric"]))
           $resac = db_query("insert into db_acount values($acount,514,3578,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d41_matric'))."','$this->d41_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d41_testada"]))
           $resac = db_query("insert into db_acount values($acount,514,3579,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d41_testada'))."','$this->d41_testada',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d41_eixo"]))
           $resac = db_query("insert into db_acount values($acount,514,3580,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d41_eixo'))."','$this->d41_eixo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d41_obs"]))
           $resac = db_query("insert into db_acount values($acount,514,3581,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d41_obs'))."','$this->d41_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d41_auto"]))
           $resac = db_query("insert into db_acount values($acount,514,3582,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d41_auto'))."','$this->d41_auto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d41_pgtopref"]))
           $resac = db_query("insert into db_acount values($acount,514,4857,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d41_pgtopref'))."','$this->d41_pgtopref',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($d41_codigo=null,$d41_matric=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,514,3577,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d41_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,514,3578,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d41_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,514,3579,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d41_testada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,514,3580,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d41_eixo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,514,3581,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d41_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,514,3582,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d41_auto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,514,4857,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d41_pgtopref'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
