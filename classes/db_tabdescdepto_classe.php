...
class cl_tabdescdepto { 
   ...
   public $k69_sequencial = 0; 
   public $k69_coddepto = 0; 
   public $k69_tabdesc = 0; 
   ...
   function incluir ($k69_sequencial){ 
     ...
     if($k69_sequencial == "" || $k69_sequencial == null ){
       ...
       $this->k69_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tabdescdepto_k69_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k69_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2066,11951,'','".AddSlashes(pg_fetch_result($resaco,0,'k69_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2066,11952,'','".AddSlashes(pg_fetch_result($resaco,0,'k69_coddepto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2066,11953,'','".AddSlashes(pg_fetch_result($resaco,0,'k69_tabdesc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k69_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k69_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k69_sequencial"])){ 
       $sql  .= $virgula." k69_sequencial = $this->k69_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k69_sequencial) == null ){ 
     ...
     if(trim((string) $this->k69_coddepto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k69_coddepto"])){ 
       $sql  .= $virgula." k69_coddepto = $this->k69_coddepto ";
       $virgula = ",";
       if(trim((string) $this->k69_coddepto) == null ){ 
         $this->erro_sql = " Campo Código Departamento nao Informado.";
         $this->erro_campo = "k69_coddepto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k69_tabdesc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k69_tabdesc"])){ 
       $sql  .= $virgula." k69_tabdesc = $this->k69_tabdesc ";
       $virgula = ",";
       if(trim((string) $this->k69_tabdesc) == null ){ 
         $this->erro_sql = " Campo Código da Descrição nao Informado.";
         $this->erro_campo = "k69_tabdesc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k69_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2066,11951,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k69_sequencial'))."','$this->k69_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k69_coddepto"]))
           $resac = db_query("insert into db_acount values($acount,2066,11952,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k69_coddepto'))."','$this->k69_coddepto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k69_tabdesc"]))
           $resac = db_query("insert into db_acount values($acount,2066,11953,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k69_tabdesc'))."','$this->k69_tabdesc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k69_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2066,11951,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k69_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2066,11952,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k69_coddepto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2066,11953,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k69_tabdesc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
