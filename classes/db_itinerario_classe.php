...
class cl_itinerario { 
   ...
   public $ed218_d_datacad_dia = null; 
   public $ed218_d_datacad_mes = null; 
   public $ed218_d_datacad_ano = null; 
   public $ed218_d_datacad = null; 
   public $ed218_v_nome = null; 
   public $ed218_i_sequencia = 0; 
   public $ed218_i_linha = 0; 
   public $ed218_i_usuario = 0; 
   ...
   function incluir ($ed218_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1925,11150,'','".AddSlashes(pg_fetch_result($resaco,0,'ed218_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1925,11151,'','".AddSlashes(pg_fetch_result($resaco,0,'ed218_d_datacad'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1925,11152,'','".AddSlashes(pg_fetch_result($resaco,0,'ed218_v_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1925,11153,'','".AddSlashes(pg_fetch_result($resaco,0,'ed218_i_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1925,11155,'','".AddSlashes(pg_fetch_result($resaco,0,'ed218_i_linha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1925,11156,'','".AddSlashes(pg_fetch_result($resaco,0,'ed218_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed218_i_codigo=null) { 
     ...
     if(trim((string) $this->ed218_d_datacad)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed218_d_datacad_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["ed218_d_datacad_dia"] !="") ){ 
       $sql  .= $virgula." ed218_d_datacad = '$this->ed218_d_datacad' ";
       $virgula = ",";
       if(trim((string) $this->ed218_d_datacad) == null ){ 
         $this->erro_sql = " Campo Data cadastro nao Informado.";
         $this->erro_campo = "ed218_d_datacad_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed218_v_nome)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed218_v_nome"])){ 
       $sql  .= $virgula." ed218_v_nome = '$this->ed218_v_nome' ";
       $virgula = ",";
       if(trim((string) $this->ed218_v_nome) == null ){ 
         $this->erro_sql = " Campo Nome nao Informado.";
         $this->erro_campo = "ed218_v_nome";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed218_i_sequencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed218_i_sequencia"])){ 
       $sql  .= $virgula." ed218_i_sequencia = $this->ed218_i_sequencia ";
       $virgula = ",";
       if(trim((string) $this->ed218_i_sequencia) == null ){ 
         $this->erro_sql = " Campo Sequencia nao Informado.";
         $this->erro_campo = "ed218_i_sequencia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed218_i_linha)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed218_i_linha"])){ 
       $sql  .= $virgula." ed218_i_linha = $this->ed218_i_linha ";
       $virgula = ",";
       if(trim((string) $this->ed218_i_linha) == null ){ 
         $this->erro_sql = " Campo Linha nao Informado.";
         $this->erro_campo = "ed218_i_linha";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed218_i_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed218_i_usuario"])){ 
       $sql  .= $virgula." ed218_i_usuario = $this->ed218_i_usuario ";
       $virgula = ",";
       if(trim((string) $this->ed218_i_usuario) == null ){ 
         $this->erro_sql = " Campo Usuario nao Informado.";
         $this->erro_campo = "ed218_i_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed218_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1925,11150,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed218_i_codigo'))."','$this->ed218_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed218_d_datacad"]))
           $resac = db_query("insert into db_acount values($acount,1925,11151,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed218_d_datacad'))."','$this->ed218_d_datacad',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed218_v_nome"]))
           $resac = db_query("insert into db_acount values($acount,1925,11152,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed218_v_nome'))."','$this->ed218_v_nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed218_i_sequencia"]))
           $resac = db_query("insert into db_acount values($acount,1925,11153,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed218_i_sequencia'))."','$this->ed218_i_sequencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed218_i_linha"]))
           $resac = db_query("insert into db_acount values($acount,1925,11155,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed218_i_linha'))."','$this->ed218_i_linha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed218_i_usuario"]))
           $resac = db_query("insert into db_acount values($acount,1925,11156,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed218_i_usuario'))."','$this->ed218_i_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed218_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1925,11150,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed218_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1925,11151,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed218_d_datacad'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1925,11152,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed218_v_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1925,11153,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed218_i_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1925,11155,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed218_i_linha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1925,11156,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed218_i_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
