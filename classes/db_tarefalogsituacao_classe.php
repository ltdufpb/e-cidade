...
class cl_tarefalogsituacao { 
   ...
   public $at48_sequencial = 0; 
   public $at48_tarefalog = 0; 
   public $at48_situacao = 0; 
   ...
   function incluir ($at48_sequencial){ 
     ...
     if($at48_sequencial == "" || $at48_sequencial == null ){
       ...
       $this->at48_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tarefalogsituacao_at48_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at48_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1374,8129,'','".AddSlashes(pg_fetch_result($resaco,0,'at48_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1374,8130,'','".AddSlashes(pg_fetch_result($resaco,0,'at48_tarefalog'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1374,8131,'','".AddSlashes(pg_fetch_result($resaco,0,'at48_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at48_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at48_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at48_sequencial"])){ 
       $sql  .= $virgula." at48_sequencial = $this->at48_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at48_sequencial) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
     ...
     if(trim((string) $this->at48_tarefalog)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at48_tarefalog"])){ 
       $sql  .= $virgula." at48_tarefalog = $this->at48_tarefalog ";
       $virgula = ",";
       if(trim((string) $this->at48_tarefalog) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
         $this->erro_campo = "at48_tarefalog";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at48_situacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at48_situacao"])){ 
       $sql  .= $virgula." at48_situacao = $this->at48_situacao ";
       $virgula = ",";
       if(trim((string) $this->at48_situacao) == null ){ 
         $this->erro_sql = " Campo Codigo da situacao nao Informado.";
         $this->erro_campo = "at48_situacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at48_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1374,8129,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at48_sequencial'))."','$this->at48_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at48_tarefalog"]))
           $resac = db_query("insert into db_acount values($acount,1374,8130,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at48_tarefalog'))."','$this->at48_tarefalog',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at48_situacao"]))
           $resac = db_query("insert into db_acount values($acount,1374,8131,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at48_situacao'))."','$this->at48_situacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at48_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1374,8129,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at48_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1374,8130,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at48_tarefalog'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1374,8131,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at48_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
