...
class cl_turmamedicaodidaticopedagogica { 
   ...
   public $ed345_sequencial = 0; 
   public $ed345_turma = 0; 
   public $ed345_medicaodidaticopedagogica = 0; 
   ...
   function incluir ($ed345_sequencial){ 
     ...
     if($ed345_sequencial == "" || $ed345_sequencial == null ){
       ...
       $this->ed345_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from turmamedicaodidaticopedagogica_ed345_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed345_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3708,20600,'','".AddSlashes(pg_fetch_result($resaco,0,'ed345_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3708,20601,'','".AddSlashes(pg_fetch_result($resaco,0,'ed345_turma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3708,20602,'','".AddSlashes(pg_fetch_result($resaco,0,'ed345_medicaodidaticopedagogica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($ed345_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed345_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed345_sequencial"])){ 
       $sql  .= $virgula." ed345_sequencial = $this->ed345_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed345_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed345_turma)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed345_turma"])){ 
       $sql  .= $virgula." ed345_turma = $this->ed345_turma ";
       $virgula = ",";
       if(trim((string) $this->ed345_turma) == null ){ 
         $this->erro_sql = " Campo Turma não informado.";
         $this->erro_campo = "ed345_turma";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed345_medicaodidaticopedagogica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed345_medicaodidaticopedagogica"])){ 
       $sql  .= $virgula." ed345_medicaodidaticopedagogica = $this->ed345_medicaodidaticopedagogica ";
       $virgula = ",";
       if(trim((string) $this->ed345_medicaodidaticopedagogica) == null ){ 
         $this->erro_sql = " Campo Medição Didático-Pedagógica não informado.";
         $this->erro_campo = "ed345_medicaodidaticopedagogica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["ed345_sequencial"]) || $this->ed345_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3708,20600,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed345_sequencial'))."','$this->ed345_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ed345_turma"]) || $this->ed345_turma != "")
             $resac = db_query("insert into db_acount values($acount,3708,20601,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed345_turma'))."','$this->ed345_turma',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ed345_medicaodidaticopedagogica"]) || $this->ed345_medicaodidaticopedagogica != "")
             $resac = db_query("insert into db_acount values($acount,3708,20602,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed345_medicaodidaticopedagogica'))."','$this->ed345_medicaodidaticopedagogica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3708,20600,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed345_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3708,20601,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed345_turma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3708,20602,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed345_medicaodidaticopedagogica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
