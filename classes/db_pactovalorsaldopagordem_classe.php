...
class cl_pactovalorsaldopagordem { 
   ...
   public $o110_sequencial = 0; 
   public $o110_pactovalorsaldo = 0; 
   public $o110_pagordem = 0; 
   ...
   function incluir ($o110_sequencial){ 
     ...
     if($o110_sequencial == "" || $o110_sequencial == null ){
       ...
       $this->o110_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from pactovalorsaldopagordem_o110_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $o110_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2456,13959,'','".AddSlashes(pg_fetch_result($resaco,0,'o110_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2456,13960,'','".AddSlashes(pg_fetch_result($resaco,0,'o110_pactovalorsaldo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2456,13961,'','".AddSlashes(pg_fetch_result($resaco,0,'o110_pagordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o110_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o110_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o110_sequencial"])){ 
       $sql  .= $virgula." o110_sequencial = $this->o110_sequencial ";
       $virgula = ",";
       if(trim((string) $this->o110_sequencial) == null ){ 
     ...
     if(trim((string) $this->o110_pactovalorsaldo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o110_pactovalorsaldo"])){ 
       $sql  .= $virgula." o110_pactovalorsaldo = $this->o110_pactovalorsaldo ";
       $virgula = ",";
       if(trim((string) $this->o110_pactovalorsaldo) == null ){ 
         $this->erro_sql = " Campo Pactosaldo nao Informado.";
         $this->erro_campo = "o110_pactovalorsaldo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o110_pagordem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o110_pagordem"])){ 
       $sql  .= $virgula." o110_pagordem = $this->o110_pagordem ";
       $virgula = ",";
       if(trim((string) $this->o110_pagordem) == null ){ 
         $this->erro_sql = " Campo o110_pagordem nao Informado.";
         $this->erro_campo = "o110_pagordem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o110_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2456,13959,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o110_sequencial'))."','$this->o110_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o110_pactovalorsaldo"]))
           $resac = db_query("insert into db_acount values($acount,2456,13960,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o110_pactovalorsaldo'))."','$this->o110_pactovalorsaldo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o110_pagordem"]))
           $resac = db_query("insert into db_acount values($acount,2456,13961,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o110_pagordem'))."','$this->o110_pagordem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o110_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2456,13959,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o110_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2456,13960,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o110_pactovalorsaldo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2456,13961,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o110_pagordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
