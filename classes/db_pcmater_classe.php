...
class cl_pcmater { 
   ...
   public $pc01_ativo = 'f'; 
   public $pc01_conversao = 'f'; 
   public $pc01_id_usuario = 0; 
   public $pc01_libaut = 'f'; 
   public $pc01_servico = 'f'; 
   public $pc01_veiculo = 'f'; 
   public $pc01_fraciona = 'f'; 
   public $pc01_validademinima = 'f'; 
   public $pc01_obrigatorio = 'f'; 
   public $pc01_liberaresumo = 'f'; 
   ...
   function incluir ($pc01_codmater){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,855,5491,'','".AddSlashes(pg_fetch_result($resaco,0,'pc01_codmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,855,5492,'','".AddSlashes(pg_fetch_result($resaco,0,'pc01_descrmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,855,5493,'','".AddSlashes(pg_fetch_result($resaco,0,'pc01_complmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,855,5494,'','".AddSlashes(pg_fetch_result($resaco,0,'pc01_codsubgrupo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,855,6602,'','".AddSlashes(pg_fetch_result($resaco,0,'pc01_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,855,6761,'','".AddSlashes(pg_fetch_result($resaco,0,'pc01_conversao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,855,7425,'','".AddSlashes(pg_fetch_result($resaco,0,'pc01_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,855,8068,'','".AddSlashes(pg_fetch_result($resaco,0,'pc01_libaut'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,855,10556,'','".AddSlashes(pg_fetch_result($resaco,0,'pc01_servico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,855,11473,'','".AddSlashes(pg_fetch_result($resaco,0,'pc01_veiculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,855,11708,'','".AddSlashes(pg_fetch_result($resaco,0,'pc01_fraciona'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,855,11727,'','".AddSlashes(pg_fetch_result($resaco,0,'pc01_validademinima'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,855,11728,'','".AddSlashes(pg_fetch_result($resaco,0,'pc01_obrigatorio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,855,17390,'','".AddSlashes(pg_fetch_result($resaco,0,'pc01_liberaresumo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc01_codmater=null) { 
     ...
     if(trim((string) $this->pc01_ativo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc01_ativo"])){ 
       $sql  .= $virgula." pc01_ativo = '$this->pc01_ativo' ";
       $virgula = ",";
       if(trim((string) $this->pc01_ativo) == null ){ 
         $this->erro_sql = " Campo Material inativo nao Informado.";
         $this->erro_campo = "pc01_ativo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc01_conversao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc01_conversao"])){ 
       $sql  .= $virgula." pc01_conversao = '$this->pc01_conversao' ";
       $virgula = ",";
       if(trim((string) $this->pc01_conversao) == null ){ 
         $this->erro_sql = " Campo Conversão nao Informado.";
         $this->erro_campo = "pc01_conversao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc01_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc01_id_usuario"])){ 
       $sql  .= $virgula." pc01_id_usuario = $this->pc01_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->pc01_id_usuario) == null ){ 
         $this->erro_sql = " Campo Cod. Usuário nao Informado.";
         $this->erro_campo = "pc01_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc01_libaut)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc01_libaut"])){ 
       $sql  .= $virgula." pc01_libaut = '$this->pc01_libaut' ";
       $virgula = ",";
       if(trim((string) $this->pc01_libaut) == null ){ 
         $this->erro_sql = " Campo Liberado para Autorização de Empenho nao Informado.";
         $this->erro_campo = "pc01_libaut";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc01_servico)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc01_servico"])){ 
       $sql  .= $virgula." pc01_servico = '$this->pc01_servico' ";
       $virgula = ",";
       if(trim((string) $this->pc01_servico) == null ){ 
         $this->erro_sql = " Campo Serviço nao Informado.";
         $this->erro_campo = "pc01_servico";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc01_veiculo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc01_veiculo"])){ 
       $sql  .= $virgula." pc01_veiculo = '$this->pc01_veiculo' ";
       $virgula = ",";
       if(trim((string) $this->pc01_veiculo) == null ){ 
         $this->erro_sql = " Campo Veículo nao Informado.";
         $this->erro_campo = "pc01_veiculo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc01_fraciona)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc01_fraciona"])){ 
       $sql  .= $virgula." pc01_fraciona = '$this->pc01_fraciona' ";
       $virgula = ",";
       if(trim((string) $this->pc01_fraciona) == null ){ 
         $this->erro_sql = " Campo Fraciona nao Informado.";
         $this->erro_campo = "pc01_fraciona";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc01_validademinima)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc01_validademinima"])){ 
       $sql  .= $virgula." pc01_validademinima = '$this->pc01_validademinima' ";
       $virgula = ",";
       if(trim((string) $this->pc01_validademinima) == null ){ 
         $this->erro_sql = " Campo Validade Mínima nao Informado.";
         $this->erro_campo = "pc01_validademinima";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc01_obrigatorio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc01_obrigatorio"])){ 
       $sql  .= $virgula." pc01_obrigatorio = '$this->pc01_obrigatorio' ";
       $virgula = ",";
       if(trim((string) $this->pc01_obrigatorio) == null ){ 
         $this->erro_sql = " Campo Obrigatório nao Informado.";
         $this->erro_campo = "pc01_obrigatorio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc01_liberaresumo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc01_liberaresumo"])){ 
       $sql  .= $virgula." pc01_liberaresumo = '$this->pc01_liberaresumo' ";
       $virgula = ",";
       if(trim((string) $this->pc01_liberaresumo) == null ){ 
         $this->erro_sql = " Campo Liberar Resumo nao Informado.";
         $this->erro_campo = "pc01_liberaresumo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_codmater"]) || $this->pc01_codmater != "")
           $resac = db_query("insert into db_acount values($acount,855,5491,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc01_codmater'))."','$this->pc01_codmater',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_descrmater"]) || $this->pc01_descrmater != "")
           $resac = db_query("insert into db_acount values($acount,855,5492,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc01_descrmater'))."','$this->pc01_descrmater',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_complmater"]) || $this->pc01_complmater != "")
           $resac = db_query("insert into db_acount values($acount,855,5493,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc01_complmater'))."','$this->pc01_complmater',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_codsubgrupo"]) || $this->pc01_codsubgrupo != "")
           $resac = db_query("insert into db_acount values($acount,855,5494,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc01_codsubgrupo'))."','$this->pc01_codsubgrupo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_ativo"]) || $this->pc01_ativo != "")
           $resac = db_query("insert into db_acount values($acount,855,6602,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc01_ativo'))."','$this->pc01_ativo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_conversao"]) || $this->pc01_conversao != "")
           $resac = db_query("insert into db_acount values($acount,855,6761,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc01_conversao'))."','$this->pc01_conversao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_id_usuario"]) || $this->pc01_id_usuario != "")
           $resac = db_query("insert into db_acount values($acount,855,7425,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc01_id_usuario'))."','$this->pc01_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_libaut"]) || $this->pc01_libaut != "")
           $resac = db_query("insert into db_acount values($acount,855,8068,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc01_libaut'))."','$this->pc01_libaut',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_servico"]) || $this->pc01_servico != "")
           $resac = db_query("insert into db_acount values($acount,855,10556,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc01_servico'))."','$this->pc01_servico',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_veiculo"]) || $this->pc01_veiculo != "")
           $resac = db_query("insert into db_acount values($acount,855,11473,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc01_veiculo'))."','$this->pc01_veiculo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_fraciona"]) || $this->pc01_fraciona != "")
           $resac = db_query("insert into db_acount values($acount,855,11708,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc01_fraciona'))."','$this->pc01_fraciona',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_validademinima"]) || $this->pc01_validademinima != "")
           $resac = db_query("insert into db_acount values($acount,855,11727,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc01_validademinima'))."','$this->pc01_validademinima',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_obrigatorio"]) || $this->pc01_obrigatorio != "")
           $resac = db_query("insert into db_acount values($acount,855,11728,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc01_obrigatorio'))."','$this->pc01_obrigatorio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_liberaresumo"]) || $this->pc01_liberaresumo != "")
           $resac = db_query("insert into db_acount values($acount,855,17390,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc01_liberaresumo'))."','$this->pc01_liberaresumo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc01_codmater=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,855,5491,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc01_codmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,855,5492,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc01_descrmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,855,5493,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc01_complmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,855,5494,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc01_codsubgrupo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,855,6602,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc01_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,855,6761,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc01_conversao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,855,7425,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc01_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,855,8068,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc01_libaut'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,855,10556,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc01_servico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,855,11473,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc01_veiculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,855,11708,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc01_fraciona'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,855,11727,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc01_validademinima'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,855,11728,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc01_obrigatorio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,855,17390,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc01_liberaresumo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
