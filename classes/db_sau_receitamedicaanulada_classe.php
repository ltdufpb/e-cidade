...
class cl_sau_receitamedicaanulada { 
   ...
   public $s161_i_codigo = 0; 
   public $s161_i_receita = 0; 
   public $s161_c_motivo = null; 
   public $s161_i_login = 0; 
   public $s161_d_data_dia = null; 
   public $s161_d_data_mes = null; 
   public $s161_d_data_ano = null; 
   public $s161_d_data = null; 
   public $s161_c_hora = null; 
   ...
   function incluir ($s161_i_codigo){ 
     ...
     if($s161_i_codigo == "" || $s161_i_codigo == null ){
       ...
       $this->s161_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from sau_receitamedicaanulada_s161_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $s161_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3133,17745,'','".AddSlashes(pg_fetch_result($resaco,0,'s161_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3133,17747,'','".AddSlashes(pg_fetch_result($resaco,0,'s161_i_receita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3133,17750,'','".AddSlashes(pg_fetch_result($resaco,0,'s161_c_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3133,17746,'','".AddSlashes(pg_fetch_result($resaco,0,'s161_i_login'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3133,17748,'','".AddSlashes(pg_fetch_result($resaco,0,'s161_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3133,17749,'','".AddSlashes(pg_fetch_result($resaco,0,'s161_c_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($s161_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->s161_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s161_i_codigo"])){ 
       $sql  .= $virgula." s161_i_codigo = $this->s161_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->s161_i_codigo) == null ){ 
     ...
     if(trim((string) $this->s161_i_receita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s161_i_receita"])){ 
       $sql  .= $virgula." s161_i_receita = $this->s161_i_receita ";
       $virgula = ",";
       if(trim((string) $this->s161_i_receita) == null ){ 
         $this->erro_sql = " Campo Receita nao Informado.";
         $this->erro_campo = "s161_i_receita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s161_c_motivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s161_c_motivo"])){ 
       $sql  .= $virgula." s161_c_motivo = '$this->s161_c_motivo' ";
       $virgula = ",";
       if(trim((string) $this->s161_c_motivo) == null ){ 
         $this->erro_sql = " Campo Motivo nao Informado.";
         $this->erro_campo = "s161_c_motivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s161_i_login)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s161_i_login"])){ 
       $sql  .= $virgula." s161_i_login = $this->s161_i_login ";
       $virgula = ",";
       if(trim((string) $this->s161_i_login) == null ){ 
         $this->erro_sql = " Campo Login nao Informado.";
         $this->erro_campo = "s161_i_login";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s161_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s161_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["s161_d_data_dia"] !="") ){ 
       $sql  .= $virgula." s161_d_data = '$this->s161_d_data' ";
       $virgula = ",";
       if(trim((string) $this->s161_d_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "s161_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s161_c_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s161_c_hora"])){ 
       $sql  .= $virgula." s161_c_hora = '$this->s161_c_hora' ";
       $virgula = ",";
       if(trim((string) $this->s161_c_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "s161_c_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s161_i_codigo"]) || $this->s161_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3133,17745,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s161_i_codigo'))."','$this->s161_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s161_i_receita"]) || $this->s161_i_receita != "")
           $resac = db_query("insert into db_acount values($acount,3133,17747,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s161_i_receita'))."','$this->s161_i_receita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s161_c_motivo"]) || $this->s161_c_motivo != "")
           $resac = db_query("insert into db_acount values($acount,3133,17750,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s161_c_motivo'))."','$this->s161_c_motivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s161_i_login"]) || $this->s161_i_login != "")
           $resac = db_query("insert into db_acount values($acount,3133,17746,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s161_i_login'))."','$this->s161_i_login',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s161_d_data"]) || $this->s161_d_data != "")
           $resac = db_query("insert into db_acount values($acount,3133,17748,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s161_d_data'))."','$this->s161_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s161_c_hora"]) || $this->s161_c_hora != "")
           $resac = db_query("insert into db_acount values($acount,3133,17749,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s161_c_hora'))."','$this->s161_c_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($s161_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3133,17745,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s161_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3133,17747,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s161_i_receita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3133,17750,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s161_c_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3133,17746,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s161_i_login'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3133,17748,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s161_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3133,17749,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s161_c_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
