...
class cl_orcimpactomovtiporec { 
   ...
   function incluir ($o67_codseqimpmov){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1099,6691,'','".AddSlashes(pg_fetch_result($resaco,0,'o67_codseqimpmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1099,6692,'','".AddSlashes(pg_fetch_result($resaco,0,'o67_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o67_codseqimpmov=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o67_codseqimpmov)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o67_codseqimpmov"])){ 
       $sql  .= $virgula." o67_codseqimpmov = $this->o67_codseqimpmov ";
       $virgula = ",";
       if(trim((string) $this->o67_codseqimpmov) == null ){ 
     ...
     if(trim((string) $this->o67_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o67_codigo"])){ 
       $sql  .= $virgula." o67_codigo = $this->o67_codigo ";
       $virgula = ",";
       if(trim((string) $this->o67_codigo) == null ){ 
         $this->erro_sql = " Campo Recurso nao Informado.";
         $this->erro_campo = "o67_codigo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o67_codseqimpmov"]))
           $resac = db_query("insert into db_acount values($acount,1099,6691,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o67_codseqimpmov'))."','$this->o67_codseqimpmov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o67_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1099,6692,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o67_codigo'))."','$this->o67_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o67_codseqimpmov=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1099,6691,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o67_codseqimpmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1099,6692,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o67_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
