...
class cl_tarefaexecucao { 
   ...
   public $at09_sequencial = 0; 
   public $at09_tarefa = 0; 
   public $at09_semana = 0; 
   public $at09_situacao = 0; 
   ...
   function incluir ($at09_sequencial){ 
     ...
     if($at09_sequencial == "" || $at09_sequencial == null ){
       ...
       $this->at09_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tarefaexecucao_at09_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at09_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1768,10239,'','".AddSlashes(pg_fetch_result($resaco,0,'at09_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1768,10240,'','".AddSlashes(pg_fetch_result($resaco,0,'at09_tarefa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1768,10241,'','".AddSlashes(pg_fetch_result($resaco,0,'at09_semana'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1768,10242,'','".AddSlashes(pg_fetch_result($resaco,0,'at09_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at09_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at09_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at09_sequencial"])){ 
       $sql  .= $virgula." at09_sequencial = $this->at09_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at09_sequencial) == null ){ 
     ...
     if(trim((string) $this->at09_tarefa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at09_tarefa"])){ 
       $sql  .= $virgula." at09_tarefa = $this->at09_tarefa ";
       $virgula = ",";
       if(trim((string) $this->at09_tarefa) == null ){ 
         $this->erro_sql = " Campo Tarefa nao Informado.";
         $this->erro_campo = "at09_tarefa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at09_semana)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at09_semana"])){ 
       $sql  .= $virgula." at09_semana = $this->at09_semana ";
       $virgula = ",";
       if(trim((string) $this->at09_semana) == null ){ 
         $this->erro_sql = " Campo Semana nao Informado.";
         $this->erro_campo = "at09_semana";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at09_situacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at09_situacao"])){ 
       $sql  .= $virgula." at09_situacao = $this->at09_situacao ";
       $virgula = ",";
       if(trim((string) $this->at09_situacao) == null ){ 
         $this->erro_sql = " Campo Situação nao Informado.";
         $this->erro_campo = "at09_situacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at09_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1768,10239,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at09_sequencial'))."','$this->at09_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at09_tarefa"]))
           $resac = db_query("insert into db_acount values($acount,1768,10240,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at09_tarefa'))."','$this->at09_tarefa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at09_semana"]))
           $resac = db_query("insert into db_acount values($acount,1768,10241,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at09_semana'))."','$this->at09_semana',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at09_situacao"]))
           $resac = db_query("insert into db_acount values($acount,1768,10242,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at09_situacao'))."','$this->at09_situacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at09_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1768,10239,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at09_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1768,10240,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at09_tarefa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1768,10241,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at09_semana'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1768,10242,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at09_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
