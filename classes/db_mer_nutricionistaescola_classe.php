...
class cl_mer_nutricionistaescola { 
   ...
   public $me31_i_codigo = 0; 
   public $me31_i_escola = 0; 
   public $me31_i_nutricionista = 0; 
   public $me31_i_ordem = 0; 
   ...
   function incluir ($me31_i_codigo){ 
     ...
     if($me31_i_codigo == "" || $me31_i_codigo == null ){
       ...
       $this->me31_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mer_nutricionistaescola_me31_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $me31_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2952,16760,'','".AddSlashes(pg_fetch_result($resaco,0,'me31_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2952,16761,'','".AddSlashes(pg_fetch_result($resaco,0,'me31_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2952,16762,'','".AddSlashes(pg_fetch_result($resaco,0,'me31_i_nutricionista'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2952,16767,'','".AddSlashes(pg_fetch_result($resaco,0,'me31_i_ordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me31_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->me31_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me31_i_codigo"])){ 
       $sql  .= $virgula." me31_i_codigo = $this->me31_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->me31_i_codigo) == null ){ 
     ...
     if(trim((string) $this->me31_i_escola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me31_i_escola"])){ 
       $sql  .= $virgula." me31_i_escola = $this->me31_i_escola ";
       $virgula = ",";
       if(trim((string) $this->me31_i_escola) == null ){ 
         $this->erro_sql = " Campo Escola nao Informado.";
         $this->erro_campo = "me31_i_escola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me31_i_nutricionista)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me31_i_nutricionista"])){ 
       $sql  .= $virgula." me31_i_nutricionista = $this->me31_i_nutricionista ";
       $virgula = ",";
       if(trim((string) $this->me31_i_nutricionista) == null ){ 
         $this->erro_sql = " Campo Nutricionista nao Informado.";
         $this->erro_campo = "me31_i_nutricionista";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me31_i_ordem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me31_i_ordem"])){ 
       $sql  .= $virgula." me31_i_ordem = $this->me31_i_ordem ";
       $virgula = ",";
       if(trim((string) $this->me31_i_ordem) == null ){ 
         $this->erro_sql = " Campo Ordem nao Informado.";
         $this->erro_campo = "me31_i_ordem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me31_i_codigo"]) || $this->me31_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2952,16760,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me31_i_codigo'))."','$this->me31_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me31_i_escola"]) || $this->me31_i_escola != "")
           $resac = db_query("insert into db_acount values($acount,2952,16761,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me31_i_escola'))."','$this->me31_i_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me31_i_nutricionista"]) || $this->me31_i_nutricionista != "")
           $resac = db_query("insert into db_acount values($acount,2952,16762,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me31_i_nutricionista'))."','$this->me31_i_nutricionista',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me31_i_ordem"]) || $this->me31_i_ordem != "")
           $resac = db_query("insert into db_acount values($acount,2952,16767,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me31_i_ordem'))."','$this->me31_i_ordem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me31_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2952,16760,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me31_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2952,16761,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me31_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2952,16762,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me31_i_nutricionista'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2952,16767,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me31_i_ordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
