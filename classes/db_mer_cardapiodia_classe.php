...
class cl_mer_cardapiodia { 
   ...
   public $me12_i_codigo        = 0; 
   public $me12_i_cardapio        = 0; 
   public $me12_i_tprefeicao        = 0; 
   public $me12_d_data_dia    = null; 
   public $me12_d_data_mes    = null; 
   public $me12_d_data_ano    = null; 
   public $me12_d_data        = null; 
   ...
   function incluir ($me12_i_codigo){ 
     ...
     if($me12_i_codigo == "" || $me12_i_codigo == null ){
       ...
       $this->me12_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mercardapiodia_me12_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $me12_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2233,12755,'','".AddSlashes(pg_fetch_result($resaco,0,'me12_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2233,12756,'','".AddSlashes(pg_fetch_result($resaco,0,'me12_i_cardapio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2233,13284,'','".AddSlashes(pg_fetch_result($resaco,0,'me12_i_tprefeicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2233,14156,'','".AddSlashes(pg_fetch_result($resaco,0,'me12_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me12_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->me12_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me12_i_codigo"])){ 
       $sql  .= $virgula." me12_i_codigo = $this->me12_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->me12_i_codigo) == null ){ 
     ...
     if(trim((string) $this->me12_i_cardapio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me12_i_cardapio"])){ 
       $sql  .= $virgula." me12_i_cardapio = $this->me12_i_cardapio ";
       $virgula = ",";
       if(trim((string) $this->me12_i_cardapio) == null ){ 
         $this->erro_sql = " Campo Cardápio nao Informado.";
         $this->erro_campo = "me12_i_cardapio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me12_i_tprefeicao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me12_i_tprefeicao"])){ 
       $sql  .= $virgula." me12_i_tprefeicao = $this->me12_i_tprefeicao ";
       $virgula = ",";
       if(trim((string) $this->me12_i_tprefeicao) == null ){ 
         $this->erro_sql = " Campo Tipo Refeição nao Informado.";
         $this->erro_campo = "me12_i_tprefeicao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me12_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me12_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["me12_d_data_dia"] !="") ){ 
       $sql  .= $virgula." me12_d_data = '$this->me12_d_data' ";
       $virgula = ",";
       if(trim((string) $this->me12_d_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "me12_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me12_i_codigo"]) || $this->me12_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2233,12755,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me12_i_codigo'))."','$this->me12_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me12_i_cardapio"]) || $this->me12_i_cardapio != "")
           $resac = db_query("insert into db_acount values($acount,2233,12756,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me12_i_cardapio'))."','$this->me12_i_cardapio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me12_i_tprefeicao"]) || $this->me12_i_tprefeicao != "")
           $resac = db_query("insert into db_acount values($acount,2233,13284,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me12_i_tprefeicao'))."','$this->me12_i_tprefeicao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me12_d_data"]) || $this->me12_d_data != "")
           $resac = db_query("insert into db_acount values($acount,2233,14156,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me12_d_data'))."','$this->me12_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me12_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2233,12755,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me12_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2233,12756,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me12_i_cardapio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2233,13284,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me12_i_tprefeicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2233,14156,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me12_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
