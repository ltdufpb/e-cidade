...
class cl_clientesmodulos { 
   ...
   public $at74_sequencial = 0; 
   public $at74_codcli = 0; 
   public $at74_id_item = 0; 
   public $at74_data_dia = null; 
   public $at74_data_mes = null; 
   public $at74_data_ano = null; 
   public $at74_data = null; 
   public $at74_obs = null; 
   ...
   function incluir ($at74_sequencial){ 
     ...
     if($at74_sequencial == "" || $at74_sequencial == null ){
       ...
       $this->at74_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from clientesmodulos_at74_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $at74_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2099,12100,'','".AddSlashes(pg_fetch_result($resaco,0,'at74_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2099,12101,'','".AddSlashes(pg_fetch_result($resaco,0,'at74_codcli'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2099,12102,'','".AddSlashes(pg_fetch_result($resaco,0,'at74_id_item'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2099,12103,'','".AddSlashes(pg_fetch_result($resaco,0,'at74_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2099,12104,'','".AddSlashes(pg_fetch_result($resaco,0,'at74_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($at74_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->at74_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at74_sequencial"])){ 
       $sql  .= $virgula." at74_sequencial = $this->at74_sequencial ";
       $virgula = ",";
       if(trim((string) $this->at74_sequencial) == null ){ 
     ...
     if(trim((string) $this->at74_codcli)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at74_codcli"])){ 
       $sql  .= $virgula." at74_codcli = $this->at74_codcli ";
       $virgula = ",";
       if(trim((string) $this->at74_codcli) == null ){ 
         $this->erro_sql = " Campo Código do cliente nao Informado.";
         $this->erro_campo = "at74_codcli";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at74_id_item)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at74_id_item"])){ 
       $sql  .= $virgula." at74_id_item = $this->at74_id_item ";
       $virgula = ",";
       if(trim((string) $this->at74_id_item) == null ){ 
         $this->erro_sql = " Campo Código do ítem nao Informado.";
         $this->erro_campo = "at74_id_item";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->at74_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at74_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["at74_data_dia"] !="") ){ 
     ...
     if(trim((string) $this->at74_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at74_obs"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["at74_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2099,12100,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at74_sequencial'))."','$this->at74_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at74_codcli"]))
           $resac = db_query("insert into db_acount values($acount,2099,12101,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at74_codcli'))."','$this->at74_codcli',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at74_id_item"]))
           $resac = db_query("insert into db_acount values($acount,2099,12102,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at74_id_item'))."','$this->at74_id_item',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at74_data"]))
           $resac = db_query("insert into db_acount values($acount,2099,12103,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at74_data'))."','$this->at74_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["at74_obs"]))
           $resac = db_query("insert into db_acount values($acount,2099,12104,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'at74_obs'))."','$this->at74_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($at74_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2099,12100,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at74_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2099,12101,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at74_codcli'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2099,12102,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at74_id_item'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2099,12103,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at74_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2099,12104,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'at74_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
