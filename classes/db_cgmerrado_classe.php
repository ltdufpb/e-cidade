...
class cl_cgmerrado { 
   ...
   function incluir ($z11_codigo,$z11_numcgm){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,737,5158,'','".AddSlashes(pg_fetch_result($resaco,0,'z11_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,737,5159,'','".AddSlashes(pg_fetch_result($resaco,0,'z11_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,737,6099,'','".AddSlashes(pg_fetch_result($resaco,0,'z11_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($z11_codigo=null,$z11_numcgm=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->z11_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["z11_codigo"])){ 
       $sql  .= $virgula." z11_codigo = $this->z11_codigo ";
       $virgula = ",";
       if(trim((string) $this->z11_codigo) == null ){ 
     ...
     if(trim((string) $this->z11_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["z11_numcgm"])){ 
       $sql  .= $virgula." z11_numcgm = $this->z11_numcgm ";
       $virgula = ",";
       if(trim((string) $this->z11_numcgm) == null ){ 
     ...
     if(trim((string) $this->z11_nome)!="" || isset($GLOBALS["HTTP_POST_VARS"]["z11_nome"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["z11_codigo"]))
           $resac = db_query("insert into db_acount values($acount,737,5158,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'z11_codigo'))."','$this->z11_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["z11_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,737,5159,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'z11_numcgm'))."','$this->z11_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["z11_nome"]))
           $resac = db_query("insert into db_acount values($acount,737,6099,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'z11_nome'))."','$this->z11_nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($z11_codigo=null,$z11_numcgm=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,737,5158,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'z11_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,737,5159,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'z11_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,737,6099,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'z11_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
