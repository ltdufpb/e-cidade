...
class cl_processoforocodforoant {
   ...
   public $v85_sequencial = 0;
   public $v85_processoforo = 0;
   public $v85_codforo = null;
   public $v85_data_dia = null;
   public $v85_data_mes = null;
   public $v85_data_ano = null;
   public $v85_data = null;
   ...
   function incluir ($v85_sequencial){
     ...
     if($v85_sequencial == "" || $v85_sequencial == null ){
       ...
       $this->v85_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from processoforocodforoant_v85_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $v85_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3218,18236,'','".AddSlashes(pg_fetch_result($resaco,0,'v85_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3218,18237,'','".AddSlashes(pg_fetch_result($resaco,0,'v85_processoforo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3218,18238,'','".AddSlashes(pg_fetch_result($resaco,0,'v85_codforo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3218,18239,'','".AddSlashes(pg_fetch_result($resaco,0,'v85_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   }
   ...
   function alterar ($v85_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->v85_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v85_sequencial"])){
       $sql  .= $virgula." v85_sequencial = $this->v85_sequencial ";
       $virgula = ",";
       if(trim((string) $this->v85_sequencial) == null ){
     ...
     if(trim((string) $this->v85_processoforo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v85_processoforo"])){
       $sql  .= $virgula." v85_processoforo = $this->v85_processoforo ";
       $virgula = ",";
       if(trim((string) $this->v85_processoforo) == null ){
         $this->erro_sql = " Campo Código Processo do Foro nao Informado.";
         $this->erro_campo = "v85_processoforo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->v85_codforo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v85_codforo"])){
       $sql  .= $virgula." v85_codforo = '$this->v85_codforo' ";
       $virgula = ",";
       if(trim((string) $this->v85_codforo) == null ){
         $this->erro_sql = " Campo Código Anterior nao Informado.";
         $this->erro_campo = "v85_codforo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->v85_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["v85_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["v85_data_dia"] !="") ){
       $sql  .= $virgula." v85_data = '$this->v85_data' ";
       $virgula = ",";
       if(trim((string) $this->v85_data) == null ){
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "v85_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v85_sequencial"]) || $this->v85_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3218,18236,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v85_sequencial'))."','$this->v85_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v85_processoforo"]) || $this->v85_processoforo != "")
           $resac = db_query("insert into db_acount values($acount,3218,18237,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v85_processoforo'))."','$this->v85_processoforo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v85_codforo"]) || $this->v85_codforo != "")
           $resac = db_query("insert into db_acount values($acount,3218,18238,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v85_codforo'))."','$this->v85_codforo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v85_data"]) || $this->v85_data != "")
           $resac = db_query("insert into db_acount values($acount,3218,18239,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'v85_data'))."','$this->v85_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
   ...
   function excluir ($v85_sequencial=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3218,18236,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v85_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3218,18237,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v85_processoforo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3218,18238,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v85_codforo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3218,18239,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'v85_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
