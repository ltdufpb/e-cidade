...
class cl_conlancaminscricaoslip { 
   ...
   public $c109_sequencial = 0; 
   public $c109_codlan = 0; 
   public $c109_inscricaopassiva = 0; 
   public $c109_slip = 0; 
   ...
   function incluir ($c109_sequencial){ 
     ...
     if($c109_sequencial == "" || $c109_sequencial == null ){
       ...
       $this->c109_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from conlancaminscricaoslip_c109_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $c109_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3489,19627,'','".AddSlashes(pg_fetch_result($resaco,0,'c109_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3489,19628,'','".AddSlashes(pg_fetch_result($resaco,0,'c109_codlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3489,19629,'','".AddSlashes(pg_fetch_result($resaco,0,'c109_inscricaopassiva'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3489,19630,'','".AddSlashes(pg_fetch_result($resaco,0,'c109_slip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($c109_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->c109_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c109_sequencial"])){ 
       $sql  .= $virgula." c109_sequencial = $this->c109_sequencial ";
       $virgula = ",";
       if(trim((string) $this->c109_sequencial) == null ){ 
     ...
     if(trim((string) $this->c109_codlan)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c109_codlan"])){ 
       $sql  .= $virgula." c109_codlan = $this->c109_codlan ";
       $virgula = ",";
       if(trim((string) $this->c109_codlan) == null ){ 
         $this->erro_sql = " Campo Código Lançamento nao Informado.";
         $this->erro_campo = "c109_codlan";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c109_inscricaopassiva)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c109_inscricaopassiva"])){ 
       $sql  .= $virgula." c109_inscricaopassiva = $this->c109_inscricaopassiva ";
       $virgula = ",";
       if(trim((string) $this->c109_inscricaopassiva) == null ){ 
         $this->erro_sql = " Campo Inscrição Passiva nao Informado.";
         $this->erro_campo = "c109_inscricaopassiva";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c109_slip)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c109_slip"])){ 
       $sql  .= $virgula." c109_slip = $this->c109_slip ";
       $virgula = ",";
       if(trim((string) $this->c109_slip) == null ){ 
         $this->erro_sql = " Campo Código Slip nao Informado.";
         $this->erro_campo = "c109_slip";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c109_sequencial"]) || $this->c109_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3489,19627,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c109_sequencial'))."','$this->c109_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c109_codlan"]) || $this->c109_codlan != "")
           $resac = db_query("insert into db_acount values($acount,3489,19628,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c109_codlan'))."','$this->c109_codlan',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c109_inscricaopassiva"]) || $this->c109_inscricaopassiva != "")
           $resac = db_query("insert into db_acount values($acount,3489,19629,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c109_inscricaopassiva'))."','$this->c109_inscricaopassiva',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c109_slip"]) || $this->c109_slip != "")
           $resac = db_query("insert into db_acount values($acount,3489,19630,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c109_slip'))."','$this->c109_slip',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($c109_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3489,19627,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c109_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3489,19628,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c109_codlan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3489,19629,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c109_inscricaopassiva'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3489,19630,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c109_slip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
