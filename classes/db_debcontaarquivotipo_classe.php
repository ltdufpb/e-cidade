...
class cl_debcontaarquivotipo { 
   ...
   public $d79_sequencial = 0; 
   public $d79_codigo = 0; 
   public $d79_arretipo = 0; 
   ...
   function incluir ($d79_sequencial){ 
     ...
     if($d79_sequencial == "" || $d79_sequencial == null ){
       ...
       $this->d79_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from debcontaarquivotipo_d79_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $d79_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1667,9686,'','".AddSlashes(pg_fetch_result($resaco,0,'d79_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1667,9687,'','".AddSlashes(pg_fetch_result($resaco,0,'d79_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1667,9688,'','".AddSlashes(pg_fetch_result($resaco,0,'d79_arretipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($d79_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->d79_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d79_sequencial"])){ 
       $sql  .= $virgula." d79_sequencial = $this->d79_sequencial ";
       $virgula = ",";
       if(trim((string) $this->d79_sequencial) == null ){ 
     ...
     if(trim((string) $this->d79_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d79_codigo"])){ 
       $sql  .= $virgula." d79_codigo = $this->d79_codigo ";
       $virgula = ",";
       if(trim((string) $this->d79_codigo) == null ){ 
         $this->erro_sql = " Campo Código Arquivo nao Informado.";
         $this->erro_campo = "d79_codigo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->d79_arretipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d79_arretipo"])){ 
       $sql  .= $virgula." d79_arretipo = $this->d79_arretipo ";
       $virgula = ",";
       if(trim((string) $this->d79_arretipo) == null ){ 
         $this->erro_sql = " Campo Tipo de Débito nao Informado.";
         $this->erro_campo = "d79_arretipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["d79_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1667,9686,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d79_sequencial'))."','$this->d79_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d79_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1667,9687,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d79_codigo'))."','$this->d79_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d79_arretipo"]))
           $resac = db_query("insert into db_acount values($acount,1667,9688,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d79_arretipo'))."','$this->d79_arretipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($d79_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1667,9686,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d79_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1667,9687,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d79_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1667,9688,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d79_arretipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
