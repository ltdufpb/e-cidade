...
class cl_mensagerialicencaprocessado { 
   ...
   public $am15_sequencial = 0; 
   public $am15_mensagerialicencadb_usuarios = 0; 
   public $am15_licencaempreendimento = 0; 
   ...
   function incluir ($am15_sequencial){ 
     ...
     if($am15_sequencial == "" || $am15_sequencial == null ){
       ...
       $this->am15_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mensagerialicencaprocessado_am15_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $am15_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3779,20977,'','".AddSlashes(pg_fetch_result($resaco,0,'am15_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3779,20978,'','".AddSlashes(pg_fetch_result($resaco,0,'am15_mensagerialicencadb_usuarios'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3779,20979,'','".AddSlashes(pg_fetch_result($resaco,0,'am15_licencaempreendimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($am15_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->am15_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["am15_sequencial"])){ 
       $sql  .= $virgula." am15_sequencial = $this->am15_sequencial ";
       $virgula = ",";
       if(trim((string) $this->am15_sequencial) == null ){ 
     ...
     if(trim((string) $this->am15_mensagerialicencadb_usuarios)!="" || isset($GLOBALS["HTTP_POST_VARS"]["am15_mensagerialicencadb_usuarios"])){ 
       $sql  .= $virgula." am15_mensagerialicencadb_usuarios = $this->am15_mensagerialicencadb_usuarios ";
       $virgula = ",";
       if(trim((string) $this->am15_mensagerialicencadb_usuarios) == null ){ 
         $this->erro_sql = " Campo Usuário não informado.";
         $this->erro_campo = "am15_mensagerialicencadb_usuarios";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->am15_licencaempreendimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["am15_licencaempreendimento"])){ 
       $sql  .= $virgula." am15_licencaempreendimento = $this->am15_licencaempreendimento ";
       $virgula = ",";
       if(trim((string) $this->am15_licencaempreendimento) == null ){ 
         $this->erro_sql = " Campo Licença não informado.";
         $this->erro_campo = "am15_licencaempreendimento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["am15_sequencial"]) || $this->am15_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3779,20977,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'am15_sequencial'))."','$this->am15_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["am15_mensagerialicencadb_usuarios"]) || $this->am15_mensagerialicencadb_usuarios != "")
             $resac = db_query("insert into db_acount values($acount,3779,20978,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'am15_mensagerialicencadb_usuarios'))."','$this->am15_mensagerialicencadb_usuarios',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["am15_licencaempreendimento"]) || $this->am15_licencaempreendimento != "")
             $resac = db_query("insert into db_acount values($acount,3779,20979,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'am15_licencaempreendimento'))."','$this->am15_licencaempreendimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3779,20977,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'am15_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3779,20978,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'am15_mensagerialicencadb_usuarios'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3779,20979,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'am15_licencaempreendimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
