...
class cl_issplanitop { 
   ...
   public $q96_sequencial = 0; 
   public $q96_issplanit = 0; 
   public $q96_pagordem = 0; 
   ...
   function incluir ($q96_sequencial){ 
     ...
     if($q96_sequencial == "" || $q96_sequencial == null ){
       ...
       $this->q96_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from issplanitop_q96_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q96_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1892,10970,'','".AddSlashes(pg_fetch_result($resaco,0,'q96_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1892,10971,'','".AddSlashes(pg_fetch_result($resaco,0,'q96_issplanit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1892,10972,'','".AddSlashes(pg_fetch_result($resaco,0,'q96_pagordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q96_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->q96_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q96_sequencial"])){ 
       $sql  .= $virgula." q96_sequencial = $this->q96_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q96_sequencial) == null ){ 
     ...
     if(trim((string) $this->q96_issplanit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q96_issplanit"])){ 
       $sql  .= $virgula." q96_issplanit = $this->q96_issplanit ";
       $virgula = ",";
       if(trim((string) $this->q96_issplanit) == null ){ 
         $this->erro_sql = " Campo Codigo da issplanit nao Informado.";
         $this->erro_campo = "q96_issplanit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q96_pagordem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q96_pagordem"])){ 
       $sql  .= $virgula." q96_pagordem = $this->q96_pagordem ";
       $virgula = ",";
       if(trim((string) $this->q96_pagordem) == null ){ 
         $this->erro_sql = " Campo Codigo da ordem nao Informado.";
         $this->erro_campo = "q96_pagordem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q96_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1892,10970,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q96_sequencial'))."','$this->q96_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q96_issplanit"]))
           $resac = db_query("insert into db_acount values($acount,1892,10971,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q96_issplanit'))."','$this->q96_issplanit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q96_pagordem"]))
           $resac = db_query("insert into db_acount values($acount,1892,10972,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q96_pagordem'))."','$this->q96_pagordem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q96_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1892,10970,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q96_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1892,10971,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q96_issplanit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1892,10972,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q96_pagordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
