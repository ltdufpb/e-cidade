...
class cl_empempenhonl { 
   ...
   public $e68_sequencial = 0; 
   public $e68_numemp = 0; 
   public $e68_data_dia = null; 
   public $e68_data_mes = null; 
   public $e68_data_ano = null; 
   public $e68_data = null; 
   ...
   function incluir ($e68_sequencial){ 
     ...
     if($e68_sequencial == "" || $e68_sequencial == null ){
       ...
       $this->e68_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from empempenhonl_e68_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $e68_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2016,11705,'','".AddSlashes(pg_fetch_result($resaco,0,'e68_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2016,11706,'','".AddSlashes(pg_fetch_result($resaco,0,'e68_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2016,11707,'','".AddSlashes(pg_fetch_result($resaco,0,'e68_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e68_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e68_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e68_sequencial"])){ 
       $sql  .= $virgula." e68_sequencial = $this->e68_sequencial ";
       $virgula = ",";
       if(trim((string) $this->e68_sequencial) == null ){ 
     ...
     if(trim((string) $this->e68_numemp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e68_numemp"])){ 
       $sql  .= $virgula." e68_numemp = $this->e68_numemp ";
       $virgula = ",";
       if(trim((string) $this->e68_numemp) == null ){ 
         $this->erro_sql = " Campo Número do Empenho nao Informado.";
         $this->erro_campo = "e68_numemp";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e68_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e68_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["e68_data_dia"] !="") ){ 
       $sql  .= $virgula." e68_data = '$this->e68_data' ";
       $virgula = ",";
       if(trim((string) $this->e68_data) == null ){ 
         $this->erro_sql = " Campo Data da Inclusão nao Informado.";
         $this->erro_campo = "e68_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e68_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2016,11705,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e68_sequencial'))."','$this->e68_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e68_numemp"]))
           $resac = db_query("insert into db_acount values($acount,2016,11706,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e68_numemp'))."','$this->e68_numemp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e68_data"]))
           $resac = db_query("insert into db_acount values($acount,2016,11707,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e68_data'))."','$this->e68_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e68_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2016,11705,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e68_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2016,11706,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e68_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2016,11707,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e68_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
