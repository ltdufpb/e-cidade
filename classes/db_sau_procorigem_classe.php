...
class cl_sau_procorigem { 
   ...
   public $sd95_i_codigo = 0; 
   public $sd95_i_procedimento = 0; 
   public $sd95_i_origem = 0; 
   public $sd95_i_anocomp = 0; 
   public $sd95_i_mescomp = 0; 
   ...
   function incluir ($sd95_i_codigo){ 
     ...
     if($sd95_i_codigo == "" || $sd95_i_codigo == null ){
       ...
       $this->sd95_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from sau_procorigem_sd95_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $sd95_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2001,11599,'','".AddSlashes(pg_fetch_result($resaco,0,'sd95_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2001,11600,'','".AddSlashes(pg_fetch_result($resaco,0,'sd95_i_procedimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2001,11601,'','".AddSlashes(pg_fetch_result($resaco,0,'sd95_i_origem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2001,11602,'','".AddSlashes(pg_fetch_result($resaco,0,'sd95_i_anocomp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2001,11603,'','".AddSlashes(pg_fetch_result($resaco,0,'sd95_i_mescomp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($sd95_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->sd95_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd95_i_codigo"])){ 
       $sql  .= $virgula." sd95_i_codigo = $this->sd95_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->sd95_i_codigo) == null ){ 
     ...
     if(trim((string) $this->sd95_i_procedimento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd95_i_procedimento"])){ 
       $sql  .= $virgula." sd95_i_procedimento = $this->sd95_i_procedimento ";
       $virgula = ",";
       if(trim((string) $this->sd95_i_procedimento) == null ){ 
         $this->erro_sql = " Campo Procedimento nao Informado.";
         $this->erro_campo = "sd95_i_procedimento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd95_i_origem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd95_i_origem"])){ 
       $sql  .= $virgula." sd95_i_origem = $this->sd95_i_origem ";
       $virgula = ",";
       if(trim((string) $this->sd95_i_origem) == null ){ 
         $this->erro_sql = " Campo Procedimento de Origem nao Informado.";
         $this->erro_campo = "sd95_i_origem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd95_i_anocomp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd95_i_anocomp"])){ 
       $sql  .= $virgula." sd95_i_anocomp = $this->sd95_i_anocomp ";
       $virgula = ",";
       if(trim((string) $this->sd95_i_anocomp) == null ){ 
         $this->erro_sql = " Campo Ano nao Informado.";
         $this->erro_campo = "sd95_i_anocomp";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->sd95_i_mescomp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd95_i_mescomp"])){ 
       $sql  .= $virgula." sd95_i_mescomp = $this->sd95_i_mescomp ";
       $virgula = ",";
       if(trim((string) $this->sd95_i_mescomp) == null ){ 
         $this->erro_sql = " Campo Mes nao Informado.";
         $this->erro_campo = "sd95_i_mescomp";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd95_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2001,11599,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd95_i_codigo'))."','$this->sd95_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd95_i_procedimento"]))
           $resac = db_query("insert into db_acount values($acount,2001,11600,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd95_i_procedimento'))."','$this->sd95_i_procedimento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd95_i_origem"]))
           $resac = db_query("insert into db_acount values($acount,2001,11601,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd95_i_origem'))."','$this->sd95_i_origem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd95_i_anocomp"]))
           $resac = db_query("insert into db_acount values($acount,2001,11602,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd95_i_anocomp'))."','$this->sd95_i_anocomp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["sd95_i_mescomp"]))
           $resac = db_query("insert into db_acount values($acount,2001,11603,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'sd95_i_mescomp'))."','$this->sd95_i_mescomp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($sd95_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2001,11599,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd95_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2001,11600,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd95_i_procedimento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2001,11601,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd95_i_origem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2001,11602,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd95_i_anocomp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2001,11603,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'sd95_i_mescomp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
