...
class cl_veiccadcentraldepart { 
   ...
   public $ve37_sequencial = 0; 
   public $ve37_veiccadcentral = 0; 
   public $ve37_coddepto = 0; 
   ...
   function incluir ($ve37_sequencial){ 
     ...
     if($ve37_sequencial == "" || $ve37_sequencial == null ){
       ...
       $this->ve37_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from veiccadcentraldepart_ve37_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ve37_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1938,11273,'','".AddSlashes(pg_fetch_result($resaco,0,'ve37_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1938,11274,'','".AddSlashes(pg_fetch_result($resaco,0,'ve37_veiccadcentral'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1938,11275,'','".AddSlashes(pg_fetch_result($resaco,0,'ve37_coddepto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ve37_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ve37_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve37_sequencial"])){ 
       $sql  .= $virgula." ve37_sequencial = $this->ve37_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ve37_sequencial) == null ){ 
     ...
     if(trim((string) $this->ve37_veiccadcentral)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve37_veiccadcentral"])){ 
       $sql  .= $virgula." ve37_veiccadcentral = $this->ve37_veiccadcentral ";
       $virgula = ",";
       if(trim((string) $this->ve37_veiccadcentral) == null ){ 
         $this->erro_sql = " Campo Central nao Informado.";
         $this->erro_campo = "ve37_veiccadcentral";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ve37_coddepto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve37_coddepto"])){ 
       $sql  .= $virgula." ve37_coddepto = $this->ve37_coddepto ";
       $virgula = ",";
       if(trim((string) $this->ve37_coddepto) == null ){ 
         $this->erro_sql = " Campo Depto. nao Informado.";
         $this->erro_campo = "ve37_coddepto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve37_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1938,11273,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve37_sequencial'))."','$this->ve37_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve37_veiccadcentral"]))
           $resac = db_query("insert into db_acount values($acount,1938,11274,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve37_veiccadcentral'))."','$this->ve37_veiccadcentral',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve37_coddepto"]))
           $resac = db_query("insert into db_acount values($acount,1938,11275,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ve37_coddepto'))."','$this->ve37_coddepto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ve37_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1938,11273,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve37_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1938,11274,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve37_veiccadcentral'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1938,11275,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ve37_coddepto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
