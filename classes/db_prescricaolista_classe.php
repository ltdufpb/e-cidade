...
class cl_prescricaolista { 
   ...
   public $k122_sequencial = 0; 
   public $k122_lista = 0; 
   public $k122_prescricao = 0; 
   ...
   function incluir ($k122_sequencial){ 
     ...
     if($k122_sequencial == "" || $k122_sequencial == null ){
       ...
       $this->k122_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from prescricaolista_k122_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k122_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3112,17621,'','".AddSlashes(pg_fetch_result($resaco,0,'k122_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3112,17622,'','".AddSlashes(pg_fetch_result($resaco,0,'k122_lista'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3112,17623,'','".AddSlashes(pg_fetch_result($resaco,0,'k122_prescricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k122_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k122_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k122_sequencial"])){ 
       $sql  .= $virgula." k122_sequencial = $this->k122_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k122_sequencial) == null ){ 
     ...
     if(trim((string) $this->k122_lista)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k122_lista"])){ 
       $sql  .= $virgula." k122_lista = $this->k122_lista ";
       $virgula = ",";
       if(trim((string) $this->k122_lista) == null ){ 
         $this->erro_sql = " Campo Lista de Prescrição nao Informado.";
         $this->erro_campo = "k122_lista";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k122_prescricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k122_prescricao"])){ 
       $sql  .= $virgula." k122_prescricao = $this->k122_prescricao ";
       $virgula = ",";
       if(trim((string) $this->k122_prescricao) == null ){ 
         $this->erro_sql = " Campo Prescrição nao Informado.";
         $this->erro_campo = "k122_prescricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k122_sequencial"]) || $this->k122_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3112,17621,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k122_sequencial'))."','$this->k122_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k122_lista"]) || $this->k122_lista != "")
           $resac = db_query("insert into db_acount values($acount,3112,17622,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k122_lista'))."','$this->k122_lista',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k122_prescricao"]) || $this->k122_prescricao != "")
           $resac = db_query("insert into db_acount values($acount,3112,17623,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k122_prescricao'))."','$this->k122_prescricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k122_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3112,17621,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k122_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3112,17622,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k122_lista'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3112,17623,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k122_prescricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
