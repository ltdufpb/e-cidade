...
class cl_procfiscalnotificacao { 
   ...
   function incluir ($y110_sequencial){ 
     ...
     if($y110_sequencial == "" || $y110_sequencial == null ){
       ...
       $this->y110_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from procfiscalnotificacao_y110_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $y110_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2083,12032,'','".AddSlashes(pg_fetch_result($resaco,0,'y110_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2083,12033,'','".AddSlashes(pg_fetch_result($resaco,0,'y110_notificacaofiscal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2083,12034,'','".AddSlashes(pg_fetch_result($resaco,0,'y110_procfiscal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y110_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y110_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y110_sequencial"])){ 
       $sql  .= $virgula." y110_sequencial = $this->y110_sequencial ";
       $virgula = ",";
       if(trim((string) $this->y110_sequencial) == null ){ 
     ...
     if(trim((string) $this->y110_notificacaofiscal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y110_notificacaofiscal"])){ 
       $sql  .= $virgula." y110_notificacaofiscal = $this->y110_notificacaofiscal ";
       $virgula = ",";
       if(trim((string) $this->y110_notificacaofiscal) == null ){ 
         $this->erro_sql = " Campo Notificação nao Informado.";
         $this->erro_campo = "y110_notificacaofiscal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y110_procfiscal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y110_procfiscal"])){ 
       $sql  .= $virgula." y110_procfiscal = $this->y110_procfiscal ";
       $virgula = ",";
       if(trim((string) $this->y110_procfiscal) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
         $this->erro_campo = "y110_procfiscal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y110_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2083,12032,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y110_sequencial'))."','$this->y110_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y110_notificacaofiscal"]))
           $resac = db_query("insert into db_acount values($acount,2083,12033,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y110_notificacaofiscal'))."','$this->y110_notificacaofiscal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y110_procfiscal"]))
           $resac = db_query("insert into db_acount values($acount,2083,12034,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y110_procfiscal'))."','$this->y110_procfiscal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y110_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2083,12032,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y110_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2083,12033,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y110_notificacaofiscal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2083,12034,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y110_procfiscal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
