...
class cl_cidadaotiporetorno { 
   ...
   public $ov04_sequencial = 0; 
   public $ov04_seq = 0; 
   public $ov04_tiporetorno = 0; 
   public $ov04_cidadao = 0; 
   ...
   function incluir ($ov04_sequencial){ 
     ...
     if($ov04_sequencial == "" || $ov04_sequencial == null ){
       ...
       $this->ov04_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from cidadaotiporetorno_ov04_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ov04_sequencial)){
     ...
     if (!isset($_SESSION["DB_usaAccount"])) {
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,2597,14761,'','".AddSlashes(pg_fetch_result($resaco,0,'ov04_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2597,14762,'','".AddSlashes(pg_fetch_result($resaco,0,'ov04_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2597,14763,'','".AddSlashes(pg_fetch_result($resaco,0,'ov04_tiporetorno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2597,14764,'','".AddSlashes(pg_fetch_result($resaco,0,'ov04_cidadao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($ov04_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ov04_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov04_sequencial"])){ 
       $sql  .= $virgula." ov04_sequencial = $this->ov04_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ov04_sequencial) == null ){ 
     ...
     if(trim((string) $this->ov04_seq)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov04_seq"])){ 
       $sql  .= $virgula." ov04_seq = $this->ov04_seq ";
       $virgula = ",";
       if(trim((string) $this->ov04_seq) == null ){ 
         $this->erro_sql = " Campo Sequencial nao Informado.";
     ...
     if(trim((string) $this->ov04_tiporetorno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov04_tiporetorno"])){ 
       $sql  .= $virgula." ov04_tiporetorno = $this->ov04_tiporetorno ";
       $virgula = ",";
       if(trim((string) $this->ov04_tiporetorno) == null ){ 
         $this->erro_sql = " Campo Tipo Retorno nao Informado.";
         $this->erro_campo = "ov04_tiporetorno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ov04_cidadao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov04_cidadao"])){ 
       $sql  .= $virgula." ov04_cidadao = $this->ov04_cidadao ";
       $virgula = ",";
       if(trim((string) $this->ov04_cidadao) == null ){ 
         $this->erro_sql = " Campo Cidadão nao Informado.";
         $this->erro_campo = "ov04_cidadao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["ov04_sequencial"]) || $this->ov04_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,2597,14761,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov04_sequencial'))."','$this->ov04_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ov04_seq"]) || $this->ov04_seq != "")
             $resac = db_query("insert into db_acount values($acount,2597,14762,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov04_seq'))."','$this->ov04_seq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ov04_tiporetorno"]) || $this->ov04_tiporetorno != "")
             $resac = db_query("insert into db_acount values($acount,2597,14763,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov04_tiporetorno'))."','$this->ov04_tiporetorno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["ov04_cidadao"]) || $this->ov04_cidadao != "")
             $resac = db_query("insert into db_acount values($acount,2597,14764,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov04_cidadao'))."','$this->ov04_cidadao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($_SESSION["DB_usaAccount"])) {
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
           ...
           $resac = db_query("insert into db_acount values($acount,2597,14761,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov04_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,2597,14762,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov04_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,2597,14763,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov04_tiporetorno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac = db_query("insert into db_acount values($acount,2597,14764,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov04_cidadao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
