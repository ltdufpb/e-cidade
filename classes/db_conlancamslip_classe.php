...
class cl_conlancamslip { 
   ...
   function incluir ($c84_conlancam){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3413,19224,'','".AddSlashes(pg_fetch_result($resaco,0,'c84_conlancam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3413,19225,'','".AddSlashes(pg_fetch_result($resaco,0,'c84_slip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($c84_conlancam=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->c84_conlancam)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c84_conlancam"])){ 
       $sql  .= $virgula." c84_conlancam = $this->c84_conlancam ";
       $virgula = ",";
       if(trim((string) $this->c84_conlancam) == null ){ 
     ...
     if(trim((string) $this->c84_slip)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c84_slip"])){ 
       $sql  .= $virgula." c84_slip = $this->c84_slip ";
       $virgula = ",";
       if(trim((string) $this->c84_slip) == null ){ 
         $this->erro_sql = " Campo Código Slip nao Informado.";
         $this->erro_campo = "c84_slip";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c84_conlancam"]) || $this->c84_conlancam != "")
           $resac = db_query("insert into db_acount values($acount,3413,19224,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c84_conlancam'))."','$this->c84_conlancam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c84_slip"]) || $this->c84_slip != "")
           $resac = db_query("insert into db_acount values($acount,3413,19225,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c84_slip'))."','$this->c84_slip',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($c84_conlancam=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3413,19224,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c84_conlancam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3413,19225,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c84_slip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
