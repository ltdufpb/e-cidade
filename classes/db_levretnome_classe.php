...
class cl_levretnome { 
   ...
   function incluir ($y65_sequencia){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,715,5040,'','".AddSlashes(pg_fetch_result($resaco,0,'y65_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,715,5041,'','".AddSlashes(pg_fetch_result($resaco,0,'y65_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,715,5042,'','".AddSlashes(pg_fetch_result($resaco,0,'y65_cnpj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y65_sequencia=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y65_sequencia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y65_sequencia"])){ 
       $sql  .= $virgula." y65_sequencia = $this->y65_sequencia ";
       $virgula = ",";
       if(trim((string) $this->y65_sequencia) == null ){ 
     ...
     if(trim((string) $this->y65_nome)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y65_nome"])){ 
       $sql  .= $virgula." y65_nome = '$this->y65_nome' ";
       $virgula = ",";
       if(trim((string) $this->y65_nome) == null ){ 
         $this->erro_sql = " Campo Nome nao Informado.";
         $this->erro_campo = "y65_nome";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->y65_cnpj)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y65_cnpj"])){ 
       $sql  .= $virgula." y65_cnpj = '$this->y65_cnpj' ";
       $virgula = ",";
       if(trim((string) $this->y65_cnpj) == null ){ 
         $this->erro_sql = " Campo CNPJ nao Informado.";
         $this->erro_campo = "y65_cnpj";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y65_sequencia"]))
           $resac = db_query("insert into db_acount values($acount,715,5040,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y65_sequencia'))."','$this->y65_sequencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y65_nome"]))
           $resac = db_query("insert into db_acount values($acount,715,5041,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y65_nome'))."','$this->y65_nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y65_cnpj"]))
           $resac = db_query("insert into db_acount values($acount,715,5042,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y65_cnpj'))."','$this->y65_cnpj',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y65_sequencia=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,715,5040,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y65_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,715,5041,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y65_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,715,5042,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y65_cnpj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
