...
class cl_naturezatipoassentamento { 
   ...
   public $rh159_sequencial = 0; 
   public $rh159_descricao = null; 
   ...
   function incluir ($rh159_sequencial){ 
     ...
     if($rh159_sequencial == "" || $rh159_sequencial == null ){
       ...
       $this->rh159_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from naturezatipoassentamento_rh159_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh159_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3810,21160,'','".AddSlashes(pg_fetch_result($resaco,0,'rh159_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3810,21161,'','".AddSlashes(pg_fetch_result($resaco,0,'rh159_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($rh159_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh159_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh159_sequencial"])){ 
       $sql  .= $virgula." rh159_sequencial = $this->rh159_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh159_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh159_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh159_descricao"])){ 
       $sql  .= $virgula." rh159_descricao = '$this->rh159_descricao' ";
       $virgula = ",";
       if(trim((string) $this->rh159_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição não informado.";
         $this->erro_campo = "rh159_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["rh159_sequencial"]) || $this->rh159_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3810,21160,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh159_sequencial'))."','$this->rh159_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["rh159_descricao"]) || $this->rh159_descricao != "")
             $resac = db_query("insert into db_acount values($acount,3810,21161,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh159_descricao'))."','$this->rh159_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3810,21160,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh159_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3810,21161,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh159_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
