...
class cl_averbacgmold { 
   ...
   function incluir ($j79_codigo){ 
     ...
     if($j79_codigo == "" || $j79_codigo == null ){
       ...
       $this->j79_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from averbacgmold_j79_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $j79_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1650,9595,'','".AddSlashes(pg_fetch_result($resaco,0,'j79_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1650,9596,'','".AddSlashes(pg_fetch_result($resaco,0,'j79_averbacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1650,9597,'','".AddSlashes(pg_fetch_result($resaco,0,'j79_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1650,9598,'','".AddSlashes(pg_fetch_result($resaco,0,'j79_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1650,9599,'','".AddSlashes(pg_fetch_result($resaco,0,'j79_principal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j79_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j79_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j79_codigo"])){ 
       $sql  .= $virgula." j79_codigo = $this->j79_codigo ";
       $virgula = ",";
       if(trim((string) $this->j79_codigo) == null ){ 
     ...
     if(trim((string) $this->j79_averbacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j79_averbacao"])){ 
       $sql  .= $virgula." j79_averbacao = $this->j79_averbacao ";
       $virgula = ",";
       if(trim((string) $this->j79_averbacao) == null ){ 
         $this->erro_sql = " Campo Código Averbação nao Informado.";
         $this->erro_campo = "j79_averbacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j79_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j79_numcgm"])){ 
       $sql  .= $virgula." j79_numcgm = $this->j79_numcgm ";
       $virgula = ",";
       if(trim((string) $this->j79_numcgm) == null ){ 
         $this->erro_sql = " Campo Numcgm nao Informado.";
         $this->erro_campo = "j79_numcgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j79_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j79_tipo"])){ 
       $sql  .= $virgula." j79_tipo = $this->j79_tipo ";
       $virgula = ",";
       if(trim((string) $this->j79_tipo) == null ){ 
         $this->erro_sql = " Campo Tipo nao Informado.";
         $this->erro_campo = "j79_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j79_principal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j79_principal"])){ 
       $sql  .= $virgula." j79_principal = '$this->j79_principal' ";
       $virgula = ",";
       if(trim((string) $this->j79_principal) == null ){ 
         $this->erro_sql = " Campo Principal nao Informado.";
         $this->erro_campo = "j79_principal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j79_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1650,9595,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j79_codigo'))."','$this->j79_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j79_averbacao"]))
           $resac = db_query("insert into db_acount values($acount,1650,9596,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j79_averbacao'))."','$this->j79_averbacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j79_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,1650,9597,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j79_numcgm'))."','$this->j79_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j79_tipo"]))
           $resac = db_query("insert into db_acount values($acount,1650,9598,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j79_tipo'))."','$this->j79_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j79_principal"]))
           $resac = db_query("insert into db_acount values($acount,1650,9599,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j79_principal'))."','$this->j79_principal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j79_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1650,9595,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j79_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1650,9596,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j79_averbacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1650,9597,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j79_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1650,9598,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j79_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1650,9599,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j79_principal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
