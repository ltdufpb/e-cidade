...
class cl_orcsuplemrec { 
   ...
   function incluir ($o85_codsup,$o85_codrec){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,978,6087,'','".AddSlashes(pg_fetch_result($resaco,0,'o85_codsup'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,978,6088,'','".AddSlashes(pg_fetch_result($resaco,0,'o85_codrec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,978,6089,'','".AddSlashes(pg_fetch_result($resaco,0,'o85_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,978,6090,'','".AddSlashes(pg_fetch_result($resaco,0,'o85_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o85_codsup=null,$o85_codrec=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o85_codsup)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o85_codsup"])){ 
       $sql  .= $virgula." o85_codsup = $this->o85_codsup ";
       $virgula = ",";
       if(trim((string) $this->o85_codsup) == null ){ 
     ...
     if(trim((string) $this->o85_codrec)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o85_codrec"])){ 
       $sql  .= $virgula." o85_codrec = $this->o85_codrec ";
       $virgula = ",";
       if(trim((string) $this->o85_codrec) == null ){ 
     ...
     if(trim((string) $this->o85_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o85_anousu"])){ 
       $sql  .= $virgula." o85_anousu = $this->o85_anousu ";
       $virgula = ",";
       if(trim((string) $this->o85_anousu) == null ){ 
         $this->erro_sql = " Campo ano de execício nao Informado.";
         $this->erro_campo = "o85_anousu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o85_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o85_valor"])){ 
       $sql  .= $virgula." o85_valor = $this->o85_valor ";
       $virgula = ",";
       if(trim((string) $this->o85_valor) == null ){ 
         $this->erro_sql = " Campo valor nao Informado.";
         $this->erro_campo = "o85_valor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o85_codsup"]))
           $resac = db_query("insert into db_acount values($acount,978,6087,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o85_codsup'))."','$this->o85_codsup',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o85_codrec"]))
           $resac = db_query("insert into db_acount values($acount,978,6088,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o85_codrec'))."','$this->o85_codrec',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o85_anousu"]))
           $resac = db_query("insert into db_acount values($acount,978,6089,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o85_anousu'))."','$this->o85_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o85_valor"]))
           $resac = db_query("insert into db_acount values($acount,978,6090,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o85_valor'))."','$this->o85_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o85_codsup=null,$o85_codrec=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,978,6087,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o85_codsup'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,978,6088,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o85_codrec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,978,6089,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o85_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,978,6090,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o85_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
