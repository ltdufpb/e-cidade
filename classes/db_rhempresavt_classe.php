...
class cl_rhempresavt { 
   ...
   public $rh35_instit = 0; 
   public $rh35_codigo = 0; 
   public $rh35_descr = null; 
   ...
   function incluir ($rh35_codigo,$rh35_instit){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1232,9905,'','".AddSlashes(pg_fetch_result($resaco,0,'rh35_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1232,7401,'','".AddSlashes(pg_fetch_result($resaco,0,'rh35_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1232,7402,'','".AddSlashes(pg_fetch_result($resaco,0,'rh35_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh35_codigo=null,$rh35_instit=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh35_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh35_instit"])){ 
       $sql  .= $virgula." rh35_instit = $this->rh35_instit ";
       $virgula = ",";
       if(trim((string) $this->rh35_instit) == null ){ 
     ...
     if(trim((string) $this->rh35_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh35_codigo"])){ 
       $sql  .= $virgula." rh35_codigo = $this->rh35_codigo ";
       $virgula = ",";
       if(trim((string) $this->rh35_codigo) == null ){ 
     ...
     if(trim((string) $this->rh35_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh35_descr"])){ 
       $sql  .= $virgula." rh35_descr = '$this->rh35_descr' ";
       $virgula = ",";
       if(trim((string) $this->rh35_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "rh35_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh35_instit"]))
           $resac = db_query("insert into db_acount values($acount,1232,9905,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh35_instit'))."','$this->rh35_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh35_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1232,7401,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh35_codigo'))."','$this->rh35_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh35_descr"]))
           $resac = db_query("insert into db_acount values($acount,1232,7402,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh35_descr'))."','$this->rh35_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh35_codigo=null,$rh35_instit=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1232,9905,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh35_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1232,7401,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh35_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1232,7402,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh35_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
