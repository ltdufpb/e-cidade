...
class cl_extratosaldo { 
   ...
   public $k97_sequencial = 0; 
   public $k97_dtsaldofinal_dia = null; 
   public $k97_dtsaldofinal_mes = null; 
   public $k97_dtsaldofinal_ano = null; 
   public $k97_dtsaldofinal = null; 
   public $k97_contabancaria = 0; 
   public $k97_extrato = 0; 
   public $k97_valorcredito = 0; 
   public $k97_valordebito = 0; 
   public $k97_qtdregistros = 0; 
   public $k97_posicao = null; 
   public $k97_situacao = null; 
   public $k97_saldobloqueado = 0; 
   public $k97_saldofinal = 0; 
   public $k97_limite = 0; 
   ...
   function incluir ($k97_sequencial){ 
     ...
     if($k97_sequencial == "" || $k97_sequencial == null ){
       ...
       $this->k97_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from extratosaldo_k97_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k97_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1749,10156,'','".AddSlashes(pg_fetch_result($resaco,0,'k97_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1749,10161,'','".AddSlashes(pg_fetch_result($resaco,0,'k97_dtsaldofinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1749,15640,'','".AddSlashes(pg_fetch_result($resaco,0,'k97_contabancaria'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1749,10158,'','".AddSlashes(pg_fetch_result($resaco,0,'k97_extrato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1749,10167,'','".AddSlashes(pg_fetch_result($resaco,0,'k97_valorcredito'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1749,10166,'','".AddSlashes(pg_fetch_result($resaco,0,'k97_valordebito'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1749,10165,'','".AddSlashes(pg_fetch_result($resaco,0,'k97_qtdregistros'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1749,10164,'','".AddSlashes(pg_fetch_result($resaco,0,'k97_posicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1749,10163,'','".AddSlashes(pg_fetch_result($resaco,0,'k97_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1749,10160,'','".AddSlashes(pg_fetch_result($resaco,0,'k97_saldobloqueado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1749,10162,'','".AddSlashes(pg_fetch_result($resaco,0,'k97_saldofinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1749,10159,'','".AddSlashes(pg_fetch_result($resaco,0,'k97_limite'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k97_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k97_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k97_sequencial"])){ 
       $sql  .= $virgula." k97_sequencial = $this->k97_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k97_sequencial) == null ){ 
         $this->erro_sql = " Campo Codigo sequencial nao Informado.";
     ...
     if(trim((string) $this->k97_dtsaldofinal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k97_dtsaldofinal_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["k97_dtsaldofinal_dia"] !="") ){ 
       $sql  .= $virgula." k97_dtsaldofinal = '$this->k97_dtsaldofinal' ";
       $virgula = ",";
       if(trim((string) $this->k97_dtsaldofinal) == null ){ 
         $this->erro_sql = " Campo Data do saldo final nao Informado.";
         $this->erro_campo = "k97_dtsaldofinal_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k97_contabancaria)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k97_contabancaria"])){ 
       $sql  .= $virgula." k97_contabancaria = $this->k97_contabancaria ";
       $virgula = ",";
       if(trim((string) $this->k97_contabancaria) == null ){ 
         $this->erro_sql = " Campo Codigo sequencial da conta bancaria nao Informado.";
         $this->erro_campo = "k97_contabancaria";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k97_extrato)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k97_extrato"])){ 
       $sql  .= $virgula." k97_extrato = $this->k97_extrato ";
       $virgula = ",";
       if(trim((string) $this->k97_extrato) == null ){ 
         $this->erro_sql = " Campo Codigo sequencial nao Informado.";
         $this->erro_campo = "k97_extrato";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k97_valorcredito)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k97_valorcredito"])){ 
        if(trim((string) $this->k97_valorcredito)=="" && isset($GLOBALS["HTTP_POST_VARS"]["k97_valorcredito"])){ 
           $this->k97_valorcredito = "0" ; 
        } 
     ...
     if(trim((string) $this->k97_valordebito)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k97_valordebito"])){ 
        if(trim((string) $this->k97_valordebito)=="" && isset($GLOBALS["HTTP_POST_VARS"]["k97_valordebito"])){ 
           $this->k97_valordebito = "0" ; 
        } 
     ...
     if(trim((string) $this->k97_qtdregistros)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k97_qtdregistros"])){ 
       $sql  .= $virgula." k97_qtdregistros = $this->k97_qtdregistros ";
       $virgula = ",";
       if(trim((string) $this->k97_qtdregistros) == null ){ 
         $this->erro_sql = " Campo Quantidade de registros nao Informado.";
         $this->erro_campo = "k97_qtdregistros";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k97_posicao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k97_posicao"])){ 
       $sql  .= $virgula." k97_posicao = '$this->k97_posicao' ";
       $virgula = ",";
       if(trim((string) $this->k97_posicao) == null ){ 
         $this->erro_sql = " Campo Posicao nao Informado.";
         $this->erro_campo = "k97_posicao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k97_situacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k97_situacao"])){ 
       $sql  .= $virgula." k97_situacao = '$this->k97_situacao' ";
       $virgula = ",";
       if(trim((string) $this->k97_situacao) == null ){ 
         $this->erro_sql = " Campo Situacao nao Informado.";
         $this->erro_campo = "k97_situacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k97_saldobloqueado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k97_saldobloqueado"])){ 
        if(trim((string) $this->k97_saldobloqueado)=="" && isset($GLOBALS["HTTP_POST_VARS"]["k97_saldobloqueado"])){ 
           $this->k97_saldobloqueado = "0" ; 
        } 
     ...
     if(trim((string) $this->k97_saldofinal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k97_saldofinal"])){ 
        if(trim((string) $this->k97_saldofinal)=="" && isset($GLOBALS["HTTP_POST_VARS"]["k97_saldofinal"])){ 
           $this->k97_saldofinal = "0" ; 
        } 
     ...
     if(trim((string) $this->k97_limite)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k97_limite"])){ 
        if(trim((string) $this->k97_limite)=="" && isset($GLOBALS["HTTP_POST_VARS"]["k97_limite"])){ 
           $this->k97_limite = "0" ; 
        } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k97_sequencial"]) || $this->k97_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,1749,10156,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k97_sequencial'))."','$this->k97_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k97_dtsaldofinal"]) || $this->k97_dtsaldofinal != "")
           $resac = db_query("insert into db_acount values($acount,1749,10161,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k97_dtsaldofinal'))."','$this->k97_dtsaldofinal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k97_contabancaria"]) || $this->k97_contabancaria != "")
           $resac = db_query("insert into db_acount values($acount,1749,15640,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k97_contabancaria'))."','$this->k97_contabancaria',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k97_extrato"]) || $this->k97_extrato != "")
           $resac = db_query("insert into db_acount values($acount,1749,10158,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k97_extrato'))."','$this->k97_extrato',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k97_valorcredito"]) || $this->k97_valorcredito != "")
           $resac = db_query("insert into db_acount values($acount,1749,10167,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k97_valorcredito'))."','$this->k97_valorcredito',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k97_valordebito"]) || $this->k97_valordebito != "")
           $resac = db_query("insert into db_acount values($acount,1749,10166,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k97_valordebito'))."','$this->k97_valordebito',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k97_qtdregistros"]) || $this->k97_qtdregistros != "")
           $resac = db_query("insert into db_acount values($acount,1749,10165,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k97_qtdregistros'))."','$this->k97_qtdregistros',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k97_posicao"]) || $this->k97_posicao != "")
           $resac = db_query("insert into db_acount values($acount,1749,10164,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k97_posicao'))."','$this->k97_posicao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k97_situacao"]) || $this->k97_situacao != "")
           $resac = db_query("insert into db_acount values($acount,1749,10163,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k97_situacao'))."','$this->k97_situacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k97_saldobloqueado"]) || $this->k97_saldobloqueado != "")
           $resac = db_query("insert into db_acount values($acount,1749,10160,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k97_saldobloqueado'))."','$this->k97_saldobloqueado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k97_saldofinal"]) || $this->k97_saldofinal != "")
           $resac = db_query("insert into db_acount values($acount,1749,10162,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k97_saldofinal'))."','$this->k97_saldofinal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k97_limite"]) || $this->k97_limite != "")
           $resac = db_query("insert into db_acount values($acount,1749,10159,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k97_limite'))."','$this->k97_limite',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k97_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1749,10156,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k97_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1749,10161,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k97_dtsaldofinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1749,15640,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k97_contabancaria'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1749,10158,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k97_extrato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1749,10167,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k97_valorcredito'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1749,10166,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k97_valordebito'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1749,10165,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k97_qtdregistros'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1749,10164,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k97_posicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1749,10163,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k97_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1749,10160,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k97_saldobloqueado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1749,10162,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k97_saldofinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1749,10159,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k97_limite'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
   ...
   function recriarSaldo ( $iContabancaria, $dData) {
     ...
     $iSeqExtrato = pg_fetch_result($rsExtratoSaldo,0,"k97_sequencial");
     ...
     if ($iNumRows > 0) {
        ...
        $k97_saldofinal   = pg_fetch_result($rsSaldo,0,"saldofinal");
        $k97_saldofinal   = pg_fetch_result($rsSaldo,0,"saldoanterior") + $k97_saldofinal;
        $k97_qtdregistros = pg_fetch_result($rsSaldo,0,"qtd");
   ...
   function recriarSaldoGeral ( $iContabancaria, $dData) {
     ...
     for ( $x = 0; $x < $iNumRowsSaldo; $x++) {
    	  ...
    	  $dDtSaldoFinal    = pg_fetch_result($rsExtratoSaldo,$x,"k97_dtsaldofinal");
        ...
        if ($iRows > 0) {
          ...
          $k97_valordebito  = round( pg_fetch_result($rsSaldo,0,"valordebito") ,2);
          $k97_saldofinal   = $k97_valorcredito - $k97_valordebito;  
          $k97_saldofinal   = round(pg_fetch_result($rsSaldo,0,"saldoanterior") + $k97_saldofinal,2);
          $k97_qtdregistros = pg_fetch_result($rsSaldo,0,"qtd");
          $sSql = "update extratosaldo set k97_valorcredito = {$k97_valorcredito},
                                           k97_valordebito  = {$k97_valordebito}, 
                                           k97_saldofinal   = {$k97_saldofinal},  
