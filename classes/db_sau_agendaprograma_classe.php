...
class cl_sau_agendaprograma { 
   ...
   public $s141_i_codigo = 0; 
   public $s141_i_acaoprog = 0; 
   public $s141_i_agendamento = 0; 
   public $s141_d_data_dia = null; 
   public $s141_d_data_mes = null; 
   public $s141_d_data_ano = null; 
   public $s141_d_data = null; 
   public $s141_c_hora = null; 
   ...
   function incluir ($s141_i_codigo){ 
     ...
     if($s141_i_codigo == "" || $s141_i_codigo == null ){
       ...
       $this->s141_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from sau_agendaprograma_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $s141_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2700,15338,'','".AddSlashes(pg_fetch_result($resaco,0,'s141_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2700,15340,'','".AddSlashes(pg_fetch_result($resaco,0,'s141_i_acaoprog'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2700,15339,'','".AddSlashes(pg_fetch_result($resaco,0,'s141_i_agendamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2700,15341,'','".AddSlashes(pg_fetch_result($resaco,0,'s141_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2700,15342,'','".AddSlashes(pg_fetch_result($resaco,0,'s141_c_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($s141_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->s141_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s141_i_codigo"])){ 
       $sql  .= $virgula." s141_i_codigo = $this->s141_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->s141_i_codigo) == null ){ 
     ...
     if(trim((string) $this->s141_i_acaoprog)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s141_i_acaoprog"])){ 
       $sql  .= $virgula." s141_i_acaoprog = $this->s141_i_acaoprog ";
       $virgula = ",";
       if(trim((string) $this->s141_i_acaoprog) == null ){ 
         $this->erro_sql = " Campo Programa nao Informado.";
         $this->erro_campo = "s141_i_acaoprog";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s141_i_agendamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s141_i_agendamento"])){ 
       $sql  .= $virgula." s141_i_agendamento = $this->s141_i_agendamento ";
       $virgula = ",";
       if(trim((string) $this->s141_i_agendamento) == null ){ 
         $this->erro_sql = " Campo Agendamento nao Informado.";
         $this->erro_campo = "s141_i_agendamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s141_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s141_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["s141_d_data_dia"] !="") ){ 
       $sql  .= $virgula." s141_d_data = '$this->s141_d_data' ";
       $virgula = ",";
       if(trim((string) $this->s141_d_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "s141_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s141_c_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s141_c_hora"])){ 
       $sql  .= $virgula." s141_c_hora = '$this->s141_c_hora' ";
       $virgula = ",";
       if(trim((string) $this->s141_c_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "s141_c_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s141_i_codigo"]) || $this->s141_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2700,15338,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s141_i_codigo'))."','$this->s141_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s141_i_acaoprog"]) || $this->s141_i_acaoprog != "")
           $resac = db_query("insert into db_acount values($acount,2700,15340,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s141_i_acaoprog'))."','$this->s141_i_acaoprog',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s141_i_agendamento"]) || $this->s141_i_agendamento != "")
           $resac = db_query("insert into db_acount values($acount,2700,15339,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s141_i_agendamento'))."','$this->s141_i_agendamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s141_d_data"]) || $this->s141_d_data != "")
           $resac = db_query("insert into db_acount values($acount,2700,15341,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s141_d_data'))."','$this->s141_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s141_c_hora"]) || $this->s141_c_hora != "")
           $resac = db_query("insert into db_acount values($acount,2700,15342,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s141_c_hora'))."','$this->s141_c_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($s141_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2700,15338,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s141_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2700,15340,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s141_i_acaoprog'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2700,15339,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s141_i_agendamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2700,15341,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s141_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2700,15342,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s141_c_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
