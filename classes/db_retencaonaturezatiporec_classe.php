...
class cl_retencaonaturezatiporec { 
   ...
   public $e31_sequencial = 0; 
   public $e31_retencaotiporec = 0; 
   public $e31_retencaonatureza = 0; 
   ...
   function incluir ($e31_sequencial){ 
     ...
     if($e31_sequencial == "" || $e31_sequencial == null ){
       ...
       $this->e31_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from retencaonaturezatiporec_e31_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $e31_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2113,12165,'','".AddSlashes(pg_fetch_result($resaco,0,'e31_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2113,12166,'','".AddSlashes(pg_fetch_result($resaco,0,'e31_retencaotiporec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2113,12167,'','".AddSlashes(pg_fetch_result($resaco,0,'e31_retencaonatureza'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e31_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e31_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e31_sequencial"])){ 
       $sql  .= $virgula." e31_sequencial = $this->e31_sequencial ";
       $virgula = ",";
       if(trim((string) $this->e31_sequencial) == null ){ 
     ...
     if(trim((string) $this->e31_retencaotiporec)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e31_retencaotiporec"])){ 
       $sql  .= $virgula." e31_retencaotiporec = $this->e31_retencaotiporec ";
       $virgula = ",";
       if(trim((string) $this->e31_retencaotiporec) == null ){ 
         $this->erro_sql = " Campo Código da Retenção nao Informado.";
         $this->erro_campo = "e31_retencaotiporec";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e31_retencaonatureza)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e31_retencaonatureza"])){ 
       $sql  .= $virgula." e31_retencaonatureza = $this->e31_retencaonatureza ";
       $virgula = ",";
       if(trim((string) $this->e31_retencaonatureza) == null ){ 
         $this->erro_sql = " Campo Código  do IRRF nao Informado.";
         $this->erro_campo = "e31_retencaonatureza";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e31_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2113,12165,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e31_sequencial'))."','$this->e31_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e31_retencaotiporec"]))
           $resac = db_query("insert into db_acount values($acount,2113,12166,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e31_retencaotiporec'))."','$this->e31_retencaotiporec',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e31_retencaonatureza"]))
           $resac = db_query("insert into db_acount values($acount,2113,12167,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e31_retencaonatureza'))."','$this->e31_retencaonatureza',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e31_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2113,12165,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e31_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2113,12166,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e31_retencaotiporec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2113,12167,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e31_retencaonatureza'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
