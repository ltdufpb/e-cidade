...
class cl_debcontapedidoarqcad { 
   ...
   public $d78_sequencial = 0; 
   public $d78_debcontapedido = 0; 
   public $d78_arq = null; 
   ...
   function incluir ($d78_sequencial){ 
     ...
     if($d78_sequencial == "" || $d78_sequencial == null ){
       ...
       $this->d78_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from debcontapedidoarqcad_d78_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $d78_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1392,8263,'','".AddSlashes(pg_fetch_result($resaco,0,'d78_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1392,8264,'','".AddSlashes(pg_fetch_result($resaco,0,'d78_debcontapedido'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1392,8265,'','".AddSlashes(pg_fetch_result($resaco,0,'d78_arq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($d78_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->d78_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d78_sequencial"])){ 
       $sql  .= $virgula." d78_sequencial = $this->d78_sequencial ";
       $virgula = ",";
       if(trim((string) $this->d78_sequencial) == null ){ 
     ...
     if(trim((string) $this->d78_debcontapedido)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d78_debcontapedido"])){ 
       $sql  .= $virgula." d78_debcontapedido = $this->d78_debcontapedido ";
       $virgula = ",";
       if(trim((string) $this->d78_debcontapedido) == null ){ 
         $this->erro_sql = " Campo Codigo sequencial nao Informado.";
         $this->erro_campo = "d78_debcontapedido";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->d78_arq)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d78_arq"])){ 
       $sql  .= $virgula." d78_arq = '$this->d78_arq' ";
       $virgula = ",";
       if(trim((string) $this->d78_arq) == null ){ 
         $this->erro_sql = " Campo Descricao do arquivo nao Informado.";
         $this->erro_campo = "d78_arq";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["d78_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1392,8263,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d78_sequencial'))."','$this->d78_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d78_debcontapedido"]))
           $resac = db_query("insert into db_acount values($acount,1392,8264,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d78_debcontapedido'))."','$this->d78_debcontapedido',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d78_arq"]))
           $resac = db_query("insert into db_acount values($acount,1392,8265,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d78_arq'))."','$this->d78_arq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($d78_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1392,8263,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d78_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1392,8264,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d78_debcontapedido'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1392,8265,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d78_arq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
