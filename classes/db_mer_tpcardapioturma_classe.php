...
class cl_mer_tpcardapioturma { 
   ...
   public $me28_i_codigo = 0; 
   public $me28_i_serie = 0; 
   public $me28_i_cardapioescola = 0; 
   ...
   function incluir ($me28_i_codigo){ 
     ...
     if($me28_i_codigo == "" || $me28_i_codigo == null ){
       ...
       $this->me28_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mer_tpcardapioturma_me28_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $me28_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2491,14170,'','".AddSlashes(pg_fetch_result($resaco,0,'me28_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2491,14172,'','".AddSlashes(pg_fetch_result($resaco,0,'me28_i_serie'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2491,17091,'','".AddSlashes(pg_fetch_result($resaco,0,'me28_i_cardapioescola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me28_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->me28_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me28_i_codigo"])){ 
       $sql  .= $virgula." me28_i_codigo = $this->me28_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->me28_i_codigo) == null ){ 
     ...
     if(trim((string) $this->me28_i_serie)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me28_i_serie"])){ 
       $sql  .= $virgula." me28_i_serie = $this->me28_i_serie ";
       $virgula = ",";
       if(trim((string) $this->me28_i_serie) == null ){ 
         $this->erro_sql = " Campo código da série nao Informado.";
         $this->erro_campo = "me28_i_serie";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me28_i_cardapioescola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me28_i_cardapioescola"])){ 
       $sql  .= $virgula." me28_i_cardapioescola = $this->me28_i_cardapioescola ";
       $virgula = ",";
       if(trim((string) $this->me28_i_cardapioescola) == null ){ 
         $this->erro_sql = " Campo Cardapio escola nao Informado.";
         $this->erro_campo = "me28_i_cardapioescola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me28_i_codigo"]) || $this->me28_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2491,14170,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me28_i_codigo'))."','$this->me28_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me28_i_serie"]) || $this->me28_i_serie != "")
           $resac = db_query("insert into db_acount values($acount,2491,14172,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me28_i_serie'))."','$this->me28_i_serie',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me28_i_cardapioescola"]) || $this->me28_i_cardapioescola != "")
           $resac = db_query("insert into db_acount values($acount,2491,17091,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me28_i_cardapioescola'))."','$this->me28_i_cardapioescola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me28_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2491,14170,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me28_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2491,14172,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me28_i_serie'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2491,17091,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me28_i_cardapioescola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
