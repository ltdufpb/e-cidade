...
class cl_vac_devfechadescarte { 
   ...
   public $vc25_i_codigo = 0; 
   public $vc25_i_fechadescarte = 0; 
   public $vc25_i_devolucao = 0; 
   ...
   function incluir ($vc25_i_codigo){ 
     ...
     if($vc25_i_codigo == "" || $vc25_i_codigo == null ){
       ...
       $this->vc25_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from vac_devfechadescarte_vc25_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $vc25_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3105,17577,'','".AddSlashes(pg_fetch_result($resaco,0,'vc25_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3105,17578,'','".AddSlashes(pg_fetch_result($resaco,0,'vc25_i_fechadescarte'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3105,17579,'','".AddSlashes(pg_fetch_result($resaco,0,'vc25_i_devolucao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($vc25_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->vc25_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc25_i_codigo"])){ 
       $sql  .= $virgula." vc25_i_codigo = $this->vc25_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->vc25_i_codigo) == null ){ 
     ...
     if(trim((string) $this->vc25_i_fechadescarte)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc25_i_fechadescarte"])){ 
       $sql  .= $virgula." vc25_i_fechadescarte = $this->vc25_i_fechadescarte ";
       $virgula = ",";
       if(trim((string) $this->vc25_i_fechadescarte) == null ){ 
         $this->erro_sql = " Campo Fechamento Descarte nao Informado.";
         $this->erro_campo = "vc25_i_fechadescarte";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->vc25_i_devolucao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["vc25_i_devolucao"])){ 
       $sql  .= $virgula." vc25_i_devolucao = $this->vc25_i_devolucao ";
       $virgula = ",";
       if(trim((string) $this->vc25_i_devolucao) == null ){ 
         $this->erro_sql = " Campo Devolução nao Informado.";
         $this->erro_campo = "vc25_i_devolucao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc25_i_codigo"]) || $this->vc25_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3105,17577,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc25_i_codigo'))."','$this->vc25_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc25_i_fechadescarte"]) || $this->vc25_i_fechadescarte != "")
           $resac = db_query("insert into db_acount values($acount,3105,17578,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc25_i_fechadescarte'))."','$this->vc25_i_fechadescarte',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["vc25_i_devolucao"]) || $this->vc25_i_devolucao != "")
           $resac = db_query("insert into db_acount values($acount,3105,17579,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'vc25_i_devolucao'))."','$this->vc25_i_devolucao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($vc25_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3105,17577,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc25_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3105,17578,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc25_i_fechadescarte'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3105,17579,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'vc25_i_devolucao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
