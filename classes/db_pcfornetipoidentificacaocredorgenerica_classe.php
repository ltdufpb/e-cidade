...
class cl_pcfornetipoidentificacaocredorgenerica { 
   ...
   public $c26_sequencial = 0; 
   public $c26_tipoidentificacaocredorgenerica = 0; 
   public $c26_pcforne = 0; 
   ...
   function incluir ($c26_sequencial){ 
     ...
     if($c26_sequencial == "" || $c26_sequencial == null ){
       ...
       $this->c26_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from pcfornetipoidentificacaocredorgenerica_c26_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $c26_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3326,18763,'','".AddSlashes(pg_fetch_result($resaco,0,'c26_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3326,18764,'','".AddSlashes(pg_fetch_result($resaco,0,'c26_tipoidentificacaocredorgenerica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3326,18765,'','".AddSlashes(pg_fetch_result($resaco,0,'c26_pcforne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($c26_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->c26_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c26_sequencial"])){ 
       $sql  .= $virgula." c26_sequencial = $this->c26_sequencial ";
       $virgula = ",";
       if(trim((string) $this->c26_sequencial) == null ){ 
     ...
     if(trim((string) $this->c26_tipoidentificacaocredorgenerica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c26_tipoidentificacaocredorgenerica"])){ 
       $sql  .= $virgula." c26_tipoidentificacaocredorgenerica = $this->c26_tipoidentificacaocredorgenerica ";
       $virgula = ",";
       if(trim((string) $this->c26_tipoidentificacaocredorgenerica) == null ){ 
         $this->erro_sql = " Campo Identificação do Credor Genérica nao Informado.";
         $this->erro_campo = "c26_tipoidentificacaocredorgenerica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c26_pcforne)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c26_pcforne"])){ 
       $sql  .= $virgula." c26_pcforne = $this->c26_pcforne ";
       $virgula = ",";
       if(trim((string) $this->c26_pcforne) == null ){ 
         $this->erro_sql = " Campo Fornecedor nao Informado.";
         $this->erro_campo = "c26_pcforne";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c26_sequencial"]) || $this->c26_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3326,18763,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c26_sequencial'))."','$this->c26_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c26_tipoidentificacaocredorgenerica"]) || $this->c26_tipoidentificacaocredorgenerica != "")
           $resac = db_query("insert into db_acount values($acount,3326,18764,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c26_tipoidentificacaocredorgenerica'))."','$this->c26_tipoidentificacaocredorgenerica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["c26_pcforne"]) || $this->c26_pcforne != "")
           $resac = db_query("insert into db_acount values($acount,3326,18765,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'c26_pcforne'))."','$this->c26_pcforne',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($c26_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3326,18763,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c26_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3326,18764,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c26_tipoidentificacaocredorgenerica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3326,18765,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'c26_pcforne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
