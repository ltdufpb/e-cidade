...
class cl_orcparamrelnotaperiodo { 
   ...
   public $o118_sequencial = 0; 
   public $o118_orcparamrelnota = 0; 
   public $o118_periodo = 0; 
   ...
   function incluir ($o118_sequencial){ 
     ...
     if($o118_sequencial == "" || $o118_sequencial == null ){
       ...
       $this->o118_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from orcparamrelnotaperiodo_o118_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $o118_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2490,14167,'','".AddSlashes(pg_fetch_result($resaco,0,'o118_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2490,14168,'','".AddSlashes(pg_fetch_result($resaco,0,'o118_orcparamrelnota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2490,14169,'','".AddSlashes(pg_fetch_result($resaco,0,'o118_periodo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o118_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o118_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o118_sequencial"])){ 
       $sql  .= $virgula." o118_sequencial = $this->o118_sequencial ";
       $virgula = ",";
       if(trim((string) $this->o118_sequencial) == null ){ 
     ...
     if(trim((string) $this->o118_orcparamrelnota)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o118_orcparamrelnota"])){ 
       $sql  .= $virgula." o118_orcparamrelnota = $this->o118_orcparamrelnota ";
       $virgula = ",";
       if(trim((string) $this->o118_orcparamrelnota) == null ){ 
         $this->erro_sql = " Campo Nota nao Informado.";
         $this->erro_campo = "o118_orcparamrelnota";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o118_periodo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o118_periodo"])){ 
       $sql  .= $virgula." o118_periodo = $this->o118_periodo ";
       $virgula = ",";
       if(trim((string) $this->o118_periodo) == null ){ 
         $this->erro_sql = " Campo Código do período do relatório nao Informado.";
         $this->erro_campo = "o118_periodo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["o118_sequencial"]) || $this->o118_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2490,14167,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o118_sequencial'))."','$this->o118_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o118_orcparamrelnota"]) || $this->o118_orcparamrelnota != "")
           $resac = db_query("insert into db_acount values($acount,2490,14168,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o118_orcparamrelnota'))."','$this->o118_orcparamrelnota',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o118_periodo"]) || $this->o118_periodo != "")
           $resac = db_query("insert into db_acount values($acount,2490,14169,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o118_periodo'))."','$this->o118_periodo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($o118_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2490,14167,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o118_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2490,14168,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o118_orcparamrelnota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2490,14169,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o118_periodo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
