...
class cl_alunorecursosavaliacaoinep { 
   ...
   public $ed327_sequencial = 0; 
   public $ed327_aluno = 0; 
   public $ed327_recursosavaliacaoinep = 0; 
   ...
   function incluir ($ed327_sequencial){ 
     ...
     if($ed327_sequencial == "" || $ed327_sequencial == null ){
       ...
       $this->ed327_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from alunorecursosavaliacaoinep_ed327_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed327_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3550,19799,'','".AddSlashes(pg_fetch_result($resaco,0,'ed327_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3550,19800,'','".AddSlashes(pg_fetch_result($resaco,0,'ed327_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3550,19801,'','".AddSlashes(pg_fetch_result($resaco,0,'ed327_recursosavaliacaoinep'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed327_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed327_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed327_sequencial"])){ 
       $sql  .= $virgula." ed327_sequencial = $this->ed327_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ed327_sequencial) == null ){ 
     ...
     if(trim((string) $this->ed327_aluno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed327_aluno"])){ 
       $sql  .= $virgula." ed327_aluno = $this->ed327_aluno ";
       $virgula = ",";
       if(trim((string) $this->ed327_aluno) == null ){ 
         $this->erro_sql = " Campo Código do Aluno nao Informado.";
         $this->erro_campo = "ed327_aluno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed327_recursosavaliacaoinep)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed327_recursosavaliacaoinep"])){ 
       $sql  .= $virgula." ed327_recursosavaliacaoinep = $this->ed327_recursosavaliacaoinep ";
       $virgula = ",";
       if(trim((string) $this->ed327_recursosavaliacaoinep) == null ){ 
         $this->erro_sql = " Campo Código do Recurso nao Informado.";
         $this->erro_campo = "ed327_recursosavaliacaoinep";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed327_sequencial"]) || $this->ed327_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3550,19799,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed327_sequencial'))."','$this->ed327_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed327_aluno"]) || $this->ed327_aluno != "")
           $resac = db_query("insert into db_acount values($acount,3550,19800,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed327_aluno'))."','$this->ed327_aluno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed327_recursosavaliacaoinep"]) || $this->ed327_recursosavaliacaoinep != "")
           $resac = db_query("insert into db_acount values($acount,3550,19801,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed327_recursosavaliacaoinep'))."','$this->ed327_recursosavaliacaoinep',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed327_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3550,19799,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed327_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3550,19800,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed327_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3550,19801,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed327_recursosavaliacaoinep'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
