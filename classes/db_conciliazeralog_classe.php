...
class cl_conciliazeralog { 
   ...
   public $k123_sequencial = 0; 
   public $k123_data_dia = null; 
   public $k123_data_mes = null; 
   public $k123_data_ano = null; 
   public $k123_data = null; 
   public $k123_hora = null; 
   public $k123_id_usuario = 0; 
   public $k123_obs = null; 
   public $k132_filtros = null; 
   ...
   function incluir ($k123_sequencial){ 
     ...
     if($k123_sequencial == "" || $k123_sequencial == null ){
       ...
       $this->k123_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from conciliazeralog_k123_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k123_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3120,17666,'','".AddSlashes(pg_fetch_result($resaco,0,'k123_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3120,17667,'','".AddSlashes(pg_fetch_result($resaco,0,'k123_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3120,17668,'','".AddSlashes(pg_fetch_result($resaco,0,'k123_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3120,17669,'','".AddSlashes(pg_fetch_result($resaco,0,'k123_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3120,17670,'','".AddSlashes(pg_fetch_result($resaco,0,'k123_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3120,17671,'','".AddSlashes(pg_fetch_result($resaco,0,'k132_filtros'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k123_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k123_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k123_sequencial"])){ 
       $sql  .= $virgula." k123_sequencial = $this->k123_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k123_sequencial) == null ){ 
     ...
     if(trim((string) $this->k123_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k123_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["k123_data_dia"] !="") ){ 
       $sql  .= $virgula." k123_data = '$this->k123_data' ";
       $virgula = ",";
       if(trim((string) $this->k123_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "k123_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k123_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k123_hora"])){ 
       $sql  .= $virgula." k123_hora = '$this->k123_hora' ";
       $virgula = ",";
       if(trim((string) $this->k123_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "k123_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k123_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k123_id_usuario"])){ 
       $sql  .= $virgula." k123_id_usuario = $this->k123_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->k123_id_usuario) == null ){ 
         $this->erro_sql = " Campo Id Usuario nao Informado.";
         $this->erro_campo = "k123_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k123_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k123_obs"])){ 
       $sql  .= $virgula." k123_obs = '$this->k123_obs' ";
       $virgula = ",";
       if(trim((string) $this->k123_obs) == null ){ 
         $this->erro_sql = " Campo Observações nao Informado.";
         $this->erro_campo = "k123_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k132_filtros)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k132_filtros"])){ 
       $sql  .= $virgula." k132_filtros = '$this->k132_filtros' ";
       $virgula = ",";
       if(trim((string) $this->k132_filtros) == null ){ 
         $this->erro_sql = " Campo Filtros nao Informado.";
         $this->erro_campo = "k132_filtros";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k123_sequencial"]) || $this->k123_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3120,17666,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k123_sequencial'))."','$this->k123_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k123_data"]) || $this->k123_data != "")
           $resac = db_query("insert into db_acount values($acount,3120,17667,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k123_data'))."','$this->k123_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k123_hora"]) || $this->k123_hora != "")
           $resac = db_query("insert into db_acount values($acount,3120,17668,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k123_hora'))."','$this->k123_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k123_id_usuario"]) || $this->k123_id_usuario != "")
           $resac = db_query("insert into db_acount values($acount,3120,17669,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k123_id_usuario'))."','$this->k123_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k123_obs"]) || $this->k123_obs != "")
           $resac = db_query("insert into db_acount values($acount,3120,17670,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k123_obs'))."','$this->k123_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k132_filtros"]) || $this->k132_filtros != "")
           $resac = db_query("insert into db_acount values($acount,3120,17671,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k132_filtros'))."','$this->k132_filtros',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k123_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3120,17666,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k123_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3120,17667,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k123_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3120,17668,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k123_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3120,17669,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k123_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3120,17670,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k123_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3120,17671,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k132_filtros'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
