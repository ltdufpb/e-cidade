...
class cl_ouvidoriacadlocaldepart { 
   ...
   public $ov27_sequencial = 0; 
   public $ov27_depart = 0; 
   public $ov27_ouvidoriacadlocal = 0; 
   ...
   function incluir ($ov27_sequencial){ 
     ...
     if($ov27_sequencial == "" || $ov27_sequencial == null ){
       ...
       $this->ov27_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from ouvidoriacadlocadepart_ov27_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ov27_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2632,14975,'','".AddSlashes(pg_fetch_result($resaco,0,'ov27_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2632,14977,'','".AddSlashes(pg_fetch_result($resaco,0,'ov27_depart'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2632,14976,'','".AddSlashes(pg_fetch_result($resaco,0,'ov27_ouvidoriacadlocal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ov27_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ov27_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov27_sequencial"])){ 
       $sql  .= $virgula." ov27_sequencial = $this->ov27_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ov27_sequencial) == null ){ 
     ...
     if(trim((string) $this->ov27_depart)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov27_depart"])){ 
       $sql  .= $virgula." ov27_depart = $this->ov27_depart ";
       $virgula = ",";
       if(trim((string) $this->ov27_depart) == null ){ 
         $this->erro_sql = " Campo Departamento nao Informado.";
         $this->erro_campo = "ov27_depart";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ov27_ouvidoriacadlocal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ov27_ouvidoriacadlocal"])){ 
       $sql  .= $virgula." ov27_ouvidoriacadlocal = $this->ov27_ouvidoriacadlocal ";
       $virgula = ",";
       if(trim((string) $this->ov27_ouvidoriacadlocal) == null ){ 
         $this->erro_sql = " Campo Local nao Informado.";
         $this->erro_campo = "ov27_ouvidoriacadlocal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov27_sequencial"]) || $this->ov27_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2632,14975,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov27_sequencial'))."','$this->ov27_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov27_depart"]) || $this->ov27_depart != "")
           $resac = db_query("insert into db_acount values($acount,2632,14977,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov27_depart'))."','$this->ov27_depart',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ov27_ouvidoriacadlocal"]) || $this->ov27_ouvidoriacadlocal != "")
           $resac = db_query("insert into db_acount values($acount,2632,14976,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ov27_ouvidoriacadlocal'))."','$this->ov27_ouvidoriacadlocal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ov27_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2632,14975,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov27_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2632,14977,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov27_depart'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2632,14976,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ov27_ouvidoriacadlocal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
