...
class cl_lab_labcgm { 
   ...
   public $la04_i_codigo = 0; 
   public $la04_i_cgm = 0; 
   public $la04_i_laboratorio = 0; 
   ...
   function incluir ($la04_i_codigo){ 
     ...
     if($la04_i_codigo == "" || $la04_i_codigo == null ){
       ...
       $this->la04_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from lab_labcgm_la04_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $la04_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2755,15715,'','".AddSlashes(pg_fetch_result($resaco,0,'la04_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2755,15716,'','".AddSlashes(pg_fetch_result($resaco,0,'la04_i_cgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2755,15717,'','".AddSlashes(pg_fetch_result($resaco,0,'la04_i_laboratorio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($la04_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->la04_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la04_i_codigo"])){ 
       $sql  .= $virgula." la04_i_codigo = $this->la04_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->la04_i_codigo) == null ){ 
     ...
     if(trim((string) $this->la04_i_cgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la04_i_cgm"])){ 
       $sql  .= $virgula." la04_i_cgm = $this->la04_i_cgm ";
       $virgula = ",";
       if(trim((string) $this->la04_i_cgm) == null ){ 
         $this->erro_sql = " Campo CGM nao Informado.";
         $this->erro_campo = "la04_i_cgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->la04_i_laboratorio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la04_i_laboratorio"])){ 
       $sql  .= $virgula." la04_i_laboratorio = $this->la04_i_laboratorio ";
       $virgula = ",";
       if(trim((string) $this->la04_i_laboratorio) == null ){ 
         $this->erro_sql = " Campo Laboratório nao Informado.";
         $this->erro_campo = "la04_i_laboratorio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["la04_i_codigo"]) || $this->la04_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2755,15715,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la04_i_codigo'))."','$this->la04_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la04_i_cgm"]) || $this->la04_i_cgm != "")
           $resac = db_query("insert into db_acount values($acount,2755,15716,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la04_i_cgm'))."','$this->la04_i_cgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la04_i_laboratorio"]) || $this->la04_i_laboratorio != "")
           $resac = db_query("insert into db_acount values($acount,2755,15717,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la04_i_laboratorio'))."','$this->la04_i_laboratorio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($la04_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2755,15715,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la04_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2755,15716,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la04_i_cgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2755,15717,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la04_i_laboratorio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
