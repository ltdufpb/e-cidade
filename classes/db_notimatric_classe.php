...
class cl_notimatric { 
   ...
   function incluir ($k55_notifica,$k55_matric){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,626,4719,'','".AddSlashes(pg_fetch_result($resaco,0,'k55_notifica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,626,4722,'','".AddSlashes(pg_fetch_result($resaco,0,'k55_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k55_notifica=null,$k55_matric=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k55_notifica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k55_notifica"])){ 
        if(trim((string) $this->k55_notifica)=="" && isset($GLOBALS["HTTP_POST_VARS"]["k55_notifica"])){ 
           $this->k55_notifica = "0" ; 
        } 
       $sql  .= $virgula." k55_notifica = $this->k55_notifica ";
       $virgula = ",";
       if(trim((string) $this->k55_notifica) == null ){ 
     ...
     if(trim((string) $this->k55_matric)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k55_matric"])){ 
        if(trim((string) $this->k55_matric)=="" && isset($GLOBALS["HTTP_POST_VARS"]["k55_matric"])){ 
           $this->k55_matric = "0" ; 
        } 
       $sql  .= $virgula." k55_matric = $this->k55_matric ";
       $virgula = ",";
       if(trim((string) $this->k55_matric) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k55_notifica"]))
           $resac = db_query("insert into db_acount values($acount,626,4719,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k55_notifica'))."','$this->k55_notifica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k55_matric"]))
           $resac = db_query("insert into db_acount values($acount,626,4722,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k55_matric'))."','$this->k55_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k55_notifica=null,$k55_matric=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,626,4719,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k55_notifica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,626,4722,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k55_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
