...
class cl_custoplanilha { 
   ...
   public $cc15_sequencial = 0; 
   public $cc15_anousu = 0; 
   public $cc15_mesusu = 0; 
   public $cc15_id_usuario = 0; 
   public $cc15_situacao = 0; 
   ...
   function incluir ($cc15_sequencial){ 
     ...
     if($cc15_sequencial == "" || $cc15_sequencial == null ){
       ...
       $this->cc15_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from custoplanilha_cc15_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $cc15_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2660,15115,'','".AddSlashes(pg_fetch_result($resaco,0,'cc15_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2660,15116,'','".AddSlashes(pg_fetch_result($resaco,0,'cc15_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2660,15117,'','".AddSlashes(pg_fetch_result($resaco,0,'cc15_mesusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2660,15118,'','".AddSlashes(pg_fetch_result($resaco,0,'cc15_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2660,15119,'','".AddSlashes(pg_fetch_result($resaco,0,'cc15_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($cc15_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->cc15_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc15_sequencial"])){ 
       $sql  .= $virgula." cc15_sequencial = $this->cc15_sequencial ";
       $virgula = ",";
       if(trim((string) $this->cc15_sequencial) == null ){ 
     ...
     if(trim((string) $this->cc15_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc15_anousu"])){ 
       $sql  .= $virgula." cc15_anousu = $this->cc15_anousu ";
       $virgula = ",";
       if(trim((string) $this->cc15_anousu) == null ){ 
         $this->erro_sql = " Campo Ano Usu nao Informado.";
         $this->erro_campo = "cc15_anousu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cc15_mesusu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc15_mesusu"])){ 
       $sql  .= $virgula." cc15_mesusu = $this->cc15_mesusu ";
       $virgula = ",";
       if(trim((string) $this->cc15_mesusu) == null ){ 
         $this->erro_sql = " Campo Mês Usu nao Informado.";
         $this->erro_campo = "cc15_mesusu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cc15_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc15_id_usuario"])){ 
       $sql  .= $virgula." cc15_id_usuario = $this->cc15_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->cc15_id_usuario) == null ){ 
         $this->erro_sql = " Campo Usuário nao Informado.";
         $this->erro_campo = "cc15_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->cc15_situacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cc15_situacao"])){ 
       $sql  .= $virgula." cc15_situacao = $this->cc15_situacao ";
       $virgula = ",";
       if(trim((string) $this->cc15_situacao) == null ){ 
         $this->erro_sql = " Campo Situação nao Informado.";
         $this->erro_campo = "cc15_situacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc15_sequencial"]) || $this->cc15_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2660,15115,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc15_sequencial'))."','$this->cc15_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc15_anousu"]) || $this->cc15_anousu != "")
           $resac = db_query("insert into db_acount values($acount,2660,15116,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc15_anousu'))."','$this->cc15_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc15_mesusu"]) || $this->cc15_mesusu != "")
           $resac = db_query("insert into db_acount values($acount,2660,15117,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc15_mesusu'))."','$this->cc15_mesusu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc15_id_usuario"]) || $this->cc15_id_usuario != "")
           $resac = db_query("insert into db_acount values($acount,2660,15118,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc15_id_usuario'))."','$this->cc15_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cc15_situacao"]) || $this->cc15_situacao != "")
           $resac = db_query("insert into db_acount values($acount,2660,15119,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'cc15_situacao'))."','$this->cc15_situacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($cc15_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2660,15115,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc15_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2660,15116,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc15_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2660,15117,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc15_mesusu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2660,15118,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc15_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2660,15119,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'cc15_situacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
