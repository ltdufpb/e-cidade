...
class cl_editalproj { 
   ...
   function incluir ($d10_codedi,$d10_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,619,4689,'','".AddSlashes(pg_fetch_result($resaco,0,'d10_codedi'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,619,4690,'','".AddSlashes(pg_fetch_result($resaco,0,'d10_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($d10_codedi=null,$d10_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->d10_codedi)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d10_codedi"])){ 
       $sql  .= $virgula." d10_codedi = $this->d10_codedi ";
       $virgula = ",";
       if(trim((string) $this->d10_codedi) == null ){ 
     ...
     if(trim((string) $this->d10_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["d10_codigo"])){ 
       $sql  .= $virgula." d10_codigo = $this->d10_codigo ";
       $virgula = ",";
       if(trim((string) $this->d10_codigo) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["d10_codedi"]))
           $resac = db_query("insert into db_acount values($acount,619,4689,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d10_codedi'))."','$this->d10_codedi',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d10_codigo"]))
           $resac = db_query("insert into db_acount values($acount,619,4690,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'d10_codigo'))."','$this->d10_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($d10_codedi=null,$d10_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,619,4689,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d10_codedi'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,619,4690,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'d10_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
