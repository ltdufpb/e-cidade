...
class cl_far_controle { 
   ...
   public $fa11_i_codigo = 0; 
   public $fa11_i_cgsund = 0; 
   public $fa11_t_obs = null; 
   ...
   function incluir ($fa11_i_codigo){ 
     ...
     if($fa11_i_codigo == "" || $fa11_i_codigo == null ){
       ...
       $this->fa11_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_controle_fa11_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa11_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2178,12482,'','".AddSlashes(pg_fetch_result($resaco,0,'fa11_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2178,12486,'','".AddSlashes(pg_fetch_result($resaco,0,'fa11_i_cgsund'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2178,12487,'','".AddSlashes(pg_fetch_result($resaco,0,'fa11_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa11_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa11_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa11_i_codigo"])){ 
       $sql  .= $virgula." fa11_i_codigo = $this->fa11_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa11_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa11_i_cgsund)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa11_i_cgsund"])){ 
       $sql  .= $virgula." fa11_i_cgsund = $this->fa11_i_cgsund ";
       $virgula = ",";
       if(trim((string) $this->fa11_i_cgsund) == null ){ 
         $this->erro_sql = " Campo CGS nao Informado.";
         $this->erro_campo = "fa11_i_cgsund";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa11_t_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa11_t_obs"])){ 
       $sql  .= $virgula." fa11_t_obs = '$this->fa11_t_obs' ";
       $virgula = ",";
       if(trim((string) $this->fa11_t_obs) == null ){ 
         $this->erro_sql = " Campo Observação nao Informado.";
         $this->erro_campo = "fa11_t_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa11_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2178,12482,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa11_i_codigo'))."','$this->fa11_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa11_i_cgsund"]))
           $resac = db_query("insert into db_acount values($acount,2178,12486,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa11_i_cgsund'))."','$this->fa11_i_cgsund',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa11_t_obs"]))
           $resac = db_query("insert into db_acount values($acount,2178,12487,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa11_t_obs'))."','$this->fa11_t_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa11_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2178,12482,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa11_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2178,12486,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa11_i_cgsund'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2178,12487,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa11_t_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
