...
class cl_mer_cardapiodiaescola { 
   ...
   public $me37_i_codigo         = 0; 
   public $me37_i_cardapiodia    = 0; 
   public $me37_i_cardapioescola = 0; 
   ...
   function incluir ($me37_i_codigo){ 
     ...
     if($me37_i_codigo == "" || $me37_i_codigo == null ){
       ...
       $this->me37_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mer_cardapiodiaescola_me37_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $me37_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3090,17483,'','".AddSlashes(pg_fetch_result($resaco,0,'me37_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3090,17484,'','".AddSlashes(pg_fetch_result($resaco,0,'me37_i_cardapiodia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3090,17485,'','".AddSlashes(pg_fetch_result($resaco,0,'me37_i_cardapioescola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me37_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->me37_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me37_i_codigo"])){ 
       $sql  .= $virgula." me37_i_codigo = $this->me37_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->me37_i_codigo) == null ){ 
     ...
     if(trim((string) $this->me37_i_cardapiodia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me37_i_cardapiodia"])){ 
       $sql  .= $virgula." me37_i_cardapiodia = $this->me37_i_cardapiodia ";
       $virgula = ",";
       if(trim((string) $this->me37_i_cardapiodia) == null ){ 
         $this->erro_sql = " Campo Cardapiodia nao Informado.";
         $this->erro_campo = "me37_i_cardapiodia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me37_i_cardapioescola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me37_i_cardapioescola"])){ 
       $sql  .= $virgula." me37_i_cardapioescola = $this->me37_i_cardapioescola ";
       $virgula = ",";
       if(trim((string) $this->me37_i_cardapioescola) == null ){ 
         $this->erro_sql = " Campo Cardapioescola nao Informado.";
         $this->erro_campo = "me37_i_cardapioescola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me37_i_codigo"]) || $this->me37_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3090,17483,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me37_i_codigo'))."','$this->me37_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me37_i_cardapiodia"]) || $this->me37_i_cardapiodia != "")
           $resac = db_query("insert into db_acount values($acount,3090,17484,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me37_i_cardapiodia'))."','$this->me37_i_cardapiodia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me37_i_cardapioescola"]) || $this->me37_i_cardapioescola != "")
           $resac = db_query("insert into db_acount values($acount,3090,17485,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me37_i_cardapioescola'))."','$this->me37_i_cardapioescola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me37_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3090,17483,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me37_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3090,17484,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me37_i_cardapiodia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3090,17485,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me37_i_cardapioescola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
