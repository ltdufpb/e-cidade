...
class cl_cursoato { 
   ...
   public $ed215_i_cursoescola = 0; 
   public $ed215_i_atolegal = 0; 
  ...
  public function incluir ($ed215_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2568,14611,'','".AddSlashes(pg_fetch_result($resaco,0,'ed215_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2568,14612,'','".AddSlashes(pg_fetch_result($resaco,0,'ed215_i_cursoescola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2568,14613,'','".AddSlashes(pg_fetch_result($resaco,0,'ed215_i_atolegal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
  ...
  public function alterar ($ed215_i_codigo=null) { 
     ...
     if(trim((string) $this->ed215_i_cursoescola)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_cursoescola"])){ 
       $sql  .= $virgula." ed215_i_cursoescola = $this->ed215_i_cursoescola ";
       $virgula = ",";
       if(trim((string) $this->ed215_i_cursoescola) == null ){ 
         $this->erro_sql = " Campo Curso nao Informado.";
         $this->erro_campo = "ed215_i_cursoescola";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed215_i_atolegal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_atolegal"])){ 
       $sql  .= $virgula." ed215_i_atolegal = $this->ed215_i_atolegal ";
       $virgula = ",";
       if(trim((string) $this->ed215_i_atolegal) == null ){ 
         $this->erro_sql = " Campo Ato Legal nao Informado.";
         $this->erro_campo = "ed215_i_atolegal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_codigo"]) || $this->ed215_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2568,14611,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed215_i_codigo'))."','$this->ed215_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_cursoescola"]) || $this->ed215_i_cursoescola != "")
           $resac = db_query("insert into db_acount values($acount,2568,14612,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed215_i_cursoescola'))."','$this->ed215_i_cursoescola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed215_i_atolegal"]) || $this->ed215_i_atolegal != "")
           $resac = db_query("insert into db_acount values($acount,2568,14613,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed215_i_atolegal'))."','$this->ed215_i_atolegal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
  ...
  public function excluir ($ed215_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2568,14611,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed215_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2568,14612,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed215_i_cursoescola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2568,14613,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed215_i_atolegal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
