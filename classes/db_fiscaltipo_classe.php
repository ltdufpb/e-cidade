...
class cl_fiscaltipo { 
   ...
   function incluir ($y31_codnoti,$y31_codtipo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,684,4949,'','".AddSlashes(pg_fetch_result($resaco,0,'y31_codnoti'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,684,4950,'','".AddSlashes(pg_fetch_result($resaco,0,'y31_codtipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y31_codnoti=null,$y31_codtipo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y31_codnoti)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y31_codnoti"])){ 
       $sql  .= $virgula." y31_codnoti = $this->y31_codnoti ";
       $virgula = ",";
       if(trim((string) $this->y31_codnoti) == null ){ 
     ...
     if(trim((string) $this->y31_codtipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y31_codtipo"])){ 
       $sql  .= $virgula." y31_codtipo = $this->y31_codtipo ";
       $virgula = ",";
       if(trim((string) $this->y31_codtipo) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y31_codnoti"]))
           $resac = db_query("insert into db_acount values($acount,684,4949,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y31_codnoti'))."','$this->y31_codnoti',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y31_codtipo"]))
           $resac = db_query("insert into db_acount values($acount,684,4950,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y31_codtipo'))."','$this->y31_codtipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y31_codnoti=null,$y31_codtipo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,684,4949,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y31_codnoti'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,684,4950,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y31_codtipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
