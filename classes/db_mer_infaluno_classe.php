...
class cl_mer_infaluno { 
   ...
   public $me14_i_codigo = 0; 
   public $me14_f_peso = 0; 
   public $me14_f_altura = 0; 
   public $me14_i_aluno = 0; 
   public $me14_i_ano = ""; 
   public $me14_i_mes = ""; 
   public $me14_i_periodocalendario = ""; 
   public $me14_d_data_dia = null; 
   public $me14_d_data_mes = null; 
   public $me14_d_data_ano = null; 
   public $me14_d_data = null; 
   ...
   function incluir ($me14_i_codigo){ 
     ...
     if($me14_i_codigo == "" || $me14_i_codigo == null ){
       ...
       $this->me14_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from merinfaluno_me14_codigo");
       if(($result != false) && (pg_fetch_result($result,0,0) < $me14_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2234,12758,'','".AddSlashes(pg_fetch_result($resaco,0,'me14_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2234,12759,'','".AddSlashes(pg_fetch_result($resaco,0,'me14_f_peso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2234,12760,'','".AddSlashes(pg_fetch_result($resaco,0,'me14_f_altura'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2234,12762,'','".AddSlashes(pg_fetch_result($resaco,0,'me14_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2234,17304,'','".AddSlashes(pg_fetch_result($resaco,0,'me14_i_ano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2234,17303,'','".AddSlashes(pg_fetch_result($resaco,0,'me14_i_mes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2234,17305,'','".AddSlashes(pg_fetch_result($resaco,0,'me14_i_periodocalendario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2234,12761,'','".AddSlashes(pg_fetch_result($resaco,0,'me14_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($me14_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->me14_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me14_i_codigo"])){ 
       $sql  .= $virgula." me14_i_codigo = $this->me14_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->me14_i_codigo) == null ){ 
     ...
     if(trim((string) $this->me14_f_peso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me14_f_peso"])){ 
       $sql  .= $virgula." me14_f_peso = $this->me14_f_peso ";
       $virgula = ",";
       if(trim((string) $this->me14_f_peso) == null ){ 
         $this->erro_sql = " Campo Peso nao Informado.";
         $this->erro_campo = "me14_f_peso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me14_f_altura)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me14_f_altura"])){ 
       $sql  .= $virgula." me14_f_altura = $this->me14_f_altura ";
       $virgula = ",";
       if(trim((string) $this->me14_f_altura) == null ){ 
         $this->erro_sql = " Campo Altura nao Informado.";
         $this->erro_campo = "me14_f_altura";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->me14_i_aluno)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me14_i_aluno"])){ 
       $sql  .= $virgula." me14_i_aluno = $this->me14_i_aluno ";
       $virgula = ",";
       if(trim((string) $this->me14_i_aluno) == null ){ 
         $this->erro_sql = " Campo Aluno nao Informado.";
         $this->erro_campo = "me14_i_aluno";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        ...
        if(trim((string) $this->me14_i_ano)== null){ 
           $this->me14_i_ano = "null" ; 
        } 
       $sql  .= $virgula." me14_i_ano = $this->me14_i_ano ";
       $virgula = ",";
 
        if(trim((string) $this->me14_i_mes)== null){ 
           $this->me14_i_mes = "null" ; 
        } 
       ...
       $virgula = ",";
        ...
        if(trim((string) $this->me14_i_periodocalendario)== null){ 
           $this->me14_i_periodocalendario = "null" ; 
        } 
       $sql  .= $virgula." me14_i_periodocalendario = $this->me14_i_periodocalendario ";
       $virgula = ",";

     if(trim((string) $this->me14_d_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["me14_d_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["me14_d_data_dia"] !="") ){ 
       $sql  .= $virgula." me14_d_data = '$this->me14_d_data' ";
       $virgula = ",";
       if(trim((string) $this->me14_d_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "me14_d_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["me14_i_codigo"]) || $this->me14_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2234,12758,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me14_i_codigo'))."','$this->me14_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me14_f_peso"]) || $this->me14_f_peso != "")
           $resac = db_query("insert into db_acount values($acount,2234,12759,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me14_f_peso'))."','$this->me14_f_peso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me14_f_altura"]) || $this->me14_f_altura != "")
           $resac = db_query("insert into db_acount values($acount,2234,12760,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me14_f_altura'))."','$this->me14_f_altura',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me14_i_aluno"]) || $this->me14_i_aluno != "")
           $resac = db_query("insert into db_acount values($acount,2234,12762,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me14_i_aluno'))."','$this->me14_i_aluno',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me14_i_ano"]) || $this->me14_i_ano != "")
           $resac = db_query("insert into db_acount values($acount,2234,17304,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me14_i_ano'))."','$this->me14_i_ano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me14_i_mes"]) || $this->me14_i_mes != "")
           $resac = db_query("insert into db_acount values($acount,2234,17303,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me14_i_mes'))."','$this->me14_i_mes',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me14_i_periodocalendario"]) || $this->me14_i_periodocalendario != "")
           $resac = db_query("insert into db_acount values($acount,2234,17305,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me14_i_periodocalendario'))."','$this->me14_i_periodocalendario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["me14_d_data"]) || $this->me14_d_data != "")
           $resac = db_query("insert into db_acount values($acount,2234,12761,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'me14_d_data'))."','$this->me14_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($me14_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2234,12758,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me14_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2234,12759,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me14_f_peso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2234,12760,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me14_f_altura'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2234,12762,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me14_i_aluno'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2234,17304,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me14_i_ano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2234,17303,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me14_i_mes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2234,17305,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me14_i_periodocalendario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2234,12761,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'me14_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
