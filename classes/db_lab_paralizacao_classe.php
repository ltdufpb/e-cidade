...
class cl_lab_paralizacao { 
   ...
   public $la37_i_codigo = 0; 
   public $la37_i_laboratorio = 0; 
   public $la37_d_ini_dia = null; 
   public $la37_d_ini_mes = null; 
   public $la37_d_ini_ano = null; 
   public $la37_d_ini = null; 
   public $la37_d_fim_dia = null; 
   public $la37_d_fim_mes = null; 
   public $la37_d_fim_ano = null; 
   public $la37_d_fim = null; 
   public $la37_c_horaini = null; 
   public $la37_c_horafim = null; 
   public $la37_i_motivo = 0; 
   ...
   function incluir ($la37_i_codigo){ 
     ...
     if($la37_i_codigo == "" || $la37_i_codigo == null ){
       ...
       $this->la37_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from lab_paralizacao_la37_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $la37_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2778,15799,'','".AddSlashes(pg_fetch_result($resaco,0,'la37_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2778,15800,'','".AddSlashes(pg_fetch_result($resaco,0,'la37_i_laboratorio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2778,15801,'','".AddSlashes(pg_fetch_result($resaco,0,'la37_d_ini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2778,15802,'','".AddSlashes(pg_fetch_result($resaco,0,'la37_d_fim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2778,15803,'','".AddSlashes(pg_fetch_result($resaco,0,'la37_c_horaini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2778,15804,'','".AddSlashes(pg_fetch_result($resaco,0,'la37_c_horafim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2778,17720,'','".AddSlashes(pg_fetch_result($resaco,0,'la37_i_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($la37_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->la37_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la37_i_codigo"])){ 
       $sql  .= $virgula." la37_i_codigo = $this->la37_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->la37_i_codigo) == null ){ 
     ...
     if(trim((string) $this->la37_i_laboratorio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la37_i_laboratorio"])){ 
       $sql  .= $virgula." la37_i_laboratorio = $this->la37_i_laboratorio ";
       $virgula = ",";
       if(trim((string) $this->la37_i_laboratorio) == null ){ 
         $this->erro_sql = " Campo Laboratório nao Informado.";
         $this->erro_campo = "la37_i_laboratorio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->la37_d_ini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la37_d_ini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["la37_d_ini_dia"] !="") ){ 
       $sql  .= $virgula." la37_d_ini = '$this->la37_d_ini' ";
       $virgula = ",";
       if(trim((string) $this->la37_d_ini) == null ){ 
         $this->erro_sql = " Campo Início nao Informado.";
         $this->erro_campo = "la37_d_ini_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->la37_d_fim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la37_d_fim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["la37_d_fim_dia"] !="") ){ 
       $sql  .= $virgula." la37_d_fim = '$this->la37_d_fim' ";
       $virgula = ",";
       if(trim((string) $this->la37_d_fim) == null ){ 
         $this->erro_sql = " Campo Fim nao Informado.";
         $this->erro_campo = "la37_d_fim_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->la37_c_horaini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la37_c_horaini"])){ 
       $sql  .= $virgula." la37_c_horaini = '$this->la37_c_horaini' ";
       $virgula = ",";
     }
     if(trim((string) $this->la37_c_horafim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la37_c_horafim"])){ 
       $sql  .= $virgula." la37_c_horafim = '$this->la37_c_horafim' ";
       $virgula = ",";
     }
     if(trim((string) $this->la37_i_motivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la37_i_motivo"])){ 
       $sql  .= $virgula." la37_i_motivo = $this->la37_i_motivo ";
       $virgula = ",";
       if(trim((string) $this->la37_i_motivo) == null ){ 
         $this->erro_sql = " Campo Motivo da paralisação nao Informado.";
         $this->erro_campo = "la37_i_motivo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["la37_i_codigo"]) || $this->la37_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2778,15799,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la37_i_codigo'))."','$this->la37_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la37_i_laboratorio"]) || $this->la37_i_laboratorio != "")
           $resac = db_query("insert into db_acount values($acount,2778,15800,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la37_i_laboratorio'))."','$this->la37_i_laboratorio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la37_d_ini"]) || $this->la37_d_ini != "")
           $resac = db_query("insert into db_acount values($acount,2778,15801,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la37_d_ini'))."','$this->la37_d_ini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la37_d_fim"]) || $this->la37_d_fim != "")
           $resac = db_query("insert into db_acount values($acount,2778,15802,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la37_d_fim'))."','$this->la37_d_fim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la37_c_horaini"]) || $this->la37_c_horaini != "")
           $resac = db_query("insert into db_acount values($acount,2778,15803,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la37_c_horaini'))."','$this->la37_c_horaini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la37_c_horafim"]) || $this->la37_c_horafim != "")
           $resac = db_query("insert into db_acount values($acount,2778,15804,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la37_c_horafim'))."','$this->la37_c_horafim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la37_i_motivo"]) || $this->la37_i_motivo != "")
           $resac = db_query("insert into db_acount values($acount,2778,17720,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la37_i_motivo'))."','$this->la37_i_motivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($la37_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2778,15799,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la37_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2778,15800,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la37_i_laboratorio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2778,15801,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la37_d_ini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2778,15802,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la37_d_fim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2778,15803,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la37_c_horaini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2778,15804,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la37_c_horafim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2778,17720,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la37_i_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
