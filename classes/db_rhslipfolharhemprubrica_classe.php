...
class cl_rhslipfolharhemprubrica { 
   ...
   public $rh80_sequencial = 0; 
   public $rh80_rhslipfolha = 0; 
   public $rh80_rhempenhofolharubrica = 0; 
   ...
   function incluir ($rh80_sequencial){ 
     ...
     if($rh80_sequencial == "" || $rh80_sequencial == null ){
       ...
       $this->rh80_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhslipfolharhemprubrica_rh80_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh80_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2542,14423,'','".AddSlashes(pg_fetch_result($resaco,0,'rh80_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2542,14425,'','".AddSlashes(pg_fetch_result($resaco,0,'rh80_rhslipfolha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2542,14424,'','".AddSlashes(pg_fetch_result($resaco,0,'rh80_rhempenhofolharubrica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh80_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh80_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh80_sequencial"])){ 
       $sql  .= $virgula." rh80_sequencial = $this->rh80_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh80_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh80_rhslipfolha)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh80_rhslipfolha"])){ 
       $sql  .= $virgula." rh80_rhslipfolha = $this->rh80_rhslipfolha ";
       $virgula = ",";
       if(trim((string) $this->rh80_rhslipfolha) == null ){ 
         $this->erro_sql = " Campo rhslipfolha nao Informado.";
         $this->erro_campo = "rh80_rhslipfolha";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh80_rhempenhofolharubrica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh80_rhempenhofolharubrica"])){ 
       $sql  .= $virgula." rh80_rhempenhofolharubrica = $this->rh80_rhempenhofolharubrica ";
       $virgula = ",";
       if(trim((string) $this->rh80_rhempenhofolharubrica) == null ){ 
         $this->erro_sql = " Campo rhempenhofolharubrica nao Informado.";
         $this->erro_campo = "rh80_rhempenhofolharubrica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh80_sequencial"]) || $this->rh80_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2542,14423,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh80_sequencial'))."','$this->rh80_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh80_rhslipfolha"]) || $this->rh80_rhslipfolha != "")
           $resac = db_query("insert into db_acount values($acount,2542,14425,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh80_rhslipfolha'))."','$this->rh80_rhslipfolha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh80_rhempenhofolharubrica"]) || $this->rh80_rhempenhofolharubrica != "")
           $resac = db_query("insert into db_acount values($acount,2542,14424,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh80_rhempenhofolharubrica'))."','$this->rh80_rhempenhofolharubrica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($rh80_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2542,14423,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh80_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2542,14425,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh80_rhslipfolha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2542,14424,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh80_rhempenhofolharubrica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
