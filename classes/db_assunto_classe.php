...
class cl_assunto { 
   ...
   public $bi15_codigo = 0; 
   public $bi15_assunto = null; 
   public $bi15_acervo = 0; 
   ...
   function incluir ($bi15_codigo){ 
     ...
     if($bi15_codigo == "" || $bi15_codigo == null ){
       ...
       $this->bi15_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from assunto_bi15_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $bi15_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1008020,1008154,'','".AddSlashes(pg_fetch_result($resaco,0,'bi15_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1008020,1008155,'','".AddSlashes(pg_fetch_result($resaco,0,'bi15_assunto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1008020,1008156,'','".AddSlashes(pg_fetch_result($resaco,0,'bi15_acervo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($bi15_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->bi15_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["bi15_codigo"])){ 
       $sql  .= $virgula." bi15_codigo = $this->bi15_codigo ";
       $virgula = ",";
       if(trim((string) $this->bi15_codigo) == null ){ 
     ...
     if(trim((string) $this->bi15_assunto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["bi15_assunto"])){ 
       $sql  .= $virgula." bi15_assunto = '$this->bi15_assunto' ";
       $virgula = ",";
       if(trim((string) $this->bi15_assunto) == null ){ 
         $this->erro_sql = " Campo Assunto nao Informado.";
         $this->erro_campo = "bi15_assunto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->bi15_acervo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["bi15_acervo"])){ 
       $sql  .= $virgula." bi15_acervo = $this->bi15_acervo ";
       $virgula = ",";
       if(trim((string) $this->bi15_acervo) == null ){ 
         $this->erro_sql = " Campo Acervo nao Informado.";
         $this->erro_campo = "bi15_acervo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["bi15_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1008020,1008154,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'bi15_codigo'))."','$this->bi15_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["bi15_assunto"]))
           $resac = db_query("insert into db_acount values($acount,1008020,1008155,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'bi15_assunto'))."','$this->bi15_assunto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["bi15_acervo"]))
           $resac = db_query("insert into db_acount values($acount,1008020,1008156,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'bi15_acervo'))."','$this->bi15_acervo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($bi15_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1008020,1008154,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'bi15_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1008020,1008155,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'bi15_assunto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1008020,1008156,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'bi15_acervo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
