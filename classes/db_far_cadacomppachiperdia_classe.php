...
class cl_far_cadacomppachiperdia { 
   ...
   public $fa50_i_codigo = 0; 
   public $fa50_i_triagem = 0; 
   public $fa50_i_cgsund = 0; 
   public $fa50_i_outrosmedicamentos = 0; 
   public $fa50_i_tipo = 0; 
   public $fa50_i_naomedicamentoso = 0; 
   public $fa50_i_diabetesacomp = 0; 
   public $fa50_i_hipertensaoacomp = 0; 
   public $fa50_i_exportado = 0; 
   ...
   function incluir ($fa50_i_codigo){ 
     ...
     if($fa50_i_codigo == "" || $fa50_i_codigo == null ){
       ...
       $this->fa50_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_cadacomppachiperdia_fa50_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa50_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3052,17251,'','".AddSlashes(pg_fetch_result($resaco,0,'fa50_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3052,17252,'','".AddSlashes(pg_fetch_result($resaco,0,'fa50_i_triagem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3052,17253,'','".AddSlashes(pg_fetch_result($resaco,0,'fa50_i_cgsund'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3052,17254,'','".AddSlashes(pg_fetch_result($resaco,0,'fa50_i_outrosmedicamentos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3052,17255,'','".AddSlashes(pg_fetch_result($resaco,0,'fa50_i_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3052,17256,'','".AddSlashes(pg_fetch_result($resaco,0,'fa50_i_naomedicamentoso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3052,17257,'','".AddSlashes(pg_fetch_result($resaco,0,'fa50_i_diabetesacomp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3052,17258,'','".AddSlashes(pg_fetch_result($resaco,0,'fa50_i_hipertensaoacomp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3052,17259,'','".AddSlashes(pg_fetch_result($resaco,0,'fa50_i_exportado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa50_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa50_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_codigo"])){ 
       $sql  .= $virgula." fa50_i_codigo = $this->fa50_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa50_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa50_i_triagem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_triagem"])){ 
       $sql  .= $virgula." fa50_i_triagem = $this->fa50_i_triagem ";
       $virgula = ",";
       if(trim((string) $this->fa50_i_triagem) == null ){ 
         $this->erro_sql = " Campo Triagem nao Informado.";
         $this->erro_campo = "fa50_i_triagem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa50_i_cgsund)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_cgsund"])){ 
       $sql  .= $virgula." fa50_i_cgsund = $this->fa50_i_cgsund ";
       $virgula = ",";
       if(trim((string) $this->fa50_i_cgsund) == null ){ 
         $this->erro_sql = " Campo CGS nao Informado.";
         $this->erro_campo = "fa50_i_cgsund";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa50_i_outrosmedicamentos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_outrosmedicamentos"])){ 
       $sql  .= $virgula." fa50_i_outrosmedicamentos = $this->fa50_i_outrosmedicamentos ";
       $virgula = ",";
       if(trim((string) $this->fa50_i_outrosmedicamentos) == null ){ 
         $this->erro_sql = " Campo Outros medicamentos nao Informado.";
         $this->erro_campo = "fa50_i_outrosmedicamentos";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa50_i_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_tipo"])){ 
       $sql  .= $virgula." fa50_i_tipo = $this->fa50_i_tipo ";
       $virgula = ",";
       if(trim((string) $this->fa50_i_tipo) == null ){ 
         $this->erro_sql = " Campo Tipo nao Informado.";
         $this->erro_campo = "fa50_i_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa50_i_naomedicamentoso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_naomedicamentoso"])){ 
       $sql  .= $virgula." fa50_i_naomedicamentoso = $this->fa50_i_naomedicamentoso ";
       $virgula = ",";
       if(trim((string) $this->fa50_i_naomedicamentoso) == null ){ 
         $this->erro_sql = " Campo Não medicamentoso nao Informado.";
         $this->erro_campo = "fa50_i_naomedicamentoso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa50_i_diabetesacomp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_diabetesacomp"])){ 
       $sql  .= $virgula." fa50_i_diabetesacomp = $this->fa50_i_diabetesacomp ";
       $virgula = ",";
       if(trim((string) $this->fa50_i_diabetesacomp) == null ){ 
         $this->erro_sql = " Campo Diabetes nao Informado.";
         $this->erro_campo = "fa50_i_diabetesacomp";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa50_i_hipertensaoacomp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_hipertensaoacomp"])){ 
       $sql  .= $virgula." fa50_i_hipertensaoacomp = $this->fa50_i_hipertensaoacomp ";
       $virgula = ",";
       if(trim((string) $this->fa50_i_hipertensaoacomp) == null ){ 
         $this->erro_sql = " Campo Hipertensão nao Informado.";
         $this->erro_campo = "fa50_i_hipertensaoacomp";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa50_i_exportado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_exportado"])){ 
       $sql  .= $virgula." fa50_i_exportado = $this->fa50_i_exportado ";
       $virgula = ",";
       if(trim((string) $this->fa50_i_exportado) == null ){ 
         $this->erro_sql = " Campo Exportado nao Informado.";
         $this->erro_campo = "fa50_i_exportado";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_codigo"]) || $this->fa50_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,3052,17251,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa50_i_codigo'))."','$this->fa50_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_triagem"]) || $this->fa50_i_triagem != "")
           $resac = db_query("insert into db_acount values($acount,3052,17252,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa50_i_triagem'))."','$this->fa50_i_triagem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_cgsund"]) || $this->fa50_i_cgsund != "")
           $resac = db_query("insert into db_acount values($acount,3052,17253,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa50_i_cgsund'))."','$this->fa50_i_cgsund',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_outrosmedicamentos"]) || $this->fa50_i_outrosmedicamentos != "")
           $resac = db_query("insert into db_acount values($acount,3052,17254,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa50_i_outrosmedicamentos'))."','$this->fa50_i_outrosmedicamentos',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_tipo"]) || $this->fa50_i_tipo != "")
           $resac = db_query("insert into db_acount values($acount,3052,17255,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa50_i_tipo'))."','$this->fa50_i_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_naomedicamentoso"]) || $this->fa50_i_naomedicamentoso != "")
           $resac = db_query("insert into db_acount values($acount,3052,17256,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa50_i_naomedicamentoso'))."','$this->fa50_i_naomedicamentoso',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_diabetesacomp"]) || $this->fa50_i_diabetesacomp != "")
           $resac = db_query("insert into db_acount values($acount,3052,17257,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa50_i_diabetesacomp'))."','$this->fa50_i_diabetesacomp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_hipertensaoacomp"]) || $this->fa50_i_hipertensaoacomp != "")
           $resac = db_query("insert into db_acount values($acount,3052,17258,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa50_i_hipertensaoacomp'))."','$this->fa50_i_hipertensaoacomp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa50_i_exportado"]) || $this->fa50_i_exportado != "")
           $resac = db_query("insert into db_acount values($acount,3052,17259,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa50_i_exportado'))."','$this->fa50_i_exportado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa50_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3052,17251,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa50_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3052,17252,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa50_i_triagem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3052,17253,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa50_i_cgsund'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3052,17254,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa50_i_outrosmedicamentos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3052,17255,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa50_i_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3052,17256,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa50_i_naomedicamentoso'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3052,17257,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa50_i_diabetesacomp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3052,17258,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa50_i_hipertensaoacomp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3052,17259,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa50_i_exportado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
