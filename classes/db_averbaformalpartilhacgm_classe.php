...
class cl_averbaformalpartilhacgm { 
   ...
   public $j102_sequencial = 0; 
   public $j102_numcgm = 0; 
   public $j102_averbaformalpartilha = 0; 
   ...
   function incluir ($j102_sequencial){ 
     ...
     if($j102_sequencial == "" || $j102_sequencial == null ){
       ...
       $this->j102_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from averbaformalpartilhacgm_j102_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $j102_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2010,11677,'','".AddSlashes(pg_fetch_result($resaco,0,'j102_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2010,11678,'','".AddSlashes(pg_fetch_result($resaco,0,'j102_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2010,11679,'','".AddSlashes(pg_fetch_result($resaco,0,'j102_averbaformalpartilha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j102_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j102_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j102_sequencial"])){ 
       $sql  .= $virgula." j102_sequencial = $this->j102_sequencial ";
       $virgula = ",";
       if(trim((string) $this->j102_sequencial) == null ){ 
     ...
     if(trim((string) $this->j102_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j102_numcgm"])){ 
       $sql  .= $virgula." j102_numcgm = $this->j102_numcgm ";
       $virgula = ",";
       if(trim((string) $this->j102_numcgm) == null ){ 
         $this->erro_sql = " Campo CGM nao Informado.";
         $this->erro_campo = "j102_numcgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j102_averbaformalpartilha)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j102_averbaformalpartilha"])){ 
       $sql  .= $virgula." j102_averbaformalpartilha = $this->j102_averbaformalpartilha ";
       $virgula = ",";
       if(trim((string) $this->j102_averbaformalpartilha) == null ){ 
         $this->erro_sql = " Campo Averba sentença Judicial nao Informado.";
         $this->erro_campo = "j102_averbaformalpartilha";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j102_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2010,11677,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j102_sequencial'))."','$this->j102_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j102_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,2010,11678,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j102_numcgm'))."','$this->j102_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j102_averbaformalpartilha"]))
           $resac = db_query("insert into db_acount values($acount,2010,11679,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j102_averbaformalpartilha'))."','$this->j102_averbaformalpartilha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j102_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2010,11677,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j102_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2010,11678,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j102_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2010,11679,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j102_averbaformalpartilha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
