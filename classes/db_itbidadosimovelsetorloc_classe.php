...
class cl_itbidadosimovelsetorloc { 
   ...
   public $it29_sequencial = 0; 
   public $it29_setorloc = 0; 
   public $it29_itbidadosimovel = 0; 
   ...
   function incluir ($it29_sequencial){ 
     ...
     if($it29_sequencial == "" || $it29_sequencial == null ){
       ...
       $this->it29_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from itbidadosimovelsetorloc_it29_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $it29_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2366,13519,'','".AddSlashes(pg_fetch_result($resaco,0,'it29_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2366,13520,'','".AddSlashes(pg_fetch_result($resaco,0,'it29_setorloc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2366,13521,'','".AddSlashes(pg_fetch_result($resaco,0,'it29_itbidadosimovel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($it29_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->it29_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it29_sequencial"])){ 
       $sql  .= $virgula." it29_sequencial = $this->it29_sequencial ";
       $virgula = ",";
       if(trim((string) $this->it29_sequencial) == null ){ 
     ...
     if(trim((string) $this->it29_setorloc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it29_setorloc"])){ 
       $sql  .= $virgula." it29_setorloc = $this->it29_setorloc ";
       $virgula = ",";
       if(trim((string) $this->it29_setorloc) == null ){ 
         $this->erro_sql = " Campo Setor nao Informado.";
         $this->erro_campo = "it29_setorloc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->it29_itbidadosimovel)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it29_itbidadosimovel"])){ 
       $sql  .= $virgula." it29_itbidadosimovel = $this->it29_itbidadosimovel ";
       $virgula = ",";
       if(trim((string) $this->it29_itbidadosimovel) == null ){ 
         $this->erro_sql = " Campo Dados Imovel nao Informado.";
         $this->erro_campo = "it29_itbidadosimovel";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["it29_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,2366,13519,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'it29_sequencial'))."','$this->it29_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it29_setorloc"]))
           $resac = db_query("insert into db_acount values($acount,2366,13520,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'it29_setorloc'))."','$this->it29_setorloc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it29_itbidadosimovel"]))
           $resac = db_query("insert into db_acount values($acount,2366,13521,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'it29_itbidadosimovel'))."','$this->it29_itbidadosimovel',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($it29_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2366,13519,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'it29_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2366,13520,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'it29_setorloc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2366,13521,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'it29_itbidadosimovel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
