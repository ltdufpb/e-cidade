...
class cl_sau_exames { 
   ...
   public $s108_i_codigo = 0; 
   public $s108_c_exame = null; 
   public $s108_i_grupoexame = 0; 
   ...
   function incluir ($s108_i_codigo){ 
     ...
     if($s108_i_codigo == "" || $s108_i_codigo == null ){
       ...
       $this->s108_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from sau_exame_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $s108_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2372,13547,'','".AddSlashes(pg_fetch_result($resaco,0,'s108_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2372,13548,'','".AddSlashes(pg_fetch_result($resaco,0,'s108_c_exame'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2372,14324,'','".AddSlashes(pg_fetch_result($resaco,0,'s108_i_grupoexame'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($s108_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->s108_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s108_i_codigo"])){ 
       $sql  .= $virgula." s108_i_codigo = $this->s108_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->s108_i_codigo) == null ){ 
     ...
     if(trim((string) $this->s108_c_exame)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s108_c_exame"])){ 
       $sql  .= $virgula." s108_c_exame = '$this->s108_c_exame' ";
       $virgula = ",";
       if(trim((string) $this->s108_c_exame) == null ){ 
         $this->erro_sql = " Campo Exame nao Informado.";
         $this->erro_campo = "s108_c_exame";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->s108_i_grupoexame)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s108_i_grupoexame"])){ 
       $sql  .= $virgula." s108_i_grupoexame = $this->s108_i_grupoexame ";
       $virgula = ",";
       if(trim((string) $this->s108_i_grupoexame) == null ){ 
         $this->erro_sql = " Campo Grupo do Exame nao Informado.";
         $this->erro_campo = "s108_i_grupoexame";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s108_i_codigo"]) || $this->s108_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2372,13547,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s108_i_codigo'))."','$this->s108_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s108_c_exame"]) || $this->s108_c_exame != "")
           $resac = db_query("insert into db_acount values($acount,2372,13548,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s108_c_exame'))."','$this->s108_c_exame',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["s108_i_grupoexame"]) || $this->s108_i_grupoexame != "")
           $resac = db_query("insert into db_acount values($acount,2372,14324,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'s108_i_grupoexame'))."','$this->s108_i_grupoexame',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($s108_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2372,13547,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s108_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2372,13548,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s108_c_exame'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2372,14324,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'s108_i_grupoexame'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
