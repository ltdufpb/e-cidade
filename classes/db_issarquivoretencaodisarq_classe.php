...
class cl_issarquivoretencaodisarq {
   ...
   public $q145_sequencial = 0;
   public $q145_issarquivoretencao = 0;
   public $q145_disarq = 0;
   ...
   function incluir ($q145_sequencial){
     ...
     if($q145_sequencial == "" || $q145_sequencial == null ){
       ...
       $this->q145_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from issarquivoretencaodisarq_q145_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q145_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3805,21133,'','".AddSlashes(pg_fetch_result($resaco,0,'q145_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3805,21134,'','".AddSlashes(pg_fetch_result($resaco,0,'q145_issarquivoretencao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3805,21135,'','".AddSlashes(pg_fetch_result($resaco,0,'q145_disarq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   public function alterar ($q145_sequencial=null) {
     ...
     $virgula = "";
     if(trim((string) $this->q145_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q145_sequencial"])){
       $sql  .= $virgula." q145_sequencial = $this->q145_sequencial ";
       $virgula = ",";
       if(trim((string) $this->q145_sequencial) == null ){
     ...
     if(trim((string) $this->q145_issarquivoretencao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q145_issarquivoretencao"])){
       $sql  .= $virgula." q145_issarquivoretencao = $this->q145_issarquivoretencao ";
       $virgula = ",";
       if(trim((string) $this->q145_issarquivoretencao) == null ){
         $this->erro_sql = " Campo Código Arquivo de Retenção não informado.";
         $this->erro_campo = "q145_issarquivoretencao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->q145_disarq)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q145_disarq"])){
       $sql  .= $virgula." q145_disarq = $this->q145_disarq ";
       $virgula = ",";
       if(trim((string) $this->q145_disarq) == null ){
         $this->erro_sql = " Campo Disarq não informado.";
         $this->erro_campo = "q145_disarq";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["q145_sequencial"]) || $this->q145_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3805,21133,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q145_sequencial'))."','$this->q145_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["q145_issarquivoretencao"]) || $this->q145_issarquivoretencao != "")
             $resac = db_query("insert into db_acount values($acount,3805,21134,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q145_issarquivoretencao'))."','$this->q145_issarquivoretencao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["q145_disarq"]) || $this->q145_disarq != "")
             $resac = db_query("insert into db_acount values($acount,3805,21135,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'q145_disarq'))."','$this->q145_disarq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3805,21133,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q145_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3805,21134,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q145_issarquivoretencao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3805,21135,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'q145_disarq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
