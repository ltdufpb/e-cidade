...
class cl_rhestagioperiodo { 
   ...
   public $h55_sequencial = 0; 
   public $h55_rhestagio = 0; 
   public $h55_descr = null; 
   public $h55_nroaval = 0; 
   ...
   function incluir ($h55_sequencial){ 
     ...
     if($h55_sequencial == "" || $h55_sequencial == null ){
       ...
       $this->h55_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhestagioperiodo_h55_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h55_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1871,10863,'','".AddSlashes(pg_fetch_result($resaco,0,'h55_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1871,10864,'','".AddSlashes(pg_fetch_result($resaco,0,'h55_rhestagio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1871,10865,'','".AddSlashes(pg_fetch_result($resaco,0,'h55_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1871,10866,'','".AddSlashes(pg_fetch_result($resaco,0,'h55_nroaval'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h55_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h55_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h55_sequencial"])){ 
       $sql  .= $virgula." h55_sequencial = $this->h55_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h55_sequencial) == null ){ 
     ...
     if(trim((string) $this->h55_rhestagio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h55_rhestagio"])){ 
       $sql  .= $virgula." h55_rhestagio = $this->h55_rhestagio ";
       $virgula = ",";
       if(trim((string) $this->h55_rhestagio) == null ){ 
         $this->erro_sql = " Campo Cód. estágio nao Informado.";
         $this->erro_campo = "h55_rhestagio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h55_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h55_descr"])){ 
       $sql  .= $virgula." h55_descr = '$this->h55_descr' ";
       $virgula = ",";
       if(trim((string) $this->h55_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "h55_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h55_nroaval)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h55_nroaval"])){ 
       $sql  .= $virgula." h55_nroaval = $this->h55_nroaval ";
       $virgula = ",";
       if(trim((string) $this->h55_nroaval) == null ){ 
         $this->erro_sql = " Campo Número de Avaliações nao Informado.";
         $this->erro_campo = "h55_nroaval";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h55_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1871,10863,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h55_sequencial'))."','$this->h55_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h55_rhestagio"]))
           $resac = db_query("insert into db_acount values($acount,1871,10864,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h55_rhestagio'))."','$this->h55_rhestagio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h55_descr"]))
           $resac = db_query("insert into db_acount values($acount,1871,10865,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h55_descr'))."','$this->h55_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h55_nroaval"]))
           $resac = db_query("insert into db_acount values($acount,1871,10866,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h55_nroaval'))."','$this->h55_nroaval',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h55_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1871,10863,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h55_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1871,10864,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h55_rhestagio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1871,10865,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h55_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1871,10866,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h55_nroaval'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
