...
class cl_desdobramentosliberadosordemcompra { 
   ...
   public $pc33_sequencial = 0; 
   public $pc33_codele = 0; 
   public $pc33_anousu = 0; 
   ...
   function incluir ($pc33_sequencial){ 
     ...
     if($pc33_sequencial == "" || $pc33_sequencial == null ){
       ...
       $this->pc33_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from desdobramentosliberadosordemcompra_pc33_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $pc33_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2697,15320,'','".AddSlashes(pg_fetch_result($resaco,0,'pc33_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2697,15321,'','".AddSlashes(pg_fetch_result($resaco,0,'pc33_codele'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2697,15322,'','".AddSlashes(pg_fetch_result($resaco,0,'pc33_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc33_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->pc33_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc33_sequencial"])){ 
       $sql  .= $virgula." pc33_sequencial = $this->pc33_sequencial ";
       $virgula = ",";
       if(trim((string) $this->pc33_sequencial) == null ){ 
     ...
     if(trim((string) $this->pc33_codele)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc33_codele"])){ 
       $sql  .= $virgula." pc33_codele = $this->pc33_codele ";
       $virgula = ",";
       if(trim((string) $this->pc33_codele) == null ){ 
         $this->erro_sql = " Campo Cod Elemento nao Informado.";
         $this->erro_campo = "pc33_codele";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->pc33_anousu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc33_anousu"])){ 
       $sql  .= $virgula." pc33_anousu = $this->pc33_anousu ";
       $virgula = ",";
       if(trim((string) $this->pc33_anousu) == null ){ 
         $this->erro_sql = " Campo Ano Uso nao Informado.";
         $this->erro_campo = "pc33_anousu";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc33_sequencial"]) || $this->pc33_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2697,15320,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc33_sequencial'))."','$this->pc33_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc33_codele"]) || $this->pc33_codele != "")
           $resac = db_query("insert into db_acount values($acount,2697,15321,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc33_codele'))."','$this->pc33_codele',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc33_anousu"]) || $this->pc33_anousu != "")
           $resac = db_query("insert into db_acount values($acount,2697,15322,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'pc33_anousu'))."','$this->pc33_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($pc33_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2697,15320,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc33_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2697,15321,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc33_codele'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2697,15322,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'pc33_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
