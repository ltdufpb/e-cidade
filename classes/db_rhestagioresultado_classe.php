...
class cl_rhestagioresultado { 
   ...
   public $h65_sequencial = 0; 
   public $h65_rhestagioagenda = 0; 
   public $h65_data_dia = null; 
   public $h65_data_mes = null; 
   public $h65_data_ano = null; 
   public $h65_data = null; 
   public $h65_rhportaria = 0; 
   public $h65_resultado = null; 
   public $h65_pontos = 0; 
   public $h65_observacao = null; 
   ...
   function incluir ($h65_sequencial){ 
     ...
     if($h65_sequencial == "" || $h65_sequencial == null ){
       ...
       $this->h65_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhestagioresultado_h65_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h65_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1888,10935,'','".AddSlashes(pg_fetch_result($resaco,0,'h65_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1888,10936,'','".AddSlashes(pg_fetch_result($resaco,0,'h65_rhestagioagenda'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1888,10940,'','".AddSlashes(pg_fetch_result($resaco,0,'h65_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1888,10938,'','".AddSlashes(pg_fetch_result($resaco,0,'h65_rhportaria'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1888,10937,'','".AddSlashes(pg_fetch_result($resaco,0,'h65_resultado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1888,10939,'','".AddSlashes(pg_fetch_result($resaco,0,'h65_pontos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1888,10941,'','".AddSlashes(pg_fetch_result($resaco,0,'h65_observacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h65_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h65_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h65_sequencial"])){ 
       $sql  .= $virgula." h65_sequencial = $this->h65_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h65_sequencial) == null ){ 
     ...
     if(trim((string) $this->h65_rhestagioagenda)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h65_rhestagioagenda"])){ 
       $sql  .= $virgula." h65_rhestagioagenda = $this->h65_rhestagioagenda ";
       $virgula = ",";
       if(trim((string) $this->h65_rhestagioagenda) == null ){ 
         $this->erro_sql = " Campo Código do Estágio nao Informado.";
         $this->erro_campo = "h65_rhestagioagenda";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h65_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h65_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["h65_data_dia"] !="") ){ 
       $sql  .= $virgula." h65_data = '$this->h65_data' ";
       $virgula = ",";
       if(trim((string) $this->h65_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "h65_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h65_rhportaria)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h65_rhportaria"])){ 
       $sql  .= $virgula." h65_rhportaria = $this->h65_rhportaria ";
       $virgula = ",";
       if(trim((string) $this->h65_rhportaria) == null ){ 
         $this->erro_sql = " Campo Código da Portaria nao Informado.";
         $this->erro_campo = "h65_rhportaria";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h65_resultado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h65_resultado"])){ 
       $sql  .= $virgula." h65_resultado = '$this->h65_resultado' ";
       $virgula = ",";
       if(trim((string) $this->h65_resultado) == null ){ 
         $this->erro_sql = " Campo Resultado nao Informado.";
         $this->erro_campo = "h65_resultado";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h65_pontos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h65_pontos"])){ 
       $sql  .= $virgula." h65_pontos = $this->h65_pontos ";
       $virgula = ",";
       if(trim((string) $this->h65_pontos) == null ){ 
         $this->erro_sql = " Campo Pontos Obtidos nao Informado.";
         $this->erro_campo = "h65_pontos";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h65_observacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h65_observacao"])){ 
       $sql  .= $virgula." h65_observacao = '$this->h65_observacao' ";
       $virgula = ",";
       if(trim((string) $this->h65_observacao) == null ){ 
         $this->erro_sql = " Campo Observacoes nao Informado.";
         $this->erro_campo = "h65_observacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h65_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1888,10935,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h65_sequencial'))."','$this->h65_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h65_rhestagioagenda"]))
           $resac = db_query("insert into db_acount values($acount,1888,10936,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h65_rhestagioagenda'))."','$this->h65_rhestagioagenda',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h65_data"]))
           $resac = db_query("insert into db_acount values($acount,1888,10940,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h65_data'))."','$this->h65_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h65_rhportaria"]))
           $resac = db_query("insert into db_acount values($acount,1888,10938,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h65_rhportaria'))."','$this->h65_rhportaria',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h65_resultado"]))
           $resac = db_query("insert into db_acount values($acount,1888,10937,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h65_resultado'))."','$this->h65_resultado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h65_pontos"]))
           $resac = db_query("insert into db_acount values($acount,1888,10939,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h65_pontos'))."','$this->h65_pontos',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h65_observacao"]))
           $resac = db_query("insert into db_acount values($acount,1888,10941,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h65_observacao'))."','$this->h65_observacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h65_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1888,10935,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h65_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1888,10936,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h65_rhestagioagenda'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1888,10940,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h65_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1888,10938,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h65_rhportaria'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1888,10937,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h65_resultado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1888,10939,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h65_pontos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1888,10941,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h65_observacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
