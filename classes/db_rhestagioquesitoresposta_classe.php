...
class cl_rhestagioquesitoresposta { 
   ...
   public $h54_sequencial = 0; 
   public $h54_rhestagioquesitopergunta = 0; 
   public $h54_rhestagiocriterio = 0; 
   public $h54_descr = null; 
   ...
   function incluir ($h54_sequencial){ 
     ...
     if($h54_sequencial == "" || $h54_sequencial == null ){
       ...
       $this->h54_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhestagioquesitoresposta_h54_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h54_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1873,10870,'','".AddSlashes(pg_fetch_result($resaco,0,'h54_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1873,10871,'','".AddSlashes(pg_fetch_result($resaco,0,'h54_rhestagioquesitopergunta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1873,10872,'','".AddSlashes(pg_fetch_result($resaco,0,'h54_rhestagiocriterio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1873,10873,'','".AddSlashes(pg_fetch_result($resaco,0,'h54_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h54_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h54_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h54_sequencial"])){ 
       $sql  .= $virgula." h54_sequencial = $this->h54_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h54_sequencial) == null ){ 
     ...
     if(trim((string) $this->h54_rhestagioquesitopergunta)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h54_rhestagioquesitopergunta"])){ 
       $sql  .= $virgula." h54_rhestagioquesitopergunta = $this->h54_rhestagioquesitopergunta ";
       $virgula = ",";
       if(trim((string) $this->h54_rhestagioquesitopergunta) == null ){ 
         $this->erro_sql = " Campo Cód. Pergunta nao Informado.";
         $this->erro_campo = "h54_rhestagioquesitopergunta";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h54_rhestagiocriterio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h54_rhestagiocriterio"])){ 
       $sql  .= $virgula." h54_rhestagiocriterio = $this->h54_rhestagiocriterio ";
       $virgula = ",";
       if(trim((string) $this->h54_rhestagiocriterio) == null ){ 
         $this->erro_sql = " Campo Cód. Critério nao Informado.";
         $this->erro_campo = "h54_rhestagiocriterio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h54_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h54_descr"])){ 
       $sql  .= $virgula." h54_descr = '$this->h54_descr' ";
       $virgula = ",";
       if(trim((string) $this->h54_descr) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "h54_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h54_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1873,10870,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h54_sequencial'))."','$this->h54_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h54_rhestagioquesitopergunta"]))
           $resac = db_query("insert into db_acount values($acount,1873,10871,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h54_rhestagioquesitopergunta'))."','$this->h54_rhestagioquesitopergunta',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h54_rhestagiocriterio"]))
           $resac = db_query("insert into db_acount values($acount,1873,10872,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h54_rhestagiocriterio'))."','$this->h54_rhestagiocriterio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h54_descr"]))
           $resac = db_query("insert into db_acount values($acount,1873,10873,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h54_descr'))."','$this->h54_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h54_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1873,10870,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h54_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1873,10871,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h54_rhestagioquesitopergunta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1873,10872,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h54_rhestagiocriterio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1873,10873,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h54_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
