...
class cl_fiscalcgm { 
   ...
   function incluir ($y36_codnoti){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,689,4959,'','".AddSlashes(pg_fetch_result($resaco,0,'y36_codnoti'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,689,4960,'','".AddSlashes(pg_fetch_result($resaco,0,'y36_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y36_codnoti=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->y36_codnoti)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y36_codnoti"])){ 
       $sql  .= $virgula." y36_codnoti = $this->y36_codnoti ";
       $virgula = ",";
       if(trim((string) $this->y36_codnoti) == null ){ 
     ...
     if(trim((string) $this->y36_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["y36_numcgm"])){ 
       $sql  .= $virgula." y36_numcgm = $this->y36_numcgm ";
       $virgula = ",";
       if(trim((string) $this->y36_numcgm) == null ){ 
         $this->erro_sql = " Campo Numcgm nao Informado.";
         $this->erro_campo = "y36_numcgm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["y36_codnoti"]))
           $resac = db_query("insert into db_acount values($acount,689,4959,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y36_codnoti'))."','$this->y36_codnoti',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y36_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,689,4960,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'y36_numcgm'))."','$this->y36_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($y36_codnoti=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,689,4959,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y36_codnoti'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,689,4960,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'y36_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
