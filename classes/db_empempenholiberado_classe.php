...
class cl_empempenholiberado { 
   ...
   public $e22_sequencial = 0; 
   public $e22_numemp = 0; 
   public $e22_id_usuario = 0; 
   public $e22_data_dia = null; 
   public $e22_data_mes = null; 
   public $e22_data_ano = null; 
   public $e22_data = null; 
   public $e22_hora = null; 
   ...
   function incluir ($e22_sequencial){ 
     ...
     if($e22_sequencial == "" || $e22_sequencial == null ){
       ...
       $this->e22_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from empempenholiberado_e22_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $e22_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2696,15315,'','".AddSlashes(pg_fetch_result($resaco,0,'e22_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2696,15316,'','".AddSlashes(pg_fetch_result($resaco,0,'e22_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2696,15317,'','".AddSlashes(pg_fetch_result($resaco,0,'e22_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2696,15318,'','".AddSlashes(pg_fetch_result($resaco,0,'e22_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2696,15319,'','".AddSlashes(pg_fetch_result($resaco,0,'e22_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e22_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->e22_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e22_sequencial"])){ 
       $sql  .= $virgula." e22_sequencial = $this->e22_sequencial ";
       $virgula = ",";
       if(trim((string) $this->e22_sequencial) == null ){ 
     ...
     if(trim((string) $this->e22_numemp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e22_numemp"])){ 
       $sql  .= $virgula." e22_numemp = $this->e22_numemp ";
       $virgula = ",";
       if(trim((string) $this->e22_numemp) == null ){ 
         $this->erro_sql = " Campo Numero Empenho nao Informado.";
         $this->erro_campo = "e22_numemp";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e22_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e22_id_usuario"])){ 
       $sql  .= $virgula." e22_id_usuario = $this->e22_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->e22_id_usuario) == null ){ 
         $this->erro_sql = " Campo Cod Usuario nao Informado.";
         $this->erro_campo = "e22_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e22_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e22_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["e22_data_dia"] !="") ){ 
       $sql  .= $virgula." e22_data = '$this->e22_data' ";
       $virgula = ",";
       if(trim((string) $this->e22_data) == null ){ 
         $this->erro_sql = " Campo Data nao Informado.";
         $this->erro_campo = "e22_data_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->e22_hora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e22_hora"])){ 
       $sql  .= $virgula." e22_hora = '$this->e22_hora' ";
       $virgula = ",";
       if(trim((string) $this->e22_hora) == null ){ 
         $this->erro_sql = " Campo Hora nao Informado.";
         $this->erro_campo = "e22_hora";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e22_sequencial"]) || $this->e22_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2696,15315,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e22_sequencial'))."','$this->e22_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e22_numemp"]) || $this->e22_numemp != "")
           $resac = db_query("insert into db_acount values($acount,2696,15316,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e22_numemp'))."','$this->e22_numemp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e22_id_usuario"]) || $this->e22_id_usuario != "")
           $resac = db_query("insert into db_acount values($acount,2696,15317,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e22_id_usuario'))."','$this->e22_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e22_data"]) || $this->e22_data != "")
           $resac = db_query("insert into db_acount values($acount,2696,15318,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e22_data'))."','$this->e22_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e22_hora"]) || $this->e22_hora != "")
           $resac = db_query("insert into db_acount values($acount,2696,15319,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e22_hora'))."','$this->e22_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($e22_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2696,15315,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e22_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2696,15316,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e22_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2696,15317,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e22_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2696,15318,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e22_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2696,15319,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e22_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
