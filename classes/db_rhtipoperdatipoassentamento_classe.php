...
class cl_rhtipoperdatipoassentamento { 
   ...
   public $h71_sequencial = 0; 
   public $h71_rhtipoperda = 0; 
   public $h71_tipoassentamento = 0; 
   ...
   function incluir ($h71_sequencial){ 
     ...
     if($h71_sequencial == "" || $h71_sequencial == null ){
       ...
       $this->h71_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from rhtipoperdatipoassentamento_h71_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $h71_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3314,18706,'','".AddSlashes(pg_fetch_result($resaco,0,'h71_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3314,18707,'','".AddSlashes(pg_fetch_result($resaco,0,'h71_rhtipoperda'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3314,18708,'','".AddSlashes(pg_fetch_result($resaco,0,'h71_tipoassentamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($h71_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->h71_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h71_sequencial"])){ 
       $sql  .= $virgula." h71_sequencial = $this->h71_sequencial ";
       $virgula = ",";
       if(trim((string) $this->h71_sequencial) == null ){ 
     ...
     if(trim((string) $this->h71_rhtipoperda)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h71_rhtipoperda"])){ 
       $sql  .= $virgula." h71_rhtipoperda = $this->h71_rhtipoperda ";
       $virgula = ",";
       if(trim((string) $this->h71_rhtipoperda) == null ){ 
         $this->erro_sql = " Campo TIpo de perda nao Informado.";
         $this->erro_campo = "h71_rhtipoperda";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->h71_tipoassentamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["h71_tipoassentamento"])){ 
       $sql  .= $virgula." h71_tipoassentamento = $this->h71_tipoassentamento ";
       $virgula = ",";
       if(trim((string) $this->h71_tipoassentamento) == null ){ 
         $this->erro_sql = " Campo Tipo de assentamento nao Informado.";
         $this->erro_campo = "h71_tipoassentamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h71_sequencial"]) || $this->h71_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3314,18706,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h71_sequencial'))."','$this->h71_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h71_rhtipoperda"]) || $this->h71_rhtipoperda != "")
           $resac = db_query("insert into db_acount values($acount,3314,18707,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h71_rhtipoperda'))."','$this->h71_rhtipoperda',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["h71_tipoassentamento"]) || $this->h71_tipoassentamento != "")
           $resac = db_query("insert into db_acount values($acount,3314,18708,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'h71_tipoassentamento'))."','$this->h71_tipoassentamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($h71_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3314,18706,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h71_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3314,18707,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h71_rhtipoperda'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3314,18708,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'h71_tipoassentamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
