...
class cl_empanulado {
  ...
  function incluir ($e94_codanu){
    ...
    if($e94_codanu == "" || $e94_codanu == null ){
      ...
      $this->e94_codanu = pg_fetch_result($result,0,0);
    }else{
      $result = db_query("select last_value from empanulado_e94_codanu_seq");
      if(($result != false) && (pg_fetch_result($result,0,0) < $e94_codanu)){
    ...
    if(($resaco!=false)||($this->numrows!=0)){
      ...
      $resac = db_query("insert into db_acount values($acount,1030,6325,'','".AddSlashes(pg_fetch_result($resaco,0,'e94_codanu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
      $resac = db_query("insert into db_acount values($acount,1030,6321,'','".AddSlashes(pg_fetch_result($resaco,0,'e94_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
      $resac = db_query("insert into db_acount values($acount,1030,6324,'','".AddSlashes(pg_fetch_result($resaco,0,'e94_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
      $resac = db_query("insert into db_acount values($acount,1030,6323,'','".AddSlashes(pg_fetch_result($resaco,0,'e94_saldoant'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
      $resac = db_query("insert into db_acount values($acount,1030,6322,'','".AddSlashes(pg_fetch_result($resaco,0,'e94_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
      $resac = db_query("insert into db_acount values($acount,1030,6329,'','".AddSlashes(pg_fetch_result($resaco,0,'e94_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
      $resac = db_query("insert into db_acount values($acount,1030,11318,'','".AddSlashes(pg_fetch_result($resaco,0,'e94_empanuladotipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
    }
    return true;
  }
  ...
  function alterar ($e94_codanu=null) {
    ...
    $virgula = "";
    if(trim((string) $this->e94_codanu)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e94_codanu"])){
      $sql  .= $virgula." e94_codanu = $this->e94_codanu ";
      $virgula = ",";
      if(trim((string) $this->e94_codanu) == null ){
    ...
    if(trim((string) $this->e94_numemp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e94_numemp"])){
      $sql  .= $virgula." e94_numemp = $this->e94_numemp ";
      $virgula = ",";
      if(trim((string) $this->e94_numemp) == null ){
        $this->erro_sql = " Campo Número nao Informado.";
        $this->erro_campo = "e94_numemp";
        $this->erro_banco = "";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
    ...
    if(trim((string) $this->e94_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e94_valor"])){
      $sql  .= $virgula." e94_valor = $this->e94_valor ";
      $virgula = ",";
      if(trim((string) $this->e94_valor) == null ){
        $this->erro_sql = " Campo Valor anulado nao Informado.";
        $this->erro_campo = "e94_valor";
        $this->erro_banco = "";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
    ...
    if(trim((string) $this->e94_saldoant)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e94_saldoant"])){
      $sql  .= $virgula." e94_saldoant = $this->e94_saldoant ";
      $virgula = ",";
      if(trim((string) $this->e94_saldoant) == null ){
        $this->erro_sql = " Campo Saldo anterior nao Informado.";
        $this->erro_campo = "e94_saldoant";
        $this->erro_banco = "";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
    ...
    if(trim((string) $this->e94_data)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e94_data_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["e94_data_dia"] !="") ){
      $sql  .= $virgula." e94_data = '$this->e94_data' ";
      $virgula = ",";
      if(trim((string) $this->e94_data) == null ){
        $this->erro_sql = " Campo Data anulação nao Informado.";
        $this->erro_campo = "e94_data_dia";
        $this->erro_banco = "";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
    ...
    if(trim((string) $this->e94_motivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e94_motivo"])){
      $sql  .= $virgula." e94_motivo = '$this->e94_motivo' ";
      $virgula = ",";
      if(trim((string) $this->e94_motivo) == null ){
        $this->erro_sql = " Campo Motivo nao Informado.";
        $this->erro_campo = "e94_motivo";
        $this->erro_banco = "";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
    ...
    if(trim((string) $this->e94_empanuladotipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e94_empanuladotipo"])){
      if(trim((string) $this->e94_empanuladotipo)=="" && isset($GLOBALS["HTTP_POST_VARS"]["e94_empanuladotipo"])){
        $this->e94_empanuladotipo = "0" ;
      }
    ...
    if($this->numrows>0){
      for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
        ...
        if(isset($GLOBALS["HTTP_POST_VARS"]["e94_codanu"]))
          $resac = db_query("insert into db_acount values($acount,1030,6325,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e94_codanu'))."','$this->e94_codanu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        if(isset($GLOBALS["HTTP_POST_VARS"]["e94_numemp"]))
          $resac = db_query("insert into db_acount values($acount,1030,6321,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e94_numemp'))."','$this->e94_numemp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        if(isset($GLOBALS["HTTP_POST_VARS"]["e94_valor"]))
          $resac = db_query("insert into db_acount values($acount,1030,6324,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e94_valor'))."','$this->e94_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        if(isset($GLOBALS["HTTP_POST_VARS"]["e94_saldoant"]))
          $resac = db_query("insert into db_acount values($acount,1030,6323,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e94_saldoant'))."','$this->e94_saldoant',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        if(isset($GLOBALS["HTTP_POST_VARS"]["e94_data"]))
          $resac = db_query("insert into db_acount values($acount,1030,6322,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e94_data'))."','$this->e94_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        if(isset($GLOBALS["HTTP_POST_VARS"]["e94_motivo"]))
          $resac = db_query("insert into db_acount values($acount,1030,6329,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e94_motivo'))."','$this->e94_motivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        if(isset($GLOBALS["HTTP_POST_VARS"]["e94_empanuladotipo"]))
          $resac = db_query("insert into db_acount values($acount,1030,11318,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'e94_empanuladotipo'))."','$this->e94_empanuladotipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
      }
    }
    $result = db_query($sql);
    if($result==false){
  ...
  function excluir ($e94_codanu=null,$dbwhere=null) {
    ...
    if(($resaco!=false)||($this->numrows!=0)){
      for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
        ...
        $resac = db_query("insert into db_acount values($acount,1030,6325,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e94_codanu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        $resac = db_query("insert into db_acount values($acount,1030,6321,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e94_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        $resac = db_query("insert into db_acount values($acount,1030,6324,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e94_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        $resac = db_query("insert into db_acount values($acount,1030,6323,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e94_saldoant'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        $resac = db_query("insert into db_acount values($acount,1030,6322,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e94_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        $resac = db_query("insert into db_acount values($acount,1030,6329,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e94_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        $resac = db_query("insert into db_acount values($acount,1030,11318,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'e94_empanuladotipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
      }
    }
