...
class cl_mensagerialicenca { 
   ...
   public $am14_sequencial = 0; 
   public $am14_assunto = null; 
   public $am14_mensagem = null; 
   ...
   function incluir ($am14_sequencial){ 
     ...
     if($am14_sequencial == "" || $am14_sequencial == null ){
       ...
       $this->am14_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from mensagerialicenca_am14_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $am14_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3778,20974,'','".AddSlashes(pg_fetch_result($resaco,0,'am14_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3778,20975,'','".AddSlashes(pg_fetch_result($resaco,0,'am14_assunto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3778,20976,'','".AddSlashes(pg_fetch_result($resaco,0,'am14_mensagem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   public function alterar ($am14_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->am14_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["am14_sequencial"])){ 
       $sql  .= $virgula." am14_sequencial = $this->am14_sequencial ";
       $virgula = ",";
       if(trim((string) $this->am14_sequencial) == null ){ 
     ...
     if(trim((string) $this->am14_assunto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["am14_assunto"])){ 
       $sql  .= $virgula." am14_assunto = '$this->am14_assunto' ";
       $virgula = ",";
       if(trim((string) $this->am14_assunto) == null ){ 
         $this->erro_sql = " Campo Assunto não informado.";
         $this->erro_campo = "am14_assunto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->am14_mensagem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["am14_mensagem"])){ 
       $sql  .= $virgula." am14_mensagem = '$this->am14_mensagem' ";
       $virgula = ",";
       if(trim((string) $this->am14_mensagem) == null ){ 
         $this->erro_sql = " Campo Mensagem não informado.";
         $this->erro_campo = "am14_mensagem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["am14_sequencial"]) || $this->am14_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3778,20974,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'am14_sequencial'))."','$this->am14_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["am14_assunto"]) || $this->am14_assunto != "")
             $resac = db_query("insert into db_acount values($acount,3778,20975,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'am14_assunto'))."','$this->am14_assunto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["am14_mensagem"]) || $this->am14_mensagem != "")
             $resac = db_query("insert into db_acount values($acount,3778,20976,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'am14_mensagem'))."','$this->am14_mensagem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3778,20974,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'am14_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3778,20975,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'am14_assunto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3778,20976,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'am14_mensagem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
