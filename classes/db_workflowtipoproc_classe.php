...
class cl_workflowtipoproc { 
   ...
   public $db116_sequencial = 0; 
   public $db116_workflow = 0; 
   public $db116_tipoproc = 0; 
   ...
   function incluir ($db116_sequencial){ 
     ...
     if($db116_sequencial == "" || $db116_sequencial == null ){
       ...
       $this->db116_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from workflowtipoproc_db116_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db116_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3153,17859,'','".AddSlashes(pg_fetch_result($resaco,0,'db116_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3153,17860,'','".AddSlashes(pg_fetch_result($resaco,0,'db116_workflow'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3153,17861,'','".AddSlashes(pg_fetch_result($resaco,0,'db116_tipoproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db116_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db116_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db116_sequencial"])){ 
       $sql  .= $virgula." db116_sequencial = $this->db116_sequencial ";
       $virgula = ",";
       if(trim((string) $this->db116_sequencial) == null ){ 
     ...
     if(trim((string) $this->db116_workflow)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db116_workflow"])){ 
       $sql  .= $virgula." db116_workflow = $this->db116_workflow ";
       $virgula = ",";
       if(trim((string) $this->db116_workflow) == null ){ 
         $this->erro_sql = " Campo Código Work Flow nao Informado.";
         $this->erro_campo = "db116_workflow";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db116_tipoproc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db116_tipoproc"])){ 
       $sql  .= $virgula." db116_tipoproc = $this->db116_tipoproc ";
       $virgula = ",";
       if(trim((string) $this->db116_tipoproc) == null ){ 
         $this->erro_sql = " Campo Código Tipo Processo nao Informado.";
         $this->erro_campo = "db116_tipoproc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db116_sequencial"]) || $this->db116_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3153,17859,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db116_sequencial'))."','$this->db116_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db116_workflow"]) || $this->db116_workflow != "")
           $resac = db_query("insert into db_acount values($acount,3153,17860,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db116_workflow'))."','$this->db116_workflow',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db116_tipoproc"]) || $this->db116_tipoproc != "")
           $resac = db_query("insert into db_acount values($acount,3153,17861,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db116_tipoproc'))."','$this->db116_tipoproc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db116_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3153,17859,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db116_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3153,17860,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db116_workflow'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3153,17861,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db116_tipoproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
