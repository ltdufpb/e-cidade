...
class cl_ppaversao { 
   ...
   public $o119_sequencial = 0; 
   public $o119_ppalei = 0; 
   public $o119_idusuario = 0; 
   public $o119_versao = 0; 
   public $o119_finalizada = 'f'; 
   public $o119_datainicio_dia = null; 
   public $o119_datainicio_mes = null; 
   public $o119_datainicio_ano = null; 
   public $o119_datainicio = null; 
   public $o119_datatermino_dia = null; 
   public $o119_datatermino_mes = null; 
   public $o119_datatermino_ano = null; 
   public $o119_datatermino = null; 
   public $o119_versaofinal = 'f'; 
   public $o119_ativo = 'f'; 
   ...
   function incluir ($o119_sequencial){ 
     ...
     if($o119_sequencial == "" || $o119_sequencial == null ){
       ...
       $this->o119_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from ppaversao_o119_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $o119_sequencial)){
     ...
     if (isset($lSessaoDesativarAccount) && $lSessaoDesativarAccount === false) {
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,2498,14200,'','".AddSlashes(pg_fetch_result($resaco,0,'o119_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2498,14205,'','".AddSlashes(pg_fetch_result($resaco,0,'o119_ppalei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2498,14203,'','".AddSlashes(pg_fetch_result($resaco,0,'o119_idusuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2498,14206,'','".AddSlashes(pg_fetch_result($resaco,0,'o119_versao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2498,14204,'','".AddSlashes(pg_fetch_result($resaco,0,'o119_finalizada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2498,14201,'','".AddSlashes(pg_fetch_result($resaco,0,'o119_datainicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2498,14202,'','".AddSlashes(pg_fetch_result($resaco,0,'o119_datatermino'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2498,14207,'','".AddSlashes(pg_fetch_result($resaco,0,'o119_versaofinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2498,19866,'','".AddSlashes(pg_fetch_result($resaco,0,'o119_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($o119_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->o119_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o119_sequencial"])){ 
       $sql  .= $virgula." o119_sequencial = $this->o119_sequencial ";
       $virgula = ",";
       if(trim((string) $this->o119_sequencial) == null ){ 
     ...
     if(trim((string) $this->o119_ppalei)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o119_ppalei"])){ 
       $sql  .= $virgula." o119_ppalei = $this->o119_ppalei ";
       $virgula = ",";
       if(trim((string) $this->o119_ppalei) == null ){ 
         $this->erro_sql = " Campo Lei do PPA nao Informado.";
         $this->erro_campo = "o119_ppalei";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o119_idusuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o119_idusuario"])){ 
       $sql  .= $virgula." o119_idusuario = $this->o119_idusuario ";
       $virgula = ",";
       if(trim((string) $this->o119_idusuario) == null ){ 
         $this->erro_sql = " Campo Código do Usuário nao Informado.";
         $this->erro_campo = "o119_idusuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o119_versao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o119_versao"])){ 
       $sql  .= $virgula." o119_versao = $this->o119_versao ";
       $virgula = ",";
       if(trim((string) $this->o119_versao) == null ){ 
         $this->erro_sql = " Campo Versão nao Informado.";
         $this->erro_campo = "o119_versao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o119_finalizada)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o119_finalizada"])){ 
       $sql  .= $virgula." o119_finalizada = '$this->o119_finalizada' ";
       $virgula = ",";
       if(trim((string) $this->o119_finalizada) == null ){ 
         $this->erro_sql = " Campo Finalizada nao Informado.";
         $this->erro_campo = "o119_finalizada";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o119_datainicio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o119_datainicio_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["o119_datainicio_dia"] !="") ){ 
       $sql  .= $virgula." o119_datainicio = '$this->o119_datainicio' ";
       $virgula = ",";
       if(trim((string) $this->o119_datainicio) == null ){ 
         $this->erro_sql = " Campo Data de Inicio nao Informado.";
         $this->erro_campo = "o119_datainicio_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o119_datatermino)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o119_datatermino_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["o119_datatermino_dia"] !="") ){ 
     ...
     if(trim((string) $this->o119_versaofinal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o119_versaofinal"])){ 
       $sql  .= $virgula." o119_versaofinal = '$this->o119_versaofinal' ";
       $virgula = ",";
       if(trim((string) $this->o119_versaofinal) == null ){ 
         $this->erro_sql = " Campo Versão Final nao Informado.";
         $this->erro_campo = "o119_versaofinal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->o119_ativo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o119_ativo"])){ 
       $sql  .= $virgula." o119_ativo = '$this->o119_ativo' ";
       $virgula = ",";
       if(trim((string) $this->o119_ativo) == null ){ 
         $this->erro_sql = " Campo Ativo nao Informado.";
         $this->erro_campo = "o119_ativo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["o119_sequencial"]) || $this->o119_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,2498,14200,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o119_sequencial'))."','$this->o119_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["o119_ppalei"]) || $this->o119_ppalei != "")
             $resac = db_query("insert into db_acount values($acount,2498,14205,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o119_ppalei'))."','$this->o119_ppalei',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["o119_idusuario"]) || $this->o119_idusuario != "")
             $resac = db_query("insert into db_acount values($acount,2498,14203,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o119_idusuario'))."','$this->o119_idusuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["o119_versao"]) || $this->o119_versao != "")
             $resac = db_query("insert into db_acount values($acount,2498,14206,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o119_versao'))."','$this->o119_versao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["o119_finalizada"]) || $this->o119_finalizada != "")
             $resac = db_query("insert into db_acount values($acount,2498,14204,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o119_finalizada'))."','$this->o119_finalizada',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["o119_datainicio"]) || $this->o119_datainicio != "")
             $resac = db_query("insert into db_acount values($acount,2498,14201,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o119_datainicio'))."','$this->o119_datainicio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["o119_datatermino"]) || $this->o119_datatermino != "")
             $resac = db_query("insert into db_acount values($acount,2498,14202,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o119_datatermino'))."','$this->o119_datatermino',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["o119_versaofinal"]) || $this->o119_versaofinal != "")
             $resac = db_query("insert into db_acount values($acount,2498,14207,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o119_versaofinal'))."','$this->o119_versaofinal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["o119_ativo"]) || $this->o119_ativo != "")
             $resac = db_query("insert into db_acount values($acount,2498,19866,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'o119_ativo'))."','$this->o119_ativo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (isset($lSessaoDesativarAccount) && $lSessaoDesativarAccount === false) {
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,2498,14200,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o119_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,2498,14205,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o119_ppalei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,2498,14203,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o119_idusuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,2498,14206,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o119_versao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,2498,14204,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o119_finalizada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,2498,14201,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o119_datainicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,2498,14202,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o119_datatermino'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,2498,14207,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o119_versaofinal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,2498,19866,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'o119_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
