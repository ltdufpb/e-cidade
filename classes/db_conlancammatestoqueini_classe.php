...
class cl_conlancammatestoqueini { 
   ...
   public $c103_codlan = 0; 
   public $c103_matestoqueini = 0; 
   ...
   function alterar ($c103_sequencial=null) { 
     ...
     if(trim((string) $this->c103_codlan)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c103_codlan"])){ 
       $sql  .= $virgula." c103_codlan = $this->c103_codlan ";
       $virgula = ",";
       if(trim((string) $this->c103_codlan) == null ){ 
         $this->erro_sql = " Campo Código Lançamento nao Informado.";
         $this->erro_campo = "c103_codlan";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->c103_matestoqueini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c103_matestoqueini"])){ 
       $sql  .= $virgula." c103_matestoqueini = $this->c103_matestoqueini ";
       $virgula = ",";
       if(trim((string) $this->c103_matestoqueini) == null ){ 
         $this->erro_sql = " Campo Lançamento nao Informado.";
         $this->erro_campo = "c103_matestoqueini";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
