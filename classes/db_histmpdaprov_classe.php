...
class cl_histmpdaprov { 
   ...
   public $ed70_i_codigo = 0; 
   public $ed70_i_historico = 0; 
   public $ed70_i_disciplina = 0; 
   ...
   function incluir ($ed70_i_codigo){ 
     ...
     if($ed70_i_codigo == "" || $ed70_i_codigo == null ){
       ...
       $this->ed70_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from histmpdaprov_ed70_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed70_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010130,1008752,'','".AddSlashes(pg_fetch_result($resaco,0,'ed70_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010130,1008753,'','".AddSlashes(pg_fetch_result($resaco,0,'ed70_i_historico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010130,1008754,'','".AddSlashes(pg_fetch_result($resaco,0,'ed70_i_disciplina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed70_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed70_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed70_i_codigo"])){ 
       $sql  .= $virgula." ed70_i_codigo = $this->ed70_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed70_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed70_i_historico)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed70_i_historico"])){ 
       $sql  .= $virgula." ed70_i_historico = $this->ed70_i_historico ";
       $virgula = ",";
       if(trim((string) $this->ed70_i_historico) == null ){ 
         $this->erro_sql = " Campo Histórico nao Informado.";
         $this->erro_campo = "ed70_i_historico";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed70_i_disciplina)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed70_i_disciplina"])){ 
       $sql  .= $virgula." ed70_i_disciplina = $this->ed70_i_disciplina ";
       $virgula = ",";
       if(trim((string) $this->ed70_i_disciplina) == null ){ 
         $this->erro_sql = " Campo Disciplina nao Informado.";
         $this->erro_campo = "ed70_i_disciplina";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed70_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1010130,1008752,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed70_i_codigo'))."','$this->ed70_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed70_i_historico"]))
           $resac = db_query("insert into db_acount values($acount,1010130,1008753,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed70_i_historico'))."','$this->ed70_i_historico',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed70_i_disciplina"]))
           $resac = db_query("insert into db_acount values($acount,1010130,1008754,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed70_i_disciplina'))."','$this->ed70_i_disciplina',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed70_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010130,1008752,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed70_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010130,1008753,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed70_i_historico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010130,1008754,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed70_i_disciplina'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
