...
class cl_acordoposicaoacordomovimentacao { 
   ...
   public $ac31_sequencial = 0; 
   public $ac31_acordoposicao = 0; 
   public $ac31_acordomovimentacao = 0; 
   ...
   function incluir ($ac31_sequencial){ 
     ...
     if($ac31_sequencial == "" || $ac31_sequencial == null ){
       ...
       $this->ac31_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordoposicaoacordomovimentacao_ac31_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac31_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2944,16735,'','".AddSlashes(pg_fetch_result($resaco,0,'ac31_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2944,16736,'','".AddSlashes(pg_fetch_result($resaco,0,'ac31_acordoposicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2944,16737,'','".AddSlashes(pg_fetch_result($resaco,0,'ac31_acordomovimentacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac31_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac31_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac31_sequencial"])){ 
       $sql  .= $virgula." ac31_sequencial = $this->ac31_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac31_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac31_acordoposicao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac31_acordoposicao"])){ 
       $sql  .= $virgula." ac31_acordoposicao = $this->ac31_acordoposicao ";
       $virgula = ",";
       if(trim((string) $this->ac31_acordoposicao) == null ){ 
         $this->erro_sql = " Campo Código da posicao nao Informado.";
         $this->erro_campo = "ac31_acordoposicao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac31_acordomovimentacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac31_acordomovimentacao"])){ 
       $sql  .= $virgula." ac31_acordomovimentacao = $this->ac31_acordomovimentacao ";
       $virgula = ",";
       if(trim((string) $this->ac31_acordomovimentacao) == null ){ 
         $this->erro_sql = " Campo Código da Movimentacao nao Informado.";
         $this->erro_campo = "ac31_acordomovimentacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac31_sequencial"]) || $this->ac31_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2944,16735,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac31_sequencial'))."','$this->ac31_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac31_acordoposicao"]) || $this->ac31_acordoposicao != "")
           $resac = db_query("insert into db_acount values($acount,2944,16736,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac31_acordoposicao'))."','$this->ac31_acordoposicao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac31_acordomovimentacao"]) || $this->ac31_acordomovimentacao != "")
           $resac = db_query("insert into db_acount values($acount,2944,16737,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac31_acordomovimentacao'))."','$this->ac31_acordomovimentacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac31_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2944,16735,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac31_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2944,16736,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac31_acordoposicao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2944,16737,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac31_acordomovimentacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
