...
class cl_far_concentracaomed { 
   ...
   public $fa37_i_codigo = 0; 
   public $fa37_i_medanvisa = 0; 
   public $fa37_i_concentracao = 0; 
   ...
   function incluir ($fa37_i_codigo){ 
     ...
     if($fa37_i_codigo == "" || $fa37_i_codigo == null ){
       ...
       $this->fa37_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from far_concentracaomed_fa37_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $fa37_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2530,14370,'','".AddSlashes(pg_fetch_result($resaco,0,'fa37_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2530,14368,'','".AddSlashes(pg_fetch_result($resaco,0,'fa37_i_medanvisa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2530,14367,'','".AddSlashes(pg_fetch_result($resaco,0,'fa37_i_concentracao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($fa37_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->fa37_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa37_i_codigo"])){ 
       $sql  .= $virgula." fa37_i_codigo = $this->fa37_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->fa37_i_codigo) == null ){ 
     ...
     if(trim((string) $this->fa37_i_medanvisa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa37_i_medanvisa"])){ 
       $sql  .= $virgula." fa37_i_medanvisa = $this->fa37_i_medanvisa ";
       $virgula = ",";
       if(trim((string) $this->fa37_i_medanvisa) == null ){ 
         $this->erro_sql = " Campo medanvisa nao Informado.";
         $this->erro_campo = "fa37_i_medanvisa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->fa37_i_concentracao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa37_i_concentracao"])){ 
       $sql  .= $virgula." fa37_i_concentracao = $this->fa37_i_concentracao ";
       $virgula = ",";
       if(trim((string) $this->fa37_i_concentracao) == null ){ 
         $this->erro_sql = " Campo concentracao nao Informado.";
         $this->erro_campo = "fa37_i_concentracao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa37_i_codigo"]) || $this->fa37_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2530,14370,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa37_i_codigo'))."','$this->fa37_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa37_i_medanvisa"]) || $this->fa37_i_medanvisa != "")
           $resac = db_query("insert into db_acount values($acount,2530,14368,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa37_i_medanvisa'))."','$this->fa37_i_medanvisa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["fa37_i_concentracao"]) || $this->fa37_i_concentracao != "")
           $resac = db_query("insert into db_acount values($acount,2530,14367,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'fa37_i_concentracao'))."','$this->fa37_i_concentracao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($fa37_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2530,14370,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa37_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2530,14368,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa37_i_medanvisa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2530,14367,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'fa37_i_concentracao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
