...
class cl_itbipropriold { 
   ...
   function incluir ($it20_guia,$it20_numcgm){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,981,6104,'','".AddSlashes(pg_fetch_result($resaco,0,'it20_guia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,981,6105,'','".AddSlashes(pg_fetch_result($resaco,0,'it20_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,981,6106,'','".AddSlashes(pg_fetch_result($resaco,0,'it20_pri'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($it20_guia=null,$it20_numcgm=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->it20_guia)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it20_guia"])){ 
       $sql  .= $virgula." it20_guia = $this->it20_guia ";
       $virgula = ",";
       if(trim((string) $this->it20_guia) == null ){ 
     ...
     if(trim((string) $this->it20_numcgm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it20_numcgm"])){ 
       $sql  .= $virgula." it20_numcgm = $this->it20_numcgm ";
       $virgula = ",";
       if(trim((string) $this->it20_numcgm) == null ){ 
     ...
     if(trim((string) $this->it20_pri)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it20_pri"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["it20_guia"]))
           $resac = db_query("insert into db_acount values($acount,981,6104,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'it20_guia'))."','$this->it20_guia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it20_numcgm"]))
           $resac = db_query("insert into db_acount values($acount,981,6105,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'it20_numcgm'))."','$this->it20_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it20_pri"]))
           $resac = db_query("insert into db_acount values($acount,981,6106,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'it20_pri'))."','$this->it20_pri',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($it20_guia=null,$it20_numcgm=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,981,6104,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'it20_guia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,981,6105,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'it20_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,981,6106,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'it20_pri'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
