...
class cl_tabrecregrasjm { 
   ...
   public $k04_sequencial = 0; 
   public $k04_receit = 0; 
   public $k04_codjm = 0; 
   public $k04_dtini_dia = null; 
   public $k04_dtini_mes = null; 
   public $k04_dtini_ano = null; 
   public $k04_dtini = null; 
   public $k04_dtfim_dia = null; 
   public $k04_dtfim_mes = null; 
   public $k04_dtfim_ano = null; 
   public $k04_dtfim = null; 
   ...
   function incluir ($k04_sequencial){ 
     ...
     if($k04_sequencial == "" || $k04_sequencial == null ){
       ...
       $this->k04_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from tabrecregrasjm_k04_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $k04_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1389,8243,'','".AddSlashes(pg_fetch_result($resaco,0,'k04_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1389,8244,'','".AddSlashes(pg_fetch_result($resaco,0,'k04_receit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1389,8245,'','".AddSlashes(pg_fetch_result($resaco,0,'k04_codjm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1389,8246,'','".AddSlashes(pg_fetch_result($resaco,0,'k04_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1389,8247,'','".AddSlashes(pg_fetch_result($resaco,0,'k04_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k04_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k04_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k04_sequencial"])){ 
       $sql  .= $virgula." k04_sequencial = $this->k04_sequencial ";
       $virgula = ",";
       if(trim((string) $this->k04_sequencial) == null ){ 
     ...
     if(trim((string) $this->k04_receit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k04_receit"])){ 
       $sql  .= $virgula." k04_receit = $this->k04_receit ";
       $virgula = ",";
       if(trim((string) $this->k04_receit) == null ){ 
         $this->erro_sql = " Campo Receita nao Informado.";
         $this->erro_campo = "k04_receit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k04_codjm)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k04_codjm"])){ 
       $sql  .= $virgula." k04_codjm = $this->k04_codjm ";
       $virgula = ",";
       if(trim((string) $this->k04_codjm) == null ){ 
         $this->erro_sql = " Campo codigo do juro e multa nao Informado.";
         $this->erro_campo = "k04_codjm";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k04_dtini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k04_dtini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["k04_dtini_dia"] !="") ){ 
       $sql  .= $virgula." k04_dtini = '$this->k04_dtini' ";
       $virgula = ",";
       if(trim((string) $this->k04_dtini) == null ){ 
         $this->erro_sql = " Campo Data inicial nao Informado.";
         $this->erro_campo = "k04_dtini_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k04_dtfim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k04_dtfim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["k04_dtfim_dia"] !="") ){ 
       $sql  .= $virgula." k04_dtfim = '$this->k04_dtfim' ";
       $virgula = ",";
       if(trim((string) $this->k04_dtfim) == null ){ 
         $this->erro_sql = " Campo Data final nao Informado.";
         $this->erro_campo = "k04_dtfim_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k04_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1389,8243,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k04_sequencial'))."','$this->k04_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k04_receit"]))
           $resac = db_query("insert into db_acount values($acount,1389,8244,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k04_receit'))."','$this->k04_receit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k04_codjm"]))
           $resac = db_query("insert into db_acount values($acount,1389,8245,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k04_codjm'))."','$this->k04_codjm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k04_dtini"]))
           $resac = db_query("insert into db_acount values($acount,1389,8246,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k04_dtini'))."','$this->k04_dtini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k04_dtfim"]))
           $resac = db_query("insert into db_acount values($acount,1389,8247,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k04_dtfim'))."','$this->k04_dtfim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k04_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1389,8243,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k04_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1389,8244,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k04_receit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1389,8245,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k04_codjm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1389,8246,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k04_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1389,8247,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k04_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
