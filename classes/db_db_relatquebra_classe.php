...
class cl_db_relatquebra { 
   ...
   public $db97_codigo = 0; 
   public $db97_codrel = 0; 
   public $db97_codcam = 0; 
   public $db97_totaliza = 'f'; 
   ...
   function incluir ($db97_codigo){ 
     ...
     if($db97_codigo == "" || $db97_codigo == null ){
       ...
       $this->db97_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_relatquebra_db97_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db97_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1401,8298,'','".AddSlashes(pg_fetch_result($resaco,0,'db97_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1401,8299,'','".AddSlashes(pg_fetch_result($resaco,0,'db97_codrel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1401,8300,'','".AddSlashes(pg_fetch_result($resaco,0,'db97_codcam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1401,8301,'','".AddSlashes(pg_fetch_result($resaco,0,'db97_totaliza'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db97_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db97_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db97_codigo"])){ 
       $sql  .= $virgula." db97_codigo = $this->db97_codigo ";
       $virgula = ",";
       if(trim((string) $this->db97_codigo) == null ){ 
     ...
     if(trim((string) $this->db97_codrel)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db97_codrel"])){ 
       $sql  .= $virgula." db97_codrel = $this->db97_codrel ";
       $virgula = ",";
       if(trim((string) $this->db97_codrel) == null ){ 
         $this->erro_sql = " Campo Código do relatório nao Informado.";
         $this->erro_campo = "db97_codrel";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db97_codcam)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db97_codcam"])){ 
       $sql  .= $virgula." db97_codcam = $this->db97_codcam ";
       $virgula = ",";
       if(trim((string) $this->db97_codcam) == null ){ 
         $this->erro_sql = " Campo Código nao Informado.";
         $this->erro_campo = "db97_codcam";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db97_totaliza)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db97_totaliza"])){ 
       $sql  .= $virgula." db97_totaliza = '$this->db97_totaliza' ";
       $virgula = ",";
       if(trim((string) $this->db97_totaliza) == null ){ 
         $this->erro_sql = " Campo Totalizar nao Informado.";
         $this->erro_campo = "db97_totaliza";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db97_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1401,8298,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db97_codigo'))."','$this->db97_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db97_codrel"]))
           $resac = db_query("insert into db_acount values($acount,1401,8299,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db97_codrel'))."','$this->db97_codrel',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db97_codcam"]))
           $resac = db_query("insert into db_acount values($acount,1401,8300,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db97_codcam'))."','$this->db97_codcam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db97_totaliza"]))
           $resac = db_query("insert into db_acount values($acount,1401,8301,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db97_totaliza'))."','$this->db97_totaliza',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db97_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1401,8298,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db97_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1401,8299,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db97_codrel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1401,8300,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db97_codcam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1401,8301,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db97_totaliza'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
