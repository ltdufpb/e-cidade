...
class cl_portariaassinatura { 
   ...
   public $rh136_sequencial = 0; 
   public $rh136_nome = null; 
   public $rh136_cargo = null; 
   public $rh136_amparo = null; 
   ...
   function incluir ($rh136_sequencial){ 
     ...
     if($rh136_sequencial == "" || $rh136_sequencial == null ){
       ...
       $this->rh136_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from portariaassinatura_rh136_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $rh136_sequencial)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3683,20480,'','".AddSlashes(pg_fetch_result($resaco,0,'rh136_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3683,20481,'','".AddSlashes(pg_fetch_result($resaco,0,'rh136_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3683,20482,'','".AddSlashes(pg_fetch_result($resaco,0,'rh136_cargo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3683,20483,'','".AddSlashes(pg_fetch_result($resaco,0,'rh136_amparo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function alterar ($rh136_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->rh136_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh136_sequencial"])){ 
       $sql  .= $virgula." rh136_sequencial = $this->rh136_sequencial ";
       $virgula = ",";
       if(trim((string) $this->rh136_sequencial) == null ){ 
     ...
     if(trim((string) $this->rh136_nome)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh136_nome"])){ 
       $sql  .= $virgula." rh136_nome = '$this->rh136_nome' ";
       $virgula = ",";
       if(trim((string) $this->rh136_nome) == null ){ 
         $this->erro_sql = " Campo Nome não informado.";
         $this->erro_campo = "rh136_nome";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh136_cargo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh136_cargo"])){ 
       $sql  .= $virgula." rh136_cargo = '$this->rh136_cargo' ";
       $virgula = ",";
       if(trim((string) $this->rh136_cargo) == null ){ 
         $this->erro_sql = " Campo Cargo não informado.";
         $this->erro_campo = "rh136_cargo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->rh136_amparo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh136_amparo"])){ 
       $sql  .= $virgula." rh136_amparo = '$this->rh136_amparo' ";
       $virgula = ",";
       if(trim((string) $this->rh136_amparo) == null ){ 
         $this->erro_sql = " Campo Amparo Legal não informado.";
         $this->erro_campo = "rh136_amparo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["rh136_sequencial"]) || $this->rh136_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,3683,20480,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh136_sequencial'))."','$this->rh136_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["rh136_nome"]) || $this->rh136_nome != "")
             $resac = db_query("insert into db_acount values($acount,3683,20481,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh136_nome'))."','$this->rh136_nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["rh136_cargo"]) || $this->rh136_cargo != "")
             $resac = db_query("insert into db_acount values($acount,3683,20482,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh136_cargo'))."','$this->rh136_cargo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if(isset($GLOBALS["HTTP_POST_VARS"]["rh136_amparo"]) || $this->rh136_amparo != "")
             $resac = db_query("insert into db_acount values($acount,3683,20483,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'rh136_amparo'))."','$this->rh136_amparo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3683,20480,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh136_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3683,20481,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh136_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3683,20482,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh136_cargo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,3683,20483,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'rh136_amparo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
