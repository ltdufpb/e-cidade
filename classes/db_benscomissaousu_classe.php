...
class cl_benscomissaousu { 
   ...
   function incluir ($t61_codcom,$t61_id_usuario){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,921,5799,'','".AddSlashes(pg_fetch_result($resaco,0,'t61_codcom'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,921,5800,'','".AddSlashes(pg_fetch_result($resaco,0,'t61_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($t61_codcom=null,$t61_id_usuario=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->t61_codcom)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t61_codcom"])){ 
       $sql  .= $virgula." t61_codcom = $this->t61_codcom ";
       $virgula = ",";
       if(trim((string) $this->t61_codcom) == null ){ 
     ...
     if(trim((string) $this->t61_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t61_id_usuario"])){ 
       $sql  .= $virgula." t61_id_usuario = $this->t61_id_usuario ";
       $virgula = ",";
       if(trim((string) $this->t61_id_usuario) == null ){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["t61_codcom"]))
           $resac = db_query("insert into db_acount values($acount,921,5799,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t61_codcom'))."','$this->t61_codcom',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["t61_id_usuario"]))
           $resac = db_query("insert into db_acount values($acount,921,5800,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'t61_id_usuario'))."','$this->t61_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($t61_codcom=null,$t61_id_usuario=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,921,5799,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t61_codcom'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,921,5800,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'t61_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
