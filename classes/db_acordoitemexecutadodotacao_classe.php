...
class cl_acordoitemexecutadodotacao { 
   ...
   public $ac32_sequencial = 0; 
   public $ac32_acordoitem = 0; 
   public $ac32_coddot = 0; 
   public $ac32_valor = 0; 
   ...
   function incluir ($ac32_sequencial){ 
     ...
     if($ac32_sequencial == "" || $ac32_sequencial == null ){
       ...
       $this->ac32_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from acordoitemexecutadodotacao_ac32_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ac32_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,3028,17142,'','".AddSlashes(pg_fetch_result($resaco,0,'ac32_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3028,17143,'','".AddSlashes(pg_fetch_result($resaco,0,'ac32_acordoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3028,17144,'','".AddSlashes(pg_fetch_result($resaco,0,'ac32_coddot'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,3028,17145,'','".AddSlashes(pg_fetch_result($resaco,0,'ac32_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac32_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ac32_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac32_sequencial"])){ 
       $sql  .= $virgula." ac32_sequencial = $this->ac32_sequencial ";
       $virgula = ",";
       if(trim((string) $this->ac32_sequencial) == null ){ 
     ...
     if(trim((string) $this->ac32_acordoitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac32_acordoitem"])){ 
       $sql  .= $virgula." ac32_acordoitem = $this->ac32_acordoitem ";
       $virgula = ",";
       if(trim((string) $this->ac32_acordoitem) == null ){ 
         $this->erro_sql = " Campo Código do item nao Informado.";
         $this->erro_campo = "ac32_acordoitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac32_coddot)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac32_coddot"])){ 
       $sql  .= $virgula." ac32_coddot = $this->ac32_coddot ";
       $virgula = ",";
       if(trim((string) $this->ac32_coddot) == null ){ 
         $this->erro_sql = " Campo Dotação nao Informado.";
         $this->erro_campo = "ac32_coddot";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ac32_valor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac32_valor"])){ 
        if(trim((string) $this->ac32_valor)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ac32_valor"])){ 
           $this->ac32_valor = "0" ; 
        } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac32_sequencial"]) || $this->ac32_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,3028,17142,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac32_sequencial'))."','$this->ac32_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac32_acordoitem"]) || $this->ac32_acordoitem != "")
           $resac = db_query("insert into db_acount values($acount,3028,17143,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac32_acordoitem'))."','$this->ac32_acordoitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac32_coddot"]) || $this->ac32_coddot != "")
           $resac = db_query("insert into db_acount values($acount,3028,17144,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac32_coddot'))."','$this->ac32_coddot',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac32_valor"]) || $this->ac32_valor != "")
           $resac = db_query("insert into db_acount values($acount,3028,17145,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ac32_valor'))."','$this->ac32_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ac32_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,3028,17142,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac32_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3028,17143,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac32_acordoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3028,17144,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac32_coddot'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,3028,17145,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ac32_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
