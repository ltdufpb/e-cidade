...
class cl_cadtipoparcdeb { 
   ...
   public $k41_cadtipoparc = 0; 
   public $k41_arretipo = 0; 
   public $k41_vencini_dia = null; 
   public $k41_vencini_mes = null; 
   public $k41_vencini_ano = null; 
   public $k41_vencini = null; 
   public $k41_vencfim_dia = null; 
   public $k41_vencfim_mes = null; 
   public $k41_vencfim_ano = null; 
   public $k41_vencfim = null; 
   ...
   function incluir ($k41_cadtipoparc,$k41_arretipo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1258,7579,'','".AddSlashes(pg_fetch_result($resaco,0,'k41_cadtipoparc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1258,7580,'','".AddSlashes(pg_fetch_result($resaco,0,'k41_arretipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1258,9968,'','".AddSlashes(pg_fetch_result($resaco,0,'k41_vencini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1258,9969,'','".AddSlashes(pg_fetch_result($resaco,0,'k41_vencfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k41_cadtipoparc=null,$k41_arretipo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->k41_cadtipoparc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k41_cadtipoparc"])){ 
       $sql  .= $virgula." k41_cadtipoparc = $this->k41_cadtipoparc ";
       $virgula = ",";
       if(trim((string) $this->k41_cadtipoparc) == null ){ 
     ...
     if(trim((string) $this->k41_arretipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k41_arretipo"])){ 
       $sql  .= $virgula." k41_arretipo = $this->k41_arretipo ";
       $virgula = ",";
       if(trim((string) $this->k41_arretipo) == null ){ 
     ...
     if(trim((string) $this->k41_vencini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k41_vencini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["k41_vencini_dia"] !="") ){ 
       $sql  .= $virgula." k41_vencini = '$this->k41_vencini' ";
       $virgula = ",";
       if(trim((string) $this->k41_vencini) == null ){ 
         $this->erro_sql = " Campo Vencimento inicial nao Informado.";
         $this->erro_campo = "k41_vencini_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->k41_vencfim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k41_vencfim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["k41_vencfim_dia"] !="") ){ 
       $sql  .= $virgula." k41_vencfim = '$this->k41_vencfim' ";
       $virgula = ",";
       if(trim((string) $this->k41_vencfim) == null ){ 
         $this->erro_sql = " Campo Vencimento final nao Informado.";
         $this->erro_campo = "k41_vencfim_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k41_cadtipoparc"]))
           $resac = db_query("insert into db_acount values($acount,1258,7579,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k41_cadtipoparc'))."','$this->k41_cadtipoparc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k41_arretipo"]))
           $resac = db_query("insert into db_acount values($acount,1258,7580,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k41_arretipo'))."','$this->k41_arretipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k41_vencini"]))
           $resac = db_query("insert into db_acount values($acount,1258,9968,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k41_vencini'))."','$this->k41_vencini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k41_vencfim"]))
           $resac = db_query("insert into db_acount values($acount,1258,9969,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'k41_vencfim'))."','$this->k41_vencfim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($k41_cadtipoparc=null,$k41_arretipo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1258,7579,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k41_cadtipoparc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1258,7580,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k41_arretipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1258,9968,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k41_vencini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1258,9969,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'k41_vencfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
