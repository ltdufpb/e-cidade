...
class cl_lab_setorexame { 
   ...
   public $la09_i_codigo = 0; 
   public $la09_i_labsetor = 0; 
   public $la09_i_exame = 0; 
   public $la09_i_ativo = 0; 
   ...
   function incluir ($la09_i_codigo){ 
     ...
     if($la09_i_codigo == "" || $la09_i_codigo == null ){
       ...
       $this->la09_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from lab_setorexame_la09_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $la09_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2759,15749,'','".AddSlashes(pg_fetch_result($resaco,0,'la09_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2759,15750,'','".AddSlashes(pg_fetch_result($resaco,0,'la09_i_labsetor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2759,15751,'','".AddSlashes(pg_fetch_result($resaco,0,'la09_i_exame'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2759,17968,'','".AddSlashes(pg_fetch_result($resaco,0,'la09_i_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($la09_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->la09_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la09_i_codigo"])){ 
       $sql  .= $virgula." la09_i_codigo = $this->la09_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->la09_i_codigo) == null ){ 
     ...
     if(trim((string) $this->la09_i_labsetor)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la09_i_labsetor"])){ 
       $sql  .= $virgula." la09_i_labsetor = $this->la09_i_labsetor ";
       $virgula = ",";
       if(trim((string) $this->la09_i_labsetor) == null ){ 
         $this->erro_sql = " Campo Setor nao Informado.";
         $this->erro_campo = "la09_i_labsetor";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->la09_i_exame)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la09_i_exame"])){ 
       $sql  .= $virgula." la09_i_exame = $this->la09_i_exame ";
       $virgula = ",";
       if(trim((string) $this->la09_i_exame) == null ){ 
         $this->erro_sql = " Campo Exame nao Informado.";
         $this->erro_campo = "la09_i_exame";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->la09_i_ativo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["la09_i_ativo"])){ 
       $sql  .= $virgula." la09_i_ativo = $this->la09_i_ativo ";
       $virgula = ",";
       if(trim((string) $this->la09_i_ativo) == null ){ 
         $this->erro_sql = " Campo Situação nao Informado.";
         $this->erro_campo = "la09_i_ativo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["la09_i_codigo"]) || $this->la09_i_codigo != "")
           $resac = db_query("insert into db_acount values($acount,2759,15749,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la09_i_codigo'))."','$this->la09_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la09_i_labsetor"]) || $this->la09_i_labsetor != "")
           $resac = db_query("insert into db_acount values($acount,2759,15750,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la09_i_labsetor'))."','$this->la09_i_labsetor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la09_i_exame"]) || $this->la09_i_exame != "")
           $resac = db_query("insert into db_acount values($acount,2759,15751,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la09_i_exame'))."','$this->la09_i_exame',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["la09_i_ativo"]) || $this->la09_i_ativo != "")
           $resac = db_query("insert into db_acount values($acount,2759,17968,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'la09_i_ativo'))."','$this->la09_i_ativo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($la09_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2759,15749,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la09_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2759,15750,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la09_i_labsetor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2759,15751,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la09_i_exame'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2759,17968,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'la09_i_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
