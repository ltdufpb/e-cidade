...
class cl_serieequiv { 
   ...
   public $ed234_i_codigo = 0; 
   public $ed234_i_serie = 0; 
   public $ed234_i_serieequiv = 0; 
   ...
   function incluir ($ed234_i_codigo){ 
     ...
     if($ed234_i_codigo == "" || $ed234_i_codigo == null ){
       ...
       $this->ed234_i_codigo = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from serieequiv_ed234_i_codigo_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $ed234_i_codigo)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2020,11731,'','".AddSlashes(pg_fetch_result($resaco,0,'ed234_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2020,11732,'','".AddSlashes(pg_fetch_result($resaco,0,'ed234_i_serie'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2020,11733,'','".AddSlashes(pg_fetch_result($resaco,0,'ed234_i_serieequiv'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed234_i_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->ed234_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed234_i_codigo"])){ 
       $sql  .= $virgula." ed234_i_codigo = $this->ed234_i_codigo ";
       $virgula = ",";
       if(trim((string) $this->ed234_i_codigo) == null ){ 
     ...
     if(trim((string) $this->ed234_i_serie)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed234_i_serie"])){ 
       $sql  .= $virgula." ed234_i_serie = $this->ed234_i_serie ";
       $virgula = ",";
       if(trim((string) $this->ed234_i_serie) == null ){ 
         $this->erro_sql = " Campo Série nao Informado.";
         $this->erro_campo = "ed234_i_serie";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->ed234_i_serieequiv)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed234_i_serieequiv"])){ 
       $sql  .= $virgula." ed234_i_serieequiv = $this->ed234_i_serieequiv ";
       $virgula = ",";
       if(trim((string) $this->ed234_i_serieequiv) == null ){ 
         $this->erro_sql = " Campo Série Equivalente nao Informado.";
         $this->erro_campo = "ed234_i_serieequiv";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed234_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,2020,11731,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed234_i_codigo'))."','$this->ed234_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed234_i_serie"]))
           $resac = db_query("insert into db_acount values($acount,2020,11732,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed234_i_serie'))."','$this->ed234_i_serie',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed234_i_serieequiv"]))
           $resac = db_query("insert into db_acount values($acount,2020,11733,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'ed234_i_serieequiv'))."','$this->ed234_i_serieequiv',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed234_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2020,11731,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed234_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2020,11732,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed234_i_serie'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2020,11733,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'ed234_i_serieequiv'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
