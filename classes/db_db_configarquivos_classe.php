...
class cl_db_configarquivos { 
   ...
   public $db38_sequencial = 0; 
   public $db38_instit = 0; 
   public $db38_arquivo = 0; 
   public $db38_tipo = 0; 
   ...
   function incluir ($db38_sequencial){ 
     ...
     if($db38_sequencial == "" || $db38_sequencial == null ){
       ...
       $this->db38_sequencial = pg_fetch_result($result,0,0); 
     }else{
       $result = db_query("select last_value from db_configarquivos_db38_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $db38_sequencial)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2710,15439,'','".AddSlashes(pg_fetch_result($resaco,0,'db38_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2710,15440,'','".AddSlashes(pg_fetch_result($resaco,0,'db38_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2710,15441,'','".AddSlashes(pg_fetch_result($resaco,0,'db38_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2710,15442,'','".AddSlashes(pg_fetch_result($resaco,0,'db38_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db38_sequencial=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->db38_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db38_sequencial"])){ 
       $sql  .= $virgula." db38_sequencial = $this->db38_sequencial ";
       $virgula = ",";
       if(trim((string) $this->db38_sequencial) == null ){ 
     ...
     if(trim((string) $this->db38_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db38_instit"])){ 
       $sql  .= $virgula." db38_instit = $this->db38_instit ";
       $virgula = ",";
       if(trim((string) $this->db38_instit) == null ){ 
         $this->erro_sql = " Campo Instituição nao Informado.";
         $this->erro_campo = "db38_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->db38_arquivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db38_arquivo"])){ 
       $sql  .= $virgula." db38_arquivo = $this->db38_arquivo ";
       $virgula = ",";

     }
     if(trim((string) $this->db38_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db38_tipo"])){ 
       $sql  .= $virgula." db38_tipo = $this->db38_tipo ";
       $virgula = ",";
       if(trim((string) $this->db38_tipo) == null ){ 
         $this->erro_sql = " Campo Tipo de Arquivo nao Informado.";
         $this->erro_campo = "db38_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db38_sequencial"]) || $this->db38_sequencial != "")
           $resac = db_query("insert into db_acount values($acount,2710,15439,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db38_sequencial'))."','$this->db38_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db38_instit"]) || $this->db38_instit != "")
           $resac = db_query("insert into db_acount values($acount,2710,15440,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db38_instit'))."','$this->db38_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db38_arquivo"]) || $this->db38_arquivo != "")
           $resac = db_query("insert into db_acount values($acount,2710,15441,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db38_arquivo'))."','$this->db38_arquivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db38_tipo"]) || $this->db38_tipo != "")
           $resac = db_query("insert into db_acount values($acount,2710,15442,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'db38_tipo'))."','$this->db38_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db38_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2710,15439,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db38_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2710,15440,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db38_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2710,15441,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db38_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2710,15442,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'db38_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
