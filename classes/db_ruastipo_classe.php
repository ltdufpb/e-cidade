...
class cl_ruastipo { 
   ...
   public $j88_codigo = null; 
   public $j88_sigla = null; 
   public $j88_descricao = null; 
   ...
   function incluir ($j88_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1499,8776,'','".AddSlashes(pg_fetch_result($resaco,0,'j88_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1499,8777,'','".AddSlashes(pg_fetch_result($resaco,0,'j88_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1499,8778,'','".AddSlashes(pg_fetch_result($resaco,0,'j88_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j88_codigo=null) { 
     ...
     $virgula = "";
     if(trim((string) $this->j88_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j88_codigo"])){ 
       $sql  .= $virgula." j88_codigo = '$this->j88_codigo' ";
       $virgula = ",";
       if(trim((string) $this->j88_codigo) == null ){ 
     ...
     if(trim((string) $this->j88_sigla)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j88_sigla"])){ 
       $sql  .= $virgula." j88_sigla = '$this->j88_sigla' ";
       $virgula = ",";
       if(trim((string) $this->j88_sigla) == null ){ 
         $this->erro_sql = " Campo Sigla nao Informado.";
         $this->erro_campo = "j88_sigla";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim((string) $this->j88_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j88_descricao"])){ 
       $sql  .= $virgula." j88_descricao = '$this->j88_descricao' ";
       $virgula = ",";
       if(trim((string) $this->j88_descricao) == null ){ 
         $this->erro_sql = " Campo Descrição nao Informado.";
         $this->erro_campo = "j88_descricao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j88_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1499,8776,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j88_codigo'))."','$this->j88_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j88_sigla"]))
           $resac = db_query("insert into db_acount values($acount,1499,8777,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j88_sigla'))."','$this->j88_sigla',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j88_descricao"]))
           $resac = db_query("insert into db_acount values($acount,1499,8778,'".AddSlashes(pg_fetch_result($resaco,$conresaco,'j88_descricao'))."','$this->j88_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($j88_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1499,8776,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j88_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1499,8777,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j88_sigla'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1499,8778,'','".AddSlashes(pg_fetch_result($resaco,$iresaco,'j88_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
