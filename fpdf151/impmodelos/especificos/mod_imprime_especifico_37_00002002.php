...
$this->objpdf->text($xcol + 6, $xlin + 47, pg_fetch_result($this->dados, 0, "k17_debito").'   -   '.pg_fetch_result($this->dados, 0, "descr_debito"));
$this->objpdf->text($xcol + 2, $xlin + 56, 'CRÉDITO');
$this->objpdf->text($xcol + 6, $xlin + 60, pg_fetch_result($this->dados, 0, "k17_credito").'   -   '.pg_fetch_result($this->dados, 0, "descr_credito"));
