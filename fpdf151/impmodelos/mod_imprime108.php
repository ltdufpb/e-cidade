<?php
    ...
    $this->objpdf->cell(32, $iAltLabel, trim((string) $this->iptAreaTer)."m² = ".trim((string) $this->iptVlrTer), $iBordaInfoImovel, 0, 'L', 0);

    //VALOR VENAL DA EDIFICAÇÃO
    $this->objpdf->setX($iXPosPagina + 32);
    $this->objpdf->SetFont('Arial', '', $nFonteInfoImovel);
    $this->objpdf->cell(35, $iAltLabel, trim((string) $this->iptAreaEdi)."m² = ".trim((string) $this->iptVlrEdi), $iBordaInfoImovel, 0, 'L', 0);
    
    //VALOR VENAL DO IMÓVEL
    $this->objpdf->setX($iXPosPagina + 67);
    $this->objpdf->SetFont('Arial', '', $nFonteInfoImovel);
    $this->objpdf->cell(30, $iAltLabel, trim((string) $this->iptVlrImovel), $iBordaInfoImovel, 0, 'L', 0);
