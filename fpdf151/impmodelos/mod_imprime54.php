...
// Label das colunas
if($imprimevalidmin=="true") {
  $this->objpdf->SetWidths([12,15,88, 24,24,19,19]);
  $this->objpdf->SetAligns(['C','C','J','C','C','R','R']);
  
} else {
  $this->objpdf->SetWidths([12,15,113,24,19,19]);
  $this->objpdf->SetAligns(['C','C','J','C','R','R']);
}
...
// Separa cada item com uma linha
     ...
     if($volta_impressao == 0){
         ...
         $this->objpdf->Row_multicell([($ii+1),
     ...
     if((isset($resumo) && $resumo!="" && $volta_impressao == 0) || $volta_impressao == 1){
         ...
         $volta_impressao = 0;
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
         if (strlen((string) $resumo) > 1900){  // Tarcisio: Tratamento para resumos maiores que 2000 caracteres 
                                       //           erro encontrado em Eldorado.
           $volta_impressao = 4;
           $texto_impressao = substr((string) $resumo,1895,strlen((string) $resumo));
           $resumo          = substr((string) $resumo,0,1895);
         }
