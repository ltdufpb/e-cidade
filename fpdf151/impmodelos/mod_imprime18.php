  ...
  $iPag = ($this->linhasdositens/40);      
    ...
    if ($this->Ratendrequi != null){
	  ...
	  for($ii = $comeco;$ii < $this->linhasdositens ;$ii++) {
	     ...
	     $this->objpdf->cell(20,3,trim(pg_fetch_result($this->recorddositens,$ii,$this->rquantdeitens)),0,0,"C",0);
	     $this->objpdf->cell(22,3,trim(pg_fetch_result($this->recorddositens,$ii,$this->rquantatend)),0,0,"C",0);
	     $this->objpdf->multicell(50,3,substr(trim(pg_fetch_result($this->recorddositens,$ii,$this->robsdositens)),0,30),0,"L");  
