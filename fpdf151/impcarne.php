...
public $it01_obs           ="";
public $aTaxas = [];//array da taxas do ITBI
public $aTaxas2 = [];//array da taxas do ITBI
public $numero_emissoes = 1;
public $transmitente = "";
public $fracaoIdeal = 0;
 ...
 */
  function __construct(public $objpdf, public $impmodelo)
  {
  }
  function muda_pag($pagina, $xlin, $xcol, $fornec="false", &$contapagina = null, $mais=1, $mod=1) {
...
//      $this->objpdf->text(40,$xlin+2,'Continuaï¿½ï¿½o da Pï¿½gina '.($contapagina-1));
  ...
  function muda_pag2($pagina,$xlin,$xcol,&$contapagina,$mais=1,$linha = null){
    global $resparag, $resparagpadrao, $db61_texto, $db02_texto, $maislin, $xtotal, $flag_rodape;
 ...
 function muda_pag3($pagina, $xlin, $xcol, $fornec="false", &$contapagina = null, $mais=1, $mod=1) {
   global $resparag, $resparagpadrao, $db61_texto, $db02_texto, $maislin, $xtotal, $flag_rodape;
 ...
 function imprime(){
  ...
  $sCgcCliente = $sCodCliente->cgc;
 	...
 	$sInstit     = str_pad((string) db_getsession("DB_instit"), 2,0,STR_PAD_LEFT);
