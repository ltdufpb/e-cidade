...
//  echo "aqui -> solicita ->$i<br>";
	...
	$pdf->cell(19, $alt, @ date('d/m/Y', strtotime((string) $pc10_data)), 0, 0, "C", $c);
	$pdf->cell(50, $alt, substr((string) @ $z01_nome, 0, 31), 0, 0, "L", $c);
	$pdf->cell(50, $alt, substr((string) @ $pc50_descr, 0, 31), 0, 0, "L", $c);
	$pdf->cell(50, $alt, substr((string) @ $departamento, 0, 31), 0, 0, "L", $c);
	$pdf->cell(30, $alt, substr((string) @ $login, 0, 30), 0, 0, "L", $c);
	...
	if ($listar == 's') {
		 if ($e54_autori !=''){
		  ...
		  for ($y = 0; $y < $clempautitem->numrows; $y ++) {
			  ...
			  $pdf->cell(50, $alt, substr((string) $pc01_descrmater, 0, 31), 0, 0, "L", $c);
			  $pdf->cell(50, $alt, substr((string) $e55_descr, 0, 30), 0, 0, "L", $c);
			  $pdf->cell(15, $alt, $e55_codele, 0, 0, "C", $c);
			  $pdf->cell(53, $alt, $o56_elemento, 0, 0, "C", $c);
			  $pdf->cell(50, $alt, substr((string) @ $o56_descr, 0, 30), 0, 0, "L", $c);
