...
try {
  ...
  switch ($oParam->exec) {
    ...
    case 'salvarPeriodoAula':
      ...
      $oRetorno->sMessage = urlencode( (string) _M(MSG_EDU4_HORARIOAULA_RPC . "periodos_salvos") );
    ...
    case 'removerPeriodoAula':
      ...
      db_fim_transacao();
      $oRetorno->sMessage = urlencode( (string) _M(MSG_EDU4_HORARIOAULA_RPC . "periodos_excluido") );
