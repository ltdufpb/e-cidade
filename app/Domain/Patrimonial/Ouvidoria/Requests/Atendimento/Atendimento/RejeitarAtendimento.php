...
class RejeitarAtendimento extends BaseFormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            "motivo.required" => mb_convert_encoding("Motivo não informado.", 'UTF-8', 'ISO-8859-1'),
            "motivo.filled" => mb_convert_encoding("O motivo informado está vazio.", 'UTF-8', 'ISO-8859-1'),
