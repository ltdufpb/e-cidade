    ...
    <fieldset>
      ...
      <table width="35%" border="0" align="center" cellspacing="3" class="form-container">
        <tr>
          ...
          <td><?php  db_input("rh140_sequencial",10,$Irh140_sequencial,true,"text",4,"","chave_rh140_sequencial"); ?></td>
        </tr>
        <tr>
          <td><label><?=$Lrh140_sequencial?></label></td>
          <td><?php  db_input("rh140_sequencial",10,$Irh140_sequencial,true,"text",4,"","chave_rh140_sequencial");?></td>
    ...
    <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_rubricadescontoconsignado.hide();">
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_rh140_sequencial)){
          $repassa = ["chave_rh140_sequencial"=>$chave_rh140_sequencial,"chave_rh140_sequencial"=>$chave_rh140_sequencial];
        }
