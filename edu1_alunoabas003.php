...
<table valign="top" marginwidth="0" width="790" border="0" cellspacing="0" cellpadding="0">
 <tr>
  <td height="430" align="left" valign="top" bgcolor="#CCCCCC">
   ...
   $clcriaabas->identifica = ["a1"=>"Dados Pessoais","a2"=>"Documentos","a3"=>"Cursos","a4"=>"Documentos Pendentes","a5"=>"Necessidades Especiais","a6"=>"Histórico"];
   $clcriaabas->sizecampo  = ["a1"=>"15","a2"=>"10","a3"=>"15","a4"=>"25","a5"=>"25","a6"=>"15"];
   $clcriaabas->src        = ["a1"=>"edu1_alunodados003.php","a2"=>"","a3"=>"","a4"=>"","a5"=>"","a6"=>""];
