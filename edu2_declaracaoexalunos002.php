...
$oDadosAluno->sNomes       = urlencode((string) $oMatricula->getAluno()->getNome());
$oDadosAluno->dtMatriculas = urlencode((string) $oMatricula->getDataMatricula()->getDate(DBDate::DATA_PTBR));
$aAlunos[]=$oDadosAluno;
