  ...
  switch($oParam->exec) {
      ...
      if (isset($oParam->iTurma) && isset($oParam->iEtapa) && !empty($oParam->iTurma) && !empty($oParam->iEtapa)) {
        ...
        foreach ($oProcedimentoAvaliacao->getElementos() as $oAvaliacao) {
          ...
          if ($oAvaliacao instanceof ResultadoAvaliacao) {
            ...
            $oPeriodosAvaliacao->sDescricaoPeriodo          = urlencode((string) $oTipoResultado->getDescricao());
            $oPeriodosAvaliacao->sDescricaoPeriodoAbreviado = urlencode((string) $oTipoResultado->getDescricaoAbreviada());
          ...
          if ($oAvaliacao instanceof AvaliacaoPeriodica) {
            ...
            $oPeriodosAvaliacao->sDescricaoPeriodo          = urlencode((string) $oPeriodo->getDescricao());
            $oPeriodosAvaliacao->sDescricaoPeriodoAbreviado = urlencode((string) $oPeriodo->getDescricaoAbreviada());
    ...
    case 'getAlunosAvaliacaoRegencia' :
      ...
      foreach ($aMatriculas as $oMatricula) {
        ...
        $oDadosAluno->iSequencia     = urlencode((string) $oMatricula->getNumeroOrdemAluno());
        $oDadosAluno->sNomeAluno     = urlencode((string) $oMatricula->getAluno()->getNome());
        ...
        $oDadosAluno->sSituacaoAbreviada = urlencode( (string) $oMatricula->getAbreviaturaSituacao() );
        ...
        $oDadoRegencia->sDescricao            = urlencode((string) $oRegencia->getDisciplina()->getNomeDisciplina());
        ...
        foreach ($oDadosAproveitamento->getAvaliacoes() as $oAvaliacao) {
          ...
          if ($oAvaliacao->isAvaliacaoExterna()) {
            ...
            if (!empty($oAvaliacaoOrigem)) {
              ...
              $oDadosAvaliacao->oAvaliacaoOrigem->sFormaAvaliacao = urlencode((string) $oAvaliacaoOrigem->getElementoAvaliacao()
                                                                                               ->getFormaDeAvaliacao()
                                                                                               ->getDescricao()
                                                                              );
          ...
          if (!empty($oResultadoFinalRegencia)) {
            ...
            $oDadoRegencia->oResultadoFinal->sResultadoFinal       = urlencode((string) $oResultadoFinalRegencia->getResultadoFinal());
