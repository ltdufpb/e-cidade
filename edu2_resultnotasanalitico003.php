    ...
    $aSomaNotas = [];
      ...
      foreach ($aAvalicaoPeriodica as $oAvaliacaoPeriodica ) {
          foreach ($oTurma->getDisciplinasPorEtapa($oEtapa) as $oRegencia) {
              ...
              $stringDisciplina = strtolower((string) $oAvaliacao->sNomeDisplina); // 2018-06-26 Wallace (ATMA) tranforma a disciplina em letra minúscula
      ...
      foreach ($oTurma->getDisciplinasPorEtapa($oEtapa) as $oRegencia) {
          ...
          $stringDisciplina = strtolower((string) $oAvaliacao->sNomeDisciplina); // 2018-06-26 Wallace (ATMA)
