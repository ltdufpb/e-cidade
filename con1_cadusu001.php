...
if(isset($_POST["incluir"])) {
  ...
  if($login!=""){
    db_query("insert into db_usuacgm (id_usuario,cgmlogin) values($id_usuario,$login)") or die("Erro(21)($i) inserindo em db_usuacgm: ".pg_last_error());
  } 
  db_query("COMMIT");
...
////////////////ALTERAR////////////////  
  ...
  if($senha == "" and 1 == 2) {
	...
	$senha = pg_fetch_result($result,0,0);
  }
  $usuarioativo = (!isset($usuarioativo) || $usuarioativo==""?"0":$usuarioativo);
  db_query("BEGIN");
