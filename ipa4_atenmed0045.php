...
if(isset($_POST["excluir"])) {
  db_query("delete from exames where codexa = ".$_POST["favoritos"]) or die("Erro(15) deletando tabela exames");
}
?>
<html>
<head>
