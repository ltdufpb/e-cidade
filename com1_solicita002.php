  ...
  <tr> 
     ...
     <?php 
        ...
        if(isset($pc30_sugforn) && $pc30_sugforn=='t'){
            ...
            $clcriaabas->src = ["solicita"=>"com1_solicita005.php".$parametro];
            $clcriaabas->title      = ["solicita"=>"Cadastro de solicitação de compras","solicitem"=>"Cadastro de Itens e Dotações","sugforn"=>"Cadastro de fornecedores sugeridos"];//nome do iframe e o label
            ...
            $clcriaabas->src = ["solicita"=>"com1_solicita005.php".$parametro];
            $clcriaabas->title      = ["solicita"=>"Cadastro de solicitação de compras","solicitem"=>"Cadastro de Itens e Dotações"];//nome do iframe e o label
