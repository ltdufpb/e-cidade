 ...
 * @param int $anousu
 * @param string $apresentarCodigoSiconfi
 * @return string
 */
function getFonteRecurso($o58_codigo, $anousu, $apresentarCodigoSiconfi)
{
    ...
    $fonte = $apresentarCodigoSiconfi === 'N' ? $fonteRecurso->gestao : $fonteRecurso->codigo_siconfi;
