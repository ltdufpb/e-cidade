        ...
        declare
          ...
          begin
            ...
            if lRaise is true then
              perform fc_debug('Processando parcelamento dos d\xe9bitos...',lRaise,true,false);
            end if;
            ...
            if iInstit is null then
               raise exception 'Variavel de sess\xe3o [DB_instit] n\xe3o encontrada.';
            end if;
        
            iAnousu := cast(fc_getsession('DB_anousu') as integer);
            if iAnousu is null then
               raise exception 'Variavel de sess\xe3o [DB_anousu] n\xe3o encontrada.';
            end if;
        
            dDataUsu := cast(fc_getsession('DB_datausu') as date);
            if dDataUsu is null then
               raise exception 'Variavel de sess\xe3o [DB_datausu] n\xe3o encontrada.';
            end if;
            ...
            -- se houver d\xe9bitos do tipo Inicial verificamos se o par\xe2metro do M\xf3d. Juridio PARTILHA est\xe1 ativo 'SIM' e
            ...
            if lValidaParcInicial is true then
               ...
               if found then
                  ...
                  if found then
                    return '[2] - N\xe3o \xe9 poss\xedvel parcelar iniciais com processos do foro diferentes para um mesmo parcelamento! [Utiliza\xe7\xe3o de Partilha Ativada]';
                  end if;
            ...
            -- Desativado par\xe2metro para que n\xe3o seja gerado registros na incorpora\xe7\xe3o tribut\xe1ria
            ...
            -- Ativado par\xe2metro para que continue sendo gerado registros na incorpora\xe7\xe3o tribut\xe1ria
            ...
            loop
              ...
              if lRaise is true then
                perform fc_debug('Verificando quantidades de parcelaas marcadas com a quantidade de parcelas do d\xe9bito: v_somar1: '||v_somar1||' - v_somar2: '||v_somar2,lRaise,false,false);
              end if;
            ...
            -- senao for inicial do foro
              ...
              if lRaise is true then
                perform fc_debug(' ',lRaise,false,false);
                perform fc_debug(' ',lRaise,false,false);
                perform fc_debug('Buscando CGM princial por matricula ou inscri\xe7\xe3o',lRaise,false,false);
                perform fc_debug(' ',lRaise,false,false);
              end if;
        ...
        ';
            ...
            loop
              ...
              if v_record_recpar.tipo_origem is null then
                return '[6] - N\xe3o encontrados registros na tabela Divida para um dos debitos que esta sendo parcelado.';
              end if;
              ...
              loop
                ...
                --Adicionado arredondamento e fun\xe7\xe3o para retornar o m\xednimo monet\xe1rio
                ...
                --Arredonda o valor da parcela para inserir na tabela parcelas j\xe1 arrendado, local onde servir\xe1 de base para inserir os valores na arrecad
                ...
                -- Se alguma das colunas atingiu o m\xe1ximo ent\xe3o zera este valor para que n\xe3o lance valores errados
                ...
                --Verifica se o valor da tabela parcelas j\xe1 atingiu o m\xe1ximo para a receita
            ...
            loop
              ...
              if v_record_recpar.parcela = v_totalparcelas or v_record_recpar.parcela = ultimaparcelareceita then
                ...
                if v_juronaultima is true then
                  ...
                  -- se total ate agora for menor ao total do parcelamento * valor proporcional dessa receita em relacao ao total do parcelamento
                    ...
                    -- valor da ultima parcela da receita \xe9 composta por ((x) - (y))
                    -- ((x) - (y))
                    -- (total que deve ser gerado para a receita) - (total que j\xe1 foi gerado para a receita)
              ...
              if v_valparc > 0 then
                ...
                if lSeparaJuroMulta = 1 then
                  ...
                  --
                  --
                  -- Caso seja a ultima parcela do parcelamento realizamos a verifica\xe7\xe3o nos valores gerados para a composi\xe7\xe3o das parcelas
                  -- Se encontrar alguma diferenca \xe9 realizado o processamento do ajuste da composicao
                  --
                  if v_record_recpar.parcela = v_totparcdestarec then
                     ...
                     --
                     -- Verificamos os valores j\xe1 gerados para a composicao do d\xe9bito somando com o valor que ser\xe1 gerado para esta parcela e receita
                     --
                     select sum(k00_vlrhist)+v_historico_compos,
                      ...
                      --
                      -- Verificamos o total do valor de origem do parcelamento sem altera\xe7\xf5es e aplica\xe7\xf5es de regra.
                      --
                      ...
                      --
                      -- Caso seja encontrada diferenca na composicao do d\xe9bito com o total parcelado
                      -- Realizamos os ajustes necessarios nos valores onde existem diferenca, se o valor da diferenca existir e n\xe3o for maior que 1.
                      --
                      if abs(nVlrDiferencaComposicaoTotal) between 0.01 and 1.00 then
                         ...
                         --
                         --
                         -- Se a vari\xe1vel de sess\xe3o db_debugon estiver setada, verificamos os valores finais gerados para a composi\xe7\xe3o do d\xe9bito
                         -- Essa verifica\xe7\xe3o \xe9 realizada buscando os valores j\xe1 gerados somando com o valor da receita que ser\xe1 cadastrado j\xe1 com
            ...
            if nPercCalc < 0.5 then
               ...
               --
               -- Jogamos a diferen\xe7a do percentual na Arreinscr quando:
               --  - N\xe3o existir vinculo com matricula
               --  - O percentual da inscri\xe7\xe3o for menor que o percentual da matricula
               --
               -- Jogamos a difen\xe7a do percentual na Arrematric quando:
               -- - N\xe3o existir vinculo com a inscri\xe7\xe3o
               -- - O Percentual da matricula for menor que o percentual da inscri\xe7\xe3o
               --
              if lRaise then
            ...
            if round(nValidacaoPerc, 2) <> 100.00 then
                ...
                --
                -- Verificamos se o problema \xe9 devido estar no parcelamento d\xe9bitos que pertencem a matricula/inscri\xe7\xe3o e d\xe9bitos sem vinculo com matricula/inscricao
                -- Se for encontrado um numpre que n\xe3o esteja vinculado a matricula e a inscri\xe7\xe3o na origem, mostramos uma mensagem de erro diferenciada para facilitar a
                -- corre\xe7\xe3o do caso. Geralmente a corre\xe7\xe3o \xe9 realizada vinculando o numpre a uma matricula ou inscri\xe7\xe3o.
                --
                ...
                if sNumpreSemVinculoMatricInsc <> '' then
                  return '[15] - Inconsistencia no percentual do d\xe9bito gerado ap\xf3s o processamento do parcelamento - numpre: '||v_numpre||'. - Encontrados numpres que n\xe3o possuem vinculo com Matricula/Inscri\xe7\xe3o. Numpres ['||sNumpreSemVinculoMatricInsc||']';
                else
                  return '[15] - Inconsistencia no percentual do d\xe9bito gerado ap\xf3s o processamento do parcelamento - numpre: '||v_numpre;
                end if;
            ...
            -- diferen\xe7a de valor, sem que seja adicionada a diferen\xe7a h\xe1 \xfaltima parecela.
            --CAPIVARI
            if ( iCodcli = 26 ) then
            ...
            -- Alterado a l\xf3gica do v_teste para lan\xe7ar na \xfaltima parcela a diferen\xe7a do valor gravado no arrecad e do total do parcelamento calculado durante o processamento, caso v_teste esteja entre 0.01 e 6.00.
            -- N\xe3o se sabe o porqu\xea dos valores descritos, anteriormente j\xe1 havia l\xf3gica semelhante, apenas alteramos o between.
