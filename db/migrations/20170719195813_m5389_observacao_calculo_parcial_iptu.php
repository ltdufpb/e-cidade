...
class M5389ObservacaoCalculoParcialIptu extends PostgresMigration
{
  ...
  {
    $this->table('iptucalclog',  ['schema'=>'cadastro', 'id'=> false, 'primary_key'=>'j27_codigo', 'constraint'=>'iptucalclog_codi_pk'])->addColumn('j27_observacao', 'text', ['null'=>true])->save();
  }
  ...
  {
    $this->table('iptucalclog',  ['schema'=>'cadastro', 'id'=> false, 'primary_key'=>'j27_codigo', 'constraint'=>'iptucalclog_codi_pk'])->removeColumn('j27_observacao')->save();
  }
}
