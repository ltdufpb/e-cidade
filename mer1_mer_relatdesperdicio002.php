...
$dat   = substr((string) $inicio,8,2)."/".substr((string) $inicio,5,2)."/".substr((string) $inicio,0,4);
$dat2  = substr((string) $fim,8,2)."/".substr((string) $fim,5,2)."/".substr((string) $fim,0,4);
...
for ($c=0; $c<$linhas; $c++) {
  ...
  $dat=substr((string) $me22_d_data,8,2)."/".substr((string) $me22_d_data,5,2)."/".substr((string) $me22_d_data,0,4);
