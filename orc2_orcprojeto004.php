 ...
 *
 * strtoupper(trim($munic)) == "SAPIRANGA")
 *
 */
...
if ($auxiliar->numrows > 0) {
    for ($x = 0; $x < $auxiliar->numrows; $x++) {
        ...
        $pdf->setX(20);
        $pdf->Cell(120, 4, db_formatar($o15_recurso, 'recurso') . " - " . $o15_descr . "  (" . $o47_coddot . ")", 0, 0, "L", '0');
