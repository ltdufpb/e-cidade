...
try {
  ...
  switch($oParam->exec) {
    ...
    case 'cidadaoResponsavel':
      ...
      if (!empty($oParam->iAluno)) {
        ...
        if ($oAluno->getCidadaoResponsavel() != null) {
          ...
          $oRetorno->oResponsavel->sNome   = urlencode( (string) $oCidadaoResponsavel->getNome() );
        }
      }
      break;
    ...
    case 'buscaDadosAluno':
      ...
      $oDadosAluno->nome_aluno        = urlencode((string) $oAluno->getNome());
      $oDadosAluno->codigo_turma      = $oMatricula->getTurma()->getCodigo();
      $oDadosAluno->descricao_turma   = urlencode((string) $oMatricula->getTurma()->getDescricao());
      $oDadosAluno->descricao_turno   = urlencode((string) $oMatricula->getTurma()->getTurno()->getDescricao());
      ...
      $oDadosAluno->nome_calendario   = urlencode((string) $oMatricula->getTurma()->getCalendario()->getDescricao());
      ...
      $oDadosAluno->descricao_etapa   = urlencode((string) $oMatricula->getEtapaDeOrigem()->getNome());
      ...
      $oDadosAluno->tipo_matricula    = urlencode((string) $oMatricula->getTipo());
