  ...
  case 'getAlunos':
    ...
    if ($iTotalMatricula > 0) {
      ...
      for ($iContadorMatricula = 0; $iContadorMatricula < $iTotalMatricula; $iContadorMatricula++) {
        ...
        $aPartesNomeAluno        = explode(" ", trim((string) $oMatricula->getAluno()->getNome())); 
        ...
        $oDadosAluno->sDescricao        = urlencode((string) $oMatricula->getAluno()->getNome());
        $oDadosAluno->sTurma            = urlencode((string) $oMatricula->getTurma()->getDescricao());
        $oDadosAluno->sSala             = urlencode((string) $oMatricula->getTurma()->getSala()->getDescricao());
