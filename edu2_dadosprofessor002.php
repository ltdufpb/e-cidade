...
function validaTamanhoNomeEscola( $iEscola ) {
  ...
  $iLetrasNomeEscola = strlen( (string) $sNomeEscola );

  if ( $iLetrasNomeEscola > 45 ) {
    $sNomeEscola = substr( (string) $sNomeEscola, 0, 45 - $iLetrasNomeEscola);
  }
...
function validaTamanhoNomeUsuario( $iUsuario ) {
  ...
  $iLetrasNomeUsuario = strlen( (string) $sNomeUsuario );

  if ( $iLetrasNomeUsuario > 35 ) {
    $sNomeUsuario = substr( (string) $sNomeUsuario, 0, 35 - $iLetrasNomeUsuario );
  }
