...
include(modification("fpdf151/pdf.php"));
    ...
    for($i=0;$i<$num;$i++) {
      ...
      $pdf->Cell(12,4,pg_fetch_result($result,$i,"q03_ativ"),"B",0,"C",0);
      $pdf->Cell(80,4,pg_fetch_result($result,$i,"q03_descr"),"B",0,"L",0);
      $pdf->Cell(60,4,pg_fetch_result($result,$i,"q12_descr"),"B",0,"L",0);
      $pdf->Cell(120,4,pg_fetch_result($result,$i,"q81_descr"),"B",1,"L",0);
      $TotPag += 1;
    }
