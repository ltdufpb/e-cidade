...
// Diret�rio das extensoes do servidor necess�rias
...
// Se n�o existir o arquivo config/require_extensions.xml retorna mensagem
   $sMsgConf   = "Erro: 404 Diret�rio de Configura��o Inexistente! \n";
...
if ( isset($DB_VALIDA_REQUISITOS) && $DB_VALIDA_REQUISITOS == true ) {
	...
	foreach ($oXmlEst->browsers->browser as $oValCampo ) {
	  ...
	  if ($sStrpos === false) {
	    ...
	    /**
	     * Caso devemos ignorar algum peda�o da versao, deixamos a versao do browser do usuario como *
	     */
	    ...
	    if ($iTam >= 2) {
	      ...
	      $sMsgConf   = "Erro: Parametro(s) de Configura��o do Browser n�o Configurados Corretamente! \n";
	      $lErroConf  = true;
	      $lErro      = true;
	    }
	  }
...
<table border="0" width="100%">
	<tr align="center">
		...
		<div id="titulo">Verifica��o de Configura��es </div>
		<div id="conteudo">
...
if (count(@$aListaModulos) > 0) {
  ...
  echo "<tr rowspan=0>";
  echo "  <td><b>&nbsp;M�dulos Pendentes:</b></td>";
  echo "</tr>";
...
if (count(@$aListaParam) > 0) {
  ...
  echo "<table border=0 cellpadding=0 cellspacing=2 width=100% height=100%>";
  echo "<tr rowspan=0>";
  echo "  <td><b>&nbsp;Par�metro PHP.INI:</b></td>";
...
if (count(@$aListaParamPostgre) > 0) {
  ...
  echo "<table border=0 cellpadding=0 cellspacing=2 width=100% height=100%>";
  echo "<tr rowspan=0>";
  echo "  <td><b>&nbsp;Par�metro POSTGRESQL:</b></td>";
...
if ($lDirTmpRaizExist == false || $lDirTmpDbPortalExist == false) {
  ...
  echo "<tr>";
  echo "  <td><b>&nbsp;Diret�rio(s) n�o encontrado(s) ou sem permiss�o de escrita:</b></td>";
  echo "</tr>";
  echo "<tr id=lista_pendente_tr rowspan=0>";
...
if (isset($sMsgErro) && $sMsgErro != "") {
  ...
  echo "<table border=0 width=100% height=100%>";
  echo "<tr rowspan=0>";
  echo "  <td><b>&nbsp;Parametros de configura��o do PostgreSQL:</b></td>";
  echo "</tr>";
  echo "<tr id=lista_pendente_tr rowspan=0>";
...
if ($lErroConf == true) {
  ...
  echo "<table border=0 width=100% height=100%>";
  echo "<tr rowspan=0>";
  echo "  <td><b>&nbsp;Arquivo Inexistente ou Parametro(s) de Configura��o n�o Configurado(s) Corretamente:</b></td>";
  echo "</tr>";
  echo "<tr id=lista_pendente_tr rowspan=0>";
...
<body>
    ...
    <table border=0 width=100% height=100%>
      ...
      <tr id=lista_pendente_tr rowspan=0>
        <td id=lista_pendente_td>Configura��es OK.</td>
      </tr>
    </table>
...
<table border='0' width='100%'>
	<tr align='center'>
		<td>
		<div id='lista_pendente' align='left'>
		<div id='titulo'>Verifica��o de Configura��es <img src='' /></div>
		<div id='conteudo'>
		<table width='100%' border='0' cellpadding='0' cellspacing='0'>
			<tr>
				<td width='0' height='0' nowrap='nowrap'>&nbsp;</td>
		...
		<table border='0' width='100%' height='100%'>
			<tr rowspan='0'>
				<td><b>&nbsp;Arquivo Inexistente ou Parametro(s) de Configura��o n�o Configurado(s) Corretamente:</b></td>
			</tr>
			<tr id='lista_pendente_tr' rowspan='0'>
