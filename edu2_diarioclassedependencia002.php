 ...
 */
  ...
  for ($iCont = 0; $iCont < $iLinhasRegencia; $iCont++) {
    ...
    for ($iCont2 = 0; $iCont2 < $iLinhasMatDep2; $iCont2++) {
  	  ...
  	  $aInfoAnterior = explode("|", (string) RFanterior($oDadosMatricula2->ed60_i_codigo));
  	  if ($oGet->lResultAnt == "true") {
  	  ...
  	  if (trim((string) $oDadosMatricula2->ed60_c_situacao) == "MATRICULADO") {
  	   ...
  	   if ($amparo == "S") {
  	    ...
  	    $oPdf->Cell($iLarguraCell, 4, trim(substr((string) Situacao($oDadosMatricula2->ed60_c_situacao, 
