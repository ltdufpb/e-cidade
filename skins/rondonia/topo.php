...
<script>
  ...
  function js_criaDIV() {
    ...
    camada.innerHTML =   '<table cellspacing="0" cellpadding="0">'
                       ...
                       + '    <td nowrap><?=@pg_fetch_result($result,0,0)?>&nbsp;</td>'
                       + '    <td nowrap><strong>Login:</strong></td>'
                       + '    <td nowrap><?=@pg_fetch_result($result,0,1)?>&nbsp;</td>'
                       + '  </tr>'
                       + '  <tr>'
                       ...
                       + '    <td nowrap><?=($_SERVER["HTTP_X_FORWARDED_FOR"] ?? $_SERVER['REMOTE_ADDR'])?>&nbsp;</td>'
                       + '    <td nowrap><strong>Local:</strong></td>'
                       + '    <td nowrap><?=$_SERVER['PHP_SELF'];?></td>'
                       + '  </tr>'
                       + '</table>'
