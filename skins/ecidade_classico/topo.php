...
<script>
  ...
  function js_criaDIV() {
    ...
    camada.innerHTML = '<table border="1" cellspacing="0" cellpadding="0"><tr><td style="font-size:10px;" bgcolor="#C4C400" nowrap><strong>Nome:</strong></td><td  style="font-size:10px" bgcolor="#C4C400" nowrap><?=@pg_fetch_result($result,0,0)?>&nbsp;</td><td  style="font-size:10px" bgcolor="#C4C400" nowrap><strong>Login:</strong></td><td  bgcolor="#C4C400" style="font-size:10px" nowrap><?=@pg_fetch_result($result,0,1)?>&nbsp;</td></tr><tr><td  style="font-size:10px" bgcolor="#C4C400" nowrap><strong>Base de Dados:&nbsp;</strong></td><td  style="font-size:10px"  bgcolor="#C4C400" nowrap>' + document.getElementById('auxAcesso').value + '&nbsp;</td><td  style="font-size:10px" bgcolor="#C4C400" nowrap><strong>Servidor:</strong></td><td  style="font-size:10px"  bgcolor="#C4C400" nowrap><?=$DB_SERVIDOR?>&nbsp;</td></tr><tr><td  style="font-size:10px" bgcolor="#C4C400" nowrap><strong>IP:</strong></td><td  style="font-size:10px"  bgcolor="#C4C400" nowrap><?=($_SERVER["HTTP_X_FORWARDED_FOR"] ?? $_SERVER['REMOTE_ADDR'])?>&nbsp;</td><td  style="font-size:10px" bgcolor="#C4C400" nowrap><strong>Local:</strong></td><td  style="font-size:10px" bgcolor="#C4C400" nowrap><?=$_SERVER['PHP_SELF'];?></td></tr></table>';
