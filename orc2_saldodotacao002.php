...
$codigoRecurso = RecursoRepository::getRecursoPorCodigo($o58_codigo);
$fonteRecurso = $codigoRecurso->getFonteDeRecurso();
...
$pdf->setfont('arial','',8);
$pdf->cell( 30,$alt,$fonteRecurso,1,0,"L",0);
...
$pdf->cell(21,$alt,"Complemento:",1,0,"L",0);
$pdf->setfont('arial','',8);
$pdf->cell(30,$alt,$complemento,1,0,"L",0);
$pdf->cell(98,$alt,$complementoDescricao,1,0,"L",0);
$pdf->cell(1.5,$alt,"",0,0,"C",0);
$pdf->setfont('arial','b',8);
