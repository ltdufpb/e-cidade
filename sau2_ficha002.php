...
echo "|Atendimento: ".substr((string) $sd23_c_atendimento,0,4)." | ".substr((string) $sd23_c_atendimento,4,2)." | ".substr((string) $sd23_c_atendimento,6,5)?> Data/Hora: <?=$sd23_d_consulta." /".$sd23_c_hora."                   |<br>";
echo "+------------------------------------------------------------------------------+<br>";
...
echo "|Familia ..:".str_pad(trim((string) $sd01_i_familia),67," ")."|<br>";
