...
$NumRows_mat_calc = $Result_mat_calc === false || $Result_mat_calc === null ? 0 : pg_num_rows($Result_mat_calc);
...
$NumRows_pago = $Result_pago === false || $Result_pago === null ? 0 : pg_num_rows($Result_pago);
...
$NumRows_mat_pag = $Result_mat_pag === false || $Result_mat_pag === null ? 0 : pg_num_rows($Result_mat_pag);
...
$NumRows_div = $Result_div === false || $Result_div === null ? 0 : pg_num_rows($Result_div);
...
$NumRows_mat_div = $Result_mat_div === false || $Result_mat_div === null ? 0 : pg_num_rows($Result_mat_div);
