    ...
    <fieldset>
      ...
      <table width="35%" border="0" align="center" cellspacing="3" class="form-container">
        <tr>
          ...
          <td><?php  db_input("p14_sequencial",10,$Ip14_sequencial,true,"text",4,"","chave_p14_sequencial"); ?></td>
        </tr>
        <tr>
          <td><label><?=$Lp14_sequencial?></label></td>
          <td><?php  db_input("p14_sequencial",10,$Ip14_sequencial,true,"text",4,"","chave_p14_sequencial");?></td>
    ...
    <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_levantamentopatrimonialbens.hide();">
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_p14_sequencial)){
          $repassa = ["chave_p14_sequencial"=>$chave_p14_sequencial,"chave_p14_sequencial"=>$chave_p14_sequencial];
        }
