  ...
  <fieldset>
    ...
    <table class='form-container'>
      <tr>
        ...
        <td nowrap="nowrap">
          <select id='cntCalendario' onchange=" js_buscaTurmas();"> <!--2018-06-26 Wallace (ATMA) onchange="js_buscaPeriodos();-->
            <option value=''>Selecione</option>
          </select>
        </td>
      </tr>
<!--      <tr>  2018-06-26 Wallace (ATMA) Retirar o Período, vai ser selecionado automático -->
...
//  }
  ...
  var sUrl  = 'edu2_resultnotasanalitico003.php?periodo= 0';
